...
(assert (not
 (=> (= (ControlFlow 0 0) 37317) (let ((anon0$1_correct@@1  (=> (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_23648| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@47) (and (|Select__T@[Int]Bool_| (|domain#$Memory_22822| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_22822| $1_Roles_RoleId_$memory) addr@@47)) 4))))
 :qid |ValidatorOperatorConfigbpl.2140:20|
 :skolemid |82|
)) (=> (and (|$IsValid'address'| _$t0@@1) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_23648| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@1)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc@@1))
 :qid |ValidatorOperatorConfigbpl.2147:20|
 :skolemid |83|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_23648| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@1))
))) (=> (and (and (= _$t0@@1 _$t0@@1) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_23648| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0@@1))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 33163) (- 0 37436)))) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_23648| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0@@1)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_15010_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_15010| stream@@2) 0) (forall ((v@@16 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_15010| stream@@2) v@@16) 0)
 :qid |ValidatorOperatorConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |ValidatorOperatorConfigbpl.1292:13|
 :skolemid |34|
))) (= (ControlFlow 0 33060) 33163)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 37317) 33060) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))
))
(check-sat)
(pop 1)
