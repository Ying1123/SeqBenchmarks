...
(assert (not
 (=> (= (ControlFlow 0 0) 515976) (let ((anon12_Else_correct@@2  (=> (not $abort_flag@0@@9) (=> (and (= $t9@0@@2 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| $t8@1@@2)) (= $t9@0@@2 $t9@0@@2)) (and (=> (= (ControlFlow 0 371276) (- 0 516302)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (=> (= (ControlFlow 0 371276) (- 0 516314)) (= $t9@0@@2 (let ((addr@@34 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) addr@@34)))))))))))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 371214) (- 0 516253)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (= (ControlFlow 0 371214) (- 0 516260)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 $t7@0@@3)))))))
(let ((anon12_Then_correct@@2  (=> (and (and $abort_flag@0@@9 (= $abort_code@1@@9 $abort_code@1@@9)) (and (= $t7@0@@3 $abort_code@1@@9) (= (ControlFlow 0 371290) 371214))) L3_correct@@2)))
(let ((anon11_Then$1_correct@@2  (=> (= $t8@1@@2 $t8@@2) (=> (and (= $abort_flag@0@@9 true) (= $abort_code@1@@9 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 371342) 371290) anon12_Then_correct@@2) (=> (= (ControlFlow 0 371342) 371276) anon12_Else_correct@@2))))))
(let ((anon11_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (ControlFlow 0 371340) 371342)) anon11_Then$1_correct@@2)))
(let ((anon11_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (=> (and (and (= $t8@0@@2 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= $t8@1@@2 $t8@0@@2)) (and (= $abort_flag@0@@9 false) (= $abort_code@1@@9 $abort_code@0@@9))) (and (=> (= (ControlFlow 0 371232) 371290) anon12_Then_correct@@2) (=> (= (ControlFlow 0 371232) 371276) anon12_Else_correct@@2))))))
(let ((anon10_Then_correct@@2  (=> $t4@0@@3 (and (=> (= (ControlFlow 0 371218) 371340) anon11_Then_correct@@2) (=> (= (ControlFlow 0 371218) 371232) anon11_Else_correct@@2)))))
(let ((anon10_Else_correct@@2  (=> (and (and (not $t4@0@@3) (= $t6@@2 $t6@@2)) (and (= $t7@0@@3 $t6@@2) (= (ControlFlow 0 371182) 371214))) L3_correct@@2)))
(let ((anon0$1_correct@@9  (=> (forall ((config_address@@17 Int) ) (!  (=> (|$IsValid'address'| config_address@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) config_address@@17) (= config_address@@17 173345816)))
 :qid |DiemConfigbpl.9030:20|
 :skolemid |244|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (forall (($a_0@@29 Int) ) (! (let (($rsc@@29 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) $a_0@@29)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption''| $rsc@@29))
 :qid |DiemConfigbpl.9038:20|
 :skolemid |245|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) $a_0@@29))
))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_173999| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6@@2) (= $t6@@2 5)) (and (= $t6@@2 $t6@@2) (= $t4@0@@3 $t4@0@@3)))) (and (=> (= (ControlFlow 0 371166) 371218) anon10_Then_correct@@2) (=> (= (ControlFlow 0 371166) 371182) anon10_Else_correct@@2)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@19 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_144488| stream@@19) 0) (forall ((v@@47 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@19) v@@47) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 371041) 371166)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 515976) 371041) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9))))))))))))
))
(check-sat)
(pop 1)
