...
(assert (not
 (=> (= (ControlFlow 0 0) 525371) (let ((anon15_Else_correct@@4  (=> (not $abort_flag@0@@19) (and (=> (= (ControlFlow 0 382502) (- 0 526435)) (forall ((config_address@@36 Int) ) (!  (=> (|$IsValid'address'| config_address@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@36) (= config_address@@36 173345816)))
 :qid |DiemConfigbpl.12304:15|
 :skolemid |383|
))) (=> (forall ((config_address@@37 Int) ) (!  (=> (|$IsValid'address'| config_address@@37) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@37) (= config_address@@37 173345816)))
 :qid |DiemConfigbpl.12304:15|
 :skolemid |383|
)) (and (=> (= (ControlFlow 0 382502) (- 0 526460)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (and (= $t15@0@@6 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0@@6 $t15@0@@6)) (and (=> (= (ControlFlow 0 382502) (- 0 526497)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0))) (and (=> (= (ControlFlow 0 382502) (- 0 526509)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (and (=> (= (ControlFlow 0 382502) (- 0 526527)) (not (not (= (|$addr#$signer| _$t0@@11) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@11) 173345816))) (and (=> (= (ControlFlow 0 382502) (- 0 526541)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 382502) (- 0 526551)) (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816) (and (=> (= (ControlFlow 0 382502) (- 0 526557)) (= (let ((addr@@138 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@138))) _$t1@@10)) (=> (= (let ((addr@@139 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@139))) _$t1@@10) (=> (= (ControlFlow 0 382502) (- 0 526566)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct@@12  (and (=> (= (ControlFlow 0 382309) (- 0 526316)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 382309) (- 0 526356)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) (= 5 $t7@0@@8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t4@@0)) 0)) (= 3 $t7@0@@8))) (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t7@0@@8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0@@8))))))))
(let ((anon15_Then_correct@@4  (=> (and (and $abort_flag@0@@19 (= $abort_code@1@@19 $abort_code@1@@19)) (and (= $t7@0@@8 $abort_code@1@@19) (= (ControlFlow 0 382516) 382309))) L3_correct@@12)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0@@19 true) (= $abort_code@1@@19 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 382568) 382516) anon15_Then_correct@@4) (=> (= (ControlFlow 0 382568) 382502) anon15_Else_correct@@4))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@11)) (= (ControlFlow 0 382566) 382568)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@11))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1| ($Memory_178828 (|Store__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@11) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@11) $t13@0@@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1|)) (and (= $abort_flag@0@@19 false) (= $abort_code@1@@19 $abort_code@0@@19))) (and (=> (= (ControlFlow 0 382353) 382516) anon15_Then_correct@@4) (=> (= (ControlFlow 0 382353) 382502) anon15_Else_correct@@4))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1@@5 (= $t13@0@@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1@@10))) (and (=> (= (ControlFlow 0 382331) (- 0 526189)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@11))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@11)) (and (=> (= (ControlFlow 0 382331) 382566) anon14_Then_correct) (=> (= (ControlFlow 0 382331) 382353) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@5) (= $t12@@1 $t12@@1)) (and (= $t7@0@@8 $t12@@1) (= (ControlFlow 0 382181) 382309))) L3_correct@@12)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12@@1) (= $t12@@1 6)) (and (= $t12@@1 $t12@@1) (= inline$$Not$0$dst@1@@5 inline$$Not$0$dst@1@@5))) (and (=> (= (ControlFlow 0 382165) 382331) anon13_Then_correct) (=> (= (ControlFlow 0 382165) 382181) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@5  (=> (and (= inline$$Not$0$dst@1@@5  (not $t9@0@@11)) (= (ControlFlow 0 382125) 382165)) anon12_Else$1_correct)))
(let ((anon12_Else_correct@@6  (=> (not $t6@@11) (=> (and (and (|$IsValid'address'| $t8@@11) (= $t8@@11 (|$addr#$signer| _$t0@@11))) (and (= $t9@0@@11 (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8@@11)) (= (ControlFlow 0 382131) 382125))) inline$$Not$0$anon0_correct@@5))))
(let ((anon12_Then_correct@@6  (=> $t6@@11 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t7@@10)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t5@@6)) (= 5 $t7@@10))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t5@@6)) 0)) (= 3 $t7@@10))) (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t7@@10))) (= $t7@@10 $t7@@10)) (and (= $t7@0@@8 $t7@@10) (= (ControlFlow 0 382660) 382309))) L3_correct@@12))))
(let ((anon0$1_correct@@19  (=> (and (and (forall ((addr@@140 Int) ) (!  (=> (|$IsValid'address'| addr@@140) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@140) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@140)) 0)) (= addr@@140 173345816)))
 :qid |DiemConfigbpl.12082:20|
 :skolemid |365|
)) (forall ((addr@@141 Int) ) (!  (=> (|$IsValid'address'| addr@@141) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@141)) 1)) (= addr@@141 186537453)))
 :qid |DiemConfigbpl.12086:20|
 :skolemid |366|
))) (and (forall ((addr@@142 Int) ) (!  (=> (|$IsValid'address'| addr@@142) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@142)) 2))))))
 :qid |DiemConfigbpl.12090:20|
 :skolemid |367|
)) (forall ((addr@@143 Int) ) (!  (=> (|$IsValid'address'| addr@@143) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@143)) 2))))))
 :qid |DiemConfigbpl.12094:20|
 :skolemid |368|
)))) (=> (and (and (and (forall ((addr@@144 Int) ) (!  (=> (|$IsValid'address'| addr@@144) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@144)) 2))))))
 :qid |DiemConfigbpl.12098:20|
 :skolemid |369|
)) (forall ((addr@@145 Int) ) (!  (=> (|$IsValid'address'| addr@@145) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@145)) 2))))))
 :qid |DiemConfigbpl.12102:20|
 :skolemid |370|
))) (and (forall ((addr@@146 Int) ) (!  (=> (|$IsValid'address'| addr@@146) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@146)) 2)))))
 :qid |DiemConfigbpl.12106:20|
 :skolemid |371|
)) (forall ((addr@@147 Int) ) (!  (=> (|$IsValid'address'| addr@@147) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@147)) 2)))))
 :qid |DiemConfigbpl.12110:20|
 :skolemid |372|
)))) (and (and (forall ((addr@@148 Int) ) (!  (=> (|$IsValid'address'| addr@@148) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@148)) 2)))))
 :qid |DiemConfigbpl.12114:20|
 :skolemid |373|
)) (forall ((addr@@149 Int) ) (!  (=> (|$IsValid'address'| addr@@149) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176842| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@149) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@149)) 4))))
 :qid |DiemConfigbpl.12118:20|
 :skolemid |374|
))) (and (forall ((addr@@150 Int) ) (!  (=> (|$IsValid'address'| addr@@150) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177901| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@150) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@150)) 3))))
 :qid |DiemConfigbpl.12122:20|
 :skolemid |375|
)) (forall ((addr@@151 Int) ) (!  (=> (|$IsValid'address'| addr@@151) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177901| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@151) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@151)) 3))))
 :qid |DiemConfigbpl.12126:20|
 :skolemid |376|
))))) (=> (and (and (and (and (forall ((addr@@152 Int) ) (!  (=> (|$IsValid'address'| addr@@152) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_177901| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@152) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_177901| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@152)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@152)) 3))))
 :qid |DiemConfigbpl.12130:20|
 :skolemid |377|
)) (forall ((config_address@@38 Int) ) (!  (=> (|$IsValid'address'| config_address@@38) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@38) (= config_address@@38 173345816)))
 :qid |DiemConfigbpl.12134:20|
 :skolemid |378|
))) (and (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_194338| $1_DualAttestation_Credential_$memory) addr1@@4) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr1@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr1@@4)) 2)))))
 :qid |DiemConfigbpl.12138:20|
 :skolemid |379|
)) (forall ((addr@@153 Int) ) (!  (=> (|$IsValid'address'| addr@@153) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_194723| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@153) (|Select__T@[Int]Bool_| (|domain#$Memory_194783| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@153)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) addr@@153)) 2)))))
 :qid |DiemConfigbpl.12142:20|
 :skolemid |380|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@11)) ($1_Signer_is_txn_signer _$t0@@11)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@11)))) (and (and (and (forall (($a_0@@50 Int) ) (! (let (($rsc@@50 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $a_0@@50)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@50))
 :qid |DiemConfigbpl.12151:20|
 :skolemid |381|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $a_0@@50))
)) (forall (($a_0@@51 Int) ) (! (let (($rsc@@51 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@51)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@51))
 :qid |DiemConfigbpl.12155:20|
 :skolemid |382|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@51))
))) (and (= $t4@@0 (|$addr#$signer| _$t0@@11)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| 173345816))) (and (and (= _$t0@@11 _$t0@@11) (= _$t1@@10 _$t1@@10)) (and (= $t5@@6 (|$addr#$signer| _$t0@@11)) (= $t6@@11  (or (or (or (not (= (|$addr#$signer| _$t0@@11) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172830| $1_Roles_RoleId_$memory) $t5@@6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172830| $1_Roles_RoleId_$memory) $t5@@6)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816)))))))) (and (=> (= (ControlFlow 0 382069) 382660) anon12_Then_correct@@6) (=> (= (ControlFlow 0 382069) 382131) anon12_Else_correct@@6)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@24 T@$1_Event_EventHandle) ) (! (let ((stream@@29 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@24)))
 (and (= (|l#Multiset_144488| stream@@29) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@29) v@@57) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 381495) 382069)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (ControlFlow 0 525371) 381495) inline$$InitEventStore$0$anon0_correct@@19)))
anon0_correct@@19))))))))))))))))
))
(check-sat)
(pop 1)
