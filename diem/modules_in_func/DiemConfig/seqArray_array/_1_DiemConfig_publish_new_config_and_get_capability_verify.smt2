...
(assert (not
 (=> (= (ControlFlow 0 0) 539792) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 392612) (- 0 540856)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.12331:15|
 :skolemid |405|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConfigbpl.12331:15|
 :skolemid |405|
)) (and (=> (= (ControlFlow 0 392612) (- 0 540881)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 392612) (- 0 540918)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 392612) (- 0 540930)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 392612) (- 0 540948)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 392612) (- 0 540962)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 392612) (- 0 540972)) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 392612) (- 0 540978)) (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@0))) _$t1)) (=> (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@1))) _$t1) (=> (= (ControlFlow 0 392612) (- 0 540987)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 392419) (- 0 540737)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 392419) (- 0 540777)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 392626) 392419))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 392678) 392626) anon15_Then_correct) (=> (= (ControlFlow 0 392678) 392612) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 392676) 392678)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_186774 (|Store__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 392463) 392626) anon15_Then_correct) (=> (= (ControlFlow 0 392463) 392612) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1))) (and (=> (= (ControlFlow 0 392441) (- 0 540610)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 392441) 392676) anon14_Then_correct) (=> (= (ControlFlow 0 392441) 392463) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 392291) 392419))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 392275) 392441) anon13_Then_correct) (=> (= (ControlFlow 0 392275) 392291) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 392235) 392275)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8)) (= (ControlFlow 0 392241) 392235))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 392770) 392419))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@2)) 0)) (= addr@@2 173345816)))
 :qid |DiemConfigbpl.12109:20|
 :skolemid |387|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@3)) 1)) (= addr@@3 186537453)))
 :qid |DiemConfigbpl.12113:20|
 :skolemid |388|
 ...
 :qid |DiemConfigbpl.12165:20|
 :skolemid |401|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_203026| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_203086| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@15)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@15)) 2)))))
 :qid |DiemConfigbpl.12169:20|
 :skolemid |402|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 391605) 392179)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 539792) 391605) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
