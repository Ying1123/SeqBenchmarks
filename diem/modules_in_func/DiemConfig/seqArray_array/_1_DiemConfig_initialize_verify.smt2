...
(declare-fun $t14@0 () T@$1_DiemConfig_Configuration)
...
(assert (not
 (=> (= (ControlFlow 0 0) 531876) (let ((anon21_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 383599) (- 0 532785)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@1) 173345816)) (=> (= $t15 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 383599) (- 0 532812)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 383599) (- 0 532820)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 383599) (- 0 532830)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 383599) (- 0 532844)) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@1) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@1) 173345816) (and (=> (= (ControlFlow 0 383599) (- 0 532850)) (= (|$epoch#$1_DiemConfig_Configuration| $t15) 0)) (=> (= (|$epoch#$1_DiemConfig_Configuration| $t15) 0) (=> (= (ControlFlow 0 383599) (- 0 532861)) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t15) 0))))))))))))))))))
(let ((anon19_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 383363) (- 0 532711)) (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 383363) (- 0 532732)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (= 6 $t4@0)) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t4@0))))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t4@0 $abort_code@1) (= (ControlFlow 0 383613) 383363))) L3_correct)))
(let ((anon20_Then$1_correct  (=> (= $1_DiemConfig_Configuration_$memory@1 $1_DiemConfig_Configuration_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 383665) 383613) anon21_Then_correct) (=> (= (ControlFlow 0 383665) 383599) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 383663) 383665)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_DiemConfig_Configuration_$memory@1 $1_DiemConfig_Configuration_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 383507) 383613) anon21_Then_correct) (=> (= (ControlFlow 0 383507) 383599) anon21_Else_correct))))))
(let ((anon19_Else_correct  (=> (and (not false) (= $t14@0 ($1_DiemConfig_Configuration 0 0 |inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 383485) (- 0 532602)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 383485) 383663) anon20_Then_correct) (=> (= (ControlFlow 0 383485) 383507) anon20_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 383451) 383679) anon19_Then_correct) (=> (= (ControlFlow 0 383451) 383485) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (and inline$$Not$0$dst@1 (|$IsValid'u64'| 0)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 383457) 383451))) |inline$$1_Event_new_event_handle'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|)))
(let ((anon18_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t10 $t10)) (and (= $t4@0 $t10) (= (ControlFlow 0 383283) 383363))) L3_correct)))
(let ((anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t10) (= $t10 6)) (and (= $t10 $t10) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 383267) 383457) anon18_Then_correct) (=> (= (ControlFlow 0 383267) 383283) anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t7@0)) (= (ControlFlow 0 383231) 383267)) anon17_Else$1_correct)))
(let ((anon17_Else_correct  (=> (and (and (not $t5) (|$IsValid'address'| 173345816)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= (ControlFlow 0 383237) 383231))) inline$$Not$0$anon0_correct)))
(let ((anon17_Then_correct  (=> $t5 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t4)) (= $t4 $t4)) (and (= $t4@0 $t4) (= (ControlFlow 0 383709) 383363))) L3_correct))))
(let ((anon16_Else_correct  (=> (and (not $t3) (= $t5  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 383181) 383709) anon17_Then_correct) (=> (= (ControlFlow 0 383181) 383237) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> $t3 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t4)) (= $t4 $t4)) (and (= $t4@0 $t4) (= (ControlFlow 0 383735) 383363))) L3_correct))))
...
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@0))
 :qid |DiemConfigbpl.9794:20|
 :skolemid |278|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) $a_0@@0))
)))) (and (and (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t3  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 383159) 383735) anon16_Then_correct) (=> (= (ControlFlow 0 383159) 383181) anon16_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 382745) 383159)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 531876) 382745) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))
))
(check-sat)
(pop 1)
