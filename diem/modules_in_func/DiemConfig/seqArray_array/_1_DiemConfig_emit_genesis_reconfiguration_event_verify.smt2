...
(declare-fun $t12@2 () T@$Mutation_204305)
...
(declare-fun $t24@0 () T@$Mutation_172895)
(declare-fun $t26@0 () T@$1_DiemConfig_NewEpochEvent)
(declare-fun $t4@0 () Bool)
(declare-fun $t23@0 () T@$Mutation_11647)
(declare-fun $t12@1 () T@$Mutation_204305)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t23@1 () T@$Mutation_11647)
...
(declare-fun $t12 () T@$Mutation_204305)
(declare-fun $abort_code@1 () Int)
(declare-fun $t12@0 () T@$Mutation_204305)
(declare-fun MapConstVec_11252 (Int) |T@[Int]Int|)
(declare-fun DefaultVecElem_11252 () Int)
(declare-fun $abort_code@0 () Int)
(declare-fun $t7@0 () Bool)
(declare-fun $t9 () Int)
(declare-fun $t5 () T@$Mutation_204305)
(declare-fun $t23 () T@$Mutation_11647)
(declare-fun $t24 () T@$Mutation_172895)
(push 1)
(set-info :boogie-vc-id $1_DiemConfig_emit_genesis_reconfiguration_event$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 527158) (let ((anon22_Else_correct  (=> (and (not $abort_flag@0) (= $1_DiemConfig_Configuration_$memory@0 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_204305| $t12@2)) true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_204305| $t12@2)) (|v#$Mutation_204305| $t12@2))))) (and (=> (= (ControlFlow 0 378119) (- 0 527798)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@0) 173345816)) (=> (= $t27 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory@0) 173345816)) (=> (and (= $t28 (|$events#$1_DiemConfig_Configuration| $t27)) (= $t29 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t27)))) (and (=> (= (ControlFlow 0 378119) (- 0 527849)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28)))
(let ((stream_new (let ((len (|l#Multiset_146057| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28 stream_new@@0))))))
 ...
 :qid |DiemConfigbpl.2603:13|
 :skolemid |92|
))))) (=> (= (ControlFlow 0 378119) (- 0 527874)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t28 stream_new@@1))))))
...
(let ((|inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| (|v#$Mutation_172895| $t24@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_146057| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 377989) 378133) anon22_Then_correct) (=> (= (ControlFlow 0 377989) 378119) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> $t4@0 (=> (and (and (and (|$IsValid'u64'| 1) (= $t23@0 ($Mutation_11647 (|l#$Mutation_204305| $t12@1) (let ((l (|l#Vec_21325| (|p#$Mutation_204305| $t12@1))))
(Vec_21325 (|Store__T@[Int]Int_| (|v#Vec_21325| (|p#$Mutation_204305| $t12@1)) l 0) (+ l 1))) (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@1))))) (and (= $t23@1 ($Mutation_11647 (|l#$Mutation_11647| $t23@0) (|p#$Mutation_11647| $t23@0) 1)) (= $t12@2 ($Mutation_204305 (|l#$Mutation_204305| $t12@1) (|p#$Mutation_204305| $t12@1) ($1_DiemConfig_Configuration (|v#$Mutation_11647| $t23@1) (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@1)) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@1))))))) (and (and (= $t24@0 ($Mutation_172895 (|l#$Mutation_204305| $t12@2) (let ((l@@0 (|l#Vec_21325| (|p#$Mutation_204305| $t12@2))))
(Vec_21325 (|Store__T@[Int]Int_| (|v#Vec_21325| (|p#$Mutation_204305| $t12@2)) l@@0 2) (+ l@@0 1))) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@2)))) (= $t25@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@2)))) (and (= $t26@0 ($1_DiemConfig_NewEpochEvent $t25@0)) (= (ControlFlow 0 377995) 377989)))) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|))))
(let ((anon21_Else_correct true))
(let ((L5_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 1)) (and (= $t21 $t21) (= $t4@0 $t4@0))) (and (=> (= (ControlFlow 0 377832) 377995) anon21_Then_correct) (=> (= (ControlFlow 0 377832) 377848) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (and (not $t15@0) (= false false)) (and (= $t4@0 false) (= (ControlFlow 0 377802) 377832))) L5_correct)))
(let ((anon20_Then_correct  (=> $t15@0 (=> (and (= $t16@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@1))) (|$IsValid'u64'| 0)) (=> (and (and (= $t18@0 (= $t16@0 0)) (= $t18@0 $t18@0)) (and (= $t4@0 $t18@0) (= (ControlFlow 0 378163) 377832))) L5_correct)))))
(let ((anon19_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_DiemConfig_Configuration'@0| (|v#$Mutation_204305| $t12@1))) (=> (and (and (= |$temp_0'$1_DiemConfig_Configuration'@0| |$temp_0'$1_DiemConfig_Configuration'@0|) (= $t13@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_204305| $t12@1)))) (and (|$IsValid'u64'| 0) (= $t15@0 (= $t13@0 0)))) (and (=> (= (ControlFlow 0 377782) 378163) anon20_Then_correct) (=> (= (ControlFlow 0 377782) 377802) anon20_Else_correct))))))
(let ((anon19_Then_correct true))
(let ((anon18_Then$1_correct  (=> (= $t12@1 $t12) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 378229) 378177) anon19_Then_correct) (=> (= (ControlFlow 0 378229) 377782) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= (ControlFlow 0 378227) 378229)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (=> (and (and (= $t12@0 ($Mutation_204305 ($Global 173345816) (Vec_21325 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (= $t12@1 $t12@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 377744) 378177) anon19_Then_correct) (=> (= (ControlFlow 0 377744) 377782) anon19_Else_correct))))))
(let ((anon17_Then_correct  (=> (and $t7@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 377722) 378227) anon18_Then_correct) (=> (= (ControlFlow 0 377722) 377744) anon18_Else_correct)))))
(let ((anon17_Else_correct true))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) $a_0)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc))
 :qid |DiemConfigbpl.7949:20|
 :skolemid |228|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) $a_0))
)) (|$IsValid'address'| 173345816)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 377690) 377722) anon17_Then_correct) (=> (= (ControlFlow 0 377690) 377706) anon17_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 377602) 377690)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_21325| (|p#$Mutation_204305| $t5)) 0) (=> (and (and (= (|l#Vec_21325| (|p#$Mutation_204305| $t12)) 0) (= (|l#Vec_21325| (|p#$Mutation_11647| $t23)) 0)) (and (= (|l#Vec_21325| (|p#$Mutation_172895| $t24)) 0) (= (ControlFlow 0 377612) 377602))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 527158) 377612) anon0_correct)))
