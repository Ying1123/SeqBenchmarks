...
(declare-fun $t7 () Int)
(declare-fun |$1_DiemConfig_DiemConfig'#0'_$memory@0| () T@$Memory_186774)
...
(declare-fun $t15@1 () T@$Mutation_188695)
(declare-fun $t16@0 () T@$Mutation_149509)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t16@1 () T@$Mutation_149509)
(declare-fun $t15@2 () T@$Mutation_188695)
...
(declare-fun $t15 () T@$Mutation_188695)
(declare-fun $t15@0 () T@$Mutation_188695)
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) $t32 stream_new)))) $es)) (= $t34 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $t35 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t36 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t34)))))) (and (=> (= (ControlFlow 0 404817) (- 0 551771)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 404817) (- 0 551783)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6)))) (and (=> (= (ControlFlow 0 404817) (- 0 551825)) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816) (and (=> (= (ControlFlow 0 404817) (- 0 551831)) (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) addr@@0))) _$t1)) (=> (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) addr@@1))) _$t1) (and (=> (= (ControlFlow 0 404817) (- 0 551840)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816))) (=> (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816)) (and (=> (= (ControlFlow 0 404817) (- 0 551851)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1)))) $EmptyEventStore)))
 ...
 :qid |DiemConfigbpl.2603:13|
 :skolemid |92|
))))) (=> (= (ControlFlow 0 404817) (- 0 551896)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_DiemConfig_Configuration_$memory@1 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1) (= (ControlFlow 0 404419) 404817))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_DiemConfig_Configuration_$memory@0 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0) (= (ControlFlow 0 404829) 404817))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not $t25) (and (=> (= (ControlFlow 0 404407) 404829) anon19_Then_correct) (=> (= (ControlFlow 0 404407) 404419) anon19_Else_correct)))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 404088) (- 0 551378)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6)))) (=> (= (ControlFlow 0 404088) (- 0 551424)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= 5 $t14@0)) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))) (= 1 $t14@0))))))))
(let ((anon18_Then_correct  (=> $t25 (=> (and (and (and (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21)))) (= 1 $t14)) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 404909) 404088))) L3_correct))))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| (|v#$Mutation_188695| $t15@1)) (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| |$temp_0'$1_DiemConfig_DiemConfig'#0''@0|)) (=> (and (and (= $t16@0 ($Mutation_149509 (|l#$Mutation_188695| $t15@1) (let ((l (|l#Vec_21325| (|p#$Mutation_188695| $t15@1))))
(Vec_21325 (|Store__T@[Int]Int_| (|v#Vec_21325| (|p#$Mutation_188695| $t15@1)) l 0) (+ l 1))) (|$payload#$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_188695| $t15@1)))) (= $t16@1 ($Mutation_149509 (|l#$Mutation_149509| $t16@0) (|p#$Mutation_149509| $t16@0) _$t1))) (and (= $t15@2 ($Mutation_188695 (|l#$Mutation_188695| $t15@1) (|p#$Mutation_188695| $t15@1) (|$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_149509| $t16@1)))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_186774 (|Store__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_188695| $t15@2)) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_188695| $t15@2)) (|v#$Mutation_188695| $t15@2)))))) (and (=> (= (ControlFlow 0 404399) (- 0 551067)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.15289:15|
 :skolemid |529|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConfigbpl.15289:15|
 :skolemid |529|
)) (and (=> (= (ControlFlow 0 404399) (- 0 551092)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (and (and (and (= $t17 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t18 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t19 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t20 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (and (= $t21 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t22 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t23 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t24 (|$events#$1_DiemConfig_Configuration| $t23))))) (and (=> (= (ControlFlow 0 404399) (- 0 551199)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 404399) (- 0 551212)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (=> (= $t25  (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21))))) (and (=> (= (ControlFlow 0 404399) 404909) anon18_Then_correct) (=> (= (ControlFlow 0 404399) 404407) anon18_Else_correct)))))))))))))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 404923) 404088))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t15@1 $t15) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 404975) 404923) anon17_Then_correct) (=> (= (ControlFlow 0 404975) 404399) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= (ControlFlow 0 404973) 404975)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (=> (and (and (= $t15@0 ($Mutation_188695 ($Global 173345816) (Vec_21325 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (= $t15@1 $t15@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 404120) 404923) anon17_Then_correct) (=> (= (ControlFlow 0 404120) 404399) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t11@0 (and (=> (= (ControlFlow 0 404098) (- 0 550876)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 404098) 404973) anon16_Then_correct) (=> (= (ControlFlow 0 404098) 404120) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 403964) 404088))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemConfigbpl.15121:20|
 :skolemid |524|
))) (and (|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemConfigbpl.15130:20|
 :skolemid |525|
...
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@2)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@2))
 :qid |DiemConfigbpl.15142:20|
 :skolemid |528|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@2))
)) (= $t6 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))))) (=> (and (and (and (and (= $t7 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t8 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t9 (|$events#$1_DiemConfig_Configuration| $t8)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_186774| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 403948) 404098) anon15_Then_correct) (=> (= (ControlFlow 0 403948) 403964) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 403659) 403948)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_21325| (|p#$Mutation_188695| $t5)) 0) (= (|l#Vec_21325| (|p#$Mutation_188695| $t15)) 0)) (and (= (|l#Vec_21325| (|p#$Mutation_149509| $t16)) 0) (= (ControlFlow 0 403669) 403659))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 550480) 403669) anon0_correct)))
