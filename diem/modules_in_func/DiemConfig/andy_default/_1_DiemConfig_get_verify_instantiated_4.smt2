...
(assert (not
 (=> (= (ControlFlow 0 0) 516699) (let ((anon12_Else_correct@@4  (=> (not $abort_flag@0@@11) (=> (and (= $t9@0@@4 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| $t8@1@@4)) (= $t9@0@@4 $t9@0@@4)) (and (=> (= (ControlFlow 0 372077) (- 0 517048)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (=> (= (ControlFlow 0 372077) (- 0 517060)) (= $t9@0@@4 (let ((addr@@37 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) addr@@37)))))))))))
(let ((L3_correct@@4  (and (=> (= (ControlFlow 0 372015) (- 0 516999)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (= (ControlFlow 0 372015) (- 0 517006)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (= 5 $t7@0@@5)))))))
(let ((anon12_Then_correct@@4  (=> (and (and $abort_flag@0@@11 (= $abort_code@1@@11 $abort_code@1@@11)) (and (= $t7@0@@5 $abort_code@1@@11) (= (ControlFlow 0 372091) 372015))) L3_correct@@4)))
(let ((anon11_Then$1_correct@@4  (=> (= $t8@1@@4 $t8@@4) (=> (and (= $abort_flag@0@@11 true) (= $abort_code@1@@11 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 372143) 372091) anon12_Then_correct@@4) (=> (= (ControlFlow 0 372143) 372077) anon12_Else_correct@@4))))))
(let ((anon11_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (= (ControlFlow 0 372141) 372143)) anon11_Then$1_correct@@4)))
(let ((anon11_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816) (=> (and (and (= $t8@0@@4 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (= $t8@1@@4 $t8@0@@4)) (and (= $abort_flag@0@@11 false) (= $abort_code@1@@11 $abort_code@0@@11))) (and (=> (= (ControlFlow 0 372033) 372091) anon12_Then_correct@@4) (=> (= (ControlFlow 0 372033) 372077) anon12_Else_correct@@4))))))
(let ((anon10_Then_correct@@4  (=> $t4@0@@5 (and (=> (= (ControlFlow 0 372019) 372141) anon11_Then_correct@@4) (=> (= (ControlFlow 0 372019) 372033) anon11_Else_correct@@4)))))
(let ((anon10_Else_correct@@4  (=> (and (and (not $t4@0@@5) (= $t6@@4 $t6@@4)) (and (= $t7@0@@5 $t6@@4) (= (ControlFlow 0 371983) 372015))) L3_correct@@4)))
(let ((anon0$1_correct@@11  (=> (and (and (forall ((config_address@@19 Int) ) (!  (=> (|$IsValid'address'| config_address@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) config_address@@19) (= config_address@@19 173345816)))
 :qid |DiemConfigbpl.9336:20|
 :skolemid |249|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (and (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) addr@@38) (= addr@@38 173345816)))
 :qid |DiemConfigbpl.9344:20|
 :skolemid |250|
)) (forall (($a_0@@31 Int) ) (! (let (($rsc@@31 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@31)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''| $rsc@@31))
 :qid |DiemConfigbpl.9348:20|
 :skolemid |251|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@31))
)))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_174623| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6@@4) (= $t6@@4 5)) (and (= $t6@@4 $t6@@4) (= $t4@0@@5 $t4@0@@5)))) (and (=> (= (ControlFlow 0 371967) 372019) anon10_Then_correct@@4) (=> (= (ControlFlow 0 371967) 371983) anon10_Else_correct@@4))))))
(let ((inline$$InitEventStore$0$anon0_correct@@11  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@21 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_144488| stream@@21) 0) (forall ((v@@49 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@21) v@@49) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 371819) 371967)) anon0$1_correct@@11)))
(let ((anon0_correct@@11  (=> (= (ControlFlow 0 516699) 371819) inline$$InitEventStore$0$anon0_correct@@11)))
anon0_correct@@11))))))))))))
))
(check-sat)
(pop 1)
