...
(assert (not
 (=> (= (ControlFlow 0 0) 517077) (let ((anon12_Else_correct@@5  (=> (not $abort_flag@0@@12) (=> (and (= $t9@0@@5 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| $t8@1@@5)) (= $t9@0@@5 $t9@0@@5)) (and (=> (= (ControlFlow 0 372484) (- 0 517426)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (= (ControlFlow 0 372484) (- 0 517438)) (= $t9@0@@5 (let ((addr@@39 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@39)))))))))))
(let ((L3_correct@@5  (and (=> (= (ControlFlow 0 372422) (- 0 517377)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (=> (= (ControlFlow 0 372422) (- 0 517384)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= 5 $t7@0@@6)))))))
(let ((anon12_Then_correct@@5  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= $t7@0@@6 $abort_code@1@@12) (= (ControlFlow 0 372498) 372422))) L3_correct@@5)))
(let ((anon11_Then$1_correct@@5  (=> (= $t8@1@@5 $t8@@5) (=> (and (= $abort_flag@0@@12 true) (= $abort_code@1@@12 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 372550) 372498) anon12_Then_correct@@5) (=> (= (ControlFlow 0 372550) 372484) anon12_Else_correct@@5))))))
(let ((anon11_Then_correct@@5  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= (ControlFlow 0 372548) 372550)) anon11_Then$1_correct@@5)))
(let ((anon11_Else_correct@@5  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (=> (and (and (= $t8@0@@5 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= $t8@1@@5 $t8@0@@5)) (and (= $abort_flag@0@@12 false) (= $abort_code@1@@12 $abort_code@0@@12))) (and (=> (= (ControlFlow 0 372440) 372498) anon12_Then_correct@@5) (=> (= (ControlFlow 0 372440) 372484) anon12_Else_correct@@5))))))
(let ((anon10_Then_correct@@5  (=> $t4@0@@6 (and (=> (= (ControlFlow 0 372426) 372548) anon11_Then_correct@@5) (=> (= (ControlFlow 0 372426) 372440) anon11_Else_correct@@5)))))
(let ((anon10_Else_correct@@5  (=> (and (and (not $t4@0@@6) (= $t6@@5 $t6@@5)) (and (= $t7@0@@6 $t6@@5) (= (ControlFlow 0 372390) 372422))) L3_correct@@5)))
(let ((anon0$1_correct@@12  (=> (and (and (forall ((config_address@@20 Int) ) (!  (=> (|$IsValid'address'| config_address@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) config_address@@20) (= config_address@@20 173345816)))
 :qid |DiemConfigbpl.9493:20|
 :skolemid |252|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (and (forall ((addr@@40 Int) ) (!  (=> (|$IsValid'address'| addr@@40) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@40) (= addr@@40 173345816)))
 :qid |DiemConfigbpl.9501:20|
 :skolemid |253|
)) (forall (($a_0@@32 Int) ) (! (let (($rsc@@32 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0@@32)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''| $rsc@@32))
 :qid |DiemConfigbpl.9505:20|
 :skolemid |254|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0@@32))
)))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_172704| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6@@5) (= $t6@@5 5)) (and (= $t6@@5 $t6@@5) (= $t4@0@@6 $t4@0@@6)))) (and (=> (= (ControlFlow 0 372374) 372426) anon10_Then_correct@@5) (=> (= (ControlFlow 0 372374) 372390) anon10_Else_correct@@5))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@22 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_144488| stream@@22) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@22) v@@50) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 372226) 372374)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 517077) 372226) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12))))))))))))
))
(check-sat)
(pop 1)
