...
(declare-fun $t13@0 () |T@$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 541008) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 394005) (- 0 542095)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.12681:15|
 :skolemid |425|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConfigbpl.12681:15|
 :skolemid |425|
)) (and (=> (= (ControlFlow 0 394005) (- 0 542120)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 394005) (- 0 542131)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@0) (= addr@@0 173345816)))
 :qid |DiemConfigbpl.12693:15|
 :skolemid |426|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@1) (= addr@@1 173345816)))
 :qid |DiemConfigbpl.12693:15|
 :skolemid |426|
)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'$1_DiemSystem_DiemSystem'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 394005) (- 0 542182)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 394005) (- 0 542194)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 394005) (- 0 542212)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 394005) (- 0 542226)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 394005) (- 0 542236)) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 394005) (- 0 542242)) (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@2)))) (|$scheme#$1_DiemSystem_DiemSystem| _$t1)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@2)))) (|$validators#$1_DiemSystem_DiemSystem| _$t1)))) (=> (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@3)))) (|$scheme#$1_DiemSystem_DiemSystem| _$t1)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@3)))) (|$validators#$1_DiemSystem_DiemSystem| _$t1))) (=> (= (ControlFlow 0 394005) (- 0 542251)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 393787) (- 0 541976)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 393787) (- 0 542016)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 394019) 393787))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 394071) 394019) anon15_Then_correct) (=> (= (ControlFlow 0 394071) 394005) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 394069) 394071)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0| ($Memory_180719 (|Store__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 393831) 394019) anon15_Then_correct) (=> (= (ControlFlow 0 393831) 394005) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| _$t1))) (and (=> (= (ControlFlow 0 393809) (- 0 541849)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 393809) 394069) anon14_Then_correct) (=> (= (ControlFlow 0 393809) 393831) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 393659) 393787))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 393643) 393809) anon13_Then_correct) (=> (= (ControlFlow 0 393643) 393659) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 393603) 393643)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $t8)) (= (ControlFlow 0 393609) 393603))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 394163) 393787))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4)) 0)) (= addr@@4 173345816)))
 ...
 :qid |DiemConfigbpl.12507:20|
 :skolemid |419|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@17) (= addr@@17 173345816)))
 :qid |DiemConfigbpl.12511:20|
 :skolemid |420|
 ...
 :qid |DiemConfigbpl.12519:20|
 :skolemid |422|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_DiemSystem_DiemSystem'| _$t1)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemConfigbpl.12528:20|
 :skolemid |423|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@0))
 :qid |DiemConfigbpl.12532:20|
 :skolemid |424|
...
))) (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))))))) (and (=> (= (ControlFlow 0 393547) 394163) anon12_Then_correct) (=> (= (ControlFlow 0 393547) 393609) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 392950) 393547)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 541008) 392950) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
