...
(declare-fun $t9@0 () T@$1_RegisteredCurrencies_RegisteredCurrencies)
...
(declare-fun $t8 () |T@$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'|)
(declare-fun $t8@0 () |T@$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 530042) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 381003) (- 0 530368)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (= (ControlFlow 0 381003) (- 0 530380)) (|$IsEqual'vec'vec'u8'''| (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| $t9@0) (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@0))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 380941) (- 0 530319)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (= (ControlFlow 0 380941) (- 0 530326)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 $t7@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 381017) 380941))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 381069) 381017) anon12_Then_correct) (=> (= (ControlFlow 0 381069) 381003) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= (ControlFlow 0 381067) 381069)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 380959) 381017) anon12_Then_correct) (=> (= (ControlFlow 0 380959) 381003) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (and (=> (= (ControlFlow 0 380945) 381067) anon11_Then_correct) (=> (= (ControlFlow 0 380945) 380959) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 380909) 380941))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.8904:20|
 :skolemid |264|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc))
 :qid |DiemConfigbpl.8912:20|
 :skolemid |265|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0))
))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180863| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 380893) 380945) anon10_Then_correct) (=> (= (ControlFlow 0 380893) 380909) anon10_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 380768) 380893)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 530042) 380768) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
