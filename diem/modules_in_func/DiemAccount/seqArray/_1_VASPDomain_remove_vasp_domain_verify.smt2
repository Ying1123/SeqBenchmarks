...
(declare-fun $t23@0 () T@$Mutation_474564)
(declare-fun $t22@1 () T@$Mutation_474524)
(declare-fun $t23@1 () T@$Mutation_474564)
(declare-fun $t21@@0 () |T@$1_Option_Option'address'|)
(declare-fun $t22@2 () T@$Mutation_474524)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0@@1 () T@$Memory_465642)
...
(declare-fun $t22 () T@$Mutation_474524)
(declare-fun $t17 () Int)
(declare-fun $t22@0 () T@$Mutation_474524)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_475586)
...
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_419582_| (|T@[$1_Event_EventHandle]Multiset_419582| T@$1_Event_EventHandle T@Multiset_419582) |T@[$1_Event_EventHandle]Multiset_419582|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_419582|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_419582)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|Store__T@[$1_Event_EventHandle]Multiset_419582_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_419582|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_419582)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|Store__T@[$1_Event_EventHandle]Multiset_419582_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_419582_| ?x0 ?y1))) :weight 0)))
...
(declare-fun $t34@0 () T@$Mutation_453628)
(declare-fun $t36@0 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun $t33@1 () T@$Mutation_519512)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 () T@$1_VASPDomain_VASPDomain)
(declare-fun $t33 () T@$Mutation_519512)
(declare-fun $t33@0 () T@$Mutation_519512)
...
(declare-fun $t24@2 () T@$Mutation_519451)
(declare-fun $t24@1@@0 () T@$Mutation_519451)
(declare-fun |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_436834)
...
(declare-fun $t31@0 () T@$Mutation_436834)
...
(declare-fun $t24@@1 () T@$Mutation_519451)
(declare-fun $t24@0@@0 () T@$Mutation_519451)
...
(declare-fun $t9@@3 () T@$Mutation_519451)
(declare-fun $t31 () T@$Mutation_436834)
(declare-fun $t34 () T@$Mutation_453628)
; Valid
(declare-fun $abort_flag@3 () Bool)
(declare-fun $t38 () (Seq T@$1_VASPDomain_VASPDomain))
(declare-fun $1_VASPDomain_VASPDomains_$memory@0@@0 () T@$Memory_475586)
(declare-fun _$t1@@4 () Int)
(declare-fun $t11@@3 () (Seq T@$1_VASPDomain_VASPDomain))
...
(declare-fun $t14@@3 () T@$1_VASPDomain_VASPDomainEvent)
...
(declare-fun $t35@0 () T@$Mutation_453628)
(declare-fun $t37@0 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun $t34@1 () T@$Mutation_519512)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 () T@$1_VASPDomain_VASPDomain)
(declare-fun $t34@@0 () T@$Mutation_519512)
(declare-fun $t34@0@@0 () T@$Mutation_519512)
(declare-fun $abort_flag@2@@0 () Bool)
(declare-fun $abort_code@3@@0 () Int)
(declare-fun $t24@2@@0 () T@$Mutation_519451)
(declare-fun $t24@1@@1 () T@$Mutation_519451)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| () T@$Mutation_436834)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@0| () T@$Mutation_436834)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_436834)
(declare-fun $t31@0@@0 () T@$Mutation_436834)
...
(declare-fun $t26@0@@1 () (Seq T@$1_VASPDomain_VASPDomain))
...
(declare-fun $t24@@2 () T@$Mutation_519451)
(declare-fun $t24@0@@1 () T@$Mutation_519451)
...
(declare-fun $t7@@2 () T@$Mutation_519451)
(declare-fun $t31@@0 () T@$Mutation_436834)
(declare-fun $t35 () T@$Mutation_453628)
(push 1)
(set-info :boogie-vc-id $1_VASPDomain_remove_vasp_domain$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2048421) (let ((anon46_Else_correct  (=> (and (not $abort_flag@3) (= $t38 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory@0@@0) _$t1@@4)))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051404)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051415)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051425)) (not (not (exists ((i@@87 Int) ) (!  (and (and (|$IsValid'u64'| i@@87) (and (>= i@@87 0) (< i@@87 (seq.len $t11@@3)))) (= (seq.nth $t11@@3 i@@87) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
))))) (=> (not (not (exists ((i@@88 Int) ) (!  (and (and (|$IsValid'u64'| i@@88) (and (>= i@@88 0) (< i@@88 (seq.len $t11@@3)))) (= (seq.nth $t11@@3 i@@88) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
)))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051439)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051451)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) 1))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051469)) (not (not (= (|$addr#$signer| _$t0@@5) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@5) 186537453))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051483)) (not (> (seq.len _$t2@@2) 63))) (=> (not (> (seq.len _$t2@@2) 63)) (and (=> (= (ControlFlow 0 1106530) (- 0 2051495)) (not (exists ((i@@89 Int) ) (!  (and (and (|$IsValid'u64'| i@@89) (and (>= i@@89 0) (< i@@89 (seq.len $t38)))) (= (seq.nth $t38 i@@89) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
)))) (=> (not (exists ((i@@90 Int) ) (!  (and (and (|$IsValid'u64'| i@@90) (and (>= i@@90 0) (< i@@90 (seq.len $t38)))) (= (seq.nth $t38 i@@90) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
))) (and (=> (= (ControlFlow 0 1106530) (- 0 2051507)) (let ((actual@@2 ($EventStore (- (|counter#$EventStore| $es@0@@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@0) (|streams#$EventStore| $es)))))
(let ((expected@@2 (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_419582| stream@@10)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@10) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3))))
(Multiset_419582 (|Store__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@10) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3 stream_new@@3))))))
 (and (<= (|counter#$EventStore| expected@@2) (|counter#$EventStore| actual@@2)) (forall ((handle@@10 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@2) handle@@10)) (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@2) handle@@10))) (forall ((v@@63 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@2) handle@@10)) v@@63) (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@2) handle@@10)) v@@63))
 :qid |DiemAccountbpl.139:13|
 :skolemid |3|
)))
 :qid |DiemAccountbpl.3680:13|
 :skolemid |103|
...
(let ((expected@@3 (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_419582| stream@@11)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@11) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3))))
(Multiset_419582 (|Store__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@11) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3 stream_new@@4))))))
 (and (<= (|counter#$EventStore| expected@@3) (|counter#$EventStore| actual@@3)) (forall ((handle@@11 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@3) handle@@11)) (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@3) handle@@11))) (forall ((v@@64 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@3) handle@@11)) v@@64) (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@3) handle@@11)) v@@64))
 :qid |DiemAccountbpl.139:13|
 :skolemid |3|
)))
 :qid |DiemAccountbpl.3680:13|
 :skolemid |103|
))))) (=> (= (ControlFlow 0 1106530) (- 0 2051532)) (let ((actual@@4 ($EventStore (- (|counter#$EventStore| $es@0@@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@0) (|streams#$EventStore| $es)))))
(let ((expected@@4 (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_419582| stream@@12)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@12) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3))))
(Multiset_419582 (|Store__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@12) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14@@3) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $EmptyEventStore) $t13@@3 stream_new@@5))))))
 (and (<= (|counter#$EventStore| actual@@4) (|counter#$EventStore| expected@@4)) (forall ((handle@@12 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@4) handle@@12)) (|l#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@4) handle@@12))) (forall ((v@@65 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| actual@@4) handle@@12)) v@@65) (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| expected@@4) handle@@12)) v@@65))
 :qid |DiemAccountbpl.139:13|
 :skolemid |3|
)))
 :qid |DiemAccountbpl.3680:13|
...
(let ((L7_correct@@1  (and (=> (= (ControlFlow 0 1104888) (- 0 2051192)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (not (exists ((i@@91 Int) ) (!  (and (and (|$IsValid'u64'| i@@91) (and (>= i@@91 0) (< i@@91 (seq.len $t11@@3)))) (= (seq.nth $t11@@3 i@@91) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453))) (> (seq.len _$t2@@2) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (not (exists ((i@@92 Int) ) (!  (and (and (|$IsValid'u64'| i@@92) (and (>= i@@92 0) (< i@@92 (seq.len $t11@@3)))) (= (seq.nth $t11@@3 i@@92) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453))) (> (seq.len _$t2@@2) 63)) (=> (= (ControlFlow 0 1104888) (- 0 2051260)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)) (= 5 $t17@0@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $t17@0@@1))) (and (not (exists ((i@@93 Int) ) (!  (and (and (|$IsValid'u64'| i@@93) (and (>= i@@93 0) (< i@@93 (seq.len $t11@@3)))) (= (seq.nth $t11@@3 i@@93) ($1_VASPDomain_VASPDomain _$t2@@2)))
 :qid |DiemAccountbpl.1860:13|
 :skolemid |52|
))) (= 7 $t17@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) (= 5 $t17@0@@1))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t12@@4)) 1)) (= 3 $t17@0@@1))) (and (not (= (|$addr#$signer| _$t0@@5) 186537453)) (= 2 $t17@0@@1))) (and (> (seq.len _$t2@@2) 63) (= 7 $t17@0@@1))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0@@1 $abort_code@4) (= (ControlFlow 0 1106544) 1104888))) L7_correct@@1)))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct@@0|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0| (|v#$Mutation_453628| $t35@0)) (= $es@0@@0 (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0|)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_419582| stream@@13)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@13) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t37@0))))
(Multiset_419582 (|Store__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@13) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t37@0) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0| stream_new@@6)))))) (and (=> (= (ControlFlow 0 1106340) 1106544) anon46_Then_correct) (=> (= (ControlFlow 0 1106340) 1106530) anon46_Else_correct)))))
(let ((anon45_Else_correct@@0  (=> (and (and (not $abort_flag@3) (= $t35@0 ($Mutation_453628 (|l#$Mutation_519512| $t34@1) (seq.++ (|p#$Mutation_519512| $t34@1) (seq.unit 0)) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_519512| $t34@1))))) (and (= $t37@0 ($1_VASPDomain_VASPDomainEvent true inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 _$t1@@4)) (= (ControlFlow 0 1106346) 1106340))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct@@0|)))
(let ((anon45_Then_correct@@0  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0@@1 $abort_code@4) (= (ControlFlow 0 1106558) 1104888))) L7_correct@@1)))
(let ((anon44_Then$1_correct  (=> (= $t34@1 $t34@@0) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1106610) 1106558) anon45_Then_correct@@0) (=> (= (ControlFlow 0 1106610) 1106346) anon45_Else_correct@@0))))))
(let ((anon44_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 1106608) 1106610)) anon44_Then$1_correct)))
(let ((anon44_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (=> (and (and (= $t34@0@@0 ($Mutation_519512 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (= $t34@1 $t34@0@@0)) (and (= $abort_flag@3 $abort_flag@2@@0) (= $abort_code@4 $abort_code@3@@0))) (and (=> (= (ControlFlow 0 1106231) 1106558) anon45_Then_correct@@0) (=> (= (ControlFlow 0 1106231) 1106346) anon45_Else_correct@@0))))))
(let ((anon43_Else_correct@@0  (=> (and (not $abort_flag@2@@0) (= $t24@2@@0 ($Mutation_519451 (|l#$Mutation_519451| $t24@1@@1) (|p#$Mutation_519451| $t24@1@@1) ($1_VASPDomain_VASPDomains (|v#$Mutation_436834| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2|))))) (and (=> (= (ControlFlow 0 1106209) (- 0 2050754)) (let (($range_0@@20 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_1@@20 Int) ) (!  (=> ($InRange $range_0@@20 $i_1@@20) (let ((i@@94 $i_1@@20))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) i@@94))) 63)))
 :qid |DiemAccountbpl.19682:107|
 :skolemid |422|
)))) (=> (let (($range_0@@21 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_1@@21 Int) ) (!  (=> ($InRange $range_0@@21 $i_1@@21) (let ((i@@95 $i_1@@21))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) i@@95))) 63)))
 :qid |DiemAccountbpl.19682:107|
 :skolemid |422|
))) (and (=> (= (ControlFlow 0 1106209) (- 0 2050802)) (let (($range_0@@22 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_1@@22 Int) ) (!  (=> ($InRange $range_0@@22 $i_1@@22) (let ((i@@96 $i_1@@22))
(let (($range_2@@3 ($Range (+ i@@96 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_3@@3 Int) ) (!  (=> ($InRange $range_2@@3 $i_3@@3) (let ((j@@20 $i_3@@3))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) i@@96) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) j@@20)))))
 :qid |DiemAccountbpl.19690:112|
 :skolemid |423|
)))))
 :qid |DiemAccountbpl.19689:107|
 :skolemid |424|
)))) (=> (let (($range_0@@23 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_1@@23 Int) ) (!  (=> ($InRange $range_0@@23 $i_1@@23) (let ((i@@97 $i_1@@23))
(let (($range_2@@4 ($Range (+ i@@97 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))))
(forall (($i_3@@4 Int) ) (!  (=> ($InRange $range_2@@4 $i_3@@4) (let ((j@@21 $i_3@@4))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) i@@97) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0)) j@@21)))))
 :qid |DiemAccountbpl.19690:112|
 :skolemid |423|
)))))
 :qid |DiemAccountbpl.19689:107|
 :skolemid |424|
))) (and (=> (= (ControlFlow 0 1106209) (- 0 2050887)) (let (($range_0@@24 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))
(forall (($i_1@@24 Int) ) (!  (=> (and (>= $i_1@@24 0) (< $i_1@@24 (seq.len $range_0@@24))) (let (($elem@@4 (seq.nth $range_0@@24 $i_1@@24)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@4)) 63)))
 :qid |DiemAccountbpl.19697:88|
 :skolemid |425|
)))) (=> (let (($range_0@@25 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@2@@0))))
(forall (($i_1@@25 Int) ) (!  (=> (and (>= $i_1@@25 0) (< $i_1@@25 (seq.len $range_0@@25))) (let (($elem@@5 (seq.nth $range_0@@25 $i_1@@25)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@5)) 63)))
 :qid |DiemAccountbpl.19697:88|
 :skolemid |425|
))) (=> (= $1_VASPDomain_VASPDomains_$memory@0@@0 ($Memory_475586 (|Store__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_519451| $t24@2@@0)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_519451| $t24@2@@0)) (|v#$Mutation_519451| $t24@2@@0)))) (and (=> (= (ControlFlow 0 1106209) (- 0 2050945)) (forall ((addr@@201 Int) ) (!  (=> (|$IsValid'address'| addr@@201) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory@0@@0) addr@@201)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@201) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@201)) 5))))
 :qid |DiemAccountbpl.19709:15|
 :skolemid |426|
))) (=> (forall ((addr@@202 Int) ) (!  (=> (|$IsValid'address'| addr@@202) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory@0@@0) addr@@202)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@202)) 5))))
 :qid |DiemAccountbpl.19709:15|
 :skolemid |426|
)) (=> (|$IsValid'address'| 186537453) (and (=> (= (ControlFlow 0 1106209) 1106608) anon44_Then_correct@@0) (=> (= (ControlFlow 0 1106209) 1106231) anon44_Else_correct@@0)))))))))))))))
(let ((anon43_Then_correct@@0  (=> (and (and $abort_flag@2@@0 (= $abort_code@3@@0 $abort_code@3@@0)) (and (= $t17@0@@1 $abort_code@3@@0) (= (ControlFlow 0 1106624) 1104888))) L7_correct@@1)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|  (=> (= $abort_code@3@@0 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2@@0 true) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@0|)) (and (=> (= (ControlFlow 0 1105954) 1106624) anon43_Then_correct@@0) (=> (= (ControlFlow 0 1105954) 1106209) anon43_Else_correct@@0))))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (and (not (and (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0) (< |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|)))) (= (ControlFlow 0 1105952) 1105954)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (and (and (and (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0) (< |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|))) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$e@1| (seq.nth |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|))) (and (and (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_436834 (|l#$Mutation_436834| $t31@0@@0) (|p#$Mutation_436834| $t31@0@@0) (seq.++ (seq.extract |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| 0 (- |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (seq.extract |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (+ |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 1) (- (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) (+ |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 1)))))) (= $abort_code@3@@0 $abort_code@2@@0)) (and (= $abort_flag@2@@0 $abort_flag@1@@0) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1|)))) (and (=> (= (ControlFlow 0 1105902) 1106624) anon43_Then_correct@@0) (=> (= (ControlFlow 0 1105902) 1106209) anon43_Else_correct@@0)))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (|v#$Mutation_436834| $t31@0@@0)) (and (=> (= (ControlFlow 0 1105878) 1105952) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1105878) 1105902) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((anon42_Then_correct@@0  (=> |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| (=> (and (= $t31@0@@0 ($Mutation_436834 (|l#$Mutation_519451| $t24@1@@1) (seq.++ (|p#$Mutation_519451| $t24@1@@1) (seq.unit 0)) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)))) (= (ControlFlow 0 1105962) 1105878)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((anon42_Else_correct@@0  (=> (not |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|) (and (=> (= (ControlFlow 0 1105767) (- 0 2050418)) (let (($range_0@@26 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_1@@26 Int) ) (!  (=> ($InRange $range_0@@26 $i_1@@26) (let ((i@@98 $i_1@@26))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) i@@98))) 63)))
 :qid |DiemAccountbpl.19614:107|
 :skolemid |418|
)))) (=> (let (($range_0@@27 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_1@@27 Int) ) (!  (=> ($InRange $range_0@@27 $i_1@@27) (let ((i@@99 $i_1@@27))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) i@@99))) 63)))
 :qid |DiemAccountbpl.19614:107|
 :skolemid |418|
))) (and (=> (= (ControlFlow 0 1105767) (- 0 2050466)) (let (($range_0@@28 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_1@@28 Int) ) (!  (=> ($InRange $range_0@@28 $i_1@@28) (let ((i@@100 $i_1@@28))
(let (($range_2@@5 ($Range (+ i@@100 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_3@@5 Int) ) (!  (=> ($InRange $range_2@@5 $i_3@@5) (let ((j@@22 $i_3@@5))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) i@@100) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) j@@22)))))
 :qid |DiemAccountbpl.19622:112|
 :skolemid |419|
)))))
 :qid |DiemAccountbpl.19621:107|
 :skolemid |420|
)))) (=> (let (($range_0@@29 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_1@@29 Int) ) (!  (=> ($InRange $range_0@@29 $i_1@@29) (let ((i@@101 $i_1@@29))
(let (($range_2@@6 ($Range (+ i@@101 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))))
(forall (($i_3@@6 Int) ) (!  (=> ($InRange $range_2@@6 $i_3@@6) (let ((j@@23 $i_3@@6))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) i@@101) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1)) j@@23)))))
 :qid |DiemAccountbpl.19622:112|
 :skolemid |419|
)))))
 :qid |DiemAccountbpl.19621:107|
 :skolemid |420|
))) (and (=> (= (ControlFlow 0 1105767) (- 0 2050551)) (let (($range_0@@30 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))
(forall (($i_1@@30 Int) ) (!  (=> (and (>= $i_1@@30 0) (< $i_1@@30 (seq.len $range_0@@30))) (let (($elem@@6 (seq.nth $range_0@@30 $i_1@@30)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@6)) 63)))
 :qid |DiemAccountbpl.19629:88|
 :skolemid |421|
)))) (=> (let (($range_0@@31 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))))
(forall (($i_1@@31 Int) ) (!  (=> (and (>= $i_1@@31 0) (< $i_1@@31 (seq.len $range_0@@31))) (let (($elem@@7 (seq.nth $range_0@@31 $i_1@@31)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@7)) 63)))
 :qid |DiemAccountbpl.19629:88|
 :skolemid |421|
))) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t30@@0)) (=> (and (and (= $t30@@0 7) (= $t30@@0 $t30@@0)) (and (= $t17@0@@1 $t30@@0) (= (ControlFlow 0 1105767) 1104888))) L7_correct@@1)))))))))))
(let ((anon41_Else_correct@@0  (=> (not $abort_flag@1@@0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 1105557) 1105962) anon42_Then_correct@@0) (=> (= (ControlFlow 0 1105557) 1105767) anon42_Else_correct@@0))))))
(let ((anon41_Then_correct@@0  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t17@0@@1 $abort_code@2@@0) (= (ControlFlow 0 1106638) 1104888))) L7_correct@@1)))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 1105517) 1106638) anon41_Then_correct@@0) (=> (= (ControlFlow 0 1105517) 1105557) anon41_Else_correct@@0))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 1105527) 1106638) anon41_Then_correct@@0) (=> (= (ControlFlow 0 1105527) 1105557) anon41_Else_correct@@0))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| (|$IndexOfVec'$1_VASPDomain_VASPDomain'| $t26@0@@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0)) (and (=> (= (ControlFlow 0 1105505) 1105527) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1105505) 1105517) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((anon40_Else_correct@@0  (=> (and (and (not $abort_flag@1@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0)) (and (= $t26@0@@1 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_519451| $t24@1@@1))) (= (ControlFlow 0 1105535) 1105505))) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon40_Then_correct@@0  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t17@0@@1 $abort_code@2@@0) (= (ControlFlow 0 1106652) 1104888))) L7_correct@@1)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0  (=> (= $abort_flag@1@@0 true) (=> (and (= $abort_code@2@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0@@0)) (and (=> (= (ControlFlow 0 1105368) 1106652) anon40_Then_correct@@0) (=> (= (ControlFlow 0 1105368) 1105535) anon40_Else_correct@@0))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct@@0  (=> (and (and (not inline$$Le$0$dst@1@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= (ControlFlow 0 1105362) 1105368))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct@@0  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0 $abort_code@1@@5) (= (ControlFlow 0 1105400) 1105368))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct@@0  (=> (and inline$$Le$0$dst@1@@0 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0 ($1_VASPDomain_VASPDomain _$t2@@2))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0) (= $abort_flag@1@@0 $abort_flag@0@@5)) (and (= $abort_code@2@@0 $abort_code@1@@5) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0))) (and (=> (= (ControlFlow 0 1105386) 1106652) anon40_Then_correct@@0) (=> (= (ControlFlow 0 1105386) 1105535) anon40_Else_correct@@0))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct@@0  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= inline$$Le$0$dst@1@@0 inline$$Le$0$dst@1@@0))) (and (=> (= (ControlFlow 0 1105346) 1105386) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct@@0) (=> (= (ControlFlow 0 1105346) 1105362) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct@@0))))))
(let ((inline$$Le$0$anon0_correct@@0  (=> (and (= inline$$Le$0$dst@1@@0 (<= |inline$$1_Vector_length'u8'$0$l@1@@0| 63)) (= (ControlFlow 0 1105310) 1105346)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct@@0  (=> (not $abort_flag@0@@5) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 1105316) 1105310)) inline$$Le$0$anon0_correct@@0))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@0| (seq.len _$t2@@2)) (and (=> (= (ControlFlow 0 1105250) 1105400) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct@@0) (=> (= (ControlFlow 0 1105250) 1105316) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct@@0)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct@@0  (=> (and (= _$t2@@2 _$t2@@2) (= (ControlFlow 0 1105256) 1105250)) |inline$$1_Vector_length'u8'$0$anon0_correct@@0|)))
(let ((anon39_Else_correct@@0  (=> (and (and (not $abort_flag@0@@5) (= |$temp_0'$1_VASPDomain_VASPDomains'@0@@0| (|v#$Mutation_519451| $t24@1@@1))) (and (= |$temp_0'$1_VASPDomain_VASPDomains'@0@@0| |$temp_0'$1_VASPDomain_VASPDomains'@0@@0|) (= (ControlFlow 0 1105406) 1105256))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct@@0)))
(let ((anon39_Then_correct@@0  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t17@0@@1 $abort_code@1@@5) (= (ControlFlow 0 1106666) 1104888))) L7_correct@@1)))
(let ((anon38_Then$1_correct  (=> (= $t24@1@@1 $t24@@2) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1106718) 1106666) anon39_Then_correct@@0) (=> (= (ControlFlow 0 1106718) 1105406) anon39_Else_correct@@0))))))
(let ((anon38_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)) (= (ControlFlow 0 1106716) 1106718)) anon38_Then$1_correct)))
(let ((anon38_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4) (=> (and (and (= $t24@0@@1 ($Mutation_519451 ($Global _$t1@@4) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4))) (= $t24@1@@1 $t24@0@@1)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 1104972) 1106666) anon39_Then_correct@@0) (=> (= (ControlFlow 0 1104972) 1105406) anon39_Else_correct@@0))))))
(let ((anon37_Then_correct@@0  (=> $t21@0@@0 (and (=> (= (ControlFlow 0 1104950) 1106716) anon38_Then_correct@@0) (=> (= (ControlFlow 0 1104950) 1104972) anon38_Else_correct@@0)))))
(let ((anon37_Else_correct@@0  (=> (and (and (not $t21@0@@0) (= $t23@@2 $t23@@2)) (and (= $t17@0@@1 $t23@@2) (= (ControlFlow 0 1104946) 1104888))) L7_correct@@1)))
(let ((anon36_Then_correct@@0  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 (=> (and (= $t21@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| $t23@@2) (= $t23@@2 5)) (and (= $t23@@2 $t23@@2) (= $t21@0@@0 $t21@0@@0))) (and (=> (= (ControlFlow 0 1104930) 1104950) anon37_Then_correct@@0) (=> (= (ControlFlow 0 1104930) 1104946) anon37_Else_correct@@0)))))))
(let ((anon36_Else_correct@@0  (=> (and (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0) (= $t20@@2 $t20@@2)) (and (= $t17@0@@1 $t20@@2) (= (ControlFlow 0 1104672) 1104888))) L7_correct@@1)))
(let ((anon35_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t20@@2) (= $t20@@2 5)) (and (= $t20@@2 $t20@@2) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 1104656) 1104930) anon36_Then_correct@@0) (=> (= (ControlFlow 0 1104656) 1104672) anon36_Else_correct@@0))))))
(let ((anon34_Then_correct@@0  (=> $t16@@1 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t15@@2)) (= 5 $t17@@1)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t15@@2)) 1)) (= 3 $t17@@1))) (and (not (= (|$addr#$signer| _$t0@@5) 186537453)) (= 2 $t17@@1))) (= $t17@@1 $t17@@1)) (and (= $t17@0@@1 $t17@@1) (= (ControlFlow 0 1106804) 1104888))) L7_correct@@1))))
(let ((anon35_Then_correct@@0 true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct@@0  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 1104614) 1106732) anon35_Then_correct@@0) (=> (= (ControlFlow 0 1104614) 1104656) anon35_Else_correct@@0))))))
(let ((anon34_Else_correct@@0  (=> (and (not $t16@@1) (= (ControlFlow 0 1104620) 1104614)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct@@0)))
(let ((anon0$1_correct@@5  (=> (and (and (forall ((addr@@203 Int) ) (!  (=> (|$IsValid'address'| addr@@203) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@203) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@203)) 0)) (= addr@@203 173345816)))
 :qid |DiemAccountbpl.19256:20|
 :skolemid |385|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_459802| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@204 Int) ) (!  (=> (|$IsValid'address'| addr@@204) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@204)) 1)) (= addr@@204 186537453)))
 :qid |DiemAccountbpl.19264:20|
 :skolemid |386|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_459802| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@205 Int) ) (!  (=> (|$IsValid'address'| addr@@205) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@205)) 2))))))
 :qid |DiemAccountbpl.19272:20|
 :skolemid |387|
)) (forall ((addr@@206 Int) ) (!  (=> (|$IsValid'address'| addr@@206) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@206)) 2))))))
 :qid |DiemAccountbpl.19276:20|
 :skolemid |388|
))) (and (forall ((addr@@207 Int) ) (!  (=> (|$IsValid'address'| addr@@207) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@207)) 2))))))
 :qid |DiemAccountbpl.19280:20|
 :skolemid |389|
)) (forall ((addr@@208 Int) ) (!  (=> (|$IsValid'address'| addr@@208) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@208)) 2))))))
 :qid |DiemAccountbpl.19284:20|
 :skolemid |390|
)))) (and (and (forall ((addr@@209 Int) ) (!  (=> (|$IsValid'address'| addr@@209) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@209)) 2)))))
 :qid |DiemAccountbpl.19288:20|
 :skolemid |391|
)) (forall ((addr@@210 Int) ) (!  (=> (|$IsValid'address'| addr@@210) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@210)) 2)))))
 :qid |DiemAccountbpl.19292:20|
 :skolemid |392|
))) (and (forall ((addr@@211 Int) ) (!  (=> (|$IsValid'address'| addr@@211) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@211)) 2)))))
 :qid |DiemAccountbpl.19296:20|
 :skolemid |393|
)) (forall ((addr@@212 Int) ) (!  (=> (|$IsValid'address'| addr@@212) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_466037| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@212) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@212) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@212)) 4))))
 :qid |DiemAccountbpl.19300:20|
 :skolemid |394|
))))) (=> (and (and (and (and (forall ((addr@@213 Int) ) (!  (=> (|$IsValid'address'| addr@@213) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@213) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@213) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@213)) 3))))
 :qid |DiemAccountbpl.19304:20|
 :skolemid |395|
)) (forall ((addr@@214 Int) ) (!  (=> (|$IsValid'address'| addr@@214) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@214) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@214) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@214)) 3))))
 :qid |DiemAccountbpl.19308:20|
 :skolemid |396|
))) (and (forall ((addr@@215 Int) ) (!  (=> (|$IsValid'address'| addr@@215) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@215) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@215)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@215) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@215)) 3))))
 :qid |DiemAccountbpl.19312:20|
 :skolemid |397|
)) (let (($range_0@@32 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@216 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@216))))))))
(forall (($i_1@@32 Int) ) (!  (=> ($InRange $range_0@@32 $i_1@@32) (let ((i1@@2 $i_1@@32))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@217 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@217)))) i1@@2))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@217 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@217)))) i1@@2)))) 3))))
 :qid |DiemAccountbpl.19316:151|
 :skolemid |398|
))))) (and (and (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_466374| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |DiemAccountbpl.19321:20|
 :skolemid |399|
)) (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475401| $1_DiemAccount_DiemAccount_$memory) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@218)))
 :qid |DiemAccountbpl.19325:20|
 :skolemid |400|
))) (and (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) addr@@219)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@219) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@219)) 1))))
 :qid |DiemAccountbpl.19329:20|
 :skolemid |401|
)) (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) addr@@220)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@220) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@220)) 5))))
 :qid |DiemAccountbpl.19333:20|
 :skolemid |402|
))))) (and (and (and (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_466489| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_466549| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@221)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@221)) 2)))))
 :qid |DiemAccountbpl.19337:20|
 :skolemid |403|
)) (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475720| $1_DesignatedDealer_Dealer_$memory) addr@@222)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@222) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@222)) 2))))
 :qid |DiemAccountbpl.19341:20|
 :skolemid |404|
))) (and (forall ((addr@@223 Int) ) (!  (=> (|$IsValid'address'| addr@@223) (= (|Select__T@[Int]Bool_| (|domain#$Memory_466374| $1_DualAttestation_Credential_$memory) addr@@223)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@223) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@223)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@223) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@223)) 5)))))
 :qid |DiemAccountbpl.19345:20|
 :skolemid |405|
)) (forall ((addr@@224 Int) ) (!  (=> (|$IsValid'address'| addr@@224) (= (|Select__T@[Int]Bool_| (|domain#$Memory_460691| $1_SlidingNonce_SlidingNonce_$memory) addr@@224)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@224) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@224)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@224) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@224)) 1)))))
 :qid |DiemAccountbpl.19349:20|
 :skolemid |406|
)))) (and (and (forall ((addr@@225 Int) ) (!  (=> (|$IsValid'address'| addr@@225) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@225)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@225) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@225)) 3))))
 :qid |DiemAccountbpl.19353:20|
 :skolemid |407|
)) (forall ((addr@@226 Int) ) (!  (=> (|$IsValid'address'| addr@@226) (= (|Select__T@[Int]Bool_| (|domain#$Memory_466037| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@226)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@226) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@226)) 4))))
 :qid |DiemAccountbpl.19357:20|
 :skolemid |408|
))) (and (forall ((addr@@227 Int) ) (!  (=> (|$IsValid'address'| addr@@227) (= (|Select__T@[Int]Bool_| (|domain#$Memory_475975| $1_VASP_ParentVASP_$memory) addr@@227)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@227) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@227)) 5))))
 :qid |DiemAccountbpl.19361:20|
 :skolemid |409|
)) (forall ((addr@@228 Int) ) (!  (=> (|$IsValid'address'| addr@@228) (= (|Select__T@[Int]Bool_| (|domain#$Memory_476075| $1_VASP_ChildVASP_$memory) addr@@228)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@228) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@228)) 6))))
 :qid |DiemAccountbpl.19365:20|
 :skolemid |410|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@5)) ($1_Signer_is_txn_signer _$t0@@5)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@5))) (and (|$IsValid'address'| _$t1@@4) (|$IsValid'vec'u8''| _$t2@@2))) (and (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $a_0@@10)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@10))
 :qid |DiemAccountbpl.19377:20|
 :skolemid |411|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $a_0@@10))
)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@11)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@11))
 :qid |DiemAccountbpl.19381:20|
 :skolemid |412|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@11))
))) (and (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) $a_0@@12)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@12) (and (and (let (($range_1@@0 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12)))))
(forall (($i_2@@0 Int) ) (!  (=> ($InRange $range_1@@0 $i_2@@0) (let ((i@@102 $i_2@@0))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12) i@@102))) 63)))
 :qid |DiemAccountbpl.19386:140|
 :skolemid |413|
))) (let (($range_3@@0 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12)))))
(forall (($i_4@@0 Int) ) (!  (=> ($InRange $range_3@@0 $i_4@@0) (let ((i@@103 $i_4@@0))
(let (($range_5@@0 ($Range (+ i@@103 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12)))))
(forall (($i_6@@0 Int) ) (!  (=> ($InRange $range_5@@0 $i_6@@0) (let ((j@@24 $i_6@@0))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12) i@@103) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12) j@@24)))))
 :qid |DiemAccountbpl.19388:98|
 :skolemid |414|
)))))
 :qid |DiemAccountbpl.19387:202|
 :skolemid |415|
)))) (let (($range_7@@0 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@12)))
(forall (($i_8@@0 Int) ) (!  (=> (and (>= $i_8@@0 0) (< $i_8@@0 (seq.len $range_7@@0))) (let (($elem@@8 (seq.nth $range_7@@0 $i_8@@0)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@8)) 63)))
 :qid |DiemAccountbpl.19389:229|
 :skolemid |416|
))))))
 :qid |DiemAccountbpl.19385:20|
 :skolemid |417|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) $a_0@@12))
)) (= $t11@@3 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_475586| $1_VASPDomain_VASPDomains_$memory) _$t1@@4)))))) (and (and (and (= $t12@@4 (|$addr#$signer| _$t0@@5)) (= $t13@@3 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_475501| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t14@@3 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2@@2) _$t1@@4)) (= _$t0@@5 _$t0@@5))) (and (and (= _$t1@@4 _$t1@@4) (= _$t2@@2 _$t2@@2)) (and (= $t15@@2 (|$addr#$signer| _$t0@@5)) (= $t16@@1  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) $t15@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) $t15@@2)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453)))))))) (and (=> (= (ControlFlow 0 1104527) 1106804) anon34_Then_correct@@0) (=> (= (ControlFlow 0 1104527) 1104620) anon34_Else_correct@@0))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_419582| stream@@14) 0) (forall ((v@@66 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@14) v@@66) 0)
 :qid |DiemAccountbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemAccountbpl.3664:13|
 :skolemid |102|
))) (= (ControlFlow 0 1103447) 1104527)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (and (= (seq.len (|p#$Mutation_519451| $t7@@2)) 0) (= (seq.len (|p#$Mutation_519451| $t24@@2)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_436834| $t31@@0)) 0) (= (seq.len (|p#$Mutation_519512| $t34@@0)) 0)) (and (= (seq.len (|p#$Mutation_453628| $t35)) 0) (= (ControlFlow 0 1103457) 1103447))) inline$$InitEventStore$0$anon0_correct@@5))))
(let ((PreconditionGeneratedEntry_correct@@4  (=> (= (ControlFlow 0 2048421) 1103457) anon0_correct@@5)))
