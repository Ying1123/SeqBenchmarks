...
(declare-fun inline$$1_BitVector_new$0$$t5@2 () T@Vec_92615)
...
(declare-fun inline$$1_BitVector_new$0$$t5@1 () T@Vec_92615)
...
(declare-fun |inline$$1_Vector_push_back'bool'$0$m'@1| () T@$Mutation_456873)
(declare-fun inline$$1_BitVector_new$0$$t21@2 () T@$Mutation_456873)
(declare-fun MapConstVec_18066 (Int) |T@[Int]Int|)
(declare-fun DefaultVecElem_18066 () Int)
(declare-fun |inline$$1_Vector_empty'bool'$0$v@1| () T@Vec_92615)
(declare-fun inline$$1_BitVector_new$0$$t19@1 () Int)
(declare-fun inline$$1_BitVector_new$0$$t20@1 () Int)
(declare-fun inline$$1_BitVector_new$0$$t21@1 () T@$Mutation_456873)
(declare-fun MapConstVec_16957 (Bool) |T@[Int]Bool|)
(declare-fun DefaultVecElem_16957 () Bool)
...
(declare-fun inline$$1_BitVector_new$0$$t21@0 () T@$Mutation_456873)
...
(declare-fun $t4@1 () T@$1_DiemAccount_DiemAccount)
(declare-fun $t4 () T@$1_DiemAccount_DiemAccount)
(declare-fun $t3 () Int)
(declare-fun $t4@0 () T@$1_DiemAccount_DiemAccount)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_publish_crsn$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2567575) (let ((inline$$1_BitVector_new$0$anon25_Else_correct  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 1861203) (- 0 2569513)) (<= inline$$AddU64$0$dst@2 _$t1)) (=> (<= inline$$AddU64$0$dst@2 _$t1) (=> (= (ControlFlow 0 1861203) (- 0 2569520)) (= (|l#Vec_92615| inline$$1_BitVector_new$0$$t5@2) inline$$AddU64$0$dst@2)))))))
(let ((anon11_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 1861548) (- 0 2569363)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0))))))
 :qid |DiemAccountbpl.91507:15|
 :skolemid |3226|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0))))))
 :qid |DiemAccountbpl.91507:15|
 :skolemid |3226|
)) (and (=> (= (ControlFlow 0 1861548) (- 0 2569411)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)))) 0)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)))) 0))))
 :qid |DiemAccountbpl.91512:15|
 :skolemid |3227|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0))))
 :qid |DiemAccountbpl.91512:15|
 :skolemid |3227|
)) (=> (= (ControlFlow 0 1861548) (- 0 2569463)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))))
 :qid |DiemAccountbpl.91517:15|
 :skolemid |3228|
))))))))))
(let ((anon11_Then_correct true))
(let ((inline$$1_CRSN_publish$0$anon25_Else_correct  (=> (not $abort_flag@3) (=> (and (= $abort_flag@4 $abort_flag@3) (= $abort_code@5 $abort_code@4)) (and (=> (= (ControlFlow 0 1861301) 1861562) anon11_Then_correct) (=> (= (ControlFlow 0 1861301) 1861548) anon11_Else_correct))))))
(let ((inline$$1_CRSN_publish$0$L7_correct  (=> (and (= $abort_flag@4 true) (= $abort_code@5 inline$$1_CRSN_publish$0$$t11@1)) (and (=> (= (ControlFlow 0 1859606) 1861562) anon11_Then_correct) (=> (= (ControlFlow 0 1859606) 1861548) anon11_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon25_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@4) (= (ControlFlow 0 1861315) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon24_Then$1_correct  (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= $abort_flag@3 true)) (and (=> (= (ControlFlow 0 1861367) 1861315) inline$$1_CRSN_publish$0$anon25_Then_correct) (=> (= (ControlFlow 0 1861367) 1861301) inline$$1_CRSN_publish$0$anon25_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon24_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 1861365) 1861367)) inline$$1_CRSN_publish$0$anon24_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon24_Else_correct  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0))) (= $1_CRSN_CRSN_$memory@0 ($Memory_576150 (|Store__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0) inline$$1_CRSN_publish$0$$t24@1)))) (and (= $abort_code@4 $abort_code@3) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 1861291) 1861315) inline$$1_CRSN_publish$0$anon25_Then_correct) (=> (= (ControlFlow 0 1861291) 1861301) inline$$1_CRSN_publish$0$anon25_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon23_Else_correct  (=> (and (not $abort_flag@2) (= inline$$1_CRSN_publish$0$$t24@1 ($1_CRSN_CRSN $t6@0 _$t1 inline$$1_BitVector_new$0$$ret0))) (and (=> (= (ControlFlow 0 1861269) 1861365) inline$$1_CRSN_publish$0$anon24_Then_correct) (=> (= (ControlFlow 0 1861269) 1861291) inline$$1_CRSN_publish$0$anon24_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon23_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@3) (= (ControlFlow 0 1861381) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_BitVector_new$0$anon23_Else_correct  (=> (not inline$$Lt$1$dst@1) (and (=> (= (ControlFlow 0 1860919) (- 0 2568971)) (= inline$$1_BitVector_new$0$$t16@1 _$t1)) (=> (= inline$$1_BitVector_new$0$$t16@1 _$t1) (and (=> (= (ControlFlow 0 1860919) (- 0 2568978)) (= (|l#Vec_92615| inline$$1_BitVector_new$0$$t5@1) _$t1)) (=> (= (|l#Vec_92615| inline$$1_BitVector_new$0$$t5@1) _$t1) (=> (and (and (= inline$$1_BitVector_new$0$$t23@1 ($1_BitVector_BitVector _$t1 inline$$1_BitVector_new$0$$t5@1)) (= inline$$1_BitVector_new$0$$t23@1 inline$$1_BitVector_new$0$$t23@1)) (and (= $abort_flag@2 $abort_flag@0) (= $abort_code@3 $abort_code@1))) (and (=> (= (ControlFlow 0 1860919) 1861381) inline$$1_CRSN_publish$0$anon23_Then_correct) (=> (= (ControlFlow 0 1860919) 1861269) inline$$1_CRSN_publish$0$anon23_Else_correct))))))))))
(let ((inline$$1_BitVector_new$0$L10_correct  (=> (and (= $abort_flag@2 true) (= $abort_code@3 inline$$1_BitVector_new$0$$t11@1)) (and (=> (= (ControlFlow 0 1860591) 1861381) inline$$1_CRSN_publish$0$anon23_Then_correct) (=> (= (ControlFlow 0 1860591) 1861269) inline$$1_CRSN_publish$0$anon23_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon25_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@2) (= (ControlFlow 0 1861217) 1860591))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 1861163) 1861217) inline$$1_BitVector_new$0$anon25_Then_correct) (=> (= (ControlFlow 0 1861163) 1861203) inline$$1_BitVector_new$0$anon25_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ inline$$1_BitVector_new$0$$t16@1 1) $MAX_U64) (= (ControlFlow 0 1861161) 1861163)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ inline$$1_BitVector_new$0$$t16@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ inline$$1_BitVector_new$0$$t16@1 1)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 1861109) 1861217) inline$$1_BitVector_new$0$anon25_Then_correct) (=> (= (ControlFlow 0 1861109) 1861203) inline$$1_BitVector_new$0$anon25_Else_correct))))))
(let ((inline$$1_BitVector_new$0$anon24_Else_correct  (=> (not $abort_flag@0) (=> (and (= inline$$1_BitVector_new$0$$t5@2 (|v#$Mutation_456873| |inline$$1_Vector_push_back'bool'$0$m'@1|)) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 1861169) 1861161) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 1861169) 1861109) inline$$AddU64$0$anon3_Else_correct))))))
(let ((inline$$1_BitVector_new$0$anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@1) (= (ControlFlow 0 1861231) 1860591))) inline$$1_BitVector_new$0$L10_correct)))
(let ((|inline$$1_Vector_push_back'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'bool'$0$m'@1| ($Mutation_456873 (|l#$Mutation_456873| inline$$1_BitVector_new$0$$t21@2) (|p#$Mutation_456873| inline$$1_BitVector_new$0$$t21@2) (let ((l (|l#Vec_92615| (|v#$Mutation_456873| inline$$1_BitVector_new$0$$t21@2))))
(Vec_92615 (|Store__T@[Int]Bool_| (|v#Vec_92615| (|v#$Mutation_456873| inline$$1_BitVector_new$0$$t21@2)) l false) (+ l 1))))) (and (=> (= (ControlFlow 0 1860990) 1861231) inline$$1_BitVector_new$0$anon24_Then_correct) (=> (= (ControlFlow 0 1860990) 1861169) inline$$1_BitVector_new$0$anon24_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon23_Then_correct  (=> inline$$Lt$1$dst@1 (=> (and (= inline$$1_BitVector_new$0$$t21@2 ($Mutation_456873 ($Local 5) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) inline$$1_BitVector_new$0$$t5@1)) (= (ControlFlow 0 1860996) 1860990)) |inline$$1_Vector_push_back'bool'$0$anon0_correct|))))
(let ((inline$$1_BitVector_new$0$anon22_Else$1_correct  (and (=> (= (ControlFlow 0 1860875) 1860996) inline$$1_BitVector_new$0$anon23_Then_correct) (=> (= (ControlFlow 0 1860875) 1860919) inline$$1_BitVector_new$0$anon23_Else_correct))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$1_BitVector_new$0$$t16@1 _$t1)) (= (ControlFlow 0 1860865) 1860875)) inline$$1_BitVector_new$0$anon22_Else$1_correct)))
(let ((inline$$1_BitVector_new$0$anon22_Else_correct  (=> (and (not $abort_flag@0) (= |inline$$1_Vector_empty'bool'$0$v@1| |inline$$1_Vector_empty'bool'$0$v@1|)) (and (=> (= (ControlFlow 0 1860871) (- 0 2568842)) (<= 0 _$t1)) (=> (<= 0 _$t1) (and (=> (= (ControlFlow 0 1860871) (- 0 2568849)) (= (|l#Vec_92615| |inline$$1_Vector_empty'bool'$0$v@1|) 0)) (=> (= (|l#Vec_92615| |inline$$1_Vector_empty'bool'$0$v@1|) 0) (=> (|$IsValid'vec'bool''| inline$$1_BitVector_new$0$$t5@1) (=> (and (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t16@1) (|$IsValid'u64'| inline$$1_BitVector_new$0$$t19@1)) (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t20@1) (|$IsValid'vec'bool''| (|v#$Mutation_456873| inline$$1_BitVector_new$0$$t21@1)))) (and (and (not $abort_flag@0) (<= inline$$1_BitVector_new$0$$t16@1 _$t1)) (and (= (|l#Vec_92615| inline$$1_BitVector_new$0$$t5@1) inline$$1_BitVector_new$0$$t16@1) (= (ControlFlow 0 1860871) 1860865)))) inline$$Lt$1$anon0_correct)))))))))
(let ((inline$$1_BitVector_new$0$anon22_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@1) (= (ControlFlow 0 1861245) 1860591))) inline$$1_BitVector_new$0$L10_correct)))
(let ((|inline$$1_Vector_empty'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'bool'$0$v@1| (Vec_92615 (MapConstVec_16957 DefaultVecElem_16957) 0)) (and (=> (= (ControlFlow 0 1860731) 1861245) inline$$1_BitVector_new$0$anon22_Then_correct) (=> (= (ControlFlow 0 1860731) 1860871) inline$$1_BitVector_new$0$anon22_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon21_Then_correct  (=> (and (and inline$$Lt$0$dst@1 (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 1860737) 1860731))) |inline$$1_Vector_empty'bool'$0$anon0_correct|)))
(let ((inline$$1_BitVector_new$0$anon21_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= inline$$1_BitVector_new$0$$t15@0 inline$$1_BitVector_new$0$$t15@0)) (and (= inline$$1_BitVector_new$0$$t11@1 inline$$1_BitVector_new$0$$t15@0) (= (ControlFlow 0 1860693) 1860591))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$1_BitVector_new$0$anon20_Then$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t15@0) (= inline$$1_BitVector_new$0$$t15@0 7)) (and (= inline$$1_BitVector_new$0$$t15@0 inline$$1_BitVector_new$0$$t15@0) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 1860677) 1860737) inline$$1_BitVector_new$0$anon21_Then_correct) (=> (= (ControlFlow 0 1860677) 1860693) inline$$1_BitVector_new$0$anon21_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< _$t1 1024)) (= (ControlFlow 0 1860641) 1860677)) inline$$1_BitVector_new$0$anon20_Then$1_correct)))
(let ((inline$$1_BitVector_new$0$anon20_Then_correct  (=> inline$$Gt$1$dst@1 (=> (and (|$IsValid'u64'| 1024) (= (ControlFlow 0 1860647) 1860641)) inline$$Lt$0$anon0_correct))))
(let ((inline$$1_BitVector_new$0$anon20_Else_correct  (=> (and (and (not inline$$Gt$1$dst@1) (= inline$$1_BitVector_new$0$$t10@0 inline$$1_BitVector_new$0$$t10@0)) (and (= inline$$1_BitVector_new$0$$t11@1 inline$$1_BitVector_new$0$$t10@0) (= (ControlFlow 0 1860585) 1860591))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$1_BitVector_new$0$anon0$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t10@0) (= inline$$1_BitVector_new$0$$t10@0 7)) (and (= inline$$1_BitVector_new$0$$t10@0 inline$$1_BitVector_new$0$$t10@0) (= inline$$Gt$1$dst@1 inline$$Gt$1$dst@1))) (and (=> (= (ControlFlow 0 1860569) 1860647) inline$$1_BitVector_new$0$anon20_Then_correct) (=> (= (ControlFlow 0 1860569) 1860585) inline$$1_BitVector_new$0$anon20_Else_correct))))))
(let ((inline$$Gt$1$anon0_correct  (=> (and (= inline$$Gt$1$dst@1 (> _$t1 0)) (= (ControlFlow 0 1860533) 1860569)) inline$$1_BitVector_new$0$anon0$1_correct)))
(let ((inline$$1_BitVector_new$0$anon0_correct  (=> (and (and (= (|l#Vec_33444| (|p#$Mutation_456873| inline$$1_BitVector_new$0$$t21@0)) 0) (= _$t1 _$t1)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1860539) 1860533))) inline$$Gt$1$anon0_correct)))
(let ((inline$$1_CRSN_publish$0$anon22_Then_correct  (=> (and inline$$Le$0$dst@1 (= (ControlFlow 0 1861251) 1860539)) inline$$1_BitVector_new$0$anon0_correct)))
(let ((inline$$1_CRSN_publish$0$anon22_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_CRSN_publish$0$$t22@0 inline$$1_CRSN_publish$0$$t22@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t22@0) (= (ControlFlow 0 1859810) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon21_Then$1_correct  (=> (|$IsValid'u64'| 3) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t22@0) (= inline$$1_CRSN_publish$0$$t22@0 7)) (and (= inline$$1_CRSN_publish$0$$t22@0 inline$$1_CRSN_publish$0$$t22@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1859794) 1861251) inline$$1_CRSN_publish$0$anon22_Then_correct) (=> (= (ControlFlow 0 1859794) 1859810) inline$$1_CRSN_publish$0$anon22_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= _$t1 256)) (= (ControlFlow 0 1859758) 1859794)) inline$$1_CRSN_publish$0$anon21_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon21_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 1859764) 1859758)) inline$$Le$0$anon0_correct))))
(let ((inline$$1_CRSN_publish$0$anon21_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= inline$$1_CRSN_publish$0$$t18@0 inline$$1_CRSN_publish$0$$t18@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t18@0) (= (ControlFlow 0 1859708) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon20_Then$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t18@0) (= inline$$1_CRSN_publish$0$$t18@0 7)) (and (= inline$$1_CRSN_publish$0$$t18@0 inline$$1_CRSN_publish$0$$t18@0) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 1859692) 1859764) inline$$1_CRSN_publish$0$anon21_Then_correct) (=> (= (ControlFlow 0 1859692) 1859708) inline$$1_CRSN_publish$0$anon21_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> _$t1 0)) (= (ControlFlow 0 1859656) 1859692)) inline$$1_CRSN_publish$0$anon20_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon20_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1859662) 1859656)) inline$$Gt$0$anon0_correct))))
(let ((inline$$1_CRSN_publish$0$anon20_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= inline$$1_CRSN_publish$0$$t14@0 inline$$1_CRSN_publish$0$$t14@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t14@0) (= (ControlFlow 0 1859600) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t14@0) (= inline$$1_CRSN_publish$0$$t14@0 1)) (and (= inline$$1_CRSN_publish$0$$t14@0 inline$$1_CRSN_publish$0$$t14@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1859584) 1859662) inline$$1_CRSN_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 1859584) 1859600) inline$$1_CRSN_publish$0$anon20_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_CRSN_has_crsn$0$$t1@1)) (= (ControlFlow 0 1859548) 1859584)) inline$$1_CRSN_publish$0$anon19_Else$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon19_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1859554) 1859548)) inline$$Not$0$anon0_correct)))
(let ((inline$$1_CRSN_publish$0$anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@1) (= (ControlFlow 0 1861395) 1859606))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_has_crsn$0$anon0_correct  (=> (= inline$$1_CRSN_publish$0$$t9@0 inline$$1_CRSN_publish$0$$t9@0) (=> (and (= inline$$1_CRSN_has_crsn$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_publish$0$$t9@0)) (= inline$$1_CRSN_has_crsn$0$$t1@1 inline$$1_CRSN_has_crsn$0$$t1@1)) (and (=> (= (ControlFlow 0 1859504) 1861395) inline$$1_CRSN_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 1859504) 1859554) inline$$1_CRSN_publish$0$anon19_Else_correct))))))
(let ((inline$$1_CRSN_publish$0$anon0_correct  (=> (and (= _$t0 _$t0) (= $t6@0 $t6@0)) (=> (and (and (= _$t1 _$t1) (|$IsValid'address'| inline$$1_CRSN_publish$0$$t9@0)) (and (= inline$$1_CRSN_publish$0$$t9@0 (|$addr#$signer| _$t0)) (= (ControlFlow 0 1859510) 1859504))) inline$$1_CRSN_has_crsn$0$anon0_correct))))
(let ((anon10_Else_correct  (=> (and (and (not $abort_flag@0) (= $t4@1 $t4@1)) (and (= $t6@0 (|$sequence_number#$1_DiemAccount_DiemAccount| $t4@1)) (= (ControlFlow 0 1861399) 1859510))) inline$$1_CRSN_publish$0$anon0_correct)))
(let ((anon10_Then_correct true))
(let ((anon9_Then$1_correct  (=> (= $t4@1 $t4) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1861634) 1861582) anon10_Then_correct) (=> (= (ControlFlow 0 1861634) 1861399) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t3)) (= (ControlFlow 0 1861632) 1861634)) anon9_Then$1_correct)))
(let ((anon9_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t3) (=> (and (and (= $t4@0 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t3)) (= $t4@1 $t4@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1858808) 1861582) anon10_Then_correct) (=> (= (ControlFlow 0 1858808) 1861399) anon10_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4) (or (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0) (and (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0)) (= addr@@4 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0)))))))
 :qid |DiemAccountbpl.91411:20|
 :skolemid |3217|
)) (=> (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5)))) 0)) (and (not (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5)))) 0)) (= addr@@5 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5)))) 0)))))))
 :qid |DiemAccountbpl.91415:20|
 :skolemid |3218|
)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@6)))
 :qid |DiemAccountbpl.91419:20|
 :skolemid |3219|
))) (=> (and (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (= (|Select__T@[Int]Bool_| (|domain#$Memory_473580| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@7)  (and (= addr@@7 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@7))))
 :qid |DiemAccountbpl.91423:20|
 :skolemid |3220|
 ...
 :qid |DiemAccountbpl.91435:20|
 :skolemid |3223|
)))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'u64'| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $a_0)))
(|$IsValid'$1_CRSN_CRSN'| $rsc))
 :qid |DiemAccountbpl.91444:20|
 :skolemid |3224|
 :pattern ( (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@0)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@0) (and (<= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@0))) 1) (<= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@0))) 1))))
 :qid |DiemAccountbpl.91448:20|
 :skolemid |3225|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@0))
)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (|$IsValid'address'| $t3) (= $t3 (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 1858794) 1861632) anon9_Then_correct) (=> (= (ControlFlow 0 1858794) 1858808) anon9_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1858465) 1858794)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2567575) 1858465) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
