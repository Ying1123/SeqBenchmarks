...
(declare-fun $t15@0 () T@$Mutation_486387)
(declare-fun $t14@1 () T@$Mutation_486346)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t15@1 () T@$Mutation_486387)
(declare-fun $t13 () |T@$1_Option_Option'address'|)
(declare-fun $t14@2 () T@$Mutation_486346)
...
(declare-fun $t14 () T@$Mutation_486346)
(declare-fun $t9 () Int)
(declare-fun $t14@0 () T@$Mutation_486346)
...
(declare-fun $t15 () T@$Mutation_486387)
(push 1)
(set-info :boogie-vc-id $1_ValidatorConfig_remove_operator$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2064229) (let ((anon18_Else_correct  (=> (and (and (not $abort_flag@0) (= $t15@0 ($Mutation_486387 (|l#$Mutation_486346| $t14@1) (let ((l (|l#Vec_33444| (|p#$Mutation_486346| $t14@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_486346| $t14@1)) l 1) (+ l 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@1))))) (and (= $t15@1 ($Mutation_486387 (|l#$Mutation_486387| $t15@0) (|p#$Mutation_486387| $t15@0) $t13)) (= $t14@2 ($Mutation_486346 (|l#$Mutation_486346| $t14@1) (|p#$Mutation_486346| $t14@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@1)) (|v#$Mutation_486387| $t15@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@1))))))) (and (=> (= (ControlFlow 0 1112565) (- 0 2065611)) (<= (|l#Vec_421811| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@2)))) 1)) (=> (<= (|l#Vec_421811| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@2)))) 1) (and (=> (= (ControlFlow 0 1112565) (- 0 2065624)) (<= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@2)))) 1)) (=> (<= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_486346| $t14@2)))) 1) (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_477156 (|Store__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_486346| $t14@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_486346| $t14@2)) (|v#$Mutation_486346| $t14@2)))) (and (=> (= (ControlFlow 0 1112565) (- 0 2065668)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) a)) (=> (not (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) a))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) a))))) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) a)) 3))))))
 :qid |DiemAccountbpl.8768:15|
 :skolemid |247|
 ...
 :qid |DiemAccountbpl.8774:15|
 :skolemid |248|
)) (and (=> (= (ControlFlow 0 1112565) (- 0 2065750)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr)) 3))))
 :qid |DiemAccountbpl.8780:15|
 :skolemid |249|
 ...
 :qid |DiemAccountbpl.8780:15|
 :skolemid |249|
)) (and (=> (= (ControlFlow 0 1112565) (- 0 2065775)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@1)) 3))))
 :qid |DiemAccountbpl.8786:15|
 :skolemid |250|
...
(|Select__T@[Int]Int_| (|v#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)) a@@1)))
 :qid |DiemAccountbpl.8799:674|
 :skolemid |253|
))))
 :qid |DiemAccountbpl.8798:592|
 :skolemid |254|
...
(|Select__T@[Int]Int_| (|v#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) a@@2)))
 ...
 :qid |DiemAccountbpl.8798:592|
 :skolemid |254|
))) (and (=> (= (ControlFlow 0 1112565) (- 0 2065966)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@19)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19)) 3))))
 :qid |DiemAccountbpl.8805:15|
 :skolemid |255|
 ...
 :qid |DiemAccountbpl.8805:15|
 :skolemid |255|
)) (and (=> (= (ControlFlow 0 1112565) (- 0 2065994)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 1112565) (- 0 2066006)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 3))) (and (=> (= (ControlFlow 0 1112565) (- 0 2066024)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (and (=> (= (ControlFlow 0 1112565) (- 0 2066036)) (not (not (= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0)))) (=> (not (not (= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0))) (=> (= (ControlFlow 0 1112565) (- 0 2066047)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (not (= addr@@21 $t4)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@21))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21))))))
 :qid |DiemAccountbpl.8834:15|
 :skolemid |256|
)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1112001) (- 0 2065473)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (=> (= (ControlFlow 0 1112001) (- 0 2065504)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 3)) (= 3 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)) (= 5 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 1112579) 1112001))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $t14@1 $t14) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1112631) 1112579) anon18_Then_correct) (=> (= (ControlFlow 0 1112631) 1112565) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= (ControlFlow 0 1112629) 1112631)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t9) (=> (and (and (= $t14@0 ($Mutation_486346 ($Global $t9) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t9))) (= $t14@1 $t14@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1112049) 1112579) anon18_Then_correct) (=> (= (ControlFlow 0 1112049) 1112565) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t13) (<= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| $t13)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t13) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0))))) (and (=> (= (ControlFlow 0 1112027) 1112629) anon17_Then_correct) (=> (= (ControlFlow 0 1112027) 1112049) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 1111901) 1112001))) L3_correct)))
(let ((anon15_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 1111885) 1112027) anon16_Then_correct) (=> (= (ControlFlow 0 1111885) 1111901) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t6)) 3)) (= 3 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 1112697) 1112001))) L3_correct))))
(let ((anon15_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t9 $t9) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 1111843) 1112645) anon15_Then_correct) (=> (= (ControlFlow 0 1111843) 1111885) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (not $t7) (=> (and (and (|$IsValid'address'| $t9) (= $t9 (|$addr#$signer| _$t0))) (and (= $t9 $t9) (= (ControlFlow 0 1111849) 1111843))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22)) 0)) (= addr@@22 173345816)))
 ...
 :qid |DiemAccountbpl.8517:20|
 :skolemid |228|
))))) (=> (and (and (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@32) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@32)) 3))))
 :qid |DiemAccountbpl.8521:20|
 :skolemid |229|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@36))))) i1)))) 3))))
 ...
 :qid |DiemAccountbpl.8582:20|
 :skolemid |244|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemAccountbpl.8588:20|
 :skolemid |245|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@0) (and (<= (|l#Vec_421811| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1) (<= (|l#Vec_33444| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1))))
 :qid |DiemAccountbpl.8592:20|
 :skolemid |246|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t6)) 3))))))) (and (=> (= (ControlFlow 0 1111718) 1112697) anon14_Then_correct) (=> (= (ControlFlow 0 1111718) 1111849) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1110862) 1111718)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_33444| (|p#$Mutation_486346| $t14)) 0) (=> (and (= (|l#Vec_33444| (|p#$Mutation_486387| $t15)) 0) (= (ControlFlow 0 1110872) 1110862)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2064229) 1110872) anon0_correct)))
