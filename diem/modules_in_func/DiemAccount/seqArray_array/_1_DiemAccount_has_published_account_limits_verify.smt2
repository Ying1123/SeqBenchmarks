...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_has_published_account_limits$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2441284) (let ((anon11_Then_correct true))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon6_Then_correct| true))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 1669568) (- 0 2441994)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.73866:15|
 :skolemid |2704|
 ...
 :qid |DiemAccountbpl.73866:15|
 :skolemid |2704|
)) (=> (= (ControlFlow 0 1669568) (- 0 2442030)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.73871:15|
 :skolemid |2705|
))))))))
(let ((anon11_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|)) (and (= $t1@0 |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|) (= (ControlFlow 0 1670066) 1669568))) L3_correct)))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$L2_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 |inline$$1_VASP_has_account_limits'#0'$0$$t3@1|) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 1670004) 1670080) anon11_Then_correct) (=> (= (ControlFlow 0 1670004) 1670066) anon11_Else_correct))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|  (=> |inline$$1_VASP_has_account_limits'#0'$0$$t2@0| (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@0| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@1| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|) (= (ControlFlow 0 1670042) 1670004))) |inline$$1_VASP_has_account_limits'#0'$0$L2_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 1669984) 1670080) anon11_Then_correct) (=> (= (ControlFlow 0 1669984) 1670066) anon11_Else_correct))))))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|  (=> (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|)) (and (=> (= (ControlFlow 0 1669960) 1669998) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 1669960) 1669984) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|  (=> (and (and (not |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|) (|$IsValid'address'| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (= (ControlFlow 0 1669966) 1669960))) |inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|)))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|  (=> (and (= _$t0 _$t0) (= |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 1669841) 1670042) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|) (=> (= (ControlFlow 0 1669841) 1669966) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|)))))
(let ((anon10_Then_correct  (=> (and $t2 (= (ControlFlow 0 1670048) 1669841)) |inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|)))
(let ((anon12_Else_correct  (=> (and (and (not false) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (and (= $t1@0 |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|) (= (ControlFlow 0 1669478) 1669568))) L3_correct)))
(let ((anon12_Then_correct true))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t0)) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1669454) 1669582) anon12_Then_correct) (=> (= (ControlFlow 0 1669454) 1669478) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not $t2) (= (ControlFlow 0 1669460) 1669454)) |inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|)))
(let ((anon0$1_correct  (=> (and (and (forall ((window_addr Int) ) (!  (=> (|$IsValid'address'| window_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) window_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_526401| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) window_addr)))))
 :qid |DiemAccountbpl.73744:20|
 :skolemid |2695|
 ...
 :qid |DiemAccountbpl.73756:20|
 :skolemid |2698|
)))) (=> (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@4)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@4)) 6))))
 :qid |DiemAccountbpl.73760:20|
 :skolemid |2699|
 ...
 :qid |DiemAccountbpl.73764:20|
 :skolemid |2700|
))) (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) $a_0)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc))
 :qid |DiemAccountbpl.73770:20|
 :skolemid |2701|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) $a_0))
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@0))
 :qid |DiemAccountbpl.73774:20|
 :skolemid |2702|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_487799| $1_VASP_ParentVASP_$memory) $a_0@@1)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@1))
 :qid |DiemAccountbpl.73778:20|
 :skolemid |2703|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_487799| $1_VASP_ParentVASP_$memory) $a_0@@1))
))) (and (= _$t0 _$t0) (= $t2  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))))) (and (=> (= (ControlFlow 0 1669351) 1670048) anon10_Then_correct) (=> (= (ControlFlow 0 1669351) 1669460) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1669059) 1669351)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2441284) 1669059) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
