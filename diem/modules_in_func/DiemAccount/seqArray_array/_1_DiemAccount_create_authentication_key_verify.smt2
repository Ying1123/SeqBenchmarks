...
(declare-fun $t14 () Int)
(declare-fun |inline$$1_Vector_append'u8'$0$m'@1| () T@$Mutation_455163)
(declare-fun $t5@0 () T@$Mutation_455163)
(declare-fun call1formal@res@0 () T@Vec_33444)
(declare-fun DefaultVecElem_18066 () Int)
(declare-fun inline$$1_Signer_borrow_address$0$res@1 () Int)
...
(declare-fun $t5 () T@$Mutation_455163)
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_create_authentication_key$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2221161) (let ((anon17_Else_correct true))
(let ((anon17_Then_correct  (=> (and $t12@0 (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 1321194) (- 0 2221546)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0))))))
 :qid |DiemAccountbpl.50641:15|
 :skolemid |1565|
 ...
 :qid |DiemAccountbpl.50646:15|
 :skolemid |1566|
)) (=> (= (ControlFlow 0 1321194) (- 0 2221646)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))))
 :qid |DiemAccountbpl.50651:15|
 :skolemid |1567|
))))))))))
(let ((anon16_Else_correct  (=> (and (and (and (not false) (|$IsValid'u64'| 32)) (and (= $t12@0 (= |inline$$1_Vector_length'u8'$0$l@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12@0 $t12@0)))) (and (=> (= (ControlFlow 0 1321017) 1321194) anon17_Then_correct) (=> (= (ControlFlow 0 1321017) 1321033) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_33444| $t4@0)) (and (=> (= (ControlFlow 0 1320959) 1321208) anon16_Then_correct) (=> (= (ControlFlow 0 1320959) 1321017) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (not false) (=> (and (= $t4@0 (|v#$Mutation_455163| |inline$$1_Vector_append'u8'$0$m'@1|)) (= (ControlFlow 0 1320965) 1320959)) |inline$$1_Vector_length'u8'$0$anon0_correct|))))
(let ((anon15_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$0$m'@1| ($Mutation_455163 (|l#$Mutation_455163| $t5@0) (|p#$Mutation_455163| $t5@0) (let ((m2@@0 (|v#Vec_33444| call1formal@res@0)))
(let ((l2 (|l#Vec_33444| call1formal@res@0)))
(let ((m1@@0 (|v#Vec_33444| (|v#$Mutation_455163| $t5@0))))
(let ((l1 (|l#Vec_33444| (|v#$Mutation_455163| $t5@0))))
(Vec_33444 (|lambda#42| 0 (+ l1 l2) l1 m1@@0 m2@@0 l1 DefaultVecElem_18066) (+ l1 l2)))))))) (and (=> (= (ControlFlow 0 1320907) 1321222) anon15_Then_correct) (=> (= (ControlFlow 0 1320907) 1320965) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not false) (= (ControlFlow 0 1320913) 1320907)) |inline$$1_Vector_append'u8'$0$anon0_correct|)))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (not false) (= call1formal@res@0 (|$1_BCS_serialize'address'| inline$$1_Signer_borrow_address$0$res@1))) (and (=> (= (ControlFlow 0 1320848) 1321236) anon14_Then_correct) (=> (= (ControlFlow 0 1320848) 1320913) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((inline$$1_Signer_borrow_address$0$anon0_correct  (=> (= inline$$1_Signer_borrow_address$0$res@1 (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 1320834) 1321250) anon13_Then_correct) (=> (= (ControlFlow 0 1320834) 1320848) anon13_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (|$IsValid'vec'u8''| _$t1) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t1 _$t1)) (and (= $t5@0 ($Mutation_455163 ($Local 4) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) _$t1)) (= (ControlFlow 0 1320840) 1320834)))) inline$$1_Signer_borrow_address$0$anon0_correct)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1320732) 1320840)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_33444| (|p#$Mutation_455163| $t5)) 0) (= (ControlFlow 0 1320742) 1320732)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2221161) 1320742) anon0_correct)))
