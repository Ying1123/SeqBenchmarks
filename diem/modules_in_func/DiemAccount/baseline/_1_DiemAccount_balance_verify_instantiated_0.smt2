...
(declare-fun $t7@1 () |T@$1_DiemAccount_Balance'$1_XUS_XUS'|)
(declare-fun $t7 () |T@$1_DiemAccount_Balance'$1_XUS_XUS'|)
(declare-fun $t7@0 () |T@$1_DiemAccount_Balance'$1_XUS_XUS'|)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_balance$verify_instantiated_0)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2161896) (let ((anon15_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1|)) (and (=> (= (ControlFlow 0 1237685) (- 0 2162412)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 1237685) (- 0 2162423)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.42280:15|
 :skolemid |1161|
 ...
 :qid |DiemAccountbpl.42280:15|
 :skolemid |1161|
)) (=> (= (ControlFlow 0 1237685) (- 0 2162459)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.42285:15|
 :skolemid |1162|
))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1237264) (- 0 2162374)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (=> (= (ControlFlow 0 1237264) (- 0 2162380)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (= 5 $t6@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1237699) 1237264))) L3_correct)))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@0) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1237553) 1237699) anon15_Then_correct) (=> (= (ControlFlow 0 1237553) 1237685) anon15_Else_correct)))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1237571) 1237699) anon15_Then_correct) (=> (= (ControlFlow 0 1237571) 1237685) anon15_Else_correct)))))
(let ((|inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1|)) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1237529) 1237571) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1237529) 1237553) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon0_correct|  (=> (= $t7@1 $t7@1) (=> (and (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| $t7@1)) (= (ControlFlow 0 1237535) 1237529)) |inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1237577) 1237535)) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1237713) 1237264))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1237765) 1237713) anon14_Then_correct) (=> (= (ControlFlow 0 1237765) 1237577) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (= (ControlFlow 0 1237763) 1237765)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1237282) 1237713) anon14_Then_correct) (=> (= (ControlFlow 0 1237282) 1237577) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 1237268) 1237763) anon13_Then_correct) (=> (= (ControlFlow 0 1237268) 1237282) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 1237232) 1237264))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 2)))))
 :qid |DiemAccountbpl.42177:20|
 :skolemid |1158|
)) (=> (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))
 :qid |DiemAccountbpl.42181:20|
 :skolemid |1159|
)) (|$IsValid'address'| _$t0)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'$1_XUS_XUS''| $rsc))
 :qid |DiemAccountbpl.42187:20|
 :skolemid |1160|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) _$t0)) (|$IsValid'u64'| 19))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 1237216) 1237268) anon12_Then_correct) (=> (= (ControlFlow 0 1237216) 1237232) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1237076) 1237216)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2161896) 1237076) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
