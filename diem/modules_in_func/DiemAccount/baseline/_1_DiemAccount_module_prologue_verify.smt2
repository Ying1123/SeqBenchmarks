...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_module_prologue$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2445153) (let ((anon11_Else_correct  (=> (not $abort_flag@31) (and (=> (= (ControlFlow 0 1686717) (- 0 2453042)) (not (not (let ((publish_option (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 ...
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0)) 0))))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453054)) (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)))))) (=> (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453067)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453079)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t11) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t11))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t11) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t11)))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453089)) (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11)))))) (=> (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453108)) (not (> $t10 18446744073709551615))) (=> (not (> $t10 18446744073709551615)) (and (=> (= (ControlFlow 0 1686717) (- 0 2453119)) (not (and (> $t10 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))))) (=> (not (and (> $t10 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453137)) (not (and (> $t10 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t11))))) (=> (not (and (> $t10 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t11)))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453157)) (not (and (> $t10 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t11))) $t10)))) (=> (not (and (> $t10 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t11))) $t10))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453179)) (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5))) (=> (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (and (=> (= (ControlFlow 0 1686717) (- 0 2453190)) (not (>= _$t1 18446744073709551615))) (=> (not (>= _$t1 18446744073709551615)) (and (=> (= (ControlFlow 0 1686717) (- 0 2453200)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t11)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t11)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453224)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t11)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t11)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t11))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453248)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t11) (not (let ((crsn (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $t11)))
...
(ite  (or (< _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0)) (>= _$t1 (+ (|$min_nonce#$1_CRSN_CRSN| crsn@@0) (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0)))))) false (let ((scaled_nonce@@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0))))
 (not (ite (>= scaled_nonce@@0 (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0)))) false (|Select__T@[Int]Bool_| (|v#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0))) scaled_nonce@@0))))))))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453268)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453278)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1686717) (- 0 2453295)) (let ((addr@@1 (|$addr#$signer| _$t0)))
 ...
 :qid |DiemAccountbpl.75232:15|
 :skolemid |2777|
)) (=> (= (ControlFlow 0 1686717) (- 0 2453343)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5))))))
 :qid |DiemAccountbpl.75237:15|
 :skolemid |2778|
))))))))))))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1677328) (- 0 2452510)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (let ((publish_option@@1 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
...
(let ((anon11_Then_correct  (=> (and (and $abort_flag@31 (= $abort_code@29 $abort_code@29)) (and (= $t13@0 $abort_code@29) (= (ControlFlow 0 1686731) 1677328))) L3_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|  (=> (and (= $abort_code@29 $abort_code@28) (= $abort_flag@31 $abort_flag@30)) (and (=> (= (ControlFlow 0 1681763) 1686731) anon11_Then_correct) (=> (= (ControlFlow 0 1681763) 1686717) anon11_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Then_correct|  (=> (and (and inline$$1_CRSN_check$0$$ret0@1 (= $abort_flag@30 $abort_flag@29)) (and (= $abort_code@28 $abort_code@27) (= (ControlFlow 0 1685013) 1681763))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Then_correct|  (=> (and (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| (= $abort_flag@30 $abort_flag@17)) (and (= $abort_code@28 $abort_code@16) (= (ControlFlow 0 1681759) 1681763))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|  (=> (and (= $abort_code@29 |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1|) (= $abort_flag@31 true)) (and (=> (= (ControlFlow 0 1679974) 1686731) anon11_Then_correct) (=> (= (ControlFlow 0 1679974) 1686717) anon11_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Else_correct|  (=> (and (and (not inline$$Ge$2$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= (ControlFlow 0 1686153) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|  (=> (and (and $abort_flag@15 (= $abort_code@14 $abort_code@14)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@14) (= (ControlFlow 0 1686171) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= (ControlFlow 0 1685284) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Else_correct|  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= (ControlFlow 0 1685226) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@12) (= (ControlFlow 0 1686185) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Else_correct|  (=> (and (and (not inline$$1_CRSN_check$0$$ret0@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= (ControlFlow 0 1685009) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|  (=> (and (not $abort_flag@29) (|$IsValid'u64'| 1014)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@1))) (and (=> (= (ControlFlow 0 1684993) 1685013) |inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Then_correct|) (=> (= (ControlFlow 0 1684993) 1685009) |inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|  (=> (and (and $abort_flag@29 (= $abort_code@27 $abort_code@27)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@27) (= (ControlFlow 0 1685027) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_CRSN_check$0$L9_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$1_CRSN_check$0$$t5@1) (= $abort_code@27 $abort_code@26)) (and (= $abort_flag@29 $abort_flag@28) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$t5@1))) (and (=> (= (ControlFlow 0 1684729) 1685027) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|) (=> (= (ControlFlow 0 1684729) 1684993) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|)))))
(let ((inline$$1_CRSN_check$0$anon43_Else$1_correct  (=> (= inline$$Not$1$dst@1 inline$$Not$1$dst@1) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$Not$1$dst@1) (= $abort_flag@28 $abort_flag@27)) (and (= $abort_code@26 $abort_code@25) (= (ControlFlow 0 1684717) 1684729))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not inline$$1_BitVector_is_index_set$0$$ret0@1)) (= (ControlFlow 0 1684699) 1684717)) inline$$1_CRSN_check$0$anon43_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon43_Else_correct  (=> (and (not $abort_flag@27) (= (ControlFlow 0 1684705) 1684699)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon41_Then_correct  (=> (and inline$$1_CRSN_check$0$$t4@1 (= false false)) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 false) (= $abort_flag@28 $abort_flag@24)) (and (= $abort_code@26 $abort_code@22) (= (ControlFlow 0 1684779) 1684729))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$1_CRSN_check$0$L11_correct  (=> (= $abort_code@27 inline$$1_CRSN_check$0$$t13@1) (=> (and (= $abort_flag@29 true) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@0)) (and (=> (= (ControlFlow 0 1682882) 1685027) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|) (=> (= (ControlFlow 0 1682882) 1684993) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|))))))
(let ((inline$$1_CRSN_check$0$anon43_Then_correct  (=> (and (and $abort_flag@27 (= $abort_code@25 $abort_code@25)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@25) (= (ControlFlow 0 1684743) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Else_correct  (=> (not $abort_flag@26) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_flag@27 $abort_flag@26)) (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_code@25 $abort_code@24))) (and (=> (= (ControlFlow 0 1684627) 1684743) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1684627) 1684705) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$L3_correct  (=> (= $abort_flag@27 true) (=> (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 inline$$1_BitVector_is_index_set$0$$ret0@0) (= $abort_code@25 inline$$1_BitVector_is_index_set$0$$t6@1)) (and (=> (= (ControlFlow 0 1684460) 1684743) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1684460) 1684705) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Then_correct  (=> (and (and $abort_flag@26 (= $abort_code@24 $abort_code@24)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@24) (= (ControlFlow 0 1684641) 1684460))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|  (=> (= $abort_code@24 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@26 true) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@0|)) (and (=> (= (ControlFlow 0 1684603) 1684641) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1684603) 1684627) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2)) (= (ControlFlow 0 1684601) 1684603)) |inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|  (=> (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@1| (|Select__T@[Int]Bool_| (|v#Vec_92615| inline$$1_BitVector_is_index_set$0$$t10@1) inline$$Sub$0$dst@2)) (= $abort_code@24 $abort_code@23)) (and (= $abort_flag@26 $abort_flag@25) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@1|))) (and (=> (= (ControlFlow 0 1684551) 1684641) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1684551) 1684627) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Then_correct  (=> (and inline$$Lt$3$dst@1 (= inline$$1_BitVector_is_index_set$0$$t10@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1))) (and (=> (= (ControlFlow 0 1684609) 1684601) |inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1684609) 1684551) |inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|)))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Else_correct  (=> (and (and (not inline$$Lt$3$dst@1) (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 inline$$1_BitVector_is_index_set$0$$t9@0) (= (ControlFlow 0 1684454) 1684460))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$1_BitVector_is_index_set$0$$t9@0 7)) (and (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$Lt$3$dst@1 inline$$Lt$3$dst@1))) (and (=> (= (ControlFlow 0 1684438) 1684609) inline$$1_BitVector_is_index_set$0$anon9_Then_correct) (=> (= (ControlFlow 0 1684438) 1684454) inline$$1_BitVector_is_index_set$0$anon9_Else_correct))))))
(let ((inline$$Lt$3$anon0_correct  (=> (and (= inline$$Lt$3$dst@1 (< inline$$Sub$0$dst@2 |inline$$1_Vector_length'bool'$1$l@1|)) (= (ControlFlow 0 1684402) 1684438)) inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else_correct  (=> (and (not $abort_flag@25) (= (ControlFlow 0 1684408) 1684402)) inline$$Lt$3$anon0_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Then_correct  (=> (and (and $abort_flag@25 (= $abort_code@23 $abort_code@23)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@23) (= (ControlFlow 0 1684655) 1684460))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_length'bool'$1$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$1$l@1| (|l#Vec_92615| inline$$1_BitVector_is_index_set$0$$t4@1)) (and (=> (= (ControlFlow 0 1684348) 1684655) inline$$1_BitVector_is_index_set$0$anon8_Then_correct) (=> (= (ControlFlow 0 1684348) 1684408) inline$$1_BitVector_is_index_set$0$anon8_Else_correct)))))
(let ((inline$$1_BitVector_is_index_set$0$anon0_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t31@1 inline$$1_CRSN_check$0$$t31@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_BitVector_is_index_set$0$$t4@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1)) (= (ControlFlow 0 1684354) 1684348))) |inline$$1_Vector_length'bool'$1$anon0_correct|)))
(let ((inline$$1_CRSN_check$0$anon42_Else_correct  (=> (and (and (not $abort_flag@25) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_CRSN_check$0$$t31@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1684661) 1684354))) inline$$1_BitVector_is_index_set$0$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon42_Then_correct  (=> (and (and $abort_flag@25 (= $abort_code@23 $abort_code@23)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@23) (= (ControlFlow 0 1684757) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@25 true) (=> (and (= $abort_code@23 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 1683995) 1684757) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1683995) 1684661) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< _$t1 inline$$1_CRSN_check$0$$t29@1) (= (ControlFlow 0 1683993) 1683995)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$1_CRSN_check$0$$t29@1 _$t1) (=> (and (and (= inline$$Sub$0$dst@1 (- _$t1 inline$$1_CRSN_check$0$$t29@1)) (= $abort_flag@25 $abort_flag@24)) (and (= $abort_code@23 $abort_code@22) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 1683945) 1684757) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1683945) 1684661) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon41_Else_correct  (=> (and (not inline$$1_CRSN_check$0$$t4@1) (= inline$$1_CRSN_check$0$$t29@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1684001) 1683993) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 1684001) 1683945) inline$$Sub$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon40_Else$1_correct  (=> (and (and (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1) (= $abort_code@22 $abort_code@21)) (and (= inline$$1_CRSN_check$0$$t4@1 inline$$Ge$1$dst@1) (= $abort_flag@24 $abort_flag@23))) (and (=> (= (ControlFlow 0 1683850) 1684779) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1683850) 1684001) inline$$1_CRSN_check$0$anon41_Else_correct)))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= inline$$CastU128$3$dst@1 inline$$AddU128$0$dst@2)) (= (ControlFlow 0 1683832) 1683850)) inline$$1_CRSN_check$0$anon40_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon40_Else_correct  (=> (and (not $abort_flag@23) (= (ControlFlow 0 1683838) 1683832)) inline$$Ge$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon35_Then_correct  (=> inline$$Lt$2$dst@1 (=> (and (and (= true true) (= $abort_code@22 $abort_code@17)) (and (= inline$$1_CRSN_check$0$$t4@1 true) (= $abort_flag@24 $abort_flag@18))) (and (=> (= (ControlFlow 0 1684867) 1684779) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1684867) 1684001) inline$$1_CRSN_check$0$anon41_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon40_Then_correct  (=> (and (and $abort_flag@23 (= $abort_code@21 $abort_code@21)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@21) (= (ControlFlow 0 1684793) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$AddU128$0$anon3_Then$1_correct  (=> (= $abort_flag@23 true) (=> (and (= $abort_code@21 $EXEC_FAILURE_CODE) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@0)) (and (=> (= (ControlFlow 0 1683778) 1684793) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1683778) 1683838) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$AddU128$0$anon3_Then_correct  (=> (and (> (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1) $MAX_U128) (= (ControlFlow 0 1683776) 1683778)) inline$$AddU128$0$anon3_Then$1_correct)))
(let ((inline$$AddU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (=> (and (and (= inline$$AddU128$0$dst@1 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (= $abort_flag@23 $abort_flag@22)) (and (= $abort_code@21 $abort_code@20) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@1))) (and (=> (= (ControlFlow 0 1683724) 1684793) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1683724) 1683838) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon39_Else_correct  (=> (not $abort_flag@22) (and (=> (= (ControlFlow 0 1683784) 1683776) inline$$AddU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1683784) 1683724) inline$$AddU128$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon39_Then_correct  (=> (and (and $abort_flag@22 (= $abort_code@20 $abort_code@20)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@20) (= (ControlFlow 0 1684807) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$5$anon3_Then$1_correct  (=> (= $abort_code@20 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@22 true) (= inline$$CastU128$5$dst@1 inline$$CastU128$5$dst@0)) (and (=> (= (ControlFlow 0 1683617) 1684807) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1683617) 1683784) inline$$1_CRSN_check$0$anon39_Else_correct))))))
(let ((inline$$CastU128$5$anon3_Then_correct  (=> (and (> inline$$1_BitVector_length$0$$ret0@1 $MAX_U128) (= (ControlFlow 0 1683615) 1683617)) inline$$CastU128$5$anon3_Then$1_correct)))
(let ((inline$$CastU128$5$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_BitVector_length$0$$ret0@1) (= $abort_code@20 $abort_code@19)) (and (= $abort_flag@22 $abort_flag@21) (= inline$$CastU128$5$dst@1 inline$$1_BitVector_length$0$$ret0@1))) (and (=> (= (ControlFlow 0 1683567) 1684807) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1683567) 1683784) inline$$1_CRSN_check$0$anon39_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Else_correct  (=> (not $abort_flag@21) (and (=> (= (ControlFlow 0 1683623) 1683615) inline$$CastU128$5$anon3_Then_correct) (=> (= (ControlFlow 0 1683623) 1683567) inline$$CastU128$5$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Then_correct  (=> (and (and $abort_flag@21 (= $abort_code@19 $abort_code@19)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@19) (= (ControlFlow 0 1684821) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_length$0$anon3_Else_correct  (=> (and (and (not $abort_flag@20) (= |inline$$1_Vector_length'bool'$0$l@1| |inline$$1_Vector_length'bool'$0$l@1|)) (and (= $abort_flag@21 $abort_flag@20) (= inline$$1_BitVector_length$0$$ret0@1 |inline$$1_Vector_length'bool'$0$l@1|))) (and (=> (= (ControlFlow 0 1683466) 1684821) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1683466) 1683623) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon3_Then_correct  (=> (and (and $abort_flag@20 (= $abort_code@19 $abort_code@19)) (and (= $abort_flag@21 true) (= inline$$1_BitVector_length$0$$ret0@1 inline$$1_BitVector_length$0$$ret0@0))) (and (=> (= (ControlFlow 0 1683484) 1684821) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1683484) 1683623) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((|inline$$1_Vector_length'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$0$l@1| (|l#Vec_92615| inline$$1_BitVector_length$0$$t1@1)) (and (=> (= (ControlFlow 0 1683442) 1683484) inline$$1_BitVector_length$0$anon3_Then_correct) (=> (= (ControlFlow 0 1683442) 1683466) inline$$1_BitVector_length$0$anon3_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t23@1 inline$$1_CRSN_check$0$$t23@1) (=> (and (= inline$$1_BitVector_length$0$$t1@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t23@1)) (= (ControlFlow 0 1683448) 1683442)) |inline$$1_Vector_length'bool'$0$anon0_correct|))))
(let ((inline$$1_CRSN_check$0$anon37_Else_correct  (=> (not $abort_flag@20) (=> (and (= inline$$1_CRSN_check$0$$t23@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1683490) 1683448)) inline$$1_BitVector_length$0$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon37_Then_correct  (=> (and (and $abort_flag@20 (= $abort_code@19 $abort_code@19)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@19) (= (ControlFlow 0 1684835) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$4$anon3_Then$1_correct  (=> (= $abort_flag@20 true) (=> (and (= $abort_code@19 $EXEC_FAILURE_CODE) (= inline$$CastU128$4$dst@1 inline$$CastU128$4$dst@0)) (and (=> (= (ControlFlow 0 1683246) 1684835) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1683246) 1683490) inline$$1_CRSN_check$0$anon37_Else_correct))))))
(let ((inline$$CastU128$4$anon3_Then_correct  (=> (and (> inline$$1_CRSN_check$0$$t21@1 $MAX_U128) (= (ControlFlow 0 1683244) 1683246)) inline$$CastU128$4$anon3_Then$1_correct)))
(let ((inline$$CastU128$4$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_CRSN_check$0$$t21@1) (= $abort_flag@20 $abort_flag@19)) (and (= $abort_code@19 $abort_code@18) (= inline$$CastU128$4$dst@1 inline$$1_CRSN_check$0$$t21@1))) (and (=> (= (ControlFlow 0 1683196) 1684835) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1683196) 1683490) inline$$1_CRSN_check$0$anon37_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Else_correct  (=> (and (not $abort_flag@19) (= inline$$1_CRSN_check$0$$t21@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1683252) 1683244) inline$$CastU128$4$anon3_Then_correct) (=> (= (ControlFlow 0 1683252) 1683196) inline$$CastU128$4$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Then_correct  (=> (and (and $abort_flag@19 (= $abort_code@18 $abort_code@18)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@18) (= (ControlFlow 0 1684849) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$3$anon3_Then$1_correct  (=> (= $abort_code@18 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@19 true) (= inline$$CastU128$3$dst@1 inline$$CastU128$3$dst@0)) (and (=> (= (ControlFlow 0 1683107) 1684849) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1683107) 1683252) inline$$1_CRSN_check$0$anon36_Else_correct))))))
(let ((inline$$CastU128$3$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1683105) 1683107)) inline$$CastU128$3$anon3_Then$1_correct)))
(let ((inline$$CastU128$3$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_code@18 $abort_code@17)) (and (= $abort_flag@19 $abort_flag@18) (= inline$$CastU128$3$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1683057) 1684849) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1683057) 1683252) inline$$1_CRSN_check$0$anon36_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon35_Else_correct  (=> (not inline$$Lt$2$dst@1) (and (=> (= (ControlFlow 0 1683113) 1683105) inline$$CastU128$3$anon3_Then_correct) (=> (= (ControlFlow 0 1683113) 1683057) inline$$CastU128$3$anon3_Else_correct)))))
(let ((inline$$Lt$2$anon0_correct  (=> (= inline$$Lt$2$dst@1 (< _$t1 inline$$1_CRSN_check$0$$t17@1)) (and (=> (= (ControlFlow 0 1682974) 1684867) inline$$1_CRSN_check$0$anon35_Then_correct) (=> (= (ControlFlow 0 1682974) 1683113) inline$$1_CRSN_check$0$anon35_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon34_Else_correct  (=> (not $abort_flag@18) (=> (and (and (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)) (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1|)) (and (= inline$$1_CRSN_check$0$$t17@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1682980) 1682974))) inline$$Lt$2$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon34_Then_correct  (=> (and (and $abort_flag@18 (= $abort_code@17 $abort_code@17)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@17) (= (ControlFlow 0 1684881) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Then$1_correct  (=> (= $abort_flag@18 true) (=> (and (= $abort_code@17 $EXEC_FAILURE_CODE) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@0)) (and (=> (= (ControlFlow 0 1684933) 1684881) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1684933) 1682980) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon33_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= (ControlFlow 0 1684931) 1684933)) inline$$1_CRSN_check$0$anon33_Then$1_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0) (=> (and (and (= inline$$1_CRSN_check$0$$t16@1 ($Mutation_577037 ($Global inline$$1_CRSN_check$0$$t11@0) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0))) (= $abort_flag@18 $abort_flag@17)) (and (= $abort_code@17 $abort_code@16) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@1))) (and (=> (= (ControlFlow 0 1682908) 1684881) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1682908) 1682980) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon32_Then_correct  (=> inline$$1_CRSN_has_crsn$1$$t1@1 (and (=> (= (ControlFlow 0 1682886) 1684931) inline$$1_CRSN_check$0$anon33_Then_correct) (=> (= (ControlFlow 0 1682886) 1682908) inline$$1_CRSN_check$0$anon33_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon32_Else_correct  (=> (and (and (not inline$$1_CRSN_has_crsn$1$$t1@1) (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0)) (and (= inline$$1_CRSN_check$0$$t13@1 inline$$1_CRSN_check$0$$t15@0) (= (ControlFlow 0 1682876) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon31_Else_correct  (=> (and (not $abort_flag@17) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_check$0$$t15@0 1)) (and (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1))) (and (=> (= (ControlFlow 0 1682860) 1682886) inline$$1_CRSN_check$0$anon32_Then_correct) (=> (= (ControlFlow 0 1682860) 1682876) inline$$1_CRSN_check$0$anon32_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon31_Then_correct  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@16) (= (ControlFlow 0 1684947) 1682882))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_has_crsn$1$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (=> (and (= inline$$1_CRSN_has_crsn$1$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1)) (and (=> (= (ControlFlow 0 1682818) 1684947) inline$$1_CRSN_check$0$anon31_Then_correct) (=> (= (ControlFlow 0 1682818) 1682860) inline$$1_CRSN_check$0$anon31_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon0_correct  (=> (and (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t7@0)) 0) (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t16@0)) 0)) (=> (and (and (and (= inline$$1_CRSN_check$0$$t9@0 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0))) (= inline$$1_CRSN_check$0$$t10@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| inline$$1_CRSN_check$0$$t9@0)))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| inline$$1_CRSN_check$0$$t11@0) (= inline$$1_CRSN_check$0$$t11@0 (|$addr#$signer| _$t0))) (and (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (= (ControlFlow 0 1682824) 1682818)))) inline$$1_CRSN_has_crsn$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Then_correct|  (=> (and (and inline$$1_CRSN_has_crsn$0$$t1@1 (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0)))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t90@0| (- _$t1 (|$min_nonce#$1_CRSN_CRSN| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|))) (= (ControlFlow 0 1684953) 1682824))) inline$$1_CRSN_check$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= (ControlFlow 0 1681755) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Then_correct|  (=> (and (and (and inline$$Ge$0$dst@1 (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t98@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| (= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t98@1|)) (|$IsValid'u64'| 1003))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1|)))) (and (=> (= (ControlFlow 0 1681739) 1681759) |inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Then_correct|) (=> (= (ControlFlow 0 1681739) 1681755) |inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Else_correct|  (=> (and (and (not inline$$Ge$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= (ControlFlow 0 1681693) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else$1_correct|  (=> (|$IsValid'u64'| 1002) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 1681677) 1681739) |inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Then_correct|) (=> (= (ControlFlow 0 1681677) 1681693) |inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t94@1|)) (= (ControlFlow 0 1681637) 1681677)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else_correct|  (=> (not inline$$1_CRSN_has_crsn$0$$t1@1) (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t94@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|)) (= (ControlFlow 0 1681643) 1681637)) inline$$Ge$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Else_correct|  (=> (not $abort_flag@17) (and (=> (= (ControlFlow 0 1681585) 1684953) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Then_correct|) (=> (= (ControlFlow 0 1681585) 1681643) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Then_correct|  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@16) (= (ControlFlow 0 1685041) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_CRSN_has_crsn$0$anon0_correct  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= inline$$1_CRSN_has_crsn$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= inline$$1_CRSN_has_crsn$0$$t1@1 inline$$1_CRSN_has_crsn$0$$t1@1)) (and (=> (= (ControlFlow 0 1681571) 1685041) |inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Then_correct|) (=> (= (ControlFlow 0 1681571) 1681585) |inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Then_correct|  (=> (and inline$$Lt$1$dst@1 (= (ControlFlow 0 1681577) 1681571)) inline$$1_CRSN_has_crsn$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Else_correct|  (=> (and (and (not inline$$Lt$1$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= (ControlFlow 0 1681470) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else$1_correct|  (=> (|$IsValid'u64'| 1011) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| 8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= inline$$Lt$1$dst@1 inline$$Lt$1$dst@1))) (and (=> (= (ControlFlow 0 1681454) 1681577) |inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Then_correct|) (=> (= (ControlFlow 0 1681454) 1681470) |inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Else_correct|))))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$CastU128$2$dst@1 18446744073709551615)) (= (ControlFlow 0 1681414) 1681454)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|  (=> (not $abort_flag@17) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1681420) 1681414)) inline$$Lt$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@16) (= (ControlFlow 0 1685055) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$2$anon3_Then$1_correct  (=> (= $abort_code@16 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@17 true) (= inline$$CastU128$2$dst@1 inline$$CastU128$2$dst@0)) (and (=> (= (ControlFlow 0 1681354) 1685055) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|) (=> (= (ControlFlow 0 1681354) 1681420) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|))))))
(let ((inline$$CastU128$2$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1681352) 1681354)) inline$$CastU128$2$anon3_Then$1_correct)))
(let ((inline$$CastU128$2$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_code@16 $abort_code@15)) (and (= $abort_flag@17 $abort_flag@16) (= inline$$CastU128$2$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1681304) 1685055) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|) (=> (= (ControlFlow 0 1681304) 1681420) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Then_correct|  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 1681360) 1681352) inline$$CastU128$2$anon3_Then_correct) (=> (= (ControlFlow 0 1681360) 1681304) inline$$CastU128$2$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Else_correct|  (=> (and (and (not inline$$Lt$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= (ControlFlow 0 1681231) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else$1_correct|  (=> (|$IsValid'u64'| 1006) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 1681215) 1681360) |inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Then_correct|) (=> (= (ControlFlow 0 1681215) 1681231) |inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Else_correct|))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0| _$t5)) (= (ControlFlow 0 1681175) 1681215)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0|) (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0| (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)) (= (ControlFlow 0 1681181) 1681175))) inline$$Lt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|) (= (ControlFlow 0 1685081) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1681113) 1685081) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Then_correct|) (=> (= (ControlFlow 0 1681113) 1681181) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Then_correct|  (=> (and (and inline$$Ge$2$dst@1 (= $abort_flag@16 $abort_flag@15)) (and (= $abort_code@15 $abort_code@14) (= (ControlFlow 0 1686157) 1681113))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= inline$$Ge$2$dst@1 inline$$Ge$2$dst@1))) (and (=> (= (ControlFlow 0 1686137) 1686157) |inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Then_correct|) (=> (= (ControlFlow 0 1686137) 1686153) |inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Else_correct|))))))
(let ((inline$$Ge$2$anon0_correct  (=> (and (= inline$$Ge$2$dst@1 (>= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| inline$$MulU64$0$dst@2)) (= (ControlFlow 0 1686097) 1686137)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|  (=> (not $abort_flag@15) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@1|) (= (ControlFlow 0 1686103) 1686097)) inline$$Ge$2$anon0_correct))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@14) (=> (and (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_code@14 $abort_code@13)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_flag@15 $abort_flag@14))) (and (=> (= (ControlFlow 0 1685955) 1686171) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|) (=> (= (ControlFlow 0 1685955) 1686103) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$L3_correct|  (=> (= $abort_code@14 |inline$$1_DiemAccount_balance'#0'$0$$t6@1|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@0|) (= $abort_flag@15 true)) (and (=> (= (ControlFlow 0 1685624) 1686171) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|) (=> (= (ControlFlow 0 1685624) 1686103) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@14 (= $abort_code@13 $abort_code@13)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@13) (= (ControlFlow 0 1685969) 1685624))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@13) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $abort_flag@14 $abort_flag@13) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_Diem_value'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1685913) 1685969) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1685913) 1685955) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|  (=> (and (and $abort_flag@13 (= $abort_code@13 $abort_code@13)) (and (= $abort_flag@14 true) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1685931) 1685969) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1685931) 1685955) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1685889) 1685931) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1685889) 1685913) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|) (=> (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'#0'| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|)) (= (ControlFlow 0 1685895) 1685889)) |inline$$1_Diem_value'#0'$0$anon0_correct|))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@13) (= (ControlFlow 0 1685937) 1685895)) |inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|  (=> (and (and $abort_flag@13 (= $abort_code@13 $abort_code@13)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@13) (= (ControlFlow 0 1685983) 1685624))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|  (=> (= $abort_flag@13 true) (=> (and (= $abort_code@13 $EXEC_FAILURE_CODE) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@0|)) (and (=> (= (ControlFlow 0 1686035) 1685983) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1686035) 1685937) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= (ControlFlow 0 1686033) 1686035)) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (and (= |inline$$1_DiemAccount_balance'#0'$0$$t7@1| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= $abort_flag@13 $abort_flag@12)) (and (= $abort_code@13 $abort_code@12) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@1|))) (and (=> (= (ControlFlow 0 1685642) 1685983) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1685642) 1685937) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|  (=> |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (and (=> (= (ControlFlow 0 1685628) 1686033) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 1685628) 1685642) |inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_balance'#0'$0$$t3@1|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= (ControlFlow 0 1685618) 1685624))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (|$IsValid'u64'| 19)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| 5)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| |inline$$1_DiemAccount_balance'#0'$0$$t3@1|))) (and (=> (= (ControlFlow 0 1685602) 1685628) |inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 1685602) 1685618) |inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| (= (ControlFlow 0 1686041) 1685602)) |inline$$1_DiemAccount_balance'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Then_correct|  (=> |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (|$IsValid'u64'| 1005)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1|))) (and (=> (= (ControlFlow 0 1685268) 1686041) |inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Then_correct|) (=> (= (ControlFlow 0 1685268) 1685284) |inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Else_correct|  (=> (and (not $abort_flag@12) (|$IsValid'u64'| 1012)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1685210) 1685268) |inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Then_correct|) (=> (= (ControlFlow 0 1685210) 1685226) |inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Else_correct|))))))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1685164) 1686185) |inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Then_correct|) (=> (= (ControlFlow 0 1685164) 1685210) |inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|  (=> (and inline$$Gt$0$dst@1 (= (ControlFlow 0 1685170) 1685164)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|  (=> (and (and (not inline$$Gt$0$dst@1) (= $abort_flag@16 $abort_flag@12)) (and (= $abort_code@15 $abort_code@12) (= (ControlFlow 0 1681101) 1681113))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> inline$$MulU64$0$dst@2 0)) (and (=> (= (ControlFlow 0 1681087) 1685170) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|) (=> (= (ControlFlow 0 1681087) 1681101) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|  (=> (and (and (not $abort_flag@12) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@2)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1681093) 1681087))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@12) (= (ControlFlow 0 1686199) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$MulU64$0$anon3_Then$1_correct  (=> (= $abort_code@12 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@12 true) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@0)) (and (=> (= (ControlFlow 0 1681019) 1686199) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|) (=> (= (ControlFlow 0 1681019) 1681093) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|))))))
(let ((inline$$MulU64$0$anon3_Then_correct  (=> (and (> (* _$t3 _$t4) $MAX_U64) (= (ControlFlow 0 1681017) 1681019)) inline$$MulU64$0$anon3_Then$1_correct)))
(let ((inline$$MulU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (* _$t3 _$t4)) (=> (and (and (= inline$$MulU64$0$dst@1 (* _$t3 _$t4)) (= $abort_code@12 $abort_code@11)) (and (= $abort_flag@12 $abort_flag@11) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@1))) (and (=> (= (ControlFlow 0 1680965) 1686199) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|) (=> (= (ControlFlow 0 1680965) 1681093) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 1681025) 1681017) inline$$MulU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 1681025) 1680965) inline$$MulU64$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|  (=> (and (and (not inline$$Le$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= (ControlFlow 0 1680868) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1680852) 1681025) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|) (=> (= (ControlFlow 0 1680852) 1680868) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 1680812) 1680852)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|  (=> (not $abort_flag@11) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1680818) 1680812)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@11) (= (ControlFlow 0 1686213) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_flag@11 true) (=> (and (= $abort_code@11 $EXEC_FAILURE_CODE) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 1680752) 1686213) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1680752) 1680818) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 1680750) 1680752)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_flag@11 $abort_flag@10)) (and (= $abort_code@11 $abort_code@10) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 1680698) 1686213) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1680698) 1680818) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|  (=> (not $abort_flag@10) (and (=> (= (ControlFlow 0 1680758) 1680750) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1680758) 1680698) inline$$MulU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|  (=> (and (and $abort_flag@10 (= $abort_code@10 $abort_code@10)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@10) (= (ControlFlow 0 1686227) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@10 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@10 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 1680591) 1686227) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|) (=> (= (ControlFlow 0 1680591) 1680758) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t4 $MAX_U128) (= (ControlFlow 0 1680589) 1680591)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t4) (= $abort_code@10 $abort_code@9)) (and (= $abort_flag@10 $abort_flag@9) (= inline$$CastU128$1$dst@1 _$t4))) (and (=> (= (ControlFlow 0 1680541) 1686227) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|) (=> (= (ControlFlow 0 1680541) 1680758) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 1680597) 1680589) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 1680597) 1680541) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|  (=> (and (and $abort_flag@9 (= $abort_code@9 $abort_code@9)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@9) (= (ControlFlow 0 1686241) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@9 true) (=> (and (= $abort_code@9 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 1680458) 1686241) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|) (=> (= (ControlFlow 0 1680458) 1680597) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t3 $MAX_U128) (= (ControlFlow 0 1680456) 1680458)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t3) (= $abort_flag@9 $abort_flag@8)) (and (= $abort_code@9 $abort_code@8) (= inline$$CastU128$0$dst@1 _$t3))) (and (=> (= (ControlFlow 0 1680408) 1686241) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|) (=> (= (ControlFlow 0 1680408) 1680597) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| (and (=> (= (ControlFlow 0 1680464) 1680456) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1680464) 1680408) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= (ControlFlow 0 1680335) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|  (=> (and (and (and (not $abort_flag@8) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t54@1| (|$authentication_key#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| (|$IsEqual'vec'u8''| call1formal@res@0 |inline$$1_DiemAccount_prologue_common'#0'$0$$t54@1|)) (|$IsValid'u64'| 1001))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1|)))) (and (=> (= (ControlFlow 0 1680319) 1680464) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|) (=> (= (ControlFlow 0 1680319) 1680335) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|  (=> (and (and $abort_flag@8 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@8) (= (ControlFlow 0 1686255) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|  (=> (not $abort_flag@8) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|) (= call1formal@res@0 ($1_Hash_sha3 _$t2))) (and (|$IsValid'vec'u8''| call1formal@res@0) (= (|l#Vec_33444| call1formal@res@0) 32))) (and (=> (= (ControlFlow 0 1680271) 1686255) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|) (=> (= (ControlFlow 0 1680271) 1680319) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|  (=> (and (and $abort_flag@8 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@8) (= (ControlFlow 0 1686269) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then$1_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@0|) (=> (and (= $abort_code@8 $EXEC_FAILURE_CODE) (= $abort_flag@8 true)) (and (=> (= (ControlFlow 0 1686321) 1686269) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|) (=> (= (ControlFlow 0 1686321) 1680271) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= (ControlFlow 0 1686319) 1686321)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1|)) (and (= $abort_code@8 $abort_code@7) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 1680255) 1686269) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|) (=> (= (ControlFlow 0 1680255) 1680271) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 1680241) 1686319) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|) (=> (= (ControlFlow 0 1680241) 1680255) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|  (=> (and (and (not inline$$Not$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= (ControlFlow 0 1680237) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then$1_correct|  (=> (|$IsValid'u64'| 1000) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| 1)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1680221) 1680241) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|) (=> (= (ControlFlow 0 1680221) 1680237) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t48@0|)) (= (ControlFlow 0 1680181) 1680221)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t48@0|  (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)))) (= (ControlFlow 0 1680187) 1680181)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= (ControlFlow 0 1680133) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|  (=> (and (not $abort_flag@7) (|$IsValid'u64'| 1004)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 1680117) 1680187) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|) (=> (= (ControlFlow 0 1680117) 1680133) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@7) (= (ControlFlow 0 1686335) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 1680075) 1686335) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|) (=> (= (ControlFlow 0 1680075) 1680117) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| (= (ControlFlow 0 1680081) 1680075)) inline$$1_DiemAccount_exists_at$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= (ControlFlow 0 1679968) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|  (=> (not $abort_flag@7) (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| (= inline$$1_ChainId_get$0$$ret0@1 _$t6)) (|$IsValid'u64'| 1007)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1|))) (and (=> (= (ControlFlow 0 1679952) 1680081) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|) (=> (= (ControlFlow 0 1679952) 1679968) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@7) (= (ControlFlow 0 1686349) 1679974))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_ChainId_get$0$L2_correct  (=> (= $abort_flag@7 true) (=> (and (= $abort_code@7 inline$$1_ChainId_get$0$$t1@1) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$ret0@0)) (and (=> (= (ControlFlow 0 1679826) 1686349) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1679826) 1679952) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon10_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@6 $abort_code@6)) (and (= inline$$1_ChainId_get$0$$t1@1 $abort_code@6) (= (ControlFlow 0 1679820) 1679826))) inline$$1_ChainId_get$0$L2_correct)))
(let ((inline$$1_ChainId_get$0$anon8_Then_correct  (=> inline$$1_ChainId_get$0$$t0@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ChainId_get$0$$t1@0)) (= inline$$1_ChainId_get$0$$t1@0 inline$$1_ChainId_get$0$$t1@0)) (and (= inline$$1_ChainId_get$0$$t1@1 inline$$1_ChainId_get$0$$t1@0) (= (ControlFlow 0 1679904) 1679826))) inline$$1_ChainId_get$0$L2_correct))))
(let ((inline$$1_ChainId_get$0$anon10_Else_correct  (=> (and (not $abort_flag@6) (= inline$$1_ChainId_get$0$$t4@1 (|$id#$1_ChainId_ChainId| inline$$1_ChainId_get$0$$t3@2))) (=> (and (and (= inline$$1_ChainId_get$0$$t4@1 inline$$1_ChainId_get$0$$t4@1) (= $abort_flag@7 $abort_flag@6)) (and (= $abort_code@7 $abort_code@6) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$t4@1))) (and (=> (= (ControlFlow 0 1679806) 1686349) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1679806) 1679952) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon9_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@6 true) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@0)) (and (=> (= (ControlFlow 0 1679878) 1679820) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1679878) 1679806) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon9_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= (ControlFlow 0 1679876) 1679878)) inline$$1_ChainId_get$0$anon9_Then$1_correct)))
(let ((inline$$1_ChainId_get$0$anon9_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816) (=> (and (and (= inline$$1_ChainId_get$0$$t3@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@6 $abort_flag@5) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@1))) (and (=> (= (ControlFlow 0 1679784) 1679820) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1679784) 1679806) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon8_Else_correct  (=> (and (not inline$$1_ChainId_get$0$$t0@0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 1679770) 1679876) inline$$1_ChainId_get$0$anon9_Then_correct) (=> (= (ControlFlow 0 1679770) 1679784) inline$$1_ChainId_get$0$anon9_Else_correct)))))
(let ((inline$$1_ChainId_get$0$anon0_correct  (=> (= inline$$1_ChainId_get$0$$t0@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1679756) 1679904) inline$$1_ChainId_get$0$anon8_Then_correct) (=> (= (ControlFlow 0 1679756) 1679770) inline$$1_ChainId_get$0$anon8_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| (|$addr#$signer| _$t0)) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t38@0| (* _$t3 _$t4)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2))) (=> (and (and (and (= _$t3 _$t3) (= _$t4 _$t4)) (and (= _$t5 _$t5) (= _$t6 _$t6))) (and (and (|$IsValid'address'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (= (ControlFlow 0 1679910) 1679756)))) inline$$1_ChainId_get$0$anon0_correct)))))
(let ((anon10_Then_correct  (=> (and (and inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1 (= $t16 (|$addr#$signer| _$t0))) (and (= $t17 (* _$t3 _$t4)) (= (ControlFlow 0 1686353) 1679910))) |inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|)))
(let ((anon10_Else_correct  (=> (and (and (not inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1) (= $t15 $t15)) (and (= $t13@0 $t15) (= (ControlFlow 0 1676732) 1677328))) L3_correct)))
(let ((anon9_Else_correct  (=> (and (not $abort_flag@5) (|$IsValid'u64'| 1009)) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 1)) (and (= $t15 $t15) (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1))) (and (=> (= (ControlFlow 0 1676716) 1686353) anon10_Then_correct) (=> (= (ControlFlow 0 1676716) 1676732) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@5 $abort_code@5)) (and (= $t13@0 $abort_code@5) (= (ControlFlow 0 1686745) 1677328))) L3_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L5_correct  (=> (= $abort_flag@5 true) (=> (and (= $abort_code@5 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@1) (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@0)) (and (=> (= (ControlFlow 0 1676624) 1686745) anon9_Then_correct) (=> (= (ControlFlow 0 1676624) 1676716) anon9_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1676618) 1676624))) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L5_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon7_Then_correct  (=> inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t4@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@0)) (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@0 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@1 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t5@0) (= (ControlFlow 0 1676670) 1676624))) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L5_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L3_correct  (=> (and (and (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t1@1 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t1@1) (= $abort_flag@5 $abort_flag@4)) (and (= $abort_code@5 $abort_code@4) (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t1@1))) (and (=> (= (ControlFlow 0 1676604) 1686745) anon9_Then_correct) (=> (= (ControlFlow 0 1676604) 1676716) anon9_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Else_correct  (=> (and (not $abort_flag@3) (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_diem_root_role$0$$ret0@1)) (=> (and (and (= $abort_flag@4 $abort_flag@3) (= $abort_code@4 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t1@1 inline$$1_Roles_has_diem_root_role$0$$ret0@1) (= (ControlFlow 0 1676592) 1676604))) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L3_correct))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 1676552) 1676618) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Then_correct) (=> (= (ControlFlow 0 1676552) 1676592) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Else_correct)))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_diem_root_role$0$$ret0@0) (= $abort_flag@3 true))) (and (=> (= (ControlFlow 0 1676570) 1676618) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Then_correct) (=> (= (ControlFlow 0 1676570) 1676592) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon9_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= $abort_code@3 $abort_code@1)) (and (= $abort_flag@2 true) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@0))) (and (=> (= (ControlFlow 0 1676476) 1676570) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1676476) 1676552) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$L3_correct  (=> (and (and (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t2@1) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$t2@1))) (and (=> (= (ControlFlow 0 1676412) 1676570) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1676412) 1676552) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Else_correct  (=> (and (and (and (not $abort_flag@0) (= inline$$1_Roles_has_role$0$$t8@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$0$$t6@2))) (and (= inline$$1_Roles_has_role$0$$t9@1 (= inline$$1_Roles_has_role$0$$t8@1 0)) (= inline$$1_Roles_has_role$0$$t9@1 inline$$1_Roles_has_role$0$$t9@1))) (and (and (= $abort_code@2 $abort_code@1) (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t9@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 1676458) 1676412)))) inline$$1_Roles_has_role$0$L3_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@0)) (and (=> (= (ControlFlow 0 1676528) 1676476) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1676528) 1676458) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= (ControlFlow 0 1676526) 1676528)) inline$$1_Roles_has_role$0$anon10_Then$1_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@1))) (and (=> (= (ControlFlow 0 1676430) 1676476) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1676430) 1676458) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon9_Then_correct  (=> inline$$1_Roles_has_role$0$$t5@1 (and (=> (= (ControlFlow 0 1676416) 1676526) inline$$1_Roles_has_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 1676416) 1676430) inline$$1_Roles_has_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct  (=> (and (not inline$$1_Roles_has_role$0$$t5@1) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= inline$$1_Roles_has_role$0$$t2@1 false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 1676400) 1676412))) inline$$1_Roles_has_role$0$L3_correct))))
(let ((inline$$1_Roles_has_role$0$anon0_correct  (=> (and (= _$t0 _$t0) (= 0 0)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t4@0 (|$addr#$signer| _$t0))) (and (= inline$$1_Roles_has_role$0$$t4@0 inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t5@1 (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)))) (and (=> (= (ControlFlow 0 1676380) 1676416) inline$$1_Roles_has_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 1676380) 1676400) inline$$1_Roles_has_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1676534) 1676380)) inline$$1_Roles_has_role$0$anon0_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon8_Else_correct  (=> (and (not inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t6@1) (= (ControlFlow 0 1676576) 1676534)) inline$$1_Roles_has_diem_root_role$0$anon0_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon8_Then_correct  (=> (and inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t6@1 (= true true)) (=> (and (and (= $abort_flag@4 false) (= $abort_code@4 $abort_code@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$$t1@1 true) (= (ControlFlow 0 1676642) 1676604))) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$L3_correct))))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@5))
 ...
 :qid |DiemAccountbpl.75002:20|
 :skolemid |2775|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@6))
)))) (and (and (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@7)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc@@7))
 :qid |DiemAccountbpl.75006:20|
 :skolemid |2776|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@7))
)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (* _$t3 _$t4)) (= $t11 (|$addr#$signer| _$t0))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (= _$t5 _$t5)) (and (= _$t6 _$t6) (= (ControlFlow 0 1676676) 1675866))))))) inline$$1_DiemTransactionPublishingOption_is_module_allowed$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1674030) 1676676)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2445153) 1674030) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
