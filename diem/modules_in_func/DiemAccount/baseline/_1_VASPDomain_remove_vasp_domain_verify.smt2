...
(declare-fun $t35@0 () T@$Mutation_464575)
(declare-fun $t37@0 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun $t34@1 () T@$Mutation_532783)
...
(declare-fun $t34 () T@$Mutation_532783)
(declare-fun $t34@0 () T@$Mutation_532783)
...
(declare-fun $t24@2 () T@$Mutation_532718)
(declare-fun $t24@1 () T@$Mutation_532718)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| () T@$Mutation_443377)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@0| () T@$Mutation_443377)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_422523)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_443377)
(declare-fun $t31@0 () T@$Mutation_443377)
...
(declare-fun $t26@0 () T@Vec_422523)
...
(declare-fun $t24 () T@$Mutation_532718)
(declare-fun $t24@0 () T@$Mutation_532718)
...
(declare-fun $t7 () T@$Mutation_532718)
(declare-fun $t31 () T@$Mutation_443377)
(declare-fun $t35 () T@$Mutation_464575)
(push 1)
(set-info :boogie-vc-id $1_VASPDomain_remove_vasp_domain$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2072810) (let ((anon46_Else_correct  (=> (and (not $abort_flag@3) (= $t38 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075793)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075804)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075814)) (not (not (exists ((i@@135 Int) ) (!  (and (and (|$IsValid'u64'| i@@135) (InRangeVec_385170 $t11 i@@135)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t11) i@@135)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))))) (=> (not (not (exists ((i@@136 Int) ) (!  (and (and (|$IsValid'u64'| i@@136) (InRangeVec_385170 $t11 i@@136)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t11) i@@136)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075828)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075840)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075858)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075872)) (not (> (|l#Vec_33444| _$t2) 63))) (=> (not (> (|l#Vec_33444| _$t2) 63)) (and (=> (= (ControlFlow 0 1123872) (- 0 2075884)) (not (exists ((i@@137 Int) ) (!  (and (and (|$IsValid'u64'| i@@137) (InRangeVec_385170 $t38 i@@137)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t38) i@@137)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)))) (=> (not (exists ((i@@138 Int) ) (!  (and (and (|$IsValid'u64'| i@@138) (InRangeVec_385170 $t38 i@@138)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t38) i@@138)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (and (=> (= (ControlFlow 0 1123872) (- 0 2075896)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14) (+ cnt 1)) (+ len 1))))))
...
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (=> (= (ControlFlow 0 1123872) (- 0 2075921)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t14) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 1122230) (- 0 2075581)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (not (exists ((i@@139 Int) ) (!  (and (and (|$IsValid'u64'| i@@139) (InRangeVec_385170 $t11 i@@139)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t11) i@@139)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (|l#Vec_33444| _$t2) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (not (exists ((i@@140 Int) ) (!  (and (and (|$IsValid'u64'| i@@140) (InRangeVec_385170 $t11 i@@140)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t11) i@@140)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (> (|l#Vec_33444| _$t2) 63)) (=> (= (ControlFlow 0 1122230) (- 0 2075649)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= 5 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $t17@0))) (and (not (exists ((i@@141 Int) ) (!  (and (and (|$IsValid'u64'| i@@141) (InRangeVec_385170 $t11 i@@141)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $t11) i@@141)) (|$domain#$1_VASPDomain_VASPDomain| ($1_VASPDomain_VASPDomain _$t2))))
 :qid |DiemAccountbpl.1893:13|
 :skolemid |70|
))) (= 7 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) (= 5 $t17@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17@0))) (and (> (|l#Vec_33444| _$t2) 63) (= 7 $t17@0))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 1123886) 1122230))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_464575| $t35@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t37@0))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t37@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1123682) 1123886) anon46_Then_correct) (=> (= (ControlFlow 0 1123682) 1123872) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (and (and (not $abort_flag@3) (= $t35@0 ($Mutation_464575 (|l#$Mutation_532783| $t34@1) (let ((l (|l#Vec_33444| (|p#$Mutation_532783| $t34@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_532783| $t34@1)) l 0) (+ l 1))) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_532783| $t34@1))))) (and (= $t37@0 ($1_VASPDomain_VASPDomainEvent true inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 1123688) 1123682))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 1123900) 1122230))) L7_correct)))
(let ((anon44_Then$1_correct  (=> (= $t34@1 $t34) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1123952) 1123900) anon45_Then_correct) (=> (= (ControlFlow 0 1123952) 1123688) anon45_Else_correct))))))
(let ((anon44_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 1123950) 1123952)) anon44_Then$1_correct)))
(let ((anon44_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (=> (and (and (= $t34@0 ($Mutation_532783 ($Global 186537453) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (= $t34@1 $t34@0)) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 1123573) 1123900) anon45_Then_correct) (=> (= (ControlFlow 0 1123573) 1123688) anon45_Else_correct))))))
(let ((anon43_Else_correct  (=> (and (not $abort_flag@2) (= $t24@2 ($Mutation_532718 (|l#$Mutation_532718| $t24@1) (|p#$Mutation_532718| $t24@1) ($1_VASPDomain_VASPDomains (|v#$Mutation_443377| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2|))))) (and (=> (= (ControlFlow 0 1123551) (- 0 2075143)) (let (($range_0 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@142 $i_1))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) i@@142))) 63)))
 :qid |DiemAccountbpl.19748:107|
 :skolemid |456|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@143 $i_1@@0))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) i@@143))) 63)))
 :qid |DiemAccountbpl.19748:107|
 :skolemid |456|
))) (and (=> (= (ControlFlow 0 1123551) (- 0 2075191)) (let (($range_0@@1 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@144 $i_1@@1))
(let (($range_2 ($Range (+ i@@144 1) (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@43 $i_3))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) i@@144)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) j@@43))))))
 :qid |DiemAccountbpl.19756:112|
 :skolemid |457|
)))))
 :qid |DiemAccountbpl.19755:107|
 :skolemid |458|
)))) (=> (let (($range_0@@2 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@145 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@145 1) (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@44 $i_3@@0))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) i@@145)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))) j@@44))))))
 :qid |DiemAccountbpl.19756:112|
 :skolemid |457|
)))))
 :qid |DiemAccountbpl.19755:107|
 :skolemid |458|
))) (and (=> (= (ControlFlow 0 1123551) (- 0 2075276)) (let (($range_0@@3 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))
(forall (($i_1@@3 Int) ) (!  (=> (InRangeVec_385170 $range_0@@3 $i_1@@3) (let (($elem (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $range_0@@3) $i_1@@3)))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |DiemAccountbpl.19763:88|
 :skolemid |459|
)))) (=> (let (($range_0@@4 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@2))))
(forall (($i_1@@4 Int) ) (!  (=> (InRangeVec_385170 $range_0@@4 $i_1@@4) (let (($elem@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $range_0@@4) $i_1@@4)))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| $elem@@0)) 63)))
 :qid |DiemAccountbpl.19763:88|
 :skolemid |459|
))) (=> (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_487410 (|Store__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_532718| $t24@2)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_532718| $t24@2)) (|v#$Mutation_532718| $t24@2)))) (and (=> (= (ControlFlow 0 1123551) (- 0 2075334)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory@0) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |DiemAccountbpl.19775:15|
 :skolemid |460|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory@0) addr@@0)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0)) 5))))
 :qid |DiemAccountbpl.19775:15|
 :skolemid |460|
)) (=> (|$IsValid'address'| 186537453) (and (=> (= (ControlFlow 0 1123551) 1123950) anon44_Then_correct) (=> (= (ControlFlow 0 1123551) 1123573) anon44_Else_correct)))))))))))))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 1123966) 1122230))) L7_correct)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@0|)) (and (=> (= (ControlFlow 0 1123296) 1123966) anon43_Then_correct) (=> (= (ControlFlow 0 1123296) 1123551) anon43_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_385170 |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|)) (= (ControlFlow 0 1123294) 1123296)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (and (InRangeVec_385170 |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$e@1| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|))) (=> (and (and (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_443377 (|l#$Mutation_443377| $t31@0) (|p#$Mutation_443377| $t31@0) (let ((l@@0 (- (|l#Vec_422523| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) 1)))
(Vec_422523 (|lambda#26| 0 l@@0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (|v#Vec_422523| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) (|v#Vec_422523| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) 1 DefaultVecElem_385190) l@@0)))) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@2| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1|))) (and (=> (= (ControlFlow 0 1123244) 1123966) anon43_Then_correct) (=> (= (ControlFlow 0 1123244) 1123551) anon43_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (|v#$Mutation_443377| $t31@0)) (and (=> (= (ControlFlow 0 1123220) 1123294) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1123220) 1123244) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((anon42_Then_correct  (=> |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| (=> (and (= $t31@0 ($Mutation_443377 (|l#$Mutation_532718| $t24@1) (let ((l@@1 (|l#Vec_33444| (|p#$Mutation_532718| $t24@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_532718| $t24@1)) l@@1 0) (+ l@@1 1))) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1)))) (= (ControlFlow 0 1123304) 1123220)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((anon42_Else_correct  (=> (not |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|) (and (=> (= (ControlFlow 0 1123109) (- 0 2074807)) (let (($range_0@@5 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@146 $i_1@@5))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) i@@146))) 63)))
 :qid |DiemAccountbpl.19680:107|
 :skolemid |452|
)))) (=> (let (($range_0@@6 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((i@@147 $i_1@@6))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) i@@147))) 63)))
 :qid |DiemAccountbpl.19680:107|
 :skolemid |452|
))) (and (=> (= (ControlFlow 0 1123109) (- 0 2074855)) (let (($range_0@@7 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((i@@148 $i_1@@7))
(let (($range_2@@1 ($Range (+ i@@148 1) (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_3@@1 Int) ) (!  (=> ($InRange $range_2@@1 $i_3@@1) (let ((j@@45 $i_3@@1))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) i@@148)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) j@@45))))))
 :qid |DiemAccountbpl.19688:112|
 :skolemid |453|
)))))
 :qid |DiemAccountbpl.19687:107|
 :skolemid |454|
)))) (=> (let (($range_0@@8 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((i@@149 $i_1@@8))
(let (($range_2@@2 ($Range (+ i@@149 1) (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))))
(forall (($i_3@@2 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@2) (let ((j@@46 $i_3@@2))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) i@@149)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) j@@46))))))
 :qid |DiemAccountbpl.19688:112|
 :skolemid |453|
)))))
 :qid |DiemAccountbpl.19687:107|
 :skolemid |454|
))) (and (=> (= (ControlFlow 0 1123109) (- 0 2074940)) (let (($range_0@@9 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))
(forall (($i_1@@9 Int) ) (!  (=> (InRangeVec_385170 $range_0@@9 $i_1@@9) (let (($elem@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $range_0@@9) $i_1@@9)))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| $elem@@1)) 63)))
 :qid |DiemAccountbpl.19695:88|
 :skolemid |455|
)))) (=> (let (($range_0@@10 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))))
(forall (($i_1@@10 Int) ) (!  (=> (InRangeVec_385170 $range_0@@10 $i_1@@10) (let (($elem@@2 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $range_0@@10) $i_1@@10)))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| $elem@@2)) 63)))
 :qid |DiemAccountbpl.19695:88|
 :skolemid |455|
))) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t30)) (=> (and (and (= $t30 7) (= $t30 $t30)) (and (= $t17@0 $t30) (= (ControlFlow 0 1123109) 1122230))) L7_correct)))))))))))
(let ((anon41_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 1122899) 1123304) anon42_Then_correct) (=> (= (ControlFlow 0 1122899) 1123109) anon42_Else_correct))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 1123980) 1122230))) L7_correct)))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 1122859) 1123980) anon41_Then_correct) (=> (= (ControlFlow 0 1122859) 1122899) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 1122869) 1123980) anon41_Then_correct) (=> (= (ControlFlow 0 1122869) 1122899) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| (|$IndexOfVec'$1_VASPDomain_VASPDomain'| $t26@0 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (=> (= (ControlFlow 0 1122847) 1122869) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1122847) 1122859) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((anon40_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= $t26@0 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_532718| $t24@1))) (= (ControlFlow 0 1122877) 1122847))) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 1123994) 1122230))) L7_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 1122710) 1123994) anon40_Then_correct) (=> (= (ControlFlow 0 1122710) 1122877) anon40_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 1122704) 1122710))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 1122742) 1122710))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t2))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 1122728) 1123994) anon40_Then_correct) (=> (= (ControlFlow 0 1122728) 1122877) anon40_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1122688) 1122728) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 1122688) 1122704) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 1122652) 1122688)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 1122658) 1122652)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_33444| _$t2)) (and (=> (= (ControlFlow 0 1122592) 1122742) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 1122592) 1122658) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 1122598) 1122592)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon39_Else_correct  (=> (and (and (not $abort_flag@0) (= |$temp_0'$1_VASPDomain_VASPDomains'@0| (|v#$Mutation_532718| $t24@1))) (and (= |$temp_0'$1_VASPDomain_VASPDomains'@0| |$temp_0'$1_VASPDomain_VASPDomains'@0|) (= (ControlFlow 0 1122748) 1122598))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct)))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 1124008) 1122230))) L7_correct)))
(let ((anon38_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1124060) 1124008) anon39_Then_correct) (=> (= (ControlFlow 0 1124060) 1122748) anon39_Else_correct))))))
(let ((anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= (ControlFlow 0 1124058) 1124060)) anon38_Then$1_correct)))
(let ((anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1) (=> (and (and (= $t24@0 ($Mutation_532718 ($Global _$t1) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1122314) 1124008) anon39_Then_correct) (=> (= (ControlFlow 0 1122314) 1122748) anon39_Else_correct))))))
(let ((anon37_Then_correct  (=> $t21@0 (and (=> (= (ControlFlow 0 1122292) 1124058) anon38_Then_correct) (=> (= (ControlFlow 0 1122292) 1122314) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 1122288) 1122230))) L7_correct)))
(let ((anon36_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= $t21@0 (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 5)) (and (= $t23 $t23) (= $t21@0 $t21@0))) (and (=> (= (ControlFlow 0 1122272) 1122292) anon37_Then_correct) (=> (= (ControlFlow 0 1122272) 1122288) anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (and (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 1122014) 1122230))) L7_correct)))
(let ((anon35_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 5)) (and (= $t20 $t20) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 1121998) 1122272) anon36_Then_correct) (=> (= (ControlFlow 0 1121998) 1122014) anon36_Else_correct))))))
(let ((anon34_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 1124146) 1122230))) L7_correct))))
(let ((anon35_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 1121956) 1124074) anon35_Then_correct) (=> (= (ControlFlow 0 1121956) 1121998) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (not $t16) (= (ControlFlow 0 1121962) 1121956)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct)))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 :qid |DiemAccountbpl.19322:20|
 :skolemid |419|
 ...
 :qid |DiemAccountbpl.19378:20|
 :skolemid |431|
)) (let (($range_0@@11 ($Range 0 (|l#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@14 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 ...
 :qid |DiemAccountbpl.19387:20|
 :skolemid |433|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@16)))
 :qid |DiemAccountbpl.19391:20|
 :skolemid |434|
))) (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) addr@@17)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@17)) 1))))
 :qid |DiemAccountbpl.19395:20|
 :skolemid |435|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) addr@@18)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18)) 5))))
 :qid |DiemAccountbpl.19399:20|
 :skolemid |436|
))))) (and (and (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@19)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19)) 2)))))
 :qid |DiemAccountbpl.19403:20|
 :skolemid |437|
)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) addr@@20)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20)) 2))))
 :qid |DiemAccountbpl.19407:20|
 :skolemid |438|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) addr@@21)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21)) 5)))))
 :qid |DiemAccountbpl.19411:20|
 :skolemid |439|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_472200| $1_SlidingNonce_SlidingNonce_$memory) addr@@22)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22)) 1)))))
 :qid |DiemAccountbpl.19415:20|
 :skolemid |440|
)))) (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |DiemAccountbpl.19419:20|
 :skolemid |441|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477551| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24)) 4))))
 :qid |DiemAccountbpl.19423:20|
 :skolemid |442|
))) (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@25)) 5))))
 :qid |DiemAccountbpl.19427:20|
 :skolemid |443|
)) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@26)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@26)) 6))))
 :qid |DiemAccountbpl.19431:20|
 :skolemid |444|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemAccountbpl.19443:20|
 :skolemid |445|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@0))
 :qid |DiemAccountbpl.19447:20|
 :skolemid |446|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) $a_0@@1)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@1) (and (and (let (($range_1 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@150 $i_2))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@150))) 63)))
 :qid |DiemAccountbpl.19452:140|
 :skolemid |447|
))) (let (($range_3 ($Range 0 (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@151 $i_4))
(let (($range_5 ($Range (+ i@@151 1) (|l#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@47 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@151)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) j@@47))))))
 :qid |DiemAccountbpl.19454:98|
 :skolemid |448|
)))))
 :qid |DiemAccountbpl.19453:202|
 :skolemid |449|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))
(forall (($i_8 Int) ) (!  (=> (InRangeVec_385170 $range_7 $i_8) (let (($elem@@3 (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_422523| $range_7) $i_8)))
(<= (|l#Vec_33444| (|$domain#$1_VASPDomain_VASPDomain| $elem@@3)) 63)))
 :qid |DiemAccountbpl.19455:229|
 :skolemid |450|
))))))
 :qid |DiemAccountbpl.19451:20|
 :skolemid |451|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) $a_0@@1))
)) (= $t11 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) _$t1)))))) (and (and (and (= $t12 (|$addr#$signer| _$t0)) (= $t13 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t14 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= $t15 (|$addr#$signer| _$t0)) (= $t16  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 1121869) 1124146) anon34_Then_correct) (=> (= (ControlFlow 0 1121869) 1121962) anon34_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1120789) 1121869)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_33444| (|p#$Mutation_532718| $t7)) 0) (= (|l#Vec_33444| (|p#$Mutation_532718| $t24)) 0)) (=> (and (and (= (|l#Vec_33444| (|p#$Mutation_443377| $t31)) 0) (= (|l#Vec_33444| (|p#$Mutation_532783| $t34)) 0)) (and (= (|l#Vec_33444| (|p#$Mutation_464575| $t35)) 0) (= (ControlFlow 0 1120799) 1120789))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2072810) 1120799) anon0_correct)))
