...
(push 1)
(set-info :boogie-vc-id $1_Diem_assert_is_SCS_currency$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 810804) (let ((anon10_Else_correct@@4 true))
(let ((anon10_Then_correct@@4  (=> |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| (and (=> (= (ControlFlow 0 545940) (- 0 811438)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 545940) (- 0 811459)) (forall ((addr@@206 Int) ) (!  (=> (|$IsValid'address'| addr@@206) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@206)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@206))))
 :qid |Diembpl.9050:15|
 :skolemid |346|
))) (=> (forall ((addr@@207 Int) ) (!  (=> (|$IsValid'address'| addr@@207) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@207)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@207))))
 :qid |Diembpl.9050:15|
 :skolemid |346|
)) (and (=> (= (ControlFlow 0 545940) (- 0 811488)) (forall ((addr@@208 Int) ) (!  (=> (|$IsValid'address'| addr@@208) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@208) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@208)))
 :qid |Diembpl.9055:15|
 :skolemid |347|
))) (=> (forall ((addr@@209 Int) ) (!  (=> (|$IsValid'address'| addr@@209) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@209) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@209)))
 :qid |Diembpl.9055:15|
 :skolemid |347|
)) (and (=> (= (ControlFlow 0 545940) (- 0 811513)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 545940) (- 0 811534)) (forall ((addr@@210 Int) ) (!  (=> (|$IsValid'address'| addr@@210) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@210)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@210))))
 :qid |Diembpl.9065:15|
 :skolemid |348|
))) (=> (forall ((addr@@211 Int) ) (!  (=> (|$IsValid'address'| addr@@211) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@211)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@211))))
 :qid |Diembpl.9065:15|
 :skolemid |348|
)) (and (=> (= (ControlFlow 0 545940) (- 0 811563)) (forall ((addr@@212 Int) ) (!  (=> (|$IsValid'address'| addr@@212) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@212) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@212)))
 :qid |Diembpl.9070:15|
 :skolemid |349|
))) (=> (forall ((addr@@213 Int) ) (!  (=> (|$IsValid'address'| addr@@213) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@213) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@213)))
 :qid |Diembpl.9070:15|
 :skolemid |349|
)) (and (=> (= (ControlFlow 0 545940) (- 0 811588)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 545940) (- 0 811609)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 545940) (- 0 811630)) (forall ((addr@@214 Int) ) (!  (=> (|$IsValid'address'| addr@@214) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@214) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@214))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@214))))
 :qid |Diembpl.9085:15|
 :skolemid |350|
))) (=> (forall ((addr@@215 Int) ) (!  (=> (|$IsValid'address'| addr@@215) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@215) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@215))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@215))))
 :qid |Diembpl.9085:15|
 :skolemid |350|
)) (=> (= (ControlFlow 0 545940) (- 0 811666)) (forall ((addr@@216 Int) ) (!  (=> (|$IsValid'address'| addr@@216) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@216) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@216)))
 :qid |Diembpl.9090:15|
 :skolemid |351|
))))))))))))))))))))))))
(let ((anon9_Else_correct@@3  (=> (and (not $abort_flag@2) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t6@@6) (= $t6@@6 1)) (and (= $t6@@6 $t6@@6) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 545654) 545940) anon10_Then_correct@@4) (=> (= (ControlFlow 0 545654) 545670) anon10_Else_correct@@4))))))
(let ((anon9_Then_correct@@3 true))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1|) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 545546) 545954) anon9_Then_correct@@3) (=> (= (ControlFlow 0 545546) 545654) anon9_Else_correct@@3))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t2@1| $abort_code@1@@5) (= (ControlFlow 0 545540) 545546))) |inline$$1_Diem_is_SCS_currency'#0'$0$L5_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$ret0@1| |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1|))) (and (=> (= (ControlFlow 0 545442) 545954) anon9_Then_correct@@3) (=> (= (ControlFlow 0 545442) 545654) anon9_Else_correct@@3)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|  (=> (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0) (=> (and (and (= $abort_code@2 $abort_code@1@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| inline$$Not$0$dst@1@@0)) (and (= $abort_flag@1 $abort_flag@0@@5) (= (ControlFlow 0 545526) 545442))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1|)) (= (ControlFlow 0 545508) 545526)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@0@@5) (=> (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t5@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2|)) (= (ControlFlow 0 545514) 545508)) inline$$Not$0$anon0_correct@@0))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|  (=> (= $abort_flag@0@@5 true) (=> (and (= $abort_code@1@@5 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@0|)) (and (=> (= (ControlFlow 0 545598) 545540) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 545598) 545514) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 545596) 545598)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then$1_correct|)))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $abort_flag@0@@5 false)) (and (= $abort_code@1@@5 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@2| |inline$$1_Diem_is_SCS_currency'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 545466) 545540) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 545466) 545514) |inline$$1_Diem_is_SCS_currency'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|  (=> (and |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 545452) 545596) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 545452) 545466) |inline$$1_Diem_is_SCS_currency'#0'$0$anon13_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|  (=> (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0@@5) (= |inline$$1_Diem_is_SCS_currency'#0'$0$$t0@1| false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 545430) 545442))) |inline$$1_Diem_is_SCS_currency'#0'$0$L3_correct|))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|  (=> (not false) (and (=> (= (ControlFlow 0 545410) 545452) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 545410) 545430) |inline$$1_Diem_is_SCS_currency'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct| true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 545396) 545612) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 545396) 545410) |inline$$1_Diem_is_SCS_currency'#0'$0$anon11_Else_correct|))))))
(let ((|inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|  (=> (= (ControlFlow 0 545402) 545396) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct@@0  (=> (and (not $t2@@3) (= (ControlFlow 0 545618) 545402)) |inline$$1_Diem_is_SCS_currency'#0'$0$anon0_correct|)))
(let ((anon8_Then_correct@@0 true))
(let ((anon0$1_correct@@12  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@8 Int) (mint_cap_owner2@@8 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@8) (=> (|$IsValid'address'| mint_cap_owner2@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@8)) (= mint_cap_owner1@@8 mint_cap_owner2@@8))))
 :qid |Diembpl.8933:88|
 :skolemid |342|
))) (=> (and (and (forall ((addr3@@8 Int) ) (!  (=> (|$IsValid'address'| addr3@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr3@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |Diembpl.8937:20|
 :skolemid |343|
)) (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@217) (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |Diembpl.8941:20|
 :skolemid |344|
))) (and (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@14)))
 ...
 :qid |Diembpl.8944:20|
 :skolemid |345|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@14))
)) (= $t2@@3  (not (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 545063) 545980) anon8_Then_correct@@0) (=> (= (ControlFlow 0 545063) 545618) anon8_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_215979| stream@@13) 0) (forall ((v@@51 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_215979| stream@@13) v@@51) 0)
 :qid |Diembpl.134:13|
 :skolemid |2|
))))
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 544900) 545063)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 810804) 544900) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
