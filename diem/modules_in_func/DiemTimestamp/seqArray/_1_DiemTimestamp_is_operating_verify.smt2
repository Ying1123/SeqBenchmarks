...
(assert (not
 (=> (= (ControlFlow 0 0) 202232) (let ((anon0$1_correct@@2  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@2)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@2))
 :qid |DiemTimestampbpl.3756:20|
 :skolemid |104|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@2))
))) (=> (and (and (|$IsValid'address'| 173345816) (= $t1@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (= $t1@0@@0 $t1@0@@0) (= (ControlFlow 0 147055) (- 0 202326)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_64028| stream@@3) 0) (forall ((v@@35 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_64028| stream@@3) v@@35) 0)
 :qid |DiemTimestampbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 146979) 147055)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 202232) 146979) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))
))
(check-sat)
(pop 1)
