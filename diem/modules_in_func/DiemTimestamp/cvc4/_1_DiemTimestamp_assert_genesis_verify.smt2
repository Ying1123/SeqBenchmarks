...
(assert (not
 (=> (= (ControlFlow 0 0) 201425) (let ((L3_correct  (and (=> (= (ControlFlow 0 146399) (- 0 201661)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 146399) (- 0 201666)) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3@0)))))))
(let ((anon7_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t5 $t5)) (and (= $t3@0 $t5) (= (ControlFlow 0 146371) 146399))) L3_correct)))
(let ((anon7_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 146415) (- 0 201626))) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))
(let ((anon6_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t5) (= $t5 1)) (and (= $t5 $t5) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 146355) 146415) anon7_Then_correct) (=> (= (ControlFlow 0 146355) 146371) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 146313) 146429) anon6_Then_correct) (=> (= (ControlFlow 0 146313) 146355) anon6_Else_correct)))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_DiemTimestamp_is_genesis$0$$t1@1)) (= (ControlFlow 0 146295) 146313)) inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct)))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_genesis$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 146301) 146295)) inline$$Not$0$anon0_correct))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemTimestampbpl.3426:20|
 :skolemid |101|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
)) (= (ControlFlow 0 146319) 146301)) inline$$1_DiemTimestamp_is_genesis$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_64028| stream@@0) 0) (forall ((v@@32 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_64028| stream@@0) v@@32) 0)
 :qid |DiemTimestampbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 146139) 146319)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 201425) 146139) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
