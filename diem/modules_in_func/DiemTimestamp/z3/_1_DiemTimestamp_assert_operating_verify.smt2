...
(assert (not
 (=> (= (ControlFlow 0 0) 201868) (let ((L3_correct@@0  (and (=> (= (ControlFlow 0 146711) (- 0 202079)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 146711) (- 0 202084)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t3@0@@0)))))))
(let ((anon7_Else_correct@@0  (=> (and (and (not inline$$1_DiemTimestamp_is_operating$0$$t1@1) (= $t5@@0 $t5@@0)) (and (= $t3@0@@0 $t5@@0) (= (ControlFlow 0 146683) 146711))) L3_correct@@0)))
(let ((anon7_Then_correct@@0  (=> (and inline$$1_DiemTimestamp_is_operating$0$$t1@1 (= (ControlFlow 0 146727) (- 0 202044))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))
(let ((anon6_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t5@@0) (= $t5@@0 1)) (and (= $t5@@0 $t5@@0) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1))) (and (=> (= (ControlFlow 0 146667) 146727) anon7_Then_correct@@0) (=> (= (ControlFlow 0 146667) 146683) anon7_Else_correct@@0))))))
(let ((anon6_Then_correct@@0 true))
(let ((inline$$1_DiemTimestamp_is_operating$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= inline$$1_DiemTimestamp_is_operating$0$$t1@1 inline$$1_DiemTimestamp_is_operating$0$$t1@1)) (and (=> (= (ControlFlow 0 146625) 146741) anon6_Then_correct@@0) (=> (= (ControlFlow 0 146625) 146667) anon6_Else_correct@@0))))))
(let ((anon0$1_correct@@0  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@0))
 :qid |DiemTimestampbpl.3537:20|
 :skolemid |102|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0))
)) (= (ControlFlow 0 146631) 146625)) inline$$1_DiemTimestamp_is_operating$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_64028| stream@@1) 0) (forall ((v@@33 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_64028| stream@@1) v@@33) 0)
 :qid |DiemTimestampbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 146494) 146631)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 201868) 146494) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))
))
(check-sat)
(pop 1)
