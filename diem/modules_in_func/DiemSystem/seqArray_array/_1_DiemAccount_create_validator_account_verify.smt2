...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@3 () T@$Memory_260857)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_260857)
(declare-fun inline$$1_ValidatorConfig_publish$0$$t9@1 () Int)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_260857)
...
(assert (not
 (=> (= (ControlFlow 0 0) 1042610) (let ((L2_correct  (and (=> (= (ControlFlow 0 787300) (- 0 1046429)) (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_30471| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) _$t1))) (=> (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_30471| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) _$t1)) (=> (= (ControlFlow 0 787300) (- 0 1046530)) (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (= 6 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (= _$t1 0) (= 7 $t8@0))) (and (= _$t1 1) (= 7 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) _$t1) (= 6 $t8@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8@0))) (and (not (= (+ 16 (|l#Vec_30471| _$t2)) 32)) (= 7 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) _$t1) (= 6 $t8@0))))))))
(let ((anon31_Then_correct  (=> $t19 (=> (and (and (or (or (or (or (and (= $t15 0) (= 7 $t8)) (and (= $t15 1) (= 7 $t8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $t15) (= 6 $t8))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8))) (and (not (= (+ 16 (|l#Vec_30471| _$t2)) 32)) (= 7 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 786972) 787300))) L2_correct))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 787314) 787300))) L2_correct)))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 787328) 787300))) L2_correct)))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 787342) 787300))) L2_correct)))
(let ((anon26_Then_correct  (=> $t7 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 787448) 787300))) L2_correct))))
(let ((anon24_correct  (=> (= $t20 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (=> (and (= $t21 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t22 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) $t15)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory@2) $t15) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory@2) $t15))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t20) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t20) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16))))) (and (not (= (|l#Vec_202659| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_202659| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))))) (and (and (and (not (= (|l#Vec_202698| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_202698| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))) (= $t23 $t22)) (and (and (= $t24 $t21) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) $t24)))
(let ((stream_new (let ((len (|l#Multiset_202527| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) $t24 stream_new)))))) (and (= $t25 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t26 ($1_DiemAccount_CreateAccountEvent _$t1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) _$t1)))))))) (and (=> (= (ControlFlow 0 786818) (- 0 1046133)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (and (=> (= (ControlFlow 0 786818) (- 0 1046142)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 786818) (- 0 1046154)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 786818) (- 0 1046172)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 786818) (- 0 1046186)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 786818) (- 0 1046196)) (not (= _$t1 1))) (=> (not (= _$t1 1)) (and (=> (= (ControlFlow 0 786818) (- 0 1046206)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (=> (= (ControlFlow 0 786818) (- 0 1046215)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (=> (= (ControlFlow 0 786818) (- 0 1046232)) (not (not (= (+ 16 (|l#Vec_30471| _$t2)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_30471| _$t2)) 32))) (and (=> (= (ControlFlow 0 786818) (- 0 1046250)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 786818) (- 0 1046260)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) _$t1)) (and (=> (= (ControlFlow 0 786818) (- 0 1046269)) (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) _$t1) (and (=> (= (ControlFlow 0 786818) (- 0 1046276)) (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1) (and (=> (= (ControlFlow 0 786818) (- 0 1046283)) (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) _$t1) (and (=> (= (ControlFlow 0 786818) (- 0 1046290)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) _$t1)) 3)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) _$t1)) 3) (and (=> (= (ControlFlow 0 786818) (- 0 1046303)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory@2) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemSystembpl.47524:15|
 :skolemid |1781|
 ...
 :qid |DiemSystembpl.47524:15|
 :skolemid |1781|
)) (and (=> (= (ControlFlow 0 786818) (- 0 1046338)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_202527| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_202527| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@1))))))
 ...
 :qid |DiemSystembpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 786818) (- 0 1046363)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@2))))))
...
(let ((anon35_Else_correct  (=> (and (and (not |$temp_0'bool'@3|) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_251999 (|Store__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 false) (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1) (= (ControlFlow 0 786389) 786818))) anon24_correct)))
(let ((anon35_Then_correct  (=> (and (and |$temp_0'bool'@3| (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_251999 (|Store__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0) (= (ControlFlow 0 786830) 786818))) anon24_correct)))
(let ((anon34_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_251827 (|Store__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $t15 false) (|contents#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 786375) 786830) anon35_Then_correct) (=> (= (ControlFlow 0 786375) 786389) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_251827 (|Store__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $t15 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $t15 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 786842) 786830) anon35_Then_correct) (=> (= (ControlFlow 0 786842) 786389) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not |$temp_0'bool'@1|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_242387 (|Store__T@[Int]Bool_| (|domain#$Memory_242387| $1_Event_EventHandleGenerator_$memory) $t15 false) (|contents#$Memory_242387| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 786361) 786842) anon34_Then_correct) (=> (= (ControlFlow 0 786361) 786375) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and |$temp_0'bool'@1| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_242387 (|Store__T@[Int]Bool_| (|domain#$Memory_242387| $1_Event_EventHandleGenerator_$memory) $t15 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_242387| $1_Event_EventHandleGenerator_$memory) $t15 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 786854) 786842) anon34_Then_correct) (=> (= (ControlFlow 0 786854) 786375) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_263336 (|Store__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $t15 false) (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 786347) 786854) anon33_Then_correct) (=> (= (ControlFlow 0 786347) 786361) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_263336 (|Store__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $t15 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $t15 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 786866) 786854) anon33_Then_correct) (=> (= (ControlFlow 0 786866) 786361) anon33_Else_correct))))))
(let ((anon31_Else_correct  (=> (not $t19) (and (=> (= (ControlFlow 0 786335) 786866) anon32_Then_correct) (=> (= (ControlFlow 0 786335) 786347) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t15 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t16 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (and (= $t17 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t18 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 786329) (- 0 1045628)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $t15))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $t15)) (and (=> (= (ControlFlow 0 786329) (- 0 1045639)) (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (and (=> (= (ControlFlow 0 786329) (- 0 1045648)) (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) $t15)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) $t15) (=> (= $t19  (or (or (or (or (= $t15 0) (= $t15 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $t15)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_30471| _$t2)) 32)))) (and (=> (= (ControlFlow 0 786329) 786972) anon31_Then_correct) (=> (= (ControlFlow 0 786329) 786335) anon31_Else_correct)))))))))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Else_correct  (=> (and (and (not $abort_flag@1) (= $abort_code@3 $abort_code@2)) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 785955) 787314) anon30_Then_correct) (=> (= (ControlFlow 0 785955) 786329) anon30_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$L3_correct  (=> (= $abort_code@3 inline$$1_ValidatorConfig_publish$0$$t9@1) (=> (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@2) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 785861) 787314) anon30_Then_correct) (=> (= (ControlFlow 0 785861) 786329) anon30_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 $abort_code@2) (= (ControlFlow 0 785969) 785861))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 786021) 785969) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 786021) 785955) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 786019) 786021)) inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_260857 (|Store__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) inline$$1_ValidatorConfig_publish$0$$t21@1))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 785945) 785969) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 785945) 785955) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| inline$$1_ValidatorConfig_publish$0$$t19@0) (<= (|l#Vec_202620| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_202620 (MapConstVec_184068 DefaultVecElem_184068) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_publish$0$$t20@0) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= inline$$1_ValidatorConfig_publish$0$$t21@1 ($1_ValidatorConfig_ValidatorConfig inline$$1_ValidatorConfig_publish$0$$t19@0 inline$$1_ValidatorConfig_publish$0$$t20@0 _$t3))))) (and (=> (= (ControlFlow 0 785923) 786019) inline$$1_ValidatorConfig_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 785923) 785945) inline$$1_ValidatorConfig_publish$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t18@0) (= (ControlFlow 0 785855) 785861))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$1_ValidatorConfig_publish$0$$t18@0 6)) (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 785839) 785923) inline$$1_ValidatorConfig_publish$0$anon18_Then_correct) (=> (= (ControlFlow 0 785839) 785855) inline$$1_ValidatorConfig_publish$0$anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_ValidatorConfig_publish$0$$t15@1)) (= (ControlFlow 0 785799) 785839)) inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t13@0) (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_publish$0$$t14@0) (= inline$$1_ValidatorConfig_publish$0$$t14@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (= inline$$1_ValidatorConfig_publish$0$$t15@1 (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_publish$0$$t14@0)) (= (ControlFlow 0 785805) 785799))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t13@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 786073) 785861))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t11@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t12@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= inline$$1_ValidatorConfig_publish$0$$t13@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3))))) (and (=> (= (ControlFlow 0 785743) 786073) inline$$1_ValidatorConfig_publish$0$anon17_Then_correct) (=> (= (ControlFlow 0 785743) 785805) inline$$1_ValidatorConfig_publish$0$anon17_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t11@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 786165) 785861))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t8@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t10@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t11@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 785697) 786165) inline$$1_ValidatorConfig_publish$0$anon16_Then_correct) (=> (= (ControlFlow 0 785697) 785743) inline$$1_ValidatorConfig_publish$0$anon16_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Then_correct  (=> inline$$1_ValidatorConfig_publish$0$$t8@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ValidatorConfig_publish$0$$t9@0)) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 786191) 785861))) inline$$1_ValidatorConfig_publish$0$L3_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_publish$0$$t5@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t6@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t7@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= _$t0 _$t0)) (and (= _$t3 _$t3) (= inline$$1_ValidatorConfig_publish$0$$t8@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 785627) 786191) inline$$1_ValidatorConfig_publish$0$anon15_Then_correct) (=> (= (ControlFlow 0 785627) 785697) inline$$1_ValidatorConfig_publish$0$anon15_Else_correct)))))))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t13 (|$addr#$signer| _$t0))) (and (= $t14 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 786195) 785627))) inline$$1_ValidatorConfig_publish$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 784764) 787328) anon29_Then_correct) (=> (= (ControlFlow 0 784764) 786195) anon29_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (=> (= (ControlFlow 0 784639) 787342) anon28_Then_correct) (=> (= (ControlFlow 0 784639) 784764) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Then_correct  (=> inline$$1_Roles_new_validator_role$0$$t9@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 784633) 784639))) inline$$1_Roles_new_validator_role$0$L2_correct))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Then_correct  (=> (and (and inline$$1_Roles_new_validator_role$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) (= 5 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0)) (= 3 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)))) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 784731) 784639))) inline$$1_Roles_new_validator_role$0$L2_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon7_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 784591) 787342) anon28_Then_correct) (=> (= (ControlFlow 0 784591) 784764) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Else_correct  (=> (and (and (not |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_250432 (|Store__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_250432| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 784565) 784591))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Then_correct  (=> (and (and |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_250432 (|Store__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_new_validator_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 784605) 784591))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Else_correct  (=> (not inline$$1_Roles_new_validator_role$0$$t9@0) (and (=> (= (ControlFlow 0 784551) 784605) inline$$1_Roles_new_validator_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 784551) 784565) inline$$1_Roles_new_validator_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Else_correct  (=> (and (not inline$$1_Roles_new_validator_role$0$$t5@0) (|$IsValid'u64'| 3)) (=> (and (and (= inline$$1_Roles_new_validator_role$0$$t8@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 3 0) (= inline$$1_Roles_new_validator_role$0$$t8@0 173345816))) (and (=> (= 3 1) (= inline$$1_Roles_new_validator_role$0$$t8@0 186537453)) (= inline$$1_Roles_new_validator_role$0$$t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 784545) 784633) inline$$1_Roles_new_validator_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 784545) 784551) inline$$1_Roles_new_validator_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon0_correct  (=> (and (= inline$$1_Roles_new_validator_role$0$$t2@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t3@0 (|$addr#$signer| _$t0))) (=> (and (and (= _$t0 _$t0) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= inline$$1_Roles_new_validator_role$0$$t4@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t5@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 784479) 784731) inline$$1_Roles_new_validator_role$0$anon8_Then_correct) (=> (= (ControlFlow 0 784479) 784545) inline$$1_Roles_new_validator_role$0$anon8_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (and (not false) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 784735) (- 0 1044414)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 784735) 784479) inline$$1_Roles_new_validator_role$0$anon0_correct))))))
(let ((anon27_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer _$t1)) (and (=> (= (ControlFlow 0 783859) 787356) anon27_Then_correct) (=> (= (ControlFlow 0 783859) 784735) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $t7) (= (ControlFlow 0 783865) 783859)) inline$$1_DiemAccount_create_signer$0$anon0_correct)))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2)) 0)) (= addr@@2 173345816)))
 ...
 :qid |DiemSystembpl.46936:20|
 :skolemid |1753|
)))) (and (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@13)) 3))))
 :qid |DiemSystembpl.46940:20|
 :skolemid |1754|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@16))))) i1)))) 3))))
 ...
 :qid |DiemSystembpl.47049:20|
 :skolemid |1761|
))))) (and (and (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252070| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@21)  (and (= addr@@21 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) addr@@21))))
 :qid |DiemSystembpl.47053:20|
 :skolemid |1762|
 ...
 :qid |DiemSystembpl.47097:20|
 :skolemid |1773|
)))) (and (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_264108| $1_VASP_ChildVASP_$memory) addr@@33)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@33)) 6))))
 :qid |DiemSystembpl.47101:20|
 :skolemid |1774|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemSystembpl.47145:20|
 :skolemid |1776|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemSystembpl.47153:20|
 :skolemid |1778|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_251827| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $a_0@@3)))
 ...
 :qid |DiemSystembpl.47157:20|
 :skolemid |1779|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_263336| $1_DiemAccount_DiemAccount_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_251999| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4)))
(|$IsValid'$1_DiemAccount_AccountOperationsCapability'| $rsc@@4))
 :qid |DiemSystembpl.47161:20|
 :skolemid |1780|
...
))))) (and (and (and (= $t5 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies _$t1)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))))))) (and (=> (= (ControlFlow 0 783821) 787448) anon26_Then_correct) (=> (= (ControlFlow 0 783821) 783865) anon26_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 782339) 783821)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 1042610) 782339) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
