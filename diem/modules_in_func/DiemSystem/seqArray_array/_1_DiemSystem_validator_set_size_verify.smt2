...
(declare-fun $t4@0 () T@Vec_202840)
(declare-fun $t1 () T@$1_DiemSystem_DiemSystem)
...
(assert (not
 (=> (= (ControlFlow 0 0) 911110) (let ((L2_correct  (and (=> (= (ControlFlow 0 580036) (- 0 911670)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 580036) (- 0 911677)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t3@0)))))))
(let ((anon6_Then_correct  (=> $t2 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t3)) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 580064) 580036))) L2_correct))))
(let ((anon7_Else_correct  (=> (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (=> (= (ControlFlow 0 579990) (- 0 911622)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 579990) (- 0 911634)) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))))) (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1)))))) (=> (= (ControlFlow 0 579990) (- 0 911646)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@2)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
...
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_202840| $t4@0)) (and (=> (= (ControlFlow 0 579930) 580004) anon7_Then_correct) (=> (= (ControlFlow 0 579930) 579990) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (not $t2) (=> (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t1) (let (($range_0 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t1)))))
(let (($range_1 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t1)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@129 $i_2))
(let ((j@@40 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t1)) i@@129)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t1)) j@@40))) (= i@@129 j@@40))))))
 :qid |DiemSystembpl.24806:222|
 :skolemid |840|
))))) (=> (and (and (and (= (|$scheme#$1_DiemSystem_DiemSystem| $t1) (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@4))))) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| $t1) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@4)))))) (= $t1 $t1)) (and (= $t4@0 (|$validators#$1_DiemSystem_DiemSystem| $t1)) (= (ControlFlow 0 579936) 579930))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|)))))
...
(let ((j@@41 $i_4))
 ...
 :qid |DiemSystembpl.24772:367|
 :skolemid |838|
))))))
 :qid |DiemSystembpl.24771:20|
 :skolemid |839|
...
)) (= $t2  (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 579789) 580064) anon6_Then_correct) (=> (= (ControlFlow 0 579789) 579936) anon6_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 579496) 579789)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 911110) 579496) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))
))
(check-sat)
(pop 1)
