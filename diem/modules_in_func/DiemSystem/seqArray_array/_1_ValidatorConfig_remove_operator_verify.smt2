...
(declare-fun $t15@0 () T@$Mutation_262434)
(declare-fun $t14@1 () T@$Mutation_262393)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t15@1 () T@$Mutation_262434)
(declare-fun $t13 () |T@$1_Option_Option'address'|)
(declare-fun $t14@2 () T@$Mutation_262393)
...
(declare-fun $t14 () T@$Mutation_262393)
(declare-fun $t9 () Int)
(declare-fun $t14@0 () T@$Mutation_262393)
...
(declare-fun $t15 () T@$Mutation_262434)
(push 1)
(set-info :boogie-vc-id $1_ValidatorConfig_remove_operator$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 853364) (let ((anon18_Else_correct  (=> (and (and (not $abort_flag@0) (= $t15@0 ($Mutation_262434 (|l#$Mutation_262393| $t14@1) (let ((l (|l#Vec_30471| (|p#$Mutation_262393| $t14@1))))
(Vec_30471 (|Store__T@[Int]Int_| (|v#Vec_30471| (|p#$Mutation_262393| $t14@1)) l 1) (+ l 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@1))))) (and (= $t15@1 ($Mutation_262434 (|l#$Mutation_262434| $t15@0) (|p#$Mutation_262434| $t15@0) $t13)) (= $t14@2 ($Mutation_262393 (|l#$Mutation_262393| $t14@1) (|p#$Mutation_262393| $t14@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@1)) (|v#$Mutation_262434| $t15@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@1))))))) (and (=> (= (ControlFlow 0 516814) (- 0 854746)) (<= (|l#Vec_202620| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@2)))) 1)) (=> (<= (|l#Vec_202620| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@2)))) 1) (and (=> (= (ControlFlow 0 516814) (- 0 854759)) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@2)))) 1)) (=> (<= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_262393| $t14@2)))) 1) (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_260857 (|Store__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_262393| $t14@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_262393| $t14@2)) (|v#$Mutation_262393| $t14@2)))) (and (=> (= (ControlFlow 0 516814) (- 0 854803)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) a)) (=> (not (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) a))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) a))))) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) a)) 3))))))
 :qid |DiemSystembpl.8022:15|
 :skolemid |202|
 ...
 :qid |DiemSystembpl.8028:15|
 :skolemid |203|
)) (and (=> (= (ControlFlow 0 516814) (- 0 854885)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |DiemSystembpl.8034:15|
 :skolemid |204|
 ...
 :qid |DiemSystembpl.8034:15|
 :skolemid |204|
)) (and (=> (= (ControlFlow 0 516814) (- 0 854910)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2)) 3))))
 :qid |DiemSystembpl.8040:15|
 :skolemid |205|
...
(|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)) a@@1)))
 :qid |DiemSystembpl.8053:674|
 :skolemid |208|
))))
 :qid |DiemSystembpl.8052:592|
 :skolemid |209|
...
(|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) a@@2)))
 ...
 :qid |DiemSystembpl.8052:592|
 :skolemid |209|
))) (and (=> (= (ControlFlow 0 516814) (- 0 855101)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@20)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@20)) 3))))
 :qid |DiemSystembpl.8059:15|
 :skolemid |210|
 ...
 :qid |DiemSystembpl.8059:15|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 516814) (- 0 855129)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 516814) (- 0 855141)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 3))) (and (=> (= (ControlFlow 0 516814) (- 0 855159)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (and (=> (= (ControlFlow 0 516814) (- 0 855171)) (not (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0)))) (=> (not (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0))) (=> (= (ControlFlow 0 516814) (- 0 855182)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (not (= addr@@22 $t4)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@22))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@22))))))
 :qid |DiemSystembpl.8088:15|
 :skolemid |211|
)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 516250) (- 0 854608)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (=> (= (ControlFlow 0 516250) (- 0 854639)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 3)) (= 3 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)) (= 5 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 516828) 516250))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $t14@1 $t14) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 516880) 516828) anon18_Then_correct) (=> (= (ControlFlow 0 516880) 516814) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= (ControlFlow 0 516878) 516880)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t9) (=> (and (and (= $t14@0 ($Mutation_262393 ($Global $t9) (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t9))) (= $t14@1 $t14@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 516298) 516828) anon18_Then_correct) (=> (= (ControlFlow 0 516298) 516814) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t13) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| $t13)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t13) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0))))) (and (=> (= (ControlFlow 0 516276) 516878) anon17_Then_correct) (=> (= (ControlFlow 0 516276) 516298) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 516150) 516250))) L3_correct)))
(let ((anon15_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 516134) 516276) anon16_Then_correct) (=> (= (ControlFlow 0 516134) 516150) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) 3)) (= 3 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 516946) 516250))) L3_correct))))
(let ((anon15_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t9 $t9) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 516092) 516894) anon15_Then_correct) (=> (= (ControlFlow 0 516092) 516134) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (not $t7) (=> (and (and (|$IsValid'address'| $t9) (= $t9 (|$addr#$signer| _$t0))) (and (= $t9 $t9) (= (ControlFlow 0 516098) 516092))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@23)) 0)) (= addr@@23 173345816)))
 ...
 :qid |DiemSystembpl.7771:20|
 :skolemid |183|
))))) (=> (and (and (and (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@33) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@33)) 3))))
 :qid |DiemSystembpl.7775:20|
 :skolemid |184|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@37))))) i1)))) 3))))
 ...
 :qid |DiemSystembpl.7836:20|
 :skolemid |199|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemSystembpl.7842:20|
 :skolemid |200|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@0) (and (<= (|l#Vec_202620| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1))))
 :qid |DiemSystembpl.7846:20|
 :skolemid |201|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_260857| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t6)) 3))))))) (and (=> (= (ControlFlow 0 515967) 516946) anon14_Then_correct) (=> (= (ControlFlow 0 515967) 516098) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 515111) 515967)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_30471| (|p#$Mutation_262393| $t14)) 0) (=> (and (= (|l#Vec_30471| (|p#$Mutation_262434| $t15)) 0) (= (ControlFlow 0 515121) 515111)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 853364) 515121) anon0_correct)))
