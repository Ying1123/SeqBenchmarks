...
(declare-fun |$1_DiemConfig_DiemConfig'#0'_$memory| () T@$Memory_272061)
(declare-fun $t6 () T@$1_DiemConfig_Configuration)
(declare-fun $t7 () Int)
(declare-fun |$1_DiemConfig_DiemConfig'#0'_$memory@0| () T@$Memory_272061)
...
(declare-fun $t15@1 () T@$Mutation_273959)
(declare-fun $t16@0 () T@$Mutation_206184)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t16@1 () T@$Mutation_206184)
(declare-fun $t15@2 () T@$Mutation_273959)
...
(declare-fun $t15 () T@$Mutation_273959)
(declare-fun $t15@0 () T@$Mutation_273959)
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) $t32 stream_new)))) $es)) (= $t34 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $t35 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t36 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t34)))))) (and (=> (= (ControlFlow 0 545423) (- 0 881011)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 545423) (- 0 881023)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6)))) (and (=> (= (ControlFlow 0 545423) (- 0 881065)) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816) (and (=> (= (ControlFlow 0 545423) (- 0 881071)) (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) addr@@0))) _$t1)) (=> (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) addr@@1))) _$t1) (and (=> (= (ControlFlow 0 545423) (- 0 881080)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory@2) 173345816))) (=> (= (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory@2) 173345816)) (and (=> (= (ControlFlow 0 545423) (- 0 881091)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1)))) $EmptyEventStore)))
 ...
 :qid |DiemSystembpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 545423) (- 0 881136)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_DiemConfig_Configuration_$memory@1 ($Memory_250712 (|Store__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1) (= (ControlFlow 0 545025) 545423))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_DiemConfig_Configuration_$memory@0 ($Memory_250712 (|Store__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0) (= (ControlFlow 0 545435) 545423))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not $t25) (and (=> (= (ControlFlow 0 545013) 545435) anon19_Then_correct) (=> (= (ControlFlow 0 545013) 545025) anon19_Else_correct)))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 544694) (- 0 880618)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6)))) (=> (= (ControlFlow 0 544694) (- 0 880664)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= 5 $t14@0)) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))) (= 1 $t14@0))))))))
(let ((anon18_Then_correct  (=> $t25 (=> (and (and (and (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21)))) (= 1 $t14)) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 545515) 544694))) L3_correct))))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| (|v#$Mutation_273959| $t15@1)) (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| |$temp_0'$1_DiemConfig_DiemConfig'#0''@0|)) (=> (and (and (= $t16@0 ($Mutation_206184 (|l#$Mutation_273959| $t15@1) (let ((l (|l#Vec_30471| (|p#$Mutation_273959| $t15@1))))
(Vec_30471 (|Store__T@[Int]Int_| (|v#Vec_30471| (|p#$Mutation_273959| $t15@1)) l 0) (+ l 1))) (|$payload#$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_273959| $t15@1)))) (= $t16@1 ($Mutation_206184 (|l#$Mutation_206184| $t16@0) (|p#$Mutation_206184| $t16@0) _$t1))) (and (= $t15@2 ($Mutation_273959 (|l#$Mutation_273959| $t15@1) (|p#$Mutation_273959| $t15@1) (|$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_206184| $t16@1)))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_272061 (|Store__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_273959| $t15@2)) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_273959| $t15@2)) (|v#$Mutation_273959| $t15@2)))))) (and (=> (= (ControlFlow 0 545005) (- 0 880307)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.15997:15|
 :skolemid |542|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemSystembpl.15997:15|
 :skolemid |542|
)) (and (=> (= (ControlFlow 0 545005) (- 0 880332)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (and (and (and (= $t17 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t18 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t19 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t20 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (and (= $t21 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t22 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t23 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t24 (|$events#$1_DiemConfig_Configuration| $t23))))) (and (=> (= (ControlFlow 0 545005) (- 0 880439)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 545005) (- 0 880452)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (=> (= $t25  (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21))))) (and (=> (= (ControlFlow 0 545005) 545515) anon18_Then_correct) (=> (= (ControlFlow 0 545005) 545013) anon18_Else_correct)))))))))))))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 545529) 544694))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t15@1 $t15) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 545581) 545529) anon17_Then_correct) (=> (= (ControlFlow 0 545581) 545005) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= (ControlFlow 0 545579) 545581)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (=> (and (and (= $t15@0 ($Mutation_273959 ($Global 173345816) (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (= $t15@1 $t15@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 544726) 545529) anon17_Then_correct) (=> (= (ControlFlow 0 544726) 545005) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t11@0 (and (=> (= (ControlFlow 0 544704) (- 0 880116)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 544704) 545579) anon16_Then_correct) (=> (= (ControlFlow 0 544704) 544726) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 544570) 544694))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemSystembpl.15829:20|
 :skolemid |537|
))) (and (|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemSystembpl.15838:20|
 :skolemid |538|
...
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@2)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@2))
 :qid |DiemSystembpl.15850:20|
 :skolemid |541|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@2))
)) (= $t6 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))))) (=> (and (and (and (and (= $t7 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t8 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t9 (|$events#$1_DiemConfig_Configuration| $t8)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 544554) 544704) anon15_Then_correct) (=> (= (ControlFlow 0 544554) 544570) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 544265) 544554)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_30471| (|p#$Mutation_273959| $t5)) 0) (= (|l#Vec_30471| (|p#$Mutation_273959| $t15)) 0)) (and (= (|l#Vec_30471| (|p#$Mutation_206184| $t16)) 0) (= (ControlFlow 0 544275) 544265))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 879720) 544275) anon0_correct)))
