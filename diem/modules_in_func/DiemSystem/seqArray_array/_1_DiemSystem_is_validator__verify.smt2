...
(declare-fun _$t1 () T@Vec_202840)
(declare-fun $t3 () Int)
(declare-fun $t4 () |T@$1_Option_Option'u64'|)
(declare-fun $t5 () Bool)
...
(assert (not
 (=> (= (ControlFlow 0 0) 898185) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t1) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t3 (|l#Vec_202840| _$t1)))) (=> (and (and (and (|$IsValid'$1_Option_Option'u64''| $t4) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t4)) 1)) (=> (let (($range_0 ($Range 0 $t3)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@129 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t1) i@@129)) _$t0))))
 :qid |DiemSystembpl.21414:54|
 :skolemid |706|
))) (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t4)) 0))) (and (and (=> (let (($range_0@@0 ($Range 0 $t3)))
(exists (($i_1@@0 Int) ) (!  (and ($InRange $range_0@@0 $i_1@@0) (let ((i@@130 $i_1@@0))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t1) i@@130)) _$t0)))
 :qid |DiemSystembpl.21418:54|
 :skolemid |707|
))) (and (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t4)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'u64'| $t4)) 0)))
(= at ($choice_0 _$t1 _$t0))))) (= $t4 $t4)) (and (= $t5  (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t4)) 0))) (= $t5 $t5)))) (and (=> (= (ControlFlow 0 565247) (- 0 898404)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 565247) (- 0 898411)) (= $t5 (let (($range_0@@1 _$t1))
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_183043 $range_0@@1 $i_1@@1) (let ((v@@62 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@1) $i_1@@1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@62) _$t0)))
 :qid |DiemSystembpl.21451:57|
 :skolemid |708|
))))) (=> (= $t5 (let (($range_0@@2 _$t1))
(exists (($i_1@@2 Int) ) (!  (and (InRangeVec_183043 $range_0@@2 $i_1@@2) (let ((v@@63 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@2) $i_1@@2)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@63) _$t0)))
 :qid |DiemSystembpl.21451:57|
 :skolemid |708|
)))) (=> (= (ControlFlow 0 565247) (- 0 898447)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_202527| stream@@0) 0) (forall ((v@@64 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@0) v@@64) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 564996) 565247)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 898185) 564996) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
