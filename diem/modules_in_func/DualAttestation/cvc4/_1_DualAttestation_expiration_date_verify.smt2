...
(assert (not
 (=> (= (ControlFlow 0 0) 293604) (let ((anon12_Else_correct@@4  (=> (not $abort_flag@0@@5) (=> (and (= $t8@0@@6 (|$expiration_date#$1_DualAttestation_Credential| $t7@1@@2)) (= $t8@0@@6 $t8@0@@6)) (and (=> (= (ControlFlow 0 218665) (- 0 293954)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14))) (=> (= (ControlFlow 0 218665) (- 0 293965)) (= $t8@0@@6 (|$expiration_date#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14))))))))))
(let ((L3_correct@@4  (and (=> (= (ControlFlow 0 218599) (- 0 293907)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)) (=> (= (ControlFlow 0 218599) (- 0 293913)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= 5 $t6@0@@3)))))))
(let ((anon12_Then_correct@@4  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t6@0@@3 $abort_code@1@@5) (= (ControlFlow 0 218679) 218599))) L3_correct@@4)))
(let ((anon11_Then$1_correct@@3  (=> (= $t7@1@@2 $t7@@5) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 218731) 218679) anon12_Then_correct@@4) (=> (= (ControlFlow 0 218731) 218665) anon12_Else_correct@@4))))))
(let ((anon11_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= (ControlFlow 0 218729) 218731)) anon11_Then$1_correct@@3)))
(let ((anon11_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14) (=> (and (and (= $t7@0@@3 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)) (= $t7@1@@2 $t7@0@@3)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 218617) 218679) anon12_Then_correct@@4) (=> (= (ControlFlow 0 218617) 218665) anon12_Else_correct@@4))))))
(let ((anon10_Then_correct@@3  (=> $t3@0@@6 (and (=> (= (ControlFlow 0 218603) 218729) anon11_Then_correct@@3) (=> (= (ControlFlow 0 218603) 218617) anon11_Else_correct@@3)))))
(let ((anon10_Else_correct@@3  (=> (and (and (not $t3@0@@6) (= $t5@@4 $t5@@4)) (and (= $t6@0@@3 $t5@@4) (= (ControlFlow 0 218567) 218599))) L3_correct@@4)))
(let ((anon0$1_correct@@14  (=> (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr1@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@9)) 2)))))
 :qid |DualAttestationbpl.15003:20|
 :skolemid |317|
)) (=> (and (forall ((addr@@87 Int) ) (!  (=> (|$IsValid'address'| addr@@87) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr@@87)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@87) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@87)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@87) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@87)) 5)))))
 :qid |DualAttestationbpl.15007:20|
 :skolemid |318|
)) (|$IsValid'address'| _$t0@@14)) (=> (and (and (and (forall (($a_0@@39 Int) ) (! (let (($rsc@@39 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@39)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@39))
 :qid |DualAttestationbpl.15014:20|
 :skolemid |319|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@39))
)) (= _$t0@@14 _$t0@@14)) (and (= $t3@0@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@14)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@4) (= $t5@@4 5)) (and (= $t5@@4 $t5@@4) (= $t3@0@@6 $t3@0@@6)))) (and (=> (= (ControlFlow 0 218551) 218603) anon10_Then_correct@@3) (=> (= (ControlFlow 0 218551) 218567) anon10_Else_correct@@3)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@14  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@16 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@16)))
 (and (= (|l#Multiset_84854| stream@@15) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@15) v@@50) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 218401) 218551)) anon0$1_correct@@14)))
(let ((anon0_correct@@14  (=> (= (ControlFlow 0 293604) 218401) inline$$InitEventStore$0$anon0_correct@@14)))
anon0_correct@@14))))))))))))
))
(check-sat)
(pop 1)
