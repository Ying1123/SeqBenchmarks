...
(declare-fun $1_DualAttestation_Credential_$memory@1 () T@$Memory_124454)
...
(declare-fun $t24@0 () T@$1_DualAttestation_Credential)
(declare-fun $abort_code@0 () Int)
(declare-fun _$t2 () T@Vec_21610)
(declare-fun |inline$$1_Vector_empty'u8'$0$v@1| () T@Vec_21610)
(declare-fun |inline$$1_Vector_empty'u8'$1$v@1| () T@Vec_21610)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 308701) (let ((anon30_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 230850) (- 0 310151)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@1) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.15685:15|
 :skolemid |358|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@1) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DualAttestationbpl.15685:15|
 :skolemid |358|
)) (and (=> (= (ControlFlow 0 230850) (- 0 310184)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a) (=> (not (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@1) a)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a)))) ($1_Signer_is_txn_signer_addr a))))
 :qid |DualAttestationbpl.15691:15|
 :skolemid |359|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@0) (=> (not (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@1) a@@0)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@0)))) ($1_Signer_is_txn_signer_addr a@@0))))
 :qid |DualAttestationbpl.15691:15|
 :skolemid |359|
)) (and (=> (= (ControlFlow 0 230850) (- 0 310227)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@1) (=> (not (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@1) a@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@1)))) ($1_Signer_is_txn_signer_addr a@@1))))
 :qid |DualAttestationbpl.15697:15|
 :skolemid |360|
))) (=> (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@2) (=> (not (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@1) a@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@2)))) ($1_Signer_is_txn_signer_addr a@@2))))
 :qid |DualAttestationbpl.15697:15|
 :skolemid |360|
)) (and (=> (= (ControlFlow 0 230850) (- 0 310273)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 230850) (- 0 310285)) (not (and (not (= $t6 5)) (not (= $t6 2))))) (=> (not (and (not (= $t6 5)) (not (= $t6 2)))) (and (=> (= (ControlFlow 0 230850) (- 0 310308)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t7))) (and (=> (= (ControlFlow 0 230850) (- 0 310320)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) 1))) (and (=> (= (ControlFlow 0 230850) (- 0 310338)) (not (not (= (|$addr#$signer| _$t1) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t1) 186537453))) (=> (= (ControlFlow 0 230850) (- 0 310352)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)))))))))))))))))))))))
(let ((anon28_Then_correct true))
(let ((anon27_Then_correct true))
(let ((anon26_Then_correct true))
(let ((anon25_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 230335) (- 0 309958)) (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) (and (not (= $t6 5)) (not (= $t6 2)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t7))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)))) (=> (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) (and (not (= $t6 5)) (not (= $t6 2)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t7))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0))) (=> (= (ControlFlow 0 230335) (- 0 310028)) (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) (= 5 $t11@0)) (and (and (not (= $t6 5)) (not (= $t6 2))) (= 3 $t11@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) (= 5 $t11@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t7)) 1)) (= 3 $t11@0))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t11@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)) (= 6 $t11@0))))))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t11@0 $abort_code@1) (= (ControlFlow 0 230864) 230335))) L3_correct)))
(let ((anon29_Then$1_correct  (=> (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 230916) 230864) anon30_Then_correct) (=> (= (ControlFlow 0 230916) 230850) anon30_Else_correct))))))
(let ((anon29_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 230914) 230916)) anon29_Then$1_correct)))
(let ((anon29_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DualAttestation_Credential_$memory@0 ($Memory_124454 (|Store__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0) $t24@0))) (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 230627) 230864) anon30_Then_correct) (=> (= (ControlFlow 0 230627) 230850) anon30_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (not false) (= $t24@0 ($1_DualAttestation_Credential _$t2 |inline$$1_Vector_empty'u8'$0$v@1| |inline$$1_Vector_empty'u8'$1$v@1| 18446744073709551615 |inline$$1_Event_new_event_handle'$1_DualAttestation_ComplianceKeyRotationEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_DualAttestation_BaseUrlRotationEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 230605) 230914) anon29_Then_correct) (=> (= (ControlFlow 0 230605) 230627) anon29_Else_correct)))))
(let ((|inline$$1_Event_new_event_handle'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_DualAttestation_BaseUrlRotationEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_DualAttestation_BaseUrlRotationEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 230569) 230930) anon28_Then_correct) (=> (= (ControlFlow 0 230569) 230605) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not false) (= (ControlFlow 0 230575) 230569)) |inline$$1_Event_new_event_handle'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DualAttestation_ComplianceKeyRotationEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DualAttestation_ComplianceKeyRotationEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 230487) 230944) anon27_Then_correct) (=> (= (ControlFlow 0 230487) 230575) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 18446744073709551615) (= (ControlFlow 0 230493) 230487)) |inline$$1_Event_new_event_handle'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((|inline$$1_Vector_empty'u8'$1$anon0_correct|  (=> (= |inline$$1_Vector_empty'u8'$1$v@1| (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0)) (and (=> (= (ControlFlow 0 230397) 230958) anon26_Then_correct) (=> (= (ControlFlow 0 230397) 230493) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not false) (= (ControlFlow 0 230403) 230397)) |inline$$1_Vector_empty'u8'$1$anon0_correct|)))
(let ((|inline$$1_Vector_empty'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'u8'$0$v@1| (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0)) (and (=> (= (ControlFlow 0 230361) 230972) anon25_Then_correct) (=> (= (ControlFlow 0 230361) 230403) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 230367) 230361)) |inline$$1_Vector_empty'u8'$0$anon0_correct|)))
(let ((anon24_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t18 $t18)) (and (= $t11@0 $t18) (= (ControlFlow 0 230127) 230335))) L3_correct)))
(let ((anon23_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t18) (= $t18 6)) (and (= $t18 $t18) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 230111) 230367) anon24_Then_correct) (=> (= (ControlFlow 0 230111) 230127) anon24_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t15@0)) (= (ControlFlow 0 230071) 230111)) anon23_Else$1_correct)))
(let ((anon23_Else_correct  (=> (not $t13) (=> (and (and (|$IsValid'address'| $t14) (= $t14 (|$addr#$signer| _$t0))) (and (= $t15@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t14)) (= (ControlFlow 0 230077) 230071))) inline$$Not$0$anon0_correct))))
(let ((anon23_Then_correct  (=> $t13 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t12)) (= 5 $t11)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t11))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t11))) (= $t11 $t11)) (and (= $t11@0 $t11) (= (ControlFlow 0 231044) 230335))) L3_correct))))
(let ((anon22_Else_correct  (=> (not $t10) (=> (and (= $t12 (|$addr#$signer| _$t1)) (= $t13  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t12)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))))) (and (=> (= (ControlFlow 0 230015) 231044) anon23_Then_correct) (=> (= (ControlFlow 0 230015) 230077) anon23_Else_correct))))))
(let ((anon22_Then_correct  (=> $t10 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t8)) (= 5 $t11)) (and (and (not (= $t9 5)) (not (= $t9 2))) (= 3 $t11))) (= $t11 $t11)) (and (= $t11@0 $t11) (= (ControlFlow 0 231100) 230335))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |DualAttestationbpl.15383:20|
 :skolemid |341|
)) (=> (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0)) 1)) (= addr@@0 186537453)))
 :qid |DualAttestationbpl.15387:20|
 :skolemid |342|
 ...
 :qid |DualAttestationbpl.15399:20|
 :skolemid |345|
 ...
 :qid |DualAttestationbpl.15403:20|
 :skolemid |346|
 ...
 :qid |DualAttestationbpl.15407:20|
 :skolemid |347|
 ...
 :qid |DualAttestationbpl.15411:20|
 :skolemid |348|
 ...
 :qid |DualAttestationbpl.15415:20|
 :skolemid |349|
 ...
 :qid |DualAttestationbpl.15419:20|
 :skolemid |350|
 ...
 :qid |DualAttestationbpl.15423:20|
 :skolemid |351|
 ...
 :qid |DualAttestationbpl.15427:20|
 :skolemid |352|
 ...
 :qid |DualAttestationbpl.15431:20|
 :skolemid |353|
 ...
 :qid |DualAttestationbpl.15435:20|
 :skolemid |354|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_124569| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_124629| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@12)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@12)) 2)))))
 :qid |DualAttestationbpl.15439:20|
 :skolemid |355|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1)) ($1_Signer_is_txn_signer _$t1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1))) (and (and (|$IsValid'vec'u8''| _$t2) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DualAttestationbpl.15451:20|
 :skolemid |356|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DualAttestationbpl.15455:20|
 :skolemid |357|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@0))
)) (= $t5 (|$addr#$signer| _$t0))))) (and (and (and (= $t6 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t5))) (= $t7 (|$addr#$signer| _$t1))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t8))) (= $t10  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t8)) (and (not (= $t9 5)) (not (= $t9 2)))))))))) (and (=> (= (ControlFlow 0 229957) 231100) anon22_Then_correct) (=> (= (ControlFlow 0 229957) 230015) anon22_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 229374) 229957)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 308701) 229374) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
