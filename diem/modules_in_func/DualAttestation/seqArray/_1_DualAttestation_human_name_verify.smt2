...
(assert (not
 (=> (= (ControlFlow 0 0) 280148) (let ((anon12_Else_correct@@0  (=> (not $abort_flag@0@@1) (=> (and (= $t8@0 (|$human_name#$1_DualAttestation_Credential| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 202437) (- 0 280498)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1))) (=> (= (ControlFlow 0 202437) (- 0 280509)) (= $t8@0 (|$human_name#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1))))))))))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 202371) (- 0 280451)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)) (=> (= (ControlFlow 0 202371) (- 0 280457)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= 5 $t6@0@@0)))))))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t6@0@@0 $abort_code@1@@1) (= (ControlFlow 0 202451) 202371))) L3_correct@@0)))
(let ((anon11_Then$1_correct@@0  (=> (= $t7@1 $t7@@0) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 202503) 202451) anon12_Then_correct@@0) (=> (= (ControlFlow 0 202503) 202437) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= (ControlFlow 0 202501) 202503)) anon11_Then$1_correct@@0)))
(let ((anon11_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)) (= $t7@1 $t7@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 202389) 202451) anon12_Then_correct@@0) (=> (= (ControlFlow 0 202389) 202437) anon12_Else_correct@@0))))))
(let ((anon10_Then_correct@@0  (=> $t3@0 (and (=> (= (ControlFlow 0 202375) 202501) anon11_Then_correct@@0) (=> (= (ControlFlow 0 202375) 202389) anon11_Else_correct@@0)))))
(let ((anon10_Else_correct@@0  (=> (and (and (not $t3@0) (= $t5@@0 $t5@@0)) (and (= $t6@0@@0 $t5@@0) (= (ControlFlow 0 202339) 202371))) L3_correct@@0)))
(let ((anon0$1_correct@@1  (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |DualAttestationbpl.10412:20|
 :skolemid |211|
)) (=> (and (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr@@49)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@49)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@49)) 5)))))
 :qid |DualAttestationbpl.10416:20|
 :skolemid |212|
)) (|$IsValid'address'| _$t0@@1)) (=> (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@1)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@1))
 :qid |DualAttestationbpl.10423:20|
 :skolemid |213|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_117094| $1_DualAttestation_Credential_$memory) $a_0@@1))
)) (= _$t0@@1 _$t0@@1)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) _$t0@@1)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5@@0) (= $t5@@0 5)) (and (= $t5@@0 $t5@@0) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 202323) 202375) anon10_Then_correct@@0) (=> (= (ControlFlow 0 202323) 202339) anon10_Else_correct@@0)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_84854| stream@@2) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@2) v@@37) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 202173) 202323)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 280148) 202173) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))
))
(check-sat)
(pop 1)
