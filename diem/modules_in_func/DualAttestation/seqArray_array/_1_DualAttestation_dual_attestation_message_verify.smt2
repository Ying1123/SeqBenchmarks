...
(declare-fun $t3@2 () T@Vec_21610)
(declare-fun |inline$$1_Vector_append'u8'$2$m'@1| () T@$Mutation_106221)
(declare-fun $t9@0 () T@$Mutation_106221)
(declare-fun $t10@0 () T@Vec_21610)
(declare-fun DefaultVecElem_11252 () Int)
(declare-fun $t3@1 () T@Vec_21610)
(declare-fun |inline$$1_Vector_append'u8'$1$m'@1| () T@$Mutation_106221)
(declare-fun MapConstVec_11252 (Int) |T@[Int]Int|)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t7@0 () T@$Mutation_106221)
(declare-fun call1formal@res@0 () T@Vec_21610)
(declare-fun $t3@0 () T@Vec_21610)
(declare-fun |inline$$1_Vector_append'u8'$0$m'@1| () T@$Mutation_106221)
(declare-fun _$t2 () Int)
(declare-fun $t4@0 () T@$Mutation_106221)
(declare-fun call1formal@res@0@@0 () T@Vec_21610)
(declare-fun _$t0 () Int)
(declare-fun _$t1 () T@Vec_21610)
(declare-fun $es () T@$EventStore)
(declare-fun $t4 () T@$Mutation_106221)
(declare-fun $t7 () T@$Mutation_106221)
(declare-fun $t9 () T@$Mutation_106221)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_dual_attestation_message$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 304011) (let ((anon16_Else_correct  (=> (and (and (not false) (= $t3@2 (|v#$Mutation_106221| |inline$$1_Vector_append'u8'$2$m'@1|))) (and (= $t3@2 $t3@2) (= (ControlFlow 0 224609) (- 0 304540)))) (not false))))
(let ((anon16_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$2$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$2$m'@1| ($Mutation_106221 (|l#$Mutation_106221| $t9@0) (|p#$Mutation_106221| $t9@0) (let ((m2@@0 (|v#Vec_21610| $t10@0)))
(let ((l2 (|l#Vec_21610| $t10@0)))
(let ((m1@@0 (|v#Vec_21610| (|v#$Mutation_106221| $t9@0))))
(let ((l1 (|l#Vec_21610| (|v#$Mutation_106221| $t9@0))))
(Vec_21610 (|lambda#24| 0 (+ l1 l2) l1 m1@@0 m2@@0 l1 DefaultVecElem_11252) (+ l1 l2)))))))) (and (=> (= (ControlFlow 0 224571) 224623) anon16_Then_correct) (=> (= (ControlFlow 0 224571) 224609) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not false) (= $t3@1 (|v#$Mutation_106221| |inline$$1_Vector_append'u8'$1$m'@1|))) (=> (and (and (= $t9@0 ($Mutation_106221 ($Local 3) (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0) $t3@1)) (= $t10@0 (let ((m2@@1 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 36) 1 64) 2 64) 3))))
(let ((l2@@0 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 36) 1 64) 2 64) 3))))
(let ((m1@@1 (|v#Vec_21610| (let ((m2@@2 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 69) 1 83) 2 84) 3 36) 4))))
(let ((l2@@1 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 69) 1 83) 2 84) 3 36) 4))))
(let ((m1@@2 (|v#Vec_21610| (let ((m2@@3 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((l2@@2 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((m1@@3 (|v#Vec_21610| (let ((m2@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((l2@@3 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((m1@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 64) 1 64) 2 36) 3 36) 4))))
(let ((l1@@0 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 64) 1 64) 2 36) 3 36) 4))))
(Vec_21610 (|lambda#24| 0 (+ l1@@0 l2@@3) l1@@0 m1@@4 m2@@4 l1@@0 DefaultVecElem_11252) (+ l1@@0 l2@@3)))))))))
(let ((l1@@1 (|l#Vec_21610| (let ((m2@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((l2@@3 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((m1@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 64) 1 64) 2 36) 3 36) 4))))
(let ((l1@@0 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 64) 1 64) 2 36) 3 36) 4))))
(Vec_21610 (|lambda#24| 0 (+ l1@@0 l2@@3) l1@@0 m1@@4 m2@@4 l1@@0 DefaultVecElem_11252) (+ l1@@0 l2@@3)))))))))
(Vec_21610 (|lambda#24| 0 (+ l1@@1 l2@@2) l1@@1 m1@@3 m2@@3 l1@@1 DefaultVecElem_11252) (+ l1@@1 l2@@2)))))))))
(let ((l1@@2 (|l#Vec_21610| (let ((m2@@3 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((l2@@2 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((m1@@3 (|v#Vec_21610| (let ((m2@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((l2@@3 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
(let ((m1@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 64) 1 64) 2 36) 3 36) 4))))
...
(Vec_21610 (|lambda#24| 0 (+ l1@@0 l2@@3) l1@@0 m1@@4 m2@@4 l1@@0 DefaultVecElem_11252) (+ l1@@0 l2@@3)))))))))
(Vec_21610 (|lambda#24| 0 (+ l1@@1 l2@@2) l1@@1 m1@@3 m2@@3 l1@@1 DefaultVecElem_11252) (+ l1@@1 l2@@2)))))))))
(Vec_21610 (|lambda#24| 0 (+ l1@@2 l2@@1) l1@@2 m1@@2 m2@@2 l1@@2 DefaultVecElem_11252) (+ l1@@2 l2@@1)))))))))
(let ((l1@@3 (|l#Vec_21610| (let ((m2@@2 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 69) 1 83) 2 84) 3 36) 4))))
(let ((l2@@1 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 69) 1 83) 2 84) 3 36) 4))))
(let ((m1@@2 (|v#Vec_21610| (let ((m2@@3 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((l2@@2 (|l#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 95) 1 65) 2 84) 3 84) 4))))
(let ((m1@@3 (|v#Vec_21610| (let ((m2@@4 (|v#Vec_21610| (Vec_21610 (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 68) 1 73) 2 69) 3 77) 4))))
...
(Vec_21610 (|lambda#24| 0 (+ l1@@1 l2@@2) l1@@1 m1@@3 m2@@3 l1@@1 DefaultVecElem_11252) (+ l1@@1 l2@@2)))))))))
(Vec_21610 (|lambda#24| 0 (+ l1@@2 l2@@1) l1@@2 m1@@2 m2@@2 l1@@2 DefaultVecElem_11252) (+ l1@@2 l2@@1)))))))))
(Vec_21610 (|lambda#24| 0 (+ l1@@3 l2@@0) l1@@3 m1@@1 m2@@1 l1@@3 DefaultVecElem_11252) (+ l1@@3 l2@@0)))))))) (and (|$IsValid'vec'u8''| $t10@0) (= (ControlFlow 0 224577) 224571))) |inline$$1_Vector_append'u8'$2$anon0_correct|))))
(let ((anon15_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$1$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$1$m'@1| ($Mutation_106221 (|l#$Mutation_106221| $t7@0) (|p#$Mutation_106221| $t7@0) (let ((m2@@5 (|v#Vec_21610| call1formal@res@0)))
(let ((l2@@4 (|l#Vec_21610| call1formal@res@0)))
(let ((m1@@5 (|v#Vec_21610| (|v#$Mutation_106221| $t7@0))))
(let ((l1@@4 (|l#Vec_21610| (|v#$Mutation_106221| $t7@0))))
(Vec_21610 (|lambda#24| 0 (+ l1@@4 l2@@4) l1@@4 m1@@5 m2@@5 l1@@4 DefaultVecElem_11252) (+ l1@@4 l2@@4)))))))) (and (=> (= (ControlFlow 0 224430) 224647) anon15_Then_correct) (=> (= (ControlFlow 0 224430) 224577) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not false) (= (ControlFlow 0 224436) 224430)) |inline$$1_Vector_append'u8'$1$anon0_correct|)))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (and (not false) (= $t3@0 (|v#$Mutation_106221| |inline$$1_Vector_append'u8'$0$m'@1|))) (and (= $t7@0 ($Mutation_106221 ($Local 3) (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0) $t3@0)) (= call1formal@res@0 (|$1_BCS_serialize'u64'| _$t2)))) (and (=> (= (ControlFlow 0 224373) 224661) anon14_Then_correct) (=> (= (ControlFlow 0 224373) 224436) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$0$m'@1| ($Mutation_106221 (|l#$Mutation_106221| $t4@0) (|p#$Mutation_106221| $t4@0) (let ((m2@@6 (|v#Vec_21610| call1formal@res@0@@0)))
(let ((l2@@5 (|l#Vec_21610| call1formal@res@0@@0)))
(let ((m1@@6 (|v#Vec_21610| (|v#$Mutation_106221| $t4@0))))
(let ((l1@@5 (|l#Vec_21610| (|v#$Mutation_106221| $t4@0))))
(Vec_21610 (|lambda#24| 0 (+ l1@@5 l2@@5) l1@@5 m1@@6 m2@@6 l1@@5 DefaultVecElem_11252) (+ l1@@5 l2@@5)))))))) (and (=> (= (ControlFlow 0 224343) 224675) anon13_Then_correct) (=> (= (ControlFlow 0 224343) 224373) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not false) (= (ControlFlow 0 224349) 224343)) |inline$$1_Vector_append'u8'$0$anon0_correct|)))
(let ((anon12_Then_correct true))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (|$IsValid'vec'u8''| _$t1) (|$IsValid'u64'| _$t2)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t1 _$t1)) (and (= $t4@0 ($Mutation_106221 ($Local 3) (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0) _$t1)) (= call1formal@res@0@@0 (|$1_BCS_serialize'address'| _$t0))))) (and (=> (= (ControlFlow 0 224286) 224689) anon12_Then_correct) (=> (= (ControlFlow 0 224286) 224349) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 224220) 224286)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_21610| (|p#$Mutation_106221| $t4)) 0) (= (|l#Vec_21610| (|p#$Mutation_106221| $t7)) 0)) (and (= (|l#Vec_21610| (|p#$Mutation_106221| $t9)) 0) (= (ControlFlow 0 224230) 224220))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 304011) 224230) anon0_correct)))
