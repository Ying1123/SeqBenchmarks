...
(declare-fun $t46 () T@$1_Event_EventHandle)
(declare-fun |Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle| Int) T@$1_NetworkIdentity_NetworkIdentityEventHandle)
(declare-fun $1_NetworkIdentity_NetworkIdentityEventHandle_$memory () T@$Memory_91407)
(declare-fun $t47 () T@$1_NetworkIdentity_NetworkIdentityChangeNotification)
(declare-fun $t15 () Int)
...
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory@2 () T@$Memory_91560)
(declare-fun |Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds| Int) T@$1_DiemTimestamp_CurrentTimeMicroseconds)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory () T@$Memory_76747)
(declare-fun _$t1 () T@Vec_44531)
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory () T@$Memory_91560)
(declare-fun $t17 () Bool)
(declare-fun $t16 () T@Vec_44531)
(declare-fun $es@1 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun |Store__T@[$EventRep]Int_| (|T@[$EventRep]Int| T@$EventRep Int) |T@[$EventRep]Int|)
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?x2 Int)) (! (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?y1 T@$EventRep) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$EventRep]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_44199_| (|T@[$1_Event_EventHandle]Multiset_44199| T@$1_Event_EventHandle T@Multiset_44199) |T@[$1_Event_EventHandle]Multiset_44199|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_44199|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_44199)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|Store__T@[$1_Event_EventHandle]Multiset_44199_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_44199|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_44199)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|Store__T@[$1_Event_EventHandle]Multiset_44199_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_44199_| ?x0 ?y1))) :weight 0)))
(declare-fun $abort_flag@1 () Bool)
(declare-fun $1_NetworkIdentity_NetworkIdentity_$memory@1 () T@$Memory_91560)
(declare-fun $es@0 () T@$EventStore)
(declare-fun $t37 () Bool)
(declare-fun $t35@2 () T@$Mutation_98842)
...
(declare-fun $t41@0 () T@$Mutation_69605)
(declare-fun $t45@0 () T@$1_NetworkIdentity_NetworkIdentityChangeNotification)
(declare-fun $t44 () Bool)
(declare-fun $t43 () Int)
(declare-fun $t31 () Int)
(declare-fun $t42@0 () T@Vec_44531)
(declare-fun $t19 () Int)
(declare-fun $t40@1 () T@$Mutation_98906)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t40 () T@$Mutation_98906)
(declare-fun $t40@0 () T@$Mutation_98906)
...
(declare-fun $t35@1 () T@$Mutation_98842)
(declare-fun $t36@0 () T@$Mutation_62774)
(declare-fun |$temp_0'vec'vec'u8'''@0| () T@Vec_44531)
(declare-fun $t38@0 () T@Vec_44531)
(declare-fun $t36@1 () T@$Mutation_62774)
(declare-fun |$temp_0'vec'vec'u8'''@1| () T@Vec_44531)
(declare-fun $t35 () T@$Mutation_98842)
(declare-fun $t35@0 () T@$Mutation_98842)
...
(declare-fun $t26 () Int)
(declare-fun inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 () Bool)
(declare-fun $t21 () Int)
(declare-fun $1_Roles_RoleId_$memory () T@$Memory_76935)
(declare-fun |Select__T@[Int]$1_Roles_RoleId_| (|T@[Int]$1_Roles_RoleId| Int) T@$1_Roles_RoleId)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory () T@$Memory_78351)
(declare-fun $1_DiemConfig_Configuration_$memory () T@$Memory_78465)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory| () T@$Memory_78384)
(declare-fun $1_DiemSystem_CapabilityHolder_$memory () T@$Memory_79892)
(declare-fun |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory| () T@$Memory_78564)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_80223)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory| () T@$Memory_84998)
(declare-fun $1_XDX_Reserve_$memory () T@$Memory_85304)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_80287)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory| () T@$Memory_85217)
(declare-fun |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory| () T@$Memory_86221)
(declare-fun $1_DualAttestation_Limit_$memory () T@$Memory_86464)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory| () T@$Memory_78628)
(declare-fun $1_ChainId_ChainId_$memory () T@$Memory_87694)
(declare-fun $1_AccountFreezing_FreezeEventsHolder_$memory () T@$Memory_88039)
(declare-fun $1_AccountFreezing_FreezingBit_$memory () T@$Memory_87727)
(declare-fun |Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|T@[Int]$1_AccountFreezing_FreezingBit| Int) T@$1_AccountFreezing_FreezingBit)
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory () T@$Memory_88930)
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory () T@$Memory_89334)
(declare-fun $1_DiemBlock_BlockMetadata_$memory () T@$Memory_89869)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory| () T@$Memory_78692)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory| () T@$Memory_78756)
(declare-fun $1_Signer_is_txn_signer (T@$signer) Bool)
(declare-fun $1_Signer_is_txn_signer_addr (Int) Bool)
(declare-fun $t12 () T@$Mutation_62774)
(declare-fun $t13 () T@$Mutation_98842)
(declare-fun $t36 () T@$Mutation_62774)
(declare-fun $t41 () T@$Mutation_69605)
(push 1)
(set-info :boogie-vc-id $1_NetworkIdentity_remove_identities$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 122097) (let ((L11_correct  (=> (and (= $t46 (|$identity_change_events#$1_NetworkIdentity_NetworkIdentityEventHandle| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (= $t47 ($1_NetworkIdentity_NetworkIdentityChangeNotification $t15 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)))) (and (=> (= (ControlFlow 0 112326) (- 0 124392)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (and (=> (= (ControlFlow 0 112326) (- 0 124402)) (not (= (|l#Vec_44531| _$t1) 0))) (=> (not (= (|l#Vec_44531| _$t1) 0)) (and (=> (= (ControlFlow 0 112326) (- 0 124414)) (not (> (|l#Vec_44531| _$t1) 100))) (=> (not (> (|l#Vec_44531| _$t1) 100)) (and (=> (= (ControlFlow 0 112326) (- 0 124426)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and (=> (= (ControlFlow 0 112326) (- 0 124438)) (not (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 112326) (- 0 124452)) (let (($range_0 _$t1))
(forall (($i_1 Int) ) (!  (=> (InRangeVec_62197 $range_0 $i_1) (let ((e@@16 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0) $i_1)))
 (not (exists ((i@@77 Int) ) (!  (and (and (|$IsValid'u64'| i@@77) (InRangeVec_62197 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@77)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))) i@@77) e@@16))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6930:37|
 :skolemid |270|
)))) (=> (let (($range_0@@0 _$t1))
(forall (($i_1@@0 Int) ) (!  (=> (InRangeVec_62197 $range_0@@0 $i_1@@0) (let ((e@@17 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@0) $i_1@@0)))
 (not (exists ((i@@78 Int) ) (!  (and (and (|$IsValid'u64'| i@@78) (InRangeVec_62197 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@78)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))) i@@78) e@@17))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6930:37|
 :skolemid |270|
))) (and (=> (= (ControlFlow 0 112326) (- 0 124490)) (let (($range_0@@1 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))))
(forall (($i_1@@1 Int) ) (!  (=> (InRangeVec_62197 $range_0@@1 $i_1@@1) (let ((e@@18 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@1) $i_1@@1)))
(exists ((i@@79 Int) ) (!  (and (and (|$IsValid'u64'| i@@79) (InRangeVec_62197 $t16 i@@79)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $t16) i@@79) e@@18))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
))))
 :qid |NetworkIdentitybpl.6936:146|
 :skolemid |271|
)))) (=> (let (($range_0@@2 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))))
(forall (($i_1@@2 Int) ) (!  (=> (InRangeVec_62197 $range_0@@2 $i_1@@2) (let ((e@@19 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@2) $i_1@@2)))
(exists ((i@@80 Int) ) (!  (and (and (|$IsValid'u64'| i@@80) (InRangeVec_62197 $t16 i@@80)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $t16) i@@80) e@@19))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
))))
 :qid |NetworkIdentitybpl.6936:146|
 :skolemid |271|
))) (and (=> (= (ControlFlow 0 112326) (- 0 124527)) (let (($range_0@@3 $t16))
(forall (($i_1@@3 Int) ) (!  (=> (InRangeVec_62197 $range_0@@3 $i_1@@3) (let ((e@@20 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@3) $i_1@@3)))
 (or (exists ((i@@81 Int) ) (!  (and (and (|$IsValid'u64'| i@@81) (InRangeVec_62197 _$t1 i@@81)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| _$t1) i@@81) e@@20))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)) (exists ((i@@82 Int) ) (!  (and (and (|$IsValid'u64'| i@@82) (InRangeVec_62197 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@82)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))) i@@82) e@@20))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6942:38|
 :skolemid |272|
)))) (=> (let (($range_0@@4 $t16))
(forall (($i_1@@4 Int) ) (!  (=> (InRangeVec_62197 $range_0@@4 $i_1@@4) (let ((e@@21 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@4) $i_1@@4)))
 (or (exists ((i@@83 Int) ) (!  (and (and (|$IsValid'u64'| i@@83) (InRangeVec_62197 _$t1 i@@83)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| _$t1) i@@83) e@@21))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)) (exists ((i@@84 Int) ) (!  (and (and (|$IsValid'u64'| i@@84) (InRangeVec_62197 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15)) i@@84)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory@2) $t15))) i@@84) e@@21))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6942:38|
 :skolemid |272|
))) (and (=> (= (ControlFlow 0 112326) (- 0 124571)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite $t17 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new (let ((len (|l#Multiset_44199| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@0) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_44199 (|Store__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@0) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@40 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected) handle@@1)) v@@40) (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual) handle@@1)) v@@40))
 :qid |NetworkIdentitybpl.164:13|
 :skolemid |5|
)))
 :qid |NetworkIdentitybpl.2422:13|
 :skolemid |85|
...
(let ((expected@@0 (ite $t17 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_44199| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@1) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_44199 (|Store__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@1) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new@@0)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@41 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected@@0) handle@@2)) v@@41) (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual@@0) handle@@2)) v@@41))
 :qid |NetworkIdentitybpl.164:13|
 :skolemid |5|
)))
 :qid |NetworkIdentitybpl.2422:13|
 :skolemid |85|
))))) (=> (= (ControlFlow 0 112326) (- 0 124598)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite $t17 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_44199| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@2) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47))))
(Multiset_44199 (|Store__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@2) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t47) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $EmptyEventStore) $t46 stream_new@@1)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@42 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| actual@@1) handle@@3)) v@@42) (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| expected@@1) handle@@3)) v@@42))
 :qid |NetworkIdentitybpl.164:13|
 :skolemid |5|
)))
 :qid |NetworkIdentitybpl.2422:13|
...
(let ((anon49_Else_correct  (=> (and (and (not $abort_flag@1) (= $1_NetworkIdentity_NetworkIdentity_$memory@2 $1_NetworkIdentity_NetworkIdentity_$memory@1)) (and (= $es@1 $es@0) (= (ControlFlow 0 112618) 112326))) L11_correct)))
(let ((anon45_Else_correct  (=> (not $t37) (and (=> (= (ControlFlow 0 112045) (- 0 123716)) (let (($range_0@@5 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(let (($range_1 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0@@5 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@85 $i_2))
(let ((j@@24 $i_3))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) i@@85) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) j@@24)) (= i@@85 j@@24))))))
 :qid |NetworkIdentitybpl.6875:223|
 :skolemid |269|
))))) (=> (let (($range_0@@6 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(let (($range_1@@0 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(forall (($i_2@@0 Int) ($i_3@@0 Int) ) (!  (=> ($InRange $range_0@@6 $i_2@@0) (=> ($InRange $range_1@@0 $i_3@@0) (let ((i@@86 $i_2@@0))
(let ((j@@25 $i_3@@0))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) i@@86) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) j@@25)) (= i@@86 j@@25))))))
 :qid |NetworkIdentitybpl.6875:223|
 :skolemid |269|
)))) (=> (and (and (= $1_NetworkIdentity_NetworkIdentity_$memory@0 ($Memory_91560 (|Store__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_98842| $t35@2)) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_98842| $t35@2)) (|v#$Mutation_98842| $t35@2)))) (= $1_NetworkIdentity_NetworkIdentity_$memory@2 $1_NetworkIdentity_NetworkIdentity_$memory@0)) (and (= $es@1 $es) (= (ControlFlow 0 112045) 112326))) L11_correct))))))
(let ((anon39_Then_correct true))
(let ((L13_correct  (and (=> (= (ControlFlow 0 111182) (- 0 124198)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (|l#Vec_44531| _$t1) 0)) (> (|l#Vec_44531| _$t1) 100)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (|l#Vec_44531| _$t1) 0)) (> (|l#Vec_44531| _$t1) 100)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (= (ControlFlow 0 111182) (- 0 124241)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= 5 $t19@0)) (and (= (|l#Vec_44531| _$t1) 0) (= 7 $t19@0))) (and (> (|l#Vec_44531| _$t1) 100) (= 8 $t19@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15)) (= 5 $t19@0))) (and (and $t17 (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t19@0))))))))
(let ((anon49_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t19@0 $abort_code@2) (= (ControlFlow 0 112632) 111182))) L13_correct)))
(let ((|inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1| (|v#$Mutation_69605| $t41@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_44199| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@3) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t45@0))))
(Multiset_44199 (|Store__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@3) (|$ToEventRep'$1_NetworkIdentity_NetworkIdentityChangeNotification'| $t45@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 112602) 112632) anon49_Then_correct) (=> (= (ControlFlow 0 112602) 112618) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (not $t44) (=> (and (and (|$IsValid'u64'| $t43) (= $t43 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t45@0 ($1_NetworkIdentity_NetworkIdentityChangeNotification $t31 $t42@0 $t43)) (= (ControlFlow 0 112608) 112602))) |inline$$1_Event_emit_event'$1_NetworkIdentity_NetworkIdentityChangeNotification'$0$anon0_correct|))))
(let ((anon48_Then_correct  (=> $t44 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t19)) (= $t19 $t19)) (and (= $t19@0 $t19) (= (ControlFlow 0 112658) 111182))) L13_correct))))
(let ((anon47_Else_correct  (=> (not $abort_flag@1) (=> (and (= $t41@0 ($Mutation_69605 (|l#$Mutation_98906| $t40@1) (let ((l (|l#Vec_18710| (|p#$Mutation_98906| $t40@1))))
(Vec_18710 (|Store__T@[Int]Int_| (|v#Vec_18710| (|p#$Mutation_98906| $t40@1)) l 0) (+ l 1))) (|$identity_change_events#$1_NetworkIdentity_NetworkIdentityEventHandle| (|v#$Mutation_98906| $t40@1)))) (= $t42@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2)))) (and (=> (= (ControlFlow 0 112499) (- 0 123934)) (let (($range_0@@7 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(let (($range_1@@1 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(forall (($i_2@@1 Int) ($i_3@@1 Int) ) (!  (=> ($InRange $range_0@@7 $i_2@@1) (=> ($InRange $range_1@@1 $i_3@@1) (let ((i@@87 $i_2@@1))
(let ((j@@26 $i_3@@1))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) i@@87) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) j@@26)) (= i@@87 j@@26))))))
 :qid |NetworkIdentitybpl.6807:223|
 :skolemid |268|
))))) (=> (let (($range_0@@8 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(let (($range_1@@2 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))))))
(forall (($i_2@@2 Int) ($i_3@@2 Int) ) (!  (=> ($InRange $range_0@@8 $i_2@@2) (=> ($InRange $range_1@@2 $i_3@@2) (let ((i@@88 $i_2@@2))
(let ((j@@27 $i_3@@2))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) i@@88) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@2))) j@@27)) (= i@@88 j@@27))))))
 :qid |NetworkIdentitybpl.6807:223|
 :skolemid |268|
)))) (=> (and (= $1_NetworkIdentity_NetworkIdentity_$memory@1 ($Memory_91560 (|Store__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_98842| $t35@2)) true) (|Store__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) (|a#$Global| (|l#$Mutation_98842| $t35@2)) (|v#$Mutation_98842| $t35@2)))) (= $t44  (not (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 112499) 112658) anon48_Then_correct) (=> (= (ControlFlow 0 112499) 112608) anon48_Else_correct)))))))))
(let ((anon47_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t19@0 $abort_code@2) (= (ControlFlow 0 112672) 111182))) L13_correct)))
(let ((anon46_Then$1_correct  (=> (= $t40@1 $t40) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 112724) 112672) anon47_Then_correct) (=> (= (ControlFlow 0 112724) 112499) anon47_Else_correct))))))
(let ((anon46_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= (ControlFlow 0 112722) 112724)) anon46_Then$1_correct)))
(let ((anon46_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453) (=> (and (and (= $t40@0 ($Mutation_98906 ($Global 186537453) (Vec_18710 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453))) (= $t40@1 $t40@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 112358) 112672) anon47_Then_correct) (=> (= (ControlFlow 0 112358) 112499) anon47_Else_correct))))))
(let ((anon45_Then_correct  (=> (and $t37 (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 112336) 112722) anon46_Then_correct) (=> (= (ControlFlow 0 112336) 112358) anon46_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0| (|v#$Mutation_98842| $t35@1))) (=> (and (and (= |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0| |$temp_0'$1_NetworkIdentity_NetworkIdentity'@0|) (= $t36@0 ($Mutation_62774 (|l#$Mutation_98842| $t35@1) (let ((l@@0 (|l#Vec_18710| (|p#$Mutation_98842| $t35@1))))
(Vec_18710 (|Store__T@[Int]Int_| (|v#Vec_18710| (|p#$Mutation_98842| $t35@1)) l@@0 0) (+ l@@0 1))) (|$identities#$1_NetworkIdentity_NetworkIdentity| (|v#$Mutation_98842| $t35@1))))) (and (= |$temp_0'vec'vec'u8'''@0| (|v#$Mutation_62774| $t36@0)) (= |$temp_0'vec'vec'u8'''@0| |$temp_0'vec'vec'u8'''@0|))) (and (=> (= (ControlFlow 0 111936) (- 0 123362)) (let (($range_0@@9 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@0)))))
(let (($range_1@@3 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@0)))))
(forall (($i_2@@3 Int) ($i_3@@3 Int) ) (!  (=> ($InRange $range_0@@9 $i_2@@3) (=> ($InRange $range_1@@3 $i_3@@3) (let ((i@@89 $i_2@@3))
(let ((j@@28 $i_3@@3))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@0)) i@@89) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@0)) j@@28)) (= i@@89 j@@28))))))
 :qid |NetworkIdentitybpl.6715:127|
 :skolemid |262|
))))) (=> (let (($range_0@@10 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@0)))))
(let (($range_1@@4 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@0)))))
(forall (($i_2@@4 Int) ($i_3@@4 Int) ) (!  (=> ($InRange $range_0@@10 $i_2@@4) (=> ($InRange $range_1@@4 $i_3@@4) (let ((i@@90 $i_2@@4))
(let ((j@@29 $i_3@@4))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@0)) i@@90) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@0)) j@@29)) (= i@@90 j@@29))))))
 :qid |NetworkIdentitybpl.6715:127|
 :skolemid |262|
)))) (=> (= $t38@0 (|v#$Mutation_62774| $t36@0)) (=> (and (= $t36@1 ($Mutation_62774 (|l#$Mutation_62774| $t36@0) (|p#$Mutation_62774| $t36@0) |$temp_0'vec'vec'u8'''@1|)) (|$IsValid'vec'vec'u8'''| (|v#$Mutation_62774| $t36@1))) (=> (and (and (and (|$IsValid'vec'vec'u8'''| (|v#$Mutation_62774| $t36@1)) (let (($range_0@@11 _$t1))
(forall (($i_1@@5 Int) ) (!  (=> (InRangeVec_62197 $range_0@@11 $i_1@@5) (let ((e@@22 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@11) $i_1@@5)))
 (not (exists ((i@@91 Int) ) (!  (and (and (|$IsValid'u64'| i@@91) (InRangeVec_62197 (|v#$Mutation_62774| $t36@1) i@@91)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@1)) i@@91) e@@22))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6736:42|
 :skolemid |263|
)))) (and (let (($range_0@@12 (|v#$Mutation_62774| $t36@1)))
(forall (($i_1@@6 Int) ) (!  (=> (InRangeVec_62197 $range_0@@12 $i_1@@6) (let ((e@@23 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@12) $i_1@@6)))
(exists ((i@@92 Int) ) (!  (and (and (|$IsValid'u64'| i@@92) (InRangeVec_62197 $t38@0 i@@92)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $t38@0) i@@92) e@@23))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
))))
 :qid |NetworkIdentitybpl.6740:57|
 :skolemid |264|
))) (let (($range_0@@13 $t38@0))
(forall (($i_1@@7 Int) ) (!  (=> (InRangeVec_62197 $range_0@@13 $i_1@@7) (let ((e@@24 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@13) $i_1@@7)))
 (or (exists ((i@@93 Int) ) (!  (and (and (|$IsValid'u64'| i@@93) (InRangeVec_62197 _$t1 i@@93)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| _$t1) i@@93) e@@24))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)) (exists ((i@@94 Int) ) (!  (and (and (|$IsValid'u64'| i@@94) (InRangeVec_62197 (|v#$Mutation_62774| $t36@1) i@@94)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@1)) i@@94) e@@24))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
)))))
 :qid |NetworkIdentitybpl.6744:43|
 :skolemid |265|
))))) (and (and (let (($range_0@@14 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@1)))))
(let (($range_1@@5 ($Range 0 (|l#Vec_44531| (|v#$Mutation_62774| $t36@1)))))
(forall (($i_2@@5 Int) ($i_3@@5 Int) ) (!  (=> ($InRange $range_0@@14 $i_2@@5) (=> ($InRange $range_1@@5 $i_3@@5) (let ((i@@95 $i_2@@5))
(let ((j@@30 $i_3@@5))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@1)) i@@95) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|v#$Mutation_62774| $t36@1)) j@@30)) (= i@@95 j@@30))))))
 :qid |NetworkIdentitybpl.6748:132|
 :skolemid |266|
)))) (= $t37 (let (($range_0@@15 _$t1))
(exists (($i_1@@8 Int) ) (!  (and (InRangeVec_62197 $range_0@@15 $i_1@@8) (let ((e@@25 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@15) $i_1@@8)))
(exists ((i@@96 Int) ) (!  (and (and (|$IsValid'u64'| i@@96) (InRangeVec_62197 $t38@0 i@@96)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $t38@0) i@@96) e@@25))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
))))
 :qid |NetworkIdentitybpl.6753:63|
 :skolemid |267|
))))) (and (= $t35@2 ($Mutation_98842 (|l#$Mutation_98842| $t35@1) (|p#$Mutation_98842| $t35@1) ($1_NetworkIdentity_NetworkIdentity (|v#$Mutation_62774| $t36@1)))) (= $t37 $t37)))) (and (=> (= (ControlFlow 0 111936) 112336) anon45_Then_correct) (=> (= (ControlFlow 0 111936) 112045) anon45_Else_correct)))))))))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t19@0 $abort_code@1) (= (ControlFlow 0 112738) 111182))) L13_correct)))
(let ((anon43_Then$1_correct  (=> (= $t35@1 $t35) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 112790) 112738) anon44_Then_correct) (=> (= (ControlFlow 0 112790) 111936) anon44_Else_correct))))))
(let ((anon43_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t31)) (= (ControlFlow 0 112788) 112790)) anon43_Then$1_correct)))
(let ((anon43_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t31) (=> (and (and (= $t35@0 ($Mutation_98842 ($Global $t31) (Vec_18710 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t31))) (= $t35@1 $t35@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 111552) 112738) anon44_Then_correct) (=> (= (ControlFlow 0 111552) 111936) anon44_Else_correct))))))
(let ((anon42_Then_correct  (=> $t32@0 (and (=> (= (ControlFlow 0 111530) (- 0 123204)) (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t31)) (=> (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t31) (and (=> (= (ControlFlow 0 111530) 112788) anon43_Then_correct) (=> (= (ControlFlow 0 111530) 111552) anon43_Else_correct)))))))
(let ((anon42_Else_correct  (=> (and (and (not $t32@0) (= $t34 $t34)) (and (= $t19@0 $t34) (= (ControlFlow 0 111520) 111182))) L13_correct)))
(let ((anon41_Then_correct  (=> (and inline$$Le$0$dst@1 (|$IsValid'address'| $t31)) (=> (and (and (and (= $t31 (|$addr#$signer| _$t0)) (= $t31 $t31)) (and (= $t32@0 (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t31)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t34) (= $t34 5)) (and (= $t34 $t34) (= $t32@0 $t32@0)))) (and (=> (= (ControlFlow 0 111504) 111530) anon42_Then_correct) (=> (= (ControlFlow 0 111504) 111520) anon42_Else_correct))))))
(let ((anon41_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t30 $t30)) (and (= $t19@0 $t30) (= (ControlFlow 0 111442) 111182))) L13_correct)))
(let ((anon40_Then$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t30) (= $t30 8)) (and (= $t30 $t30) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 111426) 111504) anon41_Then_correct) (=> (= (ControlFlow 0 111426) 111442) anon41_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'vec'u8''$0$l@1| 100)) (= (ControlFlow 0 111386) 111426)) anon40_Then$1_correct)))
(let ((anon40_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (|$IsValid'u64'| 100) (= (ControlFlow 0 111392) 111386)) inline$$Le$0$anon0_correct))))
(let ((anon40_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t26 $t26)) (and (= $t19@0 $t26) (= (ControlFlow 0 111336) 111182))) L13_correct)))
(let ((anon39_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 7)) (and (= $t26 $t26) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 111320) 111392) anon40_Then_correct) (=> (= (ControlFlow 0 111320) 111336) anon40_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Vector_length'vec'u8''$0$l@1| 0)) (= (ControlFlow 0 111284) 111320)) anon39_Else$1_correct)))
(let ((anon39_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'vec'u8''$0$l@1| |inline$$1_Vector_length'vec'u8''$0$l@1|)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 111290) 111284))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Vector_length'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_length'vec'u8''$0$l@1| (|l#Vec_44531| _$t1)) (and (=> (= (ControlFlow 0 111216) 112804) anon39_Then_correct) (=> (= (ControlFlow 0 111216) 111290) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (and inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 (= (ControlFlow 0 111222) 111216)) |inline$$1_Vector_length'vec'u8''$0$anon0_correct|)))
(let ((anon38_Else_correct  (=> (and (and (not inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1) (= $t21 $t21)) (and (= $t19@0 $t21) (= (ControlFlow 0 111038) 111182))) L13_correct)))
(let ((anon37_Else_correct  (=> (and (not false) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 5)) (and (= $t21 $t21) (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 111022) 111222) anon38_Then_correct) (=> (= (ControlFlow 0 111022) 111038) anon38_Else_correct))))))
(let ((anon37_Then_correct true))
(let ((inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) 186537453)) (= inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1 inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 110980) 112818) anon37_Then_correct) (=> (= (ControlFlow 0 110980) 111022) anon37_Else_correct))))))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_76935| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_76935| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_76935| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_76935| $1_Roles_RoleId_$memory) 186537453)) 1))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78351| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78351| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78465| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_78384| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_79892| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78564| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_80223| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_84998| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))))) (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85304| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_80287| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_85217| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_86221| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_86464| $1_DualAttestation_Limit_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78628| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_87694| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_88039| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87727| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_87727| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87727| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_87727| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_88039| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_88930| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_89334| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_89869| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78692| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_78756| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'vec'vec'u8'''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |NetworkIdentitybpl.6413:20|
 :skolemid |257|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_76747| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0@@0)))
 (and (|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc@@0) (let (($range_1@@6 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)))))
(let (($range_2 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)))))
(forall (($i_3@@6 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@6 $i_3@@6) (=> ($InRange $range_2 $i_4) (let ((i@@97 $i_3@@6))
(let ((j@@31 $i_4))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)) i@@97) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc@@0)) j@@31)) (= i@@97 j@@31))))))
 :qid |NetworkIdentitybpl.6418:249|
 :skolemid |258|
))))))
 :qid |NetworkIdentitybpl.6417:20|
 :skolemid |259|
 :pattern ( (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0@@0))
)))) (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) $a_0@@1)))
(|$IsValid'$1_NetworkIdentity_NetworkIdentityEventHandle'| $rsc@@1))
 :qid |NetworkIdentitybpl.6423:20|
 :skolemid |260|
 :pattern ( (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentityEventHandle_| (|contents#$Memory_91407| $1_NetworkIdentity_NetworkIdentityEventHandle_$memory) $a_0@@1))
)) (= $t15 (|$addr#$signer| _$t0))) (and (= $t16 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $t15))) (= $t17 (let (($range_0@@16 _$t1))
(exists (($i_1@@9 Int) ) (!  (and (InRangeVec_62197 $range_0@@16 $i_1@@9) (let ((e@@26 (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $range_0@@16) $i_1@@9)))
(exists ((i@@98 Int) ) (!  (and (and (|$IsValid'u64'| i@@98) (InRangeVec_62197 $t16 i@@98)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| $t16) i@@98) e@@26))
 :qid |NetworkIdentitybpl.1712:13|
 :skolemid |63|
))))
 :qid |NetworkIdentitybpl.6436:51|
 :skolemid |261|
)))))) (and (and (|Select__T@[Int]Bool_| $1_NetworkIdentity_NetworkIdentity_$modifies $t15) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 110986) 110980))))) inline$$1_NetworkIdentity_tc_network_identity_event_handle_exists$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_44199| stream@@4) 0) (forall ((v@@43 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_44199| stream@@4) v@@43) 0)
 :qid |NetworkIdentitybpl.159:13|
 :skolemid |4|
))))
 :qid |NetworkIdentitybpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 110335) 110986)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_18710| (|p#$Mutation_62774| $t12)) 0) (=> (and (= (|l#Vec_18710| (|p#$Mutation_98842| $t13)) 0) (= (|l#Vec_18710| (|p#$Mutation_98842| $t35)) 0)) (=> (and (and (= (|l#Vec_18710| (|p#$Mutation_62774| $t36)) 0) (= (|l#Vec_18710| (|p#$Mutation_98906| $t40)) 0)) (and (= (|l#Vec_18710| (|p#$Mutation_69605| $t41)) 0) (= (ControlFlow 0 110345) 110335))) inline$$InitEventStore$0$anon0_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 122097) 110345) anon0_correct)))
