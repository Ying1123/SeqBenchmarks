...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 117831) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 105642) (- 0 118201)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))) (=> (= (ControlFlow 0 105642) (- 0 118212)) (|$IsEqual'vec'vec'u8'''| $t8@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 105576) (- 0 118154)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (=> (= (ControlFlow 0 105576) (- 0 118160)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 105656) 105576))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 105708) 105656) anon12_Then_correct) (=> (= (ControlFlow 0 105708) 105642) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= (ControlFlow 0 105706) 105708)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 105594) 105656) anon12_Then_correct) (=> (= (ControlFlow 0 105594) 105642) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 105580) 105706) anon11_Then_correct) (=> (= (ControlFlow 0 105580) 105594) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 105544) 105576))) L3_correct)))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0)))
 (and (|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc) (let (($range_1 ($Range 0 (|l#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)))))
...
(let ((j@@24 $i_4))
 (=> (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)) i@@77) (|Select__T@[Int]Vec_18710_| (|v#Vec_44531| (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)) j@@24)) (= i@@77 j@@24))))))
 :qid |NetworkIdentitybpl.5194:249|
 :skolemid |203|
))))))
 :qid |NetworkIdentitybpl.5193:20|
 :skolemid |204|
...
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_91560| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 105528) 105580) anon10_Then_correct) (=> (= (ControlFlow 0 105528) 105544) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_44199_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |NetworkIdentitybpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 105359) 105528)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 117831) 105359) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
