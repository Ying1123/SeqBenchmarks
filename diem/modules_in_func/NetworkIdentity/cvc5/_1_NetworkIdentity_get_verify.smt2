...
(assert (not
 (=> (= (ControlFlow 0 0) 104074) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 96018) (- 0 104444)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))) (=> (= (ControlFlow 0 96018) (- 0 104455)) (= $t8@0 (|$identities#$1_NetworkIdentity_NetworkIdentity| (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 95952) (- 0 104397)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (=> (= (ControlFlow 0 95952) (- 0 104403)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 96032) 95952))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 96084) 96032) anon12_Then_correct) (=> (= (ControlFlow 0 96084) 96018) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= (ControlFlow 0 96082) 96084)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 95970) 96032) anon12_Then_correct) (=> (= (ControlFlow 0 95970) 96018) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 95956) 96082) anon11_Then_correct) (=> (= (ControlFlow 0 95956) 95970) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 95920) 95952))) L3_correct)))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0)))
 (and (|$IsValid'$1_NetworkIdentity_NetworkIdentity'| $rsc) (let (($range_1 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)))))
(let (($range_2 ($Range 0 (seq.len (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc)))))
(forall (($i_3 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1 $i_3) (=> ($InRange $range_2 $i_4) (let ((i@@36 $i_3))
(let ((j@@8 $i_4))
 (=> (= (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc) i@@36) (seq.nth (|$identities#$1_NetworkIdentity_NetworkIdentity| $rsc) j@@8)) (= i@@36 j@@8))))))
 :qid |NetworkIdentitybpl.5130:249|
 :skolemid |183|
))))))
 :qid |NetworkIdentitybpl.5129:20|
 :skolemid |184|
 :pattern ( (|Select__T@[Int]$1_NetworkIdentity_NetworkIdentity_| (|contents#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_82842| $1_NetworkIdentity_NetworkIdentity_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 95904) 95956) anon10_Then_correct) (=> (= (ControlFlow 0 95904) 95920) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_42660_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_42660| stream@@0) 0) (forall ((v@@32 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_42660| stream@@0) v@@32) 0)
 :qid |NetworkIdentitybpl.134:13|
 :skolemid |2|
))))
 :qid |NetworkIdentitybpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 95735) 95904)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 104074) 95735) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
