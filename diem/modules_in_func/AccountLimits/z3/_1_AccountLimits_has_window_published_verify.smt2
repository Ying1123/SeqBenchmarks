...
(assert (not
 (=> (= (ControlFlow 0 0) 272280) (let ((anon0$1_correct@@7  (=> (and (and (and (forall ((window_addr@@5 Int) ) (!  (=> (|$IsValid'address'| window_addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@5)))))
 :qid |AccountLimitsbpl.9482:20|
 :skolemid |222|
)) (forall ((addr@@63 Int) ) (!  (=> (|$IsValid'address'| addr@@63) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) addr@@63) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@63) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@63)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@63)) 6)))))
 :qid |AccountLimitsbpl.9486:20|
 :skolemid |223|
))) (and (|$IsValid'address'| _$t0@@7) (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@14)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@14))
 :qid |AccountLimitsbpl.9493:20|
 :skolemid |224|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@14))
)))) (and (and (= _$t0@@7 _$t0@@7) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@7))) (and (= $t1@0@@5 $t1@0@@5) (= (ControlFlow 0 217477) (- 0 272456))))) (= $t1@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t0@@7)))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_81090| stream@@8) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@8) v@@37) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 217317) 217477)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 272280) 217317) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))
))
(check-sat)
(pop 1)
