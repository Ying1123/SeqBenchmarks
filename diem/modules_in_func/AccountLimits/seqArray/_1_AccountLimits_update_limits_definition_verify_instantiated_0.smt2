...
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_update_limits_definition$verify_instantiated_0)
(assert (not
 (=> (= (ControlFlow 0 0) 290084) (let ((L14_correct@@6 true))
(let ((anon26_Else_correct@@0  (=> (not inline$$Gt$3$dst@1@@0) (and (=> (= (ControlFlow 0 239575) (- 0 291948)) (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0)) (=> (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0) (and (=> (= (ControlFlow 0 239575) (- 0 291960)) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0)) (=> (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0) (and (=> (= (ControlFlow 0 239575) (- 0 291972)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0)) (=> (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0) (and (=> (= (ControlFlow 0 239575) (- 0 291984)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0)) (=> (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) 0) (=> (= |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1| ($Memory_115201 (|Store__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_166419| $t15@7@@0)) true) (|Store__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_| (|contents#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_166419| $t15@7@@0)) (|v#$Mutation_166419| $t15@7@@0)))) (and (=> (= (ControlFlow 0 239575) (- 0 292021)) (forall ((addr@@194 Int) ) (!  (=> (|$IsValid'address'| addr@@194) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) addr@@194) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) addr@@194)))
 :qid |AccountLimitsbpl.14468:15|
 :skolemid |428|
))) (=> (forall ((addr@@195 Int) ) (!  (=> (|$IsValid'address'| addr@@195) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) addr@@195) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) addr@@195)))
 :qid |AccountLimitsbpl.14468:15|
 :skolemid |428|
)) (and (=> (= (ControlFlow 0 239575) (- 0 292045)) (forall ((window_addr@@41 Int) ) (!  (=> (|$IsValid'address'| window_addr@@41) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@41) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@41)))))
 :qid |AccountLimitsbpl.14474:15|
 :skolemid |429|
))) (=> (forall ((window_addr@@42 Int) ) (!  (=> (|$IsValid'address'| window_addr@@42) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@42) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@42)))))
 :qid |AccountLimitsbpl.14474:15|
 :skolemid |429|
)) (and (=> (= (ControlFlow 0 239575) (- 0 292076)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 239575) (- 0 292090)) (forall ((addr@@196 Int) ) (!  (=> (|$IsValid'address'| addr@@196) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) addr@@196) (= addr@@196 173345816)))
 :qid |AccountLimitsbpl.14486:15|
 :skolemid |430|
))) (=> (forall ((addr@@197 Int) ) (!  (=> (|$IsValid'address'| addr@@197) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@1|) addr@@197) (= addr@@197 173345816)))
 :qid |AccountLimitsbpl.14486:15|
 :skolemid |430|
)) (=> (= (ControlFlow 0 239575) 239579) L14_correct@@6)))))))))))))))))))))
(let ((anon26_Then_correct@@0  (=> (and (and inline$$Gt$3$dst@1@@0 (= $t27@0@@0 ($Mutation_10128 (|l#$Mutation_166419| $t15@7@@0) (seq.++ (|p#$Mutation_166419| $t15@7@@0) (seq.unit 2)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0))))) (and (= $t27@1@@0 ($Mutation_10128 (|l#$Mutation_10128| $t27@0@@0) (|p#$Mutation_10128| $t27@0@@0) _$t5@@0)) (= $t15@8@@0 ($Mutation_166419 (|l#$Mutation_166419| $t15@7@@0) (|p#$Mutation_166419| $t15@7@@0) (|$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0)) (|v#$Mutation_10128| $t27@1@@0) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@7@@0))))))) (and (=> (= (ControlFlow 0 239778) (- 0 291775)) (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0)) (=> (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0) (and (=> (= (ControlFlow 0 239778) (- 0 291787)) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0)) (=> (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0) (and (=> (= (ControlFlow 0 239778) (- 0 291799)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0)) (=> (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0) (and (=> (= (ControlFlow 0 239778) (- 0 291811)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0)) (=> (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@8@@0)) 0) (=> (= |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0| ($Memory_115201 (|Store__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_166419| $t15@8@@0)) true) (|Store__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_| (|contents#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_166419| $t15@8@@0)) (|v#$Mutation_166419| $t15@8@@0)))) (and (=> (= (ControlFlow 0 239778) (- 0 291848)) (forall ((addr@@198 Int) ) (!  (=> (|$IsValid'address'| addr@@198) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) addr@@198) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) addr@@198)))
 :qid |AccountLimitsbpl.14403:15|
 :skolemid |425|
))) (=> (forall ((addr@@199 Int) ) (!  (=> (|$IsValid'address'| addr@@199) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) addr@@199) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) addr@@199)))
 :qid |AccountLimitsbpl.14403:15|
 :skolemid |425|
)) (and (=> (= (ControlFlow 0 239778) (- 0 291872)) (forall ((window_addr@@43 Int) ) (!  (=> (|$IsValid'address'| window_addr@@43) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@43) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@43)))))
 :qid |AccountLimitsbpl.14409:15|
 :skolemid |426|
))) (=> (forall ((window_addr@@44 Int) ) (!  (=> (|$IsValid'address'| window_addr@@44) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@44) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@44)))))
 :qid |AccountLimitsbpl.14409:15|
 :skolemid |426|
)) (and (=> (= (ControlFlow 0 239778) (- 0 291903)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 239778) (- 0 291917)) (forall ((addr@@200 Int) ) (!  (=> (|$IsValid'address'| addr@@200) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) addr@@200) (= addr@@200 173345816)))
 :qid |AccountLimitsbpl.14421:15|
 :skolemid |427|
))) (=> (forall ((addr@@201 Int) ) (!  (=> (|$IsValid'address'| addr@@201) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0|) addr@@201) (= addr@@201 173345816)))
 :qid |AccountLimitsbpl.14421:15|
 :skolemid |427|
)) (=> (= (ControlFlow 0 239778) 239579) L14_correct@@6)))))))))))))))))))))
(let ((inline$$Gt$3$anon0_correct@@0  (=> (= inline$$Gt$3$dst@1@@0 (> _$t5@@0 0)) (and (=> (= (ControlFlow 0 239398) 239778) anon26_Then_correct@@0) (=> (= (ControlFlow 0 239398) 239575) anon26_Else_correct@@0)))))
(let ((L10_correct@@0  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 239404) 239398)) inline$$Gt$3$anon0_correct@@0)))
(let ((anon25_Else_correct@@3  (=> (not inline$$Gt$2$dst@1@@0) (=> (and (= $t15@7@@0 $t15@5@@0) (= (ControlFlow 0 239350) 239404)) L10_correct@@0))))
(let ((anon25_Then_correct@@3  (=> (and inline$$Gt$2$dst@1@@0 (= $t24@0@@4 ($Mutation_10128 (|l#$Mutation_166419| $t15@5@@0) (seq.++ (|p#$Mutation_166419| $t15@5@@0) (seq.unit 3)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@5@@0))))) (=> (and (and (= $t24@1@@1 ($Mutation_10128 (|l#$Mutation_10128| $t24@0@@4) (|p#$Mutation_10128| $t24@0@@4) _$t4@@0)) (= $t15@6@@0 ($Mutation_166419 (|l#$Mutation_166419| $t15@5@@0) (|p#$Mutation_166419| $t15@5@@0) (|$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@5@@0)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@5@@0)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@5@@0)) (|v#$Mutation_10128| $t24@1@@1))))) (and (= $t15@7@@0 $t15@6@@0) (= (ControlFlow 0 239816) 239404))) L10_correct@@0))))
(let ((inline$$Gt$2$anon0_correct@@0  (=> (= inline$$Gt$2$dst@1@@0 (> _$t4@@0 0)) (and (=> (= (ControlFlow 0 239336) 239816) anon25_Then_correct@@3) (=> (= (ControlFlow 0 239336) 239350) anon25_Else_correct@@3)))))
(let ((L7_correct@@1  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 239342) 239336)) inline$$Gt$2$anon0_correct@@0)))
(let ((anon24_Else_correct@@3  (=> (not inline$$Gt$1$dst@1@@0) (=> (and (= $t15@5@@0 $t15@3@@0) (= (ControlFlow 0 239288) 239342)) L7_correct@@1))))
(let ((anon24_Then_correct@@3  (=> (and inline$$Gt$1$dst@1@@0 (= $t21@0@@3 ($Mutation_10128 (|l#$Mutation_166419| $t15@3@@0) (seq.++ (|p#$Mutation_166419| $t15@3@@0) (seq.unit 1)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@3@@0))))) (=> (and (and (= $t21@1@@0 ($Mutation_10128 (|l#$Mutation_10128| $t21@0@@3) (|p#$Mutation_10128| $t21@0@@3) _$t3@@0)) (= $t15@4@@0 ($Mutation_166419 (|l#$Mutation_166419| $t15@3@@0) (|p#$Mutation_166419| $t15@3@@0) (|$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@3@@0)) (|v#$Mutation_10128| $t21@1@@0) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@3@@0)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@3@@0)))))) (and (= $t15@5@@0 $t15@4@@0) (= (ControlFlow 0 239854) 239342))) L7_correct@@1))))
(let ((inline$$Gt$1$anon0_correct@@0  (=> (= inline$$Gt$1$dst@1@@0 (> _$t3@@0 0)) (and (=> (= (ControlFlow 0 239274) 239854) anon24_Then_correct@@3) (=> (= (ControlFlow 0 239274) 239288) anon24_Else_correct@@3)))))
(let ((L4_correct@@0  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 239280) 239274)) inline$$Gt$1$anon0_correct@@0)))
(let ((anon23_Else_correct@@3  (=> (not inline$$Gt$0$dst@1@@1) (=> (and (= $t15@3@@0 $t15@1@@0) (= (ControlFlow 0 239226) 239280)) L4_correct@@0))))
(let ((anon23_Then_correct@@3  (=> (and inline$$Gt$0$dst@1@@1 (= $t18@0@@3 ($Mutation_10128 (|l#$Mutation_166419| $t15@1@@0) (seq.++ (|p#$Mutation_166419| $t15@1@@0) (seq.unit 0)) (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@1@@0))))) (=> (and (and (= $t18@1@@3 ($Mutation_10128 (|l#$Mutation_10128| $t18@0@@3) (|p#$Mutation_10128| $t18@0@@3) _$t2@@6)) (= $t15@2@@0 ($Mutation_166419 (|l#$Mutation_166419| $t15@1@@0) (|p#$Mutation_166419| $t15@1@@0) (|$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_10128| $t18@1@@3) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@1@@0)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@1@@0)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| (|v#$Mutation_166419| $t15@1@@0)))))) (and (= $t15@3@@0 $t15@2@@0) (= (ControlFlow 0 239892) 239280))) L4_correct@@0))))
(let ((inline$$Gt$0$anon0_correct@@1  (=> (= inline$$Gt$0$dst@1@@1 (> _$t2@@6 0)) (and (=> (= (ControlFlow 0 239212) 239892) anon23_Then_correct@@3) (=> (= (ControlFlow 0 239212) 239226) anon23_Else_correct@@3)))))
(let ((anon22_Else_correct@@3  (=> (not $abort_flag@0@@14) (=> (and (and (= |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XUS_XUS''@0| (|v#$Mutation_166419| $t15@1@@0)) (= |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XUS_XUS''@0| |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XUS_XUS''@0|)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 239218) 239212))) inline$$Gt$0$anon0_correct@@1))))
(let ((anon22_Then_correct@@3 true))
(let ((anon21_Then$1_correct@@0  (=> (= $t15@1@@0 $t15@@7) (=> (and (= $abort_flag@0@@14 true) (= $abort_code@1@@14 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 239958) 239906) anon22_Then_correct@@3) (=> (= (ControlFlow 0 239958) 239218) anon22_Else_correct@@3))))))
(let ((anon21_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) _$t1@@14)) (= (ControlFlow 0 239956) 239958)) anon21_Then$1_correct@@0)))
(let ((anon21_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) _$t1@@14) (=> (and (and (= $t15@0@@4 ($Mutation_166419 ($Global _$t1@@14) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_| (|contents#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) _$t1@@14))) (= $t15@1@@0 $t15@0@@4)) (and (= $abort_flag@0@@14 false) (= $abort_code@1@@14 $abort_code@0@@14))) (and (=> (= (ControlFlow 0 239146) 239906) anon22_Then_correct@@3) (=> (= (ControlFlow 0 239146) 239218) anon22_Else_correct@@3))))))
(let ((anon20_Then_correct@@3  (=> $t12@0@@6 (and (=> (= (ControlFlow 0 239124) 239956) anon21_Then_correct@@3) (=> (= (ControlFlow 0 239124) 239146) anon21_Else_correct@@3)))))
(let ((anon20_Else_correct@@3 true))
(let ((anon19_Else_correct@@4  (=> (not $t10@@6) (=> (and (= $t12@0@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) _$t1@@14)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t14@@3) (= $t14@@3 5)) (and (= $t14@@3 $t14@@3) (= $t12@0@@6 $t12@0@@6))) (and (=> (= (ControlFlow 0 239098) 239124) anon20_Then_correct@@3) (=> (= (ControlFlow 0 239098) 239114) anon20_Else_correct@@3)))))))
(let ((anon19_Then_correct@@4 true))
(let ((anon0$1_correct@@17  (=> (forall ((addr@@202 Int) ) (!  (=> (|$IsValid'address'| addr@@202) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@202)) 0)) (= addr@@202 173345816)))
 :qid |AccountLimitsbpl.13981:20|
 :skolemid |395|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@203 Int) ) (!  (=> (|$IsValid'address'| addr@@203) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@203) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@203)) 1)) (= addr@@203 186537453)))
 :qid |AccountLimitsbpl.13989:20|
 :skolemid |396|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@204 Int) ) (!  (=> (|$IsValid'address'| addr@@204) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@204)) 2))))))
 :qid |AccountLimitsbpl.13997:20|
 :skolemid |397|
))) (and (forall ((addr@@205 Int) ) (!  (=> (|$IsValid'address'| addr@@205) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@205)) 2))))))
 :qid |AccountLimitsbpl.14001:20|
 :skolemid |398|
)) (forall ((addr@@206 Int) ) (!  (=> (|$IsValid'address'| addr@@206) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@206)) 2))))))
 :qid |AccountLimitsbpl.14005:20|
 :skolemid |399|
)))) (=> (and (and (and (forall ((addr@@207 Int) ) (!  (=> (|$IsValid'address'| addr@@207) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@207)) 2))))))
 :qid |AccountLimitsbpl.14009:20|
 :skolemid |400|
)) (forall ((addr@@208 Int) ) (!  (=> (|$IsValid'address'| addr@@208) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@208)) 2)))))
 :qid |AccountLimitsbpl.14013:20|
 :skolemid |401|
))) (and (forall ((addr@@209 Int) ) (!  (=> (|$IsValid'address'| addr@@209) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@209)) 2)))))
 :qid |AccountLimitsbpl.14017:20|
 :skolemid |402|
)) (forall ((addr@@210 Int) ) (!  (=> (|$IsValid'address'| addr@@210) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@210)) 2)))))
 :qid |AccountLimitsbpl.14021:20|
 :skolemid |403|
)))) (and (and (forall ((addr@@211 Int) ) (!  (=> (|$IsValid'address'| addr@@211) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@211) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@211) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@211)) 4))))
 :qid |AccountLimitsbpl.14025:20|
 :skolemid |404|
)) (forall ((addr@@212 Int) ) (!  (=> (|$IsValid'address'| addr@@212) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@212) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@212) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@212)) 3))))
 :qid |AccountLimitsbpl.14029:20|
 :skolemid |405|
))) (and (forall ((addr@@213 Int) ) (!  (=> (|$IsValid'address'| addr@@213) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@213) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@213) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@213)) 3))))
 :qid |AccountLimitsbpl.14033:20|
 :skolemid |406|
)) (forall ((addr@@214 Int) ) (!  (=> (|$IsValid'address'| addr@@214) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@214) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@214)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@214) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@214)) 3))))
 :qid |AccountLimitsbpl.14037:20|
 :skolemid |407|
))))) (=> (and (and (and (and (let (($range_0@@3 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@215 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@215))))))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i1@@3 $i_1@@3))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@216 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@216)))) i1@@3))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@216 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@216)))) i1@@3)))) 3))))
 :qid |AccountLimitsbpl.14041:151|
 :skolemid |408|
))) (forall ((window_addr@@45 Int) ) (!  (=> (|$IsValid'address'| window_addr@@45) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@45) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_117706| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory|) window_addr@@45)))))
 :qid |AccountLimitsbpl.14046:20|
 :skolemid |409|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)) (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) addr@@217) (= addr@@217 173345816)))
 :qid |AccountLimitsbpl.14054:20|
 :skolemid |410|
)))) (and (and (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1@@7) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@7)) 2)))))
 :qid |AccountLimitsbpl.14058:20|
 :skolemid |411|
)) (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141421| $1_DiemAccount_DiemAccount_$memory) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@218)))
 :qid |AccountLimitsbpl.14062:20|
 :skolemid |412|
))) (and (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141521| $1_VASPDomain_VASPDomainManager_$memory) addr@@219)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@219) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@219)) 1))))
 :qid |AccountLimitsbpl.14066:20|
 :skolemid |413|
)) (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141606| $1_VASPDomain_VASPDomains_$memory) addr@@220)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@220) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@220)) 5))))
 :qid |AccountLimitsbpl.14070:20|
 :skolemid |414|
))))) (and (and (and (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@221)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@221)) 2)))))
 :qid |AccountLimitsbpl.14074:20|
 :skolemid |415|
)) (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141740| $1_DesignatedDealer_Dealer_$memory) addr@@222)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@222) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@222)) 2))))
 :qid |AccountLimitsbpl.14078:20|
 :skolemid |416|
))) (and (forall ((addr@@223 Int) ) (!  (=> (|$IsValid'address'| addr@@223) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr@@223)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@223) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@223)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@223) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@223)) 5)))))
 :qid |AccountLimitsbpl.14082:20|
 :skolemid |417|
)) (forall ((addr@@224 Int) ) (!  (=> (|$IsValid'address'| addr@@224) (= (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) addr@@224)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@224) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@224)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@224) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@224)) 1)))))
 :qid |AccountLimitsbpl.14086:20|
 :skolemid |418|
)))) (and (and (forall ((addr@@225 Int) ) (!  (=> (|$IsValid'address'| addr@@225) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@225)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@225) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@225)) 3))))
 :qid |AccountLimitsbpl.14090:20|
 :skolemid |419|
)) (forall ((addr@@226 Int) ) (!  (=> (|$IsValid'address'| addr@@226) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@226)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@226) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@226)) 4))))
 :qid |AccountLimitsbpl.14094:20|
 :skolemid |420|
))) (and (forall ((addr@@227 Int) ) (!  (=> (|$IsValid'address'| addr@@227) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141995| $1_VASP_ParentVASP_$memory) addr@@227)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@227) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@227)) 5))))
 :qid |AccountLimitsbpl.14098:20|
 :skolemid |421|
)) (forall ((addr@@228 Int) ) (!  (=> (|$IsValid'address'| addr@@228) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142095| $1_VASP_ChildVASP_$memory) addr@@228)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@228) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@228)) 6))))
 :qid |AccountLimitsbpl.14102:20|
 :skolemid |422|
)))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@17)) ($1_Signer_is_txn_signer _$t0@@17)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@17))) (|$IsValid'address'| _$t1@@14)) (and (|$IsValid'u64'| _$t2@@6) (|$IsValid'u64'| _$t3@@0))) (and (and (|$IsValid'u64'| _$t4@@0) (|$IsValid'u64'| _$t5@@0)) (and (forall (($a_0@@39 Int) ) (! (let (($rsc@@39 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@39)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@39))
 :qid |AccountLimitsbpl.14123:20|
 :skolemid |423|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@39))
)) (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_| (|contents#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) $a_0@@40)))
 (and (|$IsValid'$1_AccountLimits_LimitsDefinition'$1_XUS_XUS''| $rsc@@40) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| $rsc@@40) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| $rsc@@40) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| $rsc@@40) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'| $rsc@@40) 0))))
 :qid |AccountLimitsbpl.14127:20|
 :skolemid |424|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_| (|contents#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) $a_0@@40))
))))) (and (and (and (= _$t0@@17 _$t0@@17) (= _$t1@@14 _$t1@@14)) (and (= _$t2@@6 _$t2@@6) (= _$t3@@0 _$t3@@0))) (and (and (= _$t4@@0 _$t4@@0) (= _$t5@@0 _$t5@@0)) (and (= $t9@@7 (|$addr#$signer| _$t0@@17)) (= $t10@@6  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@7)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@7)) 1))) (not (= (|$addr#$signer| _$t0@@17) 186537453)))))))) (and (=> (= (ControlFlow 0 239056) 240030) anon19_Then_correct@@4) (=> (= (ControlFlow 0 239056) 239098) anon19_Else_correct@@4))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@17  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@19 T@$1_Event_EventHandle) ) (! (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@19)))
 (and (= (|l#Multiset_81090| stream@@18) 0) (forall ((v@@47 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@18) v@@47) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 238088) 239056)) anon0$1_correct@@17)))
(let ((anon0_correct@@17  (=> (= (seq.len (|p#$Mutation_166419| $t8@@7)) 0) (=> (and (= (seq.len (|p#$Mutation_166419| $t15@@7)) 0) (= (seq.len (|p#$Mutation_10128| $t18@@6)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_10128| $t21@@3)) 0) (= (seq.len (|p#$Mutation_10128| $t24@@1)) 0)) (and (= (seq.len (|p#$Mutation_10128| $t27@@3)) 0) (= (ControlFlow 0 238098) 238088))) inline$$InitEventStore$0$anon0_correct@@17)))))
(let ((PreconditionGeneratedEntry_correct@@10  (=> (= (ControlFlow 0 290084) 238098) anon0_correct@@17)))
