...
(declare-fun |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1| () T@$Memory_237799)
...
(declare-fun |$1_DiemConfig_DiemConfig'#0'_$memory@2| () T@$Memory_235957)
...
(declare-fun |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@0| () T@$Memory_237799)
...
(declare-fun |$1_DiemConfig_DiemConfig'#0'_$memory@1| () T@$Memory_235957)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 769406) (let ((anon19_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 460387) (- 0 770627)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 460387) (- 0 770645)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 460387) (- 0 770653)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (and (=> (= (ControlFlow 0 460387) (- 0 770664)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 460387) (- 0 770676)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 460387) (- 0 770694)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 460387) (- 0 770708)) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 460387) (- 0 770717)) (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 460387) (- 0 770723)) (= (let ((addr 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr))) _$t1)) (=> (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr@@0))) _$t1) (=> (= (ControlFlow 0 460387) (- 0 770732)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_224609| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_224609| $1_DiemConfig_Configuration_$memory) 173345816))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 460219) (- 0 770503)) (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (= (ControlFlow 0 460219) (- 0 770549)) (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) (= 5 $t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t9@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t9@0))))))))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 460401) 460219))) L3_correct)))
(let ((anon18_Then$1_correct  (=> (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 460453) 460401) anon19_Then_correct) (=> (= (ControlFlow 0 460453) 460387) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 460451) 460453)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@0| ($Memory_237799 (|Store__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0) $t7))) (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 460259) 460401) anon19_Then_correct) (=> (= (ControlFlow 0 460259) 460387) anon19_Else_correct))))))
(let ((anon17_Then_correct  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 460237) (- 0 770375)) (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 460237) 460451) anon18_Then_correct) (=> (= (ControlFlow 0 460237) 460259) anon18_Else_correct)))))))
(let ((anon17_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t14 $t14)) (and (= $t9@0 $t14) (= (ControlFlow 0 460083) 460219))) L3_correct)))
(let ((anon5$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t14) (= $t14 6)) (and (= $t14 $t14) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 460067) 460237) anon17_Then_correct) (=> (= (ControlFlow 0 460067) 460083) anon17_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t11@0)) (= (ControlFlow 0 460027) 460067)) anon5$1_correct)))
(let ((anon5_correct  (=> (and (and (|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| $t7) (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (and (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr@@1))) _$t1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_224609| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_224609| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (=> (= (ControlFlow 0 460033) (- 0 770255)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) config_address) (= config_address 173345816)))
 :qid |DiemVMConfigbpl.10444:15|
 :skolemid |246|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemVMConfigbpl.10444:15|
 :skolemid |246|
)) (and (=> (= (ControlFlow 0 460033) (- 0 770280)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (=> (= $t7 $t7) (=> (and (and (|$IsValid'address'| $t10) (= $t10 (|$addr#$signer| _$t0))) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $t10)) (= (ControlFlow 0 460033) 460027))) inline$$Not$0$anon0_correct)))))))))
(let ((anon16_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| ($Memory_235957 (|Store__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 false) (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@2| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) (= (ControlFlow 0 459904) 460033))) anon5_correct)))
(let ((anon16_Then_correct  (=> (and (and |$temp_0'bool'@0| (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_235957 (|Store__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'#0''@0|)))) (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@2| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) (= (ControlFlow 0 460465) 460033))) anon5_correct)))
(let ((anon15_Else_correct  (=> (not $t8) (and (=> (= (ControlFlow 0 459892) 460465) anon16_Then_correct) (=> (= (ControlFlow 0 459892) 459904) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> $t8 (=> (and (and (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) (= 5 $t9)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t9))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t9))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t9))) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 460553) 460219))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (and (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@2)) 0)) (= addr@@2 173345816)))
 :qid |DiemVMConfigbpl.10264:20|
 :skolemid |227|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@3)) 1)) (= addr@@3 186537453)))
 :qid |DiemVMConfigbpl.10268:20|
 :skolemid |228|
))) (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@4)) 2))))))
 :qid |DiemVMConfigbpl.10272:20|
 :skolemid |229|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@5)) 2))))))
 :qid |DiemVMConfigbpl.10276:20|
 :skolemid |230|
)))) (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@6)) 2))))))
 ...
 :qid |DiemVMConfigbpl.10308:20|
 :skolemid |238|
)))) (and (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@14) (not (= (|l#Vec_177917| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@14)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@14)) 3))))
 :qid |DiemVMConfigbpl.10312:20|
 :skolemid |239|
)) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemVMConfigbpl.10316:20|
 :skolemid |240|
 ...
 :qid |DiemVMConfigbpl.10320:20|
 :skolemid |241|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_251857| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_251917| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@15)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@15)) 2)))))
 :qid |DiemVMConfigbpl.10324:20|
 :skolemid |242|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemVMConfigbpl.10333:20|
 :skolemid |243|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $a_0))
))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@0))
 :qid |DiemVMConfigbpl.10337:20|
 :skolemid |244|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $a_0@@1)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| $rsc@@1))
 :qid |DiemVMConfigbpl.10341:20|
 :skolemid |245|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_237799| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $a_0@@1))
))) (and (= $t5 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816))) (and (and (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| 173345816) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t6 (|$addr#$signer| _$t0))))))) (and (=> (= (ControlFlow 0 459884) (- 0 770030)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816) (=> (= $t8  (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_235957| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 459884) 460553) anon15_Then_correct) (=> (= (ControlFlow 0 459884) 459892) anon15_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemVMConfigbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 459270) 459884)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 769406) 459270) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
