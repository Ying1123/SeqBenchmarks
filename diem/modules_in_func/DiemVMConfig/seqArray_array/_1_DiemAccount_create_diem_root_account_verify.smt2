...
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory@4 () T@$Memory_225896)
...
(declare-fun _$t0 () T@Vec_29362)
(declare-fun $t7 () Int)
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory@1 () T@$Memory_225967)
...
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory@3 () T@$Memory_225896)
...
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory@0 () T@$Memory_225967)
...
(assert (not
 (=> (= (ControlFlow 0 0) 870518) (let ((anon51_correct  (=> (= $t35 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816)) (=> (and (= $t36 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816))) (= $t37 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t30)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t30) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t30))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t35) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t31) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t31)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t35) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t31) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t31))))) (and (not (= (|l#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t30)))) 0)) (= $t30 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t30)))) 0)))))) (and (and (and (not (= (|l#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t30)))) 0)) (= $t30 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t30)))) 0)))) (= $t38 $t37)) (and (= $t39 $t36) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) $t39)))
(let ((stream_new (let ((len (|l#Multiset_177831| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t38))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t38) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) $t39 stream_new)))))))) (and (=> (= (ControlFlow 0 610500) (- 0 874380)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816)) (=> (and (= $t40 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) 173345816))) (= $t41 ($1_DiemAccount_CreateAccountEvent 173345816 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) 173345816))))) (and (=> (= (ControlFlow 0 610500) (- 0 874428)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (and (=> (= (ControlFlow 0 610500) (- 0 874438)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (and (=> (= (ControlFlow 0 610500) (- 0 874448)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (and (=> (= (ControlFlow 0 610500) (- 0 874458)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (and (=> (= (ControlFlow 0 610500) (- 0 874468)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 610500) (- 0 874478)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) 173345816)) (and (=> (= (ControlFlow 0 610500) (- 0 874488)) (not (not (= (+ 16 (|l#Vec_29362| _$t0)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_29362| _$t0)) 32))) (and (=> (= (ControlFlow 0 610500) (- 0 874506)) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) 173345816) (and (=> (= (ControlFlow 0 610500) (- 0 874514)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) 173345816)) 0)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) 173345816)) 0) (and (=> (= (ControlFlow 0 610500) (- 0 874528)) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) $t7)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@4) $t7) (and (=> (= (ControlFlow 0 610500) (- 0 874536)) (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory@1) $t7)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory@1) $t7) (and (=> (= (ControlFlow 0 610500) (- 0 874544)) (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory@2) $t7)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory@2) $t7) (and (=> (= (ControlFlow 0 610500) (- 0 874552)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) $t7)) 0))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) $t7)) 0)) (and (=> (= (ControlFlow 0 610500) (- 0 874560)) (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7) (and (=> (= (ControlFlow 0 610500) (- 0 874568)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t7) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t7))))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t7) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t7)))) (and (=> (= (ControlFlow 0 610500) (- 0 874576)) (and (not (= (|l#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)) (= $t7 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0))))) (=> (and (not (= (|l#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)) (= $t7 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)))) (and (=> (= (ControlFlow 0 610500) (- 0 874584)) (and (not (= (|l#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)) (= $t7 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0))))) (=> (and (not (= (|l#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)) (= $t7 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t7)))) 0)))) (and (=> (= (ControlFlow 0 610500) (- 0 874592)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemVMConfigbpl.33799:15|
 :skolemid |1065|
 ...
 :qid |DiemVMConfigbpl.33799:15|
 :skolemid |1065|
)) (and (=> (= (ControlFlow 0 610500) (- 0 874627)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_177831| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_177831| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40 stream_new@@1))))))
 ...
 :qid |DiemVMConfigbpl.3327:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 610500) (- 0 874652)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_177831| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@3) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@3) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t41) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t40 stream_new@@2))))))
...
(let ((anon73_Else_correct  (=> (and (and (not |$temp_0'bool'@4|) (= $1_DiemAccount_AccountOperationsCapability_$memory@3 ($Memory_225896 (|Store__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816 false) (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@4 $1_DiemAccount_AccountOperationsCapability_$memory@3) (= (ControlFlow 0 610069) 610500))) anon51_correct)))
(let ((anon73_Then_correct  (=> (and (and |$temp_0'bool'@4| (= $1_DiemAccount_AccountOperationsCapability_$memory@2 ($Memory_225896 (|Store__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@4 $1_DiemAccount_AccountOperationsCapability_$memory@2) (= (ControlFlow 0 610512) 610500))) anon51_correct)))
(let ((anon72_Else_correct  (=> (not |$temp_0'bool'@3|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_225724 (|Store__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t30 false) (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 610055) 610512) anon73_Then_correct) (=> (= (ControlFlow 0 610055) 610069) anon73_Else_correct))))))
(let ((anon72_Then_correct  (=> |$temp_0'bool'@3| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_225724 (|Store__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t30 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t30 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 610524) 610512) anon73_Then_correct) (=> (= (ControlFlow 0 610524) 610069) anon73_Else_correct))))))
(let ((anon71_Else_correct  (=> (and (not |$temp_0'bool'@2|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_216284 (|Store__T@[Int]Bool_| (|domain#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t30 false) (|contents#$Memory_216284| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 610041) 610524) anon72_Then_correct) (=> (= (ControlFlow 0 610041) 610055) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (and |$temp_0'bool'@2| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_216284 (|Store__T@[Int]Bool_| (|domain#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t30 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t30 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 610536) 610524) anon72_Then_correct) (=> (= (ControlFlow 0 610536) 610055) anon72_Else_correct)))))
(let ((anon70_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_313615 (|Store__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t30 false) (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 610027) 610536) anon71_Then_correct) (=> (= (ControlFlow 0 610027) 610041) anon71_Else_correct))))))
(let ((anon70_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_313615 (|Store__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t30 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t30 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 610548) 610536) anon71_Then_correct) (=> (= (ControlFlow 0 610548) 610041) anon71_Else_correct))))))
(let ((anon69_Else_correct  (=> (not $t34) (and (=> (= (ControlFlow 0 610015) 610548) anon70_Then_correct) (=> (= (ControlFlow 0 610015) 610027) anon70_Else_correct)))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 608812) (- 0 873931)) (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) 173345816)) (not (= (+ 16 (|l#Vec_29362| _$t0)) 32)))) (=> (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) 173345816)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) 173345816)) (not (= (+ 16 (|l#Vec_29362| _$t0)) 32))) (=> (= (ControlFlow 0 608812) (- 0 873986)) (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) 173345816) (= 6 $t9@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (= 6 $t9@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816) (= 6 $t9@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) 173345816) (= 6 $t9@0))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t9@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) 173345816) (= 6 $t9@0))) (and (not (= (+ 16 (|l#Vec_29362| _$t0)) 32)) (= 7 $t9@0))))))))
(let ((anon69_Then_correct  (=> $t34 (=> (and (and (or (or (or (or (and (= $t30 0) (= 7 $t9)) (and (= $t30 1) (= 7 $t9))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t30) (= 6 $t9))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816))) (= 5 $t9))) (and (not (= (+ 16 (|l#Vec_29362| _$t0)) 32)) (= 7 $t9))) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 610654) 608812))) L5_correct))))
(let ((anon68_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 610009) (- 0 873603)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory@1) 173345816)) (=> (and (and (= $t30 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t31 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816))) (and (= $t32 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t33 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 610009) (- 0 873660)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t30))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t30)) (and (=> (= (ControlFlow 0 610009) (- 0 873671)) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816) (and (=> (= (ControlFlow 0 610009) (- 0 873679)) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t30)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t30) (and (=> (= (ControlFlow 0 610009) (- 0 873687)) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t30)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t30) (and (=> (= (ControlFlow 0 610009) (- 0 873693)) (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t30)) (=> (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t30) (and (=> (= (ControlFlow 0 610009) (- 0 873699)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t30)) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t30) (and (=> (= (ControlFlow 0 610009) (- 0 873705)) (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies 173345816) (=> (= $t34  (or (or (or (or (= $t30 0) (= $t30 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t30)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t0)) 32)))) (and (=> (= (ControlFlow 0 610009) 610654) anon69_Then_correct) (=> (= (ControlFlow 0 610009) 610015) anon69_Else_correct)))))))))))))))))))))))
(let ((anon68_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t9@0 $abort_code@4) (= (ControlFlow 0 610668) 608812))) L5_correct)))
(let ((anon67_Then$1_correct  (=> (= $1_DiemAccount_DiemWriteSetManager_$memory@1 $1_DiemAccount_DiemWriteSetManager_$memory) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 610720) 610668) anon68_Then_correct) (=> (= (ControlFlow 0 610720) 610009) anon68_Else_correct))))))
(let ((anon67_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 610718) 610720)) anon67_Then$1_correct)))
(let ((anon67_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_DiemAccount_DiemWriteSetManager_$memory@0 ($Memory_225967 (|Store__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_DiemAccount_DiemWriteSetManager_| (|contents#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) $t29@0))) (= $1_DiemAccount_DiemWriteSetManager_$memory@1 $1_DiemAccount_DiemWriteSetManager_$memory@0)) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 609827) 610668) anon68_Then_correct) (=> (= (ControlFlow 0 609827) 610009) anon68_Else_correct))))))
(let ((anon66_Else_correct  (=> (and (not $abort_flag@2) (= $t29@0 ($1_DiemAccount_DiemWriteSetManager |inline$$1_Event_new_event_handle'$1_DiemAccount_AdminTransactionEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 609805) (- 0 873502)) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemWriteSetManager_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_DiemWriteSetManager_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (and (=> (= (ControlFlow 0 609805) 610718) anon67_Then_correct) (=> (= (ControlFlow 0 609805) 609827) anon67_Else_correct)))))))
(let ((anon66_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t9@0 $abort_code@3) (= (ControlFlow 0 610734) 608812))) L5_correct)))
(let ((|inline$$1_Event_new_event_handle'$1_DiemAccount_AdminTransactionEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_DiemAccount_AdminTransactionEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_DiemAccount_AdminTransactionEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 609769) 610734) anon66_Then_correct) (=> (= (ControlFlow 0 609769) 609805) anon66_Else_correct)))))
(let ((anon65_Then_correct  (=> (and inline$$Not$1$dst@1 (= (ControlFlow 0 609775) 609769)) |inline$$1_Event_new_event_handle'$1_DiemAccount_AdminTransactionEvent'$0$anon0_correct|)))
(let ((anon65_Else_correct  (=> (and (and (not inline$$Not$1$dst@1) (= $t27 $t27)) (and (= $t9@0 $t27) (= (ControlFlow 0 609697) 608812))) L5_correct)))
(let ((anon64_Else$1_correct  (=> (|$IsValid'u64'| 23) (=> (and (and (|$IsValid'u64'| $t27) (= $t27 6)) (and (= $t27 $t27) (= inline$$Not$1$dst@1 inline$$Not$1$dst@1))) (and (=> (= (ControlFlow 0 609681) 609775) anon65_Then_correct) (=> (= (ControlFlow 0 609681) 609697) anon65_Else_correct))))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not $t24@0)) (= (ControlFlow 0 609641) 609681)) anon64_Else$1_correct)))
(let ((anon64_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 609647) (- 0 873342)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@1) 173345816)) (=> (|$IsValid'address'| 173345816) (=> (and (= $t24@0 (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (= (ControlFlow 0 609647) 609641)) inline$$Not$1$anon0_correct)))))))
(let ((anon64_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t9@0 $abort_code@3) (= (ControlFlow 0 610748) 608812))) L5_correct)))
(let ((anon63_Then$1_correct  (=> (= $1_DiemAccount_AccountOperationsCapability_$memory@1 $1_DiemAccount_AccountOperationsCapability_$memory) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 610800) 610748) anon64_Then_correct) (=> (= (ControlFlow 0 610800) 609647) anon64_Else_correct))))))
(let ((anon63_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 610798) 610800)) anon63_Then$1_correct)))
(let ((anon63_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_225896 (|Store__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) $t22@0))) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 $1_DiemAccount_AccountOperationsCapability_$memory@0)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 609573) 610748) anon64_Then_correct) (=> (= (ControlFlow 0 609573) 609647) anon64_Else_correct))))))
(let ((anon62_Else_correct  (=> (and (not $abort_flag@1) (= $t22@0 ($1_DiemAccount_AccountOperationsCapability inline$$1_AccountLimits_grant_mutation_capability$0$$ret0@1 |inline$$1_Event_new_event_handle'$1_DiemAccount_CreateAccountEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 609551) (- 0 873241)) (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (and (=> (= (ControlFlow 0 609551) 610798) anon63_Then_correct) (=> (= (ControlFlow 0 609551) 609573) anon63_Else_correct)))))))
(let ((anon62_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t9@0 $abort_code@2) (= (ControlFlow 0 610814) 608812))) L5_correct)))
(let ((|inline$$1_Event_new_event_handle'$1_DiemAccount_CreateAccountEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemAccount_CreateAccountEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemAccount_CreateAccountEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 609513) 610814) anon62_Then_correct) (=> (= (ControlFlow 0 609513) 609551) anon62_Else_correct)))))
(let ((anon61_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 609519) 609513)) |inline$$1_Event_new_event_handle'$1_DiemAccount_CreateAccountEvent'$0$anon0_correct|)))
(let ((anon61_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t9@0 $abort_code@2) (= (ControlFlow 0 610828) 608812))) L5_correct)))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$L2_correct  (=> (= $abort_code@2 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0) (=> (and (= $abort_flag@1 true) (= inline$$1_AccountLimits_grant_mutation_capability$0$$ret0@1 inline$$1_AccountLimits_grant_mutation_capability$0$$ret0@0)) (and (=> (= (ControlFlow 0 609405) 610828) anon61_Then_correct) (=> (= (ControlFlow 0 609405) 609519) anon61_Else_correct))))))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$anon6_Then_correct  (=> (and (and inline$$1_AccountLimits_grant_mutation_capability$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)) (= 2 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_AccountLimits_grant_mutation_capability$0$$t4@0)) (= 5 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_AccountLimits_grant_mutation_capability$0$$t4@0)) 0)) (= 3 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0))) (and (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)) (= 2 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0)))) (and (= inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0) (= (ControlFlow 0 609399) 609405))) inline$$1_AccountLimits_grant_mutation_capability$0$L2_correct)))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$anon5_Then_correct  (=> inline$$1_AccountLimits_grant_mutation_capability$0$$t2@0 (=> (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0)) (and (= inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0 inline$$1_AccountLimits_grant_mutation_capability$0$$t3@0) (= (ControlFlow 0 609431) 609405))) inline$$1_AccountLimits_grant_mutation_capability$0$L2_correct))))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$anon6_Else_correct  (=> (and (not inline$$1_AccountLimits_grant_mutation_capability$0$$t5@0) (= inline$$1_AccountLimits_grant_mutation_capability$0$$t7@1 ($1_AccountLimits_AccountLimitMutationCapability false))) (=> (and (and (= inline$$1_AccountLimits_grant_mutation_capability$0$$t7@1 inline$$1_AccountLimits_grant_mutation_capability$0$$t7@1) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_AccountLimits_grant_mutation_capability$0$$ret0@1 inline$$1_AccountLimits_grant_mutation_capability$0$$t7@1))) (and (=> (= (ControlFlow 0 609307) 610828) anon61_Then_correct) (=> (= (ControlFlow 0 609307) 609519) anon61_Else_correct))))))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$anon5_Else_correct  (=> (not inline$$1_AccountLimits_grant_mutation_capability$0$$t2@0) (=> (and (= inline$$1_AccountLimits_grant_mutation_capability$0$$t4@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= inline$$1_AccountLimits_grant_mutation_capability$0$$t5@0  (or (or (or (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_AccountLimits_grant_mutation_capability$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_AccountLimits_grant_mutation_capability$0$$t4@0)) 0))) (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816))))) (and (=> (= (ControlFlow 0 609279) 609399) inline$$1_AccountLimits_grant_mutation_capability$0$anon6_Then_correct) (=> (= (ControlFlow 0 609279) 609307) inline$$1_AccountLimits_grant_mutation_capability$0$anon6_Else_correct))))))
(let ((inline$$1_AccountLimits_grant_mutation_capability$0$anon0_correct  (=> (= inline$$1_AccountLimits_grant_mutation_capability$0$$t1@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= inline$$1_AccountLimits_grant_mutation_capability$0$$t2@0  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 609209) 609431) inline$$1_AccountLimits_grant_mutation_capability$0$anon5_Then_correct) (=> (= (ControlFlow 0 609209) 609279) inline$$1_AccountLimits_grant_mutation_capability$0$anon5_Else_correct))))))
(let ((anon60_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (= $t19 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 609437) 609209)) inline$$1_AccountLimits_grant_mutation_capability$0$anon0_correct))))
(let ((anon60_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t18 $t18)) (and (= $t9@0 $t18) (= (ControlFlow 0 608624) 608812))) L5_correct)))
(let ((anon59_Else$1_correct  (=> (|$IsValid'u64'| 22) (=> (and (and (|$IsValid'u64'| $t18) (= $t18 6)) (and (= $t18 $t18) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 608608) 609437) anon60_Then_correct) (=> (= (ControlFlow 0 608608) 608624) anon60_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t15@0)) (= (ControlFlow 0 608568) 608608)) anon59_Else$1_correct)))
(let ((anon59_Else_correct  (=> (and (and (not $abort_flag@0) (|$IsValid'address'| 173345816)) (and (= $t15@0 (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (= (ControlFlow 0 608574) 608568))) inline$$Not$0$anon0_correct)))
(let ((anon59_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 610842) 608812))) L5_correct)))
(let ((anon13_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (and (=> (= (ControlFlow 0 608516) 610842) anon59_Then_correct) (=> (= (ControlFlow 0 608516) 608574) anon59_Else_correct)))))
(let ((anon58_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_224516 (|Store__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 608485) 608516))) anon13_correct)))
(let ((anon58_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_224516 (|Store__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |$temp_0'$1_SlidingNonce_SlidingNonce'@0|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 610856) 608516))) anon13_correct)))
(let ((anon57_Else_correct  (=> (not $t13) (and (=> (= (ControlFlow 0 608471) 610856) anon58_Then_correct) (=> (= (ControlFlow 0 608471) 608485) anon58_Else_correct)))))
(let ((anon57_Then_correct  (=> $t13 (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 610884) 608812))) L5_correct))))
(let ((anon56_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 608465) (- 0 872652)) (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= $t13 (|Select__T@[Int]Bool_| (|domain#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (=> (= (ControlFlow 0 608465) 610884) anon57_Then_correct) (=> (= (ControlFlow 0 608465) 608471) anon57_Else_correct))))))))
(let ((anon56_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 610898) 608812))) L5_correct)))
(let ((inline$$1_Roles_grant_diem_root_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_grant_diem_root_role$0$$t2@0)) (and (=> (= (ControlFlow 0 608375) 610898) anon56_Then_correct) (=> (= (ControlFlow 0 608375) 608465) anon56_Else_correct))))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon12_Then_correct  (=> inline$$1_Roles_grant_diem_root_role$0$$t6@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_grant_diem_root_role$0$$t2@0)) (and (= inline$$1_Roles_grant_diem_root_role$0$$t2@0 inline$$1_Roles_grant_diem_root_role$0$$t2@0) (= (ControlFlow 0 608369) 608375))) inline$$1_Roles_grant_diem_root_role$0$L2_correct))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon11_Then_correct  (=> inline$$1_Roles_grant_diem_root_role$0$$t3@0 (=> (and (and (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)) (= 2 inline$$1_Roles_grant_diem_root_role$0$$t2@0)) (and (= inline$$1_Roles_grant_diem_root_role$0$$t2@0 inline$$1_Roles_grant_diem_root_role$0$$t2@0) (= (ControlFlow 0 608405) 608375))) inline$$1_Roles_grant_diem_root_role$0$L2_correct))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon10_Then_correct  (=> inline$$1_Roles_grant_diem_root_role$0$$t1@0 (=> (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 inline$$1_Roles_grant_diem_root_role$0$$t2@0)) (and (= inline$$1_Roles_grant_diem_root_role$0$$t2@0 inline$$1_Roles_grant_diem_root_role$0$$t2@0) (= (ControlFlow 0 608431) 608375))) inline$$1_Roles_grant_diem_root_role$0$L2_correct))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon9_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 0) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 608327) 610898) anon56_Then_correct) (=> (= (ControlFlow 0 608327) 608465) anon56_Else_correct))))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon13_Else_correct  (=> (and (and (not |inline$$1_Roles_grant_diem_root_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_224329 (|Store__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_224329| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 608301) 608327))) inline$$1_Roles_grant_diem_root_role$0$anon9_correct)))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon13_Then_correct  (=> (and (and |inline$$1_Roles_grant_diem_root_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_224329 (|Store__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_grant_diem_root_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 608341) 608327))) inline$$1_Roles_grant_diem_root_role$0$anon9_correct)))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon12_Else_correct  (=> (not inline$$1_Roles_grant_diem_root_role$0$$t6@0) (and (=> (= (ControlFlow 0 608287) 608341) inline$$1_Roles_grant_diem_root_role$0$anon13_Then_correct) (=> (= (ControlFlow 0 608287) 608301) inline$$1_Roles_grant_diem_root_role$0$anon13_Else_correct)))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon11_Else_correct  (=> (and (not inline$$1_Roles_grant_diem_root_role$0$$t3@0) (|$IsValid'u64'| 0)) (=> (and (and (= inline$$1_Roles_grant_diem_root_role$0$$t5@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 0 0) (= inline$$1_Roles_grant_diem_root_role$0$$t5@0 173345816))) (and (=> (= 0 1) (= inline$$1_Roles_grant_diem_root_role$0$$t5@0 186537453)) (= inline$$1_Roles_grant_diem_root_role$0$$t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 608281) 608369) inline$$1_Roles_grant_diem_root_role$0$anon12_Then_correct) (=> (= (ControlFlow 0 608281) 608287) inline$$1_Roles_grant_diem_root_role$0$anon12_Else_correct))))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon10_Else_correct  (=> (and (not inline$$1_Roles_grant_diem_root_role$0$$t1@0) (= inline$$1_Roles_grant_diem_root_role$0$$t3@0  (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)))) (and (=> (= (ControlFlow 0 608215) 608405) inline$$1_Roles_grant_diem_root_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 608215) 608281) inline$$1_Roles_grant_diem_root_role$0$anon11_Else_correct)))))
(let ((inline$$1_Roles_grant_diem_root_role$0$anon0_correct  (=> (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= inline$$1_Roles_grant_diem_root_role$0$$t1@0  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 608193) 608431) inline$$1_Roles_grant_diem_root_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 608193) 608215) inline$$1_Roles_grant_diem_root_role$0$anon10_Else_correct)))))
(let ((anon55_Else_correct  (=> (not $t12) (and (=> (= (ControlFlow 0 608435) (- 0 872322)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 608435) 608193) inline$$1_Roles_grant_diem_root_role$0$anon0_correct))))))
(let ((anon55_Then_correct  (=> $t12 (=> (and (and (and (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)) (= 2 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 610928) 608812))) L5_correct))))
(let ((anon54_Else_correct  (=> (not false) (=> (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= $t12  (not (= (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) 173345816)))) (and (=> (= (ControlFlow 0 607776) 610928) anon55_Then_correct) (=> (= (ControlFlow 0 607776) 608435) anon55_Else_correct))))))
(let ((anon53_Then_correct  (=> $t8 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 610968) 608812))) L5_correct))))
(let ((anon54_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer 173345816)) (and (=> (= (ControlFlow 0 607740) 610942) anon54_Then_correct) (=> (= (ControlFlow 0 607740) 607776) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (not $t8) (=> (and (|$IsValid'address'| 173345816) (= (ControlFlow 0 607746) 607740)) inline$$1_DiemAccount_create_signer$0$anon0_correct))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_224695| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 ...
 :qid |DiemVMConfigbpl.33031:20|
 :skolemid |1048|
))))))) (and (and (and (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_312564| $1_DesignatedDealer_Dealer_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@24)) 2))))
 :qid |DiemVMConfigbpl.33035:20|
 :skolemid |1049|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@1))
 :qid |DiemVMConfigbpl.33106:20|
 :skolemid |1060|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_224516| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@1))
)))))) (and (and (and (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemVMConfigbpl.33110:20|
 :skolemid |1061|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $a_0@@3)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@3) (and (<= (|l#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@3))) 1) (<= (|l#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@3))) 1))))
 :qid |DiemVMConfigbpl.33114:20|
 :skolemid |1062|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $a_0@@3))
))) (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4)))
(|$IsValid'$1_DiemAccount_AccountOperationsCapability'| $rsc@@4))
 :qid |DiemVMConfigbpl.33118:20|
 :skolemid |1063|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4))
)) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_DiemAccount_DiemWriteSetManager_| (|contents#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) $a_0@@5)))
(|$IsValid'$1_DiemAccount_DiemWriteSetManager'| $rsc@@5))
 :qid |DiemVMConfigbpl.33122:20|
 :skolemid |1064|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemWriteSetManager_| (|contents#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) $a_0@@5))
)))) (and (and (= $t6 173345816) (= $t7 173345816)) (and (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t6) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemAccount_$modifies $t6)))) (and (and (and (|Select__T@[Int]Bool_| $1_DiemAccount_AccountOperationsCapability_$modifies $t6) (|Select__T@[Int]Bool_| $1_DiemAccount_DiemWriteSetManager_$modifies $t6)) (and (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies $t6) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies $t6))) (and (and (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t6) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies 173345816)) (and (= _$t0 _$t0) (= $t8  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))))) (and (=> (= (ControlFlow 0 607696) 610968) anon53_Then_correct) (=> (= (ControlFlow 0 607696) 607746) anon53_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemVMConfigbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 606252) 607696)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 870518) 606252) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
