...
(declare-fun $1_ChainId_ChainId_$memory@1 () T@$Memory_91819)
(declare-fun _$t0@@0 () T@$signer)
(declare-fun $t4 () Int)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1@@0 () Int)
(declare-fun $1_ChainId_ChainId_$memory@0 () T@$Memory_91819)
...
(assert (not
 (=> (= (ControlFlow 0 0) 201781) (let ((anon18_Else_correct  (=> (not $abort_flag@0@@0) (and (=> (= (ControlFlow 0 148209) (- 0 202619)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 148209) (- 0 202636)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 148209) (- 0 202646)) (not (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 173345816))) (and (=> (= (ControlFlow 0 148209) (- 0 202657)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t4))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t4)) (=> (= (ControlFlow 0 148209) (- 0 202667)) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory@1) $t4)))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 148107) (- 0 202541)) (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t4))) (=> (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t4)) (=> (= (ControlFlow 0 148107) (- 0 202564)) (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t6@0)) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t4) (= 6 $t6@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t6@0 $abort_code@1@@0) (= (ControlFlow 0 148223) 148107))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_ChainId_ChainId_$memory@1 $1_ChainId_ChainId_$memory) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 148275) 148223) anon18_Then_correct) (=> (= (ControlFlow 0 148275) 148209) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 148273) 148275)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) (|$addr#$signer| _$t0@@0))) (=> (and (and (= $1_ChainId_ChainId_$memory@0 ($Memory_91819 (|Store__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_91819| $1_ChainId_ChainId_$memory) (|$addr#$signer| _$t0@@0) $t13@0))) (= $1_ChainId_ChainId_$memory@1 $1_ChainId_ChainId_$memory@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 148145) 148223) anon18_Then_correct) (=> (= (ControlFlow 0 148145) 148209) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 ($1_ChainId_ChainId _$t1@@0))) (and (=> (= (ControlFlow 0 148123) (- 0 202419)) (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies (|$addr#$signer| _$t0@@0)) (and (=> (= (ControlFlow 0 148123) 148273) anon17_Then_correct) (=> (= (ControlFlow 0 148123) 148145) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12@@0 $t12@@0)) (and (= $t6@0 $t12@@0) (= (ControlFlow 0 148023) 148107))) L3_correct)))
(let ((anon15_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12@@0) (= $t12@@0 6)) (and (= $t12@@0 $t12@@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 148007) 148123) anon16_Then_correct) (=> (= (ControlFlow 0 148007) 148023) anon16_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 147971) 148007)) anon15_Else$1_correct)))
(let ((anon15_Else_correct  (=> (not $t7@@0) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0@@0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) $t8)) (= (ControlFlow 0 147977) 147971))) inline$$Not$0$anon0_correct))))
(let ((anon15_Then_correct  (=> $t7@@0 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 148305) 148107))) L3_correct))))
(let ((anon14_Else_correct  (=> (and (not $t5) (= $t7@@0  (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (and (=> (= (ControlFlow 0 147915) 148305) anon15_Then_correct) (=> (= (ControlFlow 0 147915) 147977) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> $t5 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 148331) 148107))) L3_correct))))
(let ((anon0$1_correct@@0  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_90566| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_90566| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_90566| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_90566| $1_Roles_RoleId_$memory) 186537453)) 1))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90753| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90753| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90846| $1_DiemConfig_Configuration_$memory) 173345816)))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_90932| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91005| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91076| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91160| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91244| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91315| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91399| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91483| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91554| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91651| $1_DualAttestation_Limit_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91735| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91819| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91890| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_91961| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_91961| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_91961| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_91961| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_91890| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92133| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92204| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92275| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_92359| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90440| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) ($1_Signer_is_txn_signer _$t0@@0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@0)))) (and (and (and (|$IsValid'u8'| _$t1@@0) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@0))
 :qid |ChainIdbpl.10597:20|
 :skolemid |171|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_91819| $1_ChainId_ChainId_$memory) $a_0@@1)))
(|$IsValid'$1_ChainId_ChainId'| $rsc@@1))
 :qid |ChainIdbpl.10601:20|
 :skolemid |172|
 :pattern ( (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_91819| $1_ChainId_ChainId_$memory) $a_0@@1))
)) (= $t4 (|$addr#$signer| _$t0@@0)))) (and (and (|Select__T@[Int]Bool_| $1_ChainId_ChainId_$modifies $t4) (= _$t0@@0 _$t0@@0)) (and (= _$t1@@0 _$t1@@0) (= $t5  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89888| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))))) (and (=> (= (ControlFlow 0 147893) 148331) anon14_Then_correct) (=> (= (ControlFlow 0 147893) 147915) anon14_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_63416_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_63416| stream@@1) 0) (forall ((v@@33 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_63416| stream@@1) v@@33) 0)
 :qid |ChainIdbpl.134:13|
 :skolemid |2|
))))
 :qid |ChainIdbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 147469) 147893)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 201781) 147469) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))))))))))
))
(check-sat)
(pop 1)
