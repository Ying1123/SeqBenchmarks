...
(assert (not
 (=> (= (ControlFlow 0 0) 152437) (let ((L5_correct  (and (=> (= (ControlFlow 0 132092) (- 0 155434)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155446)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) 1))) (and (=> (= (ControlFlow 0 132092) (- 0 155464)) (not (not (= (|$addr#$signer| _$t1@@0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t1@@0) 186537453))) (and (=> (= (ControlFlow 0 132092) (- 0 155478)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155490)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) 2)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) 2))) (and (=> (= (ControlFlow 0 132092) (- 0 155508)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t5@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t5@@0)) (and (=> (= (ControlFlow 0 132092) (- 0 155518)) (not (and _$t2 (let ((addr@@21 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@21) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@21))))))) (=> (not (and _$t2 (let ((addr@@22 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@22) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@22)))))) (and (=> (= (ControlFlow 0 132092) (- 0 155529)) (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5@@0)))) (=> (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155542)) (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5@@0)))) (=> (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155555)) (not (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (not (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 132092) (- 0 155568)) (not (and (not _$t2) (let ((addr@@23 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@23) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@23))))))) (=> (not (and (not _$t2) (let ((addr@@24 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@24) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@24)))))) (and (=> (= (ControlFlow 0 132092) (- 0 155581)) (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t5@@0)))) (=> (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t5@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155596)) (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t5@@0)))) (=> (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t5@@0))) (and (=> (= (ControlFlow 0 132092) (- 0 155611)) (not (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (= (ControlFlow 0 132092) (- 0 155626)) (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) $t5@@0))))))))))))))))))))))))))))))))
(let ((anon38_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1| ($Memory_87707 (|Store__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20@@0 false) (|contents#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|))) (= (ControlFlow 0 132464) 132092)) L5_correct))))
(let ((anon38_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0| ($Memory_87707 (|Store__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20@@0 true) (|Store__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20@@0 |$temp_0'$1_Diem_PreburnQueue'$1_XUS_XUS''@0|))) (= (ControlFlow 0 132478) 132092)) L5_correct))))
(let ((anon37_Else_correct  (=> (not $t23) (and (=> (= (ControlFlow 0 132452) 132478) anon38_Then_correct) (=> (= (ControlFlow 0 132452) 132464) anon38_Else_correct)))))
(let ((anon28_correct  (=> (= (ControlFlow 0 131880) 132092) L5_correct)))
(let ((anon40_Else_correct  (=> (not |$temp_0'bool'@0@@0|) (=> (and (= |$1_Diem_PreburnQueue'#0'_$memory@1@@0| ($Memory_87905 (|Store__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 false) (|contents#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|))) (= (ControlFlow 0 131876) 131880)) anon28_correct))))
(let ((anon40_Then_correct  (=> |$temp_0'bool'@0@@0| (=> (and (= |$1_Diem_PreburnQueue'#0'_$memory@0@@0| ($Memory_87905 (|Store__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 |$temp_0'$1_Diem_PreburnQueue'#0''@0@@0|))) (= (ControlFlow 0 132104) 131880)) anon28_correct))))
(let ((anon39_Else_correct  (=> (not $t27) (and (=> (= (ControlFlow 0 131864) 132104) anon40_Then_correct) (=> (= (ControlFlow 0 131864) 131876) anon40_Else_correct)))))
(let ((anon33_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 131549) (- 0 154990)) (or (or (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) 2))) (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t5@@0)) (and _$t2 (let ((addr@@25 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@25) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@25)))))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5@@0))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5@@0))) (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (not _$t2) (let ((addr@@26 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@26) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@26)))))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t5@@0))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t5@@0))) (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) 2))) (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t5@@0)) (and _$t2 (let ((addr@@27 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@27) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@27)))))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5@@0))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5@@0))) (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (not _$t2) (let ((addr@@28 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@28) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@28)))))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t5@@0))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t5@@0))) (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (= (ControlFlow 0 131549) (- 0 155138)) (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) (= 5 $t10@0@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t6@@0)) 1)) (= 3 $t10@0@@0))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 $t10@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) (= 5 $t10@0@@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t7@@0)) 2)) (= 3 $t10@0@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t5@@0) (= 6 $t10@0@@0))) (and (and _$t2 (let ((addr@@29 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@29) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@29))))) (= 7 $t10@0@@0))) (and (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5@@0)) (= 6 $t10@0@@0))) (and (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5@@0)) (= 1 $t10@0@@0))) (and (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= 5 $t10@0@@0))) (and (and (not _$t2) (let ((addr@@30 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@30) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@30))))) (= 7 $t10@0@@0))) (and (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t5@@0)) (= 6 $t10@0@@0))) (and (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t5@@0)) (= 1 $t10@0@@0))) (and (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 5 $t10@0@@0))))))))
(let ((anon37_Then_correct  (=> $t23 (=> (and (and (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t21@@0)) (= 5 $t10@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t21@@0)) 1)) (= 3 $t10@@0))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t22)) (= 5 $t10@@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t22)) 2)) (= 3 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) $t20@@0)) (= 5 $t10@@0))) (and (let ((addr@@31 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@31) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@31)))) (= 7 $t10@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20@@0) (= 6 $t10@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t20@@0) (= 1 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t10@@0))) (= $t10@@0 $t10@@0)) (and (= $t10@0@@0 $t10@@0) (= (ControlFlow 0 132672) 131549))) L7_correct))))
(let ((anon36_Then_correct  (=> (and (and _$t2 (= $t20@@0 (|$addr#$signer| _$t0@@1))) (and (= $t21@@0 (|$addr#$signer| _$t1@@0)) (= $t22 (|$addr#$signer| _$t0@@1)))) (and (=> (= (ControlFlow 0 132446) (- 0 154277)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t20@@0)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t20@@0) (=> (= $t23  (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t21@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t21@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t22))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t22)) 2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) $t20@@0))) (let ((addr@@32 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@32) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@32))))) (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20@@0)) (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t20@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 132446) 132672) anon37_Then_correct) (=> (= (ControlFlow 0 132446) 132452) anon37_Else_correct))))))))
(let ((anon39_Then_correct  (=> $t27 (=> (and (and (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t25)) (= 5 $t10@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t25)) 1)) (= 3 $t10@@0))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t26)) (= 5 $t10@@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t26)) 2)) (= 3 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) $t24)) (= 5 $t10@@0))) (and (let ((addr@@33 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@33) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@33)))) (= 7 $t10@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t24) (= 6 $t10@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t24) (= 1 $t10@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t10@@0))) (= $t10@@0 $t10@@0)) (and (= $t10@0@@0 $t10@@0) (= (ControlFlow 0 132298) 131549))) L7_correct))))
(let ((anon36_Else_correct  (=> (and (and (not _$t2) (= $t24 (|$addr#$signer| _$t0@@1))) (and (= $t25 (|$addr#$signer| _$t1@@0)) (= $t26 (|$addr#$signer| _$t0@@1)))) (and (=> (= (ControlFlow 0 131858) (- 0 154423)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies@@0| $t24)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies@@0| $t24) (=> (= $t27  (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t25)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t25)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t26))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t26)) 2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) $t24))) (let ((addr@@34 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@34) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@34))))) (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $t24)) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $t24)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 131858) 132298) anon39_Then_correct) (=> (= (ControlFlow 0 131858) 131864) anon39_Else_correct))))))))
(let ((anon35_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 131708) (- 0 154219)) (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) addr@@35) (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) addr@@35)))
 :qid |DesignatedDealerbpl.7002:15|
 :skolemid |330|
))) (=> (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) addr@@36) (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory@1) addr@@36)))
 :qid |DesignatedDealerbpl.7002:15|
 :skolemid |330|
)) (and (=> (= (ControlFlow 0 131708) 132446) anon36_Then_correct) (=> (= (ControlFlow 0 131708) 131858) anon36_Else_correct)))))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0@@0 $abort_code@1) (= (ControlFlow 0 132686) 131549))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $1_DesignatedDealer_Dealer_$memory@1 $1_DesignatedDealer_Dealer_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 132738) 132686) anon35_Then_correct) (=> (= (ControlFlow 0 132738) 131708) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0@@1)) (= (ControlFlow 0 132736) 132738)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0@@1))) (=> (and (and (= $1_DesignatedDealer_Dealer_$memory@0 ($Memory_92161 (|Store__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0@@1) true) (|Store__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0@@1) $t19@0))) (= $1_DesignatedDealer_Dealer_$memory@1 $1_DesignatedDealer_Dealer_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 131673) 132686) anon35_Then_correct) (=> (= (ControlFlow 0 131673) 131708) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not false) (= $t19@0 ($1_DesignatedDealer_Dealer |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 131651) (- 0 154118)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies (|$addr#$signer| _$t0@@1))) (=> (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies (|$addr#$signer| _$t0@@1)) (and (=> (= (ControlFlow 0 131651) 132736) anon34_Then_correct) (=> (= (ControlFlow 0 131651) 131673) anon34_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 131619) 132752) anon33_Then_correct) (=> (= (ControlFlow 0 131619) 131651) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 131625) 131619)) |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|)))
(let ((anon32_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t17@@0 $t17@@0)) (and (= $t10@0@@0 $t17@@0) (= (ControlFlow 0 131089) 131549))) L7_correct)))
(let ((anon31_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t17@@0) (= $t17@@0 6)) (and (= $t17@@0 $t17@@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 131073) 131625) anon32_Then_correct) (=> (= (ControlFlow 0 131073) 131089) anon32_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t14@0)) (= (ControlFlow 0 131037) 131073)) anon31_Else$1_correct)))
(let ((anon31_Else_correct  (=> (not $t12@@0) (=> (and (and (|$IsValid'address'| $t13) (= $t13 (|$addr#$signer| _$t0@@1))) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $t13)) (= (ControlFlow 0 131043) 131037))) inline$$Not$0$anon0_correct))))
(let ((anon31_Then_correct  (=> $t12@@0 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t11@@0)) (= 5 $t10@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t11@@0)) 2)) (= 3 $t10@@0))) (= $t10@@0 $t10@@0)) (and (= $t10@0@@0 $t10@@0) (= (ControlFlow 0 132804) 131549))) L7_correct))))
(let ((anon30_Else_correct  (=> (not $t9@@0) (=> (and (= $t11@@0 (|$addr#$signer| _$t0@@1)) (= $t12@@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t11@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t11@@0)) 2))))) (and (=> (= (ControlFlow 0 130981) 132804) anon31_Then_correct) (=> (= (ControlFlow 0 130981) 131043) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> $t9@@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t8@@0)) (= 5 $t10@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t8@@0)) 1)) (= 3 $t10@@0))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 $t10@@0))) (= $t10@@0 $t10@@0)) (and (= $t10@0@@0 $t10@@0) (= (ControlFlow 0 132876) 131549))) L7_correct))))
(let ((anon0$1_correct@@1  (=> (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@37)) 0)) (= addr@@37 173345816)))
 :qid |DesignatedDealerbpl.6629:20|
 :skolemid |293|
)) (=> (and (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@38)) 1)) (= addr@@38 186537453)))
 :qid |DesignatedDealerbpl.6633:20|
 :skolemid |294|
)) (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@39)) 2))))))
 :qid |DesignatedDealerbpl.6637:20|
 :skolemid |295|
))) (=> (and (and (forall ((addr@@40 Int) ) (!  (=> (|$IsValid'address'| addr@@40) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@40)) 2))))))
 :qid |DesignatedDealerbpl.6641:20|
 :skolemid |296|
)) (forall ((addr@@41 Int) ) (!  (=> (|$IsValid'address'| addr@@41) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@41)) 2))))))
 :qid |DesignatedDealerbpl.6645:20|
 :skolemid |297|
))) (and (forall ((addr@@42 Int) ) (!  (=> (|$IsValid'address'| addr@@42) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@42)) 2))))))
 :qid |DesignatedDealerbpl.6649:20|
 :skolemid |298|
)) (forall ((addr@@43 Int) ) (!  (=> (|$IsValid'address'| addr@@43) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@43)) 2)))))
 :qid |DesignatedDealerbpl.6653:20|
 :skolemid |299|
)))) (=> (and (and (and (and (forall ((addr@@44 Int) ) (!  (=> (|$IsValid'address'| addr@@44) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@44)) 2)))))
 :qid |DesignatedDealerbpl.6657:20|
 :skolemid |300|
)) (forall ((addr@@45 Int) ) (!  (=> (|$IsValid'address'| addr@@45) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@45)) 2)))))
 :qid |DesignatedDealerbpl.6661:20|
 :skolemid |301|
))) (and (forall ((addr@@46 Int) ) (!  (=> (|$IsValid'address'| addr@@46) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_79975| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@46) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@46) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@46)) 4))))
 :qid |DesignatedDealerbpl.6665:20|
 :skolemid |302|
)) (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_80391| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@47) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@47)) 3))))
 :qid |DesignatedDealerbpl.6669:20|
 :skolemid |303|
)))) (and (and (forall ((addr@@48 Int) ) (!  (=> (|$IsValid'address'| addr@@48) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_80391| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@48) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@48) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@48)) 3))))
 :qid |DesignatedDealerbpl.6673:20|
 :skolemid |304|
)) (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_80391| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@49) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_80391| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@49)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@49)) 3))))
 :qid |DesignatedDealerbpl.6677:20|
 :skolemid |305|
))) (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@0 Int) (mint_cap_owner2@@0 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@0) (=> (|$IsValid'address'| mint_cap_owner2@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82084| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_82084| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2@@0)) (= mint_cap_owner1@@0 mint_cap_owner2@@0))))
 :qid |DesignatedDealerbpl.6681:104|
 :skolemid |306|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_82212| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_82212| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 :qid |DesignatedDealerbpl.6685:88|
 :skolemid |307|
)))))) (and (and (and (forall ((addr3@@0 Int) ) (!  (=> (|$IsValid'address'| addr3@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82084| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |DesignatedDealerbpl.6689:20|
 :skolemid |308|
)) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_82212| |$1_Diem_MintCapability'#0'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |DesignatedDealerbpl.6693:20|
 :skolemid |309|
))) (and (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@1)) 2))))
 :qid |DesignatedDealerbpl.6697:20|
 :skolemid |310|
)) (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) addr1@@2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@2)) 2))))
 :qid |DesignatedDealerbpl.6701:20|
 :skolemid |311|
)))) (and (and (forall ((dd_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@1) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@1))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@1)))))
 :qid |DesignatedDealerbpl.6705:20|
 :skolemid |312|
)) (forall ((dd_addr@@2 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@2) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@2))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@2)))))
 :qid |DesignatedDealerbpl.6709:20|
 :skolemid |313|
))) (and (forall ((dd_addr@@3 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@3) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@3))))
 :qid |DesignatedDealerbpl.6713:20|
 :skolemid |314|
)) (forall ((dd_addr@@4 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@4) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@4))))
 :qid |DesignatedDealerbpl.6717:20|
 :skolemid |315|
)))))) (=> (and (and (and (and (and (forall ((addr@@50 Int) ) (!  (=> (|$IsValid'address'| addr@@50) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@50) (|Select__T@[Int]Bool_| (|domain#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DesignatedDealerbpl.6721:20|
 :skolemid |316|
)) (forall ((addr@@51 Int) ) (!  (=> (|$IsValid'address'| addr@@51) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) addr@@51) (|Select__T@[Int]Bool_| (|domain#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DesignatedDealerbpl.6725:20|
 :skolemid |317|
))) (and (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91467| $1_DualAttestation_Credential_$memory) addr1@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr1@@3)) 2)))))
 :qid |DesignatedDealerbpl.6729:20|
 :skolemid |318|
)) (forall ((addr@@52 Int) ) (!  (=> (|$IsValid'address'| addr@@52) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_93760| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@52) (|Select__T@[Int]Bool_| (|domain#$Memory_93820| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@52)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) addr@@52)) 2)))))
 :qid |DesignatedDealerbpl.6733:20|
 :skolemid |319|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@1)) ($1_Signer_is_txn_signer _$t0@@1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@1)))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1@@0)) ($1_Signer_is_txn_signer _$t1@@0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1@@0))) (and (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $a_0@@5)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@5))
 :qid |DesignatedDealerbpl.6745:20|
 :skolemid |320|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $a_0@@5))
)) (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@6)))
 ...
 :qid |DesignatedDealerbpl.6749:20|
 :skolemid |321|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_81448| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@6))
))) (and (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $a_0@@7)))
(|$IsValid'$1_Diem_Preburn'$1_XUS_XUS''| $rsc@@7))
 :qid |DesignatedDealerbpl.6753:20|
 :skolemid |322|
 :pattern ( (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_87298| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $a_0@@7))
)) (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@8)))
...
(forall (($i_2@@0 Int) ) (!  (=> ($InRange $range_1@@0 $i_2@@0) (let ((i@@44 $i_2@@0))
(> (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@8) i@@44)))) 0)))
 :qid |DesignatedDealerbpl.6758:223|
 :skolemid |323|
))))))
 :qid |DesignatedDealerbpl.6757:20|
 :skolemid |324|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_87707| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@8))
)))))) (and (and (and (and (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@9)))
 ...
 :qid |DesignatedDealerbpl.6762:20|
 :skolemid |325|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_81686| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@9))
)) (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $a_0@@10)))
(|$IsValid'$1_Diem_Preburn'#0''| $rsc@@10))
 :qid |DesignatedDealerbpl.6766:20|
 :skolemid |326|
 :pattern ( (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_87480| |$1_Diem_Preburn'#0'_$memory|) $a_0@@10))
))) (and (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@11)))
...
(forall (($i_2@@1 Int) ) (!  (=> ($InRange $range_1@@1 $i_2@@1) (let ((i@@45 $i_2@@1))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@11) i@@45)))) 0)))
 :qid |DesignatedDealerbpl.6771:199|
 :skolemid |327|
))))))
 :qid |DesignatedDealerbpl.6770:20|
 :skolemid |328|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_87905| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@11))
)) (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $a_0@@12)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc@@12))
 :qid |DesignatedDealerbpl.6775:20|
 :skolemid |329|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $a_0@@12))
)))) (and (and (= $t5@@0 (|$addr#$signer| _$t0@@1)) (= $t6@@0 (|$addr#$signer| _$t1@@0))) (and (= $t7@@0 (|$addr#$signer| _$t0@@1)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies $t5@@0)))) (and (and (and (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t5@@0) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies@@0| $t5@@0)) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t5@@0) (= _$t0@@1 _$t0@@1))) (and (and (= _$t1@@0 _$t1@@0) (= _$t2 _$t2)) (and (= $t8@@0 (|$addr#$signer| _$t1@@0)) (= $t9@@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_79648| $1_Roles_RoleId_$memory) $t8@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_79648| $1_Roles_RoleId_$memory) $t8@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))))))))) (and (=> (= (ControlFlow 0 130935) 132876) anon30_Then_correct) (=> (= (ControlFlow 0 130935) 130981) anon30_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_52020_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_52020| stream@@2) 0) (forall ((v@@39 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_52020| stream@@2) v@@39) 0)
 :qid |DesignatedDealerbpl.134:13|
 :skolemid |2|
))))
 :qid |DesignatedDealerbpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 129664) 130935)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 152437) 129664) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1)))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
