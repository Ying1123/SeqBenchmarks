...
(declare-fun $t11 () T@$1_VASPDomain_VASPDomains)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 92829) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (and (=> (= (ControlFlow 0 78831) (- 0 93678)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0))) (and (=> (= (ControlFlow 0 78831) (- 0 93689)) (not (> (|l#Vec_13392| _$t1) 63))) (=> (not (> (|l#Vec_13392| _$t1) 63)) (=> (= (ControlFlow 0 78831) (- 0 93701)) (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (InRangeVec_27481 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) i@@59)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0))) i@@59)) (|$domain#$1_VASPDomain_VASPDomain| $t6)))
 :qid |VASPDomainbpl.1169:13|
 :skolemid |42|
)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 78257) (- 0 93615)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (|l#Vec_13392| _$t1) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (> (|l#Vec_13392| _$t1) 63)) (=> (= (ControlFlow 0 78257) (- 0 93630)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= 5 $t10@0)) (and (> (|l#Vec_13392| _$t1) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 78845) 78257))) L3_correct)))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@60 Int) ) (!  (and (and (|$IsValid'u64'| i@@60) (InRangeVec_27481 $t13@0 i@@60)) (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| $t13@0) i@@60)) (|$domain#$1_VASPDomain_VASPDomain| inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))
 :qid |VASPDomainbpl.1169:13|
 :skolemid |42|
))) (and (=> (= (ControlFlow 0 78765) 78845) anon18_Then_correct) (=> (= (ControlFlow 0 78765) 78831) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= $t13@0 (|$domains#$1_VASPDomain_VASPDomains| $t11@1)) (= (ControlFlow 0 78771) 78765))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 78859) 78257))) L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 78667) 78859) anon17_Then_correct) (=> (= (ControlFlow 0 78667) 78771) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 78661) 78667))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 78699) 78667))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t1))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 78685) 78859) anon17_Then_correct) (=> (= (ControlFlow 0 78685) 78771) anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 78645) 78685) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 78645) 78661) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 78609) 78645)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 78615) 78609)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_13392| _$t1)) (and (=> (= (ControlFlow 0 78549) 78699) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 78549) 78615) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t1 _$t1) (= (ControlFlow 0 78555) 78549)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 78705) 78555)) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 78873) 78257))) L3_correct)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 78925) 78873) anon16_Then_correct) (=> (= (ControlFlow 0 78925) 78705) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= (ControlFlow 0 78923) 78925)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 78275) 78873) anon16_Then_correct) (=> (= (ControlFlow 0 78275) 78705) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 78261) 78923) anon15_Then_correct) (=> (= (ControlFlow 0 78261) 78275) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 78197) 78257))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |VASPDomainbpl.3771:20|
 :skolemid |147|
)) (=> (and (and (|$IsValid'address'| _$t0) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc) (and (and (let (($range_1 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@61 $i_2))
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@61))) 63)))
 :qid |VASPDomainbpl.3782:140|
 :skolemid |148|
))) (let (($range_3 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@62 $i_4))
(let (($range_5 ($Range (+ i@@62 1) (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@18 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@62)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) j@@18))))))
 :qid |VASPDomainbpl.3784:98|
 :skolemid |149|
)))))
 :qid |VASPDomainbpl.3783:202|
 :skolemid |150|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc)))
...
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |VASPDomainbpl.3785:229|
 :skolemid |151|
))))))
 :qid |VASPDomainbpl.3781:20|
 :skolemid |152|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0))
)) (= $t6 ($1_VASPDomain_VASPDomain _$t1)))) (=> (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 78181) 78261) anon14_Then_correct) (=> (= (ControlFlow 0 78181) 78197) anon14_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_31124_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2044:13|
 :skolemid |70|
))) (= (ControlFlow 0 77884) 78181)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 92829) 77884) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
