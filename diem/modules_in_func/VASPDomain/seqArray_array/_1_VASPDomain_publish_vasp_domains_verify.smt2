...
(declare-fun $t3 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_55341)
...
(declare-fun |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_31445)
(declare-fun MapConstVec_27501 (T@$1_VASPDomain_VASPDomain) |T@[Int]$1_VASPDomain_VASPDomain|)
...
(assert (not
 (=> (= (ControlFlow 0 0) 95139) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 81862) (- 0 96381)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 81862) (- 0 96393)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 5))) (and (=> (= (ControlFlow 0 81862) (- 0 96411)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t3))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t3)) (and (=> (= (ControlFlow 0 81862) (- 0 96421)) (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory@1) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory@1) $t3) (=> (= (ControlFlow 0 81862) (- 0 96429)) (= (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory@1) $t3))) 0)))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 81597) (- 0 96288)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t3))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t3)) (=> (= (ControlFlow 0 81597) (- 0 96317)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 5)) (= 3 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t3) (= 6 $t7@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 81876) 81597))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 81928) 81876) anon18_Then_correct) (=> (= (ControlFlow 0 81928) 81862) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 81926) 81928)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_55341 (|Store__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 81792) 81876) anon18_Then_correct) (=> (= (ControlFlow 0 81792) 81862) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t14@0 ($1_VASPDomain_VASPDomains |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 81770) (- 0 96069)) (let (($range_0 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@59 $i_1))
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) i@@59))) 63)))
 :qid |VASPDomainbpl.4528:93|
 :skolemid |197|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@60 $i_1@@0))
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) i@@60))) 63)))
 :qid |VASPDomainbpl.4528:93|
 :skolemid |197|
))) (and (=> (= (ControlFlow 0 81770) (- 0 96113)) (let (($range_0@@1 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@61 $i_1@@1))
(let (($range_2 ($Range (+ i@@61 1) (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@18 $i_3))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) i@@61)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) j@@18))))))
 :qid |VASPDomainbpl.4536:98|
 :skolemid |198|
)))))
 :qid |VASPDomainbpl.4535:93|
 :skolemid |199|
)))) (=> (let (($range_0@@2 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@62 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@62 1) (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@19 $i_3@@0))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) i@@62)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $t14@0)) j@@19))))))
 :qid |VASPDomainbpl.4536:98|
 :skolemid |198|
)))))
 :qid |VASPDomainbpl.4535:93|
 :skolemid |199|
))) (and (=> (= (ControlFlow 0 81770) 81926) anon17_Then_correct) (=> (= (ControlFlow 0 81770) 81792) anon17_Else_correct)))))))))
(let ((|inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| (Vec_31445 (MapConstVec_27501 DefaultVecElem_27501) 0)) (and (=> (= (ControlFlow 0 81623) 81942) anon16_Then_correct) (=> (= (ControlFlow 0 81623) 81770) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 81629) 81623)) |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 81501) 81597))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 81485) 81629) anon15_Then_correct) (=> (= (ControlFlow 0 81485) 81501) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 81445) 81485)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $t8)) (= (ControlFlow 0 81451) 81445))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t5)) 5)) (= 3 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 81994) 81597))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |VASPDomainbpl.4327:20|
 :skolemid |176|
)) (=> (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@0)) 1)) (= addr@@0 186537453)))
 :qid |VASPDomainbpl.4331:20|
 :skolemid |177|
)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@1)) 2))))))
 :qid |VASPDomainbpl.4335:20|
 :skolemid |178|
))) (=> (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@2)) 2))))))
 :qid |VASPDomainbpl.4339:20|
 :skolemid |179|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@3)) 2))))))
 :qid |VASPDomainbpl.4343:20|
 :skolemid |180|
))) (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@4)) 2))))))
 :qid |VASPDomainbpl.4347:20|
 :skolemid |181|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@5)) 2)))))
 :qid |VASPDomainbpl.4351:20|
 :skolemid |182|
)))) (=> (and (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@6)) 2)))))
 ...
 :qid |VASPDomainbpl.4359:20|
 :skolemid |184|
))) (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53481| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@8)) 4))))
 :qid |VASPDomainbpl.4363:20|
 :skolemid |185|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54002| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@9)) 3))))
 :qid |VASPDomainbpl.4367:20|
 :skolemid |186|
)))) (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54002| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@10)) 3))))
 :qid |VASPDomainbpl.4371:20|
 :skolemid |187|
)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_54002| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (not (= (|l#Vec_31210| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54002| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |VASPDomainbpl.4375:20|
 :skolemid |188|
))) (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_56661| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |VASPDomainbpl.4379:20|
 :skolemid |189|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_56948| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_57008| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@12)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr@@12)) 2)))))
 :qid |VASPDomainbpl.4383:20|
 :skolemid |190|
))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |VASPDomainbpl.4389:20|
 :skolemid |191|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0@@0)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@0) (and (and (let (($range_1 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@63 $i_2))
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) i@@63))) 63)))
 :qid |VASPDomainbpl.4394:140|
 :skolemid |192|
))) (let (($range_3 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@64 $i_4))
(let (($range_5 ($Range (+ i@@64 1) (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@20 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) i@@64)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) j@@20))))))
 :qid |VASPDomainbpl.4396:98|
 :skolemid |193|
)))))
 :qid |VASPDomainbpl.4395:202|
 :skolemid |194|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))
(forall (($i_8 Int) ) (!  (=> (InRangeVec_27481 $range_7 $i_8) (let (($elem (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| $range_7) $i_8)))
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |VASPDomainbpl.4397:229|
 :skolemid |195|
))))))
 :qid |VASPDomainbpl.4393:20|
 :skolemid |196|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t5)) 5))))))) (and (=> (= (ControlFlow 0 81389) 81994) anon14_Then_correct) (=> (= (ControlFlow 0 81389) 81451) anon14_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_31124_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2044:13|
 :skolemid |70|
))) (= (ControlFlow 0 80710) 81389)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 95139) 80710) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
