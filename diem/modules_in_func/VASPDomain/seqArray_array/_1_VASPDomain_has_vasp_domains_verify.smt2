...
(assert (not
 (=> (= (ControlFlow 0 0) 93722) (let ((anon0$1_correct  (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |VASPDomainbpl.3953:20|
 :skolemid |153|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0)))
...
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@59))) 63)))
 :qid |VASPDomainbpl.3961:140|
 :skolemid |154|
))) (let (($range_3 ($Range 0 (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@60 $i_4))
(let (($range_5 ($Range (+ i@@60 1) (|l#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@18 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) i@@60)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_31445| (|$domains#$1_VASPDomain_VASPDomains| $rsc)) j@@18))))))
 :qid |VASPDomainbpl.3963:98|
 :skolemid |155|
)))))
 :qid |VASPDomainbpl.3962:202|
 :skolemid |156|
...
(<= (|l#Vec_13392| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |VASPDomainbpl.3964:229|
 :skolemid |157|
))))))
 :qid |VASPDomainbpl.3960:20|
 :skolemid |158|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 79347) (- 0 94003)) (not false)) (=> (not false) (=> (= (ControlFlow 0 79347) (- 0 94010)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_55341| $1_VASPDomain_VASPDomains_$memory) _$t0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_31124_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2044:13|
 :skolemid |70|
))) (= (ControlFlow 0 79076) 79347)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 93722) 79076) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
