...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_91251)
(declare-fun $t20 () Int)
(declare-fun $t21 () Int)
...
(declare-fun $t37 () T@Vec_56286)
(declare-fun $t38 () T@$1_DiemConfig_Configuration)
(declare-fun $t39 () Int)
(declare-fun $t40 () T@$1_DiemConfig_NewEpochEvent)
(declare-fun $t8 () T@Vec_56286)
(declare-fun _$t3 () T@Vec_19663)
(declare-fun _$t4 () T@Vec_19663)
...
(declare-fun MapConstVec_50264 (T@$1_ValidatorConfig_Config) |T@[Int]$1_ValidatorConfig_Config|)
(declare-fun DefaultVecElem_50264 () T@$1_ValidatorConfig_Config)
(declare-fun $t18 () Int)
(declare-fun $t28 () Int)
(declare-fun |$temp_0'bool'@0| () Bool)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_91251)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0 () T@$Memory_91251)
...
(assert (not
 (=> (= (ControlFlow 0 0) 177120) (let ((L2_correct  (and (=> (= (ControlFlow 0 154583) (- 0 180595)) (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0) (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (not (= (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) $t9))) (not (let (($range_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@42) _$t1)))
 ...
 :skolemid |148|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t10))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (and $t5 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11) 18446744073709551615)) (< $t12 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11))))) (and $t5 (> $t7 (- 18446744073709551615 300000000)))) (and $t5 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7 300000000)))) (not (= (|$addr#$signer| _$t0) (let ((t_ref@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@1))) 0)))))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0) (let ((t_ref@@2 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@2))) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (not (= (let ((t_ref@@3 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@3))) 0)) $t9))) (not (let (($range_0@@0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@1))))))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@43) _$t1)))
 :qid |ValidatorAdministrationScriptsbpl.4596:125|
 :skolemid |148|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t10))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (and $t5 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11) 18446744073709551615)) (< $t12 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11))))) (and $t5 (> $t7 (- 18446744073709551615 300000000)))) (and $t5 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7 300000000)))) (not (= (|$addr#$signer| _$t0) (let ((t_ref@@4 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@4))) 0))))) (=> (= (ControlFlow 0 154583) (- 0 180777)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (= (|$addr#$signer| _$t0) (let ((t_ref@@5 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@5))) 0)))) (= 7 $t16)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2)) (= 7 $t16))) (and (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= 5 $t16))) (and (not (= (let ((t_ref@@6 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@6))) 0)) $t9)) (= 7 $t16))) (and (not (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@2))))))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@44) _$t1)))
 :qid |ValidatorAdministrationScriptsbpl.4596:125|
 :skolemid |148|
)))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) (= 5 $t16))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) 4)) (= 3 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= 5 $t16))) (and (and $t5 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11) 18446744073709551615)) (< $t12 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11)))) (= 1 $t16))) (and (and $t5 (> $t7 (- 18446744073709551615 300000000))) (= 8 $t16))) (and (and $t5 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7 300000000))) (= 8 $t16))) (and (not (= (|$addr#$signer| _$t0) (let ((t_ref@@7 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@7))) 0)))) (= 7 $t16))) (= 5 $t16)) (= 3 $t16)) (= 7 $t16)) (= 1 $t16)))))))
(let ((anon17_Then_correct  (=> (and (and $t29 (or (or (or (or (or (or (or (or (or (or (and (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (= 7 $t16)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)) (= 5 $t16))) (and (not (= (let ((t_ref@@8 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@8))) 0)) $t20)) (= 7 $t16))) (and (not (let (($range_0@@2 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@45) _$t1)))
 :qid |ValidatorAdministrationScriptsbpl.4596:125|
 :skolemid |148|
)))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t21)) (= 5 $t16))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t21)) 4)) (= 3 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)) (= 5 $t16))) (and (and $t17 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t23) 18446744073709551615)) (< $t24 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t23)))) (= 1 $t16))) (and (and $t17 (> $t19 (- 18446744073709551615 300000000))) (= 8 $t16))) (and (and $t17 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t19 300000000))) (= 8 $t16)))) (and (= $t16 $t16) (= (ControlFlow 0 154019) 154583))) L2_correct)))
(let ((anon15_Then_correct  (=> (and (and $t15 (or (or (or (and (not (= (|$addr#$signer| _$t0) (let ((t_ref@@9 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@9))) 0)))) (= 7 $t16)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2)) (= 7 $t16))) (and (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))) (= 7 $t16))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (= 5 $t16)))) (and (= $t16 $t16) (= (ControlFlow 0 154681) 154583))) L2_correct)))
(let ((anon13_correct  (=> (and (= $t30 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@4))))) (= $t31 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory@2) 173345816))) (=> (and (and (and (and (= $t32 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t33 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t31)))) (and (= (|l#Vec_56286| $t30) (|l#Vec_56286| $t22)) (let (($range_0@@3 ($Range 0 (|l#Vec_56286| $t22))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@84 $i_1@@3))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@84)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@84)))))
 :qid |ValidatorAdministrationScriptsbpl.8885:62|
 :skolemid |331|
))))) (and (and (let (($range_0@@4 ($Range 0 (|l#Vec_56286| $t22))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@85 $i_1@@4))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85)) _$t1)) (and (and (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85))) (= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85)))) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85)))))) (= (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@85)) (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@85)))))))
 :qid |ValidatorAdministrationScriptsbpl.8889:62|
 :skolemid |332|
))) (let (($range_0@@5 ($Range 0 (|l#Vec_56286| $t22))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@86 $i_1@@5))
 (or (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@86)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@86))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@86))))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t22) i@@86)) _$t1) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (let ((config (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config)) 0)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (let ((config (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config)) 0))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t30) i@@86))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (let ((config (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config)) 0)))))))))
 :qid |ValidatorAdministrationScriptsbpl.8893:62|
 :skolemid |333|
)))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) _$t1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) _$t1)) 3)))) (and (and (and (= $t34 $t33) (= $t35 $t27)) (and (= $t36  (and $t25 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t32 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26)))))) (= $es@0 (ite $t36 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $es) $t35)))
(let ((stream_new (let ((len (|l#Multiset_56001| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t34))))
(Multiset_56001 (|Store__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t34) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $es) $t35 stream_new)))) $es)))) (and (and (= $t37 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@5 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@5))))) (= $t38 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $t39 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t40 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t38))))))) (and (=> (= (ControlFlow 0 153729) (- 0 180051)) (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@10 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@10))) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@11 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@11))) 0))))) (and (=> (= (ControlFlow 0 153729) (- 0 180067)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (and (=> (= (ControlFlow 0 153729) (- 0 180077)) (not (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0))))) (=> (not (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (and (=> (= (ControlFlow 0 153729) (- 0 180088)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (and (=> (= (ControlFlow 0 153729) (- 0 180099)) (not (not (= (let ((t_ref@@12 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@12))) 0)) $t9)))) (=> (not (not (= (let ((t_ref@@13 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@13))) 0)) $t9))) (and (=> (= (ControlFlow 0 153729) (- 0 180114)) (not (not (let (($range_0@@6 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@6 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@6))))))
(exists (($i_1@@6 Int) ) (!  (and (InRangeVec_49842 $range_0@@6 $i_1@@6) (let ((v@@46 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@6) $i_1@@6)))
...
(exists (($i_1@@7 Int) ) (!  (and (InRangeVec_49842 $range_0@@7 $i_1@@7) (let ((v@@47 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@7) $i_1@@7)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@47) _$t1)))
 :qid |ValidatorAdministrationScriptsbpl.4596:125|
 :skolemid |148|
))))) (and (=> (= (ControlFlow 0 153729) (- 0 180125)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 153729) (- 0 180135)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t10)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t10))) (and (=> (= (ControlFlow 0 153729) (- 0 180147)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) 4)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t10)) 4))) (and (=> (= (ControlFlow 0 153729) (- 0 180165)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (and (=> (= (ControlFlow 0 153729) (- 0 180176)) (not (and $t5 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11) 18446744073709551615)) (< $t12 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11)))))) (=> (not (and $t5 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t11) 18446744073709551615)) (< $t12 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t11))))) (and (=> (= (ControlFlow 0 153729) (- 0 180222)) (not (and $t5 (> $t7 (- 18446744073709551615 300000000))))) (=> (not (and $t5 (> $t7 (- 18446744073709551615 300000000)))) (and (=> (= (ControlFlow 0 153729) (- 0 180241)) (not (and $t5 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7 300000000))))) (=> (not (and $t5 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t7 300000000)))) (and (=> (= (ControlFlow 0 153729) (- 0 180261)) (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@14 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@14))) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0) (let ((t_ref@@15 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@15))) 0))))) (and (=> (= (ControlFlow 0 153729) (- 0 180277)) (= (|l#Vec_56286| $t37) (|l#Vec_56286| $t8))) (=> (= (|l#Vec_56286| $t37) (|l#Vec_56286| $t8)) (and (=> (= (ControlFlow 0 153729) (- 0 180290)) (let (($range_0@@8 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((i@@87 $i_1@@8))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@87)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@87)))))
 :qid |ValidatorAdministrationScriptsbpl.9013:56|
 :skolemid |334|
)))) (=> (let (($range_0@@9 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@9 Int) ) (!  (=> ($InRange $range_0@@9 $i_1@@9) (let ((i@@88 $i_1@@9))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@88)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@88)))))
 :qid |ValidatorAdministrationScriptsbpl.9013:56|
 :skolemid |334|
))) (and (=> (= (ControlFlow 0 153729) (- 0 180336)) (let (($range_0@@10 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@10 Int) ) (!  (=> ($InRange $range_0@@10 $i_1@@10) (let ((i@@89 $i_1@@10))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89)) _$t1)) (and (and (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89))) (= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89)))) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89)))))) (= (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@89)) (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@89)))))))
 :qid |ValidatorAdministrationScriptsbpl.9019:56|
 :skolemid |335|
)))) (=> (let (($range_0@@11 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@11 Int) ) (!  (=> ($InRange $range_0@@11 $i_1@@11) (let ((i@@90 $i_1@@11))
 (=> (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90)) _$t1)) (and (and (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90))) (= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90)) (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90)))) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90)))))) (= (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@90)) (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@90)))))))
 :qid |ValidatorAdministrationScriptsbpl.9019:56|
 :skolemid |335|
))) (and (=> (= (ControlFlow 0 153729) (- 0 180393)) (let (($range_0@@12 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@12 Int) ) (!  (=> ($InRange $range_0@@12 $i_1@@12) (let ((i@@91 $i_1@@12))
 (or (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@91)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@91))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@91))))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@91)) _$t1) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (let ((config@@0 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@0)) 0)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (let ((config@@0 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@0)) 0))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@91))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (let ((config@@0 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@0)) 0)))))))))
 :qid |ValidatorAdministrationScriptsbpl.9025:56|
 :skolemid |336|
)))) (=> (let (($range_0@@13 ($Range 0 (|l#Vec_56286| $t8))))
(forall (($i_1@@13 Int) ) (!  (=> ($InRange $range_0@@13 $i_1@@13) (let ((i@@92 $i_1@@13))
 (or (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@92)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@92))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@92))))) (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t8) i@@92)) _$t1) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$consensus_pubkey#$1_ValidatorConfig_Config| (let ((config@@1 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@1)) 0)))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$validator_network_addresses#$1_ValidatorConfig_Config| (let ((config@@1 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@1)) 0))))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $t37) i@@92))) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (let ((config@@1 (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))))
(|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| config@@1)) 0)))))))))
 :qid |ValidatorAdministrationScriptsbpl.9025:56|
 :skolemid |336|
))) (and (=> (= (ControlFlow 0 153729) (- 0 180468)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) _$t1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) _$t1)) 3))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) _$t1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) _$t1)) 3)) (and (=> (= (ControlFlow 0 153729) (- 0 180476)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (and (=> (= (ControlFlow 0 153729) (- 0 180483)) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$consensus_pubkey#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$validator_network_addresses#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4))))) (=> (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$consensus_pubkey#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$validator_network_addresses#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)))) (and (=> (= (ControlFlow 0 153729) (- 0 180497)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (ite  (and $t5 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13))))) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_56001| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_56001 (|Store__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14 stream_new@@0)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@48 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected) handle@@1)) v@@48) (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual) handle@@1)) v@@48))
...
(let ((expected@@0 (ite  (and $t5 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13))))) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_56001| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_56001 (|Store__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14 stream_new@@1)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@49 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected@@0) handle@@2)) v@@49) (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual@@0) handle@@2)) v@@49))
 :qid |ValidatorAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |ValidatorAdministrationScriptsbpl.2603:13|
 :skolemid |92|
))))) (=> (= (ControlFlow 0 153729) (- 0 180546)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (and $t5 (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t39 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t13))))) (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_56001| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40))))
(Multiset_56001 (|Store__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t40) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $EmptyEventStore) $t14 stream_new@@2)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@50 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| actual@@1) handle@@3)) v@@50) (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| expected@@1) handle@@3)) v@@50))
 :qid |ValidatorAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |ValidatorAdministrationScriptsbpl.2603:13|
...
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@2|) (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| ($Memory_93557 (|Store__T@[Int]Bool_| (|domain#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 false) (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) (= (ControlFlow 0 152829) 153729))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@2| (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0| ($Memory_93557 (|Store__T@[Int]Bool_| (|domain#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''@0|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0|) (= (ControlFlow 0 153741) 153729))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= $1_DiemConfig_Configuration_$memory@1 ($Memory_93750 (|Store__T@[Int]Bool_| (|domain#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1)) (and (=> (= (ControlFlow 0 152815) 153741) anon19_Then_correct) (=> (= (ControlFlow 0 152815) 152829) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_93750 (|Store__T@[Int]Bool_| (|domain#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0)) (and (=> (= (ControlFlow 0 153753) 153741) anon19_Then_correct) (=> (= (ControlFlow 0 153753) 152829) anon19_Else_correct))))))
(let ((anon17_Else_correct  (=> (not $t29) (and (=> (= (ControlFlow 0 152803) 153753) anon18_Then_correct) (=> (= (ControlFlow 0 152803) 152815) anon18_Else_correct)))))
(let ((anon5_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (=> (and (and (and (and (and (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_56094 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_50264 DefaultVecElem_50264) 0 ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))))) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_56094 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_50264 DefaultVecElem_50264) 0 ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))))))) (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_56094 (|Store__T@[Int]$1_ValidatorConfig_Config_| (MapConstVec_50264 DefaultVecElem_50264) 0 ($1_ValidatorConfig_Config _$t2 _$t3 _$t4)) 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))))) (= $t17  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (let (($range_0@@14 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@8 173345816))
...
(exists (($i_1@@14 Int) ) (!  (and (InRangeVec_49842 $range_0@@14 $i_1@@14) (let ((v_info (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@14) $i_1@@14)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| v_info) _$t1) (not (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info)) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info)) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info)) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))))))))
 :qid |ValidatorAdministrationScriptsbpl.8774:223|
 :skolemid |329|
)))))) (and (and (= $t18 ($choice_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9)))) _$t1)) (= $t19 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@10 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@10))))) $t18)))) (and (= $t20 (|$addr#$signer| _$t0)) (= $t21 (|$addr#$signer| _$t0))))) (and (and (and (= $t22 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))) (= $t23 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t24 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t25  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (let (($range_0@@15 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
...
(exists (($i_1@@15 Int) ) (!  (and (InRangeVec_49842 $range_0@@15 $i_1@@15) (let ((v_info@@0 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@15) $i_1@@15)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| v_info@@0) _$t1) (not (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info@@0)) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info@@0)) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| v_info@@0)) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|Select__T@[Int]$1_ValidatorConfig_Config_| (|v#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))))))))
 :qid |ValidatorAdministrationScriptsbpl.8807:223|
 :skolemid |330|
))))))) (and (and (= $t26 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t27 (|$events#$1_DiemConfig_Configuration| $t26))) (and (= $t28 (|$addr#$signer| _$t0)) (= $t29  (or (or (or (or (or (or (or (or (or (or (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))) (not (= (let ((t_ref@@16 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@16))) 0)) $t20))) (not (let (($range_0@@16 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))))
(exists (($i_1@@16 Int) ) (!  (and (InRangeVec_49842 $range_0@@16 $i_1@@16) (let ((v@@51 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@16) $i_1@@16)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@51) _$t1)))
 :qid |ValidatorAdministrationScriptsbpl.4596:125|
 :skolemid |148|
))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t21))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t21)) 4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@2) _$t1))) (and $t17 (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t23) 18446744073709551615)) (< $t24 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t23))))) (and $t17 (> $t19 (- 18446744073709551615 300000000)))) (and $t17 (<= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ $t19 300000000))))))))) (and (=> (= (ControlFlow 0 152797) 154019) anon17_Then_correct) (=> (= (ControlFlow 0 152797) 152803) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 ($Memory_91251 (|Store__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1 false) (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory)))) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= (ControlFlow 0 152351) 152797))) anon5_correct)))
(let ((anon16_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_91251 (|Store__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1 true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1 |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0|)))) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@0) (= (ControlFlow 0 154595) 152797))) anon5_correct)))
(let ((anon15_Else_correct  (=> (not $t15) (and (=> (= (ControlFlow 0 152339) 154595) anon16_Then_correct) (=> (= (ControlFlow 0 152339) 152351) anon16_Else_correct)))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@14)) 0)) (= addr@@14 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8390:20|
 :skolemid |291|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@15)) 1)) (= addr@@15 186537453)))
 :qid |ValidatorAdministrationScriptsbpl.8398:20|
 :skolemid |292|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8406:20|
 :skolemid |293|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8410:20|
 :skolemid |294|
)))) (=> (and (and (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8414:20|
 :skolemid |295|
)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.8418:20|
 :skolemid |296|
))) (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8422:20|
 :skolemid |297|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8426:20|
 :skolemid |298|
)))) (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8430:20|
 :skolemid |299|
)) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@23)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.8434:20|
 :skolemid |300|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@24)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8438:20|
 :skolemid |301|
)) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@25) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@25)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8442:20|
 :skolemid |302|
))))) (and (and (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@26) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@26)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@26)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8446:20|
 :skolemid |303|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8462:20|
 :skolemid |304|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_95363| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27) (= addr@@27 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.8470:20|
 :skolemid |305|
)) (let (($range_0@@17 ($Range 0 (|l#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@28 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@28))))))))
(forall (($i_1@@17 Int) ) (!  (=> ($InRange $range_0@@17 $i_1@@17) (let ((i1 $i_1@@17))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@29 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@29))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@29 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@29))))) i1)))) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8474:151|
 :skolemid |306|
))))))) (=> (and (and (and (and (and (and (let (($range_0@@18 ($Range 0 (|l#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@30 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@30))))))))
(forall (($i_1@@18 Int) ) (!  (=> ($InRange $range_0@@18 $i_1@@18) (let ((i1@@0 $i_1@@18))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@31 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@31))))) i1@@0)) 1)))
 :qid |ValidatorAdministrationScriptsbpl.8479:151|
 :skolemid |307|
 ...
 :qid |ValidatorAdministrationScriptsbpl.8516:20|
 :skolemid |308|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93913| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107885| $1_ChainId_ChainId_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_108263| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_108263| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109214| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109618| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_108430| $1_DiemAccount_DiemAccount_$memory) addr@@32) (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@32)))
 :qid |ValidatorAdministrationScriptsbpl.8552:20|
 :skolemid |309|
)) (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106018| $1_VASPDomain_VASPDomainManager_$memory) addr@@33)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@33)) 1))))
 :qid |ValidatorAdministrationScriptsbpl.8556:20|
 :skolemid |310|
)))) (and (and (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106135| $1_VASPDomain_VASPDomains_$memory) addr@@34)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@34)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.8560:20|
 :skolemid |311|
)) (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_109349| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@35) (|Select__T@[Int]Bool_| (|domain#$Memory_109440| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@35)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@35)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.8564:20|
 :skolemid |312|
))) (and (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (= (|Select__T@[Int]Bool_| (|domain#$Memory_107665| $1_DesignatedDealer_Dealer_$memory) addr@@36)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@36)) 2))))
 :qid |ValidatorAdministrationScriptsbpl.8568:20|
 :skolemid |313|
)) (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106591| $1_DualAttestation_Credential_$memory) addr@@37)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@37)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@37)) 5)))))
 :qid |ValidatorAdministrationScriptsbpl.8572:20|
 :skolemid |314|
))))) (and (and (and (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (= (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) addr@@38)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@38)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@38)) 1)))))
 :qid |ValidatorAdministrationScriptsbpl.8576:20|
 :skolemid |315|
)) (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (= (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@39)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@39)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.8580:20|
 :skolemid |316|
))) (and (forall ((addr@@40 Int) ) (!  (=> (|$IsValid'address'| addr@@40) (= (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@40)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@40)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.8584:20|
 :skolemid |317|
)) (forall ((addr@@41 Int) ) (!  (=> (|$IsValid'address'| addr@@41) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106232| $1_VASP_ParentVASP_$memory) addr@@41)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@41)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.8588:20|
 :skolemid |318|
)))) (and (and (forall ((addr@@42 Int) ) (!  (=> (|$IsValid'address'| addr@@42) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106168| $1_VASP_ChildVASP_$memory) addr@@42)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@42)) 6))))
 :qid |ValidatorAdministrationScriptsbpl.8592:20|
 :skolemid |319|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112146| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93977| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_94041| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (and (|$IsValid'address'| _$t1) (|$IsValid'vec'u8''| _$t2)) (and (|$IsValid'vec'u8''| _$t3) (|$IsValid'vec'u8''| _$t4)))) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |ValidatorAdministrationScriptsbpl.8622:20|
 :skolemid |320|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $a_0@@0)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |ValidatorAdministrationScriptsbpl.8626:20|
 :skolemid |321|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8630:20|
 :skolemid |322|
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) $a_0@@2)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@2))
 :qid |ValidatorAdministrationScriptsbpl.8634:20|
 :skolemid |323|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) $a_0@@2))
)))) (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@3)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@3))
 :qid |ValidatorAdministrationScriptsbpl.8638:20|
 :skolemid |324|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_93638| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@4)))
 (and (|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@4) (let (($range_1 ($Range 0 (|l#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@4))))))
(let (($range_2 ($Range 0 (|l#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@4))))))
(forall (($i_3 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1 $i_3) (=> ($InRange $range_2 $i_4) (let ((i@@93 $i_3))
(let ((j@@25 $i_4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@4))) i@@93)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@4))) j@@25))) (= i@@93 j@@25))))))
 :qid |ValidatorAdministrationScriptsbpl.8643:367|
 :skolemid |325|
))))))
 :qid |ValidatorAdministrationScriptsbpl.8642:20|
 :skolemid |326|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@4))
))) (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_95363| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@5)))
(|$IsValid'$1_DiemSystem_CapabilityHolder'| $rsc@@5))
 :qid |ValidatorAdministrationScriptsbpl.8648:20|
 :skolemid |327|
 :pattern ( (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_95363| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@5))
)) (= $t5 (let (($range_0@@19 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@43 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@43))))))
(exists (($i_1@@19 Int) ) (!  (and (InRangeVec_49842 $range_0@@19 $i_1@@19) (let ((v_info@@1 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| $range_0@@19) $i_1@@19)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.8653:140|
 :skolemid |328|
)))))))) (and (and (and (and (= $t6 ($choice_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@44 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@44)))) _$t1)) (= $t7 (|$last_config_update_time#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@45 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@45))))) $t6)))) (and (= $t8 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@46 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@46))))) (= $t9 (|$addr#$signer| _$t0)))) (and (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t12 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t13 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_93750| $1_DiemConfig_Configuration_$memory) 173345816))))) (and (and (and (= $t14 (|$events#$1_DiemConfig_Configuration| $t13)) (let ((addr@@47 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_108430| $1_DiemAccount_DiemAccount_$memory) addr@@47)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) addr@@47) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) addr@@47))))))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= _$t4 _$t4) (= $t15  (or (or (or (not (= (|$addr#$signer| _$t0) (let ((t_ref@@17 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@17))) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)))))))))) (and (=> (= (ControlFlow 0 152331) 154681) anon15_Then_correct) (=> (= (ControlFlow 0 152331) 152339) anon15_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |ValidatorAdministrationScriptsbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 150708) 152331)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 177120) 150708) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
