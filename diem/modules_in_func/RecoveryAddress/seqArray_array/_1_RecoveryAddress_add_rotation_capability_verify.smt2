...
(declare-fun $t19@2 () T@$Mutation_64149)
(declare-fun $t19@1 () T@$Mutation_64149)
...
(declare-fun _$t0 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun $t14@0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun $t20@0 () T@$Mutation_33497)
...
(declare-fun $t21@0 () T@Vec_28962)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| () T@Vec_28962)
(declare-fun $t19 () T@$Mutation_64149)
(declare-fun $t19@0 () T@$Mutation_64149)
...
(declare-fun $t8 () T@$Mutation_33497)
(declare-fun $t20 () T@$Mutation_33497)
(push 1)
(set-info :boogie-vc-id $1_RecoveryAddress_add_rotation_capability$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 88345) (let ((anon30_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t19@2 ($Mutation_64149 (|l#$Mutation_64149| $t19@1) (|p#$Mutation_64149| $t19@1) ($1_RecoveryAddress_RecoveryAddress (|v#$Mutation_33497| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)))) (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_51427 (|Store__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_64149| $t19@2)) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_64149| $t19@2)) (|v#$Mutation_64149| $t19@2))))) (and (=> (= (ControlFlow 0 77623) (- 0 89363)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr))) 0)) addr))))
 :qid |RecoveryAddressbpl.5784:15|
 :skolemid |201|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@0))) 0)) addr@@0))))
 :qid |RecoveryAddressbpl.5784:15|
 :skolemid |201|
)) (and (=> (= (ControlFlow 0 77623) (- 0 89410)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@1)))
 :qid |RecoveryAddressbpl.5790:15|
 :skolemid |202|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@2)))
 :qid |RecoveryAddressbpl.5790:15|
 :skolemid |202|
)) (and (=> (= (ControlFlow 0 77623) (- 0 89434)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@3)))
 :qid |RecoveryAddressbpl.5796:15|
 :skolemid |203|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@4)))
 :qid |RecoveryAddressbpl.5796:15|
 :skolemid |203|
)) (and (=> (= (ControlFlow 0 77623) (- 0 89458)) (forall ((recovery_addr Int) (to_recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr) (=> (|$IsValid'address'| to_recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr) (=> (exists ((i@@50 Int) ) (!  (and (and (|$IsValid'u64'| i@@50) (and (<= 0 i@@50) (< i@@50 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr))) i@@50)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)) (exists ((i@@51 Int) ) (!  (and (and (|$IsValid'u64'| i@@51) (and (<= 0 i@@51) (< i@@51 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr))) i@@51)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))))))
 :qid |RecoveryAddressbpl.5802:15|
 :skolemid |204|
 ...
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)) (exists ((i@@53 Int) ) (!  (and (and (|$IsValid'u64'| i@@53) (and (<= 0 i@@53) (< i@@53 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) recovery_addr@@0))) i@@53)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))))))
 :qid |RecoveryAddressbpl.5802:15|
 :skolemid |204|
)) (and (=> (= (ControlFlow 0 77623) (- 0 89499)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@5) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@5))))
 :qid |RecoveryAddressbpl.5808:15|
 :skolemid |205|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) addr@@6) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@6))))
 :qid |RecoveryAddressbpl.5808:15|
 :skolemid |205|
)) (=> (= $t27 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 77623) (- 0 89542)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 77623) (- 0 89553)) (not (>= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256))) (=> (not (>= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (and (=> (= (ControlFlow 0 77623) (- 0 89570)) (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 77623) (- 0 89584)) (= (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@0) _$t1))) (- $t27 1)) _$t0)))))))))))))))))))))))
(let ((anon24_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 76878) (- 0 89227)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10)))))))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (>= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))))))) (=> (= (ControlFlow 0 76878) (- 0 89258)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t14@0)) (and (>= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256) (= 8 $t14@0))) (and (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t10) $t10 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $t10)))))) (= 7 $t14@0))))))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 77637) 76878))) L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_33497 (|l#$Mutation_33497| $t20@0) (|p#$Mutation_33497| $t20@0) (let ((l (|l#Vec_28962| (|v#$Mutation_33497| $t20@0))))
(Vec_28962 (|Store__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|v#$Mutation_33497| $t20@0)) l _$t0) (+ l 1))))) (and (=> (= (ControlFlow 0 77326) 77637) anon30_Then_correct) (=> (= (ControlFlow 0 77326) 77623) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 77332) 77326)) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t26 $t26)) (and (= $t14@0 $t26) (= (ControlFlow 0 77271) 76878))) L7_correct)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 6) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 8)) (and (= $t26 $t26) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 77255) 77332) anon29_Then_correct) (=> (= (ControlFlow 0 77255) 77271) anon29_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| 256)) (= (ControlFlow 0 77215) 77255)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 77221) 77215)) inline$$Lt$0$anon0_correct))))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 77651) 76878))) L7_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (|l#Vec_28962| $t21@0)) (and (=> (= (ControlFlow 0 77155) 77651) anon28_Then_correct) (=> (= (ControlFlow 0 77155) 77221) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not $abort_flag@0) (= $t20@0 ($Mutation_33497 (|l#$Mutation_64149| $t19@1) (let ((l@@0 (|l#Vec_12290| (|p#$Mutation_64149| $t19@1))))
(Vec_12290 (|Store__T@[Int]Int_| (|v#Vec_12290| (|p#$Mutation_64149| $t19@1)) l@@0 0) (+ l@@0 1))) (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|v#$Mutation_64149| $t19@1))))) (=> (and (and (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| (|v#$Mutation_33497| $t20@0)) (= |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0| |$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@0|)) (and (= $t21@0 (|v#$Mutation_33497| $t20@0)) (= (ControlFlow 0 77161) 77155))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 77665) 76878))) L7_correct)))
(let ((anon26_Then$1_correct  (=> (= $t19@1 $t19) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 77717) 77665) anon27_Then_correct) (=> (= (ControlFlow 0 77717) 77161) anon27_Else_correct))))))
(let ((anon26_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 77715) 77717)) anon26_Then$1_correct)))
(let ((anon26_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t19@0 ($Mutation_64149 ($Global _$t1) (Vec_12290 (MapConstVec_7770 DefaultVecElem_7770) 0) (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (= $t19@1 $t19@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 77089) 77665) anon27_Then_correct) (=> (= (ControlFlow 0 77089) 77161) anon27_Else_correct))))))
(let ((anon25_Then_correct  (=> $t16 (and (=> (= (ControlFlow 0 77067) 77715) anon26_Then_correct) (=> (= (ControlFlow 0 77067) 77089) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (and (not $t16) (= $t18 $t18)) (and (= $t14@0 $t18) (= (ControlFlow 0 77063) 76878))) L7_correct)))
(let ((anon24_Else_correct  (=> (and (and (and (not false) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (= $t16  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)))))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16 $t16)))) (and (=> (= (ControlFlow 0 77047) 77067) anon25_Then_correct) (=> (= (ControlFlow 0 77047) 77063) anon25_Else_correct)))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 76975) 77731) anon24_Then_correct) (=> (= (ControlFlow 0 76975) 77047) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and $t11@0 (= (ControlFlow 0 76981) 76975)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon23_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 76770) 76878))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |RecoveryAddressbpl.5509:20|
 :skolemid |193|
)) (=> (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (= (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@7)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@7)) 5))))
 :qid |RecoveryAddressbpl.5513:20|
 :skolemid |194|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (= (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@8)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@8)) 6))))
 :qid |RecoveryAddressbpl.5517:20|
 :skolemid |195|
))) (=> (and (and (and (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9))) 0)) addr@@9))))
 :qid |RecoveryAddressbpl.5521:20|
 :skolemid |196|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@10) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@10))))
 :qid |RecoveryAddressbpl.5525:20|
 :skolemid |197|
))) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t0) (|$IsValid'address'| _$t1))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |RecoveryAddressbpl.5534:20|
 :skolemid |198|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@0))
 :qid |RecoveryAddressbpl.5538:20|
 :skolemid |199|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@1))
 :qid |RecoveryAddressbpl.5542:20|
 :skolemid |200|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@1))
)) (= $t10 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 76754) 76981) anon23_Then_correct) (=> (= (ControlFlow 0 76754) 76770) anon23_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28837_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.1863:13|
 :skolemid |63|
))) (= (ControlFlow 0 76453) 76754)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_12290| (|p#$Mutation_33497| $t8)) 0) (= (|l#Vec_12290| (|p#$Mutation_64149| $t19)) 0)) (and (= (|l#Vec_12290| (|p#$Mutation_33497| $t20)) 0) (= (ControlFlow 0 76463) 76453))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 88345) 76463) anon0_correct)))
