...
(assert (not
 (=> (= (ControlFlow 0 0) 634316) (let ((anon15_Else_correct@@4  (=> (not $abort_flag@0@@9) (and (=> (= (ControlFlow 0 387035) (- 0 635380)) (forall ((config_address@@29 Int) ) (!  (=> (|$IsValid'address'| config_address@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@29) (= config_address@@29 173345816)))
 :qid |DiemConsensusConfigbpl.11699:15|
 :skolemid |320|
))) (=> (forall ((config_address@@30 Int) ) (!  (=> (|$IsValid'address'| config_address@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@30) (= config_address@@30 173345816)))
 :qid |DiemConsensusConfigbpl.11699:15|
 :skolemid |320|
)) (and (=> (= (ControlFlow 0 387035) (- 0 635405)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (and (= $t15@0@@4 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0@@4 $t15@0@@4)) (and (=> (= (ControlFlow 0 387035) (- 0 635442)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 387035) (- 0 635454)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 387035) (- 0 635472)) (not (not (= (|$addr#$signer| _$t0@@9) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@9) 173345816))) (and (=> (= (ControlFlow 0 387035) (- 0 635486)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 387035) (- 0 635496)) (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816) (and (=> (= (ControlFlow 0 387035) (- 0 635502)) (= (let ((addr@@118 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@118))) _$t1@@9)) (=> (= (let ((addr@@119 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@119))) _$t1@@9) (=> (= (ControlFlow 0 387035) (- 0 635511)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_193925| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_193925| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct@@4  (and (=> (= (ControlFlow 0 386842) (- 0 635261)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0@@9) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0@@9) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 386842) (- 0 635301)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0@@9) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct@@4  (=> (and (and $abort_flag@0@@9 (= $abort_code@1@@9 $abort_code@1@@9)) (and (= $t7@0 $abort_code@1@@9) (= (ControlFlow 0 387049) 386842))) L3_correct@@4)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0@@9 true) (= $abort_code@1@@9 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 387101) 387049) anon15_Then_correct@@4) (=> (= (ControlFlow 0 387101) 387035) anon15_Else_correct@@4))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@9)) (= (ControlFlow 0 387099) 387101)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@9))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1| ($Memory_193732 (|Store__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@9) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@9) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1|)) (and (= $abort_flag@0@@9 false) (= $abort_code@1@@9 $abort_code@0@@9))) (and (=> (= (ControlFlow 0 386886) 387049) anon15_Then_correct@@4) (=> (= (ControlFlow 0 386886) 387035) anon15_Else_correct@@4))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1@@4 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1@@9))) (and (=> (= (ControlFlow 0 386864) (- 0 635134)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@9))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@9)) (and (=> (= (ControlFlow 0 386864) 387099) anon14_Then_correct) (=> (= (ControlFlow 0 386864) 386886) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@4) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 386714) 386842))) L3_correct@@4)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1@@4 inline$$Not$0$dst@1@@4))) (and (=> (= (ControlFlow 0 386698) 386864) anon13_Then_correct) (=> (= (ControlFlow 0 386698) 386714) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@4  (=> (and (= inline$$Not$0$dst@1@@4  (not $t9@0@@4)) (= (ControlFlow 0 386658) 386698)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6@@4) (=> (and (and (|$IsValid'address'| $t8@@4) (= $t8@@4 (|$addr#$signer| _$t0@@9))) (and (= $t9@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8@@4)) (= (ControlFlow 0 386664) 386658))) inline$$Not$0$anon0_correct@@4))))
(let ((anon12_Then_correct  (=> $t6@@4 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@9) 173345816)) (= 2 $t7@@9)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t5@@4)) (= 5 $t7@@9))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t5@@4)) 0)) (= 3 $t7@@9))) (and (not (= (|$addr#$signer| _$t0@@9) 173345816)) (= 2 $t7@@9))) (= $t7@@9 $t7@@9)) (and (= $t7@0 $t7@@9) (= (ControlFlow 0 387193) 386842))) L3_correct@@4))))
(let ((anon0$1_correct@@9  (=> (and (and (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@120)) 0)) (= addr@@120 173345816)))
 :qid |DiemConsensusConfigbpl.11477:20|
 :skolemid |302|
)) (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@121)) 1)) (= addr@@121 186537453)))
 :qid |DiemConsensusConfigbpl.11481:20|
 :skolemid |303|
))) (and (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@122)) 2))))))
 :qid |DiemConsensusConfigbpl.11485:20|
 :skolemid |304|
)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@123)) 2))))))
 :qid |DiemConsensusConfigbpl.11489:20|
 :skolemid |305|
)))) (=> (and (and (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@124)) 2))))))
 :qid |DiemConsensusConfigbpl.11493:20|
 :skolemid |306|
)) (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@125)) 2))))))
 :qid |DiemConsensusConfigbpl.11497:20|
 :skolemid |307|
))) (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@126)) 2)))))
 :qid |DiemConsensusConfigbpl.11501:20|
 :skolemid |308|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@127)) 2)))))
 :qid |DiemConsensusConfigbpl.11505:20|
 :skolemid |309|
)))) (and (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@128)) 2)))))
 :qid |DiemConsensusConfigbpl.11509:20|
 :skolemid |310|
)) (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190511| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@129) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@129)) 4))))
 :qid |DiemConsensusConfigbpl.11513:20|
 :skolemid |311|
))) (and (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191977| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@130) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@130)) 3))))
 :qid |DiemConsensusConfigbpl.11517:20|
 :skolemid |312|
)) (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191977| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@131) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@131)) 3))))
 :qid |DiemConsensusConfigbpl.11521:20|
 :skolemid |313|
))))) (=> (and (and (and (and (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_191977| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@132) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_191977| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@132)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@132)) 3))))
 :qid |DiemConsensusConfigbpl.11525:20|
 :skolemid |314|
)) (forall ((config_address@@31 Int) ) (!  (=> (|$IsValid'address'| config_address@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@31) (= config_address@@31 173345816)))
 :qid |DiemConsensusConfigbpl.11529:20|
 :skolemid |315|
))) (and (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_209258| $1_DualAttestation_Credential_$memory) addr1@@4) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr1@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr1@@4)) 2)))))
 :qid |DiemConsensusConfigbpl.11533:20|
 :skolemid |316|
)) (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_209373| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@133) (|Select__T@[Int]Bool_| (|domain#$Memory_209433| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@133)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) addr@@133)) 2)))))
 :qid |DiemConsensusConfigbpl.11537:20|
 :skolemid |317|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@9)) ($1_Signer_is_txn_signer _$t0@@9)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@9)))) (and (and (and (forall (($a_0@@39 Int) ) (! (let (($rsc@@39 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $a_0@@39)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@39))
 :qid |DiemConsensusConfigbpl.11546:20|
 :skolemid |318|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $a_0@@39))
)) (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@40)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@40))
 :qid |DiemConsensusConfigbpl.11550:20|
 :skolemid |319|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_193732| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@40))
))) (and (= $t4 (|$addr#$signer| _$t0@@9)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| 173345816))) (and (and (= _$t0@@9 _$t0@@9) (= _$t1@@9 _$t1@@9)) (and (= $t5@@4 (|$addr#$signer| _$t0@@9)) (= $t6@@4  (or (or (or (not (= (|$addr#$signer| _$t0@@9) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185879| $1_Roles_RoleId_$memory) $t5@@4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_185879| $1_Roles_RoleId_$memory) $t5@@4)) 0))) (not (= (|$addr#$signer| _$t0@@9) 173345816)))))))) (and (=> (= (ControlFlow 0 386602) 387193) anon12_Then_correct) (=> (= (ControlFlow 0 386602) 386664) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@11 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_148386_| (|streams#$EventStore| $es) handle@@11)))
 (and (= (|l#Multiset_148386| stream@@15) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_148386| stream@@15) v@@57) 0)
 :qid |DiemConsensusConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConsensusConfigbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 386028) 386602)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 634316) 386028) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9))))))))))))))))
))
(check-sat)
(pop 1)
