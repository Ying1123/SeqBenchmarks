...
(assert (not
 (=> (= (ControlFlow 0 0) 654153) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 400057) (- 0 655217)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemConsensusConfigbpl.11731:15|
 :skolemid |350|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConsensusConfigbpl.11731:15|
 :skolemid |350|
)) (and (=> (= (ControlFlow 0 400057) (- 0 655242)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 400057) (- 0 655279)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 400057) (- 0 655291)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 400057) (- 0 655309)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 400057) (- 0 655323)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 400057) (- 0 655333)) (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 400057) (- 0 655339)) (= (let ((addr 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr))) _$t1)) (=> (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@0))) _$t1) (=> (= (ControlFlow 0 400057) (- 0 655348)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_204530| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_204530| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 399864) (- 0 655098)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 399864) (- 0 655138)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 400071) 399864))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 400123) 400071) anon15_Then_correct) (=> (= (ControlFlow 0 400123) 400057) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 400121) 400123)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_204337 (|Store__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 399908) 400071) anon15_Then_correct) (=> (= (ControlFlow 0 399908) 400057) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1))) (and (=> (= (ControlFlow 0 399886) (- 0 654971)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 399886) 400121) anon14_Then_correct) (=> (= (ControlFlow 0 399886) 399908) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 399736) 399864))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 399720) 399886) anon13_Then_correct) (=> (= (ControlFlow 0 399720) 399736) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 399680) 399720)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_204337| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8)) (= (ControlFlow 0 399686) 399680))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 400215) 399864))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 :qid |DiemConsensusConfigbpl.11509:20|
 :skolemid |332|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) addr@@2)) 1)) (= addr@@2 186537453)))
 ...
 :qid |DiemConsensusConfigbpl.11541:20|
 :skolemid |340|
 ...
 :qid |DiemConsensusConfigbpl.11545:20|
 :skolemid |341|
))) (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_202497| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196301| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196301| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |DiemConsensusConfigbpl.11549:20|
 :skolemid |342|
 ...
 :qid |DiemConsensusConfigbpl.11553:20|
 :skolemid |343|
 ...
 :qid |DiemConsensusConfigbpl.11557:20|
 :skolemid |344|
 ...
 :qid |DiemConsensusConfigbpl.11561:20|
 :skolemid |345|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_150327_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConsensusConfigbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 399050) 399624)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 654153) 399050) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
