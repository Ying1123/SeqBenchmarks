...
(assert (not
 (=> (= (ControlFlow 0 0) 247956) (let ((L3_correct  (and (=> (= (ControlFlow 0 179326) (- 0 248339)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (=> (= (ControlFlow 0 179326) (- 0 248359)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t7@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t7@0))))))))
(let ((anon11_Else_correct  (=> (and (and (not $t9@0) (= $t10 $t10)) (and (= $t7@0 $t10) (= (ControlFlow 0 179254) 179326))) L3_correct)))
(let ((anon9_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 179406) 179326))) L3_correct))))
(let ((anon11_Then_correct  (=> $t9@0 (and (=> (= (ControlFlow 0 179362) (- 0 248285)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 179362) (- 0 248298)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))))))))
(let ((anon5_correct  (=> (and (|$IsValid'u64'| $t5) (= $t5 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= $t5 $t5)) (and (|$IsValid'u64'| 0) (= $t9@0 (= $t5 0)))) (and (and (|$IsValid'u64'| $t10) (= $t10 7)) (and (= $t10 $t10) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 179238) 179362) anon11_Then_correct) (=> (= (ControlFlow 0 179238) 179254) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_106974 (|Store__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 179172) 179238))) anon5_correct)))
(let ((anon10_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_106974 (|Store__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |$temp_0'$1_SlidingNonce_SlidingNonce'@0|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 179376) 179238))) anon5_correct)))
(let ((anon9_Else_correct  (=> (not $t6) (and (=> (= (ControlFlow 0 179158) 179376) anon10_Then_correct) (=> (= (ControlFlow 0 179158) 179172) anon10_Else_correct)))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106105| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106105| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) addr)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_106787| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_106787| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_106787| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_106787| $1_Roles_RoleId_$memory) addr)) 1)))))
 :qid |SlidingNoncebpl.4997:20|
 :skolemid |134|
))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'u64'| _$t1)) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) $a_0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |SlidingNoncebpl.5006:20|
 :skolemid |135|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))))) (and (=> (= (ControlFlow 0 179152) 179406) anon9_Then_correct) (=> (= (ControlFlow 0 179152) 179158) anon9_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_73950_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |SlidingNoncebpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 179009) 179152)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 247956) 179009) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
