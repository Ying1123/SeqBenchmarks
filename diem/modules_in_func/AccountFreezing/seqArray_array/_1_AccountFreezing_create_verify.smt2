...
(assert (not
 (=> (= (ControlFlow 0 0) 668810) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 387179) (- 0 669191)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) addr)))
 :qid |AccountFreezingbpl.16452:15|
 :skolemid |284|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) addr@@0)))
 :qid |AccountFreezingbpl.16452:15|
 :skolemid |284|
)) (and (=> (= (ControlFlow 0 387179) (- 0 669215)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) addr@@1)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |AccountFreezingbpl.5139:13|
 :skolemid |157|
)))))
 :qid |AccountFreezingbpl.16458:15|
 :skolemid |285|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@2) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) addr@@2)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@2)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |AccountFreezingbpl.5139:13|
 :skolemid |157|
)))))
 :qid |AccountFreezingbpl.16458:15|
 :skolemid |285|
)) (and (=> (= (ControlFlow 0 387179) (- 0 669261)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t4))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t4)) (=> (= (ControlFlow 0 387179) (- 0 669271)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) $t4) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@1) $t4))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 387031) (- 0 669163)) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t4)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t4) (=> (= (ControlFlow 0 387031) (- 0 669168)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t4) (= 6 $t10@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 387193) 387031))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 387245) 387193) anon12_Then_correct) (=> (= (ControlFlow 0 387245) 387179) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 387243) 387245)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_199368 (|Store__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0) $t12@0))) (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 387081) 387193) anon12_Then_correct) (=> (= (ControlFlow 0 387081) 387179) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t12@0 ($1_AccountFreezing_FreezingBit false))) (and (=> (= (ControlFlow 0 387059) (- 0 669040)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 387059) 387243) anon11_Then_correct) (=> (= (ControlFlow 0 387059) 387081) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 387003) 387031))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t9) (= $t9 6)) (and (= $t9 $t9) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 386987) 387059) anon10_Then_correct) (=> (= (ControlFlow 0 386987) 387003) anon10_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t6@0)) (= (ControlFlow 0 386951) 386987)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $a_0)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc))
 :qid |AccountFreezingbpl.16337:20|
 :skolemid |283|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $a_0))
))) (and (and (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t4)) (and (= _$t0 _$t0) (|$IsValid'address'| $t5))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= $t5 $t5)) (and (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $t5)) (= (ControlFlow 0 386957) 386951))))) inline$$Not$0$anon0_correct)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 386811) 386957)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 668810) 386811) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
