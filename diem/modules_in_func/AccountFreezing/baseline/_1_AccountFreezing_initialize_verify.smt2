...
(declare-fun $t14@0 () T@$1_AccountFreezing_FreezeEventsHolder)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 667178) (let ((anon24_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 385760) (- 0 668118)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 385760) (- 0 668132)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 385760) (- 0 668149)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 385760) (- 0 668159)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 385760) (- 0 668173)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t3))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t3)) (=> (= (ControlFlow 0 385760) (- 0 668183)) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory@1) $t3)))))))))))))))
(let ((anon22_Then_correct true))
(let ((anon21_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 385482) (- 0 668040)) (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t3))) (=> (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t3)) (=> (= (ControlFlow 0 385482) (- 0 668063)) (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t5@0)) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t5@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t3) (= 6 $t5@0))))))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t5@0 $abort_code@1) (= (ControlFlow 0 385774) 385482))) L3_correct)))
(let ((anon23_Then$1_correct  (=> (= $1_AccountFreezing_FreezeEventsHolder_$memory@1 $1_AccountFreezing_FreezeEventsHolder_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 385826) 385774) anon24_Then_correct) (=> (= (ControlFlow 0 385826) 385760) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 385824) 385826)) anon23_Then$1_correct)))
(let ((anon23_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_AccountFreezing_FreezeEventsHolder_$memory@0 ($Memory_199297 (|Store__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_AccountFreezing_FreezeEventsHolder_$memory@1 $1_AccountFreezing_FreezeEventsHolder_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 385680) 385774) anon24_Then_correct) (=> (= (ControlFlow 0 385680) 385760) anon24_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (not false) (= $t14@0 ($1_AccountFreezing_FreezeEventsHolder |inline$$1_Event_new_event_handle'$1_AccountFreezing_FreezeAccountEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_AccountFreezing_UnfreezeAccountEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 385658) 385824) anon23_Then_correct) (=> (= (ControlFlow 0 385658) 385680) anon23_Else_correct)))))
(let ((|inline$$1_Event_new_event_handle'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_AccountFreezing_UnfreezeAccountEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_AccountFreezing_UnfreezeAccountEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 385636) 385840) anon22_Then_correct) (=> (= (ControlFlow 0 385636) 385658) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not false) (= (ControlFlow 0 385642) 385636)) |inline$$1_Event_new_event_handle'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_AccountFreezing_FreezeAccountEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_AccountFreezing_FreezeAccountEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 385554) 385854) anon21_Then_correct) (=> (= (ControlFlow 0 385554) 385642) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 385560) 385554)) |inline$$1_Event_new_event_handle'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|)))
(let ((anon20_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t11 $t11)) (and (= $t5@0 $t11) (= (ControlFlow 0 385398) 385482))) L3_correct)))
(let ((anon19_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11) (= $t11 6)) (and (= $t11 $t11) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 385382) 385560) anon20_Then_correct) (=> (= (ControlFlow 0 385382) 385398) anon20_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t8@0)) (= (ControlFlow 0 385342) 385382)) anon19_Else$1_correct)))
(let ((anon19_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $t7)) (= (ControlFlow 0 385348) 385342))) inline$$Not$0$anon0_correct))))
(let ((anon19_Then_correct  (=> $t6 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t5)) (= $t5 $t5)) (and (= $t5@0 $t5) (= (ControlFlow 0 385884) 385482))) L3_correct))))
(let ((anon18_Else_correct  (=> (and (not $t4) (= $t6  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 385286) 385884) anon19_Then_correct) (=> (= (ControlFlow 0 385286) 385348) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> $t4 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t5)) (= $t5 $t5)) (and (= $t5@0 $t5) (= (ControlFlow 0 385910) 385482))) L3_correct))))
...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |AccountFreezingbpl.15795:20|
 :skolemid |275|
...
))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@0)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@0))
 :qid |AccountFreezingbpl.15799:20|
 :skolemid |276|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t4  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 385264) 385910) anon18_Then_correct) (=> (= (ControlFlow 0 385264) 385286) anon18_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 384858) 385264)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 667178) 384858) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))
))
(check-sat)
(pop 1)
