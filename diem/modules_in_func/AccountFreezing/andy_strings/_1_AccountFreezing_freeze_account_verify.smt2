...
(assert (not
 (=> (= (ControlFlow 0 0) 649275) (let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 376317) (- 0 651658)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 376317) (- 0 651668)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2))) (and (=> (= (ControlFlow 0 376317) (- 0 651680)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) 1))) (and (=> (= (ControlFlow 0 376317) (- 0 651698)) (not (not (= (|$addr#$signer| _$t0@@5) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@5) 186537453))) (and (=> (= (ControlFlow 0 376317) (- 0 651712)) (not (= _$t1@@1 173345816))) (=> (not (= _$t1@@1 173345816)) (and (=> (= (ControlFlow 0 376317) (- 0 651722)) (not (= _$t1@@1 186537453))) (=> (not (= _$t1@@1 186537453)) (and (=> (= (ControlFlow 0 376317) (- 0 651732)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1))) (and (=> (= (ControlFlow 0 376317) (- 0 651743)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) _$t1@@1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) _$t1@@1)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) _$t1@@1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) _$t1@@1))) (and (=> (= (ControlFlow 0 376317) (- 0 651750)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0)))
(let ((stream_new (let ((len (|l#Multiset_149542| stream@@6)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@6) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@6) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@7 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected) handle@@7)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual) handle@@7))) (forall ((v@@53 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected) handle@@7)) v@@53) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual) handle@@7)) v@@53))
...
(let ((expected@@0 (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_149542| stream@@7)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@7) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@7) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@8 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@0) handle@@8)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@0) handle@@8))) (forall ((v@@54 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@0) handle@@8)) v@@54) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@0) handle@@8)) v@@54))
 :qid |AccountFreezingbpl.139:13|
 :skolemid |3|
)))
 :qid |AccountFreezingbpl.3288:13|
 :skolemid |90|
))))) (=> (= (ControlFlow 0 376317) (- 0 651775)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_149542| stream@@8)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@8) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@8) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11@@1) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t10@@0 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@9 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@1) handle@@9)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@1) handle@@9))) (forall ((v@@55 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@1) handle@@9)) v@@55) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@1) handle@@9)) v@@55))
 :qid |AccountFreezingbpl.139:13|
 :skolemid |3|
)))
 :qid |AccountFreezingbpl.3288:13|
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 375648) (- 0 651471)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453))) (= _$t1@@1 173345816)) (= _$t1@@1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453))) (= _$t1@@1 173345816)) (= _$t1@@1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1))) (=> (= (ControlFlow 0 375648) (- 0 651533)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t9@@2)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@5) 186537453)) (= 2 $t13@0))) (and (= _$t1@@1 173345816) (= 7 $t13@0))) (and (= _$t1@@1 186537453) (= 7 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1)) (= 5 $t13@0))))))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 376331) 375648))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| (|v#$Mutation_180695| $t33@0)) (= $es@0 (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_149542| stream@@9)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@9) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@9) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 376151) 376331) anon36_Then_correct) (=> (= (ControlFlow 0 376151) 376317) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (and (not $abort_flag@1) (= $t33@0 ($Mutation_180695 (|l#$Mutation_235929| $t32@1) (seq.++ (|p#$Mutation_235929| $t32@1) (seq.unit 0)) (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_235929| $t32@1))))) (and (= $t34@0 ($1_AccountFreezing_FreezeAccountEvent $t30 _$t1@@1)) (= (ControlFlow 0 376157) 376151))) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|)))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 376345) 375648))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $t32@1 $t32) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 376397) 376345) anon35_Then_correct) (=> (= (ControlFlow 0 376397) 376157) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 376395) 376397)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t32@0 ($Mutation_235929 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t32@1 $t32@0)) (and (= $abort_flag@1 $abort_flag@0@@4) (= $abort_code@2 $abort_code@1@@4))) (and (=> (= (ControlFlow 0 376052) 376345) anon35_Then_correct) (=> (= (ControlFlow 0 376052) 376157) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (not $abort_flag@0@@4) (=> (and (and (= $t29@0 ($Mutation_45139 (|l#$Mutation_235887| $t28@1) (seq.++ (|p#$Mutation_235887| $t28@1) (seq.unit 0)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_235887| $t28@1)))) (= $t29@1 ($Mutation_45139 (|l#$Mutation_45139| $t29@0) (|p#$Mutation_45139| $t29@0) true))) (and (= $t28@2 ($Mutation_235887 (|l#$Mutation_235887| $t28@1) (|p#$Mutation_235887| $t28@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_45139| $t29@1)))) (= $1_AccountFreezing_FreezingBit_$memory@0@@0 ($Memory_188942 (|Store__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_235887| $t28@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_235887| $t28@2)) (|v#$Mutation_235887| $t28@2)))))) (and (=> (= (ControlFlow 0 376030) (- 0 651103)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 173345816))))) (and (=> (= (ControlFlow 0 376030) (- 0 651117)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) 186537453))))) (and (=> (= (ControlFlow 0 376030) (- 0 651131)) (forall ((addr@@57 Int) ) (!  (=> (|$IsValid'address'| addr@@57) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@57) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@57)))
 :qid |AccountFreezingbpl.17009:15|
 :skolemid |288|
))) (=> (forall ((addr@@58 Int) ) (!  (=> (|$IsValid'address'| addr@@58) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@58) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@58)))
 :qid |AccountFreezingbpl.17009:15|
 :skolemid |288|
)) (and (=> (= (ControlFlow 0 376030) (- 0 651155)) (forall ((addr@@59 Int) ) (!  (=> (|$IsValid'address'| addr@@59) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@59) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@59)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@59)))) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@9)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.17015:15|
 :skolemid |289|
))) (=> (forall ((addr@@60 Int) ) (!  (=> (|$IsValid'address'| addr@@60) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@60) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@60)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@60)))) (exists ((a@@10 Int) ) (!  (and (|$IsValid'address'| a@@10) (and ($1_Signer_is_txn_signer_addr a@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@10)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.17015:15|
 :skolemid |289|
)) (and (=> (= (ControlFlow 0 376030) (- 0 651198)) (forall ((addr@@61 Int) ) (!  (=> (|$IsValid'address'| addr@@61) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@61) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@61)))
 :qid |AccountFreezingbpl.17021:15|
 :skolemid |290|
))) (=> (forall ((addr@@62 Int) ) (!  (=> (|$IsValid'address'| addr@@62) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@62) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@62)))
 :qid |AccountFreezingbpl.17021:15|
 :skolemid |290|
)) (and (=> (= (ControlFlow 0 376030) (- 0 651223)) (forall ((addr@@63 Int) ) (!  (=> (|$IsValid'address'| addr@@63) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@63) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@63)))
 :qid |AccountFreezingbpl.17027:15|
 :skolemid |291|
))) (=> (forall ((addr@@64 Int) ) (!  (=> (|$IsValid'address'| addr@@64) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@64) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@0) addr@@64)))
 :qid |AccountFreezingbpl.17027:15|
 :skolemid |291|
)) (=> (and (and (|$IsValid'address'| $t30) (= $t30 (|$addr#$signer| _$t0@@5))) (and (= $t30 $t30) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 376030) 376395) anon34_Then_correct) (=> (= (ControlFlow 0 376030) 376052) anon34_Else_correct)))))))))))))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t13@0 $abort_code@1@@4) (= (ControlFlow 0 376411) 375648))) L7_correct)))
(let ((anon32_Then$1_correct  (=> (= $t28@1 $t28) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 376463) 376411) anon33_Then_correct) (=> (= (ControlFlow 0 376463) 376030) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1)) (= (ControlFlow 0 376461) 376463)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1) (=> (and (and (= $t28@0 ($Mutation_235887 ($Global _$t1@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1))) (= $t28@1 $t28@0)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 375796) 376411) anon33_Then_correct) (=> (= (ControlFlow 0 375796) 376030) anon33_Else_correct))))))
(let ((anon31_Then_correct  (=> $t24@0@@0 (and (=> (= (ControlFlow 0 375774) 376461) anon32_Then_correct) (=> (= (ControlFlow 0 375774) 375796) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (and (not $t24@0@@0) (= $t26 $t26)) (and (= $t13@0 $t26) (= (ControlFlow 0 375764) 375648))) L7_correct)))
(let ((anon30_Then_correct  (=> $t21@0 (=> (and (= $t24@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 5)) (and (= $t26 $t26) (= $t24@0@@0 $t24@0@@0))) (and (=> (= (ControlFlow 0 375748) 375774) anon31_Then_correct) (=> (= (ControlFlow 0 375748) 375764) anon31_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (and (not $t21@0) (= $t23@@0 $t23@@0)) (and (= $t13@0 $t23@@0) (= (ControlFlow 0 375710) 375648))) L7_correct)))
(let ((anon29_Then_correct  (=> (and (and (and $t17@0@@0 (|$IsValid'address'| 186537453)) (and (= $t21@0  (not (= _$t1@@1 186537453))) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 7)) (and (= $t23@@0 $t23@@0) (= $t21@0 $t21@0)))) (and (=> (= (ControlFlow 0 375694) 375748) anon30_Then_correct) (=> (= (ControlFlow 0 375694) 375710) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not $t17@0@@0) (= $t19 $t19)) (and (= $t13@0 $t19) (= (ControlFlow 0 375444) 375648))) L7_correct)))
(let ((anon28_Else_correct  (=> (and (and (and (not $t15) (|$IsValid'address'| 173345816)) (and (= $t17@0@@0  (not (= _$t1@@1 173345816))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t19) (= $t19 7)) (and (= $t19 $t19) (= $t17@0@@0 $t17@0@@0)))) (and (=> (= (ControlFlow 0 375428) 375694) anon29_Then_correct) (=> (= (ControlFlow 0 375428) 375444) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> $t15 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t14@@0)) (= 5 $t13)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t14@@0)) 1)) (= 3 $t13))) (and (not (= (|$addr#$signer| _$t0@@5) 186537453)) (= 2 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 376535) 375648))) L7_correct))))
(let ((anon27_Else_correct  (=> (not $t12@@0) (=> (and (= $t14@@0 (|$addr#$signer| _$t0@@5)) (= $t15  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t14@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t14@@0)) 1))) (not (= (|$addr#$signer| _$t0@@5) 186537453))))) (and (=> (= (ControlFlow 0 375378) 376535) anon28_Then_correct) (=> (= (ControlFlow 0 375378) 375428) anon28_Else_correct))))))
(let ((anon27_Then_correct  (=> $t12@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 376561) 375648))) L7_correct))))
(let ((anon0$1_correct@@5  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@65 Int) ) (!  (=> (|$IsValid'address'| addr@@65) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@65) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@65)) 0)) (= addr@@65 173345816)))
 :qid |AccountFreezingbpl.16494:20|
 :skolemid |256|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@66 Int) ) (!  (=> (|$IsValid'address'| addr@@66) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@66) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@66)) 1)) (= addr@@66 186537453)))
 :qid |AccountFreezingbpl.16502:20|
 :skolemid |257|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@67 Int) ) (!  (=> (|$IsValid'address'| addr@@67) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@67)) 2))))))
 :qid |AccountFreezingbpl.16510:20|
 :skolemid |258|
)))) (=> (and (and (and (and (forall ((addr@@68 Int) ) (!  (=> (|$IsValid'address'| addr@@68) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@68)) 2))))))
 :qid |AccountFreezingbpl.16514:20|
 :skolemid |259|
)) (forall ((addr@@69 Int) ) (!  (=> (|$IsValid'address'| addr@@69) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@69)) 2))))))
 :qid |AccountFreezingbpl.16518:20|
 :skolemid |260|
))) (and (forall ((addr@@70 Int) ) (!  (=> (|$IsValid'address'| addr@@70) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@70)) 2))))))
 :qid |AccountFreezingbpl.16522:20|
 :skolemid |261|
)) (forall ((addr@@71 Int) ) (!  (=> (|$IsValid'address'| addr@@71) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@71)) 2)))))
 :qid |AccountFreezingbpl.16526:20|
 :skolemid |262|
)))) (and (and (forall ((addr@@72 Int) ) (!  (=> (|$IsValid'address'| addr@@72) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@72)) 2)))))
 :qid |AccountFreezingbpl.16530:20|
 :skolemid |263|
)) (forall ((addr@@73 Int) ) (!  (=> (|$IsValid'address'| addr@@73) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@73)) 2)))))
 :qid |AccountFreezingbpl.16534:20|
 :skolemid |264|
))) (and (forall ((addr@@74 Int) ) (!  (=> (|$IsValid'address'| addr@@74) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@74) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@74) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@74)) 4))))
 :qid |AccountFreezingbpl.16538:20|
 :skolemid |265|
)) (forall ((addr@@75 Int) ) (!  (=> (|$IsValid'address'| addr@@75) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@75) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@75) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@75)) 3))))
 :qid |AccountFreezingbpl.16542:20|
 :skolemid |266|
))))) (and (and (and (forall ((addr@@76 Int) ) (!  (=> (|$IsValid'address'| addr@@76) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@76) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@76) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@76)) 3))))
 :qid |AccountFreezingbpl.16546:20|
 :skolemid |267|
)) (forall ((addr@@77 Int) ) (!  (=> (|$IsValid'address'| addr@@77) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@77) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@77)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@77) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@77)) 3))))
 :qid |AccountFreezingbpl.16550:20|
 :skolemid |268|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187827| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187986| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (let (($range_0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@78 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@78))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@79 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@79)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@79 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@79)))) i1)))) 3))))
 :qid |AccountFreezingbpl.16570:151|
 :skolemid |269|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188057| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))))) (=> (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188141| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188225| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188296| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188380| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188464| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188535| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188632| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193056| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |AccountFreezingbpl.16607:20|
 :skolemid |270|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188716| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188800| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189114| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189185| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))))) (and (and (and (and (forall ((addr@@80 Int) ) (!  (=> (|$IsValid'address'| addr@@80) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@80) (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@80)))
 :qid |AccountFreezingbpl.16643:20|
 :skolemid |271|
)) (forall ((addr@@81 Int) ) (!  (=> (|$IsValid'address'| addr@@81) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223943| $1_VASPDomain_VASPDomainManager_$memory) addr@@81)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@81) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@81)) 1))))
 :qid |AccountFreezingbpl.16647:20|
 :skolemid |272|
))) (and (forall ((addr@@82 Int) ) (!  (=> (|$IsValid'address'| addr@@82) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223879| $1_VASPDomain_VASPDomains_$memory) addr@@82)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@82) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@82)) 5))))
 :qid |AccountFreezingbpl.16651:20|
 :skolemid |273|
)) (forall ((addr@@83 Int) ) (!  (=> (|$IsValid'address'| addr@@83) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_193171| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@83) (|Select__T@[Int]Bool_| (|domain#$Memory_193231| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@83)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@83)) 2)))))
 :qid |AccountFreezingbpl.16655:20|
 :skolemid |274|
)))) (and (and (forall ((addr@@84 Int) ) (!  (=> (|$IsValid'address'| addr@@84) (= (|Select__T@[Int]Bool_| (|domain#$Memory_232070| $1_DesignatedDealer_Dealer_$memory) addr@@84)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@84) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@84)) 2))))
 :qid |AccountFreezingbpl.16659:20|
 :skolemid |275|
)) (forall ((addr@@85 Int) ) (!  (=> (|$IsValid'address'| addr@@85) (= (|Select__T@[Int]Bool_| (|domain#$Memory_193056| $1_DualAttestation_Credential_$memory) addr@@85)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@85) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@85)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@85) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@85)) 5)))))
 :qid |AccountFreezingbpl.16663:20|
 :skolemid |276|
))) (and (forall ((addr@@86 Int) ) (!  (=> (|$IsValid'address'| addr@@86) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@86) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@86)))
 :qid |AccountFreezingbpl.16667:20|
 :skolemid |277|
)) (forall ((addr@@87 Int) ) (!  (=> (|$IsValid'address'| addr@@87) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@87) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@87)))
 :qid |AccountFreezingbpl.16671:20|
 :skolemid |278|
))))) (and (and (and (forall ((addr@@88 Int) ) (!  (=> (|$IsValid'address'| addr@@88) (= (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) addr@@88)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@88) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@88)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@88) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@88)) 1)))))
 :qid |AccountFreezingbpl.16675:20|
 :skolemid |279|
)) (forall ((addr@@89 Int) ) (!  (=> (|$IsValid'address'| addr@@89) (= (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@89)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@89) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@89)) 3))))
 :qid |AccountFreezingbpl.16679:20|
 :skolemid |280|
))) (and (forall ((addr@@90 Int) ) (!  (=> (|$IsValid'address'| addr@@90) (= (|Select__T@[Int]Bool_| (|domain#$Memory_192719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@90)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@90) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@90)) 4))))
 :qid |AccountFreezingbpl.16683:20|
 :skolemid |281|
)) (forall ((addr@@91 Int) ) (!  (=> (|$IsValid'address'| addr@@91) (= (|Select__T@[Int]Bool_| (|domain#$Memory_225364| $1_VASP_ParentVASP_$memory) addr@@91)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@91) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@91)) 5))))
 :qid |AccountFreezingbpl.16687:20|
 :skolemid |282|
)))) (and (and (forall ((addr@@92 Int) ) (!  (=> (|$IsValid'address'| addr@@92) (= (|Select__T@[Int]Bool_| (|domain#$Memory_225300| $1_VASP_ChildVASP_$memory) addr@@92)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@92) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@92)) 6))))
 :qid |AccountFreezingbpl.16691:20|
 :skolemid |283|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189256| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189340| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187421| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@5)) ($1_Signer_is_txn_signer _$t0@@5)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@5))) (|$IsValid'address'| _$t1@@1)) (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@6)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@6))
 :qid |AccountFreezingbpl.16712:20|
 :skolemid |284|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@6))
)) (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $a_0@@7)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@7))
 :qid |AccountFreezingbpl.16716:20|
 :skolemid |285|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $a_0@@7))
)))) (and (and (and (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@8)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@8))
 :qid |AccountFreezingbpl.16720:20|
 :skolemid |286|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@8))
)) (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@9)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@9))
 :qid |AccountFreezingbpl.16724:20|
 :skolemid |287|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@9))
))) (and (= $t9@@2 (|$addr#$signer| _$t0@@5)) (= $t10@@0 (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (= $t11@@1 ($1_AccountFreezing_FreezeAccountEvent (|$addr#$signer| _$t0@@5) _$t1@@1)) (= _$t0@@5 _$t0@@5)) (and (= _$t1@@1 _$t1@@1) (= $t12@@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 375320) 376561) anon27_Then_correct) (=> (= (ControlFlow 0 375320) 375378) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_149542| stream@@10) 0) (forall ((v@@56 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@10) v@@56) 0)
 :qid |AccountFreezingbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountFreezingbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 374128) 375320)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (seq.len (|p#$Mutation_235887| $t28)) 0) (=> (and (and (= (seq.len (|p#$Mutation_45139| $t29)) 0) (= (seq.len (|p#$Mutation_235929| $t32)) 0)) (and (= (seq.len (|p#$Mutation_180695| $t33)) 0) (= (ControlFlow 0 374138) 374128))) inline$$InitEventStore$0$anon0_correct@@5))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 649275) 374138) anon0_correct@@5)))
