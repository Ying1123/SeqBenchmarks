...
(declare-datatypes ((T@$Mutation_7873 0)) ((($Mutation_7873 (|l#$Mutation_7873| T@$Location) (|p#$Mutation_7873| T@Vec_2977) (|v#$Mutation_7873| T@Vec_2977) ) ) ))
...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |CoreAddressesbpl.190:23|
 :skolemid |6|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |CoreAddressesbpl.194:24|
 :skolemid |7|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |CoreAddressesbpl.198:25|
 :skolemid |8|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |CoreAddressesbpl.202:24|
 :skolemid |9|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |CoreAddressesbpl.206:28|
 :skolemid |10|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |CoreAddressesbpl.216:19|
 :skolemid |11|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |CoreAddressesbpl.482:15|
 :skolemid |15|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |CoreAddressesbpl.491:15|
 :skolemid |16|
...
(assert (forall ((v1 T@Vec_2977) (v2 T@Vec_2977) ) (! (= (|$IsEqual'vec'u8''| v1 v2)  (and (= (|l#Vec_2977| v1) (|l#Vec_2977| v2)) (forall ((i@@0 Int) ) (!  (=> (InRangeVec_2977 v1 i@@0) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v1) i@@0) (|Select__T@[Int]Int_| (|v#Vec_2977| v2) i@@0)))
 :qid |CoreAddressesbpl.615:13|
 :skolemid |17|
))))
 :qid |CoreAddressesbpl.613:28|
 :skolemid |18|
...
(assert (forall ((v@@4 T@Vec_2977) ) (! (= (|$IsValid'vec'u8''| v@@4)  (and (|$IsValid'u64'| (|l#Vec_2977| v@@4)) (forall ((i@@1 Int) ) (!  (=> (InRangeVec_2977 v@@4 i@@1) (|$IsValid'u8'| (|Select__T@[Int]Int_| (|v#Vec_2977| v@@4) i@@1)))
 :qid |CoreAddressesbpl.621:13|
 :skolemid |19|
))))
 :qid |CoreAddressesbpl.619:28|
 :skolemid |20|
...
(ite  (not (exists ((i@@3 Int) ) (!  (and (and (|$IsValid'u64'| i@@3) (InRangeVec_2977 v@@5 i@@3)) (= (|Select__T@[Int]Int_| (|v#Vec_2977| v@@5) i@@3) e))
 ...
 :qid |CoreAddressesbpl.634:17|
 :skolemid |22|
)))))
 :qid |CoreAddressesbpl.630:15|
 :skolemid |23|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12516) (let ((anon4_Else_correct  (=> (and (not $t5@0) (= $t7 $t7)) (and (=> (= (ControlFlow 0 11236) (- 0 12666)) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (not (= (|$addr#$signer| _$t0) 173345816)) (=> (= (ControlFlow 0 11236) (- 0 12675)) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))))))))
(let ((anon4_Then_correct  (=> (and $t5@0 (= (ControlFlow 0 11256) (- 0 12639))) (not (not (= (|$addr#$signer| _$t0) 173345816))))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t3))) (and (and (and (= $t3 (|$addr#$signer| _$t0)) (|$IsValid'address'| 173345816)) (and (= $t5@0 (= $t3 173345816)) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t7) (= $t7 2)) (and (= $t7 $t7) (= $t5@0 $t5@0))))) (and (=> (= (ControlFlow 0 11188) 11256) anon4_Then_correct) (=> (= (ControlFlow 0 11188) 11236) anon4_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 12516) 11188) anon0$1_correct)))
anon0_correct)))))
))
(check-sat)
(pop 1)
