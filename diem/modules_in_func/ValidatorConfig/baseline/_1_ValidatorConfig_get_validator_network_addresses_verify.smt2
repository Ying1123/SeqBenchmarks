...
(declare-fun _$t0 () T@$1_ValidatorConfig_Config)
(declare-fun $t1@0 () T@Vec_15835)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 104822) (let ((anon0$1_correct  (=> (|$IsValid'$1_ValidatorConfig_Config'| _$t0) (=> (and (and (= _$t0 _$t0) (= $t1@0 (|$validator_network_addresses#$1_ValidatorConfig_Config| _$t0))) (and (= $t1@0 $t1@0) (= (ControlFlow 0 89002) (- 0 104885)))) (not false)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88958) 89002)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 104822) 88958) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
