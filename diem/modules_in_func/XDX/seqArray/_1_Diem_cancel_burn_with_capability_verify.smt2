...
(push 1)
(set-info :boogie-vc-id $1_Diem_cancel_burn_with_capability$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 471112) (let ((L5_correct@@0  (=> (and (= $t20@0@@2 $t20@0@@2) (= $t36 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816))) (and (=> (= (ControlFlow 0 333497) (- 0 473239)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2@@3))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2@@3)) (and (=> (= (ControlFlow 0 333497) (- 0 473251)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 333497) (- 0 473261)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3))) (and (=> (= (ControlFlow 0 333497) (- 0 473272)) (not (let (($range_0 ($Range 0 (seq.len $t9@@0))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@48 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9@@0 i@@48)))) _$t2@@3))))
 :qid |XDXbpl.10237:57|
 :skolemid |259|
))))) (=> (not (let (($range_0@@0 ($Range 0 (seq.len $t9@@0))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@49 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9@@0 i@@49)))) _$t2@@3))))
 :qid |XDXbpl.10237:57|
 :skolemid |259|
)))) (and (=> (= (ControlFlow 0 333497) (- 0 473319)) (= $t36 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10@@3) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10@@3) _$t2@@3) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10@@3)))) (=> (= $t36 (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10@@3) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10@@3) _$t2@@3) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10@@3) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10@@3))) (and (=> (= (ControlFlow 0 333497) (- 0 473337)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0@@3))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0@@3)) (and (=> (= (ControlFlow 0 333497) (- 0 473350)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816) (and (=> (= (ControlFlow 0 333497) (- 0 473358)) (= (|$value#$1_Diem_Diem'#0'| $t20@0@@2) _$t2@@3)) (=> (= (|$value#$1_Diem_Diem'#0'| $t20@0@@2) _$t2@@3) (and (=> (= (ControlFlow 0 333497) (- 0 473367)) (> (|$value#$1_Diem_Diem'#0'| $t20@0@@2) 0)) (=> (> (|$value#$1_Diem_Diem'#0'| $t20@0@@2) 0) (and (=> (= (ControlFlow 0 333497) (- 0 473377)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 333497) (- 0 473397)) (forall ((addr@@60 Int) ) (!  (=> (|$IsValid'address'| addr@@60) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@60)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@60))))
 :qid |XDXbpl.10273:15|
 :skolemid |260|
))) (=> (forall ((addr@@61 Int) ) (!  (=> (|$IsValid'address'| addr@@61) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@61)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@61))))
 :qid |XDXbpl.10273:15|
 :skolemid |260|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473426)) (forall ((addr@@62 Int) ) (!  (=> (|$IsValid'address'| addr@@62) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@62) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@62)))
 :qid |XDXbpl.10278:15|
 :skolemid |261|
))) (=> (forall ((addr@@63 Int) ) (!  (=> (|$IsValid'address'| addr@@63) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@63) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@63)))
 :qid |XDXbpl.10278:15|
 :skolemid |261|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473451)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 333497) (- 0 473471)) (forall ((addr@@64 Int) ) (!  (=> (|$IsValid'address'| addr@@64) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@64)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@64))))
 :qid |XDXbpl.10288:15|
 :skolemid |262|
))) (=> (forall ((addr@@65 Int) ) (!  (=> (|$IsValid'address'| addr@@65) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@65)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@65))))
 :qid |XDXbpl.10288:15|
 :skolemid |262|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473500)) (forall ((addr@@66 Int) ) (!  (=> (|$IsValid'address'| addr@@66) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@66) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@66)))
 :qid |XDXbpl.10293:15|
 :skolemid |263|
))) (=> (forall ((addr@@67 Int) ) (!  (=> (|$IsValid'address'| addr@@67) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@67) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@67)))
 :qid |XDXbpl.10293:15|
 :skolemid |263|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473525)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@2@@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 333497) (- 0 473545)) (forall ((addr@@68 Int) ) (!  (=> (|$IsValid'address'| addr@@68) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@68) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@68))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@68))))
 :qid |XDXbpl.10303:15|
 :skolemid |264|
))) (=> (forall ((addr@@69 Int) ) (!  (=> (|$IsValid'address'| addr@@69) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@69) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@69))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@69))))
 :qid |XDXbpl.10303:15|
 :skolemid |264|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473580)) (forall ((addr@@70 Int) ) (!  (=> (|$IsValid'address'| addr@@70) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@70) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@70)))
 :qid |XDXbpl.10308:15|
 :skolemid |265|
))) (=> (forall ((addr@@71 Int) ) (!  (=> (|$IsValid'address'| addr@@71) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@71) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@71)))
 :qid |XDXbpl.10308:15|
 :skolemid |265|
)) (and (=> (= (ControlFlow 0 333497) (- 0 473604)) (let ((actual@@8 ($EventStore (- (|counter#$EventStore| $es@1@@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1@@2) (|streams#$EventStore| $es)))))
(let ((expected@@8 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2)))
(let ((stream_new@@11 (let ((len@@11 (|l#Multiset_131870| stream@@16)))
(let ((cnt@@11 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@16) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@16) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)) (+ cnt@@11 1)) (+ len@@11 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2 stream_new@@11)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@8) (|counter#$EventStore| actual@@8)) (forall ((handle@@14 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@8) handle@@14)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@8) handle@@14))) (forall ((v@@54 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@8) handle@@14)) v@@54) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@8) handle@@14)) v@@54))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
 :skolemid |80|
)))))) (=> (let ((actual@@9 ($EventStore (- (|counter#$EventStore| $es@1@@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1@@2) (|streams#$EventStore| $es)))))
(let ((expected@@9 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@17 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2)))
(let ((stream_new@@12 (let ((len@@12 (|l#Multiset_131870| stream@@17)))
(let ((cnt@@12 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@17) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@17) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)) (+ cnt@@12 1)) (+ len@@12 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2 stream_new@@12)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@9) (|counter#$EventStore| actual@@9)) (forall ((handle@@15 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@9) handle@@15)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@9) handle@@15))) (forall ((v@@55 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@9) handle@@15)) v@@55) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@9) handle@@15)) v@@55))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
 :skolemid |80|
))))) (=> (= (ControlFlow 0 333497) (- 0 473639)) (let ((actual@@10 ($EventStore (- (|counter#$EventStore| $es@1@@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1@@2) (|streams#$EventStore| $es)))))
(let ((expected@@10 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11@@0)) (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2)))
(let ((stream_new@@13 (let ((len@@13 (|l#Multiset_131870| stream@@18)))
(let ((cnt@@13 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@18) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@18) (|$ToEventRep'$1_Diem_CancelBurnEvent'| ($1_Diem_CancelBurnEvent _$t2@@3 $t12@@3 _$t0@@3)) (+ cnt@@13 1)) (+ len@@13 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t13@@2 stream_new@@13)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@10) (|counter#$EventStore| expected@@10)) (forall ((handle@@16 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@10) handle@@16)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@10) handle@@16))) (forall ((v@@56 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@10) handle@@16)) v@@56) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@10) handle@@16)) v@@56))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
...
(let ((anon33_Else_correct  (=> (not $abort_flag@1@@2) (and (=> (= (ControlFlow 0 333840) (- 0 472967)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@0| ($Memory_176283 (|Store__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t24@2)) (|v#$Mutation_183598| $t24@2)))) (and (=> (= (ControlFlow 0 333840) (- 0 473015)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)))) (forall ((mint_cap_owner1@@20 Int) (mint_cap_owner2@@20 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@20) (=> (|$IsValid'address'| mint_cap_owner2@@20) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@20)) (= mint_cap_owner1@@20 mint_cap_owner2@@20))))
 :qid |XDXbpl.10097:83|
 :skolemid |251|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)))) (forall ((mint_cap_owner1@@21 Int) (mint_cap_owner2@@21 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@21) (=> (|$IsValid'address'| mint_cap_owner2@@21) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@21) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@21)) (= mint_cap_owner1@@21 mint_cap_owner2@@21))))
 :qid |XDXbpl.10097:83|
 :skolemid |251|
))) (and (=> (= (ControlFlow 0 333840) (- 0 473060)) (forall ((addr3@@20 Int) ) (!  (=> (|$IsValid'address'| addr3@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@20) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816))))))
 :qid |XDXbpl.10103:15|
 :skolemid |252|
))) (=> (forall ((addr3@@21 Int) ) (!  (=> (|$IsValid'address'| addr3@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@21) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816))))))
 :qid |XDXbpl.10103:15|
 :skolemid |252|
)) (and (=> (= (ControlFlow 0 333840) (- 0 473083)) (forall ((addr@@72 Int) ) (!  (=> (|$IsValid'address'| addr@@72) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@72) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)))
 :qid |XDXbpl.10109:15|
 :skolemid |253|
))) (=> (forall ((addr@@73 Int) ) (!  (=> (|$IsValid'address'| addr@@73) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@73) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)))
 :qid |XDXbpl.10109:15|
 :skolemid |253|
)) (and (=> (= (ControlFlow 0 333840) (- 0 473106)) (forall ((dr_addr@@17 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) dr_addr@@17)))
 :qid |XDXbpl.10115:15|
 :skolemid |254|
))) (=> (forall ((dr_addr@@18 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) dr_addr@@18)))
 :qid |XDXbpl.10115:15|
 :skolemid |254|
)) (and (=> (= (ControlFlow 0 333840) (- 0 473130)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@53 Int) ) (!  (and (|$IsValid'address'| a@@53) (and ($1_Signer_is_txn_signer_addr a@@53) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@53) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@53)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@54 Int) ) (!  (and (|$IsValid'address'| a@@54) (and ($1_Signer_is_txn_signer_addr a@@54) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@54) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@54)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 333840) (- 0 473154)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@55 Int) ) (!  (and (|$IsValid'address'| a@@55) (and ($1_Signer_is_txn_signer_addr a@@55) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@55)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@56 Int) ) (!  (and (|$IsValid'address'| a@@56) (and ($1_Signer_is_txn_signer_addr a@@56) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@56)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 333840) (- 0 473178)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (exists ((a@@57 Int) ) (!  (and (|$IsValid'address'| a@@57) (and ($1_Signer_is_txn_signer_addr a@@57) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@57)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) 173345816)) (exists ((a@@58 Int) ) (!  (and (|$IsValid'address'| a@@58) (and ($1_Signer_is_txn_signer_addr a@@58) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@58)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (=> (= $es@1@@2 $es@0@@2) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@0| |$1_Diem_CurrencyInfo'#0'_$memory@1@@0|) (= (ControlFlow 0 333840) 333497)) L5_correct@@0))))))))))))))))))))))
(let ((anon32_Else_correct  (=> (not inline$$Not$0$dst@1@@2) (and (=> (= (ControlFlow 0 333014) (- 0 472488)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@0| ($Memory_176283 (|Store__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t24@2)) (|v#$Mutation_183598| $t24@2)))) (and (=> (= (ControlFlow 0 333014) (- 0 472536)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)))) (forall ((mint_cap_owner1@@22 Int) (mint_cap_owner2@@22 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@22) (=> (|$IsValid'address'| mint_cap_owner2@@22) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@22)) (= mint_cap_owner1@@22 mint_cap_owner2@@22))))
 :qid |XDXbpl.10163:83|
 :skolemid |255|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)))) (forall ((mint_cap_owner1@@23 Int) (mint_cap_owner2@@23 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@23) (=> (|$IsValid'address'| mint_cap_owner2@@23) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@23)) (= mint_cap_owner1@@23 mint_cap_owner2@@23))))
 :qid |XDXbpl.10163:83|
 :skolemid |255|
))) (and (=> (= (ControlFlow 0 333014) (- 0 472581)) (forall ((addr3@@22 Int) ) (!  (=> (|$IsValid'address'| addr3@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816))))))
 :qid |XDXbpl.10169:15|
 :skolemid |256|
))) (=> (forall ((addr3@@23 Int) ) (!  (=> (|$IsValid'address'| addr3@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816))))))
 :qid |XDXbpl.10169:15|
 :skolemid |256|
)) (and (=> (= (ControlFlow 0 333014) (- 0 472604)) (forall ((addr@@74 Int) ) (!  (=> (|$IsValid'address'| addr@@74) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@74) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)))
 :qid |XDXbpl.10175:15|
 :skolemid |257|
))) (=> (forall ((addr@@75 Int) ) (!  (=> (|$IsValid'address'| addr@@75) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@75) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)))
 :qid |XDXbpl.10175:15|
 :skolemid |257|
)) (and (=> (= (ControlFlow 0 333014) (- 0 472627)) (forall ((dr_addr@@19 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) dr_addr@@19)))
 :qid |XDXbpl.10181:15|
 :skolemid |258|
))) (=> (forall ((dr_addr@@20 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) dr_addr@@20)))
 :qid |XDXbpl.10181:15|
 :skolemid |258|
)) (and (=> (= (ControlFlow 0 333014) (- 0 472651)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@59 Int) ) (!  (and (|$IsValid'address'| a@@59) (and ($1_Signer_is_txn_signer_addr a@@59) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@59)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@60 Int) ) (!  (and (|$IsValid'address'| a@@60) (and ($1_Signer_is_txn_signer_addr a@@60) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@60) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@60)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 333014) (- 0 472675)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@61 Int) ) (!  (and (|$IsValid'address'| a@@61) (and ($1_Signer_is_txn_signer_addr a@@61) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@61) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@61)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@62 Int) ) (!  (and (|$IsValid'address'| a@@62) (and ($1_Signer_is_txn_signer_addr a@@62) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@62) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@62)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 333014) (- 0 472699)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (exists ((a@@63 Int) ) (!  (and (|$IsValid'address'| a@@63) (and ($1_Signer_is_txn_signer_addr a@@63) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@63) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@63)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) 173345816)) (exists ((a@@64 Int) ) (!  (and (|$IsValid'address'| a@@64) (and ($1_Signer_is_txn_signer_addr a@@64) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@64) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@64)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (=> (= $es@1@@2 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2@@0| |$1_Diem_CurrencyInfo'#0'_$memory@0@@0|) (= (ControlFlow 0 333014) 333497)) L5_correct@@0))))))))))))))))))))))
(let ((L7_correct  (and (=> (= (ControlFlow 0 332541) (- 0 472796)) (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2@@3) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3))) (let (($range_0@@1 ($Range 0 (seq.len $t9@@0))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@50 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9@@0 i@@50)))) _$t2@@3))))
 :qid |XDXbpl.10331:251|
 :skolemid |266|
))))) (=> (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2@@3) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3))) (let (($range_0@@2 ($Range 0 (seq.len $t9@@0))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@51 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9@@0 i@@51)))) _$t2@@3))))
 :qid |XDXbpl.10331:251|
 :skolemid |266|
)))) (=> (= (ControlFlow 0 332541) (- 0 472862)) (or (or (or (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2@@3) (= 8 $t17@0@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3)) (= 5 $t17@0@@0))) (and (let (($range_0@@3 ($Range 0 (seq.len $t9@@0))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@52 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t9@@0 i@@52)))) _$t2@@3))))
 :qid |XDXbpl.10336:336|
 :skolemid |267|
))) (= 1 $t17@0@@0))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@1@@2 (= $abort_code@2@@2 $abort_code@2@@2)) (and (= $t17@0@@0 $abort_code@2@@2) (= (ControlFlow 0 333854) 332541))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| (|v#$Mutation_158725| $t34@0@@2)) (= $es@0@@2 (let ((stream@@19 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1|)))
(let ((stream_new@@14 (let ((len@@14 (|l#Multiset_131870| stream@@19)))
(let ((cnt@@14 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@19) (|$ToEventRep'$1_Diem_CancelBurnEvent'| $t35@0))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@19) (|$ToEventRep'$1_Diem_CancelBurnEvent'| $t35@0) (+ cnt@@14 1)) (+ len@@14 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| stream_new@@14)))))) (and (=> (= (ControlFlow 0 333594) 333854) anon33_Then_correct) (=> (= (ControlFlow 0 333594) 333840) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and inline$$Not$0$dst@1@@2 (= $t34@0@@2 ($Mutation_158725 (|l#$Mutation_183598| $t24@2) (seq.++ (|p#$Mutation_183598| $t24@2) (seq.unit 11)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))))) (and (= $t35@0 ($1_Diem_CancelBurnEvent _$t2@@3 $t21 _$t0@@3)) (= (ControlFlow 0 333600) 333594))) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct@@2  (=> (= inline$$Not$0$dst@1@@2  (not $t32@0)) (and (=> (= (ControlFlow 0 332766) 333600) anon32_Then_correct) (=> (= (ControlFlow 0 332766) 333014) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not $abort_flag@1@@2) (= $t31@0 ($Mutation_14548 (|l#$Mutation_183598| $t24@1@@0) (seq.++ (|p#$Mutation_183598| $t24@1@@0) (seq.unit 1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0))))) (=> (and (and (= $t31@1 ($Mutation_14548 (|l#$Mutation_14548| $t31@0) (|p#$Mutation_14548| $t31@0) inline$$Sub$0$dst@2@@2)) (= $t24@2 ($Mutation_183598 (|l#$Mutation_183598| $t24@1@@0) (|p#$Mutation_183598| $t24@1@@0) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|v#$Mutation_14548| $t31@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@2))) (= (ControlFlow 0 332772) 332766))) inline$$Not$0$anon0_correct@@2))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@1@@2 (= $abort_code@2@@2 $abort_code@2@@2)) (and (= $t17@0@@0 $abort_code@2@@2) (= (ControlFlow 0 333868) 332541))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct@@2  (=> (= $abort_flag@1@@2 true) (=> (and (= $abort_code@2@@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2@@2 inline$$Sub$0$dst@0@@2)) (and (=> (= (ControlFlow 0 332682) 333868) anon31_Then_correct) (=> (= (ControlFlow 0 332682) 332772) anon31_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct@@2  (=> (and (< $t29@0@@2 _$t2@@3) (= (ControlFlow 0 332680) 332682)) inline$$Sub$0$anon3_Then$1_correct@@2)))
(let ((inline$$Sub$0$anon3_Else_correct@@2  (=> (<= _$t2@@3 $t29@0@@2) (=> (and (and (= inline$$Sub$0$dst@1@@2 (- $t29@0@@2 _$t2@@3)) (= $abort_flag@1@@2 $abort_flag@0@@3)) (and (= $abort_code@2@@2 $abort_code@1@@3) (= inline$$Sub$0$dst@2@@2 inline$$Sub$0$dst@1@@2))) (and (=> (= (ControlFlow 0 332632) 333868) anon31_Then_correct) (=> (= (ControlFlow 0 332632) 332772) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> (and inline$$Ge$0$dst@1@@2 (= $t29@0@@2 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)))) (and (=> (= (ControlFlow 0 332688) 332680) inline$$Sub$0$anon3_Then_correct@@2) (=> (= (ControlFlow 0 332688) 332632) inline$$Sub$0$anon3_Else_correct@@2)))))
(let ((anon30_Else_correct  (=> (not inline$$Ge$0$dst@1@@2) (and (=> (= (ControlFlow 0 332359) (- 0 472256)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0)) 10000000000)) (=> (= $t28@@2 $t28@@2) (=> (and (= $t17@0@@0 $t28@@2) (= (ControlFlow 0 332359) 332541)) L7_correct)))))))
(let ((anon29_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t28@@2) (= $t28@@2 8)) (and (= $t28@@2 $t28@@2) (= inline$$Ge$0$dst@1@@2 inline$$Ge$0$dst@1@@2))) (and (=> (= (ControlFlow 0 332317) 332688) anon30_Then_correct) (=> (= (ControlFlow 0 332317) 332359) anon30_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct@@2  (=> (and (= inline$$Ge$0$dst@1@@2 (>= $t25@0 _$t2@@3)) (= (ControlFlow 0 332281) 332317)) anon29_Else$1_correct)))
(let ((anon29_Else_correct  (=> (not $abort_flag@0@@3) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@0| (|v#$Mutation_183598| $t24@1@@0)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@0|)) (and (= $t25@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t24@1@@0))) (= (ControlFlow 0 332287) 332281))) inline$$Ge$0$anon0_correct@@2))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t17@0@@0 $abort_code@1@@3) (= (ControlFlow 0 333882) 332541))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t24@1@@0 $t24@@0) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 333934) 333882) anon29_Then_correct) (=> (= (ControlFlow 0 333934) 332287) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 333932) 333934)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t24@0@@0 ($Mutation_183598 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t24@1@@0 $t24@0@@0)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 332215) 333882) anon29_Then_correct) (=> (= (ControlFlow 0 332215) 332287) anon29_Else_correct))))))
(let ((anon27_Else_correct  (=> (not $t22) (=> (and (and (|$IsValid'vec'u8''| $t21) (= $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t21 $t21) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 332193) (- 0 472076)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 332193) 333932) anon28_Then_correct) (=> (= (ControlFlow 0 332193) 332215) anon28_Else_correct))))))))
(let ((anon27_Then_correct  (=> $t22 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@@2)) (= $t17@@2 $t17@@2)) (and (= $t17@0@@0 $t17@@2) (= (ControlFlow 0 333960) 332541))) L7_correct))))
(let ((anon5_correct  (=> (and (and (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| $t15@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0@@3))) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15@@2))) _$t2@@3) (= $t18@0@@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15@@2)))) (and (and (= $t19@0 (|$metadata#$1_Diem_PreburnWithMetadata'#0'| $t15@@2)) (= $t20@0@@2 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0@@0))) (and (= $t20@0@@2 $t20@0@@2) (= $t22  (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 332155) 333960) anon27_Then_correct) (=> (= (ControlFlow 0 332155) 332193) anon27_Else_correct)))))
(let ((anon26_Else_correct@@0  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_182795 (|Store__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3 false) (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 332093) 332155))) anon5_correct)))
(let ((anon26_Then_correct@@0  (=> (and (and |$temp_0'bool'@0| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_182795 (|Store__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3 |$temp_0'$1_Diem_PreburnQueue'#0''@0|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 333972) 332155))) anon5_correct)))
(let ((anon25_Else_correct@@0  (=> (not $t16@@2) (and (=> (= (ControlFlow 0 332081) 333972) anon26_Then_correct@@0) (=> (= (ControlFlow 0 332081) 332093) anon26_Else_correct@@0)))))
(let ((anon25_Then_correct@@0  (=> $t16@@2 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3)) (= 5 $t17@@2)) (and (let (($range_0@@4 ($Range 0 (seq.len $t14@@3))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@53 $i_1@@4))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t14@@3 i@@53)))) _$t2@@3))))
 :qid |XDXbpl.9853:151|
 :skolemid |250|
))) (= 1 $t17@@2))) (= $t17@@2 $t17@@2)) (and (= $t17@0@@0 $t17@@2) (= (ControlFlow 0 334053) 332541))) L7_correct))))
(let ((anon0$1_correct@@3  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@24 Int) (mint_cap_owner2@@24 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@24) (=> (|$IsValid'address'| mint_cap_owner2@@24) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@24) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@24)) (= mint_cap_owner1@@24 mint_cap_owner2@@24))))
 :qid |XDXbpl.9733:88|
 :skolemid |240|
))) (=> (and (forall ((addr3@@24 Int) ) (!  (=> (|$IsValid'address'| addr3@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.9737:20|
 :skolemid |241|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1)) 2))))
 :qid |XDXbpl.9741:20|
 :skolemid |242|
))) (=> (and (and (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr)))))
 :qid |XDXbpl.9745:20|
 :skolemid |243|
)) (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))))
 :qid |XDXbpl.9749:20|
 :skolemid |244|
))) (and (forall ((addr@@76 Int) ) (!  (=> (|$IsValid'address'| addr@@76) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@76) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.9753:20|
 :skolemid |245|
)) (|$IsValid'address'| _$t0@@3))) (=> (and (and (and (and (|$IsValid'$1_Diem_BurnCapability'#0''| _$t1@@3) (|$IsValid'u64'| _$t2@@3)) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@3)))
 ...
 :qid |XDXbpl.9766:20|
 :skolemid |246|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@4)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@4) (and (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@4)) 256) (let (($range_1 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@4)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@54 $i_2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@4) i@@54)))) 0)))
 :qid |XDXbpl.9771:199|
 :skolemid |247|
))))))
 :qid |XDXbpl.9770:20|
 :skolemid |248|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@4))
)))) (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9@@0 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3)))) (and (= $t10@@3 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t11@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t12@@3 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13@@2 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t11@@0))) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0@@3) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816))) (and (and (= _$t0@@3 _$t0@@3) (= _$t1@@3 _$t1@@3)) (and (= _$t2@@3 _$t2@@3) (= $t14@@3 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3))))))) (and (=> (= (ControlFlow 0 332073) (- 0 471758)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0@@3)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0@@3) (=> (= $t16@@2  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0@@3)) (let (($range_0@@5 ($Range 0 (seq.len $t14@@3))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@55 $i_1@@5))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth $t14@@3 i@@55)))) _$t2@@3))))
 :qid |XDXbpl.9843:131|
 :skolemid |249|
))))) (and (=> (= (ControlFlow 0 332073) 334053) anon25_Then_correct@@0) (=> (= (ControlFlow 0 332073) 332081) anon25_Else_correct@@0)))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@17 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@17)))
 (and (= (|l#Multiset_131870| stream@@20) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@20) v@@57) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 331547) 332073)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_183598| $t6)) 0) (=> (and (and (= (seq.len (|p#$Mutation_183598| $t24@@0)) 0) (= (seq.len (|p#$Mutation_14548| $t31@@2)) 0)) (and (= (seq.len (|p#$Mutation_158725| $t34)) 0) (= (ControlFlow 0 331557) 331547))) inline$$InitEventStore$0$anon0_correct@@3))))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (= (ControlFlow 0 471112) 331557) anon0_correct@@3)))
