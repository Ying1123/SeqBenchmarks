...
(declare-fun $t9@1 () T@$Mutation_203332)
...
(declare-fun $t9@2 () T@$Mutation_203332)
...
(declare-fun $t9@0 () T@$Mutation_203332)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 528560) (let ((L2_correct  (and (=> (= (ControlFlow 0 393769) (- 0 530451)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 393769) (- 0 530491)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 393641) 393769))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 393847) 393769))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 393919) 393769))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| (|v#$Mutation_203332| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0|) (= $t10@0 ($Mutation_74265 (|l#$Mutation_203332| $t9@1) (let ((l (|l#Vec_23605| (|p#$Mutation_203332| $t9@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_203332| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1))))) (and (= $t10@1 ($Mutation_74265 (|l#$Mutation_74265| $t10@0) (|p#$Mutation_74265| $t10@0) _$t1)) (= $t9@2 ($Mutation_203332 (|l#$Mutation_203332| $t9@1) (|p#$Mutation_203332| $t9@1) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|v#$Mutation_74265| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@1))))))) (and (=> (= (ControlFlow 0 393627) (- 0 529878)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t9@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_175669 (|Store__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_203332| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_203332| $t9@2)) (|v#$Mutation_203332| $t9@2)))) (and (=> (= (ControlFlow 0 393627) (- 0 529926)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.22155:99|
 :skolemid |712|
 ...
 :qid |XDXbpl.22155:99|
 :skolemid |712|
))) (and (=> (= (ControlFlow 0 393627) (- 0 529971)) (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816))))))
 :qid |XDXbpl.22161:15|
 :skolemid |713|
 ...
 :qid |XDXbpl.22161:15|
 :skolemid |713|
)) (and (=> (= (ControlFlow 0 393627) (- 0 529994)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))
 :qid |XDXbpl.22167:15|
 :skolemid |714|
 ...
 :qid |XDXbpl.22167:15|
 :skolemid |714|
)) (and (=> (= (ControlFlow 0 393627) (- 0 530017)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) dr_addr)))
 :qid |XDXbpl.22173:15|
 :skolemid |715|
 ...
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 393627) (- 0 530108)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 393627) (- 0 530123)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 393627) (- 0 530133)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 393627) (- 0 530145)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 393627) (- 0 530163)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 393627) (- 0 530177)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 393627) (- 0 530188)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 393627) (- 0 530208)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1))))
 :qid |XDXbpl.22236:15|
 :skolemid |716|
 ...
 :qid |XDXbpl.22236:15|
 :skolemid |716|
)) (and (=> (= (ControlFlow 0 393627) (- 0 530237)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3)))
 :qid |XDXbpl.22241:15|
 :skolemid |717|
 ...
 :qid |XDXbpl.22241:15|
 :skolemid |717|
)) (and (=> (= (ControlFlow 0 393627) (- 0 530262)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 393627) (- 0 530282)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5))))
 :qid |XDXbpl.22251:15|
 :skolemid |718|
 ...
 :qid |XDXbpl.22251:15|
 :skolemid |718|
)) (and (=> (= (ControlFlow 0 393627) (- 0 530311)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7)))
 :qid |XDXbpl.22256:15|
 :skolemid |719|
 ...
 :qid |XDXbpl.22256:15|
 :skolemid |719|
)) (and (=> (= (ControlFlow 0 393627) (- 0 530336)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 393627) (- 0 530356)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 393627) (- 0 530376)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9))))
 :qid |XDXbpl.22271:15|
 :skolemid |720|
 ...
 :qid |XDXbpl.22271:15|
 :skolemid |720|
)) (=> (= (ControlFlow 0 393627) (- 0 530412)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11)))
 :qid |XDXbpl.22276:15|
 :skolemid |721|
))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 393821) 393641) anon14_Then_correct) (=> (= (ControlFlow 0 393821) 393627) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 393819) 393821)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_203332 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 393007) 393641) anon14_Then_correct) (=> (= (ControlFlow 0 393007) 393627) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 392985) 393819) anon13_Then_correct) (=> (= (ControlFlow 0 392985) 393007) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 392971) 393847) anon12_Then_correct) (=> (= (ControlFlow 0 392971) 392985) anon12_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1)))) 3))))
 ...
 :qid |XDXbpl.21944:20|
 :skolemid |696|
))) (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.21948:20|
 :skolemid |697|
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0)))
...
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 392953) 393919) anon11_Then_correct) (=> (= (ControlFlow 0 392953) 392971) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 391990) 392953)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_203332| $t2)) 0) (= (|l#Vec_23605| (|p#$Mutation_203332| $t9)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_74265| $t10)) 0) (= (ControlFlow 0 392000) 391990))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 528560) 392000) anon0_correct)))
