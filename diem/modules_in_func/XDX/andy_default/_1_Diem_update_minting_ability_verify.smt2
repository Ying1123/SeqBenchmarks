...
(push 1)
(set-info :boogie-vc-id $1_Diem_update_minting_ability$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 506657) (let ((L2_correct  (and (=> (= (ControlFlow 0 377184) (- 0 508526)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@15) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@15) 186537453))) (=> (= (ControlFlow 0 377184) (- 0 508566)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0@@15) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0@@15 (= $abort_code@1@@15 $abort_code@1@@15)) (and (= $t6@0 $abort_code@1@@15) (= (ControlFlow 0 377056) 377184))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7@@3 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6@@2)) (= $t6@@2 $t6@@2)) (and (= $t6@0 $t6@@2) (= (ControlFlow 0 377262) 377184))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6@@2)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6@@2))) (and (not (= (|$addr#$signer| _$t0@@15) 186537453)) (= 2 $t6@@2))) (= $t6@@2 $t6@@2)) (and (= $t6@0 $t6@@2) (= (ControlFlow 0 377334) 377184))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0@@15) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@3| (|v#$Mutation_183598| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@3| |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@3|) (= $t10@0@@2 ($Mutation_73044 (|l#$Mutation_183598| $t9@1) (seq.++ (|p#$Mutation_183598| $t9@1) (seq.unit 7)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1))))) (and (= $t10@1 ($Mutation_73044 (|l#$Mutation_73044| $t10@0@@2) (|p#$Mutation_73044| $t10@0@@2) _$t1@@15)) (= $t9@2 ($Mutation_183598 (|l#$Mutation_183598| $t9@1) (|p#$Mutation_183598| $t9@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|v#$Mutation_73044| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@1))))))) (and (=> (= (ControlFlow 0 377042) (- 0 507965)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t9@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@4| ($Memory_176283 (|Store__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t9@2)) (|v#$Mutation_183598| $t9@2)))) (and (=> (= (ControlFlow 0 377042) (- 0 508013)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)))) (forall ((mint_cap_owner1@@74 Int) (mint_cap_owner2@@74 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@74) (=> (|$IsValid'address'| mint_cap_owner2@@74) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@74) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@74)) (= mint_cap_owner1@@74 mint_cap_owner2@@74))))
 :qid |XDXbpl.21165:83|
 :skolemid |604|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)))) (forall ((mint_cap_owner1@@75 Int) (mint_cap_owner2@@75 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@75) (=> (|$IsValid'address'| mint_cap_owner2@@75) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@75) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@75)) (= mint_cap_owner1@@75 mint_cap_owner2@@75))))
 :qid |XDXbpl.21165:83|
 :skolemid |604|
))) (and (=> (= (ControlFlow 0 377042) (- 0 508058)) (forall ((addr3@@74 Int) ) (!  (=> (|$IsValid'address'| addr3@@74) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@74) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816))))))
 :qid |XDXbpl.21171:15|
 :skolemid |605|
))) (=> (forall ((addr3@@75 Int) ) (!  (=> (|$IsValid'address'| addr3@@75) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@75) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816))))))
 :qid |XDXbpl.21171:15|
 :skolemid |605|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508081)) (forall ((addr@@354 Int) ) (!  (=> (|$IsValid'address'| addr@@354) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@354) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)))
 :qid |XDXbpl.21177:15|
 :skolemid |606|
))) (=> (forall ((addr@@355 Int) ) (!  (=> (|$IsValid'address'| addr@@355) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@355) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)))
 :qid |XDXbpl.21177:15|
 :skolemid |606|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508104)) (forall ((dr_addr@@59 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@59) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@59) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) dr_addr@@59)))
 :qid |XDXbpl.21183:15|
 :skolemid |607|
))) (=> (forall ((dr_addr@@60 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@60) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@60) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) dr_addr@@60)))
 :qid |XDXbpl.21183:15|
 :skolemid |607|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508128)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@179 Int) ) (!  (and (|$IsValid'address'| a@@179) (and ($1_Signer_is_txn_signer_addr a@@179) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@179) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@179)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@180 Int) ) (!  (and (|$IsValid'address'| a@@180) (and ($1_Signer_is_txn_signer_addr a@@180) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@180) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@180)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 377042) (- 0 508152)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@181 Int) ) (!  (and (|$IsValid'address'| a@@181) (and ($1_Signer_is_txn_signer_addr a@@181) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@181) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@181)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@182 Int) ) (!  (and (|$IsValid'address'| a@@182) (and ($1_Signer_is_txn_signer_addr a@@182) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@182) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@182)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 377042) (- 0 508176)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (exists ((a@@183 Int) ) (!  (and (|$IsValid'address'| a@@183) (and ($1_Signer_is_txn_signer_addr a@@183) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@183) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@183)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (exists ((a@@184 Int) ) (!  (and (|$IsValid'address'| a@@184) (and ($1_Signer_is_txn_signer_addr a@@184) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@184) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@184)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (and (=> (= (ControlFlow 0 377042) (- 0 508198)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 377042) (- 0 508208)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 377042) (- 0 508220)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 377042) (- 0 508238)) (not (not (= (|$addr#$signer| _$t0@@15) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@15) 186537453))) (and (=> (= (ControlFlow 0 377042) (- 0 508252)) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) _$t1@@15)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) _$t1@@15) (and (=> (= (ControlFlow 0 377042) (- 0 508263)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 377042) (- 0 508283)) (forall ((addr@@356 Int) ) (!  (=> (|$IsValid'address'| addr@@356) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@356)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@356))))
 :qid |XDXbpl.21240:15|
 :skolemid |608|
))) (=> (forall ((addr@@357 Int) ) (!  (=> (|$IsValid'address'| addr@@357) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@357)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@357))))
 :qid |XDXbpl.21240:15|
 :skolemid |608|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508312)) (forall ((addr@@358 Int) ) (!  (=> (|$IsValid'address'| addr@@358) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@358) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@358)))
 :qid |XDXbpl.21245:15|
 :skolemid |609|
))) (=> (forall ((addr@@359 Int) ) (!  (=> (|$IsValid'address'| addr@@359) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@359) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@359)))
 :qid |XDXbpl.21245:15|
 :skolemid |609|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508337)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 377042) (- 0 508357)) (forall ((addr@@360 Int) ) (!  (=> (|$IsValid'address'| addr@@360) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@360)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@360))))
 :qid |XDXbpl.21255:15|
 :skolemid |610|
))) (=> (forall ((addr@@361 Int) ) (!  (=> (|$IsValid'address'| addr@@361) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@361)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@361))))
 :qid |XDXbpl.21255:15|
 :skolemid |610|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508386)) (forall ((addr@@362 Int) ) (!  (=> (|$IsValid'address'| addr@@362) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@362) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@362)))
 :qid |XDXbpl.21260:15|
 :skolemid |611|
))) (=> (forall ((addr@@363 Int) ) (!  (=> (|$IsValid'address'| addr@@363) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@363) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@363)))
 :qid |XDXbpl.21260:15|
 :skolemid |611|
)) (and (=> (= (ControlFlow 0 377042) (- 0 508411)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 377042) (- 0 508431)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 377042) (- 0 508451)) (forall ((addr@@364 Int) ) (!  (=> (|$IsValid'address'| addr@@364) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@364) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@364))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@364))))
 :qid |XDXbpl.21275:15|
 :skolemid |612|
))) (=> (forall ((addr@@365 Int) ) (!  (=> (|$IsValid'address'| addr@@365) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@365) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@365))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@365))))
 :qid |XDXbpl.21275:15|
 :skolemid |612|
)) (=> (= (ControlFlow 0 377042) (- 0 508487)) (forall ((addr@@366 Int) ) (!  (=> (|$IsValid'address'| addr@@366) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@366) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@366)))
 :qid |XDXbpl.21280:15|
 :skolemid |613|
))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9@@9) (=> (and (= $abort_flag@0@@15 true) (= $abort_code@1@@15 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 377236) 377056) anon14_Then_correct) (=> (= (ControlFlow 0 377236) 377042) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 377234) 377236)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_183598 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0@@15 false) (= $abort_code@1@@15 $abort_code@0@@15))) (and (=> (= (ControlFlow 0 376434) 377056) anon14_Then_correct) (=> (= (ControlFlow 0 376434) 377042) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7@@3) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 376412) 377234) anon13_Then_correct) (=> (= (ControlFlow 0 376412) 376434) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7@@3  (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 376398) 377262) anon12_Then_correct) (=> (= (ControlFlow 0 376398) 376412) anon12_Else_correct)))))
(let ((anon0$1_correct@@15  (=> (forall ((addr@@367 Int) ) (!  (=> (|$IsValid'address'| addr@@367) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@367) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@367)) 0)) (= addr@@367 173345816)))
 :qid |XDXbpl.20889:20|
 :skolemid |573|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@368 Int) ) (!  (=> (|$IsValid'address'| addr@@368) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@368) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@368)) 1)) (= addr@@368 186537453)))
 :qid |XDXbpl.20897:20|
 :skolemid |574|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@369 Int) ) (!  (=> (|$IsValid'address'| addr@@369) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@369)) 2))))))
 :qid |XDXbpl.20905:20|
 :skolemid |575|
))) (and (forall ((addr@@370 Int) ) (!  (=> (|$IsValid'address'| addr@@370) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@370)) 2))))))
 :qid |XDXbpl.20909:20|
 :skolemid |576|
)) (forall ((addr@@371 Int) ) (!  (=> (|$IsValid'address'| addr@@371) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@371)) 2))))))
 :qid |XDXbpl.20913:20|
 :skolemid |577|
)))) (=> (and (and (and (forall ((addr@@372 Int) ) (!  (=> (|$IsValid'address'| addr@@372) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@372)) 2))))))
 :qid |XDXbpl.20917:20|
 :skolemid |578|
)) (forall ((addr@@373 Int) ) (!  (=> (|$IsValid'address'| addr@@373) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@373)) 2)))))
 :qid |XDXbpl.20921:20|
 :skolemid |579|
))) (and (forall ((addr@@374 Int) ) (!  (=> (|$IsValid'address'| addr@@374) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@374)) 2)))))
 :qid |XDXbpl.20925:20|
 :skolemid |580|
)) (forall ((addr@@375 Int) ) (!  (=> (|$IsValid'address'| addr@@375) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@375)) 2)))))
 :qid |XDXbpl.20929:20|
 :skolemid |581|
)))) (and (and (forall ((addr@@376 Int) ) (!  (=> (|$IsValid'address'| addr@@376) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@376) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@376) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@376)) 4))))
 :qid |XDXbpl.20933:20|
 :skolemid |582|
)) (forall ((addr@@377 Int) ) (!  (=> (|$IsValid'address'| addr@@377) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@377) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@377) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@377)) 3))))
 :qid |XDXbpl.20937:20|
 :skolemid |583|
))) (and (forall ((addr@@378 Int) ) (!  (=> (|$IsValid'address'| addr@@378) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@378) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@378) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@378)) 3))))
 :qid |XDXbpl.20941:20|
 :skolemid |584|
)) (forall ((addr@@379 Int) ) (!  (=> (|$IsValid'address'| addr@@379) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@379) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@379)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@379) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@379)) 3))))
 :qid |XDXbpl.20945:20|
 :skolemid |585|
))))) (=> (and (and (and (and (let (($range_0@@23 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@380 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@380))))))))
(forall (($i_1@@23 Int) ) (!  (=> ($InRange $range_0@@23 $i_1@@23) (let ((i1@@2 $i_1@@23))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@381 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@381)))) i1@@2))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@381 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@381)))) i1@@2)))) 3))))
 :qid |XDXbpl.20949:151|
 :skolemid |586|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@76 Int) (mint_cap_owner2@@76 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@76) (=> (|$IsValid'address'| mint_cap_owner2@@76) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@76) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@76)) (= mint_cap_owner1@@76 mint_cap_owner2@@76))))
 :qid |XDXbpl.20954:88|
 :skolemid |587|
)))) (and (forall ((addr3@@76 Int) ) (!  (=> (|$IsValid'address'| addr3@@76) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@76) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.20958:20|
 :skolemid |588|
)) (forall ((addr@@382 Int) ) (!  (=> (|$IsValid'address'| addr@@382) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@382) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.20962:20|
 :skolemid |589|
)))) (and (and (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |XDXbpl.20966:20|
 :skolemid |590|
)) (forall ((addr@@383 Int) ) (!  (=> (|$IsValid'address'| addr@@383) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234919| $1_DiemAccount_DiemAccount_$memory) addr@@383) (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@383)))
 :qid |XDXbpl.20970:20|
 :skolemid |591|
))) (and (forall ((addr@@384 Int) ) (!  (=> (|$IsValid'address'| addr@@384) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235019| $1_VASPDomain_VASPDomainManager_$memory) addr@@384)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@384) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@384)) 1))))
 :qid |XDXbpl.20974:20|
 :skolemid |592|
)) (forall ((addr@@385 Int) ) (!  (=> (|$IsValid'address'| addr@@385) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235104| $1_VASPDomain_VASPDomains_$memory) addr@@385)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@385) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@385)) 5))))
 :qid |XDXbpl.20978:20|
 :skolemid |593|
))))) (and (and (and (forall ((addr@@386 Int) ) (!  (=> (|$IsValid'address'| addr@@386) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_235191| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@386) (|Select__T@[Int]Bool_| (|domain#$Memory_235251| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@386)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@386)) 2)))))
 :qid |XDXbpl.20982:20|
 :skolemid |594|
)) (forall ((addr@@387 Int) ) (!  (=> (|$IsValid'address'| addr@@387) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235336| $1_DesignatedDealer_Dealer_$memory) addr@@387)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@387) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@387)) 2))))
 :qid |XDXbpl.20986:20|
 :skolemid |595|
))) (and (forall ((addr@@388 Int) ) (!  (=> (|$IsValid'address'| addr@@388) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr@@388)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@388) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@388)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@388) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@388)) 5)))))
 :qid |XDXbpl.20990:20|
 :skolemid |596|
)) (forall ((addr@@389 Int) ) (!  (=> (|$IsValid'address'| addr@@389) (= (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) addr@@389)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@389) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@389)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@389) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@389)) 1)))))
 :qid |XDXbpl.20994:20|
 :skolemid |597|
)))) (and (and (forall ((addr@@390 Int) ) (!  (=> (|$IsValid'address'| addr@@390) (= (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@390)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@390) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@390)) 3))))
 :qid |XDXbpl.20998:20|
 :skolemid |598|
)) (forall ((addr@@391 Int) ) (!  (=> (|$IsValid'address'| addr@@391) (= (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@391)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@391) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@391)) 4))))
 :qid |XDXbpl.21002:20|
 :skolemid |599|
))) (and (forall ((addr@@392 Int) ) (!  (=> (|$IsValid'address'| addr@@392) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235591| $1_VASP_ParentVASP_$memory) addr@@392)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@392) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@392)) 5))))
 :qid |XDXbpl.21006:20|
 :skolemid |600|
)) (forall ((addr@@393 Int) ) (!  (=> (|$IsValid'address'| addr@@393) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235691| $1_VASP_ChildVASP_$memory) addr@@393)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@393) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@393)) 6))))
 :qid |XDXbpl.21010:20|
 :skolemid |601|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@15)) ($1_Signer_is_txn_signer _$t0@@15)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@15))) (forall (($a_0@@36 Int) ) (! (let (($rsc@@36 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@36)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@36))
 :qid |XDXbpl.21019:20|
 :skolemid |602|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@36))
))) (and (forall (($a_0@@37 Int) ) (! (let (($rsc@@37 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@37)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@37) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@37)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@37) 10000000000))))
 :qid |XDXbpl.21023:20|
 :skolemid |603|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@37))
)) (= $t3 (|$addr#$signer| _$t0@@15)))) (and (and (= _$t0@@15 _$t0@@15) (= _$t1@@15 _$t1@@15)) (and (= $t4 (|$addr#$signer| _$t0@@15)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0@@15) 186537453))))))) (and (=> (= (ControlFlow 0 376380) 377334) anon11_Then_correct) (=> (= (ControlFlow 0 376380) 376398) anon11_Else_correct))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@15  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@53 T@$1_Event_EventHandle) ) (! (let ((stream@@64 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@53)))
 (and (= (|l#Multiset_131870| stream@@64) 0) (forall ((v@@93 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@64) v@@93) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 375427) 376380)) anon0$1_correct@@15)))
(let ((anon0_correct@@15  (=> (and (and (= (seq.len (|p#$Mutation_183598| $t2)) 0) (= (seq.len (|p#$Mutation_183598| $t9@@9)) 0)) (and (= (seq.len (|p#$Mutation_73044| $t10@@12)) 0) (= (ControlFlow 0 375437) 375427))) inline$$InitEventStore$0$anon0_correct@@15)))
(let ((PreconditionGeneratedEntry_correct@@12  (=> (= (ControlFlow 0 506657) 375437) anon0_correct@@15)))
