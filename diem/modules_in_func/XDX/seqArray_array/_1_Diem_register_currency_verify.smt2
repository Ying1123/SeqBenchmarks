...
(assert (not
 (=> (= (ControlFlow 0 0) 511614) (let ((anon43_Else_correct  (=> (not $abort_flag@1) (=> (and (and (= $t42@0 (|$1_Diem_MintCapability'#0'| false)) (= $t44@0 (|$1_Diem_BurnCapability'#0'| false))) (and (= $t42@0 $t42@0) (= $t44@0 $t44@0))) (and (=> (= (ControlFlow 0 374887) (- 0 515468)) (not (or (= _$t3 0) (> _$t3 10000000000)))) (=> (not (or (= _$t3 0) (> _$t3 10000000000))) (and (=> (= (ControlFlow 0 374887) (- 0 515485)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0))) (and (=> (= (ControlFlow 0 374887) (- 0 515496)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t11)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t11))) (and (=> (= (ControlFlow 0 374887) (- 0 515508)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t11)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t11)) 0))) (and (=> (= (ControlFlow 0 374887) (- 0 515526)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 374887) (- 0 515540)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 374887) (- 0 515554)) (not (exists ((i@@104 Int) ) (!  (and (and (|$IsValid'u64'| i@@104) (InRangeVec_160014 (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_175346| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@0))))) i@@105) _$t5))
 :qid |XDXbpl.2255:13|
 :skolemid |84|
))) (and (=> (= (ControlFlow 0 374887) (- 0 515567)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_181569| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_181569| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 374887) (- 0 515580)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175346| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175346| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 374887) (- 0 515592)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180409| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12) 18446744073709551615)) (< $t13 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180409| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12) 18446744073709551615)) (< $t13 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12)))) (and (=> (= (ControlFlow 0 374887) (- 0 515634)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 374887) (- 0 515640)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) 0)) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) 0) (and (=> (= (ControlFlow 0 374887) (- 0 515652)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 374887) (- 0 515672)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1))))
 :qid |XDXbpl.18809:15|
 :skolemid |499|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@2))))
 :qid |XDXbpl.18809:15|
 :skolemid |499|
)) (and (=> (= (ControlFlow 0 374887) (- 0 515701)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3)))
 :qid |XDXbpl.18814:15|
 :skolemid |500|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@4)))
 :qid |XDXbpl.18814:15|
 :skolemid |500|
)) (and (=> (= (ControlFlow 0 374887) (- 0 515726)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 374887) (- 0 515746)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5))))
 :qid |XDXbpl.18824:15|
 :skolemid |501|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6))))
 :qid |XDXbpl.18824:15|
 :skolemid |501|
)) (and (=> (= (ControlFlow 0 374887) (- 0 515775)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7)))
 :qid |XDXbpl.18829:15|
 :skolemid |502|
))) (=> (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@8)))
 :qid |XDXbpl.18829:15|
 :skolemid |502|
)) (and (=> (= (ControlFlow 0 374887) (- 0 515800)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 374887) (- 0 515820)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 374887) (- 0 515840)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9))))
 :qid |XDXbpl.18844:15|
 :skolemid |503|
))) (=> (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@10))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10))))
 :qid |XDXbpl.18844:15|
 :skolemid |503|
)) (=> (= (ControlFlow 0 374887) (- 0 515876)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11)))
 :qid |XDXbpl.18849:15|
 :skolemid |504|
)))))))))))))))))))))))))))))))))))))))))))))))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_175346| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@13))))) i@@107) _$t5))
 :qid |XDXbpl.2255:13|
 :skolemid |84|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_181569| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175346| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180409| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12) 18446744073709551615)) (< $t13 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12)))) (=> (= (ControlFlow 0 372035) (- 0 515207)) (or (or (or (or (or (or (or (or (or (and (or (= _$t3 0) (> _$t3 10000000000)) (= 7 $t16@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0)) (= 6 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t11)) (= 5 $t16@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t11)) 0)) (= 3 $t16@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t16@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t16@0))) (and (exists ((i@@108 Int) ) (!  (and (and (|$IsValid'u64'| i@@108) (InRangeVec_160014 (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@14 173345816))
...
(let ((anon43_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t16@0 $abort_code@2) (= (ControlFlow 0 374901) 372035))) L9_correct)))
...
(Vec_134061 (|Store__T@[Int]Vec_23605_| (|v#Vec_134061| (|v#$Mutation_160591| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1)) l _$t5) (+ l 1))))) (and (=> (= (ControlFlow 0 374013) 374345) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct) (=> (= (ControlFlow 0 374013) 374149) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Else_correct)))))
...
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_184654| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1)) l@@0 0) (+ l@@0 1))) (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (|v#$Mutation_184654| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1)))) (= (ControlFlow 0 374019) 374013))) |inline$$1_Vector_push_back'vec'u8''$0$anon0_correct|)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct  (=> (and (and (not inline$$Not$1$dst@1) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= (ControlFlow 0 373930) 373936))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 7)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$Not$1$dst@1 inline$$Not$1$dst@1))) (and (=> (= (ControlFlow 0 373914) 374019) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Then_correct) (=> (= (ControlFlow 0 373914) 373930) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct))))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not |inline$$1_Vector_contains'vec'u8''$0$res@1|)) (= (ControlFlow 0 373874) 373914)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 373880) 373874)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1) (= (ControlFlow 0 374359) 373936))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((|inline$$1_Vector_contains'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'vec'u8''$0$res@1| (exists ((i@@109 Int) ) (!  (and (and (|$IsValid'u64'| i@@109) (InRangeVec_160014 inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1 i@@109)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_23605_| (|v#Vec_134061| inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1) i@@109) _$t5))
 :qid |XDXbpl.2255:13|
 :skolemid |84|
))) (and (=> (= (ControlFlow 0 373830) 374359) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct) (=> (= (ControlFlow 0 373830) 373880) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct)))))
...
(let ((anon42_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 374391) (- 0 514081)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |XDXbpl.18666:15|
 :skolemid |496|
)) (and (=> (= (ControlFlow 0 374391) (- 0 514149)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XDXbpl.18672:15|
 :skolemid |497|
))) (=> (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XDXbpl.18672:15|
 :skolemid |497|
)) (and (=> (= (ControlFlow 0 374391) (- 0 514172)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 :qid |XDXbpl.18678:15|
 :skolemid |498|
 ...
 :qid |XDXbpl.18678:15|
 :skolemid |498|
)) (and (=> (= (ControlFlow 0 374391) (- 0 514196)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 374391) (- 0 514220)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 374391) (- 0 514244)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (=> (= $t39 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_175116| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (= $t40 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= (ControlFlow 0 374391) 373758)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon0_correct)))))))))))))))))))
(let ((anon42_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t16@0 $abort_code@1) (= (ControlFlow 0 374915) 372035))) L9_correct)))
(let ((anon41_Then$1_correct  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| |$1_Diem_CurrencyInfo'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 374967) 374915) anon42_Then_correct) (=> (= (ControlFlow 0 374967) 374391) anon42_Else_correct))))))
(let ((anon41_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 374965) 374967)) anon41_Then$1_correct)))
(let ((anon41_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_186082 (|Store__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0) $t38@0))) (= |$1_Diem_CurrencyInfo'#0'_$memory@1| |$1_Diem_CurrencyInfo'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 372675) 374915) anon42_Then_correct) (=> (= (ControlFlow 0 372675) 374391) anon42_Else_correct))))))
(let ((anon40_Else_correct  (=> (and (not false) (= $t38@0 (|$1_Diem_CurrencyInfo'#0'| 0 0 _$t1 _$t2 _$t3 _$t4 _$t5 true |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 372653) (- 0 513971)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000)) (and (=> (= (ControlFlow 0 372653) 374965) anon41_Then_correct) (=> (= (ControlFlow 0 372653) 372675) anon41_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|) false) (= $1_Event_EventHandles@4 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 372583) 374981) anon40_Then_correct) (=> (= (ControlFlow 0 372583) 372653) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (not false) (= (ControlFlow 0 372589) 372583)) |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@3 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 372501) 374995) anon39_Then_correct) (=> (= (ControlFlow 0 372501) 372589) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (not false) (= (ControlFlow 0 372507) 372501)) |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0|) false) (= $1_Event_EventHandles@2 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 372419) 375009) anon38_Then_correct) (=> (= (ControlFlow 0 372419) 372507) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (not false) (= (ControlFlow 0 372425) 372419)) |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 372337) 375023) anon37_Then_correct) (=> (= (ControlFlow 0 372337) 372425) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (not false) (= (ControlFlow 0 372343) 372337)) |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 372255) 375037) anon36_Then_correct) (=> (= (ControlFlow 0 372255) 372343) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (and (and $t10@0 (|$IsValid'u128'| 0)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 372261) 372255))) |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|)))
(let ((anon35_Else_correct  (=> (and (and (not $t10@0) (= $t29 $t29)) (and (= $t16@0 $t29) (= (ControlFlow 0 372159) 372035))) L9_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t29) (= $t29 7)) (and (= $t29 $t29) (= $t10@0 $t10@0))) (and (=> (= (ControlFlow 0 372143) 372261) anon35_Then_correct) (=> (= (ControlFlow 0 372143) 372159) anon35_Else_correct))))))
(let ((anon34_Then$1_correct  (=> (= inline$$Le$0$dst@1 inline$$Le$0$dst@1) (=> (and (= $t10@0 inline$$Le$0$dst@1) (= (ControlFlow 0 375103) 372143)) L5_correct))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= _$t3 10000000000)) (= (ControlFlow 0 375087) 375103)) anon34_Then$1_correct)))
(let ((anon34_Then_correct  (=> inline$$Lt$0$dst@1 (=> (and (|$IsValid'u64'| 10000000000) (= (ControlFlow 0 375093) 375087)) inline$$Le$0$anon0_correct))))
(let ((anon34_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= false false)) (and (= $t10@0 false) (= (ControlFlow 0 372113) 372143))) L5_correct)))
(let ((inline$$Lt$0$anon0_correct  (=> (= inline$$Lt$0$dst@1 (< 0 _$t3)) (and (=> (= (ControlFlow 0 372085) 375093) anon34_Then_correct) (=> (= (ControlFlow 0 372085) 372113) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 372091) 372085)) inline$$Lt$0$anon0_correct))))
(let ((anon33_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t22 $t22)) (and (= $t16@0 $t22) (= (ControlFlow 0 371647) 372035))) L9_correct)))
(let ((anon32_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t22) (= $t22 6)) (and (= $t22 $t22) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 371631) 372091) anon33_Then_correct) (=> (= (ControlFlow 0 371631) 371647) anon33_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t19@0)) (= (ControlFlow 0 371591) 371631)) anon32_Else$1_correct)))
(let ((anon32_Else_correct  (=> (not $t17) (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0))) (and (= $t19@0 (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $t18)) (= (ControlFlow 0 371597) 371591))) inline$$Not$0$anon0_correct))))
(let ((anon32_Then_correct  (=> $t17 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t16)) (= $t16 $t16)) (and (= $t16@0 $t16) (= (ControlFlow 0 375133) 372035))) L9_correct))))
(let ((anon31_Else_correct  (=> (and (not $t15) (= $t17  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 371535) 375133) anon32_Then_correct) (=> (= (ControlFlow 0 371535) 371597) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> $t15 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t16)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t14)) (= 5 $t16))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t14)) 0)) (= 3 $t16))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t16))) (= $t16 $t16)) (and (= $t16@0 $t16) (= (ControlFlow 0 375225) 372035))) L9_correct))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@33))))) i1)))) 3))))
 ...
 :qid |XDXbpl.18113:88|
 :skolemid |473|
))))))) (=> (and (and (and (and (and (and (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.18117:20|
 :skolemid |474|
)) (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@34) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.18121:20|
 :skolemid |475|
...
)))) (and (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@5)))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 370073) 371513)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 511614) 370073) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
