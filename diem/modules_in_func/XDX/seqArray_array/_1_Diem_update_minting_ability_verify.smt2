...
(declare-fun $t9@1 () T@$Mutation_194232)
...
(declare-fun $t9@2 () T@$Mutation_194232)
...
(declare-fun $t9 () T@$Mutation_194232)
(declare-fun $t9@0 () T@$Mutation_194232)
...
(assert (not
 (=> (= (ControlFlow 0 0) 524556) (let ((L2_correct  (and (=> (= (ControlFlow 0 389343) (- 0 526425)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 389343) (- 0 526465)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 389215) 389343))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 389421) 389343))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 389493) 389343))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_194232| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|) (= $t10@0 ($Mutation_74265 (|l#$Mutation_194232| $t9@1) (let ((l (|l#Vec_23605| (|p#$Mutation_194232| $t9@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_194232| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1))))) (and (= $t10@1 ($Mutation_74265 (|l#$Mutation_74265| $t10@0) (|p#$Mutation_74265| $t10@0) _$t1)) (= $t9@2 ($Mutation_194232 (|l#$Mutation_194232| $t9@1) (|p#$Mutation_194232| $t9@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|v#$Mutation_74265| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@1))))))) (and (=> (= (ControlFlow 0 389201) (- 0 525864)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t9@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_186082 (|Store__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t9@2)) (|v#$Mutation_194232| $t9@2)))) (and (=> (= (ControlFlow 0 389201) (- 0 525912)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.21229:83|
 :skolemid |630|
 ...
 :qid |XDXbpl.21235:15|
 :skolemid |631|
)) (and (=> (= (ControlFlow 0 389201) (- 0 525980)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XDXbpl.21241:15|
 :skolemid |632|
 ...
 :qid |XDXbpl.21241:15|
 :skolemid |632|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526003)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr)))
 :qid |XDXbpl.21247:15|
 :skolemid |633|
 ...
 :qid |XDXbpl.21247:15|
 :skolemid |633|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526027)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 389201) (- 0 526051)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 389201) (- 0 526075)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 389201) (- 0 526097)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 389201) (- 0 526107)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 389201) (- 0 526119)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 389201) (- 0 526137)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 389201) (- 0 526151)) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 389201) (- 0 526162)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389201) (- 0 526182)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1))))
 :qid |XDXbpl.21304:15|
 :skolemid |634|
 ...
 :qid |XDXbpl.21304:15|
 :skolemid |634|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526211)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3)))
 :qid |XDXbpl.21309:15|
 :skolemid |635|
 ...
 :qid |XDXbpl.21309:15|
 :skolemid |635|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526236)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389201) (- 0 526256)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5))))
 :qid |XDXbpl.21319:15|
 :skolemid |636|
 ...
 :qid |XDXbpl.21319:15|
 :skolemid |636|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526285)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7)))
 :qid |XDXbpl.21324:15|
 :skolemid |637|
 ...
 :qid |XDXbpl.21324:15|
 :skolemid |637|
)) (and (=> (= (ControlFlow 0 389201) (- 0 526310)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389201) (- 0 526330)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389201) (- 0 526350)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9))))
 :qid |XDXbpl.21339:15|
 :skolemid |638|
 ...
 :qid |XDXbpl.21339:15|
 :skolemid |638|
)) (=> (= (ControlFlow 0 389201) (- 0 526386)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11)))
 :qid |XDXbpl.21344:15|
 :skolemid |639|
))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 389395) 389215) anon14_Then_correct) (=> (= (ControlFlow 0 389395) 389201) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 389393) 389395)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_194232 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 388593) 389215) anon14_Then_correct) (=> (= (ControlFlow 0 388593) 389201) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 388571) 389393) anon13_Then_correct) (=> (= (ControlFlow 0 388571) 388593) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 388557) 389421) anon12_Then_correct) (=> (= (ControlFlow 0 388557) 388571) anon12_Else_correct)))))
(let ((anon0$1_correct  (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@12)) 0)) (= addr@@12 173345816)))
 :qid |XDXbpl.20953:20|
 :skolemid |599|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13)) 1)) (= addr@@13 186537453)))
 :qid |XDXbpl.20961:20|
 :skolemid |600|
 ...
 :qid |XDXbpl.21009:20|
 :skolemid |611|
))))) (=> (and (and (and (and (let (($range_0 ($Range 0 (|l#Vec_134004| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@25 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1)))) 3))))
 ...
 :qid |XDXbpl.21022:20|
 :skolemid |614|
)) (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.21026:20|
 :skolemid |615|
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0)))
...
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 388539) 389493) anon11_Then_correct) (=> (= (ControlFlow 0 388539) 388557) anon11_Else_correct))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 387586) 388539)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_194232| $t2)) 0) (= (|l#Vec_23605| (|p#$Mutation_194232| $t9)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_74265| $t10)) 0) (= (ControlFlow 0 387596) 387586))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 524556) 387596) anon0_correct)))
