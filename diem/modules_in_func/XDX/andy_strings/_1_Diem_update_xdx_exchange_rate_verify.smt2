...
(assert (not
 (=> (= (ControlFlow 0 0) 512674) (let ((L2_correct@@2  (and (=> (= (ControlFlow 0 384129) (- 0 514850)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 384129) (- 0 514890)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0@@18) 186537453)) (= 2 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon20_Then_correct@@0  (=> (and (and $abort_flag@0@@18 (= $abort_code@1@@18 $abort_code@1@@18)) (and (= $t8@0 $abort_code@1@@18) (= (ControlFlow 0 384001) 384129))) L2_correct@@2)))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0@@18 (= $abort_code@1@@18 $abort_code@1@@18)) (and (= $t8@0 $abort_code@1@@18) (= (ControlFlow 0 384143) 384129))) L2_correct@@2)))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0@@18 (= $abort_code@1@@18 $abort_code@1@@18)) (and (= $t8@0 $abort_code@1@@18) (= (ControlFlow 0 384157) 384129))) L2_correct@@2)))
(let ((anon16_Then_correct  (=> $t9@@12 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t8@@5)) (= $t8@@5 $t8@@5)) (and (= $t8@0 $t8@@5) (= (ControlFlow 0 384235) 384129))) L2_correct@@2))))
(let ((anon15_Then_correct  (=> $t7@@6 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t6@@5)) (= 5 $t8@@5)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t6@@5)) 1)) (= 3 $t8@@5))) (and (not (= (|$addr#$signer| _$t0@@18) 186537453)) (= 2 $t8@@5))) (= $t8@@5 $t8@@5)) (and (= $t8@0 $t8@@5) (= (ControlFlow 0 384307) 384129))) L2_correct@@2))))
(let ((anon20_Else_correct@@0  (=> (not $abort_flag@0@@18) (and (=> (= (ControlFlow 0 383987) (- 0 514233)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@5| ($Memory_176283 (|Store__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t11@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_183598| $t11@2)) (|v#$Mutation_183598| $t11@2)))) (and (=> (= (ControlFlow 0 383987) (- 0 514281)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)))) (forall ((mint_cap_owner1@@83 Int) (mint_cap_owner2@@83 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@83) (=> (|$IsValid'address'| mint_cap_owner2@@83) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@83) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@83)) (= mint_cap_owner1@@83 mint_cap_owner2@@83))))
 :qid |XDXbpl.22602:83|
 :skolemid |727|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)))) (forall ((mint_cap_owner1@@84 Int) (mint_cap_owner2@@84 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@84) (=> (|$IsValid'address'| mint_cap_owner2@@84) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@84) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@84)) (= mint_cap_owner1@@84 mint_cap_owner2@@84))))
 :qid |XDXbpl.22602:83|
 :skolemid |727|
))) (and (=> (= (ControlFlow 0 383987) (- 0 514326)) (forall ((addr3@@83 Int) ) (!  (=> (|$IsValid'address'| addr3@@83) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@83) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816))))))
 :qid |XDXbpl.22608:15|
 :skolemid |728|
))) (=> (forall ((addr3@@84 Int) ) (!  (=> (|$IsValid'address'| addr3@@84) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@84) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816))))))
 :qid |XDXbpl.22608:15|
 :skolemid |728|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514349)) (forall ((addr@@474 Int) ) (!  (=> (|$IsValid'address'| addr@@474) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@474) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)))
 :qid |XDXbpl.22614:15|
 :skolemid |729|
))) (=> (forall ((addr@@475 Int) ) (!  (=> (|$IsValid'address'| addr@@475) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@475) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)))
 :qid |XDXbpl.22614:15|
 :skolemid |729|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514372)) (forall ((dr_addr@@65 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@65) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@65) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) dr_addr@@65)))
 :qid |XDXbpl.22620:15|
 :skolemid |730|
))) (=> (forall ((dr_addr@@66 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@66) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@66) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) dr_addr@@66)))
 :qid |XDXbpl.22620:15|
 :skolemid |730|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514396)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@197 Int) ) (!  (and (|$IsValid'address'| a@@197) (and ($1_Signer_is_txn_signer_addr a@@197) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@197) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@197)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@198 Int) ) (!  (and (|$IsValid'address'| a@@198) (and ($1_Signer_is_txn_signer_addr a@@198) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@198) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@198)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 383987) (- 0 514420)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@199 Int) ) (!  (and (|$IsValid'address'| a@@199) (and ($1_Signer_is_txn_signer_addr a@@199) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@199) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@199)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@200 Int) ) (!  (and (|$IsValid'address'| a@@200) (and ($1_Signer_is_txn_signer_addr a@@200) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@200) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@200)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 383987) (- 0 514444)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (exists ((a@@201 Int) ) (!  (and (|$IsValid'address'| a@@201) (and ($1_Signer_is_txn_signer_addr a@@201) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@201) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@201)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (exists ((a@@202 Int) ) (!  (and (|$IsValid'address'| a@@202) (and ($1_Signer_is_txn_signer_addr a@@202) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@202)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (and (=> (= (ControlFlow 0 383987) (- 0 514466)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2))) (and (=> (= (ControlFlow 0 383987) (- 0 514478)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@2)) 1))) (and (=> (= (ControlFlow 0 383987) (- 0 514496)) (not (not (= (|$addr#$signer| _$t0@@18) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@18) 186537453))) (and (=> (= (ControlFlow 0 383987) (- 0 514510)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 383987) (- 0 514520)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) _$t1@@18)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) _$t1@@18) (and (=> (= (ControlFlow 0 383987) (- 0 514531)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 383987) (- 0 514551)) (forall ((addr@@476 Int) ) (!  (=> (|$IsValid'address'| addr@@476) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@476)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@476))))
 :qid |XDXbpl.22677:15|
 :skolemid |731|
))) (=> (forall ((addr@@477 Int) ) (!  (=> (|$IsValid'address'| addr@@477) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@477)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@477))))
 :qid |XDXbpl.22677:15|
 :skolemid |731|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514580)) (forall ((addr@@478 Int) ) (!  (=> (|$IsValid'address'| addr@@478) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@478) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@478)))
 :qid |XDXbpl.22682:15|
 :skolemid |732|
))) (=> (forall ((addr@@479 Int) ) (!  (=> (|$IsValid'address'| addr@@479) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@479) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@479)))
 :qid |XDXbpl.22682:15|
 :skolemid |732|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514605)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 383987) (- 0 514625)) (forall ((addr@@480 Int) ) (!  (=> (|$IsValid'address'| addr@@480) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@480)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@480))))
 :qid |XDXbpl.22692:15|
 :skolemid |733|
))) (=> (forall ((addr@@481 Int) ) (!  (=> (|$IsValid'address'| addr@@481) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@481)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@481))))
 :qid |XDXbpl.22692:15|
 :skolemid |733|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514654)) (forall ((addr@@482 Int) ) (!  (=> (|$IsValid'address'| addr@@482) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@482) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@482)))
 :qid |XDXbpl.22697:15|
 :skolemid |734|
))) (=> (forall ((addr@@483 Int) ) (!  (=> (|$IsValid'address'| addr@@483) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@483) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@483)))
 :qid |XDXbpl.22697:15|
 :skolemid |734|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514679)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 383987) (- 0 514699)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@0@@5|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 383987) (- 0 514719)) (forall ((addr@@484 Int) ) (!  (=> (|$IsValid'address'| addr@@484) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@484) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@484))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@484))))
 :qid |XDXbpl.22712:15|
 :skolemid |735|
))) (=> (forall ((addr@@485 Int) ) (!  (=> (|$IsValid'address'| addr@@485) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@485) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@485))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@485))))
 :qid |XDXbpl.22712:15|
 :skolemid |735|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514755)) (forall ((addr@@486 Int) ) (!  (=> (|$IsValid'address'| addr@@486) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@486) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@486)))
 :qid |XDXbpl.22717:15|
 :skolemid |736|
))) (=> (forall ((addr@@487 Int) ) (!  (=> (|$IsValid'address'| addr@@487) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@487) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@487)))
 :qid |XDXbpl.22717:15|
 :skolemid |736|
)) (and (=> (= (ControlFlow 0 383987) (- 0 514780)) (let ((actual@@35 ($EventStore (- (|counter#$EventStore| $es@0@@11) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@11) (|streams#$EventStore| $es)))))
(let ((expected@@35 (let ((stream@@67 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2)))
(let ((stream_new@@47 (let ((len@@47 (|l#Multiset_131870| stream@@67)))
(let ((cnt@@47 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@67) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@67) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2) (+ cnt@@47 1)) (+ len@@47 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2 stream_new@@47))))))
 (and (<= (|counter#$EventStore| expected@@35) (|counter#$EventStore| actual@@35)) (forall ((handle@@56 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@35) handle@@56)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@35) handle@@56))) (forall ((v@@96 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@35) handle@@56)) v@@96) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@35) handle@@56)) v@@96))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
...
(let ((expected@@36 (let ((stream@@68 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2)))
(let ((stream_new@@48 (let ((len@@48 (|l#Multiset_131870| stream@@68)))
(let ((cnt@@48 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@68) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@68) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2) (+ cnt@@48 1)) (+ len@@48 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2 stream_new@@48))))))
 (and (<= (|counter#$EventStore| expected@@36) (|counter#$EventStore| actual@@36)) (forall ((handle@@57 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@36) handle@@57)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@36) handle@@57))) (forall ((v@@97 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@36) handle@@57)) v@@97) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@36) handle@@57)) v@@97))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
 :skolemid |80|
))))) (=> (= (ControlFlow 0 383987) (- 0 514805)) (let ((actual@@37 ($EventStore (- (|counter#$EventStore| $es@0@@11) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@11) (|streams#$EventStore| $es)))))
(let ((expected@@37 (let ((stream@@69 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2)))
(let ((stream_new@@49 (let ((len@@49 (|l#Multiset_131870| stream@@69)))
(let ((cnt@@49 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@69) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@69) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5@@2) (+ cnt@@49 1)) (+ len@@49 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $EmptyEventStore) $t4@@2 stream_new@@49))))))
 (and (<= (|counter#$EventStore| actual@@37) (|counter#$EventStore| expected@@37)) (forall ((handle@@58 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@37) handle@@58)) (|l#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@37) handle@@58))) (forall ((v@@98 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| actual@@37) handle@@58)) v@@98) (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| expected@@37) handle@@58)) v@@98))
 :qid |XDXbpl.139:13|
 :skolemid |3|
)))
 :qid |XDXbpl.2928:13|
...
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_158725| $t13@0@@2)) (= $es@0@@11 (let ((stream@@70 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@50 (let ((len@@50 (|l#Multiset_131870| stream@@70)))
(let ((cnt@@50 (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@70) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t17@0@@9))))
(Multiset_131870 (|Store__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@70) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t17@0@@9) (+ cnt@@50 1)) (+ len@@50 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@50)))))) (and (=> (= (ControlFlow 0 383361) 384001) anon20_Then_correct@@0) (=> (= (ControlFlow 0 383361) 383987) anon20_Else_correct@@0)))))
(let ((anon19_Else_correct  (=> (not $abort_flag@0@@18) (=> (and (= $t17@0@@9 ($1_Diem_ToXDXExchangeRateUpdateEvent $t14@0@@0 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 383367) 383361)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= $t15@0@@3 $t15@0@@3) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| $t15@0@@3)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 383268) 384143) anon19_Then_correct) (=> (= (ControlFlow 0 383268) 383367) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0@@18) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@4| (|v#$Mutation_183598| $t11@1))) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@4| |$temp_0'$1_Diem_CurrencyInfo'#0''@0@@4|) (= $t12@0 ($Mutation_259473 (|l#$Mutation_183598| $t11@1) (seq.++ (|p#$Mutation_183598| $t11@1) (seq.unit 2)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1))))) (and (= $t12@1 ($Mutation_259473 (|l#$Mutation_259473| $t12@0) (|p#$Mutation_259473| $t12@0) _$t1@@18)) (= $t11@2 ($Mutation_183598 (|l#$Mutation_183598| $t11@1) (|p#$Mutation_183598| $t11@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|v#$Mutation_259473| $t12@1) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@1))))))) (and (and (= $t13@0@@2 ($Mutation_158725 (|l#$Mutation_183598| $t11@2) (seq.++ (|p#$Mutation_183598| $t11@2) (seq.unit 12)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2)))) (= $t14@0@@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2)))) (and (= $t15@0@@3 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_183598| $t11@2))) (= (ControlFlow 0 383274) 383268)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((anon17_Then$1_correct  (=> (= $t11@1 $t11@@12) (=> (and (= $abort_flag@0@@18 true) (= $abort_code@1@@18 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 384209) 384157) anon18_Then_correct) (=> (= (ControlFlow 0 384209) 383274) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 384207) 384209)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t11@0@@0 ($Mutation_183598 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t11@1 $t11@0@@0)) (and (= $abort_flag@0@@18 false) (= $abort_code@1@@18 $abort_code@0@@18))) (and (=> (= (ControlFlow 0 383093) 384157) anon18_Then_correct) (=> (= (ControlFlow 0 383093) 383274) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not $t9@@12) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 383071) 384207) anon17_Then_correct) (=> (= (ControlFlow 0 383071) 383093) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t7@@6) (= $t9@@12  (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 383057) 384235) anon16_Then_correct) (=> (= (ControlFlow 0 383057) 383071) anon16_Else_correct)))))
(let ((anon0$1_correct@@18  (=> (forall ((addr@@488 Int) ) (!  (=> (|$IsValid'address'| addr@@488) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@488) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@488)) 0)) (= addr@@488 173345816)))
 :qid |XDXbpl.22283:20|
 :skolemid |696|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@489 Int) ) (!  (=> (|$IsValid'address'| addr@@489) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@489) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@489)) 1)) (= addr@@489 186537453)))
 :qid |XDXbpl.22291:20|
 :skolemid |697|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@490 Int) ) (!  (=> (|$IsValid'address'| addr@@490) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@490)) 2))))))
 :qid |XDXbpl.22299:20|
 :skolemid |698|
))) (and (forall ((addr@@491 Int) ) (!  (=> (|$IsValid'address'| addr@@491) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@491)) 2))))))
 :qid |XDXbpl.22303:20|
 :skolemid |699|
)) (forall ((addr@@492 Int) ) (!  (=> (|$IsValid'address'| addr@@492) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@492)) 2))))))
 :qid |XDXbpl.22307:20|
 :skolemid |700|
)))) (=> (and (and (and (forall ((addr@@493 Int) ) (!  (=> (|$IsValid'address'| addr@@493) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@493)) 2))))))
 :qid |XDXbpl.22311:20|
 :skolemid |701|
)) (forall ((addr@@494 Int) ) (!  (=> (|$IsValid'address'| addr@@494) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@494)) 2)))))
 :qid |XDXbpl.22315:20|
 :skolemid |702|
))) (and (forall ((addr@@495 Int) ) (!  (=> (|$IsValid'address'| addr@@495) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@495)) 2)))))
 :qid |XDXbpl.22319:20|
 :skolemid |703|
)) (forall ((addr@@496 Int) ) (!  (=> (|$IsValid'address'| addr@@496) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@496)) 2)))))
 :qid |XDXbpl.22323:20|
 :skolemid |704|
)))) (and (and (forall ((addr@@497 Int) ) (!  (=> (|$IsValid'address'| addr@@497) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@497) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@497) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@497)) 4))))
 :qid |XDXbpl.22327:20|
 :skolemid |705|
)) (forall ((addr@@498 Int) ) (!  (=> (|$IsValid'address'| addr@@498) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@498) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@498) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@498)) 3))))
 :qid |XDXbpl.22331:20|
 :skolemid |706|
))) (and (forall ((addr@@499 Int) ) (!  (=> (|$IsValid'address'| addr@@499) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@499) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@499) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@499)) 3))))
 :qid |XDXbpl.22335:20|
 :skolemid |707|
)) (forall ((addr@@500 Int) ) (!  (=> (|$IsValid'address'| addr@@500) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@500) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@500)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@500) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@500)) 3))))
 :qid |XDXbpl.22339:20|
 :skolemid |708|
))))) (=> (and (and (and (and (and (let (($range_0@@26 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@501 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@501))))))))
(forall (($i_1@@26 Int) ) (!  (=> ($InRange $range_0@@26 $i_1@@26) (let ((i1@@5 $i_1@@26))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@502 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@502)))) i1@@5))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@502 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@502)))) i1@@5)))) 3))))
 :qid |XDXbpl.22343:151|
 :skolemid |709|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@85 Int) (mint_cap_owner2@@85 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@85) (=> (|$IsValid'address'| mint_cap_owner2@@85) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@85) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@85)) (= mint_cap_owner1@@85 mint_cap_owner2@@85))))
 :qid |XDXbpl.22348:88|
 :skolemid |710|
)))) (and (forall ((addr3@@85 Int) ) (!  (=> (|$IsValid'address'| addr3@@85) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@85) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.22352:20|
 :skolemid |711|
)) (forall ((addr@@503 Int) ) (!  (=> (|$IsValid'address'| addr@@503) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@503) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.22356:20|
 :skolemid |712|
)))) (and (and (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr1@@8) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@8)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@8)) 2)))))
 :qid |XDXbpl.22360:20|
 :skolemid |713|
)) (forall ((addr@@504 Int) ) (!  (=> (|$IsValid'address'| addr@@504) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234919| $1_DiemAccount_DiemAccount_$memory) addr@@504) (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@504)))
 :qid |XDXbpl.22364:20|
 :skolemid |714|
))) (and (forall ((addr@@505 Int) ) (!  (=> (|$IsValid'address'| addr@@505) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235019| $1_VASPDomain_VASPDomainManager_$memory) addr@@505)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@505) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@505)) 1))))
 :qid |XDXbpl.22368:20|
 :skolemid |715|
)) (forall ((addr@@506 Int) ) (!  (=> (|$IsValid'address'| addr@@506) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235104| $1_VASPDomain_VASPDomains_$memory) addr@@506)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@506) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@506)) 5))))
 :qid |XDXbpl.22372:20|
 :skolemid |716|
))))) (and (and (and (forall ((addr@@507 Int) ) (!  (=> (|$IsValid'address'| addr@@507) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_235191| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@507) (|Select__T@[Int]Bool_| (|domain#$Memory_235251| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@507)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@507)) 2)))))
 :qid |XDXbpl.22376:20|
 :skolemid |717|
)) (forall ((addr@@508 Int) ) (!  (=> (|$IsValid'address'| addr@@508) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235336| $1_DesignatedDealer_Dealer_$memory) addr@@508)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@508) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@508)) 2))))
 :qid |XDXbpl.22380:20|
 :skolemid |718|
))) (and (forall ((addr@@509 Int) ) (!  (=> (|$IsValid'address'| addr@@509) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr@@509)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@509) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@509)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@509) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@509)) 5)))))
 :qid |XDXbpl.22384:20|
 :skolemid |719|
)) (forall ((addr@@510 Int) ) (!  (=> (|$IsValid'address'| addr@@510) (= (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) addr@@510)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@510) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@510)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@510) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@510)) 1)))))
 :qid |XDXbpl.22388:20|
 :skolemid |720|
)))) (and (and (forall ((addr@@511 Int) ) (!  (=> (|$IsValid'address'| addr@@511) (= (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@511)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@511) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@511)) 3))))
 :qid |XDXbpl.22392:20|
 :skolemid |721|
)) (forall ((addr@@512 Int) ) (!  (=> (|$IsValid'address'| addr@@512) (= (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@512)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@512) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@512)) 4))))
 :qid |XDXbpl.22396:20|
 :skolemid |722|
))) (and (forall ((addr@@513 Int) ) (!  (=> (|$IsValid'address'| addr@@513) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235591| $1_VASP_ParentVASP_$memory) addr@@513)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@513) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@513)) 5))))
 :qid |XDXbpl.22400:20|
 :skolemid |723|
)) (forall ((addr@@514 Int) ) (!  (=> (|$IsValid'address'| addr@@514) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235691| $1_VASP_ChildVASP_$memory) addr@@514)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@514) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@514)) 6))))
 :qid |XDXbpl.22404:20|
 :skolemid |724|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@18)) ($1_Signer_is_txn_signer _$t0@@18)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@18))) (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| _$t1@@18) (forall (($a_0@@42 Int) ) (! (let (($rsc@@42 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@42)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@42))
 :qid |XDXbpl.22413:20|
 :skolemid |725|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@42))
)))) (and (and (and (forall (($a_0@@43 Int) ) (! (let (($rsc@@43 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@43)))
 ...
 :qid |XDXbpl.22417:20|
 :skolemid |726|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@43))
)) (= $t3@@2 (|$addr#$signer| _$t0@@18))) (and (= $t4@@2 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t5@@2 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| _$t1@@18))))) (and (and (= _$t0@@18 _$t0@@18) (= _$t1@@18 _$t1@@18)) (and (= $t6@@5 (|$addr#$signer| _$t0@@18)) (= $t7@@6  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t6@@5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t6@@5)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))))))))) (and (=> (= (ControlFlow 0 383039) 384307) anon15_Then_correct) (=> (= (ControlFlow 0 383039) 383057) anon15_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@18  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@59 T@$1_Event_EventHandle) ) (! (let ((stream@@71 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@59)))
 (and (= (|l#Multiset_131870| stream@@71) 0) (forall ((v@@99 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@71) v@@99) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 382052) 383039)) anon0$1_correct@@18)))
(let ((anon0_correct@@18  (=> (= (seq.len (|p#$Mutation_183598| $t2@@2)) 0) (=> (and (and (= (seq.len (|p#$Mutation_183598| $t11@@12)) 0) (= (seq.len (|p#$Mutation_259473| $t12@@15)) 0)) (and (= (seq.len (|p#$Mutation_158725| $t13@@14)) 0) (= (ControlFlow 0 382062) 382052))) inline$$InitEventStore$0$anon0_correct@@18))))
(let ((PreconditionGeneratedEntry_correct@@15  (=> (= (ControlFlow 0 512674) 382062) anon0_correct@@18)))
