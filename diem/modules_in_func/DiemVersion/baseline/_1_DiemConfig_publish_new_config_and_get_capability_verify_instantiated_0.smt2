...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 772556) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 465488) (- 0 773643)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemVersionbpl.12865:15|
 :skolemid |373|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemVersionbpl.12865:15|
 :skolemid |373|
)) (and (=> (= (ControlFlow 0 465488) (- 0 773668)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 465488) (- 0 773679)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr) (= addr 173345816)))
 :qid |DiemVersionbpl.12877:15|
 :skolemid |374|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@0) (= addr@@0 173345816)))
 :qid |DiemVersionbpl.12877:15|
 :skolemid |374|
)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'$1_DiemSystem_DiemSystem'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 465488) (- 0 773730)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 465488) (- 0 773742)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 465488) (- 0 773760)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 465488) (- 0 773774)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 465488) (- 0 773784)) (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 465488) (- 0 773790)) (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) addr@@2)))) (|$validators#$1_DiemSystem_DiemSystem| _$t1))) (=> (= (ControlFlow 0 465488) (- 0 773799)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 465270) (- 0 773524)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 465270) (- 0 773564)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 465502) 465270))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 465554) 465502) anon15_Then_correct) (=> (= (ControlFlow 0 465554) 465488) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 465552) 465554)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0| ($Memory_223188 (|Store__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 465314) 465502) anon15_Then_correct) (=> (= (ControlFlow 0 465314) 465488) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| _$t1))) (and (=> (= (ControlFlow 0 465292) (- 0 773397)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 465292) 465552) anon14_Then_correct) (=> (= (ControlFlow 0 465292) 465314) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 465142) 465270))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 465126) 465292) anon13_Then_correct) (=> (= (ControlFlow 0 465126) 465142) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 465086) 465126)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $t8)) (= (ControlFlow 0 465092) 465086))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 465646) 465270))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@3)) 0)) (= addr@@3 173345816)))
 ...
 :qid |DiemVersionbpl.12691:20|
 :skolemid |367|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@16) (= addr@@16 173345816)))
 :qid |DiemVersionbpl.12695:20|
 :skolemid |368|
 ...
 :qid |DiemVersionbpl.12699:20|
 :skolemid |369|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_250327| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_250387| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@17)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@17)) 2)))))
 :qid |DiemVersionbpl.12703:20|
 :skolemid |370|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_DiemSystem_DiemSystem'| _$t1)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemVersionbpl.12712:20|
 :skolemid |371|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@0))
 :qid |DiemVersionbpl.12716:20|
 :skolemid |372|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemVersionbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 464433) 465030)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 772556) 464433) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
