...
(declare-fun $t8 () T@$1_VASP_ChildVASP)
...
(assert (not
 (=> (= (ControlFlow 0 0) 59259) (let ((L3_correct  (=> (= $t2@0 $t2@0) (and (=> (= (ControlFlow 0 50531) (- 0 59740)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 50531) (- 0 59759)) (= $t2@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (= $t2@0 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 50531) (- 0 59772)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.3109:15|
 :skolemid |118|
 ...
 :qid |VASPbpl.3109:15|
 :skolemid |118|
)) (=> (= (ControlFlow 0 50531) (- 0 59797)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.3114:15|
 :skolemid |119|
))))))))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= $t9@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| $t8@1))) (=> (and (and (= $t9@0 $t9@0) (= $t9@0 $t9@0)) (and (= $t2@0 $t9@0) (= (ControlFlow 0 50425) 50531))) L3_correct))))
(let ((anon15_Then_correct  (=> (and (and $t3 (= _$t0 _$t0)) (and (= $t2@0 _$t0) (= (ControlFlow 0 50611) 50531))) L3_correct)))
(let ((L7_correct  (and (=> (= (ControlFlow 0 50377) (- 0 59650)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= (ControlFlow 0 50377) (- 0 59664)) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t7@0)))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 50545) 50377))) L7_correct)))
(let ((anon17_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 50597) 50545) anon18_Then_correct) (=> (= (ControlFlow 0 50597) 50425) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)) (= (ControlFlow 0 50595) 50597)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 50395) 50545) anon18_Then_correct) (=> (= (ControlFlow 0 50395) 50425) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> $t4 (and (=> (= (ControlFlow 0 50381) 50595) anon17_Then_correct) (=> (= (ControlFlow 0 50381) 50395) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (not $t4) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t6)) (=> (and (and (= $t6 7) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 50325) 50377))) L7_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t3) (= $t4 (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (and (=> (= (ControlFlow 0 50293) 50381) anon16_Then_correct) (=> (= (ControlFlow 0 50293) 50325) anon16_Else_correct)))))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |VASPbpl.2940:20|
 :skolemid |112|
)) (=> (and (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_33031| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_33031| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |VASPbpl.2944:20|
 :skolemid |113|
 ...
 :qid |VASPbpl.2948:20|
 :skolemid |114|
))) (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35768| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) addr@@1))))
 :qid |VASPbpl.2952:20|
 :skolemid |115|
...
))) (and (= _$t0 _$t0) (= $t3 (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 50273) 50611) anon15_Then_correct) (=> (= (ControlFlow 0 50273) 50293) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20906_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1501:13|
 :skolemid |49|
))) (= (ControlFlow 0 50081) 50273)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 59259) 50081) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
