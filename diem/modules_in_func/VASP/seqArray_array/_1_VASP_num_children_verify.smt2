...
(declare-fun $t4 () T@$1_VASP_ParentVASP)
(declare-fun $t1 () Int)
...
(assert (not
 (=> (= (ControlFlow 0 0) 58754) (let ((L2_correct  (and (=> (= (ControlFlow 0 49890) (- 0 59224)) (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)))) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (=> (= (ControlFlow 0 49890) (- 0 59231)) (and (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t3@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t3@0 $abort_code@1) (= (ControlFlow 0 49854) 49890))) L2_correct)))
(let ((anon9_Then_correct  (=> $t2 (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 $t3)) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 49980) 49890))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t5@0 (|$num_children#$1_VASP_ParentVASP| $t4@1)) (= $t5@0 $t5@0)) (and (=> (= (ControlFlow 0 49840) (- 0 59143)) (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))))) (=> (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 49840) (- 0 59155)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.2883:15|
 :skolemid |110|
 ...
 :qid |VASPbpl.2883:15|
 :skolemid |110|
)) (=> (= (ControlFlow 0 49840) (- 0 59180)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.2888:15|
 :skolemid |111|
)))))))))))
(let ((anon10_Then$1_correct  (=> (= $t4@1 $t4) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 49942) 49854) anon11_Then_correct) (=> (= (ControlFlow 0 49942) 49840) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) $t1)) (= (ControlFlow 0 49940) 49942)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) $t1) (=> (and (and (= $t4@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) $t1)) (= $t4@1 $t4@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 49746) 49854) anon11_Then_correct) (=> (= (ControlFlow 0 49746) 49840) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (not $t2) (=> (and (|$IsValid'address'| $t1) (= $t1 (ite (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 49732) 49940) anon10_Then_correct) (=> (= (ControlFlow 0 49732) 49746) anon10_Else_correct))))))
...
))) (and (= _$t0 _$t0) (= $t2  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) _$t0))))))) (and (=> (= (ControlFlow 0 49710) 49980) anon9_Then_correct) (=> (= (ControlFlow 0 49710) 49732) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20906_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1501:13|
 :skolemid |49|
))) (= (ControlFlow 0 49514) 49710)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 58754) 49514) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
