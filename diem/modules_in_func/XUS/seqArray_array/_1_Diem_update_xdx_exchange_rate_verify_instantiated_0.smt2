...
(declare-fun $t7 () Bool)
(declare-fun $t6 () Int)
(declare-fun $t11@2 () T@$Mutation_196886)
...
(declare-fun $t11@1 () T@$Mutation_196886)
...
(declare-fun $t11 () T@$Mutation_196886)
(declare-fun $t11@0 () T@$Mutation_196886)
...
(assert (not
 (=> (= (ControlFlow 0 0) 527872) (let ((L2_correct  (and (=> (= (ControlFlow 0 394819) (- 0 530070)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (=> (= (ControlFlow 0 394819) (- 0 530110)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 394691) 394819))) L2_correct)))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 394833) 394819))) L2_correct)))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 394847) 394819))) L2_correct)))
(let ((anon16_Then_correct  (=> $t9 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 394925) 394819))) L2_correct))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 394997) 394819))) L2_correct))))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 394677) (- 0 529441)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| ($Memory_173577 (|Store__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_196886| $t11@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_196886| $t11@2)) (|v#$Mutation_196886| $t11@2)))) (and (=> (= (ControlFlow 0 394677) (- 0 529489)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XUSbpl.23097:99|
 :skolemid |794|
 ...
 :qid |XUSbpl.23103:15|
 :skolemid |795|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529557)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))
 :qid |XUSbpl.23109:15|
 :skolemid |796|
 ...
 :qid |XUSbpl.23109:15|
 :skolemid |796|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529580)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) dr_addr)))
 :qid |XUSbpl.23115:15|
 :skolemid |797|
 ...
 :qid |XUSbpl.23115:15|
 :skolemid |797|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529604)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 394677) (- 0 529628)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 394677) (- 0 529652)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 394677) (- 0 529671)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 394677) (- 0 529686)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 394677) (- 0 529698)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 394677) (- 0 529716)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 394677) (- 0 529730)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 394677) (- 0 529740)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 394677) (- 0 529751)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 394677) (- 0 529771)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1))))
 :qid |XUSbpl.23178:15|
 :skolemid |798|
 ...
 :qid |XUSbpl.23178:15|
 :skolemid |798|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529800)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3)))
 :qid |XUSbpl.23183:15|
 :skolemid |799|
 ...
 :qid |XUSbpl.23183:15|
 :skolemid |799|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529825)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 394677) (- 0 529845)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5))))
 :qid |XUSbpl.23193:15|
 :skolemid |800|
 ...
 :qid |XUSbpl.23193:15|
 :skolemid |800|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529874)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7)))
 :qid |XUSbpl.23198:15|
 :skolemid |801|
 ...
 :qid |XUSbpl.23198:15|
 :skolemid |801|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529899)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 394677) (- 0 529919)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 394677) (- 0 529939)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9))))
 :qid |XUSbpl.23213:15|
 :skolemid |802|
 ...
 :qid |XUSbpl.23213:15|
 :skolemid |802|
)) (and (=> (= (ControlFlow 0 394677) (- 0 529975)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@11)))
 :qid |XUSbpl.23218:15|
 :skolemid |803|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@12)))
 :qid |XUSbpl.23218:15|
 :skolemid |803|
)) (and (=> (= (ControlFlow 0 394677) (- 0 530000)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new@@0))))))
 ...
 :qid |XUSbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 394677) (- 0 530025)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 394039) 394691) anon20_Then_correct) (=> (= (ControlFlow 0 394039) 394677) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t17@0 ($1_Diem_ToXDXExchangeRateUpdateEvent $t14@0 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 394045) 394039)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= $t15@0 $t15@0) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| $t15@0)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 393946) 394833) anon19_Then_correct) (=> (= (ControlFlow 0 393946) 394045) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| (|v#$Mutation_196886| $t11@1))) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0|) (= $t12@0 ($Mutation_268527 (|l#$Mutation_196886| $t11@1) (let ((l (|l#Vec_23605| (|p#$Mutation_196886| $t11@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_196886| $t11@1)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1))))) (and (= $t12@1 ($Mutation_268527 (|l#$Mutation_268527| $t12@0) (|p#$Mutation_268527| $t12@0) _$t1)) (= $t11@2 ($Mutation_196886 (|l#$Mutation_196886| $t11@1) (|p#$Mutation_196886| $t11@1) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|v#$Mutation_268527| $t12@1) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@1))))))) (and (and (= $t13@0 ($Mutation_165569 (|l#$Mutation_196886| $t11@2) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_196886| $t11@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_196886| $t11@2)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2)))) (= $t14@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2)))) (and (= $t15@0 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t11@2))) (= (ControlFlow 0 393952) 393946)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((anon17_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 394899) 394847) anon18_Then_correct) (=> (= (ControlFlow 0 394899) 393952) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 394897) 394899)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= $t11@0 ($Mutation_196886 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 393771) 394847) anon18_Then_correct) (=> (= (ControlFlow 0 393771) 393952) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not $t9) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 393749) 394897) anon17_Then_correct) (=> (= (ControlFlow 0 393749) 393771) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t7) (= $t9  (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 393735) 394925) anon16_Then_correct) (=> (= (ControlFlow 0 393735) 393749) anon16_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@13)) 0)) (= addr@@13 173345816)))
 :qid |XUSbpl.22774:20|
 :skolemid |763|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@14)) 1)) (= addr@@14 186537453)))
 :qid |XUSbpl.22782:20|
 :skolemid |764|
 ...
 :qid |XUSbpl.22830:20|
 :skolemid |775|
)) (let (($range_0 ($Range 0 (|l#Vec_132151| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@26 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_173349| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27))))) i1)))) 3))))
 ...
 :qid |XUSbpl.22843:20|
 :skolemid |778|
))) (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XUSbpl.22847:20|
 :skolemid |779|
...
)))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0)))
...
)) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t5 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| _$t1))))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 393717) 394997) anon15_Then_correct) (=> (= (ControlFlow 0 393717) 393735) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 392720) 393717)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_196886| $t2)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_196886| $t11)) 0) (= (|l#Vec_23605| (|p#$Mutation_268527| $t12)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_165569| $t13)) 0) (= (ControlFlow 0 392730) 392720))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 527872) 392730) anon0_correct)))
