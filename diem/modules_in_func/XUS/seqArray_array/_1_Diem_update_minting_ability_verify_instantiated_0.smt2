...
(declare-fun $t9@1 () T@$Mutation_196886)
(declare-fun $t10@0 () T@$Mutation_74103)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t10@1 () T@$Mutation_74103)
(declare-fun _$t1 () Bool)
(declare-fun $t9@2 () T@$Mutation_196886)
...
(declare-fun $t9@0 () T@$Mutation_196886)
...
(declare-fun $t2 () T@$Mutation_196886)
(declare-fun $t10 () T@$Mutation_74103)
(push 1)
(set-info :boogie-vc-id $1_Diem_update_minting_ability$verify_instantiated_0)
(assert (not
 (=> (= (ControlFlow 0 0) 521548) (let ((L2_correct  (and (=> (= (ControlFlow 0 387437) (- 0 523439)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 387437) (- 0 523479)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 387309) 387437))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 387515) 387437))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 387587) 387437))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| (|v#$Mutation_196886| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0|) (= $t10@0 ($Mutation_74103 (|l#$Mutation_196886| $t9@1) (let ((l (|l#Vec_23605| (|p#$Mutation_196886| $t9@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_196886| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1))))) (and (= $t10@1 ($Mutation_74103 (|l#$Mutation_74103| $t10@0) (|p#$Mutation_74103| $t10@0) _$t1)) (= $t9@2 ($Mutation_196886 (|l#$Mutation_196886| $t9@1) (|p#$Mutation_196886| $t9@1) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|v#$Mutation_74103| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@1))))))) (and (=> (= (ControlFlow 0 387295) (- 0 522866)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_196886| $t9@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| ($Memory_173577 (|Store__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_196886| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_196886| $t9@2)) (|v#$Mutation_196886| $t9@2)))) (and (=> (= (ControlFlow 0 387295) (- 0 522914)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XUSbpl.21599:99|
 :skolemid |671|
 ...
 :qid |XUSbpl.21605:15|
 :skolemid |672|
)) (and (=> (= (ControlFlow 0 387295) (- 0 522982)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))
 :qid |XUSbpl.21611:15|
 :skolemid |673|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))
 :qid |XUSbpl.21611:15|
 :skolemid |673|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523005)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) dr_addr)))
 :qid |XUSbpl.21617:15|
 :skolemid |674|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) dr_addr@@0)))
 :qid |XUSbpl.21617:15|
 :skolemid |674|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523029)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 387295) (- 0 523053)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@2)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 387295) (- 0 523077)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 387295) (- 0 523096)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 387295) (- 0 523111)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 387295) (- 0 523121)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 387295) (- 0 523133)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 387295) (- 0 523151)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 387295) (- 0 523165)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 387295) (- 0 523176)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 387295) (- 0 523196)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1))))
 :qid |XUSbpl.21680:15|
 :skolemid |675|
 ...
 :qid |XUSbpl.21680:15|
 :skolemid |675|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523225)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184665| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3)))
 :qid |XUSbpl.21685:15|
 :skolemid |676|
 ...
 :qid |XUSbpl.21685:15|
 :skolemid |676|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523250)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 387295) (- 0 523270)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5))))
 :qid |XUSbpl.21695:15|
 :skolemid |677|
 ...
 :qid |XUSbpl.21695:15|
 :skolemid |677|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523299)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_185073| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7)))
 :qid |XUSbpl.21700:15|
 :skolemid |678|
 ...
 :qid |XUSbpl.21700:15|
 :skolemid |678|
)) (and (=> (= (ControlFlow 0 387295) (- 0 523324)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 387295) (- 0 523344)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 387295) (- 0 523364)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191324| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9))))
 :qid |XUSbpl.21715:15|
 :skolemid |679|
...
(let ((anon0$1_correct  (=> (and (and (and (and (and (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@12)) 0)) (= addr@@12 173345816)))
 ...
 :qid |XUSbpl.21371:20|
 :skolemid |651|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_177677| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@24) (not (= (|l#Vec_131939| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_177677| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@24)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@24)) 3))))
 :qid |XUSbpl.21375:20|
 :skolemid |652|
)) (let (($range_0 ($Range 0 (|l#Vec_132151| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@25 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_173349| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@25))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_132151| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@26 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_173349| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_132151| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@26 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_173349| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1)))) 3))))
 :qid |XUSbpl.21379:151|
 :skolemid |653|
 ...
 :qid |XUSbpl.21388:20|
 :skolemid |655|
))) (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190912| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XUSbpl.21392:20|
 :skolemid |656|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_243632| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |XUSbpl.21400:20|
 :skolemid |657|
)) (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (= (|Select__T@[Int]Bool_| (|domain#$Memory_243919| $1_DiemAccount_DiemAccount_$memory) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@28)))
 :qid |XUSbpl.21404:20|
 :skolemid |658|
))) (and (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244019| $1_VASPDomain_VASPDomainManager_$memory) addr@@29)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@29)) 1))))
 :qid |XUSbpl.21408:20|
 :skolemid |659|
)) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244104| $1_VASPDomain_VASPDomains_$memory) addr@@30)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@30)) 5))))
 :qid |XUSbpl.21412:20|
 :skolemid |660|
))))) (and (and (and (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_244191| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@31) (|Select__T@[Int]Bool_| (|domain#$Memory_244251| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@31)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@31)) 2)))))
 :qid |XUSbpl.21416:20|
 :skolemid |661|
)) (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244336| $1_DesignatedDealer_Dealer_$memory) addr@@32)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@32)) 2))))
 :qid |XUSbpl.21420:20|
 :skolemid |662|
))) (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_243632| $1_DualAttestation_Credential_$memory) addr@@33)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@33)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@33)) 5)))))
 :qid |XUSbpl.21424:20|
 :skolemid |663|
)) (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (= (|Select__T@[Int]Bool_| (|domain#$Memory_173170| $1_SlidingNonce_SlidingNonce_$memory) addr@@34)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@34)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@34)) 1)))))
 :qid |XUSbpl.21428:20|
 :skolemid |664|
)))) (and (and (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (= (|Select__T@[Int]Bool_| (|domain#$Memory_177677| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@35)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@35)) 3))))
 :qid |XUSbpl.21432:20|
 :skolemid |665|
)) (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (= (|Select__T@[Int]Bool_| (|domain#$Memory_177034| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@36)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@36)) 4))))
 :qid |XUSbpl.21436:20|
 :skolemid |666|
))) (and (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244591| $1_VASP_ParentVASP_$memory) addr@@37)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@37)) 5))))
 :qid |XUSbpl.21440:20|
 :skolemid |667|
)) (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244691| $1_VASP_ChildVASP_$memory) addr@@38)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr@@38)) 6))))
 :qid |XUSbpl.21444:20|
 :skolemid |668|
))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |XUSbpl.21453:20|
 :skolemid |669|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0)))
 ...
 :qid |XUSbpl.21457:20|
 :skolemid |670|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_173577| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 386621) 387587) anon11_Then_correct) (=> (= (ControlFlow 0 386621) 386639) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 385658) 386621)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_196886| $t2)) 0) (= (|l#Vec_23605| (|p#$Mutation_196886| $t9)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_74103| $t10)) 0) (= (ControlFlow 0 385668) 385658))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 521548) 385668) anon0_correct)))
