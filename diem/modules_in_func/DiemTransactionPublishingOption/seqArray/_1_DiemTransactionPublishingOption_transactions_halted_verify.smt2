...
(assert (not
 (=> (= (ControlFlow 0 0) 254233) (let ((anon0$1_correct@@7  (=> (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@25)))
(|$IsValid'$1_DiemTransactionPublishingOption_HaltAllTransactions'| $rsc@@25))
 :qid |DiemTransactionPublishingOptionbpl.13498:20|
 :skolemid |382|
 :pattern ( (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@25))
)) (=> (and (|$IsValid'address'| 173345816) (= $t1@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816))) (=> (and (and (= $t1@0@@1 $t1@0@@1) (= (ControlFlow 0 188792) (- 0 254323))) (|Select__T@[Int]Bool_| (|domain#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_73622_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_73622| stream@@8) 0) (forall ((v@@40 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_73622| stream@@8) v@@40) 0)
 :qid |DiemTransactionPublishingOptionbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTransactionPublishingOptionbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 188708) 188792)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 254233) 188708) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7))))
))
(check-sat)
(pop 1)
