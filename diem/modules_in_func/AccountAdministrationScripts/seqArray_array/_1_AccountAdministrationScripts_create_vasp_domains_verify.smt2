...
(declare-fun $1_VASPDomain_VASPDomains_$memory@3 () T@$Memory_127047)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_127047)
(declare-fun $abort_code@1 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@2 () T@$Memory_127047)
(declare-fun inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 () Int)
(declare-fun _$t0 () T@$signer)
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_127047)
...
(declare-fun |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_74621)
(declare-fun MapConstVec_66304 (T@$1_VASPDomain_VASPDomain) |T@[Int]$1_VASPDomain_VASPDomain|)
(declare-fun DefaultVecElem_66304 () T@$1_VASPDomain_VASPDomain)
...
(assert (not
 (=> (= (ControlFlow 0 0) 296197) (let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Then_correct true))
(let ((anon4_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 227670) (- 0 297808)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory@3) addr)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr)) 5))))
 :qid |AccountAdministrationScriptsbpl.14769:15|
 :skolemid |426|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory@3) addr@@0)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@0)) 5))))
 :qid |AccountAdministrationScriptsbpl.14769:15|
 :skolemid |426|
)) (and (=> (= (ControlFlow 0 227670) (- 0 297836)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) $t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) $t2))) (and (=> (= (ControlFlow 0 227670) (- 0 297848)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) 5))) (and (=> (= (ControlFlow 0 227670) (- 0 297866)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $t1)) (and (=> (= (ControlFlow 0 227670) (- 0 297876)) (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory@3) $t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory@3) $t1) (=> (= (ControlFlow 0 227670) (- 0 297884)) (= (|l#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_127047| $1_VASPDomain_VASPDomains_$memory@3) $t1))) 0)))))))))))))))
(let ((anon4_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (=> (= (ControlFlow 0 227794) (- 0 297704)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $t1))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $t1)) (=> (= (ControlFlow 0 227794) (- 0 297733)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) (= 5 $abort_code@2)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $t2)) 5)) (= 3 $abort_code@2))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $t1) (= 6 $abort_code@2))) (= 6 $abort_code@2)) (= 3 $abort_code@2))))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct  (=> (and (and (not $abort_flag@0) (= $abort_flag@1 $abort_flag@0)) (and (= $1_VASPDomain_VASPDomains_$memory@3 $1_VASPDomain_VASPDomains_$memory@1) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 227439) 227794) anon4_Then_correct) (=> (= (ControlFlow 0 227439) 227670) anon4_Else_correct)))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $1_VASPDomain_VASPDomains_$memory@3 $1_VASPDomain_VASPDomains_$memory@2) (= $abort_code@2 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1)) (and (=> (= (ControlFlow 0 227361) 227794) anon4_Then_correct) (=> (= (ControlFlow 0 227361) 227670) anon4_Else_correct))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@1)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 $abort_code@1) (= (ControlFlow 0 227453) 227361))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then$1_correct  (=> (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 227505) 227453) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct) (=> (= (ControlFlow 0 227505) 227439) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 227503) 227505)) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then$1_correct)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_127047 (|Store__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) (|$addr#$signer| _$t0) inline$$1_VASPDomain_publish_vasp_domains$0$$t14@1))) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 227429) 227453) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Then_correct) (=> (= (ControlFlow 0 227429) 227439) inline$$1_VASPDomain_publish_vasp_domains$0$anon17_Else_correct))))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Else_correct  (=> (and (not false) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t14@1 ($1_VASPDomain_VASPDomains |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 227407) 227503) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Then_correct) (=> (= (ControlFlow 0 227407) 227429) inline$$1_VASPDomain_publish_vasp_domains$0$anon16_Else_correct)))))
(let ((|inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$v@1| (Vec_74621 (MapConstVec_66304 DefaultVecElem_66304) 0)) (and (=> (= (ControlFlow 0 227387) 227519) inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Then_correct) (=> (= (ControlFlow 0 227387) 227407) inline$$1_VASPDomain_publish_vasp_domains$0$anon15_Else_correct)))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 227393) 227387)) |inline$$1_Vector_empty'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= (ControlFlow 0 227355) 227361))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 6)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t12@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 227339) 227393) inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Then_correct) (=> (= (ControlFlow 0 227339) 227355) inline$$1_VASPDomain_publish_vasp_domains$0$anon14_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_VASPDomain_publish_vasp_domains$0$$t9@1)) (= (ControlFlow 0 227299) 227339)) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else$1_correct)))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else_correct  (=> (not inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0) (=> (and (and (|$IsValid'address'| inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0 (|$addr#$signer| _$t0))) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t9@1 (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t8@0)) (= (ControlFlow 0 227305) 227299))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Then_correct  (=> (and inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) (= 5 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) 5)) (= 3 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0)))) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0) (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 inline$$1_VASPDomain_publish_vasp_domains$0$$t7@0) (= (ControlFlow 0 227571) 227361))) inline$$1_VASPDomain_publish_vasp_domains$0$L3_correct))))
(let ((inline$$1_VASPDomain_publish_vasp_domains$0$anon0_correct  (=> (= inline$$1_VASPDomain_publish_vasp_domains$0$$t3@0 (|$addr#$signer| _$t0)) (=> (and (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t4@0 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0 (|$addr#$signer| _$t0)) (= inline$$1_VASPDomain_publish_vasp_domains$0$$t6@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_publish_vasp_domains$0$$t5@0)) 5)))))) (and (=> (= (ControlFlow 0 227243) 227571) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Then_correct) (=> (= (ControlFlow 0 227243) 227305) inline$$1_VASPDomain_publish_vasp_domains$0$anon13_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 :qid |AccountAdministrationScriptsbpl.14599:20|
 :skolemid |394|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@2)) 1)) (= addr@@2 186537453)))
 :qid |AccountAdministrationScriptsbpl.14607:20|
 :skolemid |395|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@3)) 2))))))
 :qid |AccountAdministrationScriptsbpl.14615:20|
 :skolemid |396|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@4)) 2))))))
 :qid |AccountAdministrationScriptsbpl.14619:20|
 :skolemid |397|
))) (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@5)) 2))))))
 :qid |AccountAdministrationScriptsbpl.14623:20|
 :skolemid |398|
)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6)) 2))))))
 :qid |AccountAdministrationScriptsbpl.14627:20|
 :skolemid |399|
)))) (and (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7)) 2)))))
 :qid |AccountAdministrationScriptsbpl.14631:20|
 :skolemid |400|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@8)) 2)))))
 :qid |AccountAdministrationScriptsbpl.14635:20|
 :skolemid |401|
))) (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@9)) 2)))))
 :qid |AccountAdministrationScriptsbpl.14639:20|
 :skolemid |402|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115131| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@10)) 4))))
 :qid |AccountAdministrationScriptsbpl.14643:20|
 :skolemid |403|
))))) (=> (and (and (and (and (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116094| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |AccountAdministrationScriptsbpl.14647:20|
 :skolemid |404|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116094| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@12)) 3))))
 :qid |AccountAdministrationScriptsbpl.14651:20|
 :skolemid |405|
))) (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_116094| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13) (not (= (|l#Vec_74112| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_116094| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@13)) 3))))
 :qid |AccountAdministrationScriptsbpl.14655:20|
 :skolemid |406|
)) (let (($range_0 ($Range 0 (|l#Vec_74301| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@14 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117156| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@14))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_74301| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@15 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117156| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_74301| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@15 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_117156| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 :qid |AccountAdministrationScriptsbpl.14659:151|
 :skolemid |407|
))))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |AccountAdministrationScriptsbpl.14664:20|
 :skolemid |408|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@16)))
 :qid |AccountAdministrationScriptsbpl.14668:20|
 :skolemid |409|
))) (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127358| $1_VASPDomain_VASPDomainManager_$memory) addr@@17)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@17)) 1))))
 :qid |AccountAdministrationScriptsbpl.14672:20|
 :skolemid |410|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) addr@@18)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@18)) 5))))
 :qid |AccountAdministrationScriptsbpl.14676:20|
 :skolemid |411|
))))) (and (and (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_140142| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_140233| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@19)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@19)) 2)))))
 :qid |AccountAdministrationScriptsbpl.14680:20|
 :skolemid |412|
)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_131599| $1_DesignatedDealer_Dealer_$memory) addr@@20)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@20)) 2))))
 :qid |AccountAdministrationScriptsbpl.14684:20|
 :skolemid |413|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) addr@@21)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@21)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@21)) 5)))))
 :qid |AccountAdministrationScriptsbpl.14688:20|
 :skolemid |414|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116706| $1_SlidingNonce_SlidingNonce_$memory) addr@@22)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@22)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@22)) 1)))))
 :qid |AccountAdministrationScriptsbpl.14692:20|
 :skolemid |415|
)))) (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116094| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |AccountAdministrationScriptsbpl.14696:20|
 :skolemid |416|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_115131| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@24)) 4))))
 :qid |AccountAdministrationScriptsbpl.14700:20|
 :skolemid |417|
))) (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@25)) 5))))
 :qid |AccountAdministrationScriptsbpl.14704:20|
 :skolemid |418|
)) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) addr@@26)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@26)) 6))))
 :qid |AccountAdministrationScriptsbpl.14708:20|
 :skolemid |419|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |AccountAdministrationScriptsbpl.14714:20|
 :skolemid |420|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) $a_0))
))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $a_0@@0)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@0) (and (and (let (($range_1 ($Range 0 (|l#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@104 $i_2))
(<= (|l#Vec_22899| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) i@@104))) 63)))
 :qid |AccountAdministrationScriptsbpl.14719:140|
 :skolemid |421|
))) (let (($range_3 ($Range 0 (|l#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@105 $i_4))
(let (($range_5 ($Range (+ i@@105 1) (|l#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@33 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) i@@105)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_74621| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)) j@@33))))))
 :qid |AccountAdministrationScriptsbpl.14721:98|
 :skolemid |422|
)))))
 :qid |AccountAdministrationScriptsbpl.14720:202|
 :skolemid |423|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@0)))
(forall (($i_8 Int) ) (!  (=> (InRangeVec_66284 $range_7 $i_8) (let (($elem (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_74621| $range_7) $i_8)))
(<= (|l#Vec_22899| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |AccountAdministrationScriptsbpl.14722:229|
 :skolemid |424|
))))))
 :qid |AccountAdministrationScriptsbpl.14718:20|
 :skolemid |425|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_127047| $1_VASPDomain_VASPDomains_$memory) $a_0@@0))
)) (= $t1 (|$addr#$signer| _$t0))) (and (= $t2 (|$addr#$signer| _$t0)) (let ((addr@@27 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@27)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@27) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@27)))))))) (and (and (= _$t0 _$t0) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4 (|$addr#$signer| _$t0)) (= (ControlFlow 0 227575) 227243)))))) inline$$1_VASPDomain_publish_vasp_domains$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountAdministrationScriptsbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 225736) 227575)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 296197) 225736) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))
))
(check-sat)
(pop 1)
