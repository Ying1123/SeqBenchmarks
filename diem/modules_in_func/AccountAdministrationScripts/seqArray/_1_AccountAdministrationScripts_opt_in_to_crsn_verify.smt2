...
(declare-fun $1_VASPDomain_VASPDomains_$memory@3 () T@$Memory_116617)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_116617)
(declare-fun $abort_code@1@@5 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@2 () T@$Memory_116617)
(declare-fun inline$$1_VASPDomain_publish_vasp_domains$0$$t7@1 () Int)
(declare-fun _$t0@@5 () T@$signer)
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_116617)
...
(declare-fun $1_CRSN_CRSN_$memory () T@$Memory_125239)
(declare-fun _$t0@@6 () T@$signer)
(declare-fun $1_CRSN_CRSN_$memory@0 () T@$Memory_125239)
...
(declare-fun |inline$$1_Vector_push_back'bool'$0$m'@1| () T@$Mutation_93497)
(declare-fun inline$$1_BitVector_new$0$$t21@2 () T@$Mutation_93497)
...
(declare-fun inline$$1_BitVector_new$0$$t21@1 () T@$Mutation_93497)
...
(declare-fun inline$$1_BitVector_new$0$$t21@0 () T@$Mutation_93497)
...
(assert (not
 (=> (= (ControlFlow 0 0) 280163) (let ((inline$$1_BitVector_new$0$anon25_Else_correct  (=> (and (not $abort_flag@1@@6) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 219041) (- 0 282071)) (<= inline$$AddU64$0$dst@2 _$t1@@1)) (=> (<= inline$$AddU64$0$dst@2 _$t1@@1) (=> (= (ControlFlow 0 219041) (- 0 282078)) (= (seq.len inline$$1_BitVector_new$0$$t5@2) inline$$AddU64$0$dst@2)))))))
(let ((anon3_Else_correct true))
(let ((anon3_Then_correct true))
(let ((inline$$1_DiemAccount_publish_crsn$0$L2_correct  (=> (and (= $abort_code@6@@5 inline$$1_DiemAccount_publish_crsn$0$$t5@1) (= $abort_flag@5@@5 true)) (and (=> (= (ControlFlow 0 219267) 219365) anon3_Then_correct) (=> (= (ControlFlow 0 219267) 219347) anon3_Else_correct)))))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon10_Then_correct  (=> (and (and $abort_flag@4@@5 (= $abort_code@5@@5 $abort_code@5@@5)) (and (= inline$$1_DiemAccount_publish_crsn$0$$t5@1 $abort_code@5@@5) (= (ControlFlow 0 219261) 219267))) inline$$1_DiemAccount_publish_crsn$0$L2_correct)))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon9_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= inline$$1_DiemAccount_publish_crsn$0$$t5@1 $abort_code@1@@6) (= (ControlFlow 0 219281) 219267))) inline$$1_DiemAccount_publish_crsn$0$L2_correct)))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon10_Else_correct  (=> (not $abort_flag@4@@5) (=> (and (= $abort_code@6@@5 $abort_code@5@@5) (= $abort_flag@5@@5 $abort_flag@4@@5)) (and (=> (= (ControlFlow 0 219247) 219365) anon3_Then_correct) (=> (= (ControlFlow 0 219247) 219347) anon3_Else_correct))))))
(let ((inline$$1_CRSN_publish$0$anon25_Else_correct  (=> (not $abort_flag@3@@5) (=> (and (= $abort_code@5@@5 $abort_code@4@@5) (= $abort_flag@4@@5 $abort_flag@3@@5)) (and (=> (= (ControlFlow 0 219139) 219261) inline$$1_DiemAccount_publish_crsn$0$anon10_Then_correct) (=> (= (ControlFlow 0 219139) 219247) inline$$1_DiemAccount_publish_crsn$0$anon10_Else_correct))))))
(let ((inline$$1_CRSN_publish$0$L7_correct  (=> (and (= $abort_code@5@@5 inline$$1_CRSN_publish$0$$t11@1) (= $abort_flag@4@@5 true)) (and (=> (= (ControlFlow 0 217444) 219261) inline$$1_DiemAccount_publish_crsn$0$anon10_Then_correct) (=> (= (ControlFlow 0 217444) 219247) inline$$1_DiemAccount_publish_crsn$0$anon10_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon25_Then_correct  (=> (and (and $abort_flag@3@@5 (= $abort_code@4@@5 $abort_code@4@@5)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@4@@5) (= (ControlFlow 0 219153) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon24_Then$1_correct  (=> (and (= $abort_flag@3@@5 true) (= $abort_code@4@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 219205) 219153) inline$$1_CRSN_publish$0$anon25_Then_correct) (=> (= (ControlFlow 0 219205) 219139) inline$$1_CRSN_publish$0$anon25_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon24_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_125239| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0@@6)) (= (ControlFlow 0 219203) 219205)) inline$$1_CRSN_publish$0$anon24_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon24_Else_correct  (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_125239| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0@@6))) (= $1_CRSN_CRSN_$memory@0 ($Memory_125239 (|Store__T@[Int]Bool_| (|domain#$Memory_125239| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0@@6) true) (|Store__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_125239| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0@@6) inline$$1_CRSN_publish$0$$t24@1)))) (and (= $abort_flag@3@@5 $abort_flag@2@@5) (= $abort_code@4@@5 $abort_code@3@@5))) (and (=> (= (ControlFlow 0 219129) 219153) inline$$1_CRSN_publish$0$anon25_Then_correct) (=> (= (ControlFlow 0 219129) 219139) inline$$1_CRSN_publish$0$anon25_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon23_Else_correct  (=> (and (not $abort_flag@2@@5) (= inline$$1_CRSN_publish$0$$t24@1 ($1_CRSN_CRSN inline$$1_DiemAccount_publish_crsn$0$$t6@1 _$t1@@1 inline$$1_BitVector_new$0$$ret0))) (and (=> (= (ControlFlow 0 219107) 219203) inline$$1_CRSN_publish$0$anon24_Then_correct) (=> (= (ControlFlow 0 219107) 219129) inline$$1_CRSN_publish$0$anon24_Else_correct)))))
(let ((inline$$1_CRSN_publish$0$anon23_Then_correct  (=> (and (and $abort_flag@2@@5 (= $abort_code@3@@5 $abort_code@3@@5)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@3@@5) (= (ControlFlow 0 219219) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_BitVector_new$0$anon23_Else_correct  (=> (not inline$$Lt$1$dst@1) (and (=> (= (ControlFlow 0 218757) (- 0 281617)) (= inline$$1_BitVector_new$0$$t16@1 _$t1@@1)) (=> (= inline$$1_BitVector_new$0$$t16@1 _$t1@@1) (and (=> (= (ControlFlow 0 218757) (- 0 281624)) (= (seq.len inline$$1_BitVector_new$0$$t5@1) _$t1@@1)) (=> (= (seq.len inline$$1_BitVector_new$0$$t5@1) _$t1@@1) (=> (and (and (= inline$$1_BitVector_new$0$$t23@1 ($1_BitVector_BitVector _$t1@@1 inline$$1_BitVector_new$0$$t5@1)) (= inline$$1_BitVector_new$0$$t23@1 inline$$1_BitVector_new$0$$t23@1)) (and (= $abort_code@3@@5 $abort_code@1@@6) (= $abort_flag@2@@5 $abort_flag@0@@6))) (and (=> (= (ControlFlow 0 218757) 219219) inline$$1_CRSN_publish$0$anon23_Then_correct) (=> (= (ControlFlow 0 218757) 219107) inline$$1_CRSN_publish$0$anon23_Else_correct))))))))))
(let ((inline$$1_BitVector_new$0$L10_correct  (=> (and (= $abort_code@3@@5 inline$$1_BitVector_new$0$$t11@1) (= $abort_flag@2@@5 true)) (and (=> (= (ControlFlow 0 218429) 219219) inline$$1_CRSN_publish$0$anon23_Then_correct) (=> (= (ControlFlow 0 218429) 219107) inline$$1_CRSN_publish$0$anon23_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon25_Then_correct  (=> (and (and $abort_flag@1@@6 (= $abort_code@2@@6 $abort_code@2@@6)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@2@@6) (= (ControlFlow 0 219055) 218429))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2@@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@6 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 219001) 219055) inline$$1_BitVector_new$0$anon25_Then_correct) (=> (= (ControlFlow 0 219001) 219041) inline$$1_BitVector_new$0$anon25_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ inline$$1_BitVector_new$0$$t16@1 1) $MAX_U64) (= (ControlFlow 0 218999) 219001)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ inline$$1_BitVector_new$0$$t16@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ inline$$1_BitVector_new$0$$t16@1 1)) (= $abort_code@2@@6 $abort_code@1@@6)) (and (= $abort_flag@1@@6 $abort_flag@0@@6) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 218947) 219055) inline$$1_BitVector_new$0$anon25_Then_correct) (=> (= (ControlFlow 0 218947) 219041) inline$$1_BitVector_new$0$anon25_Else_correct))))))
(let ((inline$$1_BitVector_new$0$anon24_Else_correct  (=> (not $abort_flag@0@@6) (=> (and (= inline$$1_BitVector_new$0$$t5@2 (|v#$Mutation_93497| |inline$$1_Vector_push_back'bool'$0$m'@1|)) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 219007) 218999) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 219007) 218947) inline$$AddU64$0$anon3_Else_correct))))))
(let ((inline$$1_BitVector_new$0$anon24_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@1@@6) (= (ControlFlow 0 219069) 218429))) inline$$1_BitVector_new$0$L10_correct)))
(let ((|inline$$1_Vector_push_back'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'bool'$0$m'@1| ($Mutation_93497 (|l#$Mutation_93497| inline$$1_BitVector_new$0$$t21@2) (|p#$Mutation_93497| inline$$1_BitVector_new$0$$t21@2) (seq.++ (|v#$Mutation_93497| inline$$1_BitVector_new$0$$t21@2) (seq.unit false)))) (and (=> (= (ControlFlow 0 218828) 219069) inline$$1_BitVector_new$0$anon24_Then_correct) (=> (= (ControlFlow 0 218828) 219007) inline$$1_BitVector_new$0$anon24_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon23_Then_correct  (=> inline$$Lt$1$dst@1 (=> (and (= inline$$1_BitVector_new$0$$t21@2 ($Mutation_93497 ($Local 5) (as seq.empty (Seq Int)) inline$$1_BitVector_new$0$$t5@1)) (= (ControlFlow 0 218834) 218828)) |inline$$1_Vector_push_back'bool'$0$anon0_correct|))))
(let ((inline$$1_BitVector_new$0$anon22_Else$1_correct  (and (=> (= (ControlFlow 0 218713) 218834) inline$$1_BitVector_new$0$anon23_Then_correct) (=> (= (ControlFlow 0 218713) 218757) inline$$1_BitVector_new$0$anon23_Else_correct))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$1_BitVector_new$0$$t16@1 _$t1@@1)) (= (ControlFlow 0 218703) 218713)) inline$$1_BitVector_new$0$anon22_Else$1_correct)))
(let ((inline$$1_BitVector_new$0$anon22_Else_correct  (=> (and (not $abort_flag@0@@6) (= |inline$$1_Vector_empty'bool'$0$v@1| |inline$$1_Vector_empty'bool'$0$v@1|)) (and (=> (= (ControlFlow 0 218709) (- 0 281488)) (<= 0 _$t1@@1)) (=> (<= 0 _$t1@@1) (and (=> (= (ControlFlow 0 218709) (- 0 281495)) (= (seq.len |inline$$1_Vector_empty'bool'$0$v@1|) 0)) (=> (= (seq.len |inline$$1_Vector_empty'bool'$0$v@1|) 0) (=> (|$IsValid'vec'bool''| inline$$1_BitVector_new$0$$t5@1) (=> (and (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t16@1) (|$IsValid'u64'| inline$$1_BitVector_new$0$$t19@1)) (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t20@1) (|$IsValid'vec'bool''| (|v#$Mutation_93497| inline$$1_BitVector_new$0$$t21@1)))) (and (and (not $abort_flag@0@@6) (<= inline$$1_BitVector_new$0$$t16@1 _$t1@@1)) (and (= (seq.len inline$$1_BitVector_new$0$$t5@1) inline$$1_BitVector_new$0$$t16@1) (= (ControlFlow 0 218709) 218703)))) inline$$Lt$1$anon0_correct)))))))))
(let ((inline$$1_BitVector_new$0$anon22_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= inline$$1_BitVector_new$0$$t11@1 $abort_code@1@@6) (= (ControlFlow 0 219083) 218429))) inline$$1_BitVector_new$0$L10_correct)))
(let ((|inline$$1_Vector_empty'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'bool'$0$v@1| (as seq.empty (Seq Bool))) (and (=> (= (ControlFlow 0 218569) 219083) inline$$1_BitVector_new$0$anon22_Then_correct) (=> (= (ControlFlow 0 218569) 218709) inline$$1_BitVector_new$0$anon22_Else_correct)))))
(let ((inline$$1_BitVector_new$0$anon21_Then_correct  (=> (and (and inline$$Lt$0$dst@1@@0 (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 218575) 218569))) |inline$$1_Vector_empty'bool'$0$anon0_correct|)))
(let ((inline$$1_BitVector_new$0$anon21_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1@@0) (= inline$$1_BitVector_new$0$$t15@0 inline$$1_BitVector_new$0$$t15@0)) (and (= inline$$1_BitVector_new$0$$t11@1 inline$$1_BitVector_new$0$$t15@0) (= (ControlFlow 0 218531) 218429))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$1_BitVector_new$0$anon20_Then$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t15@0) (= inline$$1_BitVector_new$0$$t15@0 7)) (and (= inline$$1_BitVector_new$0$$t15@0 inline$$1_BitVector_new$0$$t15@0) (= inline$$Lt$0$dst@1@@0 inline$$Lt$0$dst@1@@0))) (and (=> (= (ControlFlow 0 218515) 218575) inline$$1_BitVector_new$0$anon21_Then_correct) (=> (= (ControlFlow 0 218515) 218531) inline$$1_BitVector_new$0$anon21_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct@@0  (=> (and (= inline$$Lt$0$dst@1@@0 (< _$t1@@1 1024)) (= (ControlFlow 0 218479) 218515)) inline$$1_BitVector_new$0$anon20_Then$1_correct)))
(let ((inline$$1_BitVector_new$0$anon20_Then_correct  (=> inline$$Gt$1$dst@1 (=> (and (|$IsValid'u64'| 1024) (= (ControlFlow 0 218485) 218479)) inline$$Lt$0$anon0_correct@@0))))
(let ((inline$$1_BitVector_new$0$anon20_Else_correct  (=> (and (and (not inline$$Gt$1$dst@1) (= inline$$1_BitVector_new$0$$t10@0 inline$$1_BitVector_new$0$$t10@0)) (and (= inline$$1_BitVector_new$0$$t11@1 inline$$1_BitVector_new$0$$t10@0) (= (ControlFlow 0 218423) 218429))) inline$$1_BitVector_new$0$L10_correct)))
(let ((inline$$1_BitVector_new$0$anon0$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_new$0$$t10@0) (= inline$$1_BitVector_new$0$$t10@0 7)) (and (= inline$$1_BitVector_new$0$$t10@0 inline$$1_BitVector_new$0$$t10@0) (= inline$$Gt$1$dst@1 inline$$Gt$1$dst@1))) (and (=> (= (ControlFlow 0 218407) 218485) inline$$1_BitVector_new$0$anon20_Then_correct) (=> (= (ControlFlow 0 218407) 218423) inline$$1_BitVector_new$0$anon20_Else_correct))))))
(let ((inline$$Gt$1$anon0_correct  (=> (and (= inline$$Gt$1$dst@1 (> _$t1@@1 0)) (= (ControlFlow 0 218371) 218407)) inline$$1_BitVector_new$0$anon0$1_correct)))
(let ((inline$$1_BitVector_new$0$anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_93497| inline$$1_BitVector_new$0$$t21@0)) 0) (= _$t1@@1 _$t1@@1)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 218377) 218371))) inline$$Gt$1$anon0_correct)))
(let ((inline$$1_CRSN_publish$0$anon22_Then_correct  (=> (and inline$$Le$0$dst@1 (= (ControlFlow 0 219089) 218377)) inline$$1_BitVector_new$0$anon0_correct)))
(let ((inline$$1_CRSN_publish$0$anon22_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_CRSN_publish$0$$t22@0 inline$$1_CRSN_publish$0$$t22@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t22@0) (= (ControlFlow 0 217648) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon21_Then$1_correct  (=> (|$IsValid'u64'| 3) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t22@0) (= inline$$1_CRSN_publish$0$$t22@0 7)) (and (= inline$$1_CRSN_publish$0$$t22@0 inline$$1_CRSN_publish$0$$t22@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 217632) 219089) inline$$1_CRSN_publish$0$anon22_Then_correct) (=> (= (ControlFlow 0 217632) 217648) inline$$1_CRSN_publish$0$anon22_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= _$t1@@1 256)) (= (ControlFlow 0 217596) 217632)) inline$$1_CRSN_publish$0$anon21_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon21_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 217602) 217596)) inline$$Le$0$anon0_correct))))
(let ((inline$$1_CRSN_publish$0$anon21_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= inline$$1_CRSN_publish$0$$t18@0 inline$$1_CRSN_publish$0$$t18@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t18@0) (= (ControlFlow 0 217546) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon20_Then$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t18@0) (= inline$$1_CRSN_publish$0$$t18@0 7)) (and (= inline$$1_CRSN_publish$0$$t18@0 inline$$1_CRSN_publish$0$$t18@0) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 217530) 217602) inline$$1_CRSN_publish$0$anon21_Then_correct) (=> (= (ControlFlow 0 217530) 217546) inline$$1_CRSN_publish$0$anon21_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> _$t1@@1 0)) (= (ControlFlow 0 217494) 217530)) inline$$1_CRSN_publish$0$anon20_Then$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon20_Then_correct  (=> inline$$Not$0$dst@1@@6 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 217500) 217494)) inline$$Gt$0$anon0_correct))))
(let ((inline$$1_CRSN_publish$0$anon20_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@6) (= inline$$1_CRSN_publish$0$$t14@0 inline$$1_CRSN_publish$0$$t14@0)) (and (= inline$$1_CRSN_publish$0$$t11@1 inline$$1_CRSN_publish$0$$t14@0) (= (ControlFlow 0 217438) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_publish$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_publish$0$$t14@0) (= inline$$1_CRSN_publish$0$$t14@0 1)) (and (= inline$$1_CRSN_publish$0$$t14@0 inline$$1_CRSN_publish$0$$t14@0) (= inline$$Not$0$dst@1@@6 inline$$Not$0$dst@1@@6))) (and (=> (= (ControlFlow 0 217422) 217500) inline$$1_CRSN_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 217422) 217438) inline$$1_CRSN_publish$0$anon20_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@6  (=> (and (= inline$$Not$0$dst@1@@6  (not inline$$1_CRSN_has_crsn$0$$t1@1)) (= (ControlFlow 0 217386) 217422)) inline$$1_CRSN_publish$0$anon19_Else$1_correct)))
(let ((inline$$1_CRSN_publish$0$anon19_Else_correct  (=> (and (not $abort_flag@0@@6) (= (ControlFlow 0 217392) 217386)) inline$$Not$0$anon0_correct@@6)))
(let ((inline$$1_CRSN_publish$0$anon19_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= inline$$1_CRSN_publish$0$$t11@1 $abort_code@1@@6) (= (ControlFlow 0 219233) 217444))) inline$$1_CRSN_publish$0$L7_correct)))
(let ((inline$$1_CRSN_has_crsn$0$anon0_correct  (=> (= inline$$1_CRSN_publish$0$$t9@0 inline$$1_CRSN_publish$0$$t9@0) (=> (and (= inline$$1_CRSN_has_crsn$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_125239| $1_CRSN_CRSN_$memory) inline$$1_CRSN_publish$0$$t9@0)) (= inline$$1_CRSN_has_crsn$0$$t1@1 inline$$1_CRSN_has_crsn$0$$t1@1)) (and (=> (= (ControlFlow 0 217342) 219233) inline$$1_CRSN_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 217342) 217392) inline$$1_CRSN_publish$0$anon19_Else_correct))))))
(let ((inline$$1_CRSN_publish$0$anon0_correct  (=> (and (= _$t0@@6 _$t0@@6) (= inline$$1_DiemAccount_publish_crsn$0$$t6@1 inline$$1_DiemAccount_publish_crsn$0$$t6@1)) (=> (and (and (= _$t1@@1 _$t1@@1) (|$IsValid'address'| inline$$1_CRSN_publish$0$$t9@0)) (and (= inline$$1_CRSN_publish$0$$t9@0 (|$addr#$signer| _$t0@@6)) (= (ControlFlow 0 217348) 217342))) inline$$1_CRSN_has_crsn$0$anon0_correct))))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon9_Else_correct  (=> (and (and (not $abort_flag@0@@6) (= inline$$1_DiemAccount_publish_crsn$0$$t4@2 inline$$1_DiemAccount_publish_crsn$0$$t4@2)) (and (= inline$$1_DiemAccount_publish_crsn$0$$t6@1 (|$sequence_number#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_publish_crsn$0$$t4@2)) (= (ControlFlow 0 219237) 217348))) inline$$1_CRSN_publish$0$anon0_correct)))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon8_Then$1_correct  (=> (= $abort_flag@0@@6 true) (=> (and (= $abort_code@1@@6 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_publish_crsn$0$$t4@2 inline$$1_DiemAccount_publish_crsn$0$$t4@0)) (and (=> (= (ControlFlow 0 219333) 219281) inline$$1_DiemAccount_publish_crsn$0$anon9_Then_correct) (=> (= (ControlFlow 0 219333) 219237) inline$$1_DiemAccount_publish_crsn$0$anon9_Else_correct))))))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon8_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_publish_crsn$0$$t3@0)) (= (ControlFlow 0 219331) 219333)) inline$$1_DiemAccount_publish_crsn$0$anon8_Then$1_correct)))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon8_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_publish_crsn$0$$t3@0) (=> (and (and (= inline$$1_DiemAccount_publish_crsn$0$$t4@1 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_publish_crsn$0$$t3@0)) (= $abort_flag@0@@6 false)) (and (= $abort_code@1@@6 $abort_code@0@@6) (= inline$$1_DiemAccount_publish_crsn$0$$t4@2 inline$$1_DiemAccount_publish_crsn$0$$t4@1))) (and (=> (= (ControlFlow 0 216646) 219281) inline$$1_DiemAccount_publish_crsn$0$anon9_Then_correct) (=> (= (ControlFlow 0 216646) 219237) inline$$1_DiemAccount_publish_crsn$0$anon9_Else_correct))))))
(let ((inline$$1_DiemAccount_publish_crsn$0$anon0_correct  (=> (and (and (= _$t0@@6 _$t0@@6) (= _$t1@@1 _$t1@@1)) (and (|$IsValid'address'| inline$$1_DiemAccount_publish_crsn$0$$t3@0) (= inline$$1_DiemAccount_publish_crsn$0$$t3@0 (|$addr#$signer| _$t0@@6)))) (and (=> (= (ControlFlow 0 216632) 219331) inline$$1_DiemAccount_publish_crsn$0$anon8_Then_correct) (=> (= (ControlFlow 0 216632) 216646) inline$$1_DiemAccount_publish_crsn$0$anon8_Else_correct)))))
(let ((anon0$1_correct@@6  (=> (forall ((addr@@261 Int) ) (!  (=> (|$IsValid'address'| addr@@261) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@261) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@261)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@261)))) 0)) (= addr@@261 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@261))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.14765:20|
 :skolemid |401|
)) (=> (and (forall ((addr@@262 Int) ) (!  (=> (|$IsValid'address'| addr@@262) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@262) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@262) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@262)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@262)))) 0)) (= addr@@262 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@262))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.14769:20|
 :skolemid |402|
)) (forall ((addr@@263 Int) ) (!  (=> (|$IsValid'address'| addr@@263) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@263) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@263)))
 :qid |AccountAdministrationScriptsbpl.14773:20|
 :skolemid |403|
))) (=> (and (and (forall ((addr@@264 Int) ) (!  (=> (|$IsValid'address'| addr@@264) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@264)  (and (= addr@@264 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@264))))
 :qid |AccountAdministrationScriptsbpl.14777:20|
 :skolemid |404|
)) (forall ((addr@@265 Int) ) (!  (=> (|$IsValid'address'| addr@@265) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@265)  (and (= addr@@265 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@265))))
 :qid |AccountAdministrationScriptsbpl.14781:20|
 :skolemid |405|
))) (and (forall ((addr@@266 Int) ) (!  (=> (|$IsValid'address'| addr@@266) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@266) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@266)))
 :qid |AccountAdministrationScriptsbpl.14785:20|
 :skolemid |406|
)) (forall ((addr@@267 Int) ) (!  (=> (|$IsValid'address'| addr@@267) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@267) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@267)))
 :qid |AccountAdministrationScriptsbpl.14789:20|
 :skolemid |407|
)))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@6)) ($1_Signer_is_txn_signer _$t0@@6)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@6))) (and (|$IsValid'u64'| _$t1@@1) (forall (($a_0@@22 Int) ) (! (let (($rsc@@22 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_125239| $1_CRSN_CRSN_$memory) $a_0@@22)))
(|$IsValid'$1_CRSN_CRSN'| $rsc@@22))
 :qid |AccountAdministrationScriptsbpl.14798:20|
 :skolemid |408|
 :pattern ( (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_125239| $1_CRSN_CRSN_$memory) $a_0@@22))
)))) (and (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@23)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@23) (and (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@23))) 1) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@23))) 1))))
 :qid |AccountAdministrationScriptsbpl.14802:20|
 :skolemid |409|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@23))
)) (= _$t0@@6 _$t0@@6)) (and (= _$t1@@1 _$t1@@1) (= (ControlFlow 0 219337) 216632)))) inline$$1_DiemAccount_publish_crsn$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@6  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@8 T@$1_Event_EventHandle) ) (! (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@8)))
 (and (= (|l#Multiset_72203| stream@@7) 0) (forall ((v@@48 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@7) v@@48) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 216049) 219337)) anon0$1_correct@@6)))
(let ((anon0_correct@@6  (=> (= (ControlFlow 0 280163) 216049) inline$$InitEventStore$0$anon0_correct@@6)))
anon0_correct@@6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
