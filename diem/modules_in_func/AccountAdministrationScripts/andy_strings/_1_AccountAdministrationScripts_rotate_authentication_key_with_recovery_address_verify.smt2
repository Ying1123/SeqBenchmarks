...
(assert (not
 (=> (= (ControlFlow 0 0) 291988) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct  (=> (and (not $abort_flag@2@@9) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@2@@0)) (and (=> (= (ControlFlow 0 238971) (- 0 293623)) (<= inline$$AddU64$0$dst@2@@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (<= inline$$AddU64$0$dst@2@@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (=> (= (ControlFlow 0 238971) (- 0 293630)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0 ($Range 0 inline$$AddU64$0$dst@2@@0)))
...
(let ((anon4_Else_correct@@4  (=> (not $abort_flag@5@@9) (and (=> (= (ControlFlow 0 240295) (- 0 294543)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5))) (and (=> (= (ControlFlow 0 240295) (- 0 294554)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) _$t2@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (and (=> (= (ControlFlow 0 240295) (- 0 294565)) (not (not (= (seq.len _$t3@@0) 32)))) (=> (not (not (= (seq.len _$t3@@0) 32))) (and (=> (= (ControlFlow 0 240295) (- 0 294579)) (not (not (exists ((i@@50 Int) ) (!  (and (and (|$IsValid'u64'| i@@50) (and (<= 0 i@@50) (< i@@50 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@50)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
))))) (=> (not (not (exists ((i@@51 Int) ) (!  (and (and (|$IsValid'u64'| i@@51) (and (<= 0 i@@51) (< i@@51 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@51)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (and (=> (= (ControlFlow 0 240295) (- 0 294591)) (not (not (or (= (|$addr#$signer| _$t0@@10) _$t1@@5) (= (|$addr#$signer| _$t0@@10) _$t2@@1))))) (=> (not (not (or (= (|$addr#$signer| _$t0@@10) _$t1@@5) (= (|$addr#$signer| _$t0@@10) _$t2@@1)))) (and (=> (= (ControlFlow 0 240295) (- 0 294612)) (not (not (exists ((i@@52 Int) ) (!  (and (and (|$IsValid'u64'| i@@52) (and (<= 0 i@@52) (< i@@52 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@52)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
))))) (=> (not (not (exists ((i@@53 Int) ) (!  (and (and (|$IsValid'u64'| i@@53) (and (<= 0 i@@53) (< i@@53 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@53)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (and (=> (= (ControlFlow 0 240295) (- 0 294624)) (not (not (or (= $t4@@5 _$t1@@5) (= $t4@@5 _$t2@@1))))) (=> (not (not (or (= $t4@@5 _$t1@@5) (= $t4@@5 _$t2@@1)))) (=> (= (ControlFlow 0 240295) (- 0 294643)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@2) _$t2@@1)) _$t3@@0)))))))))))))))))))
(let ((anon4_Then_correct@@4  (=> (and $abort_flag@5@@9 (= $abort_code@6@@9 $abort_code@6@@9)) (and (=> (= (ControlFlow 0 240575) (- 0 294312)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (not (= (seq.len _$t3@@0) 32))) (not (exists ((i@@54 Int) ) (!  (and (and (|$IsValid'u64'| i@@54) (and (<= 0 i@@54) (< i@@54 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@54)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (not (or (= (|$addr#$signer| _$t0@@10) _$t1@@5) (= (|$addr#$signer| _$t0@@10) _$t2@@1)))) (not (exists ((i@@55 Int) ) (!  (and (and (|$IsValid'u64'| i@@55) (and (<= 0 i@@55) (< i@@55 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@55)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (not (or (= $t4@@5 _$t1@@5) (= $t4@@5 _$t2@@1))))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (not (= (seq.len _$t3@@0) 32))) (not (exists ((i@@56 Int) ) (!  (and (and (|$IsValid'u64'| i@@56) (and (<= 0 i@@56) (< i@@56 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@56)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (not (or (= (|$addr#$signer| _$t0@@10) _$t1@@5) (= (|$addr#$signer| _$t0@@10) _$t2@@1)))) (not (exists ((i@@57 Int) ) (!  (and (and (|$IsValid'u64'| i@@57) (and (<= 0 i@@57) (< i@@57 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@57)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
)))) (not (or (= $t4@@5 _$t1@@5) (= $t4@@5 _$t2@@1)))) (=> (= (ControlFlow 0 240575) (- 0 294389)) (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (= 5 $abort_code@6@@9)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) _$t2@@1)) (= 5 $abort_code@6@@9))) (and (not (= (seq.len _$t3@@0) 32)) (= 7 $abort_code@6@@9))) (and (not (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@58)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
))) (= 7 $abort_code@6@@9))) (and (not (or (= (|$addr#$signer| _$t0@@10) _$t1@@5) (= (|$addr#$signer| _$t0@@10) _$t2@@1))) (= 7 $abort_code@6@@9))) (and (not (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (<= 0 i@@59) (< i@@59 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) i@@59)) _$t2@@1))
 :qid |AccountAdministrationScriptsbpl.11876:13|
 :skolemid |198|
))) (= 7 $abort_code@6@@9))) (and (not (or (= $t4@@5 _$t1@@5) (= $t4@@5 _$t2@@1))) (= 7 $abort_code@6@@9))) (= 5 $abort_code@6@@9)) (= 7 $abort_code@6@@9))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct  (=> (and (and (not $abort_flag@4@@9) (= $1_DiemAccount_DiemAccount_$memory@3@@2 $1_DiemAccount_DiemAccount_$memory@1@@5)) (and (= $abort_flag@5@@9 $abort_flag@4@@9) (= $abort_code@6@@9 $abort_code@5@@9))) (and (=> (= (ControlFlow 0 240019) 240575) anon4_Then_correct@@4) (=> (= (ControlFlow 0 240019) 240295) anon4_Else_correct@@4)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct  (=> (= $1_DiemAccount_DiemAccount_$memory@3@@2 $1_DiemAccount_DiemAccount_$memory@2@@3) (=> (and (= $abort_flag@5@@9 true) (= $abort_code@6@@9 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1)) (and (=> (= (ControlFlow 0 238002) 240575) anon4_Then_correct@@4) (=> (= (ControlFlow 0 238002) 240295) anon4_Else_correct@@4))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct  (=> $abort_flag@4@@9 (=> (and (and (= $abort_code@5@@9 $abort_code@5@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@5@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory@1@@5) (= (ControlFlow 0 240033) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@3  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3 ($Mutation_92207 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@3 ($Mutation_92207 (|l#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3) (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3) _$t3@@0)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) ($1_DiemAccount_DiemAccount (|v#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@3) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0@@5 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)) (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)))) (= $abort_code@5@@9 $abort_code@4@@9)) (and (= $abort_flag@4@@9 $abort_flag@3@@9) (= $1_DiemAccount_DiemAccount_$memory@1@@5 $1_DiemAccount_DiemAccount_$memory@0@@5)))) (and (=> (= (ControlFlow 0 239911) 240033) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 239911) 240019) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3  (=> (= $abort_code@5@@9 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3) (=> (and (= $abort_flag@4@@9 true) (= $1_DiemAccount_DiemAccount_$memory@1@@5 $1_DiemAccount_DiemAccount_$memory)) (and (=> (= (ControlFlow 0 239707) 240033) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 239707) 240019) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= (ControlFlow 0 239861) 239707))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@3  (=> (and (and (and (not $abort_flag@3@@9) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 (= |inline$$1_Vector_length'u8'$0$l@1@@3| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3)))) (and (=> (= (ControlFlow 0 239845) 239911) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@3) (=> (= (ControlFlow 0 239845) 239861) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@3  (=> (and (and $abort_flag@3@@9 (= $abort_code@4@@9 $abort_code@4@@9)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@4@@9) (= (ControlFlow 0 239925) 239707))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@3|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@3| (seq.len _$t3@@0)) (and (=> (= (ControlFlow 0 239787) 239925) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@3) (=> (= (ControlFlow 0 239787) 239845) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3  (=> (and (and (not $abort_flag@3@@9) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3|) (= (ControlFlow 0 239793) 239787))) |inline$$1_Vector_length'u8'$0$anon0_correct@@3|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3  (=> (and (and $abort_flag@3@@9 (= $abort_code@4@@9 $abort_code@4@@9)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@4@@9) (= (ControlFlow 0 239939) 239707))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@3  (=> (= $abort_flag@3@@9 true) (=> (and (= $abort_code@4@@9 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@3)) (and (=> (= (ControlFlow 0 239991) 239939) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 239991) 239793) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3)) (= (ControlFlow 0 239989) 239991)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@3 ($Mutation_131921 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3))) (= $abort_flag@3@@9 $abort_flag@1@@10)) (and (= $abort_code@4@@9 $abort_code@2@@10) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@3))) (and (=> (= (ControlFlow 0 239737) 239939) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 239737) 239793) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@3  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1@@8 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|))) (and (=> (= (ControlFlow 0 239715) 239989) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@3) (=> (= (ControlFlow 0 239715) 239737) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@8) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= (ControlFlow 0 239701) 239707))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@3  (=> (and (not $abort_flag@1@@10) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 inline$$1_DiemAccount_exists_at$0$$t1@1@@8))) (and (=> (= (ControlFlow 0 239685) 239715) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@3) (=> (= (ControlFlow 0 239685) 239701) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@3  (=> (and (and $abort_flag@1@@10 (= $abort_code@2@@10 $abort_code@2@@10)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@2@@10) (= (ControlFlow 0 240005) 239707))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@8  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 inline$$1_DiemAccount_exists_at$0$$t1@1@@8)) (and (=> (= (ControlFlow 0 239643) 240005) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@3) (=> (= (ControlFlow 0 239643) 239685) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@3)) 0) (=> (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@3)) 0) (= (seq.len (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@3)) 0)) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= _$t3@@0 _$t3@@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= (ControlFlow 0 239649) 239643))) inline$$1_DiemAccount_exists_at$0$anon0_correct@@8)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct  (=> (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= (ControlFlow 0 240009) 239649)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@3)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct  (=> $abort_flag@2@@9 (=> (and (and (= $abort_code@3@@9 $abort_code@3@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@3@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 238985) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$AddU64$0$anon3_Then$1_correct@@0  (=> (= $abort_flag@2@@9 true) (=> (and (= $abort_code@3@@9 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@0@@0)) (and (=> (= (ControlFlow 0 238902) 238985) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 238902) 238971) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct@@0  (=> (and (> (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1) $MAX_U64) (= (ControlFlow 0 238900) 238902)) inline$$AddU64$0$anon3_Then$1_correct@@0)))
(let ((inline$$AddU64$0$anon3_Else_correct@@0  (=> (>= $MAX_U64 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1@@0 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (= $abort_flag@2@@9 $abort_flag@1@@10)) (and (= $abort_code@3@@9 $abort_code@2@@10) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@1@@0))) (and (=> (= (ControlFlow 0 238848) 238985) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 238848) 238971) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct  (=> (and (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 238908) 238900) inline$$AddU64$0$anon3_Then_correct@@0) (=> (= (ControlFlow 0 238908) 238848) inline$$AddU64$0$anon3_Else_correct@@0)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct  (=> (and (not $abort_flag@1@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 _$t2@@1))) (and (=> (= (ControlFlow 0 238741) 240009) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct) (=> (= (ControlFlow 0 238741) 238908) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct  (=> $abort_flag@1@@10 (=> (and (and (= $abort_code@2@@10 $abort_code@2@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2@@10)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 240047) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@1  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1)) (and (=> (= (ControlFlow 0 238721) 240047) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct) (=> (= (ControlFlow 0 238721) 238741) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct  (=> (not $abort_flag@1@@10) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 238727) 238721)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@1))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct  (=> $abort_flag@1@@10 (=> (and (and (= $abort_code@2@@10 $abort_code@2@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2@@10)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 240061) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|  (=> (= $abort_code@2@@10 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@10 true) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@0|)) (and (=> (= (ControlFlow 0 238606) 240061) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 238606) 238727) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (and (>= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 0) (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1)))) (= (ControlFlow 0 238604) 238606)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (and (>= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 0) (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (seq.nth inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1)) (= $abort_code@2@@10 $abort_code@1@@10)) (and (= $abort_flag@1@@10 $abort_flag@0@@10) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 238554) 240061) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 238554) 238727) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct  (=> inline$$Lt$0$dst@1@@1 (and (=> (= (ControlFlow 0 238612) 238604) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 238612) 238554) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct  (=> (not inline$$Lt$0$dst@1@@1) (and (=> (= (ControlFlow 0 238467) (- 0 293283)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (and (=> (= (ControlFlow 0 238467) (- 0 293290)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)))
...
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1))
 ...
 :qid |unknown.0:0|
 :skolemid |202|
))) (=> (|$IsValid'u64'| 4) (=> (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 7)) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 238467) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct  (and (=> (= (ControlFlow 0 238386) 238612) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct) (=> (= (ControlFlow 0 238386) 238467) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct))))
(let ((inline$$Lt$0$anon0_correct@@1  (=> (and (= inline$$Lt$0$dst@1@@1 (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (= (ControlFlow 0 238376) 238386)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct  (=> (and (not $abort_flag@0@@10) (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0| |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (and (=> (= (ControlFlow 0 238382) (- 0 293121)) (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (and (=> (= (ControlFlow 0 238382) (- 0 293128)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@2 ($Range 0 0)))
...
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4))
 ...
 :qid |unknown.0:0|
 :skolemid |201|
))) (= (ControlFlow 0 238382) 238376)))) inline$$Lt$0$anon0_correct@@1)))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct  (=> $abort_flag@0@@10 (=> (and (and (= $abort_code@1@@10 $abort_code@1@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1@@10)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 240075) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0| (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1)) (and (=> (= (ControlFlow 0 238186) 240075) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct) (=> (= (ControlFlow 0 238186) 238382) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct  (=> (and (not $abort_flag@0@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2))) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 238192) 238186))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct@@0|))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct  (=> $abort_flag@0@@10 (=> (and (and (= $abort_code@1@@10 $abort_code@1@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1@@10)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 240089) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct  (=> (= $abort_flag@0@@10 true) (=> (and (= $abort_code@1@@10 $EXEC_FAILURE_CODE) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@0)) (and (=> (= (ControlFlow 0 240141) 240089) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 240141) 238192) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (= (ControlFlow 0 240139) 240141)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (= $abort_flag@0@@10 false)) (and (= $abort_code@1@@10 $abort_code@0@@10) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1))) (and (=> (= (ControlFlow 0 238122) 240089) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 238122) 238192) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 (and (=> (= (ControlFlow 0 238108) 240139) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct) (=> (= (ControlFlow 0 238108) 238122) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 238104) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 7)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1))) (and (=> (= (ControlFlow 0 238088) 238108) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct) (=> (= (ControlFlow 0 238088) 238104) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t1@@5)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1) (= (ControlFlow 0 238054) 238088))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct  (=> (and (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= true true)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 true) (= (ControlFlow 0 240159) 238088))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (=> (and (and (|$IsValid'address'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 (|$addr#$signer| _$t0@@10))) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t2@@1)))) (and (=> (= (ControlFlow 0 238032) 240159) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct) (=> (= (ControlFlow 0 238032) 238054) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 237996) 238002))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct  (=> (and (= _$t0@@10 _$t0@@10) (= _$t1@@5 _$t1@@5)) (=> (and (and (and (= _$t2@@1 _$t2@@1) (= _$t3@@0 _$t3@@0)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@5)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 5)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1)))) (and (=> (= (ControlFlow 0 237980) 238032) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct) (=> (= (ControlFlow 0 237980) 237996) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct))))))
(let ((anon0$1_correct@@10  (=> (forall ((addr@@295 Int) ) (!  (=> (|$IsValid'address'| addr@@295) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@295) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@295)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@295)))) 0)) (= addr@@295 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@295))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.15526:20|
 :skolemid |439|
)) (=> (and (and (and (forall ((addr@@296 Int) ) (!  (=> (|$IsValid'address'| addr@@296) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@296) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@296) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@296)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@296)))) 0)) (= addr@@296 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@296))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.15530:20|
 :skolemid |440|
)) (forall ((addr@@297 Int) ) (!  (=> (|$IsValid'address'| addr@@297) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@297) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@297)))
 :qid |AccountAdministrationScriptsbpl.15534:20|
 :skolemid |441|
))) (and (forall ((addr@@298 Int) ) (!  (=> (|$IsValid'address'| addr@@298) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@298)  (and (= addr@@298 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@298))))
 :qid |AccountAdministrationScriptsbpl.15538:20|
 :skolemid |442|
)) (forall ((addr@@299 Int) ) (!  (=> (|$IsValid'address'| addr@@299) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@299)  (and (= addr@@299 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@299))))
 :qid |AccountAdministrationScriptsbpl.15542:20|
 :skolemid |443|
)))) (and (and (forall ((addr@@300 Int) ) (!  (=> (|$IsValid'address'| addr@@300) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@300) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@300)))
 :qid |AccountAdministrationScriptsbpl.15546:20|
 :skolemid |444|
)) (forall ((addr@@301 Int) ) (!  (=> (|$IsValid'address'| addr@@301) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@301) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@301)))
 :qid |AccountAdministrationScriptsbpl.15550:20|
 :skolemid |445|
))) (and (forall ((addr@@302 Int) ) (!  (=> (|$IsValid'address'| addr@@302) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@302) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@302))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@302)) 0)) addr@@302))))
 :qid |AccountAdministrationScriptsbpl.15554:20|
 :skolemid |446|
)) (forall ((addr@@303 Int) ) (!  (=> (|$IsValid'address'| addr@@303) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@303) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) addr@@303) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) addr@@303))))
 :qid |AccountAdministrationScriptsbpl.15558:20|
 :skolemid |447|
))))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@10)) ($1_Signer_is_txn_signer _$t0@@10)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@10))) (and (and (|$IsValid'address'| _$t1@@5) (|$IsValid'address'| _$t2@@1)) (and (|$IsValid'vec'u8''| _$t3@@0) (forall (($a_0@@30 Int) ) (! (let (($rsc@@30 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@30)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc@@30) (and (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc@@30))) 1) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc@@30))) 1))))
 :qid |AccountAdministrationScriptsbpl.15573:20|
 :skolemid |448|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@30))
))))) (and (and (and (forall (($a_0@@31 Int) ) (! (let (($rsc@@31 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@31)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@31))
 :qid |AccountAdministrationScriptsbpl.15577:20|
 :skolemid |449|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@31))
)) (= $t4@@5 (|$addr#$signer| _$t0@@10))) (and (let ((addr@@304 (|$addr#$signer| _$t0@@10)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@304)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@304) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@304)))))) (= _$t0@@10 _$t0@@10))) (and (and (= _$t1@@5 _$t1@@5) (= _$t2@@1 _$t2@@1)) (and (= _$t3@@0 _$t3@@0) (= (ControlFlow 0 240163) 237980))))) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct@@10  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@12 T@$1_Event_EventHandle) ) (! (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@12)))
 (and (= (|l#Multiset_72203| stream@@11) 0) (forall ((v@@52 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@11) v@@52) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 236369) 240163)) anon0$1_correct@@10)))
(let ((anon0_correct@@10  (=> (= (ControlFlow 0 291988) 236369) inline$$InitEventStore$0$anon0_correct@@10)))
anon0_correct@@10)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
