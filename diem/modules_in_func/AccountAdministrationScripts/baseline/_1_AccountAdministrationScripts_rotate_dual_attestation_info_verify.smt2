...
(declare-fun $1_DualAttestation_Credential_$memory () T@$Memory_128561)
(declare-fun $t3 () Int)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory () T@$Memory_113710)
(declare-fun _$t2 () T@Vec_22899)
(declare-fun $t5 () Int)
...
(declare-fun $1_DualAttestation_Credential_$memory@3 () T@$Memory_128561)
(declare-fun $t4 () Int)
(declare-fun _$t1 () T@Vec_22899)
(declare-fun $t6 () Int)
(declare-fun $es@5 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun $t8 () T@$1_Event_EventHandle)
(declare-fun $t9 () T@$1_DualAttestation_BaseUrlRotationEvent)
(declare-fun |Store__T@[$EventRep]Int_| (|T@[$EventRep]Int| T@$EventRep Int) |T@[$EventRep]Int|)
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?x2 Int)) (! (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$EventRep]Int|) ( ?x1 T@$EventRep) ( ?y1 T@$EventRep) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$EventRep]Int_| (|Store__T@[$EventRep]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$EventRep]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_74026_| (|T@[$1_Event_EventHandle]Multiset_74026| T@$1_Event_EventHandle T@Multiset_74026) |T@[$1_Event_EventHandle]Multiset_74026|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_74026|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_74026)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|Store__T@[$1_Event_EventHandle]Multiset_74026_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_74026|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_74026)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|Store__T@[$1_Event_EventHandle]Multiset_74026_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_74026_| ?x0 ?y1))) :weight 0)))
(declare-fun $t11 () T@$1_Event_EventHandle)
(declare-fun $t12 () T@$1_DualAttestation_ComplianceKeyRotationEvent)
(declare-fun $abort_flag@2 () Bool)
(declare-fun $1_DualAttestation_Credential_$memory@2 () T@$Memory_128561)
(declare-fun |Store__T@[Int]Bool_| (|T@[Int]Bool| Int Bool) |T@[Int]Bool|)
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?x2 Bool)) (! (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Bool)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Bool_| ?x0 ?y1))) :weight 0)))
(declare-fun $1_DualAttestation_Credential_$memory@1 () T@$Memory_128561)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3 () T@$Mutation_129472)
...
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 () Int)
...
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@1 () T@$Mutation_106978)
(declare-fun $es@2 () T@$EventStore)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1 () T@$1_DualAttestation_ComplianceKeyRotationEvent)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0 () Bool)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0 () Int)
(declare-fun |Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds| Int) T@$1_DiemTimestamp_CurrentTimeMicroseconds)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0 () Int)
(declare-fun |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1| () T@$1_DualAttestation_Credential)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1 () T@$Mutation_99130)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@2 () T@$Mutation_99130)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@0 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@1 () T@$Mutation_129472)
...
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 () Bool)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t7@0 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@0 () T@$Mutation_99130)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@0 () T@$Mutation_106978)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t8@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t9@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t10@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t11@0 () T@$1_Event_EventHandle)
(declare-fun inline$$1_DualAttestation_rotate_compliance_public_key$0$$t12@0 () T@$1_DualAttestation_ComplianceKeyRotationEvent)
(declare-fun $t19 () Int)
(declare-fun $t20 () Int)
(declare-fun $t21 () Int)
(declare-fun $t22 () T@$1_Event_EventHandle)
(declare-fun $t23 () T@$1_DualAttestation_ComplianceKeyRotationEvent)
(declare-fun $abort_flag@0 () Bool)
(declare-fun $1_DualAttestation_Credential_$memory@0 () T@$Memory_128561)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t16@3 () T@$Mutation_129472)
(declare-fun $abort_code@1 () Int)
(declare-fun $es@0 () T@$EventStore)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t15@1 () Int)
...
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t18@1 () T@$Mutation_106978)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t21@1 () T@$1_DualAttestation_BaseUrlRotationEvent)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t20@0 () Bool)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t19@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t15@0 () Int)
(declare-fun |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1| () T@$1_DualAttestation_Credential)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t16@2 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t17@1 () T@$Mutation_99130)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t17@2 () T@$Mutation_99130)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t16@0 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t11@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t16@1 () T@$Mutation_129472)
(declare-fun $abort_code@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t12@1 () Bool)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t14@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t5@0 () T@$Mutation_129472)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t17@0 () T@$Mutation_99130)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t18@0 () T@$Mutation_106978)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t6@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t7@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t8@0 () Int)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t9@0 () T@$1_Event_EventHandle)
(declare-fun inline$$1_DualAttestation_rotate_base_url$0$$t10@0 () T@$1_DualAttestation_BaseUrlRotationEvent)
(declare-fun $1_Roles_RoleId_$memory () T@$Memory_113898)
(declare-fun |Select__T@[Int]$1_Roles_RoleId_| (|T@[Int]$1_Roles_RoleId| Int) T@$1_Roles_RoleId)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory () T@$Memory_116706)
(declare-fun $1_DiemConfig_Configuration_$memory () T@$Memory_117237)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory| () T@$Memory_117156)
(declare-fun $1_DiemSystem_CapabilityHolder_$memory () T@$Memory_118664)
(declare-fun |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory| () T@$Memory_117336)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_118995)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory| () T@$Memory_126487)
(declare-fun $1_XDX_Reserve_$memory () T@$Memory_126782)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_119114)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory| () T@$Memory_126706)
(declare-fun |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory| () T@$Memory_128382)
(declare-fun $1_DualAttestation_Limit_$memory () T@$Memory_128625)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory| () T@$Memory_117400)
(declare-fun $1_ChainId_ChainId_$memory () T@$Memory_131819)
(declare-fun $1_AccountFreezing_FreezeEventsHolder_$memory () T@$Memory_138731)
...
(declare-fun $1_DiemBlock_BlockMetadata_$memory () T@$Memory_170508)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory| () T@$Memory_117464)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory| () T@$Memory_117528)
...
(declare-fun $t17 () T@$1_DualAttestation_BaseUrlRotationEvent)
(push 1)
(set-info :boogie-vc-id $1_AccountAdministrationScripts_rotate_dual_attestation_info$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 312403) (let ((L2_correct  (and (=> (= (ControlFlow 0 256486) (- 0 314884)) (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0))))) (=> (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 256486) (- 0 314931)) (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t3)) (= 5 $t18@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t18@0))) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2)) (= 7 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t5)) (= 5 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t18@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0))) (= 5 $t18@0))) (= 5 $t18@0)) (= 7 $t18@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t18@0 $abort_code@4) (= (ControlFlow 0 256306) 256486))) L2_correct)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t18@0 $abort_code@2) (= (ControlFlow 0 256500) 256486))) L2_correct)))
(let ((anon7_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 256292) (- 0 314619)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t3))) (and (=> (= (ControlFlow 0 256292) (- 0 314631)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 256292) (- 0 314641)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2))) (and (=> (= (ControlFlow 0 256292) (- 0 314651)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) $t5))) (and (=> (= (ControlFlow 0 256292) (- 0 314663)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 256292) (- 0 314673)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 256292) (- 0 314686)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) $t4)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) $t4)) _$t1) (and (=> (= (ControlFlow 0 256292) (- 0 314699)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (not (= addr1 $t4)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) addr1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1)))))
 :qid |AccountAdministrationScriptsbpl.16093:15|
 :skolemid |480|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (not (= addr1@@0 $t4)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) addr1@@0)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1@@0)))))
 :qid |AccountAdministrationScriptsbpl.16093:15|
 :skolemid |480|
)) (and (=> (= (ControlFlow 0 256292) (- 0 314737)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) $t6)) _$t2)) (=> (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) $t6)) _$t2) (and (=> (= (ControlFlow 0 256292) (- 0 314750)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t6)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) addr1@@1)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |AccountAdministrationScriptsbpl.16103:15|
 :skolemid |481|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t6)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@3) addr1@@2)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |AccountAdministrationScriptsbpl.16103:15|
 :skolemid |481|
)) (and (=> (= (ControlFlow 0 256292) (- 0 314788)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new (let ((len (|l#Multiset_74026| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@52 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected) handle@@1)) v@@52) (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual) handle@@1)) v@@52))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.2965:13|
 :skolemid |106|
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_74026| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@53 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@0) handle@@2)) v@@53) (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@0) handle@@2)) v@@53))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.2965:13|
 :skolemid |106|
))))) (and (=> (= (ControlFlow 0 256292) (- 0 314813)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_74026| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@1))))) $t11)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_74026| stream@@2)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_74026| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@1))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_74026| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@1))))) $t11 stream_new@@2))))))
 (and (<= (|counter#$EventStore| expected@@1) (|counter#$EventStore| actual@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@1) handle@@3)) (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@1) handle@@3))) (forall ((v@@54 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@1) handle@@3)) v@@54) (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@1) handle@@3)) v@@54))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.2965:13|
 :skolemid |106|
)))))) (=> (let ((actual@@2 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@2 (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_74026| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@3))))) $t11)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_74026| stream@@4)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@4) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@4) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_74026| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@3))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_74026| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@5) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@3))))) $t11 stream_new@@4))))))
 (and (<= (|counter#$EventStore| expected@@2) (|counter#$EventStore| actual@@2)) (forall ((handle@@4 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@2) handle@@4)) (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@2) handle@@4))) (forall ((v@@55 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@2) handle@@4)) v@@55) (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@2) handle@@4)) v@@55))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 256292) (- 0 314844)) (let ((actual@@3 ($EventStore (- (|counter#$EventStore| $es@5) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@5) (|streams#$EventStore| $es)))))
(let ((expected@@3 (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_74026| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@5))))) $t11)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_74026| stream@@6)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@6) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@6) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_74026| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@5))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_74026| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@7) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t9) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $EmptyEventStore) $t8 stream_new@@5))))) $t11 stream_new@@6))))))
 (and (<= (|counter#$EventStore| actual@@3) (|counter#$EventStore| expected@@3)) (forall ((handle@@5 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@3) handle@@5)) (|l#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@3) handle@@5))) (forall ((v@@56 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| actual@@3) handle@@5)) v@@56) (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| expected@@3) handle@@5)) v@@56))
 :qid |AccountAdministrationScriptsbpl.164:13|
 :skolemid |5|
)))
 :qid |AccountAdministrationScriptsbpl.2965:13|
...
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Else_correct  (=> (and (not $abort_flag@2) (= $1_DualAttestation_Credential_$memory@2 ($Memory_128561 (|Store__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory@1) (|a#$Global| (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@1) (|a#$Global| (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3))))) (=> (and (and (= $1_DualAttestation_Credential_$memory@3 $1_DualAttestation_Credential_$memory@2) (= $abort_code@4 $abort_code@3)) (and (= $es@5 $es@3) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 255888) 256306) anon7_Then_correct) (=> (= (ControlFlow 0 255888) 256292) anon7_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct  (=> (and (and (= $1_DualAttestation_Credential_$memory@3 $1_DualAttestation_Credential_$memory@1) (= $abort_code@4 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1)) (and (= $es@5 $es@4) (= $abort_flag@3 true))) (and (=> (= (ControlFlow 0 255565) 256306) anon7_Then_correct) (=> (= (ControlFlow 0 255565) 256292) anon7_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Then_correct  (=> $abort_flag@2 (=> (and (and (= $abort_code@3 $abort_code@3) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@3)) (and (= $es@4 $es@3) (= (ControlFlow 0 255902) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| (|v#$Mutation_106978| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@1)) (= $es@3 (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es@2) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1|)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_74026| stream@@8)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@8) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@8) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es@2) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es@2) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| stream_new@@7)))))) (and (=> (= (ControlFlow 0 255860) 255902) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Then_correct) (=> (= (ControlFlow 0 255860) 255888) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon25_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Else_correct  (=> (not inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t26@1 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t24@0)) (= (ControlFlow 0 255866) 255860))) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Then_correct  (=> inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0)) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 255928) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct  (=> (and (and (and (not $abort_flag@2) (= |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2))) (and (= |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1| |inline$$1_DualAttestation_rotate_compliance_public_key$0$$temp_0'$1_DualAttestation_Credential'@1|) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1 ($Mutation_99130 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) (let ((l (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) l 2) (+ l 1))) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)))))) (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@2 ($Mutation_99130 (|l#$Mutation_99130| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1) (|p#$Mutation_99130| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@1) _$t2)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3 ($Mutation_129472 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|v#$Mutation_99130| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@2) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2)))))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@1 ($Mutation_106978 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3) (let ((l@@0 (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)) l@@0 4) (+ l@@0 1))) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@3)))) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t25@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 255761) 255928) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Then_correct) (=> (= (ControlFlow 0 255761) 255866) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon24_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct  (=> $abort_flag@2 (=> (and (and (= $abort_code@3 $abort_code@3) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@3)) (and (= $es@4 $es@2) (= (ControlFlow 0 255942) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then$1_correct  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@0)) (and (=> (= (ControlFlow 0 255994) 255942) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct) (=> (= (ControlFlow 0 255994) 255761) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (= (ControlFlow 0 255992) 255994)) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then$1_correct)))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@1 ($Mutation_129472 ($Global inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0) (Vec_22899 (MapConstVec_14643 DefaultVecElem_14643) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0))) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@2 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@1))) (and (=> (= (ControlFlow 0 255683) 255942) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Then_correct) (=> (= (ControlFlow 0 255683) 255761) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon23_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Then_correct  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (and (=> (= (ControlFlow 0 255661) 255992) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Then_correct) (=> (= (ControlFlow 0 255661) 255683) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon22_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Else_correct  (=> (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 255657) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 7)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t20@0) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 255641) 255661) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Then_correct) (=> (= (ControlFlow 0 255641) 255657) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon21_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 $abort_code@2)) (and (= $es@4 $es@2) (= (ControlFlow 0 256008) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t2)) (and (=> (= (ControlFlow 0 255599) 256008) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Then_correct) (=> (= (ControlFlow 0 255599) 255641) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon20_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Then_correct  (=> (and inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 (= (ControlFlow 0 255605) 255599)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Else_correct  (=> (not inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1) (=> (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t17@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0)) (and (= $es@4 $es@2) (= (ControlFlow 0 255559) 255565))) inline$$1_DualAttestation_rotate_compliance_public_key$0$L5_correct))))
(let ((inline$$1_DualAttestation_rotate_compliance_public_key$0$anon0_correct  (=> (and (and (= (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t7@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t21@0)) 0)) (and (= (|l#Vec_22899| (|p#$Mutation_99130| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t22@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_106978| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t23@0)) 0))) (=> (and (and (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t8@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t9@0 (|$addr#$signer| _$t0))) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t10@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t11@0 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t10@0))))) (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t12@0 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t2 _$t2) (|$IsValid'address'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)))) (and (and (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory@1) inline$$1_DualAttestation_rotate_compliance_public_key$0$$t13@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 5)) (and (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t16@0) (= inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1 inline$$1_DualAttestation_rotate_compliance_public_key$0$$t14@1))))) (and (=> (= (ControlFlow 0 255543) 255605) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 255543) 255559) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon19_Else_correct))))))
(let ((anon6_Else_correct  (=> (not $abort_flag@1) (=> (and (= $t19 (|$addr#$signer| _$t0)) (= $t20 (|$addr#$signer| _$t0))) (=> (and (and (= $t21 (|$addr#$signer| _$t0)) (= $t22 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory@1) $t21)))) (and (= $t23 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= (ControlFlow 0 256012) 255543))) inline$$1_DualAttestation_rotate_compliance_public_key$0$anon0_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon18_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_128561 (|Store__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3))))) (=> (and (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0)) (and (= $es@2 $es@0) (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory@0))) (and (=> (= (ControlFlow 0 254499) 256500) anon6_Then_correct) (=> (= (ControlFlow 0 254499) 256012) anon6_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$L3_correct  (=> (and (and (= $abort_code@2 inline$$1_DualAttestation_rotate_base_url$0$$t15@1) (= $abort_flag@1 true)) (and (= $es@2 $es@1) (= $1_DualAttestation_Credential_$memory@1 $1_DualAttestation_Credential_$memory))) (and (=> (= (ControlFlow 0 254268) 256500) anon6_Then_correct) (=> (= (ControlFlow 0 254268) 256012) anon6_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon18_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 $abort_code@1)) (and (= $es@1 $es@0) (= (ControlFlow 0 254513) 254268))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_106978| inline$$1_DualAttestation_rotate_base_url$0$$t18@1)) (= $es@0 (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@8 (let ((len@@8 (|l#Multiset_74026| stream@@9)))
(let ((cnt@@8 (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@9) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| inline$$1_DualAttestation_rotate_base_url$0$$t21@1))))
(Multiset_74026 (|Store__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@9) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| inline$$1_DualAttestation_rotate_base_url$0$$t21@1) (+ cnt@@8 1)) (+ len@@8 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| stream_new@@8)))))) (and (=> (= (ControlFlow 0 254471) 254513) inline$$1_DualAttestation_rotate_base_url$0$anon18_Then_correct) (=> (= (ControlFlow 0 254471) 254499) inline$$1_DualAttestation_rotate_base_url$0$anon18_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon17_Else_correct  (=> (not inline$$1_DualAttestation_rotate_base_url$0$$t20@0) (=> (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_base_url$0$$t19@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t19@0 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t21@1 ($1_DualAttestation_BaseUrlRotationEvent _$t1 inline$$1_DualAttestation_rotate_base_url$0$$t19@0)) (= (ControlFlow 0 254477) 254471))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon17_Then_correct  (=> inline$$1_DualAttestation_rotate_base_url$0$$t20@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_DualAttestation_rotate_base_url$0$$t15@0)) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t15@0 inline$$1_DualAttestation_rotate_base_url$0$$t15@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 inline$$1_DualAttestation_rotate_base_url$0$$t15@0)) (and (= $es@1 $es) (= (ControlFlow 0 254539) 254268))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2))) (and (= |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1| |inline$$1_DualAttestation_rotate_base_url$0$$temp_0'$1_DualAttestation_Credential'@1|) (= inline$$1_DualAttestation_rotate_base_url$0$$t17@1 ($Mutation_99130 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) (let ((l@@1 (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) l@@1 1) (+ l@@1 1))) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)))))) (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t17@2 ($Mutation_99130 (|l#$Mutation_99130| inline$$1_DualAttestation_rotate_base_url$0$$t17@1) (|p#$Mutation_99130| inline$$1_DualAttestation_rotate_base_url$0$$t17@1) _$t1)) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@3 ($Mutation_129472 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|v#$Mutation_99130| inline$$1_DualAttestation_rotate_base_url$0$$t17@2) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@2)))))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t18@1 ($Mutation_106978 (|l#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3) (let ((l@@2 (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)) l@@2 5) (+ l@@2 1))) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@3)))) (= inline$$1_DualAttestation_rotate_base_url$0$$t20@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 254372) 254539) inline$$1_DualAttestation_rotate_base_url$0$anon17_Then_correct) (=> (= (ControlFlow 0 254372) 254477) inline$$1_DualAttestation_rotate_base_url$0$anon17_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 $abort_code@1)) (and (= $es@1 $es) (= (ControlFlow 0 254553) 254268))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@2 inline$$1_DualAttestation_rotate_base_url$0$$t16@0)) (and (=> (= (ControlFlow 0 254605) 254553) inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct) (=> (= (ControlFlow 0 254605) 254372) inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (= (ControlFlow 0 254603) 254605)) inline$$1_DualAttestation_rotate_base_url$0$anon15_Then$1_correct)))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t16@1 ($Mutation_129472 ($Global inline$$1_DualAttestation_rotate_base_url$0$$t11@0) (Vec_22899 (MapConstVec_14643 DefaultVecElem_14643) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0))) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t16@2 inline$$1_DualAttestation_rotate_base_url$0$$t16@1))) (and (=> (= (ControlFlow 0 254294) 254553) inline$$1_DualAttestation_rotate_base_url$0$anon16_Then_correct) (=> (= (ControlFlow 0 254294) 254372) inline$$1_DualAttestation_rotate_base_url$0$anon16_Else_correct))))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon14_Then_correct  (=> inline$$1_DualAttestation_rotate_base_url$0$$t12@1 (and (=> (= (ControlFlow 0 254272) 254603) inline$$1_DualAttestation_rotate_base_url$0$anon15_Then_correct) (=> (= (ControlFlow 0 254272) 254294) inline$$1_DualAttestation_rotate_base_url$0$anon15_Else_correct)))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon14_Else_correct  (=> (not inline$$1_DualAttestation_rotate_base_url$0$$t12@1) (=> (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t15@1 inline$$1_DualAttestation_rotate_base_url$0$$t14@0)) (and (= $es@1 $es) (= (ControlFlow 0 254262) 254268))) inline$$1_DualAttestation_rotate_base_url$0$L3_correct))))
(let ((inline$$1_DualAttestation_rotate_base_url$0$anon0_correct  (=> (and (and (= (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t5@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_129472| inline$$1_DualAttestation_rotate_base_url$0$$t16@0)) 0)) (and (= (|l#Vec_22899| (|p#$Mutation_99130| inline$$1_DualAttestation_rotate_base_url$0$$t17@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_106978| inline$$1_DualAttestation_rotate_base_url$0$$t18@0)) 0))) (=> (and (and (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t6@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_base_url$0$$t7@0 (|$addr#$signer| _$t0))) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t8@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_base_url$0$$t9@0 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t8@0))))) (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t10@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| inline$$1_DualAttestation_rotate_base_url$0$$t11@0)))) (and (and (and (= inline$$1_DualAttestation_rotate_base_url$0$$t11@0 (|$addr#$signer| _$t0)) (= inline$$1_DualAttestation_rotate_base_url$0$$t11@0 inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t12@1 (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) inline$$1_DualAttestation_rotate_base_url$0$$t11@0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 5)) (and (= inline$$1_DualAttestation_rotate_base_url$0$$t14@0 inline$$1_DualAttestation_rotate_base_url$0$$t14@0) (= inline$$1_DualAttestation_rotate_base_url$0$$t12@1 inline$$1_DualAttestation_rotate_base_url$0$$t12@1))))) (and (=> (= (ControlFlow 0 254246) 254272) inline$$1_DualAttestation_rotate_base_url$0$anon14_Then_correct) (=> (= (ControlFlow 0 254246) 254262) inline$$1_DualAttestation_rotate_base_url$0$anon14_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) 186537453)) 1))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116706| $1_SlidingNonce_SlidingNonce_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116706| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117237| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_117156| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118664| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117336| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))))) (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118995| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126487| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126782| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119114| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126706| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_128382| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_128625| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) addr1@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr1@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr1@@3)) 2)))))
 :qid |AccountAdministrationScriptsbpl.15864:20|
 :skolemid |476|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117400| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_131819| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138731| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138731| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140007| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_140502| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))))) (=> (and (and (and (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128561| $1_DualAttestation_Credential_$memory) addr)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr)) 5)))))
 :qid |AccountAdministrationScriptsbpl.15900:20|
 :skolemid |477|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_170508| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117464| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117528| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'vec'u8''| _$t1) (|$IsValid'vec'u8''| _$t2)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |AccountAdministrationScriptsbpl.15924:20|
 :skolemid |478|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |AccountAdministrationScriptsbpl.15928:20|
 :skolemid |479|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) $a_0@@0))
)))) (and (and (= $t3 (|$addr#$signer| _$t0)) (= $t4 (|$addr#$signer| _$t0))) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6 (|$addr#$signer| _$t0)))))) (and (and (and (and (= $t7 (|$addr#$signer| _$t0)) (= $t8 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) $t7)))) (and (= $t9 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= $t10 (|$addr#$signer| _$t0)))) (and (and (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) $t10))) (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t2 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)))) (and (let ((addr@@0 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))))) (= _$t0 _$t0)))) (and (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= $t13 (|$addr#$signer| _$t0)) (= $t14 (|$addr#$signer| _$t0)))) (and (and (= $t15 (|$addr#$signer| _$t0)) (= $t16 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_128561| $1_DualAttestation_Credential_$memory) $t15)))) (and (= $t17 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= (ControlFlow 0 254609) 254246)))))) inline$$1_DualAttestation_rotate_base_url$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) handle@@6)))
 (and (= (|l#Multiset_74026| stream@@10) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_74026| stream@@10) v@@57) 0)
 :qid |AccountAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |AccountAdministrationScriptsbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 252830) 254609)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 312403) 252830) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
