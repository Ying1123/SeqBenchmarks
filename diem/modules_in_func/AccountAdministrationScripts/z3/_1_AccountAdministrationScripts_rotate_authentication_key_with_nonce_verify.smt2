...
(assert (not
 (=> (= (ControlFlow 0 0) 285355) (let ((L2_correct@@2  (and (=> (= (ControlFlow 0 230296) (- 0 288434)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (not (= (seq.len _$t2) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (not (= (seq.len _$t2) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0)) (=> (= (ControlFlow 0 230296) (- 0 288501)) (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 $t7@0@@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3) 0)) (= 7 $t7@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t6@@2)) (= 5 $t7@0@@0))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0) (= 1 $t7@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3))) (= 5 $t7@0@@0))) (and (not (= (seq.len _$t2) 32)) (= 7 $t7@0@@0))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0) (= 1 $t7@0@@0))) (= 7 $t7@0@@0)) (= 1 $t7@0@@0)) (= 5 $t7@0@@0)))))))
(let ((anon13_Then_correct  (=> (and (and $abort_flag@8@@3 (= $abort_code@9@@3 $abort_code@9@@3)) (and (= $t7@0@@0 $abort_code@9@@3) (= (ControlFlow 0 230052) 230296))) L2_correct@@2)))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@6@@5 (= $abort_code@7@@4 $abort_code@7@@4)) (and (= $t7@0@@0 $abort_code@7@@4) (= (ControlFlow 0 230310) 230296))) L2_correct@@2)))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= $t7@0@@0 $abort_code@5@@7) (= (ControlFlow 0 230324) 230296))) L2_correct@@2)))
(let ((anon10_Then_correct@@0  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t7@0@@0 $abort_code@1@@8) (= (ControlFlow 0 230338) 230296))) L2_correct@@2)))
(let ((anon13_Else_correct  (=> (not $abort_flag@8@@3) (and (=> (= (ControlFlow 0 230038) (- 0 288316)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8)))) (and (=> (= (ControlFlow 0 230038) (- 0 288329)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3) 0))) (and (=> (= (ControlFlow 0 230038) (- 0 288344)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t6@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (and (=> (= (ControlFlow 0 230038) (- 0 288356)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0)) (and (=> (= (ControlFlow 0 230038) (- 0 288367)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (and (=> (= (ControlFlow 0 230038) (- 0 288381)) (not (not (= (seq.len _$t2) 32)))) (=> (not (not (= (seq.len _$t2) 32))) (and (=> (= (ControlFlow 0 230038) (- 0 288395)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@8))))) 0)) (=> (= (ControlFlow 0 230038) (- 0 288406)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@5@@0) $t4@@4)) _$t2)))))))))))))))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@0  (=> (not inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0) (=> (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0 ($Mutation_131965 (|l#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0) (|p#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0) |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@0|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) (=> (and (and (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) 1)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) 0))) (and (= (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0)) 0) inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (|p#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@4@@0 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)) (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)))) (= $1_DiemAccount_DiemAccount_$memory@5@@0 $1_DiemAccount_DiemAccount_$memory@4@@0)) (and (= $abort_code@9@@3 $abort_code@8@@4) (= $abort_flag@8@@3 $abort_flag@7@@4)))) (and (=> (= (ControlFlow 0 229810) 230052) anon13_Then_correct) (=> (= (ControlFlow 0 229810) 230038) anon13_Else_correct)))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0  (=> (= $1_DiemAccount_DiemAccount_$memory@5@@0 $1_DiemAccount_DiemAccount_$memory@3@@0) (=> (and (= $abort_code@9@@3 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0) (= $abort_flag@8@@3 true)) (and (=> (= (ControlFlow 0 229656) 230052) anon13_Then_correct) (=> (= (ControlFlow 0 229656) 230038) anon13_Else_correct))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@0  (=> inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0 (=> (and (and (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0))) 0)) (= 7 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0)) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0) (= (ControlFlow 0 229836) 229656))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0  (=> (not $abort_flag@7@@4) (=> (and (and (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0|)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0 ($Mutation_131965 (|l#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)))) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0  (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0))) 0))))) (and (=> (= (ControlFlow 0 229728) 229836) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@0) (=> (= (ControlFlow 0 229728) 229810) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0  (=> (and (and $abort_flag@7@@4 (= $abort_code@8@@4 $abort_code@8@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 $abort_code@8@@4) (= (ControlFlow 0 229850) 229656))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@0  (=> (= $abort_flag@7@@4 true) (=> (and (= $abort_code@8@@4 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0)) (and (=> (= (ControlFlow 0 229902) 229850) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0) (=> (= (ControlFlow 0 229902) 229728) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0)) (= (ControlFlow 0 229900) 229902)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0) (=> (and (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0 ($Mutation_131921 ($Global inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0))) (= $abort_flag@7@@4 $abort_flag@6@@5)) (and (= $abort_code@8@@4 $abort_code@7@@4) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0))) (and (=> (= (ControlFlow 0 229686) 229850) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0) (=> (= (ControlFlow 0 229686) 229728) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@0  (=> (and inline$$1_DiemAccount_exists_at$3$$t1@1@@0 (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3))) (and (=> (= (ControlFlow 0 229664) 229900) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@0) (=> (= (ControlFlow 0 229664) 229686) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@0  (=> (and (and (not inline$$1_DiemAccount_exists_at$3$$t1@1@@0) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= (ControlFlow 0 229650) 229656))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@0  (=> (and (not $abort_flag@6@@5) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 inline$$1_DiemAccount_exists_at$3$$t1@1@@0))) (and (=> (= (ControlFlow 0 229634) 229664) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@0) (=> (= (ControlFlow 0 229634) 229650) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@0  (=> (and (and $abort_flag@6@@5 (= $abort_code@7@@4 $abort_code@7@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 $abort_code@7@@4) (= (ControlFlow 0 229916) 229656))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_exists_at$3$anon0_correct@@0  (=> (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0) (=> (and (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0)) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 inline$$1_DiemAccount_exists_at$3$$t1@1@@0)) (and (=> (= (ControlFlow 0 229592) 229916) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@0) (=> (= (ControlFlow 0 229592) 229634) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@0  (=> (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@0)) 0) (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_131965| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@0)) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 229598) 229592))) inline$$1_DiemAccount_exists_at$3$anon0_correct@@0))))
(let ((anon12_Else_correct  (=> (and (not $abort_flag@6@@5) (= (ControlFlow 0 229920) 229598)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@0)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@1  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1 ($Mutation_92207 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1 ($Mutation_92207 (|l#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1) (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1) _$t2)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) ($1_DiemAccount_DiemAccount (|v#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@2@@1 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)) (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)))) (= $abort_code@7@@4 $abort_code@6@@7)) (and (= $1_DiemAccount_DiemAccount_$memory@3@@0 $1_DiemAccount_DiemAccount_$memory@2@@1) (= $abort_flag@6@@5 $abort_flag@5@@7)))) (and (=> (= (ControlFlow 0 228897) 230310) anon12_Then_correct) (=> (= (ControlFlow 0 228897) 229920) anon12_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1  (=> (= $abort_code@7@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1) (=> (and (= $1_DiemAccount_DiemAccount_$memory@3@@0 $1_DiemAccount_DiemAccount_$memory@1@@3) (= $abort_flag@6@@5 true)) (and (=> (= (ControlFlow 0 228693) 230310) anon12_Then_correct) (=> (= (ControlFlow 0 228693) 229920) anon12_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= (ControlFlow 0 228847) 228693))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@1  (=> (and (and (and (not $abort_flag@5@@7) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 (= |inline$$1_Vector_length'u8'$0$l@1@@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1)))) (and (=> (= (ControlFlow 0 228831) 228897) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@1) (=> (= (ControlFlow 0 228831) 228847) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@1  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@6@@7) (= (ControlFlow 0 228911) 228693))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@1|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@1| (seq.len _$t2)) (and (=> (= (ControlFlow 0 228773) 228911) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@1) (=> (= (ControlFlow 0 228773) 228831) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1  (=> (and (and (not $abort_flag@5@@7) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1|) (= (ControlFlow 0 228779) 228773))) |inline$$1_Vector_length'u8'$0$anon0_correct@@1|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@6@@7) (= (ControlFlow 0 228925) 228693))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@1  (=> (= $abort_flag@5@@7 true) (=> (and (= $abort_code@6@@7 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1)) (and (=> (= (ControlFlow 0 228977) 228925) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1) (=> (= (ControlFlow 0 228977) 228779) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1)) (= (ControlFlow 0 228975) 228977)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1 ($Mutation_131921 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1))) (= $abort_flag@5@@7 $abort_flag@4@@7)) (and (= $abort_code@6@@7 $abort_code@5@@7) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1))) (and (=> (= (ControlFlow 0 228723) 228925) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1) (=> (= (ControlFlow 0 228723) 228779) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@1  (=> (and inline$$1_DiemAccount_exists_at$2$$t1@1@@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3))) (and (=> (= (ControlFlow 0 228701) 228975) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@1) (=> (= (ControlFlow 0 228701) 228723) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_exists_at$2$$t1@1@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= (ControlFlow 0 228687) 228693))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@1  (=> (and (not $abort_flag@4@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 inline$$1_DiemAccount_exists_at$2$$t1@1@@1))) (and (=> (= (ControlFlow 0 228671) 228701) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 228671) 228687) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@1  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@5@@7) (= (ControlFlow 0 228991) 228693))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_exists_at$2$anon0_correct@@1  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1) (=> (and (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1)) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 inline$$1_DiemAccount_exists_at$2$$t1@1@@1)) (and (=> (= (ControlFlow 0 228629) 228991) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 228629) 228671) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@1  (=> (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@1)) 0) (=> (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1)) 0) (= (seq.len (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@1)) 0)) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= _$t2 _$t2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 228635) 228629))) inline$$1_DiemAccount_exists_at$2$anon0_correct@@1)))))
(let ((anon11_Else_correct  (=> (not $abort_flag@4@@7) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= (ControlFlow 0 228995) 228635)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@1))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@3  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3 ($Mutation_131965 (|l#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3) (|p#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@3|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@3) 0)))) (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0@@3 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)) (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3))) (and (and (= $abort_flag@4@@7 $abort_flag@3@@7) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3)) (and (= $abort_code@5@@7 $abort_code@4@@7) (= $1_DiemAccount_DiemAccount_$memory@1@@3 $1_DiemAccount_DiemAccount_$memory@0@@3)))) (and (=> (= (ControlFlow 0 227833) 230324) anon11_Then_correct) (=> (= (ControlFlow 0 227833) 228995) anon11_Else_correct))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3  (=> (and (and (= $abort_flag@4@@7 true) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0@@3)) (and (= $abort_code@5@@7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3) (= $1_DiemAccount_DiemAccount_$memory@1@@3 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 227510) 230324) anon11_Then_correct) (=> (= (ControlFlow 0 227510) 228995) anon11_Else_correct)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@3  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3) (= (ControlFlow 0 227859) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3  (=> (and (not $abort_flag@3@@7) (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3))) (=> (and (and (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3|) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3 ($Mutation_131965 (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@3 (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3))) 0)))) (and (=> (= (ControlFlow 0 227741) 227859) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@3) (=> (= (ControlFlow 0 227741) 227833) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3  (=> (and (and $abort_flag@3@@7 (= $abort_code@4@@7 $abort_code@4@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@4@@7) (= (ControlFlow 0 227873) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@3  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3) (=> (and (= $abort_code@4@@7 $EXEC_FAILURE_CODE) (= $abort_flag@3@@7 true)) (and (=> (= (ControlFlow 0 227925) 227873) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3) (=> (= (ControlFlow 0 227925) 227741) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= (ControlFlow 0 227923) 227925)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3 ($Mutation_131921 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3)) (and (= $abort_code@4@@7 $abort_code@3@@7) (= $abort_flag@3@@7 $abort_flag@2@@7))) (and (=> (= (ControlFlow 0 227695) 227873) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3) (=> (= (ControlFlow 0 227695) 227741) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@3  (=> inline$$1_DiemAccount_exists_at$1$$t1@1@@3 (and (=> (= (ControlFlow 0 227673) 227923) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@3) (=> (= (ControlFlow 0 227673) 227695) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= (ControlFlow 0 227669) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@3  (=> (and (not $abort_flag@2@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 inline$$1_DiemAccount_exists_at$1$$t1@1@@3))) (and (=> (= (ControlFlow 0 227653) 227673) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@3) (=> (= (ControlFlow 0 227653) 227669) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@3  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@3@@7) (= (ControlFlow 0 227939) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct@@3  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 inline$$1_DiemAccount_exists_at$1$$t1@1@@3)) (and (=> (= (ControlFlow 0 227611) 227939) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@3) (=> (= (ControlFlow 0 227611) 227653) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@3  (=> (and inline$$Not$0$dst@1@@8 (= (ControlFlow 0 227617) 227611)) inline$$1_DiemAccount_exists_at$1$anon0_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@3  (=> (and (and (not inline$$Not$0$dst@1@@8) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= (ControlFlow 0 227504) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@3  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= inline$$Not$0$dst@1@@8 inline$$Not$0$dst@1@@8))) (and (=> (= (ControlFlow 0 227488) 227617) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@3) (=> (= (ControlFlow 0 227488) 227504) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@3))))))
(let ((inline$$Not$0$anon0_correct@@8  (=> (and (= inline$$Not$0$dst@1@@8  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 227448) 227488)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3  (=> (and (not $abort_flag@2@@7) (= (ControlFlow 0 227454) 227448)) inline$$Not$0$anon0_correct@@8)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@3@@7) (= (ControlFlow 0 227953) 227510))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3  (=> (not $abort_flag@1@@8) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@3 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@3)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3) (= $abort_flag@2@@7 $abort_flag@1@@8)) (and (= $abort_code@3@@7 $abort_code@2@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3))) (and (=> (= (ControlFlow 0 227324) 227953) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 227324) 227454) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3  (=> (= $abort_flag@2@@7 true) (=> (and (= $abort_code@3@@7 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0@@3)) (and (=> (= (ControlFlow 0 227272) 227953) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 227272) 227454) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3  (=> (and (and $abort_flag@1@@8 (= $abort_code@2@@8 $abort_code@2@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 $abort_code@2@@8) (= (ControlFlow 0 227338) 227272))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@3  (=> (= $abort_code@2@@8 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@8 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0@@3)) (and (=> (= (ControlFlow 0 227390) 227338) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3) (=> (= (ControlFlow 0 227390) 227324) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= (ControlFlow 0 227388) 227390)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= $abort_code@2@@8 $abort_code@1@@8)) (and (= $abort_flag@1@@8 $abort_flag@0@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@3))) (and (=> (= (ControlFlow 0 227290) 227338) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3) (=> (= (ControlFlow 0 227290) 227324) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@3  (=> inline$$1_DiemAccount_exists_at$0$$t1@1@@6 (and (=> (= (ControlFlow 0 227276) 227388) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@3) (=> (= (ControlFlow 0 227276) 227290) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@6) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= (ControlFlow 0 227266) 227272))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@3  (=> (and (not $abort_flag@0@@8) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 inline$$1_DiemAccount_exists_at$0$$t1@1@@6))) (and (=> (= (ControlFlow 0 227250) 227276) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@3) (=> (= (ControlFlow 0 227250) 227266) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@3  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 $abort_code@1@@8) (= (ControlFlow 0 227404) 227272))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@6  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 inline$$1_DiemAccount_exists_at$0$$t1@1@@6)) (and (=> (= (ControlFlow 0 227208) 227404) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@3) (=> (= (ControlFlow 0 227208) 227250) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@3  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= (ControlFlow 0 227214) 227208)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@6)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@3)) 0) (=> (and (and (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3)) 0) (= (seq.len (|p#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@3)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@3 (|$addr#$signer| _$t0@@8)) (= _$t0@@8 _$t0@@8))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 (|$addr#$signer| _$t0@@8))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= (ControlFlow 0 227410) 227214)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@3))))
(let ((anon10_Else_correct@@0  (=> (not $abort_flag@0@@8) (=> (and (= $t8@@0 (|$addr#$signer| _$t0@@8)) (= (ControlFlow 0 227959) 227410)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@3))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0@@8 true) (= $abort_code@1@@8 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 226057) 230338) anon10_Then_correct@@0) (=> (= (ControlFlow 0 226057) 227959) anon10_Else_correct@@0)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 226051) 226057))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 226107) 226057))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0@@8 false) (= $abort_code@1@@8 $abort_code@0@@8)) (and (=> (= (ControlFlow 0 226063) 230338) anon10_Then_correct@@0) (=> (= (ControlFlow 0 226063) 227959) anon10_Else_correct@@0))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t1@@3))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0@@8)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 226035) 226063) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 226035) 226051) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_107357 (|Store__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) false) (|contents#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 225969) 226035))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_107357 (|Store__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 226077) 226035))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 225955) 226077) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 225955) 225969) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0@@8 _$t0@@8) (=> (and (= _$t1@@3 _$t1@@3) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (and (=> (= (ControlFlow 0 225949) 226107) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 225949) 225955) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct@@8  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (=> (and (and (and (forall ((addr@@276 Int) ) (!  (=> (|$IsValid'address'| addr@@276) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@276) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@276)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@276)))) 0)) (= addr@@276 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@276))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.15062:20|
 :skolemid |419|
)) (forall ((addr@@277 Int) ) (!  (=> (|$IsValid'address'| addr@@277) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@277) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@277) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@277)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@277)))) 0)) (= addr@@277 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@277))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.15066:20|
 :skolemid |420|
))) (and (forall ((addr@@278 Int) ) (!  (=> (|$IsValid'address'| addr@@278) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@278) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@278)))
 :qid |AccountAdministrationScriptsbpl.15070:20|
 :skolemid |421|
)) (forall ((addr@@279 Int) ) (!  (=> (|$IsValid'address'| addr@@279) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@279)  (and (= addr@@279 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@279))))
 :qid |AccountAdministrationScriptsbpl.15074:20|
 :skolemid |422|
)))) (and (and (forall ((addr@@280 Int) ) (!  (=> (|$IsValid'address'| addr@@280) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@280)  (and (= addr@@280 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@280))))
 :qid |AccountAdministrationScriptsbpl.15078:20|
 :skolemid |423|
)) (forall ((addr@@281 Int) ) (!  (=> (|$IsValid'address'| addr@@281) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@281) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@281)))
 :qid |AccountAdministrationScriptsbpl.15082:20|
 :skolemid |424|
))) (and (forall ((addr@@282 Int) ) (!  (=> (|$IsValid'address'| addr@@282) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@282) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@282)))
 :qid |AccountAdministrationScriptsbpl.15086:20|
 :skolemid |425|
)) (forall ((addr@@283 Int) ) (!  (=> (|$IsValid'address'| addr@@283) (= (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) addr@@283)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@283) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@283)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@283) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@283)) 1)))))
 :qid |AccountAdministrationScriptsbpl.15090:20|
 :skolemid |426|
))))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@8)) ($1_Signer_is_txn_signer _$t0@@8)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@8))) (and (and (|$IsValid'u64'| _$t1@@3) (|$IsValid'vec'u8''| _$t2)) (and (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@26))
 :qid |AccountAdministrationScriptsbpl.15102:20|
 :skolemid |427|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26))
)) (forall (($a_0@@27 Int) ) (! (let (($rsc@@27 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@27)))
 ...
 :qid |AccountAdministrationScriptsbpl.15106:20|
 :skolemid |428|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@27))
))))) (and (and (and (= $t4@@4 (|$addr#$signer| _$t0@@8)) (= $t5@@3 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@4))) 0))) (and (= $t6@@2 (|$addr#$signer| _$t0@@8)) (let ((addr@@284 (|$addr#$signer| _$t0@@8)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@284)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@284) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@284)))))))) (and (and (= _$t0@@8 _$t0@@8) (= _$t1@@3 _$t1@@3)) (and (= _$t2 _$t2) (= (ControlFlow 0 226111) 225949))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_72203| stream@@9) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@9) v@@50) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 225171) 226111)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 285355) 225171) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
