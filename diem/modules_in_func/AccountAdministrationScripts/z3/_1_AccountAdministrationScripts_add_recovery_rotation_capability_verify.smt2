...
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory () T@$Memory_136265)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@0 () T@$Memory_127894)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@1 () T@$Memory_136265)
(declare-fun $t3@@0 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun $abort_flag@4@@3 () Bool)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3 () T@$Mutation_138193)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 () T@$Mutation_138193)
(declare-fun |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| () T@$Mutation_76411)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@0 () T@$Memory_136265)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1 () T@$Mutation_76411)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0 () T@$Mutation_138193)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1 () T@$Mutation_138193)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t8@0 () T@$Mutation_76411)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@0 () T@$Mutation_76411)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0 () T@$Mutation_131965)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0 () T@$Mutation_131965)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0 () T@$Mutation_131921)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@0 () T@$Memory_127894)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@0 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@0 () T@$Mutation_131921)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@0 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@0 () T@$Mutation_131965)
...
(assert (not
 (=> (= (ControlFlow 0 0) 272966) (let ((L2_correct@@0  (and (=> (= (ControlFlow 0 208759) (- 0 275496)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@0)) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) $t5@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0)))))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@0)) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) $t5@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))))))) (=> (= (ControlFlow 0 208759) (- 0 275544)) (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@0)) (= 5 $t8@0@@0)) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@3))))) 0) (= 1 $t8@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0)) (= 5 $t8@0@@0))) (and (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) 256) (= 8 $t8@0@@0))) (and (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) $t5@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0)))))) (= 7 $t8@0@@0))) (= 1 $t8@0@@0)) (= 5 $t8@0@@0)) (= 8 $t8@0@@0)) (= 7 $t8@0@@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@5@@3 (= $abort_code@6@@3 $abort_code@6@@3)) (and (= $t8@0@@0 $abort_code@6@@3) (= (ControlFlow 0 208563) 208759))) L2_correct@@0)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@3@@3 (= $abort_code@4@@3 $abort_code@4@@3)) (and (= $t8@0@@0 $abort_code@4@@3) (= (ControlFlow 0 208773) 208759))) L2_correct@@0)))
(let ((anon7_Else_correct  (=> (not $abort_flag@5@@3) (and (=> (= (ControlFlow 0 208549) (- 0 275390)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t4@@0))) (and (=> (= (ControlFlow 0 208549) (- 0 275402)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@3))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@3))))) 0)) (and (=> (= (ControlFlow 0 208549) (- 0 275413)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) (and (=> (= (ControlFlow 0 208549) (- 0 275424)) (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) 256))) (=> (not (>= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) 256)) (and (=> (= (ControlFlow 0 208549) (- 0 275441)) (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) $t5@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0)))))))) (=> (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) $t5@@0) $t5@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $t5@@0))))))) (and (=> (= (ControlFlow 0 208549) (- 0 275455)) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@0) (|$addr#$signer| _$t0@@3))))) 0)) (=> (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory@1@@0) (|$addr#$signer| _$t0@@3))))) 0) (=> (= (ControlFlow 0 208549) (- 0 275464)) (= (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory@1) _$t1@@0)) (- (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory@1) _$t1@@0))) 1)) $t3@@0)))))))))))))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Else_correct  (=> (and (not $abort_flag@4@@3) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3 ($Mutation_138193 (|l#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) (|p#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) ($1_RecoveryAddress_RecoveryAddress (|v#$Mutation_76411| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|))))) (=> (and (and (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_136265 (|Store__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)) (|v#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)))) (= $abort_code@6@@3 $abort_code@5@@3)) (and (= $abort_flag@5@@3 $abort_flag@4@@3) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory@0))) (and (=> (= (ControlFlow 0 208321) 208563) anon7_Then_correct) (=> (= (ControlFlow 0 208321) 208549) anon7_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct  (=> (= $abort_code@6@@3 inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1) (=> (and (= $abort_flag@5@@3 true) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory)) (and (=> (= (ControlFlow 0 207831) 208563) anon7_Then_correct) (=> (= (ControlFlow 0 207831) 208549) anon7_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Then_correct  (=> (and (and $abort_flag@4@@3 (= $abort_code@5@@3 $abort_code@5@@3)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5@@3) (= (ControlFlow 0 208335) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_76411 (|l#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1) (|p#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1) (seq.++ (|v#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1) (seq.unit inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0)))) (and (=> (= (ControlFlow 0 208279) 208335) inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Then_correct) (=> (= (ControlFlow 0 208279) 208321) inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 208285) 208279)) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= (ControlFlow 0 208224) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else$1_correct  (=> (|$IsValid'u64'| 6) (=> (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 8)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 208208) 208285) inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Then_correct) (=> (= (ControlFlow 0 208208) 208224) inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| 256)) (= (ControlFlow 0 208168) 208208)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else$1_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else_correct  (=> (not $abort_flag@4@@3) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 208174) 208168)) inline$$Lt$0$anon0_correct))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Then_correct  (=> (and (and $abort_flag@4@@3 (= $abort_code@5@@3 $abort_code@5@@3)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5@@3) (= (ControlFlow 0 208349) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (seq.len inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1)) (and (=> (= (ControlFlow 0 208108) 208349) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Then_correct) (=> (= (ControlFlow 0 208108) 208174) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct  (=> (and (not $abort_flag@4@@3) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1 ($Mutation_76411 (|l#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) (seq.++ (|p#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) (seq.unit 0)) (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|v#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2))))) (=> (and (and (= |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| (|v#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1)) (= |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1|)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1 (|v#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1)) (= (ControlFlow 0 208114) 208108))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct  (=> (and (and $abort_flag@4@@3 (= $abort_code@5@@3 $abort_code@5@@3)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5@@3) (= (ControlFlow 0 208363) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then$1_correct  (=> (= $abort_flag@4@@3 true) (=> (and (= $abort_code@5@@3 $EXEC_FAILURE_CODE) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0)) (and (=> (= (ControlFlow 0 208415) 208363) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct) (=> (= (ControlFlow 0 208415) 208114) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0)) (= (ControlFlow 0 208413) 208415)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then$1_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0) (=> (and (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1 ($Mutation_138193 ($Global _$t1@@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0))) (= $abort_flag@4@@3 $abort_flag@3@@3)) (and (= $abort_code@5@@3 $abort_code@4@@3) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1))) (and (=> (= (ControlFlow 0 208042) 208363) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct) (=> (= (ControlFlow 0 208042) 208114) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Then_correct  (=> inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0 (and (=> (= (ControlFlow 0 208020) 208413) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then_correct) (=> (= (ControlFlow 0 208020) 208042) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Else_correct  (=> (and (and (not inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= (ControlFlow 0 208016) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Else_correct  (=> (and (and (and (not $abort_flag@3@@3) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) _$t1@@0) _$t1@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) _$t1@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)))))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 7)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0)))) (and (=> (= (ControlFlow 0 208000) 208020) inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Then_correct) (=> (= (ControlFlow 0 208000) 208016) inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Then_correct  (=> (and (and $abort_flag@3@@3 (= $abort_code@4@@3 $abort_code@4@@3)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@4@@3) (= (ControlFlow 0 208429) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 207928) 208429) inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Then_correct) (=> (= (ControlFlow 0 207928) 208000) inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Then_correct  (=> (and inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 (= (ControlFlow 0 207934) 207928)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Else_correct  (=> (and (and (not inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= (ControlFlow 0 207825) 207831))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t8@0)) 0) (= (seq.len (|p#$Mutation_138193| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0)) 0)) (and (= (seq.len (|p#$Mutation_76411| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@0)) 0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t10@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0)))) (=> (and (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0) (= _$t1@@0 _$t1@@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@0)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 5)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1)))) (and (=> (= (ControlFlow 0 207809) 207934) inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Then_correct) (=> (= (ControlFlow 0 207809) 207825) inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Else_correct))))))
(let ((anon6_Else_correct  (=> (not $abort_flag@3@@3) (=> (and (= $t9 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0)) (= (ControlFlow 0 208433) 207809)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon0_correct))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@0  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@0) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0 ($Mutation_131965 (|l#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0) (|p#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@0|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@0 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@0) 0)))) (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0) (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0)) (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@0) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0@@0 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0)) (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@0)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@0))) (and (and (= $abort_code@4@@3 $abort_code@3@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@0)) (and (= $abort_flag@3@@3 $abort_flag@2@@3) (= $1_DiemAccount_DiemAccount_$memory@1@@0 $1_DiemAccount_DiemAccount_$memory@0@@0)))) (and (=> (= (ControlFlow 0 206915) 208773) anon6_Then_correct) (=> (= (ControlFlow 0 206915) 208433) anon6_Else_correct))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0  (=> (and (and (= $abort_code@4@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0@@0)) (and (= $abort_flag@3@@3 true) (= $1_DiemAccount_DiemAccount_$memory@1@@0 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 206592) 208773) anon6_Then_correct) (=> (= (ControlFlow 0 206592) 208433) anon6_Else_correct)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@0  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@0 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@0)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@0) (= (ControlFlow 0 206941) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@0  (=> (and (not $abort_flag@2@@3) (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0))) (=> (and (and (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0|) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0 ($Mutation_131965 (|l#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@0 (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@0 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@0))) 0)))) (and (=> (= (ControlFlow 0 206823) 206941) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@0) (=> (= (ControlFlow 0 206823) 206915) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@0  (=> (and (and $abort_flag@2@@3 (= $abort_code@3@@3 $abort_code@3@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 $abort_code@3@@3) (= (ControlFlow 0 206955) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@0  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@0) (=> (and (= $abort_flag@2@@3 true) (= $abort_code@3@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 207007) 206955) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@0) (=> (= (ControlFlow 0 207007) 206823) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0)) (= (ControlFlow 0 207005) 207007)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@0 ($Mutation_131921 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@0)) (and (= $abort_flag@2@@3 $abort_flag@1@@3) (= $abort_code@3@@3 $abort_code@2@@3))) (and (=> (= (ControlFlow 0 206777) 206955) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@0) (=> (= (ControlFlow 0 206777) 206823) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@0  (=> inline$$1_DiemAccount_exists_at$1$$t1@1@@0 (and (=> (= (ControlFlow 0 206755) 207005) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@0) (=> (= (ControlFlow 0 206755) 206777) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@0  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0) (= (ControlFlow 0 206751) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@0  (=> (and (not $abort_flag@1@@3) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@0) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@0 inline$$1_DiemAccount_exists_at$1$$t1@1@@0))) (and (=> (= (ControlFlow 0 206735) 206755) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@0) (=> (= (ControlFlow 0 206735) 206751) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@0  (=> (and (and $abort_flag@1@@3 (= $abort_code@2@@3 $abort_code@2@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 $abort_code@2@@3) (= (ControlFlow 0 207021) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct@@0  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0)) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@0 inline$$1_DiemAccount_exists_at$1$$t1@1@@0)) (and (=> (= (ControlFlow 0 206693) 207021) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@0) (=> (= (ControlFlow 0 206693) 206735) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@0  (=> (and inline$$Not$0$dst@1@@3 (= (ControlFlow 0 206699) 206693)) inline$$1_DiemAccount_exists_at$1$anon0_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0) (= (ControlFlow 0 206586) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@0  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@0) (= inline$$Not$0$dst@1@@3 inline$$Not$0$dst@1@@3))) (and (=> (= (ControlFlow 0 206570) 206699) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@0) (=> (= (ControlFlow 0 206570) 206586) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@3  (=> (and (= inline$$Not$0$dst@1@@3  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@0)) (= (ControlFlow 0 206530) 206570)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@0)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@0  (=> (and (not $abort_flag@1@@3) (= (ControlFlow 0 206536) 206530)) inline$$Not$0$anon0_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@0  (=> (and (and $abort_flag@1@@3 (= $abort_code@2@@3 $abort_code@2@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@0 $abort_code@2@@3) (= (ControlFlow 0 207035) 206592))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@0)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@0  (=> (not $abort_flag@0@@3) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@0 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@0)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@0 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@0)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@0) (= $abort_code@2@@3 $abort_code@1@@3)) (and (= $abort_flag@1@@3 $abort_flag@0@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@0))) (and (=> (= (ControlFlow 0 206406) 207035) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@0) (=> (= (ControlFlow 0 206406) 206536) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@0)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@0  (=> (= $abort_code@2@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@0) (=> (and (= $abort_flag@1@@3 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0@@0)) (and (=> (= (ControlFlow 0 206354) 207035) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@0) (=> (= (ControlFlow 0 206354) 206536) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@0  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@0 $abort_code@1@@3) (= (ControlFlow 0 206420) 206354))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@0  (=> (= $abort_flag@0@@3 true) (=> (and (= $abort_code@1@@3 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0@@0)) (and (=> (= (ControlFlow 0 206472) 206420) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@0) (=> (= (ControlFlow 0 206472) 206406) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0)) (= (ControlFlow 0 206470) 206472)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@0)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@0 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0)) (= $abort_flag@0@@3 false)) (and (= $abort_code@1@@3 $abort_code@0@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@0))) (and (=> (= (ControlFlow 0 206372) 206420) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@0) (=> (= (ControlFlow 0 206372) 206406) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@0  (=> inline$$1_DiemAccount_exists_at$0$$t1@1@@3 (and (=> (= (ControlFlow 0 206358) 206470) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@0) (=> (= (ControlFlow 0 206358) 206372) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@0  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0) (= (ControlFlow 0 206348) 206354))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@0) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@3 inline$$1_DiemAccount_exists_at$0$$t1@1@@3))) (and (=> (= (ControlFlow 0 206332) 206358) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@0) (=> (= (ControlFlow 0 206332) 206348) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@0 true))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@3  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@3 inline$$1_DiemAccount_exists_at$0$$t1@1@@3)) (and (=> (= (ControlFlow 0 206290) 206486) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@0) (=> (= (ControlFlow 0 206290) 206332) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@0  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (= (ControlFlow 0 206296) 206290)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@0  (=> (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@0)) 0) (=> (and (and (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@0)) 0) (= (seq.len (|p#$Mutation_131965| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@0)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@0 (|$addr#$signer| _$t0@@3)) (= _$t0@@3 _$t0@@3))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 (|$addr#$signer| _$t0@@3))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@0) (= (ControlFlow 0 206492) 206296)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@0))))
(let ((anon0$1_correct@@3  (=> (and (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |AccountAdministrationScriptsbpl.14070:20|
 :skolemid |336|
)) (forall ((addr@@208 Int) ) (!  (=> (|$IsValid'address'| addr@@208) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@208) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@208)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@208)))) 0)) (= addr@@208 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@208))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.14074:20|
 :skolemid |337|
))) (and (forall ((addr@@209 Int) ) (!  (=> (|$IsValid'address'| addr@@209) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@209) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@209) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@209)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@209)))) 0)) (= addr@@209 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@209))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.14078:20|
 :skolemid |338|
)) (forall ((addr@@210 Int) ) (!  (=> (|$IsValid'address'| addr@@210) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@210) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@210)))
 :qid |AccountAdministrationScriptsbpl.14082:20|
 :skolemid |339|
)))) (=> (and (and (and (forall ((addr@@211 Int) ) (!  (=> (|$IsValid'address'| addr@@211) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@211)  (and (= addr@@211 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@211))))
 :qid |AccountAdministrationScriptsbpl.14086:20|
 :skolemid |340|
)) (forall ((addr@@212 Int) ) (!  (=> (|$IsValid'address'| addr@@212) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@212)  (and (= addr@@212 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@212))))
 :qid |AccountAdministrationScriptsbpl.14090:20|
 :skolemid |341|
))) (and (forall ((addr@@213 Int) ) (!  (=> (|$IsValid'address'| addr@@213) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@213) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@213)))
 :qid |AccountAdministrationScriptsbpl.14094:20|
 :skolemid |342|
)) (forall ((addr@@214 Int) ) (!  (=> (|$IsValid'address'| addr@@214) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@214) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@214)))
 :qid |AccountAdministrationScriptsbpl.14098:20|
 :skolemid |343|
)))) (and (and (forall ((addr@@215 Int) ) (!  (=> (|$IsValid'address'| addr@@215) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) addr@@215)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@215) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@215)) 5))))
 :qid |AccountAdministrationScriptsbpl.14102:20|
 :skolemid |344|
)) (forall ((addr@@216 Int) ) (!  (=> (|$IsValid'address'| addr@@216) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) addr@@216)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@216) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@216)) 6))))
 :qid |AccountAdministrationScriptsbpl.14106:20|
 :skolemid |345|
))) (and (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@217) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@217))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@217)) 0)) addr@@217))))
 :qid |AccountAdministrationScriptsbpl.14110:20|
 :skolemid |346|
)) (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@218) (or (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) addr@@218))))
 :qid |AccountAdministrationScriptsbpl.14114:20|
 :skolemid |347|
))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) ($1_Signer_is_txn_signer _$t0@@3)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@3))) (and (|$IsValid'address'| _$t1@@0) (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $a_0@@12)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@12))
 :qid |AccountAdministrationScriptsbpl.14123:20|
 :skolemid |348|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_117497| $1_VASP_ChildVASP_$memory) $a_0@@12))
)))) (and (and (forall (($a_0@@13 Int) ) (! (let (($rsc@@13 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_117561| $1_VASP_ParentVASP_$memory) $a_0@@13)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@13))
 :qid |AccountAdministrationScriptsbpl.14127:20|
 :skolemid |349|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_117561| $1_VASP_ParentVASP_$memory) $a_0@@13))
)) (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@14)))
 ...
 :qid |AccountAdministrationScriptsbpl.14131:20|
 :skolemid |350|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@14))
))) (and (forall (($a_0@@15 Int) ) (! (let (($rsc@@15 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@15)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@15))
 :qid |AccountAdministrationScriptsbpl.14135:20|
 :skolemid |351|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_136265| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@15))
)) (= $t2 (|$addr#$signer| _$t0@@3))))) (and (and (and (= $t3@@0 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $t2))) 0)) (= $t4@@0 (|$addr#$signer| _$t0@@3))) (and (= $t5@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| $t3@@0)) (let ((addr@@219 (|$addr#$signer| _$t0@@3)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@219)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@219) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@219)))))))) (and (and (= _$t0@@3 _$t0@@3) (= _$t1@@0 _$t1@@0)) (and (= $t6@@0 (|$addr#$signer| _$t0@@3)) (= (ControlFlow 0 207041) 206492))))) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@0)))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_72203| stream@@4) 0) (forall ((v@@45 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@4) v@@45) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 204633) 207041)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 272966) 204633) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
