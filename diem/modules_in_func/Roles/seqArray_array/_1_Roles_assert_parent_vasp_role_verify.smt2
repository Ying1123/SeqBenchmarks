...
(assert (not
 (=> (= (ControlFlow 0 0) 766021) (let ((anon15_Then_correct  (=> $t15@0 (and (=> (= (ControlFlow 0 452484) (- 0 766738)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6))) (and (=> (= (ControlFlow 0 452484) (- 0 766750)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 5))) (and (=> (= (ControlFlow 0 452484) (- 0 766768)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0))))
 :qid |Rolesbpl.7446:15|
 :skolemid |325|
 ...
 :qid |Rolesbpl.7466:15|
 :skolemid |330|
)) (=> (= (ControlFlow 0 452484) (- 0 767062)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6))))
 :qid |Rolesbpl.7470:15|
 :skolemid |331|
))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 451999) (- 0 767142)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 5)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 5))) (=> (= (ControlFlow 0 451999) (- 0 767164)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (= 5 $t11@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 5)) (= 3 $t11@0))))))))
(let ((anon15_Else_correct  (=> (and (and (not $t15@0) (= $t17 $t17)) (and (= $t11@0 $t17) (= (ControlFlow 0 452089) 451999))) L5_correct)))
(let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t13@0 (|$role_id#$1_Roles_RoleId| $t12@1)) (|$IsValid'u64'| 5)) (and (= $t15@0 (= $t13@0 5)) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t17) (= $t17 3)) (and (= $t17 $t17) (= $t15@0 $t15@0)))) (and (=> (= (ControlFlow 0 452073) 452484) anon15_Then_correct) (=> (= (ControlFlow 0 452073) 452089) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t11@0 $abort_code@1) (= (ControlFlow 0 452498) 451999))) L5_correct)))
(let ((anon13_Then$1_correct  (=> (= $t12@1 $t12) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 452550) 452498) anon14_Then_correct) (=> (= (ControlFlow 0 452550) 452073) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t7)) (= (ControlFlow 0 452548) 452550)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t7) (=> (and (and (= $t12@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t7)) (= $t12@1 $t12@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 452017) 452498) anon14_Then_correct) (=> (= (ControlFlow 0 452017) 452073) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t8@0 (and (=> (= (ControlFlow 0 452003) 452548) anon13_Then_correct) (=> (= (ControlFlow 0 452003) 452017) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t8@0) (= $t10 $t10)) (and (= $t11@0 $t10) (= (ControlFlow 0 451927) 451999))) L5_correct)))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.7293:20|
 :skolemid |324|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0))
)) (= $t6 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t7)))) (and (and (and (= $t7 (|$addr#$signer| _$t0)) (= $t7 $t7)) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t7)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t10) (= $t10 5)) (and (= $t10 $t10) (= $t8@0 $t8@0))))) (and (=> (= (ControlFlow 0 451911) 452003) anon12_Then_correct) (=> (= (ControlFlow 0 451911) 451927) anon12_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 451412) 451911)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 766021) 451412) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
