...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@3 () T@$Memory_225533)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_225533)
(declare-fun inline$$1_ValidatorConfig_publish$0$$t9@1 () Int)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_225533)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0 () T@$Memory_225533)
...
(declare-fun MapConstVec_158870 (T@$1_ValidatorConfig_Config) |T@[Int]$1_ValidatorConfig_Config|)
(declare-fun DefaultVecElem_158870 () T@$1_ValidatorConfig_Config)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 925606) (let ((L2_correct  (and (=> (= (ControlFlow 0 692229) (- 0 929425)) (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_57736| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) _$t1))) (=> (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_57736| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) _$t1)) (=> (= (ControlFlow 0 692229) (- 0 929526)) (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (= 6 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (= _$t1 0) (= 7 $t8@0))) (and (= _$t1 1) (= 7 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) _$t1) (= 6 $t8@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8@0))) (and (not (= (+ 16 (|l#Vec_57736| _$t2)) 32)) (= 7 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) _$t1) (= 6 $t8@0))))))))
(let ((anon31_Then_correct  (=> $t19 (=> (and (and (or (or (or (or (and (= $t15 0) (= 7 $t8)) (and (= $t15 1) (= 7 $t8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) $t15) (= 6 $t8))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8))) (and (not (= (+ 16 (|l#Vec_57736| _$t2)) 32)) (= 7 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 691901) 692229))) L2_correct))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 692243) 692229))) L2_correct)))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 692257) 692229))) L2_correct)))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 692271) 692229))) L2_correct)))
(let ((anon26_Then_correct  (=> $t7 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 692377) 692229))) L2_correct))))
(let ((anon24_correct  (=> (= $t20 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (=> (and (= $t21 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t22 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) $t15)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory@2) $t15) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory@2) $t15))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t20) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t20) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16))))) (and (not (= (|l#Vec_174639| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_174639| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))))) (and (and (and (not (= (|l#Vec_174678| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_174678| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))) (= $t23 $t22)) (and (and (= $t24 $t21) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) $t24)))
(let ((stream_new (let ((len (|l#Multiset_174514| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23))))
(Multiset_174514 (|Store__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) $t24 stream_new)))))) (and (= $t25 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t26 ($1_DiemAccount_CreateAccountEvent _$t1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) _$t1)))))))) (and (=> (= (ControlFlow 0 691747) (- 0 929129)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (and (=> (= (ControlFlow 0 691747) (- 0 929138)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 691747) (- 0 929150)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 691747) (- 0 929168)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 691747) (- 0 929182)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 691747) (- 0 929192)) (not (= _$t1 1))) (=> (not (= _$t1 1)) (and (=> (= (ControlFlow 0 691747) (- 0 929202)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (=> (= (ControlFlow 0 691747) (- 0 929211)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (=> (= (ControlFlow 0 691747) (- 0 929228)) (not (not (= (+ 16 (|l#Vec_57736| _$t2)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_57736| _$t2)) 32))) (and (=> (= (ControlFlow 0 691747) (- 0 929246)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 691747) (- 0 929256)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) _$t1)) (and (=> (= (ControlFlow 0 691747) (- 0 929265)) (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) _$t1) (and (=> (= (ControlFlow 0 691747) (- 0 929272)) (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1) (and (=> (= (ControlFlow 0 691747) (- 0 929279)) (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) _$t1) (and (=> (= (ControlFlow 0 691747) (- 0 929286)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) _$t1)) 3)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) _$t1)) 3) (and (=> (= (ControlFlow 0 691747) (- 0 929299)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory@2) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |Rolesbpl.38224:15|
 :skolemid |1809|
 ...
 :qid |Rolesbpl.38224:15|
 :skolemid |1809|
)) (and (=> (= (ControlFlow 0 691747) (- 0 929334)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_174514| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_174514 (|Store__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_174514| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_174514 (|Store__T@[$EventRep]Int_| (|v#Multiset_174514| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@1))))))
 ...
 :qid |Rolesbpl.3327:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 691747) (- 0 929359)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@2))))))
...
(let ((anon35_Else_correct  (=> (and (and (not |$temp_0'bool'@3|) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_222571 (|Store__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 false) (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1) (= (ControlFlow 0 691318) 691747))) anon24_correct)))
(let ((anon35_Then_correct  (=> (and (and |$temp_0'bool'@3| (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_222571 (|Store__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0) (= (ControlFlow 0 691759) 691747))) anon24_correct)))
(let ((anon34_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_222399 (|Store__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) $t15 false) (|contents#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 691304) 691759) anon35_Then_correct) (=> (= (ControlFlow 0 691304) 691318) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_222399 (|Store__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) $t15 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) $t15 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 691771) 691759) anon35_Then_correct) (=> (= (ControlFlow 0 691771) 691318) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not |$temp_0'bool'@1|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_212959 (|Store__T@[Int]Bool_| (|domain#$Memory_212959| $1_Event_EventHandleGenerator_$memory) $t15 false) (|contents#$Memory_212959| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 691290) 691771) anon34_Then_correct) (=> (= (ControlFlow 0 691290) 691304) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and |$temp_0'bool'@1| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_212959 (|Store__T@[Int]Bool_| (|domain#$Memory_212959| $1_Event_EventHandleGenerator_$memory) $t15 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_212959| $1_Event_EventHandleGenerator_$memory) $t15 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 691783) 691771) anon34_Then_correct) (=> (= (ControlFlow 0 691783) 691304) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_233241 (|Store__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) $t15 false) (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 691276) 691783) anon33_Then_correct) (=> (= (ControlFlow 0 691276) 691290) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_233241 (|Store__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) $t15 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) $t15 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 691795) 691783) anon33_Then_correct) (=> (= (ControlFlow 0 691795) 691290) anon33_Else_correct))))))
(let ((anon31_Else_correct  (=> (not $t19) (and (=> (= (ControlFlow 0 691264) 691795) anon32_Then_correct) (=> (= (ControlFlow 0 691264) 691276) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t15 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t16 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (and (= $t17 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t18 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 691258) (- 0 928624)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) $t15))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) $t15)) (and (=> (= (ControlFlow 0 691258) (- 0 928635)) (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (and (=> (= (ControlFlow 0 691258) (- 0 928644)) (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) $t15)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) $t15) (=> (= $t19  (or (or (or (or (= $t15 0) (= $t15 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_222399| $1_AccountFreezing_FreezingBit_$memory) $t15)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222571| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_57736| _$t2)) 32)))) (and (=> (= (ControlFlow 0 691258) 691901) anon31_Then_correct) (=> (= (ControlFlow 0 691258) 691264) anon31_Else_correct)))))))))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Else_correct  (=> (and (and (not $abort_flag@1) (= $abort_code@3 $abort_code@2)) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 690884) 692243) anon30_Then_correct) (=> (= (ControlFlow 0 690884) 691258) anon30_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$L3_correct  (=> (= $abort_code@3 inline$$1_ValidatorConfig_publish$0$$t9@1) (=> (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@2) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 690790) 692243) anon30_Then_correct) (=> (= (ControlFlow 0 690790) 691258) anon30_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 $abort_code@2) (= (ControlFlow 0 690898) 690790))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 690950) 690898) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 690950) 690884) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 690948) 690950)) inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_225533 (|Store__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) inline$$1_ValidatorConfig_publish$0$$t21@1))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 690874) 690898) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 690874) 690884) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| inline$$1_ValidatorConfig_publish$0$$t19@0) (<= (|l#Vec_174600| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_174600 (MapConstVec_158870 DefaultVecElem_158870) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_publish$0$$t20@0) (<= (|l#Vec_57736| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_57736 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= inline$$1_ValidatorConfig_publish$0$$t21@1 ($1_ValidatorConfig_ValidatorConfig inline$$1_ValidatorConfig_publish$0$$t19@0 inline$$1_ValidatorConfig_publish$0$$t20@0 _$t3))))) (and (=> (= (ControlFlow 0 690852) 690948) inline$$1_ValidatorConfig_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 690852) 690874) inline$$1_ValidatorConfig_publish$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t18@0) (= (ControlFlow 0 690784) 690790))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$1_ValidatorConfig_publish$0$$t18@0 6)) (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 690768) 690852) inline$$1_ValidatorConfig_publish$0$anon18_Then_correct) (=> (= (ControlFlow 0 690768) 690784) inline$$1_ValidatorConfig_publish$0$anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_ValidatorConfig_publish$0$$t15@1)) (= (ControlFlow 0 690728) 690768)) inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t13@0) (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_publish$0$$t14@0) (= inline$$1_ValidatorConfig_publish$0$$t14@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (= inline$$1_ValidatorConfig_publish$0$$t15@1 (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_publish$0$$t14@0)) (= (ControlFlow 0 690734) 690728))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t13@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 691002) 690790))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t11@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t12@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= inline$$1_ValidatorConfig_publish$0$$t13@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3))))) (and (=> (= (ControlFlow 0 690672) 691002) inline$$1_ValidatorConfig_publish$0$anon17_Then_correct) (=> (= (ControlFlow 0 690672) 690734) inline$$1_ValidatorConfig_publish$0$anon17_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t11@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 691094) 690790))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t8@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t10@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t11@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 690626) 691094) inline$$1_ValidatorConfig_publish$0$anon16_Then_correct) (=> (= (ControlFlow 0 690626) 690672) inline$$1_ValidatorConfig_publish$0$anon16_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Then_correct  (=> inline$$1_ValidatorConfig_publish$0$$t8@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ValidatorConfig_publish$0$$t9@0)) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 691120) 690790))) inline$$1_ValidatorConfig_publish$0$L3_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_publish$0$$t5@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t6@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t7@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= _$t0 _$t0)) (and (= _$t3 _$t3) (= inline$$1_ValidatorConfig_publish$0$$t8@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_220322| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 690556) 691120) inline$$1_ValidatorConfig_publish$0$anon15_Then_correct) (=> (= (ControlFlow 0 690556) 690626) inline$$1_ValidatorConfig_publish$0$anon15_Else_correct)))))))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t13 (|$addr#$signer| _$t0))) (and (= $t14 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 691124) 690556))) inline$$1_ValidatorConfig_publish$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 689693) 692257) anon29_Then_correct) (=> (= (ControlFlow 0 689693) 691124) anon29_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (=> (= (ControlFlow 0 689568) 692271) anon28_Then_correct) (=> (= (ControlFlow 0 689568) 689693) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Then_correct  (=> inline$$1_Roles_new_validator_role$0$$t9@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 689562) 689568))) inline$$1_Roles_new_validator_role$0$L2_correct))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Then_correct  (=> (and (and inline$$1_Roles_new_validator_role$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) (= 5 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0)) (= 3 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)))) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 689660) 689568))) inline$$1_Roles_new_validator_role$0$L2_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon7_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 689520) 692271) anon28_Then_correct) (=> (= (ControlFlow 0 689520) 689693) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Else_correct  (=> (and (and (not |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_221004 (|Store__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_221004| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 689494) 689520))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Then_correct  (=> (and (and |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_221004 (|Store__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_new_validator_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 689534) 689520))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Else_correct  (=> (not inline$$1_Roles_new_validator_role$0$$t9@0) (and (=> (= (ControlFlow 0 689480) 689534) inline$$1_Roles_new_validator_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 689480) 689494) inline$$1_Roles_new_validator_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Else_correct  (=> (and (not inline$$1_Roles_new_validator_role$0$$t5@0) (|$IsValid'u64'| 3)) (=> (and (and (= inline$$1_Roles_new_validator_role$0$$t8@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 3 0) (= inline$$1_Roles_new_validator_role$0$$t8@0 173345816))) (and (=> (= 3 1) (= inline$$1_Roles_new_validator_role$0$$t8@0 186537453)) (= inline$$1_Roles_new_validator_role$0$$t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 689474) 689562) inline$$1_Roles_new_validator_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 689474) 689480) inline$$1_Roles_new_validator_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon0_correct  (=> (and (= inline$$1_Roles_new_validator_role$0$$t2@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t3@0 (|$addr#$signer| _$t0))) (=> (and (and (= _$t0 _$t0) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= inline$$1_Roles_new_validator_role$0$$t4@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t5@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 689408) 689660) inline$$1_Roles_new_validator_role$0$anon8_Then_correct) (=> (= (ControlFlow 0 689408) 689474) inline$$1_Roles_new_validator_role$0$anon8_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (and (not false) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 689664) (- 0 927410)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 689664) 689408) inline$$1_Roles_new_validator_role$0$anon0_correct))))))
(let ((anon27_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer _$t1)) (and (=> (= (ControlFlow 0 688788) 692285) anon27_Then_correct) (=> (= (ControlFlow 0 688788) 689664) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $t7) (= (ControlFlow 0 688794) 688788)) inline$$1_DiemAccount_create_signer$0$anon0_correct)))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_221370| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 ...
 :qid |Rolesbpl.37749:20|
 :skolemid |1789|
))))) (and (and (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_222642| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@20)  (and (= addr@@20 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_233241| $1_DiemAccount_DiemAccount_$memory) addr@@20))))
 :qid |Rolesbpl.37753:20|
 :skolemid |1790|
 ...
 :qid |Rolesbpl.37765:20|
 :skolemid |1793|
)))) (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233560| $1_DesignatedDealer_Dealer_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@24)) 2))))
 :qid |Rolesbpl.37769:20|
 :skolemid |1794|
 ...
 :qid |Rolesbpl.37797:20|
 :skolemid |1801|
)))) (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233915| $1_VASP_ChildVASP_$memory) addr@@32)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@32)) 6))))
 :qid |Rolesbpl.37801:20|
 :skolemid |1802|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |Rolesbpl.37845:20|
 :skolemid |1804|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@1) (and (<= (|l#Vec_174600| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1) (<= (|l#Vec_57736| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1))))
 :qid |Rolesbpl.37849:20|
 :skolemid |1805|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1))
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 687268) 688750)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 925606) 687268) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
