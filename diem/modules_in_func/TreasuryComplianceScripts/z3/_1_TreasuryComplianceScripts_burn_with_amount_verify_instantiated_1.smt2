...
(declare-fun |$1_Diem_BurnCapability'#0'_$memory| () T@$Memory_200935)
(declare-fun _$t2@@4 () Int)
(declare-fun $t5@@7 () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@9| () T@$Memory_199883)
(declare-fun $t8@@6 () |T@$1_Diem_Preburn'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@6| () T@$Memory_206435)
(declare-fun $es@7 () T@$EventStore)
(declare-fun $t9@@6 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t11@@5 () T@$1_Event_EventHandle)
(declare-fun $t10@@6 () (Seq Int))
(declare-fun $abort_flag@8 () Bool)
(declare-fun $es@5 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@7| () T@$Memory_199883)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@4| () T@$Memory_206435)
(declare-fun $abort_code@9 () Int)
(declare-fun $es@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@8| () T@$Memory_199883)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@5| () T@$Memory_206435)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@6| () T@$Memory_199883)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@3| () T@$Memory_206435)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2@@0| () T@$Memory_206435)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@5| () T@$Memory_199883)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| () T@$Mutation_210444)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| () T@$Mutation_210444)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@4| () T@$Memory_199883)
(declare-fun $abort_code@7 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun $es@2@@3 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3| () T@$Memory_199883)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| () T@$Mutation_218697)
(declare-fun $es@0@@7 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@0 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@1| () T@$Memory_199883)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2@@1| () T@$Memory_199883)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0| () T@$Mutation_210444)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| () T@$Mutation_16758)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@1| () T@$Memory_199883)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| () T@$Mutation_218697)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| () T@$Mutation_218744)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| () T@$Mutation_210444)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| () |T@$1_Diem_Diem'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| () T@$Mutation_218744)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0| () T@$Mutation_218744)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0| () T@$Mutation_189683)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1@@0| () T@$Memory_206435)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0@@0| () T@$Memory_206435)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1| () |T@$1_Diem_PreburnQueue'#0'|)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0| () T@$Mutation_210444)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t21@0| () (Seq Int))
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t24@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t7@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t12@0| () (Seq Int))
(declare-fun |inline$$1_Diem_burn'#0'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@5 () |T@$1_Diem_Preburn'#0'|)
(declare-fun $t14@@5 () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
(declare-fun $t15@@5 () Int)
(declare-fun $t16@@5 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t17@@5 () |T@$1_Diem_Preburn'#0'|)
(declare-fun $t18@@5 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t19@@5 () (Seq Int))
(declare-fun $t20@@5 () T@$1_Event_EventHandle)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@2@@2 () T@$Memory_197482)
(declare-fun |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@2| () Bool)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@2 () T@$Memory_197482)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@2 () T@$Memory_197482)
...
(declare-fun $t4@@4 () |T@$1_Diem_Preburn'#0'|)
; Valid
(declare-fun _$t0@@8 () T@$signer)
(declare-fun _$t1@@8 () Int)
(declare-fun |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory| () T@$Memory_200761)
(declare-fun _$t2@@5 () Int)
(declare-fun $t5@@8 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9| () T@$Memory_199645)
(declare-fun $t8@@7 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6| () T@$Memory_206237)
(declare-fun $es@7@@0 () T@$EventStore)
(declare-fun $t9@@7 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t11@@6 () T@$1_Event_EventHandle)
(declare-fun $t10@@7 () (Seq Int))
(declare-fun $abort_flag@8@@0 () Bool)
(declare-fun $es@5@@0 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7| () T@$Memory_199645)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4| () T@$Memory_206237)
(declare-fun $abort_code@9@@0 () Int)
(declare-fun $es@6@@0 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8| () T@$Memory_199645)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5| () T@$Memory_206237)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6| () T@$Memory_199645)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3| () T@$Memory_206237)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2@@0| () T@$Memory_206237)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5| () T@$Memory_199645)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@1| () T@$Mutation_208894)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t0@1| () T@$Mutation_208894)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4| () T@$Memory_199645)
(declare-fun $abort_code@7@@0 () Int)
(declare-fun $abort_flag@6@@0 () Bool)
(declare-fun $es@2@@4 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3| () T@$Memory_199645)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4| () T@$Mutation_214414)
(declare-fun $es@0@@8 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@1 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1@@1| () T@$Memory_199645)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2@@1| () T@$Memory_199645)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@0| () T@$Mutation_208894)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@2| () T@$Mutation_16758)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0@@1| () T@$Memory_199645)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@0| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@1| () T@$Mutation_214414)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1| () T@$Mutation_214461)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1| () T@$Mutation_208894)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t29@1| () |T@$1_Diem_Diem'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2| () T@$Mutation_214461)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t10@0| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@0| () T@$Mutation_214461)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@0| () T@$Mutation_189683)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1@@0| () T@$Memory_206237)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0@@0| () T@$Memory_206237)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@0| () T@$Mutation_208894)
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t21@0| () (Seq Int))
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t24@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t7@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t12@0| () (Seq Int))
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@6 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun $t14@@6 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun $t15@@6 () Int)
(declare-fun $t16@@6 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t17@@6 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun $t18@@6 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t19@@6 () (Seq Int))
(declare-fun $t20@@6 () T@$1_Event_EventHandle)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@2@@3 () T@$Memory_197482)
(declare-fun |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@3| () Bool)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@3 () T@$Memory_197482)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@3 () T@$Memory_197482)
...
(declare-fun $t4@@5 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
; Valid
(declare-fun _$t0@@9 () T@$signer)
(declare-fun _$t1@@9 () Int)
(declare-fun |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory| () T@$Memory_200848)
(declare-fun _$t2@@6 () Int)
(declare-fun $t5@@9 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| () T@$Memory_199764)
(declare-fun $t8@@8 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| () T@$Memory_206336)
(declare-fun $es@7@@1 () T@$EventStore)
(declare-fun $t9@@8 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t11@@7 () T@$1_Event_EventHandle)
(declare-fun $t10@@8 () (Seq Int))
(declare-fun $abort_flag@8@@1 () Bool)
(declare-fun $es@5@@1 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| () T@$Memory_199764)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| () T@$Memory_206336)
(declare-fun $abort_code@9@@1 () Int)
(declare-fun $es@6@@1 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| () T@$Memory_199764)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| () T@$Memory_206336)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| () T@$Memory_199764)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| () T@$Memory_206336)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0| () T@$Memory_206336)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| () T@$Memory_199764)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| () T@$Mutation_209669)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1| () T@$Mutation_209669)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| () T@$Memory_199764)
(declare-fun $abort_code@7@@1 () Int)
(declare-fun $abort_flag@6@@1 () Bool)
(declare-fun $es@2@@5 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3| () T@$Memory_199764)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4| () T@$Mutation_216578)
(declare-fun $es@0@@9 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@2 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1@@1| () T@$Memory_199764)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| () T@$Memory_199764)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@0| () T@$Mutation_209669)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2| () T@$Mutation_16758)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@1| () T@$Memory_199764)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1| () T@$Mutation_216578)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1| () T@$Mutation_216625)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1| () T@$Mutation_209669)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1| () |T@$1_Diem_Diem'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2| () T@$Mutation_216625)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t10@0| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@0| () T@$Mutation_216625)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@0| () T@$Mutation_189683)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1@@0| () T@$Memory_206336)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0@@0| () T@$Memory_206336)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@0| () T@$Mutation_209669)
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t21@0| () (Seq Int))
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t24@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t7@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t12@0| () (Seq Int))
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@7 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun $t14@@7 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun $t15@@7 () Int)
(declare-fun $t16@@7 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t17@@7 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun $t18@@7 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t19@@7 () (Seq Int))
(declare-fun $t20@@7 () T@$1_Event_EventHandle)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@2@@4 () T@$Memory_197482)
(declare-fun |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@4| () Bool)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@4 () T@$Memory_197482)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@4 () T@$Memory_197482)
...
(declare-fun $t4@@6 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_burn_with_amount$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 674532) (let ((L2_correct@@7  (and (=> (= (ControlFlow 0 533669) (- 0 679147)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (let (($range_0@@17 ($Range 0 (seq.len $t5@@9))))
(forall (($i_1@@17 Int) ) (!  (=> ($InRange $range_0@@17 $i_1@@17) (let ((i@@86 $i_1@@17))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth $t5@@9 i@@86)))) _$t3@@4))))
 :qid |TreasuryComplianceScriptsbpl.30326:476|
 :skolemid |980|
)))) (= $t6@@9 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (let (($range_0@@18 ($Range 0 (seq.len $t5@@9))))
(forall (($i_1@@18 Int) ) (!  (=> ($InRange $range_0@@18 $i_1@@18) (let ((i@@87 $i_1@@18))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth $t5@@9 i@@87)))) _$t3@@4))))
 :qid |TreasuryComplianceScriptsbpl.30326:476|
 :skolemid |980|
)))) (= $t6@@9 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9)))) (=> (= (ControlFlow 0 533669) (- 0 679282)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))) (= 5 $t12@0@@1)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9) 0)) (= 7 $t12@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9))) (= 4 $t12@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)) (= 5 $t12@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)) (= 5 $t12@0@@1))) (and (let (($range_0@@19 ($Range 0 (seq.len $t5@@9))))
(forall (($i_1@@19 Int) ) (!  (=> ($InRange $range_0@@19 $i_1@@19) (let ((i@@88 $i_1@@19))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth $t5@@9 i@@88)))) _$t3@@4))))
 :qid |TreasuryComplianceScriptsbpl.30331:622|
 :skolemid |981|
))) (= 1 $t12@0@@1))) (and (= $t6@@9 0) (= 1 $t12@0@@1))) (and (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9) (= 8 $t12@0@@1))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9) (= 8 $t12@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t12@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9))) (= 4 $t12@0@@1))) (= 7 $t12@0@@1)) (= 4 $t12@0@@1)) (= 5 $t12@0@@1)) (= 1 $t12@0@@1)) (= 8 $t12@0@@1)))))))
(let ((anon7_Then_correct@@1  (=> (and (and $abort_flag@9@@1 (= $abort_code@10@@1 $abort_code@10@@1)) (and (= $t12@0@@1 $abort_code@10@@1) (= (ControlFlow 0 533235) 533669))) L2_correct@@7)))
(let ((anon6_Then_correct@@1  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t12@0@@1 $abort_code@1@@6) (= (ControlFlow 0 533683) 533669))) L2_correct@@7)))
(let ((anon7_Else_correct@@1  (=> (not $abort_flag@9@@1) (and (=> (= (ControlFlow 0 533221) (- 0 678827)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9)))) (and (=> (= (ControlFlow 0 533221) (- 0 678840)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9) 0))) (and (=> (= (ControlFlow 0 533221) (- 0 678855)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9)))) (and (=> (= (ControlFlow 0 533221) (- 0 678868)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (and (=> (= (ControlFlow 0 533221) (- 0 678879)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (and (=> (= (ControlFlow 0 533221) (- 0 678890)) (not (let (($range_0@@20 ($Range 0 (seq.len $t5@@9))))
(forall (($i_1@@20 Int) ) (!  (=> ($InRange $range_0@@20 $i_1@@20) (let ((i@@89 $i_1@@20))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth $t5@@9 i@@89)))) _$t3@@4))))
 :qid |TreasuryComplianceScriptsbpl.30263:57|
 :skolemid |979|
))))) (=> (not (let (($range_0@@21 ($Range 0 (seq.len $t5@@9))))
(forall (($i_1@@21 Int) ) (!  (=> ($InRange $range_0@@21 $i_1@@21) (let ((i@@90 $i_1@@21))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth $t5@@9 i@@90)))) _$t3@@4))))
 :qid |TreasuryComplianceScriptsbpl.30263:57|
 :skolemid |979|
)))) (and (=> (= (ControlFlow 0 533221) (- 0 678937)) (not (= $t6@@9 0))) (=> (not (= $t6@@9 0)) (and (=> (= (ControlFlow 0 533221) (- 0 678948)) (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (and (=> (= (ControlFlow 0 533221) (- 0 678961)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7@@8) $t6@@9)) (and (=> (= (ControlFlow 0 533221) (- 0 678974)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 533221) (- 0 678984)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@9)))) (and (=> (= (ControlFlow 0 533221) (- 0 678997)) (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8@@8))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8@@8)))) (and (=> (= (ControlFlow 0 533221) (- 0 679020)) (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8@@8))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8@@8)))) (and (=> (= (ControlFlow 0 533221) (- 0 679043)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6|) _$t2@@6))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6|) _$t2@@6)) (and (=> (= (ControlFlow 0 533221) (- 0 679056)) (let ((actual@@44 ($EventStore (- (|counter#$EventStore| $es@7@@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7@@1) (|streams#$EventStore| $es)))))
(let ((expected@@44 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9@@8)) (let ((stream@@107 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7)))
(let ((stream_new@@96 (let ((len@@96 (|l#Multiset_157370| stream@@107)))
(let ((cnt@@96 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@107) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@107) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)) (+ cnt@@96 1)) (+ len@@96 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7 stream_new@@96)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@44) (|counter#$EventStore| actual@@44)) (forall ((handle@@56 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@44) handle@@56)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@44) handle@@56))) (forall ((v@@104 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@44) handle@@56)) v@@104) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@44) handle@@56)) v@@104))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
)))))) (=> (let ((actual@@45 ($EventStore (- (|counter#$EventStore| $es@7@@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7@@1) (|streams#$EventStore| $es)))))
(let ((expected@@45 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9@@8)) (let ((stream@@108 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7)))
(let ((stream_new@@97 (let ((len@@97 (|l#Multiset_157370| stream@@108)))
(let ((cnt@@97 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@108) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@108) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)) (+ cnt@@97 1)) (+ len@@97 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7 stream_new@@97)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| expected@@45) (|counter#$EventStore| actual@@45)) (forall ((handle@@57 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@45) handle@@57)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@45) handle@@57))) (forall ((v@@105 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@45) handle@@57)) v@@105) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@45) handle@@57)) v@@105))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 533221) (- 0 679097)) (let ((actual@@46 ($EventStore (- (|counter#$EventStore| $es@7@@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7@@1) (|streams#$EventStore| $es)))))
(let ((expected@@46 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9@@8)) (let ((stream@@109 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7)))
(let ((stream_new@@98 (let ((len@@98 (|l#Multiset_157370| stream@@109)))
(let ((cnt@@98 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@109) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@109) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) $t10@@8 _$t2@@6)) (+ cnt@@98 1)) (+ len@@98 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t11@@7 stream_new@@98)))) $EmptyEventStore)))
 (and (<= (|counter#$EventStore| actual@@46) (|counter#$EventStore| expected@@46)) (forall ((handle@@58 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@46) handle@@58)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@46) handle@@58))) (forall ((v@@106 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@46) handle@@58)) v@@106) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@46) handle@@58)) v@@106))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
...
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8@@1) (= $es@7@@1 $es@5@@1)) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4|)) (and (= $abort_flag@9@@1 $abort_flag@8@@1) (= $abort_code@10@@1 $abort_code@9@@1))) (and (=> (= (ControlFlow 0 532798) 533235) anon7_Then_correct@@1) (=> (= (ControlFlow 0 532798) 533221) anon7_Else_correct@@1))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|  (=> (= $es@7@@1 $es@6@@1) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5|)) (and (= $abort_flag@9@@1 true) (= $abort_code@10@@1 |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1|))) (and (=> (= (ControlFlow 0 528369) 533235) anon7_Then_correct@@1) (=> (= (ControlFlow 0 528369) 533221) anon7_Else_correct@@1))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|  (=> $abort_flag@8@@1 (=> (and (= $abort_code@9@@1 $abort_code@9@@1) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| $abort_code@9@@1)) (=> (and (and (= $es@6@@1 $es@5@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4|) (= (ControlFlow 0 532812) 528369))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|  (=> (= $abort_code@9@@1 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1|) (=> (and (and (= $es@5@@1 $es@4@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3|) (= $abort_flag@8@@1 true))) (and (=> (= (ControlFlow 0 532677) 532812) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 532677) 532798) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= $es@4@@1 $es@3@@1) (= (ControlFlow 0 532671) 532677)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|  (=> $abort_flag@7@@1 (=> (and (= $abort_code@8@@1 $abort_code@8@@1) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| $abort_code@8@@1)) (=> (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= $es@4@@1 $es@3@@1) (= (ControlFlow 0 532691) 532677))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)) (= 5 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0| ($Range 0 (seq.len |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i|)))) _$t3@@4))))
 :qid |unknown.0:0|
 :skolemid |183|
))) (= 1 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@4@@1 $es) (= (ControlFlow 0 532784) 532677)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0|) (= $abort_code@9@@1 $abort_code@8@@1)) (=> (and (and (= $es@5@@1 $es@3@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0|) (= $abort_flag@8@@1 $abort_flag@7@@1))) (and (=> (= (ControlFlow 0 532643) 532812) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 532643) 532798) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|  (=> (not $abort_flag@7@@1) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t3@1| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0| (> (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 532635) 532671) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 532635) 532643) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1|) (= $abort_code@8@@1 $abort_code@7@@1)) (and (= $abort_flag@7@@1 $abort_flag@6@@1) (= $es@3@@1 $es@2@@5))) (and (=> (= (ControlFlow 0 532276) 532691) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 532276) 532635) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Else_correct|  (=> (not $abort_flag@6@@1) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3| ($Memory_199764 (|Store__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)))) (= $es@2@@5 $es@0@@9)) (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3|) (= (ControlFlow 0 532401) 532276))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1@@2) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1@@1| ($Memory_199764 (|Store__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)))) (= $es@2@@5 $es)) (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1@@1|) (= (ControlFlow 0 532262) 532276))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@0|) (= $abort_code@8@@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1|)) (and (= $abort_flag@7@@1 true) (= $es@3@@1 $es@1@@8))) (and (=> (= (ControlFlow 0 531192) 532691) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 531192) 532635) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Then_correct|  (=> (and $abort_flag@6@@1 (= $abort_code@7@@1 $abort_code@7@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@7@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es@0@@9) (= (ControlFlow 0 532415) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct@@1|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1@@1| (|v#$Mutation_189683| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1|)) (= $es@0@@9 (let ((stream@@110 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1@@1|)))
(let ((stream_new@@99 (let ((len@@99 (|l#Multiset_157370| stream@@110)))
(let ((cnt@@99 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@110) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1|))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@110) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1|) (+ cnt@@99 1)) (+ len@@99 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1@@1| stream_new@@99)))))) (and (=> (= (ControlFlow 0 532373) 532415) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 532373) 532401) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1@@2 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1| ($Mutation_189683 (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|) (seq.++ (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|) (seq.unit 9)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| _$t2@@6)) (= (ControlFlow 0 532379) 532373))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct@@1|)))
(let ((inline$$Not$0$anon0_correct@@2  (=> (= inline$$Not$0$dst@1@@2  (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t50@1|)) (and (=> (= (ControlFlow 0 532234) 532379) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 532234) 532262) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6@@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1| ($Mutation_16758 (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (seq.++ (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (seq.unit 1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2| ($Mutation_16758 (|l#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1|) (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1|) inline$$Sub$1$dst@2@@1)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4| ($Mutation_216578 (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|v#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|))) (= (ControlFlow 0 532240) 532234))) inline$$Not$0$anon0_correct@@2))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|  (=> (and $abort_flag@6@@1 (= $abort_code@7@@1 $abort_code@7@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@7@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532429) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct@@1  (=> (= $abort_flag@6@@1 true) (=> (and (= $abort_code@7@@1 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2@@1 inline$$Sub$1$dst@0@@1)) (and (=> (= (ControlFlow 0 532150) 532429) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 532150) 532240) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct@@1  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= (ControlFlow 0 532148) 532150)) inline$$Sub$1$anon3_Then$1_correct@@1)))
(let ((inline$$Sub$1$anon3_Else_correct@@1  (=> (<= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1@@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|)) (= $abort_flag@6@@1 $abort_flag@5@@1)) (and (= $abort_code@7@@1 $abort_code@6@@1) (= inline$$Sub$1$dst@2@@1 inline$$Sub$1$dst@1@@1))) (and (=> (= (ControlFlow 0 532100) 532429) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 532100) 532240) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1@@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 532156) 532148) inline$$Sub$1$anon3_Then_correct@@1) (=> (= (ControlFlow 0 532156) 532100) inline$$Sub$1$anon3_Else_correct@@1)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1@@1) (=> (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@1| ($Memory_199764 (|Store__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@1|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532009) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= inline$$Ge$1$dst@1@@1 inline$$Ge$1$dst@1@@1))) (and (=> (= (ControlFlow 0 531981) 532156) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 531981) 532009) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct@@1  (=> (and (= inline$$Ge$1$dst@1@@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|)) (= (ControlFlow 0 531945) 531981)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5@@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1| ($Mutation_16758 (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (seq.++ (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (seq.unit 0)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2| ($Mutation_16758 (|l#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1|) (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1|) inline$$Sub$0$dst@2@@1)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3| ($Mutation_216578 (|l#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|))) (= (ControlFlow 0 531951) 531945))) inline$$Ge$1$anon0_correct@@1))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|  (=> (and $abort_flag@5@@1 (= $abort_code@6@@1 $abort_code@6@@1)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@6@@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532443) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct@@1  (=> (= $abort_code@6@@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5@@1 true) (= inline$$Sub$0$dst@2@@1 inline$$Sub$0$dst@0@@1)) (and (=> (= (ControlFlow 0 531851) 532443) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 531851) 531951) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct@@1  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| inline$$CastU128$1$dst@1@@1) (= (ControlFlow 0 531849) 531851)) inline$$Sub$0$anon3_Then$1_correct@@1)))
(let ((inline$$Sub$0$anon3_Else_correct@@1  (=> (<= inline$$CastU128$1$dst@1@@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1@@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| inline$$CastU128$1$dst@1@@1)) (= $abort_code@6@@1 $abort_code@5@@2)) (and (= $abort_flag@5@@1 $abort_flag@4@@2) (= inline$$Sub$0$dst@2@@1 inline$$Sub$0$dst@1@@1))) (and (=> (= (ControlFlow 0 531801) 532443) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 531801) 531951) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|  (=> (not $abort_flag@4@@2) (and (=> (= (ControlFlow 0 531857) 531849) inline$$Sub$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 531857) 531801) inline$$Sub$0$anon3_Else_correct@@1)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|  (=> (and $abort_flag@4@@2 (= $abort_code@5@@2 $abort_code@5@@2)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@5@@2) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532457) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct@@1  (=> (= $abort_flag@4@@2 true) (=> (and (= $abort_code@5@@2 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1@@1 inline$$CastU128$1$dst@0@@1)) (and (=> (= (ControlFlow 0 531706) 532457) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 531706) 531857) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct@@1  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 531704) 531706)) inline$$CastU128$1$anon3_Then$1_correct@@1)))
(let ((inline$$CastU128$1$anon3_Else_correct@@1  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= $abort_flag@4@@2 $abort_flag@3@@3)) (and (= $abort_code@5@@2 $abort_code@4@@3) (= inline$$CastU128$1$dst@1@@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|))) (and (=> (= (ControlFlow 0 531656) 532457) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 531656) 531857) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1@@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 531712) 531704) inline$$CastU128$1$anon3_Then_correct@@1) (=> (= (ControlFlow 0 531712) 531656) inline$$CastU128$1$anon3_Else_correct@@1)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1@@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 531577) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= inline$$Ge$0$dst@1@@1 inline$$Ge$0$dst@1@@1))) (and (=> (= (ControlFlow 0 531561) 531712) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 531561) 531577) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct@@1  (=> (and (= inline$$Ge$0$dst@1@@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t34@1| inline$$CastU128$0$dst@1@@1)) (= (ControlFlow 0 531525) 531561)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3@@3) (= (ControlFlow 0 531531) 531525)) inline$$Ge$0$anon0_correct@@1)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|  (=> (and $abort_flag@3@@3 (= $abort_code@4@@3 $abort_code@4@@3)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@4@@3) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532471) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct@@1  (=> (= $abort_code@4@@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3@@3 true) (= inline$$CastU128$0$dst@1@@1 inline$$CastU128$0$dst@0@@1)) (and (=> (= (ControlFlow 0 531471) 532471) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 531471) 531531) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct@@1  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 531469) 531471)) inline$$CastU128$0$anon3_Then$1_correct@@1)))
(let ((inline$$CastU128$0$anon3_Else_correct@@1  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= $abort_code@4@@3 $abort_code@3@@3)) (and (= $abort_flag@3@@3 $abort_flag@2@@3) (= inline$$CastU128$0$dst@1@@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|))) (and (=> (= (ControlFlow 0 531421) 532471) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 531421) 531531) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2@@3) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 531477) 531469) inline$$CastU128$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 531477) 531421) inline$$CastU128$0$anon3_Else_correct@@1)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|  (=> (and $abort_flag@2@@3 (= $abort_code@3@@3 $abort_code@3@@3)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@3@@3) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532485) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2@@3 true) (=> (and (= $abort_code@3@@3 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0|)) (and (=> (= (ControlFlow 0 532537) 532485) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 532537) 531477) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 532535) 532537)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1| ($Mutation_216578 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $abort_flag@2@@3 $abort_flag@1@@3)) (and (= $abort_code@3@@3 $abort_code@2@@3) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1|))) (and (=> (= (ControlFlow 0 531326) 532485) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 531326) 531477) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 531304) 532535) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 531304) 531326) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532563) 531192)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1@@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1| ($Mutation_216625 (|l#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (seq.++ (|p#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (seq.unit 0)) (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1| (|v#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2| ($Mutation_216625 (|l#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|) (|p#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Diem'$1_XDX_XDX''@1|)) (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| (|v#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| (|v#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|) (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|v#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1| ($Mutation_209669 (|l#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (|p#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (|$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 531290) 532563) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 531290) 531304) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1@@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 531186) 531192))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= inline$$Gt$0$dst@1@@1 inline$$Gt$0$dst@1@@1))) (and (=> (= (ControlFlow 0 531170) 531290) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 531170) 531186) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct@@1  (=> (and (= inline$$Gt$0$dst@1@@1 (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t22@1| 0)) (= (ControlFlow 0 531134) 531170)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0|)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t22@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 531140) 531134)))) inline$$Gt$0$anon0_correct@@1)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1@@8 $es) (= (ControlFlow 0 532589) 531192)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon0_correct|  (=> (= (seq.len (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t10@0|)) 0) (=> (and (and (and (and (= (seq.len (|p#$Mutation_216625| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@0|)) 0) (= (seq.len (|p#$Mutation_216578| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0|)) 0)) (and (= (seq.len (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@0|)) 0) (= (seq.len (|p#$Mutation_16758| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@0|)) 0))) (and (and (= (seq.len (|p#$Mutation_189683| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t12@0| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t13@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1|) (= _$t2@@6 _$t2@@6)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 531052) 532589) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 531052) 531140) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'$1_XDX_XDX''| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0|) _$t2@@6))) (=> (and (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|))) _$t3@@4) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1| ($Mutation_209669 ($Local 3) (as seq.empty (Seq Int)) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t20@0| (|v#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t21@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t23@0|)) (= (ControlFlow 0 532595) 531052)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1@@0| ($Memory_206336 (|Store__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6 false) (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|)))) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1@@0|) (= (ControlFlow 0 529492) 532595))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0@@0| ($Memory_206336 (|Store__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6 true) (|Store__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'$1_Diem_PreburnQueue'$1_XDX_XDX''@1|)))) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@0| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0@@0|) (= (ControlFlow 0 532703) 532595))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0|) (and (=> (= (ControlFlow 0 529480) 532703) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 529480) 529492) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon0_correct|  (=> (and (= (seq.len (|p#$Mutation_209669| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t8@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t10@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t12@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= _$t2@@6 _$t2@@6))) (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2|) (= _$t3@@4 _$t3@@4)) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0@@0| ($Range 0 (seq.len |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i@@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i@@0|)))) _$t3@@4))))
 :qid |unknown.0:0|
 :skolemid |182|
)))))))) (and (=> (= (ControlFlow 0 529472) 532784) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 529472) 529480) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1@@3) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t23@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))))) (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t25@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t23@0|))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t27@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= (ControlFlow 0 532788) 529472)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|  (=> $abort_flag@1@@3 (=> (and (= $abort_code@2@@3 $abort_code@2@@3) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| $abort_code@2@@3)) (=> (and (and (= $es@6@@1 $es) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 532826) 528369))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then$1_correct|  (=> (= $abort_code@2@@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@3 true) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@0|)) (and (=> (= (ControlFlow 0 532878) 532826) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 532878) 532788) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (= (ControlFlow 0 532876) 532878)) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (= $abort_code@2@@3 $abort_code@1@@6)) (and (= $abort_flag@1@@3 $abort_flag@0@@6) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@1|))) (and (=> (= (ControlFlow 0 528389) 532826) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 528389) 532788) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| (and (=> (= (ControlFlow 0 528375) 532876) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 528375) 528389) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|)) (=> (and (and (= $es@6@@1 $es) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 528363) 528369))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t6@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6)))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t8@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t6@0|))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t10@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t11@0|)))) (and (and (= _$t0@@9 _$t0@@9) (= _$t2@@6 _$t2@@6)) (and (= _$t3@@4 _$t3@@4) (|$IsValid'address'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0| (|$addr#$signer| _$t0@@9)) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 528347) 528375) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 528347) 528363) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct@@1  (=> (and (not $abort_flag@0@@6) (= $t13@@7 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4)))) (=> (and (and (and (= $t14@@7 (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))) (= $t15@@7 (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t13@@7)))) (and (= $t16@@7 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t17@@7 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))))) (and (and (= $t18@@7 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t19@@7 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= $t20@@7 (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t18@@7)) (= (ControlFlow 0 532882) 528347)))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@4  (=> (and (= $abort_flag@0@@6 true) (= $abort_code@1@@6 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@4)) (and (=> (= (ControlFlow 0 527422) 533683) anon6_Then_correct@@1) (=> (= (ControlFlow 0 527422) 532882) anon6_Else_correct@@1)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@4  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@4) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4) (= (ControlFlow 0 527416) 527422))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@4)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@4  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@4)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@4)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@4) (= (ControlFlow 0 527472) 527422))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@4))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@4  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@4 (=> (and (= $abort_flag@0@@6 false) (= $abort_code@1@@6 $abort_code@0@@6)) (and (=> (= (ControlFlow 0 527428) 533683) anon6_Then_correct@@1) (=> (= (ControlFlow 0 527428) 532882) anon6_Else_correct@@1))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@4  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@4) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@4 ($1_SlidingNonce_spec_try_record_nonce _$t0@@9 _$t1@@9))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory@2@@4) (|$addr#$signer| _$t0@@9)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@4)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@4 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@4 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@4) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@4 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@4)))) (and (=> (= (ControlFlow 0 527400) 527428) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@4) (=> (= (ControlFlow 0 527400) 527416) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@4))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@4  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@4|) (= $1_SlidingNonce_SlidingNonce_$memory@1@@4 ($Memory_197482 (|Store__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9) false) (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2@@4 $1_SlidingNonce_SlidingNonce_$memory@1@@4) (= (ControlFlow 0 527334) 527400))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@4)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@4  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@4| (= $1_SlidingNonce_SlidingNonce_$memory@0@@4 ($Memory_197482 (|Store__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@4|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2@@4 $1_SlidingNonce_SlidingNonce_$memory@0@@4) (= (ControlFlow 0 527442) 527400))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@4)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@4  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@4) (and (=> (= (ControlFlow 0 527320) 527442) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@4) (=> (= (ControlFlow 0 527320) 527334) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@4)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@4  (=> (= _$t0@@9 _$t0@@9) (=> (and (= _$t1@@9 _$t1@@9) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@9))))) (and (=> (= (ControlFlow 0 527314) 527472) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@4) (=> (= (ControlFlow 0 527314) 527320) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@4))))))
(let ((anon0$1_correct@@9  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@7 Int) (mint_cap_owner2@@7 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@7) (=> (|$IsValid'address'| mint_cap_owner2@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_200378| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_200378| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@7)) (= mint_cap_owner1@@7 mint_cap_owner2@@7))))
 :qid |TreasuryComplianceScriptsbpl.30055:104|
 :skolemid |966|
)))) (=> (and (and (and (forall ((addr3@@7 Int) ) (!  (=> (|$IsValid'address'| addr3@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_200378| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |TreasuryComplianceScriptsbpl.30059:20|
 :skolemid |967|
)) (forall ((addr1@@14 Int) ) (!  (=> (|$IsValid'address'| addr1@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@14)) 1))))
 :qid |TreasuryComplianceScriptsbpl.30063:20|
 :skolemid |968|
))) (and (forall ((addr1@@15 Int) ) (!  (=> (|$IsValid'address'| addr1@@15) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_205919| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@15)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@15)) 2))))
 :qid |TreasuryComplianceScriptsbpl.30067:20|
 :skolemid |969|
)) (forall ((dd_addr@@9 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_205919| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@9) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_Preburn'$1_XDX_XDX'_| (|contents#$Memory_205919| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@9))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@9)))))
 :qid |TreasuryComplianceScriptsbpl.30071:20|
 :skolemid |970|
)))) (and (and (forall ((dd_addr@@10 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) dd_addr@@10) (not (|Select__T@[Int]Bool_| (|domain#$Memory_205919| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) dd_addr@@10))))
 :qid |TreasuryComplianceScriptsbpl.30075:20|
 :skolemid |971|
)) (forall ((addr@@284 Int) ) (!  (=> (|$IsValid'address'| addr@@284) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_205919| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@284) (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.30079:20|
 :skolemid |972|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall ((addr@@285 Int) ) (!  (=> (|$IsValid'address'| addr@@285) (= (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) addr@@285)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@285) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@285)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@285) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@285)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.30087:20|
 :skolemid |973|
))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@9)) ($1_Signer_is_txn_signer _$t0@@9)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@9))) (|$IsValid'u64'| _$t1@@9)) (and (and (|$IsValid'address'| _$t2@@6) (|$IsValid'u64'| _$t3@@4)) (and (forall (($a_0@@103 Int) ) (! (let (($rsc@@103 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@103)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@103))
 :qid |TreasuryComplianceScriptsbpl.30102:20|
 :skolemid |974|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@103))
)) (forall (($a_0@@104 Int) ) (! (let (($rsc@@104 (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) $a_0@@104)))
(|$IsValid'$1_Diem_BurnCapability'$1_XDX_XDX''| $rsc@@104))
 :qid |TreasuryComplianceScriptsbpl.30106:20|
 :skolemid |975|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_200848| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) $a_0@@104))
))))) (and (and (and (and (forall (($a_0@@105 Int) ) (! (let (($rsc@@105 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@105)))
 ...
 :qid |TreasuryComplianceScriptsbpl.30110:20|
 :skolemid |976|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@105))
)) (forall (($a_0@@106 Int) ) (! (let (($rsc@@106 (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) $a_0@@106)))
 (and (|$IsValid'$1_Diem_PreburnQueue'$1_XDX_XDX''| $rsc@@106) (and (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@106)) 256) (let (($range_1@@6 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@106)))))
(forall (($i_2@@6 Int) ) (!  (=> ($InRange $range_1@@6 $i_2@@6) (let ((i@@91 $i_2@@6))
(> (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@106) i@@91)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.30115:223|
 :skolemid |977|
))))))
 :qid |TreasuryComplianceScriptsbpl.30114:20|
 :skolemid |978|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) $a_0@@106))
))) (and (= $t4@@6 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= $t5@@9 (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_206336| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2@@6))))) (and (and (= $t6@@9 (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t4@@6))) (= $t7@@8 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= $t8@@8 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3@@4))) (= $t9@@8 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (and (and (= $t10@@8 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_199764| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t11@@7 (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9@@8))) (and (let ((addr@@286 (|$addr#$signer| _$t0@@9)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@286)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@286) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@286)))))) (= _$t0@@9 _$t0@@9))) (and (and (= _$t1@@9 _$t1@@9) (= _$t2@@6 _$t2@@6)) (and (= _$t3@@4 _$t3@@4) (= (ControlFlow 0 527476) 527314)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@4))))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@59 T@$1_Event_EventHandle) ) (! (let ((stream@@111 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) handle@@59)))
 (and (= (|l#Multiset_157370| stream@@111) 0) (forall ((v@@107 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@111) v@@107) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 526351) 527476)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 674532) 526351) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
