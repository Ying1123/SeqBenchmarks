...
(declare-fun |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory| () T@$Memory_212133)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory| () T@$Memory_218414)
(declare-fun _$t2 () Int)
(declare-fun $t5 () T@Vec_159999)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| () T@$Memory_211043)
(declare-fun $t8 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| () T@$Memory_218414)
(declare-fun $es@7 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun $t9 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| () T@$Memory_211043)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| () T@$Memory_218414)
(declare-fun $abort_code@9 () Int)
(declare-fun $es@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| () T@$Memory_211043)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| () T@$Memory_218414)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| () Int)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| () Int)
(declare-fun $es@4 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| () T@$Memory_211043)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| () T@$Memory_218414)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| () T@$Memory_211043)
(declare-fun $es@3 () T@$EventStore)
(declare-fun $abort_flag@7 () Bool)
(declare-fun $abort_code@8 () Int)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0| () Bool)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0| () T@Vec_159999)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t3@1| () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| () T@$Mutation_221820)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1| () T@$Mutation_221820)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| () T@$Memory_211043)
(declare-fun $abort_code@7 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun $es@2 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3| () T@$Memory_211043)
(declare-fun |Store__T@[Int]Bool_| (|T@[Int]Bool| Int Bool) |T@[Int]Bool|)
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?x2 Bool)) (! (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Bool)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Bool_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4| () T@$Mutation_228843)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@0| () T@$Mutation_221820)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t50@1| () Bool)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1| () T@$Mutation_228843)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1| () T@$Mutation_228893)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1| () T@$Mutation_221820)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1| () |T@$1_Diem_Diem'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2| () T@$Mutation_228893)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t10@0| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@0| () T@$Mutation_228893)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@0| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t16@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t18@1| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t24@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@0| () T@$Mutation_221820)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t5@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t6@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t9@0| () T@Vec_159999)
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t20@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t21@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t22@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t23@0| () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t24@0| () T@Vec_159999)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t25@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t26@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t27@0| () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@0| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@1| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
...
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| () Bool)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t6@0| () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t7@0| () T@Vec_159999)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t10@0| () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t11@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t12@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun $t14 () T@Vec_159999)
(declare-fun $t15 () Int)
(declare-fun $t16 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t17 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
(declare-fun $t18 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
...
(declare-fun $t4 () |T@$1_Diem_Preburn'$1_XDX_XDX'|)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_burn_with_amount$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 695315) (let ((L2_correct  (and (=> (= (ControlFlow 0 547726) (- 0 699930)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (let (($range_0 ($Range 0 (|l#Vec_159999| $t5))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@126 $i_1))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| $t5) i@@126)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30407:476|
 :skolemid |1012|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (let (($range_0@@0 ($Range 0 (|l#Vec_159999| $t5))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@127 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| $t5) i@@127)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30407:476|
 :skolemid |1012|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 547726) (- 0 700065)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)) (= 5 $t12@0))) (and (let (($range_0@@1 ($Range 0 (|l#Vec_159999| $t5))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@128 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| $t5) i@@128)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30412:622|
 :skolemid |1013|
))) (= 1 $t12@0))) (and (= $t6 0) (= 1 $t12@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6) (= 8 $t12@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6) (= 8 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (= 7 $t12@0)) (= 4 $t12@0)) (= 5 $t12@0)) (= 1 $t12@0)) (= 8 $t12@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@10 $abort_code@10)) (and (= $t12@0 $abort_code@10) (= (ControlFlow 0 547292) 547726))) L2_correct)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t12@0 $abort_code@1) (= (ControlFlow 0 547740) 547726))) L2_correct)))
(let ((anon7_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 547278) (- 0 699610)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 547278) (- 0 699623)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 547278) (- 0 699638)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 547278) (- 0 699651)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 547278) (- 0 699662)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 547278) (- 0 699673)) (not (let (($range_0@@2 ($Range 0 (|l#Vec_159999| $t5))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@129 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| $t5) i@@129)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30344:57|
 :skolemid |1011|
))))) (=> (not (let (($range_0@@3 ($Range 0 (|l#Vec_159999| $t5))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@130 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| $t5) i@@130)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30344:57|
 :skolemid |1011|
)))) (and (=> (= (ControlFlow 0 547278) (- 0 699720)) (not (= $t6 0))) (=> (not (= $t6 0)) (and (=> (= (ControlFlow 0 547278) (- 0 699731)) (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (and (=> (= (ControlFlow 0 547278) (- 0 699744)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t7) $t6)) (and (=> (= (ControlFlow 0 547278) (- 0 699757)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 547278) (- 0 699767)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 547278) (- 0 699780)) (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8)))) (and (=> (= (ControlFlow 0 547278) (- 0 699803)) (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t8)))) (and (=> (= (ControlFlow 0 547278) (- 0 699826)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6|) _$t2))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6|) _$t2)) (and (=> (= (ControlFlow 0 547278) (- 0 699839)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_159418| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_159418| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 547278) (- 0 699880)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_159418| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) $t10 _$t2)) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8) (= $es@7 $es@5)) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4|)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 546855) 547292) anon7_Then_correct) (=> (= (ControlFlow 0 546855) 547278) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|  (=> (= $es@7 $es@6) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@9| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5|)) (and (= $abort_flag@9 true) (= $abort_code@10 |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1|))) (and (=> (= (ControlFlow 0 542426) 547292) anon7_Then_correct) (=> (= (ControlFlow 0 542426) 547278) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|  (=> $abort_flag@8 (=> (and (= $abort_code@9 $abort_code@9) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| $abort_code@9)) (=> (and (and (= $es@6 $es@5) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4|) (= (ControlFlow 0 546869) 542426))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|  (=> (= $abort_code@9 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3|) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 546734) 546869) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 546734) 546855) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 546728) 546734)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|  (=> $abort_flag@7 (=> (and (= $abort_code@8 $abort_code@8) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| $abort_code@8)) (=> (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 546748) 546734))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)) (= 5 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0| ($Range 0 (|l#Vec_159999| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |215|
))) (= 1 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@6| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 546841) 546734)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0|) (= $abort_code@9 $abort_code@8)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@7| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2|) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 546700) 546869) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 546700) 546855) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t3@1| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t28@0| (> (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 546692) 546728) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 546692) 546700) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@2|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1|) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= $es@3 $es@2))) (and (=> (= (ControlFlow 0 546333) 546748) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 546333) 546692) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3| ($Memory_211043 (|Store__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)))) (= $es@2 $es@0)) (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3|) (= (ControlFlow 0 546458) 546333))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| ($Memory_211043 (|Store__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1|) (= (ControlFlow 0 546319) 546333))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$ret0@0|) (= $abort_code@8 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1|)) (and (= $abort_flag@7 true) (= $es@3 $es@1))) (and (=> (= (ControlFlow 0 545249) 546748) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 545249) 546692) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es@0) (= (ControlFlow 0 546472) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 546430) 546472) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 546430) 546458) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@1| ($Mutation_199923 (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|) (let ((l (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|)) l 9) (+ l 1))) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| _$t2)) (= (ControlFlow 0 546436) 546430))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t50@1|)) (and (=> (= (ControlFlow 0 546291) 546436) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 546291) 546319) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1| ($Mutation_17352 (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4| ($Mutation_228843 (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@4|))) (= (ControlFlow 0 546297) 546291))) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546486) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 546207) 546486) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 546207) 546297) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= (ControlFlow 0 546205) 546207)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 546157) 546486) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 546157) 546297) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 546213) 546205) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 546213) 546157) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_211043 (|Store__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)) (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|)) (and (= $es@1 $es) (= (ControlFlow 0 546066) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 546038) 546213) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 546038) 546066) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|)) (= (ControlFlow 0 546002) 546038)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1| ($Mutation_17352 (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (let ((l@@1 (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) l@@1 0) (+ l@@1 1))) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3| ($Mutation_228843 (|l#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@3|))) (= (ControlFlow 0 546008) 546002))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546500) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 545908) 546500) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 545908) 546008) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 545906) 545908)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 545858) 546500) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 545858) 546008) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 545914) 545906) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 545914) 545858) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|  (=> (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@5) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546514) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 545763) 546514) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 545763) 545914) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 545761) 545763)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|))) (and (=> (= (ControlFlow 0 545713) 546514) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 545713) 545914) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 545769) 545761) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 545769) 545713) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 545634) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 545618) 545769) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 545618) 545634) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 545582) 545618)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3) (= (ControlFlow 0 545588) 545582)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@4) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546528) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 545528) 546528) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 545528) 545588) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 545526) 545528)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|))) (and (=> (= (ControlFlow 0 545478) 546528) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 545478) 545588) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 545534) 545526) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 545534) 545478) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| $abort_code@3) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546542) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0|)) (and (=> (= (ControlFlow 0 546594) 546542) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 546594) 545534) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 546592) 546594)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1| ($Mutation_228843 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@1|))) (and (=> (= (ControlFlow 0 545383) 546542) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 545383) 545534) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 545361) 546592) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 545361) 545383) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546620) 545249)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1| ($Mutation_228893 (|l#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (let ((l@@2 (|l#Vec_25263| (|p#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|)) l@@2 0) (+ l@@2 1))) (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1| (|v#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2| ($Mutation_228893 (|l#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|) (|p#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Diem'$1_XDX_XDX''@1|)) (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| (|v#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| (|v#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'$1_XDX_XDX''| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|) (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|v#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t0@1| ($Mutation_221820 (|l#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (|p#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|) (|$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 545347) 546620) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 545347) 545361) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 545243) 545249))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 545227) 545347) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 545227) 545243) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t22@1| 0)) (= (ControlFlow 0 545191) 545227)) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t22@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 545197) 545191)))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 546646) 545249)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t10@0|)) 0) (=> (and (and (and (and (= (|l#Vec_25263| (|p#$Mutation_228893| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t27@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t33@0|)) 0)) (and (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t42@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t49@0|)) 0))) (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t12@0| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t13@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$temp_0'$1_Diem_Preburn'$1_XDX_XDX''@1|) (= _$t2 _$t2)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 545109) 546646) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 545109) 545197) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'$1_XDX_XDX''| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2|) _$t2))) (=> (and (and (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|))) _$t3) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1| ($Mutation_221820 ($Local 3) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t20@0| (|v#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t21@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t23@0|)) (= (ControlFlow 0 546652) 545109)))) |inline$$1_Diem_burn_with_resource_cap'$1_XDX_XDX'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1| ($Memory_218414 (|Store__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2 false) (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|)))) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1|) (= (ControlFlow 0 543549) 546652))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0| ($Memory_218414 (|Store__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2 true) (|Store__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2 |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$temp_0'$1_Diem_PreburnQueue'$1_XDX_XDX''@1|)))) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0|) (= (ControlFlow 0 546760) 546652))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0|) (and (=> (= (ControlFlow 0 543537) 546760) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 543537) 543549) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon0_correct|  (=> (and (= (|l#Vec_25263| (|p#$Mutation_221820| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t8@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t10@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t12@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= _$t2 _$t2))) (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2|) (= _$t3 _$t3)) (and (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (= |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0@@0| ($Range 0 (|l#Vec_159999| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i@@0| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$i@@0|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |214|
)))))))) (and (=> (= (ControlFlow 0 543529) 546841) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 543529) 543537) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t23@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))))) (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t25@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t23@0|))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t27@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= (ControlFlow 0 546845) 543529)))) |inline$$1_Diem_burn_with_capability'$1_XDX_XDX'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| $abort_code@2)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 546883) 542426))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@0|)) (and (=> (= (ControlFlow 0 546935) 546883) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 546935) 546845) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (= (ControlFlow 0 546933) 546935)) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@2| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t19@1|))) (and (=> (= (ControlFlow 0 542446) 546883) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 542446) 546845) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| (and (=> (= (ControlFlow 0 542432) 546933) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 542432) 542446) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t18@1| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@8| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 542420) 542426))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XDX_XDX'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t6@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2)))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t8@0| (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t6@0|))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t10@0| (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t11@0|)))) (and (and (= _$t0 _$t0) (= _$t2 _$t2)) (and (= _$t3 _$t3) (|$IsValid'address'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1| |inline$$1_Diem_burn'$1_XDX_XDX'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 542404) 542432) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 542404) 542420) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct  (=> (and (not $abort_flag@0) (= $t13 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3)))) (=> (and (and (and (= $t14 (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))) (= $t15 (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t13)))) (and (= $t16 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t17 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))))) (and (and (= $t18 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $t19 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= $t20 (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t18)) (= (ControlFlow 0 546939) 542404)))) |inline$$1_Diem_burn'$1_XDX_XDX'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 541479) 547740) anon6_Then_correct) (=> (= (ControlFlow 0 541479) 546939) anon6_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 541473) 541479))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 541529) 541479))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 541485) 547740) anon6_Then_correct) (=> (= (ControlFlow 0 541485) 546939) anon6_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 541457) 541485) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 541457) 541473) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 541391) 541457))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 541499) 541457))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 541377) 541499) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 541377) 541391) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 541371) 541529) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 541371) 541377) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_211663| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_211663| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |TreasuryComplianceScriptsbpl.30136:104|
 :skolemid |998|
)))) (=> (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211663| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |TreasuryComplianceScriptsbpl.30140:20|
 :skolemid |999|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 1))))
 :qid |TreasuryComplianceScriptsbpl.30144:20|
 :skolemid |1000|
))) (and (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_217966| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr1@@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1@@0)) 2))))
 :qid |TreasuryComplianceScriptsbpl.30148:20|
 :skolemid |1001|
 ...
 :qid |TreasuryComplianceScriptsbpl.30152:20|
 :skolemid |1002|
 ...
 :qid |TreasuryComplianceScriptsbpl.30156:20|
 :skolemid |1003|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_217966| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.30160:20|
 :skolemid |1004|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) addr@@0)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.30168:20|
 :skolemid |1005|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.30183:20|
 :skolemid |1006|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) $a_0@@0)))
(|$IsValid'$1_Diem_BurnCapability'$1_XDX_XDX''| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.30187:20|
 :skolemid |1007|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'$1_XDX_XDX'_| (|contents#$Memory_212133| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) $a_0@@0))
))))) (and (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@1)))
 ...
 :qid |TreasuryComplianceScriptsbpl.30191:20|
 :skolemid |1008|
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) $a_0@@2)))
 (and (|$IsValid'$1_Diem_PreburnQueue'$1_XDX_XDX''| $rsc@@2) (and (<= (|l#Vec_159999| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@2)) 256) (let (($range_1 ($Range 0 (|l#Vec_159999| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@2)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@131 $i_2))
(> (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XDX_XDX'_| (|v#Vec_159999| (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| $rsc@@2)) i@@131)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.30196:223|
 :skolemid |1009|
))))))
 :qid |TreasuryComplianceScriptsbpl.30195:20|
 :skolemid |1010|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) $a_0@@2))
))) (and (= $t4 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= $t5 (|$preburns#$1_Diem_PreburnQueue'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XDX_XDX'_| (|contents#$Memory_218414| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) _$t2))))) (and (and (= $t6 (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$to_burn#$1_Diem_Preburn'$1_XDX_XDX'| $t4))) (= $t7 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (= $t8 (|$1_Diem_Preburn'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| _$t3))) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (and (and (= $t10 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t11 (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $t9))) (and (let ((addr@@1 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 541533) 541371)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 540408) 541533)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 695315) 540408) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
