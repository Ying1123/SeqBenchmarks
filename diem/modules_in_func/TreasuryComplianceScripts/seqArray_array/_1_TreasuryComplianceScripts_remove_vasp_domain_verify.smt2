...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1 () T@$Mutation_199923)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34 () T@$Mutation_255428)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@1 () T@$Mutation_255428)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3 () T@$Mutation_255363)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 () T@$Mutation_255363)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'| () T@$Mutation_180994)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| () T@Vec_160193)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_180994)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1 () T@$Mutation_180994)
(declare-fun DefaultVecElem_143361 () T@$1_VASPDomain_VASPDomain)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 () T@Vec_160193)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0 () T@$Mutation_255363)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1 () T@$Mutation_255363)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t7@0 () T@$Mutation_255363)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@0 () T@$Mutation_180994)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@0 () T@$Mutation_255428)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@0 () T@$Mutation_199923)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t11@0 () T@Vec_160193)
...
(assert (not
 (=> (= (ControlFlow 0 0) 637801) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> $abort_flag@4 (=> (and (= $abort_code@5 $abort_code@5) (= (ControlFlow 0 455879) (- 0 640376))) (or (or (or (= 3 $abort_code@5) (= 2 $abort_code@5)) (= 5 $abort_code@5)) (= 7 $abort_code@5))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Else_correct  (=> (not $abort_flag@3) (=> (and (= $abort_flag@4 $abort_flag@3) (= $abort_code@5 $abort_code@4)) (and (=> (= (ControlFlow 0 455541) 455879) anon3_Then_correct) (=> (= (ControlFlow 0 455541) 455829) anon3_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct  (=> (and (= $abort_flag@4 true) (= $abort_code@5 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1)) (and (=> (= (ControlFlow 0 454456) 455879) anon3_Then_correct) (=> (= (ControlFlow 0 454456) 455829) anon3_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@4) (= (ControlFlow 0 455555) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_199923| inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1)) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new (let ((len (|l#Multiset_159418| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new)))))) (and (=> (= (ControlFlow 0 455525) 455555) inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Then_correct) (=> (= (ControlFlow 0 455525) 455541) inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct  (=> (and (and (not $abort_flag@3) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1 ($Mutation_199923 (|l#$Mutation_255428| inline$$1_VASPDomain_remove_vasp_domain$0$$t34) (let ((l (|l#Vec_25263| (|p#$Mutation_255428| inline$$1_VASPDomain_remove_vasp_domain$0$$t34))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_255428| inline$$1_VASPDomain_remove_vasp_domain$0$$t34)) l 0) (+ l 1))) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_255428| inline$$1_VASPDomain_remove_vasp_domain$0$$t34))))) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1 ($1_VASPDomain_VASPDomainEvent true inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 455531) 455525))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@4) (= (ControlFlow 0 455569) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then$1_correct  (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= $abort_flag@3 true)) (and (=> (= (ControlFlow 0 455621) 455569) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 455621) 455531) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 455619) 455621)) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then$1_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Else_correct  (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t34@1 ($Mutation_255428 ($Global 186537453) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $abort_code@4 $abort_code@3) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 455416) 455569) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 455416) 455531) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3 ($Mutation_255363 (|l#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) (|p#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) ($1_VASPDomain_VASPDomains (|v#$Mutation_180994| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'|))))) (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_255327 (|Store__T@[Int]Bool_| (|domain#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)) (|v#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)))) (|$IsValid'address'| 186537453))) (and (=> (= (ControlFlow 0 455394) 455619) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 455394) 455416) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@3) (= (ControlFlow 0 455635) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|  (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 455344) 455635) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 455344) 455394) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct)))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_143341 |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|)) (= (ControlFlow 0 455342) 455344)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (InRangeVec_143341 |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (=> (and (and (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$e@1| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_160193| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|)) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_180994 (|l#$Mutation_180994| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1) (|p#$Mutation_180994| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1) (let ((l@@0 (- (|l#Vec_160193| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) 1)))
(Vec_160193 (|lambda#26| 0 l@@0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (|v#Vec_160193| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) (|v#Vec_160193| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) 1 DefaultVecElem_143361) l@@0))))) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 455292) 455635) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 455292) 455394) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (|v#$Mutation_180994| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1)) (and (=> (= (ControlFlow 0 455268) 455342) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 455268) 455292) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Then_correct  (=> |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| (=> (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1 ($Mutation_180994 (|l#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) (let ((l@@1 (|l#Vec_25263| (|p#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2)) l@@1 0) (+ l@@1 1))) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2)))) (= (ControlFlow 0 455352) 455268)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Else_correct  (=> (not |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0)) (=> (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0 7) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0) (= (ControlFlow 0 455157) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 455125) 455352) inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Then_correct) (=> (= (ControlFlow 0 455125) 455157) inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@2) (= (ControlFlow 0 455649) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 455085) 455649) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 455085) 455125) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 455095) 455649) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 455095) 455125) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| (|$IndexOfVec'$1_VASPDomain_VASPDomain'| inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (=> (= (ControlFlow 0 455073) 455095) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 455073) 455085) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2))) (= (ControlFlow 0 455103) 455073))) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@2) (= (ControlFlow 0 455663) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (=> (and (= $abort_flag@1 true) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 454936) 455663) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 454936) 455103) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 454930) 454936))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 454968) 454936))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t2))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 454954) 455663) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 454954) 455103) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 454914) 454954) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 454914) 454930) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 454878) 454914)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 454884) 454878)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_25263| _$t2)) (and (=> (= (ControlFlow 0 454818) 454968) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 454818) 454884) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 454824) 454818)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| (|v#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2))) (and (= |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1|) (= (ControlFlow 0 454974) 454824))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@1) (= (ControlFlow 0 455677) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0)) (and (=> (= (ControlFlow 0 455729) 455677) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 455729) 454974) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1)) (= (ControlFlow 0 455727) 455729)) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then$1_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1) (=> (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1 ($Mutation_255363 ($Global _$t1) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1))) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1))) (and (=> (= (ControlFlow 0 454540) 455677) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 454540) 454974) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Then_correct  (=> inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 (and (=> (= (ControlFlow 0 454518) 455727) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 454518) 454540) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Else_correct  (=> (and (and (not inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= (ControlFlow 0 454514) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 (|Select__T@[Int]Bool_| (|domain#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 5)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1))) (and (=> (= (ControlFlow 0 454498) 454518) inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Then_correct) (=> (= (ControlFlow 0 454498) 454514) inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Else_correct)))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Else_correct  (=> (and (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= (ControlFlow 0 454450) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 5)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 454434) 454498) inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Then_correct) (=> (= (ControlFlow 0 454434) 454450) inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Then_correct  (=> inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) (= 5 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) 1)) (= 3 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0))) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0) (= (ControlFlow 0 455815) 454456))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 454392) 455743) inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Then_correct) (=> (= (ControlFlow 0 454392) 454434) inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Else_correct  (=> (and (not inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0) (= (ControlFlow 0 454398) 454392)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon0_correct  (=> (and (= (|l#Vec_25263| (|p#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t7@0)) 0) (= (|l#Vec_25263| (|p#$Mutation_255363| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0)) 0)) (=> (and (and (= (|l#Vec_25263| (|p#$Mutation_180994| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@0)) 0) (= (|l#Vec_25263| (|p#$Mutation_255428| inline$$1_VASPDomain_remove_vasp_domain$0$$t34@0)) 0)) (and (= (|l#Vec_25263| (|p#$Mutation_199923| inline$$1_VASPDomain_remove_vasp_domain$0$$t35@0)) 0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t11@0 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (=> (and (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t12@0 (|$addr#$signer| _$t0)) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t13@0 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t14@0 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0 (|$addr#$signer| _$t0)) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 454305) 455815) inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Then_correct) (=> (= (ControlFlow 0 454305) 454398) inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Else_correct)))))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 ...
 :qid |TreasuryComplianceScriptsbpl.24866:20|
 :skolemid |583|
 ...
 :qid |TreasuryComplianceScriptsbpl.24870:20|
 :skolemid |584|
 ...
 :qid |TreasuryComplianceScriptsbpl.24886:20|
 :skolemid |588|
 ...
 :qid |TreasuryComplianceScriptsbpl.24890:20|
 :skolemid |589|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_208943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.24894:151|
 :skolemid |590|
 ...
 :qid |TreasuryComplianceScriptsbpl.24899:20|
 :skolemid |591|
 ...
 :qid |TreasuryComplianceScriptsbpl.24903:20|
 :skolemid |592|
 ...
 :qid |TreasuryComplianceScriptsbpl.24907:20|
 :skolemid |593|
 ...
 :qid |TreasuryComplianceScriptsbpl.24919:20|
 :skolemid |596|
 ...
 :qid |TreasuryComplianceScriptsbpl.24923:20|
 :skolemid |597|
 ...
 :qid |TreasuryComplianceScriptsbpl.24927:20|
 :skolemid |598|
 ...
 :qid |TreasuryComplianceScriptsbpl.24931:20|
 :skolemid |599|
 ...
 :qid |TreasuryComplianceScriptsbpl.24935:20|
 :skolemid |600|
 ...
 :qid |TreasuryComplianceScriptsbpl.24939:20|
 :skolemid |601|
 ...
 :qid |TreasuryComplianceScriptsbpl.24943:20|
 :skolemid |602|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'address'| _$t1)) (and (and (|$IsValid'vec'u8''| _$t2) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.24955:20|
 :skolemid |603|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.24959:20|
 :skolemid |604|
...
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) $a_0@@1)))
...
(<= (|l#Vec_25263| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_160193| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@126))) 63)))
 :qid |TreasuryComplianceScriptsbpl.24964:140|
 :skolemid |605|
))) (let (($range_3 ($Range 0 (|l#Vec_160193| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@127 $i_4))
(let (($range_5 ($Range (+ i@@127 1) (|l#Vec_160193| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@40 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_160193| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) i@@127)) (|$domain#$1_VASPDomain_VASPDomain| (|Select__T@[Int]$1_VASPDomain_VASPDomain_| (|v#Vec_160193| (|$domains#$1_VASPDomain_VASPDomains| $rsc@@1)) j@@40))))))
 :qid |TreasuryComplianceScriptsbpl.24966:98|
 :skolemid |606|
)))))
 :qid |TreasuryComplianceScriptsbpl.24965:202|
 :skolemid |607|
...
(<= (|l#Vec_25263| (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |TreasuryComplianceScriptsbpl.24967:229|
 :skolemid |608|
))))))
 :qid |TreasuryComplianceScriptsbpl.24963:20|
 :skolemid |609|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) $a_0@@1))
))))) (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t3 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) _$t1))))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= $t5 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t6 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2) _$t1)) (= (ControlFlow 0 455819) 454305))))) inline$$1_VASPDomain_remove_vasp_domain$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_159418| stream@@1) 0) (forall ((v@@62 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) v@@62) 0)
 :qid |TreasuryComplianceScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 452036) 455819)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 637801) 452036) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
