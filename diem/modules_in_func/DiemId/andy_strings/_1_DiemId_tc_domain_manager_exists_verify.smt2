...
(assert (not
 (=> (= (ControlFlow 0 0) 87596) (let ((anon0$1_correct  (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) $a_0)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc))
 :qid |DiemIdbpl.3445:20|
 :skolemid |114|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) $a_0))
)) (|$IsValid'address'| 186537453)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 74663) (- 0 87681)) (not false)) (=> (not false) (=> (= (ControlFlow 0 74663) (- 0 87688)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_32802_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_32802| stream@@0) 0) (forall ((v@@29 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_32802| stream@@0) v@@29) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 74585) 74663)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 87596) 74585) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
