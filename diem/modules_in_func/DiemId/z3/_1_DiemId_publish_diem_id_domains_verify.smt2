...
(assert (not
 (=> (= (ControlFlow 0 0) 93634) (let ((anon18_Else_correct@@1  (=> (not $abort_flag@0@@2) (and (=> (= (ControlFlow 0 83295) (- 0 95187)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0))) (and (=> (= (ControlFlow 0 83295) (- 0 95199)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (and (=> (= (ControlFlow 0 83295) (- 0 95217)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t3@@0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t3@@0)) (and (=> (= (ControlFlow 0 83295) (- 0 95227)) (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0) (=> (= (ControlFlow 0 83295) (- 0 95235)) (= (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory@1) $t3@@0))) 0)))))))))))))
(let ((anon16_Then_correct@@1 true))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 83030) (- 0 95094)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t3@@0))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t3@@0)) (=> (= (ControlFlow 0 83030) (- 0 95123)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) (= 5 $t7@0@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4@@0)) 5)) (= 3 $t7@0@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t3@@0) (= 6 $t7@0@@0))))))))
(let ((anon18_Then_correct@@1  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t7@0@@0 $abort_code@1@@2) (= (ControlFlow 0 83309) 83030))) L3_correct@@2)))
(let ((anon17_Then$1_correct@@0  (=> (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory) (=> (and (= $abort_flag@0@@2 true) (= $abort_code@1@@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 83361) 83309) anon18_Then_correct@@1) (=> (= (ControlFlow 0 83361) 83295) anon18_Else_correct@@1))))))
(let ((anon17_Then_correct@@1  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4)) (= (ControlFlow 0 83359) 83361)) anon17_Then$1_correct@@0)))
(let ((anon17_Else_correct@@1  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4))) (=> (and (and (= $1_DiemId_DiemIdDomains_$memory@0@@0 ($Memory_57904 (|Store__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0@@4) $t14@0))) (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory@0@@0)) (and (= $abort_flag@0@@2 false) (= $abort_code@1@@2 $abort_code@0@@2))) (and (=> (= (ControlFlow 0 83225) 83309) anon18_Then_correct@@1) (=> (= (ControlFlow 0 83225) 83295) anon18_Else_correct@@1))))))
(let ((anon16_Else_correct@@1  (=> (and (not false) (= $t14@0 ($1_DiemId_DiemIdDomains |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 83203) (- 0 94875)) (let (($range_0@@13 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@13 Int) ) (!  (=> ($InRange $range_0@@13 $i_1@@13) (let ((i@@56 $i_1@@13))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@56))) 63)))
 :qid |DiemIdbpl.5255:91|
 :skolemid |226|
)))) (=> (let (($range_0@@14 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@14 Int) ) (!  (=> ($InRange $range_0@@14 $i_1@@14) (let ((i@@57 $i_1@@14))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@57))) 63)))
 :qid |DiemIdbpl.5255:91|
 :skolemid |226|
))) (and (=> (= (ControlFlow 0 83203) (- 0 94919)) (let (($range_0@@15 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@15 Int) ) (!  (=> ($InRange $range_0@@15 $i_1@@15) (let ((i@@58 $i_1@@15))
(let (($range_2@@3 ($Range (+ i@@58 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3@@3 Int) ) (!  (=> ($InRange $range_2@@3 $i_3@@3) (let ((j@@14 $i_3@@3))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@58) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) j@@14)))))
 :qid |DiemIdbpl.5263:96|
 :skolemid |227|
)))))
 :qid |DiemIdbpl.5262:91|
 :skolemid |228|
)))) (=> (let (($range_0@@16 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@16 Int) ) (!  (=> ($InRange $range_0@@16 $i_1@@16) (let ((i@@59 $i_1@@16))
(let (($range_2@@4 ($Range (+ i@@59 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3@@4 Int) ) (!  (=> ($InRange $range_2@@4 $i_3@@4) (let ((j@@15 $i_3@@4))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) i@@59) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $t14@0) j@@15)))))
 :qid |DiemIdbpl.5263:96|
 :skolemid |227|
)))))
 :qid |DiemIdbpl.5262:91|
 :skolemid |228|
))) (and (=> (= (ControlFlow 0 83203) 83359) anon17_Then_correct@@1) (=> (= (ControlFlow 0 83203) 83225) anon17_Else_correct@@1)))))))))
(let ((|inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| (as seq.empty (Seq T@$1_DiemId_DiemIdDomain))) (and (=> (= (ControlFlow 0 83056) 83375) anon16_Then_correct@@1) (=> (= (ControlFlow 0 83056) 83203) anon16_Else_correct@@1)))))
(let ((anon15_Then_correct@@1  (=> (and inline$$Not$0$dst@1@@1 (= (ControlFlow 0 83062) 83056)) |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct@@1  (=> (and (and (not inline$$Not$0$dst@1@@1) (= $t12@@0 $t12@@0)) (and (= $t7@0@@0 $t12@@0) (= (ControlFlow 0 82934) 83030))) L3_correct@@2)))
(let ((anon14_Else$1_correct@@0  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12@@0) (= $t12@@0 6)) (and (= $t12@@0 $t12@@0) (= inline$$Not$0$dst@1@@1 inline$$Not$0$dst@1@@1))) (and (=> (= (ControlFlow 0 82918) 83062) anon15_Then_correct@@1) (=> (= (ControlFlow 0 82918) 82934) anon15_Else_correct@@1))))))
(let ((inline$$Not$0$anon0_correct@@1  (=> (and (= inline$$Not$0$dst@1@@1  (not $t9@0@@0)) (= (ControlFlow 0 82878) 82918)) anon14_Else$1_correct@@0)))
(let ((anon14_Else_correct@@1  (=> (not $t6@@1) (=> (and (and (|$IsValid'address'| $t8@@0) (= $t8@@0 (|$addr#$signer| _$t0@@4))) (and (= $t9@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $t8@@0)) (= (ControlFlow 0 82884) 82878))) inline$$Not$0$anon0_correct@@1))))
(let ((anon14_Then_correct@@1  (=> $t6@@1 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t5@@0)) (= 5 $t7@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t5@@0)) 5)) (= 3 $t7@@0))) (= $t7@@0 $t7@@0)) (and (= $t7@0@@0 $t7@@0) (= (ControlFlow 0 83427) 83030))) L3_correct@@2))))
(let ((anon0$1_correct@@5  (=> (and (and (forall ((addr@@51 Int) ) (!  (=> (|$IsValid'address'| addr@@51) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@51) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@51)) 0)) (= addr@@51 173345816)))
 :qid |DiemIdbpl.5001:20|
 :skolemid |194|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53208| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@52 Int) ) (!  (=> (|$IsValid'address'| addr@@52) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@52) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@52)) 1)) (= addr@@52 186537453)))
 :qid |DiemIdbpl.5009:20|
 :skolemid |195|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53208| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@53 Int) ) (!  (=> (|$IsValid'address'| addr@@53) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@53)) 2))))))
 :qid |DiemIdbpl.5017:20|
 :skolemid |196|
)) (forall ((addr@@54 Int) ) (!  (=> (|$IsValid'address'| addr@@54) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@54)) 2))))))
 :qid |DiemIdbpl.5021:20|
 :skolemid |197|
))) (and (forall ((addr@@55 Int) ) (!  (=> (|$IsValid'address'| addr@@55) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@55)) 2))))))
 :qid |DiemIdbpl.5025:20|
 :skolemid |198|
)) (forall ((addr@@56 Int) ) (!  (=> (|$IsValid'address'| addr@@56) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@56)) 2))))))
 :qid |DiemIdbpl.5029:20|
 :skolemid |199|
)))) (and (and (forall ((addr@@57 Int) ) (!  (=> (|$IsValid'address'| addr@@57) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@57)) 2)))))
 :qid |DiemIdbpl.5033:20|
 :skolemid |200|
)) (forall ((addr@@58 Int) ) (!  (=> (|$IsValid'address'| addr@@58) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@58)) 2)))))
 :qid |DiemIdbpl.5037:20|
 :skolemid |201|
))) (and (forall ((addr@@59 Int) ) (!  (=> (|$IsValid'address'| addr@@59) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@59)) 2)))))
 :qid |DiemIdbpl.5041:20|
 :skolemid |202|
)) (forall ((addr@@60 Int) ) (!  (=> (|$IsValid'address'| addr@@60) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53657| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@60) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@60) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@60)) 4))))
 :qid |DiemIdbpl.5045:20|
 :skolemid |203|
))))) (=> (and (and (and (and (forall ((addr@@61 Int) ) (!  (=> (|$IsValid'address'| addr@@61) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@61) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@61) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@61)) 3))))
 :qid |DiemIdbpl.5049:20|
 :skolemid |204|
)) (forall ((addr@@62 Int) ) (!  (=> (|$IsValid'address'| addr@@62) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@62) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@62) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@62)) 3))))
 :qid |DiemIdbpl.5053:20|
 :skolemid |205|
))) (and (forall ((addr@@63 Int) ) (!  (=> (|$IsValid'address'| addr@@63) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@63) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@63)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@63) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@63)) 3))))
 :qid |DiemIdbpl.5057:20|
 :skolemid |206|
)) (let (($range_0@@17 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@64 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@64))))))))
(forall (($i_1@@17 Int) ) (!  (=> ($InRange $range_0@@17 $i_1@@17) (let ((i1@@1 $i_1@@17))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@65 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@65)))) i1@@1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@65 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@65)))) i1@@1)))) 3))))
 :qid |DiemIdbpl.5061:151|
 :skolemid |207|
))))) (and (and (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_55917| $1_DualAttestation_Credential_$memory) addr1@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@1)) 2)))))
 :qid |DiemIdbpl.5066:20|
 :skolemid |208|
)) (forall ((addr@@66 Int) ) (!  (=> (|$IsValid'address'| addr@@66) (= (|Select__T@[Int]Bool_| (|domain#$Memory_56772| $1_DiemAccount_DiemAccount_$memory) addr@@66) (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@66)))
 :qid |DiemIdbpl.5070:20|
 :skolemid |209|
))) (and (forall ((addr@@67 Int) ) (!  (=> (|$IsValid'address'| addr@@67) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55541| $1_VASPDomain_VASPDomainManager_$memory) addr@@67)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@67) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@67)) 1))))
 :qid |DiemIdbpl.5074:20|
 :skolemid |210|
)) (forall ((addr@@68 Int) ) (!  (=> (|$IsValid'address'| addr@@68) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55640| $1_VASPDomain_VASPDomains_$memory) addr@@68)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@68) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@68)) 5))))
 :qid |DiemIdbpl.5078:20|
 :skolemid |211|
))))) (and (and (and (forall ((addr@@69 Int) ) (!  (=> (|$IsValid'address'| addr@@69) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_57302| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@69) (|Select__T@[Int]Bool_| (|domain#$Memory_57393| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@69)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@69)) 2)))))
 :qid |DiemIdbpl.5082:20|
 :skolemid |212|
)) (forall ((addr@@70 Int) ) (!  (=> (|$IsValid'address'| addr@@70) (= (|Select__T@[Int]Bool_| (|domain#$Memory_56611| $1_DesignatedDealer_Dealer_$memory) addr@@70)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@70) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@70)) 2))))
 :qid |DiemIdbpl.5086:20|
 :skolemid |213|
))) (and (forall ((addr@@71 Int) ) (!  (=> (|$IsValid'address'| addr@@71) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55917| $1_DualAttestation_Credential_$memory) addr@@71)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@71)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@71) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@71)) 5)))))
 :qid |DiemIdbpl.5090:20|
 :skolemid |214|
)) (forall ((addr@@72 Int) ) (!  (=> (|$IsValid'address'| addr@@72) (= (|Select__T@[Int]Bool_| (|domain#$Memory_54600| $1_SlidingNonce_SlidingNonce_$memory) addr@@72)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@72)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@72) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@72)) 1)))))
 :qid |DiemIdbpl.5094:20|
 :skolemid |215|
)))) (and (and (forall ((addr@@73 Int) ) (!  (=> (|$IsValid'address'| addr@@73) (= (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@73)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@73) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@73)) 3))))
 :qid |DiemIdbpl.5098:20|
 :skolemid |216|
)) (forall ((addr@@74 Int) ) (!  (=> (|$IsValid'address'| addr@@74) (= (|Select__T@[Int]Bool_| (|domain#$Memory_53657| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@74)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@74) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@74)) 4))))
 :qid |DiemIdbpl.5102:20|
 :skolemid |217|
))) (and (forall ((addr@@75 Int) ) (!  (=> (|$IsValid'address'| addr@@75) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55737| $1_VASP_ParentVASP_$memory) addr@@75)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@75) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@75)) 5))))
 :qid |DiemIdbpl.5106:20|
 :skolemid |218|
)) (forall ((addr@@76 Int) ) (!  (=> (|$IsValid'address'| addr@@76) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55673| $1_VASP_ChildVASP_$memory) addr@@76)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@76) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@76)) 6))))
 :qid |DiemIdbpl.5110:20|
 :skolemid |219|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@4)) ($1_Signer_is_txn_signer _$t0@@4)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@4))) (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $a_0@@7)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@7))
 :qid |DiemIdbpl.5116:20|
 :skolemid |220|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $a_0@@7))
))) (and (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $a_0@@8)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc@@8) (and (and (let (($range_1@@2 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8)))))
(forall (($i_2@@2 Int) ) (!  (=> ($InRange $range_1@@2 $i_2@@2) (let ((i@@60 $i_2@@2))
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8) i@@60))) 63)))
 :qid |DiemIdbpl.5121:136|
 :skolemid |221|
))) (let (($range_3@@2 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8)))))
(forall (($i_4@@2 Int) ) (!  (=> ($InRange $range_3@@2 $i_4@@2) (let ((i@@61 $i_4@@2))
(let (($range_5@@2 ($Range (+ i@@61 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8)))))
(forall (($i_6@@2 Int) ) (!  (=> ($InRange $range_5@@2 $i_6@@2) (let ((j@@16 $i_6@@2))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8) i@@61) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@8) j@@16)))))
 :qid |DiemIdbpl.5123:96|
 :skolemid |222|
)))))
 :qid |DiemIdbpl.5122:196|
 :skolemid |223|
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@6)) 63)))
 :qid |DiemIdbpl.5124:221|
 :skolemid |224|
))))))
 :qid |DiemIdbpl.5120:20|
 :skolemid |225|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $a_0@@8))
)) (= $t3@@0 (|$addr#$signer| _$t0@@4)))) (and (and (= $t4@@0 (|$addr#$signer| _$t0@@4)) (= _$t0@@4 _$t0@@4)) (and (= $t5@@0 (|$addr#$signer| _$t0@@4)) (= $t6@@1  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t5@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t5@@0)) 5))))))) (and (=> (= (ControlFlow 0 82822) 83427) anon14_Then_correct@@1) (=> (= (ControlFlow 0 82822) 82884) anon14_Else_correct@@1))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_32802_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_32802| stream@@10) 0) (forall ((v@@38 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_32802| stream@@10) v@@38) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 81832) 82822)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 93634) 81832) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5)))))))))))))))))))
))
(check-sat)
(pop 1)
