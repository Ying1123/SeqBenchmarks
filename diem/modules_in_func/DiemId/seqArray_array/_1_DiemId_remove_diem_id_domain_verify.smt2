...
(declare-fun $t35@0 () T@$Mutation_56031)
(declare-fun $t37@0 () T@$1_DiemId_DiemIdDomainEvent)
(declare-fun $t34@1 () T@$Mutation_64804)
...
(declare-fun $t34 () T@$Mutation_64804)
(declare-fun $t34@0 () T@$Mutation_64804)
...
(declare-fun |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2| () T@$Mutation_41258)
...
(declare-fun |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@0| () T@$Mutation_41258)
(declare-fun |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| () T@Vec_34312)
...
(declare-fun |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@1| () T@$Mutation_41258)
(declare-fun $t31@0 () T@$Mutation_41258)
(declare-fun DefaultVecElem_29527 () T@$1_DiemId_DiemIdDomain)
...
(declare-fun $t7 () T@$Mutation_64739)
(declare-fun $t31 () T@$Mutation_41258)
(declare-fun $t35 () T@$Mutation_56031)
(push 1)
(set-info :boogie-vc-id $1_DiemId_remove_diem_id_domain$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 105463) (let ((anon46_Else_correct  (=> (and (not $abort_flag@3) (= $t38 (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 93279) (- 0 108418)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1))) (and (=> (= (ControlFlow 0 93279) (- 0 108429)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 93279) (- 0 108439)) (not (not (exists ((i@@68 Int) ) (!  (and (and (|$IsValid'u64'| i@@68) (InRangeVec_29507 $t11 i@@68)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| $t11) i@@68)) (|$domain#$1_DiemId_DiemIdDomain| ($1_DiemId_DiemIdDomain _$t2))))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
))))) (=> (not (not (exists ((i@@69 Int) ) (!  (and (and (|$IsValid'u64'| i@@69) (InRangeVec_29507 $t11 i@@69)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| $t11) i@@69)) (|$domain#$1_DiemId_DiemIdDomain| ($1_DiemId_DiemIdDomain _$t2))))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
)))) (and (=> (= (ControlFlow 0 93279) (- 0 108453)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 93279) (- 0 108465)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 93279) (- 0 108483)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 93279) (- 0 108497)) (not (> (|l#Vec_14776| _$t2) 63))) (=> (not (> (|l#Vec_14776| _$t2) 63)) (and (=> (= (ControlFlow 0 93279) (- 0 108509)) (not (exists ((i@@70 Int) ) (!  (and (and (|$IsValid'u64'| i@@70) (InRangeVec_29507 $t38 i@@70)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| $t38) i@@70)) (|$domain#$1_DiemId_DiemIdDomain| ($1_DiemId_DiemIdDomain _$t2))))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
)))) (=> (not (exists ((i@@71 Int) ) (!  (and (and (|$IsValid'u64'| i@@71) (InRangeVec_29507 $t38 i@@71)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| $t38) i@@71)) (|$domain#$1_DiemId_DiemIdDomain| ($1_DiemId_DiemIdDomain _$t2))))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
))) (and (=> (= (ControlFlow 0 93279) (- 0 108521)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0))))))
 ...
 :qid |DiemIdbpl.2241:13|
 :skolemid |78|
))))) (=> (= (ControlFlow 0 93279) (- 0 108546)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((anon46_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 93293) 91664))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1| (|v#$Mutation_56031| $t35@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_33809| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_33809| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t37@0))))
(Multiset_33809 (|Store__T@[$EventRep]Int_| (|v#Multiset_33809| stream@@3) (|$ToEventRep'$1_DiemId_DiemIdDomainEvent'| $t37@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 93089) 93293) anon46_Then_correct) (=> (= (ControlFlow 0 93089) 93279) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (and (and (not $abort_flag@3) (= $t35@0 ($Mutation_56031 (|l#$Mutation_64804| $t34@1) (let ((l (|l#Vec_14776| (|p#$Mutation_64804| $t34@1))))
(Vec_14776 (|Store__T@[Int]Int_| (|v#Vec_14776| (|p#$Mutation_64804| $t34@1)) l 0) (+ l 1))) (|$diem_id_domain_events#$1_DiemId_DiemIdDomainManager| (|v#$Mutation_64804| $t34@1))))) (and (= $t37@0 ($1_DiemId_DiemIdDomainEvent true inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 _$t1)) (= (ControlFlow 0 93095) 93089))) |inline$$1_Event_emit_event'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t17@0 $abort_code@4) (= (ControlFlow 0 93307) 91664))) L7_correct)))
(let ((anon44_Then$1_correct  (=> (= $t34@1 $t34) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 93359) 93307) anon45_Then_correct) (=> (= (ControlFlow 0 93359) 93095) anon45_Else_correct))))))
(let ((anon44_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= (ControlFlow 0 93357) 93359)) anon44_Then$1_correct)))
(let ((anon44_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (=> (and (and (= $t34@0 ($Mutation_64804 ($Global 186537453) (Vec_14776 (MapConstVec_10052 DefaultVecElem_10052) 0) (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (= $t34@1 $t34@0)) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 92980) 93307) anon45_Then_correct) (=> (= (ControlFlow 0 92980) 93095) anon45_Else_correct))))))
(let ((anon43_Else_correct  (=> (and (not $abort_flag@2) (= $t24@2 ($Mutation_64739 (|l#$Mutation_64739| $t24@1) (|p#$Mutation_64739| $t24@1) ($1_DiemId_DiemIdDomains (|v#$Mutation_41258| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2|))))) (and (=> (= (ControlFlow 0 92958) (- 0 107796)) (let (($range_0 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@2))))))
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@2))) i@@76))) 63)))
 :qid |DiemIdbpl.5866:105|
 :skolemid |284|
))) (and (=> (= (ControlFlow 0 92958) (- 0 107844)) (let (($range_0@@1 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@2))))))
...
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@21 $i_3))
 ...
 :qid |DiemIdbpl.5874:110|
 :skolemid |285|
)))))
 :qid |DiemIdbpl.5873:105|
 :skolemid |286|
...
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@22 $i_3@@0))
 ...
 :qid |DiemIdbpl.5873:105|
 :skolemid |286|
))) (and (=> (= (ControlFlow 0 92958) (- 0 107929)) (let (($range_0@@3 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@2))))
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| $elem@@0)) 63)))
 :qid |DiemIdbpl.5881:86|
 :skolemid |287|
))) (=> (and (= $1_DiemId_DiemIdDomains_$memory@0 ($Memory_64098 (|Store__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|a#$Global| (|l#$Mutation_64739| $t24@2)) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|a#$Global| (|l#$Mutation_64739| $t24@2)) (|v#$Mutation_64739| $t24@2)))) (|$IsValid'address'| 186537453)) (and (=> (= (ControlFlow 0 92958) 93357) anon44_Then_correct) (=> (= (ControlFlow 0 92958) 92980) anon44_Else_correct))))))))))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 93373) 91664))) L7_correct)))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then$1_correct|  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@0|)) (and (=> (= (ControlFlow 0 92730) 93373) anon43_Then_correct) (=> (= (ControlFlow 0 92730) 92958) anon43_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_29507 |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|)) (= (ControlFlow 0 92728) 92730)) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|  (=> (and (InRangeVec_29507 |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$e@1| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|))) (=> (and (and (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@1| ($Mutation_41258 (|l#$Mutation_41258| $t31@0) (|p#$Mutation_41258| $t31@0) (let ((l@@0 (- (|l#Vec_34312| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|) 1)))
(Vec_34312 (|lambda#11| 0 l@@0 |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| (|v#Vec_34312| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|) (|v#Vec_34312| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1|) 1 DefaultVecElem_29527) l@@0)))) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@2| |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$m'@1|))) (and (=> (= (ControlFlow 0 92678) 93373) anon43_Then_correct) (=> (= (ControlFlow 0 92678) 92958) anon43_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$v@1| (|v#$Mutation_41258| $t31@0)) (and (=> (= (ControlFlow 0 92654) 92728) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 92654) 92678) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|)))))
(let ((anon42_Then_correct  (=> |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| (=> (and (= $t31@0 ($Mutation_41258 (|l#$Mutation_64739| $t24@1) (let ((l@@1 (|l#Vec_14776| (|p#$Mutation_64739| $t24@1))))
(Vec_14776 (|Store__T@[Int]Int_| (|v#Vec_14776| (|p#$Mutation_64739| $t24@1)) l@@1 0) (+ l@@1 1))) (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1)))) (= (ControlFlow 0 92738) 92654)) |inline$$1_Vector_remove'$1_DiemId_DiemIdDomain'$0$anon0_correct|))))
(let ((anon42_Else_correct  (=> (not |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1|) (and (=> (= (ControlFlow 0 92543) (- 0 107460)) (let (($range_0@@5 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1))))))
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1))) i@@80))) 63)))
 :qid |DiemIdbpl.5798:105|
 :skolemid |280|
))) (and (=> (= (ControlFlow 0 92543) (- 0 107508)) (let (($range_0@@7 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1))))))
...
(forall (($i_3@@1 Int) ) (!  (=> ($InRange $range_2@@1 $i_3@@1) (let ((j@@23 $i_3@@1))
 ...
 :qid |DiemIdbpl.5806:110|
 :skolemid |281|
)))))
 :qid |DiemIdbpl.5805:105|
 :skolemid |282|
...
(forall (($i_3@@2 Int) ) (!  (=> ($InRange $range_2@@2 $i_3@@2) (let ((j@@24 $i_3@@2))
 ...
 :qid |DiemIdbpl.5805:105|
 :skolemid |282|
))) (and (=> (= (ControlFlow 0 92543) (- 0 107593)) (let (($range_0@@9 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1))))
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| $elem@@2)) 63)))
 :qid |DiemIdbpl.5813:86|
 :skolemid |283|
))) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| $t30)) (=> (and (and (= $t30 7) (= $t30 $t30)) (and (= $t17@0 $t30) (= (ControlFlow 0 92543) 91664))) L7_correct)))))))))))
(let ((anon41_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 92333) 92738) anon42_Then_correct) (=> (= (ControlFlow 0 92333) 92543) anon42_Else_correct))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 93387) 91664))) L7_correct)))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 92293) 93387) anon41_Then_correct) (=> (= (ControlFlow 0 92293) 92333) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 92303) 93387) anon41_Then_correct) (=> (= (ControlFlow 0 92303) 92333) anon41_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$res2@1| (|$IndexOfVec'$1_DiemId_DiemIdDomain'| $t26@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)) (and (=> (= (ControlFlow 0 92281) 92303) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 92281) 92293) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon3_Else_correct|)))))
(let ((anon40_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)) (and (= $t26@0 (|$domains#$1_DiemId_DiemIdDomains| (|v#$Mutation_64739| $t24@1))) (= (ControlFlow 0 92311) 92281))) |inline$$1_Vector_index_of'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 93401) 91664))) L7_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_DiemId_create_diem_id_domain$0$$t4@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 92144) 93401) anon40_Then_correct) (=> (= (ControlFlow 0 92144) 92311) anon40_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= (ControlFlow 0 92138) 92144))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 92176) 92144))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 ($1_DiemId_DiemIdDomain _$t2))) (=> (and (and (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 92162) 93401) anon40_Then_correct) (=> (= (ControlFlow 0 92162) 92311) anon40_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 7)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 92122) 92162) inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 92122) 92138) inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 92086) 92122)) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 92092) 92086)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_14776| _$t2)) (and (=> (= (ControlFlow 0 92026) 92176) inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 92026) 92092) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct)))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 92032) 92026)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon39_Else_correct  (=> (and (and (not $abort_flag@0) (= |$temp_0'$1_DiemId_DiemIdDomains'@0| (|v#$Mutation_64739| $t24@1))) (and (= |$temp_0'$1_DiemId_DiemIdDomains'@0| |$temp_0'$1_DiemId_DiemIdDomains'@0|) (= (ControlFlow 0 92182) 92032))) inline$$1_DiemId_create_diem_id_domain$0$anon0_correct)))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 93415) 91664))) L7_correct)))
(let ((anon38_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 93467) 93415) anon39_Then_correct) (=> (= (ControlFlow 0 93467) 92182) anon39_Else_correct))))))
(let ((anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1)) (= (ControlFlow 0 93465) 93467)) anon38_Then$1_correct)))
(let ((anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1) (=> (and (and (= $t24@0 ($Mutation_64739 ($Global _$t1) (Vec_14776 (MapConstVec_10052 DefaultVecElem_10052) 0) (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 91748) 93415) anon39_Then_correct) (=> (= (ControlFlow 0 91748) 92182) anon39_Else_correct))))))
(let ((anon37_Then_correct  (=> $t21@0 (and (=> (= (ControlFlow 0 91726) 93465) anon38_Then_correct) (=> (= (ControlFlow 0 91726) 91748) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 91722) 91664))) L7_correct)))
(let ((anon36_Then_correct  (=> inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 (=> (and (= $t21@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t1)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 5)) (and (= $t23 $t23) (= $t21@0 $t21@0))) (and (=> (= (ControlFlow 0 91706) 91726) anon37_Then_correct) (=> (= (ControlFlow 0 91706) 91722) anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (and (and (not inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 91448) 91664))) L7_correct)))
(let ((anon35_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 5)) (and (= $t20 $t20) (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 91432) 91706) anon36_Then_correct) (=> (= (ControlFlow 0 91432) 91448) anon36_Else_correct))))))
(let ((anon34_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 93553) 91664))) L7_correct))))
(let ((anon35_Then_correct true))
(let ((inline$$1_DiemId_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1 inline$$1_DiemId_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 91390) 93481) anon35_Then_correct) (=> (= (ControlFlow 0 91390) 91432) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (not $t16) (= (ControlFlow 0 91396) 91390)) inline$$1_DiemId_tc_domain_manager_exists$0$anon0_correct)))
...
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@83 $i_2))
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1)) i@@83))) 63)))
 :qid |DiemIdbpl.5570:136|
 :skolemid |275|
))) (let (($range_3 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@84 $i_4))
(let (($range_5 ($Range (+ i@@84 1) (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@25 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1)) i@@84)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@1)) j@@25))))))
 :qid |DiemIdbpl.5572:96|
 :skolemid |276|
)))))
 :qid |DiemIdbpl.5571:196|
 :skolemid |277|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemIdbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 90223) 91303)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_14776| (|p#$Mutation_64739| $t7)) 0) (= (|l#Vec_14776| (|p#$Mutation_64739| $t24)) 0)) (=> (and (and (= (|l#Vec_14776| (|p#$Mutation_41258| $t31)) 0) (= (|l#Vec_14776| (|p#$Mutation_64804| $t34)) 0)) (and (= (|l#Vec_14776| (|p#$Mutation_56031| $t35)) 0) (= (ControlFlow 0 90233) 90223))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 105463) 90233) anon0_correct)))
