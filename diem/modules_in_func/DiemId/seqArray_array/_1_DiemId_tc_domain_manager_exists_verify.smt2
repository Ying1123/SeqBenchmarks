...
(assert (not
 (=> (= (ControlFlow 0 0) 97797) (let ((anon0$1_correct  (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) $a_0)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc))
 :qid |DiemIdbpl.3484:20|
 :skolemid |132|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) $a_0))
)) (|$IsValid'address'| 186537453)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 81254) (- 0 97882)) (not false)) (=> (not false) (=> (= (ControlFlow 0 81254) (- 0 97889)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 81176) 81254)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 97797) 81176) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
