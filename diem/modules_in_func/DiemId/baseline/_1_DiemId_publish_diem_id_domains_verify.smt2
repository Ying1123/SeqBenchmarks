...
(declare-fun $t3 () Int)
(declare-fun $1_DiemId_DiemIdDomains_$memory@1 () T@$Memory_64098)
...
(declare-fun |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| () T@Vec_34312)
(declare-fun MapConstVec_29527 (T@$1_DiemId_DiemIdDomain) |T@[Int]$1_DiemId_DiemIdDomain|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 103842) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 89851) (- 0 105395)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 89851) (- 0 105407)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 5))) (and (=> (= (ControlFlow 0 89851) (- 0 105425)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t3)) (and (=> (= (ControlFlow 0 89851) (- 0 105435)) (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory@1) $t3)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory@1) $t3) (=> (= (ControlFlow 0 89851) (- 0 105443)) (= (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory@1) $t3))) 0)))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 89586) (- 0 105302)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t3))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 5))) (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t3)) (=> (= (ControlFlow 0 89586) (- 0 105331)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 5)) (= 3 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t3) (= 6 $t7@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 89865) 89586))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 89917) 89865) anon18_Then_correct) (=> (= (ControlFlow 0 89917) 89851) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 89915) 89917)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemId_DiemIdDomains_$memory@0 ($Memory_64098 (|Store__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) (|$addr#$signer| _$t0) $t14@0))) (= $1_DiemId_DiemIdDomains_$memory@1 $1_DiemId_DiemIdDomains_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 89781) 89865) anon18_Then_correct) (=> (= (ControlFlow 0 89781) 89851) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t14@0 ($1_DiemId_DiemIdDomains |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1|))) (and (=> (= (ControlFlow 0 89759) (- 0 105083)) (let (($range_0 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@68 $i_1))
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@68))) 63)))
 :qid |DiemIdbpl.5294:91|
 :skolemid |244|
)))) (=> (let (($range_0@@0 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@69 $i_1@@0))
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@69))) 63)))
 :qid |DiemIdbpl.5294:91|
 :skolemid |244|
))) (and (=> (= (ControlFlow 0 89759) (- 0 105127)) (let (($range_0@@1 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@70 $i_1@@1))
(let (($range_2 ($Range (+ i@@70 1) (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3 Int) ) (!  (=> ($InRange $range_2 $i_3) (let ((j@@21 $i_3))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@70)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) j@@21))))))
 :qid |DiemIdbpl.5302:96|
 :skolemid |245|
)))))
 :qid |DiemIdbpl.5301:91|
 :skolemid |246|
)))) (=> (let (($range_0@@2 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@71 $i_1@@2))
(let (($range_2@@0 ($Range (+ i@@71 1) (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)))))
(forall (($i_3@@0 Int) ) (!  (=> ($InRange $range_2@@0 $i_3@@0) (let ((j@@22 $i_3@@0))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) i@@71)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $t14@0)) j@@22))))))
 :qid |DiemIdbpl.5302:96|
 :skolemid |245|
)))))
 :qid |DiemIdbpl.5301:91|
 :skolemid |246|
))) (and (=> (= (ControlFlow 0 89759) 89915) anon17_Then_correct) (=> (= (ControlFlow 0 89759) 89781) anon17_Else_correct)))))))))
(let ((|inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$v@1| (Vec_34312 (MapConstVec_29527 DefaultVecElem_29527) 0)) (and (=> (= (ControlFlow 0 89612) 89931) anon16_Then_correct) (=> (= (ControlFlow 0 89612) 89759) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 89618) 89612)) |inline$$1_Vector_empty'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 89490) 89586))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 89474) 89618) anon15_Then_correct) (=> (= (ControlFlow 0 89474) 89490) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 89434) 89474)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $t8)) (= (ControlFlow 0 89440) 89434))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t5)) 5)) (= 3 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 89983) 89586))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 ...
 :qid |DiemIdbpl.5096:20|
 :skolemid |224|
)) (let (($range_0@@3 ($Range 0 (|l#Vec_34051| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
...
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i1 $i_1@@3))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_60438| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 ...
 :qid |DiemIdbpl.5149:20|
 :skolemid |237|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemIdbpl.5155:20|
 :skolemid |238|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $a_0@@0)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc@@0) (and (and (let (($range_1 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@72 $i_2))
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) i@@72))) 63)))
 :qid |DiemIdbpl.5160:136|
 :skolemid |239|
))) (let (($range_3 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@73 $i_4))
(let (($range_5 ($Range (+ i@@73 1) (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@23 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) i@@73)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)) j@@23))))))
 :qid |DiemIdbpl.5162:96|
 :skolemid |240|
)))))
 :qid |DiemIdbpl.5161:196|
 :skolemid |241|
)))) (let (($range_7 (|$domains#$1_DiemId_DiemIdDomains| $rsc@@0)))
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| $elem)) 63)))
 :qid |DiemIdbpl.5163:221|
 :skolemid |242|
))))))
 :qid |DiemIdbpl.5159:20|
 :skolemid |243|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= $t4 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t5)) 5))))))) (and (=> (= (ControlFlow 0 89378) 89983) anon14_Then_correct) (=> (= (ControlFlow 0 89378) 89440) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88388) 89378)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 103842) 88388) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
