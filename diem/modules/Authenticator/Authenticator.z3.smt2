...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |Authenticatorz3bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |Authenticatorz3bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |Authenticatorz3bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |Authenticatorz3bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |Authenticatorz3bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |Authenticatorz3bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |Authenticatorz3bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |Authenticatorz3bpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@8 Int) ) (! (let ((r@@0 (|$1_BCS_serialize'u8'| v@@8)))
 ...
 :qid |Authenticatorz3bpl.1074:15|
 :skolemid |30|
...
(assert (forall ((s T@$1_Authenticator_MultiEd25519PublicKey) ) (! (= (|$IsValid'$1_Authenticator_MultiEd25519PublicKey'| s)  (and (|$IsValid'vec'vec'u8'''| (|$public_keys#$1_Authenticator_MultiEd25519PublicKey| s)) (|$IsValid'u8'| (|$threshold#$1_Authenticator_MultiEd25519PublicKey| s))))
 :qid |Authenticatorz3bpl.1116:59|
 :skolemid |31|
...
(assert (forall ((v@@9 (Seq Int)) ) (! (let ((r@@1 (ReverseVec_4447 v@@9)))
 ...
 :qid |Authenticatorz3bpl.67:18|
 :skolemid |0|
 :pattern ( (seq.nth r@@1 i@@6))
))))
 :qid |Authenticatorz3bpl.64:32|
 :skolemid |1|
...
(let ((anon29_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_Vector_borrow'vec'u8''$0$dst@2| |inline$$1_Vector_borrow'vec'u8''$0$dst@2|)) (and (= $t14@1 ($Mutation_10769 ($Local 1) (as seq.empty (Seq Int)) $t1@0)) (= (ControlFlow 0 17767) 17761))) |inline$$1_Vector_append'u8'$1$anon0_correct|)))
...
(let ((anon35_Else_correct  (=> (not false) (=> (and (= call1formal@res@0 call1formal@res@0) (= (ControlFlow 0 17471) (- 0 19727))) (not false)))))
(let ((anon35_Then_correct true))
(let ((anon34_Else_correct  (=> (not false) (=> (and (and (= $t1@2 (|v#$Mutation_10769| |inline$$1_Vector_push_back'u8'$0$m'@1|)) (= call1formal@res@0 ($1_Hash_sha3 $t1@2))) (and (|$IsValid'vec'u8''| call1formal@res@0) (= (seq.len call1formal@res@0) 32))) (and (=> (= (ControlFlow 0 17451) 17485) anon35_Then_correct) (=> (= (ControlFlow 0 17451) 17471) anon35_Else_correct))))))
(let ((anon34_Then_correct true))
(let ((|inline$$1_Vector_push_back'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u8'$0$m'@1| ($Mutation_10769 (|l#$Mutation_10769| $t18@0) (|p#$Mutation_10769| $t18@0) (seq.++ (|v#$Mutation_10769| $t18@0) (seq.unit 1)))) (and (=> (= (ControlFlow 0 17429) 17509) anon34_Then_correct) (=> (= (ControlFlow 0 17429) 17451) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (not false) (=> (and (and (= $t1@1 (|v#$Mutation_10769| |inline$$1_Vector_append'u8'$0$m'@1|)) (= $t18@0 ($Mutation_10769 ($Local 1) (as seq.empty (Seq Int)) $t1@1))) (and (|$IsValid'u8'| 1) (= (ControlFlow 0 17435) 17429))) |inline$$1_Vector_push_back'u8'$0$anon0_correct|))))
(let ((anon33_Then_correct true))
(let ((|inline$$1_Vector_append'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_append'u8'$0$m'@1| ($Mutation_10769 (|l#$Mutation_10769| $t15@0) (|p#$Mutation_10769| $t15@0) (seq.++ (|v#$Mutation_10769| $t15@0) call1formal@res@0@@0))) (and (=> (= (ControlFlow 0 17342) 17523) anon33_Then_correct) (=> (= (ControlFlow 0 17342) 17435) anon33_Else_correct)))))
...
(let ((anon28_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t15@0 ($Mutation_10769 ($Local 1) (as seq.empty (Seq Int)) $t1@0))) (and (= $t16@0 (|$threshold#$1_Authenticator_MultiEd25519PublicKey| _$t0)) (= call1formal@res@0@@0 (|$1_BCS_serialize'u8'| $t16@0)))) (and (=> (= (ControlFlow 0 17285) 17537) anon32_Then_correct) (=> (= (ControlFlow 0 17285) 17348) anon32_Else_correct)))))
...
(let ((anon27_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_empty'u8'$0$v@1| |inline$$1_Vector_empty'u8'$0$v@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (=> (and (and (and (|$IsValid'vec'u8''| $t1@0) (|$IsValid'u64'| $t9@0)) (and (|$IsValid'vec'u8''| $t11@0) (|$IsValid'u64'| $t12@0))) (and (and (|$IsValid'u64'| $t13@0) (|$IsValid'vec'u8''| (|v#$Mutation_10769| $t14@0))) (and (not false) (= (ControlFlow 0 17263) 17257)))) inline$$Lt$0$anon0_correct))))
...
(let ((anon0$1_correct  (=> (|$IsValid'$1_Authenticator_MultiEd25519PublicKey'| _$t0) (=> (and (and (= _$t0 _$t0) (= $t6@0 (|$public_keys#$1_Authenticator_MultiEd25519PublicKey| _$t0))) (and (= $t6@0 $t6@0) (= (ControlFlow 0 17111) 17105))) |inline$$1_Vector_length'vec'u8''$0$anon0_correct|))))
(let ((anon0_correct  (=> (and (and (= (seq.len (|p#$Mutation_10769| $t14)) 0) (= (seq.len (|p#$Mutation_10769| $t15)) 0)) (and (= (seq.len (|p#$Mutation_10769| $t18)) 0) (= (ControlFlow 0 17047) 17111))) anon0$1_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 19090) 17047) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))))
))
(check-sat)
