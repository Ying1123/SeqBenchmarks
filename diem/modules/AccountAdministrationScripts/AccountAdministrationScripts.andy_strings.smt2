...
(pop 1)
; Valid
(declare-fun $1_SlidingNonce_SlidingNonce_$memory () T@$Memory_130046)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@0 () T@$Memory_161256)
(declare-fun $t4@@4 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0 () Bool)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0 () T@$Mutation_165279)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@0 () T@$Memory_161256)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@0 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@0 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@0 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@1 () T@$Memory_161256)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@3 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@1 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 () Bool)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3 () T@$Mutation_165279)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@3 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@3 () T@$Mutation_165279)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1 () T@$Memory_130046)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0 () T@$Memory_130046)
...
(assert (not
 (=> (= (ControlFlow 0 0) 343685) (let ((L2_correct@@2  (and (=> (= (ControlFlow 0 250675) (- 0 346725)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (not (= (seq.len _$t2) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (not (= (seq.len _$t2) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0)) (=> (= (ControlFlow 0 250675) (- 0 346792)) (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 $t7@0@@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2) 0)) (= 7 $t7@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t6@@2)) (= 5 $t7@0@@0))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0) (= 1 $t7@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3))) (= 5 $t7@0@@0))) (and (not (= (seq.len _$t2) 32)) (= 7 $t7@0@@0))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0) (= 1 $t7@0@@0))) (= 7 $t7@0@@0)) (= 1 $t7@0@@0)) (= 5 $t7@0@@0)))))))
(let ((anon13_Then_correct  (=> (and (and $abort_flag@8@@3 (= $abort_code@9@@3 $abort_code@9@@3)) (and (= $t7@0@@0 $abort_code@9@@3) (= (ControlFlow 0 250431) 250675))) L2_correct@@2)))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@6@@5 (= $abort_code@7@@4 $abort_code@7@@4)) (and (= $t7@0@@0 $abort_code@7@@4) (= (ControlFlow 0 250689) 250675))) L2_correct@@2)))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@4@@6 (= $abort_code@5@@6 $abort_code@5@@6)) (and (= $t7@0@@0 $abort_code@5@@6) (= (ControlFlow 0 250703) 250675))) L2_correct@@2)))
(let ((anon10_Then_correct@@0  (=> (and (and $abort_flag@0@@7 (= $abort_code@1@@7 $abort_code@1@@7)) (and (= $t7@0@@0 $abort_code@1@@7) (= (ControlFlow 0 250717) 250675))) L2_correct@@2)))
(let ((anon13_Else_correct  (=> (not $abort_flag@8@@3) (and (=> (= (ControlFlow 0 250417) (- 0 346607)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7)))) (and (=> (= (ControlFlow 0 250417) (- 0 346620)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2) 0))) (and (=> (= (ControlFlow 0 250417) (- 0 346635)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t6@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t6@@2))) (and (=> (= (ControlFlow 0 250417) (- 0 346647)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0)) (and (=> (= (ControlFlow 0 250417) (- 0 346658)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t5@@3)))) (and (=> (= (ControlFlow 0 250417) (- 0 346672)) (not (not (= (seq.len _$t2) 32)))) (=> (not (not (= (seq.len _$t2) 32))) (and (=> (= (ControlFlow 0 250417) (- 0 346686)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0@@7))))) 0)) (=> (= (ControlFlow 0 250417) (- 0 346697)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@5@@0) $t4@@4)) _$t2)))))))))))))))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@0  (=> (not inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0) (=> (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0 ($Mutation_165279 (|l#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0) (|p#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0) |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@0|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) (=> (and (and (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) 1)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0))) 0))) (and (= (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0)) 0) inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@0) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@4@@0 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)) (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@0)))) (= $1_DiemAccount_DiemAccount_$memory@5@@0 $1_DiemAccount_DiemAccount_$memory@4@@0)) (and (= $abort_code@9@@3 $abort_code@8@@4) (= $abort_flag@8@@3 $abort_flag@7@@4)))) (and (=> (= (ControlFlow 0 250189) 250431) anon13_Then_correct) (=> (= (ControlFlow 0 250189) 250417) anon13_Else_correct)))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0  (=> (= $1_DiemAccount_DiemAccount_$memory@5@@0 $1_DiemAccount_DiemAccount_$memory@3@@0) (=> (and (= $abort_code@9@@3 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0) (= $abort_flag@8@@3 true)) (and (=> (= (ControlFlow 0 250035) 250431) anon13_Then_correct) (=> (= (ControlFlow 0 250035) 250417) anon13_Else_correct))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@0  (=> inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0 (=> (and (and (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0))) 0)) (= 7 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0)) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@0) (= (ControlFlow 0 250215) 250035))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0  (=> (not $abort_flag@7@@4) (=> (and (and (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)) (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0| |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@0|)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0 ($Mutation_165279 (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0)))) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@0  (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@0))) 0))))) (and (=> (= (ControlFlow 0 250107) 250215) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@0) (=> (= (ControlFlow 0 250107) 250189) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0  (=> (and (and $abort_flag@7@@4 (= $abort_code@8@@4 $abort_code@8@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 $abort_code@8@@4) (= (ControlFlow 0 250229) 250035))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@0  (=> (= $abort_flag@7@@4 true) (=> (and (= $abort_code@8@@4 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0)) (and (=> (= (ControlFlow 0 250281) 250229) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0) (=> (= (ControlFlow 0 250281) 250107) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0)) (= (ControlFlow 0 250279) 250281)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0) (=> (and (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0 ($Mutation_165235 ($Global inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0))) (= $abort_flag@7@@4 $abort_flag@6@@5)) (and (= $abort_code@8@@4 $abort_code@7@@4) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@0))) (and (=> (= (ControlFlow 0 250065) 250229) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@0) (=> (= (ControlFlow 0 250065) 250107) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@0  (=> (and inline$$1_DiemAccount_exists_at$3$$t1@1@@0 (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3))) (and (=> (= (ControlFlow 0 250043) 250279) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@0) (=> (= (ControlFlow 0 250043) 250065) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@0  (=> (and (and (not inline$$1_DiemAccount_exists_at$3$$t1@1@@0) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= (ControlFlow 0 250029) 250035))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@0  (=> (and (not $abort_flag@6@@5) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@0) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 inline$$1_DiemAccount_exists_at$3$$t1@1@@0))) (and (=> (= (ControlFlow 0 250013) 250043) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@0) (=> (= (ControlFlow 0 250013) 250029) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@0  (=> (and (and $abort_flag@6@@5 (= $abort_code@7@@4 $abort_code@7@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@0 $abort_code@7@@4) (= (ControlFlow 0 250295) 250035))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_exists_at$3$anon0_correct@@0  (=> (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0) (=> (and (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@0) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0)) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@0 inline$$1_DiemAccount_exists_at$3$$t1@1@@0)) (and (=> (= (ControlFlow 0 249971) 250295) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@0) (=> (= (ControlFlow 0 249971) 250013) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@0  (=> (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@0)) 0) (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@0)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@0)) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 249977) 249971))) inline$$1_DiemAccount_exists_at$3$anon0_correct@@0))))
(let ((anon12_Else_correct  (=> (and (not $abort_flag@6@@5) (= (ControlFlow 0 250299) 249977)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@0)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@1  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1 ($Mutation_116002 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1 ($Mutation_116002 (|l#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1) (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@1) _$t2)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1) ($1_DiemAccount_DiemAccount (|v#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@1) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@2@@1 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)) (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@1)))) (= $abort_code@7@@4 $abort_code@6@@6)) (and (= $1_DiemAccount_DiemAccount_$memory@3@@0 $1_DiemAccount_DiemAccount_$memory@2@@1) (= $abort_flag@6@@5 $abort_flag@5@@6)))) (and (=> (= (ControlFlow 0 249276) 250689) anon12_Then_correct) (=> (= (ControlFlow 0 249276) 250299) anon12_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1  (=> (= $abort_code@7@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1) (=> (and (= $1_DiemAccount_DiemAccount_$memory@3@@0 $1_DiemAccount_DiemAccount_$memory@1@@3) (= $abort_flag@6@@5 true)) (and (=> (= (ControlFlow 0 249072) 250689) anon12_Then_correct) (=> (= (ControlFlow 0 249072) 250299) anon12_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= (ControlFlow 0 249226) 249072))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@1  (=> (and (and (and (not $abort_flag@5@@6) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 (= |inline$$1_Vector_length'u8'$0$l@1@@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@1)))) (and (=> (= (ControlFlow 0 249210) 249276) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@1) (=> (= (ControlFlow 0 249210) 249226) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@1  (=> (and (and $abort_flag@5@@6 (= $abort_code@6@@6 $abort_code@6@@6)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@6@@6) (= (ControlFlow 0 249290) 249072))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@1|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@1| (seq.len _$t2)) (and (=> (= (ControlFlow 0 249152) 249290) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@1) (=> (= (ControlFlow 0 249152) 249210) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1  (=> (and (and (not $abort_flag@5@@6) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1|) (= (ControlFlow 0 249158) 249152))) |inline$$1_Vector_length'u8'$0$anon0_correct@@1|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1  (=> (and (and $abort_flag@5@@6 (= $abort_code@6@@6 $abort_code@6@@6)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@6@@6) (= (ControlFlow 0 249304) 249072))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@1  (=> (= $abort_flag@5@@6 true) (=> (and (= $abort_code@6@@6 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1)) (and (=> (= (ControlFlow 0 249356) 249304) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1) (=> (= (ControlFlow 0 249356) 249158) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1)) (= (ControlFlow 0 249354) 249356)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1 ($Mutation_165235 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1))) (= $abort_flag@5@@6 $abort_flag@4@@6)) (and (= $abort_code@6@@6 $abort_code@5@@6) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@1))) (and (=> (= (ControlFlow 0 249102) 249304) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@1) (=> (= (ControlFlow 0 249102) 249158) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@1  (=> (and inline$$1_DiemAccount_exists_at$2$$t1@1@@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3))) (and (=> (= (ControlFlow 0 249080) 249354) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@1) (=> (= (ControlFlow 0 249080) 249102) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_exists_at$2$$t1@1@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= (ControlFlow 0 249066) 249072))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@1  (=> (and (not $abort_flag@4@@6) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@1) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 inline$$1_DiemAccount_exists_at$2$$t1@1@@1))) (and (=> (= (ControlFlow 0 249050) 249080) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 249050) 249066) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@1  (=> (and (and $abort_flag@4@@6 (= $abort_code@5@@6 $abort_code@5@@6)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@1 $abort_code@5@@6) (= (ControlFlow 0 249370) 249072))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@1)))
(let ((inline$$1_DiemAccount_exists_at$2$anon0_correct@@1  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1) (=> (and (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@3) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1)) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@1 inline$$1_DiemAccount_exists_at$2$$t1@1@@1)) (and (=> (= (ControlFlow 0 249008) 249370) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 249008) 249050) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@1  (=> (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@1)) 0) (=> (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@1)) 0) (= (seq.len (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@1)) 0)) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= _$t2 _$t2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 249014) 249008))) inline$$1_DiemAccount_exists_at$2$anon0_correct@@1)))))
(let ((anon11_Else_correct  (=> (not $abort_flag@4@@6) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3) (= (ControlFlow 0 249374) 249014)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@1))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@3  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3 ($Mutation_165279 (|l#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3) (|p#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@3|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@3) 0)))) (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@3) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0@@3 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)) (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@3)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3))) (and (and (= $abort_flag@4@@6 $abort_flag@3@@6) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@3)) (and (= $abort_code@5@@6 $abort_code@4@@6) (= $1_DiemAccount_DiemAccount_$memory@1@@3 $1_DiemAccount_DiemAccount_$memory@0@@3)))) (and (=> (= (ControlFlow 0 248212) 250703) anon11_Then_correct) (=> (= (ControlFlow 0 248212) 249374) anon11_Else_correct))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3  (=> (and (and (= $abort_flag@4@@6 true) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0@@3)) (and (= $abort_code@5@@6 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3) (= $1_DiemAccount_DiemAccount_$memory@1@@3 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 247889) 250703) anon11_Then_correct) (=> (= (ControlFlow 0 247889) 249374) anon11_Else_correct)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@3  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@3) (= (ControlFlow 0 248238) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3  (=> (and (not $abort_flag@3@@6) (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3))) (=> (and (and (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3|) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3 ($Mutation_165279 (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@3 (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@3 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@3))) 0)))) (and (=> (= (ControlFlow 0 248120) 248238) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@3) (=> (= (ControlFlow 0 248120) 248212) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3  (=> (and (and $abort_flag@3@@6 (= $abort_code@4@@6 $abort_code@4@@6)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@4@@6) (= (ControlFlow 0 248252) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@3  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3) (=> (and (= $abort_code@4@@6 $EXEC_FAILURE_CODE) (= $abort_flag@3@@6 true)) (and (=> (= (ControlFlow 0 248304) 248252) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3) (=> (= (ControlFlow 0 248304) 248120) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= (ControlFlow 0 248302) 248304)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3 ($Mutation_165235 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@3)) (and (= $abort_code@4@@6 $abort_code@3@@6) (= $abort_flag@3@@6 $abort_flag@2@@6))) (and (=> (= (ControlFlow 0 248074) 248252) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@3) (=> (= (ControlFlow 0 248074) 248120) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@3  (=> inline$$1_DiemAccount_exists_at$1$$t1@1@@3 (and (=> (= (ControlFlow 0 248052) 248302) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@3) (=> (= (ControlFlow 0 248052) 248074) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= (ControlFlow 0 248048) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@3  (=> (and (not $abort_flag@2@@6) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@3) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 inline$$1_DiemAccount_exists_at$1$$t1@1@@3))) (and (=> (= (ControlFlow 0 248032) 248052) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@3) (=> (= (ControlFlow 0 248032) 248048) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@3  (=> (and (and $abort_flag@2@@6 (= $abort_code@3@@6 $abort_code@3@@6)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@3@@6) (= (ControlFlow 0 248318) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct@@3  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@3 inline$$1_DiemAccount_exists_at$1$$t1@1@@3)) (and (=> (= (ControlFlow 0 247990) 248318) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@3) (=> (= (ControlFlow 0 247990) 248032) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@3  (=> (and inline$$Not$0$dst@1@@7 (= (ControlFlow 0 247996) 247990)) inline$$1_DiemAccount_exists_at$1$anon0_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@3  (=> (and (and (not inline$$Not$0$dst@1@@7) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= (ControlFlow 0 247883) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@3  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@3) (= inline$$Not$0$dst@1@@7 inline$$Not$0$dst@1@@7))) (and (=> (= (ControlFlow 0 247867) 247996) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@3) (=> (= (ControlFlow 0 247867) 247883) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@3))))))
(let ((inline$$Not$0$anon0_correct@@7  (=> (and (= inline$$Not$0$dst@1@@7  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3)) (= (ControlFlow 0 247827) 247867)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@3)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3  (=> (and (not $abort_flag@2@@6) (= (ControlFlow 0 247833) 247827)) inline$$Not$0$anon0_correct@@7)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3  (=> (and (and $abort_flag@2@@6 (= $abort_code@3@@6 $abort_code@3@@6)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@3 $abort_code@3@@6) (= (ControlFlow 0 248332) 247889))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3  (=> (not $abort_flag@1@@7) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@3 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@3)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3) (= $abort_flag@2@@6 $abort_flag@1@@7)) (and (= $abort_code@3@@6 $abort_code@2@@7) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@3))) (and (=> (= (ControlFlow 0 247703) 248332) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 247703) 247833) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3  (=> (= $abort_flag@2@@6 true) (=> (and (= $abort_code@3@@6 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0@@3)) (and (=> (= (ControlFlow 0 247651) 248332) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 247651) 247833) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3  (=> (and (and $abort_flag@1@@7 (= $abort_code@2@@7 $abort_code@2@@7)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 $abort_code@2@@7) (= (ControlFlow 0 247717) 247651))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@3  (=> (= $abort_code@2@@7 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@7 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0@@3)) (and (=> (= (ControlFlow 0 247769) 247717) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3) (=> (= (ControlFlow 0 247769) 247703) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= (ControlFlow 0 247767) 247769)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= $abort_code@2@@7 $abort_code@1@@7)) (and (= $abort_flag@1@@7 $abort_flag@0@@7) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@3))) (and (=> (= (ControlFlow 0 247669) 247717) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@3) (=> (= (ControlFlow 0 247669) 247703) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@3  (=> inline$$1_DiemAccount_exists_at$0$$t1@1@@6 (and (=> (= (ControlFlow 0 247655) 247767) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@3) (=> (= (ControlFlow 0 247655) 247669) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@6) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= (ControlFlow 0 247645) 247651))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@3  (=> (and (not $abort_flag@0@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@3) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 inline$$1_DiemAccount_exists_at$0$$t1@1@@6))) (and (=> (= (ControlFlow 0 247629) 247655) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@3) (=> (= (ControlFlow 0 247629) 247645) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@3  (=> (and (and $abort_flag@0@@7 (= $abort_code@1@@7 $abort_code@1@@7)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@3 $abort_code@1@@7) (= (ControlFlow 0 247783) 247651))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@6  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@6 inline$$1_DiemAccount_exists_at$0$$t1@1@@6)) (and (=> (= (ControlFlow 0 247587) 247783) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@3) (=> (= (ControlFlow 0 247587) 247629) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@3  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= (ControlFlow 0 247593) 247587)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@6)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@3)) 0) (=> (and (and (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@3)) 0) (= (seq.len (|p#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@3)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@3 (|$addr#$signer| _$t0@@7)) (= _$t0@@7 _$t0@@7))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 (|$addr#$signer| _$t0@@7))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@3) (= (ControlFlow 0 247789) 247593)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@3))))
(let ((anon10_Else_correct@@0  (=> (not $abort_flag@0@@7) (=> (and (= $t8@@0 (|$addr#$signer| _$t0@@7)) (= (ControlFlow 0 248338) 247789)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@3))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0@@7 true) (= $abort_code@1@@7 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 246436) 250717) anon10_Then_correct@@0) (=> (= (ControlFlow 0 246436) 248338) anon10_Else_correct@@0)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 246430) 246436))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 246486) 246436))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0@@7 false) (= $abort_code@1@@7 $abort_code@0@@7)) (and (=> (= (ControlFlow 0 246442) 250717) anon10_Then_correct@@0) (=> (= (ControlFlow 0 246442) 248338) anon10_Else_correct@@0))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0@@7 _$t1@@2)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 246414) 246442) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 246414) 246430) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_130046 (|Store__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) false) (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 246356) 246414)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_130046 (|Store__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|))) (= (ControlFlow 0 246456) 246414)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 246342) 246456) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 246342) 246356) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0@@7 _$t0@@7) (=> (and (= _$t1@@2 _$t1@@2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@7))))) (and (=> (= (ControlFlow 0 246336) 246486) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 246336) 246342) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct@@7  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (forall ((addr@@225 Int) ) (!  (=> (|$IsValid'address'| addr@@225) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@225) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@225)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@225)))) 0)) (= addr@@225 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@225))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18088:20|
 :skolemid |413|
))) (=> (and (and (forall ((addr@@226 Int) ) (!  (=> (|$IsValid'address'| addr@@226) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@226) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@226) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@226)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@226)))) 0)) (= addr@@226 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@226))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18092:20|
 :skolemid |414|
)) (forall ((addr@@227 Int) ) (!  (=> (|$IsValid'address'| addr@@227) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@227) (|Select__T@[Int]Bool_| (|domain#$Memory_127423| $1_Roles_RoleId_$memory) addr@@227)))
 :qid |AccountAdministrationScriptsandybpl.18096:20|
 :skolemid |415|
))) (and (forall ((addr@@228 Int) ) (!  (=> (|$IsValid'address'| addr@@228) (=> (and (= addr@@228 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@228)) (|Select__T@[Int]Bool_| (|domain#$Memory_162209| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@228)))
 :qid |AccountAdministrationScriptsandybpl.18100:20|
 :skolemid |416|
)) (forall ((addr@@229 Int) ) (!  (=> (|$IsValid'address'| addr@@229) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@229) (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@229)))
 :qid |AccountAdministrationScriptsandybpl.18104:20|
 :skolemid |417|
)))) (=> (and (and (and (and (and (forall ((addr@@230 Int) ) (!  (=> (|$IsValid'address'| addr@@230) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162344| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@230) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@230)))
 :qid |AccountAdministrationScriptsandybpl.18108:22|
 :skolemid |418|
)) (forall ((addr@@231 Int) ) (!  (=> (|$IsValid'address'| addr@@231) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162435| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@231) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@231)))
 :qid |AccountAdministrationScriptsandybpl.18108:218|
 :skolemid |419|
))) (forall ((addr@@232 Int) ) (!  (=> (|$IsValid'address'| addr@@232) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162526| |$1_DiemAccount_Balance'#0'_$memory|) addr@@232) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@232)))
 :qid |AccountAdministrationScriptsandybpl.18108:415|
 :skolemid |420|
))) (|$IsValid'address'| (|$addr#$signer| _$t0@@7))) (and (and (|$IsValid'u64'| _$t1@@2) (|$IsValid'vec'u8''| _$t2)) (and (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@24)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@24))
 :qid |AccountAdministrationScriptsandybpl.18120:20|
 :skolemid |421|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@24))
)) (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@25)))
 ...
 :qid |AccountAdministrationScriptsandybpl.18124:20|
 :skolemid |422|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@25))
))))) (and (and (and (= $t4@@4 (|$addr#$signer| _$t0@@7)) (= $t5@@3 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t4@@4))) 0))) (and (= $t6@@2 (|$addr#$signer| _$t0@@7)) (let ((addr@@233 (|$addr#$signer| _$t0@@7)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@233)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@233) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@233)))))))) (and (and (= _$t0@@7 _$t0@@7) (= _$t1@@2 _$t1@@2)) (and (= _$t2 _$t2) (= (ControlFlow 0 246490) 246336))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@7  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_89085_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_89085| stream@@8) 0) (forall ((v@@55 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_89085| stream@@8) v@@55) 0)
 :qid |AccountAdministrationScriptsandybpl.129:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsandybpl.3263:13|
 :skolemid |89|
))) (= (ControlFlow 0 245592) 246490)) anon0$1_correct@@7)))
(let ((anon0_correct@@7  (=> (= (ControlFlow 0 343685) 245592) inline$$InitEventStore$0$anon0_correct@@7)))
anon0_correct@@7)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@1 () T@$Memory_161256)
(declare-fun $t5@@4 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1 () Bool)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1 () T@$Mutation_165279)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@1 () T@$Memory_161256)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@1 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1 () Int)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@1 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@1 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@2 () T@$Memory_161256)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@4 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@2 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@2 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 () Bool)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4 () T@$Mutation_165279)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4 () T@$Mutation_165279)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@4 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 () Int)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@4 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@4 () T@$Mutation_165279)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@0 () T@$Memory_130046)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@0 () T@$Memory_130046)
...
(assert (not
 (=> (= (ControlFlow 0 0) 346945) (let ((L2_correct@@3  (and (=> (= (ControlFlow 0 256223) (- 0 350006)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (not (= (seq.len _$t3) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (not (= (seq.len _$t3) 32))) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (=> (= (ControlFlow 0 256223) (- 0 350073)) (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 $t8@0@@1)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0)) (= 7 $t8@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t7@@0)) (= 5 $t8@0@@1))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0) (= 1 $t8@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3))) (= 5 $t8@0@@1))) (and (not (= (seq.len _$t3) 32)) (= 7 $t8@0@@1))) (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0) (= 1 $t8@0@@1))) (= 7 $t8@0@@1)) (= 1 $t8@0@@1)) (= 5 $t8@0@@1)))))))
(let ((anon13_Then_correct@@0  (=> (and (and $abort_flag@8@@4 (= $abort_code@9@@4 $abort_code@9@@4)) (and (= $t8@0@@1 $abort_code@9@@4) (= (ControlFlow 0 255979) 256223))) L2_correct@@3)))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@6@@6 (= $abort_code@7@@5 $abort_code@7@@5)) (and (= $t8@0@@1 $abort_code@7@@5) (= (ControlFlow 0 256237) 256223))) L2_correct@@3)))
(let ((anon11_Then_correct@@0  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= $t8@0@@1 $abort_code@5@@7) (= (ControlFlow 0 256251) 256223))) L2_correct@@3)))
(let ((anon10_Then_correct@@1  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t8@0@@1 $abort_code@1@@8) (= (ControlFlow 0 256265) 256223))) L2_correct@@3)))
(let ((anon13_Else_correct@@0  (=> (not $abort_flag@8@@4) (and (=> (= (ControlFlow 0 255965) (- 0 349888)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8)))) (and (=> (= (ControlFlow 0 255965) (- 0 349901)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0) 0))) (and (=> (= (ControlFlow 0 255965) (- 0 349916)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t7@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t7@@0))) (and (=> (= (ControlFlow 0 255965) (- 0 349928)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (and (=> (= (ControlFlow 0 255965) (- 0 349939)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| $t6@@3)))) (and (=> (= (ControlFlow 0 255965) (- 0 349953)) (not (not (= (seq.len _$t3) 32)))) (=> (not (not (= (seq.len _$t3) 32))) (and (=> (= (ControlFlow 0 255965) (- 0 349967)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0))) (=> (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t1@@3))))) 0)) (=> (= (ControlFlow 0 255965) (- 0 349978)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@5@@1) $t5@@4)) _$t3)))))))))))))))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@1  (=> (not inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1) (=> (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1 ($Mutation_165279 (|l#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1) (|p#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1) |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@1|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) (=> (and (and (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) 1)) (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1))) 0))) (and (= (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1)) 0) inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@2@@1) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@4@@1 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)) (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@3@@1)))) (= $1_DiemAccount_DiemAccount_$memory@5@@1 $1_DiemAccount_DiemAccount_$memory@4@@1)) (and (= $abort_code@9@@4 $abort_code@8@@5) (= $abort_flag@8@@4 $abort_flag@7@@5)))) (and (=> (= (ControlFlow 0 255737) 255979) anon13_Then_correct@@0) (=> (= (ControlFlow 0 255737) 255965) anon13_Else_correct@@0)))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1  (=> (= $1_DiemAccount_DiemAccount_$memory@5@@1 $1_DiemAccount_DiemAccount_$memory@3@@1) (=> (and (= $abort_code@9@@4 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1) (= $abort_flag@8@@4 true)) (and (=> (= (ControlFlow 0 255583) 255979) anon13_Then_correct@@0) (=> (= (ControlFlow 0 255583) 255965) anon13_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@1  (=> inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1 (=> (and (and (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1))) 0)) (= 7 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1)) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@0@@1) (= (ControlFlow 0 255763) 255583))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1  (=> (not $abort_flag@7@@5) (=> (and (and (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)) (= |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1| |inline$$1_DiemAccount_restore_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@1|)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1 ($Mutation_165279 (|l#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1)))) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t12@0@@1  (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@1@@1))) 0))))) (and (=> (= (ControlFlow 0 255655) 255763) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Then_correct@@1) (=> (= (ControlFlow 0 255655) 255737) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon18_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1  (=> (and (and $abort_flag@7@@5 (= $abort_code@8@@5 $abort_code@8@@5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 $abort_code@8@@5) (= (ControlFlow 0 255777) 255583))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@1  (=> (= $abort_flag@7@@5 true) (=> (and (= $abort_code@8@@5 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1)) (and (=> (= (ControlFlow 0 255829) 255777) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 255829) 255655) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1)) (= (ControlFlow 0 255827) 255829)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then$1_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1) (=> (and (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1 ($Mutation_165235 ($Global inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1))) (= $abort_flag@7@@5 $abort_flag@6@@6)) (and (= $abort_code@8@@5 $abort_code@7@@5) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@2@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@1@@1))) (and (=> (= (ControlFlow 0 255613) 255777) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 255613) 255655) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon17_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@1  (=> (and inline$$1_DiemAccount_exists_at$3$$t1@1@@1 (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t9@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4))) (and (=> (= (ControlFlow 0 255591) 255827) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 255591) 255613) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon16_Else_correct@@1)))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@1  (=> (and (and (not inline$$1_DiemAccount_exists_at$3$$t1@1@@1) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= (ControlFlow 0 255577) 255583))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@1  (=> (and (not $abort_flag@6@@6) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t8@0@@1) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 inline$$1_DiemAccount_exists_at$3$$t1@1@@1))) (and (=> (= (ControlFlow 0 255561) 255591) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 255561) 255577) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon15_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@1  (=> (and (and $abort_flag@6@@6 (= $abort_code@7@@5 $abort_code@7@@5)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t6@1@@1 $abort_code@7@@5) (= (ControlFlow 0 255843) 255583))) inline$$1_DiemAccount_restore_key_rotation_capability$0$L3_correct@@1)))
(let ((inline$$1_DiemAccount_exists_at$3$anon0_correct@@1  (=> (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1 inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1) (=> (and (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@1) inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1)) (= inline$$1_DiemAccount_exists_at$3$$t1@1@@1 inline$$1_DiemAccount_exists_at$3$$t1@1@@1)) (and (=> (= (ControlFlow 0 255519) 255843) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Then_correct@@1) (=> (= (ControlFlow 0 255519) 255561) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon14_Else_correct@@1))))))
(let ((inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@1  (=> (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t3@0@@1)) 0) (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t10@0@@1)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_165279| inline$$1_DiemAccount_restore_key_rotation_capability$0$$t11@0@@1)) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (and (= inline$$1_DiemAccount_restore_key_rotation_capability$0$$t4@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 255525) 255519))) inline$$1_DiemAccount_exists_at$3$anon0_correct@@1))))
(let ((anon12_Else_correct@@0  (=> (and (not $abort_flag@6@@6) (= (ControlFlow 0 255847) 255525)) inline$$1_DiemAccount_restore_key_rotation_capability$0$anon0_correct@@1)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@2  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2 ($Mutation_116002 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2 ($Mutation_116002 (|l#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2) (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@2) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@2@@2 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)) (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@2)))) (= $abort_code@7@@5 $abort_code@6@@7)) (and (= $1_DiemAccount_DiemAccount_$memory@3@@1 $1_DiemAccount_DiemAccount_$memory@2@@2) (= $abort_flag@6@@6 $abort_flag@5@@7)))) (and (=> (= (ControlFlow 0 254824) 256237) anon12_Then_correct@@0) (=> (= (ControlFlow 0 254824) 255847) anon12_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2  (=> (= $abort_code@7@@5 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2) (=> (and (= $1_DiemAccount_DiemAccount_$memory@3@@1 $1_DiemAccount_DiemAccount_$memory@1@@4) (= $abort_flag@6@@6 true)) (and (=> (= (ControlFlow 0 254620) 256237) anon12_Then_correct@@0) (=> (= (ControlFlow 0 254620) 255847) anon12_Else_correct@@0))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@2  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= (ControlFlow 0 254774) 254620))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@2  (=> (and (and (and (not $abort_flag@5@@7) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 (= |inline$$1_Vector_length'u8'$0$l@1@@2| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@2)))) (and (=> (= (ControlFlow 0 254758) 254824) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@2) (=> (= (ControlFlow 0 254758) 254774) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@2  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@6@@7) (= (ControlFlow 0 254838) 254620))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@2|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@2| (seq.len _$t3)) (and (=> (= (ControlFlow 0 254700) 254838) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@2) (=> (= (ControlFlow 0 254700) 254758) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2  (=> (and (and (not $abort_flag@5@@7) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@2|) (= (ControlFlow 0 254706) 254700))) |inline$$1_Vector_length'u8'$0$anon0_correct@@2|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2  (=> (and (and $abort_flag@5@@7 (= $abort_code@6@@7 $abort_code@6@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@6@@7) (= (ControlFlow 0 254852) 254620))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@2  (=> (= $abort_flag@5@@7 true) (=> (and (= $abort_code@6@@7 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2)) (and (=> (= (ControlFlow 0 254904) 254852) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2) (=> (= (ControlFlow 0 254904) 254706) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2)) (= (ControlFlow 0 254902) 254904)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2 ($Mutation_165235 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2))) (= $abort_flag@5@@7 $abort_flag@4@@7)) (and (= $abort_code@6@@7 $abort_code@5@@7) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@2))) (and (=> (= (ControlFlow 0 254650) 254852) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@2) (=> (= (ControlFlow 0 254650) 254706) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@2  (=> (and inline$$1_DiemAccount_exists_at$2$$t1@1@@2 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@2 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4))) (and (=> (= (ControlFlow 0 254628) 254902) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@2) (=> (= (ControlFlow 0 254628) 254650) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@2)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@2  (=> (and (and (not inline$$1_DiemAccount_exists_at$2$$t1@1@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= (ControlFlow 0 254614) 254620))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@2  (=> (and (not $abort_flag@4@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@2) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 inline$$1_DiemAccount_exists_at$2$$t1@1@@2))) (and (=> (= (ControlFlow 0 254598) 254628) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@2) (=> (= (ControlFlow 0 254598) 254614) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@2  (=> (and (and $abort_flag@4@@7 (= $abort_code@5@@7 $abort_code@5@@7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@2 $abort_code@5@@7) (= (ControlFlow 0 254918) 254620))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@2)))
(let ((inline$$1_DiemAccount_exists_at$2$anon0_correct@@2  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2) (=> (and (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@1@@4) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2)) (= inline$$1_DiemAccount_exists_at$2$$t1@1@@2 inline$$1_DiemAccount_exists_at$2$$t1@1@@2)) (and (=> (= (ControlFlow 0 254556) 254918) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@2) (=> (= (ControlFlow 0 254556) 254598) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@2))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@2  (=> (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@2)) 0) (=> (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@2)) 0) (= (seq.len (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@2)) 0)) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= _$t3 _$t3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@2 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 254562) 254556))) inline$$1_DiemAccount_exists_at$2$anon0_correct@@2)))))
(let ((anon11_Else_correct@@0  (=> (not $abort_flag@4@@7) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4) (= (ControlFlow 0 254922) 254562)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@2))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@4  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4 ($Mutation_165279 (|l#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4) (|p#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1@@4|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4)) (<= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@4) 0)))) (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2@@4) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0@@4 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)) (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3@@4)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4))) (and (and (= $abort_flag@4@@7 $abort_flag@3@@7) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0@@4)) (and (= $abort_code@5@@7 $abort_code@4@@7) (= $1_DiemAccount_DiemAccount_$memory@1@@4 $1_DiemAccount_DiemAccount_$memory@0@@4)))) (and (=> (= (ControlFlow 0 253760) 256251) anon11_Then_correct@@0) (=> (= (ControlFlow 0 253760) 254922) anon11_Else_correct@@0))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4  (=> (and (and (= $abort_flag@4@@7 true) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0@@4)) (and (= $abort_code@5@@7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4) (= $1_DiemAccount_DiemAccount_$memory@1@@4 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 253437) 256251) anon11_Then_correct@@0) (=> (= (ControlFlow 0 253437) 254922) anon11_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@4  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 (=> (and (and (and (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0@@4) (= (ControlFlow 0 253786) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4  (=> (and (not $abort_flag@3@@7) (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4))) (=> (and (and (= |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4|) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4 ($Mutation_165279 (|l#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4) (seq.unit 2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1@@4 (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0@@4 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1@@4))) 0)))) (and (=> (= (ControlFlow 0 253668) 253786) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct@@4) (=> (= (ControlFlow 0 253668) 253760) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4  (=> (and (and $abort_flag@3@@7 (= $abort_code@4@@7 $abort_code@4@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@4@@7) (= (ControlFlow 0 253800) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@4  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4) (=> (and (= $abort_code@4@@7 $EXEC_FAILURE_CODE) (= $abort_flag@3@@7 true)) (and (=> (= (ControlFlow 0 253852) 253800) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4) (=> (= (ControlFlow 0 253852) 253668) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= (ControlFlow 0 253850) 253852)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4 ($Mutation_165235 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1@@4)) (and (= $abort_code@4@@7 $abort_code@3@@7) (= $abort_flag@3@@7 $abort_flag@2@@7))) (and (=> (= (ControlFlow 0 253622) 253800) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct@@4) (=> (= (ControlFlow 0 253622) 253668) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@4  (=> inline$$1_DiemAccount_exists_at$1$$t1@1@@4 (and (=> (= (ControlFlow 0 253600) 253850) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct@@4) (=> (= (ControlFlow 0 253600) 253622) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= (ControlFlow 0 253596) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@4  (=> (and (not $abort_flag@2@@7) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0@@4) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 inline$$1_DiemAccount_exists_at$1$$t1@1@@4))) (and (=> (= (ControlFlow 0 253580) 253600) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct@@4) (=> (= (ControlFlow 0 253580) 253596) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@4  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@3@@7) (= (ControlFlow 0 253866) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct@@4  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= inline$$1_DiemAccount_exists_at$1$$t1@1@@4 inline$$1_DiemAccount_exists_at$1$$t1@1@@4)) (and (=> (= (ControlFlow 0 253538) 253866) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct@@4) (=> (= (ControlFlow 0 253538) 253580) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@4  (=> (and inline$$Not$0$dst@1@@8 (= (ControlFlow 0 253544) 253538)) inline$$1_DiemAccount_exists_at$1$anon0_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@4  (=> (and (and (not inline$$Not$0$dst@1@@8) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= (ControlFlow 0 253431) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@4  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0@@4) (= inline$$Not$0$dst@1@@8 inline$$Not$0$dst@1@@8))) (and (=> (= (ControlFlow 0 253415) 253544) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct@@4) (=> (= (ControlFlow 0 253415) 253431) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct@@4))))))
(let ((inline$$Not$0$anon0_correct@@8  (=> (and (= inline$$Not$0$dst@1@@8  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4)) (= (ControlFlow 0 253375) 253415)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct@@4)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4  (=> (and (not $abort_flag@2@@7) (= (ControlFlow 0 253381) 253375)) inline$$Not$0$anon0_correct@@8)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1@@4 $abort_code@3@@7) (= (ControlFlow 0 253880) 253437))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4  (=> (not $abort_flag@1@@8) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@4 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4 (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1@@4)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4) (= $abort_flag@2@@7 $abort_flag@1@@8)) (and (= $abort_code@3@@7 $abort_code@2@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0@@4))) (and (=> (= (ControlFlow 0 253251) 253880) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 253251) 253381) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4  (=> (= $abort_flag@2@@7 true) (=> (and (= $abort_code@3@@7 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0@@4)) (and (=> (= (ControlFlow 0 253199) 253880) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 253199) 253381) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4  (=> (and (and $abort_flag@1@@8 (= $abort_code@2@@8 $abort_code@2@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 $abort_code@2@@8) (= (ControlFlow 0 253265) 253199))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@4  (=> (= $abort_code@2@@8 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@8 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0@@4)) (and (=> (= (ControlFlow 0 253317) 253265) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4) (=> (= (ControlFlow 0 253317) 253251) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= (ControlFlow 0 253315) 253317)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@4 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= $abort_code@2@@8 $abort_code@1@@8)) (and (= $abort_flag@1@@8 $abort_flag@0@@8) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1@@4))) (and (=> (= (ControlFlow 0 253217) 253265) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct@@4) (=> (= (ControlFlow 0 253217) 253251) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@4  (=> inline$$1_DiemAccount_exists_at$0$$t1@1@@7 (and (=> (= (ControlFlow 0 253203) 253315) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct@@4) (=> (= (ControlFlow 0 253203) 253217) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@7) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= (ControlFlow 0 253193) 253199))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@4  (=> (and (not $abort_flag@0@@8) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0@@4) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 inline$$1_DiemAccount_exists_at$0$$t1@1@@7))) (and (=> (= (ControlFlow 0 253177) 253203) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct@@4) (=> (= (ControlFlow 0 253177) 253193) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@4  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1@@4 $abort_code@1@@8) (= (ControlFlow 0 253331) 253199))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct@@4)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@7  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@7 inline$$1_DiemAccount_exists_at$0$$t1@1@@7)) (and (=> (= (ControlFlow 0 253135) 253331) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct@@4) (=> (= (ControlFlow 0 253135) 253177) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@4  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= (ControlFlow 0 253141) 253135)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@7)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@4  (=> (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0@@4)) 0) (=> (and (and (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0@@4)) 0) (= (seq.len (|p#$Mutation_165279| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0@@4)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0@@4 (|$addr#$signer| _$t1@@3)) (= _$t1@@3 _$t1@@3))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 (|$addr#$signer| _$t1@@3))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0@@4) (= (ControlFlow 0 253337) 253141)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct@@4))))
(let ((anon10_Else_correct@@1  (=> (not $abort_flag@0@@8) (=> (and (= $t9@@1 (|$addr#$signer| _$t1@@3)) (= (ControlFlow 0 253886) 253337)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct@@4))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0  (=> (and (= $abort_flag@0@@8 true) (= $abort_code@1@@8 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0)) (and (=> (= (ControlFlow 0 251984) 256265) anon10_Then_correct@@1) (=> (= (ControlFlow 0 251984) 253886) anon10_Else_correct@@1)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@0  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= (ControlFlow 0 251978) 251984))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@0  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@0) (= (ControlFlow 0 252034) 251984))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@0  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 (=> (and (= $abort_flag@0@@8 false) (= $abort_code@1@@8 $abort_code@0@@8)) (and (=> (= (ControlFlow 0 251990) 256265) anon10_Then_correct@@1) (=> (= (ControlFlow 0 251990) 253886) anon10_Else_correct@@1))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0  (=> (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0) (=> (and (and (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 ($1_SlidingNonce_spec_try_record_nonce _$t0@@8 _$t2@@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@0)))) (and (=> (= (ControlFlow 0 251962) 251990) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@0) (=> (= (ControlFlow 0 251962) 251978) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@0))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@0  (=> (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@0|) (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@1@@0 ($Memory_130046 (|Store__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) false) (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory))) (= (ControlFlow 0 251904) 251962)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@0  (=> |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@0| (=> (and (= $1_SlidingNonce_SlidingNonce_$memory@0@@0 ($Memory_130046 (|Store__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@0|))) (= (ControlFlow 0 252004) 251962)) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@0))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@0  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0) (and (=> (= (ControlFlow 0 251890) 252004) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@0) (=> (= (ControlFlow 0 251890) 251904) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@0)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@0  (=> (= _$t0@@8 _$t0@@8) (=> (and (= _$t2@@0 _$t2@@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@8))))) (and (=> (= (ControlFlow 0 251884) 252034) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@0) (=> (= (ControlFlow 0 251884) 251890) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@0))))))
(let ((anon0$1_correct@@8  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (forall ((addr@@234 Int) ) (!  (=> (|$IsValid'address'| addr@@234) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@234) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@234)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@234)))) 0)) (= addr@@234 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@234))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18314:20|
 :skolemid |423|
))) (=> (and (and (and (forall ((addr@@235 Int) ) (!  (=> (|$IsValid'address'| addr@@235) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@235) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@235) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@235)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@235)))) 0)) (= addr@@235 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@235))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18318:20|
 :skolemid |424|
)) (forall ((addr@@236 Int) ) (!  (=> (|$IsValid'address'| addr@@236) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@236) (|Select__T@[Int]Bool_| (|domain#$Memory_127423| $1_Roles_RoleId_$memory) addr@@236)))
 :qid |AccountAdministrationScriptsandybpl.18322:20|
 :skolemid |425|
))) (and (forall ((addr@@237 Int) ) (!  (=> (|$IsValid'address'| addr@@237) (=> (and (= addr@@237 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@237)) (|Select__T@[Int]Bool_| (|domain#$Memory_162209| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@237)))
 :qid |AccountAdministrationScriptsandybpl.18326:20|
 :skolemid |426|
)) (forall ((addr@@238 Int) ) (!  (=> (|$IsValid'address'| addr@@238) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@238) (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@238)))
 :qid |AccountAdministrationScriptsandybpl.18330:20|
 :skolemid |427|
)))) (and (and (forall ((addr@@239 Int) ) (!  (=> (|$IsValid'address'| addr@@239) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162344| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@239) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@239)))
 :qid |AccountAdministrationScriptsandybpl.18334:22|
 :skolemid |428|
)) (forall ((addr@@240 Int) ) (!  (=> (|$IsValid'address'| addr@@240) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162435| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@240) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@240)))
 :qid |AccountAdministrationScriptsandybpl.18334:218|
 :skolemid |429|
))) (forall ((addr@@241 Int) ) (!  (=> (|$IsValid'address'| addr@@241) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162526| |$1_DiemAccount_Balance'#0'_$memory|) addr@@241) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@241)))
 :qid |AccountAdministrationScriptsandybpl.18334:415|
 :skolemid |430|
)))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@8)) (|$IsValid'address'| (|$addr#$signer| _$t1@@3))) (and (|$IsValid'u64'| _$t2@@0) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@26))
 :qid |AccountAdministrationScriptsandybpl.18349:20|
 :skolemid |431|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_130046| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@26))
)) (forall (($a_0@@27 Int) ) (! (let (($rsc@@27 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@27)))
 ...
 :qid |AccountAdministrationScriptsandybpl.18353:20|
 :skolemid |432|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@27))
))) (and (= $t5@@4 (|$addr#$signer| _$t1@@3)) (= $t6@@3 (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $t5@@4))) 0))))) (and (and (and (= $t7@@0 (|$addr#$signer| _$t1@@3)) (let ((addr@@242 (|$addr#$signer| _$t1@@3)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@242)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@242) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@242))))))) (and (let ((addr@@243 (|$addr#$signer| _$t0@@8)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_127423| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_127423| $1_Roles_RoleId_$memory) addr@@243)) 0))) (= _$t0@@8 _$t0@@8))) (and (and (= _$t1@@3 _$t1@@3) (= _$t2@@0 _$t2@@0)) (and (= _$t3 _$t3) (= (ControlFlow 0 252038) 251884))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_89085_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_89085| stream@@9) 0) (forall ((v@@56 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_89085| stream@@9) v@@56) 0)
 :qid |AccountAdministrationScriptsandybpl.129:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsandybpl.3263:13|
 :skolemid |89|
))) (= (ControlFlow 0 251122) 252038)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 346945) 251122) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@2 () T@$Memory_161256)
(declare-fun $abort_code@6@@8 () Int)
(declare-fun $abort_flag@4@@8 () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@5 () T@$Memory_161256)
(declare-fun $abort_code@5@@8 () Int)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@3 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@3 () T@$Mutation_116002)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3 () T@$Mutation_165235)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@5 () T@$Memory_161256)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@3 () T@$Mutation_165235)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@3 () T@$Mutation_165235)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@3 () T@$Mutation_116002)
...
(assert (not
 (=> (= (ControlFlow 0 0) 350228) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct  (=> (and (not $abort_flag@2@@8) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 259215) (- 0 351798)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (=> (= (ControlFlow 0 259215) (- 0 351805)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0 ($Range 0 inline$$AddU64$0$dst@2)))
...
(let ((anon4_Else_correct@@4  (=> (not $abort_flag@5@@8) (and (=> (= (ControlFlow 0 260539) (- 0 352718)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4))) (and (=> (= (ControlFlow 0 260539) (- 0 352729)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) _$t2@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (and (=> (= (ControlFlow 0 260539) (- 0 352740)) (not (not (= (seq.len _$t3@@0) 32)))) (=> (not (not (= (seq.len _$t3@@0) 32))) (and (=> (= (ControlFlow 0 260539) (- 0 352754)) (not (not (exists ((i@@58 Int) ) (!  (and (and (|$IsValid'u64'| i@@58) (and (<= 0 i@@58) (< i@@58 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@58)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
))))) (=> (not (not (exists ((i@@59 Int) ) (!  (and (and (|$IsValid'u64'| i@@59) (and (<= 0 i@@59) (< i@@59 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@59)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (and (=> (= (ControlFlow 0 260539) (- 0 352766)) (not (not (or (= (|$addr#$signer| _$t0@@9) _$t1@@4) (= (|$addr#$signer| _$t0@@9) _$t2@@1))))) (=> (not (not (or (= (|$addr#$signer| _$t0@@9) _$t1@@4) (= (|$addr#$signer| _$t0@@9) _$t2@@1)))) (and (=> (= (ControlFlow 0 260539) (- 0 352787)) (not (not (exists ((i@@60 Int) ) (!  (and (and (|$IsValid'u64'| i@@60) (and (<= 0 i@@60) (< i@@60 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@60)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
))))) (=> (not (not (exists ((i@@61 Int) ) (!  (and (and (|$IsValid'u64'| i@@61) (and (<= 0 i@@61) (< i@@61 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@61)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (and (=> (= (ControlFlow 0 260539) (- 0 352799)) (not (not (or (= $t4@@5 _$t1@@4) (= $t4@@5 _$t2@@1))))) (=> (not (not (or (= $t4@@5 _$t1@@4) (= $t4@@5 _$t2@@1)))) (=> (= (ControlFlow 0 260539) (- 0 352818)) (= (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory@3@@2) _$t2@@1)) _$t3@@0)))))))))))))))))))
(let ((anon4_Then_correct@@4  (=> (and $abort_flag@5@@8 (= $abort_code@6@@8 $abort_code@6@@8)) (and (=> (= (ControlFlow 0 260819) (- 0 352487)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (not (= (seq.len _$t3@@0) 32))) (not (exists ((i@@62 Int) ) (!  (and (and (|$IsValid'u64'| i@@62) (and (<= 0 i@@62) (< i@@62 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@62)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (not (or (= (|$addr#$signer| _$t0@@9) _$t1@@4) (= (|$addr#$signer| _$t0@@9) _$t2@@1)))) (not (exists ((i@@63 Int) ) (!  (and (and (|$IsValid'u64'| i@@63) (and (<= 0 i@@63) (< i@@63 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@63)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (not (or (= $t4@@5 _$t1@@4) (= $t4@@5 _$t2@@1))))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) _$t2@@1))) (not (= (seq.len _$t3@@0) 32))) (not (exists ((i@@64 Int) ) (!  (and (and (|$IsValid'u64'| i@@64) (and (<= 0 i@@64) (< i@@64 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@64)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (not (or (= (|$addr#$signer| _$t0@@9) _$t1@@4) (= (|$addr#$signer| _$t0@@9) _$t2@@1)))) (not (exists ((i@@65 Int) ) (!  (and (and (|$IsValid'u64'| i@@65) (and (<= 0 i@@65) (< i@@65 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@65)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
)))) (not (or (= $t4@@5 _$t1@@4) (= $t4@@5 _$t2@@1)))) (=> (= (ControlFlow 0 260819) (- 0 352564)) (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (= 5 $abort_code@6@@8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) _$t2@@1)) (= 5 $abort_code@6@@8))) (and (not (= (seq.len _$t3@@0) 32)) (= 7 $abort_code@6@@8))) (and (not (exists ((i@@66 Int) ) (!  (and (and (|$IsValid'u64'| i@@66) (and (<= 0 i@@66) (< i@@66 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@66)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
))) (= 7 $abort_code@6@@8))) (and (not (or (= (|$addr#$signer| _$t0@@9) _$t1@@4) (= (|$addr#$signer| _$t0@@9) _$t2@@1))) (= 7 $abort_code@6@@8))) (and (not (exists ((i@@67 Int) ) (!  (and (and (|$IsValid'u64'| i@@67) (and (<= 0 i@@67) (< i@@67 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) i@@67)) _$t2@@1))
 :qid |AccountAdministrationScriptsandybpl.15272:13|
 :skolemid |221|
))) (= 7 $abort_code@6@@8))) (and (not (or (= $t4@@5 _$t1@@4) (= $t4@@5 _$t2@@1))) (= 7 $abort_code@6@@8))) (= 5 $abort_code@6@@8)) (= 7 $abort_code@6@@8))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct  (=> (and (and (not $abort_flag@4@@8) (= $1_DiemAccount_DiemAccount_$memory@3@@2 $1_DiemAccount_DiemAccount_$memory@1@@5)) (and (= $abort_flag@5@@8 $abort_flag@4@@8) (= $abort_code@6@@8 $abort_code@5@@8))) (and (=> (= (ControlFlow 0 260263) 260819) anon4_Then_correct@@4) (=> (= (ControlFlow 0 260263) 260539) anon4_Else_correct@@4)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct  (=> (= $1_DiemAccount_DiemAccount_$memory@3@@2 $1_DiemAccount_DiemAccount_$memory@2@@3) (=> (and (= $abort_flag@5@@8 true) (= $abort_code@6@@8 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1)) (and (=> (= (ControlFlow 0 258246) 260819) anon4_Then_correct@@4) (=> (= (ControlFlow 0 258246) 260539) anon4_Else_correct@@4))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct  (=> $abort_flag@4@@8 (=> (and (and (= $abort_code@5@@8 $abort_code@5@@8) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@5@@8)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory@1@@5) (= (ControlFlow 0 260277) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@3  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3 ($Mutation_116002 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (seq.++ (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@3 ($Mutation_116002 (|l#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3) (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@3) _$t3@@0)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3 ($Mutation_165235 (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3) ($1_DiemAccount_DiemAccount (|v#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@3) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0@@5 ($Memory_161256 (|Store__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)) (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@3)))) (= $abort_code@5@@8 $abort_code@4@@8)) (and (= $abort_flag@4@@8 $abort_flag@3@@8) (= $1_DiemAccount_DiemAccount_$memory@1@@5 $1_DiemAccount_DiemAccount_$memory@0@@5)))) (and (=> (= (ControlFlow 0 260155) 260277) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 260155) 260263) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3  (=> (= $abort_code@5@@8 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3) (=> (and (= $abort_flag@4@@8 true) (= $1_DiemAccount_DiemAccount_$memory@1@@5 $1_DiemAccount_DiemAccount_$memory)) (and (=> (= (ControlFlow 0 259951) 260277) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 259951) 260263) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= (ControlFlow 0 260105) 259951))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@3  (=> (and (and (and (not $abort_flag@3@@8) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 (= |inline$$1_Vector_length'u8'$0$l@1@@3| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@3)))) (and (=> (= (ControlFlow 0 260089) 260155) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@3) (=> (= (ControlFlow 0 260089) 260105) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@3  (=> (and (and $abort_flag@3@@8 (= $abort_code@4@@8 $abort_code@4@@8)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@4@@8) (= (ControlFlow 0 260169) 259951))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@3|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@3| (seq.len _$t3@@0)) (and (=> (= (ControlFlow 0 260031) 260169) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@3) (=> (= (ControlFlow 0 260031) 260089) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3  (=> (and (and (not $abort_flag@3@@8) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| (|v#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@3|) (= (ControlFlow 0 260037) 260031))) |inline$$1_Vector_length'u8'$0$anon0_correct@@3|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3  (=> (and (and $abort_flag@3@@8 (= $abort_code@4@@8 $abort_code@4@@8)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@4@@8) (= (ControlFlow 0 260183) 259951))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@3  (=> (= $abort_flag@3@@8 true) (=> (and (= $abort_code@4@@8 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@3)) (and (=> (= (ControlFlow 0 260235) 260183) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 260235) 260037) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3)) (= (ControlFlow 0 260233) 260235)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@3 ($Mutation_165235 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3))) (= $abort_flag@3@@8 $abort_flag@1@@9)) (and (= $abort_code@4@@8 $abort_code@2@@9) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@3))) (and (=> (= (ControlFlow 0 259981) 260183) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@3) (=> (= (ControlFlow 0 259981) 260037) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@3  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1@@8 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@3 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|))) (and (=> (= (ControlFlow 0 259959) 260233) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@3) (=> (= (ControlFlow 0 259959) 259981) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@3)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@3  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@8) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= (ControlFlow 0 259945) 259951))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@3  (=> (and (not $abort_flag@1@@9) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@3) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 inline$$1_DiemAccount_exists_at$0$$t1@1@@8))) (and (=> (= (ControlFlow 0 259929) 259959) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@3) (=> (= (ControlFlow 0 259929) 259945) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@3  (=> (and (and $abort_flag@1@@9 (= $abort_code@2@@9 $abort_code@2@@9)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@3 $abort_code@2@@9) (= (ControlFlow 0 260249) 259951))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@3)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@8  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@8 inline$$1_DiemAccount_exists_at$0$$t1@1@@8)) (and (=> (= (ControlFlow 0 259887) 260249) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@3) (=> (= (ControlFlow 0 259887) 259929) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@3))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@3  (=> (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@3)) 0) (=> (and (= (seq.len (|p#$Mutation_165235| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@3)) 0) (= (seq.len (|p#$Mutation_116002| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@3)) 0)) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= _$t3@@0 _$t3@@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@3 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= (ControlFlow 0 259893) 259887))) inline$$1_DiemAccount_exists_at$0$anon0_correct@@8)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct  (=> (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= (ControlFlow 0 260253) 259893)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@3)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct  (=> $abort_flag@2@@8 (=> (and (and (= $abort_code@3@@8 $abort_code@3@@8) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@3@@8)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 259229) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@2@@8 true) (=> (and (= $abort_code@3@@8 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 259146) 259229) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 259146) 259215) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1) $MAX_U64) (= (ControlFlow 0 259144) 259146)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (= $abort_flag@2@@8 $abort_flag@1@@9)) (and (= $abort_code@3@@8 $abort_code@2@@9) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 259092) 259229) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 259092) 259215) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct  (=> (and (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 259152) 259144) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 259152) 259092) inline$$AddU64$0$anon3_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct  (=> (and (not $abort_flag@1@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 _$t2@@1))) (and (=> (= (ControlFlow 0 258985) 260253) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct) (=> (= (ControlFlow 0 258985) 259152) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct  (=> $abort_flag@1@@9 (=> (and (and (= $abort_code@2@@9 $abort_code@2@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 260291) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@1  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1@@1)) (and (=> (= (ControlFlow 0 258965) 260291) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct) (=> (= (ControlFlow 0 258965) 258985) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct  (=> (not $abort_flag@1@@9) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 258971) 258965)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct@@1))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct  (=> $abort_flag@1@@9 (=> (and (and (= $abort_code@2@@9 $abort_code@2@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 260305) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|  (=> (= $abort_code@2@@9 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@9 true) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@0|)) (and (=> (= (ControlFlow 0 258850) 260305) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 258850) 258971) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (and (>= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 0) (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1)))) (= (ControlFlow 0 258848) 258850)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (and (>= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 0) (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1))) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (seq.nth inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1)) (= $abort_code@2@@9 $abort_code@1@@9)) (and (= $abort_flag@1@@9 $abort_flag@0@@9) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 258798) 260305) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 258798) 258971) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct  (=> inline$$Lt$0$dst@1@@0 (and (=> (= (ControlFlow 0 258856) 258848) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 258856) 258798) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct  (=> (not inline$$Lt$0$dst@1@@0) (and (=> (= (ControlFlow 0 258711) (- 0 351458)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (and (=> (= (ControlFlow 0 258711) (- 0 351465)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)))
...
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1))
 ...
 :qid |unknown.0:0|
 :skolemid |225|
))) (=> (|$IsValid'u64'| 4) (=> (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 7)) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 258711) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct  (and (=> (= (ControlFlow 0 258630) 258856) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct) (=> (= (ControlFlow 0 258630) 258711) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct))))
(let ((inline$$Lt$0$anon0_correct@@0  (=> (and (= inline$$Lt$0$dst@1@@0 (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (= (ControlFlow 0 258620) 258630)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct  (=> (and (not $abort_flag@0@@9) (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0| |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (and (=> (= (ControlFlow 0 258626) (- 0 351296)) (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0|) (and (=> (= (ControlFlow 0 258626) (- 0 351303)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@2 ($Range 0 0)))
...
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4))
 ...
 :qid |unknown.0:0|
 :skolemid |224|
))) (= (ControlFlow 0 258626) 258620)))) inline$$Lt$0$anon0_correct@@0)))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct  (=> $abort_flag@0@@9 (=> (and (and (= $abort_code@1@@9 $abort_code@1@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 260319) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1@@0| (seq.len inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1)) (and (=> (= (ControlFlow 0 258430) 260319) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct) (=> (= (ControlFlow 0 258430) 258626) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct  (=> (and (not $abort_flag@0@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2))) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 258436) 258430))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct@@0|))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct  (=> $abort_flag@0@@9 (=> (and (and (= $abort_code@1@@9 $abort_code@1@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1@@9)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 260333) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct  (=> (= $abort_flag@0@@9 true) (=> (and (= $abort_code@1@@9 $EXEC_FAILURE_CODE) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@0)) (and (=> (= (ControlFlow 0 260385) 260333) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 260385) 258436) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (= (ControlFlow 0 260383) 260385)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (= $abort_flag@0@@9 false)) (and (= $abort_code@1@@9 $abort_code@0@@9) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1))) (and (=> (= (ControlFlow 0 258366) 260333) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 258366) 258436) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 (and (=> (= (ControlFlow 0 258352) 260383) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct) (=> (= (ControlFlow 0 258352) 258366) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 258348) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 7)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1))) (and (=> (= (ControlFlow 0 258332) 258352) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct) (=> (= (ControlFlow 0 258332) 258348) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t1@@4)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1) (= (ControlFlow 0 258298) 258332))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct  (=> (and (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= true true)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 true) (= (ControlFlow 0 260403) 258332))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (=> (and (and (|$IsValid'address'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 (|$addr#$signer| _$t0@@9))) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t2@@1)))) (and (=> (= (ControlFlow 0 258276) 260403) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct) (=> (= (ControlFlow 0 258276) 258298) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2@@3 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 258240) 258246))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct  (=> (and (= _$t0@@9 _$t0@@9) (= _$t1@@4 _$t1@@4)) (=> (and (and (and (= _$t2@@1 _$t2@@1) (= _$t3@@0 _$t3@@0)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (|Select__T@[Int]Bool_| (|domain#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1@@4)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 5)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1)))) (and (=> (= (ControlFlow 0 258224) 258276) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct) (=> (= (ControlFlow 0 258224) 258240) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct))))))
(let ((anon0$1_correct@@9  (=> (forall ((addr@@244 Int) ) (!  (=> (|$IsValid'address'| addr@@244) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@244) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@244)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@244)))) 0)) (= addr@@244 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@244))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18536:20|
 :skolemid |433|
)) (=> (and (and (forall ((addr@@245 Int) ) (!  (=> (|$IsValid'address'| addr@@245) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@245) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@245) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@245)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@245)))) 0)) (= addr@@245 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@245))) 0)))))))
 :qid |AccountAdministrationScriptsandybpl.18540:20|
 :skolemid |434|
)) (forall ((addr@@246 Int) ) (!  (=> (|$IsValid'address'| addr@@246) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@246) (|Select__T@[Int]Bool_| (|domain#$Memory_127423| $1_Roles_RoleId_$memory) addr@@246)))
 :qid |AccountAdministrationScriptsandybpl.18544:20|
 :skolemid |435|
))) (and (forall ((addr@@247 Int) ) (!  (=> (|$IsValid'address'| addr@@247) (=> (and (= addr@@247 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@247)) (|Select__T@[Int]Bool_| (|domain#$Memory_162209| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@247)))
 :qid |AccountAdministrationScriptsandybpl.18548:20|
 :skolemid |436|
)) (forall ((addr@@248 Int) ) (!  (=> (|$IsValid'address'| addr@@248) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@248) (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@248)))
 :qid |AccountAdministrationScriptsandybpl.18552:20|
 :skolemid |437|
)))) (=> (and (and (and (and (and (forall ((addr@@249 Int) ) (!  (=> (|$IsValid'address'| addr@@249) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162344| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@249) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@249)))
 :qid |AccountAdministrationScriptsandybpl.18556:22|
 :skolemid |438|
)) (forall ((addr@@250 Int) ) (!  (=> (|$IsValid'address'| addr@@250) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162435| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@250) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@250)))
 :qid |AccountAdministrationScriptsandybpl.18556:218|
 :skolemid |439|
))) (forall ((addr@@251 Int) ) (!  (=> (|$IsValid'address'| addr@@251) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_162526| |$1_DiemAccount_Balance'#0'_$memory|) addr@@251) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@251)))
 :qid |AccountAdministrationScriptsandybpl.18556:415|
 :skolemid |440|
))) (|$IsValid'address'| (|$addr#$signer| _$t0@@9))) (and (and (|$IsValid'address'| _$t1@@4) (|$IsValid'address'| _$t2@@1)) (and (|$IsValid'vec'u8''| _$t3@@0) (forall (($a_0@@28 Int) ) (! (let (($rsc@@28 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@28)))
 ...
 :qid |AccountAdministrationScriptsandybpl.18571:20|
 :skolemid |441|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) $a_0@@28))
))))) (and (and (and (forall (($a_0@@29 Int) ) (! (let (($rsc@@29 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@29)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@29))
 :qid |AccountAdministrationScriptsandybpl.18575:20|
 :skolemid |442|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_169392| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@29))
)) (= $t4@@5 (|$addr#$signer| _$t0@@9))) (and (let ((addr@@252 (|$addr#$signer| _$t0@@9)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_126905| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_161256| $1_DiemAccount_DiemAccount_$memory) addr@@252)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@252) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_160273| $1_AccountFreezing_FreezingBit_$memory) addr@@252)))))) (= _$t0@@9 _$t0@@9))) (and (and (= _$t1@@4 _$t1@@4) (= _$t2@@1 _$t2@@1)) (and (= _$t3@@0 _$t3@@0) (= (ControlFlow 0 260407) 258224))))) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct@@9  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@11 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_89085_| (|streams#$EventStore| $es) handle@@11)))
 (and (= (|l#Multiset_89085| stream@@10) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_89085| stream@@10) v@@57) 0)
 :qid |AccountAdministrationScriptsandybpl.129:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsandybpl.3263:13|
 :skolemid |89|
))) (= (ControlFlow 0 256680) 260407)) anon0$1_correct@@9)))
(let ((anon0_correct@@9  (=> (= (ControlFlow 0 350228) 256680) inline$$InitEventStore$0$anon0_correct@@9)))
anon0_correct@@9)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
