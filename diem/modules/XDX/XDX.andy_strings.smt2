...
(let ((anon33_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 168086) (- 0 229553)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 168086) (- 0 229565)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 168086) (- 0 229583)) (not (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 173345816))) (and (=> (= (ControlFlow 0 168086) (- 0 229597)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816)) (and (=> (= (ControlFlow 0 168086) (- 0 229607)) (not (or (= 1000000 0) (> 1000000 10000000000)))) (=> (not (or (= 1000000 0) (> 1000000 10000000000))) (and (=> (= (ControlFlow 0 168086) (- 0 229626)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (and (=> (= (ControlFlow 0 168086) (- 0 229637)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0))) (and (=> (= (ControlFlow 0 168086) (- 0 229649)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) 0))) (and (=> (= (ControlFlow 0 168086) (- 0 229667)) (not (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 173345816))) (and (=> (= (ControlFlow 0 168086) (- 0 229681)) (not (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 173345816))) (and (=> (= (ControlFlow 0 168086) (- 0 229695)) (not (exists ((i@@44 Int) ) (!  (and (and (|$IsValid'u64'| i@@44) (and (>= i@@44 0) (< i@@44 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@0 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@1)))) i@@45) (seq.++ (seq.++ (seq.unit 88) (seq.unit 68)) (seq.unit 88))))
 :qid |XDXandybpl.2035:13|
 :skolemid |57|
))) (and (=> (= (ControlFlow 0 168086) (- 0 229715)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@0)))) (and (=> (= (ControlFlow 0 168086) (- 0 229728)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 168086) (- 0 229740)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t8) 18446744073709551615)) (< $t9@@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t8) 18446744073709551615)) (< $t9@@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (and (=> (= (ControlFlow 0 168086) (- 0 229782)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (and (=> (= (ControlFlow 0 168086) (- 0 229793)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 168086) (- 0 229803)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0))) (and (=> (= (ControlFlow 0 168086) (- 0 229815)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) 0))) (and (=> (= (ControlFlow 0 168086) (- 0 229833)) (not (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 173345816))) (and (=> (= (ControlFlow 0 168086) (- 0 229847)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0))) (and (=> (= (ControlFlow 0 168086) (- 0 229859)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) 1))) (and (=> (= (ControlFlow 0 168086) (- 0 229877)) (not (not (= (|$addr#$signer| _$t1@@0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t1@@0) 186537453))) (and (=> (= (ControlFlow 0 168086) (- 0 229891)) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816) (and (=> (= (ControlFlow 0 168086) (- 0 229897)) (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816)) 0)) (=> (= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816)) 0) (and (=> (= (ControlFlow 0 168086) (- 0 229909)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816)) false)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5|) 173345816)) false) (and (=> (= (ControlFlow 0 168086) (- 0 229921)) (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@0)) (=> (= (ControlFlow 0 168086) (- 0 229930)) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory@1) 173345816)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 160973) (- 0 228910)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0@@0) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816)) (or (= 1000000 0) (> 1000000 10000000000))) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) 0))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (exists ((i@@46 Int) ) (!  (and (and (|$IsValid'u64'| i@@46) (and (>= i@@46 0) (< i@@46 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@2 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@2)))) i@@46) (seq.++ (seq.++ (seq.unit 88) (seq.unit 68)) (seq.unit 88))))
 :qid |XDXandybpl.2035:13|
 :skolemid |57|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t8) 18446744073709551615)) (< $t9@@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) 0))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= (|$addr#$signer| _$t0@@0) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816)) (or (= 1000000 0) (> 1000000 10000000000))) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) 0))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (exists ((i@@47 Int) ) (!  (and (and (|$IsValid'u64'| i@@47) (and (>= i@@47 0) (< i@@47 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@3 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@3)))) i@@47) (seq.++ (seq.++ (seq.unit 88) (seq.unit 68)) (seq.unit 88))))
 :qid |XDXandybpl.2035:13|
 :skolemid |57|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t8) 18446744073709551615)) (< $t9@@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) 0))) (not (= (|$addr#$signer| _$t0@@0) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) 1))) (not (= (|$addr#$signer| _$t1@@0) 186537453))) (=> (= (ControlFlow 0 160973) (- 0 229156)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t13@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816) (= 6 $t13@0))) (and (or (= 1000000 0) (> 1000000 10000000000)) (= 7 $t13@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0)) (= 6 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t7@@0)) 0)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t13@0))) (and (exists ((i@@48 Int) ) (!  (and (and (|$IsValid'u64'| i@@48) (and (>= i@@48 0) (< i@@48 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@4 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@4)))) i@@48) (seq.++ (seq.++ (seq.unit 88) (seq.unit 68)) (seq.unit 88))))
 :qid |XDXandybpl.2035:13|
 :skolemid |57|
)) (= 7 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@0))) (= 4 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 $t13@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t8) 18446744073709551615)) (< $t9@@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8))) (= 1 $t13@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0)) (= 6 $t13@0))) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t10@@0)) 0)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $t11@@0)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 $t13@0))))))))
...
(let ((anon32_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 168150) 168152)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) (|$addr#$signer| _$t0@@0))) (=> (and (and (= $1_XDX_Reserve_$memory@0 ($Memory_101626 (|Store__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_XDX_Reserve_| (|contents#$Memory_101626| $1_XDX_Reserve_$memory) (|$addr#$signer| _$t0@@0) $t43@0))) (= $1_XDX_Reserve_$memory@1 $1_XDX_Reserve_$memory@0)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 167688) 168100) anon33_Then_correct) (=> (= (ControlFlow 0 167688) 168086) anon33_Else_correct))))))
...
(let ((|inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$anon7_Then_correct|  (=> |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t3@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t2@0|)) (= 5 |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t2@0|)) 1)) (= 3 |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0|))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0|))) (= |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0| |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@1| |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$$t4@0|) (= (ControlFlow 0 167630) 167532))) |inline$$1_Diem_create_preburn'$1_XDX_XDX'$0$L2_correct|))))
...
(let ((|inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$anon10_Then_correct|  (=> |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t5@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t4@0|)) (= 5 |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t4@0|)) 1)) (= 3 |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0|))) (and (not (= (|$addr#$signer| _$t1@@0) 186537453)) (= 2 |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0|))) (= |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0| |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0|)) (and (= |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@1| |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$$t6@0|) (= (ControlFlow 0 166164) 166014))) |inline$$1_Diem_update_minting_ability'$1_XDX_XDX'$0$L2_correct|))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2|) addr@@5))) inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_104108| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_104108| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $abort_flag@1 $abort_flag@0@@0) (= $abort_code@2 $abort_code@1@@0))) (and (=> (= (ControlFlow 0 164667) 164911) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 164667) 164897) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon42_Else_correct|))))))
...
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@0) (= (ControlFlow 0 164803) 164404))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
...
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct  (=> (and (not $abort_flag@0@@0) (= (ControlFlow 0 164348) 164342)) inline$$Not$2$anon0_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@0) (= (ControlFlow 0 164817) 164404))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
...
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon40_Then$1_correct|  (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 164977) 164925) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 164977) 164849) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon41_Else_correct|))))))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon40_Then_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 164975) 164977)) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon40_Then$1_correct|)))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon40_Else_correct|  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0))) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_101710 (|Store__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@0) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t38@1|))) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 163342) 164925) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 163342) 164849) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon41_Else_correct|))))))
...
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon33_Then_correct|  (=> inline$$Lt$0$dst@1@@0 (=> (and (|$IsValid'u64'| 10000000000) (= (ControlFlow 0 165103) 165097)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon33_Else_correct|  (=> (and (and (not inline$$Lt$0$dst@1@@0) (= false false)) (and (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t10@1| false) (= (ControlFlow 0 162806) 162836))) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$L5_correct|)))
(let ((inline$$Lt$0$anon0_correct@@0  (=> (= inline$$Lt$0$dst@1@@0 (< 0 1000000)) (and (=> (= (ControlFlow 0 162778) 165103) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon33_Then_correct|) (=> (= (ControlFlow 0 162778) 162806) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon33_Else_correct|)))))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon32_Then_correct|  (=> inline$$Not$1$dst@1 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 162784) 162778)) inline$$Lt$0$anon0_correct@@0))))
...
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon30_Else_correct|  (=> (and (not |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t15@0|) (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t17@0|  (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (and (=> (= (ControlFlow 0 162610) 165143) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 162610) 162672) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon31_Else_correct|)))))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon30_Then_correct|  (=> (and |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t15@0| (or (or (or (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t14@0|)) (= 5 |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t14@0|)) 0)) (= 3 |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|))) (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|)))) (=> (and (and (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0| |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|) (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@1| |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t16@0|)) (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 165235) 162728))) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$L9_correct|))))
(let ((|inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t11@0| (|$addr#$signer| _$t0@@0)) (=> (and (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t12@0| (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_104108| $1_DiemConfig_Configuration_$memory) 173345816)) (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t13@0| (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (and (and (and (= _$t0@@0 _$t0@@0) (= $t28 $t28)) (and (= true true) (= 1000000 1000000))) (and (and (= 1000 1000) (= $t33@0 $t33@0)) (and (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t14@0| (|$addr#$signer| _$t0@@0)) (= |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t15@0|  (or (or (or (not (= (|$addr#$signer| _$t0@@0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t14@0|))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$$t14@0|)) 0))) (not (= (|$addr#$signer| _$t0@@0) 173345816))))))) (and (=> (= (ControlFlow 0 162588) 165235) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon30_Then_correct|) (=> (= (ControlFlow 0 162588) 162610) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon30_Else_correct|)))))))
(let ((anon27_Else_correct  (=> (not $t29) (=> (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t28) (= $t28 (ite (= 1 1) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2)))) (=> (and (and (and (|$IsValid'u64'| 1000000) (|$IsValid'u64'| 1000)) (and (= $t33@0 (seq.++ (seq.++ (seq.unit 88) (seq.unit 68)) (seq.unit 88))) (|$IsValid'vec'u8''| $t33@0))) (and (and (= $t34 (|$addr#$signer| _$t0@@0)) (= $t35 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_104108| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t36 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= (ControlFlow 0 165243) 162588)))) |inline$$1_Diem_register_currency'$1_XDX_XDX'$0$anon0_correct|)))))
(let ((anon27_Then_correct  (=> $t29 (=> (and (and (or (or (and (= $t26 0) (= 7 $t13)) (and (and (= $t27 0) (not (= $t25@@0 0))) (= 7 $t13))) (and (> $t27 18446744073709551615) (= 8 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 168276) 160973))) L3_correct))))
(let ((anon26_Then_correct@@0  (=> (and inline$$Not$0$dst@1 (|$IsValid'u64'| 1)) (=> (and (and (and (|$IsValid'u64'| 1) (= $t22 ($shl 1 64))) (and (= $t23@@0 ($shl 1 32)) (= $t24@@0 (div $t22 $t23@@0)))) (and (and (= $t25@@0 ($shl 1 64)) (= $t26 ($shl 1 32))) (and (= $t27 (div $t25@@0 $t26)) (= $t29  (or (or (= $t26 0) (and (= $t27 0) (not (= $t25@@0 0)))) (> $t27 18446744073709551615)))))) (and (=> (= (ControlFlow 0 161101) 168276) anon27_Then_correct) (=> (= (ControlFlow 0 161101) 165243) anon27_Else_correct))))))
(let ((anon26_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1) (= $t19 $t19)) (and (= $t13@0 $t19) (= (ControlFlow 0 160265) 160973))) L3_correct)))
(let ((anon25_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 6)) (and (= $t19 $t19) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 160249) 161101) anon26_Then_correct@@0) (=> (= (ControlFlow 0 160249) 160265) anon26_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t16@0)) (= (ControlFlow 0 160213) 160249)) anon25_Else$1_correct)))
(let ((anon25_Else_correct@@0  (=> (and (and (not $t14@@0) (|$IsValid'address'| 173345816)) (and (= $t16@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101626| $1_XDX_Reserve_$memory) 173345816)) (= (ControlFlow 0 160219) 160213))) inline$$Not$0$anon0_correct)))
(let ((anon25_Then_correct@@0  (=> $t14@@0 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@0) 173345816)) (= 2 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 168306) 160973))) L3_correct))))
(let ((anon24_Else_correct@@0  (=> (and (not $t12@@0) (= $t14@@0  (not (= (|$addr#$signer| _$t0@@0) 173345816)))) (and (=> (= (ControlFlow 0 160163) 168306) anon25_Then_correct@@0) (=> (= (ControlFlow 0 160163) 160219) anon25_Else_correct@@0)))))
(let ((anon24_Then_correct@@0  (=> $t12@@0 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 168332) 160973))) L3_correct))))
(let ((anon0$1_correct@@0  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_104108| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (and (and (and (and (and (and (and (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_103637| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 ...
 :qid |XDXandybpl.9845:20|
 :skolemid |192|
)) (|$IsValid'address'| (|$addr#$signer| _$t0@@0))) (and (|$IsValid'address'| (|$addr#$signer| _$t1@@0)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@0))
 :qid |XDXandybpl.9854:20|
 :skolemid |193|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@0))
))))) (and (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $a_0@@1)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@1))
 :qid |XDXandybpl.9858:20|
 :skolemid |194|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_102208| $1_Roles_RoleId_$memory) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_104108| $1_DiemConfig_Configuration_$memory) $a_0@@2)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@2))
 :qid |XDXandybpl.9862:20|
 :skolemid |195|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_104108| $1_DiemConfig_Configuration_$memory) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@3)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@3))
 :qid |XDXandybpl.9866:20|
 :skolemid |196|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_104042| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@4)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@4))
 :qid |XDXandybpl.9870:20|
 :skolemid |197|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_103718| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@4))
)))) (and (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@5)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@5))
 :qid |XDXandybpl.9874:20|
 :skolemid |198|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_105003| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@5))
)) (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@6)))
 ...
 :qid |XDXandybpl.9878:20|
 :skolemid |199|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@6))
))) (and (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@7)))
 ...
 :qid |XDXandybpl.9882:20|
 :skolemid |200|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_101794| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@7))
)) (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_XDX_Reserve_| (|contents#$Memory_101626| $1_XDX_Reserve_$memory) $a_0@@8)))
(|$IsValid'$1_XDX_Reserve'| $rsc@@8))
 :qid |XDXandybpl.9886:20|
 :skolemid |201|
 :pattern ( (|Select__T@[Int]$1_XDX_Reserve_| (|contents#$Memory_101626| $1_XDX_Reserve_$memory) $a_0@@8))
))))) (and (and (and (= $t7@@0 (|$addr#$signer| _$t0@@0)) (= $t8 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_104108| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t9@@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t10@@0 (|$addr#$signer| _$t0@@0)))) (and (and (= $t11@@0 (|$addr#$signer| _$t1@@0)) (= _$t0@@0 _$t0@@0)) (and (= _$t1@@0 _$t1@@0) (= $t12@@0  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))))) (and (=> (= (ControlFlow 0 160141) 168332) anon24_Then_correct@@0) (=> (= (ControlFlow 0 160141) 160163) anon24_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_68951_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_68951| stream@@1) 0) (forall ((v@@39 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_68951| stream@@1) v@@39) 0)
 :qid |XDXandybpl.129:13|
 :skolemid |2|
))))
 :qid |XDXandybpl.2723:13|
 :skolemid |74|
))) (= (ControlFlow 0 159199) 160141)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 223669) 159199) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
...
(assert (not
 (=> (= (ControlFlow 0 0) 229948) (let ((L5_correct@@0  (and (=> (= (ControlFlow 0 169711) (- 0 230508)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 169711) (- 0 230518)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 169671) 169711))) L5_correct@@0))))
(let ((anon13_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 169737) 169711))) L5_correct@@0))))
(let ((L3_correct@@0  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 169569) (- 0 230465)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 169569) (- 0 230480)) (= $t0@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (|$IsValid'vec'u8''| $t5) (= $t5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (= $t3 $t5)) (= $t7@0 $t7@0)) (and (= $t0@0 $t7@0) (= (ControlFlow 0 169645) 169569))) L3_correct@@0)))))
(let ((anon13_Else_correct  (=> (and (and (not $t4) (|$IsValid'vec'u8''| $t3)) (and (= $t3 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 169611) 169671) anon14_Then_correct) (=> (= (ControlFlow 0 169611) 169645) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and |inline$$1_Diem_is_currency'#0'$0$$t1@1| (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 169583) 169737) anon13_Then_correct) (=> (= (ControlFlow 0 169583) 169611) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 169529) 169569))) L3_correct@@0)))
(let ((anon11_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 169509) 169583) anon12_Then_correct) (=> (= (ControlFlow 0 169509) 169529) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 169495) 169751) anon11_Then_correct) (=> (= (ControlFlow 0 169495) 169509) anon11_Else_correct))))))
(let ((anon0$1_correct@@1  (=> (and (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114818| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10436:22|
 :skolemid |202|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114909| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10436:222|
 :skolemid |203|
))) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115000| |$1_Diem_Preburn'#0'_$memory|) addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10436:423|
 :skolemid |204|
))) (=> (and (and (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115227| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10440:22|
 :skolemid |205|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115326| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10440:227|
 :skolemid |206|
))) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115425| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10440:433|
 :skolemid |207|
))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9)))
 ...
 :qid |XDXandybpl.10448:20|
 :skolemid |208|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9))
))) (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@10)))
 ...
 :qid |XDXandybpl.10452:20|
 :skolemid |209|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@10))
)) (= (ControlFlow 0 169501) 169495)))) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_68951_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_68951| stream@@2) 0) (forall ((v@@40 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_68951| stream@@2) v@@40) 0)
 :qid |XDXandybpl.129:13|
 :skolemid |2|
))))
 :qid |XDXandybpl.2723:13|
 :skolemid |74|
))) (= (ControlFlow 0 169162) 169501)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 229948) 169162) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1)))))))))))))))
))
(check-sat)
(pop 1)
...
(assert (not
 (=> (= (ControlFlow 0 0) 230549) (let ((L5_correct@@1  (and (=> (= (ControlFlow 0 170407) (- 0 231109)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 170407) (- 0 231119)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0@@0)))))))
(let ((anon14_Then_correct@@0  (=> $t6@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@0)) (= $t2@@0 $t2@@0)) (and (= $t2@0@@0 $t2@@0) (= (ControlFlow 0 170367) 170407))) L5_correct@@1))))
(let ((anon13_Then_correct@@0  (=> $t4@@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t2@@0)) (= $t2@@0 $t2@@0)) (and (= $t2@0@@0 $t2@@0) (= (ControlFlow 0 170433) 170407))) L5_correct@@1))))
(let ((L3_correct@@1  (=> (= $t0@0@@0 $t0@0@@0) (and (=> (= (ControlFlow 0 170265) (- 0 231066)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 170265) (- 0 231081)) (= $t0@0@@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct@@0  (=> (not $t6@@0) (=> (and (|$IsValid'vec'u8''| $t5@@0) (= $t5@@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0@@0 (= $t3@@0 $t5@@0)) (= $t7@0@@0 $t7@0@@0)) (and (= $t0@0@@0 $t7@0@@0) (= (ControlFlow 0 170341) 170265))) L3_correct@@1)))))
(let ((anon13_Else_correct@@0  (=> (and (and (not $t4@@0) (|$IsValid'vec'u8''| $t3@@0)) (and (= $t3@@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t6@@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 170307) 170367) anon14_Then_correct@@0) (=> (= (ControlFlow 0 170307) 170341) anon14_Else_correct@@0)))))
(let ((anon12_Then_correct@@0  (=> (and |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (= $t4@@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 170279) 170433) anon13_Then_correct@@0) (=> (= (ControlFlow 0 170279) 170307) anon13_Else_correct@@0)))))
(let ((anon12_Else_correct@@0  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|) (= false false)) (and (= $t0@0@@0 false) (= (ControlFlow 0 170225) 170265))) L3_correct@@1)))
(let ((anon11_Else_correct@@0  (=> (not false) (and (=> (= (ControlFlow 0 170205) 170279) anon12_Then_correct@@0) (=> (= (ControlFlow 0 170205) 170225) anon12_Else_correct@@0)))))
(let ((anon11_Then_correct@@0 true))
(let ((|inline$$1_Diem_is_currency'$1_XUS_XUS'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 170191) 170447) anon11_Then_correct@@0) (=> (= (ControlFlow 0 170191) 170205) anon11_Else_correct@@0))))))
(let ((anon0$1_correct@@2  (=> (and (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114818| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10656:22|
 :skolemid |210|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114909| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@21) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10656:222|
 :skolemid |211|
))) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115000| |$1_Diem_Preburn'#0'_$memory|) addr@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10656:423|
 :skolemid |212|
))) (=> (and (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115227| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@23) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10660:22|
 :skolemid |213|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115326| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@24) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10660:227|
 :skolemid |214|
))) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115425| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@25) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10660:433|
 :skolemid |215|
))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@11)))
 ...
 :qid |XDXandybpl.10668:20|
 :skolemid |216|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@11))
))) (and (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@12)))
 ...
 :qid |XDXandybpl.10672:20|
 :skolemid |217|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@12))
)) (= (ControlFlow 0 170197) 170191)))) |inline$$1_Diem_is_currency'$1_XUS_XUS'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_68951_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_68951| stream@@3) 0) (forall ((v@@41 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_68951| stream@@3) v@@41) 0)
 :qid |XDXandybpl.129:13|
 :skolemid |2|
))))
 :qid |XDXandybpl.2723:13|
 :skolemid |74|
))) (= (ControlFlow 0 169858) 170197)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 230549) 169858) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2)))))))))))))))
))
(check-sat)
(pop 1)
...
(assert (not
 (=> (= (ControlFlow 0 0) 231150) (let ((L5_correct@@2  (and (=> (= (ControlFlow 0 171103) (- 0 231710)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 171103) (- 0 231720)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0@@1)))))))
(let ((anon14_Then_correct@@1  (=> $t6@@1 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@1)) (= $t2@@1 $t2@@1)) (and (= $t2@0@@1 $t2@@1) (= (ControlFlow 0 171063) 171103))) L5_correct@@2))))
(let ((anon13_Then_correct@@1  (=> $t4@@1 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@1)) (= $t2@@1 $t2@@1)) (and (= $t2@0@@1 $t2@@1) (= (ControlFlow 0 171129) 171103))) L5_correct@@2))))
(let ((L3_correct@@2  (=> (= $t0@0@@1 $t0@0@@1) (and (=> (= (ControlFlow 0 170961) (- 0 231667)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 170961) (- 0 231682)) (= $t0@0@@1  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct@@1  (=> (not $t6@@1) (=> (and (|$IsValid'vec'u8''| $t5@@1) (= $t5@@1 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0@@1 (= $t3@@1 $t5@@1)) (= $t7@0@@1 $t7@0@@1)) (and (= $t0@0@@1 $t7@0@@1) (= (ControlFlow 0 171037) 170961))) L3_correct@@2)))))
(let ((anon13_Else_correct@@1  (=> (and (and (not $t4@@1) (|$IsValid'vec'u8''| $t3@@1)) (and (= $t3@@1 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t6@@1  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 171003) 171063) anon14_Then_correct@@1) (=> (= (ControlFlow 0 171003) 171037) anon14_Else_correct@@1)))))
(let ((anon12_Then_correct@@1  (=> (and |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (= $t4@@1  (not (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 170975) 171129) anon13_Then_correct@@1) (=> (= (ControlFlow 0 170975) 171003) anon13_Else_correct@@1)))))
(let ((anon12_Else_correct@@1  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= false false)) (and (= $t0@0@@1 false) (= (ControlFlow 0 170921) 170961))) L3_correct@@2)))
(let ((anon11_Else_correct@@1  (=> (not false) (and (=> (= (ControlFlow 0 170901) 170975) anon12_Then_correct@@1) (=> (= (ControlFlow 0 170901) 170921) anon12_Else_correct@@1)))))
(let ((anon11_Then_correct@@1 true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 170887) 171143) anon11_Then_correct@@1) (=> (= (ControlFlow 0 170887) 170901) anon11_Else_correct@@1))))))
(let ((anon0$1_correct@@3  (=> (and (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114818| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@26) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10876:22|
 :skolemid |218|
)) (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_114909| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10876:222|
 :skolemid |219|
))) (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115000| |$1_Diem_Preburn'#0'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10876:423|
 :skolemid |220|
))) (=> (and (and (and (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115227| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_109261| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXandybpl.10880:22|
 :skolemid |221|
)) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115326| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@30) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXandybpl.10880:227|
 :skolemid |222|
))) (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115425| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@31) (|Select__T@[Int]Bool_| (|domain#$Memory_109467| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXandybpl.10880:433|
 :skolemid |223|
))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100182| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@13 Int) ) (! (let (($rsc@@13 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@13)))
 ...
 :qid |XDXandybpl.10888:20|
 :skolemid |224|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@13))
))) (and (forall (($a_0@@14 Int) ) (! (let (($rsc@@14 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@14)))
 ...
 :qid |XDXandybpl.10892:20|
 :skolemid |225|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_101710| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@14))
)) (= (ControlFlow 0 170893) 170887)))) |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_68951_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_68951| stream@@4) 0) (forall ((v@@42 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_68951| stream@@4) v@@42) 0)
 :qid |XDXandybpl.129:13|
 :skolemid |2|
))))
 :qid |XDXandybpl.2723:13|
 :skolemid |74|
))) (= (ControlFlow 0 170554) 170893)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 231150) 170554) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3)))))))))))))))
))
(check-sat)
(pop 1)
