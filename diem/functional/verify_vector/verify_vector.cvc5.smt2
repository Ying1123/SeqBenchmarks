...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |verifyvectorcvc5bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |verifyvectorcvc5bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |verifyvectorcvc5bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |verifyvectorcvc5bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |verifyvectorcvc5bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |verifyvectorcvc5bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |verifyvectorcvc5bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |verifyvectorcvc5bpl.461:15|
 :skolemid |14|
 :pattern ( ($shr src1@@0 p@@0))
)))
(assert (forall ((v@@4 (Seq |T@#0|)) ) (! (= (|$IsValid'vec'#0''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) true)
 :qid |verifyvectorcvc5bpl.590:13|
 :skolemid |15|
))))
 :qid |verifyvectorcvc5bpl.588:28|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'#0''| v@@4))
)))
(assert (forall ((v@@5 (Seq |T@#0|)) (e |T@#0|) ) (! (let ((i@@1 (|$IndexOfVec'#0'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |verifyvectorcvc5bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |verifyvectorcvc5bpl.603:17|
 :skolemid |18|
)))))
 :qid |verifyvectorcvc5bpl.599:15|
 :skolemid |19|
...
(assert (forall ((v@@8 (Seq |T@#0|)) ) (! (let ((r@@0 (ReverseVec_14687 v@@8)))
 ...
 :qid |verifyvectorcvc5bpl.67:18|
 :skolemid |0|
 :pattern ( (seq.nth r@@0 i@@6))
))))
 :qid |verifyvectorcvc5bpl.64:32|
 :skolemid |1|
...
(assert (forall ((|l#0| Bool) (i@@8 Int) ) (! (= (|Select__T@[Int]Bool_| (|lambda#0| |l#0|) i@@8) |l#0|)
 :qid |verifyvectorcvc5bpl.245:54|
 :skolemid |68|
...
(= (seq.nth (|v#$Mutation_18392| |inline$$1_Vector_push_back'#0'$0$m'@1|) k) (seq.nth $t15@0 k))))
 :qid |verifyvectorcvc5bpl.1392:57|
 :skolemid |35|
...
(= (seq.nth (|v#$Mutation_18392| |inline$$1_Vector_pop_back'#0'$0$m'@2|) k@@1) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@1)))))
 :qid |verifyvectorcvc5bpl.1398:71|
 :skolemid |36|
...
(= (seq.nth (|v#$Mutation_18392| |inline$$1_Vector_push_back'#0'$0$m'@1|) k@@3) (seq.nth _$t1 (- k@@3 (seq.len $t16@0))))))
 :qid |verifyvectorcvc5bpl.1404:81|
 :skolemid |37|
)))))))))))))))))
...
(= (seq.nth (|v#$Mutation_18392| _$t0) k@@4) (seq.nth $t11@0 k@@4))))
 :qid |verifyvectorcvc5bpl.1218:57|
 :skolemid |29|
...
(= (seq.nth (|v#$Mutation_18392| |inline$$1_Vector_reverse'#0'$0$m'@1|) k@@6) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@6)))))
 :qid |verifyvectorcvc5bpl.1224:71|
 :skolemid |30|
...
(= (seq.nth (|v#$Mutation_18392| _$t0) k@@8) (seq.nth _$t1 (- k@@8 (seq.len $t12@0))))))
 :qid |verifyvectorcvc5bpl.1230:81|
 :skolemid |31|
...
(= (seq.nth (|v#$Mutation_18392| $t0@0) k@@10) (seq.nth $t7@0 k@@10))))
 :qid |verifyvectorcvc5bpl.1276:61|
 :skolemid |32|
...
(= (seq.nth (|v#$Mutation_18392| $t17@1) k@@11) (seq.nth _$t1 (- (- (seq.len _$t1) 1) k@@11)))))
 :qid |verifyvectorcvc5bpl.1281:76|
 :skolemid |33|
...
(= (seq.nth (|v#$Mutation_18392| $t0@0) k@@12) (seq.nth _$t1 (- k@@12 (seq.len $t8@0))))))
 :qid |verifyvectorcvc5bpl.1286:85|
 :skolemid |34|
