...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10510) (let ((anon7_Else_correct  (=> (not false) (=> (and (= call1formal@res@0 call1formal@res@0) (= call1formal@res@0@@0 call1formal@res@0@@0)) (and (=> (= (ControlFlow 0 10144) (- 0 10694)) (= (seq.len (|$1_BCS_serialize'#0'| _$t0)) (seq.len (|$1_BCS_serialize'#0'| _$t1)))) (=> (= (seq.len (|$1_BCS_serialize'#0'| _$t0)) (seq.len (|$1_BCS_serialize'#0'| _$t1))) (=> (= (ControlFlow 0 10144) (- 0 10709)) (= (seq.len call1formal@res@0) (seq.len call1formal@res@0@@0)))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (not false) (= call1formal@res@0@@0 (|$1_BCS_serialize'#0'| _$t1))) (and (=> (= (ControlFlow 0 10092) 10158) anon7_Then_correct) (=> (= (ControlFlow 0 10092) 10144) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0$1_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= call1formal@res@0 (|$1_BCS_serialize'#0'| _$t0))) (and (=> (= (ControlFlow 0 10086) 10178) anon6_Then_correct) (=> (= (ControlFlow 0 10086) 10092) anon6_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10510) 10086) anon0$1_correct)))
anon0_correct)))))))
))
(check-sat)
