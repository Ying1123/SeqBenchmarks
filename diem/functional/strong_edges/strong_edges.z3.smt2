...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |strongedgesz3bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |strongedgesz3bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |strongedgesz3bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |strongedgesz3bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |strongedgesz3bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |strongedgesz3bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |strongedgesz3bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |strongedgesz3bpl.461:15|
 :skolemid |14|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11038) (let ((anon8_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 10570) (- 0 11270)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory@1) addr@@0) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory@1) addr@@0)) 0)))
 :qid |strongedgesz3bpl.1087:15|
 :skolemid |32|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory@1) addr@@1) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory@1) addr@@1)) 0)))
 :qid |strongedgesz3bpl.1087:15|
 :skolemid |32|
)) (and (=> (= (ControlFlow 0 10570) (- 0 11303)) (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory@1) $t2)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory@1) $t2) (=> (= (ControlFlow 0 10570) (- 0 11311)) (= (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory@1) $t2)) _$t1)))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then$1_correct  (=> (= $42_TestModule_R_$memory@1 $42_TestModule_R_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 10640) 10588) anon8_Then_correct) (=> (= (ControlFlow 0 10640) 10570) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 10638) 10640)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $42_TestModule_R_$memory@0 ($Memory_8994 (|Store__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory) (|$addr#$signer| _$t0) $t3@0))) (= $42_TestModule_R_$memory@1 $42_TestModule_R_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 10507) 10588) anon8_Then_correct) (=> (= (ControlFlow 0 10507) 10570) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8994| $42_TestModule_R_$memory) addr@@2) (> (|$value#$42_TestModule_R| (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory) addr@@2)) 0)))
 :qid |strongedgesz3bpl.1043:20|
 :skolemid |30|
)) (|$IsValid'address'| (|$addr#$signer| _$t0))) (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory) $a_0)))
(|$IsValid'$42_TestModule_R'| $rsc))
 :qid |strongedgesz3bpl.1052:20|
 :skolemid |31|
 :pattern ( (|Select__T@[Int]$42_TestModule_R_| (|contents#$Memory_8994| $42_TestModule_R_$memory) $a_0))
)))) (and (and (= $t2 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t3@0 ($42_TestModule_R _$t1))))) (and (=> (= (ControlFlow 0 10485) 10638) anon7_Then_correct) (=> (= (ControlFlow 0 10485) 10507) anon7_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 11038) 10485) anon0$1_correct)))
anon0_correct))))))))
))
(check-sat)
