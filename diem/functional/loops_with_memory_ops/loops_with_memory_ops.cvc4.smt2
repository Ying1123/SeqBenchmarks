...
(assert (forall ((k1 (Seq Int)) (k2 (Seq Int)) ) (!  (=> (= k1 k2) (= ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2)))
 :qid |loopswithmemoryopscvc4bpl.1039:15|
 :skolemid |27|
 :pattern ( ($1_Signature_$ed25519_validate_pubkey k1) ($1_Signature_$ed25519_validate_pubkey k2))
)))
(assert (forall ((s1 (Seq Int)) (s2 (Seq Int)) (k1@@0 (Seq Int)) (k2@@0 (Seq Int)) (m1 (Seq Int)) (m2 (Seq Int)) ) (!  (=> (and (and (= s1 s2) (= k1@@0 k2@@0)) (= m1 m2)) (= ($1_Signature_$ed25519_verify s1 k1@@0 m1) ($1_Signature_$ed25519_verify s2 k2@@0 m2)))
 :qid |loopswithmemoryopscvc4bpl.1042:15|
 :skolemid |28|
...
(= (seq.nth (|v#$Mutation_11096| $t0@1) n) (seq.nth (|v#$Mutation_11096| $t1@1) n))))
 :qid |loopswithmemoryopscvc4bpl.1594:48|
 :skolemid |32|
))))))))))))))
...
(= (seq.nth (|v#$Mutation_11096| $t0@0) m) (seq.nth (|v#$Mutation_11096| $t1@0) m))))
 :qid |loopswithmemoryopscvc4bpl.1540:48|
 :skolemid |31|
...
(= (seq.nth (|v#$Mutation_11096| _$t0) n@@0) (seq.nth (|v#$Mutation_11096| _$t1) n@@0))))
 :qid |loopswithmemoryopscvc4bpl.1193:48|
 :skolemid |29|
...
(= (seq.nth (|v#$Mutation_11096| $t0@0) n@@2) (seq.nth (|v#$Mutation_11096| $t1@0) n@@2))))
 :qid |loopswithmemoryopscvc4bpl.1283:53|
 :skolemid |30|
