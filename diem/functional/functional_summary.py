...
TIME_LIMIT = 20
COLUMN_NAME = ["Benchmark", "z3", "cvc4", "cvc5", "andy_default", "andy_strings", "seqArray"]
SPECIAL_MAPPING = {
}

# Set the directory you want to start from
rootDir = '/home/ying/diem/old_seq_benchmarks/functional'
print(rootDir)
...
with open('functional_result.csv', mode='w') as result_file:
