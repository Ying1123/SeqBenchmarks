...
(get-value ((ControlFlow 0 42002)))
(get-value ((ControlFlow 0 38643)))
(get-value ((ControlFlow 0 38770)))
(get-value ((ControlFlow 0 38764)))
(get-value ((ControlFlow 0 38856)))
(assert (not (= (ControlFlow 0 38856) (- 42186))))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 42002)))
...
(get-value ((ControlFlow 0 38764)))
(get-value ((ControlFlow 0 38856)))
(assert (not (= (ControlFlow 0 38856) (- 42214))))
(check-sat)
(pop 1)
; Invalid
(push 1)
