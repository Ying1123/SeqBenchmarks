...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |existsinvectorcvc5bpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |existsinvectorcvc5bpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |existsinvectorcvc5bpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |existsinvectorcvc5bpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |existsinvectorcvc5bpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |existsinvectorcvc5bpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorcvc5bpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorcvc5bpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq Int)) ) (! (= (|$IsValid'vec'u64''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'u64'| (seq.nth v@@4 i@@0)))
 :qid |existsinvectorcvc5bpl.590:13|
 :skolemid |15|
))))
 :qid |existsinvectorcvc5bpl.588:29|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'u64''| v@@4))
)))
(assert (forall ((v@@5 (Seq Int)) (e Int) ) (! (let ((i@@1 (|$IndexOfVec'u64'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |existsinvectorcvc5bpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |existsinvectorcvc5bpl.603:17|
 :skolemid |18|
)))))
 :qid |existsinvectorcvc5bpl.599:15|
 :skolemid |19|
...
(assert (not
 ...
 :qid |existsinvectorcvc5bpl.1133:15|
 :skolemid |32|
 ...
 :qid |existsinvectorcvc5bpl.1138:15|
 :skolemid |33|
...
(= x 0)))
 :qid |existsinvectorcvc5bpl.1082:33|
 :skolemid |29|
))) (let (($range_0@@0 _$t0))
...
(= (seq.nth _$t0 i@@8) 0)))
 :qid |existsinvectorcvc5bpl.1088:52|
 :skolemid |30|
...
(= (seq.nth _$t0 i@@11) 0)))
 ...
 :qid |existsinvectorcvc5bpl.1094:13|
 :skolemid |31|
...
(= x@@4 e@@1)))
 ...
 :qid |existsinvectorcvc5bpl.1158:15|
 :skolemid |34|
...
(= (seq.nth _$t0 i@@17) e@@3)))
 ...
 :qid |existsinvectorcvc5bpl.1163:15|
 :skolemid |35|
...
(= (seq.nth _$t0 i@@19) e@@4)))
 ...
 :qid |existsinvectorcvc5bpl.1168:15|
 :skolemid |36|
))))))))))))))))))))))))
...
(assert (not
 ...
 :qid |existsinvectorcvc5bpl.1221:15|
 :skolemid |37|
 ...
 :qid |existsinvectorcvc5bpl.1226:15|
 :skolemid |38|
 ...
 :qid |existsinvectorcvc5bpl.1231:15|
 :skolemid |39|
...
(= x@@12 e@@6)))
 ...
 :qid |existsinvectorcvc5bpl.1251:15|
 :skolemid |40|
...
(= (seq.nth (|v#$Mutation_8552| _$t0@@0) i@@31) e@@8)))
 ...
 :qid |existsinvectorcvc5bpl.1256:15|
 :skolemid |41|
...
(= (seq.nth (|v#$Mutation_8552| _$t0@@0) i@@33) e@@9)))
 ...
 :qid |existsinvectorcvc5bpl.1261:15|
 :skolemid |42|
))))))))))))))))))))))))))))
