...
(assert (forall ((v Int) ) (! (= (|$IsValid'u8'| v)  (and (>= v 0) (<= v $MAX_U8)))
 :qid |existsinvectorseqArraybpl.160:23|
 :skolemid |4|
 :pattern ( (|$IsValid'u8'| v))
)))
(assert (forall ((v@@0 Int) ) (! (= (|$IsValid'u64'| v@@0)  (and (>= v@@0 0) (<= v@@0 $MAX_U64)))
 :qid |existsinvectorseqArraybpl.164:24|
 :skolemid |5|
 :pattern ( (|$IsValid'u64'| v@@0))
)))
(assert (forall ((v@@1 Int) ) (! (= (|$IsValid'u128'| v@@1)  (and (>= v@@1 0) (<= v@@1 $MAX_U128)))
 :qid |existsinvectorseqArraybpl.168:25|
 :skolemid |6|
 :pattern ( (|$IsValid'u128'| v@@1))
)))
(assert (forall ((v@@2 Int) ) (! (= (|$IsValid'num'| v@@2) true)
 :qid |existsinvectorseqArraybpl.172:24|
 :skolemid |7|
 :pattern ( (|$IsValid'num'| v@@2))
)))
(assert (forall ((v@@3 Int) ) (! (= (|$IsValid'address'| v@@3) (>= v@@3 0))
 :qid |existsinvectorseqArraybpl.176:28|
 :skolemid |8|
 :pattern ( (|$IsValid'address'| v@@3))
)))
(assert (forall ((r T@$Range) (i Int) ) (! (= ($InRange r i)  (and (<= (|lb#$Range| r) i) (< i (|ub#$Range| r))))
 :qid |existsinvectorseqArraybpl.186:19|
 :skolemid |9|
 :pattern ( ($InRange r i))
)))
...
(assert (forall ((src1 Int) (p Int) ) (! (= ($shl src1 p) (ite (= p 8) (* src1 256) (ite (= p 16) (* src1 65536) (ite (= p 32) (* src1 4294967296) (ite (= p 64) (* src1 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorseqArraybpl.452:15|
 :skolemid |13|
 :pattern ( ($shl src1 p))
)))
(assert (forall ((src1@@0 Int) (p@@0 Int) ) (! (= ($shr src1@@0 p@@0) (ite (= p@@0 8) (div src1@@0 256) (ite (= p@@0 16) (div src1@@0 65536) (ite (= p@@0 32) (div src1@@0 4294967296) (ite (= p@@0 64) (div src1@@0 18446744073709551616) (- 0 1))))))
 :qid |existsinvectorseqArraybpl.461:15|
 :skolemid |14|
...
(assert (forall ((v@@4 (Seq Int)) ) (! (= (|$IsValid'vec'u64''| v@@4)  (and (|$IsValid'u64'| (seq.len v@@4)) (forall ((i@@0 Int) ) (!  (=> (and (>= i@@0 0) (< i@@0 (seq.len v@@4))) (|$IsValid'u64'| (seq.nth v@@4 i@@0)))
 :qid |existsinvectorseqArraybpl.590:13|
 :skolemid |15|
))))
 :qid |existsinvectorseqArraybpl.588:29|
 :skolemid |16|
 :pattern ( (|$IsValid'vec'u64''| v@@4))
)))
(assert (forall ((v@@5 (Seq Int)) (e Int) ) (! (let ((i@@1 (|$IndexOfVec'u64'| v@@5 e)))
(ite  (not (exists ((i@@2 Int) ) (!  (and (and (|$IsValid'u64'| i@@2) (and (>= i@@2 0) (< i@@2 (seq.len v@@5)))) (= (seq.nth v@@5 i@@2) e))
 :qid |existsinvectorseqArraybpl.595:13|
 :skolemid |17|
))) (= i@@1 (- 0 1))  (and (and (and (|$IsValid'u64'| i@@1) (and (>= i@@1 0) (< i@@1 (seq.len v@@5)))) (= (seq.nth v@@5 i@@1) e)) (forall ((j Int) ) (!  (=> (and (and (|$IsValid'u64'| j) (>= j 0)) (< j i@@1)) (not (= (seq.nth v@@5 j) e)))
 :qid |existsinvectorseqArraybpl.603:17|
 :skolemid |18|
)))))
 :qid |existsinvectorseqArraybpl.599:15|
 :skolemid |19|
...
(assert (forall (($42_TestSome_R_$memory T@$Memory_13289) ) (!  (=> (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_13289| $42_TestSome_R_$memory) a) (= (|$x#$42_TestSome_R| (|Select__T@[Int]$42_TestSome_R_| (|contents#$Memory_13289| $42_TestSome_R_$memory) a)) 2)))
 :qid |existsinvectorseqArraybpl.2002:72|
 :skolemid |38|
 ...
 :qid |existsinvectorseqArraybpl.2002:15|
 :skolemid |39|
)))
(assert (forall (($t8 (Seq Int)) ) (!  (=> (|$IsValid'vec'u64''| $t8) (=> (exists ((i@@6 Int) ) (!  (and (and (|$IsValid'num'| i@@6) ($InRange ($Range 0 (seq.len $t8)) i@@6)) (= (seq.nth $t8 i@@6) 2))
 :qid |existsinvectorseqArraybpl.2013:13|
 :skolemid |40|
)) (let ((i@@7 ($choice_5 $t8)))
...
(forall ((i@@8 Int) ) (!  (=> (< i@@8 $$c) (not (and (and (|$IsValid'num'| i@@8) ($InRange ($Range 0 (seq.len $t8)) i@@8)) (= (seq.nth $t8 i@@8) 2))))
 :qid |existsinvectorseqArraybpl.2015:32|
 :skolemid |41|
)))))))
 :qid |existsinvectorseqArraybpl.2012:15|
 :skolemid |42|
)))
...
(|$IsValid'$42_TestSome_R'| $rsc))
 :qid |existsinvectorseqArraybpl.1138:20|
 :skolemid |32|
 ...
 :qid |existsinvectorseqArraybpl.1155:20|
 :skolemid |33|
...
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 19905)))
(get-value ((ControlFlow 0 17290)))
(get-value ((ControlFlow 0 17320)))
(get-value ((ControlFlow 0 17314)))
(get-value ((ControlFlow 0 17421)))
(get-value ((ControlFlow 0 17415)))
(get-value ((ControlFlow 0 17494)))
(get-value ((ControlFlow 0 17488)))
(get-value ((ControlFlow 0 17567)))
(get-value ((ControlFlow 0 17561)))
(get-value ((ControlFlow 0 17640)))
(get-value ((ControlFlow 0 17634)))
(get-value ((ControlFlow 0 17676)))
(assert (not (= (ControlFlow 0 17676) (- 20284))))
(check-sat)
(pop 1)
; Invalid
(declare-fun $t0@0@@0 () (Seq Int))
(declare-fun |inline$$1_Vector_push_back'u64'$4$m'@1| () T@$Mutation_10376)
(declare-fun $t10 () Int)
(declare-fun |inline$$1_Vector_push_back'u64'$3$m'@1@@0| () T@$Mutation_10376)
(declare-fun |inline$$1_Vector_push_back'u64'$2$m'@1@@0| () T@$Mutation_10376)
(declare-fun |inline$$1_Vector_push_back'u64'$1$m'@1@@0| () T@$Mutation_10376)
(declare-fun |inline$$1_Vector_push_back'u64'$0$m'@1@@0| () T@$Mutation_10376)
(declare-fun $t3@0@@0 () T@$Mutation_10376)
(declare-fun |inline$$1_Vector_empty'u64'$0$v@1@@0| () (Seq Int))
(declare-fun |$temp_0'vec'u64''@0@@0| () (Seq Int))
(declare-fun $t1@@0 () T@$Mutation_10376)
(declare-fun $t3@@1 () T@$Mutation_10376)
(push 1)
(set-info :boogie-vc-id $42_TestSome_test_not_using_min_incorrect$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 20311) (let ((anon19_Else_correct  (=> (not false) (=> (and (and (= $t0@0@@0 (|v#$Mutation_10376| |inline$$1_Vector_push_back'u64'$4$m'@1|)) (= $t0@0@@0 $t0@0@@0)) (and (= $t10 ($choice_6 $t0@0@@0)) (= (ControlFlow 0 18358) (- 0 20759)))) (= ($choice_6 $t0@0@@0) 1)))))
(let ((anon19_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$4$anon0_correct|  (=> (= |inline$$1_Vector_push_back'u64'$4$m'@1| ($Mutation_10376 (|l#$Mutation_10376| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (|p#$Mutation_10376| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.++ (|v#$Mutation_10376| |inline$$1_Vector_push_back'u64'$3$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 18306) 18372) anon19_Then_correct) (=> (= (ControlFlow 0 18306) 18358) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 18312) 18306)) |inline$$1_Vector_push_back'u64'$4$anon0_correct|))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$3$m'@1@@0| ($Mutation_10376 (|l#$Mutation_10376| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (|p#$Mutation_10376| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.++ (|v#$Mutation_10376| |inline$$1_Vector_push_back'u64'$2$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 18233) 18392) anon18_Then_correct) (=> (= (ControlFlow 0 18233) 18312) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 18239) 18233)) |inline$$1_Vector_push_back'u64'$3$anon0_correct@@0|))))
(let ((anon17_Then_correct true))
(let ((|inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$2$m'@1@@0| ($Mutation_10376 (|l#$Mutation_10376| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (|p#$Mutation_10376| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.++ (|v#$Mutation_10376| |inline$$1_Vector_push_back'u64'$1$m'@1@@0|) (seq.unit 3)))) (and (=> (= (ControlFlow 0 18160) 18406) anon17_Then_correct) (=> (= (ControlFlow 0 18160) 18239) anon17_Else_correct)))))
(let ((anon16_Else_correct@@0  (=> (not false) (=> (and (|$IsValid'u64'| 3) (= (ControlFlow 0 18166) 18160)) |inline$$1_Vector_push_back'u64'$2$anon0_correct@@0|))))
(let ((anon16_Then_correct@@0 true))
(let ((|inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$1$m'@1@@0| ($Mutation_10376 (|l#$Mutation_10376| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (|p#$Mutation_10376| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.++ (|v#$Mutation_10376| |inline$$1_Vector_push_back'u64'$0$m'@1@@0|) (seq.unit 2)))) (and (=> (= (ControlFlow 0 18087) 18420) anon16_Then_correct@@0) (=> (= (ControlFlow 0 18087) 18166) anon16_Else_correct@@0)))))
(let ((anon15_Else_correct@@1  (=> (not false) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 18093) 18087)) |inline$$1_Vector_push_back'u64'$1$anon0_correct@@0|))))
(let ((anon15_Then_correct@@1 true))
(let ((|inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_push_back'u64'$0$m'@1@@0| ($Mutation_10376 (|l#$Mutation_10376| $t3@0@@0) (|p#$Mutation_10376| $t3@0@@0) (seq.++ (|v#$Mutation_10376| $t3@0@@0) (seq.unit 1)))) (and (=> (= (ControlFlow 0 18014) 18434) anon15_Then_correct@@1) (=> (= (ControlFlow 0 18014) 18093) anon15_Else_correct@@1)))))
(let ((anon14_Else_correct@@1  (=> (not false) (=> (and (= |inline$$1_Vector_empty'u64'$0$v@1@@0| |inline$$1_Vector_empty'u64'$0$v@1@@0|) (= $t3@0@@0 ($Mutation_10376 ($Local 0) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'u64'$0$v@1@@0|))) (=> (and (and (= |$temp_0'vec'u64''@0@@0| (|v#$Mutation_10376| $t3@0@@0)) (= |$temp_0'vec'u64''@0@@0| |$temp_0'vec'u64''@0@@0|)) (and (|$IsValid'u64'| 1) (= (ControlFlow 0 18020) 18014))) |inline$$1_Vector_push_back'u64'$0$anon0_correct@@0|)))))
(let ((anon14_Then_correct@@1 true))
(let ((|inline$$1_Vector_empty'u64'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_empty'u64'$0$v@1@@0| (as seq.empty (Seq Int))) (and (=> (= (ControlFlow 0 17913) 18448) anon14_Then_correct@@1) (=> (= (ControlFlow 0 17913) 18020) anon14_Else_correct@@1)))))
(let ((anon0$1_correct@@4  (=> (= (ControlFlow 0 17919) 17913) |inline$$1_Vector_empty'u64'$0$anon0_correct@@0|)))
(let ((anon0_correct@@4  (=> (= (seq.len (|p#$Mutation_10376| $t1@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_10376| $t3@@1)) 0) (= (ControlFlow 0 17889) 17919)) anon0$1_correct@@4))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 20311) 17889) anon0_correct@@4)))
PreconditionGeneratedEntry_correct@@0))))))))))))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 20311)))
(get-value ((ControlFlow 0 17889)))
(get-value ((ControlFlow 0 17919)))
(get-value ((ControlFlow 0 17913)))
(get-value ((ControlFlow 0 18020)))
(get-value ((ControlFlow 0 18014)))
(get-value ((ControlFlow 0 18093)))
(get-value ((ControlFlow 0 18087)))
(get-value ((ControlFlow 0 18166)))
(get-value ((ControlFlow 0 18160)))
(get-value ((ControlFlow 0 18239)))
(get-value ((ControlFlow 0 18233)))
(get-value ((ControlFlow 0 18312)))
(get-value ((ControlFlow 0 18306)))
(get-value ((ControlFlow 0 18358)))
(assert (not (= (ControlFlow 0 18358) (- 20759))))
(check-sat)
(pop 1)
; Invalid
...
(assert (not
 (=> (= (ControlFlow 0 0) 20788) (let ((anon4_Else_correct@@0  (=> (and (and (not $abort_flag@0@@1) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@2@@0)) (and (= $t4@@2 ($choice_0 (+ _$t0@@2 42))) (= (ControlFlow 0 18809) (- 0 20985)))) (<= inline$$AddU64$0$dst@2@@0 ($choice_0 (+ _$t0@@2 42))))))
(let ((anon4_Then_correct@@0 true))
(let ((inline$$AddU64$0$anon3_Then$1_correct@@0  (=> (= $abort_flag@0@@1 true) (=> (and (= $abort_code@1@@1 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@0@@0)) (and (=> (= (ControlFlow 0 18757) 18827) anon4_Then_correct@@0) (=> (= (ControlFlow 0 18757) 18809) anon4_Else_correct@@0))))))
(let ((inline$$AddU64$0$anon3_Then_correct@@0  (=> (and (> (+ _$t0@@2 42) $MAX_U64) (= (ControlFlow 0 18755) 18757)) inline$$AddU64$0$anon3_Then$1_correct@@0)))
(let ((inline$$AddU64$0$anon3_Else_correct@@0  (=> (>= $MAX_U64 (+ _$t0@@2 42)) (=> (and (and (= inline$$AddU64$0$dst@1@@0 (+ _$t0@@2 42)) (= $abort_flag@0@@1 false)) (and (= $abort_code@1@@1 $abort_code@0@@1) (= inline$$AddU64$0$dst@2@@0 inline$$AddU64$0$dst@1@@0))) (and (=> (= (ControlFlow 0 18703) 18827) anon4_Then_correct@@0) (=> (= (ControlFlow 0 18703) 18809) anon4_Else_correct@@0))))))
(let ((anon0$1_correct@@5  (=> (|$IsValid'u64'| _$t0@@2) (=> (and (= _$t0@@2 _$t0@@2) (|$IsValid'u64'| 42)) (and (=> (= (ControlFlow 0 18763) 18755) inline$$AddU64$0$anon3_Then_correct@@0) (=> (= (ControlFlow 0 18763) 18703) inline$$AddU64$0$anon3_Else_correct@@0))))))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 20788) 18763) anon0$1_correct@@5)))
anon0_correct@@5))))))))
))
(check-sat)
(pop 1)
