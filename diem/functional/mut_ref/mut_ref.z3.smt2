...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10203) (let ((anon8_Else_correct  (=> (and (and (not $abort_flag@0) (= $t3@0 (|$x#$42_TestInvariants_R'#0'| $t1@1))) (and (= $t3@0 $t3@0) (= (ControlFlow 0 9846) (- 0 10394)))) (< $t3@0 1))))
(let ((anon8_Then_correct true))
(let ((anon7_Then$1_correct  (=> (= $t1@1 $t1) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 9916) 9864) anon8_Then_correct) (=> (= (ControlFlow 0 9916) 9846) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_8858| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= (ControlFlow 0 9914) 9916)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_8858| |$42_TestInvariants_R'#0'_$memory|) _$t0) (=> (and (and (= $t1@0 (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_8858| |$42_TestInvariants_R'#0'_$memory|) _$t0)) (= $t1@1 $t1@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 9816) 9864) anon8_Then_correct) (=> (= (ControlFlow 0 9816) 9846) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_8858| |$42_TestInvariants_R'#0'_$memory|) $a_0)))
 (and (|$IsValid'$42_TestInvariants_R'#0''| $rsc) (> (|$x#$42_TestInvariants_R'#0'| $rsc) 1)))
 :qid |mutrefz3bpl.1019:20|
 :skolemid |26|
 :pattern ( (|Select__T@[Int]$42_TestInvariants_R'#0'_| (|contents#$Memory_8858| |$42_TestInvariants_R'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (=> (= (ControlFlow 0 9802) 9914) anon7_Then_correct) (=> (= (ControlFlow 0 9802) 9816) anon7_Else_correct))))))
(let ((anon0_correct  (=> (= (ControlFlow 0 10203) 9802) anon0$1_correct)))
anon0_correct))))))))
))
(check-sat)
