...
(declare-fun $1_DiemAccount_DiemAccount_$memory () T@$Memory_57353)
(declare-fun _$t2 () Int)
(declare-fun _$t3 () T@Vec_12290)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1 () T@$Memory_57353)
(declare-fun $abort_flag@2 () Bool)
(declare-fun inline$$AddU64$0$dst@2 () Int)
(declare-fun |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| () Int)
(declare-fun $t25@0 () T@Vec_28962)
(declare-fun $t17@0 () Int)
(declare-fun $abort_code@5 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1 () T@$Mutation_41428)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 () T@$Mutation_59386)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2 () T@$Mutation_41428)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3 () T@$Mutation_59386)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0 () T@$Memory_57353)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0 () T@$Mutation_59386)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 () T@$Mutation_59386)
...
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0 () T@$Mutation_59386)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0 () T@$Mutation_41428)
...
(declare-fun $1_DiemAccount_AccountOperationsCapability_$memory () T@$Memory_58402)
(declare-fun $1_DiemAccount_DiemWriteSetManager_$memory () T@$Memory_58748)
(declare-fun $1_AccountFreezing_FreezingBit_$memory () T@$Memory_57320)
...
(assert (not
 (=> (= (ControlFlow 0 0) 86026) (let ((anon46_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 76042) (- 0 88259)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 76042) (- 0 88270)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (and (=> (= (ControlFlow 0 76042) (- 0 88281)) (not (not (= (|l#Vec_12290| _$t3) 32)))) (=> (not (not (= (|l#Vec_12290| _$t3) 32))) (and (=> (= (ControlFlow 0 76042) (- 0 88295)) (not (not (exists ((i@@50 Int) ) (!  (and (and (|$IsValid'u64'| i@@50) (and (<= 0 i@@50) (< i@@50 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@50)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))))) (=> (not (not (exists ((i@@51 Int) ) (!  (and (and (|$IsValid'u64'| i@@51) (and (<= 0 i@@51) (< i@@51 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@51)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (and (=> (= (ControlFlow 0 76042) (- 0 88307)) (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 76042) (- 0 88328)) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory@1) _$t2)) _$t3)))))))))))))))
(let ((anon47_Else_correct  (=> (and (not $abort_flag@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 74906) (- 0 87504)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (=> (= (ControlFlow 0 74906) (- 0 87511)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@15 $i_1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@15)) _$t2))))
 :qid |RecoveryAddressbpl.5391:49|
 :skolemid |192|
)))))))))
(let ((L17_correct  (and (=> (= (ControlFlow 0 73937) (- 0 88106)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_12290| _$t3) 32))) (not (exists ((i@@52 Int) ) (!  (and (and (|$IsValid'u64'| i@@52) (and (<= 0 i@@52) (< i@@52 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@52)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_12290| _$t3) 32))) (not (exists ((i@@53 Int) ) (!  (and (and (|$IsValid'u64'| i@@53) (and (<= 0 i@@53) (< i@@53 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@53)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (=> (= (ControlFlow 0 73937) (- 0 88158)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) _$t2)) (= 5 $t17@0))) (and (not (= (|l#Vec_12290| _$t3) 32)) (= 7 $t17@0))) (and (not (exists ((i@@54 Int) ) (!  (and (and (|$IsValid'u64'| i@@54) (and (<= 0 i@@54) (< i@@54 (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@54)) _$t2))
 :qid |RecoveryAddressbpl.4451:13|
 :skolemid |163|
))) (= 7 $t17@0))) (and (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))) (= 7 $t17@0))))))))
(let ((anon46_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0 $abort_code@5) (= (ControlFlow 0 76056) 73937))) L17_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1 ($Mutation_41428 (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (let ((l (|l#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))
(Vec_12290 (|Store__T@[Int]Int_| (|v#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) l 0) (+ l 1))) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2 ($Mutation_41428 (|l#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) (|p#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3 ($Mutation_59386 (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_57353 (|Store__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)))) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory@0)))) (and (=> (= (ControlFlow 0 75846) 76056) anon46_Then_correct) (=> (= (ControlFlow 0 75846) 76042) anon46_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory)) (and (=> (= (ControlFlow 0 75642) 76056) anon46_Then_correct) (=> (= (ControlFlow 0 75642) 76042) anon46_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= (ControlFlow 0 75796) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct  (=> (and (and (and (not $abort_flag@3) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= |inline$$1_Vector_length'u8'$0$l@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1)))) (and (=> (= (ControlFlow 0 75780) 75846) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct) (=> (= (ControlFlow 0 75780) 75796) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 75860) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_12290| _$t3)) (and (=> (= (ControlFlow 0 75722) 75860) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct) (=> (= (ControlFlow 0 75722) 75780) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct  (=> (and (and (not $abort_flag@3) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| (|v#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1|) (= (ControlFlow 0 75728) 75722))) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 75874) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) (and (=> (= (ControlFlow 0 75926) 75874) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 75926) 75728) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1)) (= (ControlFlow 0 75924) 75926)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 ($Mutation_59386 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (Vec_12290 (MapConstVec_7770 DefaultVecElem_7770) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1))) (= $abort_code@4 $abort_code@2)) (and (= $abort_flag@3 $abort_flag@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1))) (and (=> (= (ControlFlow 0 75672) 75874) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 75672) 75728) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|))) (and (=> (= (ControlFlow 0 75650) 75924) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct) (=> (= (ControlFlow 0 75650) 75672) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= (ControlFlow 0 75636) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 75620) 75650) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct) (=> (= (ControlFlow 0 75620) 75636) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@2) (= (ControlFlow 0 75940) 75642))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 75578) 75940) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct) (=> (= (ControlFlow 0 75578) 75620) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct  (=> (= (|l#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0)) 0) (=> (and (= (|l#Vec_12290| (|p#$Mutation_59386| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) 0) (= (|l#Vec_12290| (|p#$Mutation_41428| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0)) 0)) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= _$t3 _$t3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= (ControlFlow 0 75584) 75578))) inline$$1_DiemAccount_exists_at$0$anon0_correct)))))
(let ((anon45_Then_correct  (=> (and $t31@1 (= (ControlFlow 0 75944) 75584)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct)))
(let ((anon47_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 74920) 73937))) L17_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 74837) 74920) anon47_Then_correct) (=> (= (ControlFlow 0 74837) 74906) anon47_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t26@0 1) $MAX_U64) (= (ControlFlow 0 74835) 74837)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t26@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t26@0 1)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 74783) 74920) anon47_Then_correct) (=> (= (ControlFlow 0 74783) 74906) anon47_Else_correct))))))
(let ((anon45_Else_correct  (=> (and (not $t31@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 74843) 74835) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 74843) 74783) inline$$AddU64$0$anon3_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not $abort_flag@1) (= $t31@1 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 _$t2))) (and (=> (= (ControlFlow 0 74676) 75944) anon45_Then_correct) (=> (= (ControlFlow 0 74676) 74843) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 76070) 73937))) L17_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 74656) 76070) anon44_Then_correct) (=> (= (ControlFlow 0 74656) 74676) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 74662) 74656)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct))))
(let ((anon43_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 76084) 73937))) L17_correct)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@0|)) (and (=> (= (ControlFlow 0 74541) 76084) anon43_Then_correct) (=> (= (ControlFlow 0 74541) 74662) anon43_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_25329 $t25@0 $t26@0)) (= (ControlFlow 0 74539) 74541)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (InRangeVec_25329 $t25@0 $t26@0) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) $t26@0)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 74489) 76084) anon43_Then_correct) (=> (= (ControlFlow 0 74489) 74662) anon43_Else_correct))))))
(let ((anon42_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 74547) 74539) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 74547) 74489) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((anon42_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 74402) (- 0 87159)) (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 74402) (- 0 87166)) (let (($range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((j@@16 $i_1@@0))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@16)) _$t2))))
 :qid |RecoveryAddressbpl.5350:49|
 :skolemid |191|
)))) (=> (let (($range_0@@1 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((j@@17 $i_1@@1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@17)) _$t2))))
 :qid |RecoveryAddressbpl.5350:49|
 :skolemid |191|
))) (=> (and (|$IsValid'u64'| 4) (|$IsValid'u64'| $t35)) (=> (and (and (= $t35 7) (= $t35 $t35)) (and (= $t17@0 $t35) (= (ControlFlow 0 74402) 73937))) L17_correct)))))))))
(let ((anon41_Else$1_correct  (and (=> (= (ControlFlow 0 74321) 74547) anon42_Then_correct) (=> (= (ControlFlow 0 74321) 74402) anon42_Else_correct))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (= (ControlFlow 0 74311) 74321)) anon41_Else$1_correct)))
(let ((anon41_Else_correct  (=> (and (not $abort_flag@0) (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (and (=> (= (ControlFlow 0 74317) (- 0 86997)) (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 74317) (- 0 87004)) (let (($range_0@@2 ($Range 0 0)))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((j@@18 $i_1@@2))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@18)) _$t2))))
 :qid |RecoveryAddressbpl.5198:49|
 :skolemid |189|
)))) (=> (let (($range_0@@3 ($Range 0 0)))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((j@@19 $i_1@@3))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@19)) _$t2))))
 :qid |RecoveryAddressbpl.5198:49|
 :skolemid |189|
))) (=> (|$IsValid'u64'| $t26@0) (=> (and (and (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| $t29@0) (|$IsValid'address'| $t30@0)) (and (|$IsValid'u64'| $t32@0) (|$IsValid'u64'| $t33@0))) (and (and (not $abort_flag@0) (<= $t26@0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (and (let (($range_0@@4 ($Range 0 $t26@0)))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@20 $i_1@@4))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| $t25@0) j@@20)) _$t2))))
 :qid |RecoveryAddressbpl.5238:54|
 :skolemid |190|
))) (= (ControlFlow 0 74317) 74311)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 76098) 73937))) L17_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (|l#Vec_28962| $t25@0)) (and (=> (= (ControlFlow 0 74121) 76098) anon41_Then_correct) (=> (= (ControlFlow 0 74121) 74317) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@0) (= $t25@0 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| $t24@1))) (=> (and (and (= $t25@0 $t25@0) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 74127) 74121))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 76112) 73937))) L17_correct)))
(let ((anon39_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 76164) 76112) anon40_Then_correct) (=> (= (ControlFlow 0 76164) 74127) anon40_Else_correct))))))
(let ((anon39_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 76162) 76164)) anon39_Then$1_correct)))
(let ((anon39_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= $t24@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 74057) 76112) anon40_Then_correct) (=> (= (ControlFlow 0 74057) 74127) anon40_Else_correct))))))
(let ((anon38_Then_correct  (=> $t8@0 (and (=> (= (ControlFlow 0 74043) 76162) anon39_Then_correct) (=> (= (ControlFlow 0 74043) 74057) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (and (not $t8@0) (= $t23 $t23)) (and (= $t17@0 $t23) (= (ControlFlow 0 74039) 73937))) L17_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 7)) (and (= $t23 $t23) (= $t8@0 $t8@0))) (and (=> (= (ControlFlow 0 74023) 74043) anon38_Then_correct) (=> (= (ControlFlow 0 74023) 74039) anon38_Else_correct))))))
(let ((anon37_Else_correct  (=> (not $t19@0) (=> (and (and (= $t21@0 (= $t18 _$t1)) (= $t21@0 $t21@0)) (and (= $t8@0 $t21@0) (= (ControlFlow 0 73989) 74023))) L5_correct))))
(let ((anon37_Then_correct  (=> (and (and $t19@0 (= true true)) (and (= $t8@0 true) (= (ControlFlow 0 76182) 74023))) L5_correct)))
(let ((anon36_Then_correct  (=> $t14@0 (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0))) (and (= $t18 $t18) (= $t19@0 (= $t18 _$t2)))) (and (=> (= (ControlFlow 0 73967) 76182) anon37_Then_correct) (=> (= (ControlFlow 0 73967) 73989) anon37_Else_correct))))))
(let ((anon36_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 73761) 73937))) L17_correct)))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr) (or (= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr)))) 0) (and (not (= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)) (= addr (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))))))
 :qid |RecoveryAddressbpl.4927:20|
 :skolemid |178|
)) (=> (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@0) (= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)) (and (not (= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)) (= addr@@0 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@0)))) 0)))))))
 :qid |RecoveryAddressbpl.4931:20|
 :skolemid |179|
)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@1)))
 :qid |RecoveryAddressbpl.4935:20|
 :skolemid |180|
))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_58402| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@2)  (and (= addr@@2 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@2))))
 :qid |RecoveryAddressbpl.4939:20|
 :skolemid |181|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_58748| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@3)  (and (= addr@@3 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@3))))
 :qid |RecoveryAddressbpl.4943:20|
 :skolemid |182|
)))) (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_57320| $1_AccountFreezing_FreezingBit_$memory) addr@@4)))
 :qid |RecoveryAddressbpl.4947:20|
 :skolemid |183|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_57320| $1_AccountFreezing_FreezingBit_$memory) addr@@5)))
 :qid |RecoveryAddressbpl.4951:20|
 :skolemid |184|
))) (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6))) 0)) addr@@6))))
 :qid |RecoveryAddressbpl.4955:20|
 :skolemid |185|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@7) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@7))))
 :qid |RecoveryAddressbpl.4959:20|
 :skolemid |186|
))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'address'| _$t1)) (and (|$IsValid'address'| _$t2) (|$IsValid'vec'u8''| _$t3))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) $a_0)))
 (and (|$IsValid'$1_DiemAccount_DiemAccount'| $rsc) (and (<= (|l#Vec_29001| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| $rsc))) 1) (<= (|l#Vec_28962| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| $rsc))) 1))))
 :qid |RecoveryAddressbpl.4974:20|
 :skolemid |187|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_57353| $1_DiemAccount_DiemAccount_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@0))
 :qid |RecoveryAddressbpl.4978:20|
 :skolemid |188|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0))
))) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 73745) 73967) anon36_Then_correct) (=> (= (ControlFlow 0 73745) 73761) anon36_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28837_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_28837| stream@@0) 0) (forall ((v@@28 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_28837| stream@@0) v@@28) 0)
 :qid |RecoveryAddressbpl.159:13|
 :skolemid |4|
))))
 :qid |RecoveryAddressbpl.1863:13|
 :skolemid |63|
))) (= (ControlFlow 0 73300) 73745)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 86026) 73300) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
