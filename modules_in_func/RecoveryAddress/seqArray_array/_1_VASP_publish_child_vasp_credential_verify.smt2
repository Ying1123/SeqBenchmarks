...
(assert (not
 (=> (= (ControlFlow 0 0) 80717) (let ((anon37_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 69168) (- 0 82651)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) addr)))
 :qid |RecoveryAddressbpl.3231:15|
 :skolemid |117|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) addr@@0)))
 :qid |RecoveryAddressbpl.3231:15|
 :skolemid |117|
)) (and (=> (= (ControlFlow 0 69168) (- 0 82675)) (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory@1) child_addr)))))
 :qid |RecoveryAddressbpl.3237:15|
 :skolemid |118|
))) (=> (forall ((child_addr@@0 Int) ) (!  (=> (|$IsValid'address'| child_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) child_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory@1) child_addr@@0)))))
 :qid |RecoveryAddressbpl.3237:15|
 :skolemid |118|
)) (and (=> (= (ControlFlow 0 69168) (- 0 82704)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) a) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a) a (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory@1) a))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a) a (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a))))))
 :qid |RecoveryAddressbpl.3243:15|
 :skolemid |119|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@0) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a@@0) a@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory@1) a@@0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a@@0) a@@0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@0))))))
 :qid |RecoveryAddressbpl.3243:15|
 :skolemid |119|
)) (and (=> (= (ControlFlow 0 69168) (- 0 82737)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) addr@@1))))
 :qid |RecoveryAddressbpl.3249:15|
 :skolemid |120|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) addr@@2))))
 :qid |RecoveryAddressbpl.3249:15|
 :skolemid |120|
)) (and (=> (= (ControlFlow 0 69168) (- 0 82766)) (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11)))) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11))) (and (=> (= (ControlFlow 0 69168) (- 0 82777)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12))) (and (=> (= (ControlFlow 0 69168) (- 0 82789)) (not (> (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) 1) 65536))) (=> (not (> (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) 1) 65536)) (and (=> (= (ControlFlow 0 69168) (- 0 82807)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t13)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t13))) (and (=> (= (ControlFlow 0 69168) (- 0 82819)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) 5)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) 5))) (and (=> (= (ControlFlow 0 69168) (- 0 82837)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t11)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t11))) (and (=> (= (ControlFlow 0 69168) (- 0 82849)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) 6)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) 6))) (and (=> (= (ControlFlow 0 69168) (- 0 82867)) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$addr#$signer| _$t0))) (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) (|$addr#$signer| _$t0))) 1))) (=> (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$addr#$signer| _$t0))) (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) (|$addr#$signer| _$t0))) 1)) (and (=> (= (ControlFlow 0 69168) (- 0 82888)) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) $t11)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory@1) $t11) (=> (= (ControlFlow 0 69168) (- 0 82896)) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) $t11) $t11 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory@1) $t11))) (|$addr#$signer| _$t0))))))))))))))))))))))))))))))))
(let ((L7_correct  (and (=> (= (ControlFlow 0 68275) (- 0 82435)) (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12))) (> (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) 1) 65536)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t13))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) 5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t11))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) 6)))) (=> (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12))) (> (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) 1) 65536)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t13))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) 5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t11))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) 6))) (=> (= (ControlFlow 0 68275) (- 0 82513)) (or (or (or (or (or (or (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11)) (= 6 $t16@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) (= 7 $t16@0))) (and (> (+ (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t12)) 1) 65536) (= 8 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) (= 5 $t16@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t13)) 5)) (= 3 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) (= 5 $t16@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t11)) 6)) (= 3 $t16@0))))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t16@0 $abort_code@3) (= (ControlFlow 0 69182) 68275))) L7_correct)))
(let ((anon36_Then$1_correct  (=> (= $1_VASP_ChildVASP_$memory@1 $1_VASP_ChildVASP_$memory) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 69234) 69182) anon37_Then_correct) (=> (= (ControlFlow 0 69234) 69168) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) (|$addr#$signer| _$t1)) (= (ControlFlow 0 69232) 69234)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) (|$addr#$signer| _$t1))) (=> (and (and (= $1_VASP_ChildVASP_$memory@0 ($Memory_50035 (|Store__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) (|$addr#$signer| _$t1) true) (|Store__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) (|$addr#$signer| _$t1) $t37@0))) (= $1_VASP_ChildVASP_$memory@1 $1_VASP_ChildVASP_$memory@0)) (and (= $abort_code@3 $abort_code@2) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 68888) 69182) anon37_Then_correct) (=> (= (ControlFlow 0 68888) 69168) anon37_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (and (not $abort_flag@1) (= $t28@1 ($Mutation_8165 (|l#$Mutation_8165| $t28@0) (|p#$Mutation_8165| $t28@0) inline$$AddU64$0$dst@2))) (and (= $t27@2 ($Mutation_50501 (|l#$Mutation_50501| $t27@1) (|p#$Mutation_50501| $t27@1) ($1_VASP_ParentVASP (|v#$Mutation_8165| $t28@1)))) (= $1_VASP_ParentVASP_$memory@0 ($Memory_50099 (|Store__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) (|a#$Global| (|l#$Mutation_50501| $t27@2)) true) (|Store__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) (|a#$Global| (|l#$Mutation_50501| $t27@2)) (|v#$Mutation_50501| $t27@2)))))) (and (=> (= (ControlFlow 0 68866) (- 0 82187)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@3)))
 :qid |RecoveryAddressbpl.3181:15|
 :skolemid |113|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@4)))
 :qid |RecoveryAddressbpl.3181:15|
 :skolemid |113|
)) (and (=> (= (ControlFlow 0 68866) (- 0 82211)) (forall ((child_addr@@1 Int) ) (!  (=> (|$IsValid'address'| child_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@1)))))
 :qid |RecoveryAddressbpl.3187:15|
 :skolemid |114|
))) (=> (forall ((child_addr@@2 Int) ) (!  (=> (|$IsValid'address'| child_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@2)))))
 :qid |RecoveryAddressbpl.3187:15|
 :skolemid |114|
)) (and (=> (= (ControlFlow 0 68866) (- 0 82242)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@1) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a@@1) a@@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) a@@1) a@@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@1))))))
 :qid |RecoveryAddressbpl.3193:15|
 :skolemid |115|
))) (=> (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@2) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) a@@2) a@@2 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@2))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) a@@2) a@@2 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) a@@2))))))
 :qid |RecoveryAddressbpl.3193:15|
 :skolemid |115|
)) (and (=> (= (ControlFlow 0 68866) (- 0 82276)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@5) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@5))))
 :qid |RecoveryAddressbpl.3199:15|
 :skolemid |116|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory@0) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@6))))
 :qid |RecoveryAddressbpl.3199:15|
 :skolemid |116|
)) (=> (= $t37@0 ($1_VASP_ChildVASP $t23)) (and (=> (= (ControlFlow 0 68866) 69232) anon36_Then_correct) (=> (= (ControlFlow 0 68866) 68888) anon36_Else_correct))))))))))))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t16@0 $abort_code@2) (= (ControlFlow 0 69248) 68275))) L7_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 68678) 69248) anon35_Then_correct) (=> (= (ControlFlow 0 68678) 68866) anon35_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t34@0 1) $MAX_U64) (= (ControlFlow 0 68676) 68678)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t34@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t34@0 1)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 68624) 69248) anon35_Then_correct) (=> (= (ControlFlow 0 68624) 68866) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> inline$$Lt$0$dst@1 (=> (and (= $t34@0 (|v#$Mutation_8165| $t28@0)) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 68684) 68676) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 68684) 68624) inline$$AddU64$0$anon3_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t33 $t33)) (and (= $t16@0 $t33) (= (ControlFlow 0 68517) 68275))) L7_correct)))
(let ((anon33_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t33) (= $t33 8)) (and (= $t33 $t33) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 68501) 68684) anon34_Then_correct) (=> (= (ControlFlow 0 68501) 68517) anon34_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t29@0 65536)) (= (ControlFlow 0 68465) 68501)) anon33_Else$1_correct)))
(let ((anon33_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t28@0 ($Mutation_8165 (|l#$Mutation_50501| $t27@1) (let ((l (|l#Vec_12290| (|p#$Mutation_50501| $t27@1))))
(Vec_12290 (|Store__T@[Int]Int_| (|v#Vec_12290| (|p#$Mutation_50501| $t27@1)) l 0) (+ l 1))) (|$num_children#$1_VASP_ParentVASP| (|v#$Mutation_50501| $t27@1)))) (= |$temp_0'u64'@0| (|v#$Mutation_8165| $t28@0))) (=> (and (and (= |$temp_0'u64'@0| |$temp_0'u64'@0|) (= $t29@0 (|v#$Mutation_8165| $t28@0))) (and (|$IsValid'u64'| 65536) (= (ControlFlow 0 68471) 68465))) inline$$Lt$0$anon0_correct)))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t16@0 $abort_code@1) (= (ControlFlow 0 69262) 68275))) L7_correct)))
(let ((anon32_Then$1_correct  (=> (= $t27@1 $t27) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 69314) 69262) anon33_Then_correct) (=> (= (ControlFlow 0 69314) 68471) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t23)) (= (ControlFlow 0 69312) 69314)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t23) (=> (and (and (= $t27@0 ($Mutation_50501 ($Global $t23) (Vec_12290 (MapConstVec_7770 DefaultVecElem_7770) 0) (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $t23))) (= $t27@1 $t27@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 68383) 69262) anon33_Then_correct) (=> (= (ControlFlow 0 68383) 68471) anon33_Else_correct))))))
(let ((anon31_Then_correct  (=> $t24 (and (=> (= (ControlFlow 0 68361) 69312) anon32_Then_correct) (=> (= (ControlFlow 0 68361) 68383) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (and (not $t24) (= $t26 $t26)) (and (= $t16@0 $t26) (= (ControlFlow 0 68357) 68275))) L7_correct)))
(let ((anon30_Then_correct  (=> (and inline$$Not$0$dst@1 (|$IsValid'address'| $t23)) (=> (and (and (and (= $t23 (|$addr#$signer| _$t0)) (= $t23 $t23)) (and (= $t24 (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t23)) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t26) (= $t26 7)) (and (= $t26 $t26) (= $t24 $t24)))) (and (=> (= (ControlFlow 0 68341) 68361) anon31_Then_correct) (=> (= (ControlFlow 0 68341) 68357) anon31_Else_correct))))))
(let ((anon30_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t22 $t22)) (and (= $t16@0 $t22) (= (ControlFlow 0 68039) 68275))) L7_correct)))
(let ((anon29_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t22) (= $t22 6)) (and (= $t22 $t22) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 68023) 68341) anon30_Then_correct) (=> (= (ControlFlow 0 68023) 68039) anon30_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t19)) (= (ControlFlow 0 67987) 68023)) anon29_Else$1_correct)))
(let ((anon29_Else_correct  (=> (and (not $t17) (|$IsValid'address'| $t18)) (=> (and (and (= $t18 (|$addr#$signer| _$t1)) (= $t18 $t18)) (and (= $t19  (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t18) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t18))) (= (ControlFlow 0 67993) 67987))) inline$$Not$0$anon0_correct))))
(let ((anon29_Then_correct  (=> $t17 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1))) (= 5 $t16)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1))) 6)) (= 3 $t16))) (= $t16 $t16)) (and (= $t16@0 $t16) (= (ControlFlow 0 69370) 68275))) L7_correct))))
(let ((anon28_Else_correct  (=> (and (not $t15) (= $t17  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t1))) 6))))) (and (=> (= (ControlFlow 0 67913) 69370) anon29_Then_correct) (=> (= (ControlFlow 0 67913) 67993) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> $t15 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t14)) (= 5 $t16)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t14)) 5)) (= 3 $t16))) (= $t16 $t16)) (and (= $t16@0 $t16) (= (ControlFlow 0 69422) 68275))) L7_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@7)) 0)) (= addr@@7 173345816)))
 :qid |RecoveryAddressbpl.2759:20|
 :skolemid |93|
)) (=> (and (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@8)) 1)) (= addr@@8 186537453)))
 :qid |RecoveryAddressbpl.2763:20|
 :skolemid |94|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@9)) 2))))))
 :qid |RecoveryAddressbpl.2767:20|
 :skolemid |95|
))) (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@10)) 2))))))
 :qid |RecoveryAddressbpl.2771:20|
 :skolemid |96|
)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@11)) 2))))))
 :qid |RecoveryAddressbpl.2775:20|
 :skolemid |97|
)))) (=> (and (and (and (and (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@12)) 2))))))
 :qid |RecoveryAddressbpl.2779:20|
 :skolemid |98|
)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@13)) 2)))))
 :qid |RecoveryAddressbpl.2783:20|
 :skolemid |99|
))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@14)) 2)))))
 :qid |RecoveryAddressbpl.2787:20|
 :skolemid |100|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@15)) 2)))))
 :qid |RecoveryAddressbpl.2791:20|
 :skolemid |101|
)))) (and (and (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_48320| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@16) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@16)) 4))))
 :qid |RecoveryAddressbpl.2795:20|
 :skolemid |102|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_49265| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@17) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@17)) 3))))
 :qid |RecoveryAddressbpl.2799:20|
 :skolemid |103|
))) (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_49265| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@18) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@18)) 3))))
 :qid |RecoveryAddressbpl.2803:20|
 :skolemid |104|
)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_49265| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@19) (not (= (|l#Vec_28923| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_49265| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@19)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@19)) 3))))
 :qid |RecoveryAddressbpl.2807:20|
 :skolemid |105|
))))) (and (and (and (forall ((child_addr@@3 Int) ) (!  (=> (|$IsValid'address'| child_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr@@3)))))
 :qid |RecoveryAddressbpl.2811:20|
 :skolemid |106|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51167| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |RecoveryAddressbpl.2815:20|
 :skolemid |107|
))) (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_51282| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_51342| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@20)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) addr@@20)) 2)))))
 :qid |RecoveryAddressbpl.2819:20|
 :skolemid |108|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@21) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@21) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@21))))
 :qid |RecoveryAddressbpl.2823:20|
 :skolemid |109|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1)) ($1_Signer_is_txn_signer _$t1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |RecoveryAddressbpl.2832:20|
 :skolemid |110|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@0))
 :qid |RecoveryAddressbpl.2836:20|
 :skolemid |111|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $a_0@@0))
)))) (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $a_0@@1)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@1))
 :qid |RecoveryAddressbpl.2840:20|
 :skolemid |112|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_50099| $1_VASP_ParentVASP_$memory) $a_0@@1))
)) (= $t11 (|$addr#$signer| _$t1))) (and (= $t12 (|$addr#$signer| _$t0)) (= $t13 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t14 (|$addr#$signer| _$t0)) (= $t15  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_47993| $1_Roles_RoleId_$memory) $t14)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_47993| $1_Roles_RoleId_$memory) $t14)) 5))))))))) (and (=> (= (ControlFlow 0 67873) 69422) anon28_Then_correct) (=> (= (ControlFlow 0 67873) 67913) anon28_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28837_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.1863:13|
 :skolemid |63|
))) (= (ControlFlow 0 67244) 67873)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_12290| (|p#$Mutation_8165| $t9)) 0) (= (|l#Vec_12290| (|p#$Mutation_50501| $t27)) 0)) (and (= (|l#Vec_12290| (|p#$Mutation_8165| $t28)) 0) (= (ControlFlow 0 67254) 67244))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 80717) 67254) anon0_correct)))
