...
(declare-fun $t9 () Int)
(declare-fun _$t1 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun $t10 () Int)
...
(assert (not
 (=> (= (ControlFlow 0 0) 84681) (let ((anon26_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 72979) (- 0 85774)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr))) 0)) addr))))
 :qid |RecoveryAddressbpl.4783:15|
 :skolemid |173|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@0) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@0))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@0))) 0)) addr@@0))))
 :qid |RecoveryAddressbpl.4783:15|
 :skolemid |173|
)) (and (=> (= (ControlFlow 0 72979) (- 0 85821)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@1)))
 :qid |RecoveryAddressbpl.4789:15|
 :skolemid |174|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@2)))
 :qid |RecoveryAddressbpl.4789:15|
 :skolemid |174|
)) (and (=> (= (ControlFlow 0 72979) (- 0 85845)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@3)))
 :qid |RecoveryAddressbpl.4795:15|
 :skolemid |175|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@4)))
 :qid |RecoveryAddressbpl.4795:15|
 :skolemid |175|
 ...
 :qid |RecoveryAddressbpl.4801:15|
 :skolemid |176|
)) (and (=> (= (ControlFlow 0 72979) (- 0 85910)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@5) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@5))))
 :qid |RecoveryAddressbpl.4807:15|
 :skolemid |177|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@6) (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) addr@@6))))
 :qid |RecoveryAddressbpl.4807:15|
 :skolemid |177|
)) (and (=> (= (ControlFlow 0 72979) (- 0 85940)) (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t9))))) (=> (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t9)))) (and (=> (= (ControlFlow 0 72979) (- 0 85953)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t9))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (and (=> (= (ControlFlow 0 72979) (- 0 85963)) (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)))) (=> (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9))) (and (=> (= (ControlFlow 0 72979) (- 0 85977)) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10) (and (=> (= (ControlFlow 0 72979) (- 0 85985)) (= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10))) 1)) (=> (= (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10))) 1) (=> (= (ControlFlow 0 72979) (- 0 85999)) (= (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10))) 0) _$t1)))))))))))))))))))))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 72022) (- 0 85690)) (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t9))) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)))) (=> (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t9))) (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t9)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9))) (=> (= (ControlFlow 0 72022) (- 0 85716)) (or (or (and (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t9) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t9))) (= 7 $t15@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t9) (= 6 $t15@0))) (and (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1) $t9)) (= 7 $t15@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 72993) 72022))) L7_correct)))
(let ((anon25_Then$1_correct  (=> (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 73045) 72993) anon26_Then_correct) (=> (= (ControlFlow 0 73045) 72979) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 73043) 73045)) anon25_Then$1_correct)))
(let ((anon25_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_51427 (|Store__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0) $t25@0))) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory@0)) (and (= $abort_code@1 $abort_code@0) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 72724) 72993) anon26_Then_correct) (=> (= (ControlFlow 0 72724) 72979) anon26_Else_correct))))))
(let ((anon24_Else_correct  (=> (and (not $abort_flag@0) (= $t25@0 ($1_RecoveryAddress_RecoveryAddress |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 72702) 73043) anon25_Then_correct) (=> (= (ControlFlow 0 72702) 72724) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@0 $abort_code@0)) (and (= $t15@0 $abort_code@0) (= (ControlFlow 0 73059) 72022))) L7_correct)))
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| (|v#$Mutation_33497| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|)) (and (= $abort_flag@0 false) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|))) (and (=> (= (ControlFlow 0 72644) 73059) anon24_Then_correct) (=> (= (ControlFlow 0 72644) 72702) anon24_Else_correct))))))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_33497 (|l#$Mutation_33497| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (|p#$Mutation_33497| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (let ((l (|l#Vec_28962| (|v#$Mutation_33497| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|))))
(Vec_28962 (|Store__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|v#$Mutation_33497| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|)) l _$t1) (+ l 1))))) (and (=> (= (ControlFlow 0 72612) 72658) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 72612) 72644) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|)))))
...
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= (|l#Vec_12290| (|p#$Mutation_33497| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@0|)) 0) (=> (and (= _$t1 _$t1) (= (ControlFlow 0 72535) 72529)) |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon23_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 72684) 72535)) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon23_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t23 $t23)) (and (= $t15@0 $t23) (= (ControlFlow 0 72279) 72022))) L7_correct)))
(let ((anon22_Then$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 6)) (and (= $t23 $t23) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 72263) 72684) anon23_Then_correct) (=> (= (ControlFlow 0 72263) 72279) anon23_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t20@0)) (= (ControlFlow 0 72227) 72263)) anon22_Then$1_correct)))
(let ((anon22_Then_correct  (=> $t17@0 (=> (and (= $t20@0 (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) $t11)) (= (ControlFlow 0 72233) 72227)) inline$$Not$0$anon0_correct))))
(let ((anon22_Else_correct  (=> (and (and (not $t17@0) (= $t19 $t19)) (and (= $t15@0 $t19) (= (ControlFlow 0 72187) 72022))) L7_correct)))
(let ((anon21_Else_correct  (=> (not false) (=> (and (= $t17@0 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 $t11)) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 7)) (and (= $t19 $t19) (= $t17@0 $t17@0))) (and (=> (= (ControlFlow 0 72171) 72233) anon22_Then_correct) (=> (= (ControlFlow 0 72171) 72187) anon22_Else_correct)))))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t1 _$t1) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 72119) 73073) anon21_Then_correct) (=> (= (ControlFlow 0 72119) 72171) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and $t12 (= (ControlFlow 0 72125) 72119)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon20_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 71930) 72022))) L7_correct)))
(let ((anon0$1_correct  (=> (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) child_addr)))))
 ...
 :skolemid |167|
))) (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9) (and (> (|l#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_28962| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_51427| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9))) 0)) addr@@9))))
 ...
 :skolemid |169|
)))) (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t1)) (=> (and (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_50035| $1_VASP_ChildVASP_$memory) $a_0)))
...
)) (= $t9 (|$addr#$signer| _$t0)))) (and (and (= $t10 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t11)))) (and (and (and (= $t11 (|$addr#$signer| _$t0)) (= $t11 $t11)) (and (= $t12  (or (|Select__T@[Int]Bool_| (|domain#$Memory_50099| $1_VASP_ParentVASP_$memory) $t11) (|Select__T@[Int]Bool_| (|domain#$Memory_50035| $1_VASP_ChildVASP_$memory) $t11))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12))))) (and (=> (= (ControlFlow 0 71914) 72125) anon20_Then_correct) (=> (= (ControlFlow 0 71914) 71930) anon20_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_28837_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |RecoveryAddressbpl.1863:13|
 :skolemid |63|
))) (= (ControlFlow 0 71559) 71914)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 84681) 71559) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
