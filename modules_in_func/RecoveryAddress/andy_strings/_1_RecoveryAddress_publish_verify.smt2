...
(assert (not
 (=> (= (ControlFlow 0 0) 77137) (let ((anon26_Else_correct  (=> (not $abort_flag@1@@0) (and (=> (= (ControlFlow 0 68018) (- 0 78230)) (forall ((addr@@41 Int) ) (!  (=> (|$IsValid'address'| addr@@41) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@41) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@41))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@41)) 0)) addr@@41))))
 :qid |RecoveryAddressbpl.4745:15|
 :skolemid |159|
))) (=> (forall ((addr@@42 Int) ) (!  (=> (|$IsValid'address'| addr@@42) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@42) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@42))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@42)) 0)) addr@@42))))
 :qid |RecoveryAddressbpl.4745:15|
 :skolemid |159|
)) (and (=> (= (ControlFlow 0 68018) (- 0 78277)) (forall ((addr@@43 Int) ) (!  (=> (|$IsValid'address'| addr@@43) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@43) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@43)))
 :qid |RecoveryAddressbpl.4751:15|
 :skolemid |160|
))) (=> (forall ((addr@@44 Int) ) (!  (=> (|$IsValid'address'| addr@@44) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@44) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@44)))
 :qid |RecoveryAddressbpl.4751:15|
 :skolemid |160|
)) (and (=> (= (ControlFlow 0 68018) (- 0 78301)) (forall ((addr@@45 Int) ) (!  (=> (|$IsValid'address'| addr@@45) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@45) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@45)))
 :qid |RecoveryAddressbpl.4757:15|
 :skolemid |161|
))) (=> (forall ((addr@@46 Int) ) (!  (=> (|$IsValid'address'| addr@@46) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@46) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@46)))
 :qid |RecoveryAddressbpl.4757:15|
 :skolemid |161|
)) (and (=> (= (ControlFlow 0 68018) (- 0 78325)) (forall ((recovery_addr Int) (to_recovery_addr Int) ) (!  (=> (|$IsValid'address'| recovery_addr) (=> (|$IsValid'address'| to_recovery_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr) (=> (exists ((i@@24 Int) ) (!  (and (and (|$IsValid'u64'| i@@24) (and (<= 0 i@@24) (< i@@24 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr)) i@@24)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)) (exists ((i@@25 Int) ) (!  (and (and (|$IsValid'u64'| i@@25) (and (<= 0 i@@25) (< i@@25 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr)) i@@25)) to_recovery_addr))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))))))
 :qid |RecoveryAddressbpl.4763:15|
 :skolemid |162|
))) (=> (forall ((recovery_addr@@0 Int) (to_recovery_addr@@0 Int) ) (!  (=> (|$IsValid'address'| recovery_addr@@0) (=> (|$IsValid'address'| to_recovery_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0) (=> (exists ((i@@26 Int) ) (!  (and (and (|$IsValid'u64'| i@@26) (and (<= 0 i@@26) (< i@@26 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) recovery_addr@@0)) i@@26)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
)) (exists ((i@@27 Int) ) (!  (and (and (|$IsValid'u64'| i@@27) (and (<= 0 i@@27) (< i@@27 (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@0)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) recovery_addr@@0)) i@@27)) to_recovery_addr@@0))
 :qid |RecoveryAddressbpl.4412:13|
 :skolemid |149|
))))))
 :qid |RecoveryAddressbpl.4763:15|
 :skolemid |162|
)) (and (=> (= (ControlFlow 0 68018) (- 0 78366)) (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@47) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@47) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@47))))
 :qid |RecoveryAddressbpl.4769:15|
 :skolemid |163|
))) (=> (forall ((addr@@48 Int) ) (!  (=> (|$IsValid'address'| addr@@48) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) addr@@48) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@48) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@48))))
 :qid |RecoveryAddressbpl.4769:15|
 :skolemid |163|
)) (and (=> (= (ControlFlow 0 68018) (- 0 78396)) (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t9@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t9@@1))))) (=> (not (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t9@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t9@@1)))) (and (=> (= (ControlFlow 0 68018) (- 0 78409)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t9@@1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t9@@1)) (and (=> (= (ControlFlow 0 68018) (- 0 78419)) (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1) $t9@@1)))) (=> (not (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1) $t9@@1))) (and (=> (= (ControlFlow 0 68018) (- 0 78433)) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10@@0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10@@0) (and (=> (= (ControlFlow 0 68018) (- 0 78441)) (= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10@@0))) 1)) (=> (= (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10@@0))) 1) (=> (= (ControlFlow 0 68018) (- 0 78455)) (= (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory@1) $t10@@0)) 0) _$t1@@1)))))))))))))))))))))))))
...
(let ((L7_correct@@0  (and (=> (= (ControlFlow 0 67061) (- 0 78146)) (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t9@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t9@@1))) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t9@@1)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1) $t9@@1)))) (=> (or (or (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t9@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t9@@1))) (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t9@@1)) (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1) $t9@@1))) (=> (= (ControlFlow 0 67061) (- 0 78172)) (or (or (and (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t9@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t9@@1))) (= 7 $t15@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t9@@1) (= 6 $t15@0))) (and (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1) $t9@@1)) (= 7 $t15@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t15@0 $abort_code@1@@1) (= (ControlFlow 0 68032) 67061))) L7_correct@@0)))
(let ((anon25_Then$1_correct  (=> (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory) (=> (and (= $abort_code@1@@1 $EXEC_FAILURE_CODE) (= $abort_flag@1@@0 true)) (and (=> (= (ControlFlow 0 68084) 68032) anon26_Then_correct) (=> (= (ControlFlow 0 68084) 68018) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0@@1)) (= (ControlFlow 0 68082) 68084)) anon25_Then$1_correct)))
(let ((anon25_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0@@1))) (=> (and (and (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_47125 (|Store__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0@@1) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) (|$addr#$signer| _$t0@@1) $t25@0))) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory@0)) (and (= $abort_code@1@@1 $abort_code@0@@1) (= $abort_flag@1@@0 $abort_flag@0@@1))) (and (=> (= (ControlFlow 0 67763) 68032) anon26_Then_correct) (=> (= (ControlFlow 0 67763) 68018) anon26_Else_correct))))))
(let ((anon24_Else_correct  (=> (and (not $abort_flag@0@@1) (= $t25@0 ($1_RecoveryAddress_RecoveryAddress |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 67741) 68082) anon25_Then_correct) (=> (= (ControlFlow 0 67741) 67763) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0@@1 (= $abort_code@0@@1 $abort_code@0@@1)) (and (= $t15@0 $abort_code@0@@1) (= (ControlFlow 0 68098) 67061))) L7_correct@@0)))
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| (|v#$Mutation_31869| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|)) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|)) (and (= $abort_flag@0@@1 false) (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$ret0@1| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t1@1|))) (and (=> (= (ControlFlow 0 67683) 68098) anon24_Then_correct) (=> (= (ControlFlow 0 67683) 67741) anon24_Else_correct))))))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_31869 (|l#$Mutation_31869| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (|p#$Mutation_31869| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (seq.++ (|v#$Mutation_31869| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1|) (seq.unit _$t1@@1)))) (and (=> (= (ControlFlow 0 67651) 67697) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 67651) 67683) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon6_Else_correct|)))))
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon5_Else_correct|  (=> (and (and (not false) (= |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$v@1| |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$v@1|)) (and (= |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@1| ($Mutation_31869 ($Local 1) (as seq.empty (Seq Int)) |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$v@1|)) (= (ControlFlow 0 67657) 67651))) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((|inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$v@1| (as seq.empty (Seq T@$1_DiemAccount_KeyRotationCapability))) (and (=> (= (ControlFlow 0 67568) 67717) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon5_Then_correct|) (=> (= (ControlFlow 0 67568) 67657) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon5_Else_correct|)))))
(let ((|inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= (seq.len (|p#$Mutation_31869| |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$$t3@0|)) 0) (=> (and (= _$t1@@1 _$t1@@1) (= (ControlFlow 0 67574) 67568)) |inline$$1_Vector_empty'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((anon23_Then_correct  (=> (and inline$$Not$0$dst@1@@1 (= (ControlFlow 0 67723) 67574)) |inline$$1_Vector_singleton'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((anon23_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@1) (= $t23@@0 $t23@@0)) (and (= $t15@0 $t23@@0) (= (ControlFlow 0 67318) 67061))) L7_correct@@0)))
(let ((anon22_Then$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 6)) (and (= $t23@@0 $t23@@0) (= inline$$Not$0$dst@1@@1 inline$$Not$0$dst@1@@1))) (and (=> (= (ControlFlow 0 67302) 67723) anon23_Then_correct) (=> (= (ControlFlow 0 67302) 67318) anon23_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@1  (=> (and (= inline$$Not$0$dst@1@@1  (not $t20@0@@0)) (= (ControlFlow 0 67266) 67302)) anon22_Then$1_correct)))
(let ((anon22_Then_correct  (=> $t17@0 (=> (and (= $t20@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $t11@@1)) (= (ControlFlow 0 67272) 67266)) inline$$Not$0$anon0_correct@@1))))
(let ((anon22_Else_correct  (=> (and (and (not $t17@0) (= $t19@@0 $t19@@0)) (and (= $t15@0 $t19@@0) (= (ControlFlow 0 67226) 67061))) L7_correct@@0)))
(let ((anon21_Else_correct@@0  (=> (not false) (=> (and (= $t17@0 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 $t11@@1)) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| $t19@@0) (= $t19@@0 7)) (and (= $t19@@0 $t19@@0) (= $t17@0 $t17@0))) (and (=> (= (ControlFlow 0 67210) 67272) anon22_Then_correct) (=> (= (ControlFlow 0 67210) 67226) anon22_Else_correct)))))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= _$t1@@1 _$t1@@1) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t1@@1)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 67158) 68112) anon21_Then_correct@@0) (=> (= (ControlFlow 0 67158) 67210) anon21_Else_correct@@0))))))
(let ((anon20_Then_correct@@0  (=> (and $t12@@1 (= (ControlFlow 0 67164) 67158)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((anon20_Else_correct@@0  (=> (and (and (not $t12@@1) (= $t14@@1 $t14@@1)) (and (= $t15@0 $t14@@1) (= (ControlFlow 0 66969) 67061))) L7_correct@@0)))
(let ((anon0$1_correct@@1  (=> (forall ((child_addr@@7 Int) ) (!  (=> (|$IsValid'address'| child_addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) child_addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) child_addr@@7)))))
 :qid |RecoveryAddressbpl.4478:20|
 :skolemid |151|
)) (=> (and (and (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (= (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@49)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_43878| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_43878| $1_Roles_RoleId_$memory) addr@@49)) 5))))
 :qid |RecoveryAddressbpl.4482:20|
 :skolemid |152|
)) (forall ((addr@@50 Int) ) (!  (=> (|$IsValid'address'| addr@@50) (= (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@50)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_43878| $1_Roles_RoleId_$memory) addr@@50) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_43878| $1_Roles_RoleId_$memory) addr@@50)) 6))))
 :qid |RecoveryAddressbpl.4486:20|
 :skolemid |153|
))) (and (forall ((addr@@51 Int) ) (!  (=> (|$IsValid'address'| addr@@51) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@51) (and (> (seq.len (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@51))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@51)) 0)) addr@@51))))
 :qid |RecoveryAddressbpl.4490:20|
 :skolemid |154|
)) (forall ((addr@@52 Int) ) (!  (=> (|$IsValid'address'| addr@@52) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@52) (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) addr@@52) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) addr@@52))))
 :qid |RecoveryAddressbpl.4494:20|
 :skolemid |155|
)))) (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@1)) ($1_Signer_is_txn_signer _$t0@@1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@1))) (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t1@@1)) (=> (and (and (and (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $a_0@@6)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@6))
 :qid |RecoveryAddressbpl.4503:20|
 :skolemid |156|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_45737| $1_VASP_ChildVASP_$memory) $a_0@@6))
)) (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_45801| $1_VASP_ParentVASP_$memory) $a_0@@7)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@7))
 :qid |RecoveryAddressbpl.4507:20|
 :skolemid |157|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_45801| $1_VASP_ParentVASP_$memory) $a_0@@7))
))) (and (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@8)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@8))
 :qid |RecoveryAddressbpl.4511:20|
 :skolemid |158|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_47125| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@8))
)) (= $t9@@1 (|$addr#$signer| _$t0@@1)))) (and (and (= $t10@@0 (|$addr#$signer| _$t0@@1)) (= _$t0@@1 _$t0@@1)) (and (= _$t1@@1 _$t1@@1) (|$IsValid'address'| $t11@@1)))) (and (and (and (= $t11@@1 (|$addr#$signer| _$t0@@1)) (= $t11@@1 $t11@@1)) (and (= $t12@@1  (or (|Select__T@[Int]Bool_| (|domain#$Memory_45801| $1_VASP_ParentVASP_$memory) $t11@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_45737| $1_VASP_ChildVASP_$memory) $t11@@1))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14@@1) (= $t14@@1 7)) (and (= $t14@@1 $t14@@1) (= $t12@@1 $t12@@1))))) (and (=> (= (ControlFlow 0 66953) 67164) anon20_Then_correct@@0) (=> (= (ControlFlow 0 66953) 66969) anon20_Else_correct@@0))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_28061_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_28061| stream@@2) 0) (forall ((v@@25 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_28061| stream@@2) v@@25) 0)
 :qid |RecoveryAddressbpl.134:13|
 :skolemid |2|
))))
 :qid |RecoveryAddressbpl.1832:13|
 :skolemid |49|
))) (= (ControlFlow 0 66598) 66953)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 77137) 66598) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
