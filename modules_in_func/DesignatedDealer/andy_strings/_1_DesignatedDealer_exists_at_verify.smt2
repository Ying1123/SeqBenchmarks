...
(assert (not
 (=> (= (ControlFlow 0 0) 152317) (let ((anon0$1_correct@@0  (=> (|$IsValid'address'| _$t0@@0) (=> (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $a_0@@4)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc@@4))
 :qid |DesignatedDealerbpl.6534:20|
 :skolemid |292|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) $a_0@@4))
)) (= _$t0@@0 _$t0@@0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) _$t0@@0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 129600) (- 0 152410)) (not false)) (=> (not false) (=> (= (ControlFlow 0 129600) (- 0 152417)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_92161| $1_DesignatedDealer_Dealer_$memory) _$t0@@0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_52020_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_52020| stream@@1) 0) (forall ((v@@38 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_52020| stream@@1) v@@38) 0)
 :qid |DesignatedDealerbpl.134:13|
 :skolemid |2|
))))
 :qid |DesignatedDealerbpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 129516) 129600)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 152317) 129516) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))
))
(check-sat)
(pop 1)
