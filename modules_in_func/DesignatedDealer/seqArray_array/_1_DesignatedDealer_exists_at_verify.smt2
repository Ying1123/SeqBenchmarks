...
(assert (not
 (=> (= (ControlFlow 0 0) 166959) (let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $a_0)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc))
 :qid |DesignatedDealerbpl.6606:20|
 :skolemid |316|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 139498) (- 0 167052)) (not false)) (=> (not false) (=> (= (ControlFlow 0 139498) (- 0 167059)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) _$t0)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_53699_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DesignatedDealerbpl.2768:13|
 :skolemid |98|
))) (= (ControlFlow 0 139414) 139498)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 166959) 139414) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
