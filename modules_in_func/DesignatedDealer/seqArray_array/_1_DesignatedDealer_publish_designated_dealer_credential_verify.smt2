...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory| () T@$Memory_96638)
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory| () T@$Memory_96226)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_89836)
(declare-fun |Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|T@[Int]$1_Diem_CurrencyInfo'#0'| Int) |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory| () T@$Memory_96872)
(declare-fun |$1_Diem_Preburn'#0'_$memory| () T@$Memory_96388)
(declare-fun $1_DesignatedDealer_Dealer_$memory@1 () T@$Memory_101340)
(declare-fun |$temp_0'bool'@1| () Bool)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1| () T@$Memory_96638)
(declare-fun |Store__T@[Int]Bool_| (|T@[Int]Bool| Int Bool) |T@[Int]Bool|)
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?x2 Bool)) (! (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Bool)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Bool_| ?x0 ?y1))) :weight 0)))
(declare-fun $t20 () Int)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0| () T@$Memory_96638)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1| () T@$Memory_96872)
(declare-fun $t24 () Int)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0| () T@$Memory_96872)
...
(declare-fun $1_DesignatedDealer_Dealer_$memory@0 () T@$Memory_101340)
...
(declare-fun |$1_Diem_MintCapability'#0'_$memory| () T@$Memory_90368)
...
(assert (not
 (=> (= (ControlFlow 0 0) 167079) (let ((L5_correct  (and (=> (= (ControlFlow 0 141990) (- 0 170076)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t6))) (and (=> (= (ControlFlow 0 141990) (- 0 170088)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) 1))) (and (=> (= (ControlFlow 0 141990) (- 0 170106)) (not (not (= (|$addr#$signer| _$t1) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t1) 186537453))) (and (=> (= (ControlFlow 0 141990) (- 0 170120)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t7))) (and (=> (= (ControlFlow 0 141990) (- 0 170132)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) 2)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) 2))) (and (=> (= (ControlFlow 0 141990) (- 0 170150)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t5))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t5)) (and (=> (= (ControlFlow 0 141990) (- 0 170160)) (not (and _$t2 (let ((addr 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr))))))) (=> (not (and _$t2 (let ((addr@@0 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@0) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@0)))))) (and (=> (= (ControlFlow 0 141990) (- 0 170171)) (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5)))) (=> (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5))) (and (=> (= (ControlFlow 0 141990) (- 0 170184)) (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5)))) (=> (not (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5))) (and (=> (= (ControlFlow 0 141990) (- 0 170197)) (not (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (not (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 141990) (- 0 170210)) (not (and (not _$t2) (let ((addr@@1 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@1) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@1))))))) (=> (not (and (not _$t2) (let ((addr@@2 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@2) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@2)))))) (and (=> (= (ControlFlow 0 141990) (- 0 170223)) (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t5)))) (=> (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t5))) (and (=> (= (ControlFlow 0 141990) (- 0 170238)) (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t5)))) (=> (not (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t5))) (and (=> (= (ControlFlow 0 141990) (- 0 170253)) (not (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (= (ControlFlow 0 141990) (- 0 170268)) (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) $t5))))))))))))))))))))))))))))))))
(let ((anon38_Else_correct  (=> (not |$temp_0'bool'@1|) (=> (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1| ($Memory_96638 (|Store__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20 false) (|contents#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|))) (= (ControlFlow 0 142362) 141990)) L5_correct))))
(let ((anon38_Then_correct  (=> |$temp_0'bool'@1| (=> (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0| ($Memory_96638 (|Store__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20 true) (|Store__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20 |$temp_0'$1_Diem_PreburnQueue'$1_XUS_XUS''@0|))) (= (ControlFlow 0 142376) 141990)) L5_correct))))
(let ((anon37_Else_correct  (=> (not $t23) (and (=> (= (ControlFlow 0 142350) 142376) anon38_Then_correct) (=> (= (ControlFlow 0 142350) 142362) anon38_Else_correct)))))
(let ((anon28_correct  (=> (= (ControlFlow 0 141778) 141990) L5_correct)))
(let ((anon40_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_96872 (|Store__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 false) (|contents#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|))) (= (ControlFlow 0 141774) 141778)) anon28_correct))))
(let ((anon40_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_96872 (|Store__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t24 |$temp_0'$1_Diem_PreburnQueue'#0''@0|))) (= (ControlFlow 0 142002) 141778)) anon28_correct))))
(let ((anon39_Else_correct  (=> (not $t27) (and (=> (= (ControlFlow 0 141762) 142002) anon40_Then_correct) (=> (= (ControlFlow 0 141762) 141774) anon40_Else_correct)))))
(let ((anon33_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 141447) (- 0 169632)) (or (or (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t7))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) 2))) (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t5)) (and _$t2 (let ((addr@@3 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@3) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@3)))))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5))) (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (not _$t2) (let ((addr@@4 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@4) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@4)))))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t5))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t5))) (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (or (or (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t7))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) 2))) (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t5)) (and _$t2 (let ((addr@@5 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@5) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@5)))))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5))) (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5))) (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (not _$t2) (let ((addr@@6 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@6) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@6)))))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t5))) (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t5))) (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (= (ControlFlow 0 141447) (- 0 169780)) (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) (= 5 $t10@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t10@0))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t10@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) (= 5 $t10@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t7)) 2)) (= 3 $t10@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t5) (= 6 $t10@0))) (and (and _$t2 (let ((addr@@7 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@7) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@7))))) (= 7 $t10@0))) (and (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t5)) (= 6 $t10@0))) (and (and _$t2 (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t5)) (= 1 $t10@0))) (and (and _$t2 (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= 5 $t10@0))) (and (and (not _$t2) (let ((addr@@8 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@8))))) (= 7 $t10@0))) (and (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t5)) (= 6 $t10@0))) (and (and (not _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t5)) (= 1 $t10@0))) (and (and (not _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 5 $t10@0))))))))
(let ((anon37_Then_correct  (=> $t23 (=> (and (and (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t21)) (= 5 $t10)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t21)) 1)) (= 3 $t10))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t22)) (= 5 $t10))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t22)) 2)) (= 3 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) $t20)) (= 5 $t10))) (and (let ((addr@@9 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@9) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@9)))) (= 7 $t10))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20) (= 6 $t10))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t20) (= 1 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 142570) 141447))) L7_correct))))
(let ((anon36_Then_correct  (=> (and (and _$t2 (= $t20 (|$addr#$signer| _$t0))) (and (= $t21 (|$addr#$signer| _$t1)) (= $t22 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 142344) (- 0 168919)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t20)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t20) (=> (= $t23  (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t21)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t21)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t22))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t22)) 2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) $t20))) (let ((addr@@10 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@10) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) addr@@10))))) (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $t20)) (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $t20)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 142344) 142570) anon37_Then_correct) (=> (= (ControlFlow 0 142344) 142350) anon37_Else_correct))))))))
(let ((anon39_Then_correct  (=> $t27 (=> (and (and (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t25)) (= 5 $t10)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t25)) 1)) (= 3 $t10))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t26)) (= 5 $t10))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t26)) 2)) (= 3 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) $t24)) (= 5 $t10))) (and (let ((addr@@11 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@11) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@11)))) (= 7 $t10))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t24) (= 6 $t10))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t24) (= 1 $t10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 142196) 141447))) L7_correct))))
(let ((anon36_Else_correct  (=> (and (and (not _$t2) (= $t24 (|$addr#$signer| _$t0))) (and (= $t25 (|$addr#$signer| _$t1)) (= $t26 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 141756) (- 0 169065)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t24)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t24) (=> (= $t27  (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t25)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t25)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t26))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t26)) 2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) $t24))) (let ((addr@@12 173345816))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@12) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) addr@@12))))) (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $t24)) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $t24)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 141756) 142196) anon39_Then_correct) (=> (= (ControlFlow 0 141756) 141762) anon39_Else_correct))))))))
(let ((anon35_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 141606) (- 0 168861)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) addr@@13)))
 :qid |DesignatedDealerbpl.7074:15|
 :skolemid |354|
))) (=> (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory@1) addr@@14)))
 :qid |DesignatedDealerbpl.7074:15|
 :skolemid |354|
)) (and (=> (= (ControlFlow 0 141606) 142344) anon36_Then_correct) (=> (= (ControlFlow 0 141606) 141756) anon36_Else_correct)))))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 142584) 141447))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $1_DesignatedDealer_Dealer_$memory@1 $1_DesignatedDealer_Dealer_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 142636) 142584) anon35_Then_correct) (=> (= (ControlFlow 0 142636) 141606) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 142634) 142636)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DesignatedDealer_Dealer_$memory@0 ($Memory_101340 (|Store__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) (|$addr#$signer| _$t0) $t19@0))) (= $1_DesignatedDealer_Dealer_$memory@1 $1_DesignatedDealer_Dealer_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 141571) 142584) anon35_Then_correct) (=> (= (ControlFlow 0 141571) 141606) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not false) (= $t19@0 ($1_DesignatedDealer_Dealer |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 141549) (- 0 168760)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 141549) 142634) anon34_Then_correct) (=> (= (ControlFlow 0 141549) 141571) anon34_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 141517) 142650) anon33_Then_correct) (=> (= (ControlFlow 0 141517) 141549) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 141523) 141517)) |inline$$1_Event_new_event_handle'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|)))
(let ((anon32_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t17 $t17)) (and (= $t10@0 $t17) (= (ControlFlow 0 140987) 141447))) L7_correct)))
(let ((anon31_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t17) (= $t17 6)) (and (= $t17 $t17) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 140971) 141523) anon32_Then_correct) (=> (= (ControlFlow 0 140971) 140987) anon32_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t14@0)) (= (ControlFlow 0 140935) 140971)) anon31_Else$1_correct)))
(let ((anon31_Else_correct  (=> (not $t12) (=> (and (and (|$IsValid'address'| $t13) (= $t13 (|$addr#$signer| _$t0))) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $t13)) (= (ControlFlow 0 140941) 140935))) inline$$Not$0$anon0_correct))))
(let ((anon31_Then_correct  (=> $t12 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t11)) (= 5 $t10)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t11)) 2)) (= 3 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 142702) 141447))) L7_correct))))
(let ((anon30_Else_correct  (=> (not $t9) (=> (and (= $t11 (|$addr#$signer| _$t0)) (= $t12  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t11)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t11)) 2))))) (and (=> (= (ControlFlow 0 140879) 142702) anon31_Then_correct) (=> (= (ControlFlow 0 140879) 140941) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> $t9 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t8)) (= 5 $t10)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t8)) 1)) (= 3 $t10))) (and (not (= (|$addr#$signer| _$t1) 186537453)) (= 2 $t10))) (= $t10 $t10)) (and (= $t10@0 $t10) (= (ControlFlow 0 142774) 141447))) L7_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@15)) 0)) (= addr@@15 173345816)))
 :qid |DesignatedDealerbpl.6701:20|
 :skolemid |317|
)) (=> (and (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@16)) 1)) (= addr@@16 186537453)))
 :qid |DesignatedDealerbpl.6705:20|
 :skolemid |318|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@17)) 2))))))
 :qid |DesignatedDealerbpl.6709:20|
 :skolemid |319|
))) (=> (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@18)) 2))))))
 :qid |DesignatedDealerbpl.6713:20|
 :skolemid |320|
)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@19)) 2))))))
 :qid |DesignatedDealerbpl.6717:20|
 :skolemid |321|
))) (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@20)) 2))))))
 :qid |DesignatedDealerbpl.6721:20|
 :skolemid |322|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@21)) 2)))))
 :qid |DesignatedDealerbpl.6725:20|
 :skolemid |323|
)))) (=> (and (and (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@22)) 2)))))
 :qid |DesignatedDealerbpl.6729:20|
 :skolemid |324|
)) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@23)) 2)))))
 :qid |DesignatedDealerbpl.6733:20|
 :skolemid |325|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_87918| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@24)) 4))))
 :qid |DesignatedDealerbpl.6737:20|
 :skolemid |326|
)) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_88421| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@25) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@25)) 3))))
 :qid |DesignatedDealerbpl.6741:20|
 :skolemid |327|
)))) (and (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_88421| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@26) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@26)) 3))))
 :qid |DesignatedDealerbpl.6745:20|
 :skolemid |328|
)) (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_88421| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@27) (not (= (|l#Vec_53785| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_88421| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@27)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@27)) 3))))
 ...
 :qid |DesignatedDealerbpl.6753:104|
 :skolemid |330|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@0 Int) (mint_cap_owner2@@0 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@0) (=> (|$IsValid'address'| mint_cap_owner2@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_90368| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_90368| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@0)) (= mint_cap_owner1@@0 mint_cap_owner2@@0))))
 :qid |DesignatedDealerbpl.6757:88|
 :skolemid |331|
)))))) (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90240| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |DesignatedDealerbpl.6761:20|
 :skolemid |332|
)) (forall ((addr3@@0 Int) ) (!  (=> (|$IsValid'address'| addr3@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90368| |$1_Diem_MintCapability'#0'_$memory|) addr3@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |DesignatedDealerbpl.6765:20|
 :skolemid |333|
))) (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr1)) 2))))
 :qid |DesignatedDealerbpl.6769:20|
 :skolemid |334|
)) (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) addr1@@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@0)) 2))))
 :qid |DesignatedDealerbpl.6773:20|
 :skolemid |335|
)))) (and (and (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr)))))
 :qid |DesignatedDealerbpl.6777:20|
 :skolemid |336|
)) (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@0)))))
 :qid |DesignatedDealerbpl.6781:20|
 :skolemid |337|
))) (and (forall ((dd_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) dd_addr@@1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) dd_addr@@1))))
 :qid |DesignatedDealerbpl.6785:20|
 :skolemid |338|
)) (forall ((dd_addr@@2 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@2))))
 :qid |DesignatedDealerbpl.6789:20|
 :skolemid |339|
)))))) (=> (and (and (and (and (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |DesignatedDealerbpl.6793:20|
 :skolemid |340|
)) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DesignatedDealerbpl.6797:20|
 :skolemid |341|
))) (and (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100485| $1_DualAttestation_Credential_$memory) addr1@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr1@@1)) 2)))))
 :qid |DesignatedDealerbpl.6801:20|
 :skolemid |342|
)) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_103100| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@30) (|Select__T@[Int]Bool_| (|domain#$Memory_103160| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@30)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) addr@@30)) 2)))))
 :qid |DesignatedDealerbpl.6805:20|
 :skolemid |343|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1)) ($1_Signer_is_txn_signer _$t1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DesignatedDealerbpl.6817:20|
 :skolemid |344|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0)))
 ...
 :qid |DesignatedDealerbpl.6821:20|
 :skolemid |345|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_89598| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $a_0@@1)))
(|$IsValid'$1_Diem_Preburn'$1_XUS_XUS''| $rsc@@1))
 :qid |DesignatedDealerbpl.6825:20|
 :skolemid |346|
 :pattern ( (|Select__T@[Int]$1_Diem_Preburn'$1_XUS_XUS'_| (|contents#$Memory_96226| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@2)))
 (and (|$IsValid'$1_Diem_PreburnQueue'$1_XUS_XUS''| $rsc@@2) (and (<= (|l#Vec_54153| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)) 256) (let (($range_1 ($Range 0 (|l#Vec_54153| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@90 $i_2))
(> (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_54153| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)) i@@90)))) 0)))
 :qid |DesignatedDealerbpl.6830:223|
 :skolemid |347|
))))))
 :qid |DesignatedDealerbpl.6829:20|
 :skolemid |348|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_96638| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@2))
)))))) (and (and (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@3)))
 ...
 :qid |DesignatedDealerbpl.6834:20|
 :skolemid |349|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_89836| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $a_0@@4)))
(|$IsValid'$1_Diem_Preburn'#0''| $rsc@@4))
 :qid |DesignatedDealerbpl.6838:20|
 :skolemid |350|
 :pattern ( (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_96388| |$1_Diem_Preburn'#0'_$memory|) $a_0@@4))
))) (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@5)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@5) (and (<= (|l#Vec_54231| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@5)) 256) (let (($range_1@@0 ($Range 0 (|l#Vec_54231| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@5)))))
(forall (($i_2@@0 Int) ) (!  (=> ($InRange $range_1@@0 $i_2@@0) (let ((i@@91 $i_2@@0))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_54231| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@5)) i@@91)))) 0)))
 :qid |DesignatedDealerbpl.6843:199|
 :skolemid |351|
))))))
 :qid |DesignatedDealerbpl.6842:20|
 :skolemid |352|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_96872| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@5))
)) (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $a_0@@6)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc@@6))
 :qid |DesignatedDealerbpl.6847:20|
 :skolemid |353|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_101340| $1_DesignatedDealer_Dealer_$memory) $a_0@@6))
)))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= $t6 (|$addr#$signer| _$t1))) (and (= $t7 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies $t5)))) (and (and (and (|Select__T@[Int]Bool_| $1_Event_EventHandleGenerator_$modifies $t5) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t5)) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$modifies| $t5) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= $t8 (|$addr#$signer| _$t1)) (= $t9  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_87591| $1_Roles_RoleId_$memory) $t8)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_87591| $1_Roles_RoleId_$memory) $t8)) 1))) (not (= (|$addr#$signer| _$t1) 186537453))))))))) (and (=> (= (ControlFlow 0 140833) 142774) anon30_Then_correct) (=> (= (ControlFlow 0 140833) 140879) anon30_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_53699_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_53699| stream@@0) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_53699| stream@@0) v@@46) 0)
 :qid |DesignatedDealerbpl.159:13|
 :skolemid |4|
))))
 :qid |DesignatedDealerbpl.2768:13|
 :skolemid |98|
))) (= (ControlFlow 0 139562) 140833)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 167079) 139562) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
