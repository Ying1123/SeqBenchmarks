...
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@1 () T@$Memory_64162)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun $1_DiemId_DiemIdDomainManager_$memory@0 () T@$Memory_64162)
...
(declare-fun $t13@0 () T@$1_DiemId_DiemIdDomainManager)
...
(assert (not
 (=> (= (ControlFlow 0 0) 102420) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 88035) (- 0 103775)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 88035) (- 0 103787)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 88035) (- 0 103805)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 88035) (- 0 103819)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 88035) (- 0 103827)) (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory@1) (|$addr#$signer| _$t0))))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 87839) (- 0 103657)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 87839) (- 0 103695)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 88049) 87839))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 88101) 88049) anon18_Then_correct) (=> (= (ControlFlow 0 88101) 88035) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 88099) 88101)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DiemId_DiemIdDomainManager_$memory@0 ($Memory_64162 (|Store__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0) $t13@0))) (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 87963) 88049) anon18_Then_correct) (=> (= (ControlFlow 0 87963) 88035) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t13@0 ($1_DiemId_DiemIdDomainManager |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 87941) (- 0 103552)) (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 87941) 88099) anon17_Then_correct) (=> (= (ControlFlow 0 87941) 87963) anon17_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 87911) 88115) anon16_Then_correct) (=> (= (ControlFlow 0 87911) 87941) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 87917) 87911)) |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t11 $t11)) (and (= $t6@0 $t11) (= (ControlFlow 0 87715) 87839))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11) (= $t11 6)) (and (= $t11 $t11) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 87699) 87917) anon15_Then_correct) (=> (= (ControlFlow 0 87699) 87715) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t8@0)) (= (ControlFlow 0 87659) 87699)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) $t7)) (= (ControlFlow 0 87665) 87659))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 88187) 87839))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 ...
 :qid |DiemIdbpl.4747:20|
 :skolemid |196|
)) (let (($range_0 ($Range 0 (|l#Vec_34051| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemIdbpl.4806:20|
 :skolemid |210|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc@@0))
 :qid |DiemIdbpl.4810:20|
 :skolemid |211|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_64162| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_58971| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 87603) 88187) anon14_Then_correct) (=> (= (ControlFlow 0 87603) 87665) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 86763) 87603)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 102420) 86763) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
