...
(declare-fun $t11 () T@$1_DiemId_DiemIdDomains)
...
(assert (not
 (=> (= (ControlFlow 0 0) 101273) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1| |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1|)) (and (=> (= (ControlFlow 0 86196) (- 0 102096)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0))) (and (=> (= (ControlFlow 0 86196) (- 0 102107)) (not (> (|l#Vec_14776| _$t1) 63))) (=> (not (> (|l#Vec_14776| _$t1) 63)) (=> (= (ControlFlow 0 86196) (- 0 102119)) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1| (exists ((i@@68 Int) ) (!  (and (and (|$IsValid'u64'| i@@68) (InRangeVec_29507 (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) i@@68)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0))) i@@68)) (|$domain#$1_DiemId_DiemIdDomain| $t6)))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 85622) (- 0 102033)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (> (|l#Vec_14776| _$t1) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (> (|l#Vec_14776| _$t1) 63)) (=> (= (ControlFlow 0 85622) (- 0 102048)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (= 5 $t10@0)) (and (> (|l#Vec_14776| _$t1) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 86210) 85622))) L3_correct)))
(let ((|inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1| (exists ((i@@69 Int) ) (!  (and (and (|$IsValid'u64'| i@@69) (InRangeVec_29507 $t13@0 i@@69)) (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| $t13@0) i@@69)) (|$domain#$1_DiemId_DiemIdDomain| inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)))
 :qid |DiemIdbpl.988:13|
 :skolemid |35|
))) (and (=> (= (ControlFlow 0 86130) 86210) anon18_Then_correct) (=> (= (ControlFlow 0 86130) 86196) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1)) (and (= $t13@0 (|$domains#$1_DiemId_DiemIdDomains| $t11@1)) (= (ControlFlow 0 86136) 86130))) |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t10@0 $abort_code@2) (= (ControlFlow 0 86224) 85622))) L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$L3_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_DiemId_create_diem_id_domain$0$$t4@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 86032) 86224) anon17_Then_correct) (=> (= (ControlFlow 0 86032) 86136) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= (ControlFlow 0 86026) 86032))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 86064) 86032))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 ($1_DiemId_DiemIdDomain _$t1))) (=> (and (and (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1 inline$$1_DiemId_create_diem_id_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 86050) 86224) anon17_Then_correct) (=> (= (ControlFlow 0 86050) 86136) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 7)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 86010) 86050) inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 86010) 86026) inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 85974) 86010)) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 85980) 85974)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_14776| _$t1)) (and (=> (= (ControlFlow 0 85914) 86064) inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 85914) 85980) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct)))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon0_correct  (=> (and (= _$t1 _$t1) (= (ControlFlow 0 85920) 85914)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 86070) 85920)) inline$$1_DiemId_create_diem_id_domain$0$anon0_correct))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 86238) 85622))) L3_correct)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 86290) 86238) anon16_Then_correct) (=> (= (ControlFlow 0 86290) 86070) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (= (ControlFlow 0 86288) 86290)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 85640) 86238) anon16_Then_correct) (=> (= (ControlFlow 0 85640) 86070) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 85626) 86288) anon15_Then_correct) (=> (= (ControlFlow 0 85626) 85640) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 85562) 85622))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (|$IsValid'address'| _$t0) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $a_0)))
 (and (|$IsValid'$1_DiemId_DiemIdDomains'| $rsc) (and (and (let (($range_1 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@70 $i_2))
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)) i@@70))) 63)))
 :qid |DiemIdbpl.4447:136|
 :skolemid |174|
))) (let (($range_3 ($Range 0 (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@71 $i_4))
(let (($range_5 ($Range (+ i@@71 1) (|l#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@21 $i_6))
 (not (|$IsEqual'vec'u8''| (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)) i@@71)) (|$domain#$1_DiemId_DiemIdDomain| (|Select__T@[Int]$1_DiemId_DiemIdDomain_| (|v#Vec_34312| (|$domains#$1_DiemId_DiemIdDomains| $rsc)) j@@21))))))
 :qid |DiemIdbpl.4449:96|
 :skolemid |175|
)))))
 :qid |DiemIdbpl.4448:196|
 :skolemid |176|
...
(<= (|l#Vec_14776| (|$domain#$1_DiemId_DiemIdDomain| $elem)) 63)))
 :qid |DiemIdbpl.4450:221|
 :skolemid |177|
))))))
 :qid |DiemIdbpl.4446:20|
 :skolemid |178|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) $a_0))
)) (= $t6 ($1_DiemId_DiemIdDomain _$t1)))) (=> (and (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_64098| $1_DiemId_DiemIdDomains_$memory) _$t0)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 85546) 85626) anon14_Then_correct) (=> (= (ControlFlow 0 85546) 85562) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_33809_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemIdbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 85274) 85546)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 101273) 85274) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
