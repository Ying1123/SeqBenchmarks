...
(assert (not
 (=> (= (ControlFlow 0 0) 92212) (let ((anon18_Else_correct@@0  (=> (not $abort_flag@0@@1) (and (=> (= (ControlFlow 0 81479) (- 0 93567)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 81479) (- 0 93579)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 81479) (- 0 93597)) (not (not (= (|$addr#$signer| _$t0@@3) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@3) 186537453))) (and (=> (= (ControlFlow 0 81479) (- 0 93611)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 81479) (- 0 93619)) (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory@1) (|$addr#$signer| _$t0@@3))))))))))))))
(let ((anon16_Then_correct@@0 true))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 81283) (- 0 93449)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 81283) (- 0 93487)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct@@0  (=> (and (and $abort_flag@0@@1 (= $abort_code@1@@1 $abort_code@1@@1)) (and (= $t6@0 $abort_code@1@@1) (= (ControlFlow 0 81493) 81283))) L3_correct@@1)))
(let ((anon17_Then$1_correct  (=> (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory) (=> (and (= $abort_flag@0@@1 true) (= $abort_code@1@@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 81545) 81493) anon18_Then_correct@@0) (=> (= (ControlFlow 0 81545) 81479) anon18_Else_correct@@0))))))
(let ((anon17_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3)) (= (ControlFlow 0 81543) 81545)) anon17_Then$1_correct)))
(let ((anon17_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3))) (=> (and (and (= $1_DiemId_DiemIdDomainManager_$memory@0 ($Memory_57968 (|Store__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3) true) (|Store__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) (|$addr#$signer| _$t0@@3) $t13@0@@0))) (= $1_DiemId_DiemIdDomainManager_$memory@1 $1_DiemId_DiemIdDomainManager_$memory@0)) (and (= $abort_flag@0@@1 false) (= $abort_code@1@@1 $abort_code@0@@1))) (and (=> (= (ControlFlow 0 81407) 81493) anon18_Then_correct@@0) (=> (= (ControlFlow 0 81407) 81479) anon18_Else_correct@@0))))))
(let ((anon16_Else_correct@@0  (=> (and (not false) (= $t13@0@@0 ($1_DiemId_DiemIdDomainManager |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 81385) (- 0 93344)) (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3))) (=> (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (and (=> (= (ControlFlow 0 81385) 81543) anon17_Then_correct@@0) (=> (= (ControlFlow 0 81385) 81407) anon17_Else_correct@@0)))))))
(let ((|inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 81355) 81559) anon16_Then_correct@@0) (=> (= (ControlFlow 0 81355) 81385) anon16_Else_correct@@0)))))
(let ((anon15_Then_correct@@0  (=> (and inline$$Not$0$dst@1@@0 (= (ControlFlow 0 81361) 81355)) |inline$$1_Event_new_event_handle'$1_DiemId_DiemIdDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct@@0  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t11@@1 $t11@@1)) (and (= $t6@0 $t11@@1) (= (ControlFlow 0 81159) 81283))) L3_correct@@1)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11@@1) (= $t11@@1 6)) (and (= $t11@@1 $t11@@1) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 81143) 81361) anon15_Then_correct@@0) (=> (= (ControlFlow 0 81143) 81159) anon15_Else_correct@@0))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t8@0)) (= (ControlFlow 0 81103) 81143)) anon14_Else$1_correct)))
(let ((anon14_Else_correct@@0  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0@@3))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) $t7)) (= (ControlFlow 0 81109) 81103))) inline$$Not$0$anon0_correct@@0))))
(let ((anon14_Then_correct@@0  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6@@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6@@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 $t6@@0))) (= $t6@@0 $t6@@0)) (and (= $t6@0 $t6@@0) (= (ControlFlow 0 81631) 81283))) L3_correct@@1))))
(let ((anon0$1_correct@@4  (=> (and (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@25)) 0)) (= addr@@25 173345816)))
 :qid |DiemIdbpl.4652:20|
 :skolemid |166|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53208| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@26)) 1)) (= addr@@26 186537453)))
 :qid |DiemIdbpl.4660:20|
 :skolemid |167|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53208| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@27)) 2))))))
 :qid |DiemIdbpl.4668:20|
 :skolemid |168|
)) (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@28)) 2))))))
 :qid |DiemIdbpl.4672:20|
 :skolemid |169|
))) (and (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@29)) 2))))))
 :qid |DiemIdbpl.4676:20|
 :skolemid |170|
)) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@30)) 2))))))
 :qid |DiemIdbpl.4680:20|
 :skolemid |171|
)))) (and (and (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@31)) 2)))))
 :qid |DiemIdbpl.4684:20|
 :skolemid |172|
)) (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@32)) 2)))))
 :qid |DiemIdbpl.4688:20|
 :skolemid |173|
))) (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@33)) 2)))))
 :qid |DiemIdbpl.4692:20|
 :skolemid |174|
)) (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_53657| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@34) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@34)) 4))))
 :qid |DiemIdbpl.4696:20|
 :skolemid |175|
))))) (=> (and (and (and (and (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@35) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@35)) 3))))
 :qid |DiemIdbpl.4700:20|
 :skolemid |176|
)) (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@36) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@36)) 3))))
 :qid |DiemIdbpl.4704:20|
 :skolemid |177|
))) (and (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@37) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@37)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@37)) 3))))
 :qid |DiemIdbpl.4708:20|
 :skolemid |178|
)) (let (($range_0@@12 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@38 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@38))))))))
(forall (($i_1@@12 Int) ) (!  (=> ($InRange $range_0@@12 $i_1@@12) (let ((i1@@0 $i_1@@12))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@39 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@39)))) i1@@0))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@39 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_54633| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@39)))) i1@@0)))) 3))))
 :qid |DiemIdbpl.4712:151|
 :skolemid |179|
))))) (and (and (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_55917| $1_DualAttestation_Credential_$memory) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DiemIdbpl.4717:20|
 :skolemid |180|
)) (forall ((addr@@40 Int) ) (!  (=> (|$IsValid'address'| addr@@40) (= (|Select__T@[Int]Bool_| (|domain#$Memory_56772| $1_DiemAccount_DiemAccount_$memory) addr@@40) (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@40)))
 :qid |DiemIdbpl.4721:20|
 :skolemid |181|
))) (and (forall ((addr@@41 Int) ) (!  (=> (|$IsValid'address'| addr@@41) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55541| $1_VASPDomain_VASPDomainManager_$memory) addr@@41)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@41)) 1))))
 :qid |DiemIdbpl.4725:20|
 :skolemid |182|
)) (forall ((addr@@42 Int) ) (!  (=> (|$IsValid'address'| addr@@42) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55640| $1_VASPDomain_VASPDomains_$memory) addr@@42)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@42) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@42)) 5))))
 :qid |DiemIdbpl.4729:20|
 :skolemid |183|
))))) (and (and (and (forall ((addr@@43 Int) ) (!  (=> (|$IsValid'address'| addr@@43) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_57302| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@43) (|Select__T@[Int]Bool_| (|domain#$Memory_57393| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@43)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@43)) 2)))))
 :qid |DiemIdbpl.4733:20|
 :skolemid |184|
)) (forall ((addr@@44 Int) ) (!  (=> (|$IsValid'address'| addr@@44) (= (|Select__T@[Int]Bool_| (|domain#$Memory_56611| $1_DesignatedDealer_Dealer_$memory) addr@@44)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@44)) 2))))
 :qid |DiemIdbpl.4737:20|
 :skolemid |185|
))) (and (forall ((addr@@45 Int) ) (!  (=> (|$IsValid'address'| addr@@45) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55917| $1_DualAttestation_Credential_$memory) addr@@45)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@45)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@45)) 5)))))
 :qid |DiemIdbpl.4741:20|
 :skolemid |186|
)) (forall ((addr@@46 Int) ) (!  (=> (|$IsValid'address'| addr@@46) (= (|Select__T@[Int]Bool_| (|domain#$Memory_54600| $1_SlidingNonce_SlidingNonce_$memory) addr@@46)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@46) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@46)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@46) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@46)) 1)))))
 :qid |DiemIdbpl.4745:20|
 :skolemid |187|
)))) (and (and (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (= (|Select__T@[Int]Bool_| (|domain#$Memory_54089| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@47)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@47)) 3))))
 :qid |DiemIdbpl.4749:20|
 :skolemid |188|
)) (forall ((addr@@48 Int) ) (!  (=> (|$IsValid'address'| addr@@48) (= (|Select__T@[Int]Bool_| (|domain#$Memory_53657| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@48)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@48) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@48)) 4))))
 :qid |DiemIdbpl.4753:20|
 :skolemid |189|
))) (and (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55737| $1_VASP_ParentVASP_$memory) addr@@49)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@49)) 5))))
 :qid |DiemIdbpl.4757:20|
 :skolemid |190|
)) (forall ((addr@@50 Int) ) (!  (=> (|$IsValid'address'| addr@@50) (= (|Select__T@[Int]Bool_| (|domain#$Memory_55673| $1_VASP_ChildVASP_$memory) addr@@50)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) addr@@50) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) addr@@50)) 6))))
 :qid |DiemIdbpl.4761:20|
 :skolemid |191|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) ($1_Signer_is_txn_signer _$t0@@3)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@3))) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $a_0@@5)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@5))
 :qid |DiemIdbpl.4767:20|
 :skolemid |192|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $a_0@@5))
))) (and (forall (($a_0@@6 Int) ) (! (let (($rsc@@6 (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@6)))
(|$IsValid'$1_DiemId_DiemIdDomainManager'| $rsc@@6))
 :qid |DiemIdbpl.4771:20|
 :skolemid |193|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomainManager_| (|contents#$Memory_57968| $1_DiemId_DiemIdDomainManager_$memory) $a_0@@6))
)) (= $t3 (|$addr#$signer| _$t0@@3)))) (and (and (|Select__T@[Int]Bool_| $1_DiemId_DiemIdDomainManager_$modifies (|$addr#$signer| _$t0@@3)) (= _$t0@@3 _$t0@@3)) (and (= $t4 (|$addr#$signer| _$t0@@3)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53330| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53330| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))))))) (and (=> (= (ControlFlow 0 81047) 81631) anon14_Then_correct@@0) (=> (= (ControlFlow 0 81047) 81109) anon14_Else_correct@@0))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@4  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@9 T@$1_Event_EventHandle) ) (! (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_32802_| (|streams#$EventStore| $es) handle@@9)))
 (and (= (|l#Multiset_32802| stream@@9) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_32802| stream@@9) v@@37) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 80207) 81047)) anon0$1_correct@@4)))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 92212) 80207) inline$$InitEventStore$0$anon0_correct@@4)))
anon0_correct@@4)))))))))))))))))))
))
(check-sat)
(pop 1)
