...
(assert (not
 (=> (= (ControlFlow 0 0) 91065) (let ((anon18_Else_correct  (=> (and (not $abort_flag@1@@0) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0|)) (and (=> (= (ControlFlow 0 79628) (- 0 91888)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1))) (and (=> (= (ControlFlow 0 79628) (- 0 91899)) (not (> (seq.len _$t1@@0) 63))) (=> (not (> (seq.len _$t1@@0) 63)) (=> (= (ControlFlow 0 79628) (- 0 91911)) (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| (exists ((i@@50 Int) ) (!  (and (and (|$IsValid'u64'| i@@50) (and (>= i@@50 0) (< i@@50 (seq.len (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)))))) (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) i@@50) $t6))
 :qid |DiemIdbpl.960:13|
 :skolemid |27|
)))))))))))
(let ((L3_correct@@0  (and (=> (= (ControlFlow 0 79054) (- 0 91825)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (> (seq.len _$t1@@0) 63))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (> (seq.len _$t1@@0) 63)) (=> (= (ControlFlow 0 79054) (- 0 91840)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= 5 $t10@0)) (and (> (seq.len _$t1@@0) 63) (= 7 $t10@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t10@0 $abort_code@2@@0) (= (ControlFlow 0 79642) 79054))) L3_correct@@0)))
(let ((|inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$res@1@@0| (exists ((i@@51 Int) ) (!  (and (and (|$IsValid'u64'| i@@51) (and (>= i@@51 0) (< i@@51 (seq.len $t13@0)))) (= (seq.nth $t13@0 i@@51) inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0))
 :qid |DiemIdbpl.960:13|
 :skolemid |27|
))) (and (=> (= (ControlFlow 0 79562) 79642) anon18_Then_correct) (=> (= (ControlFlow 0 79562) 79628) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (and (not $abort_flag@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0)) (and (= $t13@0 (|$domains#$1_DiemId_DiemIdDomains| $t11@1)) (= (ControlFlow 0 79568) 79562))) |inline$$1_Vector_contains'$1_DiemId_DiemIdDomain'$0$anon0_correct@@0|)))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t10@0 $abort_code@2@@0) (= (ControlFlow 0 79656) 79054))) L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0  (=> (= $abort_flag@1@@0 true) (=> (and (= $abort_code@2@@0 inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$ret0@0@@0)) (and (=> (= (ControlFlow 0 79464) 79656) anon17_Then_correct) (=> (= (ControlFlow 0 79464) 79568) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct@@0  (=> (and (and (not inline$$Le$0$dst@1@@1) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= (ControlFlow 0 79458) 79464))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct@@0  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t4@1@@0 $abort_code@1@@0) (= (ControlFlow 0 79496) 79464))) inline$$1_DiemId_create_diem_id_domain$0$L3_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct@@0  (=> (and inline$$Le$0$dst@1@@1 (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0 ($1_DiemId_DiemIdDomain _$t1@@0))) (=> (and (and (= inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0) (= $abort_flag@1@@0 $abort_flag@0@@0)) (and (= $abort_code@2@@0 $abort_code@1@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$ret0@1@@0 inline$$1_DiemId_create_diem_id_domain$0$$t9@1@@0))) (and (=> (= (ControlFlow 0 79482) 79656) anon17_Then_correct) (=> (= (ControlFlow 0 79482) 79568) anon17_Else_correct))))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct@@0  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 7)) (and (= inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0 inline$$1_DiemId_create_diem_id_domain$0$$t8@0@@0) (= inline$$Le$0$dst@1@@1 inline$$Le$0$dst@1@@1))) (and (=> (= (ControlFlow 0 79442) 79482) inline$$1_DiemId_create_diem_id_domain$0$anon7_Then_correct@@0) (=> (= (ControlFlow 0 79442) 79458) inline$$1_DiemId_create_diem_id_domain$0$anon7_Else_correct@@0))))))
(let ((inline$$Le$0$anon0_correct@@1  (=> (and (= inline$$Le$0$dst@1@@1 (<= |inline$$1_Vector_length'u8'$0$l@1@@1| 63)) (= (ControlFlow 0 79406) 79442)) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else$1_correct@@0)))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct@@0  (=> (not $abort_flag@0@@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 79412) 79406)) inline$$Le$0$anon0_correct@@1))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@1|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@1| (seq.len _$t1@@0)) (and (=> (= (ControlFlow 0 79346) 79496) inline$$1_DiemId_create_diem_id_domain$0$anon6_Then_correct@@0) (=> (= (ControlFlow 0 79346) 79412) inline$$1_DiemId_create_diem_id_domain$0$anon6_Else_correct@@0)))))
(let ((inline$$1_DiemId_create_diem_id_domain$0$anon0_correct@@0  (=> (and (= _$t1@@0 _$t1@@0) (= (ControlFlow 0 79352) 79346)) |inline$$1_Vector_length'u8'$0$anon0_correct@@1|)))
(let ((anon16_Else_correct  (=> (not $abort_flag@0@@0) (=> (and (= $t11@1 $t11@1) (= (ControlFlow 0 79502) 79352)) inline$$1_DiemId_create_diem_id_domain$0$anon0_correct@@0))))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t10@0 $abort_code@1@@0) (= (ControlFlow 0 79670) 79054))) L3_correct@@0)))
(let ((anon15_Then$1_correct  (=> (= $t11@1 $t11@@0) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 79722) 79670) anon16_Then_correct) (=> (= (ControlFlow 0 79722) 79502) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= (ControlFlow 0 79720) 79722)) anon15_Then$1_correct)))
(let ((anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (= $t11@1 $t11@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 79072) 79670) anon16_Then_correct) (=> (= (ControlFlow 0 79072) 79502) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 79058) 79720) anon15_Then_correct) (=> (= (ControlFlow 0 79058) 79072) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (not $t7@0) (= $t9@@0 $t9@@0)) (and (= $t10@0 $t9@@0) (= (ControlFlow 0 78994) 79054))) L3_correct@@0)))
(let ((anon0$1_correct@@2  (=> (and (and (|$IsValid'address'| _$t0@@1) (|$IsValid'vec'u8''| _$t1@@0)) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $a_0@@3)))
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@3) i@@52))) 63)))
 :qid |DiemIdbpl.4408:136|
 :skolemid |156|
))) (let (($range_3@@0 ($Range 0 (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@3)))))
(forall (($i_4@@0 Int) ) (!  (=> ($InRange $range_3@@0 $i_4@@0) (let ((i@@53 $i_4@@0))
(let (($range_5@@0 ($Range (+ i@@53 1) (seq.len (|$domains#$1_DiemId_DiemIdDomains| $rsc@@3)))))
(forall (($i_6@@0 Int) ) (!  (=> ($InRange $range_5@@0 $i_6@@0) (let ((j@@12 $i_6@@0))
 (not (= (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@3) i@@53) (seq.nth (|$domains#$1_DiemId_DiemIdDomains| $rsc@@3) j@@12)))))
 :qid |DiemIdbpl.4410:96|
 :skolemid |157|
)))))
 :qid |DiemIdbpl.4409:196|
 :skolemid |158|
...
(<= (seq.len (|$domain#$1_DiemId_DiemIdDomain| $elem@@4)) 63)))
 :qid |DiemIdbpl.4411:221|
 :skolemid |159|
))))))
 :qid |DiemIdbpl.4407:20|
 :skolemid |160|
 :pattern ( (|Select__T@[Int]$1_DiemId_DiemIdDomains_| (|contents#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) $a_0@@3))
)) (= $t6 ($1_DiemId_DiemIdDomain _$t1@@0)))) (=> (and (and (and (= _$t0@@1 _$t0@@1) (= _$t1@@0 _$t1@@0)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57904| $1_DiemId_DiemIdDomains_$memory) _$t0@@1)) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t9@@0) (= $t9@@0 5)) (and (= $t9@@0 $t9@@0) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 78978) 79058) anon14_Then_correct) (=> (= (ControlFlow 0 78978) 78994) anon14_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_32802_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_32802| stream@@7) 0) (forall ((v@@35 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_32802| stream@@7) v@@35) 0)
 :qid |DiemIdbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemIdbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 78706) 78978)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 91065) 78706) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
