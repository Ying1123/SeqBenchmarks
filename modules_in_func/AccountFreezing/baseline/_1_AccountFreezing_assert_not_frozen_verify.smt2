...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 668542) (let ((anon4_Else_correct  (=> (and (not inline$$Not$0$dst@1) (= $t6 $t6)) (and (=> (= (ControlFlow 0 386722) (- 0 668780)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0))) (=> (= (ControlFlow 0 386722) (- 0 668784)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0))) (= 1 $t6))))))))
(let ((anon4_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 386738) (- 0 668758))) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0)))))))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 1)) (and (= $t6 $t6) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 386682) 386738) anon4_Then_correct) (=> (= (ControlFlow 0 386682) 386722) anon4_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t3)) (= (ControlFlow 0 386646) 386682)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr)))
 :qid |AccountFreezingbpl.16201:20|
 :skolemid |280|
))) (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@0)))
 :qid |AccountFreezingbpl.16205:20|
 :skolemid |281|
)) (|$IsValid'address'| _$t0))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $a_0)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc))
 :qid |AccountFreezingbpl.16211:20|
 :skolemid |282|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t3  (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t0)))) (= (ControlFlow 0 386652) 386646)))) inline$$Not$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountFreezingbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 386482) 386652)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 668542) 386482) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))
))
(check-sat)
(pop 1)
