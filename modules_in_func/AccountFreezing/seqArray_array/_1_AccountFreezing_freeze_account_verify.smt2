...
(declare-fun $t11 () T@$1_AccountFreezing_FreezeAccountEvent)
...
(declare-fun $t29@0 () T@$Mutation_46432)
(declare-fun $t28@1 () T@$Mutation_248014)
(declare-fun $t29@1 () T@$Mutation_46432)
(declare-fun $t28@2 () T@$Mutation_248014)
...
(declare-fun $t28 () T@$Mutation_248014)
(declare-fun $t28@0 () T@$Mutation_248014)
...
(declare-fun $t29 () T@$Mutation_46432)
(declare-fun $t33 () T@$Mutation_190559)
(push 1)
(set-info :boogie-vc-id $1_AccountFreezing_freeze_account$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 669285) (let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 389561) (- 0 671668)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 389561) (- 0 671678)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 389561) (- 0 671690)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 389561) (- 0 671708)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 389561) (- 0 671722)) (not (= _$t1 173345816))) (=> (not (= _$t1 173345816)) (and (=> (= (ControlFlow 0 389561) (- 0 671732)) (not (= _$t1 186537453))) (=> (not (= _$t1 186537453)) (and (=> (= (ControlFlow 0 389561) (- 0 671742)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (and (=> (= (ControlFlow 0 389561) (- 0 671753)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) _$t1)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) _$t1))) (and (=> (= (ControlFlow 0 389561) (- 0 671760)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new (let ((len (|l#Multiset_151483| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_151483 (|Store__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_151483| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_151483 (|Store__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |AccountFreezingbpl.3327:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 389561) (- 0 671785)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_151483| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_151483 (|Store__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 388892) (- 0 671481)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (= (ControlFlow 0 388892) (- 0 671543)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (and (= _$t1 173345816) (= 7 $t13@0))) (and (= _$t1 186537453) (= 7 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= 5 $t13@0))))))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 389575) 388892))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| (|v#$Mutation_190559| $t33@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_151483| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0))))
(Multiset_151483 (|Store__T@[$EventRep]Int_| (|v#Multiset_151483| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 389395) 389575) anon36_Then_correct) (=> (= (ControlFlow 0 389395) 389561) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (and (not $abort_flag@1) (= $t33@0 ($Mutation_190559 (|l#$Mutation_248057| $t32@1) (let ((l (|l#Vec_30625| (|p#$Mutation_248057| $t32@1))))
(Vec_30625 (|Store__T@[Int]Int_| (|v#Vec_30625| (|p#$Mutation_248057| $t32@1)) l 0) (+ l 1))) (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_248057| $t32@1))))) (and (= $t34@0 ($1_AccountFreezing_FreezeAccountEvent $t30 _$t1)) (= (ControlFlow 0 389401) 389395))) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|)))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 389589) 388892))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $t32@1 $t32) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 389641) 389589) anon35_Then_correct) (=> (= (ControlFlow 0 389641) 389401) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 389639) 389641)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t32@0 ($Mutation_248057 ($Global 173345816) (Vec_30625 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t32@1 $t32@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 389296) 389589) anon35_Then_correct) (=> (= (ControlFlow 0 389296) 389401) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t29@0 ($Mutation_46432 (|l#$Mutation_248014| $t28@1) (let ((l@@0 (|l#Vec_30625| (|p#$Mutation_248014| $t28@1))))
(Vec_30625 (|Store__T@[Int]Int_| (|v#Vec_30625| (|p#$Mutation_248014| $t28@1)) l@@0 0) (+ l@@0 1))) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_248014| $t28@1)))) (= $t29@1 ($Mutation_46432 (|l#$Mutation_46432| $t29@0) (|p#$Mutation_46432| $t29@0) true))) (and (= $t28@2 ($Mutation_248014 (|l#$Mutation_248014| $t28@1) (|p#$Mutation_248014| $t28@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_46432| $t29@1)))) (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_199368 (|Store__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_248014| $t28@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_248014| $t28@2)) (|v#$Mutation_248014| $t28@2)))))) (and (=> (= (ControlFlow 0 389274) (- 0 671113)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 173345816))))) (and (=> (= (ControlFlow 0 389274) (- 0 671127)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) 186537453))))) (and (=> (= (ControlFlow 0 389274) (- 0 671141)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr)))
 :qid |AccountFreezingbpl.17077:15|
 :skolemid |318|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@0)))
 :qid |AccountFreezingbpl.17077:15|
 :skolemid |318|
)) (and (=> (= (ControlFlow 0 389274) (- 0 671165)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@1)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |AccountFreezingbpl.5139:13|
 :skolemid |157|
)))))
 :qid |AccountFreezingbpl.17083:15|
 :skolemid |319|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@2) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@2)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@2)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |AccountFreezingbpl.5139:13|
 :skolemid |157|
)))))
 :qid |AccountFreezingbpl.17083:15|
 :skolemid |319|
)) (and (=> (= (ControlFlow 0 389274) (- 0 671208)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@3)))
 :qid |AccountFreezingbpl.17089:15|
 :skolemid |320|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@4)))
 :qid |AccountFreezingbpl.17089:15|
 :skolemid |320|
)) (and (=> (= (ControlFlow 0 389274) (- 0 671233)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@5)))
 :qid |AccountFreezingbpl.17095:15|
 :skolemid |321|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory@0) addr@@6)))
 :qid |AccountFreezingbpl.17095:15|
 :skolemid |321|
)) (=> (and (and (|$IsValid'address'| $t30) (= $t30 (|$addr#$signer| _$t0))) (and (= $t30 $t30) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 389274) 389639) anon34_Then_correct) (=> (= (ControlFlow 0 389274) 389296) anon34_Else_correct)))))))))))))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 389655) 388892))) L7_correct)))
(let ((anon32_Then$1_correct  (=> (= $t28@1 $t28) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 389707) 389655) anon33_Then_correct) (=> (= (ControlFlow 0 389707) 389274) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= (ControlFlow 0 389705) 389707)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1) (=> (and (and (= $t28@0 ($Mutation_248014 ($Global _$t1) (Vec_30625 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (= $t28@1 $t28@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 389040) 389655) anon33_Then_correct) (=> (= (ControlFlow 0 389040) 389274) anon33_Else_correct))))))
(let ((anon31_Then_correct  (=> $t24@0 (and (=> (= (ControlFlow 0 389018) 389705) anon32_Then_correct) (=> (= (ControlFlow 0 389018) 389040) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (and (not $t24@0) (= $t26 $t26)) (and (= $t13@0 $t26) (= (ControlFlow 0 389008) 388892))) L7_correct)))
(let ((anon30_Then_correct  (=> $t21@0 (=> (and (= $t24@0 (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 5)) (and (= $t26 $t26) (= $t24@0 $t24@0))) (and (=> (= (ControlFlow 0 388992) 389018) anon31_Then_correct) (=> (= (ControlFlow 0 388992) 389008) anon31_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t13@0 $t23) (= (ControlFlow 0 388954) 388892))) L7_correct)))
(let ((anon29_Then_correct  (=> (and (and (and $t17@0 (|$IsValid'address'| 186537453)) (and (= $t21@0  (not (= _$t1 186537453))) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t23) (= $t23 7)) (and (= $t23 $t23) (= $t21@0 $t21@0)))) (and (=> (= (ControlFlow 0 388938) 388992) anon30_Then_correct) (=> (= (ControlFlow 0 388938) 388954) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not $t17@0) (= $t19 $t19)) (and (= $t13@0 $t19) (= (ControlFlow 0 388688) 388892))) L7_correct)))
(let ((anon28_Else_correct  (=> (and (and (and (not $t15) (|$IsValid'address'| 173345816)) (and (= $t17@0  (not (= _$t1 173345816))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t19) (= $t19 7)) (and (= $t19 $t19) (= $t17@0 $t17@0)))) (and (=> (= (ControlFlow 0 388672) 388938) anon29_Then_correct) (=> (= (ControlFlow 0 388672) 388688) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> $t15 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t14)) (= 5 $t13)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t14)) 1)) (= 3 $t13))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 389779) 388892))) L7_correct))))
(let ((anon27_Else_correct  (=> (not $t12) (=> (and (= $t14 (|$addr#$signer| _$t0)) (= $t15  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) $t14)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $t14)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))) (and (=> (= (ControlFlow 0 388622) 389779) anon28_Then_correct) (=> (= (ControlFlow 0 388622) 388672) anon28_Else_correct))))))
(let ((anon27_Then_correct  (=> $t12 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 389805) 388892))) L7_correct))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_198339| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@21))))) i1)))) 3))))
 ...
 :skolemid |300|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199142| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199226| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199540| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_199611| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))))) (and (and (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@22) (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@22)))
 :qid |AccountFreezingbpl.16711:20|
 :skolemid |301|
)) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235803| $1_VASPDomain_VASPDomainManager_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@23)) 1))))
 :qid |AccountFreezingbpl.16715:20|
 :skolemid |302|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235739| $1_VASPDomain_VASPDomains_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@24)) 5))))
 :qid |AccountFreezingbpl.16719:20|
 :skolemid |303|
)) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_203603| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@25) (|Select__T@[Int]Bool_| (|domain#$Memory_203663| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@25)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@25)) 2)))))
 :qid |AccountFreezingbpl.16723:20|
 :skolemid |304|
)))) (and (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (= (|Select__T@[Int]Bool_| (|domain#$Memory_244160| $1_DesignatedDealer_Dealer_$memory) addr@@26)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@26)) 2))))
 :qid |AccountFreezingbpl.16727:20|
 :skolemid |305|
)) (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (= (|Select__T@[Int]Bool_| (|domain#$Memory_203488| $1_DualAttestation_Credential_$memory) addr@@27)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@27)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@27)) 5)))))
 :qid |AccountFreezingbpl.16731:20|
 :skolemid |306|
))) (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@28)))
 :qid |AccountFreezingbpl.16735:20|
 :skolemid |307|
)) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_246687| $1_DiemAccount_DiemAccount_$memory) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) addr@@29)))
 :qid |AccountFreezingbpl.16739:20|
 :skolemid |308|
))))) (and (and (and (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (= (|Select__T@[Int]Bool_| (|domain#$Memory_198160| $1_SlidingNonce_SlidingNonce_$memory) addr@@30)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@30)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@30)) 1)))))
 :qid |AccountFreezingbpl.16743:20|
 :skolemid |309|
)) (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (= (|Select__T@[Int]Bool_| (|domain#$Memory_202755| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@31)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@31)) 3))))
 :qid |AccountFreezingbpl.16747:20|
 :skolemid |310|
))) (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_203150| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@32)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@32)) 4))))
 :qid |AccountFreezingbpl.16751:20|
 :skolemid |311|
)) (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_237259| $1_VASP_ParentVASP_$memory) addr@@33)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@33)) 5))))
 :qid |AccountFreezingbpl.16755:20|
 :skolemid |312|
)))) (and (and (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (= (|Select__T@[Int]Bool_| (|domain#$Memory_237195| $1_VASP_ChildVASP_$memory) addr@@34)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_197973| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) addr@@34)) 6))))
 :qid |AccountFreezingbpl.16759:20|
 :skolemid |313|
...
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |AccountFreezingbpl.16780:20|
 :skolemid |314|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |AccountFreezingbpl.16784:20|
 :skolemid |315|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_197973| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@1))
 :qid |AccountFreezingbpl.16788:20|
 :skolemid |316|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |AccountFreezingbpl.16792:20|
 :skolemid |317|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_199368| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (= $t9 (|$addr#$signer| _$t0)) (= $t10 (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_199297| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (= $t11 ($1_AccountFreezing_FreezeAccountEvent (|$addr#$signer| _$t0) _$t1)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t12  (not (|Select__T@[Int]Bool_| (|domain#$Memory_197291| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 388564) 389805) anon27_Then_correct) (=> (= (ControlFlow 0 388564) 388622) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_151483_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |AccountFreezingbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 387372) 388564)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_30625| (|p#$Mutation_248014| $t28)) 0) (=> (and (and (= (|l#Vec_30625| (|p#$Mutation_46432| $t29)) 0) (= (|l#Vec_30625| (|p#$Mutation_248057| $t32)) 0)) (and (= (|l#Vec_30625| (|p#$Mutation_190559| $t33)) 0) (= (ControlFlow 0 387382) 387372))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 669285) 387382) anon0_correct)))
