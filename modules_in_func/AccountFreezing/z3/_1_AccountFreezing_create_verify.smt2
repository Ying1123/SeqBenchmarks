...
(assert (not
 (=> (= (ControlFlow 0 0) 648800) (let ((anon12_Else_correct@@0  (=> (not $abort_flag@0@@3) (and (=> (= (ControlFlow 0 373935) (- 0 649181)) (forall ((addr@@53 Int) ) (!  (=> (|$IsValid'address'| addr@@53) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@53) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) addr@@53)))
 :qid |AccountFreezingbpl.16384:15|
 :skolemid |254|
))) (=> (forall ((addr@@54 Int) ) (!  (=> (|$IsValid'address'| addr@@54) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@54) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) addr@@54)))
 :qid |AccountFreezingbpl.16384:15|
 :skolemid |254|
)) (and (=> (= (ControlFlow 0 373935) (- 0 649205)) (forall ((addr@@55 Int) ) (!  (=> (|$IsValid'address'| addr@@55) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@55) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) addr@@55)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@55)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.16390:15|
 :skolemid |255|
))) (=> (forall ((addr@@56 Int) ) (!  (=> (|$IsValid'address'| addr@@56) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@56) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) addr@@56)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@56)))) (exists ((a@@8 Int) ) (!  (and (|$IsValid'address'| a@@8) (and ($1_Signer_is_txn_signer_addr a@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@8)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.16390:15|
 :skolemid |255|
)) (and (=> (= (ControlFlow 0 373935) (- 0 649251)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t4@@1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t4@@1)) (=> (= (ControlFlow 0 373935) (- 0 649261)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) $t4@@1) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@1) $t4@@1))))))))))))))
(let ((L3_correct@@2  (and (=> (= (ControlFlow 0 373787) (- 0 649153)) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t4@@1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t4@@1) (=> (= (ControlFlow 0 373787) (- 0 649158)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t4@@1) (= 6 $t10@0@@0)))))))
(let ((anon12_Then_correct@@0  (=> (and (and $abort_flag@0@@3 (= $abort_code@1@@3 $abort_code@1@@3)) (and (= $t10@0@@0 $abort_code@1@@3) (= (ControlFlow 0 373949) 373787))) L3_correct@@2)))
(let ((anon11_Then$1_correct@@0  (=> (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory) (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 374001) 373949) anon12_Then_correct@@0) (=> (= (ControlFlow 0 374001) 373935) anon12_Else_correct@@0))))))
(let ((anon11_Then_correct@@1  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0@@4)) (= (ControlFlow 0 373999) 374001)) anon11_Then$1_correct@@0)))
(let ((anon11_Else_correct@@1  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0@@4))) (=> (and (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_188942 (|Store__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0@@4) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|$addr#$signer| _$t0@@4) $t12@0))) (= $1_AccountFreezing_FreezingBit_$memory@1 $1_AccountFreezing_FreezingBit_$memory@0)) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 373837) 373949) anon12_Then_correct@@0) (=> (= (ControlFlow 0 373837) 373935) anon12_Else_correct@@0))))))
(let ((anon10_Then_correct@@1  (=> (and inline$$Not$0$dst@1@@2 (= $t12@0 ($1_AccountFreezing_FreezingBit false))) (and (=> (= (ControlFlow 0 373815) (- 0 649030)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0@@4))) (=> (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies (|$addr#$signer| _$t0@@4)) (and (=> (= (ControlFlow 0 373815) 373999) anon11_Then_correct@@1) (=> (= (ControlFlow 0 373815) 373837) anon11_Else_correct@@1)))))))
(let ((anon10_Else_correct@@1  (=> (and (and (not inline$$Not$0$dst@1@@2) (= $t9@@1 $t9@@1)) (and (= $t10@0@@0 $t9@@1) (= (ControlFlow 0 373759) 373787))) L3_correct@@2)))
(let ((anon0$2_correct@@1  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t9@@1) (= $t9@@1 6)) (and (= $t9@@1 $t9@@1) (= inline$$Not$0$dst@1@@2 inline$$Not$0$dst@1@@2))) (and (=> (= (ControlFlow 0 373743) 373815) anon10_Then_correct@@1) (=> (= (ControlFlow 0 373743) 373759) anon10_Else_correct@@1))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (and (= inline$$Not$0$dst@1@@2  (not $t6@0@@0)) (= (ControlFlow 0 373707) 373743)) anon0$2_correct@@1)))
(let ((anon0$1_correct@@4  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@4)) ($1_Signer_is_txn_signer _$t0@@4)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@4))) (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@5)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@5))
 :qid |AccountFreezingbpl.16269:20|
 :skolemid |253|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@5))
))) (and (and (and (= $t4@@1 (|$addr#$signer| _$t0@@4)) (|Select__T@[Int]Bool_| $1_AccountFreezing_FreezingBit_$modifies $t4@@1)) (and (= _$t0@@4 _$t0@@4) (|$IsValid'address'| $t5@@1))) (and (and (= $t5@@1 (|$addr#$signer| _$t0@@4)) (= $t5@@1 $t5@@1)) (and (= $t6@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $t5@@1)) (= (ControlFlow 0 373713) 373707))))) inline$$Not$0$anon0_correct@@2)))
(let ((inline$$InitEventStore$0$anon0_correct@@4  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) handle@@6)))
 (and (= (|l#Multiset_149542| stream@@5) 0) (forall ((v@@52 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@5) v@@52) 0)
 :qid |AccountFreezingbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountFreezingbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 373567) 373713)) anon0$1_correct@@4)))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 648800) 373567) inline$$InitEventStore$0$anon0_correct@@4)))
anon0_correct@@4))))))))))))))
))
(check-sat)
(pop 1)
