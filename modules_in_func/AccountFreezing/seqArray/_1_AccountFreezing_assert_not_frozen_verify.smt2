...
(assert (not
 (=> (= (ControlFlow 0 0) 648532) (let ((anon4_Else_correct  (=> (and (not inline$$Not$0$dst@1@@1) (= $t6@@0 $t6@@0)) (and (=> (= (ControlFlow 0 373478) (- 0 648770)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3))) (=> (= (ControlFlow 0 373478) (- 0 648774)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3))) (= 1 $t6@@0))))))))
(let ((anon4_Then_correct  (=> (and inline$$Not$0$dst@1@@1 (= (ControlFlow 0 373494) (- 0 648748))) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3)))))))
(let ((anon0$2_correct@@0  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| $t6@@0) (= $t6@@0 1)) (and (= $t6@@0 $t6@@0) (= inline$$Not$0$dst@1@@1 inline$$Not$0$dst@1@@1))) (and (=> (= (ControlFlow 0 373438) 373494) anon4_Then_correct) (=> (= (ControlFlow 0 373438) 373478) anon4_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@1  (=> (and (= inline$$Not$0$dst@1@@1  (not $t3@@1)) (= (ControlFlow 0 373402) 373438)) anon0$2_correct@@0)))
(let ((anon0$1_correct@@3  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (forall ((addr@@51 Int) ) (!  (=> (|$IsValid'address'| addr@@51) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@51) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@51)))
 :qid |AccountFreezingbpl.16133:20|
 :skolemid |250|
))) (and (forall ((addr@@52 Int) ) (!  (=> (|$IsValid'address'| addr@@52) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@52) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@52)))
 :qid |AccountFreezingbpl.16137:20|
 :skolemid |251|
)) (|$IsValid'address'| _$t0@@3))) (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@4)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@4))
 :qid |AccountFreezingbpl.16143:20|
 :skolemid |252|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@4))
)) (= _$t0@@3 _$t0@@3)) (and (= $t3@@1  (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t0@@3)))) (= (ControlFlow 0 373408) 373402)))) inline$$Not$0$anon0_correct@@1))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_149542| stream@@4) 0) (forall ((v@@51 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@4) v@@51) 0)
 :qid |AccountFreezingbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountFreezingbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 373238) 373408)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 648532) 373238) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))))))
))
(check-sat)
(pop 1)
