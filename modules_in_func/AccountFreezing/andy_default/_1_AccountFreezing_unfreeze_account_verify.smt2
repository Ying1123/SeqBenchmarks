...
(assert (not
 (=> (= (ControlFlow 0 0) 651806) (let ((anon28_Else_correct@@0  (=> (not $abort_flag@1@@0) (and (=> (= (ControlFlow 0 378915) (- 0 653999)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 378915) (- 0 654009)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2))) (and (=> (= (ControlFlow 0 378915) (- 0 654021)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) 1))) (and (=> (= (ControlFlow 0 378915) (- 0 654039)) (not (not (= (|$addr#$signer| _$t0@@6) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@6) 186537453))) (and (=> (= (ControlFlow 0 378915) (- 0 654053)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2))) (and (=> (= (ControlFlow 0 378915) (- 0 654064)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) _$t1@@2) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) _$t1@@2))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) _$t1@@2) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) _$t1@@2)))) (and (=> (= (ControlFlow 0 378915) (- 0 654073)) (let ((actual@@2 ($EventStore (- (|counter#$EventStore| $es@0@@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@0) (|streams#$EventStore| $es)))))
(let ((expected@@2 (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_149542| stream@@11)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@11) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@11) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1 stream_new@@3))))))
 (and (<= (|counter#$EventStore| expected@@2) (|counter#$EventStore| actual@@2)) (forall ((handle@@11 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@2) handle@@11)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@2) handle@@11))) (forall ((v@@57 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@2) handle@@11)) v@@57) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@2) handle@@11)) v@@57))
...
(let ((expected@@3 (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_149542| stream@@12)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@12) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@12) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1 stream_new@@4))))))
 (and (<= (|counter#$EventStore| expected@@3) (|counter#$EventStore| actual@@3)) (forall ((handle@@12 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@3) handle@@12)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@3) handle@@12))) (forall ((v@@58 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@3) handle@@12)) v@@58) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@3) handle@@12)) v@@58))
 :qid |AccountFreezingbpl.139:13|
 :skolemid |3|
)))
 :qid |AccountFreezingbpl.3288:13|
 :skolemid |90|
))))) (=> (= (ControlFlow 0 378915) (- 0 654098)) (let ((actual@@4 ($EventStore (- (|counter#$EventStore| $es@0@@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@0) (|streams#$EventStore| $es)))))
(let ((expected@@4 (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_149542| stream@@13)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@13) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@13) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7@@1) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $EmptyEventStore) $t6@@1 stream_new@@5))))))
 (and (<= (|counter#$EventStore| actual@@4) (|counter#$EventStore| expected@@4)) (forall ((handle@@13 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@4) handle@@13)) (|l#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@4) handle@@13))) (forall ((v@@59 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| actual@@4) handle@@13)) v@@59) (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| expected@@4) handle@@13)) v@@59))
 :qid |AccountFreezingbpl.139:13|
 :skolemid |3|
)))
 :qid |AccountFreezingbpl.3288:13|
...
(let ((L3_correct@@3  (and (=> (= (ControlFlow 0 378380) (- 0 653854)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) 1))) (not (= (|$addr#$signer| _$t0@@6) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2)))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) 1))) (not (= (|$addr#$signer| _$t0@@6) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2))) (=> (= (ControlFlow 0 378380) (- 0 653902)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) (= 5 $t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t5@@2)) 1)) (= 3 $t9@0))) (and (not (= (|$addr#$signer| _$t0@@6) 186537453)) (= 2 $t9@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2)) (= 5 $t9@0))))))))
(let ((anon28_Then_correct@@0  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t9@0 $abort_code@2@@0) (= (ControlFlow 0 378929) 378380))) L3_correct@@3)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| (|v#$Mutation_180695| $t21@0@@0)) (= $es@0@@0 (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_149542| stream@@14)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@14) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t22@0))))
(Multiset_149542 (|Store__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@14) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t22@0) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| stream_new@@6)))))) (and (=> (= (ControlFlow 0 378767) 378929) anon28_Then_correct@@0) (=> (= (ControlFlow 0 378767) 378915) anon28_Else_correct@@0)))))
(let ((anon27_Else_correct@@0  (=> (and (and (not $abort_flag@1@@0) (= $t21@0@@0 ($Mutation_180695 (|l#$Mutation_235929| $t20@1) (seq.++ (|p#$Mutation_235929| $t20@1) (seq.unit 1)) (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_235929| $t20@1))))) (and (= $t22@0 ($1_AccountFreezing_UnfreezeAccountEvent $t18 _$t1@@2)) (= (ControlFlow 0 378773) 378767))) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|)))
(let ((anon27_Then_correct@@0  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= $t9@0 $abort_code@2@@0) (= (ControlFlow 0 378943) 378380))) L3_correct@@3)))
(let ((anon26_Then$1_correct  (=> (= $t20@1 $t20@@0) (=> (and (= $abort_flag@1@@0 true) (= $abort_code@2@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 378995) 378943) anon27_Then_correct@@0) (=> (= (ControlFlow 0 378995) 378773) anon27_Else_correct@@0))))))
(let ((anon26_Then_correct@@0  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 378993) 378995)) anon26_Then$1_correct)))
(let ((anon26_Else_correct@@0  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t20@0 ($Mutation_235929 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t20@1 $t20@0)) (and (= $abort_flag@1@@0 $abort_flag@0@@5) (= $abort_code@2@@0 $abort_code@1@@5))) (and (=> (= (ControlFlow 0 378668) 378943) anon27_Then_correct@@0) (=> (= (ControlFlow 0 378668) 378773) anon27_Else_correct@@0))))))
(let ((anon25_Else_correct@@0  (=> (not $abort_flag@0@@5) (=> (and (and (= $t17@0@@1 ($Mutation_45139 (|l#$Mutation_235887| $t16@1) (seq.++ (|p#$Mutation_235887| $t16@1) (seq.unit 0)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_235887| $t16@1)))) (= $t17@1 ($Mutation_45139 (|l#$Mutation_45139| $t17@0@@1) (|p#$Mutation_45139| $t17@0@@1) false))) (and (= $t16@2 ($Mutation_235887 (|l#$Mutation_235887| $t16@1) (|p#$Mutation_235887| $t16@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_45139| $t17@1)))) (= $1_AccountFreezing_FreezingBit_$memory@0@@1 ($Memory_188942 (|Store__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_235887| $t16@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_235887| $t16@2)) (|v#$Mutation_235887| $t16@2)))))) (and (=> (= (ControlFlow 0 378646) (- 0 653492)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 173345816))))) (and (=> (= (ControlFlow 0 378646) (- 0 653506)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) 186537453))))) (and (=> (= (ControlFlow 0 378646) (- 0 653520)) (forall ((addr@@93 Int) ) (!  (=> (|$IsValid'address'| addr@@93) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@93) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@93)))
 :qid |AccountFreezingbpl.17625:15|
 :skolemid |324|
))) (=> (forall ((addr@@94 Int) ) (!  (=> (|$IsValid'address'| addr@@94) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@94) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@94)))
 :qid |AccountFreezingbpl.17625:15|
 :skolemid |324|
)) (and (=> (= (ControlFlow 0 378646) (- 0 653544)) (forall ((addr@@95 Int) ) (!  (=> (|$IsValid'address'| addr@@95) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@95) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@95)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@95)))) (exists ((a@@11 Int) ) (!  (and (|$IsValid'address'| a@@11) (and ($1_Signer_is_txn_signer_addr a@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@11)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.17631:15|
 :skolemid |325|
))) (=> (forall ((addr@@96 Int) ) (!  (=> (|$IsValid'address'| addr@@96) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@96) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@96)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@96)))) (exists ((a@@12 Int) ) (!  (and (|$IsValid'address'| a@@12) (and ($1_Signer_is_txn_signer_addr a@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) a@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) a@@12)) 1))))
 :qid |AccountFreezingbpl.5100:13|
 :skolemid |127|
)))))
 :qid |AccountFreezingbpl.17631:15|
 :skolemid |325|
)) (and (=> (= (ControlFlow 0 378646) (- 0 653587)) (forall ((addr@@97 Int) ) (!  (=> (|$IsValid'address'| addr@@97) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@97) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@97)))
 :qid |AccountFreezingbpl.17637:15|
 :skolemid |326|
))) (=> (forall ((addr@@98 Int) ) (!  (=> (|$IsValid'address'| addr@@98) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@98) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@98)))
 :qid |AccountFreezingbpl.17637:15|
 :skolemid |326|
)) (and (=> (= (ControlFlow 0 378646) (- 0 653612)) (forall ((addr@@99 Int) ) (!  (=> (|$IsValid'address'| addr@@99) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@99) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@99)))
 :qid |AccountFreezingbpl.17643:15|
 :skolemid |327|
))) (=> (forall ((addr@@100 Int) ) (!  (=> (|$IsValid'address'| addr@@100) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@100) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory@0@@1) addr@@100)))
 :qid |AccountFreezingbpl.17643:15|
 :skolemid |327|
)) (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0@@6))) (and (= $t18 $t18) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 378646) 378993) anon26_Then_correct@@0) (=> (= (ControlFlow 0 378646) 378668) anon26_Else_correct@@0)))))))))))))))))))
(let ((anon25_Then_correct@@0  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t9@0 $abort_code@1@@5) (= (ControlFlow 0 379009) 378380))) L3_correct@@3)))
(let ((anon24_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 379061) 379009) anon25_Then_correct@@0) (=> (= (ControlFlow 0 379061) 378646) anon25_Else_correct@@0))))))
(let ((anon24_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2)) (= (ControlFlow 0 379059) 379061)) anon24_Then$1_correct)))
(let ((anon24_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2) (=> (and (and (= $t16@0 ($Mutation_235887 ($Global _$t1@@2) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2))) (= $t16@1 $t16@0)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 378412) 379009) anon25_Then_correct@@0) (=> (= (ControlFlow 0 378412) 378646) anon25_Else_correct@@0))))))
(let ((anon23_Then_correct@@1  (=> $t12@0@@0 (and (=> (= (ControlFlow 0 378390) 379059) anon24_Then_correct@@1) (=> (= (ControlFlow 0 378390) 378412) anon24_Else_correct@@1)))))
(let ((anon23_Else_correct@@1  (=> (and (and (not $t12@0@@0) (= $t14@@1 $t14@@1)) (and (= $t9@0 $t14@@1) (= (ControlFlow 0 378224) 378380))) L3_correct@@3)))
(let ((anon22_Else_correct@@1  (=> (not $t11@@2) (=> (and (= $t12@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) _$t1@@2)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t14@@1) (= $t14@@1 5)) (and (= $t14@@1 $t14@@1) (= $t12@0@@0 $t12@0@@0))) (and (=> (= (ControlFlow 0 378208) 378390) anon23_Then_correct@@1) (=> (= (ControlFlow 0 378208) 378224) anon23_Else_correct@@1)))))))
(let ((anon22_Then_correct@@1  (=> $t11@@2 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t10@@1)) (= 5 $t9@@3)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t10@@1)) 1)) (= 3 $t9@@3))) (and (not (= (|$addr#$signer| _$t0@@6) 186537453)) (= 2 $t9@@3))) (= $t9@@3 $t9@@3)) (and (= $t9@0 $t9@@3) (= (ControlFlow 0 379133) 378380))) L3_correct@@3))))
(let ((anon21_Else_correct@@1  (=> (not $t8) (=> (and (= $t10@@1 (|$addr#$signer| _$t0@@6)) (= $t11@@2  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) $t10@@1)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $t10@@1)) 1))) (not (= (|$addr#$signer| _$t0@@6) 186537453))))) (and (=> (= (ControlFlow 0 378166) 379133) anon22_Then_correct@@1) (=> (= (ControlFlow 0 378166) 378208) anon22_Else_correct@@1))))))
(let ((anon21_Then_correct@@1  (=> $t8 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t9@@3)) (= $t9@@3 $t9@@3)) (and (= $t9@0 $t9@@3) (= (ControlFlow 0 379159) 378380))) L3_correct@@3))))
(let ((anon0$1_correct@@6  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@101 Int) ) (!  (=> (|$IsValid'address'| addr@@101) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@101) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@101)) 0)) (= addr@@101 173345816)))
 :qid |AccountFreezingbpl.17208:20|
 :skolemid |292|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@102 Int) ) (!  (=> (|$IsValid'address'| addr@@102) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@102) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@102)) 1)) (= addr@@102 186537453)))
 :qid |AccountFreezingbpl.17216:20|
 :skolemid |293|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@103 Int) ) (!  (=> (|$IsValid'address'| addr@@103) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@103)) 2))))))
 :qid |AccountFreezingbpl.17224:20|
 :skolemid |294|
)))) (=> (and (and (and (and (forall ((addr@@104 Int) ) (!  (=> (|$IsValid'address'| addr@@104) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@104)) 2))))))
 :qid |AccountFreezingbpl.17228:20|
 :skolemid |295|
)) (forall ((addr@@105 Int) ) (!  (=> (|$IsValid'address'| addr@@105) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@105)) 2))))))
 :qid |AccountFreezingbpl.17232:20|
 :skolemid |296|
))) (and (forall ((addr@@106 Int) ) (!  (=> (|$IsValid'address'| addr@@106) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@106)) 2))))))
 :qid |AccountFreezingbpl.17236:20|
 :skolemid |297|
)) (forall ((addr@@107 Int) ) (!  (=> (|$IsValid'address'| addr@@107) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@107)) 2)))))
 :qid |AccountFreezingbpl.17240:20|
 :skolemid |298|
)))) (and (and (forall ((addr@@108 Int) ) (!  (=> (|$IsValid'address'| addr@@108) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@108)) 2)))))
 :qid |AccountFreezingbpl.17244:20|
 :skolemid |299|
)) (forall ((addr@@109 Int) ) (!  (=> (|$IsValid'address'| addr@@109) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@109)) 2)))))
 :qid |AccountFreezingbpl.17248:20|
 :skolemid |300|
))) (and (forall ((addr@@110 Int) ) (!  (=> (|$IsValid'address'| addr@@110) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@110) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@110)) 4))))
 :qid |AccountFreezingbpl.17252:20|
 :skolemid |301|
)) (forall ((addr@@111 Int) ) (!  (=> (|$IsValid'address'| addr@@111) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@111) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@111)) 3))))
 :qid |AccountFreezingbpl.17256:20|
 :skolemid |302|
))))) (and (and (and (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@112) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@112)) 3))))
 :qid |AccountFreezingbpl.17260:20|
 :skolemid |303|
)) (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@113) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@113)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@113)) 3))))
 :qid |AccountFreezingbpl.17264:20|
 :skolemid |304|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187827| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187986| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (let (($range_0@@0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@114 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@114))))))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i1@@0 $i_1@@0))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@115 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@115)))) i1@@0))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@115 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_187913| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@115)))) i1@@0)))) 3))))
 :qid |AccountFreezingbpl.17284:151|
 :skolemid |305|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188057| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))))) (=> (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188141| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188225| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188296| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188380| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188464| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188535| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188632| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193056| $1_DualAttestation_Credential_$memory) addr1@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr1@@3)) 2)))))
 :qid |AccountFreezingbpl.17321:20|
 :skolemid |306|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188716| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188800| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189114| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189185| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))))) (and (and (and (and (forall ((addr@@116 Int) ) (!  (=> (|$IsValid'address'| addr@@116) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@116) (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@116)))
 :qid |AccountFreezingbpl.17357:20|
 :skolemid |307|
)) (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223943| $1_VASPDomain_VASPDomainManager_$memory) addr@@117)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@117)) 1))))
 :qid |AccountFreezingbpl.17361:20|
 :skolemid |308|
))) (and (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223879| $1_VASPDomain_VASPDomains_$memory) addr@@118)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@118)) 5))))
 :qid |AccountFreezingbpl.17365:20|
 :skolemid |309|
)) (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_193171| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@119) (|Select__T@[Int]Bool_| (|domain#$Memory_193231| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@119)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@119)) 2)))))
 :qid |AccountFreezingbpl.17369:20|
 :skolemid |310|
)))) (and (and (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (= (|Select__T@[Int]Bool_| (|domain#$Memory_232070| $1_DesignatedDealer_Dealer_$memory) addr@@120)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@120)) 2))))
 :qid |AccountFreezingbpl.17373:20|
 :skolemid |311|
)) (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (= (|Select__T@[Int]Bool_| (|domain#$Memory_193056| $1_DualAttestation_Credential_$memory) addr@@121)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@121)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@121)) 5)))))
 :qid |AccountFreezingbpl.17377:20|
 :skolemid |312|
))) (and (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@122) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@122)))
 :qid |AccountFreezingbpl.17381:20|
 :skolemid |313|
)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234560| $1_DiemAccount_DiemAccount_$memory) addr@@123) (|Select__T@[Int]Bool_| (|domain#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) addr@@123)))
 :qid |AccountFreezingbpl.17385:20|
 :skolemid |314|
))))) (and (and (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (= (|Select__T@[Int]Bool_| (|domain#$Memory_187734| $1_SlidingNonce_SlidingNonce_$memory) addr@@124)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@124)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@124)) 1)))))
 :qid |AccountFreezingbpl.17389:20|
 :skolemid |315|
)) (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (= (|Select__T@[Int]Bool_| (|domain#$Memory_192324| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@125)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@125)) 3))))
 :qid |AccountFreezingbpl.17393:20|
 :skolemid |316|
))) (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (= (|Select__T@[Int]Bool_| (|domain#$Memory_192719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@126)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@126)) 4))))
 :qid |AccountFreezingbpl.17397:20|
 :skolemid |317|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (= (|Select__T@[Int]Bool_| (|domain#$Memory_225364| $1_VASP_ParentVASP_$memory) addr@@127)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@127)) 5))))
 :qid |AccountFreezingbpl.17401:20|
 :skolemid |318|
)))) (and (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (= (|Select__T@[Int]Bool_| (|domain#$Memory_225300| $1_VASP_ChildVASP_$memory) addr@@128)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_187547| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) addr@@128)) 6))))
 :qid |AccountFreezingbpl.17405:20|
 :skolemid |319|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189256| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_189340| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_187421| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@6)) ($1_Signer_is_txn_signer _$t0@@6)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@6))) (|$IsValid'address'| _$t1@@2)) (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@10)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@10))
 :qid |AccountFreezingbpl.17426:20|
 :skolemid |320|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@10))
)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $a_0@@11)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@11))
 :qid |AccountFreezingbpl.17430:20|
 :skolemid |321|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_187547| $1_Roles_RoleId_$memory) $a_0@@11))
)))) (and (and (and (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@12)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@12))
 :qid |AccountFreezingbpl.17434:20|
 :skolemid |322|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@12))
)) (forall (($a_0@@13 Int) ) (! (let (($rsc@@13 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@13)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@13))
 :qid |AccountFreezingbpl.17438:20|
 :skolemid |323|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_188942| $1_AccountFreezing_FreezingBit_$memory) $a_0@@13))
))) (and (= $t5@@2 (|$addr#$signer| _$t0@@6)) (= $t6@@1 (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_188871| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (= $t7@@1 ($1_AccountFreezing_UnfreezeAccountEvent (|$addr#$signer| _$t0@@6) _$t1@@2)) (= _$t0@@6 _$t0@@6)) (and (= _$t1@@2 _$t1@@2) (= $t8  (not (|Select__T@[Int]Bool_| (|domain#$Memory_186869| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 378108) 379159) anon21_Then_correct@@1) (=> (= (ControlFlow 0 378108) 378166) anon21_Else_correct@@1))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@6  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@14 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_149542_| (|streams#$EventStore| $es) handle@@14)))
 (and (= (|l#Multiset_149542| stream@@15) 0) (forall ((v@@60 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_149542| stream@@15) v@@60) 0)
 :qid |AccountFreezingbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountFreezingbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 376916) 378108)) anon0$1_correct@@6)))
(let ((anon0_correct@@6  (=> (= (seq.len (|p#$Mutation_235887| $t16)) 0) (=> (and (and (= (seq.len (|p#$Mutation_45139| $t17)) 0) (= (seq.len (|p#$Mutation_235929| $t20@@0)) 0)) (and (= (seq.len (|p#$Mutation_180695| $t21)) 0) (= (ControlFlow 0 376926) 376916))) inline$$InitEventStore$0$anon0_correct@@6))))
(let ((PreconditionGeneratedEntry_correct@@1  (=> (= (ControlFlow 0 651806) 376926) anon0_correct@@6)))
