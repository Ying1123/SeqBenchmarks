...
(assert (not
 (=> (= (ControlFlow 0 0) 248325) (let ((anon15_Else_correct@@1  (=> (not $abort_flag@0@@3) (=> (and (and (= $t12@0@@0 (|$dummy_field#$1_DiemTransactionPublishingOption_HaltAllTransactions| $t11@@1)) (= (ControlFlow 0 183146) (- 0 249477))) (|Select__T@[Int]Bool_| (|domain#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_101944| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))))
(let ((anon15_Then_correct@@1 true))
(let ((anon14_Then$1_correct@@0  (=> (and (= $abort_flag@0@@3 true) (= $abort_code@1@@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 183212) 183160) anon15_Then_correct@@1) (=> (= (ControlFlow 0 183212) 183146) anon15_Else_correct@@1)))))
(let ((anon14_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7@@1)) (= (ControlFlow 0 183210) 183212)) anon14_Then$1_correct@@0)))
(let ((anon14_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7@@1) (=> (and (and (= $t11@0@@0 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7@@1)) (= $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory@0@@0 ($Memory_129181 (|Store__T@[Int]Bool_| (|domain#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7@@1 false) (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory)))) (and (= $abort_flag@0@@3 false) (= $abort_code@1@@3 $abort_code@0@@3))) (and (=> (= (ControlFlow 0 183110) 183160) anon15_Then_correct@@1) (=> (= (ControlFlow 0 183110) 183146) anon15_Else_correct@@1))))))
(let ((anon13_Then_correct@@0  (=> $t8@0 (and (=> (= (ControlFlow 0 183090) 183210) anon14_Then_correct@@1) (=> (= (ControlFlow 0 183090) 183110) anon14_Else_correct@@1)))))
(let ((anon13_Else_correct@@0 true))
(let ((anon12_Else_correct@@0  (=> (and (not $t5@@2) (|$IsValid'address'| $t7@@1)) (=> (and (and (and (= $t7@@1 (|$addr#$signer| _$t0@@4)) (= $t7@@1 $t7@@1)) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $t7@@1)) (|$IsValid'u64'| 2))) (and (and (|$IsValid'u64'| $t10@@2) (= $t10@@2 6)) (and (= $t10@@2 $t10@@2) (= $t8@0 $t8@0)))) (and (=> (= (ControlFlow 0 183064) 183090) anon13_Then_correct@@0) (=> (= (ControlFlow 0 183064) 183080) anon13_Else_correct@@0))))))
(let ((anon12_Then_correct@@0 true))
(let ((anon0$1_correct@@4  (=> (and (and (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@117)) 0)) (= addr@@117 173345816)))
 :qid |DiemTransactionPublishingOptionbpl.12056:20|
 :skolemid |286|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100097| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@118)) 1)) (= addr@@118 186537453)))
 :qid |DiemTransactionPublishingOptionbpl.12064:20|
 :skolemid |287|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_100097| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@119)) 2))))))
 :qid |DiemTransactionPublishingOptionbpl.12072:20|
 :skolemid |288|
)) (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@120)) 2))))))
 :qid |DiemTransactionPublishingOptionbpl.12076:20|
 :skolemid |289|
))) (and (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@121)) 2))))))
 :qid |DiemTransactionPublishingOptionbpl.12080:20|
 :skolemid |290|
)) (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@122)) 2))))))
 :qid |DiemTransactionPublishingOptionbpl.12084:20|
 :skolemid |291|
)))) (and (and (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@123)) 2)))))
 :qid |DiemTransactionPublishingOptionbpl.12088:20|
 :skolemid |292|
)) (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@124)) 2)))))
 :qid |DiemTransactionPublishingOptionbpl.12092:20|
 :skolemid |293|
))) (and (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@125)) 2)))))
 :qid |DiemTransactionPublishingOptionbpl.12096:20|
 :skolemid |294|
)) (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105147| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@126) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@126)) 4))))
 :qid |DiemTransactionPublishingOptionbpl.12100:20|
 :skolemid |295|
))))) (=> (and (and (and (and (and (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105717| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@127) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@127)) 3))))
 :qid |DiemTransactionPublishingOptionbpl.12104:20|
 :skolemid |296|
)) (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105717| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@128) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@128)) 3))))
 :qid |DiemTransactionPublishingOptionbpl.12108:20|
 :skolemid |297|
))) (and (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105717| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@129) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_105717| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@129)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@129)) 3))))
 :qid |DiemTransactionPublishingOptionbpl.12112:20|
 :skolemid |298|
)) (let (($range_0@@3 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@130 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_101141| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@130))))))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i1@@3 $i_1@@3))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@131 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_101141| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@131)))) i1@@3))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@131 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_101141| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@131)))) i1@@3)))) 3))))
 :qid |DiemTransactionPublishingOptionbpl.12116:151|
 :skolemid |299|
))))) (and (and (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127839| $1_DualAttestation_Credential_$memory) addr1@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr1@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr1@@3)) 2)))))
 :qid |DiemTransactionPublishingOptionbpl.12121:20|
 :skolemid |300|
)) (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (= (|Select__T@[Int]Bool_| (|domain#$Memory_131660| $1_DiemAccount_DiemAccount_$memory) addr@@132) (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@132)))
 :qid |DiemTransactionPublishingOptionbpl.12125:20|
 :skolemid |301|
))) (and (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (= (|Select__T@[Int]Bool_| (|domain#$Memory_126166| $1_VASPDomain_VASPDomainManager_$memory) addr@@133)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@133)) 1))))
 :qid |DiemTransactionPublishingOptionbpl.12129:20|
 :skolemid |302|
)) (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (= (|Select__T@[Int]Bool_| (|domain#$Memory_126533| $1_VASPDomain_VASPDomains_$memory) addr@@134)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@134)) 5))))
 :qid |DiemTransactionPublishingOptionbpl.12133:20|
 :skolemid |303|
))))) (and (and (and (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_131854| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@135) (|Select__T@[Int]Bool_| (|domain#$Memory_131914| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@135)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@135)) 2)))))
 :qid |DiemTransactionPublishingOptionbpl.12137:20|
 :skolemid |304|
)) (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (= (|Select__T@[Int]Bool_| (|domain#$Memory_131999| $1_DesignatedDealer_Dealer_$memory) addr@@136)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@136)) 2))))
 :qid |DiemTransactionPublishingOptionbpl.12141:20|
 :skolemid |305|
))) (and (forall ((addr@@137 Int) ) (!  (=> (|$IsValid'address'| addr@@137) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127839| $1_DualAttestation_Credential_$memory) addr@@137)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@137)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@137)) 5)))))
 :qid |DiemTransactionPublishingOptionbpl.12145:20|
 :skolemid |306|
)) (forall ((addr@@138 Int) ) (!  (=> (|$IsValid'address'| addr@@138) (= (|Select__T@[Int]Bool_| (|domain#$Memory_100962| $1_SlidingNonce_SlidingNonce_$memory) addr@@138)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@138) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@138)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@138) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@138)) 1)))))
 :qid |DiemTransactionPublishingOptionbpl.12149:20|
 :skolemid |307|
)))) (and (and (forall ((addr@@139 Int) ) (!  (=> (|$IsValid'address'| addr@@139) (= (|Select__T@[Int]Bool_| (|domain#$Memory_105717| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@139)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@139) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@139)) 3))))
 :qid |DiemTransactionPublishingOptionbpl.12153:20|
 :skolemid |308|
)) (forall ((addr@@140 Int) ) (!  (=> (|$IsValid'address'| addr@@140) (= (|Select__T@[Int]Bool_| (|domain#$Memory_105147| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@140)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@140) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@140)) 4))))
 :qid |DiemTransactionPublishingOptionbpl.12157:20|
 :skolemid |309|
))) (and (forall ((addr@@141 Int) ) (!  (=> (|$IsValid'address'| addr@@141) (= (|Select__T@[Int]Bool_| (|domain#$Memory_126630| $1_VASP_ParentVASP_$memory) addr@@141)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@141)) 5))))
 :qid |DiemTransactionPublishingOptionbpl.12161:20|
 :skolemid |310|
)) (forall ((addr@@142 Int) ) (!  (=> (|$IsValid'address'| addr@@142) (= (|Select__T@[Int]Bool_| (|domain#$Memory_126566| $1_VASP_ChildVASP_$memory) addr@@142)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) addr@@142)) 6))))
 :qid |DiemTransactionPublishingOptionbpl.12165:20|
 :skolemid |311|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@4)) ($1_Signer_is_txn_signer _$t0@@4)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@4))) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) $a_0@@11)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@11))
 :qid |DiemTransactionPublishingOptionbpl.12171:20|
 :skolemid |312|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) $a_0@@11))
))) (and (and (forall (($a_0@@12 Int) ) (! (let (($rsc@@12 (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@12)))
(|$IsValid'$1_DiemTransactionPublishingOption_HaltAllTransactions'| $rsc@@12))
 :qid |DiemTransactionPublishingOptionbpl.12175:20|
 :skolemid |313|
 :pattern ( (|Select__T@[Int]$1_DiemTransactionPublishingOption_HaltAllTransactions_| (|contents#$Memory_129181| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) $a_0@@12))
)) (= _$t0@@4 _$t0@@4)) (and (= $t4@@2 (|$addr#$signer| _$t0@@4)) (= $t5@@2  (or (or (or (not (= (|$addr#$signer| _$t0@@4) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_100775| $1_Roles_RoleId_$memory) $t4@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_100775| $1_Roles_RoleId_$memory) $t4@@2)) 0))) (not (= (|$addr#$signer| _$t0@@4) 173345816)))))))) (and (=> (= (ControlFlow 0 182998) 183304) anon12_Then_correct@@0) (=> (= (ControlFlow 0 182998) 183064) anon12_Else_correct@@0)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@4  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_73622_| (|streams#$EventStore| $es) handle@@6)))
 (and (= (|l#Multiset_73622| stream@@5) 0) (forall ((v@@37 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_73622| stream@@5) v@@37) 0)
 :qid |DiemTransactionPublishingOptionbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTransactionPublishingOptionbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 182170) 182998)) anon0$1_correct@@4)))
(let ((anon0_correct@@4  (=> (= (ControlFlow 0 248325) 182170) inline$$InitEventStore$0$anon0_correct@@4)))
anon0_correct@@4)))))))))))))
))
(check-sat)
(pop 1)
