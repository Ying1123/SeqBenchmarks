...
(declare-fun $t1@0 () |T@$1_Diem_Diem'#0'|)
(declare-fun _$t0 () |T@$1_DiemAccount_Balance'#0'|)
(declare-fun $es () T@$EventStore)
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_balance_for$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2220919) (let ((anon4_Else_correct  (=> (and (not false) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1320618) (- 0 2221075)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.50453:15|
 :skolemid |1563|
 ...
 :qid |DiemAccountbpl.50453:15|
 :skolemid |1563|
)) (=> (= (ControlFlow 0 1320618) (- 0 2221111)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.50458:15|
 :skolemid |1564|
))))))))
(let ((anon4_Then_correct true))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= $t1@0 $t1@0) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| $t1@0)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1320516) 1320636) anon4_Then_correct) (=> (= (ControlFlow 0 1320516) 1320618) anon4_Else_correct))))))
(let ((anon0$1_correct  (=> (and (and (|$IsValid'$1_DiemAccount_Balance'#0''| _$t0) (= _$t0 _$t0)) (and (= $t1@0 (|$coin#$1_DiemAccount_Balance'#0'| _$t0)) (= (ControlFlow 0 1320522) 1320516))) |inline$$1_Diem_value'#0'$0$anon0_correct|)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1320389) 1320522)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2220919) 1320389) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))
))
(check-sat)
(pop 1)
