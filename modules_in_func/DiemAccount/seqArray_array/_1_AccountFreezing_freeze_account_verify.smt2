...
(declare-fun $t29@0 () T@$Mutation_17352)
(declare-fun $t28@1 () T@$Mutation_580592)
(declare-fun $t29@1 () T@$Mutation_17352)
(declare-fun $t28@2 () T@$Mutation_580592)
...
(declare-fun $t28 () T@$Mutation_580592)
(declare-fun $t28@0 () T@$Mutation_580592)
...
(declare-fun $t29 () T@$Mutation_17352)
(declare-fun $t33 () T@$Mutation_464575)
(push 1)
(set-info :boogie-vc-id $1_AccountFreezing_freeze_account$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2088275) (let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 1142205) (- 0 2090658)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090668)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090680)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090698)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090712)) (not (= _$t1 173345816))) (=> (not (= _$t1 173345816)) (and (=> (= (ControlFlow 0 1142205) (- 0 2090722)) (not (= _$t1 186537453))) (=> (not (= _$t1 186537453)) (and (=> (= (ControlFlow 0 1142205) (- 0 2090732)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090743)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1))) (and (=> (= (ControlFlow 0 1142205) (- 0 2090750)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt 1)) (+ len 1))))))
...
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (=> (= (ControlFlow 0 1142205) (- 0 2090775)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((L7_correct  (and (=> (= (ControlFlow 0 1141536) (- 0 2090471)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (= _$t1 173345816)) (= _$t1 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (= (ControlFlow 0 1141536) (- 0 2090533)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (and (= _$t1 173345816) (= 7 $t13@0))) (and (= _$t1 186537453) (= 7 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= 5 $t13@0))))))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 1142219) 1141536))) L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| (|v#$Mutation_464575| $t33@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_AccountFreezing_FreezeAccountEvent'| $t34@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1142039) 1142219) anon36_Then_correct) (=> (= (ControlFlow 0 1142039) 1142205) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (and (not $abort_flag@1) (= $t33@0 ($Mutation_464575 (|l#$Mutation_580635| $t32@1) (let ((l (|l#Vec_33444| (|p#$Mutation_580635| $t32@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_580635| $t32@1)) l 0) (+ l 1))) (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_580635| $t32@1))))) (and (= $t34@0 ($1_AccountFreezing_FreezeAccountEvent $t30 _$t1)) (= (ControlFlow 0 1142045) 1142039))) |inline$$1_Event_emit_event'$1_AccountFreezing_FreezeAccountEvent'$0$anon0_correct|)))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 1142233) 1141536))) L7_correct)))
(let ((anon34_Then$1_correct  (=> (= $t32@1 $t32) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1142285) 1142233) anon35_Then_correct) (=> (= (ControlFlow 0 1142285) 1142045) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 1142283) 1142285)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t32@0 ($Mutation_580635 ($Global 173345816) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t32@1 $t32@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 1141940) 1142233) anon35_Then_correct) (=> (= (ControlFlow 0 1141940) 1142045) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t29@0 ($Mutation_17352 (|l#$Mutation_580592| $t28@1) (let ((l@@0 (|l#Vec_33444| (|p#$Mutation_580592| $t28@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_580592| $t28@1)) l@@0 0) (+ l@@0 1))) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_580592| $t28@1)))) (= $t29@1 ($Mutation_17352 (|l#$Mutation_17352| $t29@0) (|p#$Mutation_17352| $t29@0) true))) (and (= $t28@2 ($Mutation_580592 (|l#$Mutation_580592| $t28@1) (|p#$Mutation_580592| $t28@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_17352| $t29@1)))) (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_473408 (|Store__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_580592| $t28@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_580592| $t28@2)) (|v#$Mutation_580592| $t28@2)))))) (and (=> (= (ControlFlow 0 1141918) (- 0 2090103)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816))))) (and (=> (= (ControlFlow 0 1141918) (- 0 2090117)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453))))) (and (=> (= (ControlFlow 0 1141918) (- 0 2090131)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr)))
 :qid |DiemAccountbpl.30173:15|
 :skolemid |640|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@0)))
 :qid |DiemAccountbpl.30173:15|
 :skolemid |640|
)) (and (=> (= (ControlFlow 0 1141918) (- 0 2090155)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@1)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |DiemAccountbpl.5568:13|
 :skolemid |174|
)))))
 :qid |DiemAccountbpl.30179:15|
 :skolemid |641|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@2) (=> (not (= (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@2)) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@2)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |DiemAccountbpl.5568:13|
 :skolemid |174|
)))))
 :qid |DiemAccountbpl.30179:15|
 :skolemid |641|
)) (and (=> (= (ControlFlow 0 1141918) (- 0 2090198)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@3)))
 :qid |DiemAccountbpl.30185:15|
 :skolemid |642|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@4)))
 :qid |DiemAccountbpl.30185:15|
 :skolemid |642|
)) (and (=> (= (ControlFlow 0 1141918) (- 0 2090223)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@5)))
 :qid |DiemAccountbpl.30191:15|
 :skolemid |643|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@6)))
 :qid |DiemAccountbpl.30191:15|
 :skolemid |643|
)) (=> (and (and (|$IsValid'address'| $t30) (= $t30 (|$addr#$signer| _$t0))) (and (= $t30 $t30) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 1141918) 1142283) anon34_Then_correct) (=> (= (ControlFlow 0 1141918) 1141940) anon34_Else_correct)))))))))))))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 1142299) 1141536))) L7_correct)))
(let ((anon32_Then$1_correct  (=> (= $t28@1 $t28) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1142351) 1142299) anon33_Then_correct) (=> (= (ControlFlow 0 1142351) 1141918) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= (ControlFlow 0 1142349) 1142351)) anon32_Then$1_correct)))
(let ((anon32_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1) (=> (and (and (= $t28@0 ($Mutation_580592 ($Global _$t1) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (= $t28@1 $t28@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1141684) 1142299) anon33_Then_correct) (=> (= (ControlFlow 0 1141684) 1141918) anon33_Else_correct))))))
(let ((anon31_Then_correct  (=> $t24@0 (and (=> (= (ControlFlow 0 1141662) 1142349) anon32_Then_correct) (=> (= (ControlFlow 0 1141662) 1141684) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (and (not $t24@0) (= $t26 $t26)) (and (= $t13@0 $t26) (= (ControlFlow 0 1141652) 1141536))) L7_correct)))
(let ((anon30_Then_correct  (=> $t21@0 (=> (and (= $t24@0 (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 5)) (and (= $t26 $t26) (= $t24@0 $t24@0))) (and (=> (= (ControlFlow 0 1141636) 1141662) anon31_Then_correct) (=> (= (ControlFlow 0 1141636) 1141652) anon31_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (and (not $t21@0) (= $t23 $t23)) (and (= $t13@0 $t23) (= (ControlFlow 0 1141598) 1141536))) L7_correct)))
(let ((anon29_Then_correct  (=> (and (and (and $t17@0 (|$IsValid'address'| 186537453)) (and (= $t21@0  (not (= _$t1 186537453))) (|$IsValid'u64'| 4))) (and (and (|$IsValid'u64'| $t23) (= $t23 7)) (and (= $t23 $t23) (= $t21@0 $t21@0)))) (and (=> (= (ControlFlow 0 1141582) 1141636) anon30_Then_correct) (=> (= (ControlFlow 0 1141582) 1141598) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not $t17@0) (= $t19 $t19)) (and (= $t13@0 $t19) (= (ControlFlow 0 1141332) 1141536))) L7_correct)))
(let ((anon28_Else_correct  (=> (and (and (and (not $t15) (|$IsValid'address'| 173345816)) (and (= $t17@0  (not (= _$t1 173345816))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t19) (= $t19 7)) (and (= $t19 $t19) (= $t17@0 $t17@0)))) (and (=> (= (ControlFlow 0 1141316) 1141582) anon29_Then_correct) (=> (= (ControlFlow 0 1141316) 1141332) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> $t15 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t14)) (= 5 $t13)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t14)) 1)) (= 3 $t13))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 1142423) 1141536))) L7_correct))))
(let ((anon27_Else_correct  (=> (not $t12) (=> (and (= $t14 (|$addr#$signer| _$t0)) (= $t15  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t14)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t14)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))) (and (=> (= (ControlFlow 0 1141266) 1142423) anon28_Then_correct) (=> (= (ControlFlow 0 1141266) 1141316) anon28_Else_correct))))))
(let ((anon27_Then_correct  (=> $t12 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 1142449) 1141536))) L7_correct))))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7)) 0)) (= addr@@7 173345816)))
 ...
 :qid |DiemAccountbpl.29706:20|
 :skolemid |618|
))))) (and (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@18) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18)) 3))))
 :qid |DiemAccountbpl.29710:20|
 :skolemid |619|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@20))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@21 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@21))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@21 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@21))))) i1)))) 3))))
 :qid |DiemAccountbpl.29734:151|
 :skolemid |621|
 ...
 :qid |DiemAccountbpl.29811:20|
 :skolemid |624|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24)) 5))))
 :qid |DiemAccountbpl.29815:20|
 :skolemid |625|
 ...
 :qid |DiemAccountbpl.29819:20|
 :skolemid |626|
)))) (and (and (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) addr@@26)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@26)) 2))))
 :qid |DiemAccountbpl.29823:20|
 :skolemid |627|
 ...
 :qid |DiemAccountbpl.29835:20|
 :skolemid |630|
))))) (and (and (and (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (= (|Select__T@[Int]Bool_| (|domain#$Memory_472200| $1_SlidingNonce_SlidingNonce_$memory) addr@@30)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@30)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@30)) 1)))))
 :qid |DiemAccountbpl.29839:20|
 :skolemid |631|
)) (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@31)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@31)) 3))))
 :qid |DiemAccountbpl.29843:20|
 :skolemid |632|
))) (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477551| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@32)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@32)) 4))))
 :qid |DiemAccountbpl.29847:20|
 :skolemid |633|
)) (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) addr@@33)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@33)) 5))))
 :qid |DiemAccountbpl.29851:20|
 :skolemid |634|
)))) (and (and (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@34)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@34)) 6))))
 :qid |DiemAccountbpl.29855:20|
 :skolemid |635|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemAccountbpl.29880:20|
 :skolemid |637|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1)))
(|$IsValid'$1_AccountFreezing_FreezeEventsHolder'| $rsc@@1))
 :qid |DiemAccountbpl.29884:20|
 :skolemid |638|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) $a_0@@1))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemAccountbpl.29888:20|
 :skolemid |639|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (= $t9 (|$addr#$signer| _$t0)) (= $t10 (|$freeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (= $t11 ($1_AccountFreezing_FreezeAccountEvent (|$addr#$signer| _$t0) _$t1)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t12  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 1141208) 1142449) anon27_Then_correct) (=> (= (ControlFlow 0 1141208) 1141266) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1140016) 1141208)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_33444| (|p#$Mutation_580592| $t28)) 0) (=> (and (and (= (|l#Vec_33444| (|p#$Mutation_17352| $t29)) 0) (= (|l#Vec_33444| (|p#$Mutation_580635| $t32)) 0)) (and (= (|l#Vec_33444| (|p#$Mutation_464575| $t33)) 0) (= (ControlFlow 0 1140026) 1140016))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2088275) 1140026) anon0_correct)))
