...
(declare-fun $t16@2 () T@$Mutation_552651)
...
(declare-fun $t18@0 () T@$Mutation_464575)
...
(declare-fun $t16@1 () T@$Mutation_552651)
(declare-fun $t17@0 () T@$Mutation_455163)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t17@1 () T@$Mutation_455163)
(declare-fun $t16 () T@$Mutation_552651)
(declare-fun $t11 () Int)
(declare-fun $t16@0 () T@$Mutation_552651)
...
(declare-fun $t8 () Int)
(declare-fun $t5 () T@$Mutation_552651)
(declare-fun $t17 () T@$Mutation_455163)
(declare-fun $t18 () T@$Mutation_464575)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_base_url$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2075953) (let ((anon19_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_477889 (|Store__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_552651| $t16@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_552651| $t16@2)) (|v#$Mutation_552651| $t16@2))))) (and (=> (= (ControlFlow 0 1125743) (- 0 2077034)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory@0) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DiemAccountbpl.22928:15|
 :skolemid |475|
 ...
 :qid |DiemAccountbpl.22946:15|
 :skolemid |478|
)) (and (=> (= (ControlFlow 0 1125743) (- 0 2077189)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t6))) (and (=> (= (ControlFlow 0 1125743) (- 0 2077201)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1125743) (- 0 2077211)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory@0) $t7)) _$t1) (and (=> (= (ControlFlow 0 1125743) (- 0 2077224)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DiemAccountbpl.22970:15|
 :skolemid |479|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t7)) (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DiemAccountbpl.22970:15|
 :skolemid |479|
)) (and (=> (= (ControlFlow 0 1125743) (- 0 2077262)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt 1)) (+ len 1))))))
...
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (=> (= (ControlFlow 0 1125743) (- 0 2077287)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t10) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 1125219) (- 0 2076956)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 1125219) (- 0 2076970)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t6)) (= 5 $t15@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15@0))))))))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 1125757) 1125219))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| (|v#$Mutation_464575| $t18@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DualAttestation_BaseUrlRotationEvent'| $t21@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1125422) 1125757) anon19_Then_correct) (=> (= (ControlFlow 0 1125422) 1125743) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not $t20) (=> (and (and (|$IsValid'u64'| $t19) (= $t19 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t21@0 ($1_DualAttestation_BaseUrlRotationEvent _$t1 $t19)) (= (ControlFlow 0 1125428) 1125422))) |inline$$1_Event_emit_event'$1_DualAttestation_BaseUrlRotationEvent'$0$anon0_correct|))))
(let ((anon18_Then_correct  (=> $t20 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t15)) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 1125783) 1125219))) L3_correct))))
(let ((anon17_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_552651| $t16@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t17@0 ($Mutation_455163 (|l#$Mutation_552651| $t16@1) (let ((l (|l#Vec_33444| (|p#$Mutation_552651| $t16@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_552651| $t16@1)) l 1) (+ l 1))) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)))))) (and (and (= $t17@1 ($Mutation_455163 (|l#$Mutation_455163| $t17@0) (|p#$Mutation_455163| $t17@0) _$t1)) (= $t16@2 ($Mutation_552651 (|l#$Mutation_552651| $t16@1) (|p#$Mutation_552651| $t16@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)) (|v#$Mutation_455163| $t17@1) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@1)))))) (and (= $t18@0 ($Mutation_464575 (|l#$Mutation_552651| $t16@2) (let ((l@@0 (|l#Vec_33444| (|p#$Mutation_552651| $t16@2))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_552651| $t16@2)) l@@0 5) (+ l@@0 1))) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_552651| $t16@2)))) (= $t20  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 1125323) 1125783) anon18_Then_correct) (=> (= (ControlFlow 0 1125323) 1125428) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 1125797) 1125219))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1125849) 1125797) anon17_Then_correct) (=> (= (ControlFlow 0 1125849) 1125323) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t11)) (= (ControlFlow 0 1125847) 1125849)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t11) (=> (and (and (= $t16@0 ($Mutation_552651 ($Global $t11) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) $t11))) (= $t16@1 $t16@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1125245) 1125797) anon17_Then_correct) (=> (= (ControlFlow 0 1125245) 1125323) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t12@0 (and (=> (= (ControlFlow 0 1125223) 1125847) anon16_Then_correct) (=> (= (ControlFlow 0 1125223) 1125245) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 1125163) 1125219))) L3_correct)))
...
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DiemAccountbpl.22743:20|
 :skolemid |474|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) $a_0@@0))
)))) (and (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$base_url_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_477889| $1_DualAttestation_Credential_$memory) $t8))))) (and (and (= $t10 ($1_DualAttestation_BaseUrlRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t11)))) (and (and (and (= $t11 (|$addr#$signer| _$t0)) (= $t11 $t11)) (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) $t11)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 5)) (and (= $t14 $t14) (= $t12@0 $t12@0)))))) (and (=> (= (ControlFlow 0 1125147) 1125223) anon15_Then_correct) (=> (= (ControlFlow 0 1125147) 1125163) anon15_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1124577) 1125147)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_33444| (|p#$Mutation_552651| $t5)) 0) (=> (and (and (= (|l#Vec_33444| (|p#$Mutation_552651| $t16)) 0) (= (|l#Vec_33444| (|p#$Mutation_455163| $t17)) 0)) (and (= (|l#Vec_33444| (|p#$Mutation_464575| $t18)) 0) (= (ControlFlow 0 1124587) 1124577))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2075953) 1124587) anon0_correct)))
