...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_script_prologue$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2573715) (let ((anon11_Else_correct  (=> (not $abort_flag@30) (and (=> (= (ControlFlow 0 1880157) (- 0 2581965)) (not (not (let ((publish_option (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
 ...
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
))))))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2581979)) (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)))))) (=> (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2581992)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582004)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t12))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t12) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t12)))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582014)) (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12)))))) (=> (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582033)) (not (> $t11 18446744073709551615))) (=> (not (> $t11 18446744073709551615)) (and (=> (= (ControlFlow 0 1880157) (- 0 2582044)) (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453))))) (=> (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582062)) (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t12))))) (=> (not (and (> $t11 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t12)))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582082)) (not (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11)))) (=> (not (and (> $t11 0) (< (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $t12))) $t11))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582104)) (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5))) (=> (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (and (=> (= (ControlFlow 0 1880157) (- 0 2582115)) (not (>= _$t1 18446744073709551615))) (=> (not (>= _$t1 18446744073709551615)) (and (=> (= (ControlFlow 0 1880157) (- 0 2582125)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t12)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t12)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582149)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t12)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t12)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t12))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582173)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t12) (not (let ((crsn (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $t12)))
...
(ite  (or (< _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0)) (>= _$t1 (+ (|$min_nonce#$1_CRSN_CRSN| crsn@@0) (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0)))))) false (let ((scaled_nonce@@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0))))
 (not (ite (>= scaled_nonce@@0 (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0)))) false (|Select__T@[Int]Bool_| (|v#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0))) scaled_nonce@@0))))))))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582193)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582203)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1880157) (- 0 2582220)) (let ((addr@@1 (|$addr#$signer| _$t0)))
 ...
 :qid |DiemAccountbpl.93618:15|
 :skolemid |3328|
)) (=> (= (ControlFlow 0 1880157) (- 0 2582268)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@5))))))
 :qid |DiemAccountbpl.93623:15|
 :skolemid |3329|
))))))))))))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1870764) (- 0 2581429)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (not (let ((publish_option@@1 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))))
...
(let ((anon11_Then_correct  (=> (and (and $abort_flag@30 (= $abort_code@28 $abort_code@28)) (and (= $t14@0 $abort_code@28) (= (ControlFlow 0 1880171) 1870764))) L3_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|  (=> (and (= $abort_code@28 $abort_code@27) (= $abort_flag@30 $abort_flag@29)) (and (=> (= (ControlFlow 0 1875199) 1880171) anon11_Then_correct) (=> (= (ControlFlow 0 1875199) 1880157) anon11_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Then_correct|  (=> (and (and inline$$1_CRSN_check$0$$ret0@1 (= $abort_flag@29 $abort_flag@28)) (and (= $abort_code@27 $abort_code@26) (= (ControlFlow 0 1878449) 1875199))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Then_correct|  (=> (and (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| (= $abort_flag@29 $abort_flag@16)) (and (= $abort_code@27 $abort_code@15) (= (ControlFlow 0 1875195) 1875199))) |inline$$1_DiemAccount_prologue_common'#0'$0$L27_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|  (=> (and (= $abort_code@28 |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1|) (= $abort_flag@30 true)) (and (=> (= (ControlFlow 0 1873410) 1880171) anon11_Then_correct) (=> (= (ControlFlow 0 1873410) 1880157) anon11_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Else_correct|  (=> (and (and (not inline$$Ge$2$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= (ControlFlow 0 1879589) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|  (=> (and (and $abort_flag@14 (= $abort_code@13 $abort_code@13)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@13) (= (ControlFlow 0 1879607) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= (ControlFlow 0 1878720) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Else_correct|  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= (ControlFlow 0 1878662) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Then_correct|  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@11) (= (ControlFlow 0 1879621) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Else_correct|  (=> (and (and (not inline$$1_CRSN_check$0$$ret0@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= (ControlFlow 0 1878445) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|  (=> (and (not $abort_flag@28) (|$IsValid'u64'| 1014)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t93@0|) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@1))) (and (=> (= (ControlFlow 0 1878429) 1878449) |inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Then_correct|) (=> (= (ControlFlow 0 1878429) 1878445) |inline$$1_DiemAccount_prologue_common'#0'$0$anon105_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|  (=> (and (and $abort_flag@28 (= $abort_code@26 $abort_code@26)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@26) (= (ControlFlow 0 1878463) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_CRSN_check$0$L9_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$1_CRSN_check$0$$t5@1) (= $abort_code@26 $abort_code@25)) (and (= $abort_flag@28 $abort_flag@27) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$t5@1))) (and (=> (= (ControlFlow 0 1878165) 1878463) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|) (=> (= (ControlFlow 0 1878165) 1878429) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|)))))
(let ((inline$$1_CRSN_check$0$anon43_Else$1_correct  (=> (= inline$$Not$1$dst@1 inline$$Not$1$dst@1) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$Not$1$dst@1) (= $abort_flag@27 $abort_flag@26)) (and (= $abort_code@25 $abort_code@24) (= (ControlFlow 0 1878153) 1878165))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not inline$$1_BitVector_is_index_set$0$$ret0@1)) (= (ControlFlow 0 1878135) 1878153)) inline$$1_CRSN_check$0$anon43_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon43_Else_correct  (=> (and (not $abort_flag@26) (= (ControlFlow 0 1878141) 1878135)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon41_Then_correct  (=> (and inline$$1_CRSN_check$0$$t4@1 (= false false)) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 false) (= $abort_flag@27 $abort_flag@23)) (and (= $abort_code@25 $abort_code@21) (= (ControlFlow 0 1878215) 1878165))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$1_CRSN_check$0$L11_correct  (=> (= $abort_code@26 inline$$1_CRSN_check$0$$t13@1) (=> (and (= $abort_flag@28 true) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@0)) (and (=> (= (ControlFlow 0 1876318) 1878463) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Then_correct|) (=> (= (ControlFlow 0 1876318) 1878429) |inline$$1_DiemAccount_prologue_common'#0'$0$anon104_Else_correct|))))))
(let ((inline$$1_CRSN_check$0$anon43_Then_correct  (=> (and (and $abort_flag@26 (= $abort_code@24 $abort_code@24)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@24) (= (ControlFlow 0 1878179) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Else_correct  (=> (not $abort_flag@25) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_flag@26 $abort_flag@25)) (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_code@24 $abort_code@23))) (and (=> (= (ControlFlow 0 1878063) 1878179) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1878063) 1878141) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$L3_correct  (=> (= $abort_flag@26 true) (=> (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 inline$$1_BitVector_is_index_set$0$$ret0@0) (= $abort_code@24 inline$$1_BitVector_is_index_set$0$$t6@1)) (and (=> (= (ControlFlow 0 1877896) 1878179) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1877896) 1878141) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Then_correct  (=> (and (and $abort_flag@25 (= $abort_code@23 $abort_code@23)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@23) (= (ControlFlow 0 1878077) 1877896))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|  (=> (= $abort_code@23 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@25 true) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@0|)) (and (=> (= (ControlFlow 0 1878039) 1878077) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1878039) 1878063) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2)) (= (ControlFlow 0 1878037) 1878039)) |inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|  (=> (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@1| (|Select__T@[Int]Bool_| (|v#Vec_92615| inline$$1_BitVector_is_index_set$0$$t10@1) inline$$Sub$0$dst@2)) (= $abort_code@23 $abort_code@22)) (and (= $abort_flag@25 $abort_flag@24) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@1|))) (and (=> (= (ControlFlow 0 1877987) 1878077) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1877987) 1878063) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Then_correct  (=> (and inline$$Lt$3$dst@1 (= inline$$1_BitVector_is_index_set$0$$t10@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1))) (and (=> (= (ControlFlow 0 1878045) 1878037) |inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1878045) 1877987) |inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|)))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Else_correct  (=> (and (and (not inline$$Lt$3$dst@1) (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 inline$$1_BitVector_is_index_set$0$$t9@0) (= (ControlFlow 0 1877890) 1877896))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$1_BitVector_is_index_set$0$$t9@0 7)) (and (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$Lt$3$dst@1 inline$$Lt$3$dst@1))) (and (=> (= (ControlFlow 0 1877874) 1878045) inline$$1_BitVector_is_index_set$0$anon9_Then_correct) (=> (= (ControlFlow 0 1877874) 1877890) inline$$1_BitVector_is_index_set$0$anon9_Else_correct))))))
(let ((inline$$Lt$3$anon0_correct  (=> (and (= inline$$Lt$3$dst@1 (< inline$$Sub$0$dst@2 |inline$$1_Vector_length'bool'$1$l@1|)) (= (ControlFlow 0 1877838) 1877874)) inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else_correct  (=> (and (not $abort_flag@24) (= (ControlFlow 0 1877844) 1877838)) inline$$Lt$3$anon0_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Then_correct  (=> (and (and $abort_flag@24 (= $abort_code@22 $abort_code@22)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@22) (= (ControlFlow 0 1878091) 1877896))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_length'bool'$1$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$1$l@1| (|l#Vec_92615| inline$$1_BitVector_is_index_set$0$$t4@1)) (and (=> (= (ControlFlow 0 1877784) 1878091) inline$$1_BitVector_is_index_set$0$anon8_Then_correct) (=> (= (ControlFlow 0 1877784) 1877844) inline$$1_BitVector_is_index_set$0$anon8_Else_correct)))))
(let ((inline$$1_BitVector_is_index_set$0$anon0_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t31@1 inline$$1_CRSN_check$0$$t31@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_BitVector_is_index_set$0$$t4@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1)) (= (ControlFlow 0 1877790) 1877784))) |inline$$1_Vector_length'bool'$1$anon0_correct|)))
(let ((inline$$1_CRSN_check$0$anon42_Else_correct  (=> (and (and (not $abort_flag@24) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_CRSN_check$0$$t31@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1878097) 1877790))) inline$$1_BitVector_is_index_set$0$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon42_Then_correct  (=> (and (and $abort_flag@24 (= $abort_code@22 $abort_code@22)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@22) (= (ControlFlow 0 1878193) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@24 true) (=> (and (= $abort_code@22 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 1877431) 1878193) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1877431) 1878097) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< _$t1 inline$$1_CRSN_check$0$$t29@1) (= (ControlFlow 0 1877429) 1877431)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$1_CRSN_check$0$$t29@1 _$t1) (=> (and (and (= inline$$Sub$0$dst@1 (- _$t1 inline$$1_CRSN_check$0$$t29@1)) (= $abort_flag@24 $abort_flag@23)) (and (= $abort_code@22 $abort_code@21) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 1877381) 1878193) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1877381) 1878097) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon41_Else_correct  (=> (and (not inline$$1_CRSN_check$0$$t4@1) (= inline$$1_CRSN_check$0$$t29@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1877437) 1877429) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 1877437) 1877381) inline$$Sub$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon40_Else$1_correct  (=> (and (and (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1) (= $abort_code@21 $abort_code@20)) (and (= inline$$1_CRSN_check$0$$t4@1 inline$$Ge$1$dst@1) (= $abort_flag@23 $abort_flag@22))) (and (=> (= (ControlFlow 0 1877286) 1878215) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1877286) 1877437) inline$$1_CRSN_check$0$anon41_Else_correct)))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= inline$$CastU128$3$dst@1 inline$$AddU128$0$dst@2)) (= (ControlFlow 0 1877268) 1877286)) inline$$1_CRSN_check$0$anon40_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon40_Else_correct  (=> (and (not $abort_flag@22) (= (ControlFlow 0 1877274) 1877268)) inline$$Ge$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon35_Then_correct  (=> inline$$Lt$2$dst@1 (=> (and (and (= true true) (= $abort_code@21 $abort_code@16)) (and (= inline$$1_CRSN_check$0$$t4@1 true) (= $abort_flag@23 $abort_flag@17))) (and (=> (= (ControlFlow 0 1878303) 1878215) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1878303) 1877437) inline$$1_CRSN_check$0$anon41_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon40_Then_correct  (=> (and (and $abort_flag@22 (= $abort_code@20 $abort_code@20)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@20) (= (ControlFlow 0 1878229) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$AddU128$0$anon3_Then$1_correct  (=> (= $abort_flag@22 true) (=> (and (= $abort_code@20 $EXEC_FAILURE_CODE) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@0)) (and (=> (= (ControlFlow 0 1877214) 1878229) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1877214) 1877274) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$AddU128$0$anon3_Then_correct  (=> (and (> (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1) $MAX_U128) (= (ControlFlow 0 1877212) 1877214)) inline$$AddU128$0$anon3_Then$1_correct)))
(let ((inline$$AddU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (=> (and (and (= inline$$AddU128$0$dst@1 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (= $abort_flag@22 $abort_flag@21)) (and (= $abort_code@20 $abort_code@19) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@1))) (and (=> (= (ControlFlow 0 1877160) 1878229) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1877160) 1877274) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon39_Else_correct  (=> (not $abort_flag@21) (and (=> (= (ControlFlow 0 1877220) 1877212) inline$$AddU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1877220) 1877160) inline$$AddU128$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon39_Then_correct  (=> (and (and $abort_flag@21 (= $abort_code@19 $abort_code@19)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@19) (= (ControlFlow 0 1878243) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$5$anon3_Then$1_correct  (=> (= $abort_code@19 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@21 true) (= inline$$CastU128$5$dst@1 inline$$CastU128$5$dst@0)) (and (=> (= (ControlFlow 0 1877053) 1878243) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1877053) 1877220) inline$$1_CRSN_check$0$anon39_Else_correct))))))
(let ((inline$$CastU128$5$anon3_Then_correct  (=> (and (> inline$$1_BitVector_length$0$$ret0@1 $MAX_U128) (= (ControlFlow 0 1877051) 1877053)) inline$$CastU128$5$anon3_Then$1_correct)))
(let ((inline$$CastU128$5$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_BitVector_length$0$$ret0@1) (= $abort_code@19 $abort_code@18)) (and (= $abort_flag@21 $abort_flag@20) (= inline$$CastU128$5$dst@1 inline$$1_BitVector_length$0$$ret0@1))) (and (=> (= (ControlFlow 0 1877003) 1878243) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1877003) 1877220) inline$$1_CRSN_check$0$anon39_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Else_correct  (=> (not $abort_flag@20) (and (=> (= (ControlFlow 0 1877059) 1877051) inline$$CastU128$5$anon3_Then_correct) (=> (= (ControlFlow 0 1877059) 1877003) inline$$CastU128$5$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Then_correct  (=> (and (and $abort_flag@20 (= $abort_code@18 $abort_code@18)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@18) (= (ControlFlow 0 1878257) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_length$0$anon3_Else_correct  (=> (and (and (not $abort_flag@19) (= |inline$$1_Vector_length'bool'$0$l@1| |inline$$1_Vector_length'bool'$0$l@1|)) (and (= $abort_flag@20 $abort_flag@19) (= inline$$1_BitVector_length$0$$ret0@1 |inline$$1_Vector_length'bool'$0$l@1|))) (and (=> (= (ControlFlow 0 1876902) 1878257) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1876902) 1877059) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon3_Then_correct  (=> (and (and $abort_flag@19 (= $abort_code@18 $abort_code@18)) (and (= $abort_flag@20 true) (= inline$$1_BitVector_length$0$$ret0@1 inline$$1_BitVector_length$0$$ret0@0))) (and (=> (= (ControlFlow 0 1876920) 1878257) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1876920) 1877059) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((|inline$$1_Vector_length'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$0$l@1| (|l#Vec_92615| inline$$1_BitVector_length$0$$t1@1)) (and (=> (= (ControlFlow 0 1876878) 1876920) inline$$1_BitVector_length$0$anon3_Then_correct) (=> (= (ControlFlow 0 1876878) 1876902) inline$$1_BitVector_length$0$anon3_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t23@1 inline$$1_CRSN_check$0$$t23@1) (=> (and (= inline$$1_BitVector_length$0$$t1@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t23@1)) (= (ControlFlow 0 1876884) 1876878)) |inline$$1_Vector_length'bool'$0$anon0_correct|))))
(let ((inline$$1_CRSN_check$0$anon37_Else_correct  (=> (not $abort_flag@19) (=> (and (= inline$$1_CRSN_check$0$$t23@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1876926) 1876884)) inline$$1_BitVector_length$0$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon37_Then_correct  (=> (and (and $abort_flag@19 (= $abort_code@18 $abort_code@18)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@18) (= (ControlFlow 0 1878271) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$4$anon3_Then$1_correct  (=> (= $abort_flag@19 true) (=> (and (= $abort_code@18 $EXEC_FAILURE_CODE) (= inline$$CastU128$4$dst@1 inline$$CastU128$4$dst@0)) (and (=> (= (ControlFlow 0 1876682) 1878271) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1876682) 1876926) inline$$1_CRSN_check$0$anon37_Else_correct))))))
(let ((inline$$CastU128$4$anon3_Then_correct  (=> (and (> inline$$1_CRSN_check$0$$t21@1 $MAX_U128) (= (ControlFlow 0 1876680) 1876682)) inline$$CastU128$4$anon3_Then$1_correct)))
(let ((inline$$CastU128$4$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_CRSN_check$0$$t21@1) (= $abort_flag@19 $abort_flag@18)) (and (= $abort_code@18 $abort_code@17) (= inline$$CastU128$4$dst@1 inline$$1_CRSN_check$0$$t21@1))) (and (=> (= (ControlFlow 0 1876632) 1878271) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1876632) 1876926) inline$$1_CRSN_check$0$anon37_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Else_correct  (=> (and (not $abort_flag@18) (= inline$$1_CRSN_check$0$$t21@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1876688) 1876680) inline$$CastU128$4$anon3_Then_correct) (=> (= (ControlFlow 0 1876688) 1876632) inline$$CastU128$4$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Then_correct  (=> (and (and $abort_flag@18 (= $abort_code@17 $abort_code@17)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@17) (= (ControlFlow 0 1878285) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$3$anon3_Then$1_correct  (=> (= $abort_code@17 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@18 true) (= inline$$CastU128$3$dst@1 inline$$CastU128$3$dst@0)) (and (=> (= (ControlFlow 0 1876543) 1878285) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1876543) 1876688) inline$$1_CRSN_check$0$anon36_Else_correct))))))
(let ((inline$$CastU128$3$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1876541) 1876543)) inline$$CastU128$3$anon3_Then$1_correct)))
(let ((inline$$CastU128$3$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_code@17 $abort_code@16)) (and (= $abort_flag@18 $abort_flag@17) (= inline$$CastU128$3$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1876493) 1878285) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1876493) 1876688) inline$$1_CRSN_check$0$anon36_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon35_Else_correct  (=> (not inline$$Lt$2$dst@1) (and (=> (= (ControlFlow 0 1876549) 1876541) inline$$CastU128$3$anon3_Then_correct) (=> (= (ControlFlow 0 1876549) 1876493) inline$$CastU128$3$anon3_Else_correct)))))
(let ((inline$$Lt$2$anon0_correct  (=> (= inline$$Lt$2$dst@1 (< _$t1 inline$$1_CRSN_check$0$$t17@1)) (and (=> (= (ControlFlow 0 1876410) 1878303) inline$$1_CRSN_check$0$anon35_Then_correct) (=> (= (ControlFlow 0 1876410) 1876549) inline$$1_CRSN_check$0$anon35_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon34_Else_correct  (=> (not $abort_flag@17) (=> (and (and (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)) (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1|)) (and (= inline$$1_CRSN_check$0$$t17@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1876416) 1876410))) inline$$Lt$2$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon34_Then_correct  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@16) (= (ControlFlow 0 1878317) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Then$1_correct  (=> (= $abort_flag@17 true) (=> (and (= $abort_code@16 $EXEC_FAILURE_CODE) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@0)) (and (=> (= (ControlFlow 0 1878369) 1878317) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1878369) 1876416) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon33_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= (ControlFlow 0 1878367) 1878369)) inline$$1_CRSN_check$0$anon33_Then$1_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0) (=> (and (and (= inline$$1_CRSN_check$0$$t16@1 ($Mutation_577037 ($Global inline$$1_CRSN_check$0$$t11@0) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0))) (= $abort_flag@17 $abort_flag@16)) (and (= $abort_code@16 $abort_code@15) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@1))) (and (=> (= (ControlFlow 0 1876344) 1878317) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1876344) 1876416) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon32_Then_correct  (=> inline$$1_CRSN_has_crsn$1$$t1@1 (and (=> (= (ControlFlow 0 1876322) 1878367) inline$$1_CRSN_check$0$anon33_Then_correct) (=> (= (ControlFlow 0 1876322) 1876344) inline$$1_CRSN_check$0$anon33_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon32_Else_correct  (=> (and (and (not inline$$1_CRSN_has_crsn$1$$t1@1) (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0)) (and (= inline$$1_CRSN_check$0$$t13@1 inline$$1_CRSN_check$0$$t15@0) (= (ControlFlow 0 1876312) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon31_Else_correct  (=> (and (not $abort_flag@16) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_check$0$$t15@0 1)) (and (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1))) (and (=> (= (ControlFlow 0 1876296) 1876322) inline$$1_CRSN_check$0$anon32_Then_correct) (=> (= (ControlFlow 0 1876296) 1876312) inline$$1_CRSN_check$0$anon32_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon31_Then_correct  (=> (and (and $abort_flag@16 (= $abort_code@15 $abort_code@15)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@15) (= (ControlFlow 0 1878383) 1876318))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_has_crsn$1$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (=> (and (= inline$$1_CRSN_has_crsn$1$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1)) (and (=> (= (ControlFlow 0 1876254) 1878383) inline$$1_CRSN_check$0$anon31_Then_correct) (=> (= (ControlFlow 0 1876254) 1876296) inline$$1_CRSN_check$0$anon31_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon0_correct  (=> (and (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t7@0)) 0) (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t16@0)) 0)) (=> (and (and (and (= inline$$1_CRSN_check$0$$t9@0 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0))) (= inline$$1_CRSN_check$0$$t10@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| inline$$1_CRSN_check$0$$t9@0)))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| inline$$1_CRSN_check$0$$t11@0) (= inline$$1_CRSN_check$0$$t11@0 (|$addr#$signer| _$t0))) (and (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (= (ControlFlow 0 1876260) 1876254)))) inline$$1_CRSN_has_crsn$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Then_correct|  (=> (and (and inline$$1_CRSN_has_crsn$0$$t1@1 (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0| (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0)))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t90@0| (- _$t1 (|$min_nonce#$1_CRSN_CRSN| |inline$$1_DiemAccount_prologue_common'#0'$0$$t89@0|))) (= (ControlFlow 0 1878389) 1876260))) inline$$1_CRSN_check$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= (ControlFlow 0 1875191) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Then_correct|  (=> (and (and (and inline$$Ge$0$dst@1 (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t98@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| (= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t98@1|)) (|$IsValid'u64'| 1003))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t101@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t99@1|)))) (and (=> (= (ControlFlow 0 1875175) 1875195) |inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Then_correct|) (=> (= (ControlFlow 0 1875175) 1875191) |inline$$1_DiemAccount_prologue_common'#0'$0$anon107_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Else_correct|  (=> (and (and (not inline$$Ge$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= (ControlFlow 0 1875129) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else$1_correct|  (=> (|$IsValid'u64'| 1002) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t97@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 1875113) 1875175) |inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Then_correct|) (=> (= (ControlFlow 0 1875113) 1875129) |inline$$1_DiemAccount_prologue_common'#0'$0$anon106_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= _$t1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t94@1|)) (= (ControlFlow 0 1875073) 1875113)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else_correct|  (=> (not inline$$1_CRSN_has_crsn$0$$t1@1) (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t94@1| (|$sequence_number#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|)) (= (ControlFlow 0 1875079) 1875073)) inline$$Ge$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Else_correct|  (=> (not $abort_flag@16) (and (=> (= (ControlFlow 0 1875021) 1878389) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Then_correct|) (=> (= (ControlFlow 0 1875021) 1875079) |inline$$1_DiemAccount_prologue_common'#0'$0$anon103_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Then_correct|  (=> (and (and $abort_flag@16 (= $abort_code@15 $abort_code@15)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@15) (= (ControlFlow 0 1878477) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_CRSN_has_crsn$0$anon0_correct  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= inline$$1_CRSN_has_crsn$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= inline$$1_CRSN_has_crsn$0$$t1@1 inline$$1_CRSN_has_crsn$0$$t1@1)) (and (=> (= (ControlFlow 0 1875007) 1878477) |inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Then_correct|) (=> (= (ControlFlow 0 1875007) 1875021) |inline$$1_DiemAccount_prologue_common'#0'$0$anon102_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Then_correct|  (=> (and inline$$Lt$1$dst@1 (= (ControlFlow 0 1875013) 1875007)) inline$$1_CRSN_has_crsn$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Else_correct|  (=> (and (and (not inline$$Lt$1$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= (ControlFlow 0 1874906) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else$1_correct|  (=> (|$IsValid'u64'| 1011) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| 8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t87@0|) (= inline$$Lt$1$dst@1 inline$$Lt$1$dst@1))) (and (=> (= (ControlFlow 0 1874890) 1875013) |inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Then_correct|) (=> (= (ControlFlow 0 1874890) 1874906) |inline$$1_DiemAccount_prologue_common'#0'$0$anon101_Else_correct|))))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$CastU128$2$dst@1 18446744073709551615)) (= (ControlFlow 0 1874850) 1874890)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|  (=> (not $abort_flag@16) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1874856) 1874850)) inline$$Lt$1$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|  (=> (and (and $abort_flag@16 (= $abort_code@15 $abort_code@15)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@15) (= (ControlFlow 0 1878491) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$2$anon3_Then$1_correct  (=> (= $abort_code@15 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@16 true) (= inline$$CastU128$2$dst@1 inline$$CastU128$2$dst@0)) (and (=> (= (ControlFlow 0 1874790) 1878491) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|) (=> (= (ControlFlow 0 1874790) 1874856) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|))))))
(let ((inline$$CastU128$2$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1874788) 1874790)) inline$$CastU128$2$anon3_Then$1_correct)))
(let ((inline$$CastU128$2$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_code@15 $abort_code@14)) (and (= $abort_flag@16 $abort_flag@15) (= inline$$CastU128$2$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1874740) 1878491) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Then_correct|) (=> (= (ControlFlow 0 1874740) 1874856) |inline$$1_DiemAccount_prologue_common'#0'$0$anon100_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Then_correct|  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 1874796) 1874788) inline$$CastU128$2$anon3_Then_correct) (=> (= (ControlFlow 0 1874796) 1874740) inline$$CastU128$2$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Else_correct|  (=> (and (and (not inline$$Lt$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= (ControlFlow 0 1874667) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else$1_correct|  (=> (|$IsValid'u64'| 1006) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t82@0|) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 1874651) 1874796) |inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Then_correct|) (=> (= (ControlFlow 0 1874651) 1874667) |inline$$1_DiemAccount_prologue_common'#0'$0$anon99_Else_correct|))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0| _$t5)) (= (ControlFlow 0 1874611) 1874651)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0|) (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t78@0| (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)) (= (ControlFlow 0 1874617) 1874611))) inline$$Lt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@0|) (= (ControlFlow 0 1878517) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t79@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1874549) 1878517) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Then_correct|) (=> (= (ControlFlow 0 1874549) 1874617) |inline$$1_DiemAccount_prologue_common'#0'$0$anon98_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Then_correct|  (=> (and (and inline$$Ge$2$dst@1 (= $abort_flag@15 $abort_flag@14)) (and (= $abort_code@14 $abort_code@13) (= (ControlFlow 0 1879593) 1874549))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t77@0|) (= inline$$Ge$2$dst@1 inline$$Ge$2$dst@1))) (and (=> (= (ControlFlow 0 1879573) 1879593) |inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Then_correct|) (=> (= (ControlFlow 0 1879573) 1879589) |inline$$1_DiemAccount_prologue_common'#0'$0$anon97_Else_correct|))))))
(let ((inline$$Ge$2$anon0_correct  (=> (and (= inline$$Ge$2$dst@1 (>= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| inline$$MulU64$0$dst@2)) (= (ControlFlow 0 1879533) 1879573)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|  (=> (not $abort_flag@14) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@1|) (= (ControlFlow 0 1879539) 1879533)) inline$$Ge$2$anon0_correct))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|  (=> (not $abort_flag@13) (=> (and (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_code@13 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|) (= $abort_flag@14 $abort_flag@13))) (and (=> (= (ControlFlow 0 1879391) 1879607) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|) (=> (= (ControlFlow 0 1879391) 1879539) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$L3_correct|  (=> (= $abort_code@13 |inline$$1_DiemAccount_balance'#0'$0$$t6@1|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance'#0'$0$$ret0@0|) (= $abort_flag@14 true)) (and (=> (= (ControlFlow 0 1879060) 1879607) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Then_correct|) (=> (= (ControlFlow 0 1879060) 1879539) |inline$$1_DiemAccount_prologue_common'#0'$0$anon96_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|  (=> (and (and $abort_flag@13 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@12) (= (ControlFlow 0 1879405) 1879060))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@12) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $abort_flag@13 $abort_flag@12) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_Diem_value'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1879349) 1879405) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1879349) 1879391) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= $abort_flag@13 true) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1879367) 1879405) |inline$$1_DiemAccount_balance'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1879367) 1879391) |inline$$1_DiemAccount_balance'#0'$0$anon14_Else_correct|)))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1879325) 1879367) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1879325) 1879349) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|) (=> (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'#0'| |inline$$1_DiemAccount_balance'#0'$0$$t7@2|)) (= (ControlFlow 0 1879331) 1879325)) |inline$$1_Diem_value'#0'$0$anon0_correct|))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@12) (= (ControlFlow 0 1879373) 1879331)) |inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| $abort_code@12) (= (ControlFlow 0 1879419) 1879060))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|  (=> (= $abort_flag@12 true) (=> (and (= $abort_code@12 $EXEC_FAILURE_CODE) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@0|)) (and (=> (= (ControlFlow 0 1879471) 1879419) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1879471) 1879373) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= (ControlFlow 0 1879469) 1879471)) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (and (= |inline$$1_DiemAccount_balance'#0'$0$$t7@1| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= $abort_flag@12 $abort_flag@11)) (and (= $abort_code@12 $abort_code@11) (= |inline$$1_DiemAccount_balance'#0'$0$$t7@2| |inline$$1_DiemAccount_balance'#0'$0$$t7@1|))) (and (=> (= (ControlFlow 0 1879078) 1879419) |inline$$1_DiemAccount_balance'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1879078) 1879373) |inline$$1_DiemAccount_balance'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|  (=> |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (and (=> (= (ControlFlow 0 1879064) 1879469) |inline$$1_DiemAccount_balance'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 1879064) 1879078) |inline$$1_DiemAccount_balance'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_balance'#0'$0$$t3@1|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t6@1| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= (ControlFlow 0 1879054) 1879060))) |inline$$1_DiemAccount_balance'#0'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (|$IsValid'u64'| 19)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| 5)) (and (= |inline$$1_DiemAccount_balance'#0'$0$$t5@0| |inline$$1_DiemAccount_balance'#0'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'#0'$0$$t3@1| |inline$$1_DiemAccount_balance'#0'$0$$t3@1|))) (and (=> (= (ControlFlow 0 1879038) 1879064) |inline$$1_DiemAccount_balance'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 1879038) 1879054) |inline$$1_DiemAccount_balance'#0'$0$anon11_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| (= (ControlFlow 0 1879477) 1879038)) |inline$$1_DiemAccount_balance'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Then_correct|  (=> |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (|$IsValid'u64'| 1005)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t73@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t71@1|))) (and (=> (= (ControlFlow 0 1878704) 1879477) |inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Then_correct|) (=> (= (ControlFlow 0 1878704) 1878720) |inline$$1_DiemAccount_prologue_common'#0'$0$anon95_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Else_correct|  (=> (and (not $abort_flag@11) (|$IsValid'u64'| 1012)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t70@0|) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1878646) 1878704) |inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Then_correct|) (=> (= (ControlFlow 0 1878646) 1878662) |inline$$1_DiemAccount_prologue_common'#0'$0$anon94_Else_correct|))))))
(let ((|inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1878600) 1879621) |inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Then_correct|) (=> (= (ControlFlow 0 1878600) 1878646) |inline$$1_DiemAccount_prologue_common'#0'$0$anon93_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|  (=> (and inline$$Gt$0$dst@1 (= (ControlFlow 0 1878606) 1878600)) |inline$$1_TransactionFee_is_coin_initialized'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|  (=> (and (and (not inline$$Gt$0$dst@1) (= $abort_flag@15 $abort_flag@11)) (and (= $abort_code@14 $abort_code@11) (= (ControlFlow 0 1874537) 1874549))) |inline$$1_DiemAccount_prologue_common'#0'$0$L12_correct|)))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> inline$$MulU64$0$dst@2 0)) (and (=> (= (ControlFlow 0 1874523) 1878606) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Then_correct|) (=> (= (ControlFlow 0 1874523) 1874537) |inline$$1_DiemAccount_prologue_common'#0'$0$anon92_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|  (=> (and (and (not $abort_flag@11) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@2)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1874529) 1874523))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@11) (= (ControlFlow 0 1879635) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$MulU64$0$anon3_Then$1_correct  (=> (= $abort_code@11 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@11 true) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@0)) (and (=> (= (ControlFlow 0 1874455) 1879635) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|) (=> (= (ControlFlow 0 1874455) 1874529) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|))))))
(let ((inline$$MulU64$0$anon3_Then_correct  (=> (and (> (* _$t3 _$t4) $MAX_U64) (= (ControlFlow 0 1874453) 1874455)) inline$$MulU64$0$anon3_Then$1_correct)))
(let ((inline$$MulU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (* _$t3 _$t4)) (=> (and (and (= inline$$MulU64$0$dst@1 (* _$t3 _$t4)) (= $abort_code@11 $abort_code@10)) (and (= $abort_flag@11 $abort_flag@10) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@1))) (and (=> (= (ControlFlow 0 1874401) 1879635) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Then_correct|) (=> (= (ControlFlow 0 1874401) 1874529) |inline$$1_DiemAccount_prologue_common'#0'$0$anon91_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 1874461) 1874453) inline$$MulU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 1874461) 1874401) inline$$MulU64$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|  (=> (and (and (not inline$$Le$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= (ControlFlow 0 1874304) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t64@0|) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1874288) 1874461) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Then_correct|) (=> (= (ControlFlow 0 1874288) 1874304) |inline$$1_DiemAccount_prologue_common'#0'$0$anon90_Else_correct|))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 1874248) 1874288)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|  (=> (not $abort_flag@10) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1874254) 1874248)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|  (=> (and (and $abort_flag@10 (= $abort_code@10 $abort_code@10)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@10) (= (ControlFlow 0 1879649) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_flag@10 true) (=> (and (= $abort_code@10 $EXEC_FAILURE_CODE) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 1874188) 1879649) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1874188) 1874254) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 1874186) 1874188)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_flag@10 $abort_flag@9)) (and (= $abort_code@10 $abort_code@9) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 1874134) 1879649) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Then_correct|) (=> (= (ControlFlow 0 1874134) 1874254) |inline$$1_DiemAccount_prologue_common'#0'$0$anon89_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 1874194) 1874186) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1874194) 1874134) inline$$MulU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|  (=> (and (and $abort_flag@9 (= $abort_code@9 $abort_code@9)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@9) (= (ControlFlow 0 1879663) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@9 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@9 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 1874027) 1879663) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|) (=> (= (ControlFlow 0 1874027) 1874194) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t4 $MAX_U128) (= (ControlFlow 0 1874025) 1874027)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t4) (= $abort_code@9 $abort_code@8)) (and (= $abort_flag@9 $abort_flag@8) (= inline$$CastU128$1$dst@1 _$t4))) (and (=> (= (ControlFlow 0 1873977) 1879663) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Then_correct|) (=> (= (ControlFlow 0 1873977) 1874194) |inline$$1_DiemAccount_prologue_common'#0'$0$anon88_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|  (=> (not $abort_flag@8) (and (=> (= (ControlFlow 0 1874033) 1874025) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 1874033) 1873977) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|  (=> (and (and $abort_flag@8 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@8) (= (ControlFlow 0 1879677) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@8 true) (=> (and (= $abort_code@8 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 1873894) 1879677) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|) (=> (= (ControlFlow 0 1873894) 1874033) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t3 $MAX_U128) (= (ControlFlow 0 1873892) 1873894)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t3) (= $abort_flag@8 $abort_flag@7)) (and (= $abort_code@8 $abort_code@7) (= inline$$CastU128$0$dst@1 _$t3))) (and (=> (= (ControlFlow 0 1873844) 1879677) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Then_correct|) (=> (= (ControlFlow 0 1873844) 1874033) |inline$$1_DiemAccount_prologue_common'#0'$0$anon87_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|  (=> |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| (and (=> (= (ControlFlow 0 1873900) 1873892) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1873900) 1873844) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= (ControlFlow 0 1873771) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|  (=> (and (and (and (not $abort_flag@7) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t54@1| (|$authentication_key#$1_DiemAccount_DiemAccount| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| (|$IsEqual'vec'u8''| call1formal@res@0 |inline$$1_DiemAccount_prologue_common'#0'$0$$t54@1|)) (|$IsValid'u64'| 1001))) (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t57@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t55@1|)))) (and (=> (= (ControlFlow 0 1873755) 1873900) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Then_correct|) (=> (= (ControlFlow 0 1873755) 1873771) |inline$$1_DiemAccount_prologue_common'#0'$0$anon86_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@7) (= (ControlFlow 0 1879691) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2|) (= call1formal@res@0 ($1_Hash_sha3 _$t2))) (and (|$IsValid'vec'u8''| call1formal@res@0) (= (|l#Vec_33444| call1formal@res@0) 32))) (and (=> (= (ControlFlow 0 1873707) 1879691) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Then_correct|) (=> (= (ControlFlow 0 1873707) 1873755) |inline$$1_DiemAccount_prologue_common'#0'$0$anon85_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@7 $abort_code@7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@7) (= (ControlFlow 0 1879705) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then$1_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@0|) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= $abort_flag@7 true)) (and (=> (= (ControlFlow 0 1879757) 1879705) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|) (=> (= (ControlFlow 0 1879757) 1873707) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= (ControlFlow 0 1879755) 1879757)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@2| |inline$$1_DiemAccount_prologue_common'#0'$0$$t52@1|)) (and (= $abort_code@7 $abort_code@6) (= $abort_flag@7 $abort_flag@6))) (and (=> (= (ControlFlow 0 1873691) 1879705) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Then_correct|) (=> (= (ControlFlow 0 1873691) 1873707) |inline$$1_DiemAccount_prologue_common'#0'$0$anon84_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 1873677) 1879755) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Then_correct|) (=> (= (ControlFlow 0 1873677) 1873691) |inline$$1_DiemAccount_prologue_common'#0'$0$anon83_Else_correct|)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|  (=> (and (and (not inline$$Not$0$dst@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= (ControlFlow 0 1873673) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then$1_correct|  (=> (|$IsValid'u64'| 1000) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| 1)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t51@0|) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1873657) 1873677) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Then_correct|) (=> (= (ControlFlow 0 1873657) 1873673) |inline$$1_DiemAccount_prologue_common'#0'$0$anon82_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t48@0|)) (= (ControlFlow 0 1873617) 1873657)) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t48@0|  (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)))) (= (ControlFlow 0 1873623) 1873617)) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= (ControlFlow 0 1873569) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|  (=> (and (not $abort_flag@6) (|$IsValid'u64'| 1004)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t47@0|) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 1873553) 1873623) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Then_correct|) (=> (= (ControlFlow 0 1873553) 1873569) |inline$$1_DiemAccount_prologue_common'#0'$0$anon81_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|  (=> (and (and $abort_flag@6 (= $abort_code@6 $abort_code@6)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@6) (= (ControlFlow 0 1879771) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 1873511) 1879771) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Then_correct|) (=> (= (ControlFlow 0 1873511) 1873553) |inline$$1_DiemAccount_prologue_common'#0'$0$anon80_Else_correct|))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|  (=> (and |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| (= (ControlFlow 0 1873517) 1873511)) inline$$1_DiemAccount_exists_at$0$anon0_correct)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= (ControlFlow 0 1873404) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|  (=> (not $abort_flag@6) (=> (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| (= inline$$1_ChainId_get$0$$ret0@1 _$t6)) (|$IsValid'u64'| 1007)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| 7)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t44@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1| |inline$$1_DiemAccount_prologue_common'#0'$0$$t42@1|))) (and (=> (= (ControlFlow 0 1873388) 1873517) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Then_correct|) (=> (= (ControlFlow 0 1873388) 1873404) |inline$$1_DiemAccount_prologue_common'#0'$0$anon79_Else_correct|)))))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|  (=> (and (and $abort_flag@6 (= $abort_code@6 $abort_code@6)) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t41@1| $abort_code@6) (= (ControlFlow 0 1879785) 1873410))) |inline$$1_DiemAccount_prologue_common'#0'$0$L32_correct|)))
(let ((inline$$1_ChainId_get$0$L2_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@6 inline$$1_ChainId_get$0$$t1@1) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$ret0@0)) (and (=> (= (ControlFlow 0 1873262) 1879785) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1873262) 1873388) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon10_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@5 $abort_code@5)) (and (= inline$$1_ChainId_get$0$$t1@1 $abort_code@5) (= (ControlFlow 0 1873256) 1873262))) inline$$1_ChainId_get$0$L2_correct)))
(let ((inline$$1_ChainId_get$0$anon8_Then_correct  (=> inline$$1_ChainId_get$0$$t0@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ChainId_get$0$$t1@0)) (= inline$$1_ChainId_get$0$$t1@0 inline$$1_ChainId_get$0$$t1@0)) (and (= inline$$1_ChainId_get$0$$t1@1 inline$$1_ChainId_get$0$$t1@0) (= (ControlFlow 0 1873340) 1873262))) inline$$1_ChainId_get$0$L2_correct))))
(let ((inline$$1_ChainId_get$0$anon10_Else_correct  (=> (and (not $abort_flag@5) (= inline$$1_ChainId_get$0$$t4@1 (|$id#$1_ChainId_ChainId| inline$$1_ChainId_get$0$$t3@2))) (=> (and (and (= inline$$1_ChainId_get$0$$t4@1 inline$$1_ChainId_get$0$$t4@1) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@6 $abort_code@5) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$t4@1))) (and (=> (= (ControlFlow 0 1873242) 1879785) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Then_correct|) (=> (= (ControlFlow 0 1873242) 1873388) |inline$$1_DiemAccount_prologue_common'#0'$0$anon78_Else_correct|))))))
(let ((inline$$1_ChainId_get$0$anon9_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@0)) (and (=> (= (ControlFlow 0 1873314) 1873256) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1873314) 1873242) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon9_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= (ControlFlow 0 1873312) 1873314)) inline$$1_ChainId_get$0$anon9_Then$1_correct)))
(let ((inline$$1_ChainId_get$0$anon9_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816) (=> (and (and (= inline$$1_ChainId_get$0$$t3@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@1))) (and (=> (= (ControlFlow 0 1873220) 1873256) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1873220) 1873242) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon8_Else_correct  (=> (and (not inline$$1_ChainId_get$0$$t0@0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 1873206) 1873312) inline$$1_ChainId_get$0$anon9_Then_correct) (=> (= (ControlFlow 0 1873206) 1873220) inline$$1_ChainId_get$0$anon9_Else_correct)))))
(let ((inline$$1_ChainId_get$0$anon0_correct  (=> (= inline$$1_ChainId_get$0$$t0@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1873192) 1873340) inline$$1_ChainId_get$0$anon8_Then_correct) (=> (= (ControlFlow 0 1873192) 1873206) inline$$1_ChainId_get$0$anon8_Else_correct)))))
(let ((|inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t37@0| (|$addr#$signer| _$t0)) (=> (and (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t38@0| (* _$t3 _$t4)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2))) (=> (and (and (and (= _$t3 _$t3) (= _$t4 _$t4)) (and (= _$t5 _$t5) (= _$t6 _$t6))) (and (and (|$IsValid'address'| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0| |inline$$1_DiemAccount_prologue_common'#0'$0$$t39@0|) (= (ControlFlow 0 1873346) 1873192)))) inline$$1_ChainId_get$0$anon0_correct)))))
(let ((anon10_Then_correct  (=> (and (and inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 (= $t17 (|$addr#$signer| _$t0))) (and (= $t18 (* _$t3 _$t4)) (= (ControlFlow 0 1879789) 1873346))) |inline$$1_DiemAccount_prologue_common'#0'$0$anon0_correct|)))
(let ((anon10_Else_correct  (=> (and (and (not inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1) (= $t16 $t16)) (and (= $t14@0 $t16) (= (ControlFlow 0 1870160) 1870764))) L3_correct)))
(let ((anon9_Else_correct  (=> (and (not $abort_flag@4) (|$IsValid'u64'| 1008)) (=> (and (and (|$IsValid'u64'| $t16) (= $t16 1)) (and (= $t16 $t16) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1))) (and (=> (= (ControlFlow 0 1870144) 1879789) anon10_Then_correct) (=> (= (ControlFlow 0 1870144) 1870160) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@4 $abort_code@4)) (and (= $t14@0 $abort_code@4) (= (ControlFlow 0 1880185) 1870764))) L3_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@0) (=> (and (= $abort_flag@4 true) (= $abort_code@4 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1)) (and (=> (= (ControlFlow 0 1869942) 1880185) anon9_Then_correct) (=> (= (ControlFlow 0 1869942) 1870144) anon9_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1869936) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1869974) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Then_correct  (=> inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t13@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (= 5 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0)) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@0) (= (ControlFlow 0 1870002) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1870034) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1870066) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t5@1 $abort_code@3) (= (ControlFlow 0 1870098) 1869942))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L14_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$ret0@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1) (=> (and (= $abort_flag@4 $abort_flag@3) (= $abort_code@4 $abort_code@3)) (and (=> (= (ControlFlow 0 1869922) 1880185) anon9_Then_correct) (=> (= (ControlFlow 0 1869922) 1870144) anon9_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct  (=> (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1) (=> (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1) (= (ControlFlow 0 1869918) 1869922)) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Else_correct  (=> (and (and (not $abort_flag@3) (= |inline$$1_Vector_contains'vec'u8''$0$res@1| |inline$$1_Vector_contains'vec'u8''$0$res@1|)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 |inline$$1_Vector_contains'vec'u8''$0$res@1|) (= (ControlFlow 0 1869906) 1869918))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct)))
(let ((|inline$$1_Vector_contains'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'vec'u8''$0$res@1| (exists ((i@@140 Int) ) (!  (and (and (|$IsValid'u64'| i@@140) (InRangeVec_453498 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1 i@@140)) (|$IsEqual'vec'u8''| (|Select__T@[Int]Vec_33444_| (|v#Vec_422080| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1) i@@140) _$t7))
 :qid |DiemAccountbpl.2617:13|
 :skolemid |98|
))) (and (=> (= (ControlFlow 0 1869882) 1869936) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Then_correct) (=> (= (ControlFlow 0 1869882) 1869906) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon34_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Else_correct  (=> (not |inline$$1_Vector_is_empty'vec'u8''$0$b@1|) (=> (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t17@1 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (= (ControlFlow 0 1869888) 1869882)) |inline$$1_Vector_contains'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Then_correct  (=> (and (and |inline$$1_Vector_is_empty'vec'u8''$0$b@1| (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t2@1 true) (= (ControlFlow 0 1869960) 1869918))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L12_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1869832) 1869960) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Then_correct) (=> (= (ControlFlow 0 1869832) 1869888) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon33_Else_correct)))))
(let ((|inline$$1_Vector_is_empty'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_is_empty'vec'u8''$0$b@1| (= (|l#Vec_422080| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t14@1) 0)) (and (=> (= (ControlFlow 0 1869818) 1869974) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Then_correct) (=> (= (ControlFlow 0 1869818) 1869832) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon32_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_| (|contents#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) addr@@9)))))) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0 inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t14@1 (|$script_allow_list#$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption| inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t12@0)) (= (ControlFlow 0 1869824) 1869818))) |inline$$1_Vector_is_empty'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Else_correct  (=> (and (not |inline$$1_Vector_is_empty'u8'$0$b@1|) (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t13@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1869758) 1870002) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Then_correct) (=> (= (ControlFlow 0 1869758) 1869824) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon31_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Then_correct  (=> (and (and |inline$$1_Vector_is_empty'u8'$0$b@1| (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 true) (= (ControlFlow 0 1870020) 1869922))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1869740) 1870020) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Then_correct) (=> (= (ControlFlow 0 1869740) 1869758) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon30_Else_correct)))))
(let ((|inline$$1_Vector_is_empty'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_is_empty'u8'$0$b@1| (= (|l#Vec_33444| _$t7) 0)) (and (=> (= (ControlFlow 0 1869726) 1870034) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Then_correct) (=> (= (ControlFlow 0 1869726) 1869740) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon29_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Else_correct  (=> (and (not inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1) (= (ControlFlow 0 1869732) 1869726)) |inline$$1_Vector_is_empty'u8'$0$anon0_correct|)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Then_correct  (=> (and (and inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 (= false false)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 false) (= (ControlFlow 0 1870052) 1869922))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1869690) 1870052) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Then_correct) (=> (= (ControlFlow 0 1869690) 1869732) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon28_Else_correct)))))
(let ((inline$$1_DiemTransactionPublishingOption_transactions_halted$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_557350| $1_DiemTransactionPublishingOption_HaltAllTransactions_$memory) 173345816)) (= inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1 inline$$1_DiemTransactionPublishingOption_transactions_halted$0$$t1@1)) (and (=> (= (ControlFlow 0 1869676) 1870066) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Then_correct) (=> (= (ControlFlow 0 1869676) 1869690) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon27_Else_correct))))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Else_correct  (=> (and (not inline$$1_Roles_has_diem_root_role$0$$ret0@1) (= (ControlFlow 0 1869682) 1869676)) inline$$1_DiemTransactionPublishingOption_transactions_halted$0$anon0_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Then_correct  (=> (and (and inline$$1_Roles_has_diem_root_role$0$$ret0@1 (= true true)) (and (= inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$$t7@1 true) (= (ControlFlow 0 1870084) 1869922))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$L13_correct)))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1869591) 1870084) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Then_correct) (=> (= (ControlFlow 0 1869591) 1869682) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon26_Else_correct)))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@1) (= $abort_flag@3 $abort_flag@2))) (and (=> (= (ControlFlow 0 1869559) 1870098) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct) (=> (= (ControlFlow 0 1869559) 1869591) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct)))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_Roles_has_diem_root_role$0$$ret0@1 inline$$1_Roles_has_diem_root_role$0$$ret0@0) (= $abort_flag@3 true))) (and (=> (= (ControlFlow 0 1869577) 1870098) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Then_correct) (=> (= (ControlFlow 0 1869577) 1869591) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon25_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= $abort_code@3 $abort_code@1)) (and (= $abort_flag@2 true) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$ret0@0))) (and (=> (= (ControlFlow 0 1869483) 1869577) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1869483) 1869559) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$L3_correct  (=> (and (and (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t2@1) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$1_Roles_has_role$0$$ret0@1 inline$$1_Roles_has_role$0$$t2@1))) (and (=> (= (ControlFlow 0 1869419) 1869577) inline$$1_Roles_has_diem_root_role$0$anon3_Then_correct) (=> (= (ControlFlow 0 1869419) 1869559) inline$$1_Roles_has_diem_root_role$0$anon3_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon11_Else_correct  (=> (and (and (and (not $abort_flag@0) (= inline$$1_Roles_has_role$0$$t8@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$0$$t6@2))) (and (= inline$$1_Roles_has_role$0$$t9@1 (= inline$$1_Roles_has_role$0$$t8@1 0)) (= inline$$1_Roles_has_role$0$$t9@1 inline$$1_Roles_has_role$0$$t9@1))) (and (and (= $abort_code@2 $abort_code@1) (= inline$$1_Roles_has_role$0$$t2@1 inline$$1_Roles_has_role$0$$t9@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 1869465) 1869419)))) inline$$1_Roles_has_role$0$L3_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@0)) (and (=> (= (ControlFlow 0 1869535) 1869483) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1869535) 1869465) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= (ControlFlow 0 1869533) 1869535)) inline$$1_Roles_has_role$0$anon10_Then$1_correct)))
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_Roles_has_role$0$$t6@2 inline$$1_Roles_has_role$0$$t6@1))) (and (=> (= (ControlFlow 0 1869437) 1869483) inline$$1_Roles_has_role$0$anon11_Then_correct) (=> (= (ControlFlow 0 1869437) 1869465) inline$$1_Roles_has_role$0$anon11_Else_correct))))))
(let ((inline$$1_Roles_has_role$0$anon9_Then_correct  (=> inline$$1_Roles_has_role$0$$t5@1 (and (=> (= (ControlFlow 0 1869423) 1869533) inline$$1_Roles_has_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 1869423) 1869437) inline$$1_Roles_has_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct  (=> (and (not inline$$1_Roles_has_role$0$$t5@1) (= false false)) (=> (and (and (= $abort_code@2 $abort_code@0) (= inline$$1_Roles_has_role$0$$t2@1 false)) (and (= $abort_flag@1 false) (= (ControlFlow 0 1869407) 1869419))) inline$$1_Roles_has_role$0$L3_correct))))
(let ((inline$$1_Roles_has_role$0$anon0_correct  (=> (and (= _$t0 _$t0) (= 0 0)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t4@0 (|$addr#$signer| _$t0))) (and (= inline$$1_Roles_has_role$0$$t4@0 inline$$1_Roles_has_role$0$$t4@0) (= inline$$1_Roles_has_role$0$$t5@1 (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0)))) (and (=> (= (ControlFlow 0 1869387) 1869423) inline$$1_Roles_has_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 1869387) 1869407) inline$$1_Roles_has_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_has_diem_root_role$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1869541) 1869387)) inline$$1_Roles_has_role$0$anon0_correct))))
(let ((inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t7 _$t7) (= (ControlFlow 0 1869583) 1869541)) inline$$1_Roles_has_diem_root_role$0$anon0_correct))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@24))))) i1)))) 3))))
 ...
 :qid |DiemAccountbpl.93287:20|
 :skolemid |3311|
)) (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@37) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@37)))
 :qid |DiemAccountbpl.93291:20|
 :skolemid |3312|
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@2)))
(|$IsValid'$1_TransactionFee_TransactionFee'#0''| $rsc@@2))
 :qid |DiemAccountbpl.93362:20|
 :skolemid |3321|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'#0'_| (|contents#$Memory_545418| |$1_TransactionFee_TransactionFee'#0'_$memory|) $a_0@@2))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@6))
 ...
 :qid |DiemAccountbpl.93382:20|
 :skolemid |3326|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@7))
)) (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@8)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc@@8))
 :qid |DiemAccountbpl.93386:20|
 :skolemid |3327|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0@@8))
)))) (and (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (* _$t3 _$t4))) (and (= $t12 (|$addr#$signer| _$t0)) (= _$t0 _$t0)))) (and (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= _$t4 _$t4))) (and (and (= _$t5 _$t5) (= _$t6 _$t6)) (and (= _$t7 _$t7) (= (ControlFlow 0 1870104) 1869583)))))) inline$$1_DiemTransactionPublishingOption_is_script_allowed$0$anon0_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1866749) 1870104)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2573715) 1866749) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
