...
(declare-fun $t7@1 () |T@$1_DiemAccount_Balance'$1_XDX_XDX'|)
(declare-fun $t7 () |T@$1_DiemAccount_Balance'$1_XDX_XDX'|)
(declare-fun $t7@0 () |T@$1_DiemAccount_Balance'$1_XDX_XDX'|)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_balance$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 2162507) (let ((anon15_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1|)) (and (=> (= (ControlFlow 0 1238483) (- 0 2163023)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 1238483) (- 0 2163034)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.42443:15|
 :skolemid |1166|
 ...
 :qid |DiemAccountbpl.42443:15|
 :skolemid |1166|
)) (=> (= (ControlFlow 0 1238483) (- 0 2163070)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'$1_XDX_XDX'| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.42448:15|
 :skolemid |1167|
))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1238062) (- 0 2162985)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (=> (= (ControlFlow 0 1238062) (- 0 2162991)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= 5 $t6@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1238497) 1238062))) L3_correct)))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@0) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1238351) 1238497) anon15_Then_correct) (=> (= (ControlFlow 0 1238351) 1238483) anon15_Else_correct)))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1238369) 1238497) anon15_Then_correct) (=> (= (ControlFlow 0 1238369) 1238483) anon15_Else_correct)))))
(let ((|inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XDX_XDX'| |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1|)) (= |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_value'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1238327) 1238369) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1238327) 1238351) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon0_correct|  (=> (= $t7@1 $t7@1) (=> (and (= |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'$1_XDX_XDX'| $t7@1)) (= (ControlFlow 0 1238333) 1238327)) |inline$$1_Diem_value'$1_XDX_XDX'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1238375) 1238333)) |inline$$1_DiemAccount_balance_for'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1238511) 1238062))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1238563) 1238511) anon14_Then_correct) (=> (= (ControlFlow 0 1238563) 1238375) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= (ControlFlow 0 1238561) 1238563)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1238080) 1238511) anon14_Then_correct) (=> (= (ControlFlow 0 1238080) 1238375) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 1238066) 1238561) anon13_Then_correct) (=> (= (ControlFlow 0 1238066) 1238080) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 1238030) 1238062))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 2)))))
 :qid |DiemAccountbpl.42340:20|
 :skolemid |1163|
)) (=> (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))
 :qid |DiemAccountbpl.42344:20|
 :skolemid |1164|
)) (|$IsValid'address'| _$t0)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'$1_XDX_XDX''| $rsc))
 :qid |DiemAccountbpl.42350:20|
 :skolemid |1165|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) _$t0)) (|$IsValid'u64'| 19))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 1238014) 1238066) anon12_Then_correct) (=> (= (ControlFlow 0 1238014) 1238030) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1237874) 1238014)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2162507) 1237874) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
