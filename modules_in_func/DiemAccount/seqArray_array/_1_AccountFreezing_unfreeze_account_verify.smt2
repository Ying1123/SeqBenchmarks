...
(declare-fun $t17@0 () T@$Mutation_17352)
(declare-fun $t16@1 () T@$Mutation_580592)
(declare-fun $t17@1 () T@$Mutation_17352)
(declare-fun $t16@2 () T@$Mutation_580592)
...
(declare-fun $t16 () T@$Mutation_580592)
(declare-fun $t16@0 () T@$Mutation_580592)
...
(declare-fun $t17 () T@$Mutation_17352)
(declare-fun $t21 () T@$Mutation_464575)
(push 1)
(set-info :boogie-vc-id $1_AccountFreezing_unfreeze_account$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 2090806) (let ((anon28_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 1144803) (- 0 2092999)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093009)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093021)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 1))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093039)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093053)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093064)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) _$t1)))) (and (=> (= (ControlFlow 0 1144803) (- 0 2093073)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new (let ((len (|l#Multiset_421725| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_421725| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (=> (= (ControlFlow 0 1144803) (- 0 2093098)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t7) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@1))))))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 1144268) (- 0 2092854)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (= (ControlFlow 0 1144268) (- 0 2092902)) (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) (= 5 $t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t5)) 1)) (= 3 $t9@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t9@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= 5 $t9@0))))))))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t9@0 $abort_code@2) (= (ControlFlow 0 1144817) 1144268))) L3_correct)))
(let ((|inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| (|v#$Mutation_464575| $t21@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t22@0))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_AccountFreezing_UnfreezeAccountEvent'| $t22@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 1144655) 1144817) anon28_Then_correct) (=> (= (ControlFlow 0 1144655) 1144803) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (and (not $abort_flag@1) (= $t21@0 ($Mutation_464575 (|l#$Mutation_580635| $t20@1) (let ((l (|l#Vec_33444| (|p#$Mutation_580635| $t20@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_580635| $t20@1)) l 1) (+ l 1))) (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|v#$Mutation_580635| $t20@1))))) (and (= $t22@0 ($1_AccountFreezing_UnfreezeAccountEvent $t18 _$t1)) (= (ControlFlow 0 1144661) 1144655))) |inline$$1_Event_emit_event'$1_AccountFreezing_UnfreezeAccountEvent'$0$anon0_correct|)))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t9@0 $abort_code@2) (= (ControlFlow 0 1144831) 1144268))) L3_correct)))
(let ((anon26_Then$1_correct  (=> (= $t20@1 $t20) (=> (and (= $abort_flag@1 true) (= $abort_code@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1144883) 1144831) anon27_Then_correct) (=> (= (ControlFlow 0 1144883) 1144661) anon27_Else_correct))))))
(let ((anon26_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (= (ControlFlow 0 1144881) 1144883)) anon26_Then$1_correct)))
(let ((anon26_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816) (=> (and (and (= $t20@0 ($Mutation_580635 ($Global 173345816) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (= $t20@1 $t20@0)) (and (= $abort_flag@1 $abort_flag@0) (= $abort_code@2 $abort_code@1))) (and (=> (= (ControlFlow 0 1144556) 1144831) anon27_Then_correct) (=> (= (ControlFlow 0 1144556) 1144661) anon27_Else_correct))))))
(let ((anon25_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t17@0 ($Mutation_17352 (|l#$Mutation_580592| $t16@1) (let ((l@@0 (|l#Vec_33444| (|p#$Mutation_580592| $t16@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_580592| $t16@1)) l@@0 0) (+ l@@0 1))) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|v#$Mutation_580592| $t16@1)))) (= $t17@1 ($Mutation_17352 (|l#$Mutation_17352| $t17@0) (|p#$Mutation_17352| $t17@0) false))) (and (= $t16@2 ($Mutation_580592 (|l#$Mutation_580592| $t16@1) (|p#$Mutation_580592| $t16@1) ($1_AccountFreezing_FreezingBit (|v#$Mutation_17352| $t17@1)))) (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_473408 (|Store__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_580592| $t16@2)) true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) (|a#$Global| (|l#$Mutation_580592| $t16@2)) (|v#$Mutation_580592| $t16@2)))))) (and (=> (= (ControlFlow 0 1144534) (- 0 2092492)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 173345816))))) (and (=> (= (ControlFlow 0 1144534) (- 0 2092506)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453)))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) 186537453))))) (and (=> (= (ControlFlow 0 1144534) (- 0 2092520)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr)))
 :qid |DiemAccountbpl.30789:15|
 :skolemid |676|
 ...
 :qid |DiemAccountbpl.30795:15|
 :skolemid |677|
)) (and (=> (= (ControlFlow 0 1144534) (- 0 2092587)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@3)))
 :qid |DiemAccountbpl.30801:15|
 :skolemid |678|
 ...
 :qid |DiemAccountbpl.30801:15|
 :skolemid |678|
)) (and (=> (= (ControlFlow 0 1144534) (- 0 2092612)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory@0) addr@@5)))
 :qid |DiemAccountbpl.30807:15|
 :skolemid |679|
 ...
 :qid |DiemAccountbpl.30807:15|
 :skolemid |679|
)) (=> (and (and (|$IsValid'address'| $t18) (= $t18 (|$addr#$signer| _$t0))) (and (= $t18 $t18) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 1144534) 1144881) anon26_Then_correct) (=> (= (ControlFlow 0 1144534) 1144556) anon26_Else_correct)))))))))))))))))))
(let ((anon25_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 1144897) 1144268))) L3_correct)))
(let ((anon24_Then$1_correct  (=> (= $t16@1 $t16) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1144949) 1144897) anon25_Then_correct) (=> (= (ControlFlow 0 1144949) 1144534) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (= (ControlFlow 0 1144947) 1144949)) anon24_Then$1_correct)))
(let ((anon24_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1) (=> (and (and (= $t16@0 ($Mutation_580592 ($Global _$t1) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (= $t16@1 $t16@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1144300) 1144897) anon25_Then_correct) (=> (= (ControlFlow 0 1144300) 1144534) anon25_Else_correct))))))
(let ((anon23_Then_correct  (=> $t12@0 (and (=> (= (ControlFlow 0 1144278) 1144947) anon24_Then_correct) (=> (= (ControlFlow 0 1144278) 1144300) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t9@0 $t14) (= (ControlFlow 0 1144112) 1144268))) L3_correct)))
(let ((anon22_Else_correct  (=> (not $t11) (=> (and (= $t12@0 (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t14) (= $t14 5)) (and (= $t14 $t14) (= $t12@0 $t12@0))) (and (=> (= (ControlFlow 0 1144096) 1144278) anon23_Then_correct) (=> (= (ControlFlow 0 1144096) 1144112) anon23_Else_correct)))))))
(let ((anon22_Then_correct  (=> $t11 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t10)) (= 5 $t9)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t10)) 1)) (= 3 $t9))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t9))) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 1145021) 1144268))) L3_correct))))
(let ((anon21_Else_correct  (=> (not $t8) (=> (and (= $t10 (|$addr#$signer| _$t0)) (= $t11  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t10)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t10)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))) (and (=> (= (ControlFlow 0 1144054) 1145021) anon22_Then_correct) (=> (= (ControlFlow 0 1144054) 1144096) anon22_Else_correct))))))
(let ((anon21_Then_correct  (=> $t8 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 1145047) 1144268))) L3_correct))))
...
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemAccountbpl.30602:20|
 :skolemid |675|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6 (|$unfreeze_event_handle#$1_AccountFreezing_FreezeEventsHolder| (|Select__T@[Int]$1_AccountFreezing_FreezeEventsHolder_| (|contents#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (= $t7 ($1_AccountFreezing_UnfreezeAccountEvent (|$addr#$signer| _$t0) _$t1)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t8  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 1143996) 1145047) anon21_Then_correct) (=> (= (ControlFlow 0 1143996) 1144054) anon21_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1142804) 1143996)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_33444| (|p#$Mutation_580592| $t16)) 0) (=> (and (and (= (|l#Vec_33444| (|p#$Mutation_17352| $t17)) 0) (= (|l#Vec_33444| (|p#$Mutation_580635| $t20)) 0)) (and (= (|l#Vec_33444| (|p#$Mutation_464575| $t21)) 0) (= (ControlFlow 0 1142814) 1142804))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2090806) 1142814) anon0_correct)))
