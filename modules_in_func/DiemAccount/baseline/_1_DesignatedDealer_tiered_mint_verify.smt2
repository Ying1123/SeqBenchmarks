...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3| () T@$Memory_501585)
...
(declare-fun |$1_DesignatedDealer_TierInfo'#0'_$memory@2| () T@$Memory_560400)
...
(declare-fun $t31@0 () T@$Mutation_464575)
(declare-fun $t34@0 () T@$1_DesignatedDealer_ReceivedMintEvent)
(declare-fun $t33 () Bool)
(declare-fun $t32 () T@Vec_33444)
(declare-fun $t17 () Int)
(declare-fun $t30@1 () T@$Mutation_560444)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t30 () T@$Mutation_560444)
(declare-fun $t30@0 () T@$Mutation_560444)
...
(declare-fun $t26 () |T@$1_DesignatedDealer_TierInfo'#0'|)
(declare-fun $t28@0 () Int)
(declare-fun $t29@0 () T@Vec_33444)
(declare-fun |$1_DesignatedDealer_TierInfo'#0'_$memory@1| () T@$Memory_560400)
(declare-fun |$1_DesignatedDealer_TierInfo'#0'_$memory| () T@$Memory_560400)
...
(declare-fun |$1_DesignatedDealer_TierInfo'#0'_$memory@0| () T@$Memory_560400)
...
(declare-fun $t31 () T@$Mutation_464575)
(push 1)
(set-info :boogie-vc-id $1_DesignatedDealer_tiered_mint$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2078811) (let ((anon40_Else_correct  (=> (not $abort_flag@4) (=> (and (= |inline$$1_Diem_mint'#0'$0$$ret0@1| |inline$$1_Diem_mint'#0'$0$$ret0@1|) (= $t37 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081681)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 1131127) (- 0 2081691)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081704)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081716)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081734)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081748)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081759)) (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (not (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081771)) (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128))) (=> (not (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (and (=> (= (ControlFlow 0 1131127) (- 0 2081788)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081798)) (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2) (and (=> (= (ControlFlow 0 1131127) (- 0 2081806)) (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816) (and (=> (= (ControlFlow 0 1131127) (- 0 2081814)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory@2|) _$t2))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory@2|) _$t2)) (and (=> (= (ControlFlow 0 1131127) (- 0 2081823)) (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$ret0@1|) _$t1)) (=> (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$ret0@1|) _$t1) (and (=> (= (ControlFlow 0 1131127) (- 0 2081832)) (and (and (and (and (and (and (and (and (and (and (and (and (= (|$total_value#$1_Diem_CurrencyInfo'#0'| $t37) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8)))) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t37) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t37) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t37) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t37) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t37) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t37) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t37) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8)))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (= (|$total_value#$1_Diem_CurrencyInfo'#0'| $t37) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8)))) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t37) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t37) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t37) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t37) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t37) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t37) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t37) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (= (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t37) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t8) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t8) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t8) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t8) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t8) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t8) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t8) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t8))))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081850)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new (let ((len (|l#Multiset_421725| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@0) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_421725| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@1) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (and (=> (= (ControlFlow 0 1131127) (- 0 2081875)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1))))) $t13)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_421725| stream@@2)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_Diem_MintEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@2) (|$ToEventRep'$1_Diem_MintEvent'| $t14) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1))))) $t13 stream_new@@2)))) (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_421725| stream@@3)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@3) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1)))))))
...
(let ((expected@@2 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_421725| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@3))))) $t13)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_421725| stream@@4)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@4) (|$ToEventRep'$1_Diem_MintEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@4) (|$ToEventRep'$1_Diem_MintEvent'| $t14) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_421725| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@3))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_421725| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@3))))) $t13 stream_new@@4)))) (let ((stream@@5 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@3 (let ((len@@3 (|l#Multiset_421725| stream@@5)))
(let ((cnt@@3 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@5) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@3 1)) (+ len@@3 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@3)))))))
 ...
 :qid |DiemAccountbpl.3721:13|
 :skolemid |137|
))))) (=> (= (ControlFlow 0 1131127) (- 0 2081912)) (let ((actual@@3 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@3 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t12)) (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_421725| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@5))))) $t13)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_421725| stream@@6)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@6) (|$ToEventRep'$1_Diem_MintEvent'| $t14))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@6) (|$ToEventRep'$1_Diem_MintEvent'| $t14) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_421725| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@5))))) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_421725| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@5))))) $t13 stream_new@@6)))) (let ((stream@@7 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_421725| stream@@7)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@7) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t11) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@5)))))))
...
(let ((L8_correct  (and (=> (= (ControlFlow 0 1129388) (- 0 2081411)) (or (or (or (or (or (or (or (or (= _$t1 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (or (or (or (or (or (= _$t1 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2))) (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 1129388) (- 0 2081499)) (or (or (or (or (or (or (or (or (and (= _$t1 0) (= 7 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) (= 5 $t17@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t17@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2)) (= 5 $t17@0))) (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t17@0))) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128) (= 8 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))))))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 1131313) 1129388))) L8_correct)))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t17@0 $abort_code@5) (= (ControlFlow 0 1131141) 1129388))) L8_correct)))
(let ((|inline$$1_Diem_mint'#0'$0$anon13_correct|  (=> (and (and (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= |inline$$1_Diem_mint'#0'$0$$t18@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|)))) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t18@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) _$t1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$can_mint#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t12@0|))))) (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_mint'#0'$0$$t16@0|) _$t1)) (and (= |inline$$1_Diem_mint'#0'$0$$t19@0| |inline$$1_Diem_mint'#0'$0$$t15@0|) (= |inline$$1_Diem_mint'#0'$0$$t20@0| |inline$$1_Diem_mint'#0'$0$$t14@0|))) (and (and (and (= |inline$$1_Diem_mint'#0'$0$$t21@0|  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t13@0|))) (= $es@1 (ite |inline$$1_Diem_mint'#0'$0$$t21@0| (let ((stream@@8 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es@0) |inline$$1_Diem_mint'#0'$0$$t20@0|)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_421725| stream@@8)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@8) (|$ToEventRep'$1_Diem_MintEvent'| |inline$$1_Diem_mint'#0'$0$$t19@0|))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@8) (|$ToEventRep'$1_Diem_MintEvent'| |inline$$1_Diem_mint'#0'$0$$t19@0|) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es@0) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es@0) |inline$$1_Diem_mint'#0'$0$$t20@0| stream_new@@7)))) $es@0))) (and (= |inline$$1_Diem_mint'#0'$0$$t16@0| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= $abort_code@5 $abort_code@4))) (and (and (= $es@2 $es@1) (= $abort_flag@4 $abort_flag@3)) (and (= |inline$$1_Diem_mint'#0'$0$$ret0@1| |inline$$1_Diem_mint'#0'$0$$t16@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory@2|))))) (and (=> (= (ControlFlow 0 1130663) 1131141) anon40_Then_correct) (=> (= (ControlFlow 0 1130663) 1131127) anon40_Else_correct))))))
(let ((|inline$$1_Diem_mint'#0'$0$anon18_Else_correct|  (=> (and (and (not |inline$$1_Diem_mint'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_501585 (|Store__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 false) (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|)))) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 1130561) 1130663))) |inline$$1_Diem_mint'#0'$0$anon13_correct|)))
(let ((|inline$$1_Diem_mint'#0'$0$anon18_Then_correct|  (=> (and (and |inline$$1_Diem_mint'#0'$0$$temp_0'bool'@1| (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_501585 (|Store__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816 |inline$$1_Diem_mint'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|)))) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 1130675) 1130663))) |inline$$1_Diem_mint'#0'$0$anon13_correct|)))
(let ((|inline$$1_Diem_mint'#0'$0$anon17_Else_correct|  (=> (not |inline$$1_Diem_mint'#0'$0$$t17@0|) (and (=> (= (ControlFlow 0 1130549) 1130675) |inline$$1_Diem_mint'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 1130549) 1130561) |inline$$1_Diem_mint'#0'$0$anon18_Else_correct|)))))
(let ((|inline$$1_Diem_mint'#0'$0$L3_correct|  (=> (= $abort_code@5 |inline$$1_Diem_mint'#0'$0$$t10@1|) (=> (and (and (= $es@2 $es@0) (= $abort_flag@4 true)) (and (= |inline$$1_Diem_mint'#0'$0$$ret0@1| |inline$$1_Diem_mint'#0'$0$$ret0@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory|))) (and (=> (= (ControlFlow 0 1130429) 1131141) anon40_Then_correct) (=> (= (ControlFlow 0 1130429) 1131127) anon40_Else_correct))))))
(let ((|inline$$1_Diem_mint'#0'$0$anon17_Then_correct|  (=> |inline$$1_Diem_mint'#0'$0$$t17@0| (=> (and (and (or (or (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 |inline$$1_Diem_mint'#0'$0$$t10@0|)) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128) (= 8 |inline$$1_Diem_mint'#0'$0$$t10@0|))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_mint'#0'$0$$t10@0|))) (= |inline$$1_Diem_mint'#0'$0$$t10@0| |inline$$1_Diem_mint'#0'$0$$t10@0|)) (and (= |inline$$1_Diem_mint'#0'$0$$t10@1| |inline$$1_Diem_mint'#0'$0$$t10@0|) (= (ControlFlow 0 1130743) 1130429))) |inline$$1_Diem_mint'#0'$0$L3_correct|))))
(let ((|inline$$1_Diem_mint'#0'$0$anon16_Else_correct|  (=> (and (not $abort_flag@3) (= |inline$$1_Diem_mint'#0'$0$$t12@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_mint'#0'$0$$t13@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_mint'#0'$0$$t14@0| (|$mint_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t13@0|))) (and (= |inline$$1_Diem_mint'#0'$0$$t15@0| ($1_Diem_MintEvent _$t1 (|$currency_code#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_mint'#0'$0$$t13@0|))) (= |inline$$1_Diem_mint'#0'$0$$t17@0|  (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t1) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 1130543) 1130743) |inline$$1_Diem_mint'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 1130543) 1130549) |inline$$1_Diem_mint'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_mint'#0'$0$anon16_Then_correct|  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= |inline$$1_Diem_mint'#0'$0$$t10@1| $abort_code@4) (= (ControlFlow 0 1130757) 1130429))) |inline$$1_Diem_mint'#0'$0$L3_correct|)))
(let ((|inline$$1_Diem_mint'#0'$0$anon15_Then$1_correct|  (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1130809) 1130757) |inline$$1_Diem_mint'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 1130809) 1130543) |inline$$1_Diem_mint'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_mint'#0'$0$anon15_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) |inline$$1_Diem_mint'#0'$0$$t6@0|)) (= (ControlFlow 0 1130807) 1130809)) |inline$$1_Diem_mint'#0'$0$anon15_Then$1_correct|)))
(let ((|inline$$1_Diem_mint'#0'$0$anon15_Else_correct|  (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) |inline$$1_Diem_mint'#0'$0$$t6@0|) (= |inline$$1_Diem_mint'#0'$0$$t11@1| (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) |inline$$1_Diem_mint'#0'$0$$t6@0|))) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 1130449) 1130757) |inline$$1_Diem_mint'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 1130449) 1130543) |inline$$1_Diem_mint'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_mint'#0'$0$anon14_Then_correct|  (=> |inline$$1_Diem_mint'#0'$0$$t7@1| (and (=> (= (ControlFlow 0 1130435) 1130807) |inline$$1_Diem_mint'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 1130435) 1130449) |inline$$1_Diem_mint'#0'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_mint'#0'$0$anon14_Else_correct|  (=> (and (and (not |inline$$1_Diem_mint'#0'$0$$t7@1|) (= |inline$$1_Diem_mint'#0'$0$$t9@0| |inline$$1_Diem_mint'#0'$0$$t9@0|)) (and (= |inline$$1_Diem_mint'#0'$0$$t10@1| |inline$$1_Diem_mint'#0'$0$$t9@0|) (= (ControlFlow 0 1130423) 1130429))) |inline$$1_Diem_mint'#0'$0$L3_correct|)))
(let ((|inline$$1_Diem_mint'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_mint'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| |inline$$1_Diem_mint'#0'$0$$t6@0|))) (=> (and (and (and (= |inline$$1_Diem_mint'#0'$0$$t6@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_mint'#0'$0$$t6@0| |inline$$1_Diem_mint'#0'$0$$t6@0|)) (and (= |inline$$1_Diem_mint'#0'$0$$t7@1| (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) |inline$$1_Diem_mint'#0'$0$$t6@0|)) (|$IsValid'u64'| 9))) (and (and (|$IsValid'u64'| |inline$$1_Diem_mint'#0'$0$$t9@0|) (= |inline$$1_Diem_mint'#0'$0$$t9@0| 4)) (and (= |inline$$1_Diem_mint'#0'$0$$t9@0| |inline$$1_Diem_mint'#0'$0$$t9@0|) (= |inline$$1_Diem_mint'#0'$0$$t7@1| |inline$$1_Diem_mint'#0'$0$$t7@1|)))) (and (=> (= (ControlFlow 0 1130407) 1130435) |inline$$1_Diem_mint'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1130407) 1130423) |inline$$1_Diem_mint'#0'$0$anon14_Else_correct|))))))
(let ((anon39_Else_correct  (=> (and (not $abort_flag@2) (= $t35 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 1130815) (- 0 2080773)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (=> (= (ControlFlow 0 1130815) 1130407) |inline$$1_Diem_mint'#0'$0$anon0_correct|))))))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 1131155) 1129388))) L8_correct)))
(let ((|inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$handle@1| (|v#$Mutation_464575| $t31@0)) (= $es@0 (let ((stream@@9 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$handle@1|)))
(let ((stream_new@@8 (let ((len@@8 (|l#Multiset_421725| stream@@9)))
(let ((cnt@@8 (|Select__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@9) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t34@0))))
(Multiset_421725 (|Store__T@[$EventRep]Int_| (|v#Multiset_421725| stream@@9) (|$ToEventRep'$1_DesignatedDealer_ReceivedMintEvent'| $t34@0) (+ cnt@@8 1)) (+ len@@8 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$handle@1| stream_new@@8)))))) (and (=> (= (ControlFlow 0 1129627) 1131155) anon39_Then_correct) (=> (= (ControlFlow 0 1129627) 1130815) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (not $t33) (=> (and (and (|$IsValid'vec'u8''| $t32) (|$IsEqual'vec'u8''| $t32 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t34@0 ($1_DesignatedDealer_ReceivedMintEvent $t32 _$t2 _$t1)) (= (ControlFlow 0 1129633) 1129627))) |inline$$1_Event_emit_event'$1_DesignatedDealer_ReceivedMintEvent'$0$anon0_correct|))))
(let ((anon38_Then_correct  (=> $t33 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 1131181) 1129388))) L8_correct))))
(let ((anon37_Else_correct  (=> (not $abort_flag@2) (=> (and (= $t31@0 ($Mutation_464575 (|l#$Mutation_560444| $t30@1) (let ((l (|l#Vec_33444| (|p#$Mutation_560444| $t30@1))))
(Vec_33444 (|Store__T@[Int]Int_| (|v#Vec_33444| (|p#$Mutation_560444| $t30@1)) l 0) (+ l 1))) (|$mint_event_handle#$1_DesignatedDealer_Dealer| (|v#$Mutation_560444| $t30@1)))) (= $t33  (not (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 1129528) 1131181) anon38_Then_correct) (=> (= (ControlFlow 0 1129528) 1129633) anon38_Else_correct))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t17@0 $abort_code@3) (= (ControlFlow 0 1131195) 1129388))) L8_correct)))
(let ((anon36_Then$1_correct  (=> (= $t30@1 $t30) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1131247) 1131195) anon37_Then_correct) (=> (= (ControlFlow 0 1131247) 1129528) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2)) (= (ControlFlow 0 1131245) 1131247)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2) (=> (and (and (= $t30@0 ($Mutation_560444 ($Global _$t2) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2))) (= $t30@1 $t30@0)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 1129496) 1131195) anon37_Then_correct) (=> (= (ControlFlow 0 1129496) 1129528) anon37_Else_correct))))))
(let ((L6_correct  (and (=> (= (ControlFlow 0 1129474) (- 0 2080529)) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2)) (=> (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2) (and (=> (= (ControlFlow 0 1129474) 1131245) anon36_Then_correct) (=> (= (ControlFlow 0 1129474) 1129496) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t27@0 (|$window_start#$1_DesignatedDealer_TierInfo'#0'| $t26))) (and (= $t28@0 (|$window_inflow#$1_DesignatedDealer_TierInfo'#0'| $t26)) (= $t29@0 (|$tiers#$1_DesignatedDealer_TierInfo'#0'| $t26)))) (and (and (= $abort_flag@1 $abort_flag@0) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@2| |$1_DesignatedDealer_TierInfo'#0'_$memory@1|)) (and (= $abort_code@2 $abort_code@1) (= (ControlFlow 0 1131299) 1129474)))) L6_correct)))
(let ((anon34_Then$1_correct  (=> (= |$1_DesignatedDealer_TierInfo'#0'_$memory@1| |$1_DesignatedDealer_TierInfo'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1131365) 1131313) anon35_Then_correct) (=> (= (ControlFlow 0 1131365) 1131299) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2)) (= (ControlFlow 0 1131363) 1131365)) anon34_Then$1_correct)))
(let ((anon34_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2) (= $t26@0 (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2))) (=> (and (and (= |$1_DesignatedDealer_TierInfo'#0'_$memory@0| ($Memory_560400 (|Store__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2 false) (|contents#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|))) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@1| |$1_DesignatedDealer_TierInfo'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1131277) 1131313) anon35_Then_correct) (=> (= (ControlFlow 0 1131277) 1131299) anon35_Else_correct))))))
(let ((anon33_Then_correct  (=> $t25@0 (and (=> (= (ControlFlow 0 1131257) (- 0 2080374)) (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2)) (=> (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2) (and (=> (= (ControlFlow 0 1131257) 1131363) anon34_Then_correct) (=> (= (ControlFlow 0 1131257) 1131277) anon34_Else_correct)))))))
(let ((anon33_Else_correct  (=> (not $t25@0) (=> (and (and (= $abort_flag@1 false) (= |$1_DesignatedDealer_TierInfo'#0'_$memory@2| |$1_DesignatedDealer_TierInfo'#0'_$memory|)) (and (= $abort_code@2 $abort_code@0) (= (ControlFlow 0 1129466) 1129474))) L6_correct))))
(let ((anon32_Then_correct  (=> (and $t22 (= $t25@0 (|Select__T@[Int]Bool_| (|domain#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 1129460) 1131257) anon33_Then_correct) (=> (= (ControlFlow 0 1129460) 1129466) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (and (not $t22) (= $t24 $t24)) (and (= $t17@0 $t24) (= (ControlFlow 0 1129450) 1129388))) L8_correct)))
(let ((anon31_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (= $t22 (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 5)) (and (= $t24 $t24) (= $t22 $t22))) (and (=> (= (ControlFlow 0 1129434) 1129460) anon32_Then_correct) (=> (= (ControlFlow 0 1129434) 1129450) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t21 $t21)) (and (= $t17@0 $t21) (= (ControlFlow 0 1129108) 1129388))) L8_correct)))
(let ((anon30_Else$1_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 1129092) 1129434) anon31_Then_correct) (=> (= (ControlFlow 0 1129092) 1129108) anon31_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> _$t1 0)) (= (ControlFlow 0 1129056) 1129092)) anon30_Else$1_correct)))
(let ((anon30_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1129062) 1129056)) inline$$Gt$0$anon0_correct))))
(let ((anon30_Then_correct  (=> $t16 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) (= 5 $t17)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) 1)) (= 3 $t17))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 1131437) 1129388))) L8_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |DiemAccountbpl.24369:20|
 :skolemid |496|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@0)) 1)) (= addr@@0 186537453)))
 :qid |DiemAccountbpl.24377:20|
 :skolemid |497|
 ...
 :qid |DiemAccountbpl.24421:20|
 :skolemid |507|
))) (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (not (= (|l#Vec_421811| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |DiemAccountbpl.24425:20|
 :skolemid |508|
)) (let (($range_0 ($Range 0 (|l#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@12))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_422023| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |DiemAccountbpl.24429:151|
 :skolemid |509|
))))) (and (and (forall ((mint_cap_owner Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) mint_cap_owner) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) mint_cap_owner)) 1))))
 :qid |DiemAccountbpl.24434:20|
 :skolemid |510|
 ...
 :qid |DiemAccountbpl.24442:20|
 :skolemid |512|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_508607| |$1_Diem_Preburn'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |DiemAccountbpl.24446:20|
 :skolemid |513|
 ...
 :qid |DiemAccountbpl.24450:20|
 :skolemid |514|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@15)))
 :qid |DiemAccountbpl.24454:20|
 :skolemid |515|
))) (and (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487325| $1_VASPDomain_VASPDomainManager_$memory) addr@@16)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@16)) 1))))
 :qid |DiemAccountbpl.24458:20|
 :skolemid |516|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487410| $1_VASPDomain_VASPDomains_$memory) addr@@17)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@17)) 5))))
 :qid |DiemAccountbpl.24462:20|
 :skolemid |517|
)))) (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@18)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@18)) 2)))))
 :qid |DiemAccountbpl.24466:20|
 :skolemid |518|
)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) addr@@19)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@19)) 2))))
 :qid |DiemAccountbpl.24470:20|
 :skolemid |519|
))) (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477889| $1_DualAttestation_Credential_$memory) addr@@20)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@20)) 5)))))
 :qid |DiemAccountbpl.24474:20|
 :skolemid |520|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_472200| $1_SlidingNonce_SlidingNonce_$memory) addr@@21)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@21)) 1)))))
 :qid |DiemAccountbpl.24478:20|
 :skolemid |521|
)))))) (=> (and (and (and (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477156| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@22)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@22)) 3))))
 :qid |DiemAccountbpl.24482:20|
 :skolemid |522|
)) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_477551| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@23)) 4))))
 :qid |DiemAccountbpl.24486:20|
 :skolemid |523|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@24)) 5))))
 :qid |DiemAccountbpl.24490:20|
 :skolemid |524|
)) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@25)) 6))))
 :qid |DiemAccountbpl.24494:20|
 :skolemid |525|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (|$IsValid'address'| _$t2)) (and (|$IsValid'u64'| _$t3) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemAccountbpl.24510:20|
 :skolemid |526|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $a_0))
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0)))
 ...
 :qid |DiemAccountbpl.24514:20|
 :skolemid |527|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@1)))
(|$IsValid'$1_Diem_MintCapability'#0''| $rsc@@1))
 :qid |DiemAccountbpl.24518:20|
 :skolemid |528|
 :pattern ( (|Select__T@[Int]$1_Diem_MintCapability'#0'_| (|contents#$Memory_502287| |$1_Diem_MintCapability'#0'_$memory|) $a_0@@1))
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) $a_0@@2)))
(|$IsValid'$1_DesignatedDealer_Dealer'| $rsc@@2))
 :qid |DiemAccountbpl.24522:20|
 :skolemid |529|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) $a_0@@2))
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) $a_0@@3)))
(|$IsValid'$1_DesignatedDealer_TierInfo'#0''| $rsc@@3))
 :qid |DiemAccountbpl.24526:20|
 :skolemid |530|
 :pattern ( (|Select__T@[Int]$1_DesignatedDealer_TierInfo'#0'_| (|contents#$Memory_560400| |$1_DesignatedDealer_TierInfo'#0'_$memory|) $a_0@@3))
)))))) (and (and (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$mint_event_handle#$1_DesignatedDealer_Dealer| (|Select__T@[Int]$1_DesignatedDealer_Dealer_| (|contents#$Memory_487544| $1_DesignatedDealer_Dealer_$memory) _$t2))) (= $t11 ($1_DesignatedDealer_ReceivedMintEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t2 _$t1)))) (and (and (= $t12 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_501585| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t13 (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t12))) (and (= $t14 ($1_Diem_MintEvent _$t1 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t12))) (|Select__T@[Int]Bool_| $1_DesignatedDealer_Dealer_$modifies _$t2)))) (and (and (and (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (|Select__T@[Int]Bool_| |$1_DesignatedDealer_TierInfo'#0'_$modifies| _$t2)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t15 (|$addr#$signer| _$t0)) (= $t16  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) $t15)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 1129002) 1131437) anon30_Then_correct) (=> (= (ControlFlow 0 1129002) 1129062) anon30_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@6 T@$1_Event_EventHandle) ) (! (let ((stream@@10 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@6)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1127840) 1129002)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_33444| (|p#$Mutation_560444| $t30)) 0) (=> (and (= (|l#Vec_33444| (|p#$Mutation_464575| $t31)) 0) (= (ControlFlow 0 1127850) 1127840)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 2078811) 1127850) anon0_correct)))
