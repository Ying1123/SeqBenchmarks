...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_key_rotation_capability_address$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2442076) (let ((anon0$1_correct  (=> (and (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| _$t0) (= _$t0 _$t0)) (and (= $t1@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 1670366) (- 0 2442147)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0))))))
 :qid |DiemAccountbpl.73927:15|
 :skolemid |2706|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1670185) 1670366)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2442076) 1670185) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
