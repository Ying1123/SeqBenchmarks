...
(declare-fun $t89 () T@$1_CRSN_CRSN)
(declare-fun $t90 () Int)
(declare-fun $t101 () Int)
(declare-fun inline$$Ge$0$dst@1 () Bool)
(declare-fun $t98@0 () Int)
(declare-fun $t52@1 () T@$1_DiemAccount_DiemAccount)
(declare-fun $t97 () Int)
(declare-fun $t94@0 () Int)
(declare-fun $t39 () Int)
...
(declare-fun $t57 () Int)
(declare-fun $t54@0 () T@Vec_33444)
(declare-fun call1formal@res@0 () T@Vec_33444)
(declare-fun $t52 () T@$1_DiemAccount_DiemAccount)
(declare-fun $t52@0 () T@$1_DiemAccount_DiemAccount)
(declare-fun $abort_code@2 () Int)
(declare-fun $abort_flag@1 () Bool)
(declare-fun inline$$Not$0$dst@1 () Bool)
(declare-fun $t51 () Int)
(declare-fun $t48 () Bool)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_prologue_common$verify_instantiated_0)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2554834) (let ((L27_correct  (and (=> (= (ControlFlow 0 1844513) (- 0 2560312)) (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)))))) (=> (not (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816))))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560325)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560337)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37)))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560347)) (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))))) (=> (not (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560366)) (not (> $t38 18446744073709551615))) (=> (not (> $t38 18446744073709551615)) (and (=> (= (ControlFlow 0 1844513) (- 0 2560377)) (not (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))) (=> (not (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560395)) (not (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))))) (=> (not (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37)))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560415)) (not (and (> $t38 0) (< (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))) $t38)))) (=> (not (and (> $t38 0) (< (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))) $t38))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560437)) (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5))) (=> (not (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (and (=> (= (ControlFlow 0 1844513) (- 0 2560448)) (not (>= _$t1 18446744073709551615))) (=> (not (>= _$t1 18446744073709551615)) (and (=> (= (ControlFlow 0 1844513) (- 0 2560458)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560482)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (and (=> (= (ControlFlow 0 1844513) (- 0 2560506)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37) (not (let ((crsn (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)))
...
(ite  (or (< _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0)) (>= _$t1 (+ (|$min_nonce#$1_CRSN_CRSN| crsn@@0) (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@0)))))) false (let ((scaled_nonce@@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@0))))
 ...
 :qid |DiemAccountbpl.90005:15|
 :skolemid |3197|
)) (=> (= (ControlFlow 0 1844513) (- 0 2560572)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.90010:15|
 :skolemid |3198|
)))))))))))))))))))))))))))))))))))
(let ((anon106_Then_correct  (=> (and inline$$1_CRSN_check$0$$ret0@1 (= (ControlFlow 0 1847763) 1844513)) L27_correct)))
(let ((anon108_Then_correct  (=> (and $t99@0 (= (ControlFlow 0 1844199) 1844513)) L27_correct)))
(let ((L32_correct  (and (=> (= (ControlFlow 0 1842414) (- 0 2560729)) (or (or (or (or (or (or (or (or (or (or (or (or (or (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37)))) (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (> $t38 18446744073709551615)) (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37)))) (and (> $t38 0) (< (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))) $t38))) (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5)) (>= _$t1 18446744073709551615)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37))))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37) (not (let ((crsn@@1 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)))
...
(ite  (or (< _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@2)) (>= _$t1 (+ (|$min_nonce#$1_CRSN_CRSN| crsn@@2) (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@2)))))) false (let ((scaled_nonce@@2 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@2))))
 (not (ite (>= scaled_nonce@@2 (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@2)))) false (|Select__T@[Int]Bool_| (|v#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@2))) scaled_nonce@@2))))))))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 1842414) (- 0 2560909)) (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (= _$t6 (|$id#$1_ChainId_ChainId| (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)))) (= 7 $t41@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)) (= 7 $t41@0))) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t37))) (= 1 $t41@0))) (and (not (|$IsEqual'vec'u8''| ($1_Hash_sha3 _$t2) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))) (= 7 $t41@0))) (and (> $t38 18446744073709551615) (= 7 $t41@0))) (and (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (= 7 $t41@0))) (and (and (> $t38 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))) (= 7 $t41@0))) (and (and (> $t38 0) (< (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t37))) $t38)) (= 7 $t41@0))) (and (>= (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000) _$t5) (= 7 $t41@0))) (and (>= _$t1 18446744073709551615) (= 8 $t41@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (< _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))) (= 7 $t41@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)) (> _$t1 (|$sequence_number#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t37)))) (= 7 $t41@0))) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t37) (not (let ((crsn@@3 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $t37)))
(ite  (or (< _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@3)) (>= _$t1 (+ (|$min_nonce#$1_CRSN_CRSN| crsn@@3) (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@3)))))) false (let ((scaled_nonce@@3 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| crsn@@3))))
 (not (ite (>= scaled_nonce@@3 (|l#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@3)))) false (|Select__T@[Int]Bool_| (|v#Vec_92615| (|$bit_field#$1_BitVector_BitVector| (|$slots#$1_CRSN_CRSN| crsn@@3))) scaled_nonce@@3)))))))) (= 7 $t41@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t41@0))))))))
(let ((anon98_Else_correct  (=> (and (and (not inline$$Ge$2$dst@1) (= $t77 $t77)) (and (= $t41@0 $t77) (= (ControlFlow 0 1848903) 1842414))) L32_correct)))
(let ((anon97_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@9 $abort_code@9)) (and (= $t41@0 $abort_code@9) (= (ControlFlow 0 1848921) 1842414))) L32_correct)))
(let ((anon96_Else_correct  (=> (and (and (not $t71@0) (= $t73 $t73)) (and (= $t41@0 $t73) (= (ControlFlow 0 1848034) 1842414))) L32_correct)))
(let ((anon95_Else_correct  (=> (and (and (not |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1|) (= $t70 $t70)) (and (= $t41@0 $t70) (= (ControlFlow 0 1847976) 1842414))) L32_correct)))
(let ((anon94_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (and (= $t41@0 $abort_code@7) (= (ControlFlow 0 1848935) 1842414))) L32_correct)))
(let ((anon106_Else_correct  (=> (and (and (not inline$$1_CRSN_check$0$$ret0@1) (= $t93 $t93)) (and (= $t41@0 $t93) (= (ControlFlow 0 1847759) 1842414))) L32_correct)))
(let ((anon105_Else_correct  (=> (and (not $abort_flag@23) (|$IsValid'u64'| 1014)) (=> (and (and (|$IsValid'u64'| $t93) (= $t93 7)) (and (= $t93 $t93) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@1))) (and (=> (= (ControlFlow 0 1847743) 1847763) anon106_Then_correct) (=> (= (ControlFlow 0 1847743) 1847759) anon106_Else_correct))))))
(let ((anon105_Then_correct  (=> (and (and $abort_flag@23 (= $abort_code@22 $abort_code@22)) (and (= $t41@0 $abort_code@22) (= (ControlFlow 0 1847777) 1842414))) L32_correct)))
(let ((inline$$1_CRSN_check$0$L9_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$1_CRSN_check$0$$t5@1) (= $abort_flag@23 $abort_flag@22)) (and (= $abort_code@22 $abort_code@21) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$t5@1))) (and (=> (= (ControlFlow 0 1847479) 1847777) anon105_Then_correct) (=> (= (ControlFlow 0 1847479) 1847743) anon105_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon43_Else$1_correct  (=> (= inline$$Not$1$dst@1 inline$$Not$1$dst@1) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 inline$$Not$1$dst@1) (= $abort_code@21 $abort_code@20)) (and (= $abort_flag@22 $abort_flag@21) (= (ControlFlow 0 1847467) 1847479))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not inline$$1_BitVector_is_index_set$0$$ret0@1)) (= (ControlFlow 0 1847449) 1847467)) inline$$1_CRSN_check$0$anon43_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon43_Else_correct  (=> (and (not $abort_flag@21) (= (ControlFlow 0 1847455) 1847449)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon41_Then_correct  (=> (and inline$$1_CRSN_check$0$$t4@1 (= false false)) (=> (and (and (= inline$$1_CRSN_check$0$$t5@1 false) (= $abort_code@21 $abort_code@17)) (and (= $abort_flag@22 $abort_flag@18) (= (ControlFlow 0 1847529) 1847479))) inline$$1_CRSN_check$0$L9_correct))))
(let ((inline$$1_CRSN_check$0$L11_correct  (=> (= $abort_flag@23 true) (=> (and (= $abort_code@22 inline$$1_CRSN_check$0$$t13@1) (= inline$$1_CRSN_check$0$$ret0@1 inline$$1_CRSN_check$0$$ret0@0)) (and (=> (= (ControlFlow 0 1845632) 1847777) anon105_Then_correct) (=> (= (ControlFlow 0 1845632) 1847743) anon105_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon43_Then_correct  (=> (and (and $abort_flag@21 (= $abort_code@20 $abort_code@20)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@20) (= (ControlFlow 0 1847493) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Else_correct  (=> (not $abort_flag@20) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_code@20 $abort_code@19)) (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 |inline$$1_Vector_borrow'bool'$0$dst@2|) (= $abort_flag@21 $abort_flag@20))) (and (=> (= (ControlFlow 0 1847377) 1847493) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1847377) 1847455) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$L3_correct  (=> (= $abort_code@20 inline$$1_BitVector_is_index_set$0$$t6@1) (=> (and (= inline$$1_BitVector_is_index_set$0$$ret0@1 inline$$1_BitVector_is_index_set$0$$ret0@0) (= $abort_flag@21 true)) (and (=> (= (ControlFlow 0 1847210) 1847493) inline$$1_CRSN_check$0$anon43_Then_correct) (=> (= (ControlFlow 0 1847210) 1847455) inline$$1_CRSN_check$0$anon43_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon10_Then_correct  (=> (and (and $abort_flag@20 (= $abort_code@19 $abort_code@19)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@19) (= (ControlFlow 0 1847391) 1847210))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|  (=> (= $abort_flag@20 true) (=> (and (= $abort_code@19 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@0|)) (and (=> (= (ControlFlow 0 1847353) 1847391) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1847353) 1847377) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2)) (= (ControlFlow 0 1847351) 1847353)) |inline$$1_Vector_borrow'bool'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|  (=> (InRangeVec_16728 inline$$1_BitVector_is_index_set$0$$t10@1 inline$$Sub$0$dst@2) (=> (and (and (= |inline$$1_Vector_borrow'bool'$0$dst@1| (|Select__T@[Int]Bool_| (|v#Vec_92615| inline$$1_BitVector_is_index_set$0$$t10@1) inline$$Sub$0$dst@2)) (= $abort_flag@20 $abort_flag@19)) (and (= $abort_code@19 $abort_code@18) (= |inline$$1_Vector_borrow'bool'$0$dst@2| |inline$$1_Vector_borrow'bool'$0$dst@1|))) (and (=> (= (ControlFlow 0 1847301) 1847391) inline$$1_BitVector_is_index_set$0$anon10_Then_correct) (=> (= (ControlFlow 0 1847301) 1847377) inline$$1_BitVector_is_index_set$0$anon10_Else_correct))))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Then_correct  (=> (and inline$$Lt$3$dst@1 (= inline$$1_BitVector_is_index_set$0$$t10@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1))) (and (=> (= (ControlFlow 0 1847359) 1847351) |inline$$1_Vector_borrow'bool'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1847359) 1847301) |inline$$1_Vector_borrow'bool'$0$anon3_Else_correct|)))))
(let ((inline$$1_BitVector_is_index_set$0$anon9_Else_correct  (=> (and (and (not inline$$Lt$3$dst@1) (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 inline$$1_BitVector_is_index_set$0$$t9@0) (= (ControlFlow 0 1847204) 1847210))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$1_BitVector_is_index_set$0$$t9@0 7)) (and (= inline$$1_BitVector_is_index_set$0$$t9@0 inline$$1_BitVector_is_index_set$0$$t9@0) (= inline$$Lt$3$dst@1 inline$$Lt$3$dst@1))) (and (=> (= (ControlFlow 0 1847188) 1847359) inline$$1_BitVector_is_index_set$0$anon9_Then_correct) (=> (= (ControlFlow 0 1847188) 1847204) inline$$1_BitVector_is_index_set$0$anon9_Else_correct))))))
(let ((inline$$Lt$3$anon0_correct  (=> (and (= inline$$Lt$3$dst@1 (< inline$$Sub$0$dst@2 |inline$$1_Vector_length'bool'$1$l@1|)) (= (ControlFlow 0 1847152) 1847188)) inline$$1_BitVector_is_index_set$0$anon8_Else$1_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Else_correct  (=> (and (not $abort_flag@19) (= (ControlFlow 0 1847158) 1847152)) inline$$Lt$3$anon0_correct)))
(let ((inline$$1_BitVector_is_index_set$0$anon8_Then_correct  (=> (and (and $abort_flag@19 (= $abort_code@18 $abort_code@18)) (and (= inline$$1_BitVector_is_index_set$0$$t6@1 $abort_code@18) (= (ControlFlow 0 1847405) 1847210))) inline$$1_BitVector_is_index_set$0$L3_correct)))
(let ((|inline$$1_Vector_length'bool'$1$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$1$l@1| (|l#Vec_92615| inline$$1_BitVector_is_index_set$0$$t4@1)) (and (=> (= (ControlFlow 0 1847098) 1847405) inline$$1_BitVector_is_index_set$0$anon8_Then_correct) (=> (= (ControlFlow 0 1847098) 1847158) inline$$1_BitVector_is_index_set$0$anon8_Else_correct)))))
(let ((inline$$1_BitVector_is_index_set$0$anon0_correct  (=> (and (and (= inline$$1_CRSN_check$0$$t31@1 inline$$1_CRSN_check$0$$t31@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_BitVector_is_index_set$0$$t4@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t31@1)) (= (ControlFlow 0 1847104) 1847098))) |inline$$1_Vector_length'bool'$1$anon0_correct|)))
(let ((inline$$1_CRSN_check$0$anon42_Else_correct  (=> (and (and (not $abort_flag@19) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@2)) (and (= inline$$1_CRSN_check$0$$t31@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1847411) 1847104))) inline$$1_BitVector_is_index_set$0$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon42_Then_correct  (=> (and (and $abort_flag@19 (= $abort_code@18 $abort_code@18)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@18) (= (ControlFlow 0 1847507) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@18 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@19 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 1846745) 1847507) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1846745) 1847411) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< _$t1 inline$$1_CRSN_check$0$$t29@1) (= (ControlFlow 0 1846743) 1846745)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$1_CRSN_check$0$$t29@1 _$t1) (=> (and (and (= inline$$Sub$0$dst@1 (- _$t1 inline$$1_CRSN_check$0$$t29@1)) (= $abort_code@18 $abort_code@17)) (and (= $abort_flag@19 $abort_flag@18) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 1846695) 1847507) inline$$1_CRSN_check$0$anon42_Then_correct) (=> (= (ControlFlow 0 1846695) 1847411) inline$$1_CRSN_check$0$anon42_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon41_Else_correct  (=> (and (not inline$$1_CRSN_check$0$$t4@1) (= inline$$1_CRSN_check$0$$t29@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1846751) 1846743) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 1846751) 1846695) inline$$Sub$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon40_Else$1_correct  (=> (and (and (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1) (= $abort_flag@18 $abort_flag@17)) (and (= inline$$1_CRSN_check$0$$t4@1 inline$$Ge$1$dst@1) (= $abort_code@17 $abort_code@16))) (and (=> (= (ControlFlow 0 1846600) 1847529) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1846600) 1846751) inline$$1_CRSN_check$0$anon41_Else_correct)))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= inline$$CastU128$3$dst@1 inline$$AddU128$0$dst@2)) (= (ControlFlow 0 1846582) 1846600)) inline$$1_CRSN_check$0$anon40_Else$1_correct)))
(let ((inline$$1_CRSN_check$0$anon40_Else_correct  (=> (and (not $abort_flag@17) (= (ControlFlow 0 1846588) 1846582)) inline$$Ge$1$anon0_correct)))
(let ((inline$$1_CRSN_check$0$anon35_Then_correct  (=> inline$$Lt$2$dst@1 (=> (and (and (= true true) (= $abort_flag@18 $abort_flag@12)) (and (= inline$$1_CRSN_check$0$$t4@1 true) (= $abort_code@17 $abort_code@12))) (and (=> (= (ControlFlow 0 1847617) 1847529) inline$$1_CRSN_check$0$anon41_Then_correct) (=> (= (ControlFlow 0 1847617) 1846751) inline$$1_CRSN_check$0$anon41_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon40_Then_correct  (=> (and (and $abort_flag@17 (= $abort_code@16 $abort_code@16)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@16) (= (ControlFlow 0 1847543) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$AddU128$0$anon3_Then$1_correct  (=> (= $abort_flag@17 true) (=> (and (= $abort_code@16 $EXEC_FAILURE_CODE) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@0)) (and (=> (= (ControlFlow 0 1846528) 1847543) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1846528) 1846588) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$AddU128$0$anon3_Then_correct  (=> (and (> (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1) $MAX_U128) (= (ControlFlow 0 1846526) 1846528)) inline$$AddU128$0$anon3_Then$1_correct)))
(let ((inline$$AddU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (=> (and (and (= inline$$AddU128$0$dst@1 (+ inline$$CastU128$4$dst@1 inline$$CastU128$5$dst@1)) (= $abort_flag@17 $abort_flag@16)) (and (= $abort_code@16 $abort_code@15) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@1))) (and (=> (= (ControlFlow 0 1846474) 1847543) inline$$1_CRSN_check$0$anon40_Then_correct) (=> (= (ControlFlow 0 1846474) 1846588) inline$$1_CRSN_check$0$anon40_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon39_Else_correct  (=> (not $abort_flag@16) (and (=> (= (ControlFlow 0 1846534) 1846526) inline$$AddU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1846534) 1846474) inline$$AddU128$0$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon39_Then_correct  (=> (and (and $abort_flag@16 (= $abort_code@15 $abort_code@15)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@15) (= (ControlFlow 0 1847557) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$5$anon3_Then$1_correct  (=> (= $abort_code@15 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@16 true) (= inline$$CastU128$5$dst@1 inline$$CastU128$5$dst@0)) (and (=> (= (ControlFlow 0 1846367) 1847557) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1846367) 1846534) inline$$1_CRSN_check$0$anon39_Else_correct))))))
(let ((inline$$CastU128$5$anon3_Then_correct  (=> (and (> inline$$1_BitVector_length$0$$ret0@1 $MAX_U128) (= (ControlFlow 0 1846365) 1846367)) inline$$CastU128$5$anon3_Then$1_correct)))
(let ((inline$$CastU128$5$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_BitVector_length$0$$ret0@1) (= $abort_code@15 $abort_code@14)) (and (= $abort_flag@16 $abort_flag@15) (= inline$$CastU128$5$dst@1 inline$$1_BitVector_length$0$$ret0@1))) (and (=> (= (ControlFlow 0 1846317) 1847557) inline$$1_CRSN_check$0$anon39_Then_correct) (=> (= (ControlFlow 0 1846317) 1846534) inline$$1_CRSN_check$0$anon39_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Else_correct  (=> (not $abort_flag@15) (and (=> (= (ControlFlow 0 1846373) 1846365) inline$$CastU128$5$anon3_Then_correct) (=> (= (ControlFlow 0 1846373) 1846317) inline$$CastU128$5$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon38_Then_correct  (=> (and (and $abort_flag@15 (= $abort_code@14 $abort_code@14)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@14) (= (ControlFlow 0 1847571) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_BitVector_length$0$anon3_Else_correct  (=> (and (and (not $abort_flag@14) (= |inline$$1_Vector_length'bool'$0$l@1| |inline$$1_Vector_length'bool'$0$l@1|)) (and (= $abort_flag@15 $abort_flag@14) (= inline$$1_BitVector_length$0$$ret0@1 |inline$$1_Vector_length'bool'$0$l@1|))) (and (=> (= (ControlFlow 0 1846216) 1847571) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1846216) 1846373) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon3_Then_correct  (=> (and (and $abort_flag@14 (= $abort_code@14 $abort_code@14)) (and (= $abort_flag@15 true) (= inline$$1_BitVector_length$0$$ret0@1 inline$$1_BitVector_length$0$$ret0@0))) (and (=> (= (ControlFlow 0 1846234) 1847571) inline$$1_CRSN_check$0$anon38_Then_correct) (=> (= (ControlFlow 0 1846234) 1846373) inline$$1_CRSN_check$0$anon38_Else_correct)))))
(let ((|inline$$1_Vector_length'bool'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'bool'$0$l@1| (|l#Vec_92615| inline$$1_BitVector_length$0$$t1@1)) (and (=> (= (ControlFlow 0 1846192) 1846234) inline$$1_BitVector_length$0$anon3_Then_correct) (=> (= (ControlFlow 0 1846192) 1846216) inline$$1_BitVector_length$0$anon3_Else_correct)))))
(let ((inline$$1_BitVector_length$0$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t23@1 inline$$1_CRSN_check$0$$t23@1) (=> (and (= inline$$1_BitVector_length$0$$t1@1 (|$bit_field#$1_BitVector_BitVector| inline$$1_CRSN_check$0$$t23@1)) (= (ControlFlow 0 1846198) 1846192)) |inline$$1_Vector_length'bool'$0$anon0_correct|))))
(let ((inline$$1_CRSN_check$0$anon37_Else_correct  (=> (not $abort_flag@14) (=> (and (= inline$$1_CRSN_check$0$$t23@1 (|$slots#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1846240) 1846198)) inline$$1_BitVector_length$0$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon37_Then_correct  (=> (and (and $abort_flag@14 (= $abort_code@14 $abort_code@14)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@14) (= (ControlFlow 0 1847585) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$4$anon3_Then$1_correct  (=> (= $abort_code@14 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@14 true) (= inline$$CastU128$4$dst@1 inline$$CastU128$4$dst@0)) (and (=> (= (ControlFlow 0 1845996) 1847585) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1845996) 1846240) inline$$1_CRSN_check$0$anon37_Else_correct))))))
(let ((inline$$CastU128$4$anon3_Then_correct  (=> (and (> inline$$1_CRSN_check$0$$t21@1 $MAX_U128) (= (ControlFlow 0 1845994) 1845996)) inline$$CastU128$4$anon3_Then$1_correct)))
(let ((inline$$CastU128$4$anon3_Else_correct  (=> (and (and (>= $MAX_U128 inline$$1_CRSN_check$0$$t21@1) (= $abort_code@14 $abort_code@13)) (and (= $abort_flag@14 $abort_flag@13) (= inline$$CastU128$4$dst@1 inline$$1_CRSN_check$0$$t21@1))) (and (=> (= (ControlFlow 0 1845946) 1847585) inline$$1_CRSN_check$0$anon37_Then_correct) (=> (= (ControlFlow 0 1845946) 1846240) inline$$1_CRSN_check$0$anon37_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Else_correct  (=> (and (not $abort_flag@13) (= inline$$1_CRSN_check$0$$t21@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)))) (and (=> (= (ControlFlow 0 1846002) 1845994) inline$$CastU128$4$anon3_Then_correct) (=> (= (ControlFlow 0 1846002) 1845946) inline$$CastU128$4$anon3_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon36_Then_correct  (=> (and (and $abort_flag@13 (= $abort_code@13 $abort_code@13)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@13) (= (ControlFlow 0 1847599) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$CastU128$3$anon3_Then$1_correct  (=> (= $abort_flag@13 true) (=> (and (= $abort_code@13 $EXEC_FAILURE_CODE) (= inline$$CastU128$3$dst@1 inline$$CastU128$3$dst@0)) (and (=> (= (ControlFlow 0 1845857) 1847599) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1845857) 1846002) inline$$1_CRSN_check$0$anon36_Else_correct))))))
(let ((inline$$CastU128$3$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1845855) 1845857)) inline$$CastU128$3$anon3_Then$1_correct)))
(let ((inline$$CastU128$3$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_flag@13 $abort_flag@12)) (and (= $abort_code@13 $abort_code@12) (= inline$$CastU128$3$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1845807) 1847599) inline$$1_CRSN_check$0$anon36_Then_correct) (=> (= (ControlFlow 0 1845807) 1846002) inline$$1_CRSN_check$0$anon36_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon35_Else_correct  (=> (not inline$$Lt$2$dst@1) (and (=> (= (ControlFlow 0 1845863) 1845855) inline$$CastU128$3$anon3_Then_correct) (=> (= (ControlFlow 0 1845863) 1845807) inline$$CastU128$3$anon3_Else_correct)))))
(let ((inline$$Lt$2$anon0_correct  (=> (= inline$$Lt$2$dst@1 (< _$t1 inline$$1_CRSN_check$0$$t17@1)) (and (=> (= (ControlFlow 0 1845724) 1847617) inline$$1_CRSN_check$0$anon35_Then_correct) (=> (= (ControlFlow 0 1845724) 1845863) inline$$1_CRSN_check$0$anon35_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon34_Else_correct  (=> (not $abort_flag@12) (=> (and (and (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2)) (= |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1| |inline$$1_CRSN_check$0$$temp_0'$1_CRSN_CRSN'@1|)) (and (= inline$$1_CRSN_check$0$$t17@1 (|$min_nonce#$1_CRSN_CRSN| (|v#$Mutation_577037| inline$$1_CRSN_check$0$$t16@2))) (= (ControlFlow 0 1845730) 1845724))) inline$$Lt$2$anon0_correct))))
(let ((inline$$1_CRSN_check$0$anon34_Then_correct  (=> (and (and $abort_flag@12 (= $abort_code@12 $abort_code@12)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@12) (= (ControlFlow 0 1847631) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Then$1_correct  (=> (= $abort_code@12 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@12 true) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@0)) (and (=> (= (ControlFlow 0 1847683) 1847631) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1847683) 1845730) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon33_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= (ControlFlow 0 1847681) 1847683)) inline$$1_CRSN_check$0$anon33_Then$1_correct)))
(let ((inline$$1_CRSN_check$0$anon33_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0) (=> (and (and (= inline$$1_CRSN_check$0$$t16@1 ($Mutation_577037 ($Global inline$$1_CRSN_check$0$$t11@0) (Vec_33444 (MapConstVec_18066 DefaultVecElem_18066) 0) (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0))) (= $abort_code@12 $abort_code@11)) (and (= $abort_flag@12 $abort_flag@11) (= inline$$1_CRSN_check$0$$t16@2 inline$$1_CRSN_check$0$$t16@1))) (and (=> (= (ControlFlow 0 1845658) 1847631) inline$$1_CRSN_check$0$anon34_Then_correct) (=> (= (ControlFlow 0 1845658) 1845730) inline$$1_CRSN_check$0$anon34_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon32_Then_correct  (=> inline$$1_CRSN_has_crsn$1$$t1@1 (and (=> (= (ControlFlow 0 1845636) 1847681) inline$$1_CRSN_check$0$anon33_Then_correct) (=> (= (ControlFlow 0 1845636) 1845658) inline$$1_CRSN_check$0$anon33_Else_correct)))))
(let ((inline$$1_CRSN_check$0$anon32_Else_correct  (=> (and (and (not inline$$1_CRSN_has_crsn$1$$t1@1) (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0)) (and (= inline$$1_CRSN_check$0$$t13@1 inline$$1_CRSN_check$0$$t15@0) (= (ControlFlow 0 1845626) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_check$0$anon31_Else_correct  (=> (and (not $abort_flag@11) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_check$0$$t15@0 1)) (and (= inline$$1_CRSN_check$0$$t15@0 inline$$1_CRSN_check$0$$t15@0) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1))) (and (=> (= (ControlFlow 0 1845610) 1845636) inline$$1_CRSN_check$0$anon32_Then_correct) (=> (= (ControlFlow 0 1845610) 1845626) inline$$1_CRSN_check$0$anon32_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon31_Then_correct  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= inline$$1_CRSN_check$0$$t13@1 $abort_code@11) (= (ControlFlow 0 1847697) 1845632))) inline$$1_CRSN_check$0$L11_correct)))
(let ((inline$$1_CRSN_has_crsn$1$anon0_correct  (=> (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (=> (and (= inline$$1_CRSN_has_crsn$1$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) inline$$1_CRSN_check$0$$t11@0)) (= inline$$1_CRSN_has_crsn$1$$t1@1 inline$$1_CRSN_has_crsn$1$$t1@1)) (and (=> (= (ControlFlow 0 1845568) 1847697) inline$$1_CRSN_check$0$anon31_Then_correct) (=> (= (ControlFlow 0 1845568) 1845610) inline$$1_CRSN_check$0$anon31_Else_correct))))))
(let ((inline$$1_CRSN_check$0$anon0_correct  (=> (and (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t7@0)) 0) (= (|l#Vec_33444| (|p#$Mutation_577037| inline$$1_CRSN_check$0$$t16@0)) 0)) (=> (and (and (and (= inline$$1_CRSN_check$0$$t9@0 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0))) (= inline$$1_CRSN_check$0$$t10@0 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| inline$$1_CRSN_check$0$$t9@0)))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| inline$$1_CRSN_check$0$$t11@0) (= inline$$1_CRSN_check$0$$t11@0 (|$addr#$signer| _$t0))) (and (= inline$$1_CRSN_check$0$$t11@0 inline$$1_CRSN_check$0$$t11@0) (= (ControlFlow 0 1845574) 1845568)))) inline$$1_CRSN_has_crsn$1$anon0_correct))))
(let ((anon104_Then_correct  (=> (and (and inline$$1_CRSN_has_crsn$0$$t1@1 (= $t89 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) (|$addr#$signer| _$t0)))) (and (= $t90 (- _$t1 (|$min_nonce#$1_CRSN_CRSN| $t89))) (= (ControlFlow 0 1847703) 1845574))) inline$$1_CRSN_check$0$anon0_correct)))
(let ((anon108_Else_correct  (=> (and (and (not $t99@0) (= $t101 $t101)) (and (= $t41@0 $t101) (= (ControlFlow 0 1844195) 1842414))) L32_correct)))
(let ((anon107_Then_correct  (=> (and (and (and inline$$Ge$0$dst@1 (= $t98@0 (|$sequence_number#$1_DiemAccount_DiemAccount| $t52@1))) (and (= $t99@0 (= _$t1 $t98@0)) (|$IsValid'u64'| 1003))) (and (and (|$IsValid'u64'| $t101) (= $t101 7)) (and (= $t101 $t101) (= $t99@0 $t99@0)))) (and (=> (= (ControlFlow 0 1844179) 1844199) anon108_Then_correct) (=> (= (ControlFlow 0 1844179) 1844195) anon108_Else_correct)))))
(let ((anon107_Else_correct  (=> (and (and (not inline$$Ge$0$dst@1) (= $t97 $t97)) (and (= $t41@0 $t97) (= (ControlFlow 0 1844133) 1842414))) L32_correct)))
(let ((anon104_Else$1_correct  (=> (|$IsValid'u64'| 1002) (=> (and (and (|$IsValid'u64'| $t97) (= $t97 7)) (and (= $t97 $t97) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 1844117) 1844179) anon107_Then_correct) (=> (= (ControlFlow 0 1844117) 1844133) anon107_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= _$t1 $t94@0)) (= (ControlFlow 0 1844077) 1844117)) anon104_Else$1_correct)))
(let ((anon104_Else_correct  (=> (not inline$$1_CRSN_has_crsn$0$$t1@1) (=> (and (= $t94@0 (|$sequence_number#$1_DiemAccount_DiemAccount| $t52@1)) (= (ControlFlow 0 1844083) 1844077)) inline$$Ge$0$anon0_correct))))
(let ((anon103_Else_correct  (=> (not $abort_flag@11) (and (=> (= (ControlFlow 0 1844025) 1847703) anon104_Then_correct) (=> (= (ControlFlow 0 1844025) 1844083) anon104_Else_correct)))))
(let ((anon103_Then_correct  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= $t41@0 $abort_code@11) (= (ControlFlow 0 1847791) 1842414))) L32_correct)))
(let ((inline$$1_CRSN_has_crsn$0$anon0_correct  (=> (= $t39 $t39) (=> (and (= inline$$1_CRSN_has_crsn$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_576150| $1_CRSN_CRSN_$memory) $t39)) (= inline$$1_CRSN_has_crsn$0$$t1@1 inline$$1_CRSN_has_crsn$0$$t1@1)) (and (=> (= (ControlFlow 0 1844011) 1847791) anon103_Then_correct) (=> (= (ControlFlow 0 1844011) 1844025) anon103_Else_correct))))))
(let ((anon102_Then_correct  (=> (and inline$$Lt$1$dst@1 (= (ControlFlow 0 1844017) 1844011)) inline$$1_CRSN_has_crsn$0$anon0_correct)))
(let ((anon102_Else_correct  (=> (and (and (not inline$$Lt$1$dst@1) (= $t87 $t87)) (and (= $t41@0 $t87) (= (ControlFlow 0 1843910) 1842414))) L32_correct)))
(let ((anon101_Else$1_correct  (=> (|$IsValid'u64'| 1011) (=> (and (and (|$IsValid'u64'| $t87) (= $t87 8)) (and (= $t87 $t87) (= inline$$Lt$1$dst@1 inline$$Lt$1$dst@1))) (and (=> (= (ControlFlow 0 1843894) 1844017) anon102_Then_correct) (=> (= (ControlFlow 0 1843894) 1843910) anon102_Else_correct))))))
(let ((inline$$Lt$1$anon0_correct  (=> (and (= inline$$Lt$1$dst@1 (< inline$$CastU128$2$dst@1 18446744073709551615)) (= (ControlFlow 0 1843854) 1843894)) anon101_Else$1_correct)))
(let ((anon101_Else_correct  (=> (not $abort_flag@11) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1843860) 1843854)) inline$$Lt$1$anon0_correct))))
(let ((anon101_Then_correct  (=> (and (and $abort_flag@11 (= $abort_code@11 $abort_code@11)) (and (= $t41@0 $abort_code@11) (= (ControlFlow 0 1847805) 1842414))) L32_correct)))
(let ((inline$$CastU128$2$anon3_Then$1_correct  (=> (= $abort_flag@11 true) (=> (and (= $abort_code@11 $EXEC_FAILURE_CODE) (= inline$$CastU128$2$dst@1 inline$$CastU128$2$dst@0)) (and (=> (= (ControlFlow 0 1843794) 1847805) anon101_Then_correct) (=> (= (ControlFlow 0 1843794) 1843860) anon101_Else_correct))))))
(let ((inline$$CastU128$2$anon3_Then_correct  (=> (and (> _$t1 $MAX_U128) (= (ControlFlow 0 1843792) 1843794)) inline$$CastU128$2$anon3_Then$1_correct)))
(let ((inline$$CastU128$2$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t1) (= $abort_flag@11 $abort_flag@10)) (and (= $abort_code@11 $abort_code@10) (= inline$$CastU128$2$dst@1 _$t1))) (and (=> (= (ControlFlow 0 1843744) 1847805) anon101_Then_correct) (=> (= (ControlFlow 0 1843744) 1843860) anon101_Else_correct)))))
(let ((anon100_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 1843800) 1843792) inline$$CastU128$2$anon3_Then_correct) (=> (= (ControlFlow 0 1843800) 1843744) inline$$CastU128$2$anon3_Else_correct)))))
(let ((anon100_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= $t82 $t82)) (and (= $t41@0 $t82) (= (ControlFlow 0 1843671) 1842414))) L32_correct)))
(let ((anon99_Else$1_correct  (=> (|$IsValid'u64'| 1006) (=> (and (and (|$IsValid'u64'| $t82) (= $t82 7)) (and (= $t82 $t82) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 1843655) 1843800) anon100_Then_correct) (=> (= (ControlFlow 0 1843655) 1843671) anon100_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t78 _$t5)) (= (ControlFlow 0 1843615) 1843655)) anon99_Else$1_correct)))
(let ((anon99_Else_correct  (=> (and (and (not $t79) (|$IsValid'u64'| $t78)) (and (= $t78 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000)) (= (ControlFlow 0 1843621) 1843615))) inline$$Lt$0$anon0_correct)))
(let ((anon99_Then_correct  (=> $t79 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t41)) (= $t41 $t41)) (and (= $t41@0 $t41) (= (ControlFlow 0 1847831) 1842414))) L32_correct))))
(let ((L12_correct  (=> (= $t79  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1843553) 1847831) anon99_Then_correct) (=> (= (ControlFlow 0 1843553) 1843621) anon99_Else_correct)))))
(let ((anon98_Then_correct  (=> (and (and inline$$Ge$2$dst@1 (= $abort_code@10 $abort_code@9)) (and (= $abort_flag@10 $abort_flag@9) (= (ControlFlow 0 1848907) 1843553))) L12_correct)))
(let ((anon97_Else$1_correct  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| $t77) (= $t77 7)) (and (= $t77 $t77) (= inline$$Ge$2$dst@1 inline$$Ge$2$dst@1))) (and (=> (= (ControlFlow 0 1848887) 1848907) anon98_Then_correct) (=> (= (ControlFlow 0 1848887) 1848903) anon98_Else_correct))))))
(let ((inline$$Ge$2$anon0_correct  (=> (and (= inline$$Ge$2$dst@1 (>= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@1| inline$$MulU64$0$dst@2)) (= (ControlFlow 0 1848847) 1848887)) anon97_Else$1_correct)))
(let ((anon97_Else_correct  (=> (not $abort_flag@9) (=> (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@1|) (= (ControlFlow 0 1848853) 1848847)) inline$$Ge$2$anon0_correct))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Else_correct|  (=> (not $abort_flag@8) (=> (and (and (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1|) (= $abort_code@9 $abort_code@8)) (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1|) (= $abort_flag@9 $abort_flag@8))) (and (=> (= (ControlFlow 0 1848705) 1848921) anon97_Then_correct) (=> (= (ControlFlow 0 1848705) 1848853) anon97_Else_correct))))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$L3_correct|  (=> (= $abort_code@9 |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t6@1|) (=> (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$ret0@0|) (= $abort_flag@9 true)) (and (=> (= (ControlFlow 0 1848374) 1848921) anon97_Then_correct) (=> (= (ControlFlow 0 1848374) 1848853) anon97_Else_correct))))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Then_correct|  (=> (and (and $abort_flag@8 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t6@1| $abort_code@8) (= (ControlFlow 0 1848719) 1848374))) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@7) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (= $abort_flag@8 $abort_flag@7) (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1848663) 1848719) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1848663) 1848705) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@8 $abort_code@8)) (and (= $abort_flag@8 true) (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1848681) 1848719) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 1848681) 1848705) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon14_Else_correct|)))))
(let ((|inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1|)) (= |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1| |inline$$1_Diem_value'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1848639) 1848681) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1848639) 1848663) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@2| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@2|) (=> (and (= |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'$1_XUS_XUS'| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@2|)) (= (ControlFlow 0 1848645) 1848639)) |inline$$1_Diem_value'$1_XUS_XUS'$0$anon0_correct|))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Else_correct|  (=> (and (not $abort_flag@7) (= (ControlFlow 0 1848687) 1848645)) |inline$$1_DiemAccount_balance_for'$1_XUS_XUS'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Then_correct|  (=> (and (and $abort_flag@7 (= $abort_code@8 $abort_code@8)) (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t6@1| $abort_code@8) (= (ControlFlow 0 1848733) 1848374))) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Then$1_correct|  (=> (= $abort_code@8 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@7 true) (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@2| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@0|)) (and (=> (= (ControlFlow 0 1848785) 1848733) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1848785) 1848687) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t39)) (= (ControlFlow 0 1848783) 1848785)) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t39) (=> (and (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@1| (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t39)) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@2| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t7@1|))) (and (=> (= (ControlFlow 0 1848392) 1848733) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 1848392) 1848687) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon13_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon11_Then_correct|  (=> |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t3@1| (and (=> (= (ControlFlow 0 1848378) 1848783) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 1848378) 1848392) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon12_Else_correct|)))))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t3@1|) (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0|)) (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t6@1| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0|) (= (ControlFlow 0 1848368) 1848374))) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$L3_correct|)))
(let ((|inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon0_correct|  (=> (= $t39 $t39) (=> (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t3@1| (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t39)) (|$IsValid'u64'| 19)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0| 5)) (and (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t5@0|) (= |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t3@1| |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$$t3@1|))) (and (=> (= (ControlFlow 0 1848352) 1848378) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 1848352) 1848368) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon11_Else_correct|)))))))
(let ((anon96_Then_correct  (=> (and $t71@0 (= (ControlFlow 0 1848791) 1848352)) |inline$$1_DiemAccount_balance'$1_XUS_XUS'$0$anon0_correct|)))
(let ((anon95_Then_correct  (=> |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| (=> (and (= $t71@0 (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $t39)) (|$IsValid'u64'| 1005)) (=> (and (and (|$IsValid'u64'| $t73) (= $t73 7)) (and (= $t73 $t73) (= $t71@0 $t71@0))) (and (=> (= (ControlFlow 0 1848018) 1848791) anon96_Then_correct) (=> (= (ControlFlow 0 1848018) 1848034) anon96_Else_correct)))))))
(let ((anon94_Else_correct  (=> (and (not $abort_flag@6) (|$IsValid'u64'| 1012)) (=> (and (and (|$IsValid'u64'| $t70) (= $t70 7)) (and (= $t70 $t70) (= |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1847960) 1848018) anon95_Then_correct) (=> (= (ControlFlow 0 1847960) 1847976) anon95_Else_correct))))))
(let ((|inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1847914) 1848935) anon94_Then_correct) (=> (= (ControlFlow 0 1847914) 1847960) anon94_Else_correct))))))
(let ((anon93_Then_correct  (=> (and inline$$Gt$0$dst@1 (= (ControlFlow 0 1847920) 1847914)) |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$anon0_correct|)))
(let ((anon93_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $abort_code@10 $abort_code@7)) (and (= $abort_flag@10 $abort_flag@6) (= (ControlFlow 0 1843541) 1843553))) L12_correct)))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> inline$$MulU64$0$dst@2 0)) (and (=> (= (ControlFlow 0 1843527) 1847920) anon93_Then_correct) (=> (= (ControlFlow 0 1843527) 1843541) anon93_Else_correct)))))
(let ((anon92_Else_correct  (=> (and (and (not $abort_flag@6) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@2)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 1843533) 1843527))) inline$$Gt$0$anon0_correct)))
(let ((anon92_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (and (= $t41@0 $abort_code@7) (= (ControlFlow 0 1848949) 1842414))) L32_correct)))
(let ((inline$$MulU64$0$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@0)) (and (=> (= (ControlFlow 0 1843459) 1848949) anon92_Then_correct) (=> (= (ControlFlow 0 1843459) 1843533) anon92_Else_correct))))))
(let ((inline$$MulU64$0$anon3_Then_correct  (=> (and (> (* _$t3 _$t4) $MAX_U64) (= (ControlFlow 0 1843457) 1843459)) inline$$MulU64$0$anon3_Then$1_correct)))
(let ((inline$$MulU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (* _$t3 _$t4)) (=> (and (and (= inline$$MulU64$0$dst@1 (* _$t3 _$t4)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$MulU64$0$dst@2 inline$$MulU64$0$dst@1))) (and (=> (= (ControlFlow 0 1843405) 1848949) anon92_Then_correct) (=> (= (ControlFlow 0 1843405) 1843533) anon92_Else_correct))))))
(let ((anon91_Then_correct  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 1843465) 1843457) inline$$MulU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 1843465) 1843405) inline$$MulU64$0$anon3_Else_correct)))))
(let ((anon91_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t64 $t64)) (and (= $t41@0 $t64) (= (ControlFlow 0 1843308) 1842414))) L32_correct)))
(let ((anon90_Else$1_correct  (=> (|$IsValid'u64'| 1005) (=> (and (and (|$IsValid'u64'| $t64) (= $t64 7)) (and (= $t64 $t64) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 1843292) 1843465) anon91_Then_correct) (=> (= (ControlFlow 0 1843292) 1843308) anon91_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 1843252) 1843292)) anon90_Else$1_correct)))
(let ((anon90_Else_correct  (=> (not $abort_flag@5) (=> (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 1843258) 1843252)) inline$$Le$0$anon0_correct))))
(let ((anon90_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t41@0 $abort_code@6) (= (ControlFlow 0 1848963) 1842414))) L32_correct)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 1843192) 1848963) anon90_Then_correct) (=> (= (ControlFlow 0 1843192) 1843258) anon90_Else_correct))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 1843190) 1843192)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 1843138) 1848963) anon90_Then_correct) (=> (= (ControlFlow 0 1843138) 1843258) anon90_Else_correct))))))
(let ((anon89_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 1843198) 1843190) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1843198) 1843138) inline$$MulU128$0$anon3_Else_correct)))))
(let ((anon89_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t41@0 $abort_code@5) (= (ControlFlow 0 1848977) 1842414))) L32_correct)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 1843031) 1848977) anon89_Then_correct) (=> (= (ControlFlow 0 1843031) 1843198) anon89_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t4 $MAX_U128) (= (ControlFlow 0 1843029) 1843031)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t4) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$CastU128$1$dst@1 _$t4))) (and (=> (= (ControlFlow 0 1842981) 1848977) anon89_Then_correct) (=> (= (ControlFlow 0 1842981) 1843198) anon89_Else_correct)))))
(let ((anon88_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 1843037) 1843029) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 1843037) 1842981) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon88_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t41@0 $abort_code@4) (= (ControlFlow 0 1848991) 1842414))) L32_correct)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 1842898) 1848991) anon88_Then_correct) (=> (= (ControlFlow 0 1842898) 1843037) anon88_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t3 $MAX_U128) (= (ControlFlow 0 1842896) 1842898)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t3) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$0$dst@1 _$t3))) (and (=> (= (ControlFlow 0 1842848) 1848991) anon88_Then_correct) (=> (= (ControlFlow 0 1842848) 1843037) anon88_Else_correct)))))
(let ((anon87_Then_correct  (=> $t55@0 (and (=> (= (ControlFlow 0 1842904) 1842896) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 1842904) 1842848) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon87_Else_correct  (=> (and (and (not $t55@0) (= $t57 $t57)) (and (= $t41@0 $t57) (= (ControlFlow 0 1842775) 1842414))) L32_correct)))
(let ((anon86_Else_correct  (=> (and (and (and (not $abort_flag@2) (= $t54@0 (|$authentication_key#$1_DiemAccount_DiemAccount| $t52@1))) (and (= $t55@0 (|$IsEqual'vec'u8''| call1formal@res@0 $t54@0)) (|$IsValid'u64'| 1001))) (and (and (|$IsValid'u64'| $t57) (= $t57 7)) (and (= $t57 $t57) (= $t55@0 $t55@0)))) (and (=> (= (ControlFlow 0 1842759) 1842904) anon87_Then_correct) (=> (= (ControlFlow 0 1842759) 1842775) anon87_Else_correct)))))
(let ((anon86_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t41@0 $abort_code@3) (= (ControlFlow 0 1849005) 1842414))) L32_correct)))
(let ((anon85_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t52@1 $t52@1) (= call1formal@res@0 ($1_Hash_sha3 _$t2))) (and (|$IsValid'vec'u8''| call1formal@res@0) (= (|l#Vec_33444| call1formal@res@0) 32))) (and (=> (= (ControlFlow 0 1842711) 1849005) anon86_Then_correct) (=> (= (ControlFlow 0 1842711) 1842759) anon86_Else_correct))))))
(let ((anon85_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t41@0 $abort_code@3) (= (ControlFlow 0 1849019) 1842414))) L32_correct)))
(let ((anon84_Then$1_correct  (=> (= $t52@1 $t52) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 1849071) 1849019) anon85_Then_correct) (=> (= (ControlFlow 0 1849071) 1842711) anon85_Else_correct))))))
(let ((anon84_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t39)) (= (ControlFlow 0 1849069) 1849071)) anon84_Then$1_correct)))
(let ((anon84_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t39) (=> (and (and (= $t52@0 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t39)) (= $t52@1 $t52@0)) (and (= $abort_code@3 $abort_code@2) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 1842695) 1849019) anon85_Then_correct) (=> (= (ControlFlow 0 1842695) 1842711) anon85_Else_correct))))))
(let ((anon83_Then_correct  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 1842681) 1849069) anon84_Then_correct) (=> (= (ControlFlow 0 1842681) 1842695) anon84_Else_correct)))))
(let ((anon83_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t51 $t51)) (and (= $t41@0 $t51) (= (ControlFlow 0 1842677) 1842414))) L32_correct)))
(let ((anon82_Then$1_correct  (=> (|$IsValid'u64'| 1000) (=> (and (and (|$IsValid'u64'| $t51) (= $t51 1)) (and (= $t51 $t51) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 1842661) 1842681) anon83_Then_correct) (=> (= (ControlFlow 0 1842661) 1842677) anon83_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t48)) (= (ControlFlow 0 1842621) 1842661)) anon82_Then$1_correct)))
(let ((anon82_Then_correct  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (=> (and (= $t48  (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t39) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $t39)))) (= (ControlFlow 0 1842627) 1842621)) inline$$Not$0$anon0_correct))))
(let ((anon82_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= $t47 $t47)) (and (= $t41@0 $t47) (= (ControlFlow 0 1842573) 1842414))) L32_correct)))
(let ((anon81_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 1004)) (=> (and (and (|$IsValid'u64'| $t47) (= $t47 7)) (and (= $t47 $t47) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 1842557) 1842627) anon82_Then_correct) (=> (= (ControlFlow 0 1842557) 1842573) anon82_Else_correct))))))
(let ((anon81_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t41@0 $abort_code@2) (= (ControlFlow 0 1849085) 1842414))) L32_correct)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= $t39 $t39) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $t39)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 1842515) 1849085) anon81_Then_correct) (=> (= (ControlFlow 0 1842515) 1842557) anon81_Else_correct))))))
(let ((anon80_Then_correct  (=> (and $t42@0 (= (ControlFlow 0 1842521) 1842515)) inline$$1_DiemAccount_exists_at$0$anon0_correct)))
(let ((anon80_Else_correct  (=> (and (and (not $t42@0) (= $t44 $t44)) (and (= $t41@0 $t44) (= (ControlFlow 0 1841890) 1842414))) L32_correct)))
(let ((anon79_Else_correct  (=> (not $abort_flag@1) (=> (and (= $t42@0 (= inline$$1_ChainId_get$0$$ret0@1 _$t6)) (|$IsValid'u64'| 1007)) (=> (and (and (|$IsValid'u64'| $t44) (= $t44 7)) (and (= $t44 $t44) (= $t42@0 $t42@0))) (and (=> (= (ControlFlow 0 1841874) 1842521) anon80_Then_correct) (=> (= (ControlFlow 0 1841874) 1841890) anon80_Else_correct)))))))
(let ((anon79_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t41@0 $abort_code@2) (= (ControlFlow 0 1849099) 1842414))) L32_correct)))
(let ((inline$$1_ChainId_get$0$L2_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 inline$$1_ChainId_get$0$$t1@1) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$ret0@0)) (and (=> (= (ControlFlow 0 1841748) 1849099) anon79_Then_correct) (=> (= (ControlFlow 0 1841748) 1841874) anon79_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon10_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_ChainId_get$0$$t1@1 $abort_code@1) (= (ControlFlow 0 1841742) 1841748))) inline$$1_ChainId_get$0$L2_correct)))
(let ((inline$$1_ChainId_get$0$anon8_Then_correct  (=> inline$$1_ChainId_get$0$$t0@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ChainId_get$0$$t1@0)) (= inline$$1_ChainId_get$0$$t1@0 inline$$1_ChainId_get$0$$t1@0)) (and (= inline$$1_ChainId_get$0$$t1@1 inline$$1_ChainId_get$0$$t1@0) (= (ControlFlow 0 1841826) 1841748))) inline$$1_ChainId_get$0$L2_correct))))
(let ((inline$$1_ChainId_get$0$anon10_Else_correct  (=> (and (not $abort_flag@0) (= inline$$1_ChainId_get$0$$t4@1 (|$id#$1_ChainId_ChainId| inline$$1_ChainId_get$0$$t3@2))) (=> (and (and (= inline$$1_ChainId_get$0$$t4@1 inline$$1_ChainId_get$0$$t4@1) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$1_ChainId_get$0$$ret0@1 inline$$1_ChainId_get$0$$t4@1))) (and (=> (= (ControlFlow 0 1841728) 1849099) anon79_Then_correct) (=> (= (ControlFlow 0 1841728) 1841874) anon79_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon9_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@0)) (and (=> (= (ControlFlow 0 1841800) 1841742) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1841800) 1841728) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon9_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= (ControlFlow 0 1841798) 1841800)) inline$$1_ChainId_get$0$anon9_Then$1_correct)))
(let ((inline$$1_ChainId_get$0$anon9_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816) (=> (and (and (= inline$$1_ChainId_get$0$$t3@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_ChainId_get$0$$t3@2 inline$$1_ChainId_get$0$$t3@1))) (and (=> (= (ControlFlow 0 1841706) 1841742) inline$$1_ChainId_get$0$anon10_Then_correct) (=> (= (ControlFlow 0 1841706) 1841728) inline$$1_ChainId_get$0$anon10_Else_correct))))))
(let ((inline$$1_ChainId_get$0$anon8_Else_correct  (=> (and (not inline$$1_ChainId_get$0$$t0@0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 1841692) 1841798) inline$$1_ChainId_get$0$anon9_Then_correct) (=> (= (ControlFlow 0 1841692) 1841706) inline$$1_ChainId_get$0$anon9_Else_correct)))))
(let ((inline$$1_ChainId_get$0$anon0_correct  (=> (= inline$$1_ChainId_get$0$$t0@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 1841678) 1841826) inline$$1_ChainId_get$0$anon8_Then_correct) (=> (= (ControlFlow 0 1841678) 1841692) inline$$1_ChainId_get$0$anon8_Else_correct)))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) 173345816)) 0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) 186537453)) 1)))) (=> (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472200| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472200| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472293| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472379| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472452| $1_DiemSystem_CapabilityHolder_$memory) 173345816))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472523| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472607| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472691| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472762| $1_XDX_Reserve_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472846| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_472930| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473001| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473098| $1_DualAttestation_Limit_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473182| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473266| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473337| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2) (or (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0) (and (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0)) (= addr@@2 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))) 0)))))))
 :qid |DiemAccountbpl.88905:20|
 :skolemid |3181|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))) 0)) (and (not (= (|l#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))) 0)) (= addr@@3 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_421889| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))) 0)))))))
 :qid |DiemAccountbpl.88909:20|
 :skolemid |3182|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473580| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_471307| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_473651| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@4)))
 :qid |DiemAccountbpl.88921:20|
 :skolemid |3183|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (= (|Select__T@[Int]Bool_| (|domain#$Memory_473580| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@5)  (and (= addr@@5 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@5))))
 :qid |DiemAccountbpl.88925:20|
 :skolemid |3184|
))))) (and (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (= (|Select__T@[Int]Bool_| (|domain#$Memory_473651| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@6)  (and (= addr@@6 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@6))))
 :qid |DiemAccountbpl.88929:20|
 :skolemid |3185|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_478064| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@7)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@7)) 2)))))
 :qid |DiemAccountbpl.88933:20|
 :skolemid |3186|
))) (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@8)))
 :qid |DiemAccountbpl.88937:20|
 :skolemid |3187|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) addr@@9)))
 :qid |DiemAccountbpl.88941:20|
 :skolemid |3188|
)))) (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@10)))
 :qid |DiemAccountbpl.88945:20|
 :skolemid |3189|
...
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) $a_0@@1)))
(|$IsValid'$1_ChainId_ChainId'| $rsc@@1))
 :qid |DiemAccountbpl.88989:20|
 :skolemid |3192|
 :pattern ( (|Select__T@[Int]$1_ChainId_ChainId_| (|contents#$Memory_473266| $1_ChainId_ChainId_$memory) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $a_0@@2)))
(|$IsValid'$1_CRSN_CRSN'| $rsc@@2))
 :qid |DiemAccountbpl.88993:20|
 :skolemid |3193|
 :pattern ( (|Select__T@[Int]$1_CRSN_CRSN_| (|contents#$Memory_576150| $1_CRSN_CRSN_$memory) $a_0@@2))
)))))) (and (and (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $a_0@@3)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@3))
 :qid |DiemAccountbpl.88997:20|
 :skolemid |3194|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_473408| $1_AccountFreezing_FreezingBit_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@4)))
 ...
 :qid |DiemAccountbpl.89001:20|
 :skolemid |3195|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0@@4))
))) (and (forall (($a_0@@5 Int) ) (! (let (($rsc@@5 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XUS_XUS'_| (|contents#$Memory_478004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) $a_0@@5)))
(|$IsValid'$1_DiemAccount_Balance'$1_XUS_XUS''| $rsc@@5))
 :qid |DiemAccountbpl.89005:20|
 :skolemid |3196|
...
)) (= $t37 (|$addr#$signer| _$t0)))) (and (and (= $t38 (* _$t3 _$t4)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2)))) (and (and (and (= _$t3 _$t3) (= _$t4 _$t4)) (and (= _$t5 _$t5) (= _$t6 _$t6))) (and (and (|$IsValid'address'| $t39) (= $t39 (|$addr#$signer| _$t0))) (and (= $t39 $t39) (= (ControlFlow 0 1841832) 1841678))))))) inline$$1_ChainId_get$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1840577) 1841832)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2554834) 1840577) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
