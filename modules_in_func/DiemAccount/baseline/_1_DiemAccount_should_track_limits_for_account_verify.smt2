...
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@1| () Bool)
(declare-fun $t10 () Bool)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t4@1| () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@0| () Bool)
(declare-fun $abort_flag@3 () Bool)
(declare-fun $abort_code@4 () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1| () Bool)
(declare-fun $abort_code@5 () Int)
(declare-fun $abort_flag@4 () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$t3@1| () Int)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$ret0@0| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$t2@0| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$t3@0| () Int)
(declare-fun |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1| () Bool)
(declare-fun $abort_code@0 () Int)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$1$$t1@0| () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t2@0| () Bool)
(declare-fun |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1| () Bool)
(declare-fun $t6@0 () Bool)
(declare-fun inline$$Not$0$dst@1 () Bool)
(declare-fun $t18 () Bool)
(declare-fun $t5@0 () Bool)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@1| () Bool)
(declare-fun $t16 () Bool)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t4@1| () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@0| () Bool)
(declare-fun $abort_flag@0 () Bool)
(declare-fun $abort_code@1 () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1| () Bool)
(declare-fun $abort_code@2 () Int)
(declare-fun $abort_flag@1 () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$t3@1| () Int)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$ret0@0| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$t2@0| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$t3@0| () Int)
(declare-fun |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| () Bool)
(declare-fun |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| () Int)
(declare-fun |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t2@0| () Bool)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_should_track_limits_for_account$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2600501) (let ((|inline$$1_VASP_has_account_limits'#0'$1$anon6_Then_correct| true))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon11_Then_correct| true))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon6_Then_correct| true))
(let ((L21_correct  (=> (= (ControlFlow 0 1911712) (- 0 2602070)) false)))
(let ((anon23_Then_correct  (=> $abort_flag@5 (=> (and (= $abort_code@6 $abort_code@6) (= (ControlFlow 0 1912805) 1911712)) L21_correct))))
(let ((anon26_Then_correct  (=> $abort_flag@2 (=> (and (= $abort_code@3 $abort_code@3) (= (ControlFlow 0 1911702) 1911712)) L21_correct))))
(let ((L11_correct  (=> (= $t7@0 $t7@0) (and (=> (= (ControlFlow 0 1911588) (- 0 2602234)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 1911588) (- 0 2602241)) (= $t7@0 (ite _$t2  (and (and (ite  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))))))  (and (and (ite  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))))))))) (=> (= $t7@0 (ite _$t2  (and (and (ite  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))))))  (and (and (ite  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))) (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))))))))) (and (=> (= (ControlFlow 0 1911588) (- 0 2602258)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.95525:15|
 :skolemid |3445|
 ...
 :qid |DiemAccountbpl.95525:15|
 :skolemid |3445|
)) (=> (= (ControlFlow 0 1911588) (- 0 2602294)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.95530:15|
 :skolemid |3446|
))))))))))))
(let ((L10_correct  (=> (= $t4@0 $t4@0) (=> (and (= $t7@0 $t4@0) (= (ControlFlow 0 1912691) 1911588)) L11_correct))))
(let ((anon25_Then$1_correct  (=> (= inline$$Not$1$dst@1 inline$$Not$1$dst@1) (=> (and (= $t4@0 inline$$Not$1$dst@1) (= (ControlFlow 0 1912761) 1912691)) L10_correct))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not $t12)) (= (ControlFlow 0 1912743) 1912761)) anon25_Then$1_correct)))
(let ((anon25_Then_correct  (=> $t3@0 (=> (and (= $t12  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))))) (= (ControlFlow 0 1912749) 1912743)) inline$$Not$1$anon0_correct))))
(let ((anon25_Else_correct  (=> (and (and (not $t3@0) (= false false)) (and (= $t4@0 false) (= (ControlFlow 0 1912679) 1912691))) L10_correct)))
(let ((anon24_Else_correct  (=> (not |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@1|) (=> (and (= false false) (= $t3@0 false)) (and (=> (= (ControlFlow 0 1912657) 1912749) anon25_Then_correct) (=> (= (ControlFlow 0 1912657) 1912679) anon25_Else_correct))))))
(let ((anon24_Then_correct  (=> (and (and |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@1| (= $t10  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (and (= $t10 $t10) (= $t3@0 $t10))) (and (=> (= (ControlFlow 0 1912791) 1912749) anon25_Then_correct) (=> (= (ControlFlow 0 1912791) 1912679) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (not $abort_flag@5) (and (=> (= (ControlFlow 0 1912637) 1912791) anon24_Then_correct) (=> (= (ControlFlow 0 1912637) 1912657) anon24_Else_correct)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$L5_correct|  (=> (= $abort_code@6 |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t4@1|) (=> (and (= $abort_flag@5 true) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@0|)) (and (=> (= (ControlFlow 0 1912131) 1912805) anon23_Then_correct) (=> (= (ControlFlow 0 1912131) 1912637) anon23_Else_correct))))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Then_correct|  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t4@1| $abort_code@4) (= (ControlFlow 0 1912623) 1912131))) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$L5_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$L3_correct|  (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1|) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$ret0@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 1912111) 1912805) anon23_Then_correct) (=> (= (ControlFlow 0 1912111) 1912637) anon23_Else_correct)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Else_correct|  (=> (and (not $abort_flag@3) (= |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1|)) (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1| |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1|) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= (ControlFlow 0 1912609) 1912111))) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$L3_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$1$L2_correct|  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 |inline$$1_VASP_has_account_limits'#0'$1$$t3@1|) (= |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$1$$ret0@0|)) (and (=> (= (ControlFlow 0 1912547) 1912623) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Then_correct|) (=> (= (ControlFlow 0 1912547) 1912609) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$1$anon5_Then_correct|  (=> |inline$$1_VASP_has_account_limits'#0'$1$$t2@0| (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (= 7 |inline$$1_VASP_has_account_limits'#0'$1$$t3@0|)) (= |inline$$1_VASP_has_account_limits'#0'$1$$t3@0| |inline$$1_VASP_has_account_limits'#0'$1$$t3@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$1$$t3@1| |inline$$1_VASP_has_account_limits'#0'$1$$t3@0|) (= (ControlFlow 0 1912585) 1912547))) |inline$$1_VASP_has_account_limits'#0'$1$L2_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$1$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1|) (= $abort_flag@3 false)) (and (= $abort_code@4 $abort_code@0) (= |inline$$1_VASP_has_account_limits'#0'$1$$ret0@1| |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1|))) (and (=> (= (ControlFlow 0 1912527) 1912623) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Then_correct|) (=> (= (ControlFlow 0 1912527) 1912609) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon10_Else_correct|))))))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$3$anon0_correct|  (=> (= |inline$$1_VASP_has_account_limits'#0'$1$$t1@0| |inline$$1_VASP_has_account_limits'#0'$1$$t1@0|) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) |inline$$1_VASP_has_account_limits'#0'$1$$t1@0|)) (= |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$3$$t1@1|)) (and (=> (= (ControlFlow 0 1912503) 1912541) |inline$$1_VASP_has_account_limits'#0'$1$anon6_Then_correct|) (=> (= (ControlFlow 0 1912503) 1912527) |inline$$1_VASP_has_account_limits'#0'$1$anon6_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$1$anon5_Else_correct|  (=> (and (and (not |inline$$1_VASP_has_account_limits'#0'$1$$t2@0|) (|$IsValid'address'| |inline$$1_VASP_has_account_limits'#0'$1$$t1@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$1$$t1@0| (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (= (ControlFlow 0 1912509) 1912503))) |inline$$1_AccountLimits_has_window_published'#0'$3$anon0_correct|)))
(let ((|inline$$1_VASP_has_account_limits'#0'$1$anon0_correct|  (=> (and (= _$t0 _$t0) (= |inline$$1_VASP_has_account_limits'#0'$1$$t2@0|  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))))) (and (=> (= (ControlFlow 0 1912384) 1912585) |inline$$1_VASP_has_account_limits'#0'$1$anon5_Then_correct|) (=> (= (ControlFlow 0 1912384) 1912509) |inline$$1_VASP_has_account_limits'#0'$1$anon5_Else_correct|)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon9_Then_correct|  (=> (and |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t2@0| (= (ControlFlow 0 1912591) 1912384)) |inline$$1_VASP_has_account_limits'#0'$1$anon0_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon11_Else_correct|  (=> (and (not false) (= |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1|)) (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1|) (= $abort_code@5 $abort_code@0)) (and (= $abort_flag@4 false) (= (ControlFlow 0 1912099) 1912111))) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$L3_correct|))))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$2$anon0_correct|  (=> (= _$t0 _$t0) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t0)) (= |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$2$$t1@1|)) (and (=> (= (ControlFlow 0 1912075) 1912125) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon11_Then_correct|) (=> (= (ControlFlow 0 1912075) 1912099) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon11_Else_correct|))))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon9_Else_correct|  (=> (and (not |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t2@0|) (= (ControlFlow 0 1912081) 1912075)) |inline$$1_AccountLimits_has_window_published'#0'$2$anon0_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon0_correct|  (=> (and (= _$t0 _$t0) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$1$$t2@0|  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))) (and (=> (= (ControlFlow 0 1911972) 1912591) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon9_Then_correct|) (=> (= (ControlFlow 0 1911972) 1912081) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon9_Else_correct|)))))
(let ((anon22_Then_correct  (=> (and _$t2 (= (ControlFlow 0 1912629) 1911972)) |inline$$1_DiemAccount_has_published_account_limits'#0'$1$anon0_correct|)))
(let ((L19_correct  (=> (= $t6@0 $t6@0) (=> (and (= $t7@0 $t6@0) (= (ControlFlow 0 1911472) 1911588)) L11_correct))))
(let ((anon28_Then$1_correct  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (=> (and (= $t6@0 inline$$Not$0$dst@1) (= (ControlFlow 0 1911658) 1911472)) L19_correct))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t18)) (= (ControlFlow 0 1911640) 1911658)) anon28_Then$1_correct)))
(let ((anon28_Then_correct  (=> $t5@0 (=> (and (= $t18  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t0) _$t0 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t0)))))) (= (ControlFlow 0 1911646) 1911640)) inline$$Not$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (and (and (not $t5@0) (= false false)) (and (= $t6@0 false) (= (ControlFlow 0 1911460) 1911472))) L19_correct)))
(let ((anon27_Else_correct  (=> (not |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@1|) (=> (and (= false false) (= $t5@0 false)) (and (=> (= (ControlFlow 0 1911438) 1911646) anon28_Then_correct) (=> (= (ControlFlow 0 1911438) 1911460) anon28_Else_correct))))))
(let ((anon27_Then_correct  (=> (and (and |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@1| (= $t16  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))) (and (= $t16 $t16) (= $t5@0 $t16))) (and (=> (= (ControlFlow 0 1911688) 1911646) anon28_Then_correct) (=> (= (ControlFlow 0 1911688) 1911460) anon28_Else_correct)))))
(let ((anon26_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 1911418) 1911688) anon27_Then_correct) (=> (= (ControlFlow 0 1911418) 1911438) anon27_Else_correct)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$L5_correct|  (=> (= $abort_code@3 |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t4@1|) (=> (and (= $abort_flag@2 true) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 1910912) 1911702) anon26_Then_correct) (=> (= (ControlFlow 0 1910912) 1911418) anon26_Else_correct))))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t4@1| $abort_code@1) (= (ControlFlow 0 1911404) 1910912))) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$L5_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$L3_correct|  (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1|) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$ret0@1| |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1910892) 1911702) anon26_Then_correct) (=> (= (ControlFlow 0 1910892) 1911418) anon26_Else_correct)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Else_correct|  (=> (and (not $abort_flag@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|)) (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1|) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= (ControlFlow 0 1911390) 1910892))) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$L3_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$L2_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 |inline$$1_VASP_has_account_limits'#0'$0$$t3@1|) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_VASP_has_account_limits'#0'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 1911328) 1911404) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 1911328) 1911390) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|  (=> |inline$$1_VASP_has_account_limits'#0'$0$$t2@0| (=> (and (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))) (= 7 |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@0| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t3@1| |inline$$1_VASP_has_account_limits'#0'$0$$t3@0|) (= (ControlFlow 0 1911366) 1911328))) |inline$$1_VASP_has_account_limits'#0'$0$L2_correct|))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|  (=> (not false) (=> (and (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_VASP_has_account_limits'#0'$0$$ret0@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 1911308) 1911404) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 1911308) 1911390) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon10_Else_correct|))))))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|  (=> (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (= |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$1$$t1@1|)) (and (=> (= (ControlFlow 0 1911284) 1911322) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 1911284) 1911308) |inline$$1_VASP_has_account_limits'#0'$0$anon6_Else_correct|))))))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|  (=> (and (and (not |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|) (|$IsValid'address'| |inline$$1_VASP_has_account_limits'#0'$0$$t1@0|)) (and (= |inline$$1_VASP_has_account_limits'#0'$0$$t1@0| (ite (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))) (= (ControlFlow 0 1911290) 1911284))) |inline$$1_AccountLimits_has_window_published'#0'$1$anon0_correct|)))
(let ((|inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|  (=> (and (= _$t1 _$t1) (= |inline$$1_VASP_has_account_limits'#0'$0$$t2@0|  (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1))))) (and (=> (= (ControlFlow 0 1911165) 1911366) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Then_correct|) (=> (= (ControlFlow 0 1911165) 1911290) |inline$$1_VASP_has_account_limits'#0'$0$anon5_Else_correct|)))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon9_Then_correct|  (=> (and |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t2@0| (= (ControlFlow 0 1911372) 1911165)) |inline$$1_VASP_has_account_limits'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon11_Else_correct|  (=> (and (not false) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (=> (and (and (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|) (= $abort_code@2 $abort_code@0)) (and (= $abort_flag@1 false) (= (ControlFlow 0 1910880) 1910892))) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$L3_correct|))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon11_Then_correct| true))
(let ((|inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|  (=> (= _$t1 _$t1) (=> (and (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) _$t1)) (= |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1| |inline$$1_AccountLimits_has_window_published'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1910856) 1910906) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 1910856) 1910880) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon11_Else_correct|))))))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon9_Else_correct|  (=> (and (not |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t2@0|) (= (ControlFlow 0 1910862) 1910856)) |inline$$1_AccountLimits_has_window_published'#0'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon0_correct|  (=> (and (= _$t1 _$t1) (= |inline$$1_DiemAccount_has_published_account_limits'#0'$0$$t2@0|  (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) _$t1)))) (and (=> (= (ControlFlow 0 1910753) 1911372) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 1910753) 1910862) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon9_Else_correct|)))))
(let ((anon22_Else_correct  (=> (and (not _$t2) (= (ControlFlow 0 1911410) 1910753)) |inline$$1_DiemAccount_has_published_account_limits'#0'$0$anon0_correct|)))
(let ((anon0$1_correct  (=> (and (forall ((window_addr Int) ) (!  (=> (|$IsValid'address'| window_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) window_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_526401| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) window_addr)))))
 :qid |DiemAccountbpl.95187:20|
 :skolemid |3436|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) addr@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@2)) 6)))))
 :qid |DiemAccountbpl.95191:20|
 :skolemid |3437|
))) (=> (and (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |DiemAccountbpl.95195:20|
 :skolemid |3438|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) addr@@3)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@3)) 5))))
 :qid |DiemAccountbpl.95199:20|
 :skolemid |3439|
))) (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@4)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_472013| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_472013| $1_Roles_RoleId_$memory) addr@@4)) 6))))
 :qid |DiemAccountbpl.95203:20|
 :skolemid |3440|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_600227| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@5) (or (|Select__T@[Int]Bool_| (|domain#$Memory_487799| $1_VASP_ParentVASP_$memory) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_487899| $1_VASP_ChildVASP_$memory) addr@@5))))
 :qid |DiemAccountbpl.95207:20|
 :skolemid |3441|
)))) (=> (and (and (and (|$IsValid'address'| _$t0) (|$IsValid'address'| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) $a_0)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc))
 :qid |DiemAccountbpl.95220:20|
 :skolemid |3442|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_525479| |$1_AccountLimits_Window'#0'_$memory|) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc@@0))
 :qid |DiemAccountbpl.95224:20|
 :skolemid |3443|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_487899| $1_VASP_ChildVASP_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_487799| $1_VASP_ParentVASP_$memory) $a_0@@1)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@1))
 :qid |DiemAccountbpl.95228:20|
 :skolemid |3444|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_487799| $1_VASP_ParentVASP_$memory) $a_0@@1))
)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2)))) (and (=> (= (ControlFlow 0 1910491) 1912629) anon22_Then_correct) (=> (= (ControlFlow 0 1910491) 1911410) anon22_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1910191) 1910491)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2600501) 1910191) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
