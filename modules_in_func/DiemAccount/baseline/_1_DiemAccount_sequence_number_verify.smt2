...
(declare-fun inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1 () Int)
...
(declare-fun $t7@1 () T@$1_DiemAccount_DiemAccount)
(declare-fun $t7 () T@$1_DiemAccount_DiemAccount)
(declare-fun $abort_code@1 () Int)
(declare-fun _$t0 () Int)
(declare-fun $t7@0 () T@$1_DiemAccount_DiemAccount)
...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_sequence_number$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2599524) (let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1 inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1)) (and (=> (= (ControlFlow 0 1909698) (- 0 2600117)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (not (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))) 0))))))
 :qid |DiemAccountbpl.95031:15|
 :skolemid |3430|
 ...
 :qid |DiemAccountbpl.95036:15|
 :skolemid |3431|
)) (=> (= (ControlFlow 0 1909698) (- 0 2600217)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@3)))))
 :qid |DiemAccountbpl.95041:15|
 :skolemid |3432|
))))))))))
(let ((anon18_Then_correct true))
(let ((inline$$1_DiemAccount_sequence_number_for_account$0$anon0_correct  (=> (= $t7@1 $t7@1) (=> (and (= inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1 (|$sequence_number#$1_DiemAccount_DiemAccount| $t7@1)) (= inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1 inline$$1_DiemAccount_sequence_number_for_account$0$$t1@1)) (and (=> (= (ControlFlow 0 1909535) 1909712) anon18_Then_correct) (=> (= (ControlFlow 0 1909535) 1909698) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1909541) 1909535)) inline$$1_DiemAccount_sequence_number_for_account$0$anon0_correct)))
(let ((anon17_Then_correct true))
(let ((anon16_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1909778) 1909726) anon17_Then_correct) (=> (= (ControlFlow 0 1909778) 1909541) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) _$t0)) (= (ControlFlow 0 1909776) 1909778)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1909434) 1909726) anon17_Then_correct) (=> (= (ControlFlow 0 1909434) 1909541) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (and (=> (= (ControlFlow 0 1909420) 1909776) anon16_Then_correct) (=> (= (ControlFlow 0 1909420) 1909434) anon16_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon14_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 1909394) 1909420) anon15_Then_correct) (=> (= (ControlFlow 0 1909394) 1909410) anon15_Else_correct))))))
(let ((anon14_Then_correct true))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) _$t0)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 1909352) 1909792) anon14_Then_correct) (=> (= (ControlFlow 0 1909352) 1909394) anon14_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4) (or (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0) (and (not (= (|l#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0)) (= addr@@4 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_421850| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@4)))) 0)))))))
 ...
 :qid |DiemAccountbpl.94934:20|
 :skolemid |3428|
)))) (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0)))
 ...
 :qid |DiemAccountbpl.94940:20|
 :skolemid |3429|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) $a_0))
))) (and (= _$t0 _$t0) (= (ControlFlow 0 1909358) 1909352)))) inline$$1_DiemAccount_exists_at$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1908984) 1909358)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2599524) 1908984) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
