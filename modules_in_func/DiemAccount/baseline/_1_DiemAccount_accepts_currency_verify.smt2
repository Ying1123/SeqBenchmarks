...
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_accepts_currency$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2193146) (let ((anon0$1_correct  (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))
 :qid |DiemAccountbpl.48004:20|
 :skolemid |1436|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc))
 :qid |DiemAccountbpl.48010:20|
 :skolemid |1437|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 1276852) (- 0 2193269)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@0)))))
 :qid |DiemAccountbpl.48036:15|
 :skolemid |1438|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@1)))))
 :qid |DiemAccountbpl.48036:15|
 :skolemid |1438|
)) (=> (= (ControlFlow 0 1276852) (- 0 2193305)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2))))))
 :qid |DiemAccountbpl.48041:15|
 :skolemid |1439|
)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1276683) 1276852)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2193146) 1276683) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
