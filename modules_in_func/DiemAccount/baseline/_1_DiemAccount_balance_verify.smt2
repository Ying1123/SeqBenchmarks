...
(declare-fun $t7@1 () |T@$1_DiemAccount_Balance'#0'|)
(declare-fun $t7 () |T@$1_DiemAccount_Balance'#0'|)
(declare-fun $t7@0 () |T@$1_DiemAccount_Balance'#0'|)
(declare-fun $abort_code@0 () Int)
(declare-fun $t3@0 () Bool)
(declare-fun $t5 () Int)
(declare-fun $es () T@$EventStore)
(push 1)
(set-info :boogie-vc-id $1_DiemAccount_balance$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 2161316) (let ((anon15_Else_correct  (=> (and (not $abort_flag@1) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1|)) (and (=> (= (ControlFlow 0 1236890) (- 0 2161801)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 1236890) (- 0 2161812)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemAccountbpl.42117:15|
 :skolemid |1156|
 ...
 :qid |DiemAccountbpl.42117:15|
 :skolemid |1156|
)) (=> (= (ControlFlow 0 1236890) (- 0 2161848)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1) (>= (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))) (|$value#$1_Diem_Diem'#0'| (|$coin#$1_DiemAccount_Balance'#0'| (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@1))))))
 :qid |DiemAccountbpl.42122:15|
 :skolemid |1157|
))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 1236469) (- 0 2161763)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (=> (= (ControlFlow 0 1236469) (- 0 2161769)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= 5 $t6@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1236904) 1236469))) L3_correct)))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|  (=> (and (and (not $abort_flag@0) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_Diem_value'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 1236758) 1236904) anon15_Then_correct) (=> (= (ControlFlow 0 1236758) 1236890) anon15_Else_correct)))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@1| |inline$$1_DiemAccount_balance_for'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 1236776) 1236904) anon15_Then_correct) (=> (= (ControlFlow 0 1236776) 1236890) anon15_Else_correct)))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1|)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 1236734) 1236776) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 1236734) 1236758) |inline$$1_DiemAccount_balance_for'#0'$0$anon3_Else_correct|))))))
(let ((|inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|  (=> (= $t7@1 $t7@1) (=> (and (= |inline$$1_DiemAccount_balance_for'#0'$0$$t1@1| (|$coin#$1_DiemAccount_Balance'#0'| $t7@1)) (= (ControlFlow 0 1236740) 1236734)) |inline$$1_Diem_value'#0'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 1236782) 1236740)) |inline$$1_DiemAccount_balance_for'#0'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 1236918) 1236469))) L3_correct)))
(let ((anon13_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1236970) 1236918) anon14_Then_correct) (=> (= (ControlFlow 0 1236970) 1236782) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 1236968) 1236970)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 1236487) 1236918) anon14_Then_correct) (=> (= (ControlFlow 0 1236487) 1236782) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 1236473) 1236968) anon13_Then_correct) (=> (= (ControlFlow 0 1236473) 1236487) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 1236437) 1236469))) L3_correct)))
(let ((anon0$1_correct  (=> (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_487225| $1_DiemAccount_DiemAccount_$memory) addr@@2)))
 :qid |DiemAccountbpl.42018:20|
 :skolemid |1154|
)) (|$IsValid'address'| _$t0)) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$1_DiemAccount_Balance'#0''| $rsc))
 :qid |DiemAccountbpl.42024:20|
 :skolemid |1155|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'#0'_| (|contents#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_588258| |$1_DiemAccount_Balance'#0'_$memory|) _$t0)) (|$IsValid'u64'| 19))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 1236421) 1236473) anon12_Then_correct) (=> (= (ControlFlow 0 1236421) 1236437) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_421725_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemAccountbpl.3705:13|
 :skolemid |136|
))) (= (ControlFlow 0 1236312) 1236421)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 2161316) 1236312) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))
))
(check-sat)
(pop 1)
