...
(assert (not
 (=> (= (ControlFlow 0 0) 2041706) (let ((anon29_Else_correct  (=> (and (not $abort_flag@0@@2) (= |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0| (|v#$Mutation_474524| $t25@1))) (=> (and (and (and (= |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0| |$temp_0'$1_ValidatorConfig_ValidatorConfig'@0|) (= $t26@0 ($1_ValidatorConfig_Config _$t2@@0 _$t3 _$t4))) (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| $t27) (<= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t27)) 1))) (and (and (= $t27 (|$1_Option_Option'$1_ValidatorConfig_Config'| (seq.unit $t26@0))) (= $t28@0 ($Mutation_478024 (|l#$Mutation_474524| $t25@1) (seq.++ (|p#$Mutation_474524| $t25@1) (seq.unit 0)) (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@1))))) (and (= $t28@1 ($Mutation_478024 (|l#$Mutation_478024| $t28@0) (|p#$Mutation_478024| $t28@0) $t27)) (= $t25@2 ($Mutation_474524 (|l#$Mutation_474524| $t25@1) (|p#$Mutation_474524| $t25@1) ($1_ValidatorConfig_ValidatorConfig (|v#$Mutation_478024| $t28@1) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@1)))))))) (and (=> (= (ControlFlow 0 1096889) (- 0 2042710)) (<= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@2)))) 1)) (=> (<= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@2)))) 1) (and (=> (= (ControlFlow 0 1096889) (- 0 2042723)) (<= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@2)))) 1)) (=> (<= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_474524| $t25@2)))) 1) (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@0@@0 ($Memory_465642 (|Store__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_474524| $t25@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_474524| $t25@2)) (|v#$Mutation_474524| $t25@2)))) (and (=> (= (ControlFlow 0 1096889) (- 0 2042767)) (forall ((a@@11 Int) ) (!  (=> (|$IsValid'address'| a@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) a@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) a@@11)) (=> (not (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) a@@11)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) a@@11)))) (and ($1_Signer_is_txn_signer_addr a@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) a@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) a@@11)) 3))))))
 :qid |DiemAccountbpl.9196:15|
 :skolemid |228|
))) (=> (forall ((a@@12 Int) ) (!  (=> (|$IsValid'address'| a@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) a@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) a@@12)) (=> (not (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) a@@12)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) a@@12)))) (and ($1_Signer_is_txn_signer_addr a@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) a@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) a@@12)) 3))))))
 :qid |DiemAccountbpl.9196:15|
 :skolemid |228|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042825)) (forall ((validator@@1 Int) ) (!  (=> (|$IsValid'address'| validator@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@1)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) validator@@1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) validator@@1)))) 0)))))
 :qid |DiemAccountbpl.9202:15|
 :skolemid |229|
))) (=> (forall ((validator@@2 Int) ) (!  (=> (|$IsValid'address'| validator@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@2)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) validator@@2) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) validator@@2)))) 0)))))
 :qid |DiemAccountbpl.9202:15|
 :skolemid |229|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042849)) (forall ((addr@@98 Int) ) (!  (=> (|$IsValid'address'| addr@@98) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@98) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@98) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@98)) 3))))
 :qid |DiemAccountbpl.9208:15|
 :skolemid |230|
))) (=> (forall ((addr@@99 Int) ) (!  (=> (|$IsValid'address'| addr@@99) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@99) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@99) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@99)) 3))))
 :qid |DiemAccountbpl.9208:15|
 :skolemid |230|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042874)) (forall ((addr@@100 Int) ) (!  (=> (|$IsValid'address'| addr@@100) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@100) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@100) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@100)) 3))))
 :qid |DiemAccountbpl.9214:15|
 :skolemid |231|
))) (=> (forall ((addr@@101 Int) ) (!  (=> (|$IsValid'address'| addr@@101) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@101) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@101) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@101)) 3))))
 :qid |DiemAccountbpl.9214:15|
 :skolemid |231|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042899)) (forall ((addr@@102 Int) ) (!  (=> (|$IsValid'address'| addr@@102) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@102) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@102)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@102) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@102)) 3))))
 :qid |DiemAccountbpl.9220:15|
 :skolemid |232|
))) (=> (forall ((addr@@103 Int) ) (!  (=> (|$IsValid'address'| addr@@103) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@103) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@103)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@103) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@103)) 3))))
 :qid |DiemAccountbpl.9220:15|
 :skolemid |232|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2042924)) (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@104 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@104))))) (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@105 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@105))))))) (forall ((addr@@106 Int) ) (!  (=> (|$IsValid'address'| addr@@106) (=> (let (($range_0@@2 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@107 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@107))))))))
(exists (($i_1@@2 Int) ) (!  (and ($InRange $range_0@@2 $i_1@@2) (let ((i@@65 $i_1@@2))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@108 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@108)))) i@@65)) addr@@106) (not (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@109 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@109)))) i@@65)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@110 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@110)))) i@@65)))))))
 :qid |DiemAccountbpl.9226:823|
 :skolemid |233|
))) (exists ((a@@13 Int) ) (!  (and (|$IsValid'address'| a@@13) (and ($1_Signer_is_txn_signer_addr a@@13) (= (let ((t_ref@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@106)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@1)) 0)) a@@13)))
 :qid |DiemAccountbpl.9227:674|
 :skolemid |234|
))))
 :qid |DiemAccountbpl.9226:592|
 :skolemid |235|
)))) (=> (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@111 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@111))))) (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@112 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@112))))))) (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (let (($range_0@@3 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@114 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@114))))))))
(exists (($i_1@@3 Int) ) (!  (and ($InRange $range_0@@3 $i_1@@3) (let ((i@@66 $i_1@@3))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@115 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@115)))) i@@66)) addr@@113) (not (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@116 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@116)))) i@@66)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@117 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_460870| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@117)))) i@@66)))))))
 :qid |DiemAccountbpl.9226:823|
 :skolemid |233|
))) (exists ((a@@14 Int) ) (!  (and (|$IsValid'address'| a@@14) (and ($1_Signer_is_txn_signer_addr a@@14) (= (let ((t_ref@@2 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@113)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@2)) 0)) a@@14)))
 :qid |DiemAccountbpl.9227:674|
 :skolemid |234|
))))
 :qid |DiemAccountbpl.9226:592|
 :skolemid |235|
))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043065)) (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@118)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@118)) 3))))
 :qid |DiemAccountbpl.9233:15|
 :skolemid |236|
))) (=> (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) addr@@119)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@119)) 3))))
 :qid |DiemAccountbpl.9233:15|
 :skolemid |236|
)) (and (=> (= (ControlFlow 0 1096889) (- 0 2043093)) (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@3 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@3)) 0)))))) (=> (not (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@4 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@4)) 0))))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043109)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@0)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t2@@0))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043119)) (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0))))) (=> (not (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0)))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043130)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1))) (and (=> (= (ControlFlow 0 1096889) (- 0 2043141)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) _$t1@@1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) _$t1@@1)))) 0)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) _$t1@@1) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) _$t1@@1)))) 0))) (=> (= (ControlFlow 0 1096889) (- 0 2043148)) (= (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory@0@@0) _$t1@@1) ($1_ValidatorConfig_ValidatorConfig (|$1_Option_Option'$1_ValidatorConfig_Config'| (seq.unit ($1_ValidatorConfig_Config _$t2@@0 _$t3 _$t4))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1))))))))))))))))))))))))))))))))))))))
(let ((anon26_Then_correct@@0 true))
(let ((anon24_Then_correct@@0 true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 1096047) (- 0 2042508)) (or (or (or (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@5 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@5)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@0))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) (=> (or (or (or (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@6 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@6)) 0)))) (not ($1_Signature_$ed25519_validate_pubkey _$t2@@0))) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1))) (=> (= (ControlFlow 0 1096047) (- 0 2042542)) (or (or (or (and (not (= (|$addr#$signer| _$t0@@2) (let ((t_ref@@7 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@7)) 0)))) (= 7 $t15@0@@1)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t2@@0)) (= 7 $t15@0@@1))) (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0))) (= 7 $t15@0@@1))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)) (= 5 $t15@0@@1))))))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t15@0@@1 $abort_code@1@@2) (= (ControlFlow 0 1096903) 1096047))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t25@1 $t25@@0) (=> (and (= $abort_flag@0@@2 true) (= $abort_code@1@@2 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 1096955) 1096903) anon29_Then_correct) (=> (= (ControlFlow 0 1096955) 1096889) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)) (= (ControlFlow 0 1096953) 1096955)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1) (=> (and (and (= $t25@0 ($Mutation_474524 ($Global _$t1@@1) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1))) (= $t25@1 $t25@0)) (and (= $abort_flag@0@@2 false) (= $abort_code@1@@2 $abort_code@0@@2))) (and (=> (= (ControlFlow 0 1096334) 1096903) anon29_Then_correct) (=> (= (ControlFlow 0 1096334) 1096889) anon29_Else_correct))))))
(let ((anon27_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 (and (=> (= (ControlFlow 0 1096312) (- 0 2042380)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@1)) (=> (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@1) (and (=> (= (ControlFlow 0 1096312) 1096953) anon28_Then_correct) (=> (= (ControlFlow 0 1096312) 1096334) anon28_Else_correct)))))))
(let ((anon27_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0) (= $t24@@0 $t24@@0)) (and (= $t15@0@@1 $t24@@0) (= (ControlFlow 0 1096302) 1096047))) L7_correct)))
(let ((anon26_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t24@@0) (= $t24@@0 5)) (and (= $t24@@0 $t24@@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 1096286) 1096312) anon27_Then_correct) (=> (= (ControlFlow 0 1096286) 1096302) anon27_Else_correct))))))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@0  (=> (= _$t1@@1 _$t1@@1) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0 inline$$1_ValidatorConfig_exists_config$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 1096244) 1096969) anon26_Then_correct@@0) (=> (= (ControlFlow 0 1096244) 1096286) anon26_Else_correct@@0))))))
(let ((anon25_Then_correct@@0  (=> (and inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (= (ControlFlow 0 1096250) 1096244)) inline$$1_ValidatorConfig_exists_config$0$anon0_correct@@0)))
(let ((anon25_Else_correct@@0  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t21 $t21)) (and (= $t15@0@@1 $t21) (= (ControlFlow 0 1096143) 1096047))) L7_correct)))
(let ((anon24_Else_correct@@0  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t21) (= $t21 7)) (and (= $t21 $t21) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 1096127) 1096250) anon25_Then_correct@@0) (=> (= (ControlFlow 0 1096127) 1096143) anon25_Else_correct@@0))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t2@@0)) (and (=> (= (ControlFlow 0 1096081) 1096983) anon24_Then_correct@@0) (=> (= (ControlFlow 0 1096081) 1096127) anon24_Else_correct@@0)))))
(let ((anon23_Then_correct@@0  (=> (and $t16@0 (= (ControlFlow 0 1096087) 1096081)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon23_Else_correct@@0  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t15@0@@1 $t18) (= (ControlFlow 0 1095923) 1096047))) L7_correct)))
(let ((anon22_Else_correct@@0  (=> (not $t14@@1) (=> (and (and (and (|$IsValid'address'| $t13@@0) (= $t13@@0 (let ((t_ref@@8 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@8)) 0)))) (and (= $t16@0 (= $t12@@1 $t13@@0)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t18) (= $t18 7)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 1095907) 1096087) anon23_Then_correct@@0) (=> (= (ControlFlow 0 1095907) 1095923) anon23_Else_correct@@0))))))
(let ((anon22_Then_correct@@0  (=> $t14@@1 (=> (and (and (or (and (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0))) (= 7 $t15@@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)) (= 5 $t15@@0))) (= $t15@@0 $t15@@0)) (and (= $t15@0@@1 $t15@@0) (= (ControlFlow 0 1097029) 1096047))) L7_correct))))
(let ((anon0$1_correct@@2  (=> (and (and (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@120) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@120)) 3))))
 :qid |DiemAccountbpl.8880:20|
 :skolemid |223|
)) (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@121) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@121)) 3))))
 :qid |DiemAccountbpl.8884:20|
 :skolemid |224|
))) (and (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@122)) 3))))
 :qid |DiemAccountbpl.8888:20|
 :skolemid |225|
)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (= (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@123)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_460504| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_460504| $1_Roles_RoleId_$memory) addr@@123)) 3))))
 :qid |DiemAccountbpl.8892:20|
 :skolemid |226|
)))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (and (|$IsValid'address'| _$t1@@1) (|$IsValid'vec'u8''| _$t2@@0))) (and (and (|$IsValid'vec'u8''| _$t3) (|$IsValid'vec'u8''| _$t4)) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@3)))
 ...
 :qid |DiemAccountbpl.8910:20|
 :skolemid |227|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@3))
)) (|Select__T@[Int]Bool_| $1_ValidatorConfig_ValidatorConfig_$modifies _$t1@@1)))) (and (and (and (= _$t0@@2 _$t0@@2) (= _$t1@@1 _$t1@@1)) (and (= _$t2@@0 _$t2@@0) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (|$IsValid'address'| $t12@@1)) (and (= $t12@@1 (|$addr#$signer| _$t0@@2)) (= $t14@@1  (or (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_465642| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1@@1)))))))) (and (=> (= (ControlFlow 0 1095849) 1097029) anon22_Then_correct@@0) (=> (= (ControlFlow 0 1095849) 1095907) anon22_Else_correct@@0))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_419582_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_419582| stream@@3) 0) (forall ((v@@57 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_419582| stream@@3) v@@57) 0)
 :qid |DiemAccountbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemAccountbpl.3664:13|
 :skolemid |102|
))) (= (ControlFlow 0 1095581) 1095849)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (and (and (= (seq.len (|p#$Mutation_474524| $t11@@0)) 0) (= (seq.len (|p#$Mutation_474524| $t25@@0)) 0)) (and (= (seq.len (|p#$Mutation_478024| $t28)) 0) (= (ControlFlow 0 1095591) 1095581))) inline$$InitEventStore$0$anon0_correct@@2)))
(let ((PreconditionGeneratedEntry_correct@@1  (=> (= (ControlFlow 0 2041706) 1095591) anon0_correct@@2)))
