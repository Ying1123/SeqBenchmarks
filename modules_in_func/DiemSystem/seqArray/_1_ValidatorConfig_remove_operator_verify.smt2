...
(assert (not
 (=> (= (ControlFlow 0 0) 832817) (let ((anon18_Else_correct  (=> (and (and (not $abort_flag@0@@0) (= $t15@0@@0 ($Mutation_251312 (|l#$Mutation_251272| $t14@1@@0) (seq.++ (|p#$Mutation_251272| $t14@1@@0) (seq.unit 1)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@1@@0))))) (and (= $t15@1 ($Mutation_251312 (|l#$Mutation_251312| $t15@0@@0) (|p#$Mutation_251312| $t15@0@@0) $t13)) (= $t14@2@@0 ($Mutation_251272 (|l#$Mutation_251272| $t14@1@@0) (|p#$Mutation_251272| $t14@1@@0) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@1@@0)) (|v#$Mutation_251312| $t15@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@1@@0))))))) (and (=> (= (ControlFlow 0 502951) (- 0 834199)) (<= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@2@@0)))) 1)) (=> (<= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@2@@0)))) 1) (and (=> (= (ControlFlow 0 502951) (- 0 834212)) (<= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@2@@0)))) 1)) (=> (<= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_251272| $t14@2@@0)))) 1) (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_249821 (|Store__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_251272| $t14@2@@0)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_251272| $t14@2@@0)) (|v#$Mutation_251272| $t14@2@@0)))) (and (=> (= (ControlFlow 0 502951) (- 0 834256)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) a)) (=> (not (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) a)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) a)))) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) a)) 3))))))
 :qid |DiemSystembpl.7986:15|
 :skolemid |170|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) a@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) a@@0)) (=> (not (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) a@@0)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) a@@0)))) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) a@@0)) 3))))))
 :qid |DiemSystembpl.7986:15|
 :skolemid |170|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834314)) (forall ((validator Int) ) (!  (=> (|$IsValid'address'| validator) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) validator) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) validator)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) validator) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) validator)))) 0)))))
 :qid |DiemSystembpl.7992:15|
 :skolemid |171|
))) (=> (forall ((validator@@0 Int) ) (!  (=> (|$IsValid'address'| validator@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@0) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) validator@@0)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) validator@@0) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) validator@@0)))) 0)))))
 :qid |DiemSystembpl.7992:15|
 :skolemid |171|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834338)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@4)) 3))))
 :qid |DiemSystembpl.7998:15|
 :skolemid |172|
))) (=> (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@5)) 3))))
 :qid |DiemSystembpl.7998:15|
 :skolemid |172|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834363)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@6)) 3))))
 :qid |DiemSystembpl.8004:15|
 :skolemid |173|
))) (=> (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@7)) 3))))
 :qid |DiemSystembpl.8004:15|
 :skolemid |173|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834388)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@8) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@8)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@8)) 3))))
 :qid |DiemSystembpl.8010:15|
 :skolemid |174|
))) (=> (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@9) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@9)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@9)) 3))))
 :qid |DiemSystembpl.8010:15|
 :skolemid |174|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834413)) (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@10 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@10))))) (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))))) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (let (($range_0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))))))
(exists (($i_1 Int) ) (!  (and ($InRange $range_0 $i_1) (let ((i@@62 $i_1))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@14 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@14)))) i@@62)) addr@@12) (not (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@15 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15)))) i@@62)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@16 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@16)))) i@@62)))))))
 :qid |DiemSystembpl.8016:823|
 :skolemid |175|
))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (= (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@12)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref)) 0)) a@@1)))
 :qid |DiemSystembpl.8017:674|
 :skolemid |176|
))))
 :qid |DiemSystembpl.8016:592|
 :skolemid |177|
)))) (=> (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@17 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@17))))) (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@18 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@18))))))) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (let (($range_0@@0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@20 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@20))))))))
(exists (($i_1@@0 Int) ) (!  (and ($InRange $range_0@@0 $i_1@@0) (let ((i@@63 $i_1@@0))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@21 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@21)))) i@@63)) addr@@19) (not (= (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@22 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@22)))) i@@63)) (|$config#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@23 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@23)))) i@@63)))))))
 :qid |DiemSystembpl.8016:823|
 :skolemid |175|
))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (= (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@19)))
(seq.nth (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0)) 0)) a@@2)))
 ...
 :qid |DiemSystembpl.8016:592|
 :skolemid |177|
))) (and (=> (= (ControlFlow 0 502951) (- 0 834554)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@24)) 3))))
 :qid |DiemSystembpl.8023:15|
 :skolemid |178|
))) (=> (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@25)) 3))))
 :qid |DiemSystembpl.8023:15|
 :skolemid |178|
)) (and (=> (= (ControlFlow 0 502951) (- 0 834582)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 502951) (- 0 834594)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) 3))) (and (=> (= (ControlFlow 0 502951) (- 0 834612)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (and (=> (= (ControlFlow 0 502951) (- 0 834624)) (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0@@0))))) 0)))) (=> (not (not (= (seq.len (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0@@0))))) 0))) (=> (= (ControlFlow 0 502951) (- 0 834635)) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (=> (not (= addr@@26 $t4)) (= (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@26)) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@26)))))
 :qid |DiemSystembpl.8052:15|
 :skolemid |179|
)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 502387) (- 0 834061)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (=> (= (ControlFlow 0 502387) (- 0 834092)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5)) 3)) (= 3 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)) (= 5 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t8@0 $abort_code@1@@0) (= (ControlFlow 0 502965) 502387))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $t14@1@@0 $t14@@0) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 503017) 502965) anon18_Then_correct) (=> (= (ControlFlow 0 503017) 502951) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t9@@0)) (= (ControlFlow 0 503015) 503017)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t9@@0) (=> (and (and (= $t14@0@@0 ($Mutation_251272 ($Global $t9@@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t9@@0))) (= $t14@1@@0 $t14@0@@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 502435) 502965) anon18_Then_correct) (=> (= (ControlFlow 0 502435) 502951) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t13) (<= (seq.len (|$vec#$1_Option_Option'address'| $t13)) 1)) (= $t13 (|$1_Option_Option'address'| (as seq.empty (Seq Int))))) (and (=> (= (ControlFlow 0 502413) 503015) anon17_Then_correct) (=> (= (ControlFlow 0 502413) 502435) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t12@@0 $t12@@0)) (and (= $t8@0 $t12@@0) (= (ControlFlow 0 502287) 502387))) L3_correct)))
(let ((anon15_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t12@@0) (= $t12@@0 5)) (and (= $t12@@0 $t12@@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 502271) 502413) anon16_Then_correct) (=> (= (ControlFlow 0 502271) 502287) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7@@0 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t6)) 3)) (= 3 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 503083) 502387))) L3_correct))))
(let ((anon15_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t9@@0 $t9@@0) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $t9@@0)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 502229) 503031) anon15_Then_correct) (=> (= (ControlFlow 0 502229) 502271) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (not $t7@@0) (=> (and (and (|$IsValid'address'| $t9@@0) (= $t9@@0 (|$addr#$signer| _$t0@@0))) (and (= $t9@@0 $t9@@0) (= (ControlFlow 0 502235) 502229))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon0$1_correct@@0  (=> (and (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@27) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@27)) 0)) (= addr@@27 173345816)))
 :qid |DiemSystembpl.7691:20|
 :skolemid |142|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239008| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@28)) 1)) (= addr@@28 186537453)))
 :qid |DiemSystembpl.7699:20|
 :skolemid |143|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239008| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@29)) 2))))))
 :qid |DiemSystembpl.7707:20|
 :skolemid |144|
)) (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@30)) 2))))))
 :qid |DiemSystembpl.7711:20|
 :skolemid |145|
))) (and (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@31)) 2))))))
 :qid |DiemSystembpl.7715:20|
 :skolemid |146|
)) (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@32)) 2))))))
 :qid |DiemSystembpl.7719:20|
 :skolemid |147|
)))) (and (and (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@33)) 2)))))
 :qid |DiemSystembpl.7723:20|
 :skolemid |148|
)) (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@34)) 2)))))
 :qid |DiemSystembpl.7727:20|
 :skolemid |149|
))) (and (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@35)) 2)))))
 :qid |DiemSystembpl.7731:20|
 :skolemid |150|
)) (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_247969| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@36) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@36)) 4))))
 :qid |DiemSystembpl.7735:20|
 :skolemid |151|
))))) (=> (and (and (and (and (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@37) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@37)) 3))))
 :qid |DiemSystembpl.7739:20|
 :skolemid |152|
)) (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@38) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@38)) 3))))
 :qid |DiemSystembpl.7743:20|
 :skolemid |153|
))) (and (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@39) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@39)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@39)) 3))))
 :qid |DiemSystembpl.7747:20|
 :skolemid |154|
)) (let (($range_0@@1 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@40 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@40))))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i1 $i_1@@1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@41 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@41)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@41 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_240052| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@41)))) i1)))) 3))))
 :qid |DiemSystembpl.7751:151|
 :skolemid |155|
))))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252100| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DiemSystembpl.7756:20|
 :skolemid |156|
)) (forall ((addr@@42 Int) ) (!  (=> (|$IsValid'address'| addr@@42) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252213| $1_DiemAccount_DiemAccount_$memory) addr@@42) (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@42)))
 :qid |DiemSystembpl.7760:20|
 :skolemid |157|
))) (and (forall ((addr@@43 Int) ) (!  (=> (|$IsValid'address'| addr@@43) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252313| $1_VASPDomain_VASPDomainManager_$memory) addr@@43)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@43) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@43)) 1))))
 :qid |DiemSystembpl.7764:20|
 :skolemid |158|
)) (forall ((addr@@44 Int) ) (!  (=> (|$IsValid'address'| addr@@44) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252398| $1_VASPDomain_VASPDomains_$memory) addr@@44)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@44) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@44)) 5))))
 :qid |DiemSystembpl.7768:20|
 :skolemid |159|
))))) (and (and (and (forall ((addr@@45 Int) ) (!  (=> (|$IsValid'address'| addr@@45) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_252485| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@45) (|Select__T@[Int]Bool_| (|domain#$Memory_252545| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@45)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@45)) 2)))))
 :qid |DiemSystembpl.7772:20|
 :skolemid |160|
)) (forall ((addr@@46 Int) ) (!  (=> (|$IsValid'address'| addr@@46) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252630| $1_DesignatedDealer_Dealer_$memory) addr@@46)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@46) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@46)) 2))))
 :qid |DiemSystembpl.7776:20|
 :skolemid |161|
))) (and (forall ((addr@@47 Int) ) (!  (=> (|$IsValid'address'| addr@@47) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252100| $1_DualAttestation_Credential_$memory) addr@@47)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@47)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@47) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@47)) 5)))))
 :qid |DiemSystembpl.7780:20|
 :skolemid |162|
)) (forall ((addr@@48 Int) ) (!  (=> (|$IsValid'address'| addr@@48) (= (|Select__T@[Int]Bool_| (|domain#$Memory_239873| $1_SlidingNonce_SlidingNonce_$memory) addr@@48)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@48) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@48)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@48) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@48)) 1)))))
 :qid |DiemSystembpl.7784:20|
 :skolemid |163|
)))) (and (and (forall ((addr@@49 Int) ) (!  (=> (|$IsValid'address'| addr@@49) (= (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@49)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@49) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@49)) 3))))
 :qid |DiemSystembpl.7788:20|
 :skolemid |164|
)) (forall ((addr@@50 Int) ) (!  (=> (|$IsValid'address'| addr@@50) (= (|Select__T@[Int]Bool_| (|domain#$Memory_247969| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@50)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@50) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@50)) 4))))
 :qid |DiemSystembpl.7792:20|
 :skolemid |165|
))) (and (forall ((addr@@51 Int) ) (!  (=> (|$IsValid'address'| addr@@51) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252885| $1_VASP_ParentVASP_$memory) addr@@51)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@51) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@51)) 5))))
 :qid |DiemSystembpl.7796:20|
 :skolemid |166|
)) (forall ((addr@@52 Int) ) (!  (=> (|$IsValid'address'| addr@@52) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252985| $1_VASP_ChildVASP_$memory) addr@@52)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@52) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@52)) 6))))
 :qid |DiemSystembpl.7800:20|
 :skolemid |167|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) ($1_Signer_is_txn_signer _$t0@@0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@0))) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $a_0@@0)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemSystembpl.7806:20|
 :skolemid |168|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $a_0@@0))
))) (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 ...
 :qid |DiemSystembpl.7810:20|
 :skolemid |169|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1))
)) (= $t4 (|$addr#$signer| _$t0@@0)))) (and (and (= $t5 (|$addr#$signer| _$t0@@0)) (= _$t0@@0 _$t0@@0)) (and (= $t6 (|$addr#$signer| _$t0@@0)) (= $t7@@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t6)) 3))))))) (and (=> (= (ControlFlow 0 502104) 503083) anon14_Then_correct) (=> (= (ControlFlow 0 502104) 502235) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_200533| stream@@1) 0) (forall ((v@@50 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@1) v@@50) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 501248) 502104)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (seq.len (|p#$Mutation_251272| $t14@@0)) 0) (=> (and (= (seq.len (|p#$Mutation_251312| $t15)) 0) (= (ControlFlow 0 501258) 501248)) inline$$InitEventStore$0$anon0_correct@@0))))
(let ((PreconditionGeneratedEntry_correct@@0  (=> (= (ControlFlow 0 832817) 501258) anon0_correct@@0)))
