...
(push 1)
(set-info :boogie-vc-id $1_DiemConfig_publish_new_config_and_get_capability$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 852902) (let ((anon15_Else_correct@@5  (=> (not $abort_flag@0@@13) (and (=> (= (ControlFlow 0 524466) (- 0 853966)) (forall ((config_address@@29 Int) ) (!  (=> (|$IsValid'address'| config_address@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@29) (= config_address@@29 173345816)))
 :qid |DiemSystembpl.14218:15|
 :skolemid |420|
))) (=> (forall ((config_address@@30 Int) ) (!  (=> (|$IsValid'address'| config_address@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@30) (= config_address@@30 173345816)))
 :qid |DiemSystembpl.14218:15|
 :skolemid |420|
)) (and (=> (= (ControlFlow 0 524466) (- 0 853991)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (and (= $t15@0@@7 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0@@7 $t15@0@@7)) (and (=> (= (ControlFlow 0 524466) (- 0 854028)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0))) (and (=> (= (ControlFlow 0 524466) (- 0 854040)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (and (=> (= (ControlFlow 0 524466) (- 0 854058)) (not (not (= (|$addr#$signer| _$t0@@13) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 173345816))) (and (=> (= (ControlFlow 0 524466) (- 0 854072)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 524466) (- 0 854082)) (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816) (and (=> (= (ControlFlow 0 524466) (- 0 854088)) (= (let ((addr@@247 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@247))) _$t1@@12)) (=> (= (let ((addr@@248 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@248))) _$t1@@12) (=> (= (ControlFlow 0 524466) (- 0 854097)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_239966| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_239966| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct@@5  (and (=> (= (ControlFlow 0 524273) (- 0 853847)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 524273) (- 0 853887)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t4@@0)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct@@5  (=> (and (and $abort_flag@0@@13 (= $abort_code@1@@13 $abort_code@1@@13)) (and (= $t7@0 $abort_code@1@@13) (= (ControlFlow 0 524480) 524273))) L3_correct@@5)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0@@13 true) (= $abort_code@1@@13 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 524532) 524480) anon15_Then_correct@@5) (=> (= (ControlFlow 0 524532) 524466) anon15_Else_correct@@5))))))
(let ((anon14_Then_correct@@0  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@13)) (= (ControlFlow 0 524530) 524532)) anon14_Then$1_correct)))
(let ((anon14_Else_correct@@0  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@13))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1| ($Memory_260903 (|Store__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@13) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@13) $t13@0@@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1|)) (and (= $abort_flag@0@@13 false) (= $abort_code@1@@13 $abort_code@0@@13))) (and (=> (= (ControlFlow 0 524317) 524480) anon15_Then_correct@@5) (=> (= (ControlFlow 0 524317) 524466) anon15_Else_correct@@5))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1@@4 (= $t13@0@@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1@@12))) (and (=> (= (ControlFlow 0 524295) (- 0 853720)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@13))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@13)) (and (=> (= (ControlFlow 0 524295) 524530) anon14_Then_correct@@0) (=> (= (ControlFlow 0 524295) 524317) anon14_Else_correct@@0)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@4) (= $t12@@3 $t12@@3)) (and (= $t7@0 $t12@@3) (= (ControlFlow 0 524145) 524273))) L3_correct@@5)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12@@3) (= $t12@@3 6)) (and (= $t12@@3 $t12@@3) (= inline$$Not$0$dst@1@@4 inline$$Not$0$dst@1@@4))) (and (=> (= (ControlFlow 0 524129) 524295) anon13_Then_correct) (=> (= (ControlFlow 0 524129) 524145) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@4  (=> (and (= inline$$Not$0$dst@1@@4  (not $t9@0@@4)) (= (ControlFlow 0 524089) 524129)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6@@5) (=> (and (and (|$IsValid'address'| $t8@@6) (= $t8@@6 (|$addr#$signer| _$t0@@13))) (and (= $t9@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8@@6)) (= (ControlFlow 0 524095) 524089))) inline$$Not$0$anon0_correct@@4))))
(let ((anon12_Then_correct  (=> $t6@@5 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t7@@12)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5@@5)) (= 5 $t7@@12))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5@@5)) 0)) (= 3 $t7@@12))) (and (not (= (|$addr#$signer| _$t0@@13) 173345816)) (= 2 $t7@@12))) (= $t7@@12 $t7@@12)) (and (= $t7@0 $t7@@12) (= (ControlFlow 0 524624) 524273))) L3_correct@@5))))
(let ((anon0$1_correct@@13  (=> (and (and (forall ((addr@@249 Int) ) (!  (=> (|$IsValid'address'| addr@@249) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@249) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@249)) 0)) (= addr@@249 173345816)))
 :qid |DiemSystembpl.13996:20|
 :skolemid |402|
)) (forall ((addr@@250 Int) ) (!  (=> (|$IsValid'address'| addr@@250) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@250) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@250)) 1)) (= addr@@250 186537453)))
 :qid |DiemSystembpl.14000:20|
 :skolemid |403|
))) (and (forall ((addr@@251 Int) ) (!  (=> (|$IsValid'address'| addr@@251) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@251)) 2))))))
 :qid |DiemSystembpl.14004:20|
 :skolemid |404|
)) (forall ((addr@@252 Int) ) (!  (=> (|$IsValid'address'| addr@@252) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@252)) 2))))))
 :qid |DiemSystembpl.14008:20|
 :skolemid |405|
)))) (=> (and (and (and (forall ((addr@@253 Int) ) (!  (=> (|$IsValid'address'| addr@@253) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@253)) 2))))))
 :qid |DiemSystembpl.14012:20|
 :skolemid |406|
)) (forall ((addr@@254 Int) ) (!  (=> (|$IsValid'address'| addr@@254) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@254)) 2))))))
 :qid |DiemSystembpl.14016:20|
 :skolemid |407|
))) (and (forall ((addr@@255 Int) ) (!  (=> (|$IsValid'address'| addr@@255) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@255)) 2)))))
 :qid |DiemSystembpl.14020:20|
 :skolemid |408|
)) (forall ((addr@@256 Int) ) (!  (=> (|$IsValid'address'| addr@@256) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@256)) 2)))))
 :qid |DiemSystembpl.14024:20|
 :skolemid |409|
)))) (and (and (forall ((addr@@257 Int) ) (!  (=> (|$IsValid'address'| addr@@257) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@257)) 2)))))
 :qid |DiemSystembpl.14028:20|
 :skolemid |410|
)) (forall ((addr@@258 Int) ) (!  (=> (|$IsValid'address'| addr@@258) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_247969| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@258) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@258) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@258)) 4))))
 :qid |DiemSystembpl.14032:20|
 :skolemid |411|
))) (and (forall ((addr@@259 Int) ) (!  (=> (|$IsValid'address'| addr@@259) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@259) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@259) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@259)) 3))))
 :qid |DiemSystembpl.14036:20|
 :skolemid |412|
)) (forall ((addr@@260 Int) ) (!  (=> (|$IsValid'address'| addr@@260) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@260) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@260) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@260)) 3))))
 :qid |DiemSystembpl.14040:20|
 :skolemid |413|
))))) (=> (and (and (and (and (forall ((addr@@261 Int) ) (!  (=> (|$IsValid'address'| addr@@261) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@261) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_249821| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@261)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@261) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@261)) 3))))
 :qid |DiemSystembpl.14044:20|
 :skolemid |414|
)) (forall ((config_address@@31 Int) ) (!  (=> (|$IsValid'address'| config_address@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@31) (= config_address@@31 173345816)))
 :qid |DiemSystembpl.14048:20|
 :skolemid |415|
))) (and (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252100| $1_DualAttestation_Credential_$memory) addr1@@6) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr1@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr1@@6)) 2)))))
 :qid |DiemSystembpl.14052:20|
 :skolemid |416|
)) (forall ((addr@@262 Int) ) (!  (=> (|$IsValid'address'| addr@@262) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_252485| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@262) (|Select__T@[Int]Bool_| (|domain#$Memory_252545| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@262)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) addr@@262)) 2)))))
 :qid |DiemSystembpl.14056:20|
 :skolemid |417|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@13)) ($1_Signer_is_txn_signer _$t0@@13)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@13)))) (and (and (and (forall (($a_0@@46 Int) ) (! (let (($rsc@@46 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $a_0@@46)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@46))
 :qid |DiemSystembpl.14065:20|
 :skolemid |418|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $a_0@@46))
)) (forall (($a_0@@47 Int) ) (! (let (($rsc@@47 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@47)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@47))
 :qid |DiemSystembpl.14069:20|
 :skolemid |419|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_260903| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@47))
))) (and (= $t4@@0 (|$addr#$signer| _$t0@@13)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| 173345816))) (and (and (= _$t0@@13 _$t0@@13) (= _$t1@@12 _$t1@@12)) (and (= $t5@@5 (|$addr#$signer| _$t0@@13)) (= $t6@@5  (or (or (or (not (= (|$addr#$signer| _$t0@@13) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_239686| $1_Roles_RoleId_$memory) $t5@@5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_239686| $1_Roles_RoleId_$memory) $t5@@5)) 0))) (not (= (|$addr#$signer| _$t0@@13) 173345816)))))))) (and (=> (= (ControlFlow 0 524033) 524624) anon12_Then_correct) (=> (= (ControlFlow 0 524033) 524095) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@19 (|Select__T@[$1_Event_EventHandle]Multiset_200533_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_200533| stream@@19) 0) (forall ((v@@63 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_200533| stream@@19) v@@63) 0)
 :qid |DiemSystembpl.134:13|
 :skolemid |2|
))))
 :qid |DiemSystembpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 523459) 524033)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 852902) 523459) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13))))))))))))))))
))
(check-sat)
(pop 1)
