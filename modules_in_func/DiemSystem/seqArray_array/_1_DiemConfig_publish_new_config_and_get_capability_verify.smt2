...
(declare-fun $t15@0 () |T@$1_DiemConfig_ModifyConfigCapability'#0'|)
...
(assert (not
 (=> (= (ControlFlow 0 0) 873449) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 538329) (- 0 874513)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.14250:15|
 :skolemid |452|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemSystembpl.14250:15|
 :skolemid |452|
)) (and (=> (= (ControlFlow 0 538329) (- 0 874538)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 538329) (- 0 874575)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 538329) (- 0 874587)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 538329) (- 0 874605)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 538329) (- 0 874619)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 538329) (- 0 874629)) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 538329) (- 0 874635)) (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@0))) _$t1)) (=> (= (let ((addr@@1 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@1))) _$t1) (=> (= (ControlFlow 0 538329) (- 0 874644)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 538136) (- 0 874394)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 538136) (- 0 874434)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 538343) 538136))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 538395) 538343) anon15_Then_correct) (=> (= (ControlFlow 0 538395) 538329) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 538393) 538395)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_272061 (|Store__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 538180) 538343) anon15_Then_correct) (=> (= (ControlFlow 0 538180) 538329) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1))) (and (=> (= (ControlFlow 0 538158) (- 0 874267)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 538158) 538393) anon14_Then_correct) (=> (= (ControlFlow 0 538158) 538180) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 538008) 538136))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 537992) 538158) anon13_Then_correct) (=> (= (ControlFlow 0 537992) 538008) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 537952) 537992)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8)) (= (ControlFlow 0 537958) 537952))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 538487) 538136))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@2)) 0)) (= addr@@2 173345816)))
 :qid |DiemSystembpl.14028:20|
 :skolemid |434|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@3)) 1)) (= addr@@3 186537453)))
 ...
 :qid |DiemSystembpl.14084:20|
 :skolemid |448|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_263608| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_263668| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@15)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) addr@@15)) 2)))))
 :qid |DiemSystembpl.14088:20|
 :skolemid |449|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemSystembpl.14097:20|
 :skolemid |450|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@0))
 :qid |DiemSystembpl.14101:20|
 :skolemid |451|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_272061| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0))
))) (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))))) (and (=> (= (ControlFlow 0 537896) 538487) anon12_Then_correct) (=> (= (ControlFlow 0 537896) 537958) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 537322) 537896)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 873449) 537322) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
