...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 897581) (let ((anon4_Else_correct  (=> (not $t4) (=> (and (and (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t3) (let (($range_0 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(let (($range_1 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t3)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@129 $i_2))
(let ((j@@40 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t3)) i@@129)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t3)) j@@40))) (= i@@129 j@@40))))))
 :qid |DiemSystembpl.21292:222|
 :skolemid |704|
))))) (and (= (|$scheme#$1_DiemSystem_DiemSystem| $t3) (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| $t3) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0))))))) (and (and (= $t3 $t3) (= $t6@0 (|$validators#$1_DiemSystem_DiemSystem| $t3))) (and (= $t7 (let (($range_0@@0 $t6@0))
(exists (($i_1 Int) ) (!  (and (InRangeVec_183043 $range_0@@0 $i_1) (let ((v@@62 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@0) $i_1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@62) _$t0)))
 :qid |DiemSystembpl.21313:62|
 :skolemid |705|
)))) (= $t7 $t7)))) (and (=> (= (ControlFlow 0 564821) (- 0 898143)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 564821) (- 0 898155)) (= $t7 (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
...
(exists (($i_1@@0 Int) ) (!  (and (InRangeVec_183043 $range_0@@1 $i_1@@0) (let ((v@@63 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@1) $i_1@@0)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@63) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
))))) (=> (= $t7 (let (($range_0@@2 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
...
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_183043 $range_0@@2 $i_1@@1) (let ((v@@64 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@2) $i_1@@1)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@64) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
)))) (=> (= (ControlFlow 0 564821) (- 0 898167)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@3)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@4))))))))))))))
(let ((anon4_Then_correct  (=> $t4 (=> (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5)) (= $t5 $t5)) (and (=> (= (ControlFlow 0 564879) (- 0 897949)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (=> (= (ControlFlow 0 564879) (- 0 897956)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t5)))))))))
(let ((anon0$1_correct  (=> (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.21226:20|
 :skolemid |698|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250871| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (=> (and (and (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@5) (= addr@@5 173345816)))
 :qid |DiemSystembpl.21234:20|
 :skolemid |699|
)) (let (($range_0@@3 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@6 173345816))
...
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@2) (let ((i1 $i_1@@2))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@7 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@7))))) i1)))) 3))))
 :qid |DiemSystembpl.21238:151|
 :skolemid |700|
)))) (and (let (($range_0@@4 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@8 173345816))
...
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@3) (let ((i1@@0 $i_1@@3))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9))))) i1@@0)) 1)))
 :qid |DiemSystembpl.21243:151|
 :skolemid |701|
))) (|$IsValid'address'| _$t0))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0)))
...
(let ((j@@41 $i_4))
 ...
 :qid |DiemSystembpl.21252:367|
 :skolemid |702|
))))))
 :qid |DiemSystembpl.21251:20|
 :skolemid |703|
...
)) (= _$t0 _$t0)) (and (= _$t0 _$t0) (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 564625) 564879) anon4_Then_correct) (=> (= (ControlFlow 0 564625) 564821) anon4_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_202527| stream@@0) 0) (forall ((v@@65 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@0) v@@65) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 564316) 564625)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 897581) 564316) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
