...
(declare-fun $t15@1 () T@$Mutation_281945)
(declare-fun $t16@0 () T@$Mutation_281991)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t16@1 () T@$Mutation_281991)
(declare-fun $t15@2 () T@$Mutation_281945)
...
(declare-fun $t15 () T@$Mutation_281945)
(declare-fun $t15@0 () T@$Mutation_281945)
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) addr@@1))))) (|$gas_constants#$1_DiemVMConfig_GasSchedule| (|$gas_schedule#$1_DiemVMConfig_DiemVMConfig| _$t1)))) (and (=> (= (ControlFlow 0 550458) (- 0 885625)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory@2) 173345816))) (=> (= (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory@2) 173345816)) (and (=> (= (ControlFlow 0 550458) (- 0 885636)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t35 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_202527| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@0)))) $EmptyEventStore)))
...
(let ((expected@@0 (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t35 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_202527| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@1)))) $EmptyEventStore)))
 ...
 :qid |DiemSystembpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 550458) (- 0 885681)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t35 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t8)))) (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_202527| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36))))
(Multiset_202527 (|Store__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t36) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $EmptyEventStore) $t9 stream_new@@2)))) $EmptyEventStore)))
...
(let ((anon19_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_DiemConfig_Configuration_$memory@1 ($Memory_250712 (|Store__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1) (= (ControlFlow 0 550060) 550458))) anon13_correct)))
(let ((anon19_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_DiemConfig_Configuration_$memory@0 ($Memory_250712 (|Store__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0) (= (ControlFlow 0 550470) 550458))) anon13_correct)))
(let ((anon18_Else_correct  (=> (not $t25) (and (=> (= (ControlFlow 0 550048) 550470) anon19_Then_correct) (=> (= (ControlFlow 0 550048) 550060) anon19_Else_correct)))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 549704) (- 0 885163)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6)))) (=> (= (ControlFlow 0 549704) (- 0 885209)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (= 5 $t14@0)) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t6) 18446744073709551615)) (< $t7 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t6))) (= 1 $t14@0))))))))
(let ((anon18_Then_correct  (=> $t25 (=> (and (and (and (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21)))) (= 1 $t14)) (= $t14 $t14)) (and (= $t14@0 $t14) (= (ControlFlow 0 550550) 549704))) L3_correct))))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (= |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''@0| (|v#$Mutation_281945| $t15@1)) (= |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''@0| |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''@0|)) (=> (and (and (= $t16@0 ($Mutation_281991 (|l#$Mutation_281945| $t15@1) (let ((l (|l#Vec_30471| (|p#$Mutation_281945| $t15@1))))
(Vec_30471 (|Store__T@[Int]Int_| (|v#Vec_30471| (|p#$Mutation_281945| $t15@1)) l 0) (+ l 1))) (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|v#$Mutation_281945| $t15@1)))) (= $t16@1 ($Mutation_281991 (|l#$Mutation_281991| $t16@0) (|p#$Mutation_281991| $t16@0) _$t1))) (and (= $t15@2 ($Mutation_281945 (|l#$Mutation_281945| $t15@1) (|p#$Mutation_281945| $t15@1) (|$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'| (|v#$Mutation_281991| $t16@1)))) (= |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0| ($Memory_252225 (|Store__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) (|a#$Global| (|l#$Mutation_281945| $t15@2)) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) (|a#$Global| (|l#$Mutation_281945| $t15@2)) (|v#$Mutation_281945| $t15@2)))))) (and (=> (= (ControlFlow 0 550040) (- 0 884827)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.17365:15|
 :skolemid |565|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemSystembpl.17365:15|
 :skolemid |565|
)) (and (=> (= (ControlFlow 0 550040) (- 0 884852)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 550040) (- 0 884863)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) addr@@2) (= addr@@2 173345816)))
 :qid |DiemSystembpl.17377:15|
 :skolemid |566|
))) (=> (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory@0|) addr@@3) (= addr@@3 173345816)))
 :qid |DiemSystembpl.17377:15|
 :skolemid |566|
)) (=> (and (and (and (= $t17 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t18 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t19 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t20 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (and (= $t21 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t22 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t23 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t24 (|$events#$1_DiemConfig_Configuration| $t23))))) (and (=> (= (ControlFlow 0 550040) (- 0 884984)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 550040) (- 0 884997)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (=> (= $t25  (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21) $t18)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t21) 18446744073709551615)) (< $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t21))))) (and (=> (= (ControlFlow 0 550040) 550550) anon18_Then_correct) (=> (= (ControlFlow 0 550040) 550048) anon18_Else_correct)))))))))))))))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 550564) 549704))) L3_correct)))
(let ((anon16_Then$1_correct  (=> (= $t15@1 $t15) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 550616) 550564) anon17_Then_correct) (=> (= (ControlFlow 0 550616) 550040) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (= (ControlFlow 0 550614) 550616)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816) (=> (and (and (= $t15@0 ($Mutation_281945 ($Global 173345816) (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (= $t15@1 $t15@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 549736) 550564) anon17_Then_correct) (=> (= (ControlFlow 0 549736) 550040) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t11@0 (and (=> (= (ControlFlow 0 549714) (- 0 884636)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$modifies| 173345816) (and (=> (= (ControlFlow 0 549714) 550614) anon16_Then_correct) (=> (= (ControlFlow 0 549714) 549736) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 549580) 549704))) L3_correct)))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemSystembpl.17193:20|
 :skolemid |559|
))) (=> (and (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) addr@@4) (= addr@@4 173345816)))
 :qid |DiemSystembpl.17197:20|
 :skolemid |560|
)) (|$IsValid'$1_DiemConfig_ModifyConfigCapability'$1_DiemVMConfig_DiemVMConfig''| _$t0)) (and (|$IsValid'$1_DiemVMConfig_DiemVMConfig'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemSystembpl.17206:20|
 :skolemid |561|
...
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) $a_0@@0)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@0))
 :qid |DiemSystembpl.17210:20|
 :skolemid |562|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@1)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@1))
 :qid |DiemSystembpl.17214:20|
 :skolemid |563|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_272142| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@1))
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@2)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig''| $rsc@@2))
 :qid |DiemSystembpl.17218:20|
 :skolemid |564|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_| (|contents#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) $a_0@@2))
)) (= $t6 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))))) (=> (and (and (and (and (= $t7 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t8 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t9 (|$events#$1_DiemConfig_Configuration| $t8)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250712| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (and (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$modifies| 173345816)) (and (= _$t0 _$t0) (= _$t1 _$t1)))) (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_252225| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 549564) 549714) anon15_Then_correct) (=> (= (ControlFlow 0 549564) 549580) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 549252) 549564)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_30471| (|p#$Mutation_281945| $t5)) 0) (= (|l#Vec_30471| (|p#$Mutation_281945| $t15)) 0)) (and (= (|l#Vec_30471| (|p#$Mutation_281991| $t16)) 0) (= (ControlFlow 0 549262) 549252))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 884217) 549262) anon0_correct)))
