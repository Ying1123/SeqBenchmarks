...
(declare-fun $t15 () |T@$1_Option_Option'u64'|)
...
(declare-fun $t17 () |T@$1_Option_Option'u64'|)
(declare-fun $t10@0 () T@$1_DiemSystem_ValidatorInfo)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 893901) (let ((L9_correct  (=> (= (ControlFlow 0 561026) (- 0 894787)) false)))
(let ((anon22_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 561016) 561026)) L9_correct))))
(let ((anon20_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 561092) 561026)) L9_correct))))
(let ((anon22_Else_correct  (=> (and (not $abort_flag@1) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 561002) (- 0 894741)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (=> (= (ControlFlow 0 561002) (- 0 894748)) (let (($range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((j@@40 $i_1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@40)) _$t1))))
 :qid |DiemSystembpl.20207:49|
 :skolemid |653|
)))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 560933) 561016) anon22_Then_correct) (=> (= (ControlFlow 0 560933) 561002) anon22_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t8@0 1) $MAX_U64) (= (ControlFlow 0 560931) 560933)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t8@0 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t8@0 1)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 560879) 561016) anon22_Then_correct) (=> (= (ControlFlow 0 560879) 561002) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not $t12@1) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 560939) 560931) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 560939) 560879) inline$$AddU64$0$anon3_Else_correct)))))
(let ((L8_correct  (and (=> (= (ControlFlow 0 560603) (- 0 894517)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 560603) (- 0 894524)) (=> (let (($range_0@@0 ($Range 0 $t5)))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@129 $i_1@@0))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) i@@129)) _$t1))))
 :qid |DiemSystembpl.20226:49|
 :skolemid |654|
))) (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0))) (=> (=> (let (($range_0@@1 ($Range 0 $t5)))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@130 $i_1@@1))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) i@@130)) _$t1))))
 :qid |DiemSystembpl.20226:49|
 :skolemid |654|
))) (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (and (=> (= (ControlFlow 0 560603) (- 0 894567)) (=> (let (($range_0@@2 ($Range 0 $t5)))
(exists (($i_1@@2 Int) ) (!  (and ($InRange $range_0@@2 $i_1@@2) (let ((i@@131 $i_1@@2))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) i@@131)) _$t1)))
 :qid |DiemSystembpl.20232:49|
 :skolemid |655|
))) (and (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)))
(= at ($choice_0 _$t0 _$t1)))))) (=> (=> (let (($range_0@@3 ($Range 0 $t5)))
(exists (($i_1@@3 Int) ) (!  (and ($InRange $range_0@@3 $i_1@@3) (let ((i@@132 $i_1@@3))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) i@@132)) _$t1)))
 :qid |DiemSystembpl.20232:49|
 :skolemid |655|
))) (and (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)) (let ((at@@0 (|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'u64'| $t16@0)) 0)))
(= at@@0 ($choice_0 _$t0 _$t1))))) (=> (= (ControlFlow 0 560603) (- 0 894623)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@0)))) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
...
(let ((anon21_Then_correct  (=> $t12@1 (and (=> (= (ControlFlow 0 561078) (- 0 894460)) (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) $t8@0)) _$t1)) (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) $t8@0)) _$t1) (=> (and (|$IsValid'$1_Option_Option'u64''| $t15) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t15)) 1)) (=> (and (and (|$IsEqual'vec'u64''| (|$vec#$1_Option_Option'u64'| $t15) (|$vec#$1_Option_Option'u64'| (|$1_Option_Option'u64'| (Vec_30471 (|Store__T@[Int]Int_| (MapConstVec_16957 DefaultVecElem_16957) 0 $t8@0) 1)))) (= $t15 $t15)) (and (= $t16@0 $t15) (= (ControlFlow 0 561078) 560603))) L8_correct)))))))
(let ((anon20_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (and (= $t11@1 (|$addr#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t12@1 (= $t11@1 _$t1)))) (and (=> (= (ControlFlow 0 560774) 561078) anon21_Then_correct) (=> (= (ControlFlow 0 560774) 560939) anon21_Else_correct)))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 560742) 561092) anon20_Then_correct) (=> (= (ControlFlow 0 560742) 560774) anon20_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_183043 _$t0 $t8@0)) (= (ControlFlow 0 560740) 560742)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (InRangeVec_183043 _$t0 $t8@0) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) $t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 560690) 561092) anon20_Then_correct) (=> (= (ControlFlow 0 560690) 560774) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 560748) 560740) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 560748) 560690) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|)))))
(let ((anon19_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 560475) (- 0 894269)) (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 560475) (- 0 894276)) (let (($range_0@@4 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((j@@41 $i_1@@4))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@41)) _$t1))))
 :qid |DiemSystembpl.20171:48|
 :skolemid |652|
)))) (=> (let (($range_0@@5 ($Range 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((j@@42 $i_1@@5))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@42)) _$t1))))
 :qid |DiemSystembpl.20171:48|
 :skolemid |652|
))) (=> (and (|$IsValid'$1_Option_Option'u64''| $t17) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t17)) 1)) (=> (and (and (|$IsEqual'vec'u64''| (|$vec#$1_Option_Option'u64'| $t17) (|$vec#$1_Option_Option'u64'| (|$1_Option_Option'u64'| (Vec_30471 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= $t17 $t17)) (and (= $t16@0 $t17) (= (ControlFlow 0 560475) 560603))) L8_correct)))))))))
(let ((anon18_Else$1_correct  (and (=> (= (ControlFlow 0 560390) 560748) anon19_Then_correct) (=> (= (ControlFlow 0 560390) 560475) anon19_Else_correct))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (= (ControlFlow 0 560380) 560390)) anon18_Else$1_correct)))
(let ((anon18_Else_correct  (=> (and (and (not false) (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (|$IsValid'u64'| 0) (= 0 0))) (and (=> (= (ControlFlow 0 560386) (- 0 894107)) (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|) (and (=> (= (ControlFlow 0 560386) (- 0 894114)) (let (($range_0@@6 ($Range 0 0)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@6 $i_1@@6) (let ((j@@43 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@43)) _$t1))))
 :qid |DiemSystembpl.20018:48|
 :skolemid |650|
)))) (=> (let (($range_0@@7 ($Range 0 0)))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((j@@44 $i_1@@7))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@44)) _$t1))))
 :qid |DiemSystembpl.20018:48|
 :skolemid |650|
))) (=> (|$IsValid'u64'| $t8@0) (=> (and (and (and (|$IsValid'$1_DiemSystem_ValidatorInfo'| $t10@0) (|$IsValid'address'| $t11@0)) (and (|$IsValid'u64'| $t13@0) (|$IsValid'u64'| $t14@0))) (and (and (not false) (<= $t8@0 |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1|)) (and (let (($range_0@@8 ($Range 0 $t8@0)))
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@8 $i_1@@8) (let ((j@@45 $i_1@@8))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| _$t0) j@@45)) _$t1))))
 :qid |DiemSystembpl.20058:53|
 :skolemid |651|
))) (= (ControlFlow 0 560386) 560380)))) inline$$Lt$0$anon0_correct)))))))))
(let ((anon18_Then_correct true))
(let ((|inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$l@1| (|l#Vec_202840| _$t0)) (and (=> (= (ControlFlow 0 560176) 561106) anon18_Then_correct) (=> (= (ControlFlow 0 560176) 560386) anon18_Else_correct)))))
(let ((anon0$1_correct  (=> (and (|$IsValid'vec'$1_DiemSystem_ValidatorInfo''| _$t0) (|$IsValid'address'| _$t1)) (=> (and (and (= $t5 (|l#Vec_202840| _$t0)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 560182) 560176))) |inline$$1_Vector_length'$1_DiemSystem_ValidatorInfo'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 560096) 560182)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 893901) 560096) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))
))
(check-sat)
(pop 1)
