...
(declare-fun $t18@0 () T@$1_ValidatorConfig_Config)
...
(declare-fun $t14@0 () T@Vec_202840)
(declare-fun $t15 () Int)
...
(declare-fun $t10 () |T@$1_Option_Option'u64'|)
(declare-fun $t7 () Int)
(declare-fun $t11 () Bool)
(declare-fun $t5 () T@$1_DiemSystem_DiemSystem)
(declare-fun $t13 () Int)
(declare-fun $t6 () Bool)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 892873) (let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t18@0 (|$config#$1_DiemSystem_ValidatorInfo| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2|)) (= $t18@0 $t18@0)) (and (=> (= (ControlFlow 0 559864) (- 0 893810)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 559864) (- 0 893822)) (not (not (let (($range_0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@62) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
)))))) (=> (not (not (let (($range_0@@0 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@1 173345816))
...
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@63) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
))))) (and (=> (= (ControlFlow 0 559864) (- 0 893833)) (let (($range_0@@1 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@2 173345816))
...
(exists (($i_1@@1 Int) ) (!  (and (InRangeVec_183043 $range_0@@1 $i_1@@1) (let ((info (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@1) $i_1@@1)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| info) _$t0) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t18@0) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t18@0) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t18@0) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info)))))))
 :qid |DiemSystembpl.19897:176|
 :skolemid |649|
)))) (=> (let (($range_0@@2 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@3))))))
(exists (($i_1@@2 Int) ) (!  (and (InRangeVec_183043 $range_0@@2 $i_1@@2) (let ((info@@0 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@2) $i_1@@2)))
 (and (= (|$addr#$1_DiemSystem_ValidatorInfo| info@@0) _$t0) (and (and (|$IsEqual'vec'u8''| (|$consensus_pubkey#$1_ValidatorConfig_Config| $t18@0) (|$consensus_pubkey#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info@@0))) (|$IsEqual'vec'u8''| (|$validator_network_addresses#$1_ValidatorConfig_Config| $t18@0) (|$validator_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info@@0)))) (|$IsEqual'vec'u8''| (|$fullnode_network_addresses#$1_ValidatorConfig_Config| $t18@0) (|$fullnode_network_addresses#$1_ValidatorConfig_Config| (|$config#$1_DiemSystem_ValidatorInfo| info@@0)))))))
 :qid |DiemSystembpl.19897:176|
 :skolemid |649|
))) (=> (= (ControlFlow 0 559864) (- 0 893879)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
...
(let ((L3_correct  (and (=> (= (ControlFlow 0 559584) (- 0 893738)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@3 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@6 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@6))))))
(exists (($i_1@@3 Int) ) (!  (and (InRangeVec_183043 $range_0@@3 $i_1@@3) (let ((v@@64 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@3) $i_1@@3)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@64) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
)))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (not (let (($range_0@@4 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@7 173345816))
...
(exists (($i_1@@4 Int) ) (!  (and (InRangeVec_183043 $range_0@@4 $i_1@@4) (let ((v@@65 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@4) $i_1@@4)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@65) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
))))) (=> (= (ControlFlow 0 559584) (- 0 893753)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7@0)) (and (not (let (($range_0@@5 (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@8 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@8))))))
(exists (($i_1@@5 Int) ) (!  (and (InRangeVec_183043 $range_0@@5 $i_1@@5) (let ((v@@66 (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $range_0@@5) $i_1@@5)))
(= (|$addr#$1_DiemSystem_ValidatorInfo| v@@66) _$t0)))
 :qid |DiemSystembpl.18046:125|
 :skolemid |575|
)))) (= 7 $t7@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 559878) 559584))) L3_correct)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@0|)) (and (=> (= (ControlFlow 0 559753) 559878) anon14_Then_correct) (=> (= (ControlFlow 0 559753) 559864) anon14_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_183043 $t14@0 $t15)) (= (ControlFlow 0 559751) 559753)) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|  (=> (InRangeVec_183043 $t14@0 $t15) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $t14@0) $t15)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$dst@1|))) (and (=> (= (ControlFlow 0 559701) 559878) anon14_Then_correct) (=> (= (ControlFlow 0 559701) 559864) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (not $t16) (=> (and (|$IsValid'u64'| $t15) (= $t15 (|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (and (=> (= (ControlFlow 0 559759) 559751) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 559759) 559701) |inline$$1_Vector_borrow'$1_DiemSystem_ValidatorInfo'$0$anon3_Else_correct|))))))
(let ((anon13_Then_correct  (=> $t16 (=> (and (and (and (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0) (= 7 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 559902) 559584))) L3_correct))))
(let ((anon12_Then_correct  (=> $t11 (=> (and (= $t14@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t16 (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (and (=> (= (ControlFlow 0 559600) 559902) anon13_Then_correct) (=> (= (ControlFlow 0 559600) 559759) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (and (not $t11) (= $t13 $t13)) (and (= $t7@0 $t13) (= (ControlFlow 0 559524) 559584))) L3_correct)))
(let ((anon11_Else_correct  (=> (not $t6) (=> (and (|$IsValid'$1_DiemSystem_DiemSystem'| $t5) (let (($range_0@@6 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(let (($range_1 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t5)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0@@6 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@129 $i_2))
(let ((j@@40 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t5)) i@@129)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| $t5)) j@@40))) (= i@@129 j@@40))))))
 :qid |DiemSystembpl.19740:222|
 :skolemid |646|
))))) (=> (and (and (and (and (and (= (|$scheme#$1_DiemSystem_DiemSystem| $t5) (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9))))) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| $t5) (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@9 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@9)))))) (= $t5 $t5)) (and (= $t8@0 (|$validators#$1_DiemSystem_DiemSystem| $t5)) (= $t9 (|l#Vec_202840| $t8@0)))) (and (and (|$IsValid'$1_Option_Option'u64''| $t10) (<= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 1)) (=> (let (($range_0@@7 ($Range 0 $t9)))
(forall (($i_1@@6 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@6) (let ((i@@130 $i_1@@6))
 (not (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $t8@0) i@@130)) _$t0))))
 :qid |DiemSystembpl.19767:54|
 :skolemid |647|
))) (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0)))) (and (and (and (=> (let (($range_0@@8 ($Range 0 $t9)))
(exists (($i_1@@7 Int) ) (!  (and ($InRange $range_0@@8 $i_1@@7) (let ((i@@131 $i_1@@7))
(= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| $t8@0) i@@131)) _$t0)))
 :qid |DiemSystembpl.19771:54|
 :skolemid |648|
))) (and (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0)) (let ((at (|Select__T@[Int]Int_| (|v#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0)))
(= at ($choice_0 $t8@0 _$t0))))) (= $t10 $t10)) (and (= $t11  (not (= (|l#Vec_30471| (|$vec#$1_Option_Option'u64'| $t10)) 0))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| $t13) (= $t13 7)) (and (= $t13 $t13) (= $t11 $t11))))) (and (=> (= (ControlFlow 0 559508) 559600) anon12_Then_correct) (=> (= (ControlFlow 0 559508) 559524) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t7)) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 559930) 559584))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemSystembpl.19677:20|
 :skolemid |640|
)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_249750| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_250871| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@10) (= addr@@10 173345816)))
 :qid |DiemSystembpl.19685:20|
 :skolemid |641|
))) (and (let (($range_0@@9 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@11 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))))))
(forall (($i_1@@8 Int) ) (!  (=> ($InRange $range_0@@9 $i_1@@8) (let ((i1 $i_1@@8))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@12))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_250432| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@12))))) i1)))) 3))))
 :qid |DiemSystembpl.19689:151|
 :skolemid |642|
))) (let (($range_0@@10 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))))))
(forall (($i_1@@9 Int) ) (!  (=> ($InRange $range_0@@10 $i_1@@9) (let ((i1@@0 $i_1@@9))
(= (|$consensus_voting_power#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@14 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@14))))) i1@@0)) 1)))
 :qid |DiemSystembpl.19694:151|
 :skolemid |643|
))))) (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0)))
 (and (|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc) (let (($range_1@@0 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))))))
(let (($range_2 ($Range 0 (|l#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))))))
(forall (($i_3@@0 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@0 $i_3@@0) (=> ($InRange $range_2 $i_4) (let ((i@@132 $i_3@@0))
(let ((j@@41 $i_4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))) i@@132)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_202840| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc))) j@@41))) (= i@@132 j@@41))))))
 :qid |DiemSystembpl.19703:367|
 :skolemid |644|
))))))
 :qid |DiemSystembpl.19702:20|
 :skolemid |645|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0))
))) (and (= _$t0 _$t0) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_250798| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 559217) 559930) anon11_Then_correct) (=> (= (ControlFlow 0 559217) 559508) anon11_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_202527_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_202527| stream@@0) 0) (forall ((v@@67 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_202527| stream@@0) v@@67) 0)
 :qid |DiemSystembpl.159:13|
 :skolemid |4|
))))
 :qid |DiemSystembpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 558914) 559217)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 892873) 558914) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
