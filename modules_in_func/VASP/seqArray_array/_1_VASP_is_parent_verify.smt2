...
(assert (not
 ...
 :qid |VASPbpl.2281:20|
 :skolemid |86|
)) (|$IsValid'address'| _$t0)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc))
 :qid |VASPbpl.2288:20|
 :skolemid |87|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (= $t1@0 $t1@0))) (and (=> (= (ControlFlow 0 48411) (- 0 57743)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 48411) (- 0 57750)) (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0))) (=> (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) _$t0)) (and (=> (= (ControlFlow 0 48411) (- 0 57761)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (= (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_34982| $1_VASP_ChildVASP_$memory) a)))
 :qid |VASPbpl.2325:15|
 :skolemid |88|
 ...
 :qid |VASPbpl.2325:15|
 :skolemid |88|
)) (=> (= (ControlFlow 0 48411) (- 0 57786)) (forall ((parent Int) ) (!  (=> (|$IsValid'address'| parent) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_35046| $1_VASP_ParentVASP_$memory) parent) (= (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)) (|$num_children#$1_VASP_ParentVASP| (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_35046| $1_VASP_ParentVASP_$memory) parent)))))
 :qid |VASPbpl.2330:15|
 :skolemid |89|
))))))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_20906_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPbpl.1501:13|
 :skolemid |49|
))) (= (ControlFlow 0 48209) 48411)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 57583) 48209) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))
))
(check-sat)
(pop 1)
