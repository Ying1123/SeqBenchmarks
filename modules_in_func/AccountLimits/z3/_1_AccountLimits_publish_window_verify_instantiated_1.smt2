...
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_publish_window$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 278439) (let ((anon25_Else_correct@@1  (=> (not $abort_flag@1@@7) (and (=> (= (ControlFlow 0 227028) (- 0 280895)) (forall ((window_addr@@16 Int) ) (!  (=> (|$IsValid'address'| window_addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@16)))
 :qid |AccountLimitsbpl.11624:15|
 :skolemid |332|
))) (=> (forall ((window_addr@@17 Int) ) (!  (=> (|$IsValid'address'| window_addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@17)))
 :qid |AccountLimitsbpl.11624:15|
 :skolemid |332|
)) (and (=> (= (ControlFlow 0 227028) (- 0 280919)) (forall ((window_addr@@18 Int) ) (!  (=> (|$IsValid'address'| window_addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@18)))))
 :qid |AccountLimitsbpl.11630:15|
 :skolemid |333|
))) (=> (forall ((window_addr@@19 Int) ) (!  (=> (|$IsValid'address'| window_addr@@19) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) window_addr@@19)))))
 :qid |AccountLimitsbpl.11630:15|
 :skolemid |333|
)) (and (=> (= (ControlFlow 0 227028) (- 0 280949)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) addr@@123) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@123) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@123)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@123)) 6)))))
 :qid |AccountLimitsbpl.11636:15|
 :skolemid |334|
))) (=> (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1|) addr@@124) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@124) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@124)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@124)) 6)))))
 :qid |AccountLimitsbpl.11636:15|
 :skolemid |334|
)) (and (=> (= (ControlFlow 0 227028) (- 0 281005)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1))) (and (=> (= (ControlFlow 0 227028) (- 0 281016)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8))) (and (=> (= (ControlFlow 0 227028) (- 0 281027)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1))) (and (=> (= (ControlFlow 0 227028) (- 0 281039)) (not (and (not (= $t8@@1 5)) (not (= $t8@@1 6))))) (=> (not (and (not (= $t8@@1 5)) (not (= $t8@@1 6)))) (and (=> (= (ControlFlow 0 227028) (- 0 281062)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2))) (and (=> (= (ControlFlow 0 227028) (- 0 281074)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) 0))) (=> (= (ControlFlow 0 227028) (- 0 281092)) (not (not (= (|$addr#$signer| _$t0@@11) 173345816)))))))))))))))))))))))))
(let ((inline$$1_AccountLimits_current_time$0$anon7_Then_correct@@1 true))
(let ((L5_correct@@1  (and (=> (= (ControlFlow 0 226075) (- 0 280679)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1)) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1))) (and (not (= $t8@@1 5)) (not (= $t8@@1 6)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816)))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1)) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1))) (and (not (= $t8@@1 5)) (not (= $t8@@1 6)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816))) (=> (= (ControlFlow 0 226075) (- 0 280757)) (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1)) (= 5 $t12@0@@4)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8)) (= 6 $t12@0@@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1)) (= 5 $t12@0@@4))) (and (and (not (= $t8@@1 5)) (not (= $t8@@1 6))) (= 3 $t12@0@@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) (= 5 $t12@0@@4))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@2)) 0)) (= 3 $t12@0@@4))) (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t12@0@@4))))))))
(let ((anon25_Then_correct@@1  (=> (and (and $abort_flag@1@@7 (= $abort_code@2@@7 $abort_code@2@@7)) (and (= $t12@0@@4 $abort_code@2@@7) (= (ControlFlow 0 227042) 226075))) L5_correct@@1)))
(let ((anon24_Then$1_correct@@1  (=> (= |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (=> (and (= $abort_code@2@@7 $EXEC_FAILURE_CODE) (= $abort_flag@1@@7 true)) (and (=> (= (ControlFlow 0 227094) 227042) anon25_Then_correct@@1) (=> (= (ControlFlow 0 227094) 227028) anon25_Else_correct@@1))))))
(let ((anon24_Then_correct@@1  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8)) (= (ControlFlow 0 227092) 227094)) anon24_Then$1_correct@@1)))
(let ((anon24_Else_correct@@1  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8))) (=> (and (and (= |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0| ($Memory_117894 (|Store__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8) true) (|Store__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t1@@8) $t28@0@@4))) (= |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0|)) (and (= $abort_code@2@@7 $abort_code@1@@8) (= $abort_flag@1@@7 $abort_flag@0@@8))) (and (=> (= (ControlFlow 0 226807) 227042) anon25_Then_correct@@1) (=> (= (ControlFlow 0 226807) 227028) anon25_Else_correct@@1))))))
(let ((anon23_Else_correct@@1  (=> (not $abort_flag@0@@8) (=> (and (and (|$IsValid'u64'| 0) (|$IsValid'u64'| 0)) (and (|$IsValid'u64'| 0) (= $t28@0@@4 (|$1_AccountLimits_Window'$1_XDX_XDX'| inline$$1_AccountLimits_current_time$0$$ret0@1@@1 0 0 0 _$t2@@1)))) (and (=> (= (ControlFlow 0 226785) 227092) anon24_Then_correct@@1) (=> (= (ControlFlow 0 226785) 226807) anon24_Else_correct@@1))))))
(let ((anon23_Then_correct@@1  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t12@0@@4 $abort_code@1@@8) (= (ControlFlow 0 227108) 226075))) L5_correct@@1)))
(let ((inline$$1_AccountLimits_current_time$0$L5_correct@@1  (=> (= $abort_flag@0@@8 true) (=> (and (= $abort_code@1@@8 inline$$1_AccountLimits_current_time$0$$t2@1@@1) (= inline$$1_AccountLimits_current_time$0$$ret0@1@@1 inline$$1_AccountLimits_current_time$0$$ret0@0@@1)) (and (=> (= (ControlFlow 0 226695) 227108) anon23_Then_correct@@1) (=> (= (ControlFlow 0 226695) 226785) anon23_Else_correct@@1))))))
(let ((inline$$1_AccountLimits_current_time$0$anon9_Then_correct@@1  (=> inline$$1_AccountLimits_current_time$0$$t5@0@@1 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_AccountLimits_current_time$0$$t2@0@@1)) (= inline$$1_AccountLimits_current_time$0$$t2@0@@1 inline$$1_AccountLimits_current_time$0$$t2@0@@1)) (and (= inline$$1_AccountLimits_current_time$0$$t2@1@@1 inline$$1_AccountLimits_current_time$0$$t2@0@@1) (= (ControlFlow 0 226689) 226695))) inline$$1_AccountLimits_current_time$0$L5_correct@@1))))
(let ((inline$$1_AccountLimits_current_time$0$L3_correct@@1  (=> (and (and (= inline$$1_AccountLimits_current_time$0$$t0@1@@1 inline$$1_AccountLimits_current_time$0$$t0@1@@1) (= $abort_flag@0@@8 false)) (and (= $abort_code@1@@8 $abort_code@0@@8) (= inline$$1_AccountLimits_current_time$0$$ret0@1@@1 inline$$1_AccountLimits_current_time$0$$t0@1@@1))) (and (=> (= (ControlFlow 0 226663) 227108) anon23_Then_correct@@1) (=> (= (ControlFlow 0 226663) 226785) anon23_Else_correct@@1)))))
(let ((inline$$1_AccountLimits_current_time$0$anon9_Else_correct@@1  (=> (and (not inline$$1_AccountLimits_current_time$0$$t5@0@@1) (|$IsValid'u64'| inline$$1_AccountLimits_current_time$0$$t4@0@@1)) (=> (and (and (= inline$$1_AccountLimits_current_time$0$$t4@0@@1 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= inline$$1_AccountLimits_current_time$0$$t4@0@@1 inline$$1_AccountLimits_current_time$0$$t4@0@@1)) (and (= inline$$1_AccountLimits_current_time$0$$t0@1@@1 inline$$1_AccountLimits_current_time$0$$t4@0@@1) (= (ControlFlow 0 226651) 226663))) inline$$1_AccountLimits_current_time$0$L3_correct@@1))))
(let ((inline$$1_AccountLimits_current_time$0$anon8_Else_correct@@1  (=> (and (not inline$$Not$1$dst@1@@1) (= inline$$1_AccountLimits_current_time$0$$t5@0@@1  (not (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 226625) 226689) inline$$1_AccountLimits_current_time$0$anon9_Then_correct@@1) (=> (= (ControlFlow 0 226625) 226651) inline$$1_AccountLimits_current_time$0$anon9_Else_correct@@1)))))
(let ((inline$$1_AccountLimits_current_time$0$anon8_Then_correct@@1  (=> inline$$Not$1$dst@1@@1 (=> (and (and (|$IsValid'u64'| 0) (= 0 0)) (and (= inline$$1_AccountLimits_current_time$0$$t0@1@@1 0) (= (ControlFlow 0 226713) 226663))) inline$$1_AccountLimits_current_time$0$L3_correct@@1))))
(let ((inline$$1_AccountLimits_current_time$0$anon7_Else_correct@@1  (=> (not false) (and (=> (= (ControlFlow 0 226609) 226713) inline$$1_AccountLimits_current_time$0$anon8_Then_correct@@1) (=> (= (ControlFlow 0 226609) 226625) inline$$1_AccountLimits_current_time$0$anon8_Else_correct@@1)))))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct@@1  (=> (= inline$$Not$1$dst@1@@1 inline$$Not$1$dst@1@@1) (and (=> (= (ControlFlow 0 226595) 226727) inline$$1_AccountLimits_current_time$0$anon7_Then_correct@@1) (=> (= (ControlFlow 0 226595) 226609) inline$$1_AccountLimits_current_time$0$anon7_Else_correct@@1)))))
(let ((inline$$Not$1$anon0_correct@@1  (=> (and (= inline$$Not$1$dst@1@@1  (not inline$$1_DiemTimestamp_is_genesis$0$$t1@1@@1)) (= (ControlFlow 0 226577) 226595)) inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct@@1)))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0_correct@@1  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_genesis$0$$t1@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 226583) 226577)) inline$$Not$1$anon0_correct@@1))))
(let ((inline$$1_AccountLimits_current_time$0$anon0_correct@@1  (=> (= (ControlFlow 0 226601) 226583) inline$$1_DiemTimestamp_is_genesis$0$anon0_correct@@1)))
(let ((anon22_Then_correct@@1  (=> (and inline$$Not$0$dst@1@@2 (= (ControlFlow 0 226733) 226601)) inline$$1_AccountLimits_current_time$0$anon0_correct@@1)))
(let ((anon22_Else_correct@@1  (=> (and (and (not inline$$Not$0$dst@1@@2) (= $t23@@4 $t23@@4)) (and (= $t12@0@@4 $t23@@4) (= (ControlFlow 0 226249) 226075))) L5_correct@@1)))
(let ((anon21_Else$1_correct@@1  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23@@4) (= $t23@@4 6)) (and (= $t23@@4 $t23@@4) (= inline$$Not$0$dst@1@@2 inline$$Not$0$dst@1@@2))) (and (=> (= (ControlFlow 0 226233) 226733) anon22_Then_correct@@1) (=> (= (ControlFlow 0 226233) 226249) anon22_Else_correct@@1))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (and (= inline$$Not$0$dst@1@@2  (not $t20@0@@4)) (= (ControlFlow 0 226193) 226233)) anon21_Else$1_correct@@1)))
(let ((anon21_Else_correct@@1  (=> (not $t18@@4) (=> (and (and (|$IsValid'address'| $t19@@4) (= $t19@@4 (|$addr#$signer| _$t1@@8))) (and (= $t20@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) $t19@@4)) (= (ControlFlow 0 226199) 226193))) inline$$Not$0$anon0_correct@@2))))
(let ((anon21_Then_correct@@1  (=> $t18@@4 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t16@@7)) (= 5 $t12@@1)) (and (and (not (= $t17@@4 5)) (not (= $t17@@4 6))) (= 3 $t12@@1))) (= $t12@@1 $t12@@1)) (and (= $t12@0@@4 $t12@@1) (= (ControlFlow 0 227164) 226075))) L5_correct@@1))))
(let ((anon20_Then_correct@@1  (=> (and (and $t13@0@@5 (= $t16@@7 (|$addr#$signer| _$t1@@8))) (and (= $t17@@4 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t16@@7))) (= $t18@@4  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t16@@7)) (and (not (= $t17@@4 5)) (not (= $t17@@4 6))))))) (and (=> (= (ControlFlow 0 226137) 227164) anon21_Then_correct@@1) (=> (= (ControlFlow 0 226137) 226199) anon21_Else_correct@@1)))))
(let ((anon20_Else_correct@@1  (=> (and (and (not $t13@0@@5) (= $t15@@4 $t15@@4)) (and (= $t12@0@@4 $t15@@4) (= (ControlFlow 0 225839) 226075))) L5_correct@@1)))
(let ((anon19_Else_correct@@1  (=> (not $t11@@1) (=> (and (= $t13@0@@5 (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t2@@1)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t15@@4) (= $t15@@4 5)) (and (= $t15@@4 $t15@@4) (= $t13@0@@5 $t13@0@@5))) (and (=> (= (ControlFlow 0 225823) 226137) anon20_Then_correct@@1) (=> (= (ControlFlow 0 225823) 225839) anon20_Else_correct@@1)))))))
(let ((anon19_Then_correct@@1  (=> $t11@@1 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t12@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t10@@1)) (= 5 $t12@@1))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t10@@1)) 0)) (= 3 $t12@@1))) (and (not (= (|$addr#$signer| _$t0@@11) 173345816)) (= 2 $t12@@1))) (= $t12@@1 $t12@@1)) (and (= $t12@0@@4 $t12@@1) (= (ControlFlow 0 227256) 226075))) L5_correct@@1))))
(let ((anon0$1_correct@@11  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@125)) 0)) (= addr@@125 173345816)))
 :qid |AccountLimitsbpl.11128:20|
 :skolemid |299|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@126)) 1)) (= addr@@126 186537453)))
 :qid |AccountLimitsbpl.11136:20|
 :skolemid |300|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@127)) 2))))))
 :qid |AccountLimitsbpl.11144:20|
 :skolemid |301|
)) (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@128)) 2))))))
 :qid |AccountLimitsbpl.11148:20|
 :skolemid |302|
)))) (and (and (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@129)) 2))))))
 :qid |AccountLimitsbpl.11152:20|
 :skolemid |303|
)) (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@130)) 2))))))
 :qid |AccountLimitsbpl.11156:20|
 :skolemid |304|
))) (and (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@131)) 2)))))
 :qid |AccountLimitsbpl.11160:20|
 :skolemid |305|
)) (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@132)) 2)))))
 :qid |AccountLimitsbpl.11164:20|
 :skolemid |306|
))))) (=> (and (and (and (and (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@133)) 2)))))
 :qid |AccountLimitsbpl.11168:20|
 :skolemid |307|
)) (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@134) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@134)) 4))))
 :qid |AccountLimitsbpl.11172:20|
 :skolemid |308|
))) (and (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@135) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@135)) 3))))
 :qid |AccountLimitsbpl.11176:20|
 :skolemid |309|
)) (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@136)) 3))))
 :qid |AccountLimitsbpl.11180:20|
 :skolemid |310|
)))) (and (and (forall ((addr@@137 Int) ) (!  (=> (|$IsValid'address'| addr@@137) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@137) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@137)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@137)) 3))))
 :qid |AccountLimitsbpl.11184:20|
 :skolemid |311|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109463| $1_DiemConfig_Configuration_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_110594| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (let (($range_0@@1 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@138 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@138))))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i1@@1 $i_1@@1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@139 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@139)))) i1@@1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@139 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@139)))) i1@@1)))) 3))))
 :qid |AccountLimitsbpl.11204:151|
 :skolemid |312|
)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109562| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (forall ((window_addr@@20 Int) ) (!  (=> (|$IsValid'address'| window_addr@@20) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@20) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@20)))))
 :qid |AccountLimitsbpl.11213:20|
 :skolemid |313|
)))) (and (and (forall ((addr@@140 Int) ) (!  (=> (|$IsValid'address'| addr@@140) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@140) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@140) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@140)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@140)) 6)))))
 :qid |AccountLimitsbpl.11217:20|
 :skolemid |314|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_110931| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115201| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118553| $1_XDX_Reserve_$memory) 173345816)))))) (=> (and (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_110995| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (forall ((addr@@141 Int) ) (!  (=> (|$IsValid'address'| addr@@141) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@141) (= addr@@141 173345816)))
 :qid |AccountLimitsbpl.11241:20|
 :skolemid |315|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118699| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_106033| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |AccountLimitsbpl.11253:20|
 :skolemid |316|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109626| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118851| $1_ChainId_ChainId_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118922| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_106066| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_106066| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_106066| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_106066| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118922| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119094| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119165| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@142 Int) ) (!  (=> (|$IsValid'address'| addr@@142) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141421| $1_DiemAccount_DiemAccount_$memory) addr@@142) (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@142)))
 :qid |AccountLimitsbpl.11289:20|
 :skolemid |317|
)) (forall ((addr@@143 Int) ) (!  (=> (|$IsValid'address'| addr@@143) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141521| $1_VASPDomain_VASPDomainManager_$memory) addr@@143)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@143)) 1))))
 :qid |AccountLimitsbpl.11293:20|
 :skolemid |318|
)))))) (and (and (and (and (forall ((addr@@144 Int) ) (!  (=> (|$IsValid'address'| addr@@144) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141606| $1_VASPDomain_VASPDomains_$memory) addr@@144)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@144)) 5))))
 :qid |AccountLimitsbpl.11297:20|
 :skolemid |319|
)) (forall ((addr@@145 Int) ) (!  (=> (|$IsValid'address'| addr@@145) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@145) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@145)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@145)) 2)))))
 :qid |AccountLimitsbpl.11301:20|
 :skolemid |320|
))) (and (forall ((addr@@146 Int) ) (!  (=> (|$IsValid'address'| addr@@146) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141740| $1_DesignatedDealer_Dealer_$memory) addr@@146)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@146)) 2))))
 :qid |AccountLimitsbpl.11305:20|
 :skolemid |321|
)) (forall ((addr@@147 Int) ) (!  (=> (|$IsValid'address'| addr@@147) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr@@147)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@147)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@147)) 5)))))
 :qid |AccountLimitsbpl.11309:20|
 :skolemid |322|
)))) (and (and (forall ((addr@@148 Int) ) (!  (=> (|$IsValid'address'| addr@@148) (= (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) addr@@148)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@148)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@148)) 1)))))
 :qid |AccountLimitsbpl.11313:20|
 :skolemid |323|
)) (forall ((addr@@149 Int) ) (!  (=> (|$IsValid'address'| addr@@149) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@149)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@149)) 3))))
 :qid |AccountLimitsbpl.11317:20|
 :skolemid |324|
))) (and (forall ((addr@@150 Int) ) (!  (=> (|$IsValid'address'| addr@@150) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@150)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@150)) 4))))
 :qid |AccountLimitsbpl.11321:20|
 :skolemid |325|
)) (forall ((addr@@151 Int) ) (!  (=> (|$IsValid'address'| addr@@151) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141995| $1_VASP_ParentVASP_$memory) addr@@151)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@151)) 5))))
 :qid |AccountLimitsbpl.11325:20|
 :skolemid |326|
))))) (and (and (and (forall ((addr@@152 Int) ) (!  (=> (|$IsValid'address'| addr@@152) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142095| $1_VASP_ChildVASP_$memory) addr@@152)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@152)) 6))))
 :qid |AccountLimitsbpl.11329:20|
 :skolemid |327|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119236| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109690| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109754| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@11)) ($1_Signer_is_txn_signer _$t0@@11)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@11)))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1@@8)) ($1_Signer_is_txn_signer _$t1@@8)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1@@8))) (|$IsValid'address'| _$t2@@1)) (and (and (forall (($a_0@@23 Int) ) (! (let (($rsc@@23 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@23)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@23))
 :qid |AccountLimitsbpl.11353:20|
 :skolemid |328|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@23))
)) (forall (($a_0@@24 Int) ) (! (let (($rsc@@24 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@24)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@24))
 :qid |AccountLimitsbpl.11357:20|
 :skolemid |329|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@24))
))) (and (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@25)))
 (and (|$IsValid'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''| $rsc@@25) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@25) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@25) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@25) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@25) 0))))
 :qid |AccountLimitsbpl.11361:20|
 :skolemid |330|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@25))
)) (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) $a_0@@26)))
(|$IsValid'$1_AccountLimits_Window'$1_XDX_XDX''| $rsc@@26))
 :qid |AccountLimitsbpl.11365:20|
 :skolemid |331|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) $a_0@@26))
))))) (and (and (and (= $t7@@1 (|$addr#$signer| _$t1@@8)) (= $t8@@1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@1)))) (and (= $t9@@2 (|$addr#$signer| _$t0@@11)) (= _$t0@@11 _$t0@@11))) (and (and (= _$t1@@8 _$t1@@8) (= _$t2@@1 _$t2@@1)) (and (= $t10@@1 (|$addr#$signer| _$t0@@11)) (= $t11@@1  (or (or (or (not (= (|$addr#$signer| _$t0@@11) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t10@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t10@@1)) 0))) (not (= (|$addr#$signer| _$t0@@11) 173345816))))))))) (and (=> (= (ControlFlow 0 225781) 227256) anon19_Then_correct@@1) (=> (= (ControlFlow 0 225781) 225823) anon19_Else_correct@@1)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@11  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_81090| stream@@12) 0) (forall ((v@@41 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@12) v@@41) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 224420) 225781)) anon0$1_correct@@11)))
(let ((anon0_correct@@11  (=> (= (ControlFlow 0 278439) 224420) inline$$InitEventStore$0$anon0_correct@@11)))
anon0_correct@@11))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
