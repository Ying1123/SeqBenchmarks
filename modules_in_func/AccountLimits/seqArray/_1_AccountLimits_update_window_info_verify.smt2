...
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_update_window_info$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 294176) (let ((anon17_Else_correct@@0  (=> (and (not $t14@0@@2) (= |$1_AccountLimits_Window'#0'_$memory@1@@0| ($Memory_116863 (|Store__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) (|a#$Global| (|l#$Mutation_119553| $t10@3)) true) (|Store__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) (|a#$Global| (|l#$Mutation_119553| $t10@3)) (|v#$Mutation_119553| $t10@3))))) (and (=> (= (ControlFlow 0 243779) (- 0 295759)) (forall ((window_addr@@51 Int) ) (!  (=> (|$IsValid'address'| window_addr@@51) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@51) (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@51)))
 :qid |AccountLimitsbpl.15427:15|
 :skolemid |498|
))) (=> (forall ((window_addr@@52 Int) ) (!  (=> (|$IsValid'address'| window_addr@@52) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@52) (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@52)))
 :qid |AccountLimitsbpl.15427:15|
 :skolemid |498|
)) (and (=> (= (ControlFlow 0 243779) (- 0 295783)) (forall ((window_addr@@53 Int) ) (!  (=> (|$IsValid'address'| window_addr@@53) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@53) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@53)))))
 :qid |AccountLimitsbpl.15433:15|
 :skolemid |499|
))) (=> (forall ((window_addr@@54 Int) ) (!  (=> (|$IsValid'address'| window_addr@@54) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@54) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) window_addr@@54)))))
 :qid |AccountLimitsbpl.15433:15|
 :skolemid |499|
)) (=> (= (ControlFlow 0 243779) (- 0 295813)) (forall ((addr@@264 Int) ) (!  (=> (|$IsValid'address'| addr@@264) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@1@@0|) addr@@264) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@264) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@264)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@264)) 6)))))
 :qid |AccountLimitsbpl.15439:15|
 :skolemid |500|
))))))))))
(let ((anon17_Then_correct@@0  (=> $t14@0@@2 (=> (and (and (= $t17@0@@4 ($Mutation_10128 (|l#$Mutation_119553| $t10@3) (seq.++ (|p#$Mutation_119553| $t10@3) (seq.unit 4)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@3)))) (= $t17@1 ($Mutation_10128 (|l#$Mutation_10128| $t17@0@@4) (|p#$Mutation_10128| $t17@0@@4) _$t3@@2))) (and (= $t10@4 ($Mutation_119553 (|l#$Mutation_119553| $t10@3) (|p#$Mutation_119553| $t10@3) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@3)) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@3)) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@3)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@3)) (|v#$Mutation_10128| $t17@1)))) (= |$1_AccountLimits_Window'#0'_$memory@0@@1| ($Memory_116863 (|Store__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) (|a#$Global| (|l#$Mutation_119553| $t10@4)) true) (|Store__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) (|a#$Global| (|l#$Mutation_119553| $t10@4)) (|v#$Mutation_119553| $t10@4)))))) (and (=> (= (ControlFlow 0 243950) (- 0 295621)) (forall ((window_addr@@55 Int) ) (!  (=> (|$IsValid'address'| window_addr@@55) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@55) (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@55)))
 :qid |AccountLimitsbpl.15481:15|
 :skolemid |501|
))) (=> (forall ((window_addr@@56 Int) ) (!  (=> (|$IsValid'address'| window_addr@@56) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@56) (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@56)))
 :qid |AccountLimitsbpl.15481:15|
 :skolemid |501|
)) (and (=> (= (ControlFlow 0 243950) (- 0 295645)) (forall ((window_addr@@57 Int) ) (!  (=> (|$IsValid'address'| window_addr@@57) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@57) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@57)))))
 :qid |AccountLimitsbpl.15487:15|
 :skolemid |502|
))) (=> (forall ((window_addr@@58 Int) ) (!  (=> (|$IsValid'address'| window_addr@@58) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@58) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) window_addr@@58)))))
 :qid |AccountLimitsbpl.15487:15|
 :skolemid |502|
)) (=> (= (ControlFlow 0 243950) (- 0 295675)) (forall ((addr@@265 Int) ) (!  (=> (|$IsValid'address'| addr@@265) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory@0@@1|) addr@@265) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@265) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@265)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@265)) 6)))))
 :qid |AccountLimitsbpl.15493:15|
 :skolemid |503|
)))))))))))
(let ((L2_correct@@0  (=> (and (= $t14@0@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) _$t3@@2)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t16@@8) (= $t16@@8 5)) (and (= $t16@@8 $t16@@8) (= $t14@0@@2 $t14@0@@2))) (and (=> (= (ControlFlow 0 243634) 243950) anon17_Then_correct@@0) (=> (= (ControlFlow 0 243634) 243779) anon17_Else_correct@@0))))))
(let ((anon16_Else_correct@@0  (=> (not $t12@0@@8) (=> (and (= $t10@3 $t10@1) (= (ControlFlow 0 243598) 243634)) L2_correct@@0))))
(let ((anon16_Then_correct@@0  (=> (and $t12@0@@8 (= $t13@0@@6 ($Mutation_10128 (|l#$Mutation_119553| $t10@1) (seq.++ (|p#$Mutation_119553| $t10@1) (seq.unit 3)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@1))))) (=> (and (and (= $t13@1 ($Mutation_10128 (|l#$Mutation_10128| $t13@0@@6) (|p#$Mutation_10128| $t13@0@@6) _$t2@@8)) (= $t10@2 ($Mutation_119553 (|l#$Mutation_119553| $t10@1) (|p#$Mutation_119553| $t10@1) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@1)) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@1)) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@1)) (|v#$Mutation_10128| $t13@1) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_119553| $t10@1)))))) (and (= $t10@3 $t10@2) (= (ControlFlow 0 243988) 243634))) L2_correct@@0))))
(let ((anon15_Else_correct@@3  (=> (not $abort_flag@0@@16) (=> (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0@@3| (|v#$Mutation_119553| $t10@1)) (= |$temp_0'$1_AccountLimits_Window'#0''@0@@3| |$temp_0'$1_AccountLimits_Window'#0''@0@@3|)) (and (|$IsValid'u64'| 0) (= $t12@0@@8  (not (= _$t2@@8 0))))) (and (=> (= (ControlFlow 0 243592) 243988) anon16_Then_correct@@0) (=> (= (ControlFlow 0 243592) 243598) anon16_Else_correct@@0))))))
(let ((anon15_Then_correct@@3 true))
(let ((anon14_Then$1_correct  (=> (= $t10@1 $t10@@8) (=> (and (= $abort_flag@0@@16 true) (= $abort_code@1@@16 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 244054) 244002) anon15_Then_correct@@3) (=> (= (ControlFlow 0 244054) 243592) anon15_Else_correct@@3))))))
(let ((anon14_Then_correct@@2  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t1@@16)) (= (ControlFlow 0 244052) 244054)) anon14_Then$1_correct)))
(let ((anon14_Else_correct@@2  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t1@@16) (=> (and (and (= $t10@0@@3 ($Mutation_119553 ($Global _$t1@@16) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) _$t1@@16))) (= $t10@1 $t10@0@@3)) (and (= $abort_flag@0@@16 false) (= $abort_code@1@@16 $abort_code@0@@16))) (and (=> (= (ControlFlow 0 243558) 244002) anon15_Then_correct@@3) (=> (= (ControlFlow 0 243558) 243592) anon15_Else_correct@@3))))))
(let ((anon13_Else_correct@@2  (=> (not $t8@@9) (and (=> (= (ControlFlow 0 243536) 244052) anon14_Then_correct@@2) (=> (= (ControlFlow 0 243536) 243558) anon14_Else_correct@@2)))))
(let ((anon13_Then_correct@@2 true))
(let ((anon0$1_correct@@19  (=> (and (forall ((addr@@266 Int) ) (!  (=> (|$IsValid'address'| addr@@266) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@266) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@266)) 0)) (= addr@@266 173345816)))
 :qid |AccountLimitsbpl.15147:20|
 :skolemid |467|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (forall ((addr@@267 Int) ) (!  (=> (|$IsValid'address'| addr@@267) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@267) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@267)) 1)) (= addr@@267 186537453)))
 :qid |AccountLimitsbpl.15155:20|
 :skolemid |468|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@268 Int) ) (!  (=> (|$IsValid'address'| addr@@268) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@268)) 2))))))
 :qid |AccountLimitsbpl.15163:20|
 :skolemid |469|
)) (forall ((addr@@269 Int) ) (!  (=> (|$IsValid'address'| addr@@269) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@269)) 2))))))
 :qid |AccountLimitsbpl.15167:20|
 :skolemid |470|
)))) (=> (and (and (and (forall ((addr@@270 Int) ) (!  (=> (|$IsValid'address'| addr@@270) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@270)) 2))))))
 :qid |AccountLimitsbpl.15171:20|
 :skolemid |471|
)) (forall ((addr@@271 Int) ) (!  (=> (|$IsValid'address'| addr@@271) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@271)) 2))))))
 :qid |AccountLimitsbpl.15175:20|
 :skolemid |472|
))) (and (forall ((addr@@272 Int) ) (!  (=> (|$IsValid'address'| addr@@272) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@272)) 2)))))
 :qid |AccountLimitsbpl.15179:20|
 :skolemid |473|
)) (forall ((addr@@273 Int) ) (!  (=> (|$IsValid'address'| addr@@273) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@273)) 2)))))
 :qid |AccountLimitsbpl.15183:20|
 :skolemid |474|
)))) (and (and (forall ((addr@@274 Int) ) (!  (=> (|$IsValid'address'| addr@@274) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@274)) 2)))))
 :qid |AccountLimitsbpl.15187:20|
 :skolemid |475|
)) (forall ((addr@@275 Int) ) (!  (=> (|$IsValid'address'| addr@@275) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@275) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@275) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@275)) 4))))
 :qid |AccountLimitsbpl.15191:20|
 :skolemid |476|
))) (and (forall ((addr@@276 Int) ) (!  (=> (|$IsValid'address'| addr@@276) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@276) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@276) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@276)) 3))))
 :qid |AccountLimitsbpl.15195:20|
 :skolemid |477|
)) (forall ((addr@@277 Int) ) (!  (=> (|$IsValid'address'| addr@@277) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@277) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@277) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@277)) 3))))
 :qid |AccountLimitsbpl.15199:20|
 :skolemid |478|
))))) (=> (and (and (and (and (and (forall ((addr@@278 Int) ) (!  (=> (|$IsValid'address'| addr@@278) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@278) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@278)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@278) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@278)) 3))))
 :qid |AccountLimitsbpl.15203:20|
 :skolemid |479|
)) (let (($range_0@@5 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@279 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@279))))))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i1@@5 $i_1@@5))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@280 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@280)))) i1@@5))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@280 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@280)))) i1@@5)))) 3))))
 :qid |AccountLimitsbpl.15207:151|
 :skolemid |480|
)))) (and (forall ((window_addr@@59 Int) ) (!  (=> (|$IsValid'address'| window_addr@@59) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@59) (|Select__T@[Int]Bool_| (|domain#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) window_addr@@59)))))
 :qid |AccountLimitsbpl.15212:20|
 :skolemid |481|
)) (forall ((addr@@281 Int) ) (!  (=> (|$IsValid'address'| addr@@281) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) addr@@281) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@281) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@281)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@281)) 6)))))
 :qid |AccountLimitsbpl.15216:20|
 :skolemid |482|
)))) (and (and (forall ((addr1@@9 Int) ) (!  (=> (|$IsValid'address'| addr1@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1@@9) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@9)) 2)))))
 :qid |AccountLimitsbpl.15220:20|
 :skolemid |483|
)) (forall ((addr@@282 Int) ) (!  (=> (|$IsValid'address'| addr@@282) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141421| $1_DiemAccount_DiemAccount_$memory) addr@@282) (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@282)))
 :qid |AccountLimitsbpl.15224:20|
 :skolemid |484|
))) (and (forall ((addr@@283 Int) ) (!  (=> (|$IsValid'address'| addr@@283) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141521| $1_VASPDomain_VASPDomainManager_$memory) addr@@283)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@283) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@283)) 1))))
 :qid |AccountLimitsbpl.15228:20|
 :skolemid |485|
)) (forall ((addr@@284 Int) ) (!  (=> (|$IsValid'address'| addr@@284) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141606| $1_VASPDomain_VASPDomains_$memory) addr@@284)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@284) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@284)) 5))))
 :qid |AccountLimitsbpl.15232:20|
 :skolemid |486|
))))) (and (and (and (forall ((addr@@285 Int) ) (!  (=> (|$IsValid'address'| addr@@285) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@285) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@285)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@285)) 2)))))
 :qid |AccountLimitsbpl.15236:20|
 :skolemid |487|
)) (forall ((addr@@286 Int) ) (!  (=> (|$IsValid'address'| addr@@286) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141740| $1_DesignatedDealer_Dealer_$memory) addr@@286)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@286) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@286)) 2))))
 :qid |AccountLimitsbpl.15240:20|
 :skolemid |488|
))) (and (forall ((addr@@287 Int) ) (!  (=> (|$IsValid'address'| addr@@287) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr@@287)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@287) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@287)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@287) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@287)) 5)))))
 :qid |AccountLimitsbpl.15244:20|
 :skolemid |489|
)) (forall ((addr@@288 Int) ) (!  (=> (|$IsValid'address'| addr@@288) (= (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) addr@@288)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@288) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@288)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@288) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@288)) 1)))))
 :qid |AccountLimitsbpl.15248:20|
 :skolemid |490|
)))) (and (and (forall ((addr@@289 Int) ) (!  (=> (|$IsValid'address'| addr@@289) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@289)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@289) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@289)) 3))))
 :qid |AccountLimitsbpl.15252:20|
 :skolemid |491|
)) (forall ((addr@@290 Int) ) (!  (=> (|$IsValid'address'| addr@@290) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@290)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@290) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@290)) 4))))
 :qid |AccountLimitsbpl.15256:20|
 :skolemid |492|
))) (and (forall ((addr@@291 Int) ) (!  (=> (|$IsValid'address'| addr@@291) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141995| $1_VASP_ParentVASP_$memory) addr@@291)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@291) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@291)) 5))))
 :qid |AccountLimitsbpl.15260:20|
 :skolemid |493|
)) (forall ((addr@@292 Int) ) (!  (=> (|$IsValid'address'| addr@@292) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142095| $1_VASP_ChildVASP_$memory) addr@@292)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@292) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@292)) 6))))
 :qid |AccountLimitsbpl.15264:20|
 :skolemid |494|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@19)) ($1_Signer_is_txn_signer _$t0@@19)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@19))) (and (and (|$IsValid'address'| _$t1@@16) (|$IsValid'u64'| _$t2@@8)) (and (|$IsValid'address'| _$t3@@2) (forall (($a_0@@43 Int) ) (! (let (($rsc@@43 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@43)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@43))
 :qid |AccountLimitsbpl.15279:20|
 :skolemid |495|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@43))
))))) (and (and (and (forall (($a_0@@44 Int) ) (! (let (($rsc@@44 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@44)))
 (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| $rsc@@44) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| $rsc@@44) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| $rsc@@44) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| $rsc@@44) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| $rsc@@44) 0))))
 :qid |AccountLimitsbpl.15283:20|
 :skolemid |496|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'#0'_| (|contents#$Memory_115349| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) $a_0@@44))
)) (forall (($a_0@@45 Int) ) (! (let (($rsc@@45 (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@45)))
(|$IsValid'$1_AccountLimits_Window'#0''| $rsc@@45))
 :qid |AccountLimitsbpl.15287:20|
 :skolemid |497|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_116863| |$1_AccountLimits_Window'#0'_$memory|) $a_0@@45))
))) (and (= _$t0@@19 _$t0@@19) (= _$t1@@16 _$t1@@16))) (and (and (= _$t2@@8 _$t2@@8) (= _$t3@@2 _$t3@@2)) (and (= $t7@@6 (|$addr#$signer| _$t0@@19)) (= $t8@@9  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@6)) 1))) (not (= (|$addr#$signer| _$t0@@19) 186537453))))))))) (and (=> (= (ControlFlow 0 243528) 244126) anon13_Then_correct@@2) (=> (= (ControlFlow 0 243528) 243536) anon13_Else_correct@@2))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@21 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@21)))
 (and (= (|l#Multiset_81090| stream@@20) 0) (forall ((v@@49 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@20) v@@49) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 242542) 243528)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (seq.len (|p#$Mutation_119553| $t6@@0)) 0) (=> (and (and (= (seq.len (|p#$Mutation_119553| $t10@@8)) 0) (= (seq.len (|p#$Mutation_10128| $t13@@2)) 0)) (and (= (seq.len (|p#$Mutation_10128| $t17@@5)) 0) (= (ControlFlow 0 242552) 242542))) inline$$InitEventStore$0$anon0_correct@@19))))
(let ((PreconditionGeneratedEntry_correct@@12  (=> (= (ControlFlow 0 294176) 242552) anon0_correct@@19)))
