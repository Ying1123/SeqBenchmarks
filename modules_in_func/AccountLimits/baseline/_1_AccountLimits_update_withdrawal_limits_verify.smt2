...
(assert (not
 ...
 :qid |AccountLimitsbpl.16722:15|
 :skolemid |603|
)) (and (=> (= (ControlFlow 0 258051) (- 0 312916)) (forall ((window_addr@@1 Int) ) (!  (=> (|$IsValid'address'| window_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory@0|) window_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_122943| |$1_AccountLimits_LimitsDefinition'#0'_$memory|) (|$limit_address#$1_AccountLimits_Window'#0'| (|Select__T@[Int]$1_AccountLimits_Window'#0'_| (|contents#$Memory_124457| |$1_AccountLimits_Window'#0'_$memory@0|) window_addr@@1)))))
 :qid |AccountLimitsbpl.16728:15|
 :skolemid |604|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 256518) 257098)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_18658| (|p#$Mutation_127147| $t9)) 0) (= (ControlFlow 0 256528) 256518)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 311504) 256528) anon0_correct)))
