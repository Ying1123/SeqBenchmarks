...
(declare-fun $t17@0@@4 () T@$Mutation_10128)
(declare-fun $t17@1 () T@$Mutation_10128)
(declare-fun _$t3@@2 () Int)
(declare-fun $t10@4 () T@$Mutation_119553)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@0@@1| () T@$Memory_116863)
(declare-fun $t16@@8 () Int)
(declare-fun $t12@0@@8 () Bool)
(declare-fun $t10@1 () T@$Mutation_119553)
(declare-fun $t13@0@@6 () T@$Mutation_10128)
(declare-fun $t13@1 () T@$Mutation_10128)
(declare-fun _$t2@@8 () Int)
(declare-fun $t10@2 () T@$Mutation_119553)
(declare-fun $abort_flag@0@@16 () Bool)
(declare-fun |$temp_0'$1_AccountLimits_Window'#0''@0@@3| () |T@$1_AccountLimits_Window'#0'|)
(declare-fun $t10@@8 () T@$Mutation_119553)
(declare-fun $abort_code@1@@16 () Int)
(declare-fun _$t1@@16 () Int)
(declare-fun $t10@0@@3 () T@$Mutation_119553)
(declare-fun $abort_code@0@@16 () Int)
(declare-fun $t8@@9 () Bool)
(declare-fun _$t0@@19 () T@$signer)
(declare-fun $t7@@6 () Int)
(declare-fun $t6@@0 () T@$Mutation_119553)
(declare-fun $t13@@2 () T@$Mutation_10128)
(declare-fun $t17@@5 () T@$Mutation_10128)
; Valid
(declare-fun $t14@0@@3 () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@1@@0| () T@$Memory_117706)
(declare-fun $t10@3@@0 () T@$Mutation_122739)
(declare-fun $t17@0@@5 () T@$Mutation_10128)
(declare-fun $t17@1@@0 () T@$Mutation_10128)
(declare-fun _$t3@@3 () Int)
(declare-fun $t10@4@@0 () T@$Mutation_122739)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0@@1| () T@$Memory_117706)
(declare-fun $t16@@9 () Int)
(declare-fun $t12@0@@9 () Bool)
(declare-fun $t10@1@@0 () T@$Mutation_122739)
(declare-fun $t13@0@@7 () T@$Mutation_10128)
(declare-fun $t13@1@@0 () T@$Mutation_10128)
(declare-fun _$t2@@9 () Int)
(declare-fun $t10@2@@0 () T@$Mutation_122739)
(declare-fun $abort_flag@0@@17 () Bool)
(declare-fun |$temp_0'$1_AccountLimits_Window'$1_XUS_XUS''@0@@2| () |T@$1_AccountLimits_Window'$1_XUS_XUS'|)
(declare-fun $t10@@9 () T@$Mutation_122739)
(declare-fun $abort_code@1@@17 () Int)
(declare-fun _$t1@@17 () Int)
(declare-fun $t10@0@@4 () T@$Mutation_122739)
(declare-fun $abort_code@0@@17 () Int)
(declare-fun $t8@@10 () Bool)
(declare-fun _$t0@@20 () T@$signer)
(declare-fun $t7@@7 () Int)
(declare-fun $t6@@1 () T@$Mutation_122739)
(declare-fun $t13@@3 () T@$Mutation_10128)
(declare-fun $t17@@6 () T@$Mutation_10128)
; Valid
(declare-fun $t14@0@@4 () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0| () T@$Memory_117894)
(declare-fun $t10@3@@1 () T@$Mutation_125912)
(declare-fun $t17@0@@6 () T@$Mutation_10128)
(declare-fun $t17@1@@1 () T@$Mutation_10128)
(declare-fun _$t3@@4 () Int)
(declare-fun $t10@4@@1 () T@$Mutation_125912)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1| () T@$Memory_117894)
(declare-fun $t16@@10 () Int)
(declare-fun $t12@0@@10 () Bool)
(declare-fun $t10@1@@1 () T@$Mutation_125912)
(declare-fun $t13@0@@8 () T@$Mutation_10128)
(declare-fun $t13@1@@1 () T@$Mutation_10128)
(declare-fun _$t2@@10 () Int)
(declare-fun $t10@2@@1 () T@$Mutation_125912)
(declare-fun $abort_flag@0@@18 () Bool)
(declare-fun |$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@0@@2| () |T@$1_AccountLimits_Window'$1_XDX_XDX'|)
(declare-fun $t10@@10 () T@$Mutation_125912)
(declare-fun $abort_code@1@@18 () Int)
(declare-fun _$t1@@18 () Int)
(declare-fun $t10@0@@5 () T@$Mutation_125912)
(declare-fun $abort_code@0@@18 () Int)
(declare-fun $t8@@11 () Bool)
(declare-fun _$t0@@21 () T@$signer)
(declare-fun $t7@@8 () Int)
(declare-fun $t6@@2 () T@$Mutation_125912)
(declare-fun $t13@@4 () T@$Mutation_10128)
(declare-fun $t17@@7 () T@$Mutation_10128)
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_update_window_info$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 297651) (let ((anon17_Else_correct@@2  (=> (and (not $t14@0@@4) (= |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0| ($Memory_117894 (|Store__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_125912| $t10@3@@1)) true) (|Store__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_125912| $t10@3@@1)) (|v#$Mutation_125912| $t10@3@@1))))) (and (=> (= (ControlFlow 0 247528) (- 0 299269)) (forall ((window_addr@@69 Int) ) (!  (=> (|$IsValid'address'| window_addr@@69) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@69) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@69)))
 :qid |AccountLimitsbpl.16267:15|
 :skolemid |574|
))) (=> (forall ((window_addr@@70 Int) ) (!  (=> (|$IsValid'address'| window_addr@@70) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@70) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@70)))
 :qid |AccountLimitsbpl.16267:15|
 :skolemid |574|
)) (and (=> (= (ControlFlow 0 247528) (- 0 299293)) (forall ((window_addr@@71 Int) ) (!  (=> (|$IsValid'address'| window_addr@@71) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@71) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@71)))))
 :qid |AccountLimitsbpl.16273:15|
 :skolemid |575|
))) (=> (forall ((window_addr@@72 Int) ) (!  (=> (|$IsValid'address'| window_addr@@72) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@72) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) window_addr@@72)))))
 :qid |AccountLimitsbpl.16273:15|
 :skolemid |575|
)) (=> (= (ControlFlow 0 247528) (- 0 299323)) (forall ((addr@@323 Int) ) (!  (=> (|$IsValid'address'| addr@@323) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@0|) addr@@323) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@323) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@323)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@323)) 6)))))
 :qid |AccountLimitsbpl.16279:15|
 :skolemid |576|
))))))))))
(let ((anon17_Then_correct@@2  (=> $t14@0@@4 (=> (and (and (= $t17@0@@6 ($Mutation_10128 (|l#$Mutation_125912| $t10@3@@1) (seq.++ (|p#$Mutation_125912| $t10@3@@1) (seq.unit 4)) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@3@@1)))) (= $t17@1@@1 ($Mutation_10128 (|l#$Mutation_10128| $t17@0@@6) (|p#$Mutation_10128| $t17@0@@6) _$t3@@4))) (and (= $t10@4@@1 ($Mutation_125912 (|l#$Mutation_125912| $t10@3@@1) (|p#$Mutation_125912| $t10@3@@1) (|$1_AccountLimits_Window'$1_XDX_XDX'| (|$window_start#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@3@@1)) (|$window_inflow#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@3@@1)) (|$window_outflow#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@3@@1)) (|$tracked_balance#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@3@@1)) (|v#$Mutation_10128| $t17@1@@1)))) (= |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1| ($Memory_117894 (|Store__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_125912| $t10@4@@1)) true) (|Store__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_125912| $t10@4@@1)) (|v#$Mutation_125912| $t10@4@@1)))))) (and (=> (= (ControlFlow 0 247699) (- 0 299131)) (forall ((window_addr@@73 Int) ) (!  (=> (|$IsValid'address'| window_addr@@73) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@73) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@73)))
 :qid |AccountLimitsbpl.16321:15|
 :skolemid |577|
))) (=> (forall ((window_addr@@74 Int) ) (!  (=> (|$IsValid'address'| window_addr@@74) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@74) (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@74)))
 :qid |AccountLimitsbpl.16321:15|
 :skolemid |577|
)) (and (=> (= (ControlFlow 0 247699) (- 0 299155)) (forall ((window_addr@@75 Int) ) (!  (=> (|$IsValid'address'| window_addr@@75) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@75) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@75)))))
 :qid |AccountLimitsbpl.16327:15|
 :skolemid |578|
))) (=> (forall ((window_addr@@76 Int) ) (!  (=> (|$IsValid'address'| window_addr@@76) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@76) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) window_addr@@76)))))
 :qid |AccountLimitsbpl.16327:15|
 :skolemid |578|
)) (=> (= (ControlFlow 0 247699) (- 0 299185)) (forall ((addr@@324 Int) ) (!  (=> (|$IsValid'address'| addr@@324) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1|) addr@@324) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@324) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@324)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@324)) 6)))))
 :qid |AccountLimitsbpl.16333:15|
 :skolemid |579|
)))))))))))
(let ((L2_correct@@2  (=> (and (= $t14@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t3@@4)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t16@@10) (= $t16@@10 5)) (and (= $t16@@10 $t16@@10) (= $t14@0@@4 $t14@0@@4))) (and (=> (= (ControlFlow 0 247383) 247699) anon17_Then_correct@@2) (=> (= (ControlFlow 0 247383) 247528) anon17_Else_correct@@2))))))
(let ((anon16_Else_correct@@2  (=> (not $t12@0@@10) (=> (and (= $t10@3@@1 $t10@1@@1) (= (ControlFlow 0 247347) 247383)) L2_correct@@2))))
(let ((anon16_Then_correct@@2  (=> (and $t12@0@@10 (= $t13@0@@8 ($Mutation_10128 (|l#$Mutation_125912| $t10@1@@1) (seq.++ (|p#$Mutation_125912| $t10@1@@1) (seq.unit 3)) (|$tracked_balance#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@1@@1))))) (=> (and (and (= $t13@1@@1 ($Mutation_10128 (|l#$Mutation_10128| $t13@0@@8) (|p#$Mutation_10128| $t13@0@@8) _$t2@@10)) (= $t10@2@@1 ($Mutation_125912 (|l#$Mutation_125912| $t10@1@@1) (|p#$Mutation_125912| $t10@1@@1) (|$1_AccountLimits_Window'$1_XDX_XDX'| (|$window_start#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@1@@1)) (|$window_inflow#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@1@@1)) (|$window_outflow#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@1@@1)) (|v#$Mutation_10128| $t13@1@@1) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|v#$Mutation_125912| $t10@1@@1)))))) (and (= $t10@3@@1 $t10@2@@1) (= (ControlFlow 0 247737) 247383))) L2_correct@@2))))
(let ((anon15_Else_correct@@5  (=> (not $abort_flag@0@@18) (=> (and (and (= |$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@0@@2| (|v#$Mutation_125912| $t10@1@@1)) (= |$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@0@@2| |$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@0@@2|)) (and (|$IsValid'u64'| 0) (= $t12@0@@10  (not (= _$t2@@10 0))))) (and (=> (= (ControlFlow 0 247341) 247737) anon16_Then_correct@@2) (=> (= (ControlFlow 0 247341) 247347) anon16_Else_correct@@2))))))
(let ((anon15_Then_correct@@5 true))
(let ((anon14_Then$1_correct@@1  (=> (= $t10@1@@1 $t10@@10) (=> (and (= $abort_flag@0@@18 true) (= $abort_code@1@@18 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 247803) 247751) anon15_Then_correct@@5) (=> (= (ControlFlow 0 247803) 247341) anon15_Else_correct@@5))))))
(let ((anon14_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) _$t1@@18)) (= (ControlFlow 0 247801) 247803)) anon14_Then$1_correct@@1)))
(let ((anon14_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) _$t1@@18) (=> (and (and (= $t10@0@@5 ($Mutation_125912 ($Global _$t1@@18) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) _$t1@@18))) (= $t10@1@@1 $t10@0@@5)) (and (= $abort_flag@0@@18 false) (= $abort_code@1@@18 $abort_code@0@@18))) (and (=> (= (ControlFlow 0 247307) 247751) anon15_Then_correct@@5) (=> (= (ControlFlow 0 247307) 247341) anon15_Else_correct@@5))))))
(let ((anon13_Else_correct@@4  (=> (not $t8@@11) (and (=> (= (ControlFlow 0 247285) 247801) anon14_Then_correct@@4) (=> (= (ControlFlow 0 247285) 247307) anon14_Else_correct@@4)))))
(let ((anon13_Then_correct@@4 true))
(let ((anon0$1_correct@@21  (=> (and (and (and (and (forall ((addr@@325 Int) ) (!  (=> (|$IsValid'address'| addr@@325) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@325) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@325)) 0)) (= addr@@325 173345816)))
 :qid |AccountLimitsbpl.15979:20|
 :skolemid |542|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@326 Int) ) (!  (=> (|$IsValid'address'| addr@@326) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@326) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@326)) 1)) (= addr@@326 186537453)))
 :qid |AccountLimitsbpl.15987:20|
 :skolemid |543|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 186537453)) 1))))) (and (and (forall ((addr@@327 Int) ) (!  (=> (|$IsValid'address'| addr@@327) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@327)) 2))))))
 :qid |AccountLimitsbpl.15995:20|
 :skolemid |544|
)) (forall ((addr@@328 Int) ) (!  (=> (|$IsValid'address'| addr@@328) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@328)) 2))))))
 :qid |AccountLimitsbpl.15999:20|
 :skolemid |545|
))) (and (forall ((addr@@329 Int) ) (!  (=> (|$IsValid'address'| addr@@329) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@329)) 2))))))
 :qid |AccountLimitsbpl.16003:20|
 :skolemid |546|
)) (forall ((addr@@330 Int) ) (!  (=> (|$IsValid'address'| addr@@330) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@330)) 2))))))
 :qid |AccountLimitsbpl.16007:20|
 :skolemid |547|
))))) (and (and (and (forall ((addr@@331 Int) ) (!  (=> (|$IsValid'address'| addr@@331) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@331)) 2)))))
 :qid |AccountLimitsbpl.16011:20|
 :skolemid |548|
)) (forall ((addr@@332 Int) ) (!  (=> (|$IsValid'address'| addr@@332) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@332)) 2)))))
 :qid |AccountLimitsbpl.16015:20|
 :skolemid |549|
))) (and (forall ((addr@@333 Int) ) (!  (=> (|$IsValid'address'| addr@@333) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@333)) 2)))))
 :qid |AccountLimitsbpl.16019:20|
 :skolemid |550|
)) (forall ((addr@@334 Int) ) (!  (=> (|$IsValid'address'| addr@@334) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@334) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@334) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@334)) 4))))
 :qid |AccountLimitsbpl.16023:20|
 :skolemid |551|
)))) (and (and (forall ((addr@@335 Int) ) (!  (=> (|$IsValid'address'| addr@@335) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@335) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@335) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@335)) 3))))
 :qid |AccountLimitsbpl.16027:20|
 :skolemid |552|
)) (forall ((addr@@336 Int) ) (!  (=> (|$IsValid'address'| addr@@336) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@336) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@336) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@336)) 3))))
 :qid |AccountLimitsbpl.16031:20|
 :skolemid |553|
))) (and (forall ((addr@@337 Int) ) (!  (=> (|$IsValid'address'| addr@@337) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@337) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@337)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@337) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@337)) 3))))
 :qid |AccountLimitsbpl.16035:20|
 :skolemid |554|
)) (let (($range_0@@7 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@338 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@338))))))))
(forall (($i_1@@7 Int) ) (!  (=> ($InRange $range_0@@7 $i_1@@7) (let ((i1@@7 $i_1@@7))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@339 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@339)))) i1@@7))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@339 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@339)))) i1@@7)))) 3))))
 :qid |AccountLimitsbpl.16039:151|
 :skolemid |555|
))))))) (=> (and (and (and (and (and (forall ((window_addr@@77 Int) ) (!  (=> (|$IsValid'address'| window_addr@@77) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@77) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@77)))))
 :qid |AccountLimitsbpl.16044:20|
 :skolemid |556|
)) (forall ((addr@@340 Int) ) (!  (=> (|$IsValid'address'| addr@@340) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) addr@@340) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@340) (or (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@340)) 5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@340)) 6)))))
 :qid |AccountLimitsbpl.16048:20|
 :skolemid |557|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (forall ((addr@@341 Int) ) (!  (=> (|$IsValid'address'| addr@@341) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@341) (= addr@@341 173345816)))
 :qid |AccountLimitsbpl.16056:20|
 :skolemid |558|
)))) (and (and (forall ((addr1@@11 Int) ) (!  (=> (|$IsValid'address'| addr1@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1@@11) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@11)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@11)) 2)))))
 :qid |AccountLimitsbpl.16060:20|
 :skolemid |559|
)) (forall ((addr@@342 Int) ) (!  (=> (|$IsValid'address'| addr@@342) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141421| $1_DiemAccount_DiemAccount_$memory) addr@@342) (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@342)))
 :qid |AccountLimitsbpl.16064:20|
 :skolemid |560|
))) (and (forall ((addr@@343 Int) ) (!  (=> (|$IsValid'address'| addr@@343) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141521| $1_VASPDomain_VASPDomainManager_$memory) addr@@343)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@343) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@343)) 1))))
 :qid |AccountLimitsbpl.16068:20|
 :skolemid |561|
)) (forall ((addr@@344 Int) ) (!  (=> (|$IsValid'address'| addr@@344) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141606| $1_VASPDomain_VASPDomains_$memory) addr@@344)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@344) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@344)) 5))))
 :qid |AccountLimitsbpl.16072:20|
 :skolemid |562|
))))) (and (and (and (forall ((addr@@345 Int) ) (!  (=> (|$IsValid'address'| addr@@345) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@345) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@345)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@345)) 2)))))
 :qid |AccountLimitsbpl.16076:20|
 :skolemid |563|
)) (forall ((addr@@346 Int) ) (!  (=> (|$IsValid'address'| addr@@346) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141740| $1_DesignatedDealer_Dealer_$memory) addr@@346)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@346) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@346)) 2))))
 :qid |AccountLimitsbpl.16080:20|
 :skolemid |564|
))) (and (forall ((addr@@347 Int) ) (!  (=> (|$IsValid'address'| addr@@347) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr@@347)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@347) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@347)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@347) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@347)) 5)))))
 :qid |AccountLimitsbpl.16084:20|
 :skolemid |565|
)) (forall ((addr@@348 Int) ) (!  (=> (|$IsValid'address'| addr@@348) (= (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) addr@@348)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@348) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@348)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@348) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@348)) 1)))))
 :qid |AccountLimitsbpl.16088:20|
 :skolemid |566|
)))) (and (and (forall ((addr@@349 Int) ) (!  (=> (|$IsValid'address'| addr@@349) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@349)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@349) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@349)) 3))))
 :qid |AccountLimitsbpl.16092:20|
 :skolemid |567|
)) (forall ((addr@@350 Int) ) (!  (=> (|$IsValid'address'| addr@@350) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@350)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@350) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@350)) 4))))
 :qid |AccountLimitsbpl.16096:20|
 :skolemid |568|
))) (and (forall ((addr@@351 Int) ) (!  (=> (|$IsValid'address'| addr@@351) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141995| $1_VASP_ParentVASP_$memory) addr@@351)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@351) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@351)) 5))))
 :qid |AccountLimitsbpl.16100:20|
 :skolemid |569|
)) (forall ((addr@@352 Int) ) (!  (=> (|$IsValid'address'| addr@@352) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142095| $1_VASP_ChildVASP_$memory) addr@@352)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@352) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@352)) 6))))
 :qid |AccountLimitsbpl.16104:20|
 :skolemid |570|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@21)) ($1_Signer_is_txn_signer _$t0@@21)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@21))) (and (and (|$IsValid'address'| _$t1@@18) (|$IsValid'u64'| _$t2@@10)) (and (|$IsValid'address'| _$t3@@4) (forall (($a_0@@49 Int) ) (! (let (($rsc@@49 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@49)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@49))
 :qid |AccountLimitsbpl.16119:20|
 :skolemid |571|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@49))
))))) (and (and (and (forall (($a_0@@50 Int) ) (! (let (($rsc@@50 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@50)))
 (and (|$IsValid'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''| $rsc@@50) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@50) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@50) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@50) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@50) 0))))
 :qid |AccountLimitsbpl.16123:20|
 :skolemid |572|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@50))
)) (forall (($a_0@@51 Int) ) (! (let (($rsc@@51 (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) $a_0@@51)))
(|$IsValid'$1_AccountLimits_Window'$1_XDX_XDX''| $rsc@@51))
 :qid |AccountLimitsbpl.16127:20|
 :skolemid |573|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) $a_0@@51))
))) (and (= _$t0@@21 _$t0@@21) (= _$t1@@18 _$t1@@18))) (and (and (= _$t2@@10 _$t2@@10) (= _$t3@@4 _$t3@@4)) (and (= $t7@@8 (|$addr#$signer| _$t0@@21)) (= $t8@@11  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@8)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t7@@8)) 1))) (not (= (|$addr#$signer| _$t0@@21) 186537453))))))))) (and (=> (= (ControlFlow 0 247277) 247875) anon13_Then_correct@@4) (=> (= (ControlFlow 0 247277) 247285) anon13_Else_correct@@4))))))
(let ((inline$$InitEventStore$0$anon0_correct@@21  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@23 T@$1_Event_EventHandle) ) (! (let ((stream@@22 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@23)))
 (and (= (|l#Multiset_81090| stream@@22) 0) (forall ((v@@51 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@22) v@@51) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 246256) 247277)) anon0$1_correct@@21)))
(let ((anon0_correct@@21  (=> (= (seq.len (|p#$Mutation_125912| $t6@@2)) 0) (=> (and (and (= (seq.len (|p#$Mutation_125912| $t10@@10)) 0) (= (seq.len (|p#$Mutation_10128| $t13@@4)) 0)) (and (= (seq.len (|p#$Mutation_10128| $t17@@7)) 0) (= (ControlFlow 0 246266) 246256))) inline$$InitEventStore$0$anon0_correct@@21))))
(let ((PreconditionGeneratedEntry_correct@@14  (=> (= (ControlFlow 0 297651) 246266) anon0_correct@@21)))
