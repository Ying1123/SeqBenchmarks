...
(declare-fun $t0@3 () T@$Mutation_127147)
(declare-fun $t5@0 () |T@$1_AccountLimits_Window'#0'|)
(declare-fun _$t1 () |T@$1_AccountLimits_LimitsDefinition'#0'|)
(declare-fun $1_DiemTimestamp_CurrentTimeMicroseconds_$memory () T@$Memory_112009)
(declare-fun |Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds| Int) T@$1_DiemTimestamp_CurrentTimeMicroseconds)
(declare-fun inline$$Gt$0$dst@1 () Bool)
(declare-fun _$t0 () T@$Mutation_127147)
(declare-fun $t20@0 () T@$Mutation_10506)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t20@1 () T@$Mutation_10506)
(declare-fun $t6 () Int)
(declare-fun $t0@0 () T@$Mutation_127147)
(declare-fun $t22@0 () T@$Mutation_10506)
(declare-fun $t22@1 () T@$Mutation_10506)
(declare-fun $t0@1 () T@$Mutation_127147)
(declare-fun $t24@0 () T@$Mutation_10506)
(declare-fun $t24@1 () T@$Mutation_10506)
(declare-fun $t0@2 () T@$Mutation_127147)
...
(declare-fun $t20 () T@$Mutation_10506)
(declare-fun $t22 () T@$Mutation_10506)
(declare-fun $t24 () T@$Mutation_10506)
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_reset_window$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 293212) (let ((L5_correct  (=> (and (= |$temp_0'$1_AccountLimits_Window'#0''@1| (|v#$Mutation_127147| $t0@3)) (= |$temp_0'$1_AccountLimits_Window'#0''@1| |$temp_0'$1_AccountLimits_Window'#0''@1|)) (and (=> (= (ControlFlow 0 237031) (- 0 294405)) (not (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64))) (=> (not (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64)) (and (=> (= (ControlFlow 0 237031) (- 0 294422)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 237031) (- 0 294432)) (= (|v#$Mutation_127147| $t0@3) (ite (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1))) (|$1_AccountLimits_Window'#0'| (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0 0 (|$tracked_balance#$1_AccountLimits_Window'#0'| $t5@0) (|$limit_address#$1_AccountLimits_Window'#0'| $t5@0)) $t5@0))))))))))
(let ((anon19_Else_correct  (=> (not inline$$Gt$0$dst@1) (=> (and (= $t0@3 _$t0) (= (ControlFlow 0 236971) 237031)) L5_correct))))
(let ((anon19_Then_correct  (=> (and inline$$Gt$0$dst@1 (= $t20@0 ($Mutation_10506 (|l#$Mutation_127147| _$t0) (let ((l (|l#Vec_18658| (|p#$Mutation_127147| _$t0))))
(Vec_18658 (|Store__T@[Int]Int_| (|v#Vec_18658| (|p#$Mutation_127147| _$t0)) l 0) (+ l 1))) (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0))))) (=> (and (and (= $t20@1 ($Mutation_10506 (|l#$Mutation_10506| $t20@0) (|p#$Mutation_10506| $t20@0) $t6)) (= $t0@0 ($Mutation_127147 (|l#$Mutation_127147| _$t0) (|p#$Mutation_127147| _$t0) (|$1_AccountLimits_Window'#0'| (|v#$Mutation_10506| $t20@1) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0)) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0)))))) (and (|$IsValid'u64'| 0) (= $t22@0 ($Mutation_10506 (|l#$Mutation_127147| $t0@0) (let ((l@@0 (|l#Vec_18658| (|p#$Mutation_127147| $t0@0))))
(Vec_18658 (|Store__T@[Int]Int_| (|v#Vec_18658| (|p#$Mutation_127147| $t0@0)) l@@0 1) (+ l@@0 1))) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@0)))))) (=> (and (and (and (= $t22@1 ($Mutation_10506 (|l#$Mutation_10506| $t22@0) (|p#$Mutation_10506| $t22@0) 0)) (= $t0@1 ($Mutation_127147 (|l#$Mutation_127147| $t0@0) (|p#$Mutation_127147| $t0@0) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@0)) (|v#$Mutation_10506| $t22@1) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@0)) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@0)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@0)))))) (and (|$IsValid'u64'| 0) (= $t24@0 ($Mutation_10506 (|l#$Mutation_127147| $t0@1) (let ((l@@1 (|l#Vec_18658| (|p#$Mutation_127147| $t0@1))))
(Vec_18658 (|Store__T@[Int]Int_| (|v#Vec_18658| (|p#$Mutation_127147| $t0@1)) l@@1 2) (+ l@@1 1))) (|$window_outflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@1)))))) (and (and (= $t24@1 ($Mutation_10506 (|l#$Mutation_10506| $t24@0) (|p#$Mutation_10506| $t24@0) 0)) (= $t0@2 ($Mutation_127147 (|l#$Mutation_127147| $t0@1) (|p#$Mutation_127147| $t0@1) (|$1_AccountLimits_Window'#0'| (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@1)) (|$window_inflow#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@1)) (|v#$Mutation_10506| $t24@1) (|$tracked_balance#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@1)) (|$limit_address#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| $t0@1)))))) (and (= $t0@3 $t0@2) (= (ControlFlow 0 237149) 237031)))) L5_correct)))))
(let ((inline$$Gt$0$anon0_correct  (=> (= inline$$Gt$0$dst@1 (> $t6 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 236957) 237149) anon19_Then_correct) (=> (= (ControlFlow 0 236957) 236971) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 236963) 236957)) inline$$Gt$0$anon0_correct)))
(let ((L7_correct  (and (=> (= (ControlFlow 0 236742) (- 0 294141)) (or (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 236742) (- 0 294160)) (or (and (> (+ (|$window_start#$1_AccountLimits_Window'#0'| $t5@0) (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)) $MAX_U64) (= 8 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t8@0 $abort_code@2) (= (ControlFlow 0 237163) 236742))) L7_correct)))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 236903) 237163) anon18_Then_correct) (=> (= (ControlFlow 0 236903) 236963) anon18_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ $t16@0 $t17@0) $MAX_U64) (= (ControlFlow 0 236901) 236903)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ $t16@0 $t17@0)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ $t16@0 $t17@0)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 236849) 237163) anon18_Then_correct) (=> (= (ControlFlow 0 236849) 236963) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> inline$$Le$0$dst@1 (=> (and (= $t16@0 (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0))) (= $t17@0 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1))) (and (=> (= (ControlFlow 0 236909) 236901) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 236909) 236849) inline$$AddU64$0$anon3_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t15 $t15)) (and (= $t8@0 $t15) (= (ControlFlow 0 236674) 236742))) L7_correct)))
(let ((anon16_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t15) (= $t15 8)) (and (= $t15 $t15) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 236658) 236909) anon17_Then_correct) (=> (= (ControlFlow 0 236658) 236674) anon17_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= $t9@0 inline$$Sub$0$dst@2)) (= (ControlFlow 0 236622) 236658)) anon16_Else$1_correct)))
(let ((anon16_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 236628) 236622)) inline$$Le$0$anon0_correct)))
(let ((anon16_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 237177) 236742))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 236568) 237177) anon16_Then_correct) (=> (= (ControlFlow 0 236568) 236628) anon16_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 18446744073709551615 $t11@0) (= (ControlFlow 0 236566) 236568)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t11@0 18446744073709551615) (=> (and (and (= inline$$Sub$0$dst@1 (- 18446744073709551615 $t11@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 236518) 237177) anon16_Then_correct) (=> (= (ControlFlow 0 236518) 236628) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (not $t7) (=> (and (|$IsValid'u64'| $t6) (= $t6 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (and (and (= $t6 $t6) (= $t9@0 (|$window_start#$1_AccountLimits_Window'#0'| (|v#$Mutation_127147| _$t0)))) (and (|$IsValid'u64'| 18446744073709551615) (= $t11@0 (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1)))) (and (=> (= (ControlFlow 0 236574) 236566) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 236574) 236518) inline$$Sub$0$anon3_Else_correct)))))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 237203) 236742))) L7_correct))))
(let ((anon0$1_correct  (=> (and (and (= (|l#$Mutation_127147| _$t0) ($Param 0)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112234| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112234| $1_Roles_RoleId_$memory) 173345816)) 0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112234| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112234| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116118| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116118| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116232| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_116151| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117659| $1_DiemSystem_CapabilityHolder_$memory) 173345816))))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116331| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_117990| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122795| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126147| $1_XDX_Reserve_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118054| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_122869| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126293| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112640| $1_DualAttestation_Limit_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116395| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126445| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126516| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112673| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_112673| $1_AccountFreezing_FreezingBit_$memory) 173345816))))))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112673| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_112673| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126516| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126688| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126759| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_126830| $1_DiemBlock_BlockMetadata_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116459| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_116523| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (|$IsValid'$1_AccountLimits_Window'#0''| (|v#$Mutation_127147| _$t0))))) (and (and (and (|$IsValid'$1_AccountLimits_LimitsDefinition'#0''| _$t1) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'#0'| _$t1) 0))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |AccountLimitsbpl.11910:20|
 :skolemid |353|
...
)) (= $t5@0 (|v#$Mutation_127147| _$t0)))) (and (and (= |$temp_0'$1_AccountLimits_Window'#0''@0| (|v#$Mutation_127147| _$t0)) (= |$temp_0'$1_AccountLimits_Window'#0''@0| |$temp_0'$1_AccountLimits_Window'#0''@0|)) (and (= _$t1 _$t1) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_112009| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 236395) 237203) anon15_Then_correct) (=> (= (ControlFlow 0 236395) 236574) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 235969) 236395)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_18658| (|p#$Mutation_10506| $t20)) 0) (= (|l#Vec_18658| (|p#$Mutation_10506| $t22)) 0)) (and (= (|l#Vec_18658| (|p#$Mutation_10506| $t24)) 0) (= (ControlFlow 0 235979) 235969))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 293212) 235979) anon0_correct)))
