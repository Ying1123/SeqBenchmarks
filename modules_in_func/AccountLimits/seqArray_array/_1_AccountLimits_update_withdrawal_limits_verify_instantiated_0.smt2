...
(assert (not
 ...
 :qid |AccountLimitsbpl.17131:15|
 :skolemid |612|
)) (and (=> (= (ControlFlow 0 260121) (- 0 314667)) (forall ((window_addr@@1 Int) ) (!  (=> (|$IsValid'address'| window_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125300| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_122795| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XUS_XUS'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XUS_XUS'_| (|contents#$Memory_125300| |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0|) window_addr@@1)))))
 :qid |AccountLimitsbpl.17137:15|
 :skolemid |613|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 258565) 259168)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_18658| (|p#$Mutation_130340| $t9)) 0) (= (ControlFlow 0 258575) 258565)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 313232) 258575) anon0_correct)))
