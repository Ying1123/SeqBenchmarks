...
(assert (not
 ...
 :qid |AccountLimitsbpl.17540:15|
 :skolemid |621|
)) (and (=> (= (ControlFlow 0 262192) (- 0 316418)) (forall ((window_addr@@1 Int) ) (!  (=> (|$IsValid'address'| window_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125488| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0|) window_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_122869| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_125488| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0|) window_addr@@1)))))
 :qid |AccountLimitsbpl.17546:15|
 :skolemid |622|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_82546_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountLimitsbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 260636) 261239)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (= (|l#Vec_18658| (|p#$Mutation_133519| $t9)) 0) (= (ControlFlow 0 260646) 260636)) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 314983) 260646) anon0_correct)))
