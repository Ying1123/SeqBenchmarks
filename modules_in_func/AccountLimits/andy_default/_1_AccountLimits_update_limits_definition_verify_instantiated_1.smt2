...
(declare-fun _$t0@@8 () |T@$1_AccountLimits_LimitsDefinition'#0'|)
(declare-fun $t2@0 () Bool)
(declare-fun $t15@0@@2 () Int)
(declare-fun $t17@0@@2 () Bool)
(declare-fun $t1@0@@6 () Bool)
(declare-fun $t11@0@@6 () Int)
(declare-fun $t13@0@@2 () Bool)
(declare-fun $t6@0@@3 () Bool)
(declare-fun $t7@0@@0 () Int)
(declare-fun $t9@0@@2 () Bool)
(declare-fun $t4@0 () Int)
; Valid
; Valid
(declare-fun $abort_flag@1@@5 () Bool)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@1| () T@$Memory_116863)
...
(declare-fun |$1_AccountLimits_Window'#0'_$memory@0| () T@$Memory_116863)
...
(declare-fun $t28@0@@2 () |T@$1_AccountLimits_Window'#0'|)
...
(declare-fun $t20@0@@2 () Bool)
(declare-fun $t18@@2 () Bool)
(declare-fun $t19@@2 () Int)
(declare-fun $t16@@5 () Int)
(declare-fun $t12 () Int)
(declare-fun $t17@@2 () Int)
(declare-fun $t13@0@@3 () Bool)
(declare-fun $t15@@2 () Int)
(declare-fun $t11 () Bool)
(declare-fun $t10 () Int)
(declare-fun |Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| Int) |T@$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'|)
(declare-fun $1_DiemAccount_DiemAccount_$memory () T@$Memory_141421)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory () T@$Memory_141521)
(declare-fun $1_VASPDomain_VASPDomains_$memory () T@$Memory_141606)
(declare-fun $1_DesignatedDealer_Dealer_$memory () T@$Memory_141740)
(declare-fun $1_VASP_ParentVASP_$memory () T@$Memory_141995)
(declare-fun $1_VASP_ChildVASP_$memory () T@$Memory_142095)
; Valid
(declare-fun $abort_flag@1@@6 () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@1| () T@$Memory_117706)
...
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0| () T@$Memory_117706)
...
(declare-fun $t28@0@@3 () |T@$1_AccountLimits_Window'$1_XUS_XUS'|)
(declare-fun $abort_code@1@@7 () Int)
(declare-fun $abort_flag@0@@7 () Bool)
(declare-fun inline$$1_AccountLimits_current_time$0$$ret0@1@@0 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t2@1@@0 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$ret0@0@@0 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t5@0@@0 () Bool)
(declare-fun inline$$1_AccountLimits_current_time$0$$t2@0@@0 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t0@1@@0 () Int)
(declare-fun $abort_code@0@@7 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t4@0@@0 () Int)
(declare-fun inline$$Not$1$dst@1@@0 () Bool)
(declare-fun inline$$1_DiemTimestamp_is_genesis$0$$t1@1@@0 () Bool)
(declare-fun inline$$Not$0$dst@1@@1 () Bool)
(declare-fun $t23@@3 () Int)
(declare-fun $t20@0@@3 () Bool)
(declare-fun $t18@@3 () Bool)
(declare-fun $t19@@3 () Int)
(declare-fun $t16@@6 () Int)
(declare-fun $t12@@0 () Int)
(declare-fun $t17@@3 () Int)
(declare-fun $t13@0@@4 () Bool)
(declare-fun $t15@@3 () Int)
(declare-fun $t11@@0 () Bool)
(declare-fun $t10@@0 () Int)
; Valid
(declare-fun $abort_flag@1@@7 () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1| () T@$Memory_117894)
...
(declare-fun $t12@0@@4 () Int)
(declare-fun $abort_code@2@@7 () Int)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0| () T@$Memory_117894)
...
(declare-fun $t28@0@@4 () |T@$1_AccountLimits_Window'$1_XDX_XDX'|)
(declare-fun $abort_code@1@@8 () Int)
(declare-fun $abort_flag@0@@8 () Bool)
(declare-fun inline$$1_AccountLimits_current_time$0$$ret0@1@@1 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t2@1@@1 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$ret0@0@@1 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t5@0@@1 () Bool)
(declare-fun inline$$1_AccountLimits_current_time$0$$t2@0@@1 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t0@1@@1 () Int)
(declare-fun $abort_code@0@@8 () Int)
(declare-fun inline$$1_AccountLimits_current_time$0$$t4@0@@1 () Int)
(declare-fun inline$$Not$1$dst@1@@1 () Bool)
(declare-fun inline$$1_DiemTimestamp_is_genesis$0$$t1@1@@1 () Bool)
...
(declare-fun $t13@0@@5 () Bool)
(declare-fun $t15@@4 () Int)
(declare-fun $t11@@1 () Bool)
(declare-fun $t10@@1 () Int)
; Valid
(declare-fun |$temp_0'$1_AccountLimits_Window'#0''@1@@1| () |T@$1_AccountLimits_Window'#0'|)
(declare-fun $t0@3 () T@$Mutation_119553)
(declare-fun $t5@0 () |T@$1_AccountLimits_Window'#0'|)
(declare-fun _$t1@@9 () |T@$1_AccountLimits_LimitsDefinition'#0'|)
(declare-fun inline$$Gt$0$dst@1 () Bool)
(declare-fun _$t0@@12 () T@$Mutation_119553)
(declare-fun $t20@0@@5 () T@$Mutation_10128)
(declare-fun $t20@1 () T@$Mutation_10128)
(declare-fun $t6 () Int)
(declare-fun $t0@0 () T@$Mutation_119553)
(declare-fun $t22@0@@5 () T@$Mutation_10128)
(declare-fun $t22@1 () T@$Mutation_10128)
(declare-fun $t0@1 () T@$Mutation_119553)
(declare-fun $t24@0@@2 () T@$Mutation_10128)
(declare-fun $t24@1 () T@$Mutation_10128)
(declare-fun $t0@2 () T@$Mutation_119553)
...
(declare-fun $t11@0@@7 () Int)
(declare-fun inline$$Sub$0$dst@1@@5 () Int)
(declare-fun $abort_code@0@@9 () Int)
(declare-fun $t7@@2 () Bool)
(declare-fun $t8@@2 () Int)
(declare-fun |$temp_0'$1_AccountLimits_Window'#0''@0@@1| () |T@$1_AccountLimits_Window'#0'|)
(declare-fun $t20 () T@$Mutation_10128)
(declare-fun $t22 () T@$Mutation_10128)
(declare-fun $t24 () T@$Mutation_10128)
; Valid
(declare-fun $t12@@2 () Bool)
(declare-fun $t9@2 () T@$Mutation_119553)
(declare-fun $t9@1 () T@$Mutation_119553)
(declare-fun |$temp_0'$1_AccountLimits_Window'#0''@0@@2| () |T@$1_AccountLimits_Window'#0'|)
(declare-fun $t10@@2 () Bool)
(declare-fun $t11@0@@8 () |T@$1_AccountLimits_Window'#0'|)
(declare-fun _$t0@@13 () Int)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@0@@0| () T@$Memory_116863)
...
(declare-fun $t9@@3 () T@$Mutation_119553)
(declare-fun $t9@0@@4 () T@$Mutation_119553)
...
(declare-fun _$t2@@2 () T@$1_AccountLimits_AccountLimitMutationCapability)
; Valid
(declare-fun $t12@@3 () Bool)
(declare-fun $t9@2@@0 () T@$Mutation_122739)
(declare-fun $t9@1@@0 () T@$Mutation_122739)
(declare-fun |$temp_0'$1_AccountLimits_Window'$1_XUS_XUS''@0@@1| () |T@$1_AccountLimits_Window'$1_XUS_XUS'|)
(declare-fun $t10@@3 () Bool)
(declare-fun $t11@0@@9 () |T@$1_AccountLimits_Window'$1_XUS_XUS'|)
(declare-fun _$t0@@14 () Int)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0@@0| () T@$Memory_117706)
...
(declare-fun $t9@@4 () T@$Mutation_122739)
(declare-fun $t9@0@@5 () T@$Mutation_122739)
...
(declare-fun _$t2@@3 () T@$1_AccountLimits_AccountLimitMutationCapability)
; Valid
(declare-fun $t12@@4 () Bool)
(declare-fun $t9@2@@1 () T@$Mutation_125912)
(declare-fun $t9@1@@1 () T@$Mutation_125912)
(declare-fun |$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@0@@1| () |T@$1_AccountLimits_Window'$1_XDX_XDX'|)
(declare-fun $t10@@4 () Bool)
(declare-fun $t11@0@@10 () |T@$1_AccountLimits_Window'$1_XDX_XDX'|)
(declare-fun _$t0@@15 () Int)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@0| () T@$Memory_117894)
...
(declare-fun $t9@@5 () T@$Mutation_125912)
(declare-fun $t9@0@@6 () T@$Mutation_125912)
...
(declare-fun _$t2@@4 () T@$1_AccountLimits_AccountLimitMutationCapability)
; Valid
(declare-fun inline$$Gt$3$dst@1 () Bool)
(declare-fun $t15@7 () T@$Mutation_163427)
(declare-fun |$1_AccountLimits_LimitsDefinition'#0'_$memory@1| () T@$Memory_115349)
...
(declare-fun $t27@0 () T@$Mutation_10128)
(declare-fun $t27@1 () T@$Mutation_10128)
(declare-fun _$t5 () Int)
(declare-fun $t15@8 () T@$Mutation_163427)
(declare-fun |$1_AccountLimits_LimitsDefinition'#0'_$memory@0| () T@$Memory_115349)
(declare-fun inline$$Gt$2$dst@1 () Bool)
(declare-fun $t15@5 () T@$Mutation_163427)
(declare-fun $t24@0@@3 () T@$Mutation_10128)
(declare-fun $t24@1@@0 () T@$Mutation_10128)
(declare-fun _$t4 () Int)
(declare-fun $t15@6 () T@$Mutation_163427)
(declare-fun inline$$Gt$1$dst@1 () Bool)
(declare-fun $t15@3 () T@$Mutation_163427)
(declare-fun $t21@0@@2 () T@$Mutation_10128)
(declare-fun $t21@1 () T@$Mutation_10128)
(declare-fun _$t3 () Int)
(declare-fun $t15@4 () T@$Mutation_163427)
(declare-fun inline$$Gt$0$dst@1@@0 () Bool)
(declare-fun $t15@1 () T@$Mutation_163427)
(declare-fun $t18@0@@2 () T@$Mutation_10128)
(declare-fun $t18@1@@2 () T@$Mutation_10128)
(declare-fun _$t2@@5 () Int)
(declare-fun $t15@2 () T@$Mutation_163427)
...
(declare-fun $t15@0@@3 () T@$Mutation_163427)
(declare-fun $abort_code@0@@13 () Int)
(declare-fun $t12@0@@5 () Bool)
(declare-fun $t10@@5 () Bool)
(declare-fun $t14@@2 () Int)
(declare-fun _$t0@@16 () T@$signer)
(declare-fun $t9@@6 () Int)
(declare-fun $t8@@6 () T@$Mutation_163427)
(declare-fun $t18@@5 () T@$Mutation_10128)
...
(declare-fun $t27@0@@0 () T@$Mutation_10128)
(declare-fun $t27@1@@0 () T@$Mutation_10128)
(declare-fun _$t5@@0 () Int)
(declare-fun $t15@8@@0 () T@$Mutation_166419)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory@0| () T@$Memory_115201)
(declare-fun inline$$Gt$2$dst@1@@0 () Bool)
(declare-fun $t15@5@@0 () T@$Mutation_166419)
(declare-fun $t24@0@@4 () T@$Mutation_10128)
(declare-fun $t24@1@@1 () T@$Mutation_10128)
(declare-fun _$t4@@0 () Int)
(declare-fun $t15@6@@0 () T@$Mutation_166419)
(declare-fun inline$$Gt$1$dst@1@@0 () Bool)
(declare-fun $t15@3@@0 () T@$Mutation_166419)
(declare-fun $t21@0@@3 () T@$Mutation_10128)
(declare-fun $t21@1@@0 () T@$Mutation_10128)
(declare-fun _$t3@@0 () Int)
(declare-fun $t15@4@@0 () T@$Mutation_166419)
(declare-fun inline$$Gt$0$dst@1@@1 () Bool)
(declare-fun $t15@1@@0 () T@$Mutation_166419)
(declare-fun $t18@0@@3 () T@$Mutation_10128)
(declare-fun $t18@1@@3 () T@$Mutation_10128)
(declare-fun _$t2@@6 () Int)
(declare-fun $t15@2@@0 () T@$Mutation_166419)
...
(declare-fun $t27@0@@1 () T@$Mutation_10128)
(declare-fun $t27@1@@1 () T@$Mutation_10128)
(declare-fun _$t5@@1 () Int)
(declare-fun $t15@8@@1 () T@$Mutation_169581)
(declare-fun |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0| () T@$Memory_115275)
(declare-fun inline$$Gt$2$dst@1@@1 () Bool)
(declare-fun $t15@5@@1 () T@$Mutation_169581)
(declare-fun $t24@0@@5 () T@$Mutation_10128)
(declare-fun $t24@1@@2 () T@$Mutation_10128)
(declare-fun _$t4@@1 () Int)
(declare-fun $t15@6@@1 () T@$Mutation_169581)
(declare-fun inline$$Gt$1$dst@1@@1 () Bool)
(declare-fun $t15@3@@1 () T@$Mutation_169581)
(declare-fun $t21@0@@4 () T@$Mutation_10128)
(declare-fun $t21@1@@1 () T@$Mutation_10128)
(declare-fun _$t3@@1 () Int)
(declare-fun $t15@4@@1 () T@$Mutation_169581)
(declare-fun inline$$Gt$0$dst@1@@2 () Bool)
(declare-fun $t15@1@@1 () T@$Mutation_169581)
(declare-fun $t18@0@@4 () T@$Mutation_10128)
(declare-fun $t18@1@@4 () T@$Mutation_10128)
(declare-fun _$t2@@7 () Int)
(declare-fun $t15@2@@1 () T@$Mutation_169581)
...
(declare-fun $t15@@8 () T@$Mutation_169581)
(declare-fun $abort_code@1@@15 () Int)
(declare-fun _$t1@@15 () Int)
(declare-fun $t15@0@@5 () T@$Mutation_169581)
(declare-fun $abort_code@0@@15 () Int)
(declare-fun $t12@0@@7 () Bool)
(declare-fun $t10@@7 () Bool)
(declare-fun $t14@@4 () Int)
(declare-fun _$t0@@18 () T@$signer)
(declare-fun $t9@@8 () Int)
(declare-fun $t8@@8 () T@$Mutation_169581)
(declare-fun $t18@@7 () T@$Mutation_10128)
(declare-fun $t21@@4 () T@$Mutation_10128)
(declare-fun $t24@@2 () T@$Mutation_10128)
(declare-fun $t27@@4 () T@$Mutation_10128)
(push 1)
(set-info :boogie-vc-id $1_AccountLimits_update_limits_definition$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 292131) (let ((L14_correct@@7 true))
(let ((anon26_Else_correct@@1  (=> (not inline$$Gt$3$dst@1@@1) (and (=> (= (ControlFlow 0 241810) (- 0 293995)) (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0)) (=> (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0) (and (=> (= (ControlFlow 0 241810) (- 0 294007)) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0)) (=> (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0) (and (=> (= (ControlFlow 0 241810) (- 0 294019)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0)) (=> (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0) (and (=> (= (ControlFlow 0 241810) (- 0 294031)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0)) (=> (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) 0) (=> (= |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1| ($Memory_115275 (|Store__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_169581| $t15@7@@1)) true) (|Store__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_169581| $t15@7@@1)) (|v#$Mutation_169581| $t15@7@@1)))) (and (=> (= (ControlFlow 0 241810) (- 0 294068)) (forall ((addr@@229 Int) ) (!  (=> (|$IsValid'address'| addr@@229) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@229) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) addr@@229)))
 :qid |AccountLimitsbpl.15059:15|
 :skolemid |464|
))) (=> (forall ((addr@@230 Int) ) (!  (=> (|$IsValid'address'| addr@@230) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@230) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) addr@@230)))
 :qid |AccountLimitsbpl.15059:15|
 :skolemid |464|
)) (and (=> (= (ControlFlow 0 241810) (- 0 294092)) (forall ((window_addr@@46 Int) ) (!  (=> (|$IsValid'address'| window_addr@@46) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@46) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@46)))))
 :qid |AccountLimitsbpl.15065:15|
 :skolemid |465|
))) (=> (forall ((window_addr@@47 Int) ) (!  (=> (|$IsValid'address'| window_addr@@47) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@47) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@47)))))
 :qid |AccountLimitsbpl.15065:15|
 :skolemid |465|
)) (and (=> (= (ControlFlow 0 241810) (- 0 294123)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 241810) (- 0 294137)) (forall ((addr@@231 Int) ) (!  (=> (|$IsValid'address'| addr@@231) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) addr@@231) (= addr@@231 173345816)))
 :qid |AccountLimitsbpl.15077:15|
 :skolemid |466|
))) (=> (forall ((addr@@232 Int) ) (!  (=> (|$IsValid'address'| addr@@232) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@1|) addr@@232) (= addr@@232 173345816)))
 :qid |AccountLimitsbpl.15077:15|
 :skolemid |466|
)) (=> (= (ControlFlow 0 241810) 241814) L14_correct@@7)))))))))))))))))))))
(let ((anon26_Then_correct@@1  (=> (and (and inline$$Gt$3$dst@1@@1 (= $t27@0@@1 ($Mutation_10128 (|l#$Mutation_169581| $t15@7@@1) (seq.++ (|p#$Mutation_169581| $t15@7@@1) (seq.unit 2)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1))))) (and (= $t27@1@@1 ($Mutation_10128 (|l#$Mutation_10128| $t27@0@@1) (|p#$Mutation_10128| $t27@0@@1) _$t5@@1)) (= $t15@8@@1 ($Mutation_169581 (|l#$Mutation_169581| $t15@7@@1) (|p#$Mutation_169581| $t15@7@@1) (|$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1)) (|v#$Mutation_10128| $t27@1@@1) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@7@@1))))))) (and (=> (= (ControlFlow 0 242013) (- 0 293822)) (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0)) (=> (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0) (and (=> (= (ControlFlow 0 242013) (- 0 293834)) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0)) (=> (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0) (and (=> (= (ControlFlow 0 242013) (- 0 293846)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0)) (=> (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0) (and (=> (= (ControlFlow 0 242013) (- 0 293858)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0)) (=> (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@8@@1)) 0) (=> (= |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0| ($Memory_115275 (|Store__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_169581| $t15@8@@1)) true) (|Store__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_169581| $t15@8@@1)) (|v#$Mutation_169581| $t15@8@@1)))) (and (=> (= (ControlFlow 0 242013) (- 0 293895)) (forall ((addr@@233 Int) ) (!  (=> (|$IsValid'address'| addr@@233) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@233) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) addr@@233)))
 :qid |AccountLimitsbpl.14994:15|
 :skolemid |461|
))) (=> (forall ((addr@@234 Int) ) (!  (=> (|$IsValid'address'| addr@@234) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@234) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) addr@@234)))
 :qid |AccountLimitsbpl.14994:15|
 :skolemid |461|
)) (and (=> (= (ControlFlow 0 242013) (- 0 293919)) (forall ((window_addr@@48 Int) ) (!  (=> (|$IsValid'address'| window_addr@@48) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@48) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@48)))))
 :qid |AccountLimitsbpl.15000:15|
 :skolemid |462|
))) (=> (forall ((window_addr@@49 Int) ) (!  (=> (|$IsValid'address'| window_addr@@49) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@49) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@49)))))
 :qid |AccountLimitsbpl.15000:15|
 :skolemid |462|
)) (and (=> (= (ControlFlow 0 242013) (- 0 293950)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 242013) (- 0 293964)) (forall ((addr@@235 Int) ) (!  (=> (|$IsValid'address'| addr@@235) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) addr@@235) (= addr@@235 173345816)))
 :qid |AccountLimitsbpl.15012:15|
 :skolemid |463|
))) (=> (forall ((addr@@236 Int) ) (!  (=> (|$IsValid'address'| addr@@236) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory@0|) addr@@236) (= addr@@236 173345816)))
 :qid |AccountLimitsbpl.15012:15|
 :skolemid |463|
)) (=> (= (ControlFlow 0 242013) 241814) L14_correct@@7)))))))))))))))))))))
(let ((inline$$Gt$3$anon0_correct@@1  (=> (= inline$$Gt$3$dst@1@@1 (> _$t5@@1 0)) (and (=> (= (ControlFlow 0 241633) 242013) anon26_Then_correct@@1) (=> (= (ControlFlow 0 241633) 241810) anon26_Else_correct@@1)))))
(let ((L10_correct@@1  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 241639) 241633)) inline$$Gt$3$anon0_correct@@1)))
(let ((anon25_Else_correct@@4  (=> (not inline$$Gt$2$dst@1@@1) (=> (and (= $t15@7@@1 $t15@5@@1) (= (ControlFlow 0 241585) 241639)) L10_correct@@1))))
(let ((anon25_Then_correct@@4  (=> (and inline$$Gt$2$dst@1@@1 (= $t24@0@@5 ($Mutation_10128 (|l#$Mutation_169581| $t15@5@@1) (seq.++ (|p#$Mutation_169581| $t15@5@@1) (seq.unit 3)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@5@@1))))) (=> (and (and (= $t24@1@@2 ($Mutation_10128 (|l#$Mutation_10128| $t24@0@@5) (|p#$Mutation_10128| $t24@0@@5) _$t4@@1)) (= $t15@6@@1 ($Mutation_169581 (|l#$Mutation_169581| $t15@5@@1) (|p#$Mutation_169581| $t15@5@@1) (|$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@5@@1)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@5@@1)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@5@@1)) (|v#$Mutation_10128| $t24@1@@2))))) (and (= $t15@7@@1 $t15@6@@1) (= (ControlFlow 0 242051) 241639))) L10_correct@@1))))
(let ((inline$$Gt$2$anon0_correct@@1  (=> (= inline$$Gt$2$dst@1@@1 (> _$t4@@1 0)) (and (=> (= (ControlFlow 0 241571) 242051) anon25_Then_correct@@4) (=> (= (ControlFlow 0 241571) 241585) anon25_Else_correct@@4)))))
(let ((L7_correct@@2  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 241577) 241571)) inline$$Gt$2$anon0_correct@@1)))
(let ((anon24_Else_correct@@4  (=> (not inline$$Gt$1$dst@1@@1) (=> (and (= $t15@5@@1 $t15@3@@1) (= (ControlFlow 0 241523) 241577)) L7_correct@@2))))
(let ((anon24_Then_correct@@4  (=> (and inline$$Gt$1$dst@1@@1 (= $t21@0@@4 ($Mutation_10128 (|l#$Mutation_169581| $t15@3@@1) (seq.++ (|p#$Mutation_169581| $t15@3@@1) (seq.unit 1)) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@3@@1))))) (=> (and (and (= $t21@1@@1 ($Mutation_10128 (|l#$Mutation_10128| $t21@0@@4) (|p#$Mutation_10128| $t21@0@@4) _$t3@@1)) (= $t15@4@@1 ($Mutation_169581 (|l#$Mutation_169581| $t15@3@@1) (|p#$Mutation_169581| $t15@3@@1) (|$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@3@@1)) (|v#$Mutation_10128| $t21@1@@1) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@3@@1)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@3@@1)))))) (and (= $t15@5@@1 $t15@4@@1) (= (ControlFlow 0 242089) 241577))) L7_correct@@2))))
(let ((inline$$Gt$1$anon0_correct@@1  (=> (= inline$$Gt$1$dst@1@@1 (> _$t3@@1 0)) (and (=> (= (ControlFlow 0 241509) 242089) anon24_Then_correct@@4) (=> (= (ControlFlow 0 241509) 241523) anon24_Else_correct@@4)))))
(let ((L4_correct@@1  (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 241515) 241509)) inline$$Gt$1$anon0_correct@@1)))
(let ((anon23_Else_correct@@4  (=> (not inline$$Gt$0$dst@1@@2) (=> (and (= $t15@3@@1 $t15@1@@1) (= (ControlFlow 0 241461) 241515)) L4_correct@@1))))
(let ((anon23_Then_correct@@4  (=> (and inline$$Gt$0$dst@1@@2 (= $t18@0@@4 ($Mutation_10128 (|l#$Mutation_169581| $t15@1@@1) (seq.++ (|p#$Mutation_169581| $t15@1@@1) (seq.unit 0)) (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@1@@1))))) (=> (and (and (= $t18@1@@4 ($Mutation_10128 (|l#$Mutation_10128| $t18@0@@4) (|p#$Mutation_10128| $t18@0@@4) _$t2@@7)) (= $t15@2@@1 ($Mutation_169581 (|l#$Mutation_169581| $t15@1@@1) (|p#$Mutation_169581| $t15@1@@1) (|$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_10128| $t18@1@@4) (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@1@@1)) (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@1@@1)) (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| (|v#$Mutation_169581| $t15@1@@1)))))) (and (= $t15@3@@1 $t15@2@@1) (= (ControlFlow 0 242127) 241515))) L4_correct@@1))))
(let ((inline$$Gt$0$anon0_correct@@2  (=> (= inline$$Gt$0$dst@1@@2 (> _$t2@@7 0)) (and (=> (= (ControlFlow 0 241447) 242127) anon23_Then_correct@@4) (=> (= (ControlFlow 0 241447) 241461) anon23_Else_correct@@4)))))
(let ((anon22_Else_correct@@4  (=> (not $abort_flag@0@@15) (=> (and (and (= |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''@0| (|v#$Mutation_169581| $t15@1@@1)) (= |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''@0| |$temp_0'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''@0|)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 241453) 241447))) inline$$Gt$0$anon0_correct@@2))))
(let ((anon22_Then_correct@@4 true))
(let ((anon21_Then$1_correct@@1  (=> (= $t15@1@@1 $t15@@8) (=> (and (= $abort_flag@0@@15 true) (= $abort_code@1@@15 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 242193) 242141) anon22_Then_correct@@4) (=> (= (ControlFlow 0 242193) 241453) anon22_Else_correct@@4))))))
(let ((anon21_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t1@@15)) (= (ControlFlow 0 242191) 242193)) anon21_Then$1_correct@@1)))
(let ((anon21_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t1@@15) (=> (and (and (= $t15@0@@5 ($Mutation_169581 ($Global _$t1@@15) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t1@@15))) (= $t15@1@@1 $t15@0@@5)) (and (= $abort_flag@0@@15 false) (= $abort_code@1@@15 $abort_code@0@@15))) (and (=> (= (ControlFlow 0 241381) 242141) anon22_Then_correct@@4) (=> (= (ControlFlow 0 241381) 241453) anon22_Else_correct@@4))))))
(let ((anon20_Then_correct@@4  (=> $t12@0@@7 (and (=> (= (ControlFlow 0 241359) 242191) anon21_Then_correct@@4) (=> (= (ControlFlow 0 241359) 241381) anon21_Else_correct@@4)))))
(let ((anon20_Else_correct@@4 true))
(let ((anon19_Else_correct@@5  (=> (not $t10@@7) (=> (and (= $t12@0@@7 (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) _$t1@@15)) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t14@@4) (= $t14@@4 5)) (and (= $t14@@4 $t14@@4) (= $t12@0@@7 $t12@0@@7))) (and (=> (= (ControlFlow 0 241333) 241359) anon20_Then_correct@@4) (=> (= (ControlFlow 0 241333) 241349) anon20_Else_correct@@4)))))))
(let ((anon19_Then_correct@@5 true))
(let ((anon0$1_correct@@18  (=> (forall ((addr@@237 Int) ) (!  (=> (|$IsValid'address'| addr@@237) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@237)) 0)) (= addr@@237 173345816)))
 :qid |AccountLimitsbpl.14572:20|
 :skolemid |431|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@238 Int) ) (!  (=> (|$IsValid'address'| addr@@238) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@238)) 1)) (= addr@@238 186537453)))
 :qid |AccountLimitsbpl.14580:20|
 :skolemid |432|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@239 Int) ) (!  (=> (|$IsValid'address'| addr@@239) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@239)) 2))))))
 :qid |AccountLimitsbpl.14588:20|
 :skolemid |433|
))) (and (forall ((addr@@240 Int) ) (!  (=> (|$IsValid'address'| addr@@240) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@240)) 2))))))
 :qid |AccountLimitsbpl.14592:20|
 :skolemid |434|
)) (forall ((addr@@241 Int) ) (!  (=> (|$IsValid'address'| addr@@241) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@241)) 2))))))
 :qid |AccountLimitsbpl.14596:20|
 :skolemid |435|
)))) (=> (and (and (and (forall ((addr@@242 Int) ) (!  (=> (|$IsValid'address'| addr@@242) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@242)) 2))))))
 :qid |AccountLimitsbpl.14600:20|
 :skolemid |436|
)) (forall ((addr@@243 Int) ) (!  (=> (|$IsValid'address'| addr@@243) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@243)) 2)))))
 :qid |AccountLimitsbpl.14604:20|
 :skolemid |437|
))) (and (forall ((addr@@244 Int) ) (!  (=> (|$IsValid'address'| addr@@244) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@244)) 2)))))
 :qid |AccountLimitsbpl.14608:20|
 :skolemid |438|
)) (forall ((addr@@245 Int) ) (!  (=> (|$IsValid'address'| addr@@245) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@245)) 2)))))
 :qid |AccountLimitsbpl.14612:20|
 :skolemid |439|
)))) (and (and (forall ((addr@@246 Int) ) (!  (=> (|$IsValid'address'| addr@@246) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@246) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@246) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@246)) 4))))
 :qid |AccountLimitsbpl.14616:20|
 :skolemid |440|
)) (forall ((addr@@247 Int) ) (!  (=> (|$IsValid'address'| addr@@247) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@247) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@247) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@247)) 3))))
 :qid |AccountLimitsbpl.14620:20|
 :skolemid |441|
))) (and (forall ((addr@@248 Int) ) (!  (=> (|$IsValid'address'| addr@@248) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@248) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@248) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@248)) 3))))
 :qid |AccountLimitsbpl.14624:20|
 :skolemid |442|
)) (forall ((addr@@249 Int) ) (!  (=> (|$IsValid'address'| addr@@249) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@249) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@249)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@249) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@249)) 3))))
 :qid |AccountLimitsbpl.14628:20|
 :skolemid |443|
))))) (=> (and (and (and (and (let (($range_0@@4 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@250 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@250))))))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i1@@4 $i_1@@4))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@251 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@251)))) i1@@4))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@251 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_109382| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@251)))) i1@@4)))) 3))))
 :qid |AccountLimitsbpl.14632:151|
 :skolemid |444|
))) (forall ((window_addr@@50 Int) ) (!  (=> (|$IsValid'address'| window_addr@@50) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@50) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) (|$limit_address#$1_AccountLimits_Window'$1_XDX_XDX'| (|Select__T@[Int]$1_AccountLimits_Window'$1_XDX_XDX'_| (|contents#$Memory_117894| |$1_AccountLimits_Window'$1_XDX_XDX'_$memory|) window_addr@@50)))))
 :qid |AccountLimitsbpl.14637:20|
 :skolemid |445|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105402| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (forall ((addr@@252 Int) ) (!  (=> (|$IsValid'address'| addr@@252) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) addr@@252) (= addr@@252 173345816)))
 :qid |AccountLimitsbpl.14645:20|
 :skolemid |446|
)))) (and (and (forall ((addr1@@8 Int) ) (!  (=> (|$IsValid'address'| addr1@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr1@@8) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@8)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr1@@8)) 2)))))
 :qid |AccountLimitsbpl.14649:20|
 :skolemid |447|
)) (forall ((addr@@253 Int) ) (!  (=> (|$IsValid'address'| addr@@253) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141421| $1_DiemAccount_DiemAccount_$memory) addr@@253) (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@253)))
 :qid |AccountLimitsbpl.14653:20|
 :skolemid |448|
))) (and (forall ((addr@@254 Int) ) (!  (=> (|$IsValid'address'| addr@@254) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141521| $1_VASPDomain_VASPDomainManager_$memory) addr@@254)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@254)) 1))))
 :qid |AccountLimitsbpl.14657:20|
 :skolemid |449|
)) (forall ((addr@@255 Int) ) (!  (=> (|$IsValid'address'| addr@@255) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141606| $1_VASPDomain_VASPDomains_$memory) addr@@255)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@255)) 5))))
 :qid |AccountLimitsbpl.14661:20|
 :skolemid |450|
))))) (and (and (and (forall ((addr@@256 Int) ) (!  (=> (|$IsValid'address'| addr@@256) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_106905| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@256) (|Select__T@[Int]Bool_| (|domain#$Memory_106965| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@256)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@256)) 2)))))
 :qid |AccountLimitsbpl.14665:20|
 :skolemid |451|
)) (forall ((addr@@257 Int) ) (!  (=> (|$IsValid'address'| addr@@257) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141740| $1_DesignatedDealer_Dealer_$memory) addr@@257)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@257)) 2))))
 :qid |AccountLimitsbpl.14669:20|
 :skolemid |452|
))) (and (forall ((addr@@258 Int) ) (!  (=> (|$IsValid'address'| addr@@258) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106790| $1_DualAttestation_Credential_$memory) addr@@258)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@258) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@258)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@258) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@258)) 5)))))
 :qid |AccountLimitsbpl.14673:20|
 :skolemid |453|
)) (forall ((addr@@259 Int) ) (!  (=> (|$IsValid'address'| addr@@259) (= (|Select__T@[Int]Bool_| (|domain#$Memory_109349| $1_SlidingNonce_SlidingNonce_$memory) addr@@259)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@259) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@259)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@259) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@259)) 1)))))
 :qid |AccountLimitsbpl.14677:20|
 :skolemid |454|
)))) (and (and (forall ((addr@@260 Int) ) (!  (=> (|$IsValid'address'| addr@@260) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106000| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@260)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@260) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@260)) 3))))
 :qid |AccountLimitsbpl.14681:20|
 :skolemid |455|
)) (forall ((addr@@261 Int) ) (!  (=> (|$IsValid'address'| addr@@261) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106453| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@261)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@261) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@261)) 4))))
 :qid |AccountLimitsbpl.14685:20|
 :skolemid |456|
))) (and (forall ((addr@@262 Int) ) (!  (=> (|$IsValid'address'| addr@@262) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141995| $1_VASP_ParentVASP_$memory) addr@@262)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@262) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@262)) 5))))
 :qid |AccountLimitsbpl.14689:20|
 :skolemid |457|
)) (forall ((addr@@263 Int) ) (!  (=> (|$IsValid'address'| addr@@263) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142095| $1_VASP_ChildVASP_$memory) addr@@263)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) addr@@263) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) addr@@263)) 6))))
 :qid |AccountLimitsbpl.14693:20|
 :skolemid |458|
)))))) (=> (and (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@18)) ($1_Signer_is_txn_signer _$t0@@18)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@18))) (|$IsValid'address'| _$t1@@15)) (and (|$IsValid'u64'| _$t2@@7) (|$IsValid'u64'| _$t3@@1))) (and (and (|$IsValid'u64'| _$t4@@1) (|$IsValid'u64'| _$t5@@1)) (and (forall (($a_0@@41 Int) ) (! (let (($rsc@@41 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@41)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@41))
 :qid |AccountLimitsbpl.14714:20|
 :skolemid |459|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $a_0@@41))
)) (forall (($a_0@@42 Int) ) (! (let (($rsc@@42 (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@42)))
 (and (|$IsValid'$1_AccountLimits_LimitsDefinition'$1_XDX_XDX''| $rsc@@42) (and (and (and (> (|$max_inflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@42) 0) (> (|$max_outflow#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@42) 0)) (> (|$time_period#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@42) 0)) (> (|$max_holding#$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'| $rsc@@42) 0))))
 :qid |AccountLimitsbpl.14718:20|
 :skolemid |460|
 :pattern ( (|Select__T@[Int]$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_| (|contents#$Memory_115275| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) $a_0@@42))
))))) (and (and (and (= _$t0@@18 _$t0@@18) (= _$t1@@15 _$t1@@15)) (and (= _$t2@@7 _$t2@@7) (= _$t3@@1 _$t3@@1))) (and (and (= _$t4@@1 _$t4@@1) (= _$t5@@1 _$t5@@1)) (and (= $t9@@8 (|$addr#$signer| _$t0@@18)) (= $t10@@7  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@8)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_105627| $1_Roles_RoleId_$memory) $t9@@8)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453)))))))) (and (=> (= (ControlFlow 0 241291) 242265) anon19_Then_correct@@5) (=> (= (ControlFlow 0 241291) 241333) anon19_Else_correct@@5))))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@18  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@20 T@$1_Event_EventHandle) ) (! (let ((stream@@19 (|Select__T@[$1_Event_EventHandle]Multiset_81090_| (|streams#$EventStore| $es) handle@@20)))
 (and (= (|l#Multiset_81090| stream@@19) 0) (forall ((v@@48 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_81090| stream@@19) v@@48) 0)
 :qid |AccountLimitsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountLimitsbpl.2192:13|
 :skolemid |59|
))) (= (ControlFlow 0 240323) 241291)) anon0$1_correct@@18)))
(let ((anon0_correct@@18  (=> (= (seq.len (|p#$Mutation_169581| $t8@@8)) 0) (=> (and (= (seq.len (|p#$Mutation_169581| $t15@@8)) 0) (= (seq.len (|p#$Mutation_10128| $t18@@7)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_10128| $t21@@4)) 0) (= (seq.len (|p#$Mutation_10128| $t24@@2)) 0)) (and (= (seq.len (|p#$Mutation_10128| $t27@@4)) 0) (= (ControlFlow 0 240333) 240323))) inline$$InitEventStore$0$anon0_correct@@18)))))
(let ((PreconditionGeneratedEntry_correct@@11  (=> (= (ControlFlow 0 292131) 240333) anon0_correct@@18)))
