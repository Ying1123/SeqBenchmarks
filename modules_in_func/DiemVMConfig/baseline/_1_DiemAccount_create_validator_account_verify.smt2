...
(declare-fun $t7 () Bool)
(declare-fun $t6 () Int)
(declare-fun $t20 () T@$1_DiemAccount_AccountOperationsCapability)
...
(declare-fun $t22 () T@$1_DiemAccount_CreateAccountEvent)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@3 () T@$Memory_234181)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_234181)
(declare-fun inline$$1_ValidatorConfig_publish$0$$t9@1 () Int)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_234181)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0 () T@$Memory_234181)
...
(declare-fun MapConstVec_161519 (T@$1_ValidatorConfig_Config) |T@[Int]$1_ValidatorConfig_Config|)
(declare-fun DefaultVecElem_161519 () T@$1_ValidatorConfig_Config)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 921021) (let ((L2_correct  (and (=> (= (ControlFlow 0 689336) (- 0 924840)) (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) _$t1))) (=> (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) _$t1)) (=> (= (ControlFlow 0 689336) (- 0 924941)) (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (= 6 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (= _$t1 0) (= 7 $t8@0))) (and (= _$t1 1) (= 7 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) _$t1) (= 6 $t8@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8@0))) (and (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)) (= 7 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) _$t1) (= 6 $t8@0))))))))
(let ((anon31_Then_correct  (=> $t19 (=> (and (and (or (or (or (or (and (= $t15 0) (= 7 $t8)) (and (= $t15 1) (= 7 $t8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t15) (= 6 $t8))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8))) (and (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)) (= 7 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 689008) 689336))) L2_correct))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 689350) 689336))) L2_correct)))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 689364) 689336))) L2_correct)))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 689378) 689336))) L2_correct)))
(let ((anon26_Then_correct  (=> $t7 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 689484) 689336))) L2_correct))))
(let ((anon24_correct  (=> (= $t20 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (=> (and (= $t21 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t22 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t15)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t15) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory@2) $t15))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t20) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t20) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16))))) (and (not (= (|l#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_177956| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))))) (and (and (and (not (= (|l#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_177995| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))) (= $t23 $t22)) (and (and (= $t24 $t21) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) $t24)))
(let ((stream_new (let ((len (|l#Multiset_177831| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) $t24 stream_new)))))) (and (= $t25 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t26 ($1_DiemAccount_CreateAccountEvent _$t1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) _$t1)))))))) (and (=> (= (ControlFlow 0 688854) (- 0 924544)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (and (=> (= (ControlFlow 0 688854) (- 0 924553)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 688854) (- 0 924565)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 688854) (- 0 924583)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 688854) (- 0 924597)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 688854) (- 0 924607)) (not (= _$t1 1))) (=> (not (= _$t1 1)) (and (=> (= (ControlFlow 0 688854) (- 0 924617)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (=> (= (ControlFlow 0 688854) (- 0 924626)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (=> (= (ControlFlow 0 688854) (- 0 924643)) (not (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (and (=> (= (ControlFlow 0 688854) (- 0 924661)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 688854) (- 0 924671)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) _$t1)) (and (=> (= (ControlFlow 0 688854) (- 0 924680)) (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) _$t1) (and (=> (= (ControlFlow 0 688854) (- 0 924687)) (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1) (and (=> (= (ControlFlow 0 688854) (- 0 924694)) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) _$t1) (and (=> (= (ControlFlow 0 688854) (- 0 924701)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) _$t1)) 3)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) _$t1)) 3) (and (=> (= (ControlFlow 0 688854) (- 0 924714)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory@2) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemVMConfigbpl.39286:15|
 :skolemid |1419|
 ...
 :qid |DiemVMConfigbpl.39286:15|
 :skolemid |1419|
)) (and (=> (= (ControlFlow 0 688854) (- 0 924749)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_177831| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_177831| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_177831 (|Store__T@[$EventRep]Int_| (|v#Multiset_177831| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@1))))))
 ...
 :qid |DiemVMConfigbpl.3327:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 688854) (- 0 924774)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@2))))))
...
(let ((anon35_Else_correct  (=> (and (and (not |$temp_0'bool'@3|) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_225896 (|Store__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 false) (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1) (= (ControlFlow 0 688425) 688854))) anon24_correct)))
(let ((anon35_Then_correct  (=> (and (and |$temp_0'bool'@3| (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_225896 (|Store__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0) (= (ControlFlow 0 688866) 688854))) anon24_correct)))
(let ((anon34_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_225724 (|Store__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t15 false) (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 688411) 688866) anon35_Then_correct) (=> (= (ControlFlow 0 688411) 688425) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_225724 (|Store__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t15 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t15 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 688878) 688866) anon35_Then_correct) (=> (= (ControlFlow 0 688878) 688425) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not |$temp_0'bool'@1|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_216284 (|Store__T@[Int]Bool_| (|domain#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t15 false) (|contents#$Memory_216284| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 688397) 688878) anon34_Then_correct) (=> (= (ControlFlow 0 688397) 688411) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and |$temp_0'bool'@1| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_216284 (|Store__T@[Int]Bool_| (|domain#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t15 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_216284| $1_Event_EventHandleGenerator_$memory) $t15 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 688890) 688878) anon34_Then_correct) (=> (= (ControlFlow 0 688890) 688411) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_313615 (|Store__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t15 false) (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 688383) 688890) anon33_Then_correct) (=> (= (ControlFlow 0 688383) 688397) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_313615 (|Store__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t15 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t15 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 688902) 688890) anon33_Then_correct) (=> (= (ControlFlow 0 688902) 688397) anon33_Else_correct))))))
(let ((anon31_Else_correct  (=> (not $t19) (and (=> (= (ControlFlow 0 688371) 688902) anon32_Then_correct) (=> (= (ControlFlow 0 688371) 688383) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t15 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t16 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (and (= $t17 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t18 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 688365) (- 0 924039)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t15))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $t15)) (and (=> (= (ControlFlow 0 688365) (- 0 924050)) (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (and (=> (= (ControlFlow 0 688365) (- 0 924059)) (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t15)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) $t15) (=> (= $t19  (or (or (or (or (= $t15 0) (= $t15 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $t15)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)))) (and (=> (= (ControlFlow 0 688365) 689008) anon31_Then_correct) (=> (= (ControlFlow 0 688365) 688371) anon31_Else_correct)))))))))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Else_correct  (=> (and (and (not $abort_flag@1) (= $abort_code@3 $abort_code@2)) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 687991) 689350) anon30_Then_correct) (=> (= (ControlFlow 0 687991) 688365) anon30_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$L3_correct  (=> (= $abort_code@3 inline$$1_ValidatorConfig_publish$0$$t9@1) (=> (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@2) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 687897) 689350) anon30_Then_correct) (=> (= (ControlFlow 0 687897) 688365) anon30_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 $abort_code@2) (= (ControlFlow 0 688005) 687897))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 688057) 688005) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 688057) 687991) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 688055) 688057)) inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_234181 (|Store__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) inline$$1_ValidatorConfig_publish$0$$t21@1))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 687981) 688005) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 687981) 687991) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| inline$$1_ValidatorConfig_publish$0$$t19@0) (<= (|l#Vec_177917| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_177917 (MapConstVec_161519 DefaultVecElem_161519) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_publish$0$$t20@0) (<= (|l#Vec_29362| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_29362 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= inline$$1_ValidatorConfig_publish$0$$t21@1 ($1_ValidatorConfig_ValidatorConfig inline$$1_ValidatorConfig_publish$0$$t19@0 inline$$1_ValidatorConfig_publish$0$$t20@0 _$t3))))) (and (=> (= (ControlFlow 0 687959) 688055) inline$$1_ValidatorConfig_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 687959) 687981) inline$$1_ValidatorConfig_publish$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t18@0) (= (ControlFlow 0 687891) 687897))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$1_ValidatorConfig_publish$0$$t18@0 6)) (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 687875) 687959) inline$$1_ValidatorConfig_publish$0$anon18_Then_correct) (=> (= (ControlFlow 0 687875) 687891) inline$$1_ValidatorConfig_publish$0$anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_ValidatorConfig_publish$0$$t15@1)) (= (ControlFlow 0 687835) 687875)) inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t13@0) (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_publish$0$$t14@0) (= inline$$1_ValidatorConfig_publish$0$$t14@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (= inline$$1_ValidatorConfig_publish$0$$t15@1 (|Select__T@[Int]Bool_| (|domain#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_publish$0$$t14@0)) (= (ControlFlow 0 687841) 687835))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t13@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 688109) 687897))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t11@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t12@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= inline$$1_ValidatorConfig_publish$0$$t13@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3))))) (and (=> (= (ControlFlow 0 687779) 688109) inline$$1_ValidatorConfig_publish$0$anon17_Then_correct) (=> (= (ControlFlow 0 687779) 687841) inline$$1_ValidatorConfig_publish$0$anon17_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t11@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 688201) 687897))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t8@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t10@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t11@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 687733) 688201) inline$$1_ValidatorConfig_publish$0$anon16_Then_correct) (=> (= (ControlFlow 0 687733) 687779) inline$$1_ValidatorConfig_publish$0$anon16_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Then_correct  (=> inline$$1_ValidatorConfig_publish$0$$t8@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ValidatorConfig_publish$0$$t9@0)) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 688227) 687897))) inline$$1_ValidatorConfig_publish$0$L3_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_publish$0$$t5@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t6@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t7@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= _$t0 _$t0)) (and (= _$t3 _$t3) (= inline$$1_ValidatorConfig_publish$0$$t8@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_223647| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 687663) 688227) inline$$1_ValidatorConfig_publish$0$anon15_Then_correct) (=> (= (ControlFlow 0 687663) 687733) inline$$1_ValidatorConfig_publish$0$anon15_Else_correct)))))))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t13 (|$addr#$signer| _$t0))) (and (= $t14 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 688231) 687663))) inline$$1_ValidatorConfig_publish$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 686800) 689364) anon29_Then_correct) (=> (= (ControlFlow 0 686800) 688231) anon29_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (=> (= (ControlFlow 0 686675) 689378) anon28_Then_correct) (=> (= (ControlFlow 0 686675) 686800) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Then_correct  (=> inline$$1_Roles_new_validator_role$0$$t9@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 686669) 686675))) inline$$1_Roles_new_validator_role$0$L2_correct))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Then_correct  (=> (and (and inline$$1_Roles_new_validator_role$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) (= 5 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0)) (= 3 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)))) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 686767) 686675))) inline$$1_Roles_new_validator_role$0$L2_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon7_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 686627) 689378) anon28_Then_correct) (=> (= (ControlFlow 0 686627) 686800) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Else_correct  (=> (and (and (not |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_224329 (|Store__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_224329| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 686601) 686627))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Then_correct  (=> (and (and |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_224329 (|Store__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_new_validator_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 686641) 686627))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Else_correct  (=> (not inline$$1_Roles_new_validator_role$0$$t9@0) (and (=> (= (ControlFlow 0 686587) 686641) inline$$1_Roles_new_validator_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 686587) 686601) inline$$1_Roles_new_validator_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Else_correct  (=> (and (not inline$$1_Roles_new_validator_role$0$$t5@0) (|$IsValid'u64'| 3)) (=> (and (and (= inline$$1_Roles_new_validator_role$0$$t8@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 3 0) (= inline$$1_Roles_new_validator_role$0$$t8@0 173345816))) (and (=> (= 3 1) (= inline$$1_Roles_new_validator_role$0$$t8@0 186537453)) (= inline$$1_Roles_new_validator_role$0$$t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 686581) 686669) inline$$1_Roles_new_validator_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 686581) 686587) inline$$1_Roles_new_validator_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon0_correct  (=> (and (= inline$$1_Roles_new_validator_role$0$$t2@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t3@0 (|$addr#$signer| _$t0))) (=> (and (and (= _$t0 _$t0) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= inline$$1_Roles_new_validator_role$0$$t4@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t5@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 686515) 686767) inline$$1_Roles_new_validator_role$0$anon8_Then_correct) (=> (= (ControlFlow 0 686515) 686581) inline$$1_Roles_new_validator_role$0$anon8_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (and (not false) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 686771) (- 0 922825)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 686771) 686515) inline$$1_Roles_new_validator_role$0$anon0_correct))))))
(let ((anon27_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer _$t1)) (and (=> (= (ControlFlow 0 685895) 689392) anon27_Then_correct) (=> (= (ControlFlow 0 685895) 686771) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $t7) (= (ControlFlow 0 685901) 685895)) inline$$1_DiemAccount_create_signer$0$anon0_correct)))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_224695| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 ...
 :qid |DiemVMConfigbpl.38811:20|
 :skolemid |1399|
))))) (and (and (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_225967| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@20)  (and (= addr@@20 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) addr@@20))))
 :qid |DiemVMConfigbpl.38815:20|
 :skolemid |1400|
 ...
 :qid |DiemVMConfigbpl.38827:20|
 :skolemid |1403|
)))) (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_312564| $1_DesignatedDealer_Dealer_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) addr@@24)) 2))))
 :qid |DiemVMConfigbpl.38831:20|
 :skolemid |1404|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemVMConfigbpl.38907:20|
 :skolemid |1414|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@1) (and (<= (|l#Vec_177917| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1) (<= (|l#Vec_29362| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1))))
 :qid |DiemVMConfigbpl.38911:20|
 :skolemid |1415|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_234181| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemVMConfigbpl.38915:20|
 :skolemid |1416|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_225724| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $a_0@@3)))
 ...
 :qid |DiemVMConfigbpl.38919:20|
 :skolemid |1417|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_313615| $1_DiemAccount_DiemAccount_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_225896| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4)))
(|$IsValid'$1_DiemAccount_AccountOperationsCapability'| $rsc@@4))
 :qid |DiemVMConfigbpl.38923:20|
 :skolemid |1418|
...
))))) (and (and (and (= $t5 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies _$t1)) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224329| $1_Roles_RoleId_$memory) $t6))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_224329| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))))))) (and (=> (= (ControlFlow 0 685857) 689484) anon26_Then_correct) (=> (= (ControlFlow 0 685857) 685901) anon26_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_177831_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemVMConfigbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 684375) 685857)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 921021) 684375) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
