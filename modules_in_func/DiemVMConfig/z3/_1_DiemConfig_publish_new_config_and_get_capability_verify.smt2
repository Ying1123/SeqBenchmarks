...
(assert (not
 (=> (= (ControlFlow 0 0) 756208) (let ((anon15_Else_correct@@4  (=> (not $abort_flag@0@@10) (and (=> (= (ControlFlow 0 454607) (- 0 757272)) (forall ((config_address@@29 Int) ) (!  (=> (|$IsValid'address'| config_address@@29) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@29) (= config_address@@29 173345816)))
 :qid |DiemVMConfigbpl.12488:15|
 :skolemid |323|
))) (=> (forall ((config_address@@30 Int) ) (!  (=> (|$IsValid'address'| config_address@@30) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) config_address@@30) (= config_address@@30 173345816)))
 :qid |DiemVMConfigbpl.12488:15|
 :skolemid |323|
)) (and (=> (= (ControlFlow 0 454607) (- 0 757297)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (and (= $t15@0@@5 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0@@5 $t15@0@@5)) (and (=> (= (ControlFlow 0 454607) (- 0 757334)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 454607) (- 0 757346)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 454607) (- 0 757364)) (not (not (= (|$addr#$signer| _$t0@@10) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@10) 173345816))) (and (=> (= (ControlFlow 0 454607) (- 0 757378)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 454607) (- 0 757388)) (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) 173345816) (and (=> (= (ControlFlow 0 454607) (- 0 757394)) (= (let ((addr@@122 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@122))) _$t1@@10)) (=> (= (let ((addr@@123 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0|) addr@@123))) _$t1@@10) (=> (= (ControlFlow 0 454607) (- 0 757403)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_214183| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_214183| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct@@4  (and (=> (= (ControlFlow 0 454414) (- 0 757153)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0@@10) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0@@10) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 454414) (- 0 757193)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0@@10) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct@@4  (=> (and (and $abort_flag@0@@10 (= $abort_code@1@@10 $abort_code@1@@10)) (and (= $t7@0 $abort_code@1@@10) (= (ControlFlow 0 454621) 454414))) L3_correct@@4)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0@@10 true) (= $abort_code@1@@10 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 454673) 454621) anon15_Then_correct@@4) (=> (= (ControlFlow 0 454673) 454607) anon15_Else_correct@@4))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@10)) (= (ControlFlow 0 454671) 454673)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@10))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1| ($Memory_225343 (|Store__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@10) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0@@10) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1@@0| |$1_DiemConfig_DiemConfig'#0'_$memory@0@@1|)) (and (= $abort_flag@0@@10 false) (= $abort_code@1@@10 $abort_code@0@@10))) (and (=> (= (ControlFlow 0 454458) 454621) anon15_Then_correct@@4) (=> (= (ControlFlow 0 454458) 454607) anon15_Else_correct@@4))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1@@4 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1@@10))) (and (=> (= (ControlFlow 0 454436) (- 0 757026)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@10))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| (|$addr#$signer| _$t0@@10)) (and (=> (= (ControlFlow 0 454436) 454671) anon14_Then_correct) (=> (= (ControlFlow 0 454436) 454458) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@4) (= $t12@@0 $t12@@0)) (and (= $t7@0 $t12@@0) (= (ControlFlow 0 454286) 454414))) L3_correct@@4)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12@@0) (= $t12@@0 6)) (and (= $t12@@0 $t12@@0) (= inline$$Not$0$dst@1@@4 inline$$Not$0$dst@1@@4))) (and (=> (= (ControlFlow 0 454270) 454436) anon13_Then_correct) (=> (= (ControlFlow 0 454270) 454286) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@4  (=> (and (= inline$$Not$0$dst@1@@4  (not $t9@0@@4)) (= (ControlFlow 0 454230) 454270)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6@@4) (=> (and (and (|$IsValid'address'| $t8@@4) (= $t8@@4 (|$addr#$signer| _$t0@@10))) (and (= $t9@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8@@4)) (= (ControlFlow 0 454236) 454230))) inline$$Not$0$anon0_correct@@4))))
(let ((anon12_Then_correct  (=> $t6@@4 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@10) 173345816)) (= 2 $t7@@10)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t5@@4)) (= 5 $t7@@10))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t5@@4)) 0)) (= 3 $t7@@10))) (and (not (= (|$addr#$signer| _$t0@@10) 173345816)) (= 2 $t7@@10))) (= $t7@@10 $t7@@10)) (and (= $t7@0 $t7@@10) (= (ControlFlow 0 454765) 454414))) L3_correct@@4))))
(let ((anon0$1_correct@@10  (=> (and (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@124)) 0)) (= addr@@124 173345816)))
 :qid |DiemVMConfigbpl.12266:20|
 :skolemid |305|
)) (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@125)) 1)) (= addr@@125 186537453)))
 :qid |DiemVMConfigbpl.12270:20|
 :skolemid |306|
))) (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@126)) 2))))))
 :qid |DiemVMConfigbpl.12274:20|
 :skolemid |307|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@127)) 2))))))
 :qid |DiemVMConfigbpl.12278:20|
 :skolemid |308|
)))) (=> (and (and (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@128)) 2))))))
 :qid |DiemVMConfigbpl.12282:20|
 :skolemid |309|
)) (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@129)) 2))))))
 :qid |DiemVMConfigbpl.12286:20|
 :skolemid |310|
))) (and (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@130)) 2)))))
 :qid |DiemVMConfigbpl.12290:20|
 :skolemid |311|
)) (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@131)) 2)))))
 :qid |DiemVMConfigbpl.12294:20|
 :skolemid |312|
)))) (and (and (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@132)) 2)))))
 :qid |DiemVMConfigbpl.12298:20|
 :skolemid |313|
)) (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222186| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@133) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@133)) 4))))
 :qid |DiemVMConfigbpl.12302:20|
 :skolemid |314|
))) (and (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223652| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@134) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@134)) 3))))
 :qid |DiemVMConfigbpl.12306:20|
 :skolemid |315|
)) (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223652| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@135) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@135)) 3))))
 :qid |DiemVMConfigbpl.12310:20|
 :skolemid |316|
))))) (=> (and (and (and (and (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_223652| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_223652| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@136)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@136)) 3))))
 :qid |DiemVMConfigbpl.12314:20|
 :skolemid |317|
)) (forall ((config_address@@31 Int) ) (!  (=> (|$IsValid'address'| config_address@@31) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@31) (= config_address@@31 173345816)))
 :qid |DiemVMConfigbpl.12318:20|
 :skolemid |318|
))) (and (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_240769| $1_DualAttestation_Credential_$memory) addr1@@4) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr1@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr1@@4)) 2)))))
 :qid |DiemVMConfigbpl.12322:20|
 :skolemid |319|
)) (forall ((addr@@137 Int) ) (!  (=> (|$IsValid'address'| addr@@137) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_240884| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@137) (|Select__T@[Int]Bool_| (|domain#$Memory_240944| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@137)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) addr@@137)) 2)))))
 :qid |DiemVMConfigbpl.12326:20|
 :skolemid |320|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@10)) ($1_Signer_is_txn_signer _$t0@@10)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@10)))) (and (and (and (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $a_0@@40)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@40))
 :qid |DiemVMConfigbpl.12335:20|
 :skolemid |321|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $a_0@@40))
)) (forall (($a_0@@41 Int) ) (! (let (($rsc@@41 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@41)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@41))
 :qid |DiemVMConfigbpl.12339:20|
 :skolemid |322|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_225343| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@41))
))) (and (= $t4 (|$addr#$signer| _$t0@@10)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@1| 173345816))) (and (and (= _$t0@@10 _$t0@@10) (= _$t1@@10 _$t1@@10)) (and (= $t5@@4 (|$addr#$signer| _$t0@@10)) (= $t6@@4  (or (or (or (not (= (|$addr#$signer| _$t0@@10) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_213903| $1_Roles_RoleId_$memory) $t5@@4))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_213903| $1_Roles_RoleId_$memory) $t5@@4)) 0))) (not (= (|$addr#$signer| _$t0@@10) 173345816)))))))) (and (=> (= (ControlFlow 0 454174) 454765) anon12_Then_correct) (=> (= (ControlFlow 0 454174) 454236) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@10  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@12 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_175890_| (|streams#$EventStore| $es) handle@@12)))
 (and (= (|l#Multiset_175890| stream@@16) 0) (forall ((v@@58 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_175890| stream@@16) v@@58) 0)
 :qid |DiemVMConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemVMConfigbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 453600) 454174)) anon0$1_correct@@10)))
(let ((anon0_correct@@10  (=> (= (ControlFlow 0 756208) 453600) inline$$InitEventStore$0$anon0_correct@@10)))
anon0_correct@@10))))))))))))))))
))
(check-sat)
(pop 1)
