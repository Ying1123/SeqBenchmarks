...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 247565) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 178845) (- 0 247930)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (=> (= (ControlFlow 0 178845) (- 0 247941)) (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory@1) (|$addr#$signer| _$t0))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 178761) (- 0 247897)) (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)) (=> (= (ControlFlow 0 178761) (- 0 247903)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)) (= 6 $t8@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 178859) 178761))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $1_SlidingNonce_SlidingNonce_$memory@1 $1_SlidingNonce_SlidingNonce_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 178911) 178859) anon12_Then_correct) (=> (= (ControlFlow 0 178911) 178845) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 178909) 178911)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_106974 (|Store__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) $t11@0))) (= $1_SlidingNonce_SlidingNonce_$memory@1 $1_SlidingNonce_SlidingNonce_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 178813) 178859) anon12_Then_correct) (=> (= (ControlFlow 0 178813) 178845) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (and inline$$Not$0$dst@1 (|$IsValid'u64'| 0)) (and (|$IsValid'u128'| 0) (= $t11@0 ($1_SlidingNonce_SlidingNonce 0 0)))) (and (=> (= (ControlFlow 0 178791) (- 0 247783)) (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 178791) 178909) anon11_Then_correct) (=> (= (ControlFlow 0 178791) 178813) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t7 $t7)) (and (= $t8@0 $t7) (= (ControlFlow 0 178729) 178761))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t7) (= $t7 6)) (and (= $t7 $t7) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 178713) 178791) anon10_Then_correct) (=> (= (ControlFlow 0 178713) 178729) anon10_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t4@0)) (= (ControlFlow 0 178677) 178713)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) $a_0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |SlidingNoncebpl.4821:20|
 :skolemid |133|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
))) (and (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0)) (= _$t0 _$t0))) (and (and (|$IsValid'address'| $t3) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_106974| $1_SlidingNonce_SlidingNonce_$memory) $t3)) (= (ControlFlow 0 178683) 178677)))) inline$$Not$0$anon0_correct)))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_73950_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |SlidingNoncebpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 178553) 178683)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 247565) 178553) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
