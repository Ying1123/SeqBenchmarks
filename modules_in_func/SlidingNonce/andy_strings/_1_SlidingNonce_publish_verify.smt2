...
(assert (not
 (=> (= (ControlFlow 0 0) 234093) (let ((anon12_Else_correct  (=> (not $abort_flag@0@@0) (and (=> (= (ControlFlow 0 169542) (- 0 234458)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (=> (= (ControlFlow 0 169542) (- 0 234469)) (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory@1) (|$addr#$signer| _$t0@@0))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 169458) (- 0 234425)) (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0)) (=> (= (ControlFlow 0 169458) (- 0 234431)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0)) (= 6 $t8@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= $t8@0 $abort_code@1@@0) (= (ControlFlow 0 169556) 169458))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $1_SlidingNonce_SlidingNonce_$memory@1 $1_SlidingNonce_SlidingNonce_$memory) (=> (and (= $abort_flag@0@@0 true) (= $abort_code@1@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 169608) 169556) anon12_Then_correct) (=> (= (ControlFlow 0 169608) 169542) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 169606) 169608)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0))) (=> (and (and (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_99771 (|Store__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@0) $t11@0@@0))) (= $1_SlidingNonce_SlidingNonce_$memory@1 $1_SlidingNonce_SlidingNonce_$memory@0)) (and (= $abort_flag@0@@0 false) (= $abort_code@1@@0 $abort_code@0@@0))) (and (=> (= (ControlFlow 0 169510) 169556) anon12_Then_correct) (=> (= (ControlFlow 0 169510) 169542) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (and inline$$Not$0$dst@1 (|$IsValid'u64'| 0)) (and (|$IsValid'u128'| 0) (= $t11@0@@0 ($1_SlidingNonce_SlidingNonce 0 0)))) (and (=> (= (ControlFlow 0 169488) (- 0 234311)) (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0@@0))) (=> (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0@@0)) (and (=> (= (ControlFlow 0 169488) 169606) anon11_Then_correct) (=> (= (ControlFlow 0 169488) 169510) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t7@@0 $t7@@0)) (and (= $t8@0 $t7@@0) (= (ControlFlow 0 169426) 169458))) L3_correct)))
(let ((anon0$2_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t7@@0) (= $t7@@0 6)) (and (= $t7@@0 $t7@@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 169410) 169488) anon10_Then_correct) (=> (= (ControlFlow 0 169410) 169426) anon10_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t4@0)) (= (ControlFlow 0 169374) 169410)) anon0$2_correct)))
(let ((anon0$1_correct@@0  (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@0)) ($1_Signer_is_txn_signer _$t0@@0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@0))) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@0))
 :qid |SlidingNoncebpl.4790:20|
 :skolemid |113|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0))
))) (and (|Select__T@[Int]Bool_| $1_SlidingNonce_SlidingNonce_$modifies (|$addr#$signer| _$t0@@0)) (= _$t0@@0 _$t0@@0))) (and (and (|$IsValid'address'| $t3) (= $t3 (|$addr#$signer| _$t0@@0))) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) $t3)) (= (ControlFlow 0 169380) 169374)))) inline$$Not$0$anon0_correct)))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_72434_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_72434| stream@@1) 0) (forall ((v@@33 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72434| stream@@1) v@@33) 0)
 :qid |SlidingNoncebpl.134:13|
 :skolemid |2|
))))
 :qid |SlidingNoncebpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 169250) 169380)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 234093) 169250) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0))))))))))))))
))
(check-sat)
(pop 1)
