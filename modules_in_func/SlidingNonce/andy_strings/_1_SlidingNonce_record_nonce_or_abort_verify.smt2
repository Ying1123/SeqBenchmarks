...
(assert (not
 (=> (= (ControlFlow 0 0) 234484) (let ((L3_correct@@0  (and (=> (= (ControlFlow 0 170023) (- 0 234867)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@1 _$t1@@0) 0)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@1 _$t1@@0) 0))) (=> (= (ControlFlow 0 170023) (- 0 234887)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))) (= 5 $t7@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@1 _$t1@@0) 0)) (= 7 $t7@0))))))))
(let ((anon11_Else_correct@@0  (=> (and (and (not $t9@0) (= $t10@@0 $t10@@0)) (and (= $t7@0 $t10@@0) (= (ControlFlow 0 169951) 170023))) L3_correct@@0)))
(let ((anon9_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))) (= 5 $t7@@1)) (= $t7@@1 $t7@@1)) (and (= $t7@0 $t7@@1) (= (ControlFlow 0 170103) 170023))) L3_correct@@0))))
(let ((anon11_Then_correct@@0  (=> $t9@0 (and (=> (= (ControlFlow 0 170059) (- 0 234813)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1)))) (=> (= (ControlFlow 0 170059) (- 0 234826)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@1 _$t1@@0) 0)))))))))
(let ((anon5_correct  (=> (and (|$IsValid'u64'| $t5) (= $t5 ($1_SlidingNonce_spec_try_record_nonce _$t0@@1 _$t1@@0))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0@@1)) (= $t5 $t5)) (and (|$IsValid'u64'| 0) (= $t9@0 (= $t5 0)))) (and (and (|$IsValid'u64'| $t10@@0) (= $t10@@0 7)) (and (= $t10@@0 $t10@@0) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 169935) 170059) anon11_Then_correct@@0) (=> (= (ControlFlow 0 169935) 169951) anon11_Else_correct@@0))))))
(let ((anon10_Else_correct@@0  (=> (and (and (not |$temp_0'bool'@0|) (= $1_SlidingNonce_SlidingNonce_$memory@1@@0 ($Memory_99771 (|Store__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1) false) (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1@@0) (= (ControlFlow 0 169869) 169935))) anon5_correct)))
(let ((anon10_Then_correct@@0  (=> (and (and |$temp_0'bool'@0| (= $1_SlidingNonce_SlidingNonce_$memory@0@@0 ($Memory_99771 (|Store__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1) |$temp_0'$1_SlidingNonce_SlidingNonce'@0|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0@@0) (= (ControlFlow 0 170073) 169935))) anon5_correct)))
(let ((anon9_Else_correct  (=> (not $t6) (and (=> (= (ControlFlow 0 169855) 170073) anon10_Then_correct@@0) (=> (= (ControlFlow 0 169855) 169869) anon10_Else_correct@@0)))))
(let ((anon0$1_correct@@1  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_98906| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_98906| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (= (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) addr@@3)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_99584| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_99584| $1_Roles_RoleId_$memory) addr@@3)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_99584| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_99584| $1_Roles_RoleId_$memory) addr@@3)) 1)))))
 :qid |SlidingNoncebpl.4966:20|
 :skolemid |114|
))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@1)) ($1_Signer_is_txn_signer _$t0@@1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@1))) (|$IsValid'u64'| _$t1@@0)) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@1)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@1))
 :qid |SlidingNoncebpl.4975:20|
 :skolemid |115|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@1))
)) (= _$t0@@1 _$t0@@1)) (and (= _$t1@@0 _$t1@@0) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_99771| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@1))))))) (and (=> (= (ControlFlow 0 169849) 170103) anon9_Then_correct) (=> (= (ControlFlow 0 169849) 169855) anon9_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@1  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@3 T@$1_Event_EventHandle) ) (! (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_72434_| (|streams#$EventStore| $es) handle@@3)))
 (and (= (|l#Multiset_72434| stream@@2) 0) (forall ((v@@34 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72434| stream@@2) v@@34) 0)
 :qid |SlidingNoncebpl.134:13|
 :skolemid |2|
))))
 :qid |SlidingNoncebpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 169706) 169849)) anon0$1_correct@@1)))
(let ((anon0_correct@@1  (=> (= (ControlFlow 0 234484) 169706) inline$$InitEventStore$0$anon0_correct@@1)))
anon0_correct@@1))))))))))))
))
(check-sat)
(pop 1)
