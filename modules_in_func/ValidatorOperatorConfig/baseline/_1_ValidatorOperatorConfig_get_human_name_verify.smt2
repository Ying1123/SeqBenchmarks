...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 40428) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 35368) (- 0 40825)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))) (=> (= (ControlFlow 0 35368) (- 0 40836)) (|$IsEqual'vec'u8''| $t8@0 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 35304) (- 0 40778)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (=> (= (ControlFlow 0 35304) (- 0 40784)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= 5 $t4@0)))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t4@0 $abort_code@1) (= (ControlFlow 0 35382) 35304))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 35434) 35382) anon15_Then_correct) (=> (= (ControlFlow 0 35434) 35368) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= (ControlFlow 0 35432) 35434)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 35322) 35382) anon15_Then_correct) (=> (= (ControlFlow 0 35322) 35368) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (and (=> (= (ControlFlow 0 35308) 35432) anon14_Then_correct) (=> (= (ControlFlow 0 35308) 35322) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1) (= $t6 $t6)) (and (= $t4@0 $t6) (= (ControlFlow 0 35272) 35304))) L3_correct)))
(let ((anon12_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1))) (and (=> (= (ControlFlow 0 35256) 35308) anon13_Then_correct) (=> (= (ControlFlow 0 35256) 35272) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t0)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1)) (and (=> (= (ControlFlow 0 35214) 35448) anon12_Then_correct) (=> (= (ControlFlow 0 35214) 35256) anon12_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_24893| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_24893| $1_Roles_RoleId_$memory) addr)) 4))))
 :qid |ValidatorOperatorConfigbpl.1990:20|
 :skolemid |87|
 ...
 :qid |ValidatorOperatorConfigbpl.1994:20|
 :skolemid |88|
))) (=> (and (and (|$IsValid'address'| _$t0) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_25719| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc))
 :qid |ValidatorOperatorConfigbpl.2001:20|
 :skolemid |89|
...
))) (and (= _$t0 _$t0) (= (ControlFlow 0 35220) 35214))) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_15488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorOperatorConfigbpl.1320:13|
 :skolemid |42|
))) (= (ControlFlow 0 35017) 35220)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 40428) 35017) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
