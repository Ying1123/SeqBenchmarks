...
(assert (not
 (=> (= (ControlFlow 0 0) 12720) (let ((anon4_Else_correct  (=> (and (not $t5@0) (= $t7 $t7)) (and (=> (= (ControlFlow 0 11454) (- 0 12870)) (not (= (|$addr#$signer| _$t0) 173345816))) (=> (not (= (|$addr#$signer| _$t0) 173345816)) (=> (= (ControlFlow 0 11454) (- 0 12879)) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))))))))
(let ((anon4_Then_correct  (=> (and $t5@0 (= (ControlFlow 0 11474) (- 0 12843))) (not (not (= (|$addr#$signer| _$t0) 173345816))))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t3))) (and (and (and (= $t3 (|$addr#$signer| _$t0)) (|$IsValid'address'| 173345816)) (and (= $t5@0 (= $t3 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t7) (= $t7 2)) (and (= $t7 $t7) (= $t5@0 $t5@0))))) (and (=> (= (ControlFlow 0 11406) 11474) anon4_Then_correct) (=> (= (ControlFlow 0 11406) 11454) anon4_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 12720) 11406) anon0$1_correct)))
anon0_correct)))))
))
(check-sat)
(pop 1)
