...
(assert (not
 (=> (= (ControlFlow 0 0) 13106) (let ((anon4_Else_correct  (=> (and (not $t5@0) (= $t7 $t7)) (and (=> (= (ControlFlow 0 11894) (- 0 13256)) (not (= (|$addr#$signer| _$t0) 0))) (=> (not (= (|$addr#$signer| _$t0) 0)) (=> (= (ControlFlow 0 11894) (- 0 13265)) (and (not (= (|$addr#$signer| _$t0) 0)) (= 2 $t7))))))))
(let ((anon4_Then_correct  (=> (and $t5@0 (= (ControlFlow 0 11914) (- 0 13229))) (not (not (= (|$addr#$signer| _$t0) 0))))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t3))) (and (and (and (= $t3 (|$addr#$signer| _$t0)) (|$IsValid'address'| 0)) (and (= $t5@0 (= $t3 0)) (|$IsValid'u64'| 2))) (and (and (|$IsValid'u64'| $t7) (= $t7 2)) (and (= $t7 $t7) (= $t5@0 $t5@0))))) (and (=> (= (ControlFlow 0 11846) 11914) anon4_Then_correct) (=> (= (ControlFlow 0 11846) 11894) anon4_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 13106) 11846) anon0$1_correct)))
anon0_correct)))))
))
(check-sat)
(pop 1)
