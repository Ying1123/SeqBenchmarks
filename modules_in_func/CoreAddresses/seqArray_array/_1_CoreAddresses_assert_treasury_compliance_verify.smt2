...
(assert (not
 (=> (= (ControlFlow 0 0) 12910) (let ((anon4_Else_correct  (=> (and (not $t5@0) (= $t7 $t7)) (and (=> (= (ControlFlow 0 11676) (- 0 13066)) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (not (= (|$addr#$signer| _$t0) 186537453)) (=> (= (ControlFlow 0 11676) (- 0 13075)) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7))))))))
(let ((anon4_Then_correct  (=> (and $t5@0 (= (ControlFlow 0 11696) (- 0 13039))) (not (not (= (|$addr#$signer| _$t0) 186537453))))))
(let ((anon0$1_correct  (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (|$IsValid'address'| $t3))) (and (and (and (= $t3 (|$addr#$signer| _$t0)) (|$IsValid'address'| 186537453)) (and (= $t5@0 (= $t3 186537453)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t7) (= $t7 2)) (and (= $t7 $t7) (= $t5@0 $t5@0))))) (and (=> (= (ControlFlow 0 11628) 11696) anon4_Then_correct) (=> (= (ControlFlow 0 11628) 11676) anon4_Else_correct)))))
(let ((anon0_correct  (=> (= (ControlFlow 0 12910) 11628) anon0$1_correct)))
anon0_correct)))))
))
(check-sat)
(pop 1)
