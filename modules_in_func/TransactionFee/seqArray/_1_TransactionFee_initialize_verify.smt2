...
(assert (not
 (=> (= (ControlFlow 0 0) 324458) (let ((L2_correct  (and (=> (= (ControlFlow 0 223777) (- 0 327176)) (or (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (or (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (=> (= (ControlFlow 0 223777) (- 0 327230)) (or (or (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) (= 5 $t3@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) 1)) (= 3 $t3@0))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 $t3@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453) (= 6 $t3@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t3@0))))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t3@0 $abort_code@5) (= (ControlFlow 0 223601) 223777))) L2_correct)))
(let ((anon9_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t4)) (= 5 $t3)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t3))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 $t3))) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 223849) 223777))) L2_correct))))
(let ((anon8_Then_correct  (=> $t2 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3)) (= $t3 $t3)) (and (= $t3@0 $t3) (= (ControlFlow 0 223875) 223777))) L2_correct))))
(let ((anon10_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 223587) (- 0 327068)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 223587) (- 0 327078)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t1))) (and (=> (= (ControlFlow 0 223587) (- 0 327090)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t1)) 1))) (and (=> (= (ControlFlow 0 223587) (- 0 327108)) (not (not (= (|$addr#$signer| _$t0@@0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@0) 186537453))) (and (=> (= (ControlFlow 0 223587) (- 0 327122)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (and (=> (= (ControlFlow 0 223587) (- 0 327132)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 223587) (- 0 327142)) (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@3|) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@3|) 186537453) (=> (= (ControlFlow 0 223587) (- 0 327148)) (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$balance#$1_TransactionFee_TransactionFee'$1_XUS_XUS'| (|Select__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@3|) 186537453))) 0)))))))))))))))))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Else_correct|  (=> (and (and (not $abort_flag@3) (= $abort_flag@4 $abort_flag@3)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@3| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@1|) (= $abort_code@5 $abort_code@4))) (and (=> (= (ControlFlow 0 223273) 223601) anon10_Then_correct) (=> (= (ControlFlow 0 223273) 223587) anon10_Else_correct)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|  (=> (= $abort_flag@4 true) (=> (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@3| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2|) (= $abort_code@5 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1|)) (and (=> (= (ControlFlow 0 222182) 223601) anon10_Then_correct) (=> (= (ControlFlow 0 222182) 223587) anon10_Else_correct))))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Then_correct|  (=> $abort_flag@3 (=> (and (and (= $abort_code@4 $abort_code@4) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| $abort_code@4)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@1|) (= (ControlFlow 0 223287) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then$1_correct|  (=> (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@1| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (=> (and (= $abort_flag@3 true) (= $abort_code@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 223339) 223287) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 223339) 223273) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Else_correct|))))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 223337) 223339)) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then$1_correct|)))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Else_correct|  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0@@0))) (=> (and (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@0| ($Memory_120808 (|Store__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0@@0) true) (|Store__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0@@0) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t14@1|))) (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@1| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@0|)) (and (= $abort_flag@3 $abort_flag@2) (= $abort_code@4 $abort_code@3))) (and (=> (= (ControlFlow 0 223263) 223287) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 223263) 223273) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon26_Else_correct|))))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Else_correct|  (=> (and (not $abort_flag@2) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t14@1| (|$1_TransactionFee_TransactionFee'$1_XUS_XUS'| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 223241) 223337) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Then_correct|) (=> (= (ControlFlow 0 223241) 223263) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon25_Else_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Then_correct|  (=> $abort_flag@2 (=> (and (and (= $abort_code@3 $abort_code@3) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| $abort_code@3)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 223353) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$L2_correct|  (=> (= $abort_code@3 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@1|) (=> (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$ret0@0|) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 223119) 223353) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Then_correct|) (=> (= (ControlFlow 0 223119) 223241) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Else_correct|))))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Then_correct|  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@1| $abort_code@2) (= (ControlFlow 0 223113) 223119))) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$L2_correct|)))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon8_Then_correct|  (=> |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t5@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|) (= (ControlFlow 0 223145) 223119))) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Then_correct|  (=> |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t3@0| (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) (= 5 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) 1)) (= 3 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|))) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t4@0|) (= (ControlFlow 0 223217) 223119))) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t7@1| (|$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$ret0@1|))) (=> (and (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t7@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t7@1|) (= $abort_code@3 $abort_code@2)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t7@1|) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 223099) 223353) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Then_correct|) (=> (= (ControlFlow 0 223099) 223241) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon24_Else_correct|))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$1$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1| (|$1_Diem_Diem'$1_XUS_XUS'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1|) (= $abort_code@2 $abort_code@1@@0)) (and (= $abort_flag@1 $abort_flag@0@@0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t3@1|))) (and (=> (= (ControlFlow 0 223041) 223113) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 223041) 223099) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$1$anon3_Then_correct|  (=> |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t1@0| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t1@0|) (= $abort_code@2 |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t1@0|)) (and (= $abort_flag@1 true) (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$1$$ret0@0|))) (and (=> (= (ControlFlow 0 223071) 223113) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 223071) 223099) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon9_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$1$anon0_correct|  (=> (= |inline$$1_Diem_zero'$1_XUS_XUS'$1$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 223013) 223071) |inline$$1_Diem_zero'$1_XUS_XUS'$1$anon3_Then_correct|) (=> (= (ControlFlow 0 223013) 223041) |inline$$1_Diem_zero'$1_XUS_XUS'$1$anon3_Else_correct|)))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon8_Else_correct|  (=> (and (not |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t5@0|) (= (ControlFlow 0 223077) 223013)) |inline$$1_Diem_zero'$1_XUS_XUS'$1$anon0_correct|)))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Else_correct|  (=> (and (not |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t3@0|) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t5@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 222856) 223145) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon8_Then_correct|) (=> (= (ControlFlow 0 222856) 223077) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon8_Else_correct|)))))
(let ((|inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t1@0| (|$addr#$signer| _$t0@@0)) (= _$t0@@0 _$t0@@0)) (and (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0| (|$addr#$signer| _$t0@@0)) (= |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t3@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$$t2@0|)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453)))))) (and (=> (= (ControlFlow 0 222838) 223217) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 222838) 222856) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon7_Else_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|  (=> (not $abort_flag@0@@0) (=> (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t12@0| (|$addr#$signer| _$t0@@0)) (= (ControlFlow 0 223223) 222838)) |inline$$1_Diem_create_preburn'$1_XUS_XUS'$0$anon0_correct|))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Then_correct|  (=> $abort_flag@0@@0 (=> (and (and (= $abort_code@1@@0 $abort_code@1@@0) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| $abort_code@1@@0)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 223367) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1| (|$1_Diem_Diem'$1_XUS_XUS'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1|) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t3@1|))) (and (=> (= (ControlFlow 0 222365) 223367) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 222365) 223223) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|) (= $abort_flag@0@@0 true)) (and (= $abort_code@1@@0 |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t1@0|) (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_zero'$1_XUS_XUS'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 222395) 223367) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 222395) 223223) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon23_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XUS_XUS'$0$anon0_correct|  (=> (= |inline$$1_Diem_zero'$1_XUS_XUS'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 222337) 222395) |inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 222337) 222365) |inline$$1_Diem_zero'$1_XUS_XUS'$0$anon3_Else_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon22_Then_correct|  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 222401) 222337)) |inline$$1_Diem_zero'$1_XUS_XUS'$0$anon0_correct|)))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon22_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0|)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 222176) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Else$1_correct|  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0| 6)) (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t10@0|) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 222160) 222401) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon22_Then_correct|) (=> (= (ControlFlow 0 222160) 222176) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon22_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1|)) (= (ControlFlow 0 222120) 222160)) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Else$1_correct|)))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Else_correct|  (=> (and (not false) (= (ControlFlow 0 222126) 222120)) inline$$Not$0$anon0_correct)))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon20_Then_correct|  (=> |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t6@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (=> (and (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 223407) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon19_Then_correct|  (=> (and |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t4@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) (= 5 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) 1)) (= 3 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|))) (and (not (= (|$addr#$signer| _$t0@@0) 186537453)) (= 2 |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)))) (=> (and (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@1| |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t5@0|)) (and (= |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory@2| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 223479) 222182))) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$L3_correct|))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Then_correct| true))
(let ((|inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$anon0_correct|  (=> (|$IsValid'address'| 186537453) (=> (and (= |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)) (= |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1| |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$$t1@1|)) (and (=> (= (ControlFlow 0 222076) 223381) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Then_correct|) (=> (= (ControlFlow 0 222076) 222126) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon21_Else_correct|))))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon20_Else_correct|  (=> (and (not |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t6@0|) (= (ControlFlow 0 222082) 222076)) |inline$$1_TransactionFee_is_coin_initialized'$1_XUS_XUS'$0$anon0_correct|)))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon19_Else_correct|  (=> (and (not |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t4@0|) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t6@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 221989) 223407) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon20_Then_correct|) (=> (= (ControlFlow 0 221989) 222082) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon20_Else_correct|)))))
(let ((|inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon0_correct|  (=> (= _$t0@@0 _$t0@@0) (=> (and (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0| (|$addr#$signer| _$t0@@0)) (= |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t4@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$$t3@0|)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453))))) (and (=> (= (ControlFlow 0 221971) 223479) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 221971) 221989) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon19_Else_correct|))))))
(let ((anon9_Else_correct  (=> (and (not $t5) (= (ControlFlow 0 223483) 221971)) |inline$$1_TransactionFee_add_txn_fee_currency'$1_XUS_XUS'$0$anon0_correct|)))
(let ((anon8_Else_correct  (=> (not $t2) (=> (and (= $t4 (|$addr#$signer| _$t0@@0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0@@0) 186537453))))) (and (=> (= (ControlFlow 0 221316) 223849) anon9_Then_correct) (=> (= (ControlFlow 0 221316) 223483) anon9_Else_correct))))))
(let ((anon0$1_correct@@0  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@3)) 0)) (= addr@@3 173345816)))
 :qid |TransactionFeebpl.14553:20|
 :skolemid |168|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@4)) 1)) (= addr@@4 186537453)))
 :qid |TransactionFeebpl.14561:20|
 :skolemid |169|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119820| $1_Roles_RoleId_$memory) addr@@5)) 2))))))
 :qid |TransactionFeebpl.14569:20|
 :skolemid |170|
 ...
 :qid |TransactionFeebpl.14573:20|
 :skolemid |171|
 ...
 :qid |TransactionFeebpl.14577:20|
 :skolemid |172|
 ...
 :qid |TransactionFeebpl.14581:20|
 :skolemid |173|
 ...
 :qid |TransactionFeebpl.14585:20|
 :skolemid |174|
 ...
 :qid |TransactionFeebpl.14589:20|
 :skolemid |175|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@1))
 ...
 :skolemid |199|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_120414| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@2))
)))) (and (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) $a_0@@3)))
(|$IsValid'$1_TransactionFee_TransactionFee'$1_XUS_XUS''| $rsc@@3))
 :qid |TransactionFeebpl.14784:20|
 :skolemid |200|
 :pattern ( (|Select__T@[Int]$1_TransactionFee_TransactionFee'$1_XUS_XUS'_| (|contents#$Memory_120808| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) $a_0@@3))
)) (= $t1 (|$addr#$signer| _$t0@@0))) (and (= _$t0@@0 _$t0@@0) (= $t2  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119142| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 221258) 223875) anon8_Then_correct) (=> (= (ControlFlow 0 221258) 221316) anon8_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@0  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@2 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_92611_| (|streams#$EventStore| $es) handle@@2)))
 (and (= (|l#Multiset_92611| stream@@1) 0) (forall ((v@@33 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_92611| stream@@1) v@@33) 0)
 :qid |TransactionFeebpl.134:13|
 :skolemid |2|
))))
 :qid |TransactionFeebpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 220043) 221258)) anon0$1_correct@@0)))
(let ((anon0_correct@@0  (=> (= (ControlFlow 0 324458) 220043) inline$$InitEventStore$0$anon0_correct@@0)))
anon0_correct@@0)))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
