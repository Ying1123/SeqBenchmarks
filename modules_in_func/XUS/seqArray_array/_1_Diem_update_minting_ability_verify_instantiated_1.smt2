...
(declare-fun $t9@1 () T@$Mutation_201479)
...
(declare-fun $t9@2 () T@$Mutation_201479)
...
(declare-fun $t9@0 () T@$Mutation_201479)
...
(declare-fun $t2 () T@$Mutation_201479)
(declare-fun $t10 () T@$Mutation_74103)
(push 1)
(set-info :boogie-vc-id $1_Diem_update_minting_ability$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 523561) (let ((L2_correct  (and (=> (= (ControlFlow 0 389652) (- 0 525452)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 389652) (- 0 525492)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 389524) 389652))) L2_correct)))
(let ((anon12_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6)) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 389730) 389652))) L2_correct))))
(let ((anon11_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 389802) 389652))) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| (|v#$Mutation_201479| $t9@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0|) (= $t10@0 ($Mutation_74103 (|l#$Mutation_201479| $t9@1) (let ((l (|l#Vec_23605| (|p#$Mutation_201479| $t9@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_201479| $t9@1)) l 7) (+ l 1))) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1))))) (and (= $t10@1 ($Mutation_74103 (|l#$Mutation_74103| $t10@0) (|p#$Mutation_74103| $t10@0) _$t1)) (= $t9@2 ($Mutation_201479 (|l#$Mutation_201479| $t9@1) (|p#$Mutation_201479| $t9@1) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|v#$Mutation_74103| $t10@1) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@1))))))) (and (=> (= (ControlFlow 0 389510) (- 0 524879)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_201479| $t9@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_173816 (|Store__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_201479| $t9@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_201479| $t9@2)) (|v#$Mutation_201479| $t9@2)))) (and (=> (= (ControlFlow 0 389510) (- 0 524927)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XUSbpl.22065:99|
 :skolemid |712|
 ...
 :qid |XUSbpl.22071:15|
 :skolemid |713|
)) (and (=> (= (ControlFlow 0 389510) (- 0 524995)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190993| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))
 :qid |XUSbpl.22077:15|
 :skolemid |714|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190993| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))
 :qid |XUSbpl.22077:15|
 :skolemid |714|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525018)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) dr_addr)))
 :qid |XUSbpl.22083:15|
 :skolemid |715|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) dr_addr@@0)))
 :qid |XUSbpl.22083:15|
 :skolemid |715|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525042)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 389510) (- 0 525090)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 389510) (- 0 525109)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 389510) (- 0 525124)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 389510) (- 0 525134)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 389510) (- 0 525146)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 389510) (- 0 525164)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 389510) (- 0 525178)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 389510) (- 0 525189)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389510) (- 0 525209)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1))))
 :qid |XUSbpl.22146:15|
 :skolemid |716|
 ...
 :qid |XUSbpl.22146:15|
 :skolemid |716|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525238)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3)))
 :qid |XUSbpl.22151:15|
 :skolemid |717|
 ...
 :qid |XUSbpl.22151:15|
 :skolemid |717|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525263)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389510) (- 0 525283)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185160| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185160| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5))))
 :qid |XUSbpl.22161:15|
 :skolemid |718|
 ...
 :qid |XUSbpl.22161:15|
 :skolemid |718|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525312)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185160| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_185160| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7)))
 :qid |XUSbpl.22166:15|
 :skolemid |719|
 ...
 :qid |XUSbpl.22166:15|
 :skolemid |719|
)) (and (=> (= (ControlFlow 0 389510) (- 0 525337)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389510) (- 0 525357)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 389510) (- 0 525377)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191441| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_190993| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191441| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9))))
 :qid |XUSbpl.22181:15|
 :skolemid |720|
 ...
 :qid |XUSbpl.22181:15|
 :skolemid |720|
)) (=> (= (ControlFlow 0 389510) (- 0 525413)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191441| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_191441| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11)))
 :qid |XUSbpl.22186:15|
 :skolemid |721|
))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct  (=> (= $t9@1 $t9) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 389704) 389524) anon14_Then_correct) (=> (= (ControlFlow 0 389704) 389510) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 389702) 389704)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t9@0 ($Mutation_201479 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t9@1 $t9@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 388890) 389524) anon14_Then_correct) (=> (= (ControlFlow 0 388890) 389510) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not $t7) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 388868) 389702) anon13_Then_correct) (=> (= (ControlFlow 0 388868) 388890) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not $t5) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 388854) 389730) anon12_Then_correct) (=> (= (ControlFlow 0 388854) 388868) anon12_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_173349| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1)))) 3))))
 ...
 :qid |XUSbpl.21850:104|
 :skolemid |695|
))) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184729| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |XUSbpl.21854:20|
 :skolemid |696|
))) (and (forall ((addr@@27 Int) ) (!  (=> (|$IsValid'address'| addr@@27) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_190993| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@27) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XUSbpl.21858:20|
 :skolemid |697|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172301| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_243632| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |XUSbpl.21866:20|
 :skolemid |698|
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
...
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0)))
 ...
 :qid |XUSbpl.21923:20|
 :skolemid |711|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_173816| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))))))) (and (=> (= (ControlFlow 0 388836) 389802) anon11_Then_correct) (=> (= (ControlFlow 0 388836) 388854) anon11_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 387873) 388836)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_201479| $t2)) 0) (= (|l#Vec_23605| (|p#$Mutation_201479| $t9)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_74103| $t10)) 0) (= (ControlFlow 0 387883) 387873))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 523561) 387883) anon0_correct)))
