...
(declare-fun $t17@2 () T@$Mutation_192379)
...
(declare-fun $t17@1 () T@$Mutation_192379)
...
(declare-fun $t17 () T@$Mutation_192379)
(declare-fun $t17@0 () T@$Mutation_192379)
...
(declare-fun $t7 () T@$Mutation_192379)
...
(assert (not
 ...
 :qid |XUSbpl.12656:15|
 :skolemid |362|
)) (and (=> (= (ControlFlow 0 350432) (- 0 493914)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 :qid |XUSbpl.12661:15|
 :skolemid |363|
 ...
 :qid |XUSbpl.12661:15|
 :skolemid |363|
)) (and (=> (= (ControlFlow 0 350432) (- 0 493939)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 350432) (- 0 493959)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 :qid |XUSbpl.12671:15|
 :skolemid |364|
 ...
 :qid |XUSbpl.12671:15|
 :skolemid |364|
)) (and (=> (= (ControlFlow 0 350432) (- 0 493988)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 :qid |XUSbpl.12676:15|
 :skolemid |365|
 ...
 :qid |XUSbpl.12676:15|
 :skolemid |365|
)) (and (=> (= (ControlFlow 0 350432) (- 0 494013)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 350432) (- 0 494033)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 350432) (- 0 494053)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 :qid |XUSbpl.12691:15|
 :skolemid |366|
 ...
 :qid |XUSbpl.12691:15|
 :skolemid |366|
)) (and (=> (= (ControlFlow 0 350432) (- 0 494089)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 :qid |XUSbpl.12696:15|
 :skolemid |367|
 ...
 :qid |XUSbpl.12696:15|
 :skolemid |367|
)) (and (=> (= (ControlFlow 0 350432) (- 0 494114)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |XUSbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 350432) (- 0 494145)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t10)))
...
(let ((anon42_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 350773) (- 0 493522)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t17@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t17@2)) (|v#$Mutation_192379| $t17@2)))) (and (=> (= (ControlFlow 0 350773) (- 0 493570)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |XUSbpl.12499:15|
 :skolemid |355|
)) (and (=> (= (ControlFlow 0 350773) (- 0 493638)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XUSbpl.12505:15|
 :skolemid |356|
 ...
 :qid |XUSbpl.12505:15|
 :skolemid |356|
)) (and (=> (= (ControlFlow 0 350773) (- 0 493661)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 :qid |XUSbpl.12511:15|
 :skolemid |357|
 ...
 :qid |XUSbpl.12511:15|
 :skolemid |357|
)) (and (=> (= (ControlFlow 0 350773) (- 0 493685)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 350773) (- 0 493709)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 350773) (- 0 493733)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
...
(let ((anon41_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 350016) (- 0 493114)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t17@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t17@2)) (|v#$Mutation_192379| $t17@2)))) (and (=> (= (ControlFlow 0 350016) (- 0 493162)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 ...
 :qid |XUSbpl.12565:15|
 :skolemid |359|
)) (and (=> (= (ControlFlow 0 350016) (- 0 493230)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XUSbpl.12571:15|
 :skolemid |360|
 ...
 :qid |XUSbpl.12571:15|
 :skolemid |360|
)) (and (=> (= (ControlFlow 0 350016) (- 0 493253)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 :qid |XUSbpl.12577:15|
 :skolemid |361|
 ...
 :qid |XUSbpl.12577:15|
 :skolemid |361|
)) (and (=> (= (ControlFlow 0 350016) (- 0 493277)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 350016) (- 0 493301)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 350016) (- 0 493325)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 350016) 350432)) L7_correct))))))))))))))))))))))
(let ((L9_correct  (and (=> (= (ControlFlow 0 348982) (- 0 493434)) (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 348982) (- 0 493462)) (or (or (and (not (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= 1 $t13@0)) (and (> (+ (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) _$t0) $MAX_U128) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13@0))))))))
(let ((anon42_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t13@0 $abort_code@5) (= (ControlFlow 0 350787) 348982))) L9_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_MintEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 350527) 350787) anon42_Then_correct) (=> (= (ControlFlow 0 350527) 350773) anon42_Else_correct)))))
(let ((anon41_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t34@0 ($Mutation_165569 (|l#$Mutation_192379| $t17@2) (let ((l (|l#Vec_23605| (|p#$Mutation_192379| $t17@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t17@2)) l 8) (+ l 1))) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))))) (and (= $t35@0 ($1_Diem_MintEvent _$t0 $t14)) (= (ControlFlow 0 350533) 350527))) |inline$$1_Event_emit_event'$1_Diem_MintEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t32@0)) (and (=> (= (ControlFlow 0 349768) 350533) anon41_Then_correct) (=> (= (ControlFlow 0 349768) 350016) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not $abort_flag@4) (= $t31@0 ($Mutation_15070 (|l#$Mutation_192379| $t17@1) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_192379| $t17@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t17@1)) l@@0 0) (+ l@@0 1))) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))))) (=> (and (and (= $t31@1 ($Mutation_15070 (|l#$Mutation_15070| $t31@0) (|p#$Mutation_15070| $t31@0) inline$$AddU128$0$dst@2)) (= $t17@2 ($Mutation_192379 (|l#$Mutation_192379| $t17@1) (|p#$Mutation_192379| $t17@1) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_15070| $t31@1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@2))) (= (ControlFlow 0 349774) 349768))) inline$$Not$0$anon0_correct))))
(let ((anon40_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t13@0 $abort_code@5) (= (ControlFlow 0 350801) 348982))) L9_correct)))
(let ((inline$$AddU128$0$anon3_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@4 true) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@0)) (and (=> (= (ControlFlow 0 349684) 350801) anon40_Then_correct) (=> (= (ControlFlow 0 349684) 349774) anon40_Else_correct))))))
(let ((inline$$AddU128$0$anon3_Then_correct  (=> (and (> (+ $t28@0 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 349682) 349684)) inline$$AddU128$0$anon3_Then$1_correct)))
(let ((inline$$AddU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (+ $t28@0 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$AddU128$0$dst@1 (+ $t28@0 inline$$CastU128$1$dst@1)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$AddU128$0$dst@2 inline$$AddU128$0$dst@1))) (and (=> (= (ControlFlow 0 349630) 350801) anon40_Then_correct) (=> (= (ControlFlow 0 349630) 349774) anon40_Else_correct))))))
(let ((anon39_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 349690) 349682) inline$$AddU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 349690) 349630) inline$$AddU128$0$anon3_Else_correct)))))
(let ((anon39_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t13@0 $abort_code@4) (= (ControlFlow 0 350815) 348982))) L9_correct)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 349523) 350815) anon39_Then_correct) (=> (= (ControlFlow 0 349523) 349690) anon39_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> _$t0 $MAX_U128) (= (ControlFlow 0 349521) 349523)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t0) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@4 $abort_code@3) (= inline$$CastU128$1$dst@1 _$t0))) (and (=> (= (ControlFlow 0 349473) 350815) anon39_Then_correct) (=> (= (ControlFlow 0 349473) 349690) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t28@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)))) (and (=> (= (ControlFlow 0 349529) 349521) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 349529) 349473) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon38_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 349394) (- 0 492801)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) 10000000000)) (=> (= $t27 $t27) (=> (and (= $t13@0 $t27) (= (ControlFlow 0 349394) 348982)) L9_correct)))))))
(let ((anon37_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t27) (= $t27 8)) (and (= $t27 $t27) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 349352) 349529) anon38_Then_correct) (=> (= (ControlFlow 0 349352) 349394) anon38_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= inline$$Sub$0$dst@2 inline$$CastU128$0$dst@1)) (= (ControlFlow 0 349316) 349352)) anon37_Else$1_correct)))
(let ((anon37_Else_correct  (=> (and (not $abort_flag@2) (= (ControlFlow 0 349322) 349316)) inline$$Ge$0$anon0_correct)))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t13@0 $abort_code@3) (= (ControlFlow 0 350829) 348982))) L9_correct)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 349262) 350829) anon37_Then_correct) (=> (= (ControlFlow 0 349262) 349322) anon37_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> _$t0 $MAX_U128) (= (ControlFlow 0 349260) 349262)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 _$t0) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$CastU128$0$dst@1 _$t0))) (and (=> (= (ControlFlow 0 349212) 350829) anon37_Then_correct) (=> (= (ControlFlow 0 349212) 349322) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 349268) 349260) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 349268) 349212) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon36_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t13@0 $abort_code@2) (= (ControlFlow 0 350843) 348982))) L9_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 349129) 350843) anon36_Then_correct) (=> (= (ControlFlow 0 349129) 349268) anon36_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< 340282366920938463463374607431768211455 $t22@0) (= (ControlFlow 0 349127) 349129)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= $t22@0 340282366920938463463374607431768211455) (=> (and (and (= inline$$Sub$0$dst@1 (- 340282366920938463463374607431768211455 $t22@0)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 349079) 350843) anon36_Then_correct) (=> (= (ControlFlow 0 349079) 349268) anon36_Else_correct))))))
(let ((anon35_Then_correct  (=> $t18@0 (=> (and (|$IsValid'u128'| 340282366920938463463374607431768211455) (= $t22@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)))) (and (=> (= (ControlFlow 0 349135) 349127) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 349135) 349079) inline$$Sub$0$anon3_Else_correct))))))
(let ((anon35_Else_correct  (=> (not $t18@0) (and (=> (= (ControlFlow 0 348886) (- 0 492544)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1)) 10000000000)) (=> (= $t20 $t20) (=> (and (= $t13@0 $t20) (= (ControlFlow 0 348886) 348982)) L9_correct)))))))
(let ((anon34_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_192379| $t17@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (= $t18@0 (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t17@1))) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| $t20) (= $t20 1)) (and (= $t20 $t20) (= $t18@0 $t18@0)))) (and (=> (= (ControlFlow 0 348844) 349135) anon35_Then_correct) (=> (= (ControlFlow 0 348844) 348886) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 350857) 348982))) L9_correct)))
(let ((anon33_Then$1_correct  (=> (= $t17@1 $t17) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 350909) 350857) anon34_Then_correct) (=> (= (ControlFlow 0 350909) 348844) anon34_Else_correct))))))
(let ((anon33_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 350907) 350909)) anon33_Then$1_correct)))
(let ((anon33_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t17@0 ($Mutation_192379 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t17@1 $t17@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 348790) 350857) anon34_Then_correct) (=> (= (ControlFlow 0 348790) 348844) anon34_Else_correct))))))
(let ((anon32_Else_correct  (=> (not $t15) (=> (and (and (|$IsValid'vec'u8''| $t14) (|$IsEqual'vec'u8''| $t14 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t14 $t14) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 348768) (- 0 492377)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 348768) 350907) anon33_Then_correct) (=> (= (ControlFlow 0 348768) 348790) anon33_Else_correct))))))))
(let ((anon32_Then_correct  (=> $t15 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 350935) 348982))) L9_correct))))
(let ((anon31_Else_correct  (=> (and (not $t12) (= $t15  (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 348730) 350935) anon32_Then_correct) (=> (= (ControlFlow 0 348730) 348768) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> $t12 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13)) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 350961) 348982))) L9_correct))))
(let ((anon0$1_correct  (=> (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 :qid |XUSbpl.12124:88|
 :skolemid |350|
))) (forall ((addr3@@3 Int) ) (!  (=> (|$IsValid'address'| addr3@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XUSbpl.12128:20|
 :skolemid |351|
))) (=> (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XUSbpl.12132:20|
 :skolemid |352|
)) (|$IsValid'u64'| _$t0)) (and (|$IsValid'$1_Diem_MintCapability'#0''| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)))) (=> (and (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t10 (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t9)) (= $t11 ($1_Diem_MintEvent _$t0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t9))))) (and (and (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= $t12  (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 348712) 350961) anon31_Then_correct) (=> (= (ControlFlow 0 348712) 348730) anon31_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 348469) 348712)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_192379| $t7)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_192379| $t17)) 0) (= (|l#Vec_23605| (|p#$Mutation_15070| $t31)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_165569| $t34)) 0) (= (ControlFlow 0 348479) 348469))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 491795) 348479) anon0_correct)))
