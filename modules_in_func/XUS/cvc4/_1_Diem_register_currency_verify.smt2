...
(assert (not
 (=> (= (ControlFlow 0 0) 488752) (let ((anon43_Else_correct@@5  (=> (not $abort_flag@1@@11) (=> (and (and (= $t42@0@@5 (|$1_Diem_MintCapability'#0'| false)) (= $t44@0 (|$1_Diem_BurnCapability'#0'| false))) (and (= $t42@0@@5 $t42@0@@5) (= $t44@0 $t44@0))) (and (=> (= (ControlFlow 0 358626) (- 0 492606)) (not (or (= _$t3 0) (> _$t3 10000000000)))) (=> (not (or (= _$t3 0) (> _$t3 10000000000))) (and (=> (= (ControlFlow 0 358626) (- 0 492623)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (and (=> (= (ControlFlow 0 358626) (- 0 492634)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9))) (and (=> (= (ControlFlow 0 358626) (- 0 492646)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (and (=> (= (ControlFlow 0 358626) (- 0 492664)) (not (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@12) 173345816))) (and (=> (= (ControlFlow 0 358626) (- 0 492678)) (not (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@12) 173345816))) (and (=> (= (ControlFlow 0 358626) (- 0 492692)) (not (exists ((i@@72 Int) ) (!  (and (and (|$IsValid'u64'| i@@72) (and (>= i@@72 0) (< i@@72 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@213 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@213)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@213 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@213)))) i@@72) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@214)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@214 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@214)))) i@@73) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
))) (and (=> (= (ControlFlow 0 358626) (- 0 492705)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (and (=> (= (ControlFlow 0 358626) (- 0 492718)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 358626) (- 0 492730)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12)))) (and (=> (= (ControlFlow 0 358626) (- 0 492772)) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (and (=> (= (ControlFlow 0 358626) (- 0 492778)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) 0)) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) 0) (and (=> (= (ControlFlow 0 358626) (- 0 492790)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 358626) (- 0 492810)) (forall ((addr@@215 Int) ) (!  (=> (|$IsValid'address'| addr@@215) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@215)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@215))))
 :qid |XUSbpl.18655:15|
 :skolemid |473|
))) (=> (forall ((addr@@216 Int) ) (!  (=> (|$IsValid'address'| addr@@216) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@216)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@216))))
 :qid |XUSbpl.18655:15|
 :skolemid |473|
)) (and (=> (= (ControlFlow 0 358626) (- 0 492839)) (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@217) (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@217)))
 :qid |XUSbpl.18660:15|
 :skolemid |474|
))) (=> (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr@@218)))
 :qid |XUSbpl.18660:15|
 :skolemid |474|
)) (and (=> (= (ControlFlow 0 358626) (- 0 492864)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 358626) (- 0 492884)) (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@219)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@219))))
 :qid |XUSbpl.18670:15|
 :skolemid |475|
))) (=> (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@220)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@220))))
 :qid |XUSbpl.18670:15|
 :skolemid |475|
)) (and (=> (= (ControlFlow 0 358626) (- 0 492913)) (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@221)))
 :qid |XUSbpl.18675:15|
 :skolemid |476|
))) (=> (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@222) (|Select__T@[Int]Bool_| (|domain#$Memory_175442| |$1_Diem_BurnCapability'#0'_$memory|) addr@@222)))
 :qid |XUSbpl.18675:15|
 :skolemid |476|
)) (and (=> (= (ControlFlow 0 358626) (- 0 492938)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 358626) (- 0 492958)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 358626) (- 0 492978)) (forall ((addr@@223 Int) ) (!  (=> (|$IsValid'address'| addr@@223) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@223) (|Select__T@[Int]Bool_| (|domain#$Memory_180517| |$1_Diem_Preburn'#0'_$memory|) addr@@223))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@223))))
 :qid |XUSbpl.18690:15|
 :skolemid |477|
))) (=> (forall ((addr@@224 Int) ) (!  (=> (|$IsValid'address'| addr@@224) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@224) (|Select__T@[Int]Bool_| (|domain#$Memory_180517| |$1_Diem_Preburn'#0'_$memory|) addr@@224))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@224))))
 :qid |XUSbpl.18690:15|
 :skolemid |477|
)) (=> (= (ControlFlow 0 358626) (- 0 493014)) (forall ((addr@@225 Int) ) (!  (=> (|$IsValid'address'| addr@@225) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@225) (|Select__T@[Int]Bool_| (|domain#$Memory_180942| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@225)))
 :qid |XUSbpl.18695:15|
 :skolemid |478|
)))))))))))))))))))))))))))))))))))))))))))))))))
...
(let ((L9_correct@@5  (and (=> (= (ControlFlow 0 355774) (- 0 492211)) (or (or (or (or (or (or (or (or (or (or (= _$t3 0) (> _$t3 10000000000)) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (exists ((i@@74 Int) ) (!  (and (and (|$IsValid'u64'| i@@74) (and (>= i@@74 0) (< i@@74 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@226 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@226)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@226 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@226)))) i@@74) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))))) (=> (or (or (or (or (or (or (or (or (or (or (= _$t3 0) (> _$t3 10000000000)) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (exists ((i@@75 Int) ) (!  (and (and (|$IsValid'u64'| i@@75) (and (>= i@@75 0) (< i@@75 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@227 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@227)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@227 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@227)))) i@@75) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12)))) (=> (= (ControlFlow 0 355774) (- 0 492345)) (or (or (or (or (or (or (or (or (or (and (or (= _$t3 0) (> _$t3 10000000000)) (= 7 $t16@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)) (= 6 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) (= 5 $t16@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t11@@9)) 0)) (= 3 $t16@0))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@0))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@0))) (and (exists ((i@@76 Int) ) (!  (and (and (|$IsValid'u64'| i@@76) (and (>= i@@76 0) (< i@@76 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@228 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@228)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@228 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@228)))) i@@76) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
)) (= 7 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (= 4 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 $t16@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))) (= 1 $t16@0))))))))
(let ((anon43_Then_correct@@5  (=> (and (and $abort_flag@1@@11 (= $abort_code@2@@11 $abort_code@2@@11)) (and (= $t16@0 $abort_code@2@@11) (= (ControlFlow 0 358640) 355774))) L9_correct@@5)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2|) 173345816) (=> (and (and (= (let ((addr@@229 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2|) addr@@229))) inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $abort_flag@1@@11 $abort_flag@0@@12) (= $abort_code@2@@11 $abort_code@1@@12))) (and (=> (= (ControlFlow 0 357948) 358640) anon43_Then_correct@@5) (=> (= (ControlFlow 0 357948) 358626) anon43_Else_correct@@5))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct  (=> (and (and (not |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@2|) (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@1| ($Memory_164234 (|Store__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 false) (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@1|) (= (ControlFlow 0 357922) 357948))) inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct  (=> (and (and |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@2| (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@0| ($Memory_164234 (|Store__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''@1|)))) (and (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@0|) (= (ControlFlow 0 357960) 357948))) inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Else_correct  (=> (not |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@1|) (=> (and (= $1_DiemConfig_Configuration_$memory@1 ($Memory_164004 (|Store__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1)) (and (=> (= (ControlFlow 0 357908) 357960) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct) (=> (= (ControlFlow 0 357908) 357922) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Then_correct  (=> |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@1| (=> (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_164004 (|Store__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816 |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'$1_DiemConfig_Configuration'@1|))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0)) (and (=> (= (ControlFlow 0 357972) 357960) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct) (=> (= (ControlFlow 0 357972) 357922) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Else_correct  (=> (not inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0) (and (=> (= (ControlFlow 0 357896) 357972) inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Then_correct) (=> (= (ControlFlow 0 357896) 357908) inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Else_correct)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct  (=> (and (= $abort_flag@1@@11 true) (= $abort_code@2@@11 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1)) (and (=> (= (ControlFlow 0 357675) 358640) anon43_Then_correct@@5) (=> (= (ControlFlow 0 357675) 358626) anon43_Else_correct@@5)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Then_correct  (=> inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (= 4 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0) 18446744073709551615)) (< inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0))) (= 1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0) (= (ControlFlow 0 358070) 357675))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Else_correct  (=> (not $abort_flag@0@@12) (=> (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@2 ($Mutation_173041 (|l#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (|p#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) ($1_RegisteredCurrencies_RegisteredCurrencies (|v#$Mutation_151502| |inline$$1_Vector_push_back'vec'u8''$0$m'@1|)))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@1 (|v#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@2))) (=> (and (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0) 18446744073709551615)) (< inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0))))))) (and (=> (= (ControlFlow 0 357888) 358070) inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Then_correct) (=> (= (ControlFlow 0 357888) 357896) inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Else_correct)))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@12) (= (ControlFlow 0 358084) 357675))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((|inline$$1_Vector_push_back'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'vec'u8''$0$m'@1| ($Mutation_151502 (|l#$Mutation_151502| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (|p#$Mutation_151502| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (seq.++ (|v#$Mutation_151502| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (seq.unit _$t5)))) (and (=> (= (ControlFlow 0 357752) 358084) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct) (=> (= (ControlFlow 0 357752) 357888) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Else_correct)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Then_correct  (=> (and (and inline$$Not$1$dst@1 (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1 ($Mutation_173041 ($Local 4) (as seq.empty (Seq Int)) inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0))) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1 ($Mutation_151502 (|l#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (seq.++ (|p#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (seq.unit 0)) (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (|v#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1)))) (= (ControlFlow 0 357758) 357752))) |inline$$1_Vector_push_back'vec'u8''$0$anon0_correct|)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct  (=> (and (and (not inline$$Not$1$dst@1) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= (ControlFlow 0 357669) 357675))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 7)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$Not$1$dst@1 inline$$Not$1$dst@1))) (and (=> (= (ControlFlow 0 357653) 357758) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Then_correct) (=> (= (ControlFlow 0 357653) 357669) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct))))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not |inline$$1_Vector_contains'vec'u8''$0$res@1|)) (= (ControlFlow 0 357613) 357653)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct  (=> (and (not $abort_flag@0@@12) (= (ControlFlow 0 357619) 357613)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@12) (= (ControlFlow 0 358098) 357675))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((|inline$$1_Vector_contains'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'vec'u8''$0$res@1| (exists ((i@@77 Int) ) (!  (and (and (|$IsValid'u64'| i@@77) (and (>= i@@77 0) (< i@@77 (seq.len inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1)))) (= (seq.nth inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1 i@@77) _$t5))
 :qid |XUSbpl.2220:13|
 :skolemid |62|
))) (and (=> (= (ControlFlow 0 357569) 358098) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct) (=> (= (ControlFlow 0 357569) 357619) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@230)))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1 (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0)) (= (ControlFlow 0 357575) 357569))) |inline$$1_Vector_contains'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Then_correct  (=> inline$$1_RegisteredCurrencies_add_currency_code$0$$t7@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0) (= (ControlFlow 0 358126) 357675))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon0_correct  (=> (= (seq.len (|p#$Mutation_173041| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@0)) 0) (=> (and (= (seq.len (|p#$Mutation_151502| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@0)) 0) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t5@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (and (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t6@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= _$t0@@12 _$t0@@12)) (and (= _$t5 _$t5) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t7@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 357497) 358126) inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Then_correct) (=> (= (ControlFlow 0 357497) 357575) inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Else_correct)))))))
(let ((anon42_Else_correct@@8  (=> (not $abort_flag@0@@12) (and (=> (= (ControlFlow 0 358130) (- 0 491219)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))) (forall ((mint_cap_owner1@@65 Int) (mint_cap_owner2@@65 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@65) (=> (|$IsValid'address'| mint_cap_owner2@@65) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@65) (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@65)) (= mint_cap_owner1@@65 mint_cap_owner2@@65))))
 :qid |XUSbpl.18506:83|
 :skolemid |469|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))) (forall ((mint_cap_owner1@@66 Int) (mint_cap_owner2@@66 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@66) (=> (|$IsValid'address'| mint_cap_owner2@@66) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@66) (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@66)) (= mint_cap_owner1@@66 mint_cap_owner2@@66))))
 :qid |XUSbpl.18506:83|
 :skolemid |469|
))) (and (=> (= (ControlFlow 0 358130) (- 0 491264)) (forall ((addr3@@65 Int) ) (!  (=> (|$IsValid'address'| addr3@@65) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr3@@65) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816))))))
 :qid |XUSbpl.18512:15|
 :skolemid |470|
))) (=> (forall ((addr3@@66 Int) ) (!  (=> (|$IsValid'address'| addr3@@66) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr3@@66) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816))))))
 :qid |XUSbpl.18512:15|
 :skolemid |470|
)) (and (=> (= (ControlFlow 0 358130) (- 0 491287)) (forall ((addr@@231 Int) ) (!  (=> (|$IsValid'address'| addr@@231) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180517| |$1_Diem_Preburn'#0'_$memory|) addr@@231) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))
 :qid |XUSbpl.18518:15|
 :skolemid |471|
))) (=> (forall ((addr@@232 Int) ) (!  (=> (|$IsValid'address'| addr@@232) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180517| |$1_Diem_Preburn'#0'_$memory|) addr@@232) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))
 :qid |XUSbpl.18518:15|
 :skolemid |471|
)) (and (=> (= (ControlFlow 0 358130) (- 0 491310)) (forall ((dr_addr@@53 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@53) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@53) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) dr_addr@@53)))
 :qid |XUSbpl.18524:15|
 :skolemid |472|
))) (=> (forall ((dr_addr@@54 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@54) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@54) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) dr_addr@@54)))
 :qid |XUSbpl.18524:15|
 :skolemid |472|
)) (and (=> (= (ControlFlow 0 358130) (- 0 491334)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@161 Int) ) (!  (and (|$IsValid'address'| a@@161) (and ($1_Signer_is_txn_signer_addr a@@161) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@161) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@161)) 1))))
 :qid |XUSbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@162 Int) ) (!  (and (|$IsValid'address'| a@@162) (and ($1_Signer_is_txn_signer_addr a@@162) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@162) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@162)) 1))))
 :qid |XUSbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 358130) (- 0 491358)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@163 Int) ) (!  (and (|$IsValid'address'| a@@163) (and ($1_Signer_is_txn_signer_addr a@@163) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@163) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@163)) 1))))
 :qid |XUSbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@164 Int) ) (!  (and (|$IsValid'address'| a@@164) (and ($1_Signer_is_txn_signer_addr a@@164) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@164)) 1))))
 :qid |XUSbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 358130) (- 0 491382)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (exists ((a@@165 Int) ) (!  (and (|$IsValid'address'| a@@165) (and ($1_Signer_is_txn_signer_addr a@@165) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@165) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@165)) 0))))
 :qid |XUSbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (exists ((a@@166 Int) ) (!  (and (|$IsValid'address'| a@@166) (and ($1_Signer_is_txn_signer_addr a@@166) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) a@@166) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) a@@166)) 0))))
 :qid |XUSbpl.4740:13|
 :skolemid |118|
))) (=> (= $t39@@2 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (= $t40 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= (ControlFlow 0 358130) 357497)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon0_correct)))))))))))))))))))
(let ((anon42_Then_correct@@8  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= $t16@0 $abort_code@1@@12) (= (ControlFlow 0 358654) 355774))) L9_correct@@5)))
(let ((anon41_Then$1_correct  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory|) (=> (and (= $abort_flag@0@@12 true) (= $abort_code@1@@12 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 358706) 358654) anon42_Then_correct@@8) (=> (= (ControlFlow 0 358706) 358130) anon42_Else_correct@@8))))))
(let ((anon41_Then_correct@@8  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)) (= (ControlFlow 0 358704) 358706)) anon41_Then$1_correct)))
(let ((anon41_Else_correct@@8  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| ($Memory_174430 (|Store__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12) $t38@0))) (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory@0@@3|)) (and (= $abort_flag@0@@12 false) (= $abort_code@1@@12 $abort_code@0@@12))) (and (=> (= (ControlFlow 0 356414) 358654) anon42_Then_correct@@8) (=> (= (ControlFlow 0 356414) 358130) anon42_Else_correct@@8))))))
(let ((anon40_Else_correct@@8  (=> (and (not false) (= $t38@0 (|$1_Diem_CurrencyInfo'#0'| 0 0 _$t1@@12 _$t2@@9 _$t3 _$t4 _$t5 true |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 356392) (- 0 491109)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000)) (and (=> (= (ControlFlow 0 356392) 358704) anon41_Then_correct@@8) (=> (= (ControlFlow 0 356392) 356414) anon41_Else_correct@@8)))))))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|) false) (= $1_Event_EventHandles@4 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 356322) 358720) anon40_Then_correct@@8) (=> (= (ControlFlow 0 356322) 356392) anon40_Else_correct@@8)))))
(let ((anon39_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 356328) 356322)) |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@3 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 356240) 358734) anon39_Then_correct@@8) (=> (= (ControlFlow 0 356240) 356328) anon39_Else_correct@@8)))))
(let ((anon38_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 356246) 356240)) |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0|) false) (= $1_Event_EventHandles@2 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 356158) 358748) anon38_Then_correct@@8) (=> (= (ControlFlow 0 356158) 356246) anon38_Else_correct@@8)))))
(let ((anon37_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 356164) 356158)) |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 356076) 358762) anon37_Then_correct@@8) (=> (= (ControlFlow 0 356076) 356164) anon37_Else_correct@@8)))))
(let ((anon36_Else_correct@@5  (=> (and (not false) (= (ControlFlow 0 356082) 356076)) |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 355994) 358776) anon36_Then_correct@@5) (=> (= (ControlFlow 0 355994) 356082) anon36_Else_correct@@5)))))
(let ((anon35_Then_correct@@5  (=> (and (and $t10@0 (|$IsValid'u128'| 0)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 356000) 355994))) |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|)))
(let ((anon35_Else_correct@@5  (=> (and (and (not $t10@0) (= $t29 $t29)) (and (= $t16@0 $t29) (= (ControlFlow 0 355898) 355774))) L9_correct@@5)))
(let ((L5_correct@@3  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t29) (= $t29 7)) (and (= $t29 $t29) (= $t10@0 $t10@0))) (and (=> (= (ControlFlow 0 355882) 356000) anon35_Then_correct@@5) (=> (= (ControlFlow 0 355882) 355898) anon35_Else_correct@@5))))))
(let ((anon34_Then$1_correct  (=> (= inline$$Le$0$dst@1 inline$$Le$0$dst@1) (=> (and (= $t10@0 inline$$Le$0$dst@1) (= (ControlFlow 0 358842) 355882)) L5_correct@@3))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= _$t3 10000000000)) (= (ControlFlow 0 358826) 358842)) anon34_Then$1_correct)))
(let ((anon34_Then_correct@@5  (=> inline$$Lt$0$dst@1@@0 (=> (and (|$IsValid'u64'| 10000000000) (= (ControlFlow 0 358832) 358826)) inline$$Le$0$anon0_correct))))
(let ((anon34_Else_correct@@5  (=> (and (and (not inline$$Lt$0$dst@1@@0) (= false false)) (and (= $t10@0 false) (= (ControlFlow 0 355852) 355882))) L5_correct@@3)))
(let ((inline$$Lt$0$anon0_correct@@0  (=> (= inline$$Lt$0$dst@1@@0 (< 0 _$t3)) (and (=> (= (ControlFlow 0 355824) 358832) anon34_Then_correct@@5) (=> (= (ControlFlow 0 355824) 355852) anon34_Else_correct@@5)))))
(let ((anon33_Then_correct@@5  (=> inline$$Not$0$dst@1@@11 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 355830) 355824)) inline$$Lt$0$anon0_correct@@0))))
(let ((anon33_Else_correct@@5  (=> (and (and (not inline$$Not$0$dst@1@@11) (= $t22@@2 $t22@@2)) (and (= $t16@0 $t22@@2) (= (ControlFlow 0 355386) 355774))) L9_correct@@5)))
(let ((anon32_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t22@@2) (= $t22@@2 6)) (and (= $t22@@2 $t22@@2) (= inline$$Not$0$dst@1@@11 inline$$Not$0$dst@1@@11))) (and (=> (= (ControlFlow 0 355370) 355830) anon33_Then_correct@@5) (=> (= (ControlFlow 0 355370) 355386) anon33_Else_correct@@5))))))
(let ((inline$$Not$0$anon0_correct@@11  (=> (and (= inline$$Not$0$dst@1@@11  (not $t19@0@@2)) (= (ControlFlow 0 355330) 355370)) anon32_Else$1_correct)))
(let ((anon32_Else_correct@@5  (=> (not $t17@@11) (=> (and (and (|$IsValid'address'| $t18@@2) (= $t18@@2 (|$addr#$signer| _$t0@@12))) (and (= $t19@0@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) $t18@@2)) (= (ControlFlow 0 355336) 355330))) inline$$Not$0$anon0_correct@@11))))
(let ((anon32_Then_correct@@5  (=> $t17@@11 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5)) (= $t16@@5 $t16@@5)) (and (= $t16@0 $t16@@5) (= (ControlFlow 0 358872) 355774))) L9_correct@@5))))
(let ((anon31_Else_correct@@5  (=> (and (not $t15@@8) (= $t17@@11  (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (and (=> (= (ControlFlow 0 355274) 358872) anon32_Then_correct@@5) (=> (= (ControlFlow 0 355274) 355336) anon32_Else_correct@@5)))))
(let ((anon31_Then_correct@@5  (=> $t15@@8 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t14@@12)) (= 5 $t16@@5))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t14@@12)) 0)) (= 3 $t16@@5))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5))) (= $t16@@5 $t16@@5)) (and (= $t16@0 $t16@@5) (= (ControlFlow 0 358964) 355774))) L9_correct@@5))))
(let ((anon0$1_correct@@12  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@233 Int) ) (!  (=> (|$IsValid'address'| addr@@233) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@233) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@233)) 0)) (= addr@@233 173345816)))
 :qid |XUSbpl.17870:20|
 :skolemid |432|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@234 Int) ) (!  (=> (|$IsValid'address'| addr@@234) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@234) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@234)) 1)) (= addr@@234 186537453)))
 :qid |XUSbpl.17878:20|
 :skolemid |433|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@235 Int) ) (!  (=> (|$IsValid'address'| addr@@235) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@235)) 2))))))
 :qid |XUSbpl.17886:20|
 :skolemid |434|
))) (and (forall ((addr@@236 Int) ) (!  (=> (|$IsValid'address'| addr@@236) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@236)) 2))))))
 :qid |XUSbpl.17890:20|
 :skolemid |435|
)) (forall ((addr@@237 Int) ) (!  (=> (|$IsValid'address'| addr@@237) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@237)) 2))))))
 :qid |XUSbpl.17894:20|
 :skolemid |436|
))))) (=> (and (and (and (and (forall ((addr@@238 Int) ) (!  (=> (|$IsValid'address'| addr@@238) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@238)) 2))))))
 :qid |XUSbpl.17898:20|
 :skolemid |437|
)) (forall ((addr@@239 Int) ) (!  (=> (|$IsValid'address'| addr@@239) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@239)) 2)))))
 :qid |XUSbpl.17902:20|
 :skolemid |438|
))) (and (forall ((addr@@240 Int) ) (!  (=> (|$IsValid'address'| addr@@240) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@240)) 2)))))
 :qid |XUSbpl.17906:20|
 :skolemid |439|
)) (forall ((addr@@241 Int) ) (!  (=> (|$IsValid'address'| addr@@241) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@241)) 2)))))
 :qid |XUSbpl.17910:20|
 :skolemid |440|
)))) (and (and (forall ((addr@@242 Int) ) (!  (=> (|$IsValid'address'| addr@@242) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_167770| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@242) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@242)) 4))))
 :qid |XUSbpl.17914:20|
 :skolemid |441|
)) (forall ((addr@@243 Int) ) (!  (=> (|$IsValid'address'| addr@@243) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_168328| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@243) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@243)) 3))))
 :qid |XUSbpl.17918:20|
 :skolemid |442|
))) (and (forall ((addr@@244 Int) ) (!  (=> (|$IsValid'address'| addr@@244) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_168328| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@244) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@244)) 3))))
 :qid |XUSbpl.17922:20|
 :skolemid |443|
)) (forall ((addr@@245 Int) ) (!  (=> (|$IsValid'address'| addr@@245) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_168328| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@245) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_168328| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@245)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@245)) 3))))
 :qid |XUSbpl.17926:20|
 :skolemid |444|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_163911| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_163911| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) config_address) (= config_address 173345816)))
 :qid |XUSbpl.17942:20|
 :skolemid |445|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_164090| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@246))))))))
(forall (($i_1@@20 Int) ) (!  (=> ($InRange $range_0@@20 $i_1@@20) (let ((i1 $i_1@@20))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@247 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_164090| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@247)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@247 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_164090| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@247)))) i1)))) 3))))
 :qid |XUSbpl.17950:151|
 :skolemid |446|
)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@67 Int) (mint_cap_owner2@@67 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@67) (=> (|$IsValid'address'| mint_cap_owner2@@67) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@67) (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@67)) (= mint_cap_owner1@@67 mint_cap_owner2@@67))))
 :qid |XUSbpl.17959:88|
 :skolemid |447|
))))))) (=> (and (and (and (and (and (and (forall ((addr3@@67 Int) ) (!  (=> (|$IsValid'address'| addr3@@67) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174988| |$1_Diem_MintCapability'#0'_$memory|) addr3@@67) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XUSbpl.17963:20|
 :skolemid |448|
)) (forall ((addr@@248 Int) ) (!  (=> (|$IsValid'address'| addr@@248) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180517| |$1_Diem_Preburn'#0'_$memory|) addr@@248) (|Select__T@[Int]Bool_| (|domain#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XUSbpl.17967:20|
 :skolemid |449|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164318| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164402| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164473| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164557| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164641| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164712| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164809| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_232659| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |XUSbpl.17999:20|
 :skolemid |450|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164893| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164977| $1_ChainId_ChainId_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165048| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165119| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_165119| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165119| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_165119| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165048| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165291| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165362| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@249 Int) ) (!  (=> (|$IsValid'address'| addr@@249) (= (|Select__T@[Int]Bool_| (|domain#$Memory_232946| $1_DiemAccount_DiemAccount_$memory) addr@@249) (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@249)))
 :qid |XUSbpl.18035:20|
 :skolemid |451|
)) (forall ((addr@@250 Int) ) (!  (=> (|$IsValid'address'| addr@@250) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233046| $1_VASPDomain_VASPDomainManager_$memory) addr@@250)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@250) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@250)) 1))))
 :qid |XUSbpl.18039:20|
 :skolemid |452|
)))) (and (and (forall ((addr@@251 Int) ) (!  (=> (|$IsValid'address'| addr@@251) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233131| $1_VASPDomain_VASPDomains_$memory) addr@@251)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@251)) 5))))
 :qid |XUSbpl.18043:20|
 :skolemid |453|
)) (forall ((addr@@252 Int) ) (!  (=> (|$IsValid'address'| addr@@252) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_233218| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@252) (|Select__T@[Int]Bool_| (|domain#$Memory_233278| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@252)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@252)) 2)))))
 :qid |XUSbpl.18047:20|
 :skolemid |454|
))) (and (forall ((addr@@253 Int) ) (!  (=> (|$IsValid'address'| addr@@253) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233363| $1_DesignatedDealer_Dealer_$memory) addr@@253)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@253)) 2))))
 :qid |XUSbpl.18051:20|
 :skolemid |455|
)) (forall ((addr@@254 Int) ) (!  (=> (|$IsValid'address'| addr@@254) (= (|Select__T@[Int]Bool_| (|domain#$Memory_232659| $1_DualAttestation_Credential_$memory) addr@@254)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@254)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@254)) 5)))))
 :qid |XUSbpl.18055:20|
 :skolemid |456|
))))) (and (and (and (forall ((addr@@255 Int) ) (!  (=> (|$IsValid'address'| addr@@255) (= (|Select__T@[Int]Bool_| (|domain#$Memory_163911| $1_SlidingNonce_SlidingNonce_$memory) addr@@255)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@255)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@255)) 1)))))
 :qid |XUSbpl.18059:20|
 :skolemid |457|
)) (forall ((addr@@256 Int) ) (!  (=> (|$IsValid'address'| addr@@256) (= (|Select__T@[Int]Bool_| (|domain#$Memory_168328| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@256)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@256)) 3))))
 :qid |XUSbpl.18063:20|
 :skolemid |458|
))) (and (forall ((addr@@257 Int) ) (!  (=> (|$IsValid'address'| addr@@257) (= (|Select__T@[Int]Bool_| (|domain#$Memory_167770| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@257)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@257)) 4))))
 :qid |XUSbpl.18067:20|
 :skolemid |459|
)) (forall ((addr@@258 Int) ) (!  (=> (|$IsValid'address'| addr@@258) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233618| $1_VASP_ParentVASP_$memory) addr@@258)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@258) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@258)) 5))))
 :qid |XUSbpl.18071:20|
 :skolemid |460|
)))) (and (and (forall ((addr@@259 Int) ) (!  (=> (|$IsValid'address'| addr@@259) (= (|Select__T@[Int]Bool_| (|domain#$Memory_233718| $1_VASP_ChildVASP_$memory) addr@@259)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) addr@@259) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) addr@@259)) 6))))
 :qid |XUSbpl.18075:20|
 :skolemid |461|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165433| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165517| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_163598| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@12)) ($1_Signer_is_txn_signer _$t0@@12)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@12))) (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| _$t1@@12) (|$IsValid'u64'| _$t3))) (and (and (|$IsValid'u64'| _$t4) (|$IsValid'vec'u8''| _$t5)) (and (forall (($a_0@@15 Int) ) (! (let (($rsc@@15 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@15)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@15))
 :qid |XUSbpl.18108:20|
 :skolemid |462|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@15))
)) (forall (($a_0@@16 Int) ) (! (let (($rsc@@16 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $a_0@@16)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@16))
 :qid |XUSbpl.18112:20|
 :skolemid |463|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $a_0@@16))
))))) (and (and (and (and (forall (($a_0@@17 Int) ) (! (let (($rsc@@17 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) $a_0@@17)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@17))
 :qid |XUSbpl.18116:20|
 :skolemid |464|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) $a_0@@17))
)) (forall (($a_0@@18 Int) ) (! (let (($rsc@@18 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@18)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@18))
 :qid |XUSbpl.18120:20|
 :skolemid |465|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_169132| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@18))
))) (and (forall (($a_0@@19 Int) ) (! (let (($rsc@@19 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@19)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@19))
 :qid |XUSbpl.18124:20|
 :skolemid |466|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_164234| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@19))
)) (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@20)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@20))
 :qid |XUSbpl.18128:20|
 :skolemid |467|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_169952| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@20))
)))) (and (and (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@21)))
 ...
 :qid |XUSbpl.18132:20|
 :skolemid |468|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_174430| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@21))
)) (= $t11@@9 (|$addr#$signer| _$t0@@12))) (and (= $t12@@12 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_164004| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t13@@11 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_163046| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (and (and (= _$t0@@12 _$t0@@12) (= _$t1@@12 _$t1@@12)) (and (= _$t2@@9 _$t2@@9) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (= _$t5 _$t5)) (and (= $t14@@12 (|$addr#$signer| _$t0@@12)) (= $t15@@8  (or (or (or (not (= (|$addr#$signer| _$t0@@12) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_163724| $1_Roles_RoleId_$memory) $t14@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_163724| $1_Roles_RoleId_$memory) $t14@@12)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816)))))))))) (and (=> (= (ControlFlow 0 355252) 358964) anon31_Then_correct@@5) (=> (= (ControlFlow 0 355252) 355274) anon31_Else_correct@@5)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@50 T@$1_Event_EventHandle) ) (! (let ((stream@@61 (|Select__T@[$1_Event_EventHandle]Multiset_130017_| (|streams#$EventStore| $es) handle@@50)))
 (and (= (|l#Multiset_130017| stream@@61) 0) (forall ((v@@90 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_130017| stream@@61) v@@90) 0)
 :qid |XUSbpl.134:13|
 :skolemid |2|
))))
 :qid |XUSbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 353812) 355252)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 488752) 353812) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
