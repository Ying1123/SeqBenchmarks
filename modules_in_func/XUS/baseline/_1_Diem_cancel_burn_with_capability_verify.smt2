...
(declare-fun $t20@0 () |T@$1_Diem_Diem'#0'|)
...
(declare-fun $t9 () T@Vec_132496)
(declare-fun $t10 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2| () T@$Memory_191558)
...
(declare-fun $t24@2 () T@$Mutation_192379)
...
(declare-fun $t24@1 () T@$Mutation_192379)
...
(declare-fun $t24 () T@$Mutation_192379)
(declare-fun $t24@0 () T@$Mutation_192379)
...
(declare-fun $t17 () Int)
(declare-fun $t15 () |T@$1_Diem_PreburnWithMetadata'#0'|)
(declare-fun $t18@0 () |T@$1_Diem_Preburn'#0'|)
(declare-fun $t19@0 () T@Vec_23605)
(declare-fun |$temp_0'bool'@0| () Bool)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1| () T@$Memory_191558)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0| () T@$Memory_191558)
...
(declare-fun $t6 () T@$Mutation_192379)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 484012) (let ((L5_correct  (=> (and (= $t20@0 $t20@0) (= $t36 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))) (and (=> (= (ControlFlow 0 341602) (- 0 486139)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2)) (and (=> (= (ControlFlow 0 341602) (- 0 486151)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 341602) (- 0 486161)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 341602) (- 0 486172)) (not (let (($range_0 ($Range 0 (|l#Vec_132496| $t9))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@104 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t9) i@@104)))) _$t2))))
 :qid |XUSbpl.10301:57|
 :skolemid |285|
))))) (=> (not (let (($range_0@@0 ($Range 0 (|l#Vec_132496| $t9))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@105 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t9) i@@105)))) _$t2))))
 :qid |XUSbpl.10301:57|
 :skolemid |285|
)))) (and (=> (= (ControlFlow 0 341602) (- 0 486219)) (and (and (and (and (and (and (and (and (and (and (and (and (= (|$total_value#$1_Diem_CurrencyInfo'#0'| $t36) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10)))) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t36) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t36) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t36) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t36) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t36) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t36) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t36) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10)))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (= (|$total_value#$1_Diem_CurrencyInfo'#0'| $t36) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10)))) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t36) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t36) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t36) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t36) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t36) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t36) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t36) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (= (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t36) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| $t10) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t10) _$t2) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| $t10) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t10) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t10) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| $t10) (|$currency_code#$1_Diem_CurrencyInfo'#0'| $t10) (|$can_mint#$1_Diem_CurrencyInfo'#0'| $t10) (|$mint_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t10) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| $t10))))) (and (=> (= (ControlFlow 0 341602) (- 0 486237)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0)) (and (=> (= (ControlFlow 0 341602) (- 0 486250)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 341602) (- 0 486258)) (= (|$value#$1_Diem_Diem'#0'| $t20@0) _$t2)) (=> (= (|$value#$1_Diem_Diem'#0'| $t20@0) _$t2) (and (=> (= (ControlFlow 0 341602) (- 0 486267)) (> (|$value#$1_Diem_Diem'#0'| $t20@0) 0)) (=> (> (|$value#$1_Diem_Diem'#0'| $t20@0) 0) (and (=> (= (ControlFlow 0 341602) (- 0 486277)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 341602) (- 0 486297)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 :qid |XUSbpl.10337:15|
 :skolemid |286|
 ...
 :qid |XUSbpl.10337:15|
 :skolemid |286|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486326)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 :qid |XUSbpl.10342:15|
 :skolemid |287|
 ...
 :qid |XUSbpl.10342:15|
 :skolemid |287|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486351)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 341602) (- 0 486371)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 :qid |XUSbpl.10352:15|
 :skolemid |288|
 ...
 :qid |XUSbpl.10352:15|
 :skolemid |288|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486400)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 :qid |XUSbpl.10357:15|
 :skolemid |289|
 ...
 :qid |XUSbpl.10357:15|
 :skolemid |289|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486425)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 341602) (- 0 486445)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@7))))
 :qid |XUSbpl.10367:15|
 :skolemid |290|
))) (=> (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@8))))
 :qid |XUSbpl.10367:15|
 :skolemid |290|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486480)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@9)))
 :qid |XUSbpl.10372:15|
 :skolemid |291|
))) (=> (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@10)))
 :qid |XUSbpl.10372:15|
 :skolemid |291|
)) (and (=> (= (ControlFlow 0 341602) (- 0 486504)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |XUSbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 341602) (- 0 486539)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
(let ((anon33_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 341945) (- 0 485867)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t24@2)) (|v#$Mutation_192379| $t24@2)))) (and (=> (= (ControlFlow 0 341945) (- 0 485915)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |XUSbpl.10167:15|
 :skolemid |278|
)) (and (=> (= (ControlFlow 0 341945) (- 0 485983)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XUSbpl.10173:15|
 :skolemid |279|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XUSbpl.10173:15|
 :skolemid |279|
)) (and (=> (= (ControlFlow 0 341945) (- 0 486006)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 :qid |XUSbpl.10179:15|
 :skolemid |280|
 ...
 :qid |XUSbpl.10179:15|
 :skolemid |280|
)) (and (=> (= (ControlFlow 0 341945) (- 0 486030)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 341945) (- 0 486054)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 341945) (- 0 486078)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
...
(let ((anon32_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 341119) (- 0 485388)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t24@2)) (|v#$Mutation_192379| $t24@2)))) (and (=> (= (ControlFlow 0 341119) (- 0 485436)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 ...
 :qid |XUSbpl.10233:15|
 :skolemid |282|
)) (and (=> (= (ControlFlow 0 341119) (- 0 485504)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XUSbpl.10239:15|
 :skolemid |283|
))) (=> (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XUSbpl.10239:15|
 :skolemid |283|
)) (and (=> (= (ControlFlow 0 341119) (- 0 485527)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 :qid |XUSbpl.10245:15|
 :skolemid |284|
))) (=> (forall ((dr_addr@@2 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@2)))
 :qid |XUSbpl.10245:15|
 :skolemid |284|
)) (and (=> (= (ControlFlow 0 341119) (- 0 485551)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@6 Int) ) (!  (and (|$IsValid'address'| a@@6) (and ($1_Signer_is_txn_signer_addr a@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@6)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 341119) (- 0 485575)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@8 Int) ) (!  (and (|$IsValid'address'| a@@8) (and ($1_Signer_is_txn_signer_addr a@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@8)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 341119) (- 0 485599)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@10 Int) ) (!  (and (|$IsValid'address'| a@@10) (and ($1_Signer_is_txn_signer_addr a@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@10)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 341119) 341602)) L5_correct))))))))))))))))))))))
(let ((L7_correct  (and (=> (= (ControlFlow 0 340646) (- 0 485696)) (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@1 ($Range 0 (|l#Vec_132496| $t9))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@106 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t9) i@@106)))) _$t2))))
 :qid |XUSbpl.10395:251|
 :skolemid |292|
))))) (=> (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@2 ($Range 0 (|l#Vec_132496| $t9))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@107 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t9) i@@107)))) _$t2))))
 :qid |XUSbpl.10395:251|
 :skolemid |292|
)))) (=> (= (ControlFlow 0 340646) (- 0 485762)) (or (or (or (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (= 8 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17@0))) (and (let (($range_0@@3 ($Range 0 (|l#Vec_132496| $t9))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@108 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t9) i@@108)))) _$t2))))
 :qid |XUSbpl.10400:336|
 :skolemid |293|
))) (= 1 $t17@0))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 341959) 340646))) L7_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 341699) 341959) anon33_Then_correct) (=> (= (ControlFlow 0 341699) 341945) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t34@0 ($Mutation_165569 (|l#$Mutation_192379| $t24@2) (let ((l (|l#Vec_23605| (|p#$Mutation_192379| $t24@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t24@2)) l 11) (+ l 1))) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))))) (and (= $t35@0 ($1_Diem_CancelBurnEvent _$t2 $t21 _$t0)) (= (ControlFlow 0 341705) 341699))) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t32@0)) (and (=> (= (ControlFlow 0 340871) 341705) anon32_Then_correct) (=> (= (ControlFlow 0 340871) 341119) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not $abort_flag@1) (= $t31@0 ($Mutation_15070 (|l#$Mutation_192379| $t24@1) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_192379| $t24@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t24@1)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1))))) (=> (and (and (= $t31@1 ($Mutation_15070 (|l#$Mutation_15070| $t31@0) (|p#$Mutation_15070| $t31@0) inline$$Sub$0$dst@2)) (= $t24@2 ($Mutation_192379 (|l#$Mutation_192379| $t24@1) (|p#$Mutation_192379| $t24@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|v#$Mutation_15070| $t31@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@2))) (= (ControlFlow 0 340877) 340871))) inline$$Not$0$anon0_correct))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 341973) 340646))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 340787) 341973) anon31_Then_correct) (=> (= (ControlFlow 0 340787) 340877) anon31_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< $t29@0 _$t2) (= (ControlFlow 0 340785) 340787)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= _$t2 $t29@0) (=> (and (and (= inline$$Sub$0$dst@1 (- $t29@0 _$t2)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 340737) 341973) anon31_Then_correct) (=> (= (ControlFlow 0 340737) 340877) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t29@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)))) (and (=> (= (ControlFlow 0 340793) 340785) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 340793) 340737) inline$$Sub$0$anon3_Else_correct)))))
(let ((anon30_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 340464) (- 0 485156)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1)) 10000000000)) (=> (= $t28 $t28) (=> (and (= $t17@0 $t28) (= (ControlFlow 0 340464) 340646)) L7_correct)))))))
(let ((anon29_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t28) (= $t28 8)) (and (= $t28 $t28) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 340422) 340793) anon30_Then_correct) (=> (= (ControlFlow 0 340422) 340464) anon30_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= $t25@0 _$t2)) (= (ControlFlow 0 340386) 340422)) anon29_Else$1_correct)))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_192379| $t24@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (= $t25@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t24@1))) (= (ControlFlow 0 340392) 340386))) inline$$Ge$0$anon0_correct))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 341987) 340646))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 342039) 341987) anon29_Then_correct) (=> (= (ControlFlow 0 342039) 340392) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 342037) 342039)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t24@0 ($Mutation_192379 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 340320) 341987) anon29_Then_correct) (=> (= (ControlFlow 0 340320) 340392) anon29_Else_correct))))))
(let ((anon27_Else_correct  (=> (not $t22) (=> (and (and (|$IsValid'vec'u8''| $t21) (|$IsEqual'vec'u8''| $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t21 $t21) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 340298) (- 0 484976)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 340298) 342037) anon28_Then_correct) (=> (= (ControlFlow 0 340298) 340320) anon28_Else_correct))))))))
(let ((anon27_Then_correct  (=> $t22 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 342065) 340646))) L7_correct))))
(let ((anon5_correct  (=> (and (and (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| $t15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0))) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15))) _$t2) (= $t18@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15)))) (and (and (= $t19@0 (|$metadata#$1_Diem_PreburnWithMetadata'#0'| $t15)) (= $t20@0 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0))) (and (= $t20@0 $t20@0) (= $t22  (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 340260) 342065) anon27_Then_correct) (=> (= (ControlFlow 0 340260) 340298) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_191558 (|Store__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 false) (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 340198) 340260))) anon5_correct)))
(let ((anon26_Then_correct  (=> (and (and |$temp_0'bool'@0| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_191558 (|Store__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 |$temp_0'$1_Diem_PreburnQueue'#0''@0|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 342077) 340260))) anon5_correct)))
(let ((anon25_Else_correct  (=> (not $t16) (and (=> (= (ControlFlow 0 340186) 342077) anon26_Then_correct) (=> (= (ControlFlow 0 340186) 340198) anon26_Else_correct)))))
(let ((anon25_Then_correct  (=> $t16 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17)) (and (let (($range_0@@4 ($Range 0 (|l#Vec_132496| $t14))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@109 $i_1@@4))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t14) i@@109)))) _$t2))))
 :qid |XUSbpl.9917:151|
 :skolemid |276|
))) (= 1 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 342158) 340646))) L7_correct))))
(let ((anon0$1_correct  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 :qid |XUSbpl.9797:88|
 :skolemid |266|
))) (=> (and (forall ((addr3@@3 Int) ) (!  (=> (|$IsValid'address'| addr3@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XUSbpl.9801:20|
 :skolemid |267|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) addr1)) 2))))
 :qid |XUSbpl.9805:20|
 :skolemid |268|
))) (=> (and (and (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr)))))
 :qid |XUSbpl.9809:20|
 :skolemid |269|
)) (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))))
 :qid |XUSbpl.9813:20|
 :skolemid |270|
))) (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XUSbpl.9817:20|
 :skolemid |271|
)) (|$IsValid'address'| _$t0))) (=> (and (and (and (and (|$IsValid'$1_Diem_BurnCapability'#0''| _$t1) (|$IsValid'u64'| _$t2)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@0)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@0) (and (<= (|l#Vec_132496| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)) 256) (let (($range_1 ($Range 0 (|l#Vec_132496| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@110 $i_2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)) i@@110)))) 0)))
 :qid |XUSbpl.9835:199|
 :skolemid |273|
))))))
 :qid |XUSbpl.9834:20|
 :skolemid |274|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@0))
)))) (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)))) (and (= $t10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t11 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t12 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t11))) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t14 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))))))) (and (=> (= (ControlFlow 0 340178) (- 0 484658)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (=> (= $t16  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (let (($range_0@@5 ($Range 0 (|l#Vec_132496| $t14))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@111 $i_1@@5))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_132496| $t14) i@@111)))) _$t2))))
 :qid |XUSbpl.9907:131|
 :skolemid |275|
))))) (and (=> (= (ControlFlow 0 340178) 342158) anon25_Then_correct) (=> (= (ControlFlow 0 340178) 340186) anon25_Else_correct)))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 339652) 340178)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_192379| $t6)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_192379| $t24)) 0) (= (|l#Vec_23605| (|p#$Mutation_15070| $t31)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_165569| $t34)) 0) (= (ControlFlow 0 339662) 339652))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 484012) 339662) anon0_correct)))
