...
(declare-fun $t0@0 () T@$Mutation_192331)
(declare-fun $t13 () Int)
(declare-fun $t14 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_184229)
(declare-fun |Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|T@[Int]$1_Diem_CurrencyInfo'#0'| Int) |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3| () T@$Memory_184229)
...
(declare-fun $t33@3 () T@$Mutation_192379)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2| () T@$Memory_184229)
...
(declare-fun $t33@2 () T@$Mutation_192379)
...
(declare-fun $t33@1 () T@$Mutation_192379)
...
(declare-fun $t33 () T@$Mutation_192379)
(declare-fun $t33@0 () T@$Mutation_192379)
...
(declare-fun $t27@0 () T@$Mutation_192429)
(declare-fun _$t0 () T@$Mutation_192331)
(declare-fun $t29@0 () |T@$1_Diem_Diem'#0'|)
(declare-fun $t27@1 () T@$Mutation_192429)
...
(declare-fun _$t2 () |T@$1_Diem_BurnCapability'#0'|)
(declare-fun |$temp_0'$1_Diem_Preburn'#0''@0| () |T@$1_Diem_Preburn'#0'|)
(declare-fun $t10 () T@$Mutation_192379)
(declare-fun $t27 () T@$Mutation_192429)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 475034) (let ((L9_correct  (=> (and (= |$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_192331| $t0@0)) (= |$temp_0'$1_Diem_Preburn'#0''@1| |$temp_0'$1_Diem_Preburn'#0''@1|)) (and (=> (= (ControlFlow 0 331776) (- 0 477604)) (not (= $t13 0))) (=> (not (= $t13 0)) (and (=> (= (ControlFlow 0 331776) (- 0 477615)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (and (=> (= (ControlFlow 0 331776) (- 0 477628)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (and (=> (= (ControlFlow 0 331776) (- 0 477641)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 331776) (- 0 477651)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)))) (and (=> (= (ControlFlow 0 331776) (- 0 477674)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)))) (and (=> (= (ControlFlow 0 331776) (- 0 477697)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 331776) (- 0 477717)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr))))
 :qid |XUSbpl.7826:15|
 :skolemid |216|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@0))))
 :qid |XUSbpl.7826:15|
 :skolemid |216|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477746)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 :qid |XUSbpl.7831:15|
 :skolemid |217|
))) (=> (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr@@2)))
 :qid |XUSbpl.7831:15|
 :skolemid |217|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477771)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 :qid |XUSbpl.7836:15|
 :skolemid |218|
))) (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@4))))
 :qid |XUSbpl.7836:15|
 :skolemid |218|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477800)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 :qid |XUSbpl.7841:15|
 :skolemid |219|
))) (=> (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6) (|Select__T@[Int]Bool_| (|domain#$Memory_185247| |$1_Diem_BurnCapability'#0'_$memory|) addr@@6)))
 :qid |XUSbpl.7841:15|
 :skolemid |219|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477825)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 331776) (- 0 477845)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7))))
 :qid |XUSbpl.7851:15|
 :skolemid |220|
))) (=> (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8))))
 :qid |XUSbpl.7851:15|
 :skolemid |220|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477881)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9)))
 :qid |XUSbpl.7856:15|
 :skolemid |221|
))) (=> (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_191558| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10)))
 :qid |XUSbpl.7856:15|
 :skolemid |221|
)) (and (=> (= (ControlFlow 0 331776) (- 0 477906)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t15)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t17)))
(let ((stream_new (let ((len (|l#Multiset_131853| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)))))
(Multiset_131853 (|Store__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t15)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t17)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_131853| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)))))
(Multiset_131853 (|Store__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t17 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |XUSbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 331776) (- 0 477946)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t15)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $EmptyEventStore) $t17)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_131853| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)))))
(Multiset_131853 (|Store__T@[$EventRep]Int_| (|v#Multiset_131853| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12)) $t16 _$t1)) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((anon49_Else_correct  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 332119) (- 0 477338)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@2| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@3)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@3)) (|v#$Mutation_192379| $t33@3)))) (and (=> (= (ControlFlow 0 332119) (- 0 477386)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XUSbpl.7649:83|
 :skolemid |208|
 ...
 :qid |XUSbpl.7649:83|
 :skolemid |208|
))) (and (=> (= (ControlFlow 0 332119) (- 0 477431)) (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816))))))
 :qid |XUSbpl.7655:15|
 :skolemid |209|
 ...
 :qid |XUSbpl.7655:15|
 :skolemid |209|
)) (and (=> (= (ControlFlow 0 332119) (- 0 477454)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)))
 :qid |XUSbpl.7661:15|
 :skolemid |210|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)))
 :qid |XUSbpl.7661:15|
 :skolemid |210|
)) (and (=> (= (ControlFlow 0 332119) (- 0 477477)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) dr_addr)))
 :qid |XUSbpl.7667:15|
 :skolemid |211|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) dr_addr@@0)))
 :qid |XUSbpl.7667:15|
 :skolemid |211|
)) (and (=> (= (ControlFlow 0 332119) (- 0 477501)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 332119) (- 0 477525)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@2)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 332119) (- 0 477549)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es@0) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory@2|) (= (ControlFlow 0 332119) 331776)) L9_correct))))))))))))))))))))))
(let ((anon48_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 331368) (- 0 476910)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@3)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@3)) (|v#$Mutation_192379| $t33@3)))) (and (=> (= (ControlFlow 0 331368) (- 0 476958)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 :qid |XUSbpl.7715:83|
 :skolemid |212|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1@@2 Int) (mint_cap_owner2@@2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@2) (=> (|$IsValid'address'| mint_cap_owner2@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@2)) (= mint_cap_owner1@@2 mint_cap_owner2@@2))))
 :qid |XUSbpl.7715:83|
 :skolemid |212|
))) (and (=> (= (ControlFlow 0 331368) (- 0 477003)) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816))))))
 :qid |XUSbpl.7721:15|
 :skolemid |213|
))) (=> (forall ((addr3@@2 Int) ) (!  (=> (|$IsValid'address'| addr3@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816))))))
 :qid |XUSbpl.7721:15|
 :skolemid |213|
)) (and (=> (= (ControlFlow 0 331368) (- 0 477026)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XUSbpl.7727:15|
 :skolemid |214|
))) (=> (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XUSbpl.7727:15|
 :skolemid |214|
)) (and (=> (= (ControlFlow 0 331368) (- 0 477049)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr@@1)))
 :qid |XUSbpl.7733:15|
 :skolemid |215|
))) (=> (forall ((dr_addr@@2 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@2) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr@@2)))
 :qid |XUSbpl.7733:15|
 :skolemid |215|
)) (and (=> (= (ControlFlow 0 331368) (- 0 477073)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@6 Int) ) (!  (and (|$IsValid'address'| a@@6) (and ($1_Signer_is_txn_signer_addr a@@6) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@6)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 331368) (- 0 477097)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@8 Int) ) (!  (and (|$IsValid'address'| a@@8) (and ($1_Signer_is_txn_signer_addr a@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@8)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 331368) (- 0 477121)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@10 Int) ) (!  (and (|$IsValid'address'| a@@10) (and ($1_Signer_is_txn_signer_addr a@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@10)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 331368) 331776)) L9_correct))))))))))))))))))))))
(let ((L13_correct  (and (=> (= (ControlFlow 0 329832) (- 0 477233)) (or (or (or (= $t13 0) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (= $t13 0) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 329832) (- 0 477266)) (or (or (or (and (= $t13 0) (= 1 $t20@0)) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13) (= 8 $t20@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t14) $t13) (= 8 $t20@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t20@0))))))))
(let ((anon49_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t20@0 $abort_code@5) (= (ControlFlow 0 332133) 329832))) L13_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 331873) 332133) anon49_Then_correct) (=> (= (ControlFlow 0 331873) 332119) anon49_Else_correct)))))
(let ((anon48_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t52@0 ($Mutation_165569 (|l#$Mutation_192379| $t33@3) (let ((l (|l#Vec_23605| (|p#$Mutation_192379| $t33@3))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t33@3)) l 9) (+ l 1))) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))))) (and (= $t53@0 ($1_Diem_BurnEvent $t30@0 $t18 _$t1)) (= (ControlFlow 0 331879) 331873))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t50@0)) (and (=> (= (ControlFlow 0 331120) 331879) anon48_Then_correct) (=> (= (ControlFlow 0 331120) 331368) anon48_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (not $abort_flag@4) (= $t49@0 ($Mutation_15070 (|l#$Mutation_192379| $t33@2) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_192379| $t33@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t33@2)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2))))) (=> (and (and (= $t49@1 ($Mutation_15070 (|l#$Mutation_15070| $t49@0) (|p#$Mutation_15070| $t49@0) inline$$Sub$1$dst@2)) (= $t33@3 ($Mutation_192379 (|l#$Mutation_192379| $t33@2) (|p#$Mutation_192379| $t33@2) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|v#$Mutation_15070| $t49@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)))))) (and (= $t50@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@3))) (= (ControlFlow 0 331126) 331120))) inline$$Not$0$anon0_correct))))
(let ((anon47_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t20@0 $abort_code@5) (= (ControlFlow 0 332147) 329832))) L13_correct)))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@4 true) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 331036) 332147) anon47_Then_correct) (=> (= (ControlFlow 0 331036) 331126) anon47_Else_correct))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< $t47@0 $t30@0) (= (ControlFlow 0 331034) 331036)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= $t30@0 $t47@0) (=> (and (and (= inline$$Sub$1$dst@1 (- $t47@0 $t30@0)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 330986) 332147) anon47_Then_correct) (=> (= (ControlFlow 0 330986) 331126) anon47_Else_correct))))))
(let ((anon46_Then_correct  (=> (and inline$$Ge$1$dst@1 (= $t47@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)))) (and (=> (= (ControlFlow 0 331042) 331034) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 331042) 330986) inline$$Sub$1$anon3_Else_correct)))))
(let ((anon46_Else_correct  (=> (not inline$$Ge$1$dst@1) (and (=> (= (ControlFlow 0 330895) (- 0 476471)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_184229 (|Store__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_192379| $t33@2)) (|v#$Mutation_192379| $t33@2)))) (and (=> (= (ControlFlow 0 330895) (- 0 476519)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 :qid |XUSbpl.7516:83|
 :skolemid |204|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@4 Int) (mint_cap_owner2@@4 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@4) (=> (|$IsValid'address'| mint_cap_owner2@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@4)) (= mint_cap_owner1@@4 mint_cap_owner2@@4))))
 :qid |XUSbpl.7516:83|
 :skolemid |204|
))) (and (=> (= (ControlFlow 0 330895) (- 0 476564)) (forall ((addr3@@3 Int) ) (!  (=> (|$IsValid'address'| addr3@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816))))))
 :qid |XUSbpl.7522:15|
 :skolemid |205|
))) (=> (forall ((addr3@@4 Int) ) (!  (=> (|$IsValid'address'| addr3@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816))))))
 :qid |XUSbpl.7522:15|
 :skolemid |205|
)) (and (=> (= (ControlFlow 0 330895) (- 0 476587)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XUSbpl.7528:15|
 :skolemid |206|
))) (=> (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XUSbpl.7528:15|
 :skolemid |206|
)) (and (=> (= (ControlFlow 0 330895) (- 0 476610)) (forall ((dr_addr@@3 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@3)))
 :qid |XUSbpl.7534:15|
 :skolemid |207|
))) (=> (forall ((dr_addr@@4 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@4)))
 :qid |XUSbpl.7534:15|
 :skolemid |207|
)) (and (=> (= (ControlFlow 0 330895) (- 0 476634)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@11 Int) ) (!  (and (|$IsValid'address'| a@@11) (and ($1_Signer_is_txn_signer_addr a@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@11)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@12 Int) ) (!  (and (|$IsValid'address'| a@@12) (and ($1_Signer_is_txn_signer_addr a@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@12)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 330895) (- 0 476658)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@13 Int) ) (!  (and (|$IsValid'address'| a@@13) (and ($1_Signer_is_txn_signer_addr a@@13) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@13)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@14 Int) ) (!  (and (|$IsValid'address'| a@@14) (and ($1_Signer_is_txn_signer_addr a@@14) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@14)) 1))))
 :qid |XUSbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 330895) (- 0 476682)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@15 Int) ) (!  (and (|$IsValid'address'| a@@15) (and ($1_Signer_is_txn_signer_addr a@@15) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@15)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@16 Int) ) (!  (and (|$IsValid'address'| a@@16) (and ($1_Signer_is_txn_signer_addr a@@16) (and (|Select__T@[Int]Bool_| (|domain#$Memory_172983| $1_Roles_RoleId_$memory) a@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_172983| $1_Roles_RoleId_$memory) a@@16)) 0))))
 :qid |XUSbpl.4777:13|
 :skolemid |144|
))) (=> (= $t46 $t46) (=> (and (= $t20@0 $t46) (= (ControlFlow 0 330895) 329832)) L13_correct))))))))))))))))))))))
(let ((anon45_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t46) (= $t46 8)) (and (= $t46 $t46) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 330647) 331042) anon46_Then_correct) (=> (= (ControlFlow 0 330647) 330895) anon46_Else_correct))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= $t43@0 $t30@0)) (= (ControlFlow 0 330611) 330647)) anon45_Else$1_correct)))
(let ((anon45_Else_correct  (=> (and (not $abort_flag@3) (= $t42@0 ($Mutation_15070 (|l#$Mutation_192379| $t33@1) (let ((l@@1 (|l#Vec_23605| (|p#$Mutation_192379| $t33@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192379| $t33@1)) l@@1 0) (+ l@@1 1))) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1))))) (=> (and (and (= $t42@1 ($Mutation_15070 (|l#$Mutation_15070| $t42@0) (|p#$Mutation_15070| $t42@0) inline$$Sub$0$dst@2)) (= $t33@2 ($Mutation_192379 (|l#$Mutation_192379| $t33@1) (|p#$Mutation_192379| $t33@1) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_15070| $t42@1) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)))))) (and (= $t43@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@2))) (= (ControlFlow 0 330617) 330611))) inline$$Ge$1$anon0_correct))))
(let ((anon45_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t20@0 $abort_code@4) (= (ControlFlow 0 332161) 329832))) L13_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 330517) 332161) anon45_Then_correct) (=> (= (ControlFlow 0 330517) 330617) anon45_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< $t39@0 inline$$CastU128$1$dst@1) (= (ControlFlow 0 330515) 330517)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 $t39@0) (=> (and (and (= inline$$Sub$0$dst@1 (- $t39@0 inline$$CastU128$1$dst@1)) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@4 $abort_code@3) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 330467) 332161) anon45_Then_correct) (=> (= (ControlFlow 0 330467) 330617) anon45_Else_correct))))))
(let ((anon44_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 330523) 330515) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 330523) 330467) inline$$Sub$0$anon3_Else_correct)))))
(let ((anon44_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t20@0 $abort_code@3) (= (ControlFlow 0 332175) 329832))) L13_correct)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 330372) 332175) anon44_Then_correct) (=> (= (ControlFlow 0 330372) 330523) anon44_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> $t30@0 $MAX_U128) (= (ControlFlow 0 330370) 330372)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 $t30@0) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@2 $abort_flag@1) (= inline$$CastU128$1$dst@1 $t30@0))) (and (=> (= (ControlFlow 0 330322) 332175) anon44_Then_correct) (=> (= (ControlFlow 0 330322) 330523) anon44_Else_correct)))))
(let ((anon43_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t39@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)))) (and (=> (= (ControlFlow 0 330378) 330370) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 330378) 330322) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon43_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 330243) (- 0 476157)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1)) 10000000000)) (=> (= $t38 $t38) (=> (and (= $t20@0 $t38) (= (ControlFlow 0 330243) 329832)) L13_correct)))))))
(let ((anon42_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t38) (= $t38 8)) (and (= $t38 $t38) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 330201) 330378) anon43_Then_correct) (=> (= (ControlFlow 0 330201) 330243) anon43_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= $t34@0 inline$$CastU128$0$dst@1)) (= (ControlFlow 0 330165) 330201)) anon42_Else$1_correct)))
(let ((anon42_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 330171) 330165)) inline$$Ge$0$anon0_correct)))
(let ((anon42_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t20@0 $abort_code@2) (= (ControlFlow 0 332189) 329832))) L13_correct)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 330111) 332189) anon42_Then_correct) (=> (= (ControlFlow 0 330111) 330171) anon42_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> $t30@0 $MAX_U128) (= (ControlFlow 0 330109) 330111)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 $t30@0) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$CastU128$0$dst@1 $t30@0))) (and (=> (= (ControlFlow 0 330061) 332189) anon42_Then_correct) (=> (= (ControlFlow 0 330061) 330171) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_192379| $t33@1))) (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|) (= $t34@0 (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_192379| $t33@1))))) (and (=> (= (ControlFlow 0 330117) 330109) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 330117) 330061) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon41_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t20@0 $abort_code@1) (= (ControlFlow 0 332203) 329832))) L13_correct)))
(let ((anon40_Then$1_correct  (=> (= $t33@1 $t33) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 332255) 332203) anon41_Then_correct) (=> (= (ControlFlow 0 332255) 330117) anon41_Else_correct))))))
(let ((anon40_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 332253) 332255)) anon40_Then$1_correct)))
(let ((anon40_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t33@0 ($Mutation_192379 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t33@1 $t33@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 329966) 332203) anon41_Then_correct) (=> (= (ControlFlow 0 329966) 330117) anon41_Else_correct))))))
(let ((anon39_Else_correct  (=> (and (not $t31) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 329944) 332253) anon40_Then_correct) (=> (= (ControlFlow 0 329944) 329966) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> $t31 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t20)) (= $t20 $t20)) (and (= $t20@0 $t20) (= (ControlFlow 0 332281) 329832))) L13_correct))))
(let ((anon38_Then_correct  (=> inline$$Gt$0$dst@1 (=> (and (and (= $t27@0 ($Mutation_192429 (|l#$Mutation_192331| _$t0) (let ((l@@2 (|l#Vec_23605| (|p#$Mutation_192331| _$t0))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_192331| _$t0)) l@@2 0) (+ l@@2 1))) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_192331| _$t0)))) (= $t29@0 (|v#$Mutation_192429| $t27@0))) (and (= $t27@1 ($Mutation_192429 (|l#$Mutation_192429| $t27@0) (|p#$Mutation_192429| $t27@0) |$temp_0'$1_Diem_Diem'#0''@0|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_192429| $t27@1)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_192429| $t27@1)) (|$IsValid'$1_Diem_Diem'#0''| $t28)) (and (= (|$value#$1_Diem_Diem'#0'| $t28) (|$value#$1_Diem_Diem'#0'| $t29@0)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_192429| $t27@1)) 0))) (and (and (= $t0@0 ($Mutation_192331 (|l#$Mutation_192331| _$t0) (|p#$Mutation_192331| _$t0) (|$1_Diem_Preburn'#0'| (|v#$Mutation_192429| $t27@1)))) (= $t30@0 (|$value#$1_Diem_Diem'#0'| $t28))) (and (= $t30@0 $t30@0) (= $t31  (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 329930) 332281) anon39_Then_correct) (=> (= (ControlFlow 0 329930) 329944) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t26 $t26)) (and (= $t20@0 $t26) (= (ControlFlow 0 329724) 329832))) L13_correct)))
(let ((anon37_Else$1_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t26) (= $t26 1)) (and (= $t26 $t26) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 329708) 329930) anon38_Then_correct) (=> (= (ControlFlow 0 329708) 329724) anon38_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> $t22@0 0)) (= (ControlFlow 0 329672) 329708)) anon37_Else$1_correct)))
(let ((anon37_Else_correct  (=> (and (and (and (not $t19) (|$IsValid'vec'u8''| $t18)) (and (|$IsEqual'vec'u8''| $t18 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t18 $t18))) (and (and (= $t21@0 (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_192331| _$t0))) (= $t22@0 (|$value#$1_Diem_Diem'#0'| $t21@0))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 329678) 329672)))) inline$$Gt$0$anon0_correct)))
(let ((anon37_Then_correct  (=> $t19 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t20)) (= $t20 $t20)) (and (= $t20@0 $t20) (= (ControlFlow 0 332307) 329832))) L13_correct))))
(let ((anon0$1_correct  (=> (= (|l#$Mutation_192331| _$t0) ($Param 0)) (=> (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@5 Int) (mint_cap_owner2@@5 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@5) (=> (|$IsValid'address'| mint_cap_owner2@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@5)) (= mint_cap_owner1@@5 mint_cap_owner2@@5))))
 :qid |XUSbpl.7118:88|
 :skolemid |200|
))) (forall ((addr3@@5 Int) ) (!  (=> (|$IsValid'address'| addr3@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_184793| |$1_Diem_MintCapability'#0'_$memory|) addr3@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XUSbpl.7122:20|
 :skolemid |201|
))) (=> (and (and (and (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_191074| |$1_Diem_Preburn'#0'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XUSbpl.7126:20|
 :skolemid |202|
)) (|$IsValid'$1_Diem_Preburn'#0''| (|v#$Mutation_192331| _$t0))) (and (|$IsValid'address'| _$t1) (|$IsValid'$1_Diem_BurnCapability'#0''| _$t2))) (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
 ...
 :qid |XUSbpl.7138:20|
 :skolemid |203|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0))
)) (= $t12 (|v#$Mutation_192331| _$t0))) (and (= $t13 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t12))) (= $t14 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t15 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t16 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t17 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t15)) (= |$temp_0'$1_Diem_Preburn'#0''@0| (|v#$Mutation_192331| _$t0)))) (and (and (= |$temp_0'$1_Diem_Preburn'#0''@0| |$temp_0'$1_Diem_Preburn'#0''@0|) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t19  (not (|Select__T@[Int]Bool_| (|domain#$Memory_184229| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 329590) 332307) anon37_Then_correct) (=> (= (ControlFlow 0 329590) 329678) anon37_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_131853_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XUSbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 329317) 329590)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_192379| $t10)) 0) (=> (and (= (|l#Vec_23605| (|p#$Mutation_192429| $t27)) 0) (= (|l#Vec_23605| (|p#$Mutation_192379| $t33)) 0)) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_15070| $t42)) 0) (= (|l#Vec_23605| (|p#$Mutation_15070| $t49)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_165569| $t52)) 0) (= (ControlFlow 0 329327) 329317))) inline$$InitEventStore$0$anon0_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 475034) 329327) anon0_correct)))
