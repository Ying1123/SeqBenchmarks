...
(assert (not
 (=> (= (ControlFlow 0 0) 215560) (let ((anon0$2_correct  (=> (and (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (= (ControlFlow 0 156205) (- 0 215676))) (not false))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t1@0)) (= (ControlFlow 0 156183) 156205)) anon0$2_correct)))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemTimestampbpl.3711:20|
 :skolemid |123|
...
)) (|$IsValid'address'| 173345816)) (and (= $t1@0 (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 156189) 156183))) inline$$Not$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 156091) 156189)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 215560) 156091) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))
))
(check-sat)
(pop 1)
