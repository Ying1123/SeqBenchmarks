...
(assert (not
 (=> (= (ControlFlow 0 0) 214871) (let ((L3_correct  (and (=> (= (ControlFlow 0 155684) (- 0 215107)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 155684) (- 0 215112)) (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t3@0)))))))
(let ((anon7_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t5 $t5)) (and (= $t3@0 $t5) (= (ControlFlow 0 155656) 155684))) L3_correct)))
(let ((anon7_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 155700) (- 0 215072))) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))
(let ((anon6_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t5) (= $t5 1)) (and (= $t5 $t5) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 155640) 155700) anon7_Then_correct) (=> (= (ControlFlow 0 155640) 155656) anon7_Else_correct))))))
(let ((anon6_Then_correct true))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct  (=> (= inline$$Not$0$dst@1 inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 155598) 155714) anon6_Then_correct) (=> (= (ControlFlow 0 155598) 155640) anon6_Else_correct)))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_DiemTimestamp_is_genesis$0$$t1@1)) (= (ControlFlow 0 155580) 155598)) inline$$1_DiemTimestamp_is_genesis$0$anon0$1_correct)))
(let ((inline$$1_DiemTimestamp_is_genesis$0$anon0_correct  (=> (|$IsValid'address'| 173345816) (=> (and (= inline$$1_DiemTimestamp_is_genesis$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 155586) 155580)) inline$$Not$0$anon0_correct))))
...
)) (= (ControlFlow 0 155604) 155586)) inline$$1_DiemTimestamp_is_genesis$0$anon0_correct))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 155424) 155604)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 214871) 155424) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
