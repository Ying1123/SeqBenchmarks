...
(declare-fun $t3@0 () T@$1_DiemTimestamp_CurrentTimeMicroseconds)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 215794) (let ((L2_correct  (and (=> (= (ControlFlow 0 156577) (- 0 216066)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 156577) (- 0 216071)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1@0)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0 $abort_code@1) (= (ControlFlow 0 156549) 156577))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1)) (= $t1 $t1)) (and (= $t1@0 $t1) (= (ControlFlow 0 156655) 156577))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 156535) (- 0 216034)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 156535) (- 0 216044)) (= $t4@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 156629) 156549) anon11_Then_correct) (=> (= (ControlFlow 0 156629) 156535) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 156627) 156629)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 156493) 156549) anon11_Then_correct) (=> (= (ControlFlow 0 156493) 156535) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 156479) 156627) anon10_Then_correct) (=> (= (ControlFlow 0 156479) 156493) anon10_Else_correct)))))
...
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_97699| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 156465) 156655) anon9_Then_correct) (=> (= (ControlFlow 0 156465) 156479) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_65544_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemTimestampbpl.2406:13|
 :skolemid |84|
))) (= (ControlFlow 0 156399) 156465)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 215794) 156399) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
