...
(assert (not
 (=> (= (ControlFlow 0 0) 202340) (let ((L2_correct  (and (=> (= (ControlFlow 0 147292) (- 0 202612)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (= (ControlFlow 0 147292) (- 0 202617)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1@0@@1)))))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t1@0@@1 $abort_code@1) (= (ControlFlow 0 147264) 147292))) L2_correct)))
(let ((anon9_Then_correct  (=> $t0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t1)) (= $t1 $t1)) (and (= $t1@0@@1 $t1) (= (ControlFlow 0 147370) 147292))) L2_correct))))
(let ((anon11_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t4@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| $t3@1)) (= $t4@0 $t4@0)) (and (=> (= (ControlFlow 0 147250) (- 0 202580)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 147250) (- 0 202590)) (= $t4@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 147344) 147264) anon11_Then_correct) (=> (= (ControlFlow 0 147344) 147250) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (ControlFlow 0 147342) 147344)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (=> (and (and (= $t3@0@@1 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= $t3@1 $t3@0@@1)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 147208) 147264) anon11_Then_correct) (=> (= (ControlFlow 0 147208) 147250) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (not $t0) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 147194) 147342) anon10_Then_correct) (=> (= (ControlFlow 0 147194) 147208) anon10_Else_correct)))))
(let ((anon0$1_correct@@3  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@3)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@3))
 :qid |DiemTimestampbpl.3807:20|
 :skolemid |105|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@3))
)) (= $t0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_90500| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 147180) 147370) anon9_Then_correct) (=> (= (ControlFlow 0 147180) 147194) anon9_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@5 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_64028_| (|streams#$EventStore| $es) handle@@5)))
 (and (= (|l#Multiset_64028| stream@@4) 0) (forall ((v@@36 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_64028| stream@@4) v@@36) 0)
 :qid |DiemTimestampbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemTimestampbpl.2372:13|
 :skolemid |64|
))) (= (ControlFlow 0 147114) 147180)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 202340) 147114) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))))))))))
))
(check-sat)
(pop 1)
