...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 302874) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t8@0 (|$base_url#$1_DualAttestation_Credential| $t7@1)) (= $t8@0 $t8@0)) (and (=> (= (ControlFlow 0 223213) (- 0 303224)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0))) (=> (= (ControlFlow 0 223213) (- 0 303235)) (|$IsEqual'vec'u8''| $t8@0 (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 223147) (- 0 303177)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)) (=> (= (ControlFlow 0 223147) (- 0 303183)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)) (= 5 $t6@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 223227) 223147))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t7@1 $t7) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 223279) 223227) anon12_Then_correct) (=> (= (ControlFlow 0 223279) 223213) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)) (= (ControlFlow 0 223277) 223279)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0) (=> (and (and (= $t7@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)) (= $t7@1 $t7@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 223165) 223227) anon12_Then_correct) (=> (= (ControlFlow 0 223165) 223213) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t3@0 (and (=> (= (ControlFlow 0 223151) 223277) anon11_Then_correct) (=> (= (ControlFlow 0 223151) 223165) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t3@0) (= $t5 $t5)) (and (= $t6@0 $t5) (= (ControlFlow 0 223115) 223147))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.12956:20|
 :skolemid |292|
 ...
 :qid |DualAttestationbpl.12960:20|
 :skolemid |293|
...
(|$IsValid'$1_DualAttestation_Credential'| $rsc))
 :qid |DualAttestationbpl.12967:20|
 :skolemid |294|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0))
)) (= _$t0 _$t0)) (and (= $t3@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t5) (= $t5 5)) (and (= $t5 $t5) (= $t3@0 $t3@0)))) (and (=> (= (ControlFlow 0 223099) 223151) anon10_Then_correct) (=> (= (ControlFlow 0 223099) 223115) anon10_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 222949) 223099)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 302874) 222949) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
