...
(declare-fun $1_DualAttestation_Limit_$memory@1 () T@$Memory_120777)
...
(declare-fun $1_DualAttestation_Limit_$memory@0 () T@$Memory_120777)
...
(declare-fun |$1_Diem_MintCapability'$1_XDX_XDX'_$memory| () T@$Memory_133605)
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory| () T@$Memory_139802)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 294917) (let ((anon37_Else_correct  (=> (not $abort_flag@6) (and (=> (= (ControlFlow 0 214813) (- 0 296680)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 214813) (- 0 296692)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |DualAttestationbpl.4293:13|
 :skolemid |127|
)))))
 :qid |DualAttestationbpl.11326:15|
 :skolemid |240|
))) (=> (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) a@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) a@@2)) 1))))
 :qid |DualAttestationbpl.4293:13|
 :skolemid |127|
)))))
 :qid |DualAttestationbpl.11326:15|
 :skolemid |240|
)) (and (=> (= (ControlFlow 0 214813) (- 0 296730)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 214813) (- 0 296740)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 214813) (- 0 296754)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (and (=> (= (ControlFlow 0 214813) (- 0 296764)) (not (> $t6 18446744073709551615))) (=> (not (> $t6 18446744073709551615)) (=> (= (ControlFlow 0 214813) (- 0 296775)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 213604) (- 0 296558)) (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 213604) (- 0 296596)) (or (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8@0)) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (= 6 $t8@0))) (and (> $t6 18446744073709551615) (= 8 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (and (= $t8@0 $abort_code@7) (= (ControlFlow 0 214827) 213604))) L5_correct)))
(let ((anon36_Then$1_correct  (=> (= $1_DualAttestation_Limit_$memory@1 $1_DualAttestation_Limit_$memory) (=> (and (= $abort_flag@6 true) (= $abort_code@7 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 214879) 214827) anon37_Then_correct) (=> (= (ControlFlow 0 214879) 214813) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 214877) 214879)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_DualAttestation_Limit_$memory@0 ($Memory_120777 (|Store__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0) $t25@0))) (= $1_DualAttestation_Limit_$memory@1 $1_DualAttestation_Limit_$memory@0)) (and (= $abort_flag@6 $abort_flag@5) (= $abort_code@7 $abort_code@6))) (and (=> (= (ControlFlow 0 214700) 214827) anon37_Then_correct) (=> (= (ControlFlow 0 214700) 214813) anon37_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (not $abort_flag@5) (= $t25@0 ($1_DualAttestation_Limit inline$$CastU64$0$dst@1))) (and (=> (= (ControlFlow 0 214678) 214877) anon36_Then_correct) (=> (= (ControlFlow 0 214678) 214700) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t8@0 $abort_code@6) (= (ControlFlow 0 214893) 213604))) L5_correct)))
(let ((inline$$CastU64$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$CastU64$0$dst@1 inline$$CastU64$0$dst@0)) (and (=> (= (ControlFlow 0 214652) 214893) anon35_Then_correct) (=> (= (ControlFlow 0 214652) 214678) anon35_Else_correct))))))
(let ((inline$$CastU64$0$anon3_Then_correct  (=> (and (> inline$$MulU128$0$dst@2 $MAX_U64) (= (ControlFlow 0 214650) 214652)) inline$$CastU64$0$anon3_Then$1_correct)))
(let ((inline$$CastU64$0$anon3_Else_correct  (=> (and (and (>= $MAX_U64 inline$$MulU128$0$dst@2) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$CastU64$0$dst@1 inline$$MulU128$0$dst@2))) (and (=> (= (ControlFlow 0 214602) 214893) anon35_Then_correct) (=> (= (ControlFlow 0 214602) 214678) anon35_Else_correct)))))
(let ((anon34_Then_correct  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 214658) 214650) inline$$CastU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 214658) 214602) inline$$CastU64$0$anon3_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t23 $t23)) (and (= $t8@0 $t23) (= (ControlFlow 0 214527) 213604))) L5_correct)))
(let ((anon33_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 8)) (and (= $t23 $t23) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 214511) 214658) anon34_Then_correct) (=> (= (ControlFlow 0 214511) 214527) anon34_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 214475) 214511)) anon33_Else$1_correct)))
(let ((anon33_Else_correct  (=> (and (and (not $abort_flag@4) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@2)) (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 214481) 214475))) inline$$Le$0$anon0_correct)))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t8@0 $abort_code@5) (= (ControlFlow 0 214907) 213604))) L5_correct)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 214407) 214907) anon33_Then_correct) (=> (= (ControlFlow 0 214407) 214481) anon33_Else_correct))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 214405) 214407)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 214353) 214907) anon33_Then_correct) (=> (= (ControlFlow 0 214353) 214481) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 214413) 214405) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 214413) 214353) inline$$MulU128$0$anon3_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t8@0 $abort_code@4) (= (ControlFlow 0 214921) 213604))) L5_correct)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 214246) 214921) anon32_Then_correct) (=> (= (ControlFlow 0 214246) 214413) anon32_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| $MAX_U128) (= (ControlFlow 0 214244) 214246)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1|) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 214196) 214921) anon32_Then_correct) (=> (= (ControlFlow 0 214196) 214413) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 214252) 214244) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 214252) 214196) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 214935) 213604))) L5_correct)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1|) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 214035) 214935) anon31_Then_correct) (=> (= (ControlFlow 0 214035) 214252) anon31_Else_correct))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1| $abort_code@2) (= (ControlFlow 0 214029) 214035))) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Then_correct|  (=> |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|)) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|)) (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|) (= (ControlFlow 0 214113) 214035))) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1| (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2|))) (=> (and (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1|))) (and (=> (= (ControlFlow 0 214015) 214935) anon31_Then_correct) (=> (= (ControlFlow 0 214015) 214252) anon31_Else_correct))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@0|)) (and (=> (= (ControlFlow 0 214087) 214029) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 214087) 214015) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 214085) 214087)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then$1_correct|)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@1|))) (and (=> (= (ControlFlow 0 213993) 214029) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 213993) 214015) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Else_correct|  (=> (and (not |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 213979) 214085) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 213979) 213993) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Else_correct|)))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 213965) 214113) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Then_correct|) (=> (= (ControlFlow 0 213965) 213979) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Else_correct|)))))
(let ((anon30_Else_correct  (=> (and (not $abort_flag@0) (= (ControlFlow 0 214119) 213965)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 214949) 213604))) L5_correct)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 213733) 214949) anon30_Then_correct) (=> (= (ControlFlow 0 213733) 214119) anon30_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> 1000 $MAX_U128) (= (ControlFlow 0 213731) 213733)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 1000) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$CastU128$0$dst@1 1000))) (and (=> (= (ControlFlow 0 213683) 214949) anon30_Then_correct) (=> (= (ControlFlow 0 213683) 214119) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Not$0$dst@1 (|$IsValid'u64'| 1000)) (and (=> (= (ControlFlow 0 213739) 213731) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 213739) 213683) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t14 $t14)) (and (= $t8@0 $t14) (= (ControlFlow 0 213472) 213604))) L5_correct)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t14) (= $t14 6)) (and (= $t14 $t14) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 213456) 213739) anon29_Then_correct) (=> (= (ControlFlow 0 213456) 213472) anon29_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t11@0)) (= (ControlFlow 0 213420) 213456)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (and (and (not $t9) (|$IsValid'address'| 173345816)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 213426) 213420))) inline$$Not$0$anon0_correct)))
(let ((anon28_Then_correct  (=> $t9 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 214979) 213604))) L5_correct))))
(let ((anon27_Else_correct  (=> (and (not $t7) (= $t9  (not (= (|$addr#$signer| _$t0) 173345816)))) (and (=> (= (ControlFlow 0 213370) 214979) anon28_Then_correct) (=> (= (ControlFlow 0 213370) 213426) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> $t7 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 215005) 213604))) L5_correct))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 173345816)) 0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119879| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119879| $1_SlidingNonce_SlidingNonce_$memory) 186537453)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119972| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120058| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120131| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120202| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_133605| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_133605| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |DualAttestationbpl.10969:104|
 :skolemid |234|
))))) (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_133605| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |DualAttestationbpl.10973:20|
 :skolemid |235|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_139802| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.10977:20|
 :skolemid |236|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120286| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120370| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120441| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120609| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120680| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120861| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120945| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121016| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121016| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121259| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121330| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121401| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121485| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119563| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DualAttestationbpl.11055:20|
 :skolemid |237|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0)))
 ...
 :qid |DualAttestationbpl.11059:20|
 :skolemid |238|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@1)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@1))
 :qid |DualAttestationbpl.11063:20|
 :skolemid |239|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@1))
)) (= $t6 (* 1000 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (= _$t0 _$t0) (= $t7  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 213348) 215005) anon27_Then_correct) (=> (= (ControlFlow 0 213348) 213370) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 212809) 213348)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 294917) 212809) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
