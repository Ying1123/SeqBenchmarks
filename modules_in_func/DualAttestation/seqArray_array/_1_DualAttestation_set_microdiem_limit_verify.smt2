...
(declare-fun $t14@0 () T@$Mutation_11647)
(declare-fun $t13@1 () T@$Mutation_181668)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t14@1 () T@$Mutation_11647)
(declare-fun _$t1 () Int)
(declare-fun $t13@2 () T@$Mutation_181668)
...
(declare-fun $t13 () T@$Mutation_181668)
(declare-fun $t13@0 () T@$Mutation_181668)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory () T@$Memory_182447)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory () T@$Memory_150430)
(declare-fun $1_VASPDomain_VASPDomains_$memory () T@$Memory_150829)
...
(declare-fun $1_DesignatedDealer_Dealer_$memory () T@$Memory_182688)
...
(declare-fun $t14 () T@$Mutation_11647)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_set_microdiem_limit$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 313228) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t14@0 ($Mutation_11647 (|l#$Mutation_181668| $t13@1) (let ((l (|l#Vec_21610| (|p#$Mutation_181668| $t13@1))))
(Vec_21610 (|Store__T@[Int]Int_| (|v#Vec_21610| (|p#$Mutation_181668| $t13@1)) l 0) (+ l 1))) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|v#$Mutation_181668| $t13@1)))) (= $t14@1 ($Mutation_11647 (|l#$Mutation_11647| $t14@0) (|p#$Mutation_11647| $t14@0) _$t1))) (and (= $t13@2 ($Mutation_181668 (|l#$Mutation_181668| $t13@1) (|p#$Mutation_181668| $t13@1) ($1_DualAttestation_Limit (|v#$Mutation_11647| $t14@1)))) (= $1_DualAttestation_Limit_$memory@0 ($Memory_120777 (|Store__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_181668| $t13@2)) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_181668| $t13@2)) (|v#$Mutation_181668| $t13@2)))))) (and (=> (= (ControlFlow 0 235879) (- 0 314577)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory@0) 173345816)) (and (=> (= (ControlFlow 0 235879) (- 0 314589)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@0) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |DualAttestationbpl.4293:13|
 :skolemid |127|
)))))
 :qid |DualAttestationbpl.17009:15|
 :skolemid |407|
 ...
 :qid |DualAttestationbpl.17009:15|
 :skolemid |407|
)) (and (=> (= (ControlFlow 0 235879) (- 0 314627)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 235879) (- 0 314639)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) 1))) (and (=> (= (ControlFlow 0 235879) (- 0 314657)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 235879) (- 0 314671)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 235879) (- 0 314681)) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory@0) 173345816)) _$t1))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 235670) (- 0 314390)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 235670) (- 0 314430)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 235893) 235670))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= $t13@1 $t13) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 235945) 235893) anon15_Then_correct) (=> (= (ControlFlow 0 235945) 235879) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 235943) 235945)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t13@0 ($Mutation_181668 ($Global 173345816) (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))) (= $t13@1 $t13@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 235702) 235893) anon15_Then_correct) (=> (= (ControlFlow 0 235702) 235879) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and $t9@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 235680) 235943) anon14_Then_correct) (=> (= (ControlFlow 0 235680) 235702) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t9@0) (= $t11 $t11)) (and (= $t7@0 $t11) (= (ControlFlow 0 235542) 235670))) L3_correct)))
(let ((anon12_Else_correct  (=> (and (and (and (not $t6) (|$IsValid'address'| 173345816)) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t11) (= $t11 5)) (and (= $t11 $t11) (= $t9@0 $t9@0)))) (and (=> (= (ControlFlow 0 235526) 235680) anon13_Then_correct) (=> (= (ControlFlow 0 235526) 235542) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) 1)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 236017) 235670))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |DualAttestationbpl.16738:20|
 :skolemid |379|
)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0)) 1)) (= addr@@0 186537453)))
 :qid |DualAttestationbpl.16746:20|
 :skolemid |380|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 2))))))
 :qid |DualAttestationbpl.16754:20|
 :skolemid |381|
)))) (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@2)) 2))))))
 :qid |DualAttestationbpl.16758:20|
 :skolemid |382|
)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@3)) 2))))))
 :qid |DualAttestationbpl.16762:20|
 :skolemid |383|
))) (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@4)) 2))))))
 :qid |DualAttestationbpl.16766:20|
 :skolemid |384|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@5)) 2)))))
 :qid |DualAttestationbpl.16770:20|
 :skolemid |385|
))))) (=> (and (and (and (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@6)) 2)))))
 :qid |DualAttestationbpl.16774:20|
 :skolemid |386|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@7)) 2)))))
 :qid |DualAttestationbpl.16778:20|
 :skolemid |387|
))) (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124116| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@8)) 4))))
 :qid |DualAttestationbpl.16782:20|
 :skolemid |388|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_123721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@9)) 3))))
 :qid |DualAttestationbpl.16786:20|
 :skolemid |389|
)))) (and (and (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_123721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@10)) 3))))
 :qid |DualAttestationbpl.16790:20|
 :skolemid |390|
)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_123721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (not (= (|l#Vec_86574| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_123721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |DualAttestationbpl.16794:20|
 :skolemid |391|
))) (and (let (($range_0 ($Range 0 (|l#Vec_86786| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@12 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_120058| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@12))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_86786| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_120058| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_86786| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@13 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_120058| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |DualAttestationbpl.16798:151|
 :skolemid |392|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816))))) (and (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.16807:20|
 :skolemid |393|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (= (|Select__T@[Int]Bool_| (|domain#$Memory_182447| $1_DiemAccount_DiemAccount_$memory) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@14)))
 :qid |DualAttestationbpl.16811:20|
 :skolemid |394|
))) (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150430| $1_VASPDomain_VASPDomainManager_$memory) addr@@15)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@15)) 1))))
 :qid |DualAttestationbpl.16815:20|
 :skolemid |395|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150829| $1_VASPDomain_VASPDomains_$memory) addr@@16)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@16)) 5))))
 :qid |DualAttestationbpl.16819:20|
 :skolemid |396|
)))) (and (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_124569| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@17) (|Select__T@[Int]Bool_| (|domain#$Memory_124629| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@17)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@17)) 2)))))
 :qid |DualAttestationbpl.16823:20|
 :skolemid |397|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (= (|Select__T@[Int]Bool_| (|domain#$Memory_182688| $1_DesignatedDealer_Dealer_$memory) addr@@18)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@18)) 2))))
 :qid |DualAttestationbpl.16827:20|
 :skolemid |398|
))) (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@19)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@19)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@19)) 5)))))
 :qid |DualAttestationbpl.16831:20|
 :skolemid |399|
)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_119879| $1_SlidingNonce_SlidingNonce_$memory) addr@@20)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@20)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@20)) 1)))))
 :qid |DualAttestationbpl.16835:20|
 :skolemid |400|
)))))) (and (and (and (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_123721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@21)) 3))))
 :qid |DualAttestationbpl.16839:20|
 :skolemid |401|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124116| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@22)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@22)) 4))))
 :qid |DualAttestationbpl.16843:20|
 :skolemid |402|
))) (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150926| $1_VASP_ParentVASP_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@23)) 5))))
 :qid |DualAttestationbpl.16847:20|
 :skolemid |403|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_150862| $1_VASP_ChildVASP_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@24)) 6))))
 :qid |DualAttestationbpl.16851:20|
 :skolemid |404|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DualAttestationbpl.16860:20|
 :skolemid |405|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@0))
 :qid |DualAttestationbpl.16864:20|
 :skolemid |406|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_120777| $1_DualAttestation_Limit_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) $t5)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 235478) 236017) anon12_Then_correct) (=> (= (ControlFlow 0 235478) 235526) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 234628) 235478)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_21610| (|p#$Mutation_181668| $t13)) 0) (=> (and (= (|l#Vec_21610| (|p#$Mutation_11647| $t14)) 0) (= (ControlFlow 0 234638) 234628)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 313228) 234638) anon0_correct)))
