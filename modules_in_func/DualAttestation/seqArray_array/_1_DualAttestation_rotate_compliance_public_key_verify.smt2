...
(declare-fun $1_DualAttestation_Credential_$memory@0 () T@$Memory_124454)
...
(declare-fun $t21@2 () T@$Mutation_176968)
...
(declare-fun |Store__T@[$1_Event_EventHandle]Multiset_86488_| (|T@[$1_Event_EventHandle]Multiset_86488| T@$1_Event_EventHandle T@Multiset_86488) |T@[$1_Event_EventHandle]Multiset_86488|)
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_86488|) ( ?x1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_86488)) (! (= (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|Store__T@[$1_Event_EventHandle]Multiset_86488_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[$1_Event_EventHandle]Multiset_86488|) ( ?x1 T@$1_Event_EventHandle) ( ?y1 T@$1_Event_EventHandle) ( ?x2 T@Multiset_86488)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|Store__T@[$1_Event_EventHandle]Multiset_86488_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[$1_Event_EventHandle]Multiset_86488_| ?x0 ?y1))) :weight 0)))
...
(declare-fun $t23@0 () T@$Mutation_112254)
...
(declare-fun $t21@1 () T@$Mutation_176968)
(declare-fun $t22@0 () T@$Mutation_106221)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t22@1 () T@$Mutation_106221)
(declare-fun $t21 () T@$Mutation_176968)
(declare-fun $t13 () Int)
(declare-fun $t21@0 () T@$Mutation_176968)
...
(declare-fun $t10 () Int)
(declare-fun $t7 () T@$Mutation_176968)
(declare-fun $t22 () T@$Mutation_106221)
(declare-fun $t23 () T@$Mutation_112254)
(push 1)
(set-info :boogie-vc-id $1_DualAttestation_rotate_compliance_public_key$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 311738) (let ((anon26_Else_correct  (=> (and (not $abort_flag@0) (= $1_DualAttestation_Credential_$memory@0 ($Memory_124454 (|Store__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_176968| $t21@2)) true) (|Store__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) (|a#$Global| (|l#$Mutation_176968| $t21@2)) (|v#$Mutation_176968| $t21@2))))) (and (=> (= (ControlFlow 0 234223) (- 0 312933)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DualAttestationbpl.16608:15|
 :skolemid |374|
))) (=> (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr1@@0) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@0)) 2)))))
 :qid |DualAttestationbpl.16608:15|
 :skolemid |374|
)) (and (=> (= (ControlFlow 0 234223) (- 0 312966)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a) (=> (not (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) a)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a)))) ($1_Signer_is_txn_signer_addr a))))
 :qid |DualAttestationbpl.16614:15|
 :skolemid |375|
))) (=> (forall ((a@@0 Int) ) (!  (=> (|$IsValid'address'| a@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@0) (=> (not (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) a@@0)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@0)))) ($1_Signer_is_txn_signer_addr a@@0))))
 :qid |DualAttestationbpl.16614:15|
 :skolemid |375|
)) (and (=> (= (ControlFlow 0 234223) (- 0 313009)) (forall ((a@@1 Int) ) (!  (=> (|$IsValid'address'| a@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@1) (=> (not (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) a@@1)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@1)))) ($1_Signer_is_txn_signer_addr a@@1))))
 :qid |DualAttestationbpl.16620:15|
 :skolemid |376|
))) (=> (forall ((a@@2 Int) ) (!  (=> (|$IsValid'address'| a@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@2) (=> (not (|$IsEqual'vec'u8''| (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) a@@2)) (|$base_url#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) a@@2)))) ($1_Signer_is_txn_signer_addr a@@2))))
 :qid |DualAttestationbpl.16620:15|
 :skolemid |376|
)) (and (=> (= (ControlFlow 0 234223) (- 0 313052)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr)) 5)))))
 :qid |DualAttestationbpl.16626:15|
 :skolemid |377|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr@@0)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@0)) 5)))))
 :qid |DualAttestationbpl.16626:15|
 :skolemid |377|
)) (and (=> (= (ControlFlow 0 234223) (- 0 313088)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t1)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t1))) (and (=> (= (ControlFlow 0 234223) (- 0 313098)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t8))) (and (=> (= (ControlFlow 0 234223) (- 0 313110)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 234223) (- 0 313120)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1)) (=> (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) $t9)) _$t1) (and (=> (= (ControlFlow 0 234223) (- 0 313133)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (not (= addr1@@1 $t9)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr1@@1)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@1)))))
 :qid |DualAttestationbpl.16655:15|
 :skolemid |378|
))) (=> (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (not (= addr1@@2 $t9)) (|$IsEqual'vec'u8''| (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory@0) addr1@@2)) (|$compliance_public_key#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@2)))))
 :qid |DualAttestationbpl.16655:15|
 :skolemid |378|
)) (and (=> (= (ControlFlow 0 234223) (- 0 313171)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_86488| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_86488 (|Store__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@0) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@1 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected) handle@@1)) (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual) handle@@1))) (forall ((v@@43 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected) handle@@1)) v@@43) (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual) handle@@1)) v@@43))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2481:13|
 :skolemid |90|
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_86488| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_86488 (|Store__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@1) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@2 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected@@0) handle@@2)) (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual@@0) handle@@2))) (forall ((v@@44 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected@@0) handle@@2)) v@@44) (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual@@0) handle@@2)) v@@44))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2481:13|
 :skolemid |90|
))))) (=> (= (ControlFlow 0 234223) (- 0 313196)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_86488| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12))))
(Multiset_86488 (|Store__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@2) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t12) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@1))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@3 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual@@1) handle@@3)) (|l#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected@@1) handle@@3))) (forall ((v@@45 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| actual@@1) handle@@3)) v@@45) (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| expected@@1) handle@@3)) v@@45))
 :qid |DualAttestationbpl.164:13|
 :skolemid |5|
)))
 :qid |DualAttestationbpl.2481:13|
...
(let ((L5_correct  (and (=> (= (ControlFlow 0 233597) (- 0 312834)) (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (or (or (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (=> (= (ControlFlow 0 233597) (- 0 312855)) (or (or (and (not ($1_Signature_$ed25519_validate_pubkey _$t1)) (= 7 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t8)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17@0))))))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 234237) 233597))) L5_correct)))
(let ((|inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| (|v#$Mutation_112254| $t23@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_86488| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0))))
(Multiset_86488 (|Store__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@3) (|$ToEventRep'$1_DualAttestation_ComplianceKeyRotationEvent'| $t26@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 233892) 234237) anon26_Then_correct) (=> (= (ControlFlow 0 233892) 234223) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (not $t25) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (and (= $t26@0 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 $t24)) (= (ControlFlow 0 233898) 233892))) |inline$$1_Event_emit_event'$1_DualAttestation_ComplianceKeyRotationEvent'$0$anon0_correct|))))
(let ((anon25_Then_correct  (=> $t25 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 234263) 233597))) L5_correct))))
(let ((anon24_Else_correct  (=> (and (and (and (not $abort_flag@0) (= |$temp_0'$1_DualAttestation_Credential'@0| (|v#$Mutation_176968| $t21@1))) (and (= |$temp_0'$1_DualAttestation_Credential'@0| |$temp_0'$1_DualAttestation_Credential'@0|) (= $t22@0 ($Mutation_106221 (|l#$Mutation_176968| $t21@1) (let ((l (|l#Vec_21610| (|p#$Mutation_176968| $t21@1))))
(Vec_21610 (|Store__T@[Int]Int_| (|v#Vec_21610| (|p#$Mutation_176968| $t21@1)) l 2) (+ l 1))) (|$compliance_public_key#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)))))) (and (and (= $t22@1 ($Mutation_106221 (|l#$Mutation_106221| $t22@0) (|p#$Mutation_106221| $t22@0) _$t1)) (= $t21@2 ($Mutation_176968 (|l#$Mutation_176968| $t21@1) (|p#$Mutation_176968| $t21@1) ($1_DualAttestation_Credential (|$human_name#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)) (|$base_url#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)) (|v#$Mutation_106221| $t22@1) (|$expiration_date#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)) (|$base_url_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@1)))))) (and (= $t23@0 ($Mutation_112254 (|l#$Mutation_176968| $t21@2) (let ((l@@0 (|l#Vec_21610| (|p#$Mutation_176968| $t21@2))))
(Vec_21610 (|Store__T@[Int]Int_| (|v#Vec_21610| (|p#$Mutation_176968| $t21@2)) l@@0 4) (+ l@@0 1))) (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|v#$Mutation_176968| $t21@2)))) (= $t25  (not (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (=> (= (ControlFlow 0 233793) 234263) anon25_Then_correct) (=> (= (ControlFlow 0 233793) 233898) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 234277) 233597))) L5_correct)))
(let ((anon23_Then$1_correct  (=> (= $t21@1 $t21) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 234329) 234277) anon24_Then_correct) (=> (= (ControlFlow 0 234329) 233793) anon24_Else_correct))))))
(let ((anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t13)) (= (ControlFlow 0 234327) 234329)) anon23_Then$1_correct)))
(let ((anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t13) (=> (and (and (= $t21@0 ($Mutation_176968 ($Global $t13) (Vec_21610 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $t13))) (= $t21@1 $t21@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 233715) 234277) anon24_Then_correct) (=> (= (ControlFlow 0 233715) 233793) anon24_Else_correct))))))
(let ((anon22_Then_correct  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1 (and (=> (= (ControlFlow 0 233693) 234327) anon23_Then_correct) (=> (= (ControlFlow 0 233693) 233715) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1) (= $t20 $t20)) (and (= $t17@0 $t20) (= (ControlFlow 0 233689) 233597))) L5_correct)))
(let ((anon21_Else_correct  (=> (and (not false) (|$IsValid'u64'| 2)) (=> (and (and (|$IsValid'u64'| $t20) (= $t20 7)) (and (= $t20 $t20) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1))) (and (=> (= (ControlFlow 0 233673) 233693) anon22_Then_correct) (=> (= (ControlFlow 0 233673) 233689) anon22_Else_correct))))))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1 ($1_Signature_$ed25519_validate_pubkey _$t1)) (and (=> (= (ControlFlow 0 233631) 234343) anon21_Then_correct) (=> (= (ControlFlow 0 233631) 233673) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and $t14@0 (= (ControlFlow 0 233637) 233631)) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct)))
(let ((anon20_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 233517) 233597))) L5_correct)))
(let ((anon0$1_correct  (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) 186537453)) 1))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119879| $1_SlidingNonce_SlidingNonce_$memory) 173345816)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119879| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119972| $1_DiemConfig_Configuration_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_120058| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120131| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120202| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120286| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120370| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120441| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120525| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120609| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120680| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120777| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr1@@3) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr1@@3)) 2)))))
 :qid |DualAttestationbpl.16313:20|
 :skolemid |370|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120861| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_120945| $1_ChainId_ChainId_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121016| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_121087| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121016| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121259| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121330| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)))) (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) addr@@1)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_119692| $1_Roles_RoleId_$memory) addr@@1)) 5)))))
 :qid |DualAttestationbpl.16349:20|
 :skolemid |371|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121401| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_121485| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_119563| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'vec'u8''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DualAttestationbpl.16370:20|
 :skolemid |372|
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@0)))
(|$IsValid'$1_DualAttestation_Credential'| $rsc@@0))
 :qid |DualAttestationbpl.16374:20|
 :skolemid |373|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $a_0@@0))
)))) (and (and (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$addr#$signer| _$t0))) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$compliance_key_rotation_events#$1_DualAttestation_Credential| (|Select__T@[Int]$1_DualAttestation_Credential_| (|contents#$Memory_124454| $1_DualAttestation_Credential_$memory) $t10))))) (and (and (= $t12 ($1_DualAttestation_ComplianceKeyRotationEvent _$t1 (div (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_118986| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 1000000))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_124454| $1_DualAttestation_Credential_$memory) $t13)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t16) (= $t16 5)) (and (= $t16 $t16) (= $t14@0 $t14@0)))))) (and (=> (= (ControlFlow 0 233501) 233637) anon20_Then_correct) (=> (= (ControlFlow 0 233501) 233517) anon20_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_86488_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_86488| stream@@4) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_86488| stream@@4) v@@46) 0)
 :qid |DualAttestationbpl.159:13|
 :skolemid |4|
))))
 :qid |DualAttestationbpl.2465:13|
 :skolemid |89|
))) (= (ControlFlow 0 232931) 233501)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_21610| (|p#$Mutation_176968| $t7)) 0) (=> (and (and (= (|l#Vec_21610| (|p#$Mutation_176968| $t21)) 0) (= (|l#Vec_21610| (|p#$Mutation_106221| $t22)) 0)) (and (= (|l#Vec_21610| (|p#$Mutation_112254| $t23)) 0) (= (ControlFlow 0 232941) 232931))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 311738) 232941) anon0_correct)))
