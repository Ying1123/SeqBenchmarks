...
(assert (not
 (=> (= (ControlFlow 0 0) 280529) (let ((anon37_Else_correct  (=> (not $abort_flag@6) (and (=> (= (ControlFlow 0 204594) (- 0 282292)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory@1) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory@1) 173345816)) (and (=> (= (ControlFlow 0 204594) (- 0 282304)) (forall ((a@@7 Int) ) (!  (=> (|$IsValid'address'| a@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@8 Int) ) (!  (and (|$IsValid'address'| a@@8) (and ($1_Signer_is_txn_signer_addr a@@8) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) a@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) a@@8)) 1))))
 :qid |DualAttestationbpl.4259:13|
 :skolemid |107|
)))))
 :qid |DualAttestationbpl.11260:15|
 :skolemid |220|
))) (=> (forall ((a@@9 Int) ) (!  (=> (|$IsValid'address'| a@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory@1) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@10 Int) ) (!  (and (|$IsValid'address'| a@@10) (and ($1_Signer_is_txn_signer_addr a@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) a@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) a@@10)) 1))))
 :qid |DualAttestationbpl.4259:13|
 :skolemid |107|
)))))
 :qid |DualAttestationbpl.11260:15|
 :skolemid |220|
)) (and (=> (= (ControlFlow 0 204594) (- 0 282342)) (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (=> (not (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (= (ControlFlow 0 204594) (- 0 282352)) (not (not (= (|$addr#$signer| _$t0@@2) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@2) 173345816))) (and (=> (= (ControlFlow 0 204594) (- 0 282366)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (and (=> (= (ControlFlow 0 204594) (- 0 282376)) (not (> $t6 18446744073709551615))) (=> (not (> $t6 18446744073709551615)) (=> (= (ControlFlow 0 204594) (- 0 282387)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))))))))))
(let ((L5_correct@@0  (and (=> (= (ControlFlow 0 203385) (- 0 282170)) (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@2) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (or (or (or (or (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (not (= (|$addr#$signer| _$t0@@2) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (> $t6 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 203385) (- 0 282208)) (or (or (or (or (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8@0@@0)) (and (not (= (|$addr#$signer| _$t0@@2) 173345816)) (= 2 $t8@0@@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (= 6 $t8@0@@0))) (and (> $t6 18446744073709551615) (= 8 $t8@0@@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t8@0@@0))))))))
(let ((anon37_Then_correct  (=> (and (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (and (= $t8@0@@0 $abort_code@7) (= (ControlFlow 0 204608) 203385))) L5_correct@@0)))
(let ((anon36_Then$1_correct  (=> (= $1_DualAttestation_Limit_$memory@1 $1_DualAttestation_Limit_$memory) (=> (and (= $abort_flag@6 true) (= $abort_code@7 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 204660) 204608) anon37_Then_correct) (=> (= (ControlFlow 0 204660) 204594) anon37_Else_correct))))))
(let ((anon36_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0@@2)) (= (ControlFlow 0 204658) 204660)) anon36_Then$1_correct)))
(let ((anon36_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0@@2))) (=> (and (and (= $1_DualAttestation_Limit_$memory@0 ($Memory_113423 (|Store__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0@@2) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) (|$addr#$signer| _$t0@@2) $t25@0))) (= $1_DualAttestation_Limit_$memory@1 $1_DualAttestation_Limit_$memory@0)) (and (= $abort_flag@6 $abort_flag@5) (= $abort_code@7 $abort_code@6))) (and (=> (= (ControlFlow 0 204481) 204608) anon37_Then_correct) (=> (= (ControlFlow 0 204481) 204594) anon37_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (not $abort_flag@5) (= $t25@0 ($1_DualAttestation_Limit inline$$CastU64$0$dst@1))) (and (=> (= (ControlFlow 0 204459) 204658) anon36_Then_correct) (=> (= (ControlFlow 0 204459) 204481) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t8@0@@0 $abort_code@6) (= (ControlFlow 0 204674) 203385))) L5_correct@@0)))
(let ((inline$$CastU64$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$CastU64$0$dst@1 inline$$CastU64$0$dst@0)) (and (=> (= (ControlFlow 0 204433) 204674) anon35_Then_correct) (=> (= (ControlFlow 0 204433) 204459) anon35_Else_correct))))))
(let ((inline$$CastU64$0$anon3_Then_correct  (=> (and (> inline$$MulU128$0$dst@2 $MAX_U64) (= (ControlFlow 0 204431) 204433)) inline$$CastU64$0$anon3_Then$1_correct)))
(let ((inline$$CastU64$0$anon3_Else_correct  (=> (and (and (>= $MAX_U64 inline$$MulU128$0$dst@2) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$CastU64$0$dst@1 inline$$MulU128$0$dst@2))) (and (=> (= (ControlFlow 0 204383) 204674) anon35_Then_correct) (=> (= (ControlFlow 0 204383) 204459) anon35_Else_correct)))))
(let ((anon34_Then_correct  (=> inline$$Le$0$dst@1 (and (=> (= (ControlFlow 0 204439) 204431) inline$$CastU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 204439) 204383) inline$$CastU64$0$anon3_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= $t23@@0 $t23@@0)) (and (= $t8@0@@0 $t23@@0) (= (ControlFlow 0 204308) 203385))) L5_correct@@0)))
(let ((anon33_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t23@@0) (= $t23@@0 8)) (and (= $t23@@0 $t23@@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 204292) 204439) anon34_Then_correct) (=> (= (ControlFlow 0 204292) 204308) anon34_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= inline$$MulU128$0$dst@2 18446744073709551615)) (= (ControlFlow 0 204256) 204292)) anon33_Else$1_correct)))
(let ((anon33_Else_correct  (=> (and (and (not $abort_flag@4) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@2)) (and (|$IsValid'u128'| 18446744073709551615) (= (ControlFlow 0 204262) 204256))) inline$$Le$0$anon0_correct)))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= $t8@0@@0 $abort_code@5) (= (ControlFlow 0 204688) 203385))) L5_correct@@0)))
(let ((inline$$MulU128$0$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@0)) (and (=> (= (ControlFlow 0 204188) 204688) anon33_Then_correct) (=> (= (ControlFlow 0 204188) 204262) anon33_Else_correct))))))
(let ((inline$$MulU128$0$anon3_Then_correct  (=> (and (> (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1) $MAX_U128) (= (ControlFlow 0 204186) 204188)) inline$$MulU128$0$anon3_Then$1_correct)))
(let ((inline$$MulU128$0$anon3_Else_correct  (=> (>= $MAX_U128 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (=> (and (and (= inline$$MulU128$0$dst@1 (* inline$$CastU128$0$dst@1 inline$$CastU128$1$dst@1)) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$MulU128$0$dst@2 inline$$MulU128$0$dst@1))) (and (=> (= (ControlFlow 0 204134) 204688) anon33_Then_correct) (=> (= (ControlFlow 0 204134) 204262) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (not $abort_flag@3) (and (=> (= (ControlFlow 0 204194) 204186) inline$$MulU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 204194) 204134) inline$$MulU128$0$anon3_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t8@0@@0 $abort_code@4) (= (ControlFlow 0 204702) 203385))) L5_correct@@0)))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 204027) 204702) anon32_Then_correct) (=> (= (ControlFlow 0 204027) 204194) anon32_Else_correct))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| $MAX_U128) (= (ControlFlow 0 204025) 204027)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1|) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 203977) 204702) anon32_Then_correct) (=> (= (ControlFlow 0 203977) 204194) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 204033) 204025) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 204033) 203977) inline$$CastU128$1$anon3_Else_correct)))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0@@0 $abort_code@3) (= (ControlFlow 0 204716) 203385))) L5_correct@@0)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1|) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@0|)) (and (=> (= (ControlFlow 0 203816) 204716) anon31_Then_correct) (=> (= (ControlFlow 0 203816) 204033) anon31_Else_correct))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1| $abort_code@2) (= (ControlFlow 0 203810) 203816))) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Then_correct|  (=> |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|)) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|)) (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t1@0|) (= (ControlFlow 0 203894) 203816))) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1| (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2|))) (=> (and (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1|) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t4@1|))) (and (=> (= (ControlFlow 0 203796) 204716) anon31_Then_correct) (=> (= (ControlFlow 0 203796) 204033) anon31_Else_correct))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@0|)) (and (=> (= (ControlFlow 0 203868) 203810) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 203868) 203796) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 203866) 203868)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then$1_correct|)))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@1| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= $abort_code@2 $abort_code@1@@2)) (and (= $abort_flag@1 $abort_flag@0@@2) (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@2| |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t3@1|))) (and (=> (= (ControlFlow 0 203774) 203810) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 203774) 203796) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon10_Else_correct|))))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Else_correct|  (=> (and (not |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 203760) 203866) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Then_correct|) (=> (= (ControlFlow 0 203760) 203774) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon9_Else_correct|)))))
(let ((|inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 203746) 203894) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Then_correct|) (=> (= (ControlFlow 0 203746) 203760) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon8_Else_correct|)))))
(let ((anon30_Else_correct  (=> (and (not $abort_flag@0@@2) (= (ControlFlow 0 203900) 203746)) |inline$$1_Diem_scaling_factor'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@0@@2 (= $abort_code@1@@2 $abort_code@1@@2)) (and (= $t8@0@@0 $abort_code@1@@2) (= (ControlFlow 0 204730) 203385))) L5_correct@@0)))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_flag@0@@2 true) (=> (and (= $abort_code@1@@2 $EXEC_FAILURE_CODE) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 203514) 204730) anon30_Then_correct) (=> (= (ControlFlow 0 203514) 203900) anon30_Else_correct))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> 1000 $MAX_U128) (= (ControlFlow 0 203512) 203514)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 1000) (= $abort_flag@0@@2 false)) (and (= $abort_code@1@@2 $abort_code@0@@2) (= inline$$CastU128$0$dst@1 1000))) (and (=> (= (ControlFlow 0 203464) 204730) anon30_Then_correct) (=> (= (ControlFlow 0 203464) 203900) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and inline$$Not$0$dst@1@@0 (|$IsValid'u64'| 1000)) (and (=> (= (ControlFlow 0 203520) 203512) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 203520) 203464) inline$$CastU128$0$anon3_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (and (not inline$$Not$0$dst@1@@0) (= $t14@@0 $t14@@0)) (and (= $t8@0@@0 $t14@@0) (= (ControlFlow 0 203253) 203385))) L5_correct@@0)))
(let ((anon28_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t14@@0) (= $t14@@0 6)) (and (= $t14@@0 $t14@@0) (= inline$$Not$0$dst@1@@0 inline$$Not$0$dst@1@@0))) (and (=> (= (ControlFlow 0 203237) 203520) anon29_Then_correct) (=> (= (ControlFlow 0 203237) 203253) anon29_Else_correct))))))
(let ((inline$$Not$0$anon0_correct@@0  (=> (and (= inline$$Not$0$dst@1@@0  (not $t11@0@@1)) (= (ControlFlow 0 203201) 203237)) anon28_Else$1_correct)))
(let ((anon28_Else_correct  (=> (and (and (not $t9@@1) (|$IsValid'address'| 173345816)) (and (= $t11@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 203207) 203201))) inline$$Not$0$anon0_correct@@0)))
(let ((anon28_Then_correct  (=> $t9@@1 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@2) 173345816)) (= 2 $t8)) (= $t8 $t8)) (and (= $t8@0@@0 $t8) (= (ControlFlow 0 204760) 203385))) L5_correct@@0))))
(let ((anon27_Else_correct  (=> (and (not $t7@@1) (= $t9@@1  (not (= (|$addr#$signer| _$t0@@2) 173345816)))) (and (=> (= (ControlFlow 0 203151) 204760) anon28_Then_correct) (=> (= (ControlFlow 0 203151) 203207) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> $t7@@1 (=> (and (and (and (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= 1 $t8)) (= $t8 $t8)) (and (= $t8@0@@0 $t8) (= (ControlFlow 0 204786) 203385))) L5_correct@@0))))
(let ((anon0$1_correct@@2  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) 173345816)) 0))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112525| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112525| $1_SlidingNonce_SlidingNonce_$memory) 186537453)))) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112618| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112704| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112777| $1_DiemSystem_CapabilityHolder_$memory) 173345816)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112848| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_125709| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_125709| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |DualAttestationbpl.10903:104|
 :skolemid |214|
))))) (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_125709| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |DualAttestationbpl.10907:20|
 :skolemid |215|
)) (forall ((addr@@50 Int) ) (!  (=> (|$IsValid'address'| addr@@50) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_131124| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@50) (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |DualAttestationbpl.10911:20|
 :skolemid |216|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112932| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113016| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816))))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113087| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113255| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113326| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113507| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113591| $1_ChainId_ChainId_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113662| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113733| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_113733| $1_AccountFreezing_FreezingBit_$memory) 173345816))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_113733| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_113733| $1_AccountFreezing_FreezingBit_$memory) 186537453)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113662| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113905| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113976| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_114047| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_114131| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_112212| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@2)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@2))
 :qid |DualAttestationbpl.10989:20|
 :skolemid |217|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@2))
)) (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@3)))
 ...
 :qid |DualAttestationbpl.10993:20|
 :skolemid |218|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@3))
)))) (and (and (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0@@4)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@4))
 :qid |DualAttestationbpl.10997:20|
 :skolemid |219|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0@@4))
)) (= $t6 (* 1000 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_113171| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (= _$t0@@2 _$t0@@2) (= $t7@@1  (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))))) (and (=> (= (ControlFlow 0 203129) 204786) anon27_Then_correct) (=> (= (ControlFlow 0 203129) 203151) anon27_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_84854| stream@@3) 0) (forall ((v@@38 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@3) v@@38) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 202590) 203129)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 280529) 202590) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
