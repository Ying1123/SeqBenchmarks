...
(assert (not
 (=> (= (ControlFlow 0 0) 298840) (let ((anon15_Else_correct@@4  (=> (not $abort_flag@0@@10) (=> (and (and (= $t14@0@@1 ($Mutation_11233 (|l#$Mutation_172230| $t13@1) (seq.++ (|p#$Mutation_172230| $t13@1) (seq.unit 0)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|v#$Mutation_172230| $t13@1)))) (= $t14@1@@0 ($Mutation_11233 (|l#$Mutation_11233| $t14@0@@1) (|p#$Mutation_11233| $t14@0@@1) _$t1@@12))) (and (= $t13@2 ($Mutation_172230 (|l#$Mutation_172230| $t13@1) (|p#$Mutation_172230| $t13@1) ($1_DualAttestation_Limit (|v#$Mutation_11233| $t14@1@@0)))) (= $1_DualAttestation_Limit_$memory@0@@0 ($Memory_113423 (|Store__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_172230| $t13@2)) true) (|Store__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) (|a#$Global| (|l#$Mutation_172230| $t13@2)) (|v#$Mutation_172230| $t13@2)))))) (and (=> (= (ControlFlow 0 225660) (- 0 300189)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory@0@@0) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory@0@@0) 173345816)) (and (=> (= (ControlFlow 0 225660) (- 0 300201)) (forall ((a@@23 Int) ) (!  (=> (|$IsValid'address'| a@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory@0@@0) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@24 Int) ) (!  (and (|$IsValid'address'| a@@24) (and ($1_Signer_is_txn_signer_addr a@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) a@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) a@@24)) 1))))
 :qid |DualAttestationbpl.4259:13|
 :skolemid |107|
)))))
 :qid |DualAttestationbpl.16943:15|
 :skolemid |387|
))) (=> (forall ((a@@25 Int) ) (!  (=> (|$IsValid'address'| a@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (not (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory@0@@0) 173345816)) (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (exists ((a@@26 Int) ) (!  (and (|$IsValid'address'| a@@26) (and ($1_Signer_is_txn_signer_addr a@@26) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) a@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) a@@26)) 1))))
 :qid |DualAttestationbpl.4259:13|
 :skolemid |107|
)))))
 :qid |DualAttestationbpl.16943:15|
 :skolemid |387|
)) (and (=> (= (ControlFlow 0 225660) (- 0 300239)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2))) (and (=> (= (ControlFlow 0 225660) (- 0 300251)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (and (=> (= (ControlFlow 0 225660) (- 0 300269)) (not (not (= (|$addr#$signer| _$t0@@18) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@18) 186537453))) (and (=> (= (ControlFlow 0 225660) (- 0 300283)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 225660) (- 0 300293)) (= (|$micro_xdx_limit#$1_DualAttestation_Limit| (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory@0@@0) 173345816)) _$t1@@12))))))))))))))))))
(let ((L3_correct@@8  (and (=> (= (ControlFlow 0 225451) (- 0 300002)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (=> (= (ControlFlow 0 225451) (- 0 300042)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) (= 5 $t7@0@@4)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t4@@2)) 1)) (= 3 $t7@0@@4))) (and (not (= (|$addr#$signer| _$t0@@18) 186537453)) (= 2 $t7@0@@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= 5 $t7@0@@4))))))))
(let ((anon15_Then_correct@@4  (=> (and (and $abort_flag@0@@10 (= $abort_code@1@@10 $abort_code@1@@10)) (and (= $t7@0@@4 $abort_code@1@@10) (= (ControlFlow 0 225674) 225451))) L3_correct@@8)))
(let ((anon14_Then$1_correct  (=> (= $t13@1 $t13@@7) (=> (and (= $abort_flag@0@@10 true) (= $abort_code@1@@10 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 225726) 225674) anon15_Then_correct@@4) (=> (= (ControlFlow 0 225726) 225660) anon15_Else_correct@@4))))))
(let ((anon14_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (= (ControlFlow 0 225724) 225726)) anon14_Then$1_correct)))
(let ((anon14_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816) (=> (and (and (= $t13@0 ($Mutation_172230 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))) (= $t13@1 $t13@0)) (and (= $abort_flag@0@@10 false) (= $abort_code@1@@10 $abort_code@0@@10))) (and (=> (= (ControlFlow 0 225483) 225674) anon15_Then_correct@@4) (=> (= (ControlFlow 0 225483) 225660) anon15_Else_correct@@4))))))
(let ((anon13_Then_correct@@0  (=> (and $t9@0@@1 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 225461) 225724) anon14_Then_correct@@3) (=> (= (ControlFlow 0 225461) 225483) anon14_Else_correct@@3)))))
(let ((anon13_Else_correct@@0  (=> (and (and (not $t9@0@@1) (= $t11@@9 $t11@@9)) (and (= $t7@0@@4 $t11@@9) (= (ControlFlow 0 225323) 225451))) L3_correct@@8)))
(let ((anon12_Else_correct@@6  (=> (and (and (and (not $t6@@5) (|$IsValid'address'| 173345816)) (and (= $t9@0@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t11@@9) (= $t11@@9 5)) (and (= $t11@@9 $t11@@9) (= $t9@0@@1 $t9@0@@1)))) (and (=> (= (ControlFlow 0 225307) 225461) anon13_Then_correct@@0) (=> (= (ControlFlow 0 225307) 225323) anon13_Else_correct@@0)))))
(let ((anon12_Then_correct@@6  (=> $t6@@5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t5@@8)) (= 5 $t7@@9)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t5@@8)) 1)) (= 3 $t7@@9))) (and (not (= (|$addr#$signer| _$t0@@18) 186537453)) (= 2 $t7@@9))) (= $t7@@9 $t7@@9)) (and (= $t7@0@@4 $t7@@9) (= (ControlFlow 0 225798) 225451))) L3_correct@@8))))
(let ((anon0$1_correct@@19  (=> (forall ((addr@@108 Int) ) (!  (=> (|$IsValid'address'| addr@@108) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@108) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@108)) 0)) (= addr@@108 173345816)))
 :qid |DualAttestationbpl.16672:20|
 :skolemid |359|
)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@109 Int) ) (!  (=> (|$IsValid'address'| addr@@109) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@109) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@109)) 1)) (= addr@@109 186537453)))
 :qid |DualAttestationbpl.16680:20|
 :skolemid |360|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@110 Int) ) (!  (=> (|$IsValid'address'| addr@@110) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@110)) 2))))))
 :qid |DualAttestationbpl.16688:20|
 :skolemid |361|
)))) (and (and (forall ((addr@@111 Int) ) (!  (=> (|$IsValid'address'| addr@@111) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@111)) 2))))))
 :qid |DualAttestationbpl.16692:20|
 :skolemid |362|
)) (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@112)) 2))))))
 :qid |DualAttestationbpl.16696:20|
 :skolemid |363|
))) (and (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@113)) 2))))))
 :qid |DualAttestationbpl.16700:20|
 :skolemid |364|
)) (forall ((addr@@114 Int) ) (!  (=> (|$IsValid'address'| addr@@114) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@114)) 2)))))
 :qid |DualAttestationbpl.16704:20|
 :skolemid |365|
))))) (=> (and (and (and (and (and (forall ((addr@@115 Int) ) (!  (=> (|$IsValid'address'| addr@@115) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@115)) 2)))))
 :qid |DualAttestationbpl.16708:20|
 :skolemid |366|
)) (forall ((addr@@116 Int) ) (!  (=> (|$IsValid'address'| addr@@116) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@116)) 2)))))
 :qid |DualAttestationbpl.16712:20|
 :skolemid |367|
))) (and (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116757| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@117) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@117)) 4))))
 :qid |DualAttestationbpl.16716:20|
 :skolemid |368|
)) (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116362| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@118) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@118)) 3))))
 :qid |DualAttestationbpl.16720:20|
 :skolemid |369|
)))) (and (and (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_116362| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@119) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@119)) 3))))
 :qid |DualAttestationbpl.16724:20|
 :skolemid |370|
)) (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_116362| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@120) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_116362| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@120)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@120)) 3))))
 :qid |DualAttestationbpl.16728:20|
 :skolemid |371|
))) (and (let (($range_0 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@121 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_112704| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@121))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@122 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_112704| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@122)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@122 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_112704| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@122)))) i1)))) 3))))
 :qid |DualAttestationbpl.16732:151|
 :skolemid |372|
))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_111636| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_113423| $1_DualAttestation_Limit_$memory) 173345816))))) (and (and (and (forall ((addr1@@23 Int) ) (!  (=> (|$IsValid'address'| addr1@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr1@@23) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@23)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr1@@23)) 2)))))
 :qid |DualAttestationbpl.16741:20|
 :skolemid |373|
)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (= (|Select__T@[Int]Bool_| (|domain#$Memory_173008| $1_DiemAccount_DiemAccount_$memory) addr@@123) (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@123)))
 :qid |DualAttestationbpl.16745:20|
 :skolemid |374|
))) (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (= (|Select__T@[Int]Bool_| (|domain#$Memory_141699| $1_VASPDomain_VASPDomainManager_$memory) addr@@124)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@124)) 1))))
 :qid |DualAttestationbpl.16749:20|
 :skolemid |375|
)) (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142066| $1_VASPDomain_VASPDomains_$memory) addr@@125)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@125) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@125)) 5))))
 :qid |DualAttestationbpl.16753:20|
 :skolemid |376|
)))) (and (and (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_117209| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@126) (|Select__T@[Int]Bool_| (|domain#$Memory_117269| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@126)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@126)) 2)))))
 :qid |DualAttestationbpl.16757:20|
 :skolemid |377|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (= (|Select__T@[Int]Bool_| (|domain#$Memory_173249| $1_DesignatedDealer_Dealer_$memory) addr@@127)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@127) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@127)) 2))))
 :qid |DualAttestationbpl.16761:20|
 :skolemid |378|
))) (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117094| $1_DualAttestation_Credential_$memory) addr@@128)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@128)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@128)) 5)))))
 :qid |DualAttestationbpl.16765:20|
 :skolemid |379|
)) (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (= (|Select__T@[Int]Bool_| (|domain#$Memory_112525| $1_SlidingNonce_SlidingNonce_$memory) addr@@129)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@129)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@129)) 1)))))
 :qid |DualAttestationbpl.16769:20|
 :skolemid |380|
)))))) (and (and (and (and (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116362| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@130)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@130)) 3))))
 :qid |DualAttestationbpl.16773:20|
 :skolemid |381|
)) (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116757| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@131)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@131)) 4))))
 :qid |DualAttestationbpl.16777:20|
 :skolemid |382|
))) (and (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142163| $1_VASP_ParentVASP_$memory) addr@@132)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@132)) 5))))
 :qid |DualAttestationbpl.16781:20|
 :skolemid |383|
)) (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (= (|Select__T@[Int]Bool_| (|domain#$Memory_142099| $1_VASP_ChildVASP_$memory) addr@@133)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) addr@@133)) 6))))
 :qid |DualAttestationbpl.16785:20|
 :skolemid |384|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@18)) ($1_Signer_is_txn_signer _$t0@@18)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@18)))) (and (and (and (|$IsValid'u64'| _$t1@@12) (forall (($a_0@@47 Int) ) (! (let (($rsc@@47 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $a_0@@47)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@47))
 :qid |DualAttestationbpl.16794:20|
 :skolemid |385|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $a_0@@47))
))) (and (forall (($a_0@@48 Int) ) (! (let (($rsc@@48 (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0@@48)))
(|$IsValid'$1_DualAttestation_Limit'| $rsc@@48))
 :qid |DualAttestationbpl.16798:20|
 :skolemid |386|
 :pattern ( (|Select__T@[Int]$1_DualAttestation_Limit_| (|contents#$Memory_113423| $1_DualAttestation_Limit_$memory) $a_0@@48))
)) (= $t4@@2 (|$addr#$signer| _$t0@@18)))) (and (and (= _$t0@@18 _$t0@@18) (= _$t1@@12 _$t1@@12)) (and (= $t5@@8 (|$addr#$signer| _$t0@@18)) (= $t6@@5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_112338| $1_Roles_RoleId_$memory) $t5@@8)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_112338| $1_Roles_RoleId_$memory) $t5@@8)) 1))) (not (= (|$addr#$signer| _$t0@@18) 186537453))))))))) (and (=> (= (ControlFlow 0 225259) 225798) anon12_Then_correct@@6) (=> (= (ControlFlow 0 225259) 225307) anon12_Else_correct@@6)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@19  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@27 T@$1_Event_EventHandle) ) (! (let ((stream@@28 (|Select__T@[$1_Event_EventHandle]Multiset_84854_| (|streams#$EventStore| $es) handle@@27)))
 (and (= (|l#Multiset_84854| stream@@28) 0) (forall ((v@@61 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_84854| stream@@28) v@@61) 0)
 :qid |DualAttestationbpl.134:13|
 :skolemid |2|
))))
 :qid |DualAttestationbpl.2431:13|
 :skolemid |69|
))) (= (ControlFlow 0 224409) 225259)) anon0$1_correct@@19)))
(let ((anon0_correct@@19  (=> (= (seq.len (|p#$Mutation_172230| $t13@@7)) 0) (=> (and (= (seq.len (|p#$Mutation_11233| $t14@@9)) 0) (= (ControlFlow 0 224419) 224409)) inline$$InitEventStore$0$anon0_correct@@19))))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (= (ControlFlow 0 298840) 224419) anon0_correct@@19)))
