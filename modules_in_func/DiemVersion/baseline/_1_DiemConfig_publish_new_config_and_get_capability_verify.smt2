...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 771340) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 464095) (- 0 772404)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemVersionbpl.12515:15|
 :skolemid |353|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemVersionbpl.12515:15|
 :skolemid |353|
)) (and (=> (= (ControlFlow 0 464095) (- 0 772429)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'#0'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 464095) (- 0 772466)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 464095) (- 0 772478)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 464095) (- 0 772496)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 464095) (- 0 772510)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 464095) (- 0 772520)) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 464095) (- 0 772526)) (= (let ((addr 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr))) _$t1)) (=> (= (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) addr@@0))) _$t1) (=> (= (ControlFlow 0 464095) (- 0 772535)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 463902) (- 0 772285)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 463902) (- 0 772325)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 464109) 463902))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 464161) 464109) anon15_Then_correct) (=> (= (ControlFlow 0 464161) 464095) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 464159) 464161)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_234450 (|Store__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| |$1_DiemConfig_DiemConfig'#0'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 463946) 464109) anon15_Then_correct) (=> (= (ControlFlow 0 463946) 464095) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'#0'| _$t1))) (and (=> (= (ControlFlow 0 463924) (- 0 772158)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 463924) 464159) anon14_Then_correct) (=> (= (ControlFlow 0 463924) 463946) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 463774) 463902))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 463758) 463924) anon13_Then_correct) (=> (= (ControlFlow 0 463758) 463774) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 463718) 463758)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) $t8)) (= (ControlFlow 0 463724) 463718))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 464253) 463902))) L3_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 :qid |DiemVersionbpl.12293:20|
 :skolemid |335|
)) (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@2)) 1)) (= addr@@2 186537453)))
 ...
 :qid |DiemVersionbpl.12329:20|
 :skolemid |344|
))) (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |DiemVersionbpl.12333:20|
 :skolemid |345|
 ...
 :qid |DiemVersionbpl.12349:20|
 :skolemid |349|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_250327| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_250387| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@14)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@14)) 2)))))
 :qid |DiemVersionbpl.12353:20|
 :skolemid |350|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemVersionbpl.12362:20|
 :skolemid |351|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@0))
 :qid |DiemVersionbpl.12366:20|
 :skolemid |352|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@0))
))) (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))))) (and (=> (= (ControlFlow 0 463662) 464253) anon12_Then_correct) (=> (= (ControlFlow 0 463662) 463724) anon12_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemVersionbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 463088) 463662)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 771340) 463088) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
