...
(assert (not
 (=> (= (ControlFlow 0 0) 744367) (let ((anon19_Else_correct@@4  (=> (not $abort_flag@0@@5) (and (=> (= (ControlFlow 0 443236) (- 0 745588)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 443236) (- 0 745606)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 443236) (- 0 745614)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5))) (and (=> (= (ControlFlow 0 443236) (- 0 745625)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 443236) (- 0 745637)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 443236) (- 0 745655)) (not (not (= (|$addr#$signer| _$t0@@5) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@5) 173345816))) (and (=> (= (ControlFlow 0 443236) (- 0 745669)) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) (|$addr#$signer| _$t0@@5))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1|) (|$addr#$signer| _$t0@@5)) (and (=> (= (ControlFlow 0 443236) (- 0 745678)) (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 443236) (- 0 745684)) (= (let ((addr@@25 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr@@25))) _$t1@@5)) (=> (= (let ((addr@@26 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr@@26))) _$t1@@5) (=> (= (ControlFlow 0 443236) (- 0 745693)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_212676| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_212676| $1_DiemConfig_Configuration_$memory) 173345816))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 443068) (- 0 745464)) (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0@@5) 173345816)))) (=> (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0@@5) 173345816))) (=> (= (ControlFlow 0 443068) (- 0 745510)) (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) (= 5 $t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t9@0))) (and (not (= (|$addr#$signer| _$t0@@5) 173345816)) (= 2 $t9@0))))))))
(let ((anon19_Then_correct@@4  (=> (and (and $abort_flag@0@@5 (= $abort_code@1@@5 $abort_code@1@@5)) (and (= $t9@0 $abort_code@1@@5) (= (ControlFlow 0 443250) 443068))) L3_correct)))
(let ((anon18_Then$1_correct  (=> (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 443302) 443250) anon19_Then_correct@@4) (=> (= (ControlFlow 0 443302) 443236) anon19_Else_correct@@4))))))
(let ((anon18_Then_correct@@4  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5)) (= (ControlFlow 0 443300) 443302)) anon18_Then$1_correct)))
(let ((anon18_Else_correct@@4  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5))) (=> (and (and (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@0| ($Memory_225315 (|Store__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5) true) (|Store__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0@@5) $t7@@5))) (= |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@1| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory@0|)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 443108) 443250) anon19_Then_correct@@4) (=> (= (ControlFlow 0 443108) 443236) anon19_Else_correct@@4))))))
(let ((anon17_Then_correct  (=> inline$$Not$0$dst@1 (and (=> (= (ControlFlow 0 443086) (- 0 745336)) (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| (|$addr#$signer| _$t0@@5))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| (|$addr#$signer| _$t0@@5)) (and (=> (= (ControlFlow 0 443086) 443300) anon18_Then_correct@@4) (=> (= (ControlFlow 0 443086) 443108) anon18_Else_correct@@4)))))))
(let ((anon17_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t14@@5 $t14@@5)) (and (= $t9@0 $t14@@5) (= (ControlFlow 0 442932) 443068))) L3_correct)))
(let ((anon5$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t14@@5) (= $t14@@5 6)) (and (= $t14@@5 $t14@@5) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 442916) 443086) anon17_Then_correct) (=> (= (ControlFlow 0 442916) 442932) anon17_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t11@0@@0)) (= (ControlFlow 0 442876) 442916)) anon5$1_correct)))
(let ((anon5_correct  (=> (and (and (|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| $t7@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (and (= (let ((addr@@27 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) addr@@27))) _$t1@@5) (= (|Select__T@[Int]Bool_| (|domain#$Memory_212676| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_212676| $1_DiemConfig_Configuration_$memory) 173345816)))) (and (=> (= (ControlFlow 0 442882) (- 0 745216)) (forall ((config_address@@14 Int) ) (!  (=> (|$IsValid'address'| config_address@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) config_address@@14) (= config_address@@14 173345816)))
 :qid |DiemVersionbpl.10407:15|
 :skolemid |216|
))) (=> (forall ((config_address@@15 Int) ) (!  (=> (|$IsValid'address'| config_address@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) config_address@@15) (= config_address@@15 173345816)))
 :qid |DiemVersionbpl.10407:15|
 :skolemid |216|
)) (and (=> (= (ControlFlow 0 442882) (- 0 745241)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory@2|) 173345816)) (=> (= $t7@@5 $t7@@5) (=> (and (and (|$IsValid'address'| $t10@@5) (= $t10@@5 (|$addr#$signer| _$t0@@5))) (and (= $t11@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $t10@@5)) (= (ControlFlow 0 442882) 442876))) inline$$Not$0$anon0_correct)))))))))
(let ((anon16_Else_correct  (=> (and (and (not |$temp_0'bool'@0@@4|) (= |$1_DiemConfig_DiemConfig'#0'_$memory@1| ($Memory_223836 (|Store__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 false) (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@2| |$1_DiemConfig_DiemConfig'#0'_$memory@1|) (= (ControlFlow 0 442753) 442882))) anon5_correct)))
(let ((anon16_Then_correct  (=> (and (and |$temp_0'bool'@0@@4| (= |$1_DiemConfig_DiemConfig'#0'_$memory@0@@0| ($Memory_223836 (|Store__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'#0''@0@@0|)))) (and (= |$1_DiemConfig_DiemConfig'#0'_$memory@2| |$1_DiemConfig_DiemConfig'#0'_$memory@0@@0|) (= (ControlFlow 0 443314) 442882))) anon5_correct)))
(let ((anon15_Else_correct  (=> (not $t8) (and (=> (= (ControlFlow 0 442741) 443314) anon16_Then_correct) (=> (= (ControlFlow 0 442741) 442753) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> $t8 (=> (and (and (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t6)) (= 5 $t9@@5)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t9@@5))) (and (not (= (|$addr#$signer| _$t0@@5) 173345816)) (= 2 $t9@@5))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (= 6 $t9@@5))) (= $t9@@5 $t9@@5)) (and (= $t9@0 $t9@@5) (= (ControlFlow 0 443402) 443068))) L3_correct))))
(let ((anon0$1_correct@@5  (=> (and (and (and (and (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@28)) 0)) (= addr@@28 173345816)))
 :qid |DiemVersionbpl.10227:20|
 :skolemid |197|
)) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@29) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@29)) 1)) (= addr@@29 186537453)))
 :qid |DiemVersionbpl.10231:20|
 :skolemid |198|
))) (and (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@30)) 2))))))
 :qid |DiemVersionbpl.10235:20|
 :skolemid |199|
)) (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@31)) 2))))))
 :qid |DiemVersionbpl.10239:20|
 :skolemid |200|
)))) (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@32)) 2))))))
 :qid |DiemVersionbpl.10243:20|
 :skolemid |201|
)) (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@33)) 2))))))
 :qid |DiemVersionbpl.10247:20|
 :skolemid |202|
))) (and (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@34)) 2)))))
 :qid |DiemVersionbpl.10251:20|
 :skolemid |203|
)) (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@35)) 2)))))
 :qid |DiemVersionbpl.10255:20|
 :skolemid |204|
))))) (and (and (and (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@36)) 2)))))
 :qid |DiemVersionbpl.10259:20|
 :skolemid |205|
)) (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_220679| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@37) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@37)) 4))))
 :qid |DiemVersionbpl.10263:20|
 :skolemid |206|
))) (and (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222145| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@38) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@38)) 3))))
 :qid |DiemVersionbpl.10267:20|
 :skolemid |207|
)) (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222145| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@39) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@39)) 3))))
 :qid |DiemVersionbpl.10271:20|
 :skolemid |208|
)))) (and (and (forall ((addr@@40 Int) ) (!  (=> (|$IsValid'address'| addr@@40) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222145| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@40) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_222145| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@40)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@40) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@40)) 3))))
 :qid |DiemVersionbpl.10275:20|
 :skolemid |209|
)) (forall ((config_address@@16 Int) ) (!  (=> (|$IsValid'address'| config_address@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@16) (= config_address@@16 173345816)))
 :qid |DiemVersionbpl.10279:20|
 :skolemid |210|
))) (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_239239| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |DiemVersionbpl.10283:20|
 :skolemid |211|
)) (forall ((addr@@41 Int) ) (!  (=> (|$IsValid'address'| addr@@41) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_239354| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@41) (|Select__T@[Int]Bool_| (|domain#$Memory_239414| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@41)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) addr@@41)) 2)))))
 :qid |DiemVersionbpl.10287:20|
 :skolemid |212|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@5)) ($1_Signer_is_txn_signer _$t0@@5)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@5))) (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $a_0@@25)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@25))
 :qid |DiemVersionbpl.10296:20|
 :skolemid |213|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $a_0@@25))
))) (and (and (and (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@26)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@26))
 :qid |DiemVersionbpl.10300:20|
 :skolemid |214|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@26))
)) (forall (($a_0@@27 Int) ) (! (let (($rsc@@27 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $a_0@@27)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'#0''| $rsc@@27))
 :qid |DiemVersionbpl.10304:20|
 :skolemid |215|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'#0'_| (|contents#$Memory_225315| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) $a_0@@27))
))) (and (= $t5 (|$addr#$signer| _$t0@@5)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@0| 173345816))) (and (and (|Select__T@[Int]Bool_| |$1_DiemConfig_ModifyConfigCapability'#0'_$modifies| 173345816) (= _$t0@@5 _$t0@@5)) (and (= _$t1@@5 _$t1@@5) (= $t6 (|$addr#$signer| _$t0@@5))))))) (and (=> (= (ControlFlow 0 442733) (- 0 744991)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@0| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies@@0| 173345816) (=> (= $t8  (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_212396| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_212396| $1_Roles_RoleId_$memory) $t6)) 0))) (not (= (|$addr#$signer| _$t0@@5) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_223836| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 442733) 443402) anon15_Then_correct) (=> (= (ControlFlow 0 442733) 442741) anon15_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_174383_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_174383| stream@@11) 0) (forall ((v@@53 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_174383| stream@@11) v@@53) 0)
 :qid |DiemVersionbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemVersionbpl.3272:13|
 :skolemid |89|
))) (= (ControlFlow 0 442119) 442733)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (ControlFlow 0 744367) 442119) inline$$InitEventStore$0$anon0_correct@@5)))
anon0_correct@@5)))))))))))))))))))
))
(check-sat)
(pop 1)
