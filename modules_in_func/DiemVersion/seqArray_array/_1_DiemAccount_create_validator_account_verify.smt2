...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@3 () T@$Memory_232674)
...
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@1 () T@$Memory_232674)
(declare-fun inline$$1_ValidatorConfig_publish$0$$t9@1 () Int)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@2 () T@$Memory_232674)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory@0 () T@$Memory_232674)
...
(declare-fun MapConstVec_160335 (T@$1_ValidatorConfig_Config) |T@[Int]$1_ValidatorConfig_Config|)
(declare-fun DefaultVecElem_160335 () T@$1_ValidatorConfig_Config)
...
(assert (not
 (=> (= (ControlFlow 0 0) 916042) (let ((L2_correct  (and (=> (= (ControlFlow 0 685479) (- 0 919861)) (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) _$t1))) (=> (or (or (or (or (or (or (or (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (= _$t1 0)) (= _$t1 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) _$t1)) (=> (= (ControlFlow 0 685479) (- 0 919962)) (or (or (or (or (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1) (= 6 $t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8@0))) (and (= _$t1 0) (= 7 $t8@0))) (and (= _$t1 1) (= 7 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) _$t1) (= 6 $t8@0))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8@0))) (and (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)) (= 7 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) _$t1) (= 6 $t8@0))))))))
(let ((anon31_Then_correct  (=> $t19 (=> (and (and (or (or (or (or (and (= $t15 0) (= 7 $t8)) (and (= $t15 1) (= 7 $t8))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $t15) (= 6 $t8))) (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (= 5 $t8))) (and (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)) (= 7 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 685151) 685479))) L2_correct))))
(let ((anon30_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t8@0 $abort_code@3) (= (ControlFlow 0 685493) 685479))) L2_correct)))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 685507) 685479))) L2_correct)))
(let ((anon28_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 685521) 685479))) L2_correct)))
(let ((anon26_Then_correct  (=> $t7 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t6)) 0)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 685627) 685479))) L2_correct))))
(let ((anon24_correct  (=> (= $t20 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816)) (=> (and (= $t21 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t22 ($1_DiemAccount_CreateAccountEvent (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))))) (=> (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) $t15)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory@2) $t15) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory@2) $t15))))) (and (and (= (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t20) (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16)))) (= (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t20) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| ($1_DiemAccount_AccountOperationsCapability (|$limits_cap#$1_DiemAccount_AccountOperationsCapability| $t16) (|$creation_events#$1_DiemAccount_AccountOperationsCapability| $t16))))) (and (not (= (|l#Vec_176449| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_176449| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))))) (and (and (and (not (= (|l#Vec_176488| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)) (= $t15 (|$account_address#$1_DiemAccount_WithdrawCapability| (|Select__T@[Int]$1_DiemAccount_WithdrawCapability_| (|v#Vec_176488| (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) $t15)))) 0)))) (= $t23 $t22)) (and (and (= $t24 $t21) (= $es@0 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) $t24)))
(let ((stream_new (let ((len (|l#Multiset_176324| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23))))
(Multiset_176324 (|Store__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@0) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t23) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) $t24 stream_new)))))) (and (= $t25 (|$creation_events#$1_DiemAccount_AccountOperationsCapability| (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory@2) 173345816))) (= $t26 ($1_DiemAccount_CreateAccountEvent _$t1 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) _$t1)))))))) (and (=> (= (ControlFlow 0 684997) (- 0 919565)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) _$t1)) (and (=> (= (ControlFlow 0 684997) (- 0 919574)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 684997) (- 0 919586)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $t5)) 0))) (and (=> (= (ControlFlow 0 684997) (- 0 919604)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 684997) (- 0 919618)) (not (= _$t1 0))) (=> (not (= _$t1 0)) (and (=> (= (ControlFlow 0 684997) (- 0 919628)) (not (= _$t1 1))) (=> (not (= _$t1 1)) (and (=> (= (ControlFlow 0 684997) (- 0 919638)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) _$t1)) (and (=> (= (ControlFlow 0 684997) (- 0 919647)) (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))))) (=> (not (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (and (=> (= (ControlFlow 0 684997) (- 0 919664)) (not (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)))) (=> (not (not (= (+ 16 (|l#Vec_29362| _$t2)) 32))) (and (=> (= (ControlFlow 0 684997) (- 0 919682)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 684997) (- 0 919692)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) _$t1))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) _$t1)) (and (=> (= (ControlFlow 0 684997) (- 0 919701)) (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) _$t1) (and (=> (= (ControlFlow 0 684997) (- 0 919708)) (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory@3) _$t1) (and (=> (= (ControlFlow 0 684997) (- 0 919715)) (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) _$t1)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) _$t1) (and (=> (= (ControlFlow 0 684997) (- 0 919722)) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) _$t1)) 3)) (=> (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) _$t1)) 3) (and (=> (= (ControlFlow 0 684997) (- 0 919735)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) addr) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory@2) addr)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) addr)))))
 :qid |DiemVersionbpl.39281:15|
 :skolemid |1419|
 ...
 :qid |DiemVersionbpl.39281:15|
 :skolemid |1419|
)) (and (=> (= (ControlFlow 0 684997) (- 0 919770)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_176324| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_176324 (|Store__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@1) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@0))))))
...
(let ((expected@@0 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_176324| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26))))
(Multiset_176324 (|Store__T@[$EventRep]Int_| (|v#Multiset_176324| stream@@2) (|$ToEventRep'$1_DiemAccount_CreateAccountEvent'| $t26) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@1))))))
 ...
 :qid |DiemVersionbpl.3327:13|
 :skolemid |120|
))))) (=> (= (ControlFlow 0 684997) (- 0 919795)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $EmptyEventStore) $t25 stream_new@@2))))))
...
(let ((anon35_Else_correct  (=> (and (and (not |$temp_0'bool'@3|) (= $1_DiemAccount_AccountOperationsCapability_$memory@1 ($Memory_224389 (|Store__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 false) (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@1) (= (ControlFlow 0 684568) 684997))) anon24_correct)))
(let ((anon35_Then_correct  (=> (and (and |$temp_0'bool'@3| (= $1_DiemAccount_AccountOperationsCapability_$memory@0 ($Memory_224389 (|Store__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 true) (|Store__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816 |$temp_0'$1_DiemAccount_AccountOperationsCapability'@0|)))) (and (= $1_DiemAccount_AccountOperationsCapability_$memory@2 $1_DiemAccount_AccountOperationsCapability_$memory@0) (= (ControlFlow 0 685009) 684997))) anon24_correct)))
(let ((anon34_Else_correct  (=> (not |$temp_0'bool'@2|) (=> (and (= $1_AccountFreezing_FreezingBit_$memory@1 ($Memory_224217 (|Store__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $t15 false) (|contents#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@1)) (and (=> (= (ControlFlow 0 684554) 685009) anon35_Then_correct) (=> (= (ControlFlow 0 684554) 684568) anon35_Else_correct))))))
(let ((anon34_Then_correct  (=> |$temp_0'bool'@2| (=> (and (= $1_AccountFreezing_FreezingBit_$memory@0 ($Memory_224217 (|Store__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $t15 true) (|Store__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $t15 |$temp_0'$1_AccountFreezing_FreezingBit'@0|))) (= $1_AccountFreezing_FreezingBit_$memory@2 $1_AccountFreezing_FreezingBit_$memory@0)) (and (=> (= (ControlFlow 0 685021) 685009) anon35_Then_correct) (=> (= (ControlFlow 0 685021) 684568) anon35_Else_correct))))))
(let ((anon33_Else_correct  (=> (and (not |$temp_0'bool'@1|) (= $1_Event_EventHandleGenerator_$memory@1 ($Memory_214777 (|Store__T@[Int]Bool_| (|domain#$Memory_214777| $1_Event_EventHandleGenerator_$memory) $t15 false) (|contents#$Memory_214777| $1_Event_EventHandleGenerator_$memory)))) (and (=> (= (ControlFlow 0 684540) 685021) anon34_Then_correct) (=> (= (ControlFlow 0 684540) 684554) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and |$temp_0'bool'@1| (= $1_Event_EventHandleGenerator_$memory@0 ($Memory_214777 (|Store__T@[Int]Bool_| (|domain#$Memory_214777| $1_Event_EventHandleGenerator_$memory) $t15 true) (|Store__T@[Int]$1_Event_EventHandleGenerator_| (|contents#$Memory_214777| $1_Event_EventHandleGenerator_$memory) $t15 |$temp_0'$1_Event_EventHandleGenerator'@0|)))) (and (=> (= (ControlFlow 0 685033) 685021) anon34_Then_correct) (=> (= (ControlFlow 0 685033) 684554) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemAccount_DiemAccount_$memory@1 ($Memory_312085 (|Store__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $t15 false) (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1)) (and (=> (= (ControlFlow 0 684526) 685033) anon33_Then_correct) (=> (= (ControlFlow 0 684526) 684540) anon33_Else_correct))))))
(let ((anon32_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_312085 (|Store__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $t15 true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $t15 |$temp_0'$1_DiemAccount_DiemAccount'@0|))) (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@0)) (and (=> (= (ControlFlow 0 685045) 685033) anon33_Then_correct) (=> (= (ControlFlow 0 685045) 684540) anon33_Else_correct))))))
(let ((anon31_Else_correct  (=> (not $t19) (and (=> (= (ControlFlow 0 684514) 685045) anon32_Then_correct) (=> (= (ControlFlow 0 684514) 684526) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $t15 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t16 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816))) (and (= $t17 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t18 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)))) (and (=> (= (ControlFlow 0 684508) (- 0 919060)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $t15))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $t15)) (and (=> (= (ControlFlow 0 684508) (- 0 919071)) (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816) (and (=> (= (ControlFlow 0 684508) (- 0 919080)) (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) $t15)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) $t15) (=> (= $t19  (or (or (or (or (= $t15 0) (= $t15 1)) (|Select__T@[Int]Bool_| (|domain#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $t15)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)))) (not (= (+ 16 (|l#Vec_29362| _$t2)) 32)))) (and (=> (= (ControlFlow 0 684508) 685151) anon31_Then_correct) (=> (= (ControlFlow 0 684508) 684514) anon31_Else_correct)))))))))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Else_correct  (=> (and (and (not $abort_flag@1) (= $abort_code@3 $abort_code@2)) (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@1) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 684134) 685493) anon30_Then_correct) (=> (= (ControlFlow 0 684134) 684508) anon30_Else_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$L3_correct  (=> (= $abort_code@3 inline$$1_ValidatorConfig_publish$0$$t9@1) (=> (and (= $1_ValidatorConfig_ValidatorConfig_$memory@3 $1_ValidatorConfig_ValidatorConfig_$memory@2) (= $abort_flag@2 true)) (and (=> (= (ControlFlow 0 684040) 685493) anon30_Then_correct) (=> (= (ControlFlow 0 684040) 684508) anon30_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon20_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory@1)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 $abort_code@2) (= (ControlFlow 0 684148) 684040))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct  (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 684200) 684148) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 684200) 684134) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 684198) 684200)) inline$$1_ValidatorConfig_publish$0$anon19_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon19_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_232674 (|Store__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) inline$$1_ValidatorConfig_publish$0$$t21@1))) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 684124) 684148) inline$$1_ValidatorConfig_publish$0$anon20_Then_correct) (=> (= (ControlFlow 0 684124) 684134) inline$$1_ValidatorConfig_publish$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (and (and (|$IsValid'$1_Option_Option'$1_ValidatorConfig_Config''| inline$$1_ValidatorConfig_publish$0$$t19@0) (<= (|l#Vec_176410| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0)) 1)) (|$IsEqual'vec'$1_ValidatorConfig_Config''| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| inline$$1_ValidatorConfig_publish$0$$t19@0) (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$1_Option_Option'$1_ValidatorConfig_Config'| (Vec_176410 (MapConstVec_160335 DefaultVecElem_160335) 0))))) (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_publish$0$$t20@0) (<= (|l#Vec_29362| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0)) 1)) (and (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_publish$0$$t20@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_29362 (MapConstVec_16957 DefaultVecElem_16957) 0)))) (= inline$$1_ValidatorConfig_publish$0$$t21@1 ($1_ValidatorConfig_ValidatorConfig inline$$1_ValidatorConfig_publish$0$$t19@0 inline$$1_ValidatorConfig_publish$0$$t20@0 _$t3))))) (and (=> (= (ControlFlow 0 684102) 684198) inline$$1_ValidatorConfig_publish$0$anon19_Then_correct) (=> (= (ControlFlow 0 684102) 684124) inline$$1_ValidatorConfig_publish$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon18_Else_correct  (=> (not inline$$Not$0$dst@1) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t18@0) (= (ControlFlow 0 684034) 684040))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$1_ValidatorConfig_publish$0$$t18@0 6)) (and (= inline$$1_ValidatorConfig_publish$0$$t18@0 inline$$1_ValidatorConfig_publish$0$$t18@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 684018) 684102) inline$$1_ValidatorConfig_publish$0$anon18_Then_correct) (=> (= (ControlFlow 0 684018) 684034) inline$$1_ValidatorConfig_publish$0$anon18_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_ValidatorConfig_publish$0$$t15@1)) (= (ControlFlow 0 683978) 684018)) inline$$1_ValidatorConfig_publish$0$anon17_Else$1_correct)))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t13@0) (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_publish$0$$t14@0) (= inline$$1_ValidatorConfig_publish$0$$t14@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (and (= inline$$1_ValidatorConfig_publish$0$$t15@1 (|Select__T@[Int]Bool_| (|domain#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_publish$0$$t14@0)) (= (ControlFlow 0 683984) 683978))) inline$$Not$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon17_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t13@0 (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 684252) 684040))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t11@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t12@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= inline$$1_ValidatorConfig_publish$0$$t13@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t12@0)) 3))))) (and (=> (= (ControlFlow 0 683922) 684252) inline$$1_ValidatorConfig_publish$0$anon17_Then_correct) (=> (= (ControlFlow 0 683922) 683984) inline$$1_ValidatorConfig_publish$0$anon17_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon16_Then_correct  (=> (and inline$$1_ValidatorConfig_publish$0$$t11@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) (= 5 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0)) (= 3 inline$$1_ValidatorConfig_publish$0$$t9@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_ValidatorConfig_publish$0$$t9@0)))) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 684344) 684040))) inline$$1_ValidatorConfig_publish$0$L3_correct))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Else_correct  (=> (not inline$$1_ValidatorConfig_publish$0$$t8@0) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t10@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t11@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@3) inline$$1_ValidatorConfig_publish$0$$t10@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))) (and (=> (= (ControlFlow 0 683876) 684344) inline$$1_ValidatorConfig_publish$0$anon16_Then_correct) (=> (= (ControlFlow 0 683876) 683922) inline$$1_ValidatorConfig_publish$0$anon16_Else_correct))))))
(let ((inline$$1_ValidatorConfig_publish$0$anon15_Then_correct  (=> inline$$1_ValidatorConfig_publish$0$$t8@0 (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 inline$$1_ValidatorConfig_publish$0$$t9@0)) (=> (and (and (= inline$$1_ValidatorConfig_publish$0$$t9@0 inline$$1_ValidatorConfig_publish$0$$t9@0) (= $1_ValidatorConfig_ValidatorConfig_$memory@2 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (= inline$$1_ValidatorConfig_publish$0$$t9@1 inline$$1_ValidatorConfig_publish$0$$t9@0) (= (ControlFlow 0 684370) 684040))) inline$$1_ValidatorConfig_publish$0$L3_correct)))))
(let ((inline$$1_ValidatorConfig_publish$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_publish$0$$t5@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (= inline$$1_ValidatorConfig_publish$0$$t6@0 (|$addr#$signer| _$t0)) (= inline$$1_ValidatorConfig_publish$0$$t7@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (and (and (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1) (= _$t0 _$t0)) (and (= _$t3 _$t3) (= inline$$1_ValidatorConfig_publish$0$$t8@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (=> (= (ControlFlow 0 683806) 684370) inline$$1_ValidatorConfig_publish$0$anon15_Then_correct) (=> (= (ControlFlow 0 683806) 683876) inline$$1_ValidatorConfig_publish$0$anon15_Else_correct)))))))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t12 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= $t13 (|$addr#$signer| _$t0))) (and (= $t14 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= (ControlFlow 0 684374) 683806))) inline$$1_ValidatorConfig_publish$0$anon0_correct))))
(let ((anon28_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 682943) 685507) anon29_Then_correct) (=> (= (ControlFlow 0 682943) 684374) anon29_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$L2_correct  (=> (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (=> (= (ControlFlow 0 682818) 685521) anon28_Then_correct) (=> (= (ControlFlow 0 682818) 682943) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Then_correct  (=> inline$$1_Roles_new_validator_role$0$$t9@0 (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (= 6 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 682812) 682818))) inline$$1_Roles_new_validator_role$0$L2_correct))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Then_correct  (=> (and (and inline$$1_Roles_new_validator_role$0$$t5@0 (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) (= 5 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0)) (= 3 inline$$1_Roles_new_validator_role$0$$t6@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 inline$$1_Roles_new_validator_role$0$$t6@0)))) (and (= inline$$1_Roles_new_validator_role$0$$t6@0 inline$$1_Roles_new_validator_role$0$$t6@0) (= (ControlFlow 0 682910) 682818))) inline$$1_Roles_new_validator_role$0$L2_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon7_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (and (and (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory@2) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) 3) (= $1_Roles_RoleId_$memory@3 $1_Roles_RoleId_$memory@2)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 682770) 685521) anon28_Then_correct) (=> (= (ControlFlow 0 682770) 682943) anon28_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Else_correct  (=> (and (and (not |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1|) (= $1_Roles_RoleId_$memory@1 ($Memory_222822 (|Store__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) false) (|contents#$Memory_222822| $1_Roles_RoleId_$memory)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@1) (= (ControlFlow 0 682744) 682770))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon10_Then_correct  (=> (and (and |inline$$1_Roles_new_validator_role$0$$temp_0'bool'@1| (= $1_Roles_RoleId_$memory@0 ($Memory_222822 (|Store__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) true) (|Store__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1) |inline$$1_Roles_new_validator_role$0$$temp_0'$1_Roles_RoleId'@1|)))) (and (= $1_Roles_RoleId_$memory@2 $1_Roles_RoleId_$memory@0) (= (ControlFlow 0 682784) 682770))) inline$$1_Roles_new_validator_role$0$anon7_correct)))
(let ((inline$$1_Roles_new_validator_role$0$anon9_Else_correct  (=> (not inline$$1_Roles_new_validator_role$0$$t9@0) (and (=> (= (ControlFlow 0 682730) 682784) inline$$1_Roles_new_validator_role$0$anon10_Then_correct) (=> (= (ControlFlow 0 682730) 682744) inline$$1_Roles_new_validator_role$0$anon10_Else_correct)))))
(let ((inline$$1_Roles_new_validator_role$0$anon8_Else_correct  (=> (and (not inline$$1_Roles_new_validator_role$0$$t5@0) (|$IsValid'u64'| 3)) (=> (and (and (= inline$$1_Roles_new_validator_role$0$$t8@0 (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= 3 0) (= inline$$1_Roles_new_validator_role$0$$t8@0 173345816))) (and (=> (= 3 1) (= inline$$1_Roles_new_validator_role$0$$t8@0 186537453)) (= inline$$1_Roles_new_validator_role$0$$t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))))) (and (=> (= (ControlFlow 0 682724) 682812) inline$$1_Roles_new_validator_role$0$anon9_Then_correct) (=> (= (ControlFlow 0 682724) 682730) inline$$1_Roles_new_validator_role$0$anon9_Else_correct))))))
(let ((inline$$1_Roles_new_validator_role$0$anon0_correct  (=> (and (= inline$$1_Roles_new_validator_role$0$$t2@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t3@0 (|$addr#$signer| _$t0))) (=> (and (and (= _$t0 _$t0) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= inline$$1_Roles_new_validator_role$0$$t4@0 (|$addr#$signer| _$t0)) (= inline$$1_Roles_new_validator_role$0$$t5@0  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) inline$$1_Roles_new_validator_role$0$$t4@0)) 0))) (not (= (|$addr#$signer| _$t0) 173345816)))))) (and (=> (= (ControlFlow 0 682658) 682910) inline$$1_Roles_new_validator_role$0$anon8_Then_correct) (=> (= (ControlFlow 0 682658) 682724) inline$$1_Roles_new_validator_role$0$anon8_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (and (not false) (= inline$$1_DiemAccount_create_signer$0$signer@1 inline$$1_DiemAccount_create_signer$0$signer@1)) (and (= $t10 (|$addr#$signer| _$t0)) (= $t11 (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 682914) (- 0 917846)) (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1))) (=> (|Select__T@[Int]Bool_| $1_Roles_RoleId_$modifies (|$addr#$signer| inline$$1_DiemAccount_create_signer$0$signer@1)) (=> (= (ControlFlow 0 682914) 682658) inline$$1_Roles_new_validator_role$0$anon0_correct))))))
(let ((anon27_Then_correct true))
(let ((inline$$1_DiemAccount_create_signer$0$anon0_correct  (=> (= inline$$1_DiemAccount_create_signer$0$signer@1 ($signer _$t1)) (and (=> (= (ControlFlow 0 682038) 685535) anon27_Then_correct) (=> (= (ControlFlow 0 682038) 682914) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $t7) (= (ControlFlow 0 682044) 682038)) inline$$1_DiemAccount_create_signer$0$anon0_correct)))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 ...
 :qid |DiemVersionbpl.38673:20|
 :skolemid |1386|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@7)) 2)))))
 :qid |DiemVersionbpl.38677:20|
 :skolemid |1387|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_223188| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 ...
 :qid |DiemVersionbpl.38806:20|
 :skolemid |1399|
))))) (and (and (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_224460| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@20)  (and (= addr@@20 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) addr@@20))))
 :qid |DiemVersionbpl.38810:20|
 :skolemid |1400|
 ...
 :qid |DiemVersionbpl.38822:20|
 :skolemid |1403|
)))) (and (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_311034| $1_DesignatedDealer_Dealer_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@24)) 2))))
 :qid |DiemVersionbpl.38826:20|
 :skolemid |1404|
 ...
 :qid |DiemVersionbpl.38838:20|
 :skolemid |1407|
))))))) (and (and (and (and (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223009| $1_SlidingNonce_SlidingNonce_$memory) addr@@28)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@28)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@28)) 1)))))
 :qid |DiemVersionbpl.38842:20|
 :skolemid |1408|
 ...
 :qid |DiemVersionbpl.38854:20|
 :skolemid |1411|
)))) (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (= (|Select__T@[Int]Bool_| (|domain#$Memory_304069| $1_VASP_ChildVASP_$memory) addr@@32)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_222822| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) addr@@32)) 6))))
 :qid |DiemVersionbpl.38858:20|
 :skolemid |1412|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_224531| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_224615| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_222693| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'address'| _$t1))) (and (and (and (and (|$IsValid'vec'u8''| _$t2) (|$IsValid'vec'u8''| _$t3)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemVersionbpl.38898:20|
 :skolemid |1413|
...
(|$IsValid'$1_Roles_RoleId'| $rsc@@0))
 :qid |DiemVersionbpl.38902:20|
 :skolemid |1414|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_222822| $1_Roles_RoleId_$memory) $a_0@@0))
)))) (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@1) (and (<= (|l#Vec_176410| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1) (<= (|l#Vec_29362| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@1))) 1))))
 :qid |DiemVersionbpl.38906:20|
 :skolemid |1415|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_232674| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2)))
(|$IsValid'$1_AccountFreezing_FreezingBit'| $rsc@@2))
 :qid |DiemVersionbpl.38910:20|
 :skolemid |1416|
 :pattern ( (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_224217| $1_AccountFreezing_FreezingBit_$memory) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $a_0@@3)))
 ...
 :qid |DiemVersionbpl.38914:20|
 :skolemid |1417|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_312085| $1_DiemAccount_DiemAccount_$memory) $a_0@@3))
)) (forall (($a_0@@4 Int) ) (! (let (($rsc@@4 (|Select__T@[Int]$1_DiemAccount_AccountOperationsCapability_| (|contents#$Memory_224389| $1_DiemAccount_AccountOperationsCapability_$memory) $a_0@@4)))
(|$IsValid'$1_DiemAccount_AccountOperationsCapability'| $rsc@@4))
 :qid |DiemVersionbpl.38918:20|
 :skolemid |1418|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemVersionbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 680518) 682000)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 916042) 680518) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
