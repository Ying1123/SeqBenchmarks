...
(declare-fun |$1_DiemConfig_ModifyConfigCapability'#0'_$memory| () T@$Memory_236269)
...
(declare-fun $t20@1 () T@$Mutation_236348)
(declare-fun $t21@0 () T@$Mutation_179974)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t21@1 () T@$Mutation_179974)
(declare-fun $t20@2 () T@$Mutation_236348)
...
(declare-fun $t20 () T@$Mutation_236348)
(declare-fun $t20@0 () T@$Mutation_236348)
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) $t37 stream_new)))) $es))))) (and (=> (= (ControlFlow 0 448320) (- 0 758204)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_236269| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_236269| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 448320) (- 0 758217)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 448320) (- 0 758229)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t9) 18446744073709551615)) (< $t10 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t9))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t9) 18446744073709551615)) (< $t10 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t9)))) (and (=> (= (ControlFlow 0 448320) (- 0 758271)) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816) (and (=> (= (ControlFlow 0 448320) (- 0 758277)) (= (let ((addr 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) addr@@0))) _$t1) (=> (= (ControlFlow 0 448320) (- 0 758286)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory@2) 173345816)))))))))))))))))
(let ((anon23_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= $1_DiemConfig_Configuration_$memory@1 ($Memory_223102 (|Store__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1) (= (ControlFlow 0 448038) 448320))) anon16_correct)))
(let ((anon23_Then_correct  (=> (and (and |$temp_0'bool'@0| (= $1_DiemConfig_Configuration_$memory@0 ($Memory_223102 (|Store__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|)))) (and (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0) (= (ControlFlow 0 448332) 448320))) anon16_correct)))
(let ((anon22_Else_correct  (=> (not $t30) (and (=> (= (ControlFlow 0 448026) 448332) anon23_Then_correct) (=> (= (ControlFlow 0 448026) 448038) anon23_Else_correct)))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 447639) (- 0 757820)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_236269| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t9) 18446744073709551615)) (< $t10 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t9))))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_236269| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t9) 18446744073709551615)) (< $t10 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t9)))) (=> (= (ControlFlow 0 447639) (- 0 757876)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_236269| |$1_DiemConfig_ModifyConfigCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t15@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= 5 $t15@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t9) 18446744073709551615)) (< $t10 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t9))) (= 1 $t15@0))))))))
(let ((anon22_Then_correct  (=> $t30 (=> (and (and (and (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26) $t23)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t26) 18446744073709551615)) (< $t27 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26)))) (= 1 $t15)) (= $t15 $t15)) (and (= $t15@0 $t15) (= (ControlFlow 0 448412) 447639))) L5_correct))))
(let ((anon21_Else_correct  (=> (not $abort_flag@0) (=> (and (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| (|v#$Mutation_236348| $t20@1)) (= |$temp_0'$1_DiemConfig_DiemConfig'#0''@0| |$temp_0'$1_DiemConfig_DiemConfig'#0''@0|)) (=> (and (and (= $t21@0 ($Mutation_179974 (|l#$Mutation_236348| $t20@1) (let ((l (|l#Vec_29362| (|p#$Mutation_236348| $t20@1))))
(Vec_29362 (|Store__T@[Int]Int_| (|v#Vec_29362| (|p#$Mutation_236348| $t20@1)) l 0) (+ l 1))) (|$payload#$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_236348| $t20@1)))) (= $t21@1 ($Mutation_179974 (|l#$Mutation_179974| $t21@0) (|p#$Mutation_179974| $t21@0) _$t1))) (and (= $t20@2 ($Mutation_236348 (|l#$Mutation_236348| $t20@1) (|p#$Mutation_236348| $t20@1) (|$1_DiemConfig_DiemConfig'#0'| (|v#$Mutation_179974| $t21@1)))) (= |$1_DiemConfig_DiemConfig'#0'_$memory@0| ($Memory_234450 (|Store__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_236348| $t20@2)) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) (|a#$Global| (|l#$Mutation_236348| $t20@2)) (|v#$Mutation_236348| $t20@2)))))) (and (=> (= (ControlFlow 0 448018) (- 0 757506)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) config_address) (= config_address 173345816)))
 :qid |DiemVersionbpl.8027:15|
 :skolemid |190|
 ...
 :qid |DiemVersionbpl.8027:15|
 :skolemid |190|
)) (and (=> (= (ControlFlow 0 448018) (- 0 757531)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory@0|) 173345816)) (=> (and (and (and (= $t22 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t23 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t24 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t25 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))) (and (and (= $t26 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t27 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t28 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t29 (|$events#$1_DiemConfig_Configuration| $t28))))) (and (=> (= (ControlFlow 0 448018) (- 0 757638)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_223102| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 448018) (- 0 757651)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (=> (= $t30  (and (or (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (= (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26) $t23)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_234531| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t26) 18446744073709551615)) (< $t27 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t26))))) (and (=> (= (ControlFlow 0 448018) 448412) anon22_Then_correct) (=> (= (ControlFlow 0 448018) 448026) anon22_Else_correct)))))))))))))))))
(let ((anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t15@0 $abort_code@1) (= (ControlFlow 0 448426) 447639))) L5_correct)))
(let ((anon20_Then$1_correct  (=> (= $t20@1 $t20) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 448478) 448426) anon21_Then_correct) (=> (= (ControlFlow 0 448478) 448018) anon21_Else_correct))))))
(let ((anon20_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= (ControlFlow 0 448476) 448478)) anon20_Then$1_correct)))
(let ((anon20_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (=> (and (and (= $t20@0 ($Mutation_236348 ($Global 173345816) (Vec_29362 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (= $t20@1 $t20@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 447739) 448426) anon21_Then_correct) (=> (= (ControlFlow 0 447739) 448018) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> $t17@0 (and (=> (= (ControlFlow 0 447717) (- 0 757315)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 447717) 448476) anon20_Then_correct) (=> (= (ControlFlow 0 447717) 447739) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (and (not $t17@0) (= $t19 $t19)) (and (= $t15@0 $t19) (= (ControlFlow 0 447707) 447639))) L5_correct)))
(let ((anon18_Then_correct  (=> $t12@0 (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t17@0 (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t19) (= $t19 5)) (and (= $t19 $t19) (= $t17@0 $t17@0)))) (and (=> (= (ControlFlow 0 447691) 447717) anon19_Then_correct) (=> (= (ControlFlow 0 447691) 447707) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (and (not $t12@0) (= $t14 $t14)) (and (= $t15@0 $t14) (= (ControlFlow 0 447483) 447639))) L5_correct)))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234450| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemVersionbpl.7803:20|
 :skolemid |184|
))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_222140| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemVersionbpl.7812:20|
 :skolemid |185|
...
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_176324_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemVersionbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 447156) 447467)) anon0$1_correct)))
(let ((anon0_correct  (=> (and (and (= (|l#Vec_29362| (|p#$Mutation_236348| $t7)) 0) (= (|l#Vec_29362| (|p#$Mutation_236348| $t20)) 0)) (and (= (|l#Vec_29362| (|p#$Mutation_179974| $t21)) 0) (= (ControlFlow 0 447166) 447156))) inline$$InitEventStore$0$anon0_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 756820) 447166) anon0_correct)))
