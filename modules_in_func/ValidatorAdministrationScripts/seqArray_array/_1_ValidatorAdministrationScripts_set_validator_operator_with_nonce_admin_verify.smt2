...
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t23@1 () T@$Mutation_91999)
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t22@2 () T@$Mutation_91958)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t23@2 () T@$Mutation_91999)
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t21@0 () |T@$1_Option_Option'address'|)
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t22@3 () T@$Mutation_91958)
...
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t22@0 () T@$Mutation_91958)
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t17@0 () Int)
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t22@1 () T@$Mutation_91958)
...
(declare-fun inline$$1_ValidatorConfig_set_operator$0$$t23@0 () T@$Mutation_91999)
...
(assert (not
 (=> (= (ControlFlow 0 0) 183428) (let ((anon14_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 162099) (- 0 186008)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 162099) (- 0 186021)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2) 0))) (and (=> (= (ControlFlow 0 162099) (- 0 186036)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t7)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t7))) (and (=> (= (ControlFlow 0 162099) (- 0 186048)) (not (not (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) _$t3)))) (=> (not (not (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) _$t3))) (and (=> (= (ControlFlow 0 162099) (- 0 186062)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (and (=> (= (ControlFlow 0 162099) (- 0 186073)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (and (=> (= (ControlFlow 0 162099) (- 0 186084)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 162099) (- 0 186096)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) 3))) (and (=> (= (ControlFlow 0 162099) (- 0 186114)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t8))) (and (=> (= (ControlFlow 0 162099) (- 0 186126)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t11)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t11))) (and (=> (= (ControlFlow 0 162099) (- 0 186138)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) 3))) (and (=> (= (ControlFlow 0 162099) (- 0 186156)) (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@1) $t10)))) 0))) (=> (not (= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@1) $t10)))) 0)) (and (=> (= (ControlFlow 0 162099) (- 0 186164)) (= (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@1) $t10)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)) _$t4)) (=> (= (let ((t_ref@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@1) $t10)))
(|Select__T@[Int]Int_| (|v#Vec_19663| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) _$t4) (=> (= (ControlFlow 0 162099) (- 0 186175)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (not (= addr@@0 $t10)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory@1) addr@@0))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0))))))
 :qid |ValidatorAdministrationScriptsbpl.9892:15|
 :skolemid |397|
))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 160441) (- 0 185663)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t7))) (not (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) _$t3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t11))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) 3)))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t7))) (not (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) _$t3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t11))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) 3))) (=> (= (ControlFlow 0 160441) (- 0 185776)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t7)) (= 5 $t12@0))) (and (not (|$IsEqual'vec'u8''| (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) _$t3)) (= 0 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) (= 5 $t12@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t9)) 3)) (= 3 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) $t8)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) (= 5 $t12@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $t11)) 3)) (= 3 $t12@0))) (= 0 $t12@0)) (= 7 $t12@0)) (= 5 $t12@0)) (= 3 $t12@0)))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t12@0 $abort_code@3) (= (ControlFlow 0 162113) 160441))) L3_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct  (=> (and (and (and (not $abort_flag@1) (= inline$$1_ValidatorConfig_set_operator$0$$t23@1 ($Mutation_91999 (|l#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2) (let ((l (|l#Vec_19663| (|p#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2))))
(Vec_19663 (|Store__T@[Int]Int_| (|v#Vec_19663| (|p#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2)) l 1) (+ l 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2))))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t23@2 ($Mutation_91999 (|l#$Mutation_91999| inline$$1_ValidatorConfig_set_operator$0$$t23@1) (|p#$Mutation_91999| inline$$1_ValidatorConfig_set_operator$0$$t23@1) inline$$1_ValidatorConfig_set_operator$0$$t21@0)) (= inline$$1_ValidatorConfig_set_operator$0$$t22@3 ($Mutation_91958 (|l#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2) (|p#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2)) (|v#$Mutation_91999| inline$$1_ValidatorConfig_set_operator$0$$t23@2) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@2))))))) (and (and (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_91251 (|Store__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@3)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@3)) (|v#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@3)))) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory@0)))) (and (=> (= (ControlFlow 0 161726) 162113) anon14_Then_correct) (=> (= (ControlFlow 0 161726) 162099) anon14_Else_correct)))))
(let ((inline$$1_ValidatorConfig_set_operator$0$L5_correct  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 inline$$1_ValidatorConfig_set_operator$0$$t13@1) (= $1_ValidatorConfig_ValidatorConfig_$memory@1 $1_ValidatorConfig_ValidatorConfig_$memory)) (and (=> (= (ControlFlow 0 161443) 162113) anon14_Then_correct) (=> (= (ControlFlow 0 161443) 162099) anon14_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 $abort_code@2) (= (ControlFlow 0 161740) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= inline$$1_ValidatorConfig_set_operator$0$$t22@2 inline$$1_ValidatorConfig_set_operator$0$$t22@0)) (and (=> (= (ControlFlow 0 161792) 161740) inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct) (=> (= (ControlFlow 0 161792) 161726) inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0)) (= (ControlFlow 0 161790) 161792)) inline$$1_ValidatorConfig_set_operator$0$anon23_Then$1_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0) (=> (and (and (= inline$$1_ValidatorConfig_set_operator$0$$t22@1 ($Mutation_91958 ($Global inline$$1_ValidatorConfig_set_operator$0$$t17@0) (Vec_19663 (MapConstVec_11252 DefaultVecElem_11252) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0))) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_ValidatorConfig_set_operator$0$$t22@2 inline$$1_ValidatorConfig_set_operator$0$$t22@1))) (and (=> (= (ControlFlow 0 161672) 161740) inline$$1_ValidatorConfig_set_operator$0$anon24_Then_correct) (=> (= (ControlFlow 0 161672) 161726) inline$$1_ValidatorConfig_set_operator$0$anon24_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon22_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| inline$$1_ValidatorConfig_set_operator$0$$t21@0) (<= (|l#Vec_19663| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_set_operator$0$$t21@0)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| inline$$1_ValidatorConfig_set_operator$0$$t21@0) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_19663 (|Store__T@[Int]Int_| (MapConstVec_11252 DefaultVecElem_11252) 0 _$t4) 1))))) (and (=> (= (ControlFlow 0 161650) 161790) inline$$1_ValidatorConfig_set_operator$0$anon23_Then_correct) (=> (= (ControlFlow 0 161650) 161672) inline$$1_ValidatorConfig_set_operator$0$anon23_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon22_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 inline$$1_ValidatorConfig_set_operator$0$$t20@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= (ControlFlow 0 161622) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon21_Else_correct  (=> (and (not $abort_flag@0) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 5)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t20@0 inline$$1_ValidatorConfig_set_operator$0$$t20@0) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 161606) 161650) inline$$1_ValidatorConfig_set_operator$0$anon22_Then_correct) (=> (= (ControlFlow 0 161606) 161622) inline$$1_ValidatorConfig_set_operator$0$anon22_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon21_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 $abort_code@1) (= (ControlFlow 0 161806) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 inline$$1_ValidatorConfig_set_operator$0$$t17@0) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) inline$$1_ValidatorConfig_set_operator$0$$t17@0)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 161564) 161806) inline$$1_ValidatorConfig_set_operator$0$anon21_Then_correct) (=> (= (ControlFlow 0 161564) 161606) inline$$1_ValidatorConfig_set_operator$0$anon21_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon20_Then_correct  (=> inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (=> (and (and (|$IsValid'address'| inline$$1_ValidatorConfig_set_operator$0$$t17@0) (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 (|$addr#$signer| _$t1))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t17@0 inline$$1_ValidatorConfig_set_operator$0$$t17@0) (= (ControlFlow 0 161570) 161564))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon20_Else_correct  (=> (and (and (not inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1) (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 inline$$1_ValidatorConfig_set_operator$0$$t16@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= (ControlFlow 0 161437) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon19_Else_correct  (=> (and (not $abort_flag@0) (|$IsValid'u64'| 3)) (=> (and (and (|$IsValid'u64'| inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 7)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t16@0 inline$$1_ValidatorConfig_set_operator$0$$t16@0) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1))) (and (=> (= (ControlFlow 0 161421) 161570) inline$$1_ValidatorConfig_set_operator$0$anon20_Then_correct) (=> (= (ControlFlow 0 161421) 161437) inline$$1_ValidatorConfig_set_operator$0$anon20_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 $abort_code@1) (= (ControlFlow 0 161820) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct)))
(let ((inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct  (=> (= _$t4 _$t4) (=> (and (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) (= inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1 inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$$t1@1)) (and (=> (= (ControlFlow 0 161375) 161820) inline$$1_ValidatorConfig_set_operator$0$anon19_Then_correct) (=> (= (ControlFlow 0 161375) 161421) inline$$1_ValidatorConfig_set_operator$0$anon19_Else_correct))))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon18_Else_correct  (=> (and (not inline$$1_ValidatorConfig_set_operator$0$$t12@0) (= (ControlFlow 0 161381) 161375)) inline$$1_ValidatorOperatorConfig_has_validator_operator_config$0$anon0_correct)))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon18_Then_correct  (=> inline$$1_ValidatorConfig_set_operator$0$$t12@0 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) (= 5 inline$$1_ValidatorConfig_set_operator$0$$t13@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) 3)) (= 3 inline$$1_ValidatorConfig_set_operator$0$$t13@0))) (= inline$$1_ValidatorConfig_set_operator$0$$t13@0 inline$$1_ValidatorConfig_set_operator$0$$t13@0)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t13@1 inline$$1_ValidatorConfig_set_operator$0$$t13@0) (= (ControlFlow 0 161872) 161443))) inline$$1_ValidatorConfig_set_operator$0$L5_correct))))
(let ((inline$$1_ValidatorConfig_set_operator$0$anon0_correct  (=> (and (= (|l#Vec_19663| (|p#$Mutation_91958| inline$$1_ValidatorConfig_set_operator$0$$t22@0)) 0) (= (|l#Vec_19663| (|p#$Mutation_91999| inline$$1_ValidatorConfig_set_operator$0$$t23@0)) 0)) (=> (and (and (and (= inline$$1_ValidatorConfig_set_operator$0$$t7@0 (|$addr#$signer| _$t1)) (= inline$$1_ValidatorConfig_set_operator$0$$t8@0 (|$addr#$signer| _$t1))) (and (= inline$$1_ValidatorConfig_set_operator$0$$t9@0 (|$addr#$signer| _$t1)) (= inline$$1_ValidatorConfig_set_operator$0$$t10@0 (|$addr#$signer| _$t1)))) (and (and (= _$t1 _$t1) (= _$t4 _$t4)) (and (= inline$$1_ValidatorConfig_set_operator$0$$t11@0 (|$addr#$signer| _$t1)) (= inline$$1_ValidatorConfig_set_operator$0$$t12@0  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) inline$$1_ValidatorConfig_set_operator$0$$t11@0)) 3))))))) (and (=> (= (ControlFlow 0 161270) 161872) inline$$1_ValidatorConfig_set_operator$0$anon18_Then_correct) (=> (= (ControlFlow 0 161270) 161381) inline$$1_ValidatorConfig_set_operator$0$anon18_Else_correct))))))
(let ((anon13_Then_correct  (=> (and $t15@0 (= $t17 (|$addr#$signer| _$t1))) (=> (and (and (= $t18 (|$addr#$signer| _$t1)) (= $t19 (|$addr#$signer| _$t1))) (and (= $t20 (|$addr#$signer| _$t1)) (= (ControlFlow 0 161876) 161270))) inline$$1_ValidatorConfig_set_operator$0$anon0_correct))))
(let ((anon13_Else_correct  (=> (not $t15@0) (=> (and (and (|$IsValid'u64'| 0) (= 0 0)) (and (= $t12@0 0) (= (ControlFlow 0 160053) 160441))) L3_correct))))
(let ((anon12_Else_correct  (=> (not $t14) (=> (and (and (|$IsValid'vec'u8''| $t13) (|$IsEqual'vec'u8''| $t13 (|$human_name#$1_ValidatorOperatorConfig_ValidatorOperatorConfig| (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)))) (and (= $t15@0 (|$IsEqual'vec'u8''| $t13 _$t3)) (= $t15@0 $t15@0))) (and (=> (= (ControlFlow 0 160031) 161876) anon13_Then_correct) (=> (= (ControlFlow 0 160031) 160053) anon13_Else_correct))))))
(let ((anon12_Then_correct  (=> $t14 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)) (= 5 $t12)) (= $t12 $t12)) (and (= $t12@0 $t12) (= (ControlFlow 0 162141) 160441))) L3_correct))))
(let ((anon11_Else_correct  (=> (and (not $abort_flag@0) (= $t14  (not (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) _$t4)))) (and (=> (= (ControlFlow 0 159999) 162141) anon12_Then_correct) (=> (= (ControlFlow 0 159999) 160031) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t12@0 $abort_code@1) (= (ControlFlow 0 162155) 160441))) L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 159923) 162155) anon11_Then_correct) (=> (= (ControlFlow 0 159923) 159999) anon11_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 159917) 159923))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 159973) 159923))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 159929) 162155) anon11_Then_correct) (=> (= (ControlFlow 0 159929) 159999) anon11_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t2))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 159901) 159929) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 159901) 159917) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_93107 (|Store__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 159835) 159901))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_93107 (|Store__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 159943) 159901))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 159821) 159943) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 159821) 159835) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t2 _$t2) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 159815) 159973) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 159815) 159821) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@1)) 0)) (= addr@@1 173345816)))
 :qid |ValidatorAdministrationScriptsbpl.9515:20|
 :skolemid |367|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@2)) 1)) (= addr@@2 186537453)))
 :qid |ValidatorAdministrationScriptsbpl.9523:20|
 :skolemid |368|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) 186537453)) 1)))) (and (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@3)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9531:20|
 :skolemid |369|
)) (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@4)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9535:20|
 :skolemid |370|
)))) (and (and (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@5)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9539:20|
 :skolemid |371|
)) (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@6)) 2))))))
 :qid |ValidatorAdministrationScriptsbpl.9543:20|
 :skolemid |372|
))) (and (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@7)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9547:20|
 :skolemid |373|
)) (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@8)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9551:20|
 :skolemid |374|
))))) (=> (and (and (and (and (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@9)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9555:20|
 :skolemid |375|
)) (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@10) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@10) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@10)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.9559:20|
 :skolemid |376|
))) (and (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@11)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9563:20|
 :skolemid |377|
)) (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@12) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@12)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9567:20|
 :skolemid |378|
)))) (and (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13) (not (= (|l#Vec_56094| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@13)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@13)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9571:20|
 :skolemid |379|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (let (($range_0 ($Range 0 (|l#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@14 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@14))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@15 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_56286| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@15 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_93557| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@15))))) i1)))) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9583:151|
 :skolemid |380|
)))))) (and (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106591| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9588:20|
 :skolemid |381|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_108430| $1_DiemAccount_DiemAccount_$memory) addr@@16) (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@16)))
 :qid |ValidatorAdministrationScriptsbpl.9592:20|
 :skolemid |382|
))) (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106018| $1_VASPDomain_VASPDomainManager_$memory) addr@@17)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@17)) 1))))
 :qid |ValidatorAdministrationScriptsbpl.9596:20|
 :skolemid |383|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106135| $1_VASPDomain_VASPDomains_$memory) addr@@18)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@18)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.9600:20|
 :skolemid |384|
)))) (and (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_109349| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@19) (|Select__T@[Int]Bool_| (|domain#$Memory_109440| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@19)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@19)) 2)))))
 :qid |ValidatorAdministrationScriptsbpl.9604:20|
 :skolemid |385|
)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_107665| $1_DesignatedDealer_Dealer_$memory) addr@@20)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@20)) 2))))
 :qid |ValidatorAdministrationScriptsbpl.9608:20|
 :skolemid |386|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106591| $1_DualAttestation_Credential_$memory) addr@@21)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@21)) 5)))))
 :qid |ValidatorAdministrationScriptsbpl.9612:20|
 :skolemid |387|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) addr@@22)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@22)) 1)))))
 :qid |ValidatorAdministrationScriptsbpl.9616:20|
 :skolemid |388|
)))))) (=> (and (and (and (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_91251| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |ValidatorAdministrationScriptsbpl.9620:20|
 :skolemid |389|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@24)) 4))))
 :qid |ValidatorAdministrationScriptsbpl.9624:20|
 :skolemid |390|
))) (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106232| $1_VASP_ParentVASP_$memory) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@25)) 5))))
 :qid |ValidatorAdministrationScriptsbpl.9628:20|
 :skolemid |391|
)) (forall ((addr@@26 Int) ) (!  (=> (|$IsValid'address'| addr@@26) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106168| $1_VASP_ChildVASP_$memory) addr@@26)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@26) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@26)) 6))))
 :qid |ValidatorAdministrationScriptsbpl.9632:20|
 :skolemid |392|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t1)) ($1_Signer_is_txn_signer _$t1)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t1))) (and (and (|$IsValid'u64'| _$t2) (|$IsValid'vec'u8''| _$t3)) (and (|$IsValid'address'| _$t4) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |ValidatorAdministrationScriptsbpl.9650:20|
 :skolemid |393|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) $a_0))
)))))) (and (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@0)))
(|$IsValid'$1_ValidatorOperatorConfig_ValidatorOperatorConfig'| $rsc@@0))
 :qid |ValidatorAdministrationScriptsbpl.9654:20|
 :skolemid |394|
 :pattern ( (|Select__T@[Int]$1_ValidatorOperatorConfig_ValidatorOperatorConfig_| (|contents#$Memory_90092| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) $a_0@@0))
 ...
 :qid |ValidatorAdministrationScriptsbpl.9658:20|
 :skolemid |395|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@2))
 :qid |ValidatorAdministrationScriptsbpl.9662:20|
 :skolemid |396|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_93107| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@2))
)) (= $t7 (|$addr#$signer| _$t1)))) (and (and (= $t8 (|$addr#$signer| _$t1)) (= $t9 (|$addr#$signer| _$t1))) (and (= $t10 (|$addr#$signer| _$t1)) (= $t11 (|$addr#$signer| _$t1))))) (and (and (and (let ((addr@@27 (|$addr#$signer| _$t1)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_89516| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_108430| $1_DiemAccount_DiemAccount_$memory) addr@@27)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) addr@@27) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_107918| $1_AccountFreezing_FreezingBit_$memory) addr@@27)))))) (let ((addr@@28 (|$addr#$signer| _$t0)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_89697| $1_Roles_RoleId_$memory) addr@@28) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_89697| $1_Roles_RoleId_$memory) addr@@28)) 0)))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= _$t4 _$t4) (= (ControlFlow 0 159977) 159815)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_56001_| (|streams#$EventStore| $es) handle@@1)))
 (and (= (|l#Multiset_56001| stream@@0) 0) (forall ((v@@42 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_56001| stream@@0) v@@42) 0)
 :qid |ValidatorAdministrationScriptsbpl.159:13|
 :skolemid |4|
))))
 :qid |ValidatorAdministrationScriptsbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 158473) 159977)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 183428) 158473) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
