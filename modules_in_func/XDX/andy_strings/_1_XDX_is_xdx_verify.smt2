...
(assert (not
 (=> (= (ControlFlow 0 0) 532488) (let ((L5_correct@@6  (and (=> (= (ControlFlow 0 407737) (- 0 533082)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 407737) (- 0 533092)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct@@2  (=> $t6@@8 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@5)) (= $t2@@5 $t2@@5)) (and (= $t2@0 $t2@@5) (= (ControlFlow 0 407697) 407737))) L5_correct@@6))))
(let ((anon13_Then_correct@@2  (=> $t4@@5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t2@@5)) (= $t2@@5 $t2@@5)) (and (= $t2@0 $t2@@5) (= (ControlFlow 0 407763) 407737))) L5_correct@@6))))
(let ((L3_correct@@0  (=> (= $t0@0@@2 $t0@0@@2) (and (=> (= (ControlFlow 0 407595) (- 0 533039)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 407595) (- 0 533054)) (= $t0@0@@2  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct@@2  (=> (not $t6@@8) (=> (and (|$IsValid'vec'u8''| $t5@@5) (= $t5@@5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (= $t3@@5 $t5@@5)) (= $t7@0 $t7@0)) (and (= $t0@0@@2 $t7@0) (= (ControlFlow 0 407671) 407595))) L3_correct@@0)))))
(let ((anon13_Else_correct@@2  (=> (and (and (not $t4@@5) (|$IsValid'vec'u8''| $t3@@5)) (and (= $t3@@5 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t6@@8  (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 407637) 407697) anon14_Then_correct@@2) (=> (= (ControlFlow 0 407637) 407671) anon14_Else_correct@@2)))))
(let ((anon12_Then_correct@@2  (=> (and |inline$$1_Diem_is_currency'#0'$0$$t1@1| (= $t4@@5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 407609) 407763) anon13_Then_correct@@2) (=> (= (ControlFlow 0 407609) 407637) anon13_Else_correct@@2)))))
(let ((anon12_Else_correct@@2  (=> (and (and (not |inline$$1_Diem_is_currency'#0'$0$$t1@1|) (= false false)) (and (= $t0@0@@2 false) (= (ControlFlow 0 407555) 407595))) L3_correct@@0)))
(let ((anon11_Else_correct@@2  (=> (not false) (and (=> (= (ControlFlow 0 407535) 407609) anon12_Then_correct@@2) (=> (= (ControlFlow 0 407535) 407555) anon12_Else_correct@@2)))))
(let ((anon11_Then_correct@@2 true))
(let ((|inline$$1_Diem_is_currency'#0'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'#0'$0$$t1@1| |inline$$1_Diem_is_currency'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 407521) 407777) anon11_Then_correct@@2) (=> (= (ControlFlow 0 407521) 407535) anon11_Else_correct@@2))))))
(let ((anon0$1_correct@@25  (=> (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@93 Int) (mint_cap_owner2@@93 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@93) (=> (|$IsValid'address'| mint_cap_owner2@@93) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@93) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@93)) (= mint_cap_owner1@@93 mint_cap_owner2@@93))))
 :qid |XDXbpl.27814:104|
 :skolemid |975|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@94 Int) (mint_cap_owner2@@94 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@94) (=> (|$IsValid'address'| mint_cap_owner2@@94) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@94) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@94)) (= mint_cap_owner1@@94 mint_cap_owner2@@94))))
 :qid |XDXbpl.27818:88|
 :skolemid |976|
)))) (=> (and (and (and (forall ((addr3@@93 Int) ) (!  (=> (|$IsValid'address'| addr3@@93) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@93) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |XDXbpl.27822:20|
 :skolemid |977|
)) (forall ((addr3@@94 Int) ) (!  (=> (|$IsValid'address'| addr3@@94) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@94) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.27826:20|
 :skolemid |978|
))) (and (forall ((addr@@732 Int) ) (!  (=> (|$IsValid'address'| addr@@732) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@732) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.27830:20|
 :skolemid |979|
)) (forall ((addr@@733 Int) ) (!  (=> (|$IsValid'address'| addr@@733) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@733) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.27834:20|
 :skolemid |980|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@63 Int) ) (! (let (($rsc@@63 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@63)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''| $rsc@@63) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@63)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@63) 10000000000))))
 :qid |XDXbpl.27842:20|
 :skolemid |981|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@63))
))) (and (forall (($a_0@@64 Int) ) (! (let (($rsc@@64 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@64)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@64) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@64)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@64) 10000000000))))
 :qid |XDXbpl.27846:20|
 :skolemid |982|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@64))
)) (= (ControlFlow 0 407527) 407521)))) |inline$$1_Diem_is_currency'#0'$0$anon0_correct|))))
(let ((inline$$InitEventStore$0$anon0_correct@@25  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@72 T@$1_Event_EventHandle) ) (! (let ((stream@@86 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@72)))
 (and (= (|l#Multiset_131870| stream@@86) 0) (forall ((v@@112 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@86) v@@112) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 407154) 407527)) anon0$1_correct@@25)))
(let ((anon0_correct@@25  (=> (= (ControlFlow 0 532488) 407154) inline$$InitEventStore$0$anon0_correct@@25)))
anon0_correct@@25)))))))))))))))
))
(check-sat)
(pop 1)
