...
(assert (not
 (=> (= (ControlFlow 0 0) 510661) (let ((L2_correct@@1  (and (=> (= (ControlFlow 0 381610) (- 0 512552)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) 1))) (not (= (|$addr#$signer| _$t0@@17) 186537453)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) 1))) (not (= (|$addr#$signer| _$t0@@17) 186537453))) (=> (= (ControlFlow 0 381610) (- 0 512592)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6@0@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) (= 5 $t6@0@@1))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) 1)) (= 3 $t6@0@@1))) (and (not (= (|$addr#$signer| _$t0@@17) 186537453)) (= 2 $t6@0@@1))))))))
(let ((anon14_Then_correct@@1  (=> (and (and $abort_flag@0@@17 (= $abort_code@1@@17 $abort_code@1@@17)) (and (= $t6@0@@1 $abort_code@1@@17) (= (ControlFlow 0 381482) 381610))) L2_correct@@1)))
(let ((anon12_Then_correct@@1  (=> $t7@@5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t6@@4)) (= $t6@@4 $t6@@4)) (and (= $t6@0@@1 $t6@@4) (= (ControlFlow 0 381688) 381610))) L2_correct@@1))))
(let ((anon11_Then_correct@@1  (=> $t5@@1 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t4@@1)) (= 5 $t6@@4)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t4@@1)) 1)) (= 3 $t6@@4))) (and (not (= (|$addr#$signer| _$t0@@17) 186537453)) (= 2 $t6@@4))) (= $t6@@4 $t6@@4)) (and (= $t6@0@@1 $t6@@4) (= (ControlFlow 0 381760) 381610))) L2_correct@@1))))
(let ((anon14_Else_correct@@1  (=> (and (not $abort_flag@0@@17) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0@@3| (|v#$Mutation_192630| $t9@1@@1))) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0@@3| |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0@@3|) (= $t10@0@@4 ($Mutation_73044 (|l#$Mutation_192630| $t9@1@@1) (seq.++ (|p#$Mutation_192630| $t9@1@@1) (seq.unit 7)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1))))) (and (= $t10@1@@1 ($Mutation_73044 (|l#$Mutation_73044| $t10@0@@4) (|p#$Mutation_73044| $t10@0@@4) _$t1@@17)) (= $t9@2@@1 ($Mutation_192630 (|l#$Mutation_192630| $t9@1@@1) (|p#$Mutation_192630| $t9@1@@1) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|v#$Mutation_73044| $t10@1@@1) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@1@@1))))))) (and (=> (= (ControlFlow 0 381468) (- 0 511979)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@2@@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@2@@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@2@@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_192630| $t9@2@@1)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4| ($Memory_166410 (|Store__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_192630| $t9@2@@1)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_192630| $t9@2@@1)) (|v#$Mutation_192630| $t9@2@@1)))) (and (=> (= (ControlFlow 0 381468) (- 0 512027)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)))) (forall ((mint_cap_owner1@@80 Int) (mint_cap_owner2@@80 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@80) (=> (|$IsValid'address'| mint_cap_owner2@@80) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@80) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@80)) (= mint_cap_owner1@@80 mint_cap_owner2@@80))))
 :qid |XDXbpl.22091:99|
 :skolemid |686|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)))) (forall ((mint_cap_owner1@@81 Int) (mint_cap_owner2@@81 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@81) (=> (|$IsValid'address'| mint_cap_owner2@@81) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@81) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@81)) (= mint_cap_owner1@@81 mint_cap_owner2@@81))))
 :qid |XDXbpl.22091:99|
 :skolemid |686|
))) (and (=> (= (ControlFlow 0 381468) (- 0 512072)) (forall ((addr3@@80 Int) ) (!  (=> (|$IsValid'address'| addr3@@80) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@80) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816))))))
 :qid |XDXbpl.22097:15|
 :skolemid |687|
))) (=> (forall ((addr3@@81 Int) ) (!  (=> (|$IsValid'address'| addr3@@81) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@81) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816))))))
 :qid |XDXbpl.22097:15|
 :skolemid |687|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512095)) (forall ((addr@@434 Int) ) (!  (=> (|$IsValid'address'| addr@@434) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@434) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)))
 :qid |XDXbpl.22103:15|
 :skolemid |688|
))) (=> (forall ((addr@@435 Int) ) (!  (=> (|$IsValid'address'| addr@@435) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@435) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)))
 :qid |XDXbpl.22103:15|
 :skolemid |688|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512118)) (forall ((dr_addr@@63 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@63) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr@@63) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) dr_addr@@63)))
 :qid |XDXbpl.22109:15|
 :skolemid |689|
))) (=> (forall ((dr_addr@@64 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@64) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr@@64) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) dr_addr@@64)))
 :qid |XDXbpl.22109:15|
 :skolemid |689|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512142)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a@@191 Int) ) (!  (and (|$IsValid'address'| a@@191) (and ($1_Signer_is_txn_signer_addr a@@191) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@191) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@191)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a@@192 Int) ) (!  (and (|$IsValid'address'| a@@192) (and ($1_Signer_is_txn_signer_addr a@@192) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@192) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@192)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 381468) (- 0 512166)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a@@193 Int) ) (!  (and (|$IsValid'address'| a@@193) (and ($1_Signer_is_txn_signer_addr a@@193) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@193) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@193)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a@@194 Int) ) (!  (and (|$IsValid'address'| a@@194) (and ($1_Signer_is_txn_signer_addr a@@194) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@194) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@194)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 381468) (- 0 512190)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (exists ((a@@195 Int) ) (!  (and (|$IsValid'address'| a@@195) (and ($1_Signer_is_txn_signer_addr a@@195) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@195) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@195)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (exists ((a@@196 Int) ) (!  (and (|$IsValid'address'| a@@196) (and ($1_Signer_is_txn_signer_addr a@@196) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@196) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@196)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (and (=> (= (ControlFlow 0 381468) (- 0 512209)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (and (=> (= (ControlFlow 0 381468) (- 0 512224)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 381468) (- 0 512234)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1))) (and (=> (= (ControlFlow 0 381468) (- 0 512246)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t3@@1)) 1))) (and (=> (= (ControlFlow 0 381468) (- 0 512264)) (not (not (= (|$addr#$signer| _$t0@@17) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@17) 186537453))) (and (=> (= (ControlFlow 0 381468) (- 0 512278)) (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) _$t1@@17)) (=> (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) _$t1@@17) (and (=> (= (ControlFlow 0 381468) (- 0 512289)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 381468) (- 0 512309)) (forall ((addr@@436 Int) ) (!  (=> (|$IsValid'address'| addr@@436) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@436)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@436))))
 :qid |XDXbpl.22172:15|
 :skolemid |690|
))) (=> (forall ((addr@@437 Int) ) (!  (=> (|$IsValid'address'| addr@@437) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@437)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@437))))
 :qid |XDXbpl.22172:15|
 :skolemid |690|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512338)) (forall ((addr@@438 Int) ) (!  (=> (|$IsValid'address'| addr@@438) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@438) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@438)))
 :qid |XDXbpl.22177:15|
 :skolemid |691|
))) (=> (forall ((addr@@439 Int) ) (!  (=> (|$IsValid'address'| addr@@439) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@439) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@439)))
 :qid |XDXbpl.22177:15|
 :skolemid |691|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512363)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 381468) (- 0 512383)) (forall ((addr@@440 Int) ) (!  (=> (|$IsValid'address'| addr@@440) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@440)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@440))))
 :qid |XDXbpl.22187:15|
 :skolemid |692|
))) (=> (forall ((addr@@441 Int) ) (!  (=> (|$IsValid'address'| addr@@441) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@441)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@441))))
 :qid |XDXbpl.22187:15|
 :skolemid |692|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512412)) (forall ((addr@@442 Int) ) (!  (=> (|$IsValid'address'| addr@@442) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@442) (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@442)))
 :qid |XDXbpl.22192:15|
 :skolemid |693|
))) (=> (forall ((addr@@443 Int) ) (!  (=> (|$IsValid'address'| addr@@443) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@443) (|Select__T@[Int]Bool_| (|domain#$Memory_177208| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@443)))
 :qid |XDXbpl.22192:15|
 :skolemid |693|
)) (and (=> (= (ControlFlow 0 381468) (- 0 512437)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 381468) (- 0 512457)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@4|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 381468) (- 0 512477)) (forall ((addr@@444 Int) ) (!  (=> (|$IsValid'address'| addr@@444) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@444) (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@444))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@444))))
 :qid |XDXbpl.22207:15|
 :skolemid |694|
))) (=> (forall ((addr@@445 Int) ) (!  (=> (|$IsValid'address'| addr@@445) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@445) (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@445))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@445))))
 :qid |XDXbpl.22207:15|
 :skolemid |694|
)) (=> (= (ControlFlow 0 381468) (- 0 512513)) (forall ((addr@@446 Int) ) (!  (=> (|$IsValid'address'| addr@@446) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@446) (|Select__T@[Int]Bool_| (|domain#$Memory_182696| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@446)))
 :qid |XDXbpl.22212:15|
 :skolemid |695|
))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon13_Then$1_correct@@1  (=> (= $t9@1@@1 $t9@@11) (=> (and (= $abort_flag@0@@17 true) (= $abort_code@1@@17 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 381662) 381482) anon14_Then_correct@@1) (=> (= (ControlFlow 0 381662) 381468) anon14_Else_correct@@1))))))
(let ((anon13_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 381660) 381662)) anon13_Then$1_correct@@1)))
(let ((anon13_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t9@0@@1 ($Mutation_192630 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t9@1@@1 $t9@0@@1)) (and (= $abort_flag@0@@17 false) (= $abort_code@1@@17 $abort_code@0@@17))) (and (=> (= (ControlFlow 0 380848) 381482) anon14_Then_correct@@1) (=> (= (ControlFlow 0 380848) 381468) anon14_Else_correct@@1))))))
(let ((anon12_Else_correct@@1  (=> (and (not $t7@@5) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 380826) 381660) anon13_Then_correct@@1) (=> (= (ControlFlow 0 380826) 380848) anon13_Else_correct@@1)))))
(let ((anon11_Else_correct@@1  (=> (and (not $t5@@1) (= $t7@@5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 380812) 381688) anon12_Then_correct@@1) (=> (= (ControlFlow 0 380812) 380826) anon12_Else_correct@@1)))))
(let ((anon0$1_correct@@17  (=> (and (and (and (and (and (and (forall ((addr@@447 Int) ) (!  (=> (|$IsValid'address'| addr@@447) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@447) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@447)) 0)) (= addr@@447 173345816)))
 :qid |XDXbpl.21811:20|
 :skolemid |655|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@448 Int) ) (!  (=> (|$IsValid'address'| addr@@448) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@448) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@448)) 1)) (= addr@@448 186537453)))
 :qid |XDXbpl.21819:20|
 :skolemid |656|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 186537453)) 1))))) (and (and (forall ((addr@@449 Int) ) (!  (=> (|$IsValid'address'| addr@@449) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@449)) 2))))))
 :qid |XDXbpl.21827:20|
 :skolemid |657|
)) (forall ((addr@@450 Int) ) (!  (=> (|$IsValid'address'| addr@@450) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@450)) 2))))))
 :qid |XDXbpl.21831:20|
 :skolemid |658|
))) (and (forall ((addr@@451 Int) ) (!  (=> (|$IsValid'address'| addr@@451) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@451)) 2))))))
 :qid |XDXbpl.21835:20|
 :skolemid |659|
)) (forall ((addr@@452 Int) ) (!  (=> (|$IsValid'address'| addr@@452) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@452)) 2))))))
 :qid |XDXbpl.21839:20|
 :skolemid |660|
))))) (and (and (and (forall ((addr@@453 Int) ) (!  (=> (|$IsValid'address'| addr@@453) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@453)) 2)))))
 :qid |XDXbpl.21843:20|
 :skolemid |661|
)) (forall ((addr@@454 Int) ) (!  (=> (|$IsValid'address'| addr@@454) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@454)) 2)))))
 :qid |XDXbpl.21847:20|
 :skolemid |662|
))) (and (forall ((addr@@455 Int) ) (!  (=> (|$IsValid'address'| addr@@455) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@455)) 2)))))
 :qid |XDXbpl.21851:20|
 :skolemid |663|
)) (forall ((addr@@456 Int) ) (!  (=> (|$IsValid'address'| addr@@456) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@456) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@456) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@456)) 4))))
 :qid |XDXbpl.21855:20|
 :skolemid |664|
)))) (and (and (forall ((addr@@457 Int) ) (!  (=> (|$IsValid'address'| addr@@457) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@457) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@457) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@457)) 3))))
 :qid |XDXbpl.21859:20|
 :skolemid |665|
)) (forall ((addr@@458 Int) ) (!  (=> (|$IsValid'address'| addr@@458) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@458) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@458) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@458)) 3))))
 :qid |XDXbpl.21863:20|
 :skolemid |666|
))) (and (forall ((addr@@459 Int) ) (!  (=> (|$IsValid'address'| addr@@459) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@459) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@459)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@459) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@459)) 3))))
 :qid |XDXbpl.21867:20|
 :skolemid |667|
)) (let (($range_0@@25 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@460 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@460))))))))
(forall (($i_1@@25 Int) ) (!  (=> ($InRange $range_0@@25 $i_1@@25) (let ((i1@@4 $i_1@@25))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@461 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@461)))) i1@@4))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@461 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@461)))) i1@@4)))) 3))))
 :qid |XDXbpl.21871:151|
 :skolemid |668|
))))))) (and (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@82 Int) (mint_cap_owner2@@82 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@82) (=> (|$IsValid'address'| mint_cap_owner2@@82) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@82) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@82)) (= mint_cap_owner1@@82 mint_cap_owner2@@82))))
 :qid |XDXbpl.21876:104|
 :skolemid |669|
))) (forall ((addr3@@82 Int) ) (!  (=> (|$IsValid'address'| addr3@@82) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@82) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |XDXbpl.21880:20|
 :skolemid |670|
))) (and (forall ((addr@@462 Int) ) (!  (=> (|$IsValid'address'| addr@@462) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@462) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.21884:20|
 :skolemid |671|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (forall ((addr1@@7 Int) ) (!  (=> (|$IsValid'address'| addr1@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr1@@7) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@7)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@7)) 2)))))
 :qid |XDXbpl.21892:20|
 :skolemid |672|
)) (forall ((addr@@463 Int) ) (!  (=> (|$IsValid'address'| addr@@463) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234919| $1_DiemAccount_DiemAccount_$memory) addr@@463) (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@463)))
 :qid |XDXbpl.21896:20|
 :skolemid |673|
))) (and (forall ((addr@@464 Int) ) (!  (=> (|$IsValid'address'| addr@@464) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235019| $1_VASPDomain_VASPDomainManager_$memory) addr@@464)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@464) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@464)) 1))))
 :qid |XDXbpl.21900:20|
 :skolemid |674|
)) (forall ((addr@@465 Int) ) (!  (=> (|$IsValid'address'| addr@@465) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235104| $1_VASPDomain_VASPDomains_$memory) addr@@465)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@465) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@465)) 5))))
 :qid |XDXbpl.21904:20|
 :skolemid |675|
))))) (and (and (and (forall ((addr@@466 Int) ) (!  (=> (|$IsValid'address'| addr@@466) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_235191| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@466) (|Select__T@[Int]Bool_| (|domain#$Memory_235251| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@466)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@466)) 2)))))
 :qid |XDXbpl.21908:20|
 :skolemid |676|
)) (forall ((addr@@467 Int) ) (!  (=> (|$IsValid'address'| addr@@467) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235336| $1_DesignatedDealer_Dealer_$memory) addr@@467)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@467) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@467)) 2))))
 :qid |XDXbpl.21912:20|
 :skolemid |677|
))) (and (forall ((addr@@468 Int) ) (!  (=> (|$IsValid'address'| addr@@468) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr@@468)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@468) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@468)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@468) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@468)) 5)))))
 :qid |XDXbpl.21916:20|
 :skolemid |678|
)) (forall ((addr@@469 Int) ) (!  (=> (|$IsValid'address'| addr@@469) (= (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) addr@@469)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@469) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@469)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@469) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@469)) 1)))))
 :qid |XDXbpl.21920:20|
 :skolemid |679|
)))) (and (and (forall ((addr@@470 Int) ) (!  (=> (|$IsValid'address'| addr@@470) (= (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@470)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@470) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@470)) 3))))
 :qid |XDXbpl.21924:20|
 :skolemid |680|
)) (forall ((addr@@471 Int) ) (!  (=> (|$IsValid'address'| addr@@471) (= (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@471)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@471) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@471)) 4))))
 :qid |XDXbpl.21928:20|
 :skolemid |681|
))) (and (forall ((addr@@472 Int) ) (!  (=> (|$IsValid'address'| addr@@472) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235591| $1_VASP_ParentVASP_$memory) addr@@472)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@472) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@472)) 5))))
 :qid |XDXbpl.21932:20|
 :skolemid |682|
)) (forall ((addr@@473 Int) ) (!  (=> (|$IsValid'address'| addr@@473) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235691| $1_VASP_ChildVASP_$memory) addr@@473)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@473) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@473)) 6))))
 :qid |XDXbpl.21936:20|
 :skolemid |683|
))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@17)) ($1_Signer_is_txn_signer _$t0@@17)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@17))) (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@40)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@40))
 :qid |XDXbpl.21945:20|
 :skolemid |684|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@40))
))) (and (forall (($a_0@@41 Int) ) (! (let (($rsc@@41 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@41)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''| $rsc@@41) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@41)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@41) 10000000000))))
 :qid |XDXbpl.21949:20|
 :skolemid |685|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@41))
)) (= $t3@@1 (|$addr#$signer| _$t0@@17)))) (and (and (= _$t0@@17 _$t0@@17) (= _$t1@@17 _$t1@@17)) (and (= $t4@@1 (|$addr#$signer| _$t0@@17)) (= $t5@@1  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t4@@1)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t4@@1)) 1))) (not (= (|$addr#$signer| _$t0@@17) 186537453)))))))) (and (=> (= (ControlFlow 0 380794) 381760) anon11_Then_correct@@1) (=> (= (ControlFlow 0 380794) 380812) anon11_Else_correct@@1)))))
(let ((inline$$InitEventStore$0$anon0_correct@@17  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@55 T@$1_Event_EventHandle) ) (! (let ((stream@@66 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@55)))
 (and (= (|l#Multiset_131870| stream@@66) 0) (forall ((v@@95 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@66) v@@95) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 379831) 380794)) anon0$1_correct@@17)))
(let ((anon0_correct@@17  (=> (and (and (= (seq.len (|p#$Mutation_192630| $t2@@1)) 0) (= (seq.len (|p#$Mutation_192630| $t9@@11)) 0)) (and (= (seq.len (|p#$Mutation_73044| $t10@@14)) 0) (= (ControlFlow 0 379841) 379831))) inline$$InitEventStore$0$anon0_correct@@17)))
(let ((PreconditionGeneratedEntry_correct@@14  (=> (= (ControlFlow 0 510661) 379841) anon0_correct@@17)))
