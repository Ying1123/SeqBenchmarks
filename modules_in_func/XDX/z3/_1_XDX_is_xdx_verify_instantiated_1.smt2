...
(assert (not
 (=> (= (ControlFlow 0 0) 533768) (let ((L5_correct@@8  (and (=> (= (ControlFlow 0 409128) (- 0 534277)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 409128) (- 0 534287)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0@@1)))))))
(let ((anon14_Then_correct@@4  (=> $t6@@10 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@7)) (= $t2@@7 $t2@@7)) (and (= $t2@0@@1 $t2@@7) (= (ControlFlow 0 409088) 409128))) L5_correct@@8))))
(let ((anon13_Then_correct@@4  (=> $t4@@7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2@@7)) (= $t2@@7 $t2@@7)) (and (= $t2@0@@1 $t2@@7) (= (ControlFlow 0 409154) 409128))) L5_correct@@8))))
(let ((L3_correct@@2  (=> (= $t0@0@@4 $t0@0@@4) (and (=> (= (ControlFlow 0 408986) (- 0 534234)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 408986) (- 0 534249)) (= $t0@0@@4  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct@@4  (=> (not $t6@@10) (=> (and (|$IsValid'vec'u8''| $t5@@7) (= $t5@@7 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0@@1 (= $t3@@7 $t5@@7)) (= $t7@0@@1 $t7@0@@1)) (and (= $t0@0@@4 $t7@0@@1) (= (ControlFlow 0 409062) 408986))) L3_correct@@2)))))
(let ((anon13_Else_correct@@4  (=> (and (and (not $t4@@7) (|$IsValid'vec'u8''| $t3@@7)) (and (= $t3@@7 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t6@@10  (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 409028) 409088) anon14_Then_correct@@4) (=> (= (ControlFlow 0 409028) 409062) anon14_Else_correct@@4)))))
(let ((anon12_Then_correct@@4  (=> (and |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (= $t4@@7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 409000) 409154) anon13_Then_correct@@4) (=> (= (ControlFlow 0 409000) 409028) anon13_Else_correct@@4)))))
(let ((anon12_Else_correct@@4  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= false false)) (and (= $t0@0@@4 false) (= (ControlFlow 0 408946) 408986))) L3_correct@@2)))
(let ((anon11_Else_correct@@4  (=> (not false) (and (=> (= (ControlFlow 0 408926) 409000) anon12_Then_correct@@4) (=> (= (ControlFlow 0 408926) 408946) anon12_Else_correct@@4)))))
(let ((anon11_Then_correct@@4 true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 408912) 409168) anon11_Then_correct@@4) (=> (= (ControlFlow 0 408912) 408926) anon11_Else_correct@@4))))))
(let ((anon0$1_correct@@27  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@97 Int) (mint_cap_owner2@@97 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@97) (=> (|$IsValid'address'| mint_cap_owner2@@97) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@97) (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@97)) (= mint_cap_owner1@@97 mint_cap_owner2@@97))))
 :qid |XDXbpl.28268:104|
 :skolemid |991|
))) (=> (and (forall ((addr3@@97 Int) ) (!  (=> (|$IsValid'address'| addr3@@97) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176777| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@97) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |XDXbpl.28272:20|
 :skolemid |992|
)) (forall ((addr@@736 Int) ) (!  (=> (|$IsValid'address'| addr@@736) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182279| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@736) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.28276:20|
 :skolemid |993|
))) (=> (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall (($a_0@@67 Int) ) (! (let (($rsc@@67 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@67)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''| $rsc@@67) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@67)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@67) 10000000000))))
 :qid |XDXbpl.28284:20|
 :skolemid |994|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@67))
))) (and (forall (($a_0@@68 Int) ) (! (let (($rsc@@68 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@68)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'$1_XDX_XDX''| $rsc@@68) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@68)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| $rsc@@68) 10000000000))))
 :qid |XDXbpl.28288:20|
 :skolemid |995|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@68))
)) (= (ControlFlow 0 408918) 408912))) |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|)))))
(let ((inline$$InitEventStore$0$anon0_correct@@27  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@74 T@$1_Event_EventHandle) ) (! (let ((stream@@88 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@74)))
 (and (= (|l#Multiset_131870| stream@@88) 0) (forall ((v@@114 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@88) v@@114) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 408630) 408918)) anon0$1_correct@@27)))
(let ((anon0_correct@@27  (=> (= (ControlFlow 0 533768) 408630) inline$$InitEventStore$0$anon0_correct@@27)))
anon0_correct@@27)))))))))))))))
))
(check-sat)
(pop 1)
