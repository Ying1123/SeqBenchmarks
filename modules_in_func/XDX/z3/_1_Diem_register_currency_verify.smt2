...
(assert (not
 (=> (= (ControlFlow 0 0) 493715) (let ((anon43_Else_correct@@5  (=> (not $abort_flag@1@@11) (=> (and (and (= $t42@0@@5 (|$1_Diem_MintCapability'#0'| false)) (= $t44@0 (|$1_Diem_BurnCapability'#0'| false))) (and (= $t42@0@@5 $t42@0@@5) (= $t44@0 $t44@0))) (and (=> (= (ControlFlow 0 362707) (- 0 497569)) (not (or (= _$t3 0) (> _$t3 10000000000)))) (=> (not (or (= _$t3 0) (> _$t3 10000000000))) (and (=> (= (ControlFlow 0 362707) (- 0 497586)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (and (=> (= (ControlFlow 0 362707) (- 0 497597)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9))) (and (=> (= (ControlFlow 0 362707) (- 0 497609)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (and (=> (= (ControlFlow 0 362707) (- 0 497627)) (not (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@12) 173345816))) (and (=> (= (ControlFlow 0 362707) (- 0 497641)) (not (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0@@12) 173345816))) (and (=> (= (ControlFlow 0 362707) (- 0 497655)) (not (exists ((i@@72 Int) ) (!  (and (and (|$IsValid'u64'| i@@72) (and (>= i@@72 0) (< i@@72 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@213 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@213)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@213 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@213)))) i@@72) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
)))) (=> (not (exists ((i@@73 Int) ) (!  (and (and (|$IsValid'u64'| i@@73) (and (>= i@@73 0) (< i@@73 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@214 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@214)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@214 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@214)))) i@@73) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
))) (and (=> (= (ControlFlow 0 362707) (- 0 497668)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (and (=> (= (ControlFlow 0 362707) (- 0 497681)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 362707) (- 0 497693)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12)))) (and (=> (= (ControlFlow 0 362707) (- 0 497735)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (and (=> (= (ControlFlow 0 362707) (- 0 497741)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) 0)) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) 0) (and (=> (= (ControlFlow 0 362707) (- 0 497753)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 362707) (- 0 497773)) (forall ((addr@@215 Int) ) (!  (=> (|$IsValid'address'| addr@@215) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@215)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@215))))
 :qid |XDXbpl.18745:15|
 :skolemid |473|
))) (=> (forall ((addr@@216 Int) ) (!  (=> (|$IsValid'address'| addr@@216) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@216)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@216))))
 :qid |XDXbpl.18745:15|
 :skolemid |473|
)) (and (=> (= (ControlFlow 0 362707) (- 0 497802)) (forall ((addr@@217 Int) ) (!  (=> (|$IsValid'address'| addr@@217) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@217) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@217)))
 :qid |XDXbpl.18750:15|
 :skolemid |474|
))) (=> (forall ((addr@@218 Int) ) (!  (=> (|$IsValid'address'| addr@@218) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@218) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr@@218)))
 :qid |XDXbpl.18750:15|
 :skolemid |474|
)) (and (=> (= (ControlFlow 0 362707) (- 0 497827)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 362707) (- 0 497847)) (forall ((addr@@219 Int) ) (!  (=> (|$IsValid'address'| addr@@219) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@219)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@219))))
 :qid |XDXbpl.18760:15|
 :skolemid |475|
))) (=> (forall ((addr@@220 Int) ) (!  (=> (|$IsValid'address'| addr@@220) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@220)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@220))))
 :qid |XDXbpl.18760:15|
 :skolemid |475|
)) (and (=> (= (ControlFlow 0 362707) (- 0 497876)) (forall ((addr@@221 Int) ) (!  (=> (|$IsValid'address'| addr@@221) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@221) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@221)))
 :qid |XDXbpl.18765:15|
 :skolemid |476|
))) (=> (forall ((addr@@222 Int) ) (!  (=> (|$IsValid'address'| addr@@222) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@222) (|Select__T@[Int]Bool_| (|domain#$Memory_177295| |$1_Diem_BurnCapability'#0'_$memory|) addr@@222)))
 :qid |XDXbpl.18765:15|
 :skolemid |476|
)) (and (=> (= (ControlFlow 0 362707) (- 0 497901)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 362707) (- 0 497921)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 362707) (- 0 497941)) (forall ((addr@@223 Int) ) (!  (=> (|$IsValid'address'| addr@@223) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@223) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@223))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@223))))
 :qid |XDXbpl.18780:15|
 :skolemid |477|
))) (=> (forall ((addr@@224 Int) ) (!  (=> (|$IsValid'address'| addr@@224) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@224) (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@224))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@224))))
 :qid |XDXbpl.18780:15|
 :skolemid |477|
)) (=> (= (ControlFlow 0 362707) (- 0 497977)) (forall ((addr@@225 Int) ) (!  (=> (|$IsValid'address'| addr@@225) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@225) (|Select__T@[Int]Bool_| (|domain#$Memory_182795| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@225)))
 :qid |XDXbpl.18785:15|
 :skolemid |478|
)))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon40_Then_correct@@8 true))
(let ((anon39_Then_correct@@8 true))
(let ((anon38_Then_correct@@8 true))
(let ((anon37_Then_correct@@8 true))
(let ((anon36_Then_correct@@5 true))
(let ((L9_correct@@5  (and (=> (= (ControlFlow 0 359855) (- 0 497174)) (or (or (or (or (or (or (or (or (or (or (= _$t3 0) (> _$t3 10000000000)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (exists ((i@@74 Int) ) (!  (and (and (|$IsValid'u64'| i@@74) (and (>= i@@74 0) (< i@@74 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@226 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@226)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@226 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@226)))) i@@74) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))))) (=> (or (or (or (or (or (or (or (or (or (or (= _$t3 0) (> _$t3 10000000000)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (not (= (|$addr#$signer| _$t0@@12) 173345816))) (exists ((i@@75 Int) ) (!  (and (and (|$IsValid'u64'| i@@75) (and (>= i@@75 0) (< i@@75 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@227 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@227)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@227 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@227)))) i@@75) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12)))) (=> (= (ControlFlow 0 359855) (- 0 497308)) (or (or (or (or (or (or (or (or (or (and (or (= _$t3 0) (> _$t3 10000000000)) (= 7 $t16@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)) (= 6 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) (= 5 $t16@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t11@@9)) 0)) (= 3 $t16@0))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@0))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@0))) (and (exists ((i@@76 Int) ) (!  (and (and (|$IsValid'u64'| i@@76) (and (>= i@@76 0) (< i@@76 (seq.len (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@228 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@228)))))))) (= (seq.nth (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (let ((addr@@228 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@228)))) i@@76) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
)) (= 7 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (= 4 $t16@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 $t16@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t12@@12) 18446744073709551615)) (< $t13@@11 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t12@@12))) (= 1 $t16@0))))))))
(let ((anon43_Then_correct@@5  (=> (and (and $abort_flag@1@@11 (= $abort_code@2@@11 $abort_code@2@@11)) (and (= $t16@0 $abort_code@2@@11) (= (ControlFlow 0 362721) 359855))) L9_correct@@5)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2|) 173345816) (=> (and (and (= (let ((addr@@229 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2|) addr@@229))) inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@1) (= (|Select__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (= $abort_flag@1@@11 $abort_flag@0@@12) (= $abort_code@2@@11 $abort_code@1@@12))) (and (=> (= (ControlFlow 0 362029) 362721) anon43_Then_correct@@5) (=> (= (ControlFlow 0 362029) 362707) anon43_Else_correct@@5))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct  (=> (and (and (not |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@2|) (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@1| ($Memory_166087 (|Store__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 false) (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@1|) (= (ControlFlow 0 362003) 362029))) inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct  (=> (and (and |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@2| (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@0| ($Memory_166087 (|Store__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816 |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''@1|)))) (and (= |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@2| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory@0|) (= (ControlFlow 0 362041) 362029))) inline$$1_RegisteredCurrencies_add_currency_code$0$anon17_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Else_correct  (=> (not |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@1|) (=> (and (= $1_DiemConfig_Configuration_$memory@1 ($Memory_165857 (|Store__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1)) (and (=> (= (ControlFlow 0 361989) 362041) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct) (=> (= (ControlFlow 0 361989) 362003) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Then_correct  (=> |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'bool'@1| (=> (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_165857 (|Store__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816 |inline$$1_RegisteredCurrencies_add_currency_code$0$$temp_0'$1_DiemConfig_Configuration'@1|))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0)) (and (=> (= (ControlFlow 0 362053) 362041) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Then_correct) (=> (= (ControlFlow 0 362053) 362003) inline$$1_RegisteredCurrencies_add_currency_code$0$anon24_Else_correct))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Else_correct  (=> (not inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0) (and (=> (= (ControlFlow 0 361977) 362053) inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Then_correct) (=> (= (ControlFlow 0 361977) 361989) inline$$1_RegisteredCurrencies_add_currency_code$0$anon23_Else_correct)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct  (=> (and (= $abort_flag@1@@11 true) (= $abort_code@2@@11 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1)) (and (=> (= (ControlFlow 0 361756) 362721) anon43_Then_correct@@5) (=> (= (ControlFlow 0 361756) 362707) anon43_Else_correct@@5)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Then_correct  (=> inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (= 4 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0))) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0) 18446744073709551615)) (< inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0))) (= 1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0) (= (ControlFlow 0 362151) 361756))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Else_correct  (=> (not $abort_flag@0@@12) (=> (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@2 ($Mutation_174894 (|l#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (|p#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) ($1_RegisteredCurrencies_RegisteredCurrencies (|v#$Mutation_153355| |inline$$1_Vector_push_back'vec'u8''$0$m'@1|)))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@1 (|v#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@2))) (=> (and (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t20@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) (|$addr#$signer| _$t0@@12))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0) 18446744073709551615)) (< inline$$1_RegisteredCurrencies_add_currency_code$0$$t19@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| inline$$1_RegisteredCurrencies_add_currency_code$0$$t18@0))))))) (and (=> (= (ControlFlow 0 361969) 362151) inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Then_correct) (=> (= (ControlFlow 0 361969) 361977) inline$$1_RegisteredCurrencies_add_currency_code$0$anon22_Else_correct)))))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@12) (= (ControlFlow 0 362165) 361756))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((|inline$$1_Vector_push_back'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'vec'u8''$0$m'@1| ($Mutation_153355 (|l#$Mutation_153355| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (|p#$Mutation_153355| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (seq.++ (|v#$Mutation_153355| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1) (seq.unit _$t5)))) (and (=> (= (ControlFlow 0 361833) 362165) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Then_correct) (=> (= (ControlFlow 0 361833) 361969) inline$$1_RegisteredCurrencies_add_currency_code$0$anon21_Else_correct)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Then_correct  (=> (and (and inline$$Not$1$dst@1 (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1 ($Mutation_174894 ($Local 4) (as seq.empty (Seq Int)) inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0))) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@1 ($Mutation_153355 (|l#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (seq.++ (|p#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1) (seq.unit 0)) (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| (|v#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@1)))) (= (ControlFlow 0 361839) 361833))) |inline$$1_Vector_push_back'vec'u8''$0$anon0_correct|)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct  (=> (and (and (not inline$$Not$1$dst@1) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= (ControlFlow 0 361750) 361756))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 7)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t14@0) (= inline$$Not$1$dst@1 inline$$Not$1$dst@1))) (and (=> (= (ControlFlow 0 361734) 361839) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Then_correct) (=> (= (ControlFlow 0 361734) 361750) inline$$1_RegisteredCurrencies_add_currency_code$0$anon20_Else_correct))))))
(let ((inline$$Not$1$anon0_correct  (=> (and (= inline$$Not$1$dst@1  (not |inline$$1_Vector_contains'vec'u8''$0$res@1|)) (= (ControlFlow 0 361694) 361734)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else$1_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct  (=> (and (not $abort_flag@0@@12) (= (ControlFlow 0 361700) 361694)) inline$$Not$1$anon0_correct)))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 $abort_code@1@@12) (= (ControlFlow 0 362179) 361756))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct)))
(let ((|inline$$1_Vector_contains'vec'u8''$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'vec'u8''$0$res@1| (exists ((i@@77 Int) ) (!  (and (and (|$IsValid'u64'| i@@77) (and (>= i@@77 0) (< i@@77 (seq.len inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1)))) (= (seq.nth inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1 i@@77) _$t5))
 :qid |XDXbpl.2220:13|
 :skolemid |62|
))) (and (=> (= (ControlFlow 0 361650) 362179) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Then_correct) (=> (= (ControlFlow 0 361650) 361700) inline$$1_RegisteredCurrencies_add_currency_code$0$anon19_Else_correct)))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Else_correct  (=> (and (not inline$$1_RegisteredCurrencies_add_currency_code$0$$t7@0) (|$IsValid'$1_RegisteredCurrencies_RegisteredCurrencies'| inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0)) (=> (and (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0 (let ((addr@@230 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@230)))) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t10@1 (|$currency_codes#$1_RegisteredCurrencies_RegisteredCurrencies| inline$$1_RegisteredCurrencies_add_currency_code$0$$t4@0)) (= (ControlFlow 0 361656) 361650))) |inline$$1_Vector_contains'vec'u8''$0$anon0_correct|))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Then_correct  (=> inline$$1_RegisteredCurrencies_add_currency_code$0$$t7@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0)) (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@1 inline$$1_RegisteredCurrencies_add_currency_code$0$$t8@0) (= (ControlFlow 0 362207) 361756))) inline$$1_RegisteredCurrencies_add_currency_code$0$L3_correct))))
(let ((inline$$1_RegisteredCurrencies_add_currency_code$0$anon0_correct  (=> (= (seq.len (|p#$Mutation_174894| inline$$1_RegisteredCurrencies_add_currency_code$0$$t15@0)) 0) (=> (and (= (seq.len (|p#$Mutation_153355| inline$$1_RegisteredCurrencies_add_currency_code$0$$t16@0)) 0) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t5@0 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (and (and (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t6@0 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= _$t0@@12 _$t0@@12)) (and (= _$t5 _$t5) (= inline$$1_RegisteredCurrencies_add_currency_code$0$$t7@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 361578) 362207) inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Then_correct) (=> (= (ControlFlow 0 361578) 361656) inline$$1_RegisteredCurrencies_add_currency_code$0$anon18_Else_correct)))))))
(let ((anon42_Else_correct@@8  (=> (not $abort_flag@0@@12) (and (=> (= (ControlFlow 0 362211) (- 0 496182)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))) (forall ((mint_cap_owner1@@65 Int) (mint_cap_owner2@@65 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@65) (=> (|$IsValid'address'| mint_cap_owner2@@65) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@65) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@65)) (= mint_cap_owner1@@65 mint_cap_owner2@@65))))
 :qid |XDXbpl.18596:83|
 :skolemid |469|
)))) (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))) (forall ((mint_cap_owner1@@66 Int) (mint_cap_owner2@@66 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@66) (=> (|$IsValid'address'| mint_cap_owner2@@66) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@66) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@66)) (= mint_cap_owner1@@66 mint_cap_owner2@@66))))
 :qid |XDXbpl.18596:83|
 :skolemid |469|
))) (and (=> (= (ControlFlow 0 362211) (- 0 496227)) (forall ((addr3@@65 Int) ) (!  (=> (|$IsValid'address'| addr3@@65) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@65) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816))))))
 :qid |XDXbpl.18602:15|
 :skolemid |470|
))) (=> (forall ((addr3@@66 Int) ) (!  (=> (|$IsValid'address'| addr3@@66) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@66) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816))))))
 :qid |XDXbpl.18602:15|
 :skolemid |470|
)) (and (=> (= (ControlFlow 0 362211) (- 0 496250)) (forall ((addr@@231 Int) ) (!  (=> (|$IsValid'address'| addr@@231) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@231) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))
 :qid |XDXbpl.18608:15|
 :skolemid |471|
))) (=> (forall ((addr@@232 Int) ) (!  (=> (|$IsValid'address'| addr@@232) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@232) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)))
 :qid |XDXbpl.18608:15|
 :skolemid |471|
)) (and (=> (= (ControlFlow 0 362211) (- 0 496273)) (forall ((dr_addr@@53 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@53) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@53) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) dr_addr@@53)))
 :qid |XDXbpl.18614:15|
 :skolemid |472|
))) (=> (forall ((dr_addr@@54 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@54) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@54) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) dr_addr@@54)))
 :qid |XDXbpl.18614:15|
 :skolemid |472|
)) (and (=> (= (ControlFlow 0 362211) (- 0 496297)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@161 Int) ) (!  (and (|$IsValid'address'| a@@161) (and ($1_Signer_is_txn_signer_addr a@@161) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@161) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@161)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@162 Int) ) (!  (and (|$IsValid'address'| a@@162) (and ($1_Signer_is_txn_signer_addr a@@162) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@162) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@162)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 362211) (- 0 496321)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@163 Int) ) (!  (and (|$IsValid'address'| a@@163) (and ($1_Signer_is_txn_signer_addr a@@163) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@163) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@163)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@164 Int) ) (!  (and (|$IsValid'address'| a@@164) (and ($1_Signer_is_txn_signer_addr a@@164) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@164)) 1))))
 :qid |XDXbpl.4735:13|
 :skolemid |117|
)))) (and (=> (= (ControlFlow 0 362211) (- 0 496345)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (exists ((a@@165 Int) ) (!  (and (|$IsValid'address'| a@@165) (and ($1_Signer_is_txn_signer_addr a@@165) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@165) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@165)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) (exists ((a@@166 Int) ) (!  (and (|$IsValid'address'| a@@166) (and ($1_Signer_is_txn_signer_addr a@@166) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) a@@166) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) a@@166)) 0))))
 :qid |XDXbpl.4740:13|
 :skolemid |118|
))) (=> (= $t39@@2 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (= $t40 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= (ControlFlow 0 362211) 361578)) inline$$1_RegisteredCurrencies_add_currency_code$0$anon0_correct)))))))))))))))))))
(let ((anon42_Then_correct@@8  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= $t16@0 $abort_code@1@@12) (= (ControlFlow 0 362735) 359855))) L9_correct@@5)))
(let ((anon41_Then$1_correct  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory|) (=> (and (= $abort_flag@0@@12 true) (= $abort_code@1@@12 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 362787) 362735) anon42_Then_correct@@8) (=> (= (ControlFlow 0 362787) 362211) anon42_Else_correct@@8))))))
(let ((anon41_Then_correct@@8  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12)) (= (ControlFlow 0 362785) 362787)) anon41_Then$1_correct)))
(let ((anon41_Else_correct@@8  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| ($Memory_176283 (|Store__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) (|$addr#$signer| _$t0@@12) $t38@0))) (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory@0@@3|)) (and (= $abort_flag@0@@12 false) (= $abort_code@1@@12 $abort_code@0@@12))) (and (=> (= (ControlFlow 0 360495) 362735) anon42_Then_correct@@8) (=> (= (ControlFlow 0 360495) 362211) anon42_Else_correct@@8))))))
(let ((anon40_Else_correct@@8  (=> (and (not false) (= $t38@0 (|$1_Diem_CurrencyInfo'#0'| 0 0 _$t1@@12 _$t2@@9 _$t3 _$t4 _$t5 true |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 360473) (- 0 496072)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $t38@0) 10000000000)) (and (=> (= (ControlFlow 0 360473) 362785) anon41_Then_correct@@8) (=> (= (ControlFlow 0 360473) 360495) anon41_Else_correct@@8)))))))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0|) false) (= $1_Event_EventHandles@4 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@3 |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 360403) 362801) anon40_Then_correct@@8) (=> (= (ControlFlow 0 360403) 360473) anon40_Else_correct@@8)))))
(let ((anon39_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 360409) 360403)) |inline$$1_Event_new_event_handle'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@3 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@2 |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 360321) 362815) anon39_Then_correct@@8) (=> (= (ControlFlow 0 360321) 360409) anon39_Else_correct@@8)))))
(let ((anon38_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 360327) 360321)) |inline$$1_Event_new_event_handle'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0|) false) (= $1_Event_EventHandles@2 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@1 |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 360239) 362829) anon38_Then_correct@@8) (=> (= (ControlFlow 0 360239) 360327) anon38_Else_correct@@8)))))
(let ((anon37_Else_correct@@8  (=> (and (not false) (= (ControlFlow 0 360245) 360239)) |inline$$1_Event_new_event_handle'$1_Diem_PreburnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0|) false) (= $1_Event_EventHandles@1 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles@0 |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 360157) 362843) anon37_Then_correct@@8) (=> (= (ControlFlow 0 360157) 360245) anon37_Else_correct@@8)))))
(let ((anon36_Else_correct@@5  (=> (and (not false) (= (ControlFlow 0 360163) 360157)) |inline$$1_Event_new_event_handle'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((|inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 360075) 362857) anon36_Then_correct@@5) (=> (= (ControlFlow 0 360075) 360163) anon36_Else_correct@@5)))))
(let ((anon35_Then_correct@@5  (=> (and (and $t10@0 (|$IsValid'u128'| 0)) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 360081) 360075))) |inline$$1_Event_new_event_handle'$1_Diem_MintEvent'$0$anon0_correct|)))
(let ((anon35_Else_correct@@5  (=> (and (and (not $t10@0) (= $t29 $t29)) (and (= $t16@0 $t29) (= (ControlFlow 0 359979) 359855))) L9_correct@@5)))
(let ((L5_correct@@3  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t29) (= $t29 7)) (and (= $t29 $t29) (= $t10@0 $t10@0))) (and (=> (= (ControlFlow 0 359963) 360081) anon35_Then_correct@@5) (=> (= (ControlFlow 0 359963) 359979) anon35_Else_correct@@5))))))
(let ((anon34_Then$1_correct  (=> (= inline$$Le$0$dst@1 inline$$Le$0$dst@1) (=> (and (= $t10@0 inline$$Le$0$dst@1) (= (ControlFlow 0 362923) 359963)) L5_correct@@3))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= _$t3 10000000000)) (= (ControlFlow 0 362907) 362923)) anon34_Then$1_correct)))
(let ((anon34_Then_correct@@5  (=> inline$$Lt$0$dst@1@@0 (=> (and (|$IsValid'u64'| 10000000000) (= (ControlFlow 0 362913) 362907)) inline$$Le$0$anon0_correct))))
(let ((anon34_Else_correct@@5  (=> (and (and (not inline$$Lt$0$dst@1@@0) (= false false)) (and (= $t10@0 false) (= (ControlFlow 0 359933) 359963))) L5_correct@@3)))
(let ((inline$$Lt$0$anon0_correct@@0  (=> (= inline$$Lt$0$dst@1@@0 (< 0 _$t3)) (and (=> (= (ControlFlow 0 359905) 362913) anon34_Then_correct@@5) (=> (= (ControlFlow 0 359905) 359933) anon34_Else_correct@@5)))))
(let ((anon33_Then_correct@@5  (=> inline$$Not$0$dst@1@@11 (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 359911) 359905)) inline$$Lt$0$anon0_correct@@0))))
(let ((anon33_Else_correct@@5  (=> (and (and (not inline$$Not$0$dst@1@@11) (= $t22@@2 $t22@@2)) (and (= $t16@0 $t22@@2) (= (ControlFlow 0 359467) 359855))) L9_correct@@5)))
(let ((anon32_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t22@@2) (= $t22@@2 6)) (and (= $t22@@2 $t22@@2) (= inline$$Not$0$dst@1@@11 inline$$Not$0$dst@1@@11))) (and (=> (= (ControlFlow 0 359451) 359911) anon33_Then_correct@@5) (=> (= (ControlFlow 0 359451) 359467) anon33_Else_correct@@5))))))
(let ((inline$$Not$0$anon0_correct@@11  (=> (and (= inline$$Not$0$dst@1@@11  (not $t19@0@@2)) (= (ControlFlow 0 359411) 359451)) anon32_Else$1_correct)))
(let ((anon32_Else_correct@@5  (=> (not $t17@@11) (=> (and (and (|$IsValid'address'| $t18@@2) (= $t18@@2 (|$addr#$signer| _$t0@@12))) (and (= $t19@0@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $t18@@2)) (= (ControlFlow 0 359417) 359411))) inline$$Not$0$anon0_correct@@11))))
(let ((anon32_Then_correct@@5  (=> $t17@@11 (=> (and (and (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5)) (= $t16@@5 $t16@@5)) (and (= $t16@0 $t16@@5) (= (ControlFlow 0 362953) 359855))) L9_correct@@5))))
(let ((anon31_Else_correct@@5  (=> (and (not $t15@@8) (= $t17@@11  (not (= (|$addr#$signer| _$t0@@12) 173345816)))) (and (=> (= (ControlFlow 0 359355) 362953) anon32_Then_correct@@5) (=> (= (ControlFlow 0 359355) 359417) anon32_Else_correct@@5)))))
(let ((anon31_Then_correct@@5  (=> $t15@@8 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t14@@12)) (= 5 $t16@@5))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t14@@12)) 0)) (= 3 $t16@@5))) (and (not (= (|$addr#$signer| _$t0@@12) 173345816)) (= 2 $t16@@5))) (= $t16@@5 $t16@@5)) (and (= $t16@0 $t16@@5) (= (ControlFlow 0 363045) 359855))) L9_correct@@5))))
(let ((anon0$1_correct@@12  (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (forall ((addr@@233 Int) ) (!  (=> (|$IsValid'address'| addr@@233) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@233) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@233)) 0)) (= addr@@233 173345816)))
 :qid |XDXbpl.17960:20|
 :skolemid |432|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@234 Int) ) (!  (=> (|$IsValid'address'| addr@@234) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@234) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@234)) 1)) (= addr@@234 186537453)))
 :qid |XDXbpl.17968:20|
 :skolemid |433|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@235 Int) ) (!  (=> (|$IsValid'address'| addr@@235) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@235)) 2))))))
 :qid |XDXbpl.17976:20|
 :skolemid |434|
))) (and (forall ((addr@@236 Int) ) (!  (=> (|$IsValid'address'| addr@@236) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@236)) 2))))))
 :qid |XDXbpl.17980:20|
 :skolemid |435|
)) (forall ((addr@@237 Int) ) (!  (=> (|$IsValid'address'| addr@@237) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@237)) 2))))))
 :qid |XDXbpl.17984:20|
 :skolemid |436|
))))) (=> (and (and (and (and (forall ((addr@@238 Int) ) (!  (=> (|$IsValid'address'| addr@@238) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@238)) 2))))))
 :qid |XDXbpl.17988:20|
 :skolemid |437|
)) (forall ((addr@@239 Int) ) (!  (=> (|$IsValid'address'| addr@@239) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@239)) 2)))))
 :qid |XDXbpl.17992:20|
 :skolemid |438|
))) (and (forall ((addr@@240 Int) ) (!  (=> (|$IsValid'address'| addr@@240) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@240)) 2)))))
 :qid |XDXbpl.17996:20|
 :skolemid |439|
)) (forall ((addr@@241 Int) ) (!  (=> (|$IsValid'address'| addr@@241) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@241)) 2)))))
 :qid |XDXbpl.18000:20|
 :skolemid |440|
)))) (and (and (forall ((addr@@242 Int) ) (!  (=> (|$IsValid'address'| addr@@242) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@242) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@242) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@242)) 4))))
 :qid |XDXbpl.18004:20|
 :skolemid |441|
)) (forall ((addr@@243 Int) ) (!  (=> (|$IsValid'address'| addr@@243) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@243) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@243) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@243)) 3))))
 :qid |XDXbpl.18008:20|
 :skolemid |442|
))) (and (forall ((addr@@244 Int) ) (!  (=> (|$IsValid'address'| addr@@244) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@244) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@244) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@244)) 3))))
 :qid |XDXbpl.18012:20|
 :skolemid |443|
)) (forall ((addr@@245 Int) ) (!  (=> (|$IsValid'address'| addr@@245) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@245) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@245)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@245) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@245)) 3))))
 :qid |XDXbpl.18016:20|
 :skolemid |444|
))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) config_address) (= config_address 173345816)))
 :qid |XDXbpl.18032:20|
 :skolemid |445|
)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166016| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (let (($range_0@@20 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@246 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@246))))))))
(forall (($i_1@@20 Int) ) (!  (=> ($InRange $range_0@@20 $i_1@@20) (let ((i1 $i_1@@20))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@247 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@247)))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@247 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_165943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@247)))) i1)))) 3))))
 :qid |XDXbpl.18040:151|
 :skolemid |446|
)))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@67 Int) (mint_cap_owner2@@67 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@67) (=> (|$IsValid'address'| mint_cap_owner2@@67) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@67) (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@67)) (= mint_cap_owner1@@67 mint_cap_owner2@@67))))
 :qid |XDXbpl.18049:88|
 :skolemid |447|
))))))) (=> (and (and (and (and (and (and (forall ((addr3@@67 Int) ) (!  (=> (|$IsValid'address'| addr3@@67) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_176841| |$1_Diem_MintCapability'#0'_$memory|) addr3@@67) (and (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.18053:20|
 :skolemid |448|
)) (forall ((addr@@248 Int) ) (!  (=> (|$IsValid'address'| addr@@248) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_182370| |$1_Diem_Preburn'#0'_$memory|) addr@@248) (|Select__T@[Int]Bool_| (|domain#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.18057:20|
 :skolemid |449|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166171| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166255| |$1_AccountLimits_LimitsDefinition'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166326| $1_XDX_Reserve_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166410| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166494| |$1_AccountLimits_LimitsDefinition'$1_XDX_XDX'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166565| |$1_TransactionFee_TransactionFee'$1_XUS_XUS'_$memory|) 186537453))))) (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166662| $1_DualAttestation_Limit_$memory) 173345816)) (forall ((addr1@@2 Int) ) (!  (=> (|$IsValid'address'| addr1@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr1@@2) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@2)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr1@@2)) 2)))))
 :qid |XDXbpl.18089:20|
 :skolemid |450|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166746| |$1_DiemConfig_DiemConfig'$1_DiemTransactionPublishingOption_DiemTransactionPublishingOption'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166830| $1_ChainId_ChainId_$memory) 173345816)))) (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166901| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166972| $1_AccountFreezing_FreezingBit_$memory) 173345816) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_166972| $1_AccountFreezing_FreezingBit_$memory) 173345816)))))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_166972| $1_AccountFreezing_FreezingBit_$memory) 186537453) (not (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_166972| $1_AccountFreezing_FreezingBit_$memory) 186537453))))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_166901| $1_AccountFreezing_FreezeEventsHolder_$memory) 173345816)))))) (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_167144| $1_DiemAccount_AccountOperationsCapability_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_167215| $1_DiemAccount_DiemWriteSetManager_$memory) 173345816))) (and (forall ((addr@@249 Int) ) (!  (=> (|$IsValid'address'| addr@@249) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234919| $1_DiemAccount_DiemAccount_$memory) addr@@249) (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@249)))
 :qid |XDXbpl.18125:20|
 :skolemid |451|
)) (forall ((addr@@250 Int) ) (!  (=> (|$IsValid'address'| addr@@250) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235019| $1_VASPDomain_VASPDomainManager_$memory) addr@@250)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@250) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@250)) 1))))
 :qid |XDXbpl.18129:20|
 :skolemid |452|
)))) (and (and (forall ((addr@@251 Int) ) (!  (=> (|$IsValid'address'| addr@@251) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235104| $1_VASPDomain_VASPDomains_$memory) addr@@251)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@251) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@251)) 5))))
 :qid |XDXbpl.18133:20|
 :skolemid |453|
)) (forall ((addr@@252 Int) ) (!  (=> (|$IsValid'address'| addr@@252) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_235191| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@252) (|Select__T@[Int]Bool_| (|domain#$Memory_235251| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@252)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@252)) 2)))))
 :qid |XDXbpl.18137:20|
 :skolemid |454|
))) (and (forall ((addr@@253 Int) ) (!  (=> (|$IsValid'address'| addr@@253) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235336| $1_DesignatedDealer_Dealer_$memory) addr@@253)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@253) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@253)) 2))))
 :qid |XDXbpl.18141:20|
 :skolemid |455|
)) (forall ((addr@@254 Int) ) (!  (=> (|$IsValid'address'| addr@@254) (= (|Select__T@[Int]Bool_| (|domain#$Memory_234632| $1_DualAttestation_Credential_$memory) addr@@254)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@254)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@254) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@254)) 5)))))
 :qid |XDXbpl.18145:20|
 :skolemid |456|
))))) (and (and (and (forall ((addr@@255 Int) ) (!  (=> (|$IsValid'address'| addr@@255) (= (|Select__T@[Int]Bool_| (|domain#$Memory_165764| $1_SlidingNonce_SlidingNonce_$memory) addr@@255)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@255)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@255) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@255)) 1)))))
 :qid |XDXbpl.18149:20|
 :skolemid |457|
)) (forall ((addr@@256 Int) ) (!  (=> (|$IsValid'address'| addr@@256) (= (|Select__T@[Int]Bool_| (|domain#$Memory_170181| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@256)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@256) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@256)) 3))))
 :qid |XDXbpl.18153:20|
 :skolemid |458|
))) (and (forall ((addr@@257 Int) ) (!  (=> (|$IsValid'address'| addr@@257) (= (|Select__T@[Int]Bool_| (|domain#$Memory_169623| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@257)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@257) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@257)) 4))))
 :qid |XDXbpl.18157:20|
 :skolemid |459|
)) (forall ((addr@@258 Int) ) (!  (=> (|$IsValid'address'| addr@@258) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235591| $1_VASP_ParentVASP_$memory) addr@@258)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@258) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@258)) 5))))
 :qid |XDXbpl.18161:20|
 :skolemid |460|
)))) (and (and (forall ((addr@@259 Int) ) (!  (=> (|$IsValid'address'| addr@@259) (= (|Select__T@[Int]Bool_| (|domain#$Memory_235691| $1_VASP_ChildVASP_$memory) addr@@259)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) addr@@259) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) addr@@259)) 6))))
 :qid |XDXbpl.18165:20|
 :skolemid |461|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_167286| $1_DiemBlock_BlockMetadata_$memory) 173345816))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_167370| |$1_DiemConfig_DiemConfig'$1_DiemVMConfig_DiemVMConfig'_$memory|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_165451| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))))))) (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@12)) ($1_Signer_is_txn_signer _$t0@@12)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@12))) (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| _$t1@@12) (|$IsValid'u64'| _$t3))) (and (and (|$IsValid'u64'| _$t4) (|$IsValid'vec'u8''| _$t5)) (and (forall (($a_0@@15 Int) ) (! (let (($rsc@@15 (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@15)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc@@15))
 :qid |XDXbpl.18198:20|
 :skolemid |462|
 :pattern ( (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0@@15))
)) (forall (($a_0@@16 Int) ) (! (let (($rsc@@16 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@16)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@16))
 :qid |XDXbpl.18202:20|
 :skolemid |463|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $a_0@@16))
))))) (and (and (and (and (forall (($a_0@@17 Int) ) (! (let (($rsc@@17 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) $a_0@@17)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@17))
 :qid |XDXbpl.18206:20|
 :skolemid |464|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) $a_0@@17))
)) (forall (($a_0@@18 Int) ) (! (let (($rsc@@18 (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@18)))
(|$IsValid'$1_DiemConfig_DisableReconfiguration'| $rsc@@18))
 :qid |XDXbpl.18210:20|
 :skolemid |465|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DisableReconfiguration_| (|contents#$Memory_170985| $1_DiemConfig_DisableReconfiguration_$memory) $a_0@@18))
))) (and (forall (($a_0@@19 Int) ) (! (let (($rsc@@19 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@19)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@19))
 :qid |XDXbpl.18214:20|
 :skolemid |466|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_166087| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@19))
)) (forall (($a_0@@20 Int) ) (! (let (($rsc@@20 (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@20)))
(|$IsValid'$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@20))
 :qid |XDXbpl.18218:20|
 :skolemid |467|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_171805| |$1_DiemConfig_ModifyConfigCapability'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@20))
)))) (and (and (forall (($a_0@@21 Int) ) (! (let (($rsc@@21 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@21)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@21) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@21)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@21) 10000000000))))
 :qid |XDXbpl.18222:20|
 :skolemid |468|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_176283| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@21))
)) (= $t11@@9 (|$addr#$signer| _$t0@@12))) (and (= $t12@@12 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_165857| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t13@@11 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_164899| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))))) (and (and (and (= _$t0@@12 _$t0@@12) (= _$t1@@12 _$t1@@12)) (and (= _$t2@@9 _$t2@@9) (= _$t3 _$t3))) (and (and (= _$t4 _$t4) (= _$t5 _$t5)) (and (= $t14@@12 (|$addr#$signer| _$t0@@12)) (= $t15@@8  (or (or (or (not (= (|$addr#$signer| _$t0@@12) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_165577| $1_Roles_RoleId_$memory) $t14@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_165577| $1_Roles_RoleId_$memory) $t14@@12)) 0))) (not (= (|$addr#$signer| _$t0@@12) 173345816)))))))))) (and (=> (= (ControlFlow 0 359333) 363045) anon31_Then_correct@@5) (=> (= (ControlFlow 0 359333) 359355) anon31_Else_correct@@5)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@50 T@$1_Event_EventHandle) ) (! (let ((stream@@61 (|Select__T@[$1_Event_EventHandle]Multiset_131870_| (|streams#$EventStore| $es) handle@@50)))
 (and (= (|l#Multiset_131870| stream@@61) 0) (forall ((v@@90 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_131870| stream@@61) v@@90) 0)
 :qid |XDXbpl.134:13|
 :skolemid |2|
))))
 :qid |XDXbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 357893) 359333)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 493715) 357893) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
