...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 551667) (let ((L5_correct  (and (=> (= (ControlFlow 0 421280) (- 0 552176)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 421280) (- 0 552186)) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= 5 $t2@0)))))))
(let ((anon14_Then_correct  (=> $t6 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 421240) 421280))) L5_correct))))
(let ((anon13_Then_correct  (=> $t4 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t2)) (= $t2 $t2)) (and (= $t2@0 $t2) (= (ControlFlow 0 421306) 421280))) L5_correct))))
(let ((L3_correct  (=> (= $t0@0 $t0@0) (and (=> (= (ControlFlow 0 421138) (- 0 552133)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (= (ControlFlow 0 421138) (- 0 552148)) (= $t0@0  (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$IsEqual'vec'u8''| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))))))))
(let ((anon14_Else_correct  (=> (not $t6) (=> (and (|$IsValid'vec'u8''| $t5) (|$IsEqual'vec'u8''| $t5 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (and (and (= $t7@0 (|$IsEqual'vec'u8''| $t3 $t5)) (= $t7@0 $t7@0)) (and (= $t0@0 $t7@0) (= (ControlFlow 0 421214) 421138))) L3_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not $t4) (|$IsValid'vec'u8''| $t3)) (and (|$IsEqual'vec'u8''| $t3 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t6  (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 421180) 421240) anon14_Then_correct) (=> (= (ControlFlow 0 421180) 421214) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (= $t4  (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 421152) 421306) anon13_Then_correct) (=> (= (ControlFlow 0 421152) 421180) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|) (= false false)) (and (= $t0@0 false) (= (ControlFlow 0 421098) 421138))) L3_correct)))
(let ((anon11_Else_correct  (=> (not false) (and (=> (= (ControlFlow 0 421078) 421152) anon12_Then_correct) (=> (= (ControlFlow 0 421078) 421098) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((|inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (|$IsValid'address'| 173345816) (=> (and (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1| |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$$t1@1|)) (and (=> (= (ControlFlow 0 421064) 421320) anon11_Then_correct) (=> (= (ControlFlow 0 421064) 421078) anon11_Else_correct))))))
(let ((anon0$1_correct  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 ...
 :qid |XDXbpl.28336:20|
 :skolemid |1018|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.28340:20|
 :skolemid |1019|
...
)) (= (ControlFlow 0 421070) 421064))) |inline$$1_Diem_is_currency'$1_XDX_XDX'$0$anon0_correct|)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 420782) 421070)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 551667) 420782) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))
))
(check-sat)
(pop 1)
