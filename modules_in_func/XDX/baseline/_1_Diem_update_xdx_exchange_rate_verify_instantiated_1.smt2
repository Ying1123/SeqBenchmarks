...
(declare-fun $t7 () Bool)
(declare-fun $t6 () Int)
(declare-fun $t11@2 () T@$Mutation_203332)
...
(declare-fun $t11@1 () T@$Mutation_203332)
...
(declare-fun $t11 () T@$Mutation_203332)
(declare-fun $t11@0 () T@$Mutation_203332)
...
(declare-fun $t2 () T@$Mutation_203332)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 535191) (let ((L2_correct  (and (=> (= (ControlFlow 0 401588) (- 0 537389)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (=> (= (ControlFlow 0 401588) (- 0 537429)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 401460) 401588))) L2_correct)))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 401602) 401588))) L2_correct)))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 401616) 401588))) L2_correct)))
(let ((anon16_Then_correct  (=> $t9 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 401694) 401588))) L2_correct))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 401766) 401588))) L2_correct))))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 401446) (- 0 536760)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_175669 (|Store__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_203332| $t11@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_203332| $t11@2)) (|v#$Mutation_203332| $t11@2)))) (and (=> (= (ControlFlow 0 401446) (- 0 536808)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.23714:99|
 :skolemid |835|
 ...
 :qid |XDXbpl.23714:99|
 :skolemid |835|
))) (and (=> (= (ControlFlow 0 401446) (- 0 536853)) (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816))))))
 :qid |XDXbpl.23720:15|
 :skolemid |836|
 ...
 :qid |XDXbpl.23720:15|
 :skolemid |836|
)) (and (=> (= (ControlFlow 0 401446) (- 0 536876)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))
 :qid |XDXbpl.23726:15|
 :skolemid |837|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)))
 :qid |XDXbpl.23726:15|
 :skolemid |837|
)) (and (=> (= (ControlFlow 0 401446) (- 0 536899)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) dr_addr)))
 :qid |XDXbpl.23732:15|
 :skolemid |838|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) dr_addr@@0)))
 :qid |XDXbpl.23732:15|
 :skolemid |838|
)) (and (=> (= (ControlFlow 0 401446) (- 0 536923)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 401446) (- 0 536971)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 401446) (- 0 536990)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 401446) (- 0 537005)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 401446) (- 0 537017)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 401446) (- 0 537035)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 401446) (- 0 537049)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 401446) (- 0 537059)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 401446) (- 0 537070)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 401446) (- 0 537090)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@1))))
 :qid |XDXbpl.23795:15|
 :skolemid |839|
 ...
 :qid |XDXbpl.23795:15|
 :skolemid |839|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537119)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr@@3)))
 :qid |XDXbpl.23800:15|
 :skolemid |840|
 ...
 :qid |XDXbpl.23800:15|
 :skolemid |840|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537144)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 401446) (- 0 537164)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@5))))
 :qid |XDXbpl.23810:15|
 :skolemid |841|
 ...
 :qid |XDXbpl.23810:15|
 :skolemid |841|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537193)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_187013| |$1_Diem_BurnCapability'$1_XDX_XDX'_$memory|) addr@@7)))
 :qid |XDXbpl.23815:15|
 :skolemid |842|
 ...
 :qid |XDXbpl.23815:15|
 :skolemid |842|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537218)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 401446) (- 0 537238)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 401446) (- 0 537258)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@9))))
 :qid |XDXbpl.23830:15|
 :skolemid |843|
 ...
 :qid |XDXbpl.23830:15|
 :skolemid |843|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537294)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@11)))
 :qid |XDXbpl.23835:15|
 :skolemid |844|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_193294| |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory|) addr@@12)))
 :qid |XDXbpl.23835:15|
 :skolemid |844|
)) (and (=> (= (ControlFlow 0 401446) (- 0 537319)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new@@0))))))
 ...
 :qid |XDXbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 401446) (- 0 537344)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 400808) 401460) anon20_Then_correct) (=> (= (ControlFlow 0 400808) 401446) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t17@0 ($1_Diem_ToXDXExchangeRateUpdateEvent $t14@0 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 400814) 400808)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= $t15@0 $t15@0) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| $t15@0)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 400715) 401602) anon19_Then_correct) (=> (= (ControlFlow 0 400715) 400814) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| (|v#$Mutation_203332| $t11@1))) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@0|) (= $t12@0 ($Mutation_270500 (|l#$Mutation_203332| $t11@1) (let ((l (|l#Vec_23605| (|p#$Mutation_203332| $t11@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_203332| $t11@1)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1))))) (and (= $t12@1 ($Mutation_270500 (|l#$Mutation_270500| $t12@0) (|p#$Mutation_270500| $t12@0) _$t1)) (= $t11@2 ($Mutation_203332 (|l#$Mutation_203332| $t11@1) (|p#$Mutation_203332| $t11@1) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|v#$Mutation_270500| $t12@1) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@1))))))) (and (and (= $t13@0 ($Mutation_167422 (|l#$Mutation_203332| $t11@2) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_203332| $t11@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_203332| $t11@2)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2)))) (= $t14@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2)))) (and (= $t15@0 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_203332| $t11@2))) (= (ControlFlow 0 400721) 400715)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((anon17_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 401668) 401616) anon18_Then_correct) (=> (= (ControlFlow 0 401668) 400721) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 401666) 401668)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= $t11@0 ($Mutation_203332 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 400540) 401616) anon18_Then_correct) (=> (= (ControlFlow 0 400540) 400721) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not $t9) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 400518) 401666) anon17_Then_correct) (=> (= (ControlFlow 0 400518) 400540) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t7) (= $t9  (not (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 400504) 401694) anon16_Then_correct) (=> (= (ControlFlow 0 400504) 400518) anon16_Else_correct)))))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27))))) i1)))) 3))))
 ...
 :qid |XDXbpl.23456:104|
 :skolemid |818|
))) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186582| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |XDXbpl.23460:20|
 :skolemid |819|
))) (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192846| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |XDXbpl.23464:20|
 :skolemid |820|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_245605| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |XDXbpl.23472:20|
 :skolemid |821|
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
...
)))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0)))
 ...
 :qid |XDXbpl.23529:20|
 :skolemid |834|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $t5 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_175669| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| _$t1))))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 400486) 401766) anon15_Then_correct) (=> (= (ControlFlow 0 400486) 400504) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 399489) 400486)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_203332| $t2)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_203332| $t11)) 0) (= (|l#Vec_23605| (|p#$Mutation_270500| $t12)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_167422| $t13)) 0) (= (ControlFlow 0 399499) 399489))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 535191) 399499) anon0_correct)))
