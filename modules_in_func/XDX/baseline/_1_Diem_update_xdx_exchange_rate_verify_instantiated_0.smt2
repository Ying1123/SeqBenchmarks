...
(declare-fun $t7 () Bool)
(declare-fun $t6 () Int)
(declare-fun $t11@2 () T@$Mutation_198739)
...
(declare-fun $t13@0 () T@$Mutation_167422)
...
(declare-fun $t11@1 () T@$Mutation_198739)
(declare-fun $t12@0 () T@$Mutation_270500)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t12@1 () T@$Mutation_270500)
(declare-fun $t11 () T@$Mutation_198739)
(declare-fun $t11@0 () T@$Mutation_198739)
...
(declare-fun $t2 () T@$Mutation_198739)
(declare-fun $t12 () T@$Mutation_270500)
(declare-fun $t13 () T@$Mutation_167422)
(push 1)
(set-info :boogie-vc-id $1_Diem_update_xdx_exchange_rate$verify_instantiated_0)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 532871) (let ((L2_correct  (and (=> (= (ControlFlow 0 398936) (- 0 535069)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (=> (= (ControlFlow 0 398936) (- 0 535109)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 398808) 398936))) L2_correct)))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 398950) 398936))) L2_correct)))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 398964) 398936))) L2_correct)))
(let ((anon16_Then_correct  (=> $t9 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 399042) 398936))) L2_correct))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 399114) 398936))) L2_correct))))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 398794) (- 0 534440)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| ($Memory_175430 (|Store__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_198739| $t11@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_198739| $t11@2)) (|v#$Mutation_198739| $t11@2)))) (and (=> (= (ControlFlow 0 398794) (- 0 534488)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.23187:99|
 :skolemid |794|
 ...
 :qid |XDXbpl.23193:15|
 :skolemid |795|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534556)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192765| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))
 :qid |XDXbpl.23199:15|
 :skolemid |796|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192765| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)))
 :qid |XDXbpl.23199:15|
 :skolemid |796|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534579)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) dr_addr)))
 :qid |XDXbpl.23205:15|
 :skolemid |797|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) dr_addr@@0)))
 :qid |XDXbpl.23205:15|
 :skolemid |797|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534603)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 398794) (- 0 534627)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@2)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 398794) (- 0 534651)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 398794) (- 0 534670)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (and (=> (= (ControlFlow 0 398794) (- 0 534685)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 398794) (- 0 534697)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 398794) (- 0 534715)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 398794) (- 0 534729)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 398794) (- 0 534739)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 398794) (- 0 534750)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 398794) (- 0 534770)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@1))))
 :qid |XDXbpl.23268:15|
 :skolemid |798|
 ...
 :qid |XDXbpl.23268:15|
 :skolemid |798|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534799)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr@@3)))
 :qid |XDXbpl.23273:15|
 :skolemid |799|
 ...
 :qid |XDXbpl.23273:15|
 :skolemid |799|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534824)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 398794) (- 0 534844)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186926| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186926| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@5))))
 :qid |XDXbpl.23283:15|
 :skolemid |800|
 ...
 :qid |XDXbpl.23283:15|
 :skolemid |800|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534873)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186926| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_186926| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr@@7)))
 :qid |XDXbpl.23288:15|
 :skolemid |801|
 ...
 :qid |XDXbpl.23288:15|
 :skolemid |801|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534898)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 398794) (- 0 534918)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 398794) (- 0 534938)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192765| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@9))))
 :qid |XDXbpl.23303:15|
 :skolemid |802|
 ...
 :qid |XDXbpl.23303:15|
 :skolemid |802|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534974)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@11)))
 :qid |XDXbpl.23308:15|
 :skolemid |803|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_193177| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr@@12)))
 :qid |XDXbpl.23308:15|
 :skolemid |803|
)) (and (=> (= (ControlFlow 0 398794) (- 0 534999)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4)))
(let ((stream_new (let ((len (|l#Multiset_133706| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@0) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5))))
(Multiset_133706 (|Store__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@0) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_133706| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@1) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5))))
(Multiset_133706 (|Store__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@1) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new@@0))))))
 ...
 :qid |XDXbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 398794) (- 0 535024)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_133706| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@2) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5))))
(Multiset_133706 (|Store__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@2) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t5) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new@@1))))))
...
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_167422| $t13@0)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_133706| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t17@0))))
(Multiset_133706 (|Store__T@[$EventRep]Int_| (|v#Multiset_133706| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t17@0) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 398156) 398808) anon20_Then_correct) (=> (= (ControlFlow 0 398156) 398794) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t17@0 ($1_Diem_ToXDXExchangeRateUpdateEvent $t14@0 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 398162) 398156)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= $t15@0 $t15@0) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| $t15@0)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 398063) 398950) anon19_Then_correct) (=> (= (ControlFlow 0 398063) 398162) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| (|v#$Mutation_198739| $t11@1))) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0| |$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@0|) (= $t12@0 ($Mutation_270500 (|l#$Mutation_198739| $t11@1) (let ((l (|l#Vec_23605| (|p#$Mutation_198739| $t11@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_198739| $t11@1)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1))))) (and (= $t12@1 ($Mutation_270500 (|l#$Mutation_270500| $t12@0) (|p#$Mutation_270500| $t12@0) _$t1)) (= $t11@2 ($Mutation_198739 (|l#$Mutation_198739| $t11@1) (|p#$Mutation_198739| $t11@1) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|v#$Mutation_270500| $t12@1) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@1))))))) (and (and (= $t13@0 ($Mutation_167422 (|l#$Mutation_198739| $t11@2) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_198739| $t11@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_198739| $t11@2)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2)))) (= $t14@0 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2)))) (and (= $t15@0 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_198739| $t11@2))) (= (ControlFlow 0 398069) 398063)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((anon17_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 399016) 398964) anon18_Then_correct) (=> (= (ControlFlow 0 399016) 398069) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 399014) 399016)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= $t11@0 ($Mutation_198739 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 397888) 398964) anon18_Then_correct) (=> (= (ControlFlow 0 397888) 398069) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not $t9) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 397866) 399014) anon17_Then_correct) (=> (= (ControlFlow 0 397866) 397888) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t7) (= $t9  (not (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 397852) 399042) anon16_Then_correct) (=> (= (ControlFlow 0 397852) 397866) anon16_Else_correct)))))
(let ((anon0$1_correct  (=> (and (and (and (and (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13)) 0)) (= addr@@13 173345816)))
 :qid |XDXbpl.22864:20|
 :skolemid |763|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@14)) 1)) (= addr@@14 186537453)))
 :qid |XDXbpl.22872:20|
 :skolemid |764|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) 186537453)) 1))))) (and (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@15)) 2))))))
 :qid |XDXbpl.22880:20|
 :skolemid |765|
)) (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@16)) 2))))))
 :qid |XDXbpl.22884:20|
 :skolemid |766|
))) (and (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@17)) 2))))))
 :qid |XDXbpl.22888:20|
 :skolemid |767|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@18)) 2))))))
 :qid |XDXbpl.22892:20|
 :skolemid |768|
))))) (and (and (and (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@19)) 2)))))
 :qid |XDXbpl.22896:20|
 :skolemid |769|
)) (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@20)) 2)))))
 :qid |XDXbpl.22900:20|
 :skolemid |770|
))) (and (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@21)) 2)))))
 :qid |XDXbpl.22904:20|
 :skolemid |771|
)) (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178887| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@22)) 4))))
 :qid |XDXbpl.22908:20|
 :skolemid |772|
)))) (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179530| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |XDXbpl.22912:20|
 :skolemid |773|
)) (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179530| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@24) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@24)) 3))))
 :qid |XDXbpl.22916:20|
 :skolemid |774|
))) (and (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_179530| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@25) (not (= (|l#Vec_133792| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_179530| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@25)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@25)) 3))))
 :qid |XDXbpl.22920:20|
 :skolemid |775|
)) (let (($range_0 ($Range 0 (|l#Vec_134004| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@26 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i1 $i_1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_134004| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@27 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27))))) i1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_134004| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@27 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27))))) i1)))) 3))))
 :qid |XDXbpl.22924:151|
 :skolemid |776|
 ...
 :qid |XDXbpl.22929:104|
 :skolemid |777|
))) (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186518| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |XDXbpl.22933:20|
 :skolemid |778|
))) (and (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192765| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |XDXbpl.22937:20|
 :skolemid |779|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_245605| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |XDXbpl.22945:20|
 :skolemid |780|
)) (forall ((addr@@29 Int) ) (!  (=> (|$IsValid'address'| addr@@29) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245892| $1_DiemAccount_DiemAccount_$memory) addr@@29) (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@29)))
 :qid |XDXbpl.22949:20|
 :skolemid |781|
))) (and (forall ((addr@@30 Int) ) (!  (=> (|$IsValid'address'| addr@@30) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245992| $1_VASPDomain_VASPDomainManager_$memory) addr@@30)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@30) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@30)) 1))))
 :qid |XDXbpl.22953:20|
 :skolemid |782|
)) (forall ((addr@@31 Int) ) (!  (=> (|$IsValid'address'| addr@@31) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246077| $1_VASPDomain_VASPDomains_$memory) addr@@31)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@31) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@31)) 5))))
 :qid |XDXbpl.22957:20|
 :skolemid |783|
))))) (and (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_246164| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@32) (|Select__T@[Int]Bool_| (|domain#$Memory_246224| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@32)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@32)) 2)))))
 :qid |XDXbpl.22961:20|
 :skolemid |784|
)) (forall ((addr@@33 Int) ) (!  (=> (|$IsValid'address'| addr@@33) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246309| $1_DesignatedDealer_Dealer_$memory) addr@@33)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@33) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@33)) 2))))
 :qid |XDXbpl.22965:20|
 :skolemid |785|
))) (and (forall ((addr@@34 Int) ) (!  (=> (|$IsValid'address'| addr@@34) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245605| $1_DualAttestation_Credential_$memory) addr@@34)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@34)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@34) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@34)) 5)))))
 :qid |XDXbpl.22969:20|
 :skolemid |786|
)) (forall ((addr@@35 Int) ) (!  (=> (|$IsValid'address'| addr@@35) (= (|Select__T@[Int]Bool_| (|domain#$Memory_175023| $1_SlidingNonce_SlidingNonce_$memory) addr@@35)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@35)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@35) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@35)) 1)))))
 :qid |XDXbpl.22973:20|
 :skolemid |787|
)))) (and (and (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (= (|Select__T@[Int]Bool_| (|domain#$Memory_179530| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@36)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@36) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@36)) 3))))
 :qid |XDXbpl.22977:20|
 :skolemid |788|
)) (forall ((addr@@37 Int) ) (!  (=> (|$IsValid'address'| addr@@37) (= (|Select__T@[Int]Bool_| (|domain#$Memory_178887| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@37)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@37) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@37)) 4))))
 :qid |XDXbpl.22981:20|
 :skolemid |789|
))) (and (forall ((addr@@38 Int) ) (!  (=> (|$IsValid'address'| addr@@38) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246564| $1_VASP_ParentVASP_$memory) addr@@38)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@38) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@38)) 5))))
 :qid |XDXbpl.22985:20|
 :skolemid |790|
)) (forall ((addr@@39 Int) ) (!  (=> (|$IsValid'address'| addr@@39) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246664| $1_VASP_ChildVASP_$memory) addr@@39)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@39) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@39)) 6))))
 :qid |XDXbpl.22989:20|
 :skolemid |791|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (|$IsValid'$1_FixedPoint32_FixedPoint32'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |XDXbpl.22998:20|
 :skolemid |792|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $a_0))
)))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0)))
 ...
 :qid |XDXbpl.23002:20|
 :skolemid |793|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t5 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_175430| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| _$t1))))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 397834) 399114) anon15_Then_correct) (=> (= (ControlFlow 0 397834) 397852) anon15_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 396837) 397834)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_198739| $t2)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_198739| $t11)) 0) (= (|l#Vec_23605| (|p#$Mutation_270500| $t12)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_167422| $t13)) 0) (= (ControlFlow 0 396847) 396837))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 532871) 396847) anon0_correct)))
