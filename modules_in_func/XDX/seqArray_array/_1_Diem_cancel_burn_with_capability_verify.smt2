...
(declare-fun $t9 () T@Vec_134349)
(declare-fun $t10 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2| () T@$Memory_193411)
...
(declare-fun $t24@2 () T@$Mutation_194232)
...
(declare-fun $t24@1 () T@$Mutation_194232)
...
(declare-fun $t24 () T@$Mutation_194232)
(declare-fun $t24@0 () T@$Mutation_194232)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1| () T@$Memory_193411)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0| () T@$Memory_193411)
...
(declare-fun $t6 () T@$Mutation_194232)
...
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@105 $i_1@@0))
 ...
 :qid |XDXbpl.10337:15|
 :skolemid |286|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491325)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)))
 :qid |XDXbpl.10342:15|
 :skolemid |287|
 ...
 :qid |XDXbpl.10342:15|
 :skolemid |287|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491350)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 345719) (- 0 491370)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@3))))
 :qid |XDXbpl.10352:15|
 :skolemid |288|
 ...
 :qid |XDXbpl.10352:15|
 :skolemid |288|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491399)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)))
 :qid |XDXbpl.10357:15|
 :skolemid |289|
 ...
 :qid |XDXbpl.10357:15|
 :skolemid |289|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491424)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@2|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 345719) (- 0 491444)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@7))))
 :qid |XDXbpl.10367:15|
 :skolemid |290|
))) (=> (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@8) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@8))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@8))))
 :qid |XDXbpl.10367:15|
 :skolemid |290|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491479)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@9)))
 :qid |XDXbpl.10372:15|
 :skolemid |291|
))) (=> (forall ((addr@@10 Int) ) (!  (=> (|$IsValid'address'| addr@@10) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@10) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory@2|) addr@@10)))
 :qid |XDXbpl.10372:15|
 :skolemid |291|
)) (and (=> (= (ControlFlow 0 345719) (- 0 491503)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t13 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |XDXbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 345719) (- 0 491538)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@1) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@1) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t11)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t13)))
...
(let ((anon33_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 346062) (- 0 490866)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_186082 (|Store__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t24@2)) (|v#$Mutation_194232| $t24@2)))) (and (=> (= (ControlFlow 0 346062) (- 0 490914)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.10161:83|
 :skolemid |277|
 ...
 :qid |XDXbpl.10167:15|
 :skolemid |278|
)) (and (=> (= (ControlFlow 0 346062) (- 0 490982)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)))
 :qid |XDXbpl.10173:15|
 :skolemid |279|
 ...
 :qid |XDXbpl.10173:15|
 :skolemid |279|
)) (and (=> (= (ControlFlow 0 346062) (- 0 491005)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) dr_addr)))
 :qid |XDXbpl.10179:15|
 :skolemid |280|
 ...
 :qid |XDXbpl.10179:15|
 :skolemid |280|
)) (and (=> (= (ControlFlow 0 346062) (- 0 491029)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 346062) (- 0 491053)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 346062) (- 0 491077)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es@0) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 346062) 345719)) L5_correct))))))))))))))))))))))
(let ((anon32_Else_correct  (=> (not inline$$Not$0$dst@1) (and (=> (= (ControlFlow 0 345236) (- 0 490387)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_186082 (|Store__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t24@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t24@2)) (|v#$Mutation_194232| $t24@2)))) (and (=> (= (ControlFlow 0 345236) (- 0 490435)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 :qid |XDXbpl.10227:83|
 :skolemid |281|
 ...
 :qid |XDXbpl.10233:15|
 :skolemid |282|
)) (and (=> (= (ControlFlow 0 345236) (- 0 490503)) (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@13) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XDXbpl.10239:15|
 :skolemid |283|
 ...
 :qid |XDXbpl.10239:15|
 :skolemid |283|
)) (and (=> (= (ControlFlow 0 345236) (- 0 490526)) (forall ((dr_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@1)))
 :qid |XDXbpl.10245:15|
 :skolemid |284|
 ...
 :qid |XDXbpl.10245:15|
 :skolemid |284|
)) (and (=> (= (ControlFlow 0 345236) (- 0 490550)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@5 Int) ) (!  (and (|$IsValid'address'| a@@5) (and ($1_Signer_is_txn_signer_addr a@@5) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@5)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 345236) (- 0 490574)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@7 Int) ) (!  (and (|$IsValid'address'| a@@7) (and ($1_Signer_is_txn_signer_addr a@@7) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@7)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
 ...
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 345236) (- 0 490598)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@9 Int) ) (!  (and (|$IsValid'address'| a@@9) (and ($1_Signer_is_txn_signer_addr a@@9) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@9) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@9)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
 ...
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (=> (= $es@1 $es) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= (ControlFlow 0 345236) 345719)) L5_correct))))))))))))))))))))))
(let ((L7_correct  (and (=> (= (ControlFlow 0 344763) (- 0 490695)) (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@1 ($Range 0 (|l#Vec_134349| $t9))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@106 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| $t9) i@@106)))) _$t2))))
 :qid |XDXbpl.10395:251|
 :skolemid |292|
))))) (=> (or (or (or (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))) (let (($range_0@@2 ($Range 0 (|l#Vec_134349| $t9))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@107 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| $t9) i@@107)))) _$t2))))
 :qid |XDXbpl.10395:251|
 :skolemid |292|
)))) (=> (= (ControlFlow 0 344763) (- 0 490761)) (or (or (or (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t8) _$t2) (= 8 $t17@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17@0))) (and (let (($range_0@@3 ($Range 0 (|l#Vec_134349| $t9))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@108 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| $t9) i@@108)))) _$t2))))
 :qid |XDXbpl.10400:336|
 :skolemid |293|
))) (= 1 $t17@0))))))))
(let ((anon33_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 346076) 344763))) L7_correct)))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 345816) 346076) anon33_Then_correct) (=> (= (ControlFlow 0 345816) 346062) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (and inline$$Not$0$dst@1 (= $t34@0 ($Mutation_167422 (|l#$Mutation_194232| $t24@2) (let ((l (|l#Vec_23605| (|p#$Mutation_194232| $t24@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_194232| $t24@2)) l 11) (+ l 1))) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))))) (and (= $t35@0 ($1_Diem_CancelBurnEvent _$t2 $t21 _$t0)) (= (ControlFlow 0 345822) 345816))) |inline$$1_Event_emit_event'$1_Diem_CancelBurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not $t32@0)) (and (=> (= (ControlFlow 0 344988) 345822) anon32_Then_correct) (=> (= (ControlFlow 0 344988) 345236) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not $abort_flag@1) (= $t31@0 ($Mutation_15070 (|l#$Mutation_194232| $t24@1) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_194232| $t24@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_194232| $t24@1)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1))))) (=> (and (and (= $t31@1 ($Mutation_15070 (|l#$Mutation_15070| $t31@0) (|p#$Mutation_15070| $t31@0) inline$$Sub$0$dst@2)) (= $t24@2 ($Mutation_194232 (|l#$Mutation_194232| $t24@1) (|p#$Mutation_194232| $t24@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|v#$Mutation_15070| $t31@1) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)))))) (and (= $t32@0 (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@2))) (= (ControlFlow 0 344994) 344988))) inline$$Not$0$anon0_correct))))
(let ((anon31_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= $t17@0 $abort_code@2) (= (ControlFlow 0 346090) 344763))) L7_correct)))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_flag@1 true) (=> (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 344904) 346090) anon31_Then_correct) (=> (= (ControlFlow 0 344904) 344994) anon31_Else_correct))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< $t29@0 _$t2) (= (ControlFlow 0 344902) 344904)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= _$t2 $t29@0) (=> (and (and (= inline$$Sub$0$dst@1 (- $t29@0 _$t2)) (= $abort_flag@1 $abort_flag@0)) (and (= $abort_code@2 $abort_code@1) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 344854) 346090) anon31_Then_correct) (=> (= (ControlFlow 0 344854) 344994) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> (and inline$$Ge$0$dst@1 (= $t29@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)))) (and (=> (= (ControlFlow 0 344910) 344902) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 344910) 344854) inline$$Sub$0$anon3_Else_correct)))))
(let ((anon30_Else_correct  (=> (not inline$$Ge$0$dst@1) (and (=> (= (ControlFlow 0 344581) (- 0 490155)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1)) 10000000000)) (=> (= $t28 $t28) (=> (and (= $t17@0 $t28) (= (ControlFlow 0 344581) 344763)) L7_correct)))))))
(let ((anon29_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t28) (= $t28 8)) (and (= $t28 $t28) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 344539) 344910) anon30_Then_correct) (=> (= (ControlFlow 0 344539) 344581) anon30_Else_correct))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= $t25@0 _$t2)) (= (ControlFlow 0 344503) 344539)) anon29_Else$1_correct)))
(let ((anon29_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_194232| $t24@1)) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|)) (and (= $t25@0 (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t24@1))) (= (ControlFlow 0 344509) 344503))) inline$$Ge$0$anon0_correct))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t17@0 $abort_code@1) (= (ControlFlow 0 346104) 344763))) L7_correct)))
(let ((anon28_Then$1_correct  (=> (= $t24@1 $t24) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 346156) 346104) anon29_Then_correct) (=> (= (ControlFlow 0 346156) 344509) anon29_Else_correct))))))
(let ((anon28_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 346154) 346156)) anon28_Then$1_correct)))
(let ((anon28_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t24@0 ($Mutation_194232 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t24@1 $t24@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 344437) 346104) anon29_Then_correct) (=> (= (ControlFlow 0 344437) 344509) anon29_Else_correct))))))
(let ((anon27_Else_correct  (=> (not $t22) (=> (and (and (|$IsValid'vec'u8''| $t21) (|$IsEqual'vec'u8''| $t21 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t21 $t21) (|$IsValid'address'| 173345816))) (and (=> (= (ControlFlow 0 344415) (- 0 489975)) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816) (and (=> (= (ControlFlow 0 344415) 346154) anon28_Then_correct) (=> (= (ControlFlow 0 344415) 344437) anon28_Else_correct))))))))
(let ((anon27_Then_correct  (=> $t22 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t17)) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 346182) 344763))) L7_correct))))
(let ((anon5_correct  (=> (and (and (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| $t15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t0))) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15))) _$t2) (= $t18@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| $t15)))) (and (and (= $t19@0 (|$metadata#$1_Diem_PreburnWithMetadata'#0'| $t15)) (= $t20@0 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0))) (and (= $t20@0 $t20@0) (= $t22  (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 344377) 346182) anon27_Then_correct) (=> (= (ControlFlow 0 344377) 344415) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (and (not |$temp_0'bool'@0|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_193411 (|Store__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 false) (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 344315) 344377))) anon5_correct)))
(let ((anon26_Then_correct  (=> (and (and |$temp_0'bool'@0| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_193411 (|Store__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0 |$temp_0'$1_Diem_PreburnQueue'#0''@0|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 346194) 344377))) anon5_correct)))
(let ((anon25_Else_correct  (=> (not $t16) (and (=> (= (ControlFlow 0 344303) 346194) anon26_Then_correct) (=> (= (ControlFlow 0 344303) 344315) anon26_Else_correct)))))
(let ((anon25_Then_correct  (=> $t16 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (= 5 $t17)) (and (let (($range_0@@4 ($Range 0 (|l#Vec_134349| $t14))))
(forall (($i_1@@4 Int) ) (!  (=> ($InRange $range_0@@4 $i_1@@4) (let ((i@@109 $i_1@@4))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| $t14) i@@109)))) _$t2))))
 :qid |XDXbpl.9917:151|
 :skolemid |276|
))) (= 1 $t17))) (= $t17 $t17)) (and (= $t17@0 $t17) (= (ControlFlow 0 346275) 344763))) L7_correct))))
(let ((anon0$1_correct  (=> (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@3 Int) (mint_cap_owner2@@3 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@3) (=> (|$IsValid'address'| mint_cap_owner2@@3) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@3)) (= mint_cap_owner1@@3 mint_cap_owner2@@3))))
 :qid |XDXbpl.9797:88|
 :skolemid |266|
))) (=> (and (forall ((addr3@@3 Int) ) (!  (=> (|$IsValid'address'| addr3@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr3@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.9801:20|
 :skolemid |267|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr1) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr1)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 2))))
 :qid |XDXbpl.9805:20|
 :skolemid |268|
))) (=> (and (and (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr)))))
 :qid |XDXbpl.9809:20|
 :skolemid |269|
)) (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))))
 :qid |XDXbpl.9813:20|
 :skolemid |270|
))) (and (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.9817:20|
 :skolemid |271|
)) (|$IsValid'address'| _$t0))) (=> (and (and (and (and (|$IsValid'$1_Diem_BurnCapability'#0''| _$t1) (|$IsValid'u64'| _$t2)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0)))
...
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@0)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@0) (and (<= (|l#Vec_134349| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)) 256) (let (($range_1 ($Range 0 (|l#Vec_134349| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@110 $i_2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@0)) i@@110)))) 0)))
 :qid |XDXbpl.9835:199|
 :skolemid |273|
))))))
 :qid |XDXbpl.9834:20|
 :skolemid |274|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@0))
)))) (and (and (= $t8 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t9 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)))) (and (= $t10 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t11 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t12 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t13 (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| $t11))) (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (|Select__T@[Int]Bool_| |$1_Diem_CurrencyInfo'#0'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= _$t2 _$t2) (= $t14 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0))))))) (and (=> (= (ControlFlow 0 344295) (- 0 489657)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| _$t0) (=> (= $t16  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) _$t0)) (let (($range_0@@5 ($Range 0 (|l#Vec_134349| $t14))))
(forall (($i_1@@5 Int) ) (!  (=> ($InRange $range_0@@5 $i_1@@5) (let ((i@@111 $i_1@@5))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_134349| $t14) i@@111)))) _$t2))))
 :qid |XDXbpl.9907:131|
 :skolemid |275|
))))) (and (=> (= (ControlFlow 0 344295) 346275) anon25_Then_correct) (=> (= (ControlFlow 0 344295) 344303) anon25_Else_correct)))))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 343769) 344295)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_194232| $t6)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_194232| $t24)) 0) (= (|l#Vec_23605| (|p#$Mutation_15070| $t31)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_167422| $t34)) 0) (= (ControlFlow 0 343779) 343769))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 489011) 343779) anon0_correct)))
