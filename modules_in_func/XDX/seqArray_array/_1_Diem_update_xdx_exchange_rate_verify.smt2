...
(declare-fun $t7 () Bool)
(declare-fun $t6 () Int)
(declare-fun $t11@2 () T@$Mutation_194232)
...
(declare-fun $t11@1 () T@$Mutation_194232)
...
(declare-fun $t11 () T@$Mutation_194232)
(declare-fun $t11@0 () T@$Mutation_194232)
...
(declare-fun $t2 () T@$Mutation_194232)
...
(assert (not
 (=> (= (ControlFlow 0 0) 530573) (let ((L2_correct  (and (=> (= (ControlFlow 0 396288) (- 0 532749)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 396288) (- 0 532789)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t8@0))))))))
(let ((anon20_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 396160) 396288))) L2_correct)))
(let ((anon19_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 396302) 396288))) L2_correct)))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 396316) 396288))) L2_correct)))
(let ((anon16_Then_correct  (=> $t9 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 396394) 396288))) L2_correct))))
(let ((anon15_Then_correct  (=> $t7 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t8))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 396466) 396288))) L2_correct))))
(let ((anon20_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 396146) (- 0 532132)) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2)) 10000000000))) (=> (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2))) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2)) 10000000000)) (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_186082 (|Store__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t11@2)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_194232| $t11@2)) (|v#$Mutation_194232| $t11@2)))) (and (=> (= (ControlFlow 0 396146) (- 0 532180)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |XDXbpl.22666:83|
 :skolemid |753|
 ...
 :qid |XDXbpl.22672:15|
 :skolemid |754|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532248)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XDXbpl.22678:15|
 :skolemid |755|
))) (=> (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)))
 :qid |XDXbpl.22678:15|
 :skolemid |755|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532271)) (forall ((dr_addr Int) ) (!  (=> (|$IsValid'address'| dr_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr)))
 :qid |XDXbpl.22684:15|
 :skolemid |756|
))) (=> (forall ((dr_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dr_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) dr_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) dr_addr@@0)))
 :qid |XDXbpl.22684:15|
 :skolemid |756|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532295)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a Int) ) (!  (and (|$IsValid'address'| a) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@0 Int) ) (!  (and (|$IsValid'address'| a@@0) (and ($1_Signer_is_txn_signer_addr a@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@0)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 396146) (- 0 532319)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@1 Int) ) (!  (and (|$IsValid'address'| a@@1) (and ($1_Signer_is_txn_signer_addr a@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@1)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (not (= (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (exists ((a@@2 Int) ) (!  (and (|$IsValid'address'| a@@2) (and ($1_Signer_is_txn_signer_addr a@@2) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@2)) 1))))
 :qid |XDXbpl.4772:13|
 :skolemid |143|
)))) (and (=> (= (ControlFlow 0 396146) (- 0 532343)) (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@3 Int) ) (!  (and (|$IsValid'address'| a@@3) (and ($1_Signer_is_txn_signer_addr a@@3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@3)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
)))) (=> (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (exists ((a@@4 Int) ) (!  (and (|$IsValid'address'| a@@4) (and ($1_Signer_is_txn_signer_addr a@@4) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) a@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) a@@4)) 0))))
 :qid |XDXbpl.4777:13|
 :skolemid |144|
))) (and (=> (= (ControlFlow 0 396146) (- 0 532365)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 396146) (- 0 532377)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 396146) (- 0 532395)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 396146) (- 0 532409)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 396146) (- 0 532419)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) _$t1) (and (=> (= (ControlFlow 0 396146) (- 0 532430)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 396146) (- 0 532450)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@1))))
 :qid |XDXbpl.22741:15|
 :skolemid |757|
 ...
 :qid |XDXbpl.22741:15|
 :skolemid |757|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532479)) (forall ((addr@@3 Int) ) (!  (=> (|$IsValid'address'| addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr@@3)))
 :qid |XDXbpl.22746:15|
 :skolemid |758|
 ...
 :qid |XDXbpl.22746:15|
 :skolemid |758|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532504)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 396146) (- 0 532524)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@5))))
 :qid |XDXbpl.22756:15|
 :skolemid |759|
 ...
 :qid |XDXbpl.22756:15|
 :skolemid |759|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532553)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_187100| |$1_Diem_BurnCapability'#0'_$memory|) addr@@7)))
 :qid |XDXbpl.22761:15|
 :skolemid |760|
 ...
 :qid |XDXbpl.22761:15|
 :skolemid |760|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532578)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 396146) (- 0 532598)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory@0|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 396146) (- 0 532618)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@9))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@9))))
 :qid |XDXbpl.22776:15|
 :skolemid |761|
 ...
 :qid |XDXbpl.22776:15|
 :skolemid |761|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532654)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@11)))
 :qid |XDXbpl.22781:15|
 :skolemid |762|
))) (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@12) (|Select__T@[Int]Bool_| (|domain#$Memory_193411| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@12)))
 :qid |XDXbpl.22781:15|
 :skolemid |762|
)) (and (=> (= (ControlFlow 0 396146) (- 0 532679)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $EmptyEventStore) $t4 stream_new@@0))))))
 ...
 :qid |XDXbpl.2965:13|
 :skolemid |106|
))))) (=> (= (ControlFlow 0 396146) (- 0 532704)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 395520) 396160) anon20_Then_correct) (=> (= (ControlFlow 0 395520) 396146) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t17@0 ($1_Diem_ToXDXExchangeRateUpdateEvent $t14@0 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 395526) 395520)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= $t15@0 $t15@0) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| $t15@0)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 395427) 396302) anon19_Then_correct) (=> (= (ControlFlow 0 395427) 395526) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $abort_flag@0) (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| (|v#$Mutation_194232| $t11@1))) (=> (and (and (and (= |$temp_0'$1_Diem_CurrencyInfo'#0''@0| |$temp_0'$1_Diem_CurrencyInfo'#0''@0|) (= $t12@0 ($Mutation_270500 (|l#$Mutation_194232| $t11@1) (let ((l (|l#Vec_23605| (|p#$Mutation_194232| $t11@1))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_194232| $t11@1)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1))))) (and (= $t12@1 ($Mutation_270500 (|l#$Mutation_270500| $t12@0) (|p#$Mutation_270500| $t12@0) _$t1)) (= $t11@2 ($Mutation_194232 (|l#$Mutation_194232| $t11@1) (|p#$Mutation_194232| $t11@1) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|v#$Mutation_270500| $t12@1) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@1))))))) (and (and (= $t13@0 ($Mutation_167422 (|l#$Mutation_194232| $t11@2) (let ((l@@0 (|l#Vec_23605| (|p#$Mutation_194232| $t11@2))))
(Vec_23605 (|Store__T@[Int]Int_| (|v#Vec_23605| (|p#$Mutation_194232| $t11@2)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2)))) (= $t14@0 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2)))) (and (= $t15@0 (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_194232| $t11@2))) (= (ControlFlow 0 395433) 395427)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((anon17_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 396368) 396316) anon18_Then_correct) (=> (= (ControlFlow 0 396368) 395433) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 396366) 396368)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= $t11@0 ($Mutation_194232 ($Global 173345816) (Vec_23605 (MapConstVec_14675 DefaultVecElem_14675) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 395252) 396316) anon18_Then_correct) (=> (= (ControlFlow 0 395252) 395433) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not $t9) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 395230) 396366) anon17_Then_correct) (=> (= (ControlFlow 0 395230) 395252) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not $t7) (= $t9  (not (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 395216) 396394) anon16_Then_correct) (=> (= (ControlFlow 0 395216) 395230) anon16_Else_correct)))))
(let ((anon0$1_correct  (=> (forall ((addr@@13 Int) ) (!  (=> (|$IsValid'address'| addr@@13) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@13)) 0)) (= addr@@13 173345816)))
 :qid |XDXbpl.22347:20|
 :skolemid |722|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_174154| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr@@14) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr@@14)) 1)) (= addr@@14 186537453)))
 :qid |XDXbpl.22355:20|
 :skolemid |723|
 ...
 :qid |XDXbpl.22403:20|
 :skolemid |734|
))))) (=> (and (and (and (and (and (let (($range_0 ($Range 0 (|l#Vec_134004| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@26 173345816))
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_175202| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@27))))) i1)))) 3))))
 ...
 :qid |XDXbpl.22412:88|
 :skolemid |736|
)))) (and (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186646| |$1_Diem_MintCapability'#0'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |XDXbpl.22416:20|
 :skolemid |737|
)) (forall ((addr@@28 Int) ) (!  (=> (|$IsValid'address'| addr@@28) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_192927| |$1_Diem_Preburn'#0'_$memory|) addr@@28) (|Select__T@[Int]Bool_| (|domain#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |XDXbpl.22420:20|
 :skolemid |738|
)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_245605| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |XDXbpl.22424:20|
 :skolemid |739|
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
...
)))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0)))
 ...
 :qid |XDXbpl.22481:20|
 :skolemid |752|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0))) (and (= $t4 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t5 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_186082| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| _$t1))))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_174836| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))))) (and (=> (= (ControlFlow 0 395198) 396466) anon15_Then_correct) (=> (= (ControlFlow 0 395198) 395216) anon15_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_133706_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |XDXbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 394211) 395198)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_23605| (|p#$Mutation_194232| $t2)) 0) (=> (and (and (= (|l#Vec_23605| (|p#$Mutation_194232| $t11)) 0) (= (|l#Vec_23605| (|p#$Mutation_270500| $t12)) 0)) (and (= (|l#Vec_23605| (|p#$Mutation_167422| $t13)) 0) (= (ControlFlow 0 394221) 394211))) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 530573) 394221) anon0_correct)))
