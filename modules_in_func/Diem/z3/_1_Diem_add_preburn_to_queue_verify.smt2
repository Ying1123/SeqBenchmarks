...
(assert (not
 (=> (= (ControlFlow 0 0) 804924) (let ((anon29_Else_correct  (=> (and (not $abort_flag@0@@4) (= $t25@2 ($Mutation_270395 (|l#$Mutation_270395| $t25@1) (|p#$Mutation_270395| $t25@1) (|$1_Diem_PreburnQueue'#0'| (|v#$Mutation_224513| |inline$$1_Vector_push_back'$1_Diem_PreburnWithMetadata'#0''$0$m'@1|))))) (and (=> (= (ControlFlow 0 539656) (- 0 806082)) (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2))) 256)) (=> (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2))) 256) (and (=> (= (ControlFlow 0 539656) (- 0 806096)) (let (($range_0@@0 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2))))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@44 $i_1@@0))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2)) i@@44)))) 0)))
 :qid |Diembpl.7471:107|
 :skolemid |271|
)))) (=> (let (($range_0@@1 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@45 $i_1@@1))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@2)) i@@45)))) 0)))
 :qid |Diembpl.7471:107|
 :skolemid |271|
))) (=> (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_262370 (|Store__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) (|a#$Global| (|l#$Mutation_270395| $t25@2)) true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) (|a#$Global| (|l#$Mutation_270395| $t25@2)) (|v#$Mutation_270395| $t25@2)))) (and (=> (= (ControlFlow 0 539656) (- 0 806171)) (forall ((addr1@@3 Int) ) (!  (=> (|$IsValid'address'| addr1@@3) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) addr1@@3) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr1@@3)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@3) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@3)) 2))))
 :qid |Diembpl.7488:15|
 :skolemid |272|
))) (=> (forall ((addr1@@4 Int) ) (!  (=> (|$IsValid'address'| addr1@@4) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) addr1@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr1@@4)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@4)) 2))))
 :qid |Diembpl.7488:15|
 :skolemid |272|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806204)) (forall ((dd_addr Int) ) (!  (=> (|$IsValid'address'| dd_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) dd_addr)))))
 :qid |Diembpl.7494:15|
 :skolemid |273|
))) (=> (forall ((dd_addr@@0 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@0))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) dd_addr@@0)))))
 :qid |Diembpl.7494:15|
 :skolemid |273|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806247)) (forall ((dd_addr@@1 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) dd_addr@@1) (not (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@1))))
 :qid |Diembpl.7500:15|
 :skolemid |274|
))) (=> (forall ((dd_addr@@2 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@2) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) dd_addr@@2) (not (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@2))))
 :qid |Diembpl.7500:15|
 :skolemid |274|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806274)) (forall ((tc_addr Int) ) (!  (=> (|$IsValid'address'| tc_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) tc_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) tc_addr)))
 :qid |Diembpl.7506:15|
 :skolemid |275|
))) (=> (forall ((tc_addr@@0 Int) ) (!  (=> (|$IsValid'address'| tc_addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) tc_addr@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) tc_addr@@0)))
 :qid |Diembpl.7506:15|
 :skolemid |275|
)) (=> (= $t33 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) $t10))) (and (=> (= (ControlFlow 0 539656) (- 0 806315)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10))) (and (=> (= (ControlFlow 0 539656) (- 0 806327)) (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) 0))) (=> (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) 0)) (and (=> (= (ControlFlow 0 539656) (- 0 806343)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12) (>= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12))) 256)))) (=> (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12) (>= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12))) 256))) (and (=> (= (ControlFlow 0 539656) (- 0 806368)) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) $t10)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) $t10) (and (=> (= (ControlFlow 0 539656) (- 0 806376)) (and (and (= (seq.len $t33) (+ (seq.len $t11) 1)) (= (seq.nth $t33 (- (seq.len $t33) 1)) _$t1@@0)) (= (seq.extract $t33 (|lb#$Range| ($Range 0 (- (seq.len $t33) 1))) (- (|ub#$Range| ($Range 0 (- (seq.len $t33) 1))) (|lb#$Range| ($Range 0 (- (seq.len $t33) 1))))) (seq.extract $t11 (|lb#$Range| ($Range 0 (seq.len $t11))) (- (|ub#$Range| ($Range 0 (seq.len $t11))) (|lb#$Range| ($Range 0 (seq.len $t11)))))))) (=> (and (and (= (seq.len $t33) (+ (seq.len $t11) 1)) (= (seq.nth $t33 (- (seq.len $t33) 1)) _$t1@@0)) (= (seq.extract $t33 (|lb#$Range| ($Range 0 (- (seq.len $t33) 1))) (- (|ub#$Range| ($Range 0 (- (seq.len $t33) 1))) (|lb#$Range| ($Range 0 (- (seq.len $t33) 1))))) (seq.extract $t11 (|lb#$Range| ($Range 0 (seq.len $t11))) (- (|ub#$Range| ($Range 0 (seq.len $t11))) (|lb#$Range| ($Range 0 (seq.len $t11))))))) (and (=> (= (ControlFlow 0 539656) (- 0 806386)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 539656) (- 0 806407)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@123)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@123))))
 :qid |Diembpl.7549:15|
 :skolemid |276|
))) (=> (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@124)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@124))))
 :qid |Diembpl.7549:15|
 :skolemid |276|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806436)) (forall ((addr@@125 Int) ) (!  (=> (|$IsValid'address'| addr@@125) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@125) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@125)))
 :qid |Diembpl.7554:15|
 :skolemid |277|
))) (=> (forall ((addr@@126 Int) ) (!  (=> (|$IsValid'address'| addr@@126) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@126) (|Select__T@[Int]Bool_| (|domain#$Memory_256377| |$1_Diem_MintCapability'#0'_$memory|) addr@@126)))
 :qid |Diembpl.7554:15|
 :skolemid |277|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806461)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 539656) (- 0 806482)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@127)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@127))))
 :qid |Diembpl.7564:15|
 :skolemid |278|
))) (=> (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@128)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@128))))
 :qid |Diembpl.7564:15|
 :skolemid |278|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806511)) (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@129) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@129)))
 :qid |Diembpl.7569:15|
 :skolemid |279|
))) (=> (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@130) (|Select__T@[Int]Bool_| (|domain#$Memory_256870| |$1_Diem_BurnCapability'#0'_$memory|) addr@@130)))
 :qid |Diembpl.7569:15|
 :skolemid |279|
)) (and (=> (= (ControlFlow 0 539656) (- 0 806536)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (>= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 539656) (- 0 806557)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (<= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_255740| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 539656) (- 0 806578)) (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@131) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@131))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) addr@@131))))
 :qid |Diembpl.7584:15|
 :skolemid |280|
))) (=> (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (=> (not (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@132) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr@@132))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) addr@@132))))
 :qid |Diembpl.7584:15|
 :skolemid |280|
)) (=> (= (ControlFlow 0 539656) (- 0 806613)) (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr@@133) (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory@0|) addr@@133)))
 :qid |Diembpl.7589:15|
 :skolemid |281|
))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon23_Then_correct true))
(let ((L7_correct  (and (=> (= (ControlFlow 0 538518) (- 0 805949)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10)) (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12) (>= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12))) 256)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10)) (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12) (>= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12))) 256))) (=> (= (ControlFlow 0 538518) (- 0 805991)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10)) (= 1 $t17@0)) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) 0) (= 7 $t17@0))) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12) (>= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t12))) 256)) (= 8 $t17@0))))))))
(let ((anon29_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t17@0 $abort_code@1@@4) (= (ControlFlow 0 539670) 538518))) L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_Diem_PreburnWithMetadata'#0''$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_Diem_PreburnWithMetadata'#0''$0$m'@1| ($Mutation_224513 (|l#$Mutation_224513| $t26@0) (|p#$Mutation_224513| $t26@0) (seq.++ (|v#$Mutation_224513| $t26@0) (seq.unit _$t1@@0)))) (and (=> (= (ControlFlow 0 539071) 539670) anon29_Then_correct) (=> (= (ControlFlow 0 539071) 539656) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 539077) 539071)) |inline$$1_Vector_push_back'$1_Diem_PreburnWithMetadata'#0''$0$anon0_correct|)))
(let ((anon28_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 539016) (- 0 805810)) (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))) 256)) (=> (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))) 256) (and (=> (= (ControlFlow 0 539016) (- 0 805824)) (let (($range_0@@2 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@46 $i_1@@2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1)) i@@46)))) 0)))
 :qid |Diembpl.7429:107|
 :skolemid |270|
)))) (=> (let (($range_0@@3 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@47 $i_1@@3))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1)) i@@47)))) 0)))
 :qid |Diembpl.7429:107|
 :skolemid |270|
))) (=> (= $t32 $t32) (=> (and (= $t17@0 $t32) (= (ControlFlow 0 539016) 538518)) L7_correct)))))))))
(let ((anon27_Else$1_correct  (=> (|$IsValid'u64'| 11) (=> (and (and (|$IsValid'u64'| $t32) (= $t32 8)) (and (= $t32 $t32) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 538933) 539077) anon28_Then_correct) (=> (= (ControlFlow 0 538933) 539016) anon28_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_Diem_PreburnWithMetadata'#0''$0$l@1| 256)) (= (ControlFlow 0 538893) 538933)) anon27_Else$1_correct)))
(let ((anon27_Else_correct  (=> (not $abort_flag@0@@4) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 538899) 538893)) inline$$Lt$0$anon0_correct))))
(let ((anon27_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t17@0 $abort_code@1@@4) (= (ControlFlow 0 539684) 538518))) L7_correct)))
(let ((|inline$$1_Vector_length'$1_Diem_PreburnWithMetadata'#0''$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_Diem_PreburnWithMetadata'#0''$0$l@1| (seq.len $t27@0)) (and (=> (= (ControlFlow 0 538833) 539684) anon27_Then_correct) (=> (= (ControlFlow 0 538833) 538899) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not $abort_flag@0@@4) (= $t26@0 ($Mutation_224513 (|l#$Mutation_270395| $t25@1) (seq.++ (|p#$Mutation_270395| $t25@1) (seq.unit 0)) (|$preburns#$1_Diem_PreburnQueue'#0'| (|v#$Mutation_270395| $t25@1))))) (=> (and (and (= |$temp_0'vec'$1_Diem_PreburnWithMetadata'#0'''@0| (|v#$Mutation_224513| $t26@0)) (= |$temp_0'vec'$1_Diem_PreburnWithMetadata'#0'''@0| |$temp_0'vec'$1_Diem_PreburnWithMetadata'#0'''@0|)) (and (= $t27@0 (|v#$Mutation_224513| $t26@0)) (= (ControlFlow 0 538839) 538833))) |inline$$1_Vector_length'$1_Diem_PreburnWithMetadata'#0''$0$anon0_correct|))))
(let ((anon26_Then_correct  (=> (and (and $abort_flag@0@@4 (= $abort_code@1@@4 $abort_code@1@@4)) (and (= $t17@0 $abort_code@1@@4) (= (ControlFlow 0 539698) 538518))) L7_correct)))
(let ((anon25_Then$1_correct  (=> (= $t25@1 $t25) (=> (and (= $abort_flag@0@@4 true) (= $abort_code@1@@4 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 539750) 539698) anon26_Then_correct) (=> (= (ControlFlow 0 539750) 538839) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13)) (= (ControlFlow 0 539748) 539750)) anon25_Then$1_correct)))
(let ((anon25_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13) (=> (and (and (= $t25@0 ($Mutation_270395 ($Global $t13) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13))) (= $t25@1 $t25@0)) (and (= $abort_flag@0@@4 false) (= $abort_code@1@@4 $abort_code@0@@4))) (and (=> (= (ControlFlow 0 538767) 539698) anon26_Then_correct) (=> (= (ControlFlow 0 538767) 538839) anon26_Else_correct))))))
(let ((anon24_Then_correct  (=> inline$$Gt$0$dst@1 (and (=> (= (ControlFlow 0 538745) (- 0 805564)) (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t13)) (=> (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t13) (and (=> (= (ControlFlow 0 538745) 539748) anon25_Then_correct) (=> (= (ControlFlow 0 538745) 538767) anon25_Else_correct)))))))
(let ((anon24_Else_correct  (=> (and (and (not inline$$Gt$0$dst@1) (= $t24 $t24)) (and (= $t17@0 $t24) (= (ControlFlow 0 538735) 538518))) L7_correct)))
(let ((anon23_Else$1_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| $t24) (= $t24 7)) (and (= $t24 $t24) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 538719) 538745) anon24_Then_correct) (=> (= (ControlFlow 0 538719) 538735) anon24_Else_correct))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_value'#0'$0$$t1@1| 0)) (= (ControlFlow 0 538683) 538719)) anon23_Else$1_correct)))
(let ((anon23_Else_correct  (=> (not false) (=> (and (|$IsValid'u64'| 0) (= (ControlFlow 0 538689) 538683)) inline$$Gt$0$anon0_correct))))
(let ((|inline$$1_Diem_value'#0'$0$anon0_correct|  (=> (= $t19@0 $t19@0) (=> (and (= |inline$$1_Diem_value'#0'$0$$t1@1| (|$value#$1_Diem_Diem'#0'| $t19@0)) (= |inline$$1_Diem_value'#0'$0$$t1@1| |inline$$1_Diem_value'#0'$0$$t1@1|)) (and (=> (= (ControlFlow 0 538623) 539764) anon23_Then_correct) (=> (= (ControlFlow 0 538623) 538689) anon23_Else_correct))))))
(let ((anon22_Then_correct  (=> (and (and $t14@0 (= $t18@0 (|$preburn#$1_Diem_PreburnWithMetadata'#0'| _$t1@@0))) (and (= $t19@0 (|$to_burn#$1_Diem_Preburn'#0'| $t18@0)) (= (ControlFlow 0 538629) 538623))) |inline$$1_Diem_value'#0'$0$anon0_correct|)))
(let ((anon22_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t17@0 $t16) (= (ControlFlow 0 538394) 538518))) L7_correct)))
(let ((anon0$1_correct@@5  (=> (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) addr1@@5) (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) addr1@@5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_247001| $1_Roles_RoleId_$memory) addr1@@5)) 2))))
 :qid |Diembpl.7168:20|
 :skolemid |265|
)) (=> (and (forall ((dd_addr@@3 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@3) (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|Select__T@[Int]$1_Diem_Preburn'#0'_| (|contents#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@3))) 0) (not (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@3)))))
 :qid |Diembpl.7172:20|
 :skolemid |266|
)) (forall ((dd_addr@@4 Int) ) (!  (=> (|$IsValid'address'| dd_addr@@4) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) dd_addr@@4) (not (|Select__T@[Int]Bool_| (|domain#$Memory_261945| |$1_Diem_Preburn'#0'_$memory|) dd_addr@@4))))
 :qid |Diembpl.7176:20|
 :skolemid |267|
))) (=> (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| _$t1@@0)) (=> (and (and (and (and (forall (($a_0@@7 Int) ) (! (let (($rsc@@7 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@7)))
 (and (|$IsValid'$1_Diem_PreburnQueue'#0''| $rsc@@7) (and (<= (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@7)) 256) (let (($range_1 ($Range 0 (seq.len (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@7)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@48 $i_2))
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (seq.nth (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@7) i@@48)))) 0)))
 :qid |Diembpl.7186:199|
 :skolemid |268|
))))))
 :qid |Diembpl.7185:20|
 :skolemid |269|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@7))
)) (= $t10 (|$addr#$signer| _$t0@@2))) (and (= $t11 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t10))) (= $t12 (|$addr#$signer| _$t0@@2)))) (and (and (|Select__T@[Int]Bool_| |$1_Diem_PreburnQueue'#0'_$modifies| $t10) (= _$t0@@2 _$t0@@2)) (and (= _$t1@@0 _$t1@@0) (|$IsValid'address'| $t13)))) (and (and (and (= $t13 (|$addr#$signer| _$t0@@2)) (= $t13 $t13)) (and (= $t14@0 (|Select__T@[Int]Bool_| (|domain#$Memory_262370| |$1_Diem_PreburnQueue'#0'_$memory|) $t13)) (|$IsValid'u64'| 11))) (and (and (|$IsValid'u64'| $t16) (= $t16 1)) (and (= $t16 $t16) (= $t14@0 $t14@0))))) (and (=> (= (ControlFlow 0 538378) 538629) anon22_Then_correct) (=> (= (ControlFlow 0 538378) 538394) anon22_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@7 T@$1_Event_EventHandle) ) (! (let ((stream@@6 (|Select__T@[$1_Event_EventHandle]Multiset_215979_| (|streams#$EventStore| $es) handle@@7)))
 (and (= (|l#Multiset_215979| stream@@6) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_215979| stream@@6) v@@44) 0)
 :qid |Diembpl.134:13|
 :skolemid |2|
))))
 :qid |Diembpl.2732:13|
 :skolemid |74|
))) (= (ControlFlow 0 538042) 538378)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (and (and (= (seq.len (|p#$Mutation_224513| $t9@@0)) 0) (= (seq.len (|p#$Mutation_270395| $t25)) 0)) (and (= (seq.len (|p#$Mutation_224513| $t26)) 0) (= (ControlFlow 0 538052) 538042))) inline$$InitEventStore$0$anon0_correct@@5)))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 804924) 538052) anon0_correct@@5)))
