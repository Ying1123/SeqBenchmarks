...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| () Int)
(declare-fun $es@1 () T@$EventStore)
(declare-fun $abort_flag@1 () Bool)
(declare-fun $abort_code@2 () Int)
(declare-fun $es@0 () T@$EventStore)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0| () Int)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3| () T@$Mutation_230993)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| () T@Vec_25263)
(declare-fun inline$$1_FixedPoint32_get_raw_value$0$$t1@1 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| () T@$Mutation_248284)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| () T@$Mutation_248284)
(declare-fun $t20 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1| () T@$Mutation_230993)
(declare-fun MapConstVec_16957 (Int) |T@[Int]Int|)
(declare-fun DefaultVecElem_16957 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0| () T@$Mutation_248284)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t3@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t4@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t5@0| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_update_exchange_rate$verify)
(assert (not
 (=> (= (ControlFlow 0 0) 725396) (let ((L2_correct  (and (=> (= (ControlFlow 0 593436) (- 0 728126)) (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 593436) (- 0 728257)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t13@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t13@0))) (and (= $t7 0) (= 7 $t13@0))) (and (and (= $t8 0) (not (= $t6 0))) (= 7 $t13@0))) (and (> $t8 18446744073709551615) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (= 7 $t13@0)) (= 2 $t13@0)) (= 8 $t13@0)) (= 3 $t13@0)) (= 5 $t13@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t13@0 $abort_code@3) (= (ControlFlow 0 593008) 593436))) L2_correct)))
(let ((anon9_Then_correct  (=> $t21 (=> (and (and (or (or (and (= $t18 0) (= 7 $t13)) (and (and (= $t19 0) (not (= $t17 0))) (= 7 $t13))) (and (> $t19 18446744073709551615) (= 8 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 593504) 593436))) L2_correct))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 593518) 593436))) L2_correct)))
(let ((anon10_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 592994) (- 0 727882)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 592994) (- 0 727895)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 592994) (- 0 727910)) (not (= $t7 0))) (=> (not (= $t7 0)) (and (=> (= (ControlFlow 0 592994) (- 0 727921)) (not (and (= $t8 0) (not (= $t6 0))))) (=> (not (and (= $t8 0) (not (= $t6 0)))) (and (=> (= (ControlFlow 0 592994) (- 0 727942)) (not (> $t8 18446744073709551615))) (=> (not (> $t8 18446744073709551615)) (and (=> (= (ControlFlow 0 592994) (- 0 727953)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 592994) (- 0 727965)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 592994) (- 0 727983)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 592994) (- 0 727997)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 592994) (- 0 728007)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 592994) (- 0 728019)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 592994) (- 0 728037)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 592994) (- 0 728051)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) $t5)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@1|) 173345816)) $t5) (and (=> (= (ControlFlow 0 592994) (- 0 728063)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 592994) (- 0 728088)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
...
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|  (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| |$1_Diem_CurrencyInfo'#0'_$memory|) (= $abort_code@3 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1|)) (and (= $es@2 $es@1) (= $abort_flag@2 true))) (and (=> (= (ControlFlow 0 592566) 593008) anon10_Then_correct) (=> (= (ControlFlow 0 592566) 592994) anon10_Else_correct)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es@0)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 592560) 592566))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 592580) 592566))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 592594) 592566))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|  (=> |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= (ControlFlow 0 592672) 592566))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|  (=> (and |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) 1)) (= 3 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)))) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= (ControlFlow 0 592744) 592566))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|  (=> (and (not $abort_flag@1) (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_211162 (|Store__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)) (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|))))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| |$1_Diem_CurrencyInfo'#0'_$memory@0|) (= $abort_code@3 $abort_code@2)) (and (= $es@2 $es@0) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 592546) 593008) anon10_Then_correct) (=> (= (ControlFlow 0 592546) 592994) anon10_Else_correct))))))
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 592518) 592560) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 592518) 592546) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1| ($1_Diem_ToXDXExchangeRateUpdateEvent |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 592524) 592518)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1|) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1|)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 592425) 592580) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 592425) 592524) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| ($Mutation_248284 (|l#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (let ((l (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| ($Mutation_248284 (|l#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1|) (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1|) $t20)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3| ($Mutation_230993 (|l#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|v#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))))))) (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| ($Mutation_199923 (|l#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|))) (= (ControlFlow 0 592431) 592425)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0|)) (and (=> (= (ControlFlow 0 592646) 592594) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 592646) 592431) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 592644) 592646)) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|)))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1| ($Mutation_230993 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1|))) (and (=> (= (ControlFlow 0 592250) 592594) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 592250) 592431) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 592228) 592644) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 592228) 592250) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 592214) 592672) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 592214) 592228) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0|)) 0) (=> (and (= (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0|)) 0)) (=> (and (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0|)) 0) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t3@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t4@0| (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t5@0| ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))))) (and (and (= _$t0 _$t0) (= $t20 $t20)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 592196) 592744) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 592196) 592214) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|)))))))
(let ((anon9_Else_correct  (=> (and (and (and (not $t21) (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t20)) (and (= $t20 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t20 $t20))) (and (and (= $t22 (|$addr#$signer| _$t0)) (= $t23 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t24 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))) (= (ControlFlow 0 592748) 592196)))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t14 ($shl _$t2 64))) (and (= $t15 ($shl _$t3 32)) (= $t16 (div $t14 $t15)))) (and (and (= $t17 ($shl _$t2 64)) (= $t18 ($shl _$t3 32))) (and (= $t19 (div $t17 $t18)) (= $t21  (or (or (= $t18 0) (and (= $t19 0) (not (= $t17 0)))) (> $t19 18446744073709551615)))))) (and (=> (= (ControlFlow 0 591301) 593504) anon9_Then_correct) (=> (= (ControlFlow 0 591301) 592748) anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 591129) 593518) anon8_Then_correct) (=> (= (ControlFlow 0 591129) 591301) anon8_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 591123) 591129))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 591179) 591129))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 591135) 593518) anon8_Then_correct) (=> (= (ControlFlow 0 591135) 591301) anon8_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 591107) 591135) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 591107) 591123) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 591041) 591107))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 591149) 591107))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 591027) 591149) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 591027) 591041) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 591021) 591179) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 591021) 591027) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |TreasuryComplianceScriptsbpl.32670:20|
 :skolemid |1170|
 ...
 :qid |TreasuryComplianceScriptsbpl.32678:20|
 :skolemid |1171|
 ...
 :qid |TreasuryComplianceScriptsbpl.32686:20|
 :skolemid |1172|
 ...
 :qid |TreasuryComplianceScriptsbpl.32690:20|
 :skolemid |1173|
 ...
 :qid |TreasuryComplianceScriptsbpl.32694:20|
 :skolemid |1174|
 ...
 :qid |TreasuryComplianceScriptsbpl.32698:20|
 :skolemid |1175|
 ...
 :qid |TreasuryComplianceScriptsbpl.32702:20|
 :skolemid |1176|
 ...
 :qid |TreasuryComplianceScriptsbpl.32706:20|
 :skolemid |1177|
 ...
 :qid |TreasuryComplianceScriptsbpl.32710:20|
 :skolemid |1178|
 ...
 :qid |TreasuryComplianceScriptsbpl.32714:20|
 :skolemid |1179|
 ...
 :qid |TreasuryComplianceScriptsbpl.32718:20|
 :skolemid |1180|
 ...
 :qid |TreasuryComplianceScriptsbpl.32722:20|
 :skolemid |1181|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_208943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.32738:151|
 :skolemid |1183|
 ...
 :qid |TreasuryComplianceScriptsbpl.32743:88|
 :skolemid |1184|
 ...
 :qid |TreasuryComplianceScriptsbpl.32747:20|
 :skolemid |1185|
)) (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218047| |$1_Diem_Preburn'#0'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.32751:20|
 :skolemid |1186|
 ...
 :qid |TreasuryComplianceScriptsbpl.32755:20|
 :skolemid |1187|
 ...
 :qid |TreasuryComplianceScriptsbpl.32759:20|
 :skolemid |1188|
 ...
 :qid |TreasuryComplianceScriptsbpl.32763:20|
 :skolemid |1189|
 ...
 :qid |TreasuryComplianceScriptsbpl.32767:20|
 :skolemid |1190|
 ...
 :qid |TreasuryComplianceScriptsbpl.32771:20|
 :skolemid |1191|
 ...
 :qid |TreasuryComplianceScriptsbpl.32775:20|
 :skolemid |1192|
 ...
 :qid |TreasuryComplianceScriptsbpl.32779:20|
 :skolemid |1193|
 ...
 :qid |TreasuryComplianceScriptsbpl.32783:20|
 :skolemid |1194|
 ...
 :qid |TreasuryComplianceScriptsbpl.32787:20|
 :skolemid |1195|
 ...
 :qid |TreasuryComplianceScriptsbpl.32791:20|
 :skolemid |1196|
 ...
 :qid |TreasuryComplianceScriptsbpl.32795:20|
 :skolemid |1197|
 ...
 :qid |TreasuryComplianceScriptsbpl.32799:20|
 :skolemid |1198|
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.32814:20|
 :skolemid |1199|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.32818:20|
 :skolemid |1200|
 ...
 :qid |TreasuryComplianceScriptsbpl.32822:20|
 :skolemid |1201|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@1))
))) (and (= $t5 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t6 ($shl _$t2 64)))) (and (and (= $t7 ($shl _$t3 32)) (= $t8 (div $t6 $t7))) (and (= $t9 (|$addr#$signer| _$t0)) (= $t10 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (and (and (= $t11 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t5))) (= $t12 (|$addr#$signer| _$t0))) (and (let ((addr@@26 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@26)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 591183) 591021)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 589606) 591183)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 725396) 589606) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
