...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| () Int)
(declare-fun $es@1 () T@$EventStore)
(declare-fun $abort_flag@1 () Bool)
(declare-fun $abort_code@2 () Int)
(declare-fun $es@0 () T@$EventStore)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t9@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t7@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0| () Int)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3| () T@$Mutation_228843)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t13@1| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t17@1| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t14@1| () T@Vec_25263)
(declare-fun inline$$1_FixedPoint32_get_raw_value$0$$t1@1 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t15@1| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@1| () T@$Mutation_248284)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@2| () T@$Mutation_248284)
(declare-fun $t20 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@0| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@1| () T@$Mutation_228843)
(declare-fun MapConstVec_16957 (Int) |T@[Int]Int|)
(declare-fun DefaultVecElem_16957 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t2@0| () T@$Mutation_228843)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@0| () T@$Mutation_248284)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t13@0| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t3@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t4@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t5@0| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_update_exchange_rate$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 731660) (let ((L2_correct  (and (=> (= (ControlFlow 0 602092) (- 0 734400)) (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 602092) (- 0 734531)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t13@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t13@0))) (and (= $t7 0) (= 7 $t13@0))) (and (and (= $t8 0) (not (= $t6 0))) (= 7 $t13@0))) (and (> $t8 18446744073709551615) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (= 7 $t13@0)) (= 2 $t13@0)) (= 8 $t13@0)) (= 3 $t13@0)) (= 5 $t13@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t13@0 $abort_code@3) (= (ControlFlow 0 601664) 602092))) L2_correct)))
(let ((anon9_Then_correct  (=> $t21 (=> (and (and (or (or (and (= $t18 0) (= 7 $t13)) (and (and (= $t19 0) (not (= $t17 0))) (= 7 $t13))) (and (> $t19 18446744073709551615) (= 8 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 602160) 602092))) L2_correct))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 602174) 602092))) L2_correct)))
(let ((anon10_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 601650) (- 0 734156)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 601650) (- 0 734169)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 601650) (- 0 734184)) (not (= $t7 0))) (=> (not (= $t7 0)) (and (=> (= (ControlFlow 0 601650) (- 0 734195)) (not (and (= $t8 0) (not (= $t6 0))))) (=> (not (and (= $t8 0) (not (= $t6 0)))) (and (=> (= (ControlFlow 0 601650) (- 0 734216)) (not (> $t8 18446744073709551615))) (=> (not (> $t8 18446744073709551615)) (and (=> (= (ControlFlow 0 601650) (- 0 734227)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 601650) (- 0 734239)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 601650) (- 0 734257)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 601650) (- 0 734271)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 601650) (- 0 734281)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 601650) (- 0 734293)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 601650) (- 0 734311)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 601650) (- 0 734325)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1|) 173345816)) $t5)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1|) 173345816)) $t5) (and (=> (= (ControlFlow 0 601650) (- 0 734337)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
...
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 601650) (- 0 734362)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
...
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|  (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (= $abort_code@3 |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1|)) (and (= $es@2 $es@1) (= $abort_flag@2 true))) (and (=> (= (ControlFlow 0 601222) 601664) anon10_Then_correct) (=> (= (ControlFlow 0 601222) 601650) anon10_Else_correct)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon19_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es@0)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 601216) 601222))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon18_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 601236) 601222))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 601250) 601222))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon15_Then_correct|  (=> |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t9@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|)) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|) (= (ControlFlow 0 601328) 601222))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon14_Then_correct|  (=> (and |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t7@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0|)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0|)) 1)) (= 3 |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|)))) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t8@0|) (= (ControlFlow 0 601400) 601222))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon19_Else_correct|  (=> (and (not $abort_flag@1) (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| ($Memory_211043 (|Store__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) (|a#$Global| (|l#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|)) (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|))))) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0|) (= $abort_code@3 $abort_code@2)) (and (= $es@2 $es@0) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 601202) 601664) anon10_Then_correct) (=> (= (ControlFlow 0 601202) 601650) anon10_Else_correct))))))
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t13@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t17@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t17@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 601174) 601216) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 601174) 601202) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon19_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon18_Else_correct|  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t17@1| ($1_Diem_ToXDXExchangeRateUpdateEvent |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t14@1| inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 601180) 601174)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t15@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t15@1|) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t15@1|)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 601081) 601236) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 601081) 601180) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon18_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XDX_XDX''@1|) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@1| ($Mutation_248284 (|l#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|) (let ((l (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|))))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@2| ($Mutation_248284 (|l#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@1|) (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@1|) $t20)) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3| ($Mutation_228843 (|l#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|) (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|) (|$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|$total_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|v#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@2|) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2|))))))) (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t13@1| ($Mutation_199923 (|l#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|)))) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t14@1| (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t15@1| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|v#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@3|))) (= (ControlFlow 0 601087) 601081)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@0|)) (and (=> (= (ControlFlow 0 601302) 601250) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 601302) 601087) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= (ControlFlow 0 601300) 601302)) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Then$1_correct|)))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@1| ($Mutation_228843 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@1|))) (and (=> (= (ControlFlow 0 600906) 601250) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 600906) 601087) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon15_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t9@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 600884) 601300) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 600884) 600906) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon14_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t7@0|) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t9@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 600870) 601328) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 600870) 600884) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t2@0|)) 0) (=> (and (= (|l#Vec_25263| (|p#$Mutation_228843| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t11@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t12@0|)) 0)) (=> (and (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t13@0|)) 0) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t3@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t4@0| (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t5@0| ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))))) (and (and (= _$t0 _$t0) (= $t20 $t20)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t7@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$$t6@0|)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 600852) 601400) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 600852) 600870) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon14_Else_correct|)))))))
(let ((anon9_Else_correct  (=> (and (and (and (not $t21) (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t20)) (and (= $t20 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t20 $t20))) (and (and (= $t22 (|$addr#$signer| _$t0)) (= $t23 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (= $t24 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))) (= (ControlFlow 0 601404) 600852)))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XDX_XDX'$0$anon0_correct|)))
(let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t14 ($shl _$t2 64))) (and (= $t15 ($shl _$t3 32)) (= $t16 (div $t14 $t15)))) (and (and (= $t17 ($shl _$t2 64)) (= $t18 ($shl _$t3 32))) (and (= $t19 (div $t17 $t18)) (= $t21  (or (or (= $t18 0) (and (= $t19 0) (not (= $t17 0)))) (> $t19 18446744073709551615)))))) (and (=> (= (ControlFlow 0 599957) 602160) anon9_Then_correct) (=> (= (ControlFlow 0 599957) 601404) anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 599785) 602174) anon8_Then_correct) (=> (= (ControlFlow 0 599785) 599957) anon8_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 599779) 599785))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 599835) 599785))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 599791) 602174) anon8_Then_correct) (=> (= (ControlFlow 0 599791) 599957) anon8_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 599763) 599791) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 599763) 599779) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 599697) 599763))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 599805) 599763))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 599683) 599805) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 599683) 599697) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 599677) 599835) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 599677) 599683) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |TreasuryComplianceScriptsbpl.33586:20|
 :skolemid |1234|
 ...
 :qid |TreasuryComplianceScriptsbpl.33594:20|
 :skolemid |1235|
 ...
 :qid |TreasuryComplianceScriptsbpl.33602:20|
 :skolemid |1236|
 ...
 :qid |TreasuryComplianceScriptsbpl.33606:20|
 :skolemid |1237|
 ...
 :qid |TreasuryComplianceScriptsbpl.33610:20|
 :skolemid |1238|
 ...
 :qid |TreasuryComplianceScriptsbpl.33614:20|
 :skolemid |1239|
 ...
 :qid |TreasuryComplianceScriptsbpl.33618:20|
 :skolemid |1240|
 ...
 :qid |TreasuryComplianceScriptsbpl.33622:20|
 :skolemid |1241|
 ...
 :qid |TreasuryComplianceScriptsbpl.33626:20|
 :skolemid |1242|
 ...
 :qid |TreasuryComplianceScriptsbpl.33630:20|
 :skolemid |1243|
 ...
 :qid |TreasuryComplianceScriptsbpl.33634:20|
 :skolemid |1244|
 ...
 :qid |TreasuryComplianceScriptsbpl.33638:20|
 :skolemid |1245|
 ...
 :qid |TreasuryComplianceScriptsbpl.33642:20|
 :skolemid |1246|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_208943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.33654:151|
 :skolemid |1247|
 ...
 :qid |TreasuryComplianceScriptsbpl.33659:104|
 :skolemid |1248|
 ...
 :qid |TreasuryComplianceScriptsbpl.33663:20|
 :skolemid |1249|
))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_217966| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.33667:20|
 :skolemid |1250|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_264828| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.33675:20|
 :skolemid |1251|
 ...
 :qid |TreasuryComplianceScriptsbpl.33679:20|
 :skolemid |1252|
 ...
 :qid |TreasuryComplianceScriptsbpl.33683:20|
 :skolemid |1253|
 ...
 :qid |TreasuryComplianceScriptsbpl.33687:20|
 :skolemid |1254|
 ...
 :qid |TreasuryComplianceScriptsbpl.33691:20|
 :skolemid |1255|
 ...
 :qid |TreasuryComplianceScriptsbpl.33695:20|
 :skolemid |1256|
 ...
 :qid |TreasuryComplianceScriptsbpl.33699:20|
 :skolemid |1257|
 ...
 :qid |TreasuryComplianceScriptsbpl.33703:20|
 :skolemid |1258|
 ...
 :qid |TreasuryComplianceScriptsbpl.33707:20|
 :skolemid |1259|
 ...
 :qid |TreasuryComplianceScriptsbpl.33711:20|
 :skolemid |1260|
 ...
 :qid |TreasuryComplianceScriptsbpl.33715:20|
 :skolemid |1261|
 ...
 :qid |TreasuryComplianceScriptsbpl.33719:20|
 :skolemid |1262|
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.33734:20|
 :skolemid |1263|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.33738:20|
 :skolemid |1264|
 ...
 :qid |TreasuryComplianceScriptsbpl.33742:20|
 :skolemid |1265|
...
))) (and (= $t5 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t6 ($shl _$t2 64)))) (and (and (= $t7 ($shl _$t3 32)) (= $t8 (div $t6 $t7))) (and (= $t9 (|$addr#$signer| _$t0)) (= $t10 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))))) (and (and (and (= $t11 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_211043| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t5))) (= $t12 (|$addr#$signer| _$t0))) (and (let ((addr@@26 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@26)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 599839) 599677)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 598252) 599839)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 731660) 598252) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
