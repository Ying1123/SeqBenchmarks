...
(declare-fun $t5 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun $es@2 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun $t10 () T@$1_Event_EventHandle)
(declare-fun $t11 () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| () Int)
(declare-fun $es@1 () T@$EventStore)
(declare-fun $abort_flag@1 () Bool)
(declare-fun $abort_code@2 () Int)
(declare-fun $es@0 () T@$EventStore)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t9@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t7@0| () Bool)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0| () Int)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3| () T@$Mutation_226647)
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t13@1| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t17@1| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t14@1| () T@Vec_25263)
(declare-fun inline$$1_FixedPoint32_get_raw_value$0$$t1@1 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t15@1| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@1| () T@$Mutation_248284)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@2| () T@$Mutation_248284)
(declare-fun $t20 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@0| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@1| () T@$Mutation_226647)
(declare-fun MapConstVec_16957 (Int) |T@[Int]Int|)
(declare-fun DefaultVecElem_16957 () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t2@0| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@0| () T@$Mutation_248284)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t13@0| () T@$Mutation_199923)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t3@0| () Int)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t4@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t5@0| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun _$t2 () Int)
(declare-fun _$t3 () Int)
(declare-fun $t22 () Int)
(declare-fun $t23 () T@$1_Event_EventHandle)
(declare-fun $t24 () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun $t14 () Int)
(declare-fun $t15 () Int)
(declare-fun $t16 () Int)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_update_exchange_rate$verify_instantiated_0)
(assert (not
 (=> (= (ControlFlow 0 0) 728523) (let ((L2_correct  (and (=> (= (ControlFlow 0 597763) (- 0 731263)) (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (= $t7 0)) (and (= $t8 0) (not (= $t6 0)))) (> $t8 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 597763) (- 0 731394)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t13@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t13@0))) (and (= $t7 0) (= 7 $t13@0))) (and (and (= $t8 0) (not (= $t6 0))) (= 7 $t13@0))) (and (> $t8 18446744073709551615) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t13@0))) (= 7 $t13@0)) (= 2 $t13@0)) (= 8 $t13@0)) (= 3 $t13@0)) (= 5 $t13@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= $t13@0 $abort_code@3) (= (ControlFlow 0 597335) 597763))) L2_correct)))
(let ((anon9_Then_correct  (=> $t21 (=> (and (and (or (or (and (= $t18 0) (= 7 $t13)) (and (and (= $t19 0) (not (= $t17 0))) (= 7 $t13))) (and (> $t19 18446744073709551615) (= 8 $t13))) (= $t13 $t13)) (and (= $t13@0 $t13) (= (ControlFlow 0 597831) 597763))) L2_correct))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t13@0 $abort_code@1) (= (ControlFlow 0 597845) 597763))) L2_correct)))
(let ((anon10_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 597321) (- 0 731019)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 597321) (- 0 731032)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 597321) (- 0 731047)) (not (= $t7 0))) (=> (not (= $t7 0)) (and (=> (= (ControlFlow 0 597321) (- 0 731058)) (not (and (= $t8 0) (not (= $t6 0))))) (=> (not (and (= $t8 0) (not (= $t6 0)))) (and (=> (= (ControlFlow 0 597321) (- 0 731079)) (not (> $t8 18446744073709551615))) (=> (not (> $t8 18446744073709551615)) (and (=> (= (ControlFlow 0 597321) (- 0 731090)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t9))) (and (=> (= (ControlFlow 0 597321) (- 0 731102)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t9)) 1))) (and (=> (= (ControlFlow 0 597321) (- 0 731120)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 597321) (- 0 731134)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 597321) (- 0 731144)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) $t12))) (and (=> (= (ControlFlow 0 597321) (- 0 731156)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $t12)) 1))) (and (=> (= (ControlFlow 0 597321) (- 0 731174)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 597321) (- 0 731188)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1|) 173345816)) $t5)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1|) 173345816)) $t5) (and (=> (= (ControlFlow 0 597321) (- 0 731200)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new (let ((len (|l#Multiset_159418| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new))))))
...
(let ((expected@@0 (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_159418| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@0))))))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 597321) (- 0 731225)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_159418| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t10 stream_new@@1))))))
...
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|  (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (= $abort_code@3 |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1|)) (and (= $es@2 $es@1) (= $abort_flag@2 true))) (and (=> (= (ControlFlow 0 596893) 597335) anon10_Then_correct) (=> (= (ControlFlow 0 596893) 597321) anon10_Else_correct)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon19_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es@0)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 596887) 596893))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon18_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 596907) 596893))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Then_correct|  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| $abort_code@2) (= (ControlFlow 0 596921) 596893))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon15_Then_correct|  (=> |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t9@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|)) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|) (= (ControlFlow 0 596999) 596893))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon14_Then_correct|  (=> (and |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t7@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0|)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0|)) 1)) (= 3 |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|)))) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|) (= $es@1 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t8@0|) (= (ControlFlow 0 597071) 596893))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon19_Else_correct|  (=> (and (not $abort_flag@1) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| ($Memory_210924 (|Store__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|)) (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|))))) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|) (= $abort_code@3 $abort_code@2)) (and (= $es@2 $es@0) (= $abort_flag@2 $abort_flag@1))) (and (=> (= (ControlFlow 0 596873) 597335) anon10_Then_correct) (=> (= (ControlFlow 0 596873) 597321) anon10_Else_correct))))))
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t13@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t17@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t17@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 596845) 596887) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 596845) 596873) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon19_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon18_Else_correct|  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t17@1| ($1_Diem_ToXDXExchangeRateUpdateEvent |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t14@1| inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 596851) 596845)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t15@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t15@1|) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t15@1|)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 596752) 596907) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 596752) 596851) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon18_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1|) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@1| ($Mutation_248284 (|l#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|) (let ((l (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) l 2) (+ l 1))) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|))))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@2| ($Mutation_248284 (|l#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@1|) (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@1|) $t20)) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3| ($Mutation_226647 (|l#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|) (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|v#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@2|) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2|))))))) (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t13@1| ($Mutation_199923 (|l#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|)) l@@0 12) (+ l@@0 1))) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|)))) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t14@1| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t15@1| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@3|))) (= (ControlFlow 0 596758) 596752)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@0|)) (and (=> (= (ControlFlow 0 596973) 596921) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 596973) 596758) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 596971) 596973)) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Then$1_correct|)))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@1| ($Mutation_226647 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@1|))) (and (=> (= (ControlFlow 0 596577) 596921) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 596577) 596758) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon15_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t9@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 596555) 596971) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 596555) 596577) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon14_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t7@0|) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t9@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 596541) 596999) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 596541) 596555) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t2@0|)) 0) (=> (and (= (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t11@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_248284| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t12@0|)) 0)) (=> (and (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t13@0|)) 0) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t3@0| (|$addr#$signer| _$t0))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t4@0| (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t5@0| ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))))) (and (and (= _$t0 _$t0) (= $t20 $t20)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t7@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$$t6@0|)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 596523) 597071) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 596523) 596541) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon14_Else_correct|)))))))
(let ((anon9_Else_correct  (=> (and (and (and (not $t21) (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t20)) (and (= $t20 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t20 $t20))) (and (and (= $t22 (|$addr#$signer| _$t0)) (= $t23 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= $t24 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20))) (= (ControlFlow 0 597075) 596523)))) |inline$$1_Diem_update_xdx_exchange_rate'$1_XUS_XUS'$0$anon0_correct|)))
(let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0) (= $t14 ($shl _$t2 64))) (and (= $t15 ($shl _$t3 32)) (= $t16 (div $t14 $t15)))) (and (and (= $t17 ($shl _$t2 64)) (= $t18 ($shl _$t3 32))) (and (= $t19 (div $t17 $t18)) (= $t21  (or (or (= $t18 0) (and (= $t19 0) (not (= $t17 0)))) (> $t19 18446744073709551615)))))) (and (=> (= (ControlFlow 0 595628) 597831) anon9_Then_correct) (=> (= (ControlFlow 0 595628) 597075) anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 595456) 597845) anon8_Then_correct) (=> (= (ControlFlow 0 595456) 595628) anon8_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 595450) 595456))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 595506) 595456))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 595462) 597845) anon8_Then_correct) (=> (= (ControlFlow 0 595462) 595628) anon8_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 595434) 595462) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 595434) 595450) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 595368) 595434))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 595476) 595434))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 595354) 595476) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 595354) 595368) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 595348) 595506) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 595348) 595354) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr)) 0)) (= addr 173345816)))
 :qid |TreasuryComplianceScriptsbpl.33126:20|
 :skolemid |1202|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) 173345816)) 0)))) (=> (and (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 1)) (= addr@@0 186537453)))
 :qid |TreasuryComplianceScriptsbpl.33134:20|
 :skolemid |1203|
 ...
 :qid |TreasuryComplianceScriptsbpl.33142:20|
 :skolemid |1204|
 ...
 :qid |TreasuryComplianceScriptsbpl.33146:20|
 :skolemid |1205|
 ...
 :qid |TreasuryComplianceScriptsbpl.33150:20|
 :skolemid |1206|
 ...
 :qid |TreasuryComplianceScriptsbpl.33154:20|
 :skolemid |1207|
 ...
 :qid |TreasuryComplianceScriptsbpl.33158:20|
 :skolemid |1208|
 ...
 :qid |TreasuryComplianceScriptsbpl.33162:20|
 :skolemid |1209|
 ...
 :qid |TreasuryComplianceScriptsbpl.33166:20|
 :skolemid |1210|
 ...
 :qid |TreasuryComplianceScriptsbpl.33170:20|
 :skolemid |1211|
 ...
 :qid |TreasuryComplianceScriptsbpl.33174:20|
 :skolemid |1212|
 ...
 :qid |TreasuryComplianceScriptsbpl.33178:20|
 :skolemid |1213|
 ...
 :qid |TreasuryComplianceScriptsbpl.33182:20|
 :skolemid |1214|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_208943| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@13))))) i1)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.33194:151|
 :skolemid |1215|
 ...
 :qid |TreasuryComplianceScriptsbpl.33199:104|
 :skolemid |1216|
 ...
 :qid |TreasuryComplianceScriptsbpl.33203:20|
 :skolemid |1217|
))) (and (forall ((addr@@14 Int) ) (!  (=> (|$IsValid'address'| addr@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_217885| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr@@14) (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.33207:20|
 :skolemid |1218|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_264828| $1_DualAttestation_Credential_$memory) addr1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.33215:20|
 :skolemid |1219|
)) (forall ((addr@@15 Int) ) (!  (=> (|$IsValid'address'| addr@@15) (= (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@15) (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@15)))
 :qid |TreasuryComplianceScriptsbpl.33219:20|
 :skolemid |1220|
))) (and (forall ((addr@@16 Int) ) (!  (=> (|$IsValid'address'| addr@@16) (= (|Select__T@[Int]Bool_| (|domain#$Memory_254928| $1_VASPDomain_VASPDomainManager_$memory) addr@@16)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@16) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@16)) 1))))
 :qid |TreasuryComplianceScriptsbpl.33223:20|
 :skolemid |1221|
)) (forall ((addr@@17 Int) ) (!  (=> (|$IsValid'address'| addr@@17) (= (|Select__T@[Int]Bool_| (|domain#$Memory_255327| $1_VASPDomain_VASPDomains_$memory) addr@@17)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@17) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@17)) 5))))
 :qid |TreasuryComplianceScriptsbpl.33227:20|
 :skolemid |1222|
)))))) (=> (and (and (and (and (and (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_271110| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@18) (|Select__T@[Int]Bool_| (|domain#$Memory_271193| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@18)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@18)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.33231:20|
 :skolemid |1223|
)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_267270| $1_DesignatedDealer_Dealer_$memory) addr@@19)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@19)) 2))))
 :qid |TreasuryComplianceScriptsbpl.33235:20|
 :skolemid |1224|
))) (and (forall ((addr@@20 Int) ) (!  (=> (|$IsValid'address'| addr@@20) (= (|Select__T@[Int]Bool_| (|domain#$Memory_264828| $1_DualAttestation_Credential_$memory) addr@@20)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@20)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@20) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@20)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.33239:20|
 :skolemid |1225|
)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (= (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) addr@@21)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@21)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@21) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@21)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.33243:20|
 :skolemid |1226|
)))) (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (= (|Select__T@[Int]Bool_| (|domain#$Memory_207859| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@22)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@22)) 3))))
 :qid |TreasuryComplianceScriptsbpl.33247:20|
 :skolemid |1227|
)) (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (= (|Select__T@[Int]Bool_| (|domain#$Memory_207139| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@23)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@23)) 4))))
 :qid |TreasuryComplianceScriptsbpl.33251:20|
 :skolemid |1228|
))) (and (forall ((addr@@24 Int) ) (!  (=> (|$IsValid'address'| addr@@24) (= (|Select__T@[Int]Bool_| (|domain#$Memory_258672| $1_VASP_ParentVASP_$memory) addr@@24)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@24) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@24)) 5))))
 :qid |TreasuryComplianceScriptsbpl.33255:20|
 :skolemid |1229|
)) (forall ((addr@@25 Int) ) (!  (=> (|$IsValid'address'| addr@@25) (= (|Select__T@[Int]Bool_| (|domain#$Memory_258608| $1_VASP_ChildVASP_$memory) addr@@25)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@25)) 6))))
 :qid |TreasuryComplianceScriptsbpl.33259:20|
 :skolemid |1230|
))))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (and (|$IsValid'u64'| _$t1) (|$IsValid'u64'| _$t2)) (and (|$IsValid'u64'| _$t3) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.33274:20|
 :skolemid |1231|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) $a_0))
)))))) (and (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.33278:20|
 :skolemid |1232|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@0))
 ...
 :qid |TreasuryComplianceScriptsbpl.33282:20|
 :skolemid |1233|
...
))) (and (= $t5 (ite (= _$t2 _$t3) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t6 ($shl _$t2 64)))) (and (and (= $t7 ($shl _$t3 32)) (= $t8 (div $t6 $t7))) (and (= $t9 (|$addr#$signer| _$t0)) (= $t10 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))))) (and (and (and (= $t11 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t5))) (= $t12 (|$addr#$signer| _$t0))) (and (let ((addr@@26 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@26)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@26)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 595510) 595348)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 593923) 595510)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 728523) 593923) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
