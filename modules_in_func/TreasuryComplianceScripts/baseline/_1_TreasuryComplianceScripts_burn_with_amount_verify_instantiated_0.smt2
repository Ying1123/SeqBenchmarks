...
(declare-fun |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory| () T@$Memory_212046)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory| () T@$Memory_218297)
(declare-fun _$t2 () Int)
(declare-fun $t5 () T@Vec_159960)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9| () T@$Memory_210924)
(declare-fun $t8 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6| () T@$Memory_218297)
(declare-fun $es@7 () T@$EventStore)
(declare-fun $es () T@$EventStore)
(declare-fun $t9 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t11 () T@$1_Event_EventHandle)
(declare-fun $t10 () T@Vec_25263)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7| () T@$Memory_210924)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4| () T@$Memory_218297)
(declare-fun $abort_code@9 () Int)
(declare-fun $es@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8| () T@$Memory_210924)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5| () T@$Memory_218297)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t18@1| () Int)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@1| () Int)
(declare-fun $es@4 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6| () T@$Memory_210924)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3| () T@$Memory_218297)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5| () T@$Memory_210924)
(declare-fun $es@3 () T@$EventStore)
(declare-fun $abort_flag@7 () Bool)
(declare-fun $abort_code@8 () Int)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t15@0| () Bool)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0| () T@Vec_159960)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t3@1| () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@1| () T@$Mutation_221030)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t0@1| () T@$Mutation_221030)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4| () T@$Memory_210924)
(declare-fun $abort_code@7 () Int)
(declare-fun $abort_flag@6 () Bool)
(declare-fun $es@2 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3| () T@$Memory_210924)
(declare-fun |Store__T@[Int]Bool_| (|T@[Int]Bool| Int Bool) |T@[Int]Bool|)
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?x2 Bool)) (! (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Bool|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Bool)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Bool_| (|Store__T@[Int]Bool_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Bool_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4| () T@$Mutation_226647)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@0| () T@$Mutation_221030)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@1| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t50@1| () Bool)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@0| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@1| () T@$Mutation_226647)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1| () T@$Mutation_226697)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1| () T@$Mutation_221030)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t29@1| () |T@$1_Diem_Diem'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2| () T@$Mutation_226697)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t10@0| () T@$Mutation_226647)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@0| () T@$Mutation_226697)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@0| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t16@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t18@1| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t24@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@0| () T@$Mutation_221030)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t5@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t6@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t9@0| () T@Vec_159960)
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t20@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t21@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t22@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t23@0| () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t24@0| () T@Vec_159960)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t25@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t26@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t27@0| () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@0| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@1| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
...
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1| () Bool)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t6@0| () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t7@0| () T@Vec_159960)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t10@0| () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t11@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t12@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun $t14 () T@Vec_159960)
(declare-fun $t15 () Int)
(declare-fun $t16 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t17 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
(declare-fun $t18 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t19 () T@Vec_25263)
...
(declare-fun $t4 () |T@$1_Diem_Preburn'$1_XUS_XUS'|)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_burn_with_amount$verify_instantiated_0)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 690302) (let ((L2_correct  (and (=> (= (ControlFlow 0 539699) (- 0 694917)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (let (($range_0 ($Range 0 (|l#Vec_159960| $t5))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@126 $i_1))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| $t5) i@@126)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30067:476|
 :skolemid |996|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (let (($range_0@@0 ($Range 0 (|l#Vec_159960| $t5))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@127 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| $t5) i@@127)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30067:476|
 :skolemid |996|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 539699) (- 0 695052)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)) (= 5 $t12@0))) (and (let (($range_0@@1 ($Range 0 (|l#Vec_159960| $t5))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@128 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| $t5) i@@128)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30072:622|
 :skolemid |997|
))) (= 1 $t12@0))) (and (= $t6 0) (= 1 $t12@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6) (= 8 $t12@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6) (= 8 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (= 7 $t12@0)) (= 4 $t12@0)) (= 5 $t12@0)) (= 1 $t12@0)) (= 8 $t12@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@10 $abort_code@10)) (and (= $t12@0 $abort_code@10) (= (ControlFlow 0 539265) 539699))) L2_correct)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t12@0 $abort_code@1) (= (ControlFlow 0 539713) 539699))) L2_correct)))
(let ((anon7_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 539251) (- 0 694597)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 539251) (- 0 694610)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 539251) (- 0 694625)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 539251) (- 0 694638)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 539251) (- 0 694649)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 539251) (- 0 694660)) (not (let (($range_0@@2 ($Range 0 (|l#Vec_159960| $t5))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@129 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| $t5) i@@129)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30004:57|
 :skolemid |995|
))))) (=> (not (let (($range_0@@3 ($Range 0 (|l#Vec_159960| $t5))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@130 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| $t5) i@@130)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.30004:57|
 :skolemid |995|
)))) (and (=> (= (ControlFlow 0 539251) (- 0 694707)) (not (= $t6 0))) (=> (not (= $t6 0)) (and (=> (= (ControlFlow 0 539251) (- 0 694718)) (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (and (=> (= (ControlFlow 0 539251) (- 0 694731)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t7) $t6)) (and (=> (= (ControlFlow 0 539251) (- 0 694744)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 539251) (- 0 694754)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 539251) (- 0 694767)) (= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t8))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t8)))) (and (=> (= (ControlFlow 0 539251) (- 0 694790)) (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t8))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t8)))) (and (=> (= (ControlFlow 0 539251) (- 0 694813)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6|) _$t2))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6|) _$t2)) (and (=> (= (ControlFlow 0 539251) (- 0 694826)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t9)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_159418| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new)))) $EmptyEventStore)))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t9)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_159418| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 539251) (- 0 694867)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t9)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_159418| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) $t10 _$t2)) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@1)))) $EmptyEventStore)))
...
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8) (= $es@7 $es@5)) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7|) (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4|)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 538828) 539265) anon7_Then_correct) (=> (= (ControlFlow 0 538828) 539251) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$L3_correct|  (=> (= $es@7 $es@6) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@9| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8|) (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5|)) (and (= $abort_flag@9 true) (= $abort_code@10 |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t18@1|))) (and (=> (= (ControlFlow 0 534399) 539265) anon7_Then_correct) (=> (= (ControlFlow 0 534399) 539251) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Then_correct|  (=> $abort_flag@8 (=> (and (= $abort_code@9 $abort_code@9) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t18@1| $abort_code@9)) (=> (and (and (= $es@6 $es@5) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4|) (= (ControlFlow 0 538842) 534399))) |inline$$1_Diem_burn'$1_XUS_XUS'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$L2_correct|  (=> (= $abort_code@9 |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3|) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 538707) 538842) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 538707) 538828) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 538701) 538707)))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Then_correct|  (=> $abort_flag@7 (=> (and (= $abort_code@8 $abort_code@8) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@1| $abort_code@8)) (=> (and (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 538721) 538707))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)) (= 5 |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$range_0| ($Range 0 (|l#Vec_159960| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$range_0| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$i| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$i|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |213|
))) (= 1 |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@1| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@6| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 538814) 538707)))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t28@0|) (= $abort_code@9 $abort_code@8)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@7| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2|) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 538673) 538842) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 538673) 538828) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t3@1| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t27@1| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t28@0| (> (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 538665) 538701) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 538665) 538673) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@2| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@2| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@2|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t0@1|) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= $es@3 $es@2))) (and (=> (= (ControlFlow 0 538306) 538721) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 538306) 538665) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon48_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3| ($Memory_210924 (|Store__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)) (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)))) (= $es@2 $es@0)) (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3|) (= (ControlFlow 0 538431) 538306))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1| ($Memory_210924 (|Store__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)) (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1|) (= (ControlFlow 0 538292) 538306))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$ret0@0|) (= $abort_code@8 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1|)) (and (= $abort_flag@7 true) (= $es@3 $es@1))) (and (=> (= (ControlFlow 0 537222) 538721) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 537222) 538665) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon48_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es@0) (= (ControlFlow 0 538445) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t53@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t53@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 538403) 538445) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 538403) 538431) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@1| ($Mutation_199923 (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|) (let ((l (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|)) l 9) (+ l 1))) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0| _$t2)) (= (ControlFlow 0 538409) 538403))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t50@1|)) (and (=> (= (ControlFlow 0 538264) 538409) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 538264) 538292) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@1| ($Mutation_17352 (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4| ($Mutation_226647 (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|) (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@4|))) (= (ControlFlow 0 538270) 538264))) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538459) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 538180) 538459) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 538180) 538270) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|) (= (ControlFlow 0 538178) 538180)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 538130) 538459) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 538130) 538270) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 538186) 538178) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 538186) 538130) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| ($Memory_210924 (|Store__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) (|a#$Global| (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)) (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0|)) (and (= $es@1 $es) (= (ControlFlow 0 538039) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 538011) 538186) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 538011) 538039) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|)) (= (ControlFlow 0 537975) 538011)) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@1| ($Mutation_17352 (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|) (let ((l@@1 (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) l@@1 0) (+ l@@1 1))) (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3| ($Mutation_226647 (|l#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|) (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|) (|$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@3|))) (= (ControlFlow 0 537981) 537975))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538473) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 537881) 538473) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 537881) 537981) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 537879) 537881)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 537831) 538473) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 537831) 537981) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Else_correct|  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 537887) 537879) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 537887) 537831) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Then_correct|  (=> (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@5) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538487) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 537736) 538487) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 537736) 537887) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 537734) 537736)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|))) (and (=> (= (ControlFlow 0 537686) 538487) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 537686) 537887) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 537742) 537734) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 537742) 537686) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 537607) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 537591) 537742) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 537591) 537607) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 537555) 537591)) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3) (= (ControlFlow 0 537561) 537555)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Then_correct|  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@4) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538501) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 537501) 538501) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 537501) 537561) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 537499) 537501)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|))) (and (=> (= (ControlFlow 0 537451) 538501) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 537451) 537561) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_CurrencyInfo'$1_XUS_XUS''@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|v#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 537507) 537499) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 537507) 537451) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Then_correct|  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| $abort_code@3) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538515) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@0|)) (and (=> (= (ControlFlow 0 538567) 538515) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 538567) 537507) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= (ControlFlow 0 538565) 538567)) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@1| ($Mutation_226647 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@1|))) (and (=> (= (ControlFlow 0 537356) 538515) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 537356) 537507) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 537334) 538565) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 537334) 537356) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538593) 537222)))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1| ($Mutation_226697 (|l#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|) (let ((l@@2 (|l#Vec_25263| (|p#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|)) l@@2 0) (+ l@@2 1))) (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t29@1| (|v#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2| ($Mutation_226697 (|l#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1|) (|p#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Diem'$1_XUS_XUS''@1|)) (|$IsValid'$1_Diem_Diem'$1_XUS_XUS''| (|v#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'$1_XUS_XUS''| (|v#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'$1_XUS_XUS''| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t28@0|) (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|v#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t0@1| ($Mutation_221030 (|l#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|) (|p#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|) (|$1_Diem_Preburn'$1_XUS_XUS'| (|v#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 537320) 538593) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 537320) 537334) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 537216) 537222))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 537200) 537320) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 537200) 537216) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t22@1| 0)) (= (ControlFlow 0 537164) 537200)) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t22@1| (|$value#$1_Diem_Diem'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 537170) 537164)))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 538619) 537222)))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t10@0|)) 0) (=> (and (and (and (and (= (|l#Vec_25263| (|p#$Mutation_226697| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t27@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_226647| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t33@0|)) 0)) (and (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t42@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t49@0|)) 0))) (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t12@0| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t13@0| (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@1| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@1| |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$temp_0'$1_Diem_Preburn'$1_XUS_XUS''@1|) (= _$t2 _$t2)) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 537082) 538619) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 537082) 537170) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'$1_XUS_XUS''| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2|) _$t2))) (=> (and (and (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t14@0|))) _$t3) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t17@1| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1| ($Mutation_221030 ($Local 3) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t20@0| (|v#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t21@0| (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t23@0|)) (= (ControlFlow 0 538625) 537082)))) |inline$$1_Diem_burn_with_resource_cap'$1_XUS_XUS'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1| ($Memory_218297 (|Store__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2 false) (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|)))) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1|) (= (ControlFlow 0 535522) 538625))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0| ($Memory_218297 (|Store__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2 true) (|Store__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2 |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$temp_0'$1_Diem_PreburnQueue'$1_XUS_XUS''@1|)))) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0|) (= (ControlFlow 0 538733) 538625))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t15@0|) (and (=> (= (ControlFlow 0 535510) 538733) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 535510) 535522) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon0_correct|  (=> (and (= (|l#Vec_25263| (|p#$Mutation_221030| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t8@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t10@0| (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t12@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= _$t2 _$t2))) (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2|) (= _$t3 _$t3)) (and (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (= |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)) (let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$range_0@@0| ($Range 0 (|l#Vec_159960| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$i@@0| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$i@@0|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |212|
)))))))) (and (=> (= (ControlFlow 0 535502) 538814) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 535502) 535510) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t23@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))))) (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t25@0| (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t23@0|))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t27@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= (ControlFlow 0 538818) 535502)))) |inline$$1_Diem_burn_with_capability'$1_XUS_XUS'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Then_correct|  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t18@1| $abort_code@2)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 538856) 534399))) |inline$$1_Diem_burn'$1_XUS_XUS'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@0|)) (and (=> (= (ControlFlow 0 538908) 538856) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 538908) 538818) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|)) (= (ControlFlow 0 538906) 538908)) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'$1_XUS_XUS'_| (|contents#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@2| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t19@1|))) (and (=> (= (ControlFlow 0 534419) 538856) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 534419) 538818) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1| (and (=> (= (ControlFlow 0 534405) 538906) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 534405) 534419) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t18@1| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0|)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@8| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|)) (and (= |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) (= (ControlFlow 0 534393) 534399))) |inline$$1_Diem_burn'$1_XUS_XUS'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'$1_XUS_XUS'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t6@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2)))) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t8@0| (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t6@0|))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t10@0| (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t11@0|)))) (and (and (= _$t0 _$t0) (= _$t2 _$t2)) (and (= _$t3 _$t3) (|$IsValid'address'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t17@0|) (= |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1| |inline$$1_Diem_burn'$1_XUS_XUS'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 534377) 534405) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 534377) 534393) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct  (=> (and (not $abort_flag@0) (= $t13 (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3)))) (=> (and (and (and (= $t14 (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))) (= $t15 (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t13)))) (and (= $t16 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= $t17 (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))))) (and (and (= $t18 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (= $t19 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (and (= $t20 (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t18)) (= (ControlFlow 0 538912) 534377)))) |inline$$1_Diem_burn'$1_XUS_XUS'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 533452) 539713) anon6_Then_correct) (=> (= (ControlFlow 0 533452) 538912) anon6_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 533446) 533452))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 533502) 533452))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 533458) 539713) anon6_Then_correct) (=> (= (ControlFlow 0 533458) 538912) anon6_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 533430) 533458) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 533430) 533446) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 533364) 533430))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 533472) 533430))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 533350) 533472) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 533350) 533364) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 533344) 533502) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 533344) 533350) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 186537453)) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_211599| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_211599| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |TreasuryComplianceScriptsbpl.29796:104|
 :skolemid |982|
)))) (=> (and (and (and (forall ((addr3 Int) ) (!  (=> (|$IsValid'address'| addr3) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211599| |$1_Diem_MintCapability'$1_XUS_XUS'_$memory|) addr3) (and (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))))
 :qid |TreasuryComplianceScriptsbpl.29800:20|
 :skolemid |983|
)) (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) addr1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 1))))
 :qid |TreasuryComplianceScriptsbpl.29804:20|
 :skolemid |984|
))) (and (forall ((addr1@@0 Int) ) (!  (=> (|$IsValid'address'| addr1@@0) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) addr1@@0) (|Select__T@[Int]Bool_| (|domain#$Memory_217885| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr1@@0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1@@0)) 2))))
 :qid |TreasuryComplianceScriptsbpl.29808:20|
 :skolemid |985|
 ...
 :qid |TreasuryComplianceScriptsbpl.29812:20|
 :skolemid |986|
 ...
 :qid |TreasuryComplianceScriptsbpl.29816:20|
 :skolemid |987|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_217885| |$1_Diem_Preburn'$1_XUS_XUS'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.29820:20|
 :skolemid |988|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) addr@@0)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.29828:20|
 :skolemid |989|
))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'u64'| _$t1)) (and (and (|$IsValid'address'| _$t2) (|$IsValid'u64'| _$t3)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.29843:20|
 :skolemid |990|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_BurnCapability'$1_XUS_XUS'_| (|contents#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) $a_0@@0)))
(|$IsValid'$1_Diem_BurnCapability'$1_XUS_XUS''| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.29847:20|
 :skolemid |991|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'$1_XUS_XUS'_| (|contents#$Memory_212046| |$1_Diem_BurnCapability'$1_XUS_XUS'_$memory|) $a_0@@0))
))))) (and (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) $a_0@@1)))
 ...
 :qid |TreasuryComplianceScriptsbpl.29851:20|
 :skolemid |992|
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@2)))
 (and (|$IsValid'$1_Diem_PreburnQueue'$1_XUS_XUS''| $rsc@@2) (and (<= (|l#Vec_159960| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)) 256) (let (($range_1 ($Range 0 (|l#Vec_159960| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)))))
(forall (($i_2 Int) ) (!  (=> ($InRange $range_1 $i_2) (let ((i@@131 $i_2))
(> (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| (|$preburn#$1_Diem_PreburnWithMetadata'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'$1_XUS_XUS'_| (|v#Vec_159960| (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| $rsc@@2)) i@@131)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.29856:223|
 :skolemid |993|
))))))
 :qid |TreasuryComplianceScriptsbpl.29855:20|
 :skolemid |994|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) $a_0@@2))
))) (and (= $t4 (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= $t5 (|$preburns#$1_Diem_PreburnQueue'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_PreburnQueue'$1_XUS_XUS'_| (|contents#$Memory_218297| |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory|) _$t2))))) (and (and (= $t6 (|$value#$1_Diem_Diem'$1_XUS_XUS'| (|$to_burn#$1_Diem_Preburn'$1_XUS_XUS'| $t4))) (= $t7 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (and (= $t8 (|$1_Diem_Preburn'$1_XUS_XUS'| (|$1_Diem_Diem'$1_XUS_XUS'| _$t3))) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))))) (and (and (and (= $t10 (|$currency_code#$1_Diem_CurrencyInfo'$1_XUS_XUS'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XUS_XUS'_| (|contents#$Memory_210924| |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory|) 173345816))) (= $t11 (|$burn_events#$1_Diem_CurrencyInfo'$1_XUS_XUS'| $t9))) (and (let ((addr@@1 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 533506) 533344)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 532381) 533506)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 690302) 532381) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
