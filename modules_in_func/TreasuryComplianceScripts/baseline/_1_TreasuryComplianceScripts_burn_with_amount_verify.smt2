...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@9| () T@$Memory_211162)
(declare-fun $t8 () |T@$1_Diem_Preburn'#0'|)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| () T@Vec_160038)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| () T@$Mutation_222610)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| () T@$Mutation_222610)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| () T@$Mutation_230993)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0| () T@$Mutation_222610)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1| () Bool)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| () T@$Mutation_17352)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| () T@$Mutation_230993)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| () T@$Mutation_231043)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| () T@$Mutation_222610)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| () |T@$1_Diem_Diem'#0'|)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| () T@$Mutation_231043)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0| () T@$Mutation_230993)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0| () T@$Mutation_231043)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0| () T@$Mutation_17352)
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0| () T@$Mutation_199923)
...
(declare-fun |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t19@2| () |T@$1_Diem_BurnCapability'#0'|)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0| () T@$Mutation_222610)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| () T@Vec_25263)
...
(declare-fun |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| () T@Vec_160038)
...
(declare-fun |inline$$1_Diem_burn'#0'$0$$t20@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t21@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t22@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t23@0| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t24@0| () T@Vec_160038)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t25@0| () Int)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t26@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t27@0| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t19@0| () |T@$1_Diem_BurnCapability'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t14@0| () Int)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t19@1| () |T@$1_Diem_BurnCapability'#0'|)
(declare-fun |Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|T@[Int]$1_Diem_BurnCapability'#0'| Int) |T@$1_Diem_BurnCapability'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t15@1| () Bool)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t17@0| () Int)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t6@0| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t7@0| () T@Vec_160038)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t8@0| () Int)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t10@0| () |T@$1_Diem_Preburn'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t11@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t12@0| () T@Vec_25263)
(declare-fun |inline$$1_Diem_burn'#0'$0$$t13@0| () T@$1_Event_EventHandle)
(declare-fun $t13 () |T@$1_Diem_Preburn'#0'|)
(declare-fun $t14 () T@Vec_160038)
(declare-fun $t15 () Int)
(declare-fun $t16 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t17 () |T@$1_Diem_Preburn'#0'|)
...
(declare-fun $t4 () |T@$1_Diem_Preburn'#0'|)
...
(push 1)
(set-info :boogie-vc-id $1_TreasuryComplianceScripts_burn_with_amount$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 685299) (let ((L2_correct  (and (=> (= (ControlFlow 0 531674) (- 0 689904)) (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (let (($range_0 ($Range 0 (|l#Vec_160038| $t5))))
(forall (($i_1 Int) ) (!  (=> ($InRange $range_0 $i_1) (let ((i@@126 $i_1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| $t5) i@@126)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.29727:452|
 :skolemid |980|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (let (($range_0@@0 ($Range 0 (|l#Vec_160038| $t5))))
(forall (($i_1@@0 Int) ) (!  (=> ($InRange $range_0@@0 $i_1@@0) (let ((i@@127 $i_1@@0))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| $t5) i@@127)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.29727:452|
 :skolemid |980|
)))) (= $t6 0)) (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (=> (= (ControlFlow 0 531674) (- 0 690039)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 $t12@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)) (= 7 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)) (= 5 $t12@0))) (and (let (($range_0@@1 ($Range 0 (|l#Vec_160038| $t5))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i@@128 $i_1@@1))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| $t5) i@@128)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.29732:598|
 :skolemid |981|
))) (= 1 $t12@0))) (and (= $t6 0) (= 1 $t12@0))) (and (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6) (= 8 $t12@0))) (and (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6) (= 8 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t12@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))) (= 4 $t12@0))) (= 7 $t12@0)) (= 4 $t12@0)) (= 5 $t12@0)) (= 1 $t12@0)) (= 8 $t12@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@9 (= $abort_code@10 $abort_code@10)) (and (= $t12@0 $abort_code@10) (= (ControlFlow 0 531240) 531674))) L2_correct)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t12@0 $abort_code@1) (= (ControlFlow 0 531688) 531674))) L2_correct)))
(let ((anon7_Else_correct  (=> (not $abort_flag@9) (and (=> (= (ControlFlow 0 531226) (- 0 689584)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 531226) (- 0 689597)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1) 0))) (and (=> (= (ControlFlow 0 531226) (- 0 689612)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 531226) (- 0 689625)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 531226) (- 0 689636)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (and (=> (= (ControlFlow 0 531226) (- 0 689647)) (not (let (($range_0@@2 ($Range 0 (|l#Vec_160038| $t5))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i@@129 $i_1@@2))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| $t5) i@@129)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.29664:57|
 :skolemid |979|
))))) (=> (not (let (($range_0@@3 ($Range 0 (|l#Vec_160038| $t5))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i@@130 $i_1@@3))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| $t5) i@@130)))) _$t3))))
 :qid |TreasuryComplianceScriptsbpl.29664:57|
 :skolemid |979|
)))) (and (=> (= (ControlFlow 0 531226) (- 0 689694)) (not (= $t6 0))) (=> (not (= $t6 0)) (and (=> (= (ControlFlow 0 531226) (- 0 689705)) (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6))) (=> (not (< (|$total_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (and (=> (= (ControlFlow 0 531226) (- 0 689718)) (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6))) (=> (not (< (|$preburn_value#$1_Diem_CurrencyInfo'#0'| $t7) $t6)) (and (=> (= (ControlFlow 0 531226) (- 0 689731)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 531226) (- 0 689741)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 531226) (- 0 689754)) (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8))))) (=> (= (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$total_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8)))) (and (=> (= (ControlFlow 0 531226) (- 0 689777)) (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8))))) (=> (= (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory@9|) 173345816)) (- (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t8)))) (and (=> (= (ControlFlow 0 531226) (- 0 689800)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory@6|) _$t2)) (and (=> (= (ControlFlow 0 531226) (- 0 689813)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new (let ((len (|l#Multiset_159418| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@0) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)) (+ cnt 1)) (+ len 1))))))
...
(let ((expected@@0 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_159418| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@1) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11 stream_new@@0)))) $EmptyEventStore)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3508:13|
 :skolemid |127|
))))) (=> (= (ControlFlow 0 531226) (- 0 689854)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@7) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@7) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| $t9)) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $EmptyEventStore) $t11)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_159418| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@2) (|$ToEventRep'$1_Diem_BurnEvent'| ($1_Diem_BurnEvent (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) $t10 _$t2)) (+ cnt@@1 1)) (+ len@@1 1))))))
...
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Else_correct|  (=> (and (not $abort_flag@8) (= $es@7 $es@5)) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@7|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@4|)) (and (= $abort_flag@9 $abort_flag@8) (= $abort_code@10 $abort_code@9))) (and (=> (= (ControlFlow 0 530803) 531240) anon7_Then_correct) (=> (= (ControlFlow 0 530803) 531226) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$L3_correct|  (=> (= $es@7 $es@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@9| |$1_Diem_CurrencyInfo'#0'_$memory@8|) (= |$1_Diem_PreburnQueue'#0'_$memory@6| |$1_Diem_PreburnQueue'#0'_$memory@5|)) (and (= $abort_flag@9 true) (= $abort_code@10 |inline$$1_Diem_burn'#0'$0$$t18@1|))) (and (=> (= (ControlFlow 0 526374) 531240) anon7_Then_correct) (=> (= (ControlFlow 0 526374) 531226) anon7_Else_correct))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon14_Then_correct|  (=> $abort_flag@8 (=> (and (= $abort_code@9 $abort_code@9) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@9)) (=> (and (and (= $es@6 $es@5) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory@7|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory@4|) (= (ControlFlow 0 530817) 526374))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|  (=> (= $abort_code@9 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1|) (=> (and (and (= $es@5 $es@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@6|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@3|) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 530682) 530817) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 530682) 530803) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|  (=> |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (=> (and (and (and (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0) (= 7 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 530676) 530682)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|  (=> $abort_flag@7 (=> (and (= $abort_code@8 $abort_code@8) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| $abort_code@8)) (=> (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= $es@4 $es@3) (= (ControlFlow 0 530696) 530682))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|  (=> (and (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0| (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)) (= 5 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)) (and (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0| ($Range 0 (|l#Vec_160038| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |217|
))) (= 1 |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t16@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t16@0|))) (and (and (= |$1_Diem_PreburnQueue'#0'_$memory@3| |$1_Diem_PreburnQueue'#0'_$memory|) (= |$1_Diem_CurrencyInfo'#0'_$memory@6| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@4 $es) (= (ControlFlow 0 530789) 530682)))) |inline$$1_Diem_burn_with_capability'#0'$0$L2_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0|) (= $abort_code@9 $abort_code@8)) (=> (and (and (= $es@5 $es@3) (= |$1_Diem_CurrencyInfo'#0'_$memory@7| |$1_Diem_CurrencyInfo'#0'_$memory@5|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@4| |$1_Diem_PreburnQueue'#0'_$memory@2|) (= $abort_flag@8 $abort_flag@7))) (and (=> (= (ControlFlow 0 530648) 530817) |inline$$1_Diem_burn'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 530648) 530803) |inline$$1_Diem_burn'#0'$0$anon14_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@7) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t3@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t28@0| (> (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t27@1|) 0)))) (and (=> (= (ControlFlow 0 530640) 530676) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 530640) 530648) |inline$$1_Diem_burn_with_capability'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|  (=> (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|)) (=> (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@2|) (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@4|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1|) (= $abort_code@8 $abort_code@7)) (and (= $abort_flag@7 $abort_flag@6) (= $es@3 $es@2))) (and (=> (= (ControlFlow 0 530281) 530696) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 530281) 530640) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|  (=> (not $abort_flag@6) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@3| ($Memory_211162 (|Store__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2 $es@0)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@3|) (= (ControlFlow 0 530406) 530281))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|  (=> (not inline$$Not$0$dst@1) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1| ($Memory_211162 (|Store__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)))) (= $es@2 $es)) (and (= |$1_Diem_CurrencyInfo'#0'_$memory@4| |$1_Diem_CurrencyInfo'#0'_$memory@1|) (= (ControlFlow 0 530267) 530281))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L9_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|  (=> (= |$1_Diem_CurrencyInfo'#0'_$memory@5| |$1_Diem_CurrencyInfo'#0'_$memory@2|) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$ret0@0|) (= $abort_code@8 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1|)) (and (= $abort_flag@7 true) (= $es@3 $es@1))) (and (=> (= (ControlFlow 0 529197) 530696) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 529197) 530640) |inline$$1_Diem_burn_with_capability'#0'$0$anon12_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es@0) (= (ControlFlow 0 530420) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| (|v#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1|)) (= $es@0 (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1|)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_159418| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|))))
(Multiset_159418 (|Store__T@[$EventRep]Int_| (|v#Multiset_159418| stream@@3) (|$ToEventRep'$1_Diem_BurnEvent'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1|) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$handle@1| stream_new@@2)))))) (and (=> (= (ControlFlow 0 530378) 530420) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Then_correct|) (=> (= (ControlFlow 0 530378) 530406) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon48_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|  (=> (and (and inline$$Not$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@1| ($Mutation_199923 (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|) (let ((l (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|)) l 9) (+ l 1))) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t53@1| ($1_Diem_BurnEvent |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| _$t2)) (= (ControlFlow 0 530384) 530378))) |inline$$1_Event_emit_event'$1_Diem_BurnEvent'$0$anon0_correct|)))
(let ((inline$$Not$0$anon0_correct  (=> (= inline$$Not$0$dst@1  (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1|)) (and (=> (= (ControlFlow 0 530239) 530384) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Then_correct|) (=> (= (ControlFlow 0 530239) 530267) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon47_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1| ($Mutation_17352 (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (let ((l@@0 (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) l@@0 1) (+ l@@0 1))) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@1|) inline$$Sub$1$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4| ($Mutation_230993 (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@2|) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t50@1| (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@4|))) (= (ControlFlow 0 530245) 530239))) inline$$Not$0$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|  (=> (and $abort_flag@6 (= $abort_code@7 $abort_code@7)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530434) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$1$anon3_Then$1_correct  (=> (= $abort_flag@6 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@0)) (and (=> (= (ControlFlow 0 530155) 530434) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 530155) 530245) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((inline$$Sub$1$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= (ControlFlow 0 530153) 530155)) inline$$Sub$1$anon3_Then$1_correct)))
(let ((inline$$Sub$1$anon3_Else_correct  (=> (<= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1|) (=> (and (and (= inline$$Sub$1$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= $abort_flag@6 $abort_flag@5)) (and (= $abort_code@7 $abort_code@6) (= inline$$Sub$1$dst@2 inline$$Sub$1$dst@1))) (and (=> (= (ControlFlow 0 530105) 530434) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Then_correct|) (=> (= (ControlFlow 0 530105) 530245) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon46_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|  (=> (and inline$$Ge$1$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t47@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (and (=> (= (ControlFlow 0 530161) 530153) inline$$Sub$1$anon3_Then_correct) (=> (= (ControlFlow 0 530161) 530105) inline$$Sub$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|  (=> (not inline$$Ge$1$dst@1) (=> (and (= |$1_Diem_CurrencyInfo'#0'_$memory@0| ($Memory_211162 (|Store__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)) (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory@0|)) (and (= $es@1 $es) (= (ControlFlow 0 530014) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t46@0|) (= inline$$Ge$1$dst@1 inline$$Ge$1$dst@1))) (and (=> (= (ControlFlow 0 529986) 530161) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Then_correct|) (=> (= (ControlFlow 0 529986) 530014) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon45_Else_correct|))))))
(let ((inline$$Ge$1$anon0_correct  (=> (and (= inline$$Ge$1$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|)) (= (ControlFlow 0 529950) 529986)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|  (=> (and (not $abort_flag@5) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1| ($Mutation_17352 (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (let ((l@@1 (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) l@@1 0) (+ l@@1 1))) (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2| ($Mutation_17352 (|l#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@1|) inline$$Sub$0$dst@2)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3| ($Mutation_230993 (|l#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|) (|$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@2|) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t43@1| (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@3|))) (= (ControlFlow 0 529956) 529950))) inline$$Ge$1$anon0_correct))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@6) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530448) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$Sub$0$anon3_Then$1_correct  (=> (= $abort_code@6 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@5 true) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@0)) (and (=> (= (ControlFlow 0 529856) 530448) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 529856) 529956) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((inline$$Sub$0$anon3_Then_correct  (=> (and (< |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1) (= (ControlFlow 0 529854) 529856)) inline$$Sub$0$anon3_Then$1_correct)))
(let ((inline$$Sub$0$anon3_Else_correct  (=> (<= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1|) (=> (and (and (= inline$$Sub$0$dst@1 (- |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| inline$$CastU128$1$dst@1)) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= inline$$Sub$0$dst@2 inline$$Sub$0$dst@1))) (and (=> (= (ControlFlow 0 529806) 530448) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Then_correct|) (=> (= (ControlFlow 0 529806) 529956) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon44_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|  (=> (not $abort_flag@4) (and (=> (= (ControlFlow 0 529862) 529854) inline$$Sub$0$anon3_Then_correct) (=> (= (ControlFlow 0 529862) 529806) inline$$Sub$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|  (=> (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@5) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530462) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$1$anon3_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$CastU128$1$dst@1 inline$$CastU128$1$dst@0)) (and (=> (= (ControlFlow 0 529711) 530462) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 529711) 529862) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|))))))
(let ((inline$$CastU128$1$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 529709) 529711)) inline$$CastU128$1$anon3_Then$1_correct)))
(let ((inline$$CastU128$1$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$CastU128$1$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 529661) 530462) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Then_correct|) (=> (= (ControlFlow 0 529661) 529862) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon43_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|  (=> (and inline$$Ge$0$dst@1 (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t39@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|)))) (and (=> (= (ControlFlow 0 529717) 529709) inline$$CastU128$1$anon3_Then_correct) (=> (= (ControlFlow 0 529717) 529661) inline$$CastU128$1$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 529582) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| 8)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t38@0|) (= inline$$Ge$0$dst@1 inline$$Ge$0$dst@1))) (and (=> (= (ControlFlow 0 529566) 529717) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Then_correct|) (=> (= (ControlFlow 0 529566) 529582) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon42_Else_correct|))))))
(let ((inline$$Ge$0$anon0_correct  (=> (and (= inline$$Ge$0$dst@1 (>= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| inline$$CastU128$0$dst@1)) (= (ControlFlow 0 529530) 529566)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|  (=> (and (not $abort_flag@3) (= (ControlFlow 0 529536) 529530)) inline$$Ge$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@4) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530476) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((inline$$CastU128$0$anon3_Then$1_correct  (=> (= $abort_code@4 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@3 true) (= inline$$CastU128$0$dst@1 inline$$CastU128$0$dst@0)) (and (=> (= (ControlFlow 0 529476) 530476) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 529476) 529536) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|))))))
(let ((inline$$CastU128$0$anon3_Then_correct  (=> (and (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| $MAX_U128) (= (ControlFlow 0 529474) 529476)) inline$$CastU128$0$anon3_Then$1_correct)))
(let ((inline$$CastU128$0$anon3_Else_correct  (=> (and (and (>= $MAX_U128 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= $abort_code@4 $abort_code@3)) (and (= $abort_flag@3 $abort_flag@2) (= inline$$CastU128$0$dst@1 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|))) (and (=> (= (ControlFlow 0 529426) 530476) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Then_correct|) (=> (= (ControlFlow 0 529426) 529536) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon41_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|  (=> (and (and (not $abort_flag@2) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t34@1| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2|))))) (and (=> (= (ControlFlow 0 529482) 529474) inline$$CastU128$0$anon3_Then_correct) (=> (= (ControlFlow 0 529482) 529426) inline$$CastU128$0$anon3_Else_correct)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| $abort_code@3) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530490) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) (and (=> (= (ControlFlow 0 530542) 530490) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 530542) 529482) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 530540) 530542)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1| ($Mutation_230993 ($Global 173345816) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@2| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@1|))) (and (=> (= (ControlFlow 0 529331) 530490) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Then_correct|) (=> (= (ControlFlow 0 529331) 529482) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon40_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|  (=> (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 529309) 530540) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Then_correct|) (=> (= (ControlFlow 0 529309) 529331) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon39_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530568) 529197)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|  (=> inline$$Gt$0$dst@1 (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1| ($Mutation_231043 (|l#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (let ((l@@2 (|l#Vec_25263| (|p#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))))
(Vec_25263 (|Store__T@[Int]Int_| (|v#Vec_25263| (|p#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)) l@@2 0) (+ l@@2 1))) (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1| (|v#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2| ($Mutation_231043 (|l#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) (|p#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@1|) |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Diem'#0''@1|)) (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (=> (and (and (and (|$IsValid'$1_Diem_Diem'#0''| (|v#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) (|$IsValid'$1_Diem_Diem'#0''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|)) (and (= (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|) (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t29@1|)) (= (|$value#$1_Diem_Diem'#0'| (|v#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)) 0))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t0@1| ($Mutation_222610 (|l#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|p#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|) (|$1_Diem_Preburn'#0'| (|v#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@2|)))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t28@0|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t30@1|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t31@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (=> (= (ControlFlow 0 529295) 530568) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Then_correct|) (=> (= (ControlFlow 0 529295) 529309) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon38_Else_correct|)))))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|  (=> (and (not inline$$Gt$0$dst@1) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|)) (=> (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 529191) 529197))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| 1)) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t26@0|) (= inline$$Gt$0$dst@1 inline$$Gt$0$dst@1))) (and (=> (= (ControlFlow 0 529175) 529295) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Then_correct|) (=> (= (ControlFlow 0 529175) 529191) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon37_Else_correct|))))))
(let ((inline$$Gt$0$anon0_correct  (=> (and (= inline$$Gt$0$dst@1 (> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| 0)) (= (ControlFlow 0 529139) 529175)) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else$1_correct|)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|  (=> (and (and (and (not |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|) (|$IsValid'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|)) (and (|$IsEqual'vec'u8''| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t18@0|))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1| (|$to_burn#$1_Diem_Preburn'#0'| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t22@1| (|$value#$1_Diem_Diem'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t21@1|))) (and (|$IsValid'u64'| 0) (= (ControlFlow 0 529145) 529139)))) inline$$Gt$0$anon0_correct)))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|  (=> |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0| (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|)) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t20@0|) (= |$1_Diem_CurrencyInfo'#0'_$memory@2| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= $es@1 $es) (= (ControlFlow 0 530594) 529197)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$L13_correct|))))
(let ((|inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|  (=> (= (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t10@0|)) 0) (=> (and (and (and (and (= (|l#Vec_25263| (|p#$Mutation_231043| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t27@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_230993| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t33@0|)) 0)) (and (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t42@0|)) 0) (= (|l#Vec_25263| (|p#$Mutation_17352| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t49@0|)) 0))) (and (and (= (|l#Vec_25263| (|p#$Mutation_199923| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t52@0|)) 0) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t13@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t12@0|))) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t14@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t16@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t17@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t15@0|)) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|)))) (and (and (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1| |inline$$1_Diem_burn_with_resource_cap'#0'$0$$temp_0'$1_Diem_Preburn'#0''@1|) (= _$t2 _$t2)) (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= |inline$$1_Diem_burn_with_resource_cap'#0'$0$$t19@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))) (and (=> (= (ControlFlow 0 529057) 530594) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Then_correct|) (=> (= (ControlFlow 0 529057) 529145) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon36_Else_correct|))))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|  (=> (and (|$IsValid'$1_Diem_PreburnWithMetadata'#0''| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2) (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory@2|) _$t2))) (=> (and (and (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) _$t3) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t18@1| (|$metadata#$1_Diem_PreburnWithMetadata'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t14@0|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1| |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1| ($Mutation_222610 ($Local 3) (Vec_25263 (MapConstVec_16957 DefaultVecElem_16957) 0) |inline$$1_Diem_burn_with_capability'#0'$0$$t17@1|)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0| (|v#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@1|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t21@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t20@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t22@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t24@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t25@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t23@0|)) (= (ControlFlow 0 530600) 529057)))) |inline$$1_Diem_burn_with_resource_cap'#0'$0$anon0_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|  (=> (and (and (not |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1|) (= |$1_Diem_PreburnQueue'#0'_$memory@1| ($Memory_218531 (|Store__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2 false) (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@1|) (= (ControlFlow 0 527497) 530600))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|  (=> (and (and |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'bool'@1| (= |$1_Diem_PreburnQueue'#0'_$memory@0| ($Memory_218531 (|Store__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2 true) (|Store__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2 |inline$$1_Diem_burn_with_capability'#0'$0$$temp_0'$1_Diem_PreburnQueue'#0''@1|)))) (and (= |$1_Diem_PreburnQueue'#0'_$memory@2| |$1_Diem_PreburnQueue'#0'_$memory@0|) (= (ControlFlow 0 530708) 530600))) |inline$$1_Diem_burn_with_capability'#0'$0$anon5_correct|)))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|  (=> (not |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|) (and (=> (= (ControlFlow 0 527485) 530708) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 527485) 527497) |inline$$1_Diem_burn_with_capability'#0'$0$anon11_Else_correct|)))))
(let ((|inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|  (=> (and (= (|l#Vec_25263| (|p#$Mutation_222610| |inline$$1_Diem_burn_with_capability'#0'$0$$t19@0|)) 0) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t6@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t7@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t5@0|))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t9@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))))) (=> (and (and (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t10@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn_with_capability'#0'$0$$t8@0|))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t12@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= _$t2 _$t2))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@2|) (= _$t3 _$t3)) (and (= |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (= |inline$$1_Diem_burn_with_capability'#0'$0$$t15@0|  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| ($Range 0 (|l#Vec_160038| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|))))
(forall ((|inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0| Int) ) (!  (=> ($InRange |inline$$1_Diem_burn_with_capability'#0'$0$$range_0@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|) (let ((|inline$$1_Diem_burn_with_capability'#0'$0$i@@0| |inline$$1_Diem_burn_with_capability'#0'$0$$i_1@@0|))
 (not (= (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| |inline$$1_Diem_burn_with_capability'#0'$0$$t13@0|) |inline$$1_Diem_burn_with_capability'#0'$0$i@@0|)))) _$t3))))
 :qid |unknown.0:0|
 :skolemid |216|
)))))))) (and (=> (= (ControlFlow 0 527477) 530789) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 527477) 527485) |inline$$1_Diem_burn_with_capability'#0'$0$anon10_Else_correct|)))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$1_Diem_burn'#0'$0$$t20@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (=> (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t21@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t22@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t20@0|))) (and (= |inline$$1_Diem_burn'#0'$0$$t23@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= |inline$$1_Diem_burn'#0'$0$$t24@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))))) (and (and (= |inline$$1_Diem_burn'#0'$0$$t25@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t23@0|))) (= |inline$$1_Diem_burn'#0'$0$$t26@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t27@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= (ControlFlow 0 530793) 527477)))) |inline$$1_Diem_burn_with_capability'#0'$0$anon0_correct|))))
(let ((|inline$$1_Diem_burn'#0'$0$anon13_Then_correct|  (=> $abort_flag@1 (=> (and (= $abort_code@2 $abort_code@2) (= |inline$$1_Diem_burn'#0'$0$$t18@1| $abort_code@2)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 530831) 526374))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@0|)) (and (=> (= (ControlFlow 0 530883) 530831) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 530883) 530793) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= (ControlFlow 0 530881) 530883)) |inline$$1_Diem_burn'#0'$0$anon12_Then$1_correct|)))
(let ((|inline$$1_Diem_burn'#0'$0$anon12_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|) (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t19@1| (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Diem_burn'#0'$0$$t19@2| |inline$$1_Diem_burn'#0'$0$$t19@1|))) (and (=> (= (ControlFlow 0 526394) 530831) |inline$$1_Diem_burn'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 526394) 530793) |inline$$1_Diem_burn'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Then_correct|  (=> |inline$$1_Diem_burn'#0'$0$$t15@1| (and (=> (= (ControlFlow 0 526380) 530881) |inline$$1_Diem_burn'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 526380) 526394) |inline$$1_Diem_burn'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon11_Else_correct|  (=> (not |inline$$1_Diem_burn'#0'$0$$t15@1|) (=> (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t18@1| |inline$$1_Diem_burn'#0'$0$$t17@0|)) (=> (and (and (= $es@6 $es) (= |$1_Diem_CurrencyInfo'#0'_$memory@8| |$1_Diem_CurrencyInfo'#0'_$memory|)) (and (= |$1_Diem_PreburnQueue'#0'_$memory@5| |$1_Diem_PreburnQueue'#0'_$memory|) (= (ControlFlow 0 526368) 526374))) |inline$$1_Diem_burn'#0'$0$L3_correct|)))))
(let ((|inline$$1_Diem_burn'#0'$0$anon0_correct|  (=> (and (and (= |inline$$1_Diem_burn'#0'$0$$t6@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= |inline$$1_Diem_burn'#0'$0$$t7@0| (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2)))) (and (= |inline$$1_Diem_burn'#0'$0$$t8@0| (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| |inline$$1_Diem_burn'#0'$0$$t6@0|))) (= |inline$$1_Diem_burn'#0'$0$$t9@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (and (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t10@0| (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= |inline$$1_Diem_burn'#0'$0$$t11@0| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= |inline$$1_Diem_burn'#0'$0$$t12@0| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_burn'#0'$0$$t13@0| (|$burn_events#$1_Diem_CurrencyInfo'#0'| |inline$$1_Diem_burn'#0'$0$$t11@0|)))) (and (and (= _$t0 _$t0) (= _$t2 _$t2)) (and (= _$t3 _$t3) (|$IsValid'address'| |inline$$1_Diem_burn'#0'$0$$t14@0|)))) (and (and (and (= |inline$$1_Diem_burn'#0'$0$$t14@0| (|$addr#$signer| _$t0)) (= |inline$$1_Diem_burn'#0'$0$$t14@0| |inline$$1_Diem_burn'#0'$0$$t14@0|)) (and (= |inline$$1_Diem_burn'#0'$0$$t15@1| (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) |inline$$1_Diem_burn'#0'$0$$t14@0|)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t17@0| 4)) (and (= |inline$$1_Diem_burn'#0'$0$$t17@0| |inline$$1_Diem_burn'#0'$0$$t17@0|) (= |inline$$1_Diem_burn'#0'$0$$t15@1| |inline$$1_Diem_burn'#0'$0$$t15@1|))))) (and (=> (= (ControlFlow 0 526352) 526380) |inline$$1_Diem_burn'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 526352) 526368) |inline$$1_Diem_burn'#0'$0$anon11_Else_correct|))))))
(let ((anon6_Else_correct  (=> (and (not $abort_flag@0) (= $t13 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3)))) (=> (and (and (and (= $t14 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))) (= $t15 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t13)))) (and (= $t16 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t17 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))))) (and (and (= $t18 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= $t19 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t20 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t18)) (= (ControlFlow 0 530887) 526352)))) |inline$$1_Diem_burn'#0'$0$anon0_correct|))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1)) (and (=> (= (ControlFlow 0 525427) 531688) anon6_Then_correct) (=> (= (ControlFlow 0 525427) 530887) anon6_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= (ControlFlow 0 525421) 525427))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0) (= (ControlFlow 0 525477) 525427))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (=> (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0)) (and (=> (= (ControlFlow 0 525433) 531688) anon6_Then_correct) (=> (= (ControlFlow 0 525433) 530887) anon6_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 ($1_SlidingNonce_spec_try_record_nonce _$t0 _$t1))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory@2) (|$addr#$signer| _$t0)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1)))) (and (=> (= (ControlFlow 0 525405) 525433) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct) (=> (= (ControlFlow 0 525405) 525421) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1|) (= $1_SlidingNonce_SlidingNonce_$memory@1 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) false) (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@1) (= (ControlFlow 0 525339) 525405))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1| (= $1_SlidingNonce_SlidingNonce_$memory@0 ($Memory_208471 (|Store__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2 $1_SlidingNonce_SlidingNonce_$memory@0) (= (ControlFlow 0 525447) 525405))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0) (and (=> (= (ControlFlow 0 525325) 525447) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct) (=> (= (ControlFlow 0 525325) 525339) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (= _$t1 _$t1) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0  (not (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0))))) (and (=> (= (ControlFlow 0 525319) 525477) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct) (=> (= (ControlFlow 0 525319) 525325) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) 186537453))) (=> (and (and (and (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1 Int) (mint_cap_owner2 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1) (=> (|$IsValid'address'| mint_cap_owner2) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_211727| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1) (|Select__T@[Int]Bool_| (|domain#$Memory_211727| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2)) (= mint_cap_owner1 mint_cap_owner2))))
 :qid |TreasuryComplianceScriptsbpl.29460:88|
 :skolemid |966|
 ...
 :qid |TreasuryComplianceScriptsbpl.29464:20|
 :skolemid |967|
))) (and (forall ((addr1 Int) ) (!  (=> (|$IsValid'address'| addr1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) addr1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr1)) 1))))
 :qid |TreasuryComplianceScriptsbpl.29468:20|
 :skolemid |968|
 ...
 :qid |TreasuryComplianceScriptsbpl.29472:20|
 :skolemid |969|
 ...
 :qid |TreasuryComplianceScriptsbpl.29476:20|
 :skolemid |970|
 ...
 :qid |TreasuryComplianceScriptsbpl.29480:20|
 :skolemid |971|
))) (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_218047| |$1_Diem_Preburn'#0'_$memory|) addr) (|Select__T@[Int]Bool_| (|domain#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.29484:20|
 :skolemid |972|
)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (= (|Select__T@[Int]Bool_| (|domain#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) addr@@0)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_206812| $1_Roles_RoleId_$memory) addr@@0)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.29488:20|
 :skolemid |973|
...
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc))
 :qid |TreasuryComplianceScriptsbpl.29503:20|
 :skolemid |974|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_208471| $1_SlidingNonce_SlidingNonce_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@0)))
(|$IsValid'$1_Diem_BurnCapability'#0''| $rsc@@0))
 :qid |TreasuryComplianceScriptsbpl.29507:20|
 :skolemid |975|
 :pattern ( (|Select__T@[Int]$1_Diem_BurnCapability'#0'_| (|contents#$Memory_212220| |$1_Diem_BurnCapability'#0'_$memory|) $a_0@@0))
))))) (and (and (and (and (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@1)))
 ...
 :qid |TreasuryComplianceScriptsbpl.29511:20|
 :skolemid |976|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@1))
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@2)))
...
(> (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| (|$preburn#$1_Diem_PreburnWithMetadata'#0'| (|Select__T@[Int]$1_Diem_PreburnWithMetadata'#0'_| (|v#Vec_160038| (|$preburns#$1_Diem_PreburnQueue'#0'| $rsc@@2)) i@@131)))) 0)))
 :qid |TreasuryComplianceScriptsbpl.29516:199|
 :skolemid |977|
))))))
 :qid |TreasuryComplianceScriptsbpl.29515:20|
 :skolemid |978|
 :pattern ( (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) $a_0@@2))
))) (and (= $t4 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= $t5 (|$preburns#$1_Diem_PreburnQueue'#0'| (|Select__T@[Int]$1_Diem_PreburnQueue'#0'_| (|contents#$Memory_218531| |$1_Diem_PreburnQueue'#0'_$memory|) _$t2))))) (and (and (= $t6 (|$value#$1_Diem_Diem'#0'| (|$to_burn#$1_Diem_Preburn'#0'| $t4))) (= $t7 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (= $t8 (|$1_Diem_Preburn'#0'| (|$1_Diem_Diem'#0'| _$t3))) (= $t9 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))) (and (and (and (= $t10 (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_211162| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $t11 (|$burn_events#$1_Diem_CurrencyInfo'#0'| $t9))) (and (let ((addr@@1 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_206648| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_271359| $1_DiemAccount_DiemAccount_$memory) addr@@1)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_268192| $1_AccountFreezing_FreezingBit_$memory) addr@@1)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 525481) 525319)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_159418_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |TreasuryComplianceScriptsbpl.3492:13|
 :skolemid |126|
))) (= (ControlFlow 0 524366) 525481)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 685299) 524366) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
