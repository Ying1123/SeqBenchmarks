...
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory| () T@$Memory_238609)
...
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory| () T@$Memory_205828)
(declare-fun $t6@@0 () Int)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory| () T@$Memory_206237)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@0 () T@$Memory_258253)
(declare-fun $t57@@0 () Int)
(declare-fun $t49@@0 () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@0 () T@$Memory_258253)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@8@@0 () T@$Memory_258253)
(declare-fun $t25@@0 () T@$1_DiemAccount_WithdrawCapability)
(declare-fun $t59@@0 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@2| () T@$Memory_258004)
(declare-fun $t60@@0 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2| () T@$Memory_199645)
(declare-fun $t13@@0 () Int)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2| () T@$Memory_206237)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@7@@0 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@6@@0 () T@$Memory_258253)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1| () T@$Memory_199645)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0| () T@$Memory_199645)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1| () T@$Memory_206237)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0| () T@$Memory_206237)
...
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory@1| () T@$Memory_205828)
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory@0| () T@$Memory_205828)
...
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@1| () T@$Memory_258004)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@0| () T@$Memory_258004)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@0 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@0 () T@$Memory_258253)
(declare-fun |$temp_0'$1_DiemAccount_DiemAccount'@1@@0| () T@$1_DiemAccount_DiemAccount)
(declare-fun |$temp_0'bool'@1@@0| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@1| () T@$Memory_238609)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0| () T@$Memory_238609)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@0 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@0 () T@$Memory_258253)
(declare-fun |$temp_0'$1_DiemAccount_DiemAccount'@0@@0| () T@$1_DiemAccount_DiemAccount)
(declare-fun |$1_Diem_MintCapability'$1_XUS_XUS'_$memory| () T@$Memory_200314)
...
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory| () T@$Memory_238673)
...
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory| () T@$Memory_205919)
(declare-fun $t6@@1 () Int)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory| () T@$Memory_206336)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@5@@1 () T@$Memory_258253)
(declare-fun $t57@@1 () Int)
(declare-fun $t49@@1 () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@1 () T@$Memory_258253)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@8@@1 () T@$Memory_258253)
(declare-fun $t25@@1 () T@$1_DiemAccount_WithdrawCapability)
(declare-fun $t59@@1 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| () T@$Memory_258087)
(declare-fun $t60@@1 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2| () T@$Memory_199764)
(declare-fun $t13@@1 () Int)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2| () T@$Memory_206336)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@7@@1 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@6@@1 () T@$Memory_258253)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1| () T@$Memory_199764)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0| () T@$Memory_199764)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1| () T@$Memory_206336)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0| () T@$Memory_206336)
...
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory@1| () T@$Memory_205919)
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory@0| () T@$Memory_205919)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| () T@$Memory_258087)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0| () T@$Memory_258087)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@4@@1 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@1 () T@$Memory_258253)
(declare-fun |$temp_0'$1_DiemAccount_DiemAccount'@1@@1| () T@$1_DiemAccount_DiemAccount)
(declare-fun |$temp_0'bool'@1@@1| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1| () T@$Memory_238673)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0| () T@$Memory_238673)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@1 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@1 () T@$Memory_258253)
(declare-fun |$temp_0'$1_DiemAccount_DiemAccount'@0@@1| () T@$1_DiemAccount_DiemAccount)
(declare-fun |$1_Diem_MintCapability'$1_XDX_XDX'_$memory| () T@$Memory_200378)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@2 () T@$Memory_242740)
...
(declare-fun $1_VASPDomain_VASPDomains_$memory@0 () T@$Memory_242740)
(declare-fun $es@0@@2 () T@$EventStore)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 () Int)
(declare-fun $1_VASPDomain_VASPDomains_$memory@1 () T@$Memory_242740)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t34@1 () T@$Mutation_189683)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t36@1 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 () T@$Mutation_242836)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 () T@$1_VASPDomain_VASPDomain)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@0 () T@$Mutation_242836)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t33@1 () T@$Mutation_242836)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@3 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 () T@$Mutation_242775)
(declare-fun |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_174578)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t31@1 () T@$Mutation_174578)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@0 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t24@1 () T@$Mutation_242775)
...
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t9@0 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t31@0 () T@$Mutation_174578)
(declare-fun inline$$1_VASPDomain_add_vasp_domain$0$$t34@0 () T@$Mutation_189683)
...
(assert (not
 (=> (= (ControlFlow 0 0) 613965) (let ((anon4_Else_correct  (=> (and (not $abort_flag@3) (= $t12@@2 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory@2) _$t1@@2)))) (and (=> (= (ControlFlow 0 437202) (- 0 616861)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2))) (and (=> (= (ControlFlow 0 437202) (- 0 616872)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (and (=> (= (ControlFlow 0 437202) (- 0 616882)) (not (exists ((i@@62 Int) ) (!  (and (and (|$IsValid'u64'| i@@62) (and (>= i@@62 0) (< i@@62 (seq.len $t3@@2)))) (= (seq.nth $t3@@2 i@@62) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)))) (=> (not (exists ((i@@63 Int) ) (!  (and (and (|$IsValid'u64'| i@@63) (and (>= i@@63 0) (< i@@63 (seq.len $t3@@2)))) (= (seq.nth $t3@@2 i@@63) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (and (=> (= (ControlFlow 0 437202) (- 0 616894)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2))) (and (=> (= (ControlFlow 0 437202) (- 0 616906)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (and (=> (= (ControlFlow 0 437202) (- 0 616924)) (not (not (= (|$addr#$signer| _$t0@@2) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@2) 186537453))) (and (=> (= (ControlFlow 0 437202) (- 0 616938)) (not (> (seq.len _$t2) 63))) (=> (not (> (seq.len _$t2) 63)) (and (=> (= (ControlFlow 0 437202) (- 0 616950)) (exists ((i@@64 Int) ) (!  (and (and (|$IsValid'u64'| i@@64) (and (>= i@@64 0) (< i@@64 (seq.len $t12@@2)))) (= (seq.nth $t12@@2 i@@64) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (=> (exists ((i@@65 Int) ) (!  (and (and (|$IsValid'u64'| i@@65) (and (>= i@@65 0) (< i@@65 (seq.len $t12@@2)))) (= (seq.nth $t12@@2 i@@65) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)) (and (=> (= (ControlFlow 0 437202) (- 0 616960)) (let ((actual@@14 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@14 (let ((stream@@33 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2)))
(let ((stream_new@@29 (let ((len@@29 (|l#Multiset_157370| stream@@33)))
(let ((cnt@@29 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@33) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@33) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2) (+ cnt@@29 1)) (+ len@@29 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2 stream_new@@29))))))
 (and (<= (|counter#$EventStore| expected@@14) (|counter#$EventStore| actual@@14)) (forall ((handle@@19 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@14) handle@@19)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@14) handle@@19))) (forall ((v@@67 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@14) handle@@19)) v@@67) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@14) handle@@19)) v@@67))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
)))))) (=> (let ((actual@@15 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@15 (let ((stream@@34 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2)))
(let ((stream_new@@30 (let ((len@@30 (|l#Multiset_157370| stream@@34)))
(let ((cnt@@30 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@34) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@34) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2) (+ cnt@@30 1)) (+ len@@30 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2 stream_new@@30))))))
 (and (<= (|counter#$EventStore| expected@@15) (|counter#$EventStore| actual@@15)) (forall ((handle@@20 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@15) handle@@20)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@15) handle@@20))) (forall ((v@@68 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@15) handle@@20)) v@@68) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@15) handle@@20)) v@@68))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 437202) (- 0 616985)) (let ((actual@@16 ($EventStore (- (|counter#$EventStore| $es@2) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2) (|streams#$EventStore| $es)))))
(let ((expected@@16 (let ((stream@@35 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2)))
(let ((stream_new@@31 (let ((len@@31 (|l#Multiset_157370| stream@@35)))
(let ((cnt@@31 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@35) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@35) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| $t6@@2) (+ cnt@@31 1)) (+ len@@31 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t5@@2 stream_new@@31))))))
 (and (<= (|counter#$EventStore| actual@@16) (|counter#$EventStore| expected@@16)) (forall ((handle@@21 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@16) handle@@21)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@16) handle@@21))) (forall ((v@@69 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@16) handle@@21)) v@@69) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@16) handle@@21)) v@@69))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
...
(let ((anon4_Then_correct  (=> (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (=> (= (ControlFlow 0 437458) (- 0 616625)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@66 Int) ) (!  (and (and (|$IsValid'u64'| i@@66) (and (>= i@@66 0) (< i@@66 (seq.len $t3@@2)))) (= (seq.nth $t3@@2 i@@66) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (not (= (|$addr#$signer| _$t0@@2) 186537453))) (> (seq.len _$t2) 63))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (exists ((i@@67 Int) ) (!  (and (and (|$IsValid'u64'| i@@67) (and (>= i@@67 0) (< i@@67 (seq.len $t3@@2)))) (= (seq.nth $t3@@2 i@@67) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) 1))) (not (= (|$addr#$signer| _$t0@@2) 186537453))) (> (seq.len _$t2) 63)) (=> (= (ControlFlow 0 437458) (- 0 616691)) (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)) (= 5 $abort_code@4)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= 5 $abort_code@4))) (and (exists ((i@@68 Int) ) (!  (and (and (|$IsValid'u64'| i@@68) (and (>= i@@68 0) (< i@@68 (seq.len $t3@@2)))) (= (seq.nth $t3@@2 i@@68) ($1_VASPDomain_VASPDomain _$t2)))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
)) (= 7 $abort_code@4))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) (= 5 $abort_code@4))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t4@@2)) 1)) (= 3 $abort_code@4))) (and (not (= (|$addr#$signer| _$t0@@2) 186537453)) (= 2 $abort_code@4))) (and (> (seq.len _$t2) 63) (= 7 $abort_code@4))) (= 3 $abort_code@4)) (= 2 $abort_code@4)) (= 5 $abort_code@4)) (= 7 $abort_code@4))))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= $abort_code@4 $abort_code@3) (= $abort_flag@3 $abort_flag@2)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@0) (= $es@2 $es@0@@2))) (and (=> (= (ControlFlow 0 436744) 437458) anon4_Then_correct) (=> (= (ControlFlow 0 436744) 437202) anon4_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$L7_correct  (=> (and (and (= $abort_code@4 inline$$1_VASPDomain_add_vasp_domain$0$$t17@1) (= $abort_flag@3 true)) (and (= $1_VASPDomain_VASPDomains_$memory@2 $1_VASPDomain_VASPDomains_$memory@1) (= $es@2 $es@1@@2))) (and (=> (= (ControlFlow 0 435802) 437458) anon4_Then_correct) (=> (= (ControlFlow 0 435802) 437202) anon4_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1@@2 $es@0@@2) (= (ControlFlow 0 436758) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| (|v#$Mutation_189683| inline$$1_VASPDomain_add_vasp_domain$0$$t34@1)) (= $es@0@@2 (let ((stream@@36 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1|)))
(let ((stream_new@@32 (let ((len@@32 (|l#Multiset_157370| stream@@36)))
(let ((cnt@@32 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@36) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@36) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_add_vasp_domain$0$$t36@1) (+ cnt@@32 1)) (+ len@@32 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1| stream_new@@32)))))) (and (=> (= (ControlFlow 0 436728) 436758) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 436728) 436744) inline$$1_VASPDomain_add_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct  (=> (and (and (not $abort_flag@2) (= inline$$1_VASPDomain_add_vasp_domain$0$$t34@1 ($Mutation_189683 (|l#$Mutation_242836| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2) (seq.++ (|p#$Mutation_242836| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2) (seq.unit 0)) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_242836| inline$$1_VASPDomain_add_vasp_domain$0$$t33@2))))) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t36@1 ($1_VASPDomain_VASPDomainEvent false inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 _$t1@@2)) (= (ControlFlow 0 436734) 436728))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct  (=> (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@3) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory@0)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436772) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then$1_correct  (=> (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 inline$$1_VASPDomain_add_vasp_domain$0$$t33@0) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 436824) 436772) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 436824) 436734) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 436822) 436824)) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon42_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@1 ($Mutation_242836 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (= inline$$1_VASPDomain_add_vasp_domain$0$$t33@2 inline$$1_VASPDomain_add_vasp_domain$0$$t33@1)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 436619) 436772) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 436619) 436734) inline$$1_VASPDomain_add_vasp_domain$0$anon43_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon41_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@3 ($Mutation_242775 (|l#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (|p#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) ($1_VASPDomain_VASPDomains (|v#$Mutation_174578| |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1|))))) (and (= $1_VASPDomain_VASPDomains_$memory@0 ($Memory_242740 (|Store__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)) (|v#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@3)))) (|$IsValid'address'| 186537453))) (and (=> (= (ControlFlow 0 436597) 436822) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 436597) 436619) inline$$1_VASPDomain_add_vasp_domain$0$anon42_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon41_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436838) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_174578 (|l#$Mutation_174578| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (|p#$Mutation_174578| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (seq.++ (|v#$Mutation_174578| inline$$1_VASPDomain_add_vasp_domain$0$$t31@1) (seq.unit inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)))) (and (=> (= (ControlFlow 0 436549) 436838) inline$$1_VASPDomain_add_vasp_domain$0$anon41_Then_correct) (=> (= (ControlFlow 0 436549) 436597) inline$$1_VASPDomain_add_vasp_domain$0$anon41_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon40_Then_correct  (=> inline$$Not$0$dst@1 (=> (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t31@1 ($Mutation_174578 (|l#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (seq.++ (|p#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2) (seq.unit 0)) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2)))) (= (ControlFlow 0 436555) 436549)) |inline$$1_Vector_push_back'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon40_Else_correct  (=> (and (not inline$$Not$0$dst@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436482) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else$1_correct  (=> (|$IsValid'u64'| 3) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 7)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t30@0 inline$$1_VASPDomain_add_vasp_domain$0$$t30@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 436466) 436555) inline$$1_VASPDomain_add_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 436466) 436482) inline$$1_VASPDomain_add_vasp_domain$0$anon40_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1|)) (= (ControlFlow 0 436426) 436466)) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 436432) 436426)) inline$$Not$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon39_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436852) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((|inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$res@1| (exists ((i@@69 Int) ) (!  (and (and (|$IsValid'u64'| i@@69) (and (>= i@@69 0) (< i@@69 (seq.len inline$$1_VASPDomain_add_vasp_domain$0$$t26@1)))) (= (seq.nth inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 i@@69) inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1))
 :qid |TreasuryComplianceScriptsbpl.1860:13|
 :skolemid |52|
))) (and (=> (= (ControlFlow 0 436382) 436852) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 436382) 436432) inline$$1_VASPDomain_add_vasp_domain$0$anon39_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct  (=> (and (and (not $abort_flag@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t26@1 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2))) (= (ControlFlow 0 436388) 436382))) |inline$$1_Vector_contains'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct  (=> (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@2) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436866) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct  (=> (= $abort_code@2 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1) (=> (and (= $abort_flag@1 true) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0)) (and (=> (= (ControlFlow 0 436282) 436866) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 436282) 436388) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct  (=> (and (and (not inline$$Le$0$dst@1) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= (ControlFlow 0 436276) 436282))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1 $abort_code@1) (= (ControlFlow 0 436314) 436282))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct  (=> (and inline$$Le$0$dst@1 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 ($1_VASPDomain_VASPDomain _$t2))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1))) (and (=> (= (ControlFlow 0 436300) 436866) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 436300) 436388) inline$$1_VASPDomain_add_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0) (= inline$$Le$0$dst@1 inline$$Le$0$dst@1))) (and (=> (= (ControlFlow 0 436260) 436300) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct) (=> (= (ControlFlow 0 436260) 436276) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct))))))
(let ((inline$$Le$0$anon0_correct  (=> (and (= inline$$Le$0$dst@1 (<= |inline$$1_Vector_length'u8'$0$l@1| 63)) (= (ControlFlow 0 436224) 436260)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct  (=> (not $abort_flag@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 436230) 436224)) inline$$Le$0$anon0_correct))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (seq.len _$t2)) (and (=> (= (ControlFlow 0 436164) 436314) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct) (=> (= (ControlFlow 0 436164) 436230) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct  (=> (and (= _$t2 _$t2) (= (ControlFlow 0 436170) 436164)) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct  (=> (and (and (not $abort_flag@0) (= |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| (|v#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@2))) (and (= |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| |inline$$1_VASPDomain_add_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1|) (= (ControlFlow 0 436320) 436170))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct  (=> (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 $abort_code@1) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 436880) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 inline$$1_VASPDomain_add_vasp_domain$0$$t24@0)) (and (=> (= (ControlFlow 0 436932) 436880) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 436932) 436320) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)) (= (ControlFlow 0 436930) 436932)) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then$1_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon36_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@1 ($Mutation_242775 ($Global _$t1@@2) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2))) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t24@2 inline$$1_VASPDomain_add_vasp_domain$0$$t24@1))) (and (=> (= (ControlFlow 0 435886) 436880) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 435886) 436320) inline$$1_VASPDomain_add_vasp_domain$0$anon37_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon35_Then_correct  (=> inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 (and (=> (= (ControlFlow 0 435864) 436930) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Then_correct) (=> (= (ControlFlow 0 435864) 435886) inline$$1_VASPDomain_add_vasp_domain$0$anon36_Else_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct  (=> (and (not inline$$1_VASPDomain_add_vasp_domain$0$$t21@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 435860) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (=> (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 5)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t23@0 inline$$1_VASPDomain_add_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t21@1 inline$$1_VASPDomain_add_vasp_domain$0$$t21@1))) (and (=> (= (ControlFlow 0 435844) 435864) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Then_correct) (=> (= (ControlFlow 0 435844) 435860) inline$$1_VASPDomain_add_vasp_domain$0$anon35_Else_correct)))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon34_Else_correct  (=> (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1) (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 435796) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon33_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 5)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t20@0 inline$$1_VASPDomain_add_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1))) (and (=> (= (ControlFlow 0 435780) 435844) inline$$1_VASPDomain_add_vasp_domain$0$anon34_Then_correct) (=> (= (ControlFlow 0 435780) 435796) inline$$1_VASPDomain_add_vasp_domain$0$anon34_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon32_Then_correct  (=> inline$$1_VASPDomain_add_vasp_domain$0$$t16@0 (=> (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) (= 5 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) 1)) (= 3 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (and (not (= (|$addr#$signer| _$t0@@2) 186537453)) (= 2 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0))) (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@0 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0)) (=> (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t17@1 inline$$1_VASPDomain_add_vasp_domain$0$$t17@0) (= $1_VASPDomain_VASPDomains_$memory@1 $1_VASPDomain_VASPDomains_$memory)) (and (= $es@1@@2 $es) (= (ControlFlow 0 437018) 435802))) inline$$1_VASPDomain_add_vasp_domain$0$L7_correct)))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon33_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1)) (and (=> (= (ControlFlow 0 435738) 436946) inline$$1_VASPDomain_add_vasp_domain$0$anon33_Then_correct) (=> (= (ControlFlow 0 435738) 435780) inline$$1_VASPDomain_add_vasp_domain$0$anon33_Else_correct))))))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon32_Else_correct  (=> (and (not inline$$1_VASPDomain_add_vasp_domain$0$$t16@0) (= (ControlFlow 0 435744) 435738)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct)))
(let ((inline$$1_VASPDomain_add_vasp_domain$0$anon0_correct  (=> (and (= (seq.len (|p#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t9@0)) 0) (= (seq.len (|p#$Mutation_242775| inline$$1_VASPDomain_add_vasp_domain$0$$t24@0)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_174578| inline$$1_VASPDomain_add_vasp_domain$0$$t31@0)) 0) (= (seq.len (|p#$Mutation_242836| inline$$1_VASPDomain_add_vasp_domain$0$$t33@0)) 0)) (and (= (seq.len (|p#$Mutation_189683| inline$$1_VASPDomain_add_vasp_domain$0$$t34@0)) 0) (= inline$$1_VASPDomain_add_vasp_domain$0$$t11@0 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2))))) (=> (and (and (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t12@0 (|$addr#$signer| _$t0@@2)) (= inline$$1_VASPDomain_add_vasp_domain$0$$t13@0 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t14@0 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1@@2)) (= _$t0@@2 _$t0@@2))) (and (and (= _$t1@@2 _$t1@@2) (= _$t2 _$t2)) (and (= inline$$1_VASPDomain_add_vasp_domain$0$$t15@0 (|$addr#$signer| _$t0@@2)) (= inline$$1_VASPDomain_add_vasp_domain$0$$t16@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_add_vasp_domain$0$$t15@0)) 1))) (not (= (|$addr#$signer| _$t0@@2) 186537453))))))) (and (=> (= (ControlFlow 0 435651) 437018) inline$$1_VASPDomain_add_vasp_domain$0$anon32_Then_correct) (=> (= (ControlFlow 0 435651) 435744) inline$$1_VASPDomain_add_vasp_domain$0$anon32_Else_correct)))))))
(let ((anon0$1_correct@@2  (=> (and (and (forall ((addr@@112 Int) ) (!  (=> (|$IsValid'address'| addr@@112) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@112) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@112)) 0)) (= addr@@112 173345816)))
 :qid |TreasuryComplianceScriptsbpl.24445:20|
 :skolemid |512|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@113 Int) ) (!  (=> (|$IsValid'address'| addr@@113) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@113) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@113)) 1)) (= addr@@113 186537453)))
 :qid |TreasuryComplianceScriptsbpl.24453:20|
 :skolemid |513|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (and (forall ((addr@@114 Int) ) (!  (=> (|$IsValid'address'| addr@@114) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@114)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24461:20|
 :skolemid |514|
)) (forall ((addr@@115 Int) ) (!  (=> (|$IsValid'address'| addr@@115) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@115)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24465:20|
 :skolemid |515|
))) (and (forall ((addr@@116 Int) ) (!  (=> (|$IsValid'address'| addr@@116) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@116)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24469:20|
 :skolemid |516|
)) (forall ((addr@@117 Int) ) (!  (=> (|$IsValid'address'| addr@@117) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@117)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24473:20|
 :skolemid |517|
)))) (and (and (forall ((addr@@118 Int) ) (!  (=> (|$IsValid'address'| addr@@118) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@118)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24477:20|
 :skolemid |518|
)) (forall ((addr@@119 Int) ) (!  (=> (|$IsValid'address'| addr@@119) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@119)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24481:20|
 :skolemid |519|
))) (and (forall ((addr@@120 Int) ) (!  (=> (|$IsValid'address'| addr@@120) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@120)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24485:20|
 :skolemid |520|
)) (forall ((addr@@121 Int) ) (!  (=> (|$IsValid'address'| addr@@121) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@121) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@121) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@121)) 4))))
 :qid |TreasuryComplianceScriptsbpl.24489:20|
 :skolemid |521|
))))) (and (and (and (forall ((addr@@122 Int) ) (!  (=> (|$IsValid'address'| addr@@122) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@122) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@122) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@122)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24493:20|
 :skolemid |522|
)) (forall ((addr@@123 Int) ) (!  (=> (|$IsValid'address'| addr@@123) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@123) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@123) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@123)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24497:20|
 :skolemid |523|
))) (and (forall ((addr@@124 Int) ) (!  (=> (|$IsValid'address'| addr@@124) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@124) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@124)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@124) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@124)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24501:20|
 :skolemid |524|
)) (let (($range_0@@2 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@125 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@125))))))))
(forall (($i_1@@2 Int) ) (!  (=> ($InRange $range_0@@2 $i_1@@2) (let ((i1@@2 $i_1@@2))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@126 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@126)))) i1@@2))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@126 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@126)))) i1@@2)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.24505:151|
 :skolemid |525|
))))) (and (and (forall ((addr1@@5 Int) ) (!  (=> (|$IsValid'address'| addr1@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr1@@5) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@5)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@5) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@5)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24510:20|
 :skolemid |526|
)) (forall ((addr@@127 Int) ) (!  (=> (|$IsValid'address'| addr@@127) (= (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@127) (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@127)))
 :qid |TreasuryComplianceScriptsbpl.24514:20|
 :skolemid |527|
))) (and (forall ((addr@@128 Int) ) (!  (=> (|$IsValid'address'| addr@@128) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) addr@@128)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@128) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@128)) 1))))
 :qid |TreasuryComplianceScriptsbpl.24518:20|
 :skolemid |528|
)) (forall ((addr@@129 Int) ) (!  (=> (|$IsValid'address'| addr@@129) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) addr@@129)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@129) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@129)) 5))))
 :qid |TreasuryComplianceScriptsbpl.24522:20|
 :skolemid |529|
)))))) (=> (and (and (and (and (and (forall ((addr@@130 Int) ) (!  (=> (|$IsValid'address'| addr@@130) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_258004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@130) (|Select__T@[Int]Bool_| (|domain#$Memory_258087| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@130)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@130)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24526:20|
 :skolemid |530|
)) (forall ((addr@@131 Int) ) (!  (=> (|$IsValid'address'| addr@@131) (= (|Select__T@[Int]Bool_| (|domain#$Memory_254376| $1_DesignatedDealer_Dealer_$memory) addr@@131)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@131) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@131)) 2))))
 :qid |TreasuryComplianceScriptsbpl.24530:20|
 :skolemid |531|
))) (and (forall ((addr@@132 Int) ) (!  (=> (|$IsValid'address'| addr@@132) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr@@132)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@132)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@132) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@132)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.24534:20|
 :skolemid |532|
)) (forall ((addr@@133 Int) ) (!  (=> (|$IsValid'address'| addr@@133) (= (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) addr@@133)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@133)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@133) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@133)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.24538:20|
 :skolemid |533|
)))) (and (and (forall ((addr@@134 Int) ) (!  (=> (|$IsValid'address'| addr@@134) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@134)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@134) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@134)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24542:20|
 :skolemid |534|
)) (forall ((addr@@135 Int) ) (!  (=> (|$IsValid'address'| addr@@135) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@135)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@135) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@135)) 4))))
 :qid |TreasuryComplianceScriptsbpl.24546:20|
 :skolemid |535|
))) (and (forall ((addr@@136 Int) ) (!  (=> (|$IsValid'address'| addr@@136) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246011| $1_VASP_ParentVASP_$memory) addr@@136)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@136) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@136)) 5))))
 :qid |TreasuryComplianceScriptsbpl.24550:20|
 :skolemid |536|
)) (forall ((addr@@137 Int) ) (!  (=> (|$IsValid'address'| addr@@137) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245947| $1_VASP_ChildVASP_$memory) addr@@137)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@137) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@137)) 6))))
 :qid |TreasuryComplianceScriptsbpl.24554:20|
 :skolemid |537|
))))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2))) (and (|$IsValid'address'| _$t1@@2) (|$IsValid'vec'u8''| _$t2)))) (and (and (and (and (forall (($a_0@@38 Int) ) (! (let (($rsc@@38 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@38)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@38))
 :qid |TreasuryComplianceScriptsbpl.24566:20|
 :skolemid |538|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@38))
)) (forall (($a_0@@39 Int) ) (! (let (($rsc@@39 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@39)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@39))
 :qid |TreasuryComplianceScriptsbpl.24570:20|
 :skolemid |539|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@39))
))) (and (forall (($a_0@@40 Int) ) (! (let (($rsc@@40 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) $a_0@@40)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@40) (and (and (let (($range_1@@2 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40)))))
(forall (($i_2@@2 Int) ) (!  (=> ($InRange $range_1@@2 $i_2@@2) (let ((i@@70 $i_2@@2))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40) i@@70))) 63)))
 :qid |TreasuryComplianceScriptsbpl.24575:140|
 :skolemid |540|
))) (let (($range_3 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40)))))
(forall (($i_4 Int) ) (!  (=> ($InRange $range_3 $i_4) (let ((i@@71 $i_4))
(let (($range_5 ($Range (+ i@@71 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40)))))
(forall (($i_6 Int) ) (!  (=> ($InRange $range_5 $i_6) (let ((j@@14 $i_6))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40) i@@71) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40) j@@14)))))
 :qid |TreasuryComplianceScriptsbpl.24577:98|
 :skolemid |541|
)))))
 :qid |TreasuryComplianceScriptsbpl.24576:202|
 :skolemid |542|
)))) (let (($range_7 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@40)))
(forall (($i_8 Int) ) (!  (=> (and (>= $i_8 0) (< $i_8 (seq.len $range_7))) (let (($elem (seq.nth $range_7 $i_8)))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem)) 63)))
 :qid |TreasuryComplianceScriptsbpl.24578:229|
 :skolemid |543|
))))))
 :qid |TreasuryComplianceScriptsbpl.24574:20|
 :skolemid |544|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) $a_0@@40))
)) (= $t3@@2 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2))))) (and (and (= $t4@@2 (|$addr#$signer| _$t0@@2)) (= $t5@@2 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t6@@2 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1@@2)) (let ((addr@@138 (|$addr#$signer| _$t0@@2)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@138)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@138) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@138))))))))) (and (and (and (= _$t0@@2 _$t0@@2) (= _$t1@@2 _$t1@@2)) (and (= _$t2 _$t2) (= $t7@@2 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@2))))) (and (and (= $t8@@2 (|$addr#$signer| _$t0@@2)) (= $t9@@2 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t10@@2 ($1_VASPDomain_VASPDomainEvent false ($1_VASPDomain_VASPDomain _$t2) _$t1@@2)) (= (ControlFlow 0 437022) 435651)))))) inline$$1_VASPDomain_add_vasp_domain$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@22 T@$1_Event_EventHandle) ) (! (let ((stream@@37 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) handle@@22)))
 (and (= (|l#Multiset_157370| stream@@37) 0) (forall ((v@@70 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@37) v@@70) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 433304) 437022)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 613965) 433304) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2)))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
