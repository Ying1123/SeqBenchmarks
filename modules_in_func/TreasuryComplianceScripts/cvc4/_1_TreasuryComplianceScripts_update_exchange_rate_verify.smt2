...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@5@@0| () T@$Memory_199883)
(declare-fun $t23@@5 () Int)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@3| () T@$Memory_258170)
(declare-fun _$t1@@10 () Int)
(declare-fun $t24@@5 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun _$t0@@10 () T@$signer)
(declare-fun $t5@@10 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun _$t2@@7 () Int)
(declare-fun $t6@@10 () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
(declare-fun $t7@@9 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@6@@0| () T@$Memory_206435)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@2 () T@$Memory_258253)
(declare-fun $t3@@4 () Int)
(declare-fun $t4@@7 () Int)
(declare-fun $es@7@@2 () T@$EventStore)
(declare-fun $t8@@9 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t10@@9 () T@$1_Event_EventHandle)
(declare-fun $t9@@9 () (Seq Int))
(declare-fun $t11@@8 () T@$1_Event_EventHandle)
(declare-fun $t12@@6 () T@$1_DiemAccount_ReceivedPaymentEvent)
...
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t22@1| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t27@0| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t21@1| () (Seq Int))
(declare-fun $abort_flag@4@@3 () Bool)
(declare-fun $abort_code@5@@3 () Int)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@2@@1| () T@$Memory_258170)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@2 () T@$Memory_258253)
...
(declare-fun $es@6@@2 () T@$EventStore)
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$temp_0'bool'@3| () Bool)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@1@@1| () T@$Memory_238737)
(declare-fun |$1_AccountLimits_Window'#0'_$memory@0@@1| () T@$Memory_238737)
...
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@5 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@5 () T@$Memory_258253)
...
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@1@@1| () T@$Memory_258170)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@0@@1| () T@$Memory_258170)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@3@@0| () T@$Memory_199883)
(declare-fun $abort_code@4@@4 () Int)
(declare-fun $es@3@@2 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@4@@0| () T@$Memory_206435)
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$ret0@0| () |T@$1_Diem_Diem'#0'|)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@4@@0| () T@$Memory_199883)
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$t14@1| () Int)
(declare-fun $es@4@@2 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@5@@0| () T@$Memory_206435)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t20@1| () |T@$1_Diem_Diem'#0'|)
(declare-fun $abort_code@3@@4 () Int)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@2@@2| () T@$Memory_199883)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@2@@1| () T@$Memory_206435)
(declare-fun $abort_flag@2@@4 () Bool)
(declare-fun $es@2@@6 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@2| () T@$Memory_199883)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@3| () T@$Mutation_218697)
(declare-fun $es@0@@10 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@3 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@2| () T@$Memory_199883)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@3@@0| () T@$Memory_206435)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t34@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@2| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t24@1| () T@$Mutation_218697)
...
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@1@@1| () T@$Memory_206435)
(declare-fun |$1_Diem_PreburnQueue'#0'_$memory@0@@1| () T@$Memory_206435)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t6@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t31@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'#0'$0$$t34@0| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$t21@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$t24@0| () (Seq Int))
...
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$t8@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |inline$$1_Diem_cancel_burn'#0'$0$$t11@0| () (Seq Int))
...
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t5@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t6@0| () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t7@0| () (Seq Int))
...
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t14@0| () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
...
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t17@0| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'#0'$0$$t18@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@8 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t14@@8 () (Seq |T@$1_Diem_PreburnWithMetadata'#0'|))
(declare-fun $t15@@8 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t16@@8 () (Seq Int))
(declare-fun $t17@@8 () T@$1_Event_EventHandle)
(declare-fun $t18@@8 () |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun $t19@@8 () T@$1_Event_EventHandle)
(declare-fun $t20@@8 () T@$1_DiemAccount_ReceivedPaymentEvent)
; Valid
(declare-fun $abort_flag@5@@3 () Bool)
(declare-fun $t22@@6 () Int)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@5@@0| () T@$Memory_199645)
(declare-fun $t23@@6 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@3| () T@$Memory_258004)
(declare-fun _$t1@@11 () Int)
(declare-fun $t24@@6 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun _$t0@@11 () T@$signer)
(declare-fun $t5@@11 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun _$t2@@8 () Int)
(declare-fun $t6@@11 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun $t7@@10 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@6@@0| () T@$Memory_206237)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@3 () T@$Memory_258253)
(declare-fun $t3@@5 () Int)
(declare-fun $t4@@8 () Int)
(declare-fun $es@7@@3 () T@$EventStore)
(declare-fun $t8@@10 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t10@@10 () T@$1_Event_EventHandle)
(declare-fun $t9@@10 () (Seq Int))
(declare-fun $t11@@9 () T@$1_Event_EventHandle)
(declare-fun $t12@@7 () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun $abort_code@6@@3 () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t20@1| () Int)
(declare-fun $es@5@@3 () T@$EventStore)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t28@0| () Bool)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t20@0| () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t24@0| () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t22@1| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t27@0| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t21@1| () (Seq Int))
(declare-fun $abort_flag@4@@4 () Bool)
(declare-fun $abort_code@5@@4 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@2@@1| () T@$Memory_258004)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@3 () T@$Memory_258253)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t29@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t26@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t30@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t25@0| () T@$1_Event_EventHandle)
(declare-fun $es@6@@3 () T@$EventStore)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'bool'@3| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@1@@1| () T@$Memory_238609)
(declare-fun |$1_AccountLimits_Window'$1_XUS_XUS'_$memory@0@@1| () T@$Memory_238609)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'$1_AccountLimits_Window'$1_XUS_XUS''@1| () |T@$1_AccountLimits_Window'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'bool'@2| () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@6 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@6 () T@$Memory_258253)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'$1_DiemAccount_DiemAccount'@1| () T@$1_DiemAccount_DiemAccount)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'bool'@1| () Bool)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@1@@1| () T@$Memory_258004)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@0@@1| () T@$Memory_258004)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$temp_0'$1_DiemAccount_Balance'$1_XUS_XUS''@1| () |T@$1_DiemAccount_Balance'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$ret0@1| () |T@$1_Diem_Diem'$1_XUS_XUS'|)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@3@@0| () T@$Memory_199645)
(declare-fun $abort_code@4@@5 () Int)
(declare-fun $es@3@@3 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@4@@0| () T@$Memory_206237)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$ret0@0| () |T@$1_Diem_Diem'$1_XUS_XUS'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@4@@0| () T@$Memory_199645)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t14@1| () Int)
(declare-fun $es@4@@3 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@5@@0| () T@$Memory_206237)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@2@@2| () T@$Memory_199645)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@2@@1| () T@$Memory_206237)
(declare-fun $abort_flag@2@@5 () Bool)
(declare-fun $es@2@@7 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@1@@2| () T@$Memory_199645)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t24@3| () T@$Mutation_214414)
(declare-fun $es@0@@11 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@4 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory@0@@2| () T@$Memory_199645)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@3@@0| () T@$Memory_206237)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t34@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t31@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t24@2| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t31@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t24@0| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t24@1| () T@$Mutation_214414)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@1@@1| () T@$Memory_206237)
(declare-fun |$1_Diem_PreburnQueue'$1_XUS_XUS'_$memory@0@@1| () T@$Memory_206237)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t6@0| () T@$Mutation_214414)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t31@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XUS_XUS'$0$$t34@0| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t19@2| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t20@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t21@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t22@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t23@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t24@0| () (Seq Int))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t25@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t19@0| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t15@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t19@1| () |T@$1_Diem_BurnCapability'$1_XUS_XUS'|)
(declare-fun $abort_code@0@@8 () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t16@1| () Bool)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t18@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t13@0| () Bool)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t14@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t6@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t7@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t8@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t10@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t11@0| () (Seq Int))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XUS_XUS'$0$$t12@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t4@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t5@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t6@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t7@0| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t8@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t10@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t11@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t12@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t13@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t14@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t15@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t16@0| () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t17@0| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XUS_XUS'$0$$t18@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@9 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t14@@9 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XUS_XUS'|))
(declare-fun $t15@@9 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t16@@9 () (Seq Int))
(declare-fun $t17@@9 () T@$1_Event_EventHandle)
(declare-fun $t18@@9 () |T@$1_Diem_CurrencyInfo'$1_XUS_XUS'|)
(declare-fun $t19@@9 () T@$1_Event_EventHandle)
(declare-fun $t20@@9 () T@$1_DiemAccount_ReceivedPaymentEvent)
; Valid
(declare-fun $abort_flag@5@@4 () Bool)
(declare-fun $t22@@7 () Int)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@5@@0| () T@$Memory_199764)
(declare-fun $t23@@7 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| () T@$Memory_258087)
(declare-fun _$t1@@12 () Int)
(declare-fun $t24@@7 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun _$t0@@12 () T@$signer)
(declare-fun $t5@@12 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun _$t2@@9 () Int)
(declare-fun $t6@@12 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun $t7@@11 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@6@@0| () T@$Memory_206336)
(declare-fun $1_DiemAccount_DiemAccount_$memory@3@@4 () T@$Memory_258253)
(declare-fun $t3@@6 () Int)
(declare-fun $t4@@9 () Int)
(declare-fun $es@7@@4 () T@$EventStore)
(declare-fun $t8@@11 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t10@@11 () T@$1_Event_EventHandle)
(declare-fun $t9@@11 () (Seq Int))
(declare-fun $t11@@10 () T@$1_Event_EventHandle)
(declare-fun $t12@@8 () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun $abort_code@6@@4 () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t20@1| () Int)
(declare-fun $es@5@@4 () T@$EventStore)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t28@0| () Bool)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t20@0| () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t24@0| () Int)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t22@1| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t27@0| () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t21@1| () (Seq Int))
(declare-fun $abort_flag@4@@5 () Bool)
(declare-fun $abort_code@5@@5 () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2@@1| () T@$Memory_258087)
(declare-fun $1_DiemAccount_DiemAccount_$memory@2@@4 () T@$Memory_258253)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t29@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t26@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t30@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t25@0| () T@$1_Event_EventHandle)
(declare-fun $es@6@@4 () T@$EventStore)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'bool'@3| () Bool)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@1@@1| () T@$Memory_238673)
(declare-fun |$1_AccountLimits_Window'$1_XDX_XDX'_$memory@0@@1| () T@$Memory_238673)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'$1_AccountLimits_Window'$1_XDX_XDX''@1| () |T@$1_AccountLimits_Window'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'bool'@2| () Bool)
(declare-fun $1_DiemAccount_DiemAccount_$memory@1@@7 () T@$Memory_258253)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@7 () T@$Memory_258253)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'$1_DiemAccount_DiemAccount'@1| () T@$1_DiemAccount_DiemAccount)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'bool'@1| () Bool)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1@@1| () T@$Memory_258087)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0@@1| () T@$Memory_258087)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$temp_0'$1_DiemAccount_Balance'$1_XDX_XDX''@1| () |T@$1_DiemAccount_Balance'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$ret0@1| () |T@$1_Diem_Diem'$1_XDX_XDX'|)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@3@@0| () T@$Memory_199764)
(declare-fun $abort_code@4@@6 () Int)
(declare-fun $es@3@@4 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@4@@0| () T@$Memory_206336)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$ret0@0| () |T@$1_Diem_Diem'$1_XDX_XDX'|)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@4@@0| () T@$Memory_199764)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t14@1| () Int)
(declare-fun $es@4@@4 () T@$EventStore)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@5@@0| () T@$Memory_206336)
...
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@2@@2| () T@$Memory_199764)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@2@@1| () T@$Memory_206336)
(declare-fun $abort_flag@2@@6 () Bool)
(declare-fun $es@2@@8 () T@$EventStore)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@1@@2| () T@$Memory_199764)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t24@3| () T@$Mutation_216578)
(declare-fun $es@0@@12 () T@$EventStore)
(declare-fun inline$$Not$0$dst@1@@5 () Bool)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory@0@@2| () T@$Memory_199764)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@3@@0| () T@$Memory_206336)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t34@1| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t31@1| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t24@2| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t31@2| () T@$Mutation_16758)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t24@0| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t24@1| () T@$Mutation_216578)
...
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@1@@1| () T@$Memory_206336)
(declare-fun |$1_Diem_PreburnQueue'$1_XDX_XDX'_$memory@0@@1| () T@$Memory_206336)
...
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t6@0| () T@$Mutation_216578)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t31@0| () T@$Mutation_16758)
(declare-fun |inline$$1_Diem_cancel_burn_with_capability'$1_XDX_XDX'$0$$t34@0| () T@$Mutation_189683)
...
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t19@2| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t20@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t21@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t22@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t23@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t24@0| () (Seq Int))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t25@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t19@0| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t15@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t19@1| () |T@$1_Diem_BurnCapability'$1_XDX_XDX'|)
(declare-fun $abort_code@0@@9 () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t16@1| () Bool)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t18@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t13@0| () Bool)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t14@0| () Int)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t6@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t7@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t8@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t10@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t11@0| () (Seq Int))
(declare-fun |inline$$1_Diem_cancel_burn'$1_XDX_XDX'$0$$t12@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t4@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t5@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t6@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t7@0| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t8@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t9@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t10@0| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t11@0| () T@$1_DiemAccount_ReceivedPaymentEvent)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t12@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t13@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t14@0| () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t15@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t16@0| () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t17@0| () (Seq Int))
(declare-fun |inline$$1_DiemAccount_cancel_burn'$1_XDX_XDX'$0$$t18@0| () T@$1_Event_EventHandle)
(declare-fun $t13@@10 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t14@@10 () (Seq |T@$1_Diem_PreburnWithMetadata'$1_XDX_XDX'|))
(declare-fun $t15@@10 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t16@@10 () (Seq Int))
(declare-fun $t17@@10 () T@$1_Event_EventHandle)
(declare-fun $t18@@10 () |T@$1_Diem_CurrencyInfo'$1_XDX_XDX'|)
(declare-fun $t19@@10 () T@$1_Event_EventHandle)
(declare-fun $t20@@10 () T@$1_DiemAccount_ReceivedPaymentEvent)
; Valid
; Valid
...
(declare-fun $t19@@11 () Int)
(declare-fun $t17@@11 () Int)
(declare-fun $abort_flag@0@@10 () Bool)
(declare-fun $abort_code@1@@10 () Int)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| () T@$Memory_199883)
(declare-fun $t5@@13 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun $es@2@@9 () T@$EventStore)
(declare-fun $t10@@12 () T@$1_Event_EventHandle)
(declare-fun $t11@@11 () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
...
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| () T@$Memory_199883)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3| () T@$Mutation_218697)
(declare-fun |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| () T@$1_Event_EventHandle)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| () T@$Mutation_189683)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1| () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| () (Seq Int))
...
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| () T@$Mutation_235773)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| () T@$Mutation_235773)
(declare-fun $t20@@11 () T@$1_FixedPoint32_FixedPoint32)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0| () T@$Mutation_218697)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0| () T@$Mutation_235773)
(declare-fun |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0| () T@$Mutation_189683)
...
(declare-fun $t23@@8 () T@$1_Event_EventHandle)
(declare-fun $t24@@8 () T@$1_Diem_ToXDXExchangeRateUpdateEvent)
...
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@2@@5 () T@$Memory_197482)
(declare-fun |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@5| () Bool)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@1@@5 () T@$Memory_197482)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory@0@@5 () T@$Memory_197482)
...
(assert (not
 (=> (= (ControlFlow 0 0) 704613) (let ((L2_correct@@8  (and (=> (= (ControlFlow 0 579501) (- 0 707343)) (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (= $t7@@12 0)) (and (= $t8@@12 0) (not (= $t6@@13 0)))) (> $t8@@12 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (or (or (or (or (or (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (= $t7@@12 0)) (and (= $t8@@12 0) (not (= $t6@@13 0)))) (> $t8@@12 18446744073709551615)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))) (=> (= (ControlFlow 0 579501) (- 0 707474)) (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (= 5 $t13@0)) (and (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0)) (= 7 $t13@0))) (and (= $t7@@12 0) (= 7 $t13@0))) (and (and (= $t8@@12 0) (not (= $t6@@13 0))) (= 7 $t13@0))) (and (> $t8@@12 18446744073709551615) (= 8 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 $t13@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) (= 5 $t13@0))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) 1)) (= 3 $t13@0))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 $t13@0))) (= 7 $t13@0)) (= 2 $t13@0)) (= 8 $t13@0)) (= 3 $t13@0)) (= 5 $t13@0)))))))
(let ((anon10_Then_correct  (=> (and (and $abort_flag@2@@7 (= $abort_code@3@@7 $abort_code@3@@7)) (and (= $t13@0 $abort_code@3@@7) (= (ControlFlow 0 579073) 579501))) L2_correct@@8)))
(let ((anon9_Then_correct  (=> $t21@@5 (=> (and (and (or (or (and (= $t18@@11 0) (= 7 $t13@@11)) (and (and (= $t19@@11 0) (not (= $t17@@11 0))) (= 7 $t13@@11))) (and (> $t19@@11 18446744073709551615) (= 8 $t13@@11))) (= $t13@@11 $t13@@11)) (and (= $t13@0 $t13@@11) (= (ControlFlow 0 579569) 579501))) L2_correct@@8))))
(let ((anon8_Then_correct  (=> (and (and $abort_flag@0@@10 (= $abort_code@1@@10 $abort_code@1@@10)) (and (= $t13@0 $abort_code@1@@10) (= (ControlFlow 0 579583) 579501))) L2_correct@@8)))
(let ((anon10_Else_correct  (=> (not $abort_flag@2@@7) (and (=> (= (ControlFlow 0 579059) (- 0 707099)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13)))) (and (=> (= (ControlFlow 0 579059) (- 0 707112)) (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0)))) (=> (not (not (= ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13) 0))) (and (=> (= (ControlFlow 0 579059) (- 0 707127)) (not (= $t7@@12 0))) (=> (not (= $t7@@12 0)) (and (=> (= (ControlFlow 0 579059) (- 0 707138)) (not (and (= $t8@@12 0) (not (= $t6@@13 0))))) (=> (not (and (= $t8@@12 0) (not (= $t6@@13 0)))) (and (=> (= (ControlFlow 0 579059) (- 0 707159)) (not (> $t8@@12 18446744073709551615))) (=> (not (> $t8@@12 18446744073709551615)) (and (=> (= (ControlFlow 0 579059) (- 0 707170)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12))) (and (=> (= (ControlFlow 0 579059) (- 0 707182)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t9@@12)) 1))) (and (=> (= (ControlFlow 0 579059) (- 0 707200)) (not (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 186537453))) (and (=> (= (ControlFlow 0 579059) (- 0 707214)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 579059) (- 0 707224)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9))) (and (=> (= (ControlFlow 0 579059) (- 0 707236)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $t12@@9)) 1))) (and (=> (= (ControlFlow 0 579059) (- 0 707254)) (not (not (= (|$addr#$signer| _$t0@@13) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0@@13) 186537453))) (and (=> (= (ControlFlow 0 579059) (- 0 707268)) (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) $t5@@13)) (=> (= (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory@1@@3|) 173345816)) $t5@@13) (and (=> (= (ControlFlow 0 579059) (- 0 707280)) (let ((actual@@62 ($EventStore (- (|counter#$EventStore| $es@2@@9) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2@@9) (|streams#$EventStore| $es)))))
(let ((expected@@62 (let ((stream@@145 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@130 (let ((len@@130 (|l#Multiset_157370| stream@@145)))
(let ((cnt@@130 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@145) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@145) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@130 1)) (+ len@@130 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@130))))))
 (and (<= (|counter#$EventStore| expected@@62) (|counter#$EventStore| actual@@62)) (forall ((handle@@78 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@62) handle@@78)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@62) handle@@78))) (forall ((v@@126 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@62) handle@@78)) v@@126) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@62) handle@@78)) v@@126))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
)))))) (=> (let ((actual@@63 ($EventStore (- (|counter#$EventStore| $es@2@@9) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2@@9) (|streams#$EventStore| $es)))))
(let ((expected@@63 (let ((stream@@146 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@131 (let ((len@@131 (|l#Multiset_157370| stream@@146)))
(let ((cnt@@131 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@146) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@146) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@131 1)) (+ len@@131 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@131))))))
 (and (<= (|counter#$EventStore| expected@@63) (|counter#$EventStore| actual@@63)) (forall ((handle@@79 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@63) handle@@79)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@63) handle@@79))) (forall ((v@@127 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@63) handle@@79)) v@@127) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@63) handle@@79)) v@@127))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
 :skolemid |95|
))))) (=> (= (ControlFlow 0 579059) (- 0 707305)) (let ((actual@@64 ($EventStore (- (|counter#$EventStore| $es@2@@9) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@2@@9) (|streams#$EventStore| $es)))))
(let ((expected@@64 (let ((stream@@147 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12)))
(let ((stream_new@@132 (let ((len@@132 (|l#Multiset_157370| stream@@147)))
(let ((cnt@@132 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@147) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@147) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| $t11@@11) (+ cnt@@132 1)) (+ len@@132 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $EmptyEventStore) $t10@@12 stream_new@@132))))))
 (and (<= (|counter#$EventStore| actual@@64) (|counter#$EventStore| expected@@64)) (forall ((handle@@80 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@64) handle@@80)) (|l#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@64) handle@@80))) (forall ((v@@128 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| actual@@64) handle@@80)) v@@128) (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| expected@@64) handle@@80)) v@@128))
 :qid |TreasuryComplianceScriptsbpl.139:13|
 :skolemid |3|
)))
 :qid |TreasuryComplianceScriptsbpl.3468:13|
...
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|  (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory|) (= $abort_code@3@@7 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1|)) (and (= $es@2@@9 $es@1@@12) (= $abort_flag@2@@7 true))) (and (=> (= (ControlFlow 0 578631) 579073) anon10_Then_correct) (=> (= (ControlFlow 0 578631) 579059) anon10_Else_correct)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es@0@@13)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2@@7) (= (ControlFlow 0 578625) 578631))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2@@7) (= (ControlFlow 0 578645) 578631))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|  (=> $abort_flag@1@@7 (=> (and (and (= $abort_code@2@@7 $abort_code@2@@7) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| $abort_code@2@@7) (= (ControlFlow 0 578659) 578631))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|  (=> |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= (ControlFlow 0 578737) 578631))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|  (=> (and |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0| (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) (= 5 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) 1)) (= 3 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|))) (and (not (= (|$addr#$signer| _$t0@@13) 186537453)) (= 2 |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|)))) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= $es@1@@12 $es)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t8@0|) (= (ControlFlow 0 578809) 578631))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$L2_correct|))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|  (=> (and (not $abort_flag@1@@7) (= |$1_Diem_CurrencyInfo'#0'_$memory@0@@3| ($Memory_199883 (|Store__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)) true) (|Store__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) (|a#$Global| (|l#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)) (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|))))) (=> (and (and (= |$1_Diem_CurrencyInfo'#0'_$memory@1@@3| |$1_Diem_CurrencyInfo'#0'_$memory@0@@3|) (= $abort_code@3@@7 $abort_code@2@@7)) (and (= $es@2@@9 $es@0@@13) (= $abort_flag@2@@7 $abort_flag@1@@7))) (and (=> (= (ControlFlow 0 578611) 579073) anon10_Then_correct) (=> (= (ControlFlow 0 578611) 579059) anon10_Else_correct))))))
(let ((|inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| (|v#$Mutation_189683| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1|)) (= $es@0@@13 (let ((stream@@148 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1|)))
(let ((stream_new@@133 (let ((len@@133 (|l#Multiset_157370| stream@@148)))
(let ((cnt@@133 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@148) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1|))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@148) (|$ToEventRep'$1_Diem_ToXDXExchangeRateUpdateEvent'| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1|) (+ cnt@@133 1)) (+ len@@133 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$handle@1| stream_new@@133)))))) (and (=> (= (ControlFlow 0 578583) 578625) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 578583) 578611) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon19_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|  (=> (not $abort_flag@1@@7) (=> (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t17@1| ($1_Diem_ToXDXExchangeRateUpdateEvent |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (= (ControlFlow 0 578589) 578583)) |inline$$1_Event_emit_event'$1_Diem_ToXDXExchangeRateUpdateEvent'$0$anon0_correct|))))
(let ((inline$$1_FixedPoint32_get_raw_value$0$anon0_correct  (=> (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1|) (=> (and (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 (|$value#$1_FixedPoint32_FixedPoint32| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1|)) (= inline$$1_FixedPoint32_get_raw_value$0$$t1@1 inline$$1_FixedPoint32_get_raw_value$0$$t1@1)) (and (=> (= (ControlFlow 0 578490) 578645) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 578490) 578589) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon18_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|  (=> (and (not $abort_flag@1@@7) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))) (=> (and (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$temp_0'$1_Diem_CurrencyInfo'#0''@1|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1| ($Mutation_235773 (|l#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (seq.++ (|p#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (seq.unit 2)) (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2| ($Mutation_235773 (|l#$Mutation_235773| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1|) (|p#$Mutation_235773| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@1|) $t20@@11)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3| ($Mutation_218697 (|l#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (|p#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|) (|$1_Diem_CurrencyInfo'#0'| (|$total_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$preburn_value#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|v#$Mutation_235773| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@2|) (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$fractional_part#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$can_mint#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$mint_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$preburn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$cancel_burn_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2|))))))) (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@1| ($Mutation_189683 (|l#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|) (seq.++ (|p#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|) (seq.unit 12)) (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t14@1| (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|)))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t15@1| (|$to_xdx_exchange_rate#$1_Diem_CurrencyInfo'#0'| (|v#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@3|))) (= (ControlFlow 0 578496) 578490)))) inline$$1_FixedPoint32_get_raw_value$0$anon0_correct))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|  (=> (= $abort_code@2@@7 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@7 true) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0|)) (and (=> (= (ControlFlow 0 578711) 578659) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 578711) 578496) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (= (ControlFlow 0 578709) 578711)) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then$1_correct|)))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (=> (and (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1| ($Mutation_218697 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= $abort_code@2@@7 $abort_code@1@@10)) (and (= $abort_flag@1@@7 $abort_flag@0@@10) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@2| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@1|))) (and (=> (= (ControlFlow 0 578315) 578659) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 578315) 578496) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon17_Else_correct|))))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|) (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 578293) 578709) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 578293) 578315) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|  (=> (and (not |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t9@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (=> (= (ControlFlow 0 578279) 578737) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 578279) 578293) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon15_Else_correct|)))))
(let ((|inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|  (=> (= (seq.len (|p#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t2@0|)) 0) (=> (and (= (seq.len (|p#$Mutation_218697| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t11@0|)) 0) (= (seq.len (|p#$Mutation_235773| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t12@0|)) 0)) (=> (and (and (and (= (seq.len (|p#$Mutation_189683| |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t13@0|)) 0) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t3@0| (|$addr#$signer| _$t0@@13))) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t4@0| (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t5@0| ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20@@11))))) (and (and (= _$t0@@13 _$t0@@13) (= $t20@@11 $t20@@11)) (and (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0| (|$addr#$signer| _$t0@@13)) (= |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t7@0|  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$$t6@0|)) 1))) (not (= (|$addr#$signer| _$t0@@13) 186537453))))))) (and (=> (= (ControlFlow 0 578261) 578809) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Then_correct|) (=> (= (ControlFlow 0 578261) 578279) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon14_Else_correct|)))))))
(let ((anon9_Else_correct  (=> (and (and (and (not $t21@@5) (|$IsValid'$1_FixedPoint32_FixedPoint32'| $t20@@11)) (and (= $t20@@11 (ite (= _$t2@@10 _$t3@@5) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t20@@11 $t20@@11))) (and (and (= $t22@@8 (|$addr#$signer| _$t0@@13)) (= $t23@@8 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (and (= $t24@@8 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t20@@11))) (= (ControlFlow 0 578813) 578261)))) |inline$$1_Diem_update_xdx_exchange_rate'#0'$0$anon0_correct|)))
(let ((anon8_Else_correct  (=> (and (and (and (not $abort_flag@0@@10) (= $t14@@11 ($shl _$t2@@10 64))) (and (= $t15@@11 ($shl _$t3@@5 32)) (= $t16@@11 (div $t14@@11 $t15@@11)))) (and (and (= $t17@@11 ($shl _$t2@@10 64)) (= $t18@@11 ($shl _$t3@@5 32))) (and (= $t19@@11 (div $t17@@11 $t18@@11)) (= $t21@@5  (or (or (= $t18@@11 0) (and (= $t19@@11 0) (not (= $t17@@11 0)))) (> $t19@@11 18446744073709551615)))))) (and (=> (= (ControlFlow 0 577366) 579569) anon9_Then_correct) (=> (= (ControlFlow 0 577366) 578813) anon9_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5  (=> (and (= $abort_flag@0@@10 true) (= $abort_code@1@@10 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5)) (and (=> (= (ControlFlow 0 577194) 579583) anon8_Then_correct) (=> (= (ControlFlow 0 577194) 577366) anon8_Else_correct)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@5  (=> (and (and (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= (ControlFlow 0 577188) 577194))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@5  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))) (= 5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t7@0@@5) (= (ControlFlow 0 577244) 577194))) inline$$1_SlidingNonce_record_nonce_or_abort$0$L3_correct@@5))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@5  (=> inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 (=> (and (= $abort_flag@0@@10 false) (= $abort_code@1@@10 $abort_code@0@@10)) (and (=> (= (ControlFlow 0 577200) 579583) anon8_Then_correct) (=> (= (ControlFlow 0 577200) 577366) anon8_Else_correct))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5  (=> (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 ($1_SlidingNonce_spec_try_record_nonce _$t0@@13 _$t1@@13))) (=> (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory@2@@5) (|$addr#$signer| _$t0@@13)) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5)) (and (|$IsValid'u64'| 0) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t5@0@@5 0)))) (and (and (|$IsValid'u64'| inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 7)) (and (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t10@0@@5) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5 inline$$1_SlidingNonce_record_nonce_or_abort$0$$t9@1@@5)))) (and (=> (= (ControlFlow 0 577172) 577200) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Then_correct@@5) (=> (= (ControlFlow 0 577172) 577188) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon10_Else_correct@@5))))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@5  (=> (and (and (not |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@5|) (= $1_SlidingNonce_SlidingNonce_$memory@1@@5 ($Memory_197482 (|Store__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) false) (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2@@5 $1_SlidingNonce_SlidingNonce_$memory@1@@5) (= (ControlFlow 0 577106) 577172))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@5  (=> (and (and |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'bool'@1@@5| (= $1_SlidingNonce_SlidingNonce_$memory@0@@5 ($Memory_197482 (|Store__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) true) (|Store__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13) |inline$$1_SlidingNonce_record_nonce_or_abort$0$$temp_0'$1_SlidingNonce_SlidingNonce'@1@@5|)))) (and (= $1_SlidingNonce_SlidingNonce_$memory@2@@5 $1_SlidingNonce_SlidingNonce_$memory@0@@5) (= (ControlFlow 0 577214) 577172))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon5_correct@@5)))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@5  (=> (not inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5) (and (=> (= (ControlFlow 0 577092) 577214) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Then_correct@@5) (=> (= (ControlFlow 0 577092) 577106) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon9_Else_correct@@5)))))
(let ((inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@5  (=> (= _$t0@@13 _$t0@@13) (=> (and (= _$t1@@13 _$t1@@13) (= inline$$1_SlidingNonce_record_nonce_or_abort$0$$t6@0@@5  (not (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) (|$addr#$signer| _$t0@@13))))) (and (=> (= (ControlFlow 0 577086) 577244) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Then_correct@@5) (=> (= (ControlFlow 0 577086) 577092) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon8_Else_correct@@5))))))
(let ((anon0$1_correct@@13  (=> (forall ((addr@@336 Int) ) (!  (=> (|$IsValid'address'| addr@@336) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@336) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@336)) 0)) (= addr@@336 173345816)))
 :qid |TreasuryComplianceScriptsbpl.32589:20|
 :skolemid |1138|
)) (=> (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@337 Int) ) (!  (=> (|$IsValid'address'| addr@@337) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@337) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@337)) 1)) (= addr@@337 186537453)))
 :qid |TreasuryComplianceScriptsbpl.32597:20|
 :skolemid |1139|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@338 Int) ) (!  (=> (|$IsValid'address'| addr@@338) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@338)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.32605:20|
 :skolemid |1140|
)))) (and (and (forall ((addr@@339 Int) ) (!  (=> (|$IsValid'address'| addr@@339) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@339)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.32609:20|
 :skolemid |1141|
)) (forall ((addr@@340 Int) ) (!  (=> (|$IsValid'address'| addr@@340) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@340)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.32613:20|
 :skolemid |1142|
))) (and (forall ((addr@@341 Int) ) (!  (=> (|$IsValid'address'| addr@@341) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@341)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.32617:20|
 :skolemid |1143|
)) (forall ((addr@@342 Int) ) (!  (=> (|$IsValid'address'| addr@@342) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@342)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32621:20|
 :skolemid |1144|
))))) (=> (and (and (and (and (forall ((addr@@343 Int) ) (!  (=> (|$IsValid'address'| addr@@343) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@343)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32625:20|
 :skolemid |1145|
)) (forall ((addr@@344 Int) ) (!  (=> (|$IsValid'address'| addr@@344) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@344)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32629:20|
 :skolemid |1146|
))) (and (forall ((addr@@345 Int) ) (!  (=> (|$IsValid'address'| addr@@345) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@345) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@345) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@345)) 4))))
 :qid |TreasuryComplianceScriptsbpl.32633:20|
 :skolemid |1147|
)) (forall ((addr@@346 Int) ) (!  (=> (|$IsValid'address'| addr@@346) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@346) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@346) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@346)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32637:20|
 :skolemid |1148|
)))) (and (and (forall ((addr@@347 Int) ) (!  (=> (|$IsValid'address'| addr@@347) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@347) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@347) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@347)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32641:20|
 :skolemid |1149|
)) (forall ((addr@@348 Int) ) (!  (=> (|$IsValid'address'| addr@@348) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@348) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@348)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@348) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@348)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32645:20|
 :skolemid |1150|
))) (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) 186537453))))) (and (and (and (let (($range_0@@37 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@349 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@349))))))))
(forall (($i_1@@37 Int) ) (!  (=> ($InRange $range_0@@37 $i_1@@37) (let ((i1@@7 $i_1@@37))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@350 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@350)))) i1@@7))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@350 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@350)))) i1@@7)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.32657:151|
 :skolemid |1151|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@11 Int) (mint_cap_owner2@@11 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@11) (=> (|$IsValid'address'| mint_cap_owner2@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_200442| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner1@@11) (|Select__T@[Int]Bool_| (|domain#$Memory_200442| |$1_Diem_MintCapability'#0'_$memory|) mint_cap_owner2@@11)) (= mint_cap_owner1@@11 mint_cap_owner2@@11))))
 :qid |TreasuryComplianceScriptsbpl.32662:88|
 :skolemid |1152|
)))) (and (forall ((addr3@@11 Int) ) (!  (=> (|$IsValid'address'| addr3@@11) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_200442| |$1_Diem_MintCapability'#0'_$memory|) addr3@@11) (and (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816))))))
 :qid |TreasuryComplianceScriptsbpl.32666:20|
 :skolemid |1153|
)) (forall ((addr@@351 Int) ) (!  (=> (|$IsValid'address'| addr@@351) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_206010| |$1_Diem_Preburn'#0'_$memory|) addr@@351) (|Select__T@[Int]Bool_| (|domain#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))
 :qid |TreasuryComplianceScriptsbpl.32670:20|
 :skolemid |1154|
)))) (and (and (forall ((addr1@@25 Int) ) (!  (=> (|$IsValid'address'| addr1@@25) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr1@@25) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@25)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@25) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@25)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32674:20|
 :skolemid |1155|
)) (forall ((addr@@352 Int) ) (!  (=> (|$IsValid'address'| addr@@352) (= (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@352) (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@352)))
 :qid |TreasuryComplianceScriptsbpl.32678:20|
 :skolemid |1156|
))) (and (forall ((addr@@353 Int) ) (!  (=> (|$IsValid'address'| addr@@353) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) addr@@353)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@353) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@353)) 1))))
 :qid |TreasuryComplianceScriptsbpl.32682:20|
 :skolemid |1157|
)) (forall ((addr@@354 Int) ) (!  (=> (|$IsValid'address'| addr@@354) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) addr@@354)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@354) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@354)) 5))))
 :qid |TreasuryComplianceScriptsbpl.32686:20|
 :skolemid |1158|
)))))) (=> (and (and (and (and (and (forall ((addr@@355 Int) ) (!  (=> (|$IsValid'address'| addr@@355) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_258004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@355) (|Select__T@[Int]Bool_| (|domain#$Memory_258087| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@355)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@355)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.32690:20|
 :skolemid |1159|
)) (forall ((addr@@356 Int) ) (!  (=> (|$IsValid'address'| addr@@356) (= (|Select__T@[Int]Bool_| (|domain#$Memory_254376| $1_DesignatedDealer_Dealer_$memory) addr@@356)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@356) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@356)) 2))))
 :qid |TreasuryComplianceScriptsbpl.32694:20|
 :skolemid |1160|
))) (and (forall ((addr@@357 Int) ) (!  (=> (|$IsValid'address'| addr@@357) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr@@357)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@357) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@357)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@357) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@357)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.32698:20|
 :skolemid |1161|
)) (forall ((addr@@358 Int) ) (!  (=> (|$IsValid'address'| addr@@358) (= (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) addr@@358)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@358) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@358)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@358) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@358)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.32702:20|
 :skolemid |1162|
)))) (and (and (forall ((addr@@359 Int) ) (!  (=> (|$IsValid'address'| addr@@359) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@359)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@359) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@359)) 3))))
 :qid |TreasuryComplianceScriptsbpl.32706:20|
 :skolemid |1163|
)) (forall ((addr@@360 Int) ) (!  (=> (|$IsValid'address'| addr@@360) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@360)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@360) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@360)) 4))))
 :qid |TreasuryComplianceScriptsbpl.32710:20|
 :skolemid |1164|
))) (and (forall ((addr@@361 Int) ) (!  (=> (|$IsValid'address'| addr@@361) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246011| $1_VASP_ParentVASP_$memory) addr@@361)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@361) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@361)) 5))))
 :qid |TreasuryComplianceScriptsbpl.32714:20|
 :skolemid |1165|
)) (forall ((addr@@362 Int) ) (!  (=> (|$IsValid'address'| addr@@362) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245947| $1_VASP_ChildVASP_$memory) addr@@362)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@362) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@362)) 6))))
 :qid |TreasuryComplianceScriptsbpl.32718:20|
 :skolemid |1166|
))))) (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@13)) ($1_Signer_is_txn_signer _$t0@@13)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@13))) (and (and (|$IsValid'u64'| _$t1@@13) (|$IsValid'u64'| _$t2@@10)) (and (|$IsValid'u64'| _$t3@@5) (forall (($a_0@@149 Int) ) (! (let (($rsc@@149 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@149)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@149))
 :qid |TreasuryComplianceScriptsbpl.32733:20|
 :skolemid |1167|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@149))
)))))) (and (and (and (and (forall (($a_0@@150 Int) ) (! (let (($rsc@@150 (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@150)))
(|$IsValid'$1_SlidingNonce_SlidingNonce'| $rsc@@150))
 :qid |TreasuryComplianceScriptsbpl.32737:20|
 :skolemid |1168|
 :pattern ( (|Select__T@[Int]$1_SlidingNonce_SlidingNonce_| (|contents#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) $a_0@@150))
)) (forall (($a_0@@151 Int) ) (! (let (($rsc@@151 (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@151)))
 (and (|$IsValid'$1_Diem_CurrencyInfo'#0''| $rsc@@151) (and (< 0 (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@151)) (<= (|$scaling_factor#$1_Diem_CurrencyInfo'#0'| $rsc@@151) 10000000000))))
 :qid |TreasuryComplianceScriptsbpl.32741:20|
 :skolemid |1169|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) $a_0@@151))
))) (and (= $t5@@13 (ite (= _$t2@@10 _$t3@@5) ($1_FixedPoint32_FixedPoint32 1) ($1_FixedPoint32_FixedPoint32 2))) (= $t6@@13 ($shl _$t2@@10 64)))) (and (and (= $t7@@12 ($shl _$t3@@5 32)) (= $t8@@12 (div $t6@@13 $t7@@12))) (and (= $t9@@12 (|$addr#$signer| _$t0@@13)) (= $t10@@12 (|$exchange_rate_update_events#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)))))) (and (and (and (= $t11@@11 ($1_Diem_ToXDXExchangeRateUpdateEvent (|$currency_code#$1_Diem_CurrencyInfo'#0'| (|Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|contents#$Memory_199883| |$1_Diem_CurrencyInfo'#0'_$memory|) 173345816)) (|$value#$1_FixedPoint32_FixedPoint32| $t5@@13))) (= $t12@@9 (|$addr#$signer| _$t0@@13))) (and (let ((addr@@363 (|$addr#$signer| _$t0@@13)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@363)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@363) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_255137| $1_AccountFreezing_FreezingBit_$memory) addr@@363)))))) (= _$t0@@13 _$t0@@13))) (and (and (= _$t1@@13 _$t1@@13) (= _$t2@@10 _$t2@@10)) (and (= _$t3@@5 _$t3@@5) (= (ControlFlow 0 577248) 577086)))))) inline$$1_SlidingNonce_record_nonce_or_abort$0$anon0_correct@@5))))))
(let ((inline$$InitEventStore$0$anon0_correct@@13  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@81 T@$1_Event_EventHandle) ) (! (let ((stream@@149 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) handle@@81)))
 (and (= (|l#Multiset_157370| stream@@149) 0) (forall ((v@@129 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@149) v@@129) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 575671) 577248)) anon0$1_correct@@13)))
(let ((anon0_correct@@13  (=> (= (ControlFlow 0 704613) 575671) inline$$InitEventStore$0$anon0_correct@@13)))
anon0_correct@@13)))))))))))))))))))))))))))))))))))))
))
(check-sat)
