...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1 () T@$Mutation_189683)
(declare-fun $es@0@@3 () T@$EventStore)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1 () T@$1_VASPDomain_VASPDomainEvent)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34 () T@$Mutation_242836)
(declare-fun inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 () T@$1_VASPDomain_VASPDomain)
(declare-fun _$t1@@3 () Int)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@1 () T@$Mutation_242836)
(declare-fun $abort_code@3@@0 () Int)
(declare-fun $abort_flag@2@@0 () Bool)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 () T@$Mutation_242775)
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'| () T@$Mutation_174578)
(declare-fun $1_VASPDomain_VASPDomains_$memory@0@@0 () T@$Memory_242740)
...
(declare-fun |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| () T@$Mutation_174578)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1 () T@$Mutation_174578)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1 () T@$Mutation_242775)
...
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t7@0 () T@$Mutation_242775)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t31@0 () T@$Mutation_174578)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t34@0 () T@$Mutation_242836)
(declare-fun inline$$1_VASPDomain_remove_vasp_domain$0$$t35@0 () T@$Mutation_189683)
...
(assert (not
 (=> (= (ControlFlow 0 0) 617018) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> $abort_flag@4 (=> (and (= $abort_code@5 $abort_code@5) (= (ControlFlow 0 441748) (- 0 619593))) (or (or (or (= 3 $abort_code@5) (= 2 $abort_code@5)) (= 5 $abort_code@5)) (= 7 $abort_code@5))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Else_correct  (=> (not $abort_flag@3@@0) (=> (and (= $abort_flag@4 $abort_flag@3@@0) (= $abort_code@5 $abort_code@4@@0)) (and (=> (= (ControlFlow 0 441410) 441748) anon3_Then_correct) (=> (= (ControlFlow 0 441410) 441698) anon3_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct  (=> (and (= $abort_flag@4 true) (= $abort_code@5 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1)) (and (=> (= (ControlFlow 0 440325) 441748) anon3_Then_correct) (=> (= (ControlFlow 0 440325) 441698) anon3_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Then_correct  (=> (and (and $abort_flag@3@@0 (= $abort_code@4@@0 $abort_code@4@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@4@@0) (= (ControlFlow 0 441424) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct@@0|  (=> (and (= |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0| (|v#$Mutation_189683| inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1)) (= $es@0@@3 (let ((stream@@38 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0|)))
(let ((stream_new@@33 (let ((len@@33 (|l#Multiset_157370| stream@@38)))
(let ((cnt@@33 (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@38) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1))))
(Multiset_157370 (|Store__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@38) (|$ToEventRep'$1_VASPDomain_VASPDomainEvent'| inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1) (+ cnt@@33 1)) (+ len@@33 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$handle@1@@0| stream_new@@33)))))) (and (=> (= (ControlFlow 0 441394) 441424) inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Then_correct) (=> (= (ControlFlow 0 441394) 441410) inline$$1_VASPDomain_remove_vasp_domain$0$anon45_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct  (=> (and (and (not $abort_flag@3@@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t35@1 ($Mutation_189683 (|l#$Mutation_242836| inline$$1_VASPDomain_remove_vasp_domain$0$$t34) (seq.++ (|p#$Mutation_242836| inline$$1_VASPDomain_remove_vasp_domain$0$$t34) (seq.unit 0)) (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|v#$Mutation_242836| inline$$1_VASPDomain_remove_vasp_domain$0$$t34))))) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t37@1 ($1_VASPDomain_VASPDomainEvent true inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 _$t1@@3)) (= (ControlFlow 0 441400) 441394))) |inline$$1_Event_emit_event'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct@@0|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct  (=> (and (and $abort_flag@3@@0 (= $abort_code@4@@0 $abort_code@4@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@4@@0) (= (ControlFlow 0 441438) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then$1_correct  (=> (and (= $abort_code@4@@0 $EXEC_FAILURE_CODE) (= $abort_flag@3@@0 true)) (and (=> (= (ControlFlow 0 441490) 441438) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 441490) 441400) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= (ControlFlow 0 441488) 441490)) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then$1_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Else_correct  (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t34@1 ($Mutation_242836 ($Global 186537453) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $abort_code@4@@0 $abort_code@3@@0) (= $abort_flag@3@@0 $abort_flag@2@@0))) (and (=> (= (ControlFlow 0 441285) 441438) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Then_correct) (=> (= (ControlFlow 0 441285) 441400) inline$$1_VASPDomain_remove_vasp_domain$0$anon44_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct  (=> (and (and (not $abort_flag@2@@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3 ($Mutation_242775 (|l#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) (|p#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) ($1_VASPDomain_VASPDomains (|v#$Mutation_174578| |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'|))))) (and (= $1_VASPDomain_VASPDomains_$memory@0@@0 ($Memory_242740 (|Store__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)) true) (|Store__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) (|a#$Global| (|l#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)) (|v#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@3)))) (|$IsValid'address'| 186537453))) (and (=> (= (ControlFlow 0 441263) 441488) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Then_correct) (=> (= (ControlFlow 0 441263) 441285) inline$$1_VASPDomain_remove_vasp_domain$0$anon43_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct  (=> (and (and $abort_flag@2@@0 (= $abort_code@3@@0 $abort_code@3@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@3@@0) (= (ControlFlow 0 441504) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|  (=> (and (= $abort_flag@2@@0 true) (= $abort_code@3@@0 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 441213) 441504) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 441213) 441263) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct)))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (and (not (and (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0) (< |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|)))) (= (ControlFlow 0 441211) 441213)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (and (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0) (< |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|))) (=> (and (and (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$e@1| (seq.nth |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|)) (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$m'@1| ($Mutation_174578 (|l#$Mutation_174578| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1) (|p#$Mutation_174578| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1) (seq.++ (seq.extract |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| 0 (- |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (seq.extract |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (+ |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 1) (- (seq.len |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1|) (+ |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 1))))))) (and (= $abort_flag@2@@0 $abort_flag@1@@0) (= $abort_code@3@@0 $abort_code@2@@0))) (and (=> (= (ControlFlow 0 441161) 441504) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Then_correct) (=> (= (ControlFlow 0 441161) 441263) inline$$1_VASPDomain_remove_vasp_domain$0$anon42_Else_correct))))))
(let ((|inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$v@1| (|v#$Mutation_174578| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1)) (and (=> (= (ControlFlow 0 441137) 441211) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 441137) 441161) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Then_correct  (=> |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| (=> (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t31@1 ($Mutation_174578 (|l#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) (seq.++ (|p#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2) (seq.unit 0)) (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2)))) (= (ControlFlow 0 441221) 441137)) |inline$$1_Vector_remove'$1_VASPDomain_VASPDomain'$0$anon0_correct|))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Else_correct  (=> (not |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|) (=> (and (|$IsValid'u64'| 2) (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0)) (=> (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0 7) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t30@0) (= (ControlFlow 0 441026) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct  (=> (not $abort_flag@1@@0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2|) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1|)) (and (=> (= (ControlFlow 0 440994) 441221) inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Then_correct) (=> (= (ControlFlow 0 440994) 441026) inline$$1_VASPDomain_remove_vasp_domain$0$anon41_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@2@@0) (= (ControlFlow 0 441518) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|  (=> (> 0 |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| false) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| 0)) (and (=> (= (ControlFlow 0 440954) 441518) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 440954) 440994) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|  (=> (>= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| 0) (=> (and (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res1@1| true) (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@2| |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1|)) (and (=> (= (ControlFlow 0 440964) 441518) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Then_correct) (=> (= (ControlFlow 0 440964) 440994) inline$$1_VASPDomain_remove_vasp_domain$0$anon40_Else_correct))))))
(let ((|inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|  (=> (= |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$res2@1| (|$IndexOfVec'$1_VASPDomain_VASPDomain'| inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0)) (and (=> (= (ControlFlow 0 440942) 440964) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 440942) 440954) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon3_Else_correct|)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct  (=> (and (and (not $abort_flag@1@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t26@1 (|$domains#$1_VASPDomain_VASPDomains| (|v#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2))) (= (ControlFlow 0 440972) 440942))) |inline$$1_Vector_index_of'$1_VASPDomain_VASPDomain'$0$anon0_correct|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct  (=> (and (and $abort_flag@1@@0 (= $abort_code@2@@0 $abort_code@2@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@2@@0) (= (ControlFlow 0 441532) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0  (=> (= $abort_code@2@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0) (=> (and (= $abort_flag@1@@0 true) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$ret0@0@@0)) (and (=> (= (ControlFlow 0 440805) 441532) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 440805) 440972) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct@@0  (=> (and (and (not inline$$Le$0$dst@1@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= (ControlFlow 0 440799) 440805))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct@@0  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t4@1@@0 $abort_code@1@@0) (= (ControlFlow 0 440837) 440805))) inline$$1_VASPDomain_create_vasp_domain$0$L3_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct@@0  (=> (and inline$$Le$0$dst@1@@0 (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0 ($1_VASPDomain_VASPDomain _$t2@@0))) (=> (and (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0) (= $abort_code@2@@0 $abort_code@1@@0)) (and (= $abort_flag@1@@0 $abort_flag@0@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$ret0@1@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t9@1@@0))) (and (=> (= (ControlFlow 0 440823) 441532) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Then_correct) (=> (= (ControlFlow 0 440823) 440972) inline$$1_VASPDomain_remove_vasp_domain$0$anon39_Else_correct))))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct@@0  (=> (|$IsValid'u64'| 5) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 7)) (and (= inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0 inline$$1_VASPDomain_create_vasp_domain$0$$t8@0@@0) (= inline$$Le$0$dst@1@@0 inline$$Le$0$dst@1@@0))) (and (=> (= (ControlFlow 0 440783) 440823) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Then_correct@@0) (=> (= (ControlFlow 0 440783) 440799) inline$$1_VASPDomain_create_vasp_domain$0$anon7_Else_correct@@0))))))
(let ((inline$$Le$0$anon0_correct@@0  (=> (and (= inline$$Le$0$dst@1@@0 (<= |inline$$1_Vector_length'u8'$0$l@1@@0| 63)) (= (ControlFlow 0 440747) 440783)) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else$1_correct@@0)))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct@@0  (=> (not $abort_flag@0@@0) (=> (and (|$IsValid'u64'| 63) (= (ControlFlow 0 440753) 440747)) inline$$Le$0$anon0_correct@@0))))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@0|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@0| (seq.len _$t2@@0)) (and (=> (= (ControlFlow 0 440687) 440837) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Then_correct@@0) (=> (= (ControlFlow 0 440687) 440753) inline$$1_VASPDomain_create_vasp_domain$0$anon6_Else_correct@@0)))))
(let ((inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct@@0  (=> (and (= _$t2@@0 _$t2@@0) (= (ControlFlow 0 440693) 440687)) |inline$$1_Vector_length'u8'$0$anon0_correct@@0|)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct  (=> (and (and (not $abort_flag@0@@0) (= |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| (|v#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2))) (and (= |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1| |inline$$1_VASPDomain_remove_vasp_domain$0$$temp_0'$1_VASPDomain_VASPDomains'@1|) (= (ControlFlow 0 440843) 440693))) inline$$1_VASPDomain_create_vasp_domain$0$anon0_correct@@0)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct  (=> (and (and $abort_flag@0@@0 (= $abort_code@1@@0 $abort_code@1@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 $abort_code@1@@0) (= (ControlFlow 0 441546) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then$1_correct  (=> (= $abort_flag@0@@0 true) (=> (and (= $abort_code@1@@0 $EXEC_FAILURE_CODE) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0)) (and (=> (= (ControlFlow 0 441598) 441546) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 441598) 440843) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3)) (= (ControlFlow 0 441596) 441598)) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then$1_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3) (=> (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1 ($Mutation_242775 ($Global _$t1@@3) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3))) (= $abort_flag@0@@0 false)) (and (= $abort_code@1@@0 $abort_code@0@@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t24@2 inline$$1_VASPDomain_remove_vasp_domain$0$$t24@1))) (and (=> (= (ControlFlow 0 440409) 441546) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Then_correct) (=> (= (ControlFlow 0 440409) 440843) inline$$1_VASPDomain_remove_vasp_domain$0$anon38_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Then_correct  (=> inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 (and (=> (= (ControlFlow 0 440387) 441596) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Then_correct) (=> (= (ControlFlow 0 440387) 440409) inline$$1_VASPDomain_remove_vasp_domain$0$anon37_Else_correct)))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Else_correct  (=> (and (and (not inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= (ControlFlow 0 440383) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Then_correct  (=> inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 (=> (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3)) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 5)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t23@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t21@1))) (and (=> (= (ControlFlow 0 440367) 440387) inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Then_correct) (=> (= (ControlFlow 0 440367) 440383) inline$$1_VASPDomain_remove_vasp_domain$0$anon36_Else_correct)))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Else_correct  (=> (and (and (not inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= (ControlFlow 0 440319) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 5)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t20@0) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 440303) 440367) inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Then_correct) (=> (= (ControlFlow 0 440303) 440319) inline$$1_VASPDomain_remove_vasp_domain$0$anon35_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Then_correct  (=> inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) (= 5 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) 1)) (= 3 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0))) (and (not (= (|$addr#$signer| _$t0@@3) 186537453)) (= 2 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0))) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t17@1 inline$$1_VASPDomain_remove_vasp_domain$0$$t17@0) (= (ControlFlow 0 441684) 440325))) inline$$1_VASPDomain_remove_vasp_domain$0$L7_correct))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Then_correct true))
(let ((inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct@@0  (=> (|$IsValid'address'| 186537453) (=> (and (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (= inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0 inline$$1_VASPDomain_tc_domain_manager_exists$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 440261) 441612) inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Then_correct) (=> (= (ControlFlow 0 440261) 440303) inline$$1_VASPDomain_remove_vasp_domain$0$anon34_Else_correct))))))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Else_correct  (=> (and (not inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0) (= (ControlFlow 0 440267) 440261)) inline$$1_VASPDomain_tc_domain_manager_exists$0$anon0_correct@@0)))
(let ((inline$$1_VASPDomain_remove_vasp_domain$0$anon0_correct  (=> (and (= (seq.len (|p#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t7@0)) 0) (= (seq.len (|p#$Mutation_242775| inline$$1_VASPDomain_remove_vasp_domain$0$$t24@0)) 0)) (=> (and (and (= (seq.len (|p#$Mutation_174578| inline$$1_VASPDomain_remove_vasp_domain$0$$t31@0)) 0) (= (seq.len (|p#$Mutation_242836| inline$$1_VASPDomain_remove_vasp_domain$0$$t34@0)) 0)) (and (= (seq.len (|p#$Mutation_189683| inline$$1_VASPDomain_remove_vasp_domain$0$$t35@0)) 0) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t11@0 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3))))) (=> (and (and (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t12@0 (|$addr#$signer| _$t0@@3)) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t13@0 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t14@0 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2@@0) _$t1@@3)) (= _$t0@@3 _$t0@@3))) (and (and (= _$t1@@3 _$t1@@3) (= _$t2@@0 _$t2@@0)) (and (= inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0 (|$addr#$signer| _$t0@@3)) (= inline$$1_VASPDomain_remove_vasp_domain$0$$t16@0  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) inline$$1_VASPDomain_remove_vasp_domain$0$$t15@0)) 1))) (not (= (|$addr#$signer| _$t0@@3) 186537453))))))) (and (=> (= (ControlFlow 0 440174) 441684) inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Then_correct) (=> (= (ControlFlow 0 440174) 440267) inline$$1_VASPDomain_remove_vasp_domain$0$anon33_Else_correct)))))))
(let ((anon0$1_correct@@3  (=> (and (and (forall ((addr@@139 Int) ) (!  (=> (|$IsValid'address'| addr@@139) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@139) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@139)) 0)) (= addr@@139 173345816)))
 :qid |TreasuryComplianceScriptsbpl.24753:20|
 :skolemid |545|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 173345816)) 0)))) (and (forall ((addr@@140 Int) ) (!  (=> (|$IsValid'address'| addr@@140) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@140) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@140)) 1)) (= addr@@140 186537453)))
 :qid |TreasuryComplianceScriptsbpl.24761:20|
 :skolemid |546|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_195850| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) 186537453)) 1))))) (=> (and (and (and (forall ((addr@@141 Int) ) (!  (=> (|$IsValid'address'| addr@@141) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@141)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24769:20|
 :skolemid |547|
)) (forall ((addr@@142 Int) ) (!  (=> (|$IsValid'address'| addr@@142) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@142)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24773:20|
 :skolemid |548|
))) (and (forall ((addr@@143 Int) ) (!  (=> (|$IsValid'address'| addr@@143) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@143)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24777:20|
 :skolemid |549|
)) (forall ((addr@@144 Int) ) (!  (=> (|$IsValid'address'| addr@@144) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@144)) 2))))))
 :qid |TreasuryComplianceScriptsbpl.24781:20|
 :skolemid |550|
)))) (and (and (forall ((addr@@145 Int) ) (!  (=> (|$IsValid'address'| addr@@145) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@145)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24785:20|
 :skolemid |551|
)) (forall ((addr@@146 Int) ) (!  (=> (|$IsValid'address'| addr@@146) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@146)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24789:20|
 :skolemid |552|
))) (and (forall ((addr@@147 Int) ) (!  (=> (|$IsValid'address'| addr@@147) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@147)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24793:20|
 :skolemid |553|
)) (forall ((addr@@148 Int) ) (!  (=> (|$IsValid'address'| addr@@148) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@148) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@148)) 4))))
 :qid |TreasuryComplianceScriptsbpl.24797:20|
 :skolemid |554|
))))) (=> (and (and (and (and (forall ((addr@@149 Int) ) (!  (=> (|$IsValid'address'| addr@@149) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@149) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@149)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24801:20|
 :skolemid |555|
)) (forall ((addr@@150 Int) ) (!  (=> (|$IsValid'address'| addr@@150) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@150) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@150)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24805:20|
 :skolemid |556|
))) (and (forall ((addr@@151 Int) ) (!  (=> (|$IsValid'address'| addr@@151) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@151) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@151)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@151)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24809:20|
 :skolemid |557|
)) (let (($range_0@@3 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@152 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@152))))))))
(forall (($i_1@@3 Int) ) (!  (=> ($InRange $range_0@@3 $i_1@@3) (let ((i1@@3 $i_1@@3))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@153 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@153)))) i1@@3))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@153 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_197954| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@153)))) i1@@3)))) 3))))
 :qid |TreasuryComplianceScriptsbpl.24813:151|
 :skolemid |558|
))))) (and (and (forall ((addr1@@6 Int) ) (!  (=> (|$IsValid'address'| addr1@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr1@@6) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@6)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr1@@6)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24818:20|
 :skolemid |559|
)) (forall ((addr@@154 Int) ) (!  (=> (|$IsValid'address'| addr@@154) (= (|Select__T@[Int]Bool_| (|domain#$Memory_258253| $1_DiemAccount_DiemAccount_$memory) addr@@154) (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@154)))
 :qid |TreasuryComplianceScriptsbpl.24822:20|
 :skolemid |560|
))) (and (forall ((addr@@155 Int) ) (!  (=> (|$IsValid'address'| addr@@155) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) addr@@155)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@155) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@155)) 1))))
 :qid |TreasuryComplianceScriptsbpl.24826:20|
 :skolemid |561|
)) (forall ((addr@@156 Int) ) (!  (=> (|$IsValid'address'| addr@@156) (= (|Select__T@[Int]Bool_| (|domain#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) addr@@156)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@156) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@156)) 5))))
 :qid |TreasuryComplianceScriptsbpl.24830:20|
 :skolemid |562|
))))) (and (and (and (forall ((addr@@157 Int) ) (!  (=> (|$IsValid'address'| addr@@157) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_258004| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@157) (|Select__T@[Int]Bool_| (|domain#$Memory_258087| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@157)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@157)) 2)))))
 :qid |TreasuryComplianceScriptsbpl.24834:20|
 :skolemid |563|
)) (forall ((addr@@158 Int) ) (!  (=> (|$IsValid'address'| addr@@158) (= (|Select__T@[Int]Bool_| (|domain#$Memory_254376| $1_DesignatedDealer_Dealer_$memory) addr@@158)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@158) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@158)) 2))))
 :qid |TreasuryComplianceScriptsbpl.24838:20|
 :skolemid |564|
))) (and (forall ((addr@@159 Int) ) (!  (=> (|$IsValid'address'| addr@@159) (= (|Select__T@[Int]Bool_| (|domain#$Memory_252113| $1_DualAttestation_Credential_$memory) addr@@159)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@159) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@159)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@159) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@159)) 5)))))
 :qid |TreasuryComplianceScriptsbpl.24842:20|
 :skolemid |565|
)) (forall ((addr@@160 Int) ) (!  (=> (|$IsValid'address'| addr@@160) (= (|Select__T@[Int]Bool_| (|domain#$Memory_197482| $1_SlidingNonce_SlidingNonce_$memory) addr@@160)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@160) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@160)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@160) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@160)) 1)))))
 :qid |TreasuryComplianceScriptsbpl.24846:20|
 :skolemid |566|
)))) (and (and (forall ((addr@@161 Int) ) (!  (=> (|$IsValid'address'| addr@@161) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196945| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@161)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@161) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@161)) 3))))
 :qid |TreasuryComplianceScriptsbpl.24850:20|
 :skolemid |567|
)) (forall ((addr@@162 Int) ) (!  (=> (|$IsValid'address'| addr@@162) (= (|Select__T@[Int]Bool_| (|domain#$Memory_196341| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@162)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@162) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@162)) 4))))
 :qid |TreasuryComplianceScriptsbpl.24854:20|
 :skolemid |568|
))) (and (forall ((addr@@163 Int) ) (!  (=> (|$IsValid'address'| addr@@163) (= (|Select__T@[Int]Bool_| (|domain#$Memory_246011| $1_VASP_ParentVASP_$memory) addr@@163)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@163) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@163)) 5))))
 :qid |TreasuryComplianceScriptsbpl.24858:20|
 :skolemid |569|
)) (forall ((addr@@164 Int) ) (!  (=> (|$IsValid'address'| addr@@164) (= (|Select__T@[Int]Bool_| (|domain#$Memory_245947| $1_VASP_ChildVASP_$memory) addr@@164)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_196014| $1_Roles_RoleId_$memory) addr@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) addr@@164)) 6))))
 :qid |TreasuryComplianceScriptsbpl.24862:20|
 :skolemid |570|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@3)) ($1_Signer_is_txn_signer _$t0@@3)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@3))) (|$IsValid'address'| _$t1@@3)) (and (and (|$IsValid'vec'u8''| _$t2@@0) (forall (($a_0@@41 Int) ) (! (let (($rsc@@41 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@41)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@41))
 :qid |TreasuryComplianceScriptsbpl.24874:20|
 :skolemid |571|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_196014| $1_Roles_RoleId_$memory) $a_0@@41))
))) (and (forall (($a_0@@42 Int) ) (! (let (($rsc@@42 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@42)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@42))
 :qid |TreasuryComplianceScriptsbpl.24878:20|
 :skolemid |572|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@42))
)) (forall (($a_0@@43 Int) ) (! (let (($rsc@@43 (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) $a_0@@43)))
 (and (|$IsValid'$1_VASPDomain_VASPDomains'| $rsc@@43) (and (and (let (($range_1@@3 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43)))))
(forall (($i_2@@3 Int) ) (!  (=> ($InRange $range_1@@3 $i_2@@3) (let ((i@@72 $i_2@@3))
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43) i@@72))) 63)))
 :qid |TreasuryComplianceScriptsbpl.24883:140|
 :skolemid |573|
))) (let (($range_3@@0 ($Range 0 (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43)))))
(forall (($i_4@@0 Int) ) (!  (=> ($InRange $range_3@@0 $i_4@@0) (let ((i@@73 $i_4@@0))
(let (($range_5@@0 ($Range (+ i@@73 1) (seq.len (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43)))))
(forall (($i_6@@0 Int) ) (!  (=> ($InRange $range_5@@0 $i_6@@0) (let ((j@@15 $i_6@@0))
 (not (= (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43) i@@73) (seq.nth (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43) j@@15)))))
 :qid |TreasuryComplianceScriptsbpl.24885:98|
 :skolemid |574|
)))))
 :qid |TreasuryComplianceScriptsbpl.24884:202|
 :skolemid |575|
)))) (let (($range_7@@0 (|$domains#$1_VASPDomain_VASPDomains| $rsc@@43)))
...
(<= (seq.len (|$domain#$1_VASPDomain_VASPDomain| $elem@@0)) 63)))
 :qid |TreasuryComplianceScriptsbpl.24886:229|
 :skolemid |576|
))))))
 :qid |TreasuryComplianceScriptsbpl.24882:20|
 :skolemid |577|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) $a_0@@43))
))))) (and (and (and (= _$t0@@3 _$t0@@3) (= _$t1@@3 _$t1@@3)) (and (= _$t2@@0 _$t2@@0) (= $t3@@3 (|$domains#$1_VASPDomain_VASPDomains| (|Select__T@[Int]$1_VASPDomain_VASPDomains_| (|contents#$Memory_242740| $1_VASPDomain_VASPDomains_$memory) _$t1@@3))))) (and (and (= $t4@@3 (|$addr#$signer| _$t0@@3)) (= $t5@@3 (|$vasp_domain_events#$1_VASPDomain_VASPDomainManager| (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_242373| $1_VASPDomain_VASPDomainManager_$memory) 186537453)))) (and (= $t6@@3 ($1_VASPDomain_VASPDomainEvent true ($1_VASPDomain_VASPDomain _$t2@@0) _$t1@@3)) (= (ControlFlow 0 441688) 440174))))) inline$$1_VASPDomain_remove_vasp_domain$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@3  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@23 T@$1_Event_EventHandle) ) (! (let ((stream@@39 (|Select__T@[$1_Event_EventHandle]Multiset_157370_| (|streams#$EventStore| $es) handle@@23)))
 (and (= (|l#Multiset_157370| stream@@39) 0) (forall ((v@@71 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_157370| stream@@39) v@@71) 0)
 :qid |TreasuryComplianceScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |TreasuryComplianceScriptsbpl.3452:13|
 :skolemid |94|
))) (= (ControlFlow 0 437905) 441688)) anon0$1_correct@@3)))
(let ((anon0_correct@@3  (=> (= (ControlFlow 0 617018) 437905) inline$$InitEventStore$0$anon0_correct@@3)))
anon0_correct@@3))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
