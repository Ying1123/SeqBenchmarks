...
(assert (not
 (=> (= (ControlFlow 0 0) 104215) (let ((anon19_Else_correct  (=> (and (and (not $t17) (|$IsValid'address'| $t16)) (and (= $t16 (|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0)) 0)) (= $t16 $t16))) (and (=> (= (ControlFlow 0 88771) (- 0 104783)) (not (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))))) (=> (not (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0)))) (and (=> (= (ControlFlow 0 88771) (- 0 104794)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (=> (= (ControlFlow 0 88771) (- 0 104805)) (= $t16 (let ((t_ref (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))
(|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 88597) (- 0 104708)) (or (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) (=> (or (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))) (=> (= (ControlFlow 0 88597) (- 0 104722)) (or (and (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))) (= 7 $t9@0)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= 5 $t9@0))))))))
(let ((anon19_Then_correct  (=> $t17 (=> (and (and (and (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0)) 0) (= 7 $t9)) (= $t9 $t9)) (and (= $t9@0 $t9) (= (ControlFlow 0 88795) 88597))) L5_correct))))
(let ((anon18_Then_correct  (=> $t12 (=> (and (= $t15@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1)) (= $t17 (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t15@0)) 0))) (and (=> (= (ControlFlow 0 88707) 88795) anon19_Then_correct) (=> (= (ControlFlow 0 88707) 88771) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (and (not $t12) (= $t14 $t14)) (and (= $t9@0 $t14) (= (ControlFlow 0 88691) 88597))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t10@1 $t10@1) (= $t11@0 (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $t10@1))) (and (= $t12  (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t11@0)) 0))) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t14) (= $t14 7)) (and (= $t14 $t14) (= $t12 $t12)))) (and (=> (= (ControlFlow 0 88675) 88707) anon18_Then_correct) (=> (= (ControlFlow 0 88675) 88691) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t9@0 $abort_code@1) (= (ControlFlow 0 88809) 88597))) L5_correct)))
(let ((anon16_Then$1_correct  (=> (= $t10@1 $t10) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 88861) 88809) anon17_Then_correct) (=> (= (ControlFlow 0 88861) 88675) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 88859) 88861)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t10@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t10@1 $t10@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 88615) 88809) anon17_Then_correct) (=> (= (ControlFlow 0 88615) 88675) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t6@0 (and (=> (= (ControlFlow 0 88601) 88859) anon16_Then_correct) (=> (= (ControlFlow 0 88601) 88615) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t6@0) (= $t8 $t8)) (and (= $t9@0 $t8) (= (ControlFlow 0 88537) 88597))) L5_correct)))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr)) 3))))
 :qid |ValidatorConfigbpl.4356:20|
 :skolemid |174|
)) (=> (and (and (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@0) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@0) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@0)) 3))))
 :qid |ValidatorConfigbpl.4360:20|
 :skolemid |175|
 ...
 :qid |ValidatorConfigbpl.4364:20|
 :skolemid |176|
))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@2)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@2) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@2)) 3))))
 :qid |ValidatorConfigbpl.4368:20|
 :skolemid |177|
)) (|$IsValid'address'| _$t0))) (=> (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0)))
 ...
 :qid |ValidatorConfigbpl.4375:20|
 :skolemid |178|
...
)) (= _$t0 _$t0)) (and (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t8) (= $t8 5)) (and (= $t8 $t8) (= $t6@0 $t6@0)))) (and (=> (= (ControlFlow 0 88521) 88601) anon15_Then_correct) (=> (= (ControlFlow 0 88521) 88537) anon15_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 88313) 88521)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 104215) 88313) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
