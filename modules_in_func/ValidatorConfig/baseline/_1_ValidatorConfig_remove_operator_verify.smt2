...
(declare-fun $t15@0 () T@$Mutation_69155)
(declare-fun $t14@1 () T@$Mutation_69114)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun $t15@1 () T@$Mutation_69155)
(declare-fun $t13 () |T@$1_Option_Option'address'|)
(declare-fun $t14@2 () T@$Mutation_69114)
...
(declare-fun $t14 () T@$Mutation_69114)
(declare-fun $t9 () Int)
(declare-fun $t14@0 () T@$Mutation_69114)
...
(declare-fun $t15 () T@$Mutation_69155)
(push 1)
(set-info :boogie-vc-id $1_ValidatorConfig_remove_operator$verify)
(set-option :timeout 40000)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 105307) (let ((anon18_Else_correct  (=> (and (and (not $abort_flag@0) (= $t15@0 ($Mutation_69155 (|l#$Mutation_69114| $t14@1) (let ((l (|l#Vec_15835| (|p#$Mutation_69114| $t14@1))))
(Vec_15835 (|Store__T@[Int]Int_| (|v#Vec_15835| (|p#$Mutation_69114| $t14@1)) l 1) (+ l 1))) (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@1))))) (and (= $t15@1 ($Mutation_69155 (|l#$Mutation_69155| $t15@0) (|p#$Mutation_69155| $t15@0) $t13)) (= $t14@2 ($Mutation_69114 (|l#$Mutation_69114| $t14@1) (|p#$Mutation_69114| $t14@1) ($1_ValidatorConfig_ValidatorConfig (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@1)) (|v#$Mutation_69155| $t15@1) (|$human_name#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@1))))))) (and (=> (= (ControlFlow 0 91219) (- 0 106689)) (<= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@2)))) 1)) (=> (<= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@2)))) 1) (and (=> (= (ControlFlow 0 91219) (- 0 106702)) (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@2)))) 1)) (=> (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|v#$Mutation_69114| $t14@2)))) 1) (=> (= $1_ValidatorConfig_ValidatorConfig_$memory@0 ($Memory_59721 (|Store__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_69114| $t14@2)) true) (|Store__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) (|a#$Global| (|l#$Mutation_69114| $t14@2)) (|v#$Mutation_69114| $t14@2)))) (and (=> (= (ControlFlow 0 91219) (- 0 106746)) (forall ((a Int) ) (!  (=> (|$IsValid'address'| a) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) a) (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) a)) (=> (not (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) a))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) a))))) (and ($1_Signer_is_txn_signer_addr a) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) a) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) a)) 3))))))
 :qid |ValidatorConfigbpl.5111:15|
 :skolemid |212|
 ...
 :qid |ValidatorConfigbpl.5117:15|
 :skolemid |213|
)) (and (=> (= (ControlFlow 0 91219) (- 0 106828)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr)) 3))))
 :qid |ValidatorConfigbpl.5123:15|
 :skolemid |214|
 ...
 :qid |ValidatorConfigbpl.5123:15|
 :skolemid |214|
)) (and (=> (= (ControlFlow 0 91219) (- 0 106853)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@1)) 3))))
 :qid |ValidatorConfigbpl.5129:15|
 :skolemid |215|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_69210| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@11))))) i@@68)))))))))
 :qid |ValidatorConfigbpl.5141:823|
 :skolemid |217|
...
(|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref))) 0)) a@@1)))
 :qid |ValidatorConfigbpl.5142:674|
 :skolemid |218|
))))
 :qid |ValidatorConfigbpl.5141:592|
 :skolemid |219|
...
(|Select__T@[Int]Int_| (|v#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| t_ref@@0))) 0)) a@@2)))
 ...
 :qid |ValidatorConfigbpl.5141:592|
 :skolemid |219|
))) (and (=> (= (ControlFlow 0 91219) (- 0 107044)) (forall ((addr@@19 Int) ) (!  (=> (|$IsValid'address'| addr@@19) (= (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@19)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@19) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@19)) 3))))
 :qid |ValidatorConfigbpl.5148:15|
 :skolemid |220|
 ...
 :qid |ValidatorConfigbpl.5148:15|
 :skolemid |220|
)) (and (=> (= (ControlFlow 0 91219) (- 0 107072)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t5)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t5))) (and (=> (= (ControlFlow 0 91219) (- 0 107084)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) 3)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) 3))) (and (=> (= (ControlFlow 0 91219) (- 0 107102)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (and (=> (= (ControlFlow 0 91219) (- 0 107114)) (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0)))) (=> (not (not (= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) (|$addr#$signer| _$t0))))) 0))) (=> (= (ControlFlow 0 91219) (- 0 107125)) (forall ((addr@@21 Int) ) (!  (=> (|$IsValid'address'| addr@@21) (=> (not (= addr@@21 $t4)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory@0) addr@@21))) (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@21))))))
 :qid |ValidatorConfigbpl.5177:15|
 :skolemid |221|
)))))))))))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 90655) (- 0 106551)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) 3))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t4))) (=> (= (ControlFlow 0 90655) (- 0 106582)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t5)) 3)) (= 3 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t4)) (= 5 $t8@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 91233) 90655))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $t14@1 $t14) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 91285) 91233) anon18_Then_correct) (=> (= (ControlFlow 0 91285) 91219) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= (ControlFlow 0 91283) 91285)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t9) (=> (and (and (= $t14@0 ($Mutation_69114 ($Global $t9) (Vec_15835 (MapConstVec_10052 DefaultVecElem_10052) 0) (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t9))) (= $t14@1 $t14@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 90703) 91233) anon18_Then_correct) (=> (= (ControlFlow 0 90703) 91219) anon18_Else_correct))))))
(let ((anon16_Then_correct  (=> inline$$1_ValidatorConfig_exists_config$0$$t1@1 (=> (and (and (|$IsValid'$1_Option_Option'address''| $t13) (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| $t13)) 1)) (|$IsEqual'vec'address''| (|$vec#$1_Option_Option'address'| $t13) (|$vec#$1_Option_Option'address'| (|$1_Option_Option'address'| (Vec_15835 (MapConstVec_10052 DefaultVecElem_10052) 0))))) (and (=> (= (ControlFlow 0 90681) 91283) anon17_Then_correct) (=> (= (ControlFlow 0 90681) 90703) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (not inline$$1_ValidatorConfig_exists_config$0$$t1@1) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 90555) 90655))) L3_correct)))
(let ((anon15_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1))) (and (=> (= (ControlFlow 0 90539) 90681) anon16_Then_correct) (=> (= (ControlFlow 0 90539) 90555) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t6)) 3)) (= 3 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 91351) 90655))) L3_correct))))
(let ((anon15_Then_correct true))
(let ((inline$$1_ValidatorConfig_exists_config$0$anon0_correct  (=> (= $t9 $t9) (=> (and (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $t9)) (= inline$$1_ValidatorConfig_exists_config$0$$t1@1 inline$$1_ValidatorConfig_exists_config$0$$t1@1)) (and (=> (= (ControlFlow 0 90497) 91299) anon15_Then_correct) (=> (= (ControlFlow 0 90497) 90539) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (not $t7) (=> (and (and (|$IsValid'address'| $t9) (= $t9 (|$addr#$signer| _$t0))) (and (= $t9 $t9) (= (ControlFlow 0 90503) 90497))) inline$$1_ValidatorConfig_exists_config$0$anon0_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@22)) 0)) (= addr@@22 173345816)))
 :qid |ValidatorConfigbpl.4816:20|
 :skolemid |184|
 ...
 :qid |ValidatorConfigbpl.4824:20|
 :skolemid |185|
 ...
 :qid |ValidatorConfigbpl.4832:20|
 :skolemid |186|
 ...
 :qid |ValidatorConfigbpl.4836:20|
 :skolemid |187|
 ...
 :qid |ValidatorConfigbpl.4840:20|
 :skolemid |188|
 ...
 :qid |ValidatorConfigbpl.4844:20|
 :skolemid |189|
 ...
 :qid |ValidatorConfigbpl.4848:20|
 :skolemid |190|
 ...
 :qid |ValidatorConfigbpl.4852:20|
 :skolemid |191|
 ...
 :qid |ValidatorConfigbpl.4856:20|
 :skolemid |192|
 ...
 :qid |ValidatorConfigbpl.4860:20|
 :skolemid |193|
))))) (=> (and (and (and (and (forall ((addr@@32 Int) ) (!  (=> (|$IsValid'address'| addr@@32) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@32) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr@@32) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr@@32)) 3))))
 :qid |ValidatorConfigbpl.4864:20|
 :skolemid |194|
 ...
 :qid |ValidatorConfigbpl.4868:20|
 :skolemid |195|
 ...
 :qid |ValidatorConfigbpl.4872:20|
 :skolemid |196|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_69210| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@36))))) i1)))) 3))))
 :qid |ValidatorConfigbpl.4876:151|
 :skolemid |197|
 ...
 :qid |ValidatorConfigbpl.4881:20|
 :skolemid |198|
 ...
 :qid |ValidatorConfigbpl.4885:20|
 :skolemid |199|
 ...
 :qid |ValidatorConfigbpl.4889:20|
 :skolemid |200|
 ...
 :qid |ValidatorConfigbpl.4893:20|
 :skolemid |201|
 ...
 :qid |ValidatorConfigbpl.4897:20|
 :skolemid |202|
 ...
 :qid |ValidatorConfigbpl.4909:20|
 :skolemid |205|
 ...
 :qid |ValidatorConfigbpl.4913:20|
 :skolemid |206|
 ...
 :qid |ValidatorConfigbpl.4917:20|
 :skolemid |207|
 ...
 :qid |ValidatorConfigbpl.4921:20|
 :skolemid |208|
 ...
 :qid |ValidatorConfigbpl.4925:20|
 :skolemid |209|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |ValidatorConfigbpl.4931:20|
 :skolemid |210|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0)))
 (and (|$IsValid'$1_ValidatorConfig_ValidatorConfig'| $rsc@@0) (and (<= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1) (<= (|l#Vec_15835| (|$vec#$1_Option_Option'address'| (|$operator_account#$1_ValidatorConfig_ValidatorConfig| $rsc@@0))) 1))))
 :qid |ValidatorConfigbpl.4935:20|
 :skolemid |211|
 :pattern ( (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0)))) (and (and (= $t5 (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t6 (|$addr#$signer| _$t0)) (= $t7  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) $t6)) 3))))))) (and (=> (= (ControlFlow 0 90372) 91351) anon14_Then_correct) (=> (= (ControlFlow 0 90372) 90503) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 89516) 90372)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (|l#Vec_15835| (|p#$Mutation_69114| $t14)) 0) (=> (and (= (|l#Vec_15835| (|p#$Mutation_69155| $t15)) 0) (= (ControlFlow 0 89526) 89516)) inline$$InitEventStore$0$anon0_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 105307) 89526) anon0_correct)))
