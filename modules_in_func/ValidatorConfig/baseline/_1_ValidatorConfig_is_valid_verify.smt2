...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 104900) (let ((anon11_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 89373) (- 0 105221))) false))))
(let ((L3_correct  (=> (= $t1@0 $t1@0) (and (=> (= (ControlFlow 0 89301) (- 0 105281)) (not false)) (=> (not false) (=> (= (ControlFlow 0 89301) (- 0 105288)) (= $t1@0  (and (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (not (= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)))) 0))))))))))
(let ((anon11_Else_correct  (=> (and (not $abort_flag@0) (= $t5@0 (|$config#$1_ValidatorConfig_ValidatorConfig| $t3@1))) (=> (and (and (= $t6  (not (= (|l#Vec_34709| (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| $t5@0)) 0))) (= $t6 $t6)) (and (= $t1@0 $t6) (= (ControlFlow 0 89351) 89301))) L3_correct))))
(let ((anon10_Then$1_correct  (=> (= $t3@1 $t3) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 89425) 89373) anon11_Then_correct) (=> (= (ControlFlow 0 89425) 89351) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= (ControlFlow 0 89423) 89425)) anon10_Then$1_correct)))
(let ((anon10_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0) (=> (and (and (= $t3@0 (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0)) (= $t3@1 $t3@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 89319) 89373) anon11_Then_correct) (=> (= (ControlFlow 0 89319) 89351) anon11_Else_correct))))))
(let ((anon9_Then_correct  (=> $t2@0 (and (=> (= (ControlFlow 0 89305) 89423) anon10_Then_correct) (=> (= (ControlFlow 0 89305) 89319) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (not $t2@0) (= false false)) (and (= $t1@0 false) (= (ControlFlow 0 89271) 89301))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (and (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) addr) (and (|Select__T@[Int]Bool_| (|domain#$Memory_59348| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_59348| $1_Roles_RoleId_$memory) addr)) 3))))
 :qid |ValidatorConfigbpl.4647:20|
 :skolemid |179|
 ...
 :qid |ValidatorConfigbpl.4651:20|
 :skolemid |180|
 ...
 :qid |ValidatorConfigbpl.4655:20|
 :skolemid |181|
 ...
 :qid |ValidatorConfigbpl.4659:20|
 :skolemid |182|
 ...
 :qid |ValidatorConfigbpl.4666:20|
 :skolemid |183|
...
))) (and (= _$t0 _$t0) (= $t2@0 (|Select__T@[Int]Bool_| (|domain#$Memory_59721| $1_ValidatorConfig_ValidatorConfig_$memory) _$t0))))) (and (=> (= (ControlFlow 0 89251) 89305) anon9_Then_correct) (=> (= (ControlFlow 0 89251) 89271) anon9_Else_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_34623_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |ValidatorConfigbpl.2225:13|
 :skolemid |77|
))) (= (ControlFlow 0 89073) 89251)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 104900) 89073) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
