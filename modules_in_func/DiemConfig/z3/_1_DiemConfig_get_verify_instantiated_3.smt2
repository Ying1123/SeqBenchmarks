...
(assert (not
 (=> (= (ControlFlow 0 0) 516331) (let ((anon12_Else_correct@@3  (=> (not $abort_flag@0@@10) (=> (and (= $t9@0@@3 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'| $t8@1@@3)) (= $t9@0@@3 $t9@0@@3)) (and (=> (= (ControlFlow 0 371672) (- 0 516670)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816))) (=> (= (ControlFlow 0 371672) (- 0 516682)) (= $t9@0@@3 (let ((addr@@35 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) addr@@35)))))))))))
(let ((L3_correct@@3  (and (=> (= (ControlFlow 0 371610) (- 0 516621)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (=> (= (ControlFlow 0 371610) (- 0 516628)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (= 5 $t7@0@@4)))))))
(let ((anon12_Then_correct@@3  (=> (and (and $abort_flag@0@@10 (= $abort_code@1@@10 $abort_code@1@@10)) (and (= $t7@0@@4 $abort_code@1@@10) (= (ControlFlow 0 371686) 371610))) L3_correct@@3)))
(let ((anon11_Then$1_correct@@3  (=> (= $t8@1@@3 $t8@@3) (=> (and (= $abort_flag@0@@10 true) (= $abort_code@1@@10 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 371738) 371686) anon12_Then_correct@@3) (=> (= (ControlFlow 0 371738) 371672) anon12_Else_correct@@3))))))
(let ((anon11_Then_correct@@3  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (= (ControlFlow 0 371736) 371738)) anon11_Then$1_correct@@3)))
(let ((anon11_Else_correct@@3  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816) (=> (and (and (= $t8@0@@3 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (= $t8@1@@3 $t8@0@@3)) (and (= $abort_flag@0@@10 false) (= $abort_code@1@@10 $abort_code@0@@10))) (and (=> (= (ControlFlow 0 371628) 371686) anon12_Then_correct@@3) (=> (= (ControlFlow 0 371628) 371672) anon12_Else_correct@@3))))))
(let ((anon10_Then_correct@@3  (=> $t4@0@@4 (and (=> (= (ControlFlow 0 371614) 371736) anon11_Then_correct@@3) (=> (= (ControlFlow 0 371614) 371628) anon11_Else_correct@@3)))))
(let ((anon10_Else_correct@@3  (=> (and (and (not $t4@0@@4) (= $t6@@3 $t6@@3)) (and (= $t7@0@@4 $t6@@3) (= (ControlFlow 0 371578) 371610))) L3_correct@@3)))
(let ((anon0$1_correct@@10  (=> (forall ((config_address@@18 Int) ) (!  (=> (|$IsValid'address'| config_address@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) config_address@@18) (= config_address@@18 173345816)))
 :qid |DiemConfigbpl.9183:20|
 :skolemid |246|
)) (=> (and (forall ((addr@@36 Int) ) (!  (=> (|$IsValid'address'| addr@@36) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) addr@@36) (= addr@@36 173345816)))
 :qid |DiemConfigbpl.9187:20|
 :skolemid |247|
)) (forall (($a_0@@30 Int) ) (! (let (($rsc@@30 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) $a_0@@30)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig''| $rsc@@30))
 :qid |DiemConfigbpl.9191:20|
 :skolemid |248|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) $a_0@@30))
))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@4 (|Select__T@[Int]Bool_| (|domain#$Memory_178695| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6@@3) (= $t6@@3 5)) (and (= $t6@@3 $t6@@3) (= $t4@0@@4 $t4@0@@4)))) (and (=> (= (ControlFlow 0 371562) 371614) anon10_Then_correct@@3) (=> (= (ControlFlow 0 371562) 371578) anon10_Else_correct@@3)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@10  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@15 T@$1_Event_EventHandle) ) (! (let ((stream@@20 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@15)))
 (and (= (|l#Multiset_144488| stream@@20) 0) (forall ((v@@48 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@20) v@@48) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 371424) 371562)) anon0$1_correct@@10)))
(let ((anon0_correct@@10  (=> (= (ControlFlow 0 516331) 371424) inline$$InitEventStore$0$anon0_correct@@10)))
anon0_correct@@10))))))))))))
))
(check-sat)
(pop 1)
