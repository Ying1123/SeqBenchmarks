...
(assert (not
 (=> (= (ControlFlow 0 0) 514808) (let ((anon12_Else_correct  (=> (not $abort_flag@0@@6) (=> (and (= $t9@0 (|$payload#$1_DiemConfig_DiemConfig'#0'| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 370005) (- 0 515124)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (= (ControlFlow 0 370005) (- 0 515136)) (= $t9@0 (let ((addr@@26 173345816))
(|$payload#$1_DiemConfig_DiemConfig'#0'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) addr@@26)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 369943) (- 0 515075)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (=> (= (ControlFlow 0 369943) (- 0 515082)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= 5 $t7@0@@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0@@6 (= $abort_code@1@@6 $abort_code@1@@6)) (and (= $t7@0@@0 $abort_code@1@@6) (= (ControlFlow 0 370019) 369943))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0@@6 true) (= $abort_code@1@@6 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 370071) 370019) anon12_Then_correct) (=> (= (ControlFlow 0 370071) 370005) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= (ControlFlow 0 370069) 370071)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0@@6 false) (= $abort_code@1@@6 $abort_code@0@@6))) (and (=> (= (ControlFlow 0 369961) 370019) anon12_Then_correct) (=> (= (ControlFlow 0 369961) 370005) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0@@0 (and (=> (= (ControlFlow 0 369947) 370069) anon11_Then_correct) (=> (= (ControlFlow 0 369947) 369961) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0@@0) (= $t6 $t6)) (and (= $t7@0@@0 $t6) (= (ControlFlow 0 369911) 369943))) L3_correct)))
(let ((anon0$1_correct@@6  (=> (and (forall ((config_address@@14 Int) ) (!  (=> (|$IsValid'address'| config_address@@14) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) config_address@@14) (= config_address@@14 173345816)))
 :qid |DiemConfigbpl.8561:20|
 :skolemid |235|
)) (forall (($a_0@@26 Int) ) (! (let (($rsc@@26 (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@26)))
(|$IsValid'$1_DiemConfig_DiemConfig'#0''| $rsc@@26))
 :qid |DiemConfigbpl.8565:20|
 :skolemid |236|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'#0'_| (|contents#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) $a_0@@26))
))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_178828| |$1_DiemConfig_DiemConfig'#0'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0@@0 $t4@0@@0)))) (and (=> (= (ControlFlow 0 369895) 369947) anon10_Then_correct) (=> (= (ControlFlow 0 369895) 369911) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@6  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@11 T@$1_Event_EventHandle) ) (! (let ((stream@@16 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@11)))
 (and (= (|l#Multiset_144488| stream@@16) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@16) v@@44) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 369780) 369895)) anon0$1_correct@@6)))
(let ((anon0_correct@@6  (=> (= (ControlFlow 0 514808) 369780) inline$$InitEventStore$0$anon0_correct@@6)))
anon0_correct@@6))))))))))))
))
(check-sat)
(pop 1)
