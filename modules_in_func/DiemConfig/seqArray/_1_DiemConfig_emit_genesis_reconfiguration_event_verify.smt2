...
(assert (not
 (=> (= (ControlFlow 0 0) 512737) (let ((anon22_Else_correct@@5  (=> (and (not $abort_flag@0@@5) (= $1_DiemConfig_Configuration_$memory@0@@4 ($Memory_173110 (|Store__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_196002| $t12@2)) true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_173110| $1_DiemConfig_Configuration_$memory) (|a#$Global| (|l#$Mutation_196002| $t12@2)) (|v#$Mutation_196002| $t12@2))))) (and (=> (= (ControlFlow 0 368009) (- 0 513377)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory@0@@4) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory@0@@4) 173345816)) (=> (= $t27@@4 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_173110| $1_DiemConfig_Configuration_$memory@0@@4) 173345816)) (=> (and (= $t28@@4 (|$events#$1_DiemConfig_Configuration| $t27@@4)) (= $t29@@4 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t27@@4)))) (and (=> (= (ControlFlow 0 368009) (- 0 513428)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0@@4) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@4) (|streams#$EventStore| $es)))))
(let ((expected (let ((stream@@11 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4)))
(let ((stream_new@@4 (let ((len@@4 (|l#Multiset_144488| stream@@11)))
(let ((cnt@@4 (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@11) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4))))
(Multiset_144488 (|Store__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@11) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4) (+ cnt@@4 1)) (+ len@@4 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4 stream_new@@4))))))
 (and (<= (|counter#$EventStore| expected) (|counter#$EventStore| actual)) (forall ((handle@@7 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected) handle@@7)) (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual) handle@@7))) (forall ((v@@40 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected) handle@@7)) v@@40) (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual) handle@@7)) v@@40))
...
(let ((expected@@0 (let ((stream@@12 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4)))
(let ((stream_new@@5 (let ((len@@5 (|l#Multiset_144488| stream@@12)))
(let ((cnt@@5 (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@12) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4))))
(Multiset_144488 (|Store__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@12) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4) (+ cnt@@5 1)) (+ len@@5 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4 stream_new@@5))))))
 (and (<= (|counter#$EventStore| expected@@0) (|counter#$EventStore| actual@@0)) (forall ((handle@@8 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected@@0) handle@@8)) (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual@@0) handle@@8))) (forall ((v@@41 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected@@0) handle@@8)) v@@41) (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual@@0) handle@@8)) v@@41))
 :qid |DiemConfigbpl.139:13|
 :skolemid |3|
)))
 :qid |DiemConfigbpl.2568:13|
 :skolemid |70|
))))) (=> (= (ControlFlow 0 368009) (- 0 513453)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0@@4) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0@@4) (|streams#$EventStore| $es)))))
(let ((expected@@1 (let ((stream@@13 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4)))
(let ((stream_new@@6 (let ((len@@6 (|l#Multiset_144488| stream@@13)))
(let ((cnt@@6 (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@13) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4))))
(Multiset_144488 (|Store__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@13) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29@@4) (+ cnt@@6 1)) (+ len@@6 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $EmptyEventStore) $t28@@4 stream_new@@6))))))
 (and (<= (|counter#$EventStore| actual@@1) (|counter#$EventStore| expected@@1)) (forall ((handle@@9 T@$1_Event_EventHandle) ) (!  (and (<= (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual@@1) handle@@9)) (|l#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected@@1) handle@@9))) (forall ((v@@42 T@$EventRep) ) (! (<= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| actual@@1) handle@@9)) v@@42) (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| expected@@1) handle@@9)) v@@42))
 :qid |DiemConfigbpl.139:13|
 :skolemid |3|
)))
 :qid |DiemConfigbpl.2568:13|
...
(let ((anon22_Then_correct@@5 true))
(let ((|inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|  (=> (and (= |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| (|v#$Mutation_165934| $t24@0@@0)) (= $es@0@@4 (let ((stream@@14 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1|)))
(let ((stream_new@@7 (let ((len@@7 (|l#Multiset_144488| stream@@14)))
(let ((cnt@@7 (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@14) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0))))
(Multiset_144488 (|Store__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@14) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t26@0) (+ cnt@@7 1)) (+ len@@7 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$handle@1| stream_new@@7)))))) (and (=> (= (ControlFlow 0 367879) 368023) anon22_Then_correct@@5) (=> (= (ControlFlow 0 367879) 368009) anon22_Else_correct@@5)))))
(let ((anon21_Then_correct@@5  (=> $t4@0 (=> (and (and (and (|$IsValid'u64'| 1) (= $t23@0 ($Mutation_11233 (|l#$Mutation_196002| $t12@1) (seq.++ (|p#$Mutation_196002| $t12@1) (seq.unit 0)) (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@1))))) (and (= $t23@1 ($Mutation_11233 (|l#$Mutation_11233| $t23@0) (|p#$Mutation_11233| $t23@0) 1)) (= $t12@2 ($Mutation_196002 (|l#$Mutation_196002| $t12@1) (|p#$Mutation_196002| $t12@1) ($1_DiemConfig_Configuration (|v#$Mutation_11233| $t23@1) (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@1)) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@1))))))) (and (and (= $t24@0@@0 ($Mutation_165934 (|l#$Mutation_196002| $t12@2) (seq.++ (|p#$Mutation_196002| $t12@2) (seq.unit 2)) (|$events#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@2)))) (= $t25@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@2)))) (and (= $t26@0 ($1_DiemConfig_NewEpochEvent $t25@0)) (= (ControlFlow 0 367885) 367879)))) |inline$$1_Event_emit_event'$1_DiemConfig_NewEpochEvent'$0$anon0_correct|))))
(let ((anon21_Else_correct@@5 true))
(let ((L5_correct@@5  (=> (|$IsValid'u64'| 0) (=> (and (and (|$IsValid'u64'| $t21@@4) (= $t21@@4 1)) (and (= $t21@@4 $t21@@4) (= $t4@0 $t4@0))) (and (=> (= (ControlFlow 0 367722) 367885) anon21_Then_correct@@5) (=> (= (ControlFlow 0 367722) 367738) anon21_Else_correct@@5))))))
(let ((anon20_Else_correct@@5  (=> (and (and (not $t15@0@@5) (= false false)) (and (= $t4@0 false) (= (ControlFlow 0 367692) 367722))) L5_correct@@5)))
(let ((anon20_Then_correct@@5  (=> $t15@0@@5 (=> (and (= $t16@0 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@1))) (|$IsValid'u64'| 0)) (=> (and (and (= $t18@0@@0 (= $t16@0 0)) (= $t18@0@@0 $t18@0@@0)) (and (= $t4@0 $t18@0@@0) (= (ControlFlow 0 368053) 367722))) L5_correct@@5)))))
(let ((anon19_Else_correct@@4  (=> (and (not $abort_flag@0@@5) (= |$temp_0'$1_DiemConfig_Configuration'@0@@4| (|v#$Mutation_196002| $t12@1))) (=> (and (and (= |$temp_0'$1_DiemConfig_Configuration'@0@@4| |$temp_0'$1_DiemConfig_Configuration'@0@@4|) (= $t13@0 (|$epoch#$1_DiemConfig_Configuration| (|v#$Mutation_196002| $t12@1)))) (and (|$IsValid'u64'| 0) (= $t15@0@@5 (= $t13@0 0)))) (and (=> (= (ControlFlow 0 367672) 368053) anon20_Then_correct@@5) (=> (= (ControlFlow 0 367672) 367692) anon20_Else_correct@@5))))))
(let ((anon19_Then_correct@@4 true))
(let ((anon18_Then$1_correct  (=> (= $t12@1 $t12@@0) (=> (and (= $abort_flag@0@@5 true) (= $abort_code@1@@5 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 368119) 368067) anon19_Then_correct@@4) (=> (= (ControlFlow 0 368119) 367672) anon19_Else_correct@@4))))))
(let ((anon18_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816)) (= (ControlFlow 0 368117) 368119)) anon18_Then$1_correct)))
(let ((anon18_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816) (=> (and (and (= $t12@0@@4 ($Mutation_196002 ($Global 173345816) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816))) (= $t12@1 $t12@0@@4)) (and (= $abort_flag@0@@5 false) (= $abort_code@1@@5 $abort_code@0@@5))) (and (=> (= (ControlFlow 0 367634) 368067) anon19_Then_correct@@4) (=> (= (ControlFlow 0 367634) 367672) anon19_Else_correct@@4))))))
(let ((anon17_Then_correct  (=> (and $t7@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 367612) 368117) anon18_Then_correct@@4) (=> (= (ControlFlow 0 367612) 367634) anon18_Else_correct@@4)))))
(let ((anon17_Else_correct true))
(let ((anon0$1_correct@@5  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816)) (=> (and (and (and (forall (($a_0@@25 Int) ) (! (let (($rsc@@25 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_173110| $1_DiemConfig_Configuration_$memory) $a_0@@25)))
(|$IsValid'$1_DiemConfig_Configuration'| $rsc@@25))
 :qid |DiemConfigbpl.7922:20|
 :skolemid |206|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_173110| $1_DiemConfig_Configuration_$memory) $a_0@@25))
)) (|$IsValid'address'| 173345816)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_173110| $1_DiemConfig_Configuration_$memory) 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9@@5) (= $t9@@5 5)) (and (= $t9@@5 $t9@@5) (= $t7@0 $t7@0)))) (and (=> (= (ControlFlow 0 367580) 367612) anon17_Then_correct) (=> (= (ControlFlow 0 367580) 367596) anon17_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@5  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@10 T@$1_Event_EventHandle) ) (! (let ((stream@@15 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@10)))
 (and (= (|l#Multiset_144488| stream@@15) 0) (forall ((v@@43 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@15) v@@43) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 367492) 367580)) anon0$1_correct@@5)))
(let ((anon0_correct@@5  (=> (= (seq.len (|p#$Mutation_196002| $t5)) 0) (=> (and (and (= (seq.len (|p#$Mutation_196002| $t12@@0)) 0) (= (seq.len (|p#$Mutation_11233| $t23@@5)) 0)) (and (= (seq.len (|p#$Mutation_165934| $t24@@5)) 0) (= (ControlFlow 0 367502) 367492))) inline$$InitEventStore$0$anon0_correct@@5))))
(let ((PreconditionGeneratedEntry_correct@@5  (=> (= (ControlFlow 0 512737) 367502) anon0_correct@@5)))
