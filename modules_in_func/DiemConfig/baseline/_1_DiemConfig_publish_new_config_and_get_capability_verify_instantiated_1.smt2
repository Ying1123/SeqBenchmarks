...
(declare-fun $t15@0 () |T@$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'|)
...
(declare-fun $t13@0 () |T@$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 542272) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 395400) (- 0 543359)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.13037:15|
 :skolemid |446|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConfigbpl.13037:15|
 :skolemid |446|
)) (and (=> (= (ControlFlow 0 395400) (- 0 543384)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 395400) (- 0 543395)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) addr@@0) (= addr@@0 173345816)))
 :qid |DiemConfigbpl.13049:15|
 :skolemid |447|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) addr@@1) (= addr@@1 173345816)))
 :qid |DiemConfigbpl.13049:15|
 :skolemid |447|
)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'$1_DiemConsensusConfig_DiemConsensusConfig'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 395400) (- 0 543446)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 395400) (- 0 543458)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 395400) (- 0 543476)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 395400) (- 0 543490)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 395400) (- 0 543500)) (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 395400) (- 0 543506)) (|$IsEqual'vec'u8''| (|$config#$1_DiemConsensusConfig_DiemConsensusConfig| (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) addr@@2)))) (|$config#$1_DiemConsensusConfig_DiemConsensusConfig| _$t1))) (=> (|$IsEqual'vec'u8''| (|$config#$1_DiemConsensusConfig_DiemConsensusConfig| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1|) addr@@3)))) (|$config#$1_DiemConsensusConfig_DiemConsensusConfig| _$t1)) (=> (= (ControlFlow 0 395400) (- 0 543515)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 395182) (- 0 543240)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816)) (=> (= (ControlFlow 0 395182) (- 0 543280)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 395414) 395182))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 395466) 395414) anon15_Then_correct) (=> (= (ControlFlow 0 395466) 395400) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 395464) 395466)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@0| ($Memory_186641 (|Store__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_| (|contents#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 395226) 395414) anon15_Then_correct) (=> (= (ControlFlow 0 395226) 395400) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'| _$t1))) (and (=> (= (ControlFlow 0 395204) (- 0 543113)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 395204) 395464) anon14_Then_correct) (=> (= (ControlFlow 0 395204) 395226) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 395054) 395182))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 395038) 395204) anon13_Then_correct) (=> (= (ControlFlow 0 395038) 395054) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 394998) 395038)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) $t8)) (= (ControlFlow 0 395004) 394998))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 395558) 395182))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4)) 0)) (= addr@@4 173345816)))
 ...
 :qid |DiemConfigbpl.12871:20|
 :skolemid |442|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_186641| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$memory|) addr@@18) (= addr@@18 173345816)))
 :qid |DiemConfigbpl.12875:20|
 :skolemid |443|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_DiemConsensusConfig_DiemConsensusConfig'| _$t1)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemConfigbpl.12884:20|
 :skolemid |444|
...
))) (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemConsensusConfig_DiemConsensusConfig'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))))))) (and (=> (= (ControlFlow 0 394942) 395558) anon12_Then_correct) (=> (= (ControlFlow 0 394942) 395004) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 394345) 394942)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 542272) 394345) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
