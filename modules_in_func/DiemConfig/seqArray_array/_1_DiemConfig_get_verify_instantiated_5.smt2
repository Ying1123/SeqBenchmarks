...
(declare-fun $t9@0 () T@$1_DiemVersion_DiemVersion)
(declare-fun $t8@1 () |T@$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'|)
...
(declare-fun $t8 () |T@$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'|)
(declare-fun $t8@0 () |T@$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'|)
...
(push 1)
(set-info :boogie-vc-id $1_DiemConfig_get$verify_instantiated_5)
(assert (not
 (=> (= (ControlFlow 0 0) 531498) (let ((anon12_Else_correct  (=> (not $abort_flag@0) (=> (and (= $t9@0 (|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| $t8@1)) (= $t9@0 $t9@0)) (and (=> (= (ControlFlow 0 382594) (- 0 531847)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (= (ControlFlow 0 382594) (- 0 531859)) (= $t9@0 (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@0)))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 382532) (- 0 531798)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (=> (= (ControlFlow 0 382532) (- 0 531805)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= 5 $t7@0)))))))
(let ((anon12_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 382608) 382532))) L3_correct)))
(let ((anon11_Then$1_correct  (=> (= $t8@1 $t8) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 382660) 382608) anon12_Then_correct) (=> (= (ControlFlow 0 382660) 382594) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= (ControlFlow 0 382658) 382660)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (=> (and (and (= $t8@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (= $t8@1 $t8@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 382550) 382608) anon12_Then_correct) (=> (= (ControlFlow 0 382550) 382594) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t4@0 (and (=> (= (ControlFlow 0 382536) 382658) anon11_Then_correct) (=> (= (ControlFlow 0 382536) 382550) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t4@0) (= $t6 $t6)) (and (= $t7@0 $t6) (= (ControlFlow 0 382500) 382532))) L3_correct)))
(let ((anon0$1_correct  (=> (and (and (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.9520:20|
 :skolemid |274|
)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (and (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@1) (= addr@@1 173345816)))
 :qid |DiemConfigbpl.9528:20|
 :skolemid |275|
)) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''| $rsc))
 :qid |DiemConfigbpl.9532:20|
 :skolemid |276|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0))
)))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6) (= $t6 5)) (and (= $t6 $t6) (= $t4@0 $t4@0)))) (and (=> (= (ControlFlow 0 382484) 382536) anon10_Then_correct) (=> (= (ControlFlow 0 382484) 382500) anon10_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 382336) 382484)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 531498) 382336) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
