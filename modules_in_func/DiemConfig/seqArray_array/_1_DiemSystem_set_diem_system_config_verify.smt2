...
(declare-fun _$t0 () T@$1_DiemSystem_DiemSystem)
(declare-fun $1_DiemConfig_Configuration_$memory () T@$Memory_180633)
(declare-fun $t24 () T@$1_DiemConfig_NewEpochEvent)
...
(declare-fun $t15@0 () |T@$1_DiemConfig_ModifyConfigCapability'$1_DiemSystem_DiemSystem'|)
(declare-fun $t14 () T@$1_DiemSystem_CapabilityHolder)
...
(declare-fun $t14@0 () T@$1_DiemSystem_CapabilityHolder)
...
(assert (not
 (=> (= (ControlFlow 0 0) 568932) (let ((anon18_correct  (=> (and (and (= $t21 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816)) (= $t22 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t23 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t21))) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (=> (and (and (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@0)))) (|$scheme#$1_DiemSystem_DiemSystem| _$t0)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@0 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@0)))) (|$validators#$1_DiemSystem_DiemSystem| _$t0))) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816))) (and (and (= $t24 $t23) (= $t25 $t19)) (and (= $t26  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t22 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t18))))) (= $es@0 (ite $t26 (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) $t25)))
(let ((stream_new (let ((len (|l#Multiset_146057| stream@@0)))
(let ((cnt (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t24))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@0) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t24) (+ cnt 1)) (+ len 1))))))
($EventStore (+ (|counter#$EventStore| $es) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) $t25 stream_new)))) $es))))) (and (=> (= (ControlFlow 0 425432) (- 0 570210)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.20759:15|
 :skolemid |713|
 ...
 :qid |DiemConfigbpl.20759:15|
 :skolemid |713|
)) (and (=> (= (ControlFlow 0 425432) (- 0 570235)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816)) (and (=> (= (ControlFlow 0 425432) (- 0 570246)) (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@1) (= addr@@1 173345816)))
 :qid |DiemConfigbpl.20771:15|
 :skolemid |714|
 ...
 :qid |DiemConfigbpl.20771:15|
 :skolemid |714|
)) (=> (= $t27 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816)) (=> (and (= $t28 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t29 ($1_DiemConfig_NewEpochEvent (|$epoch#$1_DiemConfig_Configuration| $t27)))) (and (=> (= (ControlFlow 0 425432) (- 0 570310)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (and (=> (= (ControlFlow 0 425432) (- 0 570320)) (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t3) 18446744073709551615)) (< $t4 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t3))))) (=> (not (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t3) 18446744073709551615)) (< $t4 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t3)))) (and (=> (= (ControlFlow 0 425432) (- 0 570362)) (and (= (|$scheme#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (|$scheme#$1_DiemSystem_DiemSystem| _$t0)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (|$validators#$1_DiemSystem_DiemSystem| _$t0)))) (=> (and (= (|$scheme#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (|$scheme#$1_DiemSystem_DiemSystem| _$t0)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816))) (|$validators#$1_DiemSystem_DiemSystem| _$t0))) (and (=> (= (ControlFlow 0 425432) (- 0 570375)) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) 173345816) (and (=> (= (ControlFlow 0 425432) (- 0 570381)) (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@3)))) (|$scheme#$1_DiemSystem_DiemSystem| _$t0)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@3)))) (|$validators#$1_DiemSystem_DiemSystem| _$t0)))) (=> (and (= (|$scheme#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@4)))) (|$scheme#$1_DiemSystem_DiemSystem| _$t0)) (|$IsEqual'vec'$1_DiemSystem_ValidatorInfo''| (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@4 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2|) addr@@4)))) (|$validators#$1_DiemSystem_DiemSystem| _$t0))) (and (=> (= (ControlFlow 0 425432) (- 0 570390)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816))) (=> (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory@2) 173345816)) (and (=> (= (ControlFlow 0 425432) (- 0 570401)) (let ((actual ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t28 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t5)))) (let ((stream@@1 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@0 (let ((len@@0 (|l#Multiset_146057| stream@@1)))
(let ((cnt@@0 (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@1) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt@@0 1)) (+ len@@0 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@0)))) $EmptyEventStore)))
...
(let ((expected@@0 (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t28 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t5)))) (let ((stream@@2 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@1 (let ((len@@1 (|l#Multiset_146057| stream@@2)))
(let ((cnt@@1 (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@2) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt@@1 1)) (+ len@@1 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@1)))) $EmptyEventStore)))
 ...
 :qid |DiemConfigbpl.2603:13|
 :skolemid |92|
))))) (=> (= (ControlFlow 0 425432) (- 0 570446)) (let ((actual@@1 ($EventStore (- (|counter#$EventStore| $es@0) (|counter#$EventStore| $es)) (|lambda#2| (|streams#$EventStore| $es@0) (|streams#$EventStore| $es)))))
(let ((expected@@1 (ite  (and (not (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))))) (not (= $t28 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t5)))) (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6)))
(let ((stream_new@@2 (let ((len@@2 (|l#Multiset_146057| stream@@3)))
(let ((cnt@@2 (|Select__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29))))
(Multiset_146057 (|Store__T@[$EventRep]Int_| (|v#Multiset_146057| stream@@3) (|$ToEventRep'$1_DiemConfig_NewEpochEvent'| $t29) (+ cnt@@2 1)) (+ len@@2 1))))))
($EventStore (+ (|counter#$EventStore| $EmptyEventStore) 1) (|Store__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $EmptyEventStore) $t6 stream_new@@2)))) $EmptyEventStore)))
...
(let ((anon26_Else_correct  (=> (and (and (not |$temp_0'bool'@1|) (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1| ($Memory_180719 (|Store__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 false) (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@1|) (= (ControlFlow 0 425034) 425432))) anon18_correct)))
(let ((anon26_Then_correct  (=> (and (and |$temp_0'bool'@1| (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0| ($Memory_180719 (|Store__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816 |$temp_0'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''@0|)))) (and (= |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@2| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory@0|) (= (ControlFlow 0 425444) 425432))) anon18_correct)))
(let ((anon25_Else_correct  (=> (not |$temp_0'bool'@0|) (=> (and (= $1_DiemConfig_Configuration_$memory@1 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 false) (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@1)) (and (=> (= (ControlFlow 0 425020) 425444) anon26_Then_correct) (=> (= (ControlFlow 0 425020) 425034) anon26_Else_correct))))))
(let ((anon25_Then_correct  (=> |$temp_0'bool'@0| (=> (and (= $1_DiemConfig_Configuration_$memory@0 ($Memory_180633 (|Store__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 true) (|Store__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816 |$temp_0'$1_DiemConfig_Configuration'@0|))) (= $1_DiemConfig_Configuration_$memory@2 $1_DiemConfig_Configuration_$memory@0)) (and (=> (= (ControlFlow 0 425456) 425444) anon26_Then_correct) (=> (= (ControlFlow 0 425456) 425034) anon26_Else_correct))))))
(let ((anon24_Else_correct  (=> (not $t20) (and (=> (= (ControlFlow 0 425008) 425456) anon25_Then_correct) (=> (= (ControlFlow 0 425008) 425020) anon25_Else_correct)))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 424834) (- 0 569894)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t3) 18446744073709551615)) (< $t4 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t3))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t3) 18446744073709551615)) (< $t4 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t3)))) (=> (= (ControlFlow 0 424834) (- 0 569938)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8@0)) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t3) 18446744073709551615)) (< $t4 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t3))) (= 1 $t8@0))))))))
(let ((anon24_Then_correct  (=> $t20 (=> (and (and (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (= 5 $t8)) (and (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t16) 18446744073709551615)) (< $t17 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t16))) (= 1 $t8))) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 425534) 424834))) L3_correct))))
(let ((anon23_Else_correct  (=> (and (not $abort_flag@0) (= $t15@0 (|$cap#$1_DiemSystem_CapabilityHolder| $t14))) (=> (and (and (= $t16 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t17 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)))) (and (= $t18 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (= $t19 (|$events#$1_DiemConfig_Configuration| $t18)))) (and (=> (= (ControlFlow 0 425000) (- 0 569708)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)) (and (=> (= (ControlFlow 0 425000) (- 0 569721)) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (=> (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816) (and (=> (= (ControlFlow 0 425000) (- 0 569727)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| 173345816)) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| 173345816) (=> (= $t20  (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (and (and (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (not (|Select__T@[Int]Bool_| (|domain#$Memory_186855| $1_DiemConfig_DisableReconfiguration_$memory) 173345816))) (> (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) 0)) (< (|$epoch#$1_DiemConfig_Configuration| $t16) 18446744073709551615)) (< $t17 (|$last_reconfiguration_time#$1_DiemConfig_Configuration| $t16))))) (and (=> (= (ControlFlow 0 425000) 425534) anon24_Then_correct) (=> (= (ControlFlow 0 425000) 425008) anon24_Else_correct)))))))))))))
(let ((anon23_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 425548) 424834))) L3_correct)))
(let ((anon22_Then$1_correct  (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 425600) 425548) anon23_Then_correct) (=> (= (ControlFlow 0 425600) 425000) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) 173345816)) (= (ControlFlow 0 425598) 425600)) anon22_Then$1_correct)))
(let ((anon22_Else_correct  (=> (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) 173345816) (= $t14@0 (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) 173345816))) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 424858) 425548) anon23_Then_correct) (=> (= (ControlFlow 0 424858) 425000) anon23_Else_correct)))))
(let ((anon21_Then_correct  (=> (and $t10@0 (|$IsValid'address'| 173345816)) (and (=> (= (ControlFlow 0 424844) 425598) anon22_Then_correct) (=> (= (ControlFlow 0 424844) 424858) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (and (not $t10@0) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 424714) 424834))) L3_correct)))
(let ((anon20_Else_correct  (=> (and (and (and (not $t7) (|$IsValid'address'| 173345816)) (and (= $t10@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) 173345816)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= $t10@0 $t10@0)))) (and (=> (= (ControlFlow 0 424698) 424844) anon21_Then_correct) (=> (= (ControlFlow 0 424698) 424714) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> $t7 (=> (and (and (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (= 1 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 425626) 424834))) L3_correct))))
(let ((anon0$1_correct  (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816)) (=> (and (forall ((config_address@@1 Int) ) (!  (=> (|$IsValid'address'| config_address@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) config_address@@1) (= config_address@@1 173345816)))
 :qid |DiemConfigbpl.20466:20|
 :skolemid |704|
)) (forall ((addr@@5 Int) ) (!  (=> (|$IsValid'address'| addr@@5) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@5) (= addr@@5 173345816)))
 :qid |DiemConfigbpl.20470:20|
 :skolemid |705|
))) (=> (and (and (and (and (|$IsValid'$1_DiemSystem_DiemSystem'| _$t0) (let (($range_0 ($Range 0 (|l#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| _$t0)))))
(let (($range_1 ($Range 0 (|l#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| _$t0)))))
(forall (($i_2 Int) ($i_3 Int) ) (!  (=> ($InRange $range_0 $i_2) (=> ($InRange $range_1 $i_3) (let ((i@@84 $i_2))
(let ((j@@25 $i_3))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| _$t0)) i@@84)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| _$t0)) j@@25))) (= i@@84 j@@25))))))
 :qid |DiemConfigbpl.20473:222|
 :skolemid |706|
))))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) $a_0)))
(|$IsValid'$1_DiemTimestamp_CurrentTimeMicroseconds'| $rsc))
 :qid |DiemConfigbpl.20478:20|
 :skolemid |707|
...
)) (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@2)))
 (and (|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem''| $rsc@@2) (let (($range_1@@0 ($Range 0 (|l#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@2))))))
(let (($range_2 ($Range 0 (|l#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@2))))))
(forall (($i_3@@0 Int) ($i_4 Int) ) (!  (=> ($InRange $range_1@@0 $i_3@@0) (=> ($InRange $range_2 $i_4) (let ((i@@85 $i_3@@0))
(let ((j@@26 $i_4))
 (=> (= (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@2))) i@@85)) (|$addr#$1_DiemSystem_ValidatorInfo| (|Select__T@[Int]$1_DiemSystem_ValidatorInfo_| (|v#Vec_146370| (|$validators#$1_DiemSystem_DiemSystem| (|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| $rsc@@2))) j@@26))) (= i@@85 j@@26))))))
 :qid |DiemConfigbpl.20491:367|
 :skolemid |710|
))))))
 :qid |DiemConfigbpl.20490:20|
 :skolemid |711|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) $a_0@@2))
))) (and (forall (($a_0@@3 Int) ) (! (let (($rsc@@3 (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@3)))
(|$IsValid'$1_DiemSystem_CapabilityHolder'| $rsc@@3))
 :qid |DiemConfigbpl.20496:20|
 :skolemid |712|
 :pattern ( (|Select__T@[Int]$1_DiemSystem_CapabilityHolder_| (|contents#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) $a_0@@3))
)) (= $t3 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))))) (and (and (and (= $t4 (|$microseconds#$1_DiemTimestamp_CurrentTimeMicroseconds| (|Select__T@[Int]$1_DiemTimestamp_CurrentTimeMicroseconds_| (|contents#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))) (= $t5 (|Select__T@[Int]$1_DiemConfig_Configuration_| (|contents#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816))) (and (= $t6 (|$events#$1_DiemConfig_Configuration| $t5)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180719| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) 173345816)) (|Select__T@[Int]Bool_| (|domain#$Memory_180792| $1_DiemSystem_CapabilityHolder_$memory) 173345816))))) (and (and (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$modifies| 173345816) (|Select__T@[Int]Bool_| $1_DiemConfig_Configuration_$modifies 173345816)) (and (= _$t0 _$t0) (= $t7  (not (|Select__T@[Int]Bool_| (|domain#$Memory_179627| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816))))))) (and (=> (= (ControlFlow 0 424646) 425626) anon20_Then_correct) (=> (= (ControlFlow 0 424646) 424698) anon20_Else_correct)))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@4 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@4)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 424174) 424646)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 568932) 424174) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))
))
(check-sat)
(pop 1)
