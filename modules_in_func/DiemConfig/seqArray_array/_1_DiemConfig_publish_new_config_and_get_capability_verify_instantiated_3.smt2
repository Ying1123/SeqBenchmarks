...
(declare-fun $t15@0 () |T@$1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'|)
...
(declare-fun $t13@0 () |T@$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'|)
...
(assert (not
 (=> (= (ControlFlow 0 0) 544800) (let ((anon15_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 398190) (- 0 545887)) (forall ((config_address Int) ) (!  (=> (|$IsValid'address'| config_address) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) config_address) (= config_address 173345816)))
 :qid |DiemConfigbpl.13749:15|
 :skolemid |488|
))) (=> (forall ((config_address@@0 Int) ) (!  (=> (|$IsValid'address'| config_address@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) config_address@@0) (= config_address@@0 173345816)))
 :qid |DiemConfigbpl.13749:15|
 :skolemid |488|
)) (and (=> (= (ControlFlow 0 398190) (- 0 545912)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) 173345816))) (=> (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) 173345816)) (and (=> (= (ControlFlow 0 398190) (- 0 545923)) (forall ((addr@@0 Int) ) (!  (=> (|$IsValid'address'| addr@@0) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) addr@@0) (= addr@@0 173345816)))
 :qid |DiemConfigbpl.13761:15|
 :skolemid |489|
))) (=> (forall ((addr@@1 Int) ) (!  (=> (|$IsValid'address'| addr@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) addr@@1) (= addr@@1 173345816)))
 :qid |DiemConfigbpl.13761:15|
 :skolemid |489|
)) (=> (and (= $t15@0 (|$1_DiemConfig_ModifyConfigCapability'$1_DiemVersion_DiemVersion'| false)) (= $t15@0 $t15@0)) (and (=> (= (ControlFlow 0 398190) (- 0 545974)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4))) (and (=> (= (ControlFlow 0 398190) (- 0 545986)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (and (=> (= (ControlFlow 0 398190) (- 0 546004)) (not (not (= (|$addr#$signer| _$t0) 173345816)))) (=> (not (not (= (|$addr#$signer| _$t0) 173345816))) (and (=> (= (ControlFlow 0 398190) (- 0 546018)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (and (=> (= (ControlFlow 0 398190) (- 0 546028)) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) 173345816)) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) 173345816) (and (=> (= (ControlFlow 0 398190) (- 0 546034)) (= (let ((addr@@2 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) addr@@2))) _$t1)) (=> (= (let ((addr@@3 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1|) addr@@3))) _$t1) (=> (= (ControlFlow 0 398190) (- 0 546043)) (= (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_180633| $1_DiemConfig_Configuration_$memory) 173345816)))))))))))))))))))))))))
(let ((L3_correct  (and (=> (= (ControlFlow 0 397972) (- 0 545768)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))) (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816)) (=> (= (ControlFlow 0 397972) (- 0 545808)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) (= 5 $t7@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t4)) 0)) (= 3 $t7@0))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) 173345816) (= 6 $t7@0))))))))
(let ((anon15_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t7@0 $abort_code@1) (= (ControlFlow 0 398204) 397972))) L3_correct)))
(let ((anon14_Then$1_correct  (=> (= |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 398256) 398204) anon15_Then_correct) (=> (= (ControlFlow 0 398256) 398190) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) (|$addr#$signer| _$t0)) (= (ControlFlow 0 398254) 398256)) anon14_Then$1_correct)))
(let ((anon14_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) (|$addr#$signer| _$t0))) (=> (and (and (= |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@0| ($Memory_180224 (|Store__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) (|$addr#$signer| _$t0) $t13@0))) (= |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@1| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory@0|)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 398016) 398204) anon15_Then_correct) (=> (= (ControlFlow 0 398016) 398190) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and inline$$Not$0$dst@1 (= $t13@0 (|$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'| _$t1))) (and (=> (= (ControlFlow 0 397994) (- 0 545641)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$modifies| (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$modifies| (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 397994) 398254) anon14_Then_correct) (=> (= (ControlFlow 0 397994) 398016) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t12 $t12)) (and (= $t7@0 $t12) (= (ControlFlow 0 397844) 397972))) L3_correct)))
(let ((anon12_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t12) (= $t12 6)) (and (= $t12 $t12) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 397828) 397994) anon13_Then_correct) (=> (= (ControlFlow 0 397828) 397844) anon13_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t9@0)) (= (ControlFlow 0 397788) 397828)) anon12_Else$1_correct)))
(let ((anon12_Else_correct  (=> (not $t6) (=> (and (and (|$IsValid'address'| $t8) (= $t8 (|$addr#$signer| _$t0))) (and (= $t9@0 (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $t8)) (= (ControlFlow 0 397794) 397788))) inline$$Not$0$anon0_correct))))
(let ((anon12_Then_correct  (=> $t6 (=> (and (and (or (or (or (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) (= 5 $t7))) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0)) (= 3 $t7))) (and (not (= (|$addr#$signer| _$t0) 173345816)) (= 2 $t7))) (= $t7 $t7)) (and (= $t7@0 $t7) (= (ControlFlow 0 398348) 397972))) L3_correct))))
(let ((anon0$1_correct  (=> (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) addr@@4)) 0)) (= addr@@4 173345816)))
 ...
 :qid |DiemConfigbpl.13583:20|
 :skolemid |484|
)) (forall ((addr@@18 Int) ) (!  (=> (|$IsValid'address'| addr@@18) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) addr@@18) (= addr@@18 173345816)))
 :qid |DiemConfigbpl.13587:20|
 :skolemid |485|
)))))) (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (|$IsValid'$1_DiemVersion_DiemVersion'| _$t1)) (and (and (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |DiemConfigbpl.13596:20|
 :skolemid |486|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $a_0))
)) (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_| (|contents#$Memory_180224| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$memory|) $a_0@@0)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion''| $rsc@@0))
 :qid |DiemConfigbpl.13600:20|
 :skolemid |487|
...
))) (and (= $t4 (|$addr#$signer| _$t0)) (|Select__T@[Int]Bool_| |$1_DiemConfig_DiemConfig'$1_DiemVersion_DiemVersion'_$modifies| 173345816))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t5 (|$addr#$signer| _$t0)) (= $t6  (or (or (or (not (= (|$addr#$signer| _$t0) 173345816)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_180353| $1_Roles_RoleId_$memory) $t5))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_180353| $1_Roles_RoleId_$memory) $t5)) 0))) (not (= (|$addr#$signer| _$t0) 173345816))))))))) (and (=> (= (ControlFlow 0 397732) 398348) anon12_Then_correct) (=> (= (ControlFlow 0 397732) 397794) anon12_Else_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_146057_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |DiemConfigbpl.2587:13|
 :skolemid |91|
))) (= (ControlFlow 0 397135) 397732)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 544800) 397135) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
