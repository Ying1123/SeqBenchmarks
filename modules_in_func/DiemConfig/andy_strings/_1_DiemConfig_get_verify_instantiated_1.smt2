...
(assert (not
 (=> (= (ControlFlow 0 0) 515621) (let ((anon12_Else_correct@@1  (=> (not $abort_flag@0@@8) (=> (and (= $t9@0@@1 (|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| $t8@1@@1)) (= $t9@0@@1 $t9@0@@1)) (and (=> (= (ControlFlow 0 370893) (- 0 515947)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (= (ControlFlow 0 370893) (- 0 515959)) (= $t9@0@@1 (let ((addr@@33 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) addr@@33)))))))))))
(let ((L3_correct@@1  (and (=> (= (ControlFlow 0 370831) (- 0 515898)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (=> (= (ControlFlow 0 370831) (- 0 515905)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= 5 $t7@0@@2)))))))
(let ((anon12_Then_correct@@1  (=> (and (and $abort_flag@0@@8 (= $abort_code@1@@8 $abort_code@1@@8)) (and (= $t7@0@@2 $abort_code@1@@8) (= (ControlFlow 0 370907) 370831))) L3_correct@@1)))
(let ((anon11_Then$1_correct@@1  (=> (= $t8@1@@1 $t8@@1) (=> (and (= $abort_flag@0@@8 true) (= $abort_code@1@@8 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 370959) 370907) anon12_Then_correct@@1) (=> (= (ControlFlow 0 370959) 370893) anon12_Else_correct@@1))))))
(let ((anon11_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= (ControlFlow 0 370957) 370959)) anon11_Then$1_correct@@1)))
(let ((anon11_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816) (=> (and (and (= $t8@0@@1 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (= $t8@1@@1 $t8@0@@1)) (and (= $abort_flag@0@@8 false) (= $abort_code@1@@8 $abort_code@0@@8))) (and (=> (= (ControlFlow 0 370849) 370907) anon12_Then_correct@@1) (=> (= (ControlFlow 0 370849) 370893) anon12_Else_correct@@1))))))
(let ((anon10_Then_correct@@1  (=> $t4@0@@2 (and (=> (= (ControlFlow 0 370835) 370957) anon11_Then_correct@@1) (=> (= (ControlFlow 0 370835) 370849) anon11_Else_correct@@1)))))
(let ((anon10_Else_correct@@1  (=> (and (and (not $t4@0@@2) (= $t6@@1 $t6@@1)) (and (= $t7@0@@2 $t6@@1) (= (ControlFlow 0 370799) 370831))) L3_correct@@1)))
(let ((anon0$1_correct@@8  (=> (forall ((config_address@@16 Int) ) (!  (=> (|$IsValid'address'| config_address@@16) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) config_address@@16) (= config_address@@16 173345816)))
 :qid |DiemConfigbpl.8877:20|
 :skolemid |242|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_172108| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (forall (($a_0@@28 Int) ) (! (let (($rsc@@28 (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@28)))
(|$IsValid'$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies''| $rsc@@28))
 :qid |DiemConfigbpl.8885:20|
 :skolemid |243|
 :pattern ( (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_| (|contents#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) $a_0@@28))
))) (=> (and (and (and (|$IsValid'address'| 173345816) (= 173345816 173345816)) (and (= $t4@0@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_173340| |$1_DiemConfig_DiemConfig'$1_RegisteredCurrencies_RegisteredCurrencies'_$memory|) 173345816)) (|$IsValid'u64'| 1))) (and (and (|$IsValid'u64'| $t6@@1) (= $t6@@1 5)) (and (= $t6@@1 $t6@@1) (= $t4@0@@2 $t4@0@@2)))) (and (=> (= (ControlFlow 0 370783) 370835) anon10_Then_correct@@1) (=> (= (ControlFlow 0 370783) 370799) anon10_Else_correct@@1)))))))
(let ((inline$$InitEventStore$0$anon0_correct@@8  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@13 T@$1_Event_EventHandle) ) (! (let ((stream@@18 (|Select__T@[$1_Event_EventHandle]Multiset_144488_| (|streams#$EventStore| $es) handle@@13)))
 (and (= (|l#Multiset_144488| stream@@18) 0) (forall ((v@@46 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_144488| stream@@18) v@@46) 0)
 :qid |DiemConfigbpl.134:13|
 :skolemid |2|
))))
 :qid |DiemConfigbpl.2552:13|
 :skolemid |69|
))) (= (ControlFlow 0 370658) 370783)) anon0$1_correct@@8)))
(let ((anon0_correct@@8  (=> (= (ControlFlow 0 515621) 370658) inline$$InitEventStore$0$anon0_correct@@8)))
anon0_correct@@8))))))))))))
))
(check-sat)
(pop 1)
