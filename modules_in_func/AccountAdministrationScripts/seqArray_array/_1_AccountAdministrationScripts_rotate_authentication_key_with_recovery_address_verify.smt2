...
(declare-fun inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 () T@Vec_74151)
...
(assert (not
 (=> (= (ControlFlow 0 0) 309730) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct  (=> (and (not $abort_flag@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2)) (and (=> (= (ControlFlow 0 250937) (- 0 311365)) (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= inline$$AddU64$0$dst@2 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (=> (= (ControlFlow 0 250937) (- 0 311372)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0 ($Range 0 inline$$AddU64$0$dst@2)))
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |229|
)))))))))
(let ((anon4_Else_correct  (=> (not $abort_flag@5) (and (=> (= (ControlFlow 0 252261) (- 0 312285)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 252261) (- 0 312296)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) _$t2)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) _$t2))) (and (=> (= (ControlFlow 0 252261) (- 0 312307)) (not (not (= (|l#Vec_22899| _$t3) 32)))) (=> (not (not (= (|l#Vec_22899| _$t3) 32))) (and (=> (= (ControlFlow 0 252261) (- 0 312321)) (not (not (exists ((i@@104 Int) ) (!  (and (and (|$IsValid'u64'| i@@104) (and (<= 0 i@@104) (< i@@104 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@104)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
))))) (=> (not (not (exists ((i@@105 Int) ) (!  (and (and (|$IsValid'u64'| i@@105) (and (<= 0 i@@105) (< i@@105 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@105)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (and (=> (= (ControlFlow 0 252261) (- 0 312333)) (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))))) (=> (not (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (and (=> (= (ControlFlow 0 252261) (- 0 312354)) (not (not (exists ((i@@106 Int) ) (!  (and (and (|$IsValid'u64'| i@@106) (and (<= 0 i@@106) (< i@@106 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@106)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
))))) (=> (not (not (exists ((i@@107 Int) ) (!  (and (and (|$IsValid'u64'| i@@107) (and (<= 0 i@@107) (< i@@107 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@107)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (and (=> (= (ControlFlow 0 252261) (- 0 312366)) (not (not (or (= $t4 _$t1) (= $t4 _$t2))))) (=> (not (not (or (= $t4 _$t1) (= $t4 _$t2)))) (=> (= (ControlFlow 0 252261) (- 0 312385)) (|$IsEqual'vec'u8''| (|$authentication_key#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory@3) _$t2)) _$t3)))))))))))))))))))
(let ((anon4_Then_correct  (=> (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (=> (= (ControlFlow 0 252541) (- 0 312054)) (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_22899| _$t3) 32))) (not (exists ((i@@108 Int) ) (!  (and (and (|$IsValid'u64'| i@@108) (and (<= 0 i@@108) (< i@@108 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@108)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (not (exists ((i@@109 Int) ) (!  (and (and (|$IsValid'u64'| i@@109) (and (<= 0 i@@109) (< i@@109 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@109)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (not (or (= $t4 _$t1) (= $t4 _$t2))))) (=> (or (or (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) _$t2))) (not (= (|l#Vec_22899| _$t3) 32))) (not (exists ((i@@110 Int) ) (!  (and (and (|$IsValid'u64'| i@@110) (and (<= 0 i@@110) (< i@@110 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@110)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2)))) (not (exists ((i@@111 Int) ) (!  (and (and (|$IsValid'u64'| i@@111) (and (<= 0 i@@111) (< i@@111 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@111)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
)))) (not (or (= $t4 _$t1) (= $t4 _$t2)))) (=> (= (ControlFlow 0 252541) (- 0 312131)) (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $abort_code@6)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) _$t2)) (= 5 $abort_code@6))) (and (not (= (|l#Vec_22899| _$t3) 32)) (= 7 $abort_code@6))) (and (not (exists ((i@@112 Int) ) (!  (and (and (|$IsValid'u64'| i@@112) (and (<= 0 i@@112) (< i@@112 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@112)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
))) (= 7 $abort_code@6))) (and (not (or (= (|$addr#$signer| _$t0) _$t1) (= (|$addr#$signer| _$t0) _$t2))) (= 7 $abort_code@6))) (and (not (exists ((i@@113 Int) ) (!  (and (and (|$IsValid'u64'| i@@113) (and (<= 0 i@@113) (< i@@113 (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))))) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) i@@113)) _$t2))
 :qid |AccountAdministrationScriptsbpl.11954:13|
 :skolemid |224|
))) (= 7 $abort_code@6))) (and (not (or (= $t4 _$t1) (= $t4 _$t2))) (= 7 $abort_code@6))) (= 5 $abort_code@6)) (= 7 $abort_code@6))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct  (=> (and (and (not $abort_flag@4) (= $1_DiemAccount_DiemAccount_$memory@3 $1_DiemAccount_DiemAccount_$memory@1)) (and (= $abort_flag@5 $abort_flag@4) (= $abort_code@6 $abort_code@5))) (and (=> (= (ControlFlow 0 251985) 252541) anon4_Then_correct) (=> (= (ControlFlow 0 251985) 252261) anon4_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct  (=> (= $1_DiemAccount_DiemAccount_$memory@3 $1_DiemAccount_DiemAccount_$memory@2) (=> (and (= $abort_flag@5 true) (= $abort_code@6 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1)) (and (=> (= (ControlFlow 0 249968) 252541) anon4_Then_correct) (=> (= (ControlFlow 0 249968) 252261) anon4_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct  (=> $abort_flag@4 (=> (and (and (= $abort_code@5 $abort_code@5) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@5)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory@1) (= (ControlFlow 0 251999) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct  (=> (and (and (and inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1 ($Mutation_99130 (|l#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (let ((l (|l#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) l 0) (+ l 1))) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2 ($Mutation_99130 (|l#$Mutation_99130| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) (|p#$Mutation_99130| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1) _$t3)) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3 ($Mutation_143116 (|l#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) (|p#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2) ($1_DiemAccount_DiemAccount (|v#$Mutation_99130| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))))))) (and (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_138898 (|Store__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)) (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3)))) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@4 $abort_flag@3) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory@0)))) (and (=> (= (ControlFlow 0 251877) 251999) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 251877) 251985) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct  (=> (= $abort_code@5 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1) (=> (and (= $abort_flag@4 true) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory)) (and (=> (= (ControlFlow 0 251673) 251999) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Then_correct) (=> (= (ControlFlow 0 251673) 251985) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon45_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= (ControlFlow 0 251827) 251673))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct  (=> (and (and (and (not $abort_flag@3) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 (= |inline$$1_Vector_length'u8'$0$l@1| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1)))) (and (=> (= (ControlFlow 0 251811) 251877) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct) (=> (= (ControlFlow 0 251811) 251827) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 251891) 251673))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'u8'$0$l@1| (|l#Vec_22899| _$t3)) (and (=> (= (ControlFlow 0 251753) 251891) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct) (=> (= (ControlFlow 0 251753) 251811) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct  (=> (and (and (not $abort_flag@3) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| (|v#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1|) (= (ControlFlow 0 251759) 251753))) |inline$$1_Vector_length'u8'$0$anon0_correct|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@4) (= (ControlFlow 0 251905) 251673))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@4 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) (and (=> (= (ControlFlow 0 251957) 251905) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 251957) 251759) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1)) (= (ControlFlow 0 251955) 251957)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1 ($Mutation_143116 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1) (Vec_22899 (MapConstVec_14643 DefaultVecElem_14643) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1))) (= $abort_flag@3 $abort_flag@1)) (and (= $abort_code@4 $abort_code@2) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1))) (and (=> (= (ControlFlow 0 251703) 251905) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct) (=> (= (ControlFlow 0 251703) 251759) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|))) (and (=> (= (ControlFlow 0 251681) 251955) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct) (=> (= (ControlFlow 0 251681) 251703) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= (ControlFlow 0 251667) 251673))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 251651) 251681) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct) (=> (= (ControlFlow 0 251651) 251667) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1 $abort_code@2) (= (ControlFlow 0 251971) 251673))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 251609) 251971) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct) (=> (= (ControlFlow 0 251609) 251651) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct  (=> (= (|l#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0)) 0) (=> (and (= (|l#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_99130| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0)) 0)) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= _$t3 _$t3)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= (ControlFlow 0 251615) 251609))) inline$$1_DiemAccount_exists_at$0$anon0_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct  (=> (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= (ControlFlow 0 251975) 251615)) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct  (=> $abort_flag@2 (=> (and (and (= $abort_code@3 $abort_code@3) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@3)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 250951) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@2 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 250868) 250951) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 250868) 250937) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (> (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1) $MAX_U64) (= (ControlFlow 0 250866) 250868)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (>= $MAX_U64 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (=> (and (and (= inline$$AddU64$0$dst@1 (+ inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 1)) (= $abort_flag@2 $abort_flag@1)) (and (= $abort_code@3 $abort_code@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 250814) 250951) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Then_correct) (=> (= (ControlFlow 0 250814) 250937) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon46_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct  (=> (and (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2) (|$IsValid'u64'| 1)) (and (=> (= (ControlFlow 0 250874) 250866) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 250874) 250814) inline$$AddU64$0$anon3_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct  (=> (and (not $abort_flag@1) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t31@2 (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 _$t2))) (and (=> (= (ControlFlow 0 250707) 251975) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Then_correct) (=> (= (ControlFlow 0 250707) 250874) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon44_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 252013) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 250687) 252013) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Then_correct) (=> (= (ControlFlow 0 250687) 250707) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon43_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct  (=> (not $abort_flag@1) (=> (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2|) (= (ControlFlow 0 250693) 250687)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct  (=> $abort_flag@1 (=> (and (and (= $abort_code@2 $abort_code@2) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@2)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 252027) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@0|)) (and (=> (= (ControlFlow 0 250572) 252027) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 250572) 250693) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|  (=> (and (not (InRangeVec_65681 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1)) (= (ControlFlow 0 250570) 250572)) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then$1_correct|)))
(let ((|inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|  (=> (InRangeVec_65681 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1) (=> (and (and (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1)) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@2| |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$dst@1|))) (and (=> (= (ControlFlow 0 250520) 252027) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Then_correct) (=> (= (ControlFlow 0 250520) 250693) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon42_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct  (=> inline$$Lt$0$dst@1 (and (=> (= (ControlFlow 0 250578) 250570) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 250578) 250520) |inline$$1_Vector_borrow'$1_DiemAccount_KeyRotationCapability'$0$anon3_Else_correct|)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct  (=> (not inline$$Lt$0$dst@1) (and (=> (= (ControlFlow 0 250433) (- 0 311025)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 250433) (- 0 311032)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@0 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@0 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@0) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@0))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@0)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |228|
)))) (=> (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@1 ($Range 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)))
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@1))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@1)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |228|
))) (=> (|$IsValid'u64'| 4) (=> (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 7)) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t35@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 250433) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct  (and (=> (= (ControlFlow 0 250352) 250578) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Then_correct) (=> (= (ControlFlow 0 250352) 250433) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon41_Else_correct))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (= (ControlFlow 0 250342) 250352)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct  (=> (and (not $abort_flag@0) (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (and (=> (= (ControlFlow 0 250348) (- 0 310863)) (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (=> (<= 0 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|) (and (=> (= (ControlFlow 0 250348) (- 0 310870)) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@2 ($Range 0 0)))
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@2 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@2) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@2))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@2)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |226|
...
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@3 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@3 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@3) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@3 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@3))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@3)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |226|
))) (=> (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1) (=> (and (and (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t29@1) (|$IsValid'address'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t30@1)) (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t32@1) (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t33@1))) (and (and (not $abort_flag@0) (<= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1 |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1|)) (and (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@4 ($Range 0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t26@1)))
(forall ((inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4 Int) ) (!  (=> ($InRange inline$$1_RecoveryAddress_rotate_authentication_key$0$$range_0@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4) (let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@4 inline$$1_RecoveryAddress_rotate_authentication_key$0$$i_1@@4))
 (not (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) inline$$1_RecoveryAddress_rotate_authentication_key$0$j@@4)) _$t2))))
 :qid |unknown.0:0|
 :skolemid |227|
))) (= (ControlFlow 0 250348) 250342)))) inline$$Lt$0$anon0_correct)))))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 252041) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (|l#Vec_74151| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1)) (and (=> (= (ControlFlow 0 250152) 252041) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Then_correct) (=> (= (ControlFlow 0 250152) 250348) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon40_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct  (=> (and (not $abort_flag@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2))) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t25@1) (|$IsValid'u64'| 0)) (and (= 0 0) (= (ControlFlow 0 250158) 250152))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct  (=> $abort_flag@0 (=> (and (and (= $abort_code@1 $abort_code@1) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 $abort_code@1)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 252055) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@0)) (and (=> (= (ControlFlow 0 252107) 252055) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 252107) 250158) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 252105) 252107)) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then$1_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@2 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t24@1))) (and (=> (= (ControlFlow 0 250088) 252055) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Then_correct) (=> (= (ControlFlow 0 250088) 250158) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon39_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 (and (=> (= (ControlFlow 0 250074) 252105) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Then_correct) (=> (= (ControlFlow 0 250074) 250088) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon38_Else_correct)))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 250070) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct  (=> (|$IsValid'u64'| 2) (=> (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 7)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t23@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1))) (and (=> (= (ControlFlow 0 250054) 250074) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Then_correct) (=> (= (ControlFlow 0 250054) 250070) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon37_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t1)) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t21@1) (= (ControlFlow 0 250020) 250054))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct  (=> (and (and inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= true true)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t8@1 true) (= (ControlFlow 0 252125) 250054))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L5_correct)))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct  (=> inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (=> (and (and (|$IsValid'address'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 (|$addr#$signer| _$t0))) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t19@1 (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t18@0 _$t2)))) (and (=> (= (ControlFlow 0 249998) 252125) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Then_correct) (=> (= (ControlFlow 0 249998) 250020) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon36_Else_correct))))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct  (=> (not inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1) (=> (and (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t17@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0)) (and (= $1_DiemAccount_DiemAccount_$memory@2 $1_DiemAccount_DiemAccount_$memory) (= (ControlFlow 0 249962) 249968))) inline$$1_RecoveryAddress_rotate_authentication_key$0$L17_correct))))
(let ((inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct  (=> (and (= _$t0 _$t0) (= _$t1 _$t1)) (=> (and (and (and (= _$t2 _$t2) (= _$t3 _$t3)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 5)) (and (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t16@0) (= inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1 inline$$1_RecoveryAddress_rotate_authentication_key$0$$t14@1)))) (and (=> (= (ControlFlow 0 249946) 249998) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Then_correct) (=> (= (ControlFlow 0 249946) 249962) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon35_Else_correct))))))
(let ((anon0$1_correct  (=> (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr) (or (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0) (and (not (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)) (= addr (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))))))
 ...
 :qid |AccountAdministrationScriptsbpl.15611:20|
 :skolemid |467|
))) (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_140007| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@2)  (and (= addr@@2 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@2))))
 :qid |AccountAdministrationScriptsbpl.15615:20|
 :skolemid |468|
 ...
 :qid |AccountAdministrationScriptsbpl.15619:20|
 :skolemid |469|
)))) (and (and (forall ((addr@@4 Int) ) (!  (=> (|$IsValid'address'| addr@@4) (= (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@4) (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@4)))
 :qid |AccountAdministrationScriptsbpl.15623:20|
 :skolemid |470|
 ...
 :qid |AccountAdministrationScriptsbpl.15627:20|
 :skolemid |471|
))) (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6) (and (> (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@6))) 0)) addr@@6))))
 :qid |AccountAdministrationScriptsbpl.15631:20|
 :skolemid |472|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@7) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) addr@@7) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) addr@@7))))
 :qid |AccountAdministrationScriptsbpl.15635:20|
 :skolemid |473|
))))) (=> (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (and (|$IsValid'address'| _$t1) (|$IsValid'address'| _$t2)) (and (|$IsValid'vec'u8''| _$t3) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $a_0)))
 ...
 :qid |AccountAdministrationScriptsbpl.15650:20|
 :skolemid |474|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $a_0))
))))) (and (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@0))
 :qid |AccountAdministrationScriptsbpl.15654:20|
 :skolemid |475|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@0))
)) (= $t4 (|$addr#$signer| _$t0))) (and (let ((addr@@8 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@8)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@8) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@8)))))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 252129) 249946))))) inline$$1_RecoveryAddress_rotate_authentication_key$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountAdministrationScriptsbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 248335) 252129)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 309730) 248335) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
