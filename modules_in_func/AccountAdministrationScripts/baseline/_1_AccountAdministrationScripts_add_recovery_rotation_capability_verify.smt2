...
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory () T@$Memory_147611)
...
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@1 () T@$Memory_147611)
(declare-fun $t3 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun $abort_flag@4 () Bool)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3 () T@$Mutation_149579)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 () T@$Mutation_149579)
(declare-fun |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| () T@$Mutation_79240)
(declare-fun $1_RecoveryAddress_RecoveryAddress_$memory@0 () T@$Memory_147611)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1 () T@$Mutation_79240)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1 () T@Vec_74151)
(declare-fun |Store__T@[Int]Int_| (|T@[Int]Int| Int Int) |T@[Int]Int|)
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?x2 Int)) (! (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?x1)  ?x2) :weight 0)))
(assert (forall ( ( ?x0 |T@[Int]Int|) ( ?x1 Int) ( ?y1 Int) ( ?x2 Int)) (! (=>  (not (= ?x1 ?y1)) (= (|Select__T@[Int]Int_| (|Store__T@[Int]Int_| ?x0 ?x1 ?x2) ?y1) (|Select__T@[Int]Int_| ?x0 ?y1))) :weight 0)))
(declare-fun |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| () T@Vec_74151)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0 () T@$Mutation_149579)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1 () T@$Mutation_149579)
...
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t8@0 () T@$Mutation_79240)
(declare-fun inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@0 () T@$Mutation_79240)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 290708) (let ((L2_correct  (and (=> (= (ControlFlow 0 220777) (- 0 293238)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t4)) (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (>= (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) $t5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5)))))))) (=> (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t4)) (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0))))) 0)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (>= (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) $t5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))))))) (=> (= (ControlFlow 0 220777) (- 0 293286)) (or (or (or (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t4)) (= 5 $t8@0)) (and (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0))))) 0) (= 1 $t8@0))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= 5 $t8@0))) (and (>= (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256) (= 8 $t8@0))) (and (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) $t5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5)))))) (= 7 $t8@0))) (= 1 $t8@0)) (= 5 $t8@0)) (= 8 $t8@0)) (= 7 $t8@0)))))))
(let ((anon7_Then_correct  (=> (and (and $abort_flag@5 (= $abort_code@6 $abort_code@6)) (and (= $t8@0 $abort_code@6) (= (ControlFlow 0 220581) 220777))) L2_correct)))
(let ((anon6_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= $t8@0 $abort_code@4) (= (ControlFlow 0 220791) 220777))) L2_correct)))
(let ((anon7_Else_correct  (=> (not $abort_flag@5) (and (=> (= (ControlFlow 0 220567) (- 0 293132)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t4)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t4))) (and (=> (= (ControlFlow 0 220567) (- 0 293144)) (not (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0))))) 0))) (=> (not (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|$addr#$signer| _$t0))))) 0)) (and (=> (= (ControlFlow 0 220567) (- 0 293155)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (and (=> (= (ControlFlow 0 220567) (- 0 293166)) (not (>= (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256))) (=> (not (>= (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) 256)) (and (=> (= (ControlFlow 0 220567) (- 0 293183)) (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) $t5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5)))))))) (=> (not (not (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) $t5) $t5 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $t5))))))) (and (=> (= (ControlFlow 0 220567) (- 0 293197)) (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory@1) (|$addr#$signer| _$t0))))) 0)) (=> (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory@1) (|$addr#$signer| _$t0))))) 0) (=> (= (ControlFlow 0 220567) (- 0 293206)) (= (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory@1) _$t1))) (- (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory@1) _$t1))) 1)) $t3)))))))))))))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Else_correct  (=> (and (not $abort_flag@4) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3 ($Mutation_149579 (|l#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) (|p#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) ($1_RecoveryAddress_RecoveryAddress (|v#$Mutation_79240| |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1|))))) (=> (and (and (= $1_RecoveryAddress_RecoveryAddress_$memory@0 ($Memory_147611 (|Store__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)) true) (|Store__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) (|a#$Global| (|l#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)) (|v#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@3)))) (= $abort_code@6 $abort_code@5)) (and (= $abort_flag@5 $abort_flag@4) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory@0))) (and (=> (= (ControlFlow 0 220339) 220581) anon7_Then_correct) (=> (= (ControlFlow 0 220339) 220567) anon7_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct  (=> (= $abort_code@6 inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1) (=> (and (= $abort_flag@5 true) (= $1_RecoveryAddress_RecoveryAddress_$memory@1 $1_RecoveryAddress_RecoveryAddress_$memory)) (and (=> (= (ControlFlow 0 219849) 220581) anon7_Then_correct) (=> (= (ControlFlow 0 219849) 220567) anon7_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5) (= (ControlFlow 0 220353) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((|inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$m'@1| ($Mutation_79240 (|l#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1) (|p#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1) (let ((l (|l#Vec_74151| (|v#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1))))
(Vec_74151 (|Store__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|v#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1)) l inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1) (+ l 1))))) (and (=> (= (ControlFlow 0 220297) 220353) inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Then_correct) (=> (= (ControlFlow 0 220297) 220339) inline$$1_RecoveryAddress_add_rotation_capability$0$anon29_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Then_correct  (=> (and inline$$Lt$0$dst@1 (= (ControlFlow 0 220303) 220297)) |inline$$1_Vector_push_back'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Else_correct  (=> (and (and (not inline$$Lt$0$dst@1) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= (ControlFlow 0 220242) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else$1_correct  (=> (|$IsValid'u64'| 6) (=> (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 8)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t26@0) (= inline$$Lt$0$dst@1 inline$$Lt$0$dst@1))) (and (=> (= (ControlFlow 0 220226) 220303) inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Then_correct) (=> (= (ControlFlow 0 220226) 220242) inline$$1_RecoveryAddress_add_rotation_capability$0$anon28_Else_correct))))))
(let ((inline$$Lt$0$anon0_correct  (=> (and (= inline$$Lt$0$dst@1 (< |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| 256)) (= (ControlFlow 0 220186) 220226)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else$1_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else_correct  (=> (not $abort_flag@4) (=> (and (|$IsValid'u64'| 256) (= (ControlFlow 0 220192) 220186)) inline$$Lt$0$anon0_correct))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5) (= (ControlFlow 0 220367) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((|inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|  (=> (= |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$l@1| (|l#Vec_74151| inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1)) (and (=> (= (ControlFlow 0 220126) 220367) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Then_correct) (=> (= (ControlFlow 0 220126) 220192) inline$$1_RecoveryAddress_add_rotation_capability$0$anon27_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct  (=> (and (not $abort_flag@4) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1 ($Mutation_79240 (|l#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2) (let ((l@@0 (|l#Vec_22899| (|p#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2))))
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2)) l@@0 0) (+ l@@0 1))) (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|v#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2))))) (=> (and (and (= |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| (|v#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1)) (= |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1| |inline$$1_RecoveryAddress_add_rotation_capability$0$$temp_0'vec'$1_DiemAccount_KeyRotationCapability''@1|)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t21@1 (|v#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@1)) (= (ControlFlow 0 220132) 220126))) |inline$$1_Vector_length'$1_DiemAccount_KeyRotationCapability'$0$anon0_correct|))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@5 $abort_code@5)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@5) (= (ControlFlow 0 220381) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then$1_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@5 $EXEC_FAILURE_CODE) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0)) (and (=> (= (ControlFlow 0 220433) 220381) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct) (=> (= (ControlFlow 0 220433) 220132) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (= (ControlFlow 0 220431) 220433)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then$1_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1) (=> (and (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1 ($Mutation_149579 ($Global _$t1) (Vec_22899 (MapConstVec_14643 DefaultVecElem_14643) 0) (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1))) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@5 $abort_code@4) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@2 inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@1))) (and (=> (= (ControlFlow 0 220060) 220381) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Then_correct) (=> (= (ControlFlow 0 220060) 220132) inline$$1_RecoveryAddress_add_rotation_capability$0$anon26_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Then_correct  (=> inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0 (and (=> (= (ControlFlow 0 220038) 220431) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Then_correct) (=> (= (ControlFlow 0 220038) 220060) inline$$1_RecoveryAddress_add_rotation_capability$0$anon25_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Else_correct  (=> (and (and (not inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= (ControlFlow 0 220034) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Else_correct  (=> (and (and (and (not $abort_flag@3) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0  (and (and (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1)) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1))) (= (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) _$t1) _$t1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) _$t1))) (ite (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)))))) (|$IsValid'u64'| 3))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 7)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t18@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t16@0)))) (and (=> (= (ControlFlow 0 220018) 220038) inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Then_correct) (=> (= (ControlFlow 0 220018) 220034) inline$$1_RecoveryAddress_add_rotation_capability$0$anon24_Else_correct)))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 $abort_code@4) (= (ControlFlow 0 220447) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1) (=> (and (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1)) (= inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1 inline$$1_DiemAccount_key_rotation_capability_address$0$$t1@1)) (and (=> (= (ControlFlow 0 219946) 220447) inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Then_correct) (=> (= (ControlFlow 0 219946) 220018) inline$$1_RecoveryAddress_add_rotation_capability$0$anon23_Else_correct))))))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Then_correct  (=> (and inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 (= (ControlFlow 0 219952) 219946)) inline$$1_DiemAccount_key_rotation_capability_address$0$anon0_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Else_correct  (=> (and (and (not inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t14@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= (ControlFlow 0 219843) 219849))) inline$$1_RecoveryAddress_add_rotation_capability$0$L7_correct)))
(let ((inline$$1_RecoveryAddress_add_rotation_capability$0$anon0_correct  (=> (and (and (= (|l#Vec_22899| (|p#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t8@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_149579| inline$$1_RecoveryAddress_add_rotation_capability$0$$t19@0)) 0)) (and (= (|l#Vec_22899| (|p#$Mutation_79240| inline$$1_RecoveryAddress_add_rotation_capability$0$$t20@0)) 0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t10@0 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1)))) (=> (and (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1) (= _$t1 _$t1)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) _$t1)) (|$IsValid'u64'| 5))) (and (and (|$IsValid'u64'| inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 5)) (and (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0 inline$$1_RecoveryAddress_add_rotation_capability$0$$t13@0) (= inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1 inline$$1_RecoveryAddress_add_rotation_capability$0$$t11@1)))) (and (=> (= (ControlFlow 0 219827) 219952) inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Then_correct) (=> (= (ControlFlow 0 219827) 219843) inline$$1_RecoveryAddress_add_rotation_capability$0$anon22_Else_correct))))))
(let ((anon6_Else_correct  (=> (not $abort_flag@3) (=> (and (= $t9 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1)) (= (ControlFlow 0 220451) 219827)) inline$$1_RecoveryAddress_add_rotation_capability$0$anon0_correct))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct  (=> (not inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0) (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2 ($Mutation_143161 (|l#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1) (|p#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1) |inline$$1_DiemAccount_extract_key_rotation_capability$0$$temp_0'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''@1|)) (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2))) (=> (and (and (|$IsValid'$1_Option_Option'$1_DiemAccount_KeyRotationCapability''| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2)) (<= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2))) 1)) (and (|$IsValid'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0 (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1)) 0)))) (=> (and (and (and (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2))) 0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3 ($Mutation_143116 (|l#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2) (|p#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2) ($1_DiemAccount_DiemAccount (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)) (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@2) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)))))) (and (= $1_DiemAccount_DiemAccount_$memory@0 ($Memory_138898 (|Store__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3)) (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@3)))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0))) (and (and (= $abort_code@4 $abort_code@3) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t19@0)) (and (= $abort_flag@3 $abort_flag@2) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory@0)))) (and (=> (= (ControlFlow 0 218933) 220791) anon6_Then_correct) (=> (= (ControlFlow 0 218933) 220451) anon6_Else_correct))))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct  (=> (and (and (= $abort_code@4 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$ret0@0)) (and (= $abort_flag@3 true) (= $1_DiemAccount_DiemAccount_$memory@1 $1_DiemAccount_DiemAccount_$memory))) (and (=> (= (ControlFlow 0 218610) 220791) anon6_Then_correct) (=> (= (ControlFlow 0 218610) 220451) anon6_Else_correct)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct  (=> inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0 (=> (and (and (and (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1))) 0) (= 7 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@0) (= (ControlFlow 0 218959) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct))))
...
(Vec_22899 (|Store__T@[Int]Int_| (|v#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2)) l@@1 2) (+ l@@1 1))) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2))))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t20@1 (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1)) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t21@0 (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|v#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@1))) 0)))) (and (=> (= (ControlFlow 0 218841) 218959) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Then_correct) (=> (= (ControlFlow 0 218841) 218933) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon25_Else_correct))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 $abort_code@3) (= (ControlFlow 0 218973) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0) (=> (and (= $abort_flag@2 true) (= $abort_code@3 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 219025) 218973) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct) (=> (= (ControlFlow 0 219025) 218841) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0)) (= (ControlFlow 0 219023) 219025)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then$1_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (=> (and (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1 ($Mutation_143116 ($Global inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (Vec_22899 (MapConstVec_14643 DefaultVecElem_14643) 0) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0))) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@2 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@1)) (and (= $abort_flag@2 $abort_flag@1) (= $abort_code@3 $abort_code@2))) (and (=> (= (ControlFlow 0 218795) 218973) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Then_correct) (=> (= (ControlFlow 0 218795) 218841) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon24_Else_correct))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct  (=> inline$$1_DiemAccount_exists_at$1$$t1@1 (and (=> (= (ControlFlow 0 218773) 219023) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Then_correct) (=> (= (ControlFlow 0 218773) 218795) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon23_Else_correct)))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$1$$t1@1) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0) (= (ControlFlow 0 218769) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct  (=> (and (not $abort_flag@1) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0 5)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t16@0) (= inline$$1_DiemAccount_exists_at$1$$t1@1 inline$$1_DiemAccount_exists_at$1$$t1@1))) (and (=> (= (ControlFlow 0 218753) 218773) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Then_correct) (=> (= (ControlFlow 0 218753) 218769) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon22_Else_correct))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 $abort_code@2) (= (ControlFlow 0 219039) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct)))
(let ((inline$$1_DiemAccount_exists_at$1$anon0_correct  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (=> (and (= inline$$1_DiemAccount_exists_at$1$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0)) (= inline$$1_DiemAccount_exists_at$1$$t1@1 inline$$1_DiemAccount_exists_at$1$$t1@1)) (and (=> (= (ControlFlow 0 218711) 219039) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Then_correct) (=> (= (ControlFlow 0 218711) 218753) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon21_Else_correct))))))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 218717) 218711)) inline$$1_DiemAccount_exists_at$1$anon0_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0) (= (ControlFlow 0 218604) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct  (=> (|$IsValid'u64'| 9) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0 1)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t13@0) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 218588) 218717) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Then_correct) (=> (= (ControlFlow 0 218588) 218604) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon20_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1)) (= (ControlFlow 0 218548) 218588)) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else$1_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct  (=> (and (not $abort_flag@1) (= (ControlFlow 0 218554) 218548)) inline$$Not$0$anon0_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct  (=> (and (and $abort_flag@1 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t10@1 $abort_code@2) (= (ControlFlow 0 219053) 218610))) inline$$1_DiemAccount_extract_key_rotation_capability$0$L5_correct)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1 (|$key_rotation_capability#$1_DiemAccount_DiemAccount| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2)) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0 (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t8@1)) 0))) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0) (= $abort_code@2 $abort_code@1)) (and (= $abort_flag@1 $abort_flag@0) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t9@0))) (and (=> (= (ControlFlow 0 218424) 219053) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct) (=> (= (ControlFlow 0 218424) 218554) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct)))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct  (=> (= $abort_code@2 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1) (=> (and (= $abort_flag@1 true) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@1 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$ret0@0)) (and (=> (= (ControlFlow 0 218372) 219053) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Then_correct) (=> (= (ControlFlow 0 218372) 218554) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon19_Else_correct))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1 $abort_code@1) (= (ControlFlow 0 218438) 218372))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@0)) (and (=> (= (ControlFlow 0 218490) 218438) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct) (=> (= (ControlFlow 0 218490) 218424) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0)) (= (ControlFlow 0 218488) 218490)) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then$1_correct)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (=> (and (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@2 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t7@1))) (and (=> (= (ControlFlow 0 218390) 218438) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Then_correct) (=> (= (ControlFlow 0 218390) 218424) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon14_Else_correct))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct  (=> inline$$1_DiemAccount_exists_at$0$$t1@1 (and (=> (= (ControlFlow 0 218376) 218488) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Then_correct) (=> (= (ControlFlow 0 218376) 218390) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon13_Else_correct)))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t4@1 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0) (= (ControlFlow 0 218366) 218372))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$L3_correct)))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0) (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0 5)) (and (= inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0 inline$$1_DiemAccount_delegated_key_rotation_capability$0$$t6@0) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1))) (and (=> (= (ControlFlow 0 218350) 218376) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Then_correct) (=> (= (ControlFlow 0 218350) 218366) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon12_Else_correct))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct true))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct  (=> (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1 (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0)) (= inline$$1_DiemAccount_exists_at$0$$t1@1 inline$$1_DiemAccount_exists_at$0$$t1@1)) (and (=> (= (ControlFlow 0 218308) 218504) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Then_correct) (=> (= (ControlFlow 0 218308) 218350) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon11_Else_correct))))))
(let ((inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct  (=> (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (= (ControlFlow 0 218314) 218308)) inline$$1_DiemAccount_exists_at$0$anon0_correct)))
(let ((inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct  (=> (= (|l#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t5@0)) 0) (=> (and (and (and (= (|l#Vec_22899| (|p#$Mutation_143116| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t17@0)) 0) (= (|l#Vec_22899| (|p#$Mutation_143161| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t18@0)) 0)) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t7@0 (|$addr#$signer| _$t0)) (= _$t0 _$t0))) (and (and (|$IsValid'address'| inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0 (|$addr#$signer| _$t0))) (and (= inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0 inline$$1_DiemAccount_extract_key_rotation_capability$0$$t8@0) (= (ControlFlow 0 218510) 218314)))) inline$$1_DiemAccount_delegated_key_rotation_capability$0$anon0_correct))))
(let ((anon0$1_correct  (=> (and (and (forall ((child_addr Int) ) (!  (=> (|$IsValid'address'| child_addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) child_addr) (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) (|$parent_vasp_addr#$1_VASP_ChildVASP| (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) child_addr)))))
 :qid |AccountAdministrationScriptsbpl.14147:20|
 :skolemid |362|
)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr) (or (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0) (and (not (= (|l#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)) (= addr (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr)))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.14151:20|
 :skolemid |363|
 ...
 :qid |AccountAdministrationScriptsbpl.14155:20|
 :skolemid |364|
 ...
 :qid |AccountAdministrationScriptsbpl.14159:20|
 :skolemid |365|
)))) (=> (and (and (and (forall ((addr@@2 Int) ) (!  (=> (|$IsValid'address'| addr@@2) (= (|Select__T@[Int]Bool_| (|domain#$Memory_140007| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@2)  (and (= addr@@2 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@2))))
 :qid |AccountAdministrationScriptsbpl.14163:20|
 :skolemid |366|
 ...
 :qid |AccountAdministrationScriptsbpl.14167:20|
 :skolemid |367|
 ...
 :qid |AccountAdministrationScriptsbpl.14171:20|
 :skolemid |368|
 ...
 :qid |AccountAdministrationScriptsbpl.14175:20|
 :skolemid |369|
)))) (and (and (forall ((addr@@6 Int) ) (!  (=> (|$IsValid'address'| addr@@6) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) addr@@6)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@6)) 5))))
 :qid |AccountAdministrationScriptsbpl.14179:20|
 :skolemid |370|
)) (forall ((addr@@7 Int) ) (!  (=> (|$IsValid'address'| addr@@7) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) addr@@7)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_113898| $1_Roles_RoleId_$memory) addr@@7)) 6))))
 :qid |AccountAdministrationScriptsbpl.14183:20|
 :skolemid |371|
))) (and (forall ((addr@@8 Int) ) (!  (=> (|$IsValid'address'| addr@@8) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@8) (and (> (|l#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@8))) 0) (= (|$account_address#$1_DiemAccount_KeyRotationCapability| (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$rotation_caps#$1_RecoveryAddress_RecoveryAddress| (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@8))) 0)) addr@@8))))
 :qid |AccountAdministrationScriptsbpl.14187:20|
 :skolemid |372|
)) (forall ((addr@@9 Int) ) (!  (=> (|$IsValid'address'| addr@@9) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) addr@@9) (or (|Select__T@[Int]Bool_| (|domain#$Memory_128026| $1_VASP_ParentVASP_$memory) addr@@9) (|Select__T@[Int]Bool_| (|domain#$Memory_127962| $1_VASP_ChildVASP_$memory) addr@@9))))
 :qid |AccountAdministrationScriptsbpl.14191:20|
 :skolemid |373|
))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (and (|$IsValid'address'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $a_0)))
(|$IsValid'$1_VASP_ChildVASP'| $rsc))
 :qid |AccountAdministrationScriptsbpl.14200:20|
 :skolemid |374|
 :pattern ( (|Select__T@[Int]$1_VASP_ChildVASP_| (|contents#$Memory_127962| $1_VASP_ChildVASP_$memory) $a_0))
)))) (and (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128026| $1_VASP_ParentVASP_$memory) $a_0@@0)))
(|$IsValid'$1_VASP_ParentVASP'| $rsc@@0))
 :qid |AccountAdministrationScriptsbpl.14204:20|
 :skolemid |375|
 :pattern ( (|Select__T@[Int]$1_VASP_ParentVASP_| (|contents#$Memory_128026| $1_VASP_ParentVASP_$memory) $a_0@@0))
)) (forall (($a_0@@1 Int) ) (! (let (($rsc@@1 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $a_0@@1)))
 ...
 :qid |AccountAdministrationScriptsbpl.14208:20|
 :skolemid |376|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $a_0@@1))
))) (and (forall (($a_0@@2 Int) ) (! (let (($rsc@@2 (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@2)))
(|$IsValid'$1_RecoveryAddress_RecoveryAddress'| $rsc@@2))
 :qid |AccountAdministrationScriptsbpl.14212:20|
 :skolemid |377|
 :pattern ( (|Select__T@[Int]$1_RecoveryAddress_RecoveryAddress_| (|contents#$Memory_147611| $1_RecoveryAddress_RecoveryAddress_$memory) $a_0@@2))
)) (= $t2 (|$addr#$signer| _$t0))))) (and (and (and (= $t3 (|Select__T@[Int]$1_DiemAccount_KeyRotationCapability_| (|v#Vec_74151| (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) $t2)))) 0)) (= $t4 (|$addr#$signer| _$t0))) (and (= $t5 (|$account_address#$1_DiemAccount_KeyRotationCapability| $t3)) (let ((addr@@10 (|$addr#$signer| _$t0)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_113710| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_138898| $1_DiemAccount_DiemAccount_$memory) addr@@10)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@10) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_138386| $1_AccountFreezing_FreezingBit_$memory) addr@@10)))))))) (and (and (= _$t0 _$t0) (= _$t1 _$t1)) (and (= $t6 (|$addr#$signer| _$t0)) (= (ControlFlow 0 219059) 218510))))) inline$$1_DiemAccount_extract_key_rotation_capability$0$anon0_correct)))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_74026_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |AccountAdministrationScriptsbpl.2949:13|
 :skolemid |105|
))) (= (ControlFlow 0 216651) 219059)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 290708) 216651) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
