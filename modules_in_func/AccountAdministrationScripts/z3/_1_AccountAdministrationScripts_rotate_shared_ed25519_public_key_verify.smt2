...
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@1@@0 () T@$Memory_134515)
(declare-fun $t3@@5 () Int)
(declare-fun $abort_code@5@@10 () Int)
(declare-fun $abort_flag@3@@11 () Bool)
(declare-fun $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@0@@0 () T@$Memory_134515)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0 () T@$Mutation_134686)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@1@@0 () T@$Mutation_92207)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2 () T@$Mutation_134686)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@2@@0 () T@$Mutation_92207)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t0@1@@0 () T@$Mutation_134686)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@0@@0 () T@$Mutation_134686)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t5@1@@0 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4 () Bool)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@4 () T@$Mutation_92207)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@4 () T@$Mutation_92207)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0 () (Seq Int))
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@4 () T@$Mutation_131921)
(declare-fun $1_DiemAccount_DiemAccount_$memory@0@@6 () T@$Memory_127894)
(declare-fun $abort_flag@1@@12 () Bool)
(declare-fun $abort_code@2@@12 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4 () Int)
(declare-fun |inline$$1_Vector_length'u8'$0$l@1@@4| () Int)
(declare-fun |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| () T@$1_DiemAccount_DiemAccount)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@4 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@4 () T@$Mutation_131921)
(declare-fun $abort_code@1@@12 () Int)
(declare-fun $abort_flag@0@@12 () Bool)
(declare-fun inline$$1_DiemAccount_exists_at$0$$t1@1@@9 () Bool)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0 () T@$1_DiemAccount_KeyRotationCapability)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@4 () Int)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@4 () T@$Mutation_131921)
(declare-fun inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@4 () T@$Mutation_92207)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@0@@0 () T@$Mutation_92207)
...
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@0 () T@$Mutation_134686)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0 () Int)
(declare-fun inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@1 () T@$Mutation_134686)
...
(assert (not
 (=> (= (ControlFlow 0 0) 297306) (let ((anon4_Else_correct@@5  (=> (not $abort_flag@4@@10) (and (=> (= (ControlFlow 0 247886) (- 0 299214)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3))) (and (=> (= (ControlFlow 0 247886) (- 0 299226)) (not (not ($1_Signature_$ed25519_validate_pubkey _$t1@@7)))) (=> (not (not ($1_Signature_$ed25519_validate_pubkey _$t1@@7))) (and (=> (= (ControlFlow 0 247886) (- 0 299236)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3))))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)))))) (and (=> (= (ControlFlow 0 247886) (- 0 299255)) (not (not (= (seq.len ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) 32)))) (=> (not (not (= (seq.len ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) 32))) (=> (= (ControlFlow 0 247886) (- 0 299271)) (= (|$key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@1@@0) $t3@@5)) _$t1@@7)))))))))))))
(let ((anon4_Then_correct@@5  (=> (and $abort_flag@4@@10 (= $abort_code@5@@10 $abort_code@5@@10)) (and (=> (= (ControlFlow 0 248050) (- 0 299072)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)) (not ($1_Signature_$ed25519_validate_pubkey _$t1@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)))))) (not (= (seq.len ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) 32)))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)) (not ($1_Signature_$ed25519_validate_pubkey _$t1@@7))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)))))) (not (= (seq.len ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) 32))) (=> (= (ControlFlow 0 248050) (- 0 299115)) (or (or (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3)) (= 5 $abort_code@5@@10)) (and (not ($1_Signature_$ed25519_validate_pubkey _$t1@@7)) (= 7 $abort_code@5@@10))) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|$account_address#$1_DiemAccount_KeyRotationCapability| (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $t2@@3))))) (= 5 $abort_code@5@@10))) (and (not (= (seq.len ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) 32)) (= 7 $abort_code@5@@10))) (= 5 $abort_code@5@@10)) (= 7 $abort_code@5@@10))))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Else_correct  (=> (not $abort_flag@3@@11) (=> (and (and (= $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@0@@0 ($Memory_134515 (|Store__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) (|a#$Global| (|l#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0)) true) (|Store__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) (|a#$Global| (|l#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0)) (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0)))) (= $abort_flag@4@@10 $abort_flag@3@@11)) (and (= $abort_code@5@@10 $abort_code@4@@11) (= $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@1@@0 $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@0@@0))) (and (=> (= (ControlFlow 0 247706) 248050) anon4_Then_correct@@5) (=> (= (ControlFlow 0 247706) 247886) anon4_Else_correct@@5))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$L3_correct  (=> (= $abort_flag@4@@10 true) (=> (and (= $abort_code@5@@10 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t9@1) (= $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory@1@@0 $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory)) (and (=> (= (ControlFlow 0 246031) 248050) anon4_Then_correct@@5) (=> (= (ControlFlow 0 246031) 247886) anon4_Else_correct@@5))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Then_correct  (=> (and (and $abort_flag@3@@11 (= $abort_code@4@@11 $abort_code@4@@11)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t9@1 $abort_code@4@@11) (= (ControlFlow 0 247720) 246031))) inline$$1_SharedEd25519PublicKey_rotate_key$0$L3_correct)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Else_correct@@0  (=> (not $abort_flag@2@@11) (=> (and (and (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@1@@0 ($Mutation_92207 (|l#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2) (seq.++ (|p#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2) (seq.unit 0)) (|$key#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2)))) (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@2@@0 ($Mutation_92207 (|l#$Mutation_92207| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@1@@0) (|p#$Mutation_92207| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@1@@0) _$t1@@7))) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t0@1@@0 ($Mutation_134686 (|l#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2) (|p#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2) ($1_SharedEd25519PublicKey_SharedEd25519PublicKey (|v#$Mutation_92207| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@2@@0) (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2))))) (= |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@2@@0| (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t0@1@@0)))) (and (and (= |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@2@@0| |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@2@@0|) (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t0@1@@0)) (and (= $abort_flag@3@@11 $abort_flag@2@@11) (= $abort_code@4@@11 $abort_code@3@@11)))) (and (=> (= (ControlFlow 0 247650) 247720) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Then_correct) (=> (= (ControlFlow 0 247650) 247706) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$L3_correct@@0  (=> (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@1@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$ret0@0@@0) (=> (and (= $abort_flag@3@@11 true) (= $abort_code@4@@11 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t5@1@@0)) (and (=> (= (ControlFlow 0 246548) 247720) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Then_correct) (=> (= (ControlFlow 0 246548) 247706) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon17_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Then_correct@@0  (=> (and (and $abort_flag@2@@11 (= $abort_code@3@@11 $abort_code@3@@11)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t5@1@@0 $abort_code@3@@11) (= (ControlFlow 0 247664) 246548))) inline$$1_SharedEd25519PublicKey_rotate_key_$0$L3_correct@@0)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@4  (=> inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4 (=> (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@4 ($Mutation_92207 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4) (seq.++ (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4) (seq.unit 0)) (|$authentication_key#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4)))) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@4 ($Mutation_92207 (|l#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@4) (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@1@@4) inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0))) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@4 ($Mutation_131921 (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4) (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4) ($1_DiemAccount_DiemAccount (|v#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@2@@4) (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4)) (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4)) (|$received_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4)) (|$sent_events#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4)) (|$sequence_number#$1_DiemAccount_DiemAccount| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4))))) (= $1_DiemAccount_DiemAccount_$memory@0@@6 ($Memory_127894 (|Store__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@4)) true) (|Store__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) (|a#$Global| (|l#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@4)) (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@3@@4))))) (and (= $abort_flag@2@@11 $abort_flag@1@@12) (= $abort_code@3@@11 $abort_code@2@@12))) (and (=> (= (ControlFlow 0 247496) 247664) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Then_correct@@0) (=> (= (ControlFlow 0 247496) 247650) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Else_correct@@0)))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4  (=> (and (= $abort_flag@2@@11 true) (= $abort_code@3@@11 inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4)) (and (=> (= (ControlFlow 0 247292) 247664) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Then_correct@@0) (=> (= (ControlFlow 0 247292) 247650) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon10_Else_correct@@0)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4) (= (ControlFlow 0 247446) 247292))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@4  (=> (and (and (and (not $abort_flag@1@@12) (|$IsValid'u64'| 32)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4 (= |inline$$1_Vector_length'u8'$0$l@1@@4| 32)) (|$IsValid'u64'| 8))) (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4 7)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t18@0@@4) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t16@1@@4)))) (and (=> (= (ControlFlow 0 247430) 247496) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Then_correct@@4) (=> (= (ControlFlow 0 247430) 247446) inline$$1_DiemAccount_rotate_authentication_key$0$anon21_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@4  (=> (and (and $abort_flag@1@@12 (= $abort_code@2@@12 $abort_code@2@@12)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 $abort_code@2@@12) (= (ControlFlow 0 247510) 247292))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4)))
(let ((|inline$$1_Vector_length'u8'$0$anon0_correct@@4|  (=> (= |inline$$1_Vector_length'u8'$0$l@1@@4| (seq.len inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0)) (and (=> (= (ControlFlow 0 247372) 247510) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Then_correct@@4) (=> (= (ControlFlow 0 247372) 247430) inline$$1_DiemAccount_rotate_authentication_key$0$anon20_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@4  (=> (and (and (not $abort_flag@1@@12) (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| (|v#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4))) (and (= |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4| |inline$$1_DiemAccount_rotate_authentication_key$0$$temp_0'$1_DiemAccount_DiemAccount'@1@@4|) (= (ControlFlow 0 247378) 247372))) |inline$$1_Vector_length'u8'$0$anon0_correct@@4|)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@4  (=> (and (and $abort_flag@1@@12 (= $abort_code@2@@12 $abort_code@2@@12)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 $abort_code@2@@12) (= (ControlFlow 0 247524) 247292))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@4  (=> (= $abort_code@2@@12 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1@@12 true) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@4)) (and (=> (= (ControlFlow 0 247576) 247524) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 247576) 247378) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@4  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4)) (= (ControlFlow 0 247574) 247576)) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then$1_correct@@4)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@4  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4) (=> (and (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@4 ($Mutation_131921 ($Global inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4))) (= $abort_code@2@@12 $abort_code@1@@12)) (and (= $abort_flag@1@@12 $abort_flag@0@@12) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t13@2@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t13@1@@4))) (and (=> (= (ControlFlow 0 247322) 247524) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Then_correct@@4) (=> (= (ControlFlow 0 247322) 247378) inline$$1_DiemAccount_rotate_authentication_key$0$anon19_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@4  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1@@9 (= inline$$1_DiemAccount_rotate_authentication_key$0$$t12@1@@4 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0))) (and (=> (= (ControlFlow 0 247300) 247574) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Then_correct@@4) (=> (= (ControlFlow 0 247300) 247322) inline$$1_DiemAccount_rotate_authentication_key$0$anon18_Else_correct@@4)))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@4  (=> (and (and (not inline$$1_DiemAccount_exists_at$0$$t1@1@@9) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4) (= (ControlFlow 0 247286) 247292))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@4  (=> (and (not $abort_flag@0@@12) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4) (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4 5)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t11@0@@4) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@9 inline$$1_DiemAccount_exists_at$0$$t1@1@@9))) (and (=> (= (ControlFlow 0 247270) 247300) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Then_correct@@4) (=> (= (ControlFlow 0 247270) 247286) inline$$1_DiemAccount_rotate_authentication_key$0$anon17_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@4  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t9@1@@4 $abort_code@1@@12) (= (ControlFlow 0 247590) 247292))) inline$$1_DiemAccount_rotate_authentication_key$0$L5_correct@@4)))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@9  (=> (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@4 inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@4) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@9 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@4)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@9 inline$$1_DiemAccount_exists_at$0$$t1@1@@9)) (and (=> (= (ControlFlow 0 247228) 247590) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Then_correct@@4) (=> (= (ControlFlow 0 247228) 247270) inline$$1_DiemAccount_rotate_authentication_key$0$anon16_Else_correct@@4))))))
(let ((inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@4  (=> (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t6@0@@4)) 0) (=> (and (= (seq.len (|p#$Mutation_131921| inline$$1_DiemAccount_rotate_authentication_key$0$$t13@0@@4)) 0) (= (seq.len (|p#$Mutation_92207| inline$$1_DiemAccount_rotate_authentication_key$0$$t19@0@@4)) 0)) (=> (and (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0) (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0)) (and (= inline$$1_DiemAccount_rotate_authentication_key$0$$t7@1@@4 (|$account_address#$1_DiemAccount_KeyRotationCapability| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0)) (= (ControlFlow 0 247234) 247228))) inline$$1_DiemAccount_exists_at$0$anon0_correct@@9)))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon9_Then_correct@@0  (=> inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@1 (=> (and (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t8@1@@0 (|$rotation_cap#$1_SharedEd25519PublicKey_SharedEd25519PublicKey| (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2))) (|$IsValid'vec'u8''| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t9@0@@0 ($1_Authenticator_spec_ed25519_authentication_key _$t1@@7)) (= (ControlFlow 0 247594) 247234))) inline$$1_DiemAccount_rotate_authentication_key$0$anon0_correct@@4))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon9_Else_correct@@0  (=> (and (and (not inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@1) (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t5@1@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0) (= (ControlFlow 0 246542) 246548))) inline$$1_SharedEd25519PublicKey_rotate_key_$0$L3_correct@@0)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon8_Else_correct@@0  (=> (and (not $abort_flag@0@@12) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0) (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0 7)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0 inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t7@0@@0) (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@1 inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@1))) (and (=> (= (ControlFlow 0 246526) 247594) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon9_Then_correct@@0) (=> (= (ControlFlow 0 246526) 246542) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon9_Else_correct@@0))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon8_Then_correct@@0  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t5@1@@0 $abort_code@1@@12) (= (ControlFlow 0 247678) 246548))) inline$$1_SharedEd25519PublicKey_rotate_key_$0$L3_correct@@0)))
(let ((inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct@@1  (=> (= inline$$1_Signature_ed25519_validate_pubkey$0$res@1@@1 ($1_Signature_$ed25519_validate_pubkey _$t1@@7)) (and (=> (= (ControlFlow 0 246480) 247678) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon8_Then_correct@@0) (=> (= (ControlFlow 0 246480) 246526) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon8_Else_correct@@0)))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon0_correct@@0  (=> (= (seq.len (|p#$Mutation_92207| inline$$1_SharedEd25519PublicKey_rotate_key_$0$$t10@0@@0)) 0) (=> (and (and (= |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@1@@0| (|v#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2)) (= |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@1@@0| |inline$$1_SharedEd25519PublicKey_rotate_key_$0$$temp_0'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'@1@@0|)) (and (= _$t1@@7 _$t1@@7) (= (ControlFlow 0 246486) 246480))) inline$$1_Signature_ed25519_validate_pubkey$0$anon0_correct@@1))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Else_correct  (=> (and (not $abort_flag@0@@12) (= (ControlFlow 0 247684) 246486)) inline$$1_SharedEd25519PublicKey_rotate_key_$0$anon0_correct@@0)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Then_correct  (=> (and (and $abort_flag@0@@12 (= $abort_code@1@@12 $abort_code@1@@12)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t9@1 $abort_code@1@@12) (= (ControlFlow 0 247734) 246031))) inline$$1_SharedEd25519PublicKey_rotate_key$0$L3_correct)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Then$1_correct  (=> (= $abort_flag@0@@12 true) (=> (and (= $abort_code@1@@12 $EXEC_FAILURE_CODE) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@0)) (and (=> (= (ControlFlow 0 247786) 247734) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Then_correct) (=> (= (ControlFlow 0 247786) 247684) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0)) (= (ControlFlow 0 247784) 247786)) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Then$1_correct)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0) (=> (and (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@1 ($Mutation_134686 ($Global inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0) (as seq.empty (Seq Int)) (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0))) (= $abort_flag@0@@12 false)) (and (= $abort_code@1@@12 $abort_code@0@@12) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@2 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@1))) (and (=> (= (ControlFlow 0 246057) 247734) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Then_correct) (=> (= (ControlFlow 0 246057) 247684) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon16_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon14_Then_correct  (=> inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0 (and (=> (= (ControlFlow 0 246035) 247784) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Then_correct) (=> (= (ControlFlow 0 246035) 246057) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon15_Else_correct)))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon14_Else_correct  (=> (and (and (not inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t9@1 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0) (= (ControlFlow 0 246025) 246031))) inline$$1_SharedEd25519PublicKey_rotate_key$0$L3_correct)))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon13_Else_correct  (=> (and (not false) (|$IsValid'u64'| 1)) (=> (and (and (|$IsValid'u64'| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0 5)) (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t11@0) (= inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0 inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0))) (and (=> (= (ControlFlow 0 246009) 246035) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon14_Then_correct) (=> (= (ControlFlow 0 246009) 246025) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon14_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon13_Then_correct true))
(let ((inline$$1_SharedEd25519PublicKey_exists_at$0$anon0_correct@@0  (=> (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0) (=> (and (= inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0 (|Select__T@[Int]Bool_| (|domain#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0)) (= inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0 inline$$1_SharedEd25519PublicKey_exists_at$0$$t1@1@@0)) (and (=> (= (ControlFlow 0 245967) 247800) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon13_Then_correct) (=> (= (ControlFlow 0 245967) 246009) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon13_Else_correct))))))
(let ((inline$$1_SharedEd25519PublicKey_rotate_key$0$anon0_correct  (=> (= (seq.len (|p#$Mutation_134686| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t12@0)) 0) (=> (and (and (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t5@0 (|$addr#$signer| _$t0@@12)) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t6@0 (|$addr#$signer| _$t0@@12))) (and (= _$t0@@12 _$t0@@12) (= _$t1@@7 _$t1@@7))) (and (and (|$IsValid'address'| inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0) (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0 (|$addr#$signer| _$t0@@12))) (and (= inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0 inline$$1_SharedEd25519PublicKey_rotate_key$0$$t7@0) (= (ControlFlow 0 245973) 245967)))) inline$$1_SharedEd25519PublicKey_exists_at$0$anon0_correct@@0))))
(let ((anon0$1_correct@@12  (=> (forall ((addr@@307 Int) ) (!  (=> (|$IsValid'address'| addr@@307) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@307) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@307)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@307)))) 0)) (= addr@@307 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@307))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.16091:20|
 :skolemid |456|
)) (=> (and (forall ((addr@@308 Int) ) (!  (=> (|$IsValid'address'| addr@@308) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@308) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@308) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@308)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@308)))) 0)) (= addr@@308 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@308))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.16095:20|
 :skolemid |457|
)) (forall ((addr@@309 Int) ) (!  (=> (|$IsValid'address'| addr@@309) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@309) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@309)))
 :qid |AccountAdministrationScriptsbpl.16099:20|
 :skolemid |458|
))) (=> (and (and (forall ((addr@@310 Int) ) (!  (=> (|$IsValid'address'| addr@@310) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@310)  (and (= addr@@310 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@310))))
 :qid |AccountAdministrationScriptsbpl.16103:20|
 :skolemid |459|
)) (forall ((addr@@311 Int) ) (!  (=> (|$IsValid'address'| addr@@311) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@311)  (and (= addr@@311 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@311))))
 :qid |AccountAdministrationScriptsbpl.16107:20|
 :skolemid |460|
))) (and (forall ((addr@@312 Int) ) (!  (=> (|$IsValid'address'| addr@@312) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@312) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@312)))
 :qid |AccountAdministrationScriptsbpl.16111:20|
 :skolemid |461|
)) (forall ((addr@@313 Int) ) (!  (=> (|$IsValid'address'| addr@@313) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@313) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@313)))
 :qid |AccountAdministrationScriptsbpl.16115:20|
 :skolemid |462|
)))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@12)) ($1_Signer_is_txn_signer _$t0@@12)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@12))) (|$IsValid'vec'u8''| _$t1@@7)) (and (forall (($a_0@@34 Int) ) (! (let (($rsc@@34 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@34)))
 ...
 :qid |AccountAdministrationScriptsbpl.16124:20|
 :skolemid |463|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@34))
)) (forall (($a_0@@35 Int) ) (! (let (($rsc@@35 (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $a_0@@35)))
(|$IsValid'$1_SharedEd25519PublicKey_SharedEd25519PublicKey'| $rsc@@35))
 :qid |AccountAdministrationScriptsbpl.16128:20|
 :skolemid |464|
 :pattern ( (|Select__T@[Int]$1_SharedEd25519PublicKey_SharedEd25519PublicKey_| (|contents#$Memory_134515| $1_SharedEd25519PublicKey_SharedEd25519PublicKey_$memory) $a_0@@35))
)))) (and (and (and (= $t2@@3 (|$addr#$signer| _$t0@@12)) (= $t3@@5 (|$addr#$signer| _$t0@@12))) (and (let ((addr@@314 (|$addr#$signer| _$t0@@12)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@314)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@314) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@314)))))) (= _$t0@@12 _$t0@@12))) (and (and (= _$t1@@7 _$t1@@7) (= $t4@@7 (|$addr#$signer| _$t0@@12))) (and (= $t5@@6 (|$addr#$signer| _$t0@@12)) (= (ControlFlow 0 247804) 245973))))) inline$$1_SharedEd25519PublicKey_rotate_key$0$anon0_correct))))))
(let ((inline$$InitEventStore$0$anon0_correct@@12  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@19 T@$1_Event_EventHandle) ) (! (let ((stream@@23 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@19)))
 (and (= (|l#Multiset_72203| stream@@23) 0) (forall ((v@@59 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@23) v@@59) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 245037) 247804)) anon0$1_correct@@12)))
(let ((anon0_correct@@12  (=> (= (ControlFlow 0 297306) 245037) inline$$InitEventStore$0$anon0_correct@@12)))
anon0_correct@@12))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
