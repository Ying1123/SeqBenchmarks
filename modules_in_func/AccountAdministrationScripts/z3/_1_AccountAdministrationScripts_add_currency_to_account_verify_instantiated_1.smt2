...
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@3| () T@$Memory_129164)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory| () T@$Memory_129164)
(declare-fun _$t0@@0 () T@$signer)
(declare-fun |$1_Diem_CurrencyInfo'#0'_$memory| () T@$Memory_109594)
...
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@1| () T@$Memory_129164)
(declare-fun |inline$$1_DiemAccount_add_currency'#0'$0$$t11@1| () Int)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@2| () T@$Memory_129164)
(declare-fun |$1_DiemAccount_Balance'#0'_$memory@0| () T@$Memory_129164)
...
(declare-fun $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory () T@$Memory_105967)
(declare-fun $1_ValidatorConfig_ValidatorConfig_$memory () T@$Memory_106820)
(declare-fun |Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|T@[Int]$1_ValidatorConfig_ValidatorConfig| Int) T@$1_ValidatorConfig_ValidatorConfig)
(declare-fun |Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| Int) |T@$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'|)
(declare-fun |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory| () T@$Memory_107807)
(declare-fun |Select__T@[Int]$1_Diem_CurrencyInfo'#0'_| (|T@[Int]$1_Diem_CurrencyInfo'#0'| Int) |T@$1_Diem_CurrencyInfo'#0'|)
(declare-fun |$1_Diem_MintCapability'#0'_$memory| () T@$Memory_109886)
(declare-fun |$1_Diem_Preburn'#0'_$memory| () T@$Memory_115241)
(declare-fun $1_DualAttestation_Credential_$memory () T@$Memory_118096)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory () T@$Memory_116914)
(declare-fun $1_VASPDomain_VASPDomains_$memory () T@$Memory_116617)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory| () T@$Memory_128982)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory| () T@$Memory_129073)
(declare-fun $1_DesignatedDealer_Dealer_$memory () T@$Memory_120910)
(declare-fun $1_SlidingNonce_SlidingNonce_$memory () T@$Memory_107357)
(declare-fun $1_VASP_ParentVASP_$memory () T@$Memory_117561)
(declare-fun $1_VASP_ChildVASP_$memory () T@$Memory_117497)
(declare-fun $t1 () Int)
; Valid
(declare-fun $abort_flag@17@@0 () Bool)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@3| () T@$Memory_128982)
(declare-fun _$t0@@1 () T@$signer)
(declare-fun |$1_Diem_CurrencyInfo'$1_XUS_XUS'_$memory| () T@$Memory_109356)
...
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@1| () T@$Memory_128982)
(declare-fun |inline$$1_DiemAccount_add_currency'$1_XUS_XUS'$0$$t11@1| () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@2| () T@$Memory_128982)
(declare-fun |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory@0| () T@$Memory_128982)
...
(declare-fun |$1_Diem_MintCapability'$1_XUS_XUS'_$memory| () T@$Memory_109758)
(declare-fun |$1_Diem_Preburn'$1_XUS_XUS'_$memory| () T@$Memory_115059)
(declare-fun $t1@@0 () Int)
; Valid
(declare-fun $abort_flag@17@@1 () Bool)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| () T@$Memory_129073)
(declare-fun _$t0@@2 () T@$signer)
(declare-fun |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory| () T@$Memory_109475)
...
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| () T@$Memory_129073)
(declare-fun |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| () Int)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| () T@$Memory_129073)
(declare-fun |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0| () T@$Memory_129073)
...
(declare-fun |$1_Diem_MintCapability'$1_XDX_XDX'_$memory| () T@$Memory_109822)
(declare-fun |$1_Diem_Preburn'$1_XDX_XDX'_$memory| () T@$Memory_115150)
(declare-fun $t1@@1 () Int)
(push 1)
(set-info :boogie-vc-id $1_AccountAdministrationScripts_add_currency_to_account$verify_instantiated_1)
(assert (not
 (=> (= (ControlFlow 0 0) 269175) (let ((anon4_Else_correct@@1  (=> (not $abort_flag@17@@1) (and (=> (= (ControlFlow 0 204128) (- 0 272862)) (forall ((addr@@141 Int) ) (!  (=> (|$IsValid'address'| addr@@141) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) addr@@141) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@141)))
 :qid |AccountAdministrationScriptsbpl.13981:15|
 :skolemid |335|
))) (=> (forall ((addr@@142 Int) ) (!  (=> (|$IsValid'address'| addr@@142) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) addr@@142) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@142)))
 :qid |AccountAdministrationScriptsbpl.13981:15|
 :skolemid |335|
)) (and (=> (= (ControlFlow 0 204128) (- 0 272890)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2))) (and (=> (= (ControlFlow 0 204128) (- 0 272901)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 204128) (- 0 272911)) (not (not (or (or (let ((addr@@143 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@143) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@143)) 5))) (let ((addr@@144 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@144) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@144)) 6)))) (let ((addr@@145 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@145) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@145)) 2))))))) (=> (not (not (or (or (let ((addr@@146 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@146) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@146)) 5))) (let ((addr@@147 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@147) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@147)) 6)))) (let ((addr@@148 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@148) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@148)) 2)))))) (and (=> (= (ControlFlow 0 204128) (- 0 272922)) (not (not (or (or (let ((addr@@149 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@149) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@149)) 5))) (let ((addr@@150 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@150) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@150)) 6)))) (let ((addr@@151 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@151) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@151)) 2))))))) (=> (not (not (or (or (let ((addr@@152 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@152) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@152)) 5))) (let ((addr@@153 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@153) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@153)) 6)))) (let ((addr@@154 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@154) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@154)) 2)))))) (and (=> (= (ControlFlow 0 204128) (- 0 272933)) (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2)) (=> (= (ControlFlow 0 204128) (- 0 272942)) (= (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3|) (|$addr#$signer| _$t0@@2)) (|$1_DiemAccount_Balance'$1_XDX_XDX'| (|$1_Diem_Diem'$1_XDX_XDX'| 0)))))))))))))))))))
(let ((anon4_Then_correct@@1  (=> (and $abort_flag@17@@1 (= $abort_code@15@@1 $abort_code@15@@1)) (and (=> (= (ControlFlow 0 204276) (- 0 272744)) (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (or (or (let ((addr@@155 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@155) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@155)) 5))) (let ((addr@@156 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@156) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@156)) 6)))) (let ((addr@@157 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@157) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@157)) 2)))))) (not (or (or (let ((addr@@158 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@158) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@158)) 5))) (let ((addr@@159 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@159) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@159)) 6)))) (let ((addr@@160 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@160) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@160)) 2))))))) (=> (or (or (or (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (not (or (or (let ((addr@@161 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@161) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@161)) 5))) (let ((addr@@162 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@162) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@162)) 6)))) (let ((addr@@163 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@163) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@163)) 2)))))) (not (or (or (let ((addr@@164 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@164) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@164)) 5))) (let ((addr@@165 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@165) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@165)) 6)))) (let ((addr@@166 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@166) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@166)) 2)))))) (=> (= (ControlFlow 0 204276) (- 0 272773)) (or (or (or (or (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (= 6 $abort_code@15@@1)) (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 $abort_code@15@@1))) (and (not (or (or (let ((addr@@167 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@167) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@167)) 5))) (let ((addr@@168 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@168) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@168)) 6)))) (let ((addr@@169 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@169) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@169)) 2))))) (= 7 $abort_code@15@@1))) (and (not (or (or (let ((addr@@170 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@170) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@170)) 5))) (let ((addr@@171 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@171) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@171)) 6)))) (let ((addr@@172 (|$addr#$signer| _$t0@@2)))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@172) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@172)) 2))))) (= 7 $abort_code@15@@1))) (= 5 $abort_code@15@@1)) (= 7 $abort_code@15@@1)) (= 6 $abort_code@15@@1))))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|  (=> (and (and (not $abort_flag@16@@1) (= $abort_code@15@@1 $abort_code@14@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1|) (= $abort_flag@17@@1 $abort_flag@16@@1))) (and (=> (= (ControlFlow 0 203881) 204276) anon4_Then_correct@@1) (=> (= (ControlFlow 0 203881) 204128) anon4_Else_correct@@1)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|  (=> (= $abort_code@15@@1 |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1|) (=> (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@3| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2|) (= $abort_flag@17@@1 true)) (and (=> (= (ControlFlow 0 200962) 204276) anon4_Then_correct@@1) (=> (= (ControlFlow 0 200962) 204128) anon4_Else_correct@@1))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|  (=> $abort_flag@16@@1 (=> (and (and (= $abort_code@14@@1 $abort_code@14@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| $abort_code@14@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1|) (= (ControlFlow 0 203895) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then$1_correct|  (=> (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (=> (and (= $abort_code@14@@1 $EXEC_FAILURE_CODE) (= $abort_flag@16@@1 true)) (and (=> (= (ControlFlow 0 203947) 203895) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 203947) 203881) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2)) (= (ControlFlow 0 203945) 203947)) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Else_correct|  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2))) (=> (and (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0| ($Memory_129073 (|Store__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2) true) (|Store__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (|$addr#$signer| _$t0@@2) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t23@1|))) (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@1| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@0|)) (and (= $abort_code@14@@1 $abort_code@13@@1) (= $abort_flag@16@@1 $abort_flag@15@@1))) (and (=> (= (ControlFlow 0 203871) 203895) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Then_correct|) (=> (= (ControlFlow 0 203871) 203881) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon31_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|  (=> (and (not $abort_flag@15@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t23@1| (|$1_DiemAccount_Balance'$1_XDX_XDX'| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1|))) (and (=> (= (ControlFlow 0 203849) 203945) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Then_correct|) (=> (= (ControlFlow 0 203849) 203871) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon30_Else_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|  (=> $abort_flag@15@@1 (=> (and (and (= $abort_code@13@@1 $abort_code@13@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| $abort_code@13@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 203961) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Else_correct|  (=> (not |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0|) (=> (and (|$IsValid'u64'| 0) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1| (|$1_Diem_Diem'$1_XDX_XDX'| 0))) (=> (and (and (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1|) (= $abort_flag@15@@1 $abort_flag@14@@1)) (and (= $abort_code@13@@1 $abort_code@12@@1) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t3@1|))) (and (=> (= (ControlFlow 0 203801) 203961) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|) (=> (= (ControlFlow 0 203801) 203849) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Then_correct|  (=> |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|)) (=> (and (and (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|) (= $abort_flag@15@@1 true)) (and (= $abort_code@13@@1 |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t1@0|) (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@1| |inline$$1_Diem_zero'$1_XDX_XDX'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 203831) 203961) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Then_correct|) (=> (= (ControlFlow 0 203831) 203849) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon29_Else_correct|)))))))
(let ((|inline$$1_Diem_zero'$1_XDX_XDX'$0$anon0_correct|  (=> (= |inline$$1_Diem_zero'$1_XDX_XDX'$0$$t0@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))) (and (=> (= (ControlFlow 0 203773) 203831) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Then_correct|) (=> (= (ControlFlow 0 203773) 203801) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon3_Else_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Then_correct|  (=> (and inline$$Not$0$dst@1@@2 (= (ControlFlow 0 203837) 203773)) |inline$$1_Diem_zero'$1_XDX_XDX'$0$anon0_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Else_correct|  (=> (not inline$$Not$0$dst@1@@2) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 203620) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then$1_correct|  (=> (|$IsValid'u64'| 15) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0| 6)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t21@0|) (= inline$$Not$0$dst@1@@2 inline$$Not$0$dst@1@@2))) (and (=> (= (ControlFlow 0 203604) 203837) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Then_correct|) (=> (= (ControlFlow 0 203604) 203620) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon28_Else_correct|))))))
(let ((inline$$Not$0$anon0_correct@@2  (=> (and (= inline$$Not$0$dst@1@@2  (not |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t18@1|)) (= (ControlFlow 0 203564) 203604)) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then$1_correct|)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then_correct|  (=> inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 (=> (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t18@1| (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|)) (= (ControlFlow 0 203570) 203564)) inline$$Not$0$anon0_correct@@2))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Else_correct|  (=> (not inline$$1_Roles_can_hold_balance$0$$ret0@1@@1) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 203524) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|  (=> (and (not $abort_flag@14@@1) (|$IsValid'u64'| 4)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0| 7)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t17@0|) (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$ret0@1@@1))) (and (=> (= (ControlFlow 0 203508) 203570) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Then_correct|) (=> (= (ControlFlow 0 203508) 203524) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon27_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|  (=> $abort_flag@14@@1 (=> (and (and (= $abort_code@12@@1 $abort_code@12@@1) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| $abort_code@12@@1)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 203975) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((inline$$1_Roles_can_hold_balance$0$L9_correct@@1  (=> (= $abort_flag@14@@1 true) (=> (and (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$ret0@0@@1) (= $abort_code@12@@1 inline$$1_Roles_can_hold_balance$0$$t4@1@@1)) (and (=> (= (ControlFlow 0 203398) 203975) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 203398) 203508) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|))))))
(let ((inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1  (=> (and (and $abort_flag@12@@1 (= $abort_code@10@@1 $abort_code@10@@1)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@10@@1) (= (ControlFlow 0 203392) 203398))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1  (=> (and (and $abort_flag@7@@2 (= $abort_code@6@@2 $abort_code@6@@2)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@6@@2) (= (ControlFlow 0 203430) 203398))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1  (=> (and (and $abort_flag@3@@2 (= $abort_code@3@@2 $abort_code@3@@2)) (and (= inline$$1_Roles_can_hold_balance$0$$t4@1@@1 $abort_code@3@@2) (= (ControlFlow 0 203462) 203398))) inline$$1_Roles_can_hold_balance$0$L9_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$L7_correct@@1  (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 inline$$1_Roles_can_hold_balance$0$$t2@1@@1) (= $abort_flag@14@@1 $abort_flag@13@@1)) (and (= inline$$1_Roles_can_hold_balance$0$$ret0@1@@1 inline$$1_Roles_can_hold_balance$0$$t2@1@@1) (= $abort_code@12@@1 $abort_code@11@@1))) (and (=> (= (ControlFlow 0 203378) 203975) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Then_correct|) (=> (= (ControlFlow 0 203378) 203508) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon26_Else_correct|)))))
(let ((inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1  (=> (and (not $abort_flag@12@@1) (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1)) (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1) (= $abort_code@11@@1 $abort_code@10@@1)) (and (= $abort_flag@13@@1 $abort_flag@12@@1) (= (ControlFlow 0 203366) 203378))) inline$$1_Roles_can_hold_balance$0$L7_correct@@1))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@11@@1) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@1@@1)) (and (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@1@@1) (= $abort_flag@12@@1 $abort_flag@11@@1))) (and (=> (= (ControlFlow 0 203324) 203392) inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 203324) 203366) inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1)))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@11@@1 (= $abort_code@10@@1 $abort_code@10@@1)) (and (= inline$$1_Roles_has_designated_dealer_role$0$$ret0@1@@1 inline$$1_Roles_has_designated_dealer_role$0$$ret0@0@@1) (= $abort_flag@12@@1 true))) (and (=> (= (ControlFlow 0 203342) 203392) inline$$1_Roles_can_hold_balance$0$anon17_Then_correct@@1) (=> (= (ControlFlow 0 203342) 203366) inline$$1_Roles_can_hold_balance$0$anon17_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon11_Then_correct@@1  (=> $abort_flag@9@@1 (=> (and (and (= $abort_code@8@@2 $abort_code@8@@2) (= $abort_flag@11@@1 true)) (and (= $abort_code@10@@1 $abort_code@8@@2) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$ret0@0@@1))) (and (=> (= (ControlFlow 0 203248) 203342) inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 203248) 203324) inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$2$$t2@1@@1 inline$$1_Roles_has_role$2$$t2@1@@1) (= $abort_flag@11@@1 $abort_flag@10@@1)) (and (= $abort_code@10@@1 $abort_code@9@@1) (= inline$$1_Roles_has_role$2$$ret0@1@@1 inline$$1_Roles_has_role$2$$t2@1@@1))) (and (=> (= (ControlFlow 0 203184) 203342) inline$$1_Roles_has_designated_dealer_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 203184) 203324) inline$$1_Roles_has_designated_dealer_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@9@@1) (= inline$$1_Roles_has_role$2$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$2$$t6@2@@1))) (and (= inline$$1_Roles_has_role$2$$t9@1@@1 (= inline$$1_Roles_has_role$2$$t8@1@@1 2)) (= inline$$1_Roles_has_role$2$$t9@1@@1 inline$$1_Roles_has_role$2$$t9@1@@1))) (and (and (= $abort_flag@10@@1 $abort_flag@9@@1) (= inline$$1_Roles_has_role$2$$t2@1@@1 inline$$1_Roles_has_role$2$$t9@1@@1)) (and (= $abort_code@9@@1 $abort_code@8@@2) (= (ControlFlow 0 203230) 203184)))) inline$$1_Roles_has_role$2$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$2$anon10_Then$1_correct@@1  (=> (= $abort_code@8@@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@9@@1 true) (= inline$$1_Roles_has_role$2$$t6@2@@1 inline$$1_Roles_has_role$2$$t6@0@@1)) (and (=> (= (ControlFlow 0 203300) 203248) inline$$1_Roles_has_role$2$anon11_Then_correct@@1) (=> (= (ControlFlow 0 203300) 203230) inline$$1_Roles_has_role$2$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)) (= (ControlFlow 0 203298) 203300)) inline$$1_Roles_has_role$2$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$2$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$2$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)) (= $abort_code@8@@2 $abort_code@7@@2)) (and (= $abort_flag@9@@1 $abort_flag@8@@1) (= inline$$1_Roles_has_role$2$$t6@2@@1 inline$$1_Roles_has_role$2$$t6@1@@1))) (and (=> (= (ControlFlow 0 203202) 203248) inline$$1_Roles_has_role$2$anon11_Then_correct@@1) (=> (= (ControlFlow 0 203202) 203230) inline$$1_Roles_has_role$2$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$2$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$2$$t5@1@@1 (and (=> (= (ControlFlow 0 203188) 203298) inline$$1_Roles_has_role$2$anon10_Then_correct@@1) (=> (= (ControlFlow 0 203188) 203202) inline$$1_Roles_has_role$2$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$2$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$2$$t5@1@@1) (= false false)) (=> (and (and (= $abort_flag@10@@1 $abort_flag@8@@1) (= inline$$1_Roles_has_role$2$$t2@1@@1 false)) (and (= $abort_code@9@@1 $abort_code@7@@2) (= (ControlFlow 0 203172) 203184))) inline$$1_Roles_has_role$2$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$2$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 2 2)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$2$$t4@0@@1) (= inline$$1_Roles_has_role$2$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$2$$t4@0@@1 inline$$1_Roles_has_role$2$$t4@0@@1) (= inline$$1_Roles_has_role$2$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$2$$t4@0@@1)))) (and (=> (= (ControlFlow 0 203152) 203188) inline$$1_Roles_has_role$2$anon9_Then_correct@@1) (=> (= (ControlFlow 0 203152) 203172) inline$$1_Roles_has_role$2$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_designated_dealer_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 203306) 203152)) inline$$1_Roles_has_role$2$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1  (=> (and (not inline$$1_Roles_can_hold_balance$0$$t1@1@@1) (= (ControlFlow 0 203348) 203306)) inline$$1_Roles_has_designated_dealer_role$0$anon0_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1  (=> (and inline$$1_Roles_can_hold_balance$0$$t1@1@@1 (= true true)) (=> (and (and (= inline$$1_Roles_can_hold_balance$0$$t2@1@@1 true) (= $abort_code@11@@1 $abort_code@7@@2)) (and (= $abort_flag@13@@1 $abort_flag@8@@1) (= (ControlFlow 0 203416) 203378))) inline$$1_Roles_can_hold_balance$0$L7_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1  (=> (not $abort_flag@7@@2) (=> (and (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1) (= inline$$1_Roles_can_hold_balance$0$$t1@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1)) (and (= $abort_flag@8@@1 $abort_flag@7@@2) (= $abort_code@7@@2 $abort_code@6@@2))) (and (=> (= (ControlFlow 0 202666) 203416) inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 202666) 203348) inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1))))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@6@@2) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@1@@1)) (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@1@@1) (= $abort_flag@7@@2 $abort_flag@6@@2))) (and (=> (= (ControlFlow 0 202624) 203430) inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 202624) 202666) inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1)))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@6@@2 (= $abort_code@6@@2 $abort_code@6@@2)) (and (= inline$$1_Roles_has_child_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_child_VASP_role$0$$ret0@0@@1) (= $abort_flag@7@@2 true))) (and (=> (= (ControlFlow 0 202642) 203430) inline$$1_Roles_can_hold_balance$0$anon15_Then_correct@@1) (=> (= (ControlFlow 0 202642) 202666) inline$$1_Roles_can_hold_balance$0$anon15_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon11_Then_correct@@1  (=> $abort_flag@4@@2 (=> (and (and (= $abort_code@4@@2 $abort_code@4@@2) (= $abort_code@6@@2 $abort_code@4@@2)) (and (= $abort_flag@6@@2 true) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$ret0@0@@1))) (and (=> (= (ControlFlow 0 202548) 202642) inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 202548) 202624) inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$1$$t2@1@@1 inline$$1_Roles_has_role$1$$t2@1@@1) (= $abort_code@6@@2 $abort_code@5@@2)) (and (= $abort_flag@6@@2 $abort_flag@5@@2) (= inline$$1_Roles_has_role$1$$ret0@1@@1 inline$$1_Roles_has_role$1$$t2@1@@1))) (and (=> (= (ControlFlow 0 202484) 202642) inline$$1_Roles_has_child_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 202484) 202624) inline$$1_Roles_has_child_VASP_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@4@@2) (= inline$$1_Roles_has_role$1$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$1$$t6@2@@1))) (and (= inline$$1_Roles_has_role$1$$t9@1@@1 (= inline$$1_Roles_has_role$1$$t8@1@@1 6)) (= inline$$1_Roles_has_role$1$$t9@1@@1 inline$$1_Roles_has_role$1$$t9@1@@1))) (and (and (= $abort_code@5@@2 $abort_code@4@@2) (= inline$$1_Roles_has_role$1$$t2@1@@1 inline$$1_Roles_has_role$1$$t9@1@@1)) (and (= $abort_flag@5@@2 $abort_flag@4@@2) (= (ControlFlow 0 202530) 202484)))) inline$$1_Roles_has_role$1$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$1$anon10_Then$1_correct@@1  (=> (= $abort_flag@4@@2 true) (=> (and (= $abort_code@4@@2 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$1$$t6@2@@1 inline$$1_Roles_has_role$1$$t6@0@@1)) (and (=> (= (ControlFlow 0 202600) 202548) inline$$1_Roles_has_role$1$anon11_Then_correct@@1) (=> (= (ControlFlow 0 202600) 202530) inline$$1_Roles_has_role$1$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)) (= (ControlFlow 0 202598) 202600)) inline$$1_Roles_has_role$1$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$1$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$1$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)) (= $abort_flag@4@@2 $abort_flag@3@@2)) (and (= $abort_code@4@@2 $abort_code@3@@2) (= inline$$1_Roles_has_role$1$$t6@2@@1 inline$$1_Roles_has_role$1$$t6@1@@1))) (and (=> (= (ControlFlow 0 202502) 202548) inline$$1_Roles_has_role$1$anon11_Then_correct@@1) (=> (= (ControlFlow 0 202502) 202530) inline$$1_Roles_has_role$1$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$1$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$1$$t5@1@@1 (and (=> (= (ControlFlow 0 202488) 202598) inline$$1_Roles_has_role$1$anon10_Then_correct@@1) (=> (= (ControlFlow 0 202488) 202502) inline$$1_Roles_has_role$1$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$1$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$1$$t5@1@@1) (= false false)) (=> (and (and (= $abort_code@5@@2 $abort_code@3@@2) (= inline$$1_Roles_has_role$1$$t2@1@@1 false)) (and (= $abort_flag@5@@2 $abort_flag@3@@2) (= (ControlFlow 0 202472) 202484))) inline$$1_Roles_has_role$1$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$1$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 6 6)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$1$$t4@0@@1) (= inline$$1_Roles_has_role$1$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$1$$t4@0@@1 inline$$1_Roles_has_role$1$$t4@0@@1) (= inline$$1_Roles_has_role$1$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$1$$t4@0@@1)))) (and (=> (= (ControlFlow 0 202452) 202488) inline$$1_Roles_has_role$1$anon9_Then_correct@@1) (=> (= (ControlFlow 0 202452) 202472) inline$$1_Roles_has_role$1$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_child_VASP_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 6) (= (ControlFlow 0 202606) 202452)) inline$$1_Roles_has_role$1$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon14_Else_correct@@1  (=> (and (not inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1) (= (ControlFlow 0 202648) 202606)) inline$$1_Roles_has_child_VASP_role$0$anon0_correct@@1)))
(let ((inline$$1_Roles_can_hold_balance$0$anon14_Then_correct@@1  (=> inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 (=> (and (and (= true true) (= inline$$1_Roles_can_hold_balance$0$$t1@1@@1 true)) (and (= $abort_flag@8@@1 $abort_flag@3@@2) (= $abort_code@7@@2 $abort_code@3@@2))) (and (=> (= (ControlFlow 0 203448) 203416) inline$$1_Roles_can_hold_balance$0$anon16_Then_correct@@1) (=> (= (ControlFlow 0 203448) 203348) inline$$1_Roles_can_hold_balance$0$anon16_Else_correct@@1))))))
(let ((inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1  (=> (not $abort_flag@3@@2) (and (=> (= (ControlFlow 0 201968) 203448) inline$$1_Roles_can_hold_balance$0$anon14_Then_correct@@1) (=> (= (ControlFlow 0 201968) 202648) inline$$1_Roles_can_hold_balance$0$anon14_Else_correct@@1)))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1  (=> (and (and (not $abort_flag@2@@2) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@1@@1)) (and (= inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@1@@1) (= $abort_flag@3@@2 $abort_flag@2@@2))) (and (=> (= (ControlFlow 0 201936) 203462) inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1) (=> (= (ControlFlow 0 201936) 201968) inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1)))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1  (=> (and (and $abort_flag@2@@2 (= $abort_code@3@@2 $abort_code@3@@2)) (and (= inline$$1_Roles_has_parent_VASP_role$0$$ret0@1@@1 inline$$1_Roles_has_parent_VASP_role$0$$ret0@0@@1) (= $abort_flag@3@@2 true))) (and (=> (= (ControlFlow 0 201954) 203462) inline$$1_Roles_can_hold_balance$0$anon13_Then_correct@@1) (=> (= (ControlFlow 0 201954) 201968) inline$$1_Roles_can_hold_balance$0$anon13_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon11_Then_correct@@1  (=> $abort_flag@0@@2 (=> (and (and (= $abort_code@1@@2 $abort_code@1@@2) (= $abort_code@3@@2 $abort_code@1@@2)) (and (= $abort_flag@2@@2 true) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$ret0@0@@1))) (and (=> (= (ControlFlow 0 201860) 201954) inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 201860) 201936) inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$L3_correct@@1  (=> (and (and (= inline$$1_Roles_has_role$0$$t2@1@@1 inline$$1_Roles_has_role$0$$t2@1@@1) (= $abort_code@3@@2 $abort_code@2@@2)) (and (= $abort_flag@2@@2 $abort_flag@1@@2) (= inline$$1_Roles_has_role$0$$ret0@1@@1 inline$$1_Roles_has_role$0$$t2@1@@1))) (and (=> (= (ControlFlow 0 201796) 201954) inline$$1_Roles_has_parent_VASP_role$0$anon3_Then_correct@@1) (=> (= (ControlFlow 0 201796) 201936) inline$$1_Roles_has_parent_VASP_role$0$anon3_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon11_Else_correct@@1  (=> (and (and (and (not $abort_flag@0@@2) (= inline$$1_Roles_has_role$0$$t8@1@@1 (|$role_id#$1_Roles_RoleId| inline$$1_Roles_has_role$0$$t6@2@@1))) (and (= inline$$1_Roles_has_role$0$$t9@1@@1 (= inline$$1_Roles_has_role$0$$t8@1@@1 5)) (= inline$$1_Roles_has_role$0$$t9@1@@1 inline$$1_Roles_has_role$0$$t9@1@@1))) (and (and (= $abort_code@2@@2 $abort_code@1@@2) (= inline$$1_Roles_has_role$0$$t2@1@@1 inline$$1_Roles_has_role$0$$t9@1@@1)) (and (= $abort_flag@1@@2 $abort_flag@0@@2) (= (ControlFlow 0 201842) 201796)))) inline$$1_Roles_has_role$0$L3_correct@@1)))
(let ((inline$$1_Roles_has_role$0$anon10_Then$1_correct@@1  (=> (= $abort_flag@0@@2 true) (=> (and (= $abort_code@1@@2 $EXEC_FAILURE_CODE) (= inline$$1_Roles_has_role$0$$t6@2@@1 inline$$1_Roles_has_role$0$$t6@0@@1)) (and (=> (= (ControlFlow 0 201912) 201860) inline$$1_Roles_has_role$0$anon11_Then_correct@@1) (=> (= (ControlFlow 0 201912) 201842) inline$$1_Roles_has_role$0$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$anon10_Then_correct@@1  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)) (= (ControlFlow 0 201910) 201912)) inline$$1_Roles_has_role$0$anon10_Then$1_correct@@1)))
(let ((inline$$1_Roles_has_role$0$anon10_Else_correct@@1  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1) (=> (and (and (= inline$$1_Roles_has_role$0$$t6@1@@1 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)) (= $abort_flag@0@@2 false)) (and (= $abort_code@1@@2 $abort_code@0@@2) (= inline$$1_Roles_has_role$0$$t6@2@@1 inline$$1_Roles_has_role$0$$t6@1@@1))) (and (=> (= (ControlFlow 0 201814) 201860) inline$$1_Roles_has_role$0$anon11_Then_correct@@1) (=> (= (ControlFlow 0 201814) 201842) inline$$1_Roles_has_role$0$anon11_Else_correct@@1))))))
(let ((inline$$1_Roles_has_role$0$anon9_Then_correct@@1  (=> inline$$1_Roles_has_role$0$$t5@1@@1 (and (=> (= (ControlFlow 0 201800) 201910) inline$$1_Roles_has_role$0$anon10_Then_correct@@1) (=> (= (ControlFlow 0 201800) 201814) inline$$1_Roles_has_role$0$anon10_Else_correct@@1)))))
(let ((inline$$1_Roles_has_role$0$anon9_Else_correct@@1  (=> (and (not inline$$1_Roles_has_role$0$$t5@1@@1) (= false false)) (=> (and (and (= $abort_code@2@@2 $abort_code@0@@2) (= inline$$1_Roles_has_role$0$$t2@1@@1 false)) (and (= $abort_flag@1@@2 false) (= (ControlFlow 0 201784) 201796))) inline$$1_Roles_has_role$0$L3_correct@@1))))
(let ((inline$$1_Roles_has_role$0$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= 5 5)) (=> (and (and (|$IsValid'address'| inline$$1_Roles_has_role$0$$t4@0@@1) (= inline$$1_Roles_has_role$0$$t4@0@@1 (|$addr#$signer| _$t0@@2))) (and (= inline$$1_Roles_has_role$0$$t4@0@@1 inline$$1_Roles_has_role$0$$t4@0@@1) (= inline$$1_Roles_has_role$0$$t5@1@@1 (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) inline$$1_Roles_has_role$0$$t4@0@@1)))) (and (=> (= (ControlFlow 0 201764) 201800) inline$$1_Roles_has_role$0$anon9_Then_correct@@1) (=> (= (ControlFlow 0 201764) 201784) inline$$1_Roles_has_role$0$anon9_Else_correct@@1))))))
(let ((inline$$1_Roles_has_parent_VASP_role$0$anon0_correct@@1  (=> (= _$t0@@2 _$t0@@2) (=> (and (|$IsValid'u64'| 5) (= (ControlFlow 0 201918) 201764)) inline$$1_Roles_has_role$0$anon0_correct@@1))))
(let ((inline$$1_Roles_can_hold_balance$0$anon0_correct@@1  (=> (and (= _$t0@@2 _$t0@@2) (= (ControlFlow 0 201960) 201918)) inline$$1_Roles_has_parent_VASP_role$0$anon0_correct@@1)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Then_correct|  (=> (and inline$$1_DiemAccount_exists_at$0$$t1@1@@2 (= (ControlFlow 0 203468) 201960)) inline$$1_Roles_can_hold_balance$0$anon0_correct@@1)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Else_correct|  (=> (not inline$$1_DiemAccount_exists_at$0$$t1@1@@2) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 200956) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Else_correct|  (=> (and (not false) (|$IsValid'u64'| 0)) (=> (and (and (|$IsValid'u64'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0| 5)) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t14@0|) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 inline$$1_DiemAccount_exists_at$0$$t1@1@@2))) (and (=> (= (ControlFlow 0 200940) 203468) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Then_correct|) (=> (= (ControlFlow 0 200940) 200956) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon25_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Then_correct|  (=> |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0| (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (= 5 |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@0|)) (=> (and (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@1| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t11@0|)) (and (= |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory@2| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) (= (ControlFlow 0 204015) 200962))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$L7_correct|)))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Then_correct| true))
(let ((inline$$1_DiemAccount_exists_at$0$anon0_correct@@2  (=> (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|) (=> (and (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|)) (= inline$$1_DiemAccount_exists_at$0$$t1@1@@2 inline$$1_DiemAccount_exists_at$0$$t1@1@@2)) (and (=> (= (ControlFlow 0 200898) 203989) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Then_correct|) (=> (= (ControlFlow 0 200898) 200940) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon24_Else_correct|))))))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Else_correct|  (=> (and (not |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0|) (= (ControlFlow 0 200904) 200898)) inline$$1_DiemAccount_exists_at$0$anon0_correct@@2)))
(let ((|inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon0_correct|  (=> (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t8@0| (|$addr#$signer| _$t0@@2)) (= _$t0@@2 _$t0@@2)) (=> (and (and (|$IsValid'address'| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0| (|$addr#$signer| _$t0@@2))) (and (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0| |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t9@0|) (= |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$$t10@0|  (not (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))) (and (=> (= (ControlFlow 0 200793) 204015) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Then_correct|) (=> (= (ControlFlow 0 200793) 200904) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon23_Else_correct|))))))
(let ((anon0$1_correct@@2  (=> (forall ((addr@@173 Int) ) (!  (=> (|$IsValid'address'| addr@@173) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@173) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@173)) 0)) (= addr@@173 173345816)))
 :qid |AccountAdministrationScriptsbpl.13772:20|
 :skolemid |295|
)) (=> (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) 173345816) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) 173345816)) 0))) (forall ((addr@@174 Int) ) (!  (=> (|$IsValid'address'| addr@@174) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@174) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@174)) 1)) (= addr@@174 186537453)))
 :qid |AccountAdministrationScriptsbpl.13780:20|
 :skolemid |296|
))) (=> (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) 186537453) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) 186537453)) 1))) (forall ((addr@@175 Int) ) (!  (=> (|$IsValid'address'| addr@@175) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175)) 0)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@175)) 2))))))
 :qid |AccountAdministrationScriptsbpl.13788:20|
 :skolemid |297|
))) (and (forall ((addr@@176 Int) ) (!  (=> (|$IsValid'address'| addr@@176) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176)) 1)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@176)) 2))))))
 :qid |AccountAdministrationScriptsbpl.13792:20|
 :skolemid |298|
)) (forall ((addr@@177 Int) ) (!  (=> (|$IsValid'address'| addr@@177) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177)) 3)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@177)) 2))))))
 :qid |AccountAdministrationScriptsbpl.13796:20|
 :skolemid |299|
)))) (and (and (forall ((addr@@178 Int) ) (!  (=> (|$IsValid'address'| addr@@178) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178)) 4)) (not (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@178)) 2))))))
 :qid |AccountAdministrationScriptsbpl.13800:20|
 :skolemid |300|
)) (forall ((addr@@179 Int) ) (!  (=> (|$IsValid'address'| addr@@179) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179)) 2)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@179)) 2)))))
 :qid |AccountAdministrationScriptsbpl.13804:20|
 :skolemid |301|
))) (and (forall ((addr@@180 Int) ) (!  (=> (|$IsValid'address'| addr@@180) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180)) 5)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@180)) 2)))))
 :qid |AccountAdministrationScriptsbpl.13808:20|
 :skolemid |302|
)) (forall ((addr@@181 Int) ) (!  (=> (|$IsValid'address'| addr@@181) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181)) 6)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@181)) 2)))))
 :qid |AccountAdministrationScriptsbpl.13812:20|
 :skolemid |303|
))))) (and (and (and (forall ((addr@@182 Int) ) (!  (=> (|$IsValid'address'| addr@@182) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_105967| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@182) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@182) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@182)) 4))))
 :qid |AccountAdministrationScriptsbpl.13816:20|
 :skolemid |304|
)) (forall ((addr@@183 Int) ) (!  (=> (|$IsValid'address'| addr@@183) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106820| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@183) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@183) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@183)) 3))))
 :qid |AccountAdministrationScriptsbpl.13820:20|
 :skolemid |305|
))) (and (forall ((addr@@184 Int) ) (!  (=> (|$IsValid'address'| addr@@184) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_106820| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@184) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@184) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@184)) 3))))
 :qid |AccountAdministrationScriptsbpl.13824:20|
 :skolemid |306|
)) (forall ((addr@@185 Int) ) (!  (=> (|$IsValid'address'| addr@@185) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_106820| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@185) (not (= (seq.len (|$vec#$1_Option_Option'$1_ValidatorConfig_Config'| (|$config#$1_ValidatorConfig_ValidatorConfig| (|Select__T@[Int]$1_ValidatorConfig_ValidatorConfig_| (|contents#$Memory_106820| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@185)))) 0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@185) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@185)) 3))))
 :qid |AccountAdministrationScriptsbpl.13828:20|
 :skolemid |307|
)))) (and (and (let (($range_0@@1 ($Range 0 (seq.len (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@186 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_107807| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@186))))))))
(forall (($i_1@@1 Int) ) (!  (=> ($InRange $range_0@@1 $i_1@@1) (let ((i1@@1 $i_1@@1))
 (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@187 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_107807| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@187)))) i1@@1))) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) (|$addr#$1_DiemSystem_ValidatorInfo| (seq.nth (|$validators#$1_DiemSystem_DiemSystem| (let ((addr@@187 173345816))
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_107807| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@187)))) i1@@1)))) 3))))
 :qid |AccountAdministrationScriptsbpl.13832:151|
 :skolemid |308|
))) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))) (forall ((mint_cap_owner1@@1 Int) (mint_cap_owner2@@1 Int) ) (!  (=> (|$IsValid'address'| mint_cap_owner1@@1) (=> (|$IsValid'address'| mint_cap_owner2@@1) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_109822| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner1@@1) (|Select__T@[Int]Bool_| (|domain#$Memory_109822| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) mint_cap_owner2@@1)) (= mint_cap_owner1@@1 mint_cap_owner2@@1))))
 :qid |AccountAdministrationScriptsbpl.13837:104|
 :skolemid |309|
)))) (and (forall ((addr3@@1 Int) ) (!  (=> (|$IsValid'address'| addr3@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_109822| |$1_Diem_MintCapability'$1_XDX_XDX'_$memory|) addr3@@1) (and (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816) (not (|$is_synthetic#$1_Diem_CurrencyInfo'$1_XDX_XDX'| (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816))))))
 :qid |AccountAdministrationScriptsbpl.13841:20|
 :skolemid |310|
)) (forall ((addr@@188 Int) ) (!  (=> (|$IsValid'address'| addr@@188) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_115150| |$1_Diem_Preburn'$1_XDX_XDX'_$memory|) addr@@188) (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)))
 :qid |AccountAdministrationScriptsbpl.13845:20|
 :skolemid |311|
)))))) (=> (and (and (and (and (and (=> (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) 173345816)) (forall ((addr1@@1 Int) ) (!  (=> (|$IsValid'address'| addr1@@1) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_118096| $1_DualAttestation_Credential_$memory) addr1@@1) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr1@@1)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr1@@1) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr1@@1)) 2)))))
 :qid |AccountAdministrationScriptsbpl.13853:20|
 :skolemid |312|
))) (and (forall ((addr@@189 Int) ) (!  (=> (|$IsValid'address'| addr@@189) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@189) (or (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@189)))) 0) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@189)))) 0)) (= addr@@189 (|$account_address#$1_DiemAccount_KeyRotationCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_KeyRotationCapability'| (|$key_rotation_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@189))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.13857:20|
 :skolemid |313|
)) (forall ((addr@@190 Int) ) (!  (=> (|$IsValid'address'| addr@@190) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@190) (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@190) (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@190)))) 0)) (and (not (= (seq.len (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@190)))) 0)) (= addr@@190 (|$account_address#$1_DiemAccount_WithdrawCapability| (seq.nth (|$vec#$1_Option_Option'$1_DiemAccount_WithdrawCapability'| (|$withdraw_capability#$1_DiemAccount_DiemAccount| (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@190))) 0)))))))
 :qid |AccountAdministrationScriptsbpl.13861:20|
 :skolemid |314|
)))) (and (and (forall ((addr@@191 Int) ) (!  (=> (|$IsValid'address'| addr@@191) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@191) (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@191)))
 :qid |AccountAdministrationScriptsbpl.13865:20|
 :skolemid |315|
)) (forall ((addr@@192 Int) ) (!  (=> (|$IsValid'address'| addr@@192) (= (|Select__T@[Int]Bool_| (|domain#$Memory_128847| $1_DiemAccount_AccountOperationsCapability_$memory) addr@@192)  (and (= addr@@192 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@192))))
 :qid |AccountAdministrationScriptsbpl.13869:20|
 :skolemid |316|
))) (and (forall ((addr@@193 Int) ) (!  (=> (|$IsValid'address'| addr@@193) (= (|Select__T@[Int]Bool_| (|domain#$Memory_129331| $1_DiemAccount_DiemWriteSetManager_$memory) addr@@193)  (and (= addr@@193 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@193))))
 :qid |AccountAdministrationScriptsbpl.13873:20|
 :skolemid |317|
)) (forall ((addr@@194 Int) ) (!  (=> (|$IsValid'address'| addr@@194) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116914| $1_VASPDomain_VASPDomainManager_$memory) addr@@194)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@194) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@194)) 1))))
 :qid |AccountAdministrationScriptsbpl.13877:20|
 :skolemid |318|
))))) (and (and (and (forall ((addr@@195 Int) ) (!  (=> (|$IsValid'address'| addr@@195) (= (|Select__T@[Int]Bool_| (|domain#$Memory_116617| $1_VASPDomain_VASPDomains_$memory) addr@@195)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@195) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@195)) 5))))
 :qid |AccountAdministrationScriptsbpl.13881:20|
 :skolemid |319|
)) (forall ((addr@@196 Int) ) (!  (=> (|$IsValid'address'| addr@@196) (=> (or (|Select__T@[Int]Bool_| (|domain#$Memory_128982| |$1_DiemAccount_Balance'$1_XUS_XUS'_$memory|) addr@@196) (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@196)) (or (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196)) 5)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196)) 6))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@196)) 2)))))
 :qid |AccountAdministrationScriptsbpl.13885:20|
 :skolemid |320|
))) (and (forall ((addr@@197 Int) ) (!  (=> (|$IsValid'address'| addr@@197) (= (|Select__T@[Int]Bool_| (|domain#$Memory_120910| $1_DesignatedDealer_Dealer_$memory) addr@@197)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@197) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@197)) 2))))
 :qid |AccountAdministrationScriptsbpl.13889:20|
 :skolemid |321|
)) (forall ((addr@@198 Int) ) (!  (=> (|$IsValid'address'| addr@@198) (= (|Select__T@[Int]Bool_| (|domain#$Memory_118096| $1_DualAttestation_Credential_$memory) addr@@198)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@198) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@198)) 2)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@198) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@198)) 5)))))
 :qid |AccountAdministrationScriptsbpl.13893:20|
 :skolemid |322|
)))) (and (and (forall ((addr@@199 Int) ) (!  (=> (|$IsValid'address'| addr@@199) (= (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@199) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@199)))
 :qid |AccountAdministrationScriptsbpl.13897:20|
 :skolemid |323|
)) (forall ((addr@@200 Int) ) (!  (=> (|$IsValid'address'| addr@@200) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@200) (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@200)))
 :qid |AccountAdministrationScriptsbpl.13901:20|
 :skolemid |324|
))) (and (forall ((addr@@201 Int) ) (!  (=> (|$IsValid'address'| addr@@201) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) addr@@201) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@201)))
 :qid |AccountAdministrationScriptsbpl.13905:20|
 :skolemid |325|
)) (forall ((addr@@202 Int) ) (!  (=> (|$IsValid'address'| addr@@202) (= (|Select__T@[Int]Bool_| (|domain#$Memory_107357| $1_SlidingNonce_SlidingNonce_$memory) addr@@202)  (or (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@202)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@202) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@202)) 1)))))
 :qid |AccountAdministrationScriptsbpl.13909:20|
 :skolemid |326|
)))))) (and (and (and (and (forall ((addr@@203 Int) ) (!  (=> (|$IsValid'address'| addr@@203) (= (|Select__T@[Int]Bool_| (|domain#$Memory_106820| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@203)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@203) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@203)) 3))))
 :qid |AccountAdministrationScriptsbpl.13913:20|
 :skolemid |327|
)) (forall ((addr@@204 Int) ) (!  (=> (|$IsValid'address'| addr@@204) (= (|Select__T@[Int]Bool_| (|domain#$Memory_105967| $1_ValidatorOperatorConfig_ValidatorOperatorConfig_$memory) addr@@204)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@204) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@204)) 4))))
 :qid |AccountAdministrationScriptsbpl.13917:20|
 :skolemid |328|
))) (and (forall ((addr@@205 Int) ) (!  (=> (|$IsValid'address'| addr@@205) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117561| $1_VASP_ParentVASP_$memory) addr@@205)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@205) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@205)) 5))))
 :qid |AccountAdministrationScriptsbpl.13921:20|
 :skolemid |329|
)) (forall ((addr@@206 Int) ) (!  (=> (|$IsValid'address'| addr@@206) (= (|Select__T@[Int]Bool_| (|domain#$Memory_117497| $1_VASP_ChildVASP_$memory) addr@@206)  (and (|Select__T@[Int]Bool_| (|domain#$Memory_104734| $1_Roles_RoleId_$memory) addr@@206) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) addr@@206)) 6))))
 :qid |AccountAdministrationScriptsbpl.13925:20|
 :skolemid |330|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0@@2)) ($1_Signer_is_txn_signer _$t0@@2)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0@@2)))) (and (and (and (forall (($a_0@@8 Int) ) (! (let (($rsc@@8 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) $a_0@@8)))
(|$IsValid'$1_Roles_RoleId'| $rsc@@8))
 :qid |AccountAdministrationScriptsbpl.13931:20|
 :skolemid |331|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_104734| $1_Roles_RoleId_$memory) $a_0@@8))
)) (forall (($a_0@@9 Int) ) (! (let (($rsc@@9 (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9)))
 ...
 :qid |AccountAdministrationScriptsbpl.13935:20|
 :skolemid |332|
 :pattern ( (|Select__T@[Int]$1_Diem_CurrencyInfo'$1_XDX_XDX'_| (|contents#$Memory_109475| |$1_Diem_CurrencyInfo'$1_XDX_XDX'_$memory|) $a_0@@9))
))) (and (forall (($a_0@@10 Int) ) (! (let (($rsc@@10 (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@10)))
 ...
 :qid |AccountAdministrationScriptsbpl.13939:20|
 :skolemid |333|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_DiemAccount_| (|contents#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) $a_0@@10))
)) (forall (($a_0@@11 Int) ) (! (let (($rsc@@11 (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0@@11)))
(|$IsValid'$1_DiemAccount_Balance'$1_XDX_XDX''| $rsc@@11))
 :qid |AccountAdministrationScriptsbpl.13943:20|
 :skolemid |334|
 :pattern ( (|Select__T@[Int]$1_DiemAccount_Balance'$1_XDX_XDX'_| (|contents#$Memory_129073| |$1_DiemAccount_Balance'$1_XDX_XDX'_$memory|) $a_0@@11))
)))) (and (and (let ((addr@@207 (|$addr#$signer| _$t0@@2)))
 (and (and (|Select__T@[Int]Bool_| (|domain#$Memory_104546| $1_DiemTimestamp_CurrentTimeMicroseconds_$memory) 173345816) (|Select__T@[Int]Bool_| (|domain#$Memory_127894| $1_DiemAccount_DiemAccount_$memory) addr@@207)) (not (and (|Select__T@[Int]Bool_| (|domain#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@207) (|$is_frozen#$1_AccountFreezing_FreezingBit| (|Select__T@[Int]$1_AccountFreezing_FreezingBit_| (|contents#$Memory_127414| $1_AccountFreezing_FreezingBit_$memory) addr@@207)))))) (= _$t0@@2 _$t0@@2)) (and (= $t1@@1 (|$addr#$signer| _$t0@@2)) (= (ControlFlow 0 204019) 200793)))))) |inline$$1_DiemAccount_add_currency'$1_XDX_XDX'$0$anon0_correct|))))))
(let ((inline$$InitEventStore$0$anon0_correct@@2  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@4 T@$1_Event_EventHandle) ) (! (let ((stream@@3 (|Select__T@[$1_Event_EventHandle]Multiset_72203_| (|streams#$EventStore| $es) handle@@4)))
 (and (= (|l#Multiset_72203| stream@@3) 0) (forall ((v@@44 T@$EventRep) ) (! (= (|Select__T@[$EventRep]Int_| (|v#Multiset_72203| stream@@3) v@@44) 0)
 :qid |AccountAdministrationScriptsbpl.134:13|
 :skolemid |2|
))))
 :qid |AccountAdministrationScriptsbpl.2912:13|
 :skolemid |79|
))) (= (ControlFlow 0 198963) 204019)) anon0$1_correct@@2)))
(let ((anon0_correct@@2  (=> (= (ControlFlow 0 269175) 198963) inline$$InitEventStore$0$anon0_correct@@2)))
anon0_correct@@2))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
