...
(declare-fun $t11 () T@$1_Roles_RoleId)
(declare-fun $t6 () Int)
...
(assert (not
 (=> (= (ControlFlow 0 0) 760755) (let ((anon15_Then_correct  (=> $t14@0 (and (=> (= (ControlFlow 0 446853) (- 0 761459)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 446853) (- 0 761472)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6))) (and (=> (= (ControlFlow 0 446853) (- 0 761491)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0))))
 :qid |Rolesbpl.6075:15|
 :skolemid |222|
 ...
 :qid |Rolesbpl.6095:15|
 :skolemid |227|
)) (=> (= (ControlFlow 0 446853) (- 0 761785)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6))))
 :qid |Rolesbpl.6099:15|
 :skolemid |228|
))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 446364) (- 0 761865)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6))) (=> (= (ControlFlow 0 446364) (- 0 761889)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) (= 5 $t10@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) (|$addr#$signer| _$t0))) 6)) (= 3 $t10@0))))))))
(let ((anon15_Else_correct  (=> (and (and (not $t14@0) (= $t16 $t16)) (and (= $t10@0 $t16) (= (ControlFlow 0 446454) 446364))) L5_correct)))
(let ((anon14_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t12@0 (|$role_id#$1_Roles_RoleId| $t11@1)) (|$IsValid'u64'| 6)) (and (= $t14@0 (= $t12@0 6)) (|$IsValid'u64'| 9))) (and (and (|$IsValid'u64'| $t16) (= $t16 3)) (and (= $t16 $t16) (= $t14@0 $t14@0)))) (and (=> (= (ControlFlow 0 446438) 446853) anon15_Then_correct) (=> (= (ControlFlow 0 446438) 446454) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t10@0 $abort_code@1) (= (ControlFlow 0 446867) 446364))) L5_correct)))
(let ((anon13_Then$1_correct  (=> (= $t11@1 $t11) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 446919) 446867) anon14_Then_correct) (=> (= (ControlFlow 0 446919) 446438) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (= (ControlFlow 0 446917) 446919)) anon13_Then$1_correct)))
(let ((anon13_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6) (=> (and (and (= $t11@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (= $t11@1 $t11@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 446382) 446867) anon14_Then_correct) (=> (= (ControlFlow 0 446382) 446438) anon14_Else_correct))))))
(let ((anon12_Then_correct  (=> $t7@0 (and (=> (= (ControlFlow 0 446368) 446917) anon13_Then_correct) (=> (= (ControlFlow 0 446368) 446382) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not $t7@0) (= $t9 $t9)) (and (= $t10@0 $t9) (= (ControlFlow 0 446284) 446364))) L5_correct)))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.5927:20|
 :skolemid |221|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0))
))) (and (= _$t0 _$t0) (|$IsValid'address'| $t6))) (and (and (and (= $t6 (|$addr#$signer| _$t0)) (= $t6 $t6)) (and (= $t7@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t9) (= $t9 5)) (and (= $t9 $t9) (= $t7@0 $t7@0))))) (and (=> (= (ControlFlow 0 446268) 446368) anon12_Then_correct) (=> (= (ControlFlow 0 446268) 446284) anon12_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 445781) 446268)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 760755) 445781) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))
))
(check-sat)
(pop 1)
