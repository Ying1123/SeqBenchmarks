...
(assert (not
 (=> (= (ControlFlow 0 0) 759467) (let ((anon18_Then_correct  (=> $t16@0 (and (=> (= (ControlFlow 0 445536) (- 0 760233)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6))) (and (=> (= (ControlFlow 0 445536) (- 0 760245)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 1))) (and (=> (= (ControlFlow 0 445536) (- 0 760263)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 445536) (- 0 760277)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0))))
 :qid |Rolesbpl.5781:15|
 :skolemid |199|
 ...
 :qid |Rolesbpl.5801:15|
 :skolemid |204|
)) (=> (= (ControlFlow 0 445536) (- 0 760571)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6))))
 :qid |Rolesbpl.5805:15|
 :skolemid |205|
))))))))))))))))))))))))
(let ((L5_correct  (and (=> (= (ControlFlow 0 445037) (- 0 760655)) (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (=> (= (ControlFlow 0 445037) (- 0 760688)) (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) (= 5 $t8@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t6)) 1)) (= 3 $t8@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8@0))))))))
(let ((anon18_Else_correct  (=> (and (and (not $t16@0) (= $t18 $t18)) (and (= $t8@0 $t18) (= (ControlFlow 0 445127) 445037))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (and (= $t14@0 (|$role_id#$1_Roles_RoleId| $t13@1)) (|$IsValid'u64'| 1)) (and (= $t16@0 (= $t14@0 1)) (|$IsValid'u64'| 2))) (and (and (|$IsValid'u64'| $t18) (= $t18 3)) (and (= $t18 $t18) (= $t16@0 $t16@0)))) (and (=> (= (ControlFlow 0 445111) 445536) anon18_Then_correct) (=> (= (ControlFlow 0 445111) 445127) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t8@0 $abort_code@1) (= (ControlFlow 0 445550) 445037))) L5_correct)))
(let ((anon16_Then$1_correct  (=> (= $t13@1 $t13) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 445602) 445550) anon17_Then_correct) (=> (= (ControlFlow 0 445602) 445111) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t9)) (= (ControlFlow 0 445600) 445602)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t9) (=> (and (and (= $t13@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t9)) (= $t13@1 $t13@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 445055) 445550) anon17_Then_correct) (=> (= (ControlFlow 0 445055) 445111) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t10@0 (and (=> (= (ControlFlow 0 445041) 445600) anon16_Then_correct) (=> (= (ControlFlow 0 445041) 445055) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t10@0) (= $t12 $t12)) (and (= $t8@0 $t12) (= (ControlFlow 0 444933) 445037))) L5_correct)))
(let ((anon14_Else_correct  (=> (and (not $t7) (|$IsValid'address'| $t9)) (=> (and (and (and (= $t9 (|$addr#$signer| _$t0)) (= $t9 $t9)) (and (= $t10@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t9)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t12) (= $t12 5)) (and (= $t12 $t12) (= $t10@0 $t10@0)))) (and (=> (= (ControlFlow 0 444917) 445041) anon15_Then_correct) (=> (= (ControlFlow 0 444917) 444933) anon15_Else_correct))))))
(let ((anon14_Then_correct  (=> $t7 (=> (and (and (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t8)) (= $t8 $t8)) (and (= $t8@0 $t8) (= (ControlFlow 0 445632) 445037))) L5_correct))))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.5596:20|
 :skolemid |198|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0))
)) (= $t6 (|$addr#$signer| _$t0))) (and (= _$t0 _$t0) (= $t7  (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 444855) 445632) anon14_Then_correct) (=> (= (ControlFlow 0 444855) 444917) anon14_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 444396) 444855)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 759467) 444396) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))))))
))
(check-sat)
(pop 1)
