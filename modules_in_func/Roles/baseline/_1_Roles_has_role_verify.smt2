...
(declare-fun $t6 () T@$1_Roles_RoleId)
(declare-fun $abort_code@1 () Int)
(declare-fun $t4 () Int)
(declare-fun $t6@0 () T@$1_Roles_RoleId)
...
(let ((L3_correct  (=> (= $t2@0 $t2@0) (and (=> (= (ControlFlow 0 471315) (- 0 782741)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0))))
 ...
 :qid |Rolesbpl.11293:15|
 :skolemid |629|
)) (=> (= (ControlFlow 0 471315) (- 0 783035)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6))))
 :qid |Rolesbpl.11297:15|
 :skolemid |630|
))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (not $abort_flag@0) (= $t8@0 (|$role_id#$1_Roles_RoleId| $t6@1))) (=> (and (and (= $t9@0 (= $t8@0 _$t1)) (= $t9@0 $t9@0)) (and (= $t2@0 $t9@0) (= (ControlFlow 0 471361) 471315))) L3_correct))))
(let ((anon11_Then$1_correct  (=> (= $t6@1 $t6) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 471431) 471379) anon12_Then_correct) (=> (= (ControlFlow 0 471431) 471361) anon12_Else_correct))))))
(let ((anon11_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t4)) (= (ControlFlow 0 471429) 471431)) anon11_Then$1_correct)))
(let ((anon11_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t4) (=> (and (and (= $t6@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t4)) (= $t6@1 $t6@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 471333) 471379) anon12_Then_correct) (=> (= (ControlFlow 0 471333) 471361) anon12_Else_correct))))))
(let ((anon10_Then_correct  (=> $t5@0 (and (=> (= (ControlFlow 0 471319) 471429) anon11_Then_correct) (=> (= (ControlFlow 0 471319) 471333) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not $t5@0) (= false false)) (and (= $t2@0 false) (= (ControlFlow 0 470944) 471315))) L3_correct)))
(let ((anon0$1_correct  (=> (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@12)) 0)) (= addr@@12 173345816)))
 ...
 :qid |Rolesbpl.11150:20|
 :skolemid |618|
))))) (=> (and (and (and (and (forall ((addr@@23 Int) ) (!  (=> (|$IsValid'address'| addr@@23) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@23) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@23) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@23)) 3))))
 :qid |Rolesbpl.11154:20|
 :skolemid |619|
 ...
 :qid |Rolesbpl.11166:20|
 :skolemid |622|
)))) (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0)))) (and (and (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.11175:20|
 :skolemid |623|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0))
))) (and (= _$t0 _$t0) (= _$t1 _$t1))) (and (and (|$IsValid'address'| $t4) (= $t4 (|$addr#$signer| _$t0))) (and (= $t4 $t4) (= $t5@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t4)))))) (and (=> (= (ControlFlow 0 470924) 471319) anon10_Then_correct) (=> (= (ControlFlow 0 470924) 470944) anon10_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 470455) 470924)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 782066) 470455) inline$$InitEventStore$0$anon0_correct)))
anon0_correct))))))))))))
))
(check-sat)
(pop 1)
