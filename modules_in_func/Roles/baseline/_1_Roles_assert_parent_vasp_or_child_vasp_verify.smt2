...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 763132) (let ((anon19_Then_correct  (=> $t5@0 (and (=> (= (ControlFlow 0 449795) (- 0 764242)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t8)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t8))) (and (=> (= (ControlFlow 0 449795) (- 0 764254)) (not (and (not (= $t9 5)) (not (= $t9 6))))) (=> (not (and (not (= $t9 5)) (not (= $t9 6)))) (and (=> (= (ControlFlow 0 449795) (- 0 764277)) (forall ((addr Int) ) (!  (=> (|$IsValid'address'| addr) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr)) 0))))
 :qid |Rolesbpl.6787:15|
 :skolemid |279|
 ...
 :qid |Rolesbpl.6807:15|
 :skolemid |284|
)) (=> (= (ControlFlow 0 449795) (- 0 764571)) (forall ((addr@@11 Int) ) (!  (=> (|$IsValid'address'| addr@@11) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6)) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@11)) 6))))
 :qid |Rolesbpl.6811:15|
 :skolemid |285|
))))))))))))))))))))))
(let ((L9_correct  (and (=> (= (ControlFlow 0 449270) (- 0 764651)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t8)) (and (not (= $t9 5)) (not (= $t9 6))))) (=> (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t8)) (and (not (= $t9 5)) (not (= $t9 6)))) (=> (= (ControlFlow 0 449270) (- 0 764678)) (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t8)) (= 5 $t14@0)) (and (and (not (= $t9 5)) (not (= $t9 6))) (= 3 $t14@0))))))))
(let ((anon19_Else_correct  (=> (and (and (not $t5@0) (= $t23 $t23)) (and (= $t14@0 $t23) (= (ControlFlow 0 449396) 449270))) L9_correct)))
(let ((L5_correct  (=> (|$IsValid'u64'| 4) (=> (and (and (|$IsValid'u64'| $t23) (= $t23 3)) (and (= $t23 $t23) (= $t5@0 $t5@0))) (and (=> (= (ControlFlow 0 449380) 449795) anon19_Then_correct) (=> (= (ControlFlow 0 449380) 449396) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not $t18@0) (|$IsValid'u64'| 6)) (=> (and (and (= $t21@0 (= $t16@0 6)) (= $t21@0 $t21@0)) (and (= $t5@0 $t21@0) (= (ControlFlow 0 449346) 449380))) L5_correct))))
(let ((anon18_Then_correct  (=> (and (and $t18@0 (= true true)) (and (= $t5@0 true) (= (ControlFlow 0 449813) 449380))) L5_correct)))
(let ((anon17_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t16@0 (|$role_id#$1_Roles_RoleId| $t15@1)) (= $t16@0 $t16@0)) (and (|$IsValid'u64'| 5) (= $t18@0 (= $t16@0 5)))) (and (=> (= (ControlFlow 0 449320) 449813) anon18_Then_correct) (=> (= (ControlFlow 0 449320) 449346) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t14@0 $abort_code@1) (= (ControlFlow 0 449827) 449270))) L9_correct)))
(let ((anon16_Then$1_correct  (=> (= $t15@1 $t15) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 449879) 449827) anon17_Then_correct) (=> (= (ControlFlow 0 449879) 449320) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t10)) (= (ControlFlow 0 449877) 449879)) anon16_Then$1_correct)))
(let ((anon16_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t10) (=> (and (and (= $t15@0 (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t10)) (= $t15@1 $t15@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 449288) 449827) anon17_Then_correct) (=> (= (ControlFlow 0 449288) 449320) anon17_Else_correct))))))
(let ((anon15_Then_correct  (=> $t11@0 (and (=> (= (ControlFlow 0 449274) 449877) anon16_Then_correct) (=> (= (ControlFlow 0 449274) 449288) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not $t11@0) (= $t13 $t13)) (and (= $t14@0 $t13) (= (ControlFlow 0 449190) 449270))) L9_correct)))
(let ((anon0$1_correct  (=> (and (and (forall ((addr@@12 Int) ) (!  (=> (|$IsValid'address'| addr@@12) (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@12) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@12)) 0)) (= addr@@12 173345816)))
 ...
 :qid |Rolesbpl.6510:20|
 :skolemid |261|
))))) (=> (and (and (and (and (forall ((addr@@22 Int) ) (!  (=> (|$IsValid'address'| addr@@22) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_225533| $1_ValidatorConfig_ValidatorConfig_$memory) addr@@22) (and (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) addr@@22) (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) addr@@22)) 3))))
 :qid |Rolesbpl.6514:20|
 :skolemid |262|
...
(|$payload#$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'| (|Select__T@[Int]$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_| (|contents#$Memory_221370| |$1_DiemConfig_DiemConfig'$1_DiemSystem_DiemSystem'_$memory|) addr@@26))))) i1)))) 3))))
 ...
 :qid |Rolesbpl.6575:20|
 :skolemid |277|
)))))) (=> (and (and (and (and (and (|$IsValid'address'| (|$addr#$signer| _$t0)) ($1_Signer_is_txn_signer _$t0)) ($1_Signer_is_txn_signer_addr (|$addr#$signer| _$t0))) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0)))
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |Rolesbpl.6581:20|
 :skolemid |278|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $a_0))
))) (and (and (= $t8 (|$addr#$signer| _$t0)) (= $t9 (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_221004| $1_Roles_RoleId_$memory) $t8)))) (and (= _$t0 _$t0) (|$IsValid'address'| $t10)))) (and (and (and (= $t10 (|$addr#$signer| _$t0)) (= $t10 $t10)) (and (= $t11@0 (|Select__T@[Int]Bool_| (|domain#$Memory_221004| $1_Roles_RoleId_$memory) $t10)) (|$IsValid'u64'| 0))) (and (and (|$IsValid'u64'| $t13) (= $t13 5)) (and (= $t13 $t13) (= $t11@0 $t11@0))))) (and (=> (= (ControlFlow 0 449174) 449274) anon15_Then_correct) (=> (= (ControlFlow 0 449174) 449190) anon15_Else_correct))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_174514_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |Rolesbpl.3311:13|
 :skolemid |119|
))) (= (ControlFlow 0 448350) 449174)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 763132) 448350) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))
))
(check-sat)
(pop 1)
