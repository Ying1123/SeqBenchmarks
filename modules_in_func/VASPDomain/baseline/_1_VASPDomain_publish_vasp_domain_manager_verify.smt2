...
(declare-fun $1_VASPDomain_VASPDomainManager_$memory@1 () T@$Memory_55405)
(declare-fun $t6@0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun $1_VASPDomain_VASPDomainManager_$memory@0 () T@$Memory_55405)
...
(declare-fun $t13@0 () T@$1_VASPDomain_VASPDomainManager)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 94028) (let ((anon18_Else_correct  (=> (not $abort_flag@0) (and (=> (= (ControlFlow 0 80388) (- 0 95072)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t3)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t3))) (and (=> (= (ControlFlow 0 80388) (- 0 95084)) (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) 1)))) (=> (not (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) 1))) (and (=> (= (ControlFlow 0 80388) (- 0 95102)) (not (not (= (|$addr#$signer| _$t0) 186537453)))) (=> (not (not (= (|$addr#$signer| _$t0) 186537453))) (and (=> (= (ControlFlow 0 80388) (- 0 95116)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 80388) (- 0 95124)) (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory@1) (|$addr#$signer| _$t0))))))))))))))
(let ((anon16_Then_correct true))
(let ((L3_correct  (and (=> (= (ControlFlow 0 80192) (- 0 94954)) (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) 186537453))) (=> (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))) (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) 186537453)) (=> (= (ControlFlow 0 80192) (- 0 94992)) (or (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) (= 5 $t6@0)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t3)) 1)) (= 3 $t6@0))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6@0))) (and (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) 186537453) (= 6 $t6@0))))))))
(let ((anon18_Then_correct  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $t6@0 $abort_code@1) (= (ControlFlow 0 80402) 80192))) L3_correct)))
(let ((anon17_Then$1_correct  (=> (= $1_VASPDomain_VASPDomainManager_$memory@1 $1_VASPDomain_VASPDomainManager_$memory) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 80454) 80402) anon18_Then_correct) (=> (= (ControlFlow 0 80454) 80388) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0)) (= (ControlFlow 0 80452) 80454)) anon17_Then$1_correct)))
(let ((anon17_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0))) (=> (and (and (= $1_VASPDomain_VASPDomainManager_$memory@0 ($Memory_55405 (|Store__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0) true) (|Store__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) (|$addr#$signer| _$t0) $t13@0))) (= $1_VASPDomain_VASPDomainManager_$memory@1 $1_VASPDomain_VASPDomainManager_$memory@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 80316) 80402) anon18_Then_correct) (=> (= (ControlFlow 0 80316) 80388) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (not false) (= $t13@0 ($1_VASPDomain_VASPDomainManager |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0|))) (and (=> (= (ControlFlow 0 80294) (- 0 94849)) (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0))) (=> (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0)) (and (=> (= (ControlFlow 0 80294) 80452) anon17_Then_correct) (=> (= (ControlFlow 0 80294) 80316) anon17_Else_correct)))))))
(let ((|inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|  (=> (and (= (|Select__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0|) false) (= $1_Event_EventHandles@0 (|Store__T@[$1_Event_EventHandle]Bool_| $1_Event_EventHandles |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$res@0| true))) (and (=> (= (ControlFlow 0 80264) 80468) anon16_Then_correct) (=> (= (ControlFlow 0 80264) 80294) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and inline$$Not$0$dst@1 (= (ControlFlow 0 80270) 80264)) |inline$$1_Event_new_event_handle'$1_VASPDomain_VASPDomainEvent'$0$anon0_correct|)))
(let ((anon15_Else_correct  (=> (and (and (not inline$$Not$0$dst@1) (= $t11 $t11)) (and (= $t6@0 $t11) (= (ControlFlow 0 80068) 80192))) L3_correct)))
(let ((anon14_Else$1_correct  (=> (|$IsValid'u64'| 1) (=> (and (and (|$IsValid'u64'| $t11) (= $t11 6)) (and (= $t11 $t11) (= inline$$Not$0$dst@1 inline$$Not$0$dst@1))) (and (=> (= (ControlFlow 0 80052) 80270) anon15_Then_correct) (=> (= (ControlFlow 0 80052) 80068) anon15_Else_correct))))))
(let ((inline$$Not$0$anon0_correct  (=> (and (= inline$$Not$0$dst@1  (not $t8@0)) (= (ControlFlow 0 80012) 80052)) anon14_Else$1_correct)))
(let ((anon14_Else_correct  (=> (not $t5) (=> (and (and (|$IsValid'address'| $t7) (= $t7 (|$addr#$signer| _$t0))) (and (= $t8@0 (|Select__T@[Int]Bool_| (|domain#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) $t7)) (= (ControlFlow 0 80018) 80012))) inline$$Not$0$anon0_correct))))
(let ((anon14_Then_correct  (=> $t5 (=> (and (and (or (or (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) (= 5 $t6)) (and (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 1)) (= 3 $t6))) (and (not (= (|$addr#$signer| _$t0) 186537453)) (= 2 $t6))) (= $t6 $t6)) (and (= $t6@0 $t6) (= (ControlFlow 0 80540) 80192))) L3_correct))))
...
(|$IsValid'$1_Roles_RoleId'| $rsc))
 :qid |VASPDomainbpl.4093:20|
 :skolemid |174|
 :pattern ( (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $a_0))
))) (and (forall (($a_0@@0 Int) ) (! (let (($rsc@@0 (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0)))
(|$IsValid'$1_VASPDomain_VASPDomainManager'| $rsc@@0))
 :qid |VASPDomainbpl.4097:20|
 :skolemid |175|
 :pattern ( (|Select__T@[Int]$1_VASPDomain_VASPDomainManager_| (|contents#$Memory_55405| $1_VASPDomain_VASPDomainManager_$memory) $a_0@@0))
)) (= $t3 (|$addr#$signer| _$t0)))) (and (and (|Select__T@[Int]Bool_| $1_VASPDomain_VASPDomainManager_$modifies (|$addr#$signer| _$t0)) (= _$t0 _$t0)) (and (= $t4 (|$addr#$signer| _$t0)) (= $t5  (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) (not (= (|$role_id#$1_Roles_RoleId| (|Select__T@[Int]$1_Roles_RoleId_| (|contents#$Memory_53154| $1_Roles_RoleId_$memory) $t4)) 1))) (not (= (|$addr#$signer| _$t0) 186537453))))))) (and (=> (= (ControlFlow 0 79956) 80540) anon14_Then_correct) (=> (= (ControlFlow 0 79956) 80018) anon14_Else_correct)))))))))
(let ((inline$$InitEventStore$0$anon0_correct  (=> (and (and (= (|counter#$EventStore| $es) 0) (forall ((handle@@1 T@$1_Event_EventHandle) ) (! (let ((stream@@0 (|Select__T@[$1_Event_EventHandle]Multiset_31124_| (|streams#$EventStore| $es) handle@@1)))
 ...
 :qid |VASPDomainbpl.2044:13|
 :skolemid |70|
))) (= (ControlFlow 0 79427) 79956)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 94028) 79427) inline$$InitEventStore$0$anon0_correct)))
anon0_correct)))))))))))))))))))
))
(check-sat)
(pop 1)
